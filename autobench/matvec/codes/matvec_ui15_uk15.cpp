...
void init()
{
	...
	BLOCKI=(BLOCKI/15/mippN)*15*mippN;
	BLOCKK=(BLOCKK/15/mippN)*15*mippN;
...
float bench()
{
	...
	for (int k=0;k<BLOCKK;k+=15) 
	{
		...
		b0_14=mipp::set1<TYPE>(B[k+ 14 ]);
		

		for (int i=0;i<BLOCKI;i+=(15)*nv) 
		{         
			...
			_mm_prefetch(C+i+(14+1)*nv ,1);
			_mm_prefetch(A+i+(14+1)*nv ,1);
			...
			a14_0.load(&A[BLOCKI*(k+ 0 ) + i+14*nv]);
			...
			c14_0 = mipp::fmadd(a14_0, b0_0,c14_0);
		...
		{         
			...
			a14_1.load(&A[BLOCKI*(k+ 1 ) + i+14*nv]);
			...
			c14_1 = mipp::fmadd(a14_1, b0_1,c14_1);
		...
		{         
			...
			a14_2.load(&A[BLOCKI*(k+ 2 ) + i+14*nv]);
			...
			c14_2 = mipp::fmadd(a14_2, b0_2,c14_2);
		...
		{         
			...
			a14_3.load(&A[BLOCKI*(k+ 3 ) + i+14*nv]);
			...
			c14_3 = mipp::fmadd(a14_3, b0_3,c14_3);
		...
		{         
			...
			mipp::Reg<TYPE> c12_4, a12_4;
			mipp::Reg<TYPE> c13_4, a13_4;
			mipp::Reg<TYPE> c14_4, a14_4;
			...
			c12_4.load(&C[i+12*nv]);
			c13_4.load(&C[i+13*nv]);
			c14_4.load(&C[i+14*nv]);
			...
			a12_4.load(&A[BLOCKI*(k+ 4 ) + i+12*nv]);
			a13_4.load(&A[BLOCKI*(k+ 4 ) + i+13*nv]);
			a14_4.load(&A[BLOCKI*(k+ 4 ) + i+14*nv]);
			...
			c12_4 = mipp::fmadd(a12_4, b0_4,c12_4);
			c13_4 = mipp::fmadd(a13_4, b0_4,c13_4);
			c14_4 = mipp::fmadd(a14_4, b0_4,c14_4);
			...
			c12_4.store(&C[i+12*nv]);
			c13_4.store(&C[i+13*nv]);
			c14_4.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c12_5, a12_5;
			mipp::Reg<TYPE> c13_5, a13_5;
			mipp::Reg<TYPE> c14_5, a14_5;
			...
			c12_5.load(&C[i+12*nv]);
			c13_5.load(&C[i+13*nv]);
			c14_5.load(&C[i+14*nv]);
			...
			a12_5.load(&A[BLOCKI*(k+ 5 ) + i+12*nv]);
			a13_5.load(&A[BLOCKI*(k+ 5 ) + i+13*nv]);
			a14_5.load(&A[BLOCKI*(k+ 5 ) + i+14*nv]);
			...
			c12_5 = mipp::fmadd(a12_5, b0_5,c12_5);
			c13_5 = mipp::fmadd(a13_5, b0_5,c13_5);
			c14_5 = mipp::fmadd(a14_5, b0_5,c14_5);
			...
			c12_5.store(&C[i+12*nv]);
			c13_5.store(&C[i+13*nv]);
			c14_5.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c12_6, a12_6;
			mipp::Reg<TYPE> c13_6, a13_6;
			mipp::Reg<TYPE> c14_6, a14_6;
			...
			c12_6.load(&C[i+12*nv]);
			c13_6.load(&C[i+13*nv]);
			c14_6.load(&C[i+14*nv]);
			...
			a12_6.load(&A[BLOCKI*(k+ 6 ) + i+12*nv]);
			a13_6.load(&A[BLOCKI*(k+ 6 ) + i+13*nv]);
			a14_6.load(&A[BLOCKI*(k+ 6 ) + i+14*nv]);
			...
			c12_6 = mipp::fmadd(a12_6, b0_6,c12_6);
			c13_6 = mipp::fmadd(a13_6, b0_6,c13_6);
			c14_6 = mipp::fmadd(a14_6, b0_6,c14_6);
			...
			c12_6.store(&C[i+12*nv]);
			c13_6.store(&C[i+13*nv]);
			c14_6.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c12_7, a12_7;
			mipp::Reg<TYPE> c13_7, a13_7;
			mipp::Reg<TYPE> c14_7, a14_7;
			...
			c12_7.load(&C[i+12*nv]);
			c13_7.load(&C[i+13*nv]);
			c14_7.load(&C[i+14*nv]);
			...
			a12_7.load(&A[BLOCKI*(k+ 7 ) + i+12*nv]);
			a13_7.load(&A[BLOCKI*(k+ 7 ) + i+13*nv]);
			a14_7.load(&A[BLOCKI*(k+ 7 ) + i+14*nv]);
			...
			c12_7 = mipp::fmadd(a12_7, b0_7,c12_7);
			c13_7 = mipp::fmadd(a13_7, b0_7,c13_7);
			c14_7 = mipp::fmadd(a14_7, b0_7,c14_7);
			...
			c12_7.store(&C[i+12*nv]);
			c13_7.store(&C[i+13*nv]);
			c14_7.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c12_8, a12_8;
			mipp::Reg<TYPE> c13_8, a13_8;
			mipp::Reg<TYPE> c14_8, a14_8;
			...
			c12_8.load(&C[i+12*nv]);
			c13_8.load(&C[i+13*nv]);
			c14_8.load(&C[i+14*nv]);
			...
			a12_8.load(&A[BLOCKI*(k+ 8 ) + i+12*nv]);
			a13_8.load(&A[BLOCKI*(k+ 8 ) + i+13*nv]);
			a14_8.load(&A[BLOCKI*(k+ 8 ) + i+14*nv]);
			...
			c12_8 = mipp::fmadd(a12_8, b0_8,c12_8);
			c13_8 = mipp::fmadd(a13_8, b0_8,c13_8);
			c14_8 = mipp::fmadd(a14_8, b0_8,c14_8);
			...
			c12_8.store(&C[i+12*nv]);
			c13_8.store(&C[i+13*nv]);
			c14_8.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c10_9, a10_9;
			mipp::Reg<TYPE> c11_9, a11_9;
			mipp::Reg<TYPE> c12_9, a12_9;
			mipp::Reg<TYPE> c13_9, a13_9;
			mipp::Reg<TYPE> c14_9, a14_9;
			...
			c8_9.load(&C[i+8*nv]);
			c9_9.load(&C[i+9*nv]);
			c10_9.load(&C[i+10*nv]);
			c11_9.load(&C[i+11*nv]);
			c12_9.load(&C[i+12*nv]);
			c13_9.load(&C[i+13*nv]);
			c14_9.load(&C[i+14*nv]);
			...
			a10_9.load(&A[BLOCKI*(k+ 9 ) + i+10*nv]);
			a11_9.load(&A[BLOCKI*(k+ 9 ) + i+11*nv]);
			a12_9.load(&A[BLOCKI*(k+ 9 ) + i+12*nv]);
			a13_9.load(&A[BLOCKI*(k+ 9 ) + i+13*nv]);
			a14_9.load(&A[BLOCKI*(k+ 9 ) + i+14*nv]);
			...
			c10_9 = mipp::fmadd(a10_9, b0_9,c10_9);
			c11_9 = mipp::fmadd(a11_9, b0_9,c11_9);
			c12_9 = mipp::fmadd(a12_9, b0_9,c12_9);
			c13_9 = mipp::fmadd(a13_9, b0_9,c13_9);
			c14_9 = mipp::fmadd(a14_9, b0_9,c14_9);
			...
			c8_9.store(&C[i+8*nv]);
			c9_9.store(&C[i+9*nv]);
			c10_9.store(&C[i+10*nv]);
			c11_9.store(&C[i+11*nv]);
			c12_9.store(&C[i+12*nv]);
			c13_9.store(&C[i+13*nv]);
			c14_9.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c10_10, a10_10;
			mipp::Reg<TYPE> c11_10, a11_10;
			mipp::Reg<TYPE> c12_10, a12_10;
			mipp::Reg<TYPE> c13_10, a13_10;
			mipp::Reg<TYPE> c14_10, a14_10;
			...
			c8_10.load(&C[i+8*nv]);
			c9_10.load(&C[i+9*nv]);
			c10_10.load(&C[i+10*nv]);
			c11_10.load(&C[i+11*nv]);
			c12_10.load(&C[i+12*nv]);
			c13_10.load(&C[i+13*nv]);
			c14_10.load(&C[i+14*nv]);
			...
			a10_10.load(&A[BLOCKI*(k+ 10 ) + i+10*nv]);
			a11_10.load(&A[BLOCKI*(k+ 10 ) + i+11*nv]);
			a12_10.load(&A[BLOCKI*(k+ 10 ) + i+12*nv]);
			a13_10.load(&A[BLOCKI*(k+ 10 ) + i+13*nv]);
			a14_10.load(&A[BLOCKI*(k+ 10 ) + i+14*nv]);
			...
			c10_10 = mipp::fmadd(a10_10, b0_10,c10_10);
			c11_10 = mipp::fmadd(a11_10, b0_10,c11_10);
			c12_10 = mipp::fmadd(a12_10, b0_10,c12_10);
			c13_10 = mipp::fmadd(a13_10, b0_10,c13_10);
			c14_10 = mipp::fmadd(a14_10, b0_10,c14_10);
			...
			c10_10.store(&C[i+10*nv]);
			c11_10.store(&C[i+11*nv]);
			c12_10.store(&C[i+12*nv]);
			c13_10.store(&C[i+13*nv]);
			c14_10.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c10_11, a10_11;
			mipp::Reg<TYPE> c11_11, a11_11;
			mipp::Reg<TYPE> c12_11, a12_11;
			mipp::Reg<TYPE> c13_11, a13_11;
			mipp::Reg<TYPE> c14_11, a14_11;
			...
			c8_11.load(&C[i+8*nv]);
			c9_11.load(&C[i+9*nv]);
			c10_11.load(&C[i+10*nv]);
			c11_11.load(&C[i+11*nv]);
			c12_11.load(&C[i+12*nv]);
			c13_11.load(&C[i+13*nv]);
			c14_11.load(&C[i+14*nv]);
			...
			a10_11.load(&A[BLOCKI*(k+ 11 ) + i+10*nv]);
			a11_11.load(&A[BLOCKI*(k+ 11 ) + i+11*nv]);
			a12_11.load(&A[BLOCKI*(k+ 11 ) + i+12*nv]);
			a13_11.load(&A[BLOCKI*(k+ 11 ) + i+13*nv]);
			a14_11.load(&A[BLOCKI*(k+ 11 ) + i+14*nv]);
			...
			c10_11 = mipp::fmadd(a10_11, b0_11,c10_11);
			c11_11 = mipp::fmadd(a11_11, b0_11,c11_11);
			c12_11 = mipp::fmadd(a12_11, b0_11,c12_11);
			c13_11 = mipp::fmadd(a13_11, b0_11,c13_11);
			c14_11 = mipp::fmadd(a14_11, b0_11,c14_11);
			...
			c10_11.store(&C[i+10*nv]);
			c11_11.store(&C[i+11*nv]);
			c12_11.store(&C[i+12*nv]);
			c13_11.store(&C[i+13*nv]);
			c14_11.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c7_12, a7_12;
			mipp::Reg<TYPE> c8_12, a8_12;
			mipp::Reg<TYPE> c9_12, a9_12;
			mipp::Reg<TYPE> c10_12, a10_12;
			mipp::Reg<TYPE> c11_12, a11_12;
			mipp::Reg<TYPE> c12_12, a12_12;
			mipp::Reg<TYPE> c13_12, a13_12;
			mipp::Reg<TYPE> c14_12, a14_12;
			...
			c8_12.load(&C[i+8*nv]);
			c9_12.load(&C[i+9*nv]);
			c10_12.load(&C[i+10*nv]);
			c11_12.load(&C[i+11*nv]);
			c12_12.load(&C[i+12*nv]);
			c13_12.load(&C[i+13*nv]);
			c14_12.load(&C[i+14*nv]);
			...
			a7_12.load(&A[BLOCKI*(k+ 12 ) + i+7*nv]);
			a8_12.load(&A[BLOCKI*(k+ 12 ) + i+8*nv]);
			a9_12.load(&A[BLOCKI*(k+ 12 ) + i+9*nv]);
			a10_12.load(&A[BLOCKI*(k+ 12 ) + i+10*nv]);
			a11_12.load(&A[BLOCKI*(k+ 12 ) + i+11*nv]);
			a12_12.load(&A[BLOCKI*(k+ 12 ) + i+12*nv]);
			a13_12.load(&A[BLOCKI*(k+ 12 ) + i+13*nv]);
			a14_12.load(&A[BLOCKI*(k+ 12 ) + i+14*nv]);
			...
			c7_12 = mipp::fmadd(a7_12, b0_12,c7_12);
			c8_12 = mipp::fmadd(a8_12, b0_12,c8_12);
			c9_12 = mipp::fmadd(a9_12, b0_12,c9_12);
			c10_12 = mipp::fmadd(a10_12, b0_12,c10_12);
			c11_12 = mipp::fmadd(a11_12, b0_12,c11_12);
			c12_12 = mipp::fmadd(a12_12, b0_12,c12_12);
			c13_12 = mipp::fmadd(a13_12, b0_12,c13_12);
			c14_12 = mipp::fmadd(a14_12, b0_12,c14_12);
			...
			c7_12.store(&C[i+7*nv]);
			c8_12.store(&C[i+8*nv]);
			c9_12.store(&C[i+9*nv]);
			c10_12.store(&C[i+10*nv]);
			c11_12.store(&C[i+11*nv]);
			c12_12.store(&C[i+12*nv]);
			c13_12.store(&C[i+13*nv]);
			c14_12.store(&C[i+14*nv]);
		...
		{         
			...
			mipp::Reg<TYPE> c7_13, a7_13;
			mipp::Reg<TYPE> c8_13, a8_13;
			mipp::Reg<TYPE> c9_13, a9_13;
			mipp::Reg<TYPE> c10_13, a10_13;
			mipp::Reg<TYPE> c11_13, a11_13;
			mipp::Reg<TYPE> c12_13, a12_13;
			mipp::Reg<TYPE> c13_13, a13_13;
			mipp::Reg<TYPE> c14_13, a14_13;
			...
			c8_13.load(&C[i+8*nv]);
			c9_13.load(&C[i+9*nv]);
			c10_13.load(&C[i+10*nv]);
			c11_13.load(&C[i+11*nv]);
			c12_13.load(&C[i+12*nv]);
			c13_13.load(&C[i+13*nv]);
			c14_13.load(&C[i+14*nv]);
			...
			a7_13.load(&A[BLOCKI*(k+ 13 ) + i+7*nv]);
			a8_13.load(&A[BLOCKI*(k+ 13 ) + i+8*nv]);
			a9_13.load(&A[BLOCKI*(k+ 13 ) + i+9*nv]);
			a10_13.load(&A[BLOCKI*(k+ 13 ) + i+10*nv]);
			a11_13.load(&A[BLOCKI*(k+ 13 ) + i+11*nv]);
			a12_13.load(&A[BLOCKI*(k+ 13 ) + i+12*nv]);
			a13_13.load(&A[BLOCKI*(k+ 13 ) + i+13*nv]);
			a14_13.load(&A[BLOCKI*(k+ 13 ) + i+14*nv]);
			...
			c7_13 = mipp::fmadd(a7_13, b0_13,c7_13);
			c8_13 = mipp::fmadd(a8_13, b0_13,c8_13);
			c9_13 = mipp::fmadd(a9_13, b0_13,c9_13);
			c10_13 = mipp::fmadd(a10_13, b0_13,c10_13);
			c11_13 = mipp::fmadd(a11_13, b0_13,c11_13);
			c12_13 = mipp::fmadd(a12_13, b0_13,c12_13);
			c13_13 = mipp::fmadd(a13_13, b0_13,c13_13);
			c14_13 = mipp::fmadd(a14_13, b0_13,c14_13);
			...
			c7_13.store(&C[i+7*nv]);
			c8_13.store(&C[i+8*nv]);
			c9_13.store(&C[i+9*nv]);
			c10_13.store(&C[i+10*nv]);
			c11_13.store(&C[i+11*nv]);
			c12_13.store(&C[i+12*nv]);
			c13_13.store(&C[i+13*nv]);
			c14_13.store(&C[i+14*nv]);
			
		}for (int i=0;i<BLOCKI;i+=(15)*nv) 
		{         
			mipp::Reg<TYPE> c0_14, a0_14;
			mipp::Reg<TYPE> c1_14, a1_14;
			mipp::Reg<TYPE> c2_14, a2_14;
			mipp::Reg<TYPE> c3_14, a3_14;
			mipp::Reg<TYPE> c4_14, a4_14;
			mipp::Reg<TYPE> c5_14, a5_14;
			mipp::Reg<TYPE> c6_14, a6_14;
			mipp::Reg<TYPE> c7_14, a7_14;
			mipp::Reg<TYPE> c8_14, a8_14;
			mipp::Reg<TYPE> c9_14, a9_14;
			mipp::Reg<TYPE> c10_14, a10_14;
			mipp::Reg<TYPE> c11_14, a11_14;
			mipp::Reg<TYPE> c12_14, a12_14;
			mipp::Reg<TYPE> c13_14, a13_14;
			mipp::Reg<TYPE> c14_14, a14_14;
			...
			c8_14.load(&C[i+8*nv]);
			c9_14.load(&C[i+9*nv]);
			c10_14.load(&C[i+10*nv]);
			c11_14.load(&C[i+11*nv]);
			c12_14.load(&C[i+12*nv]);
			c13_14.load(&C[i+13*nv]);
			c14_14.load(&C[i+14*nv]);
			

			a0_14.load(&A[BLOCKI*(k+ 14 ) + i+0*nv]);
			a1_14.load(&A[BLOCKI*(k+ 14 ) + i+1*nv]);
			a2_14.load(&A[BLOCKI*(k+ 14 ) + i+2*nv]);
			a3_14.load(&A[BLOCKI*(k+ 14 ) + i+3*nv]);
			a4_14.load(&A[BLOCKI*(k+ 14 ) + i+4*nv]);
			a5_14.load(&A[BLOCKI*(k+ 14 ) + i+5*nv]);
			a6_14.load(&A[BLOCKI*(k+ 14 ) + i+6*nv]);
			a7_14.load(&A[BLOCKI*(k+ 14 ) + i+7*nv]);
			a8_14.load(&A[BLOCKI*(k+ 14 ) + i+8*nv]);
			a9_14.load(&A[BLOCKI*(k+ 14 ) + i+9*nv]);
			a10_14.load(&A[BLOCKI*(k+ 14 ) + i+10*nv]);
			a11_14.load(&A[BLOCKI*(k+ 14 ) + i+11*nv]);
			a12_14.load(&A[BLOCKI*(k+ 14 ) + i+12*nv]);
			a13_14.load(&A[BLOCKI*(k+ 14 ) + i+13*nv]);
			a14_14.load(&A[BLOCKI*(k+ 14 ) + i+14*nv]);
			

			c0_14 = mipp::fmadd(a0_14, b0_14,c0_14);
			c1_14 = mipp::fmadd(a1_14, b0_14,c1_14);
			c2_14 = mipp::fmadd(a2_14, b0_14,c2_14);
			c3_14 = mipp::fmadd(a3_14, b0_14,c3_14);
			c4_14 = mipp::fmadd(a4_14, b0_14,c4_14);
			c5_14 = mipp::fmadd(a5_14, b0_14,c5_14);
			c6_14 = mipp::fmadd(a6_14, b0_14,c6_14);
			c7_14 = mipp::fmadd(a7_14, b0_14,c7_14);
			c8_14 = mipp::fmadd(a8_14, b0_14,c8_14);
			c9_14 = mipp::fmadd(a9_14, b0_14,c9_14);
			c10_14 = mipp::fmadd(a10_14, b0_14,c10_14);
			c11_14 = mipp::fmadd(a11_14, b0_14,c11_14);
			c12_14 = mipp::fmadd(a12_14, b0_14,c12_14);
			c13_14 = mipp::fmadd(a13_14, b0_14,c13_14);
			c14_14 = mipp::fmadd(a14_14, b0_14,c14_14);
			

			c0_14.store(&C[i+0*nv]);
			c1_14.store(&C[i+1*nv]);
			c2_14.store(&C[i+2*nv]);
			c3_14.store(&C[i+3*nv]);
			c4_14.store(&C[i+4*nv]);
			c5_14.store(&C[i+5*nv]);
			c6_14.store(&C[i+6*nv]);
			c7_14.store(&C[i+7*nv]);
			c8_14.store(&C[i+8*nv]);
			c9_14.store(&C[i+9*nv]);
			c10_14.store(&C[i+10*nv]);
			c11_14.store(&C[i+11*nv]);
			c12_14.store(&C[i+12*nv]);
			c13_14.store(&C[i+13*nv]);
			c14_14.store(&C[i+14*nv]);

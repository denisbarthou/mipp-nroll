...
0000000000000230 <.omp_outlined.>:
 ...
 323:	48 8d ac be 00 01 00 	lea    0x100(%rsi,%rdi,4),%rbp
 32a:	00 
 ...
 340:	48 8d bc be 00 01 00 	lea    0x100(%rsi,%rdi,4),%rdi
 347:	00 
 348:	48 8d b4 9e 00 01 00 	lea    0x100(%rsi,%rbx,4),%rsi
 34f:	00 
 ...
 40b:	00 00 00 00 00 
 410:	c5 7c 10 04 9a       	vmovups (%rdx,%rbx,4),%ymm8
 415:	c4 e2 3d b8 94 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm8,%ymm2
 41c:	ff ff ff 
 41f:	c4 e2 3d b8 8c 9f 00 	vfmadd231ps -0x100(%rdi,%rbx,4),%ymm8,%ymm1
 426:	ff ff ff 
 429:	c4 e2 3d b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm8,%ymm0
 430:	ff ff ff 
 433:	c5 7c 10 4c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm9
 439:	c5 7c 10 54 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm10
 43f:	c5 7c 10 5c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm11
 445:	c5 fc 10 bc 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm7
 44c:	00 00 
 44e:	c5 fc 10 b4 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm6
 455:	00 00 
 457:	c5 fc 10 ac 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm5
 45e:	00 00 
 460:	c5 fc 10 a4 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm4
 467:	00 00 
 469:	c5 fc 10 9c 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm3
 470:	00 00 
 472:	c4 e2 35 b8 94 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm9,%ymm2
 479:	ff ff ff 
 47c:	c4 e2 35 b8 8c 9f 20 	vfmadd231ps -0xe0(%rdi,%rbx,4),%ymm9,%ymm1
 483:	ff ff ff 
 486:	c4 e2 35 b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm9,%ymm0
 48d:	ff ff ff 
 490:	c4 e2 2d b8 94 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm10,%ymm2
 497:	ff ff ff 
 49a:	c4 e2 2d b8 8c 9f 40 	vfmadd231ps -0xc0(%rdi,%rbx,4),%ymm10,%ymm1
 4a1:	ff ff ff 
 4a4:	c4 e2 2d b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm10,%ymm0
 4ab:	ff ff ff 
 4ae:	c4 e2 25 b8 94 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm11,%ymm2
 4b5:	ff ff ff 
 4b8:	c4 e2 25 b8 8c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm11,%ymm1
 4bf:	ff ff ff 
 4c2:	c4 e2 25 b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm11,%ymm0
 4c9:	ff ff ff 
 4cc:	c4 e2 45 b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm7,%ymm2
 4d3:	c4 e2 45 b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm7,%ymm1
 4da:	c4 e2 45 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm7,%ymm0
 4e1:	c4 e2 4d b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm6,%ymm2
 4e8:	c4 e2 4d b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm6,%ymm1
 4ef:	c4 e2 4d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm6,%ymm0
 4f6:	c4 e2 55 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm5,%ymm2
 4fd:	c4 e2 55 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm5,%ymm1
 504:	c4 e2 55 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm5,%ymm0
 50b:	c4 e2 5d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm4,%ymm2
 512:	c4 e2 5d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm4,%ymm1
 519:	c4 e2 5d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm4,%ymm0
 520:	c4 e2 65 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm3,%ymm2
 527:	c4 e2 65 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm1
 52d:	c4 e2 65 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm0
 533:	48 83 c3 48          	add    $0x48,%rbx
 537:	48 39 cb             	cmp    %rcx,%rbx
 53a:	0f 8c d0 fe ff ff    	jl     410 <.omp_outlined.+0x1e0>
 540:	e9 27 fe ff ff       	jmpq   36c <.omp_outlined.+0x13c>
 545:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 54c:	00 00 00 00 

0000000000000550 <_Z6enablev>:
 550:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 557 <_Z6enablev+0x7>
 557:	7d 03                	jge    55c <_Z6enablev+0xc>
 559:	31 c0                	xor    %eax,%eax
 55b:	c3                   	retq   
 55c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 563 <_Z6enablev+0x13>
 563:	b8 48 00 00 00       	mov    $0x48,%eax
 568:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx

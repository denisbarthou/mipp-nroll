...
0000000000000220 <.omp_outlined.>:
 ...
 34d:	48 8d ac 30 c0 00 00 	lea    0xc0(%rax,%rsi,1),%rbp
 354:	00 
 355:	48 81 c6 c0 00 00 00 	add    $0xc0,%rsi
 ...
 64b:	c4 22 0d b8 ac 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm14,%ymm13
 652:	ff ff ff 
 655:	c4 02 0d b8 a4 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm14,%ymm12
 65c:	ff ff ff 
 65f:	4b 8d 84 17 40 ff ff 	lea    -0xc0(%r15,%r10,1),%rax
 666:	ff 
 667:	c4 42 0d b8 9c ca 40 	vfmadd231ps -0xc0(%r10,%rcx,8),%ymm14,%ymm11
 66e:	ff ff ff 
 ...
 6e1:	c4 22 0d b8 ac 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm14,%ymm13
 6e8:	ff ff ff 
 6eb:	c4 02 0d b8 a4 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm14,%ymm12
 6f2:	ff ff ff 
 ...
 76f:	c4 22 0d b8 6c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm14,%ymm13
 776:	c4 02 0d b8 64 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm14,%ymm12
 77d:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 783:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 787:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 78d:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 793:	48 01 f8             	add    %rdi,%rax
 796:	48 01 f8             	add    %rdi,%rax
 799:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 79f:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 7a5:	48 01 f8             	add    %rdi,%rax
 7a8:	48 01 f8             	add    %rdi,%rax
 7ab:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 7b1:	48 01 f8             	add    %rdi,%rax
 7b4:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 7ba:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7be:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 7c4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7c8:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 7ce:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7d2:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 7d8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7dc:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 7e2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7e6:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 7ec:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7f0:	c4 21 7c 10 74 8a 60 	vmovups 0x60(%rdx,%r9,4),%ymm14
 7f7:	c4 22 0d b8 6c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm14,%ymm13
 7fe:	c4 02 0d b8 64 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm14,%ymm12
 805:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 80b:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 80f:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 815:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 81b:	48 01 f8             	add    %rdi,%rax
 81e:	48 01 f8             	add    %rdi,%rax
 821:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 827:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 82d:	48 01 f8             	add    %rdi,%rax
 830:	48 01 f8             	add    %rdi,%rax
 833:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 839:	48 01 f8             	add    %rdi,%rax
 83c:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 842:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 846:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 84c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 850:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 856:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 85a:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 860:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 864:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 86a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 86e:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 874:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 878:	c4 21 7c 10 b4 8a 80 	vmovups 0x80(%rdx,%r9,4),%ymm14
 87f:	00 00 00 
 882:	c4 22 0d b8 6c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm14,%ymm13
 889:	c4 02 0d b8 64 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm14,%ymm12
 890:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 896:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 89a:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 8a0:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 8a6:	48 01 f8             	add    %rdi,%rax
 8a9:	48 01 f8             	add    %rdi,%rax
 8ac:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 8b2:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 8b8:	48 01 f8             	add    %rdi,%rax
 8bb:	48 01 f8             	add    %rdi,%rax
 8be:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 8c4:	48 01 f8             	add    %rdi,%rax
 8c7:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 8cd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8d1:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 8d7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8db:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 8e1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8e5:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 8eb:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8ef:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 8f5:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8f9:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 8ff:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 903:	c4 21 7c 10 b4 8a a0 	vmovups 0xa0(%rdx,%r9,4),%ymm14
 90a:	00 00 00 
 90d:	c4 22 0d b8 6c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm14,%ymm13
 914:	c4 02 0d b8 64 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm14,%ymm12
 91b:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 921:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 925:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 92b:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 931:	48 01 f8             	add    %rdi,%rax
 934:	48 01 f8             	add    %rdi,%rax
 937:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 93d:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 943:	48 01 f8             	add    %rdi,%rax
 946:	48 01 f8             	add    %rdi,%rax
 949:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 94f:	48 01 f8             	add    %rdi,%rax
 952:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 958:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 95c:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 962:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 966:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 96c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 970:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 976:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 97a:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 980:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 984:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 98a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 98e:	c4 21 7c 10 b4 8a c0 	vmovups 0xc0(%rdx,%r9,4),%ymm14
 995:	00 00 00 
 998:	c4 22 0d b8 6c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm14,%ymm13
 99f:	c4 02 0d b8 24 88    	vfmadd231ps (%r8,%r9,4),%ymm14,%ymm12
 9a5:	49 83 c1 38          	add    $0x38,%r9
 9a9:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 9af:	48 01 d8             	add    %rbx,%rax
 9b2:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 9b8:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 9be:	48 01 f8             	add    %rdi,%rax
 9c1:	48 01 f8             	add    %rdi,%rax
 9c4:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 9ca:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 9d0:	48 01 f8             	add    %rdi,%rax
 9d3:	48 01 f8             	add    %rdi,%rax
 9d6:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 9dc:	48 01 f8             	add    %rdi,%rax
 9df:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 9e5:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9e9:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 9ef:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9f3:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 9f9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9fd:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 a03:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a07:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 a0d:	48 01 f8             	add    %rdi,%rax
 a10:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 a16:	49 39 c9             	cmp    %rcx,%r9
 a19:	0f 8c 21 fc ff ff    	jl     640 <.omp_outlined.+0x420>
 a1f:	e9 9b f9 ff ff       	jmpq   3bf <.omp_outlined.+0x19f>
 a24:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
 a2b:	00 00 00 00 00 

0000000000000a30 <_Z6enablev>:
 a30:	31 c0                	xor    %eax,%eax
 a32:	c3                   	retq   
 a33:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 a3a:	84 00 00 00 00 00 

0000000000000a40 <_Z9n_reg_maxv>:
 a40:	b8 62 00 00 00       	mov    $0x62,%eax
 a45:	c3                   	retq   

...
vecmat_ui1_uk5.o:     file format elf64-x86-64
...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d ac 86 80 00 00 	lea    0x80(%rsi,%rax,4),%rbp
 2fa:	00 
 ...
 340:	c5 fc 10 44 b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm0
 346:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34c:	c5 fc 10 54 b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm2
 352:	c5 fc 10 5c b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm3
 358:	c5 fc 10 64 b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm4
 35e:	c5 fc 10 6c b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm5
 364:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 36b:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 372:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 379:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 380:	00 00 00 
 383:	48 83 c6 28          	add    $0x28,%rsi
 387:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 38b:	48 39 ce             	cmp    %rcx,%rsi
 38e:	7c b0                	jl     340 <.omp_outlined.+0x120>
 390:	e9 6f ff ff ff       	jmpq   304 <.omp_outlined.+0xe4>
 395:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 39c:	00 00 00 00 

00000000000003a0 <_Z6enablev>:
 3a0:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 3a7 <_Z6enablev+0x7>
 3a7:	7e 1e                	jle    3c7 <_Z6enablev+0x27>
 3a9:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3b0 <_Z6enablev+0x10>
 3b0:	b8 28 00 00 00       	mov    $0x28,%eax
 3b5:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx
 3ba:	0f 45 c8             	cmovne %eax,%ecx
 3bd:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3c3 <_Z6enablev+0x23>
 3c3:	0f 9e c0             	setle  %al
 3c6:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui1_uk5.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000220 <.omp_outlined.>:
 ...
 300:	49 8d 88 00 01 00 00 	lea    0x100(%r8),%rcx
 ...
 33f:	49 8d bc c0 00 01 00 	lea    0x100(%r8,%rax,8),%rdi
 346:	00 
 ...
 369:	49 8d 9c a8 00 01 00 	lea    0x100(%r8,%rbp,4),%rbx
 370:	00 
 371:	48 8d 6c 40 04       	lea    0x4(%rax,%rax,2),%rbp
 376:	48 8d 44 40 05       	lea    0x5(%rax,%rax,2),%rax
 37b:	49 8d b4 b0 00 01 00 	lea    0x100(%r8,%rsi,4),%rsi
 382:	00 
 383:	49 0f af ea          	imul   %r10,%rbp
 387:	49 0f af c2          	imul   %r10,%rax
 38b:	49 8d ac a8 00 01 00 	lea    0x100(%r8,%rbp,4),%rbp
 392:	00 
 393:	49 8d 84 80 00 01 00 	lea    0x100(%r8,%rax,4),%rax
 39a:	00 
 ...
 4fb:	00 00 00 00 00 
 500:	c4 01 7c 10 2c 8e    	vmovups (%r14,%r9,4),%ymm13
 506:	c4 a2 15 b8 ac 8f 00 	vfmadd231ps -0x100(%rdi,%r9,4),%ymm13,%ymm5
 50d:	ff ff ff 
 510:	c4 82 15 b8 a4 88 00 	vfmadd231ps -0x100(%r8,%r9,4),%ymm13,%ymm4
 517:	ff ff ff 
 51a:	c4 a2 15 b8 9c 8e 00 	vfmadd231ps -0x100(%rsi,%r9,4),%ymm13,%ymm3
 521:	ff ff ff 
 524:	c4 a2 15 b8 84 8b 00 	vfmadd231ps -0x100(%rbx,%r9,4),%ymm13,%ymm0
 52b:	ff ff ff 
 52e:	c4 a2 15 b8 94 8d 00 	vfmadd231ps -0x100(%rbp,%r9,4),%ymm13,%ymm2
 535:	ff ff ff 
 538:	c4 a2 15 b8 8c 88 00 	vfmadd231ps -0x100(%rax,%r9,4),%ymm13,%ymm1
 53f:	ff ff ff 
 542:	c4 01 7c 10 74 8e 20 	vmovups 0x20(%r14,%r9,4),%ymm14
 549:	c4 01 7c 10 64 8e 40 	vmovups 0x40(%r14,%r9,4),%ymm12
 550:	c4 01 7c 10 5c 8e 60 	vmovups 0x60(%r14,%r9,4),%ymm11
 557:	c4 01 7c 10 94 8e 80 	vmovups 0x80(%r14,%r9,4),%ymm10
 55e:	00 00 00 
 561:	c4 01 7c 10 8c 8e a0 	vmovups 0xa0(%r14,%r9,4),%ymm9
 568:	00 00 00 
 56b:	c4 01 7c 10 84 8e c0 	vmovups 0xc0(%r14,%r9,4),%ymm8
 572:	00 00 00 
 575:	c4 81 7c 10 bc 8e e0 	vmovups 0xe0(%r14,%r9,4),%ymm7
 57c:	00 00 00 
 57f:	c4 81 7c 10 b4 8e 00 	vmovups 0x100(%r14,%r9,4),%ymm6
 586:	01 00 00 
 589:	c4 a2 0d b8 ac 8f 20 	vfmadd231ps -0xe0(%rdi,%r9,4),%ymm14,%ymm5
 590:	ff ff ff 
 593:	c4 82 0d b8 a4 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm14,%ymm4
 59a:	ff ff ff 
 59d:	c4 a2 0d b8 9c 8e 20 	vfmadd231ps -0xe0(%rsi,%r9,4),%ymm14,%ymm3
 5a4:	ff ff ff 
 5a7:	c4 a2 0d b8 84 8b 20 	vfmadd231ps -0xe0(%rbx,%r9,4),%ymm14,%ymm0
 5ae:	ff ff ff 
 5b1:	c4 a2 0d b8 94 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm14,%ymm2
 5b8:	ff ff ff 
 5bb:	c4 a2 0d b8 8c 88 20 	vfmadd231ps -0xe0(%rax,%r9,4),%ymm14,%ymm1
 5c2:	ff ff ff 
 5c5:	c4 a2 1d b8 ac 8f 40 	vfmadd231ps -0xc0(%rdi,%r9,4),%ymm12,%ymm5
 5cc:	ff ff ff 
 5cf:	c4 82 1d b8 a4 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm12,%ymm4
 5d6:	ff ff ff 
 5d9:	c4 a2 1d b8 9c 8e 40 	vfmadd231ps -0xc0(%rsi,%r9,4),%ymm12,%ymm3
 5e0:	ff ff ff 
 5e3:	c4 a2 1d b8 84 8b 40 	vfmadd231ps -0xc0(%rbx,%r9,4),%ymm12,%ymm0
 5ea:	ff ff ff 
 5ed:	c4 a2 1d b8 94 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm12,%ymm2
 5f4:	ff ff ff 
 5f7:	c4 a2 1d b8 8c 88 40 	vfmadd231ps -0xc0(%rax,%r9,4),%ymm12,%ymm1
 5fe:	ff ff ff 
 601:	c4 a2 25 b8 ac 8f 60 	vfmadd231ps -0xa0(%rdi,%r9,4),%ymm11,%ymm5
 608:	ff ff ff 
 60b:	c4 82 25 b8 a4 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm11,%ymm4
 612:	ff ff ff 
 615:	c4 a2 25 b8 9c 8e 60 	vfmadd231ps -0xa0(%rsi,%r9,4),%ymm11,%ymm3
 61c:	ff ff ff 
 61f:	c4 a2 25 b8 84 8b 60 	vfmadd231ps -0xa0(%rbx,%r9,4),%ymm11,%ymm0
 626:	ff ff ff 
 629:	c4 a2 25 b8 94 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm11,%ymm2
 630:	ff ff ff 
 633:	c4 a2 25 b8 8c 88 60 	vfmadd231ps -0xa0(%rax,%r9,4),%ymm11,%ymm1
 63a:	ff ff ff 
 63d:	c4 a2 2d b8 6c 8f 80 	vfmadd231ps -0x80(%rdi,%r9,4),%ymm10,%ymm5
 644:	c4 82 2d b8 64 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm10,%ymm4
 64b:	c4 a2 2d b8 5c 8e 80 	vfmadd231ps -0x80(%rsi,%r9,4),%ymm10,%ymm3
 652:	c4 a2 2d b8 44 8b 80 	vfmadd231ps -0x80(%rbx,%r9,4),%ymm10,%ymm0
 659:	c4 a2 2d b8 54 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm10,%ymm2
 660:	c4 a2 2d b8 4c 88 80 	vfmadd231ps -0x80(%rax,%r9,4),%ymm10,%ymm1
 667:	c4 a2 35 b8 6c 8f a0 	vfmadd231ps -0x60(%rdi,%r9,4),%ymm9,%ymm5
 66e:	c4 82 35 b8 64 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm9,%ymm4
 675:	c4 a2 35 b8 5c 8e a0 	vfmadd231ps -0x60(%rsi,%r9,4),%ymm9,%ymm3
 67c:	c4 a2 35 b8 44 8b a0 	vfmadd231ps -0x60(%rbx,%r9,4),%ymm9,%ymm0
 683:	c4 a2 35 b8 54 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm9,%ymm2
 68a:	c4 a2 35 b8 4c 88 a0 	vfmadd231ps -0x60(%rax,%r9,4),%ymm9,%ymm1
 691:	c4 a2 3d b8 6c 8f c0 	vfmadd231ps -0x40(%rdi,%r9,4),%ymm8,%ymm5
 698:	c4 82 3d b8 64 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm8,%ymm4
 69f:	c4 a2 3d b8 5c 8e c0 	vfmadd231ps -0x40(%rsi,%r9,4),%ymm8,%ymm3
 6a6:	c4 a2 3d b8 44 8b c0 	vfmadd231ps -0x40(%rbx,%r9,4),%ymm8,%ymm0
 6ad:	c4 a2 3d b8 54 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm8,%ymm2
 6b4:	c4 a2 3d b8 4c 88 c0 	vfmadd231ps -0x40(%rax,%r9,4),%ymm8,%ymm1
 6bb:	c4 a2 45 b8 6c 8f e0 	vfmadd231ps -0x20(%rdi,%r9,4),%ymm7,%ymm5
 6c2:	c4 82 45 b8 64 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm7,%ymm4
 6c9:	c4 a2 45 b8 5c 8e e0 	vfmadd231ps -0x20(%rsi,%r9,4),%ymm7,%ymm3
 6d0:	c4 a2 45 b8 44 8b e0 	vfmadd231ps -0x20(%rbx,%r9,4),%ymm7,%ymm0
 6d7:	c4 a2 45 b8 54 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm7,%ymm2
 6de:	c4 a2 45 b8 4c 88 e0 	vfmadd231ps -0x20(%rax,%r9,4),%ymm7,%ymm1
 6e5:	c4 a2 4d b8 2c 8f    	vfmadd231ps (%rdi,%r9,4),%ymm6,%ymm5
 6eb:	c4 82 4d b8 24 88    	vfmadd231ps (%r8,%r9,4),%ymm6,%ymm4
 6f1:	c4 a2 4d b8 1c 8e    	vfmadd231ps (%rsi,%r9,4),%ymm6,%ymm3
 6f7:	c4 a2 4d b8 04 8b    	vfmadd231ps (%rbx,%r9,4),%ymm6,%ymm0
 6fd:	c4 a2 4d b8 54 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm6,%ymm2
 704:	c4 a2 4d b8 0c 88    	vfmadd231ps (%rax,%r9,4),%ymm6,%ymm1
 70a:	49 83 c1 48          	add    $0x48,%r9
 70e:	4d 39 d1             	cmp    %r10,%r9
 711:	0f 8c e9 fd ff ff    	jl     500 <.omp_outlined.+0x2e0>
 717:	e9 9c fc ff ff       	jmpq   3b8 <.omp_outlined.+0x198>
...
0000000000000730 <_Z9n_reg_maxv>:
 730:	b8 36 00 00 00       	mov    $0x36,%eax
 735:	c3                   	retq   

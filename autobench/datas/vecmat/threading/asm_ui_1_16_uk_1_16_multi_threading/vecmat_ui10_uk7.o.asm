...
0000000000000220 <.omp_outlined.>:
 ...
 34e:	00 
 34f:	48 8d ac f0 c0 00 00 	lea    0xc0(%rax,%rsi,8),%rbp
 356:	00 
 357:	48 05 c0 00 00 00    	add    $0xc0,%rax
 ...
 58b:	c4 22 2d b8 8c 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm10,%ymm9
 592:	ff ff ff 
 595:	c4 02 2d b8 84 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm10,%ymm8
 59c:	ff ff ff 
 59f:	4b 8d 84 17 40 ff ff 	lea    -0xc0(%r15,%r10,1),%rax
 5a6:	ff 
 5a7:	c4 c2 2d b8 bc ca 40 	vfmadd231ps -0xc0(%r10,%rcx,8),%ymm10,%ymm7
 5ae:	ff ff ff 
 ...
 5f9:	c4 22 2d b8 8c 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm10,%ymm9
 600:	ff ff ff 
 603:	c4 02 2d b8 84 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm10,%ymm8
 60a:	ff ff ff 
 ...
 65f:	c4 22 2d b8 4c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm10,%ymm9
 666:	c4 02 2d b8 44 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm10,%ymm8
 66d:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 673:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 677:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 67d:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 683:	48 01 f8             	add    %rdi,%rax
 686:	48 01 f8             	add    %rdi,%rax
 689:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 68f:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 695:	48 01 f8             	add    %rdi,%rax
 698:	48 01 f8             	add    %rdi,%rax
 69b:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 6a1:	48 01 f8             	add    %rdi,%rax
 6a4:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 6aa:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6ae:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 6b4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6b8:	c4 21 7c 10 54 8a 60 	vmovups 0x60(%rdx,%r9,4),%ymm10
 6bf:	c4 22 2d b8 4c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm10,%ymm9
 6c6:	c4 02 2d b8 44 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm10,%ymm8
 6cd:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 6d3:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6d7:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 6dd:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 6e3:	48 01 f8             	add    %rdi,%rax
 6e6:	48 01 f8             	add    %rdi,%rax
 6e9:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 6ef:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 6f5:	48 01 f8             	add    %rdi,%rax
 6f8:	48 01 f8             	add    %rdi,%rax
 6fb:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 701:	48 01 f8             	add    %rdi,%rax
 704:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 70a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 70e:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 714:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 718:	c4 21 7c 10 94 8a 80 	vmovups 0x80(%rdx,%r9,4),%ymm10
 71f:	00 00 00 
 722:	c4 22 2d b8 4c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm10,%ymm9
 729:	c4 02 2d b8 44 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm10,%ymm8
 730:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 736:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 73a:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 740:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 746:	48 01 f8             	add    %rdi,%rax
 749:	48 01 f8             	add    %rdi,%rax
 74c:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 752:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 758:	48 01 f8             	add    %rdi,%rax
 75b:	48 01 f8             	add    %rdi,%rax
 75e:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 764:	48 01 f8             	add    %rdi,%rax
 767:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 76d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 771:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 777:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 77b:	c4 21 7c 10 94 8a a0 	vmovups 0xa0(%rdx,%r9,4),%ymm10
 782:	00 00 00 
 785:	c4 22 2d b8 4c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm10,%ymm9
 78c:	c4 02 2d b8 44 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm10,%ymm8
 793:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 799:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 79d:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 7a3:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 7a9:	48 01 f8             	add    %rdi,%rax
 7ac:	48 01 f8             	add    %rdi,%rax
 7af:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 7b5:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 7bb:	48 01 f8             	add    %rdi,%rax
 7be:	48 01 f8             	add    %rdi,%rax
 7c1:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 7c7:	48 01 f8             	add    %rdi,%rax
 7ca:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 7d0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7d4:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 7da:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7de:	c4 21 7c 10 94 8a c0 	vmovups 0xc0(%rdx,%r9,4),%ymm10
 7e5:	00 00 00 
 7e8:	c4 22 2d b8 4c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm10,%ymm9
 7ef:	c4 02 2d b8 04 88    	vfmadd231ps (%r8,%r9,4),%ymm10,%ymm8
 7f5:	49 83 c1 38          	add    $0x38,%r9
 7f9:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 7ff:	48 01 d8             	add    %rbx,%rax
 802:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 808:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 80e:	48 01 f8             	add    %rdi,%rax
 811:	48 01 f8             	add    %rdi,%rax
 814:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 81a:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 820:	48 01 f8             	add    %rdi,%rax
 823:	48 01 f8             	add    %rdi,%rax
 826:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 82c:	48 01 f8             	add    %rdi,%rax
 82f:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 835:	48 01 f8             	add    %rdi,%rax
 838:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 83e:	49 39 c9             	cmp    %rcx,%r9
 841:	0f 8c 39 fd ff ff    	jl     580 <.omp_outlined.+0x360>
 847:	e9 4f fb ff ff       	jmpq   39b <.omp_outlined.+0x17b>
 84c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000000850 <_Z6enablev>:
 850:	31 c0                	xor    %eax,%eax
 852:	c3                   	retq   
 853:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 85a:	84 00 00 00 00 00 

0000000000000860 <_Z9n_reg_maxv>:
 860:	b8 46 00 00 00       	mov    $0x46,%eax
 865:	c3                   	retq   

...
vecmat_ui5_uk9.o:     file format elf64-x86-64
...
0000000000000220 <.omp_outlined.>:
 ...
 31c:	48 8d ac b0 00 01 00 	lea    0x100(%rax,%rsi,4),%rbp
 323:	00 
 ...
 42a:	c4 e2 55 b8 a4 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm5,%ymm4
 431:	ff ff ff 
 ...
 471:	00 00 
 473:	c4 e2 55 b8 9c 88 00 	vfmadd231ps -0x100(%rax,%rcx,4),%ymm5,%ymm3
 47a:	ff ff ff 
 47d:	c4 e2 55 b8 84 c8 00 	vfmadd231ps -0x100(%rax,%rcx,8),%ymm5,%ymm0
 484:	ff ff ff 
 487:	48 8d 84 03 00 ff ff 	lea    -0x100(%rbx,%rax,1),%rax
 48e:	ff 
 48f:	48 01 d8             	add    %rbx,%rax
 492:	c4 e2 55 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm5,%ymm2
 498:	c4 e2 55 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm5,%ymm1
 49e:	48 01 d8             	add    %rbx,%rax
 4a1:	48 01 d8             	add    %rbx,%rax
 4a4:	c4 e2 4d b8 a4 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm6,%ymm4
 4ab:	ff ff ff 
 4ae:	c4 e2 4d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm3
 4b4:	48 01 f8             	add    %rdi,%rax
 4b7:	c4 e2 4d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm0
 4bd:	c4 e2 4d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm6,%ymm2
 4c3:	48 01 d8             	add    %rbx,%rax
 4c6:	48 01 d8             	add    %rbx,%rax
 4c9:	c4 e2 45 b8 a4 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm7,%ymm4
 4d0:	ff ff ff 
 4d3:	c4 e2 4d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm1
 4d9:	48 01 d8             	add    %rbx,%rax
 4dc:	c4 e2 45 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm3
 4e2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4e6:	c4 e2 45 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm0
 4ec:	c4 e2 45 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm2
 4f2:	48 01 d8             	add    %rbx,%rax
 4f5:	48 01 d8             	add    %rbx,%rax
 4f8:	c4 e2 3d b8 a4 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm8,%ymm4
 4ff:	ff ff ff 
 502:	c4 e2 45 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm1
 508:	48 01 d8             	add    %rbx,%rax
 50b:	c4 e2 3d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm3
 511:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 515:	c4 e2 3d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm0
 51b:	c4 e2 3d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm2
 521:	48 01 d8             	add    %rbx,%rax
 524:	48 01 d8             	add    %rbx,%rax
 527:	c4 e2 35 b8 64 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm9,%ymm4
 52e:	c4 e2 3d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm1
 534:	48 01 d8             	add    %rbx,%rax
 537:	c4 e2 35 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm3
 53d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 541:	c4 e2 35 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm0
 547:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 54d:	48 01 d8             	add    %rbx,%rax
 550:	48 01 d8             	add    %rbx,%rax
 553:	c4 e2 2d b8 64 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm10,%ymm4
 55a:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 560:	48 01 d8             	add    %rbx,%rax
 563:	c4 e2 2d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm3
 569:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 56d:	c4 e2 2d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm0
 573:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 579:	48 01 d8             	add    %rbx,%rax
 57c:	48 01 d8             	add    %rbx,%rax
 57f:	c4 e2 25 b8 64 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm11,%ymm4
 586:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 58c:	48 01 d8             	add    %rbx,%rax
 58f:	c4 e2 25 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm11,%ymm3
 595:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 599:	c4 e2 25 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm0
 59f:	c4 e2 25 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm2
 5a5:	48 01 d8             	add    %rbx,%rax
 5a8:	48 01 d8             	add    %rbx,%rax
 5ab:	c4 e2 1d b8 64 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm12,%ymm4
 5b2:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 5b8:	48 01 d8             	add    %rbx,%rax
 5bb:	c4 e2 1d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm12,%ymm3
 5c1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5c5:	c4 e2 1d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm0
 5cb:	c4 e2 1d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm2
 5d1:	48 01 d8             	add    %rbx,%rax
 5d4:	48 01 d8             	add    %rbx,%rax
 5d7:	c4 e2 15 b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm13,%ymm4
 5de:	48 83 c6 48          	add    $0x48,%rsi
 5e2:	c4 e2 1d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm1
 5e8:	48 01 d8             	add    %rbx,%rax
 5eb:	c4 e2 15 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm13,%ymm3
 5f1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5f5:	c4 e2 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm0
 5fb:	c4 e2 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm2
 601:	48 01 d8             	add    %rbx,%rax
 604:	48 01 d8             	add    %rbx,%rax
 607:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 60d:	48 39 ce             	cmp    %rcx,%rsi
 610:	0f 8c 0a fe ff ff    	jl     420 <.omp_outlined.+0x200>
 616:	e9 29 fd ff ff       	jmpq   344 <.omp_outlined.+0x124>
...
0000000000000630 <_Z9n_reg_maxv>:
 630:	b8 2d 00 00 00       	mov    $0x2d,%eax
 635:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui5_uk9.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d ac 86 c0 00 00 	lea    0xc0(%rsi,%rax,4),%rbp
 2fa:	00 
 ...
 340:	c5 fc 10 84 b5 40 ff 	vmovups -0xc0(%rbp,%rsi,4),%ymm0
 347:	ff ff 
 349:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34f:	c5 fc 10 94 b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm2
 356:	ff ff 
 358:	c5 fc 10 5c b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm3
 35e:	c5 fc 10 64 b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm4
 364:	c5 fc 10 6c b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm5
 36a:	c5 fc 10 74 b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm6
 370:	c5 fc 10 7c b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm7
 376:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 37d:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 384:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 38b:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 392:	00 00 00 
 395:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 39c:	00 00 00 
 39f:	c4 e2 45 b8 84 b2 c0 	vfmadd231ps 0xc0(%rdx,%rsi,4),%ymm7,%ymm0
 3a6:	00 00 00 
 3a9:	48 83 c6 38          	add    $0x38,%rsi
 3ad:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 3b1:	48 39 ce             	cmp    %rcx,%rsi
 3b4:	7c 8a                	jl     340 <.omp_outlined.+0x120>
 3b6:	e9 49 ff ff ff       	jmpq   304 <.omp_outlined.+0xe4>
 3bb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000003c0 <_Z6enablev>:
 3c0:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 3c7 <_Z6enablev+0x7>
 3c7:	7e 1e                	jle    3e7 <_Z6enablev+0x27>
 3c9:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3d0 <_Z6enablev+0x10>
 3d0:	b8 38 00 00 00       	mov    $0x38,%eax
 3d5:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 3da:	0f 45 c8             	cmovne %eax,%ecx
 3dd:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3e3 <_Z6enablev+0x23>
 3e3:	0f 9e c0             	setle  %al
 3e6:	c3                   	retq   

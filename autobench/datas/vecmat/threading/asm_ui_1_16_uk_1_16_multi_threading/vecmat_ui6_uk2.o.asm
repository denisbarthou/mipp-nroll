...
0000000000000220 <.omp_outlined.>:
 ...
 302:	49 8d 48 20          	lea    0x20(%r8),%rcx
 ...
 33b:	49 8d 7c c0 20       	lea    0x20(%r8,%rax,8),%rdi
 ...
 367:	49 8d 5c a8 20       	lea    0x20(%r8,%rbp,4),%rbx
 36c:	48 8d 6c 40 04       	lea    0x4(%rax,%rax,2),%rbp
 371:	48 8d 44 40 05       	lea    0x5(%rax,%rax,2),%rax
 376:	49 8d 74 b0 20       	lea    0x20(%r8,%rsi,4),%rsi
 37b:	49 0f af ea          	imul   %r10,%rbp
 37f:	49 0f af c2          	imul   %r10,%rax
 383:	49 8d 6c a8 20       	lea    0x20(%r8,%rbp,4),%rbp
 388:	49 8d 44 80 20       	lea    0x20(%r8,%rax,4),%rax
 ...
 4f0:	c4 81 7c 10 34 8b    	vmovups (%r11,%r9,4),%ymm6
 4f6:	c4 a2 4d b8 6c 8f e0 	vfmadd231ps -0x20(%rdi,%r9,4),%ymm6,%ymm5
 4fd:	c4 82 4d b8 64 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm6,%ymm4
 504:	c4 a2 4d b8 5c 8e e0 	vfmadd231ps -0x20(%rsi,%r9,4),%ymm6,%ymm3
 50b:	c4 a2 4d b8 44 8b e0 	vfmadd231ps -0x20(%rbx,%r9,4),%ymm6,%ymm0
 512:	c4 a2 4d b8 54 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm6,%ymm2
 519:	c4 a2 4d b8 4c 88 e0 	vfmadd231ps -0x20(%rax,%r9,4),%ymm6,%ymm1
 520:	c4 81 7c 10 7c 8b 20 	vmovups 0x20(%r11,%r9,4),%ymm7
 527:	c4 a2 45 b8 2c 8f    	vfmadd231ps (%rdi,%r9,4),%ymm7,%ymm5
 52d:	c4 82 45 b8 24 88    	vfmadd231ps (%r8,%r9,4),%ymm7,%ymm4
 533:	c4 a2 45 b8 1c 8e    	vfmadd231ps (%rsi,%r9,4),%ymm7,%ymm3
 539:	c4 a2 45 b8 04 8b    	vfmadd231ps (%rbx,%r9,4),%ymm7,%ymm0
 53f:	c4 a2 45 b8 54 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm7,%ymm2
 546:	c4 a2 45 b8 0c 88    	vfmadd231ps (%rax,%r9,4),%ymm7,%ymm1
 54c:	49 83 c1 10          	add    $0x10,%r9
 550:	4d 39 d1             	cmp    %r10,%r9
 553:	7c 9b                	jl     4f0 <.omp_outlined.+0x2d0>
 555:	e9 5e fe ff ff       	jmpq   3b8 <.omp_outlined.+0x198>
 55a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)

0000000000000560 <_Z6enablev>:
 560:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 567 <_Z6enablev+0x7>
 ...
 578:	b9 fe ff ff ff       	mov    $0xfffffffe,%ecx

...
0000000000000210 <.omp_outlined.>:
 ...
 2e2:	00 
 2e3:	48 8d 6c 86 20       	lea    0x20(%rsi,%rax,4),%rbp
 ...
 330:	c5 fc 10 44 b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm0
 336:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 33c:	c5 fc 10 54 b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm2
 342:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 349:	48 83 c6 10          	add    $0x10,%rsi
 34d:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 351:	48 39 ce             	cmp    %rcx,%rsi
 354:	7c da                	jl     330 <.omp_outlined.+0x120>
 356:	eb 9c                	jmp    2f4 <.omp_outlined.+0xe4>
...
0000000000000360 <_Z6enablev>:
 ...
 375:	b9 fe ff ff ff       	mov    $0xfffffffe,%ecx

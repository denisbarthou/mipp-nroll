...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d ac 86 60 01 00 	lea    0x160(%rsi,%rax,4),%rbp
 2fa:	00 
 ...
 340:	c5 fc 10 84 b5 a0 fe 	vmovups -0x160(%rbp,%rsi,4),%ymm0
 347:	ff ff 
 349:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34f:	c5 fc 10 94 b5 c0 fe 	vmovups -0x140(%rbp,%rsi,4),%ymm2
 356:	ff ff 
 358:	c5 fc 10 9c b5 e0 fe 	vmovups -0x120(%rbp,%rsi,4),%ymm3
 35f:	ff ff 
 361:	c5 fc 10 a4 b5 00 ff 	vmovups -0x100(%rbp,%rsi,4),%ymm4
 368:	ff ff 
 36a:	c5 fc 10 ac b5 20 ff 	vmovups -0xe0(%rbp,%rsi,4),%ymm5
 371:	ff ff 
 373:	c5 fc 10 b4 b5 40 ff 	vmovups -0xc0(%rbp,%rsi,4),%ymm6
 37a:	ff ff 
 37c:	c5 fc 10 bc b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm7
 383:	ff ff 
 385:	c5 7c 10 44 b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm8
 38b:	c5 7c 10 4c b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm9
 391:	c5 7c 10 54 b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm10
 397:	c5 7c 10 5c b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm11
 39d:	c5 7c 10 64 b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm12
 3a3:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 3aa:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 3b1:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 3b8:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 3bf:	00 00 00 
 3c2:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 3c9:	00 00 00 
 3cc:	c4 e2 45 b8 84 b2 c0 	vfmadd231ps 0xc0(%rdx,%rsi,4),%ymm7,%ymm0
 3d3:	00 00 00 
 3d6:	c4 e2 3d b8 84 b2 e0 	vfmadd231ps 0xe0(%rdx,%rsi,4),%ymm8,%ymm0
 3dd:	00 00 00 
 3e0:	c4 e2 35 b8 84 b2 00 	vfmadd231ps 0x100(%rdx,%rsi,4),%ymm9,%ymm0
 3e7:	01 00 00 
 3ea:	c4 e2 2d b8 84 b2 20 	vfmadd231ps 0x120(%rdx,%rsi,4),%ymm10,%ymm0
 3f1:	01 00 00 
 3f4:	c4 e2 25 b8 84 b2 40 	vfmadd231ps 0x140(%rdx,%rsi,4),%ymm11,%ymm0
 3fb:	01 00 00 
 3fe:	c4 e2 1d b8 84 b2 60 	vfmadd231ps 0x160(%rdx,%rsi,4),%ymm12,%ymm0
 405:	01 00 00 
 408:	48 83 c6 60          	add    $0x60,%rsi
 40c:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 410:	48 39 ce             	cmp    %rcx,%rsi
 413:	0f 8c 27 ff ff ff    	jl     340 <.omp_outlined.+0x120>
 419:	e9 e6 fe ff ff       	jmpq   304 <.omp_outlined.+0xe4>
 41e:	66 90                	xchg   %ax,%ax

0000000000000420 <_Z6enablev>:
 420:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 427 <_Z6enablev+0x7>
 427:	7e 1e                	jle    447 <_Z6enablev+0x27>
 429:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 430 <_Z6enablev+0x10>
 430:	b8 60 00 00 00       	mov    $0x60,%eax
 435:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 43a:	0f 45 c8             	cmovne %eax,%ecx
 43d:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 443 <_Z6enablev+0x23>
 443:	0f 9e c0             	setle  %al
 446:	c3                   	retq   

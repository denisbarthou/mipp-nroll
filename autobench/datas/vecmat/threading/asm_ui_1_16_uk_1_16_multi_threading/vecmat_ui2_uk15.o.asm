...
0000000000000220 <.omp_outlined.>:
 ...
 2eb:	41 b9 c0 01 00 00    	mov    $0x1c0,%r9d
 ...
 3a0:	c5 fc 10 14 9a       	vmovups (%rdx,%rbx,4),%ymm2
 3a5:	c4 e2 6d b8 8c 9d 40 	vfmadd231ps -0x1c0(%rbp,%rbx,4),%ymm2,%ymm1
 3ac:	fe ff ff 
 3af:	c4 e2 6d b8 84 9e 40 	vfmadd231ps -0x1c0(%rsi,%rbx,4),%ymm2,%ymm0
 3b6:	fe ff ff 
 3b9:	c5 fc 10 54 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm2
 3bf:	c4 e2 6d b8 8c 9d 60 	vfmadd231ps -0x1a0(%rbp,%rbx,4),%ymm2,%ymm1
 3c6:	fe ff ff 
 3c9:	c4 e2 6d b8 84 9e 60 	vfmadd231ps -0x1a0(%rsi,%rbx,4),%ymm2,%ymm0
 3d0:	fe ff ff 
 3d3:	c5 fc 10 54 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm2
 3d9:	c4 e2 6d b8 8c 9d 80 	vfmadd231ps -0x180(%rbp,%rbx,4),%ymm2,%ymm1
 3e0:	fe ff ff 
 3e3:	c4 e2 6d b8 84 9e 80 	vfmadd231ps -0x180(%rsi,%rbx,4),%ymm2,%ymm0
 3ea:	fe ff ff 
 3ed:	c5 fc 10 54 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm2
 3f3:	c4 e2 6d b8 8c 9d a0 	vfmadd231ps -0x160(%rbp,%rbx,4),%ymm2,%ymm1
 3fa:	fe ff ff 
 3fd:	c4 e2 6d b8 84 9e a0 	vfmadd231ps -0x160(%rsi,%rbx,4),%ymm2,%ymm0
 404:	fe ff ff 
 407:	c5 fc 10 94 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm2
 40e:	00 00 
 410:	c4 e2 6d b8 8c 9d c0 	vfmadd231ps -0x140(%rbp,%rbx,4),%ymm2,%ymm1
 417:	fe ff ff 
 41a:	c4 e2 6d b8 84 9e c0 	vfmadd231ps -0x140(%rsi,%rbx,4),%ymm2,%ymm0
 421:	fe ff ff 
 424:	c5 fc 10 94 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm2
 42b:	00 00 
 42d:	c4 e2 6d b8 8c 9d e0 	vfmadd231ps -0x120(%rbp,%rbx,4),%ymm2,%ymm1
 434:	fe ff ff 
 437:	c4 e2 6d b8 84 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm2,%ymm0
 43e:	fe ff ff 
 441:	c5 fc 10 94 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm2
 448:	00 00 
 44a:	c4 e2 6d b8 8c 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm2,%ymm1
 451:	ff ff ff 
 454:	c4 e2 6d b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm2,%ymm0
 45b:	ff ff ff 
 45e:	c5 fc 10 94 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm2
 465:	00 00 
 467:	c4 e2 6d b8 8c 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm2,%ymm1
 46e:	ff ff ff 
 471:	c4 e2 6d b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm2,%ymm0
 478:	ff ff ff 
 47b:	c5 fc 10 94 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm2
 482:	00 00 
 484:	c4 e2 6d b8 8c 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm2,%ymm1
 48b:	ff ff ff 
 48e:	c4 e2 6d b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm2,%ymm0
 495:	ff ff ff 
 498:	c5 fc 10 94 9a 20 01 	vmovups 0x120(%rdx,%rbx,4),%ymm2
 49f:	00 00 
 4a1:	c4 e2 6d b8 8c 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm2,%ymm1
 4a8:	ff ff ff 
 4ab:	c4 e2 6d b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm2,%ymm0
 4b2:	ff ff ff 
 4b5:	c5 fc 10 94 9a 40 01 	vmovups 0x140(%rdx,%rbx,4),%ymm2
 4bc:	00 00 
 4be:	c4 e2 6d b8 4c 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm2,%ymm1
 4c5:	c4 e2 6d b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm2,%ymm0
 4cc:	c5 fc 10 94 9a 60 01 	vmovups 0x160(%rdx,%rbx,4),%ymm2
 4d3:	00 00 
 4d5:	c4 e2 6d b8 4c 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm2,%ymm1
 4dc:	c4 e2 6d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm2,%ymm0
 4e3:	c5 fc 10 94 9a 80 01 	vmovups 0x180(%rdx,%rbx,4),%ymm2
 4ea:	00 00 
 4ec:	c4 e2 6d b8 4c 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm2,%ymm1
 4f3:	c4 e2 6d b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm2,%ymm0
 4fa:	c5 fc 10 94 9a a0 01 	vmovups 0x1a0(%rdx,%rbx,4),%ymm2
 501:	00 00 
 503:	c4 e2 6d b8 4c 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm2,%ymm1
 50a:	c4 e2 6d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm2,%ymm0
 511:	c5 fc 10 94 9a c0 01 	vmovups 0x1c0(%rdx,%rbx,4),%ymm2
 518:	00 00 
 51a:	c4 e2 6d b8 4c 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm2,%ymm1
 521:	c4 e2 6d b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm2,%ymm0
 527:	48 83 c3 78          	add    $0x78,%rbx
 52b:	48 39 cb             	cmp    %rcx,%rbx
 52e:	0f 8c 6c fe ff ff    	jl     3a0 <.omp_outlined.+0x180>
 534:	e9 df fd ff ff       	jmpq   318 <.omp_outlined.+0xf8>
 539:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

0000000000000540 <_Z6enablev>:
 540:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 547 <_Z6enablev+0x7>
 547:	7d 03                	jge    54c <_Z6enablev+0xc>
 549:	31 c0                	xor    %eax,%eax
 54b:	c3                   	retq   
 54c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 553 <_Z6enablev+0x13>
 553:	b8 78 00 00 00       	mov    $0x78,%eax
 558:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 55d:	0f 45 c8             	cmovne %eax,%ecx
 560:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 566 <_Z6enablev+0x26>
 566:	0f 9e c0             	setle  %al
 569:	c3                   	retq   
 56a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)

0000000000000570 <_Z9n_reg_maxv>:
 570:	b8 1e 00 00 00       	mov    $0x1e,%eax
 575:	c3                   	retq   

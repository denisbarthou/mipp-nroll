...
0000000000000220 <.omp_outlined.>:
 ...
 313:	48 8d ac be c0 01 00 	lea    0x1c0(%rsi,%rdi,4),%rbp
 31a:	00 
 ...
 330:	48 8d bc be c0 01 00 	lea    0x1c0(%rsi,%rdi,4),%rdi
 337:	00 
 338:	48 8d b4 9e c0 01 00 	lea    0x1c0(%rsi,%rbx,4),%rsi
 33f:	00 
 ...
 405:	c4 e2 65 b8 94 9d 40 	vfmadd231ps -0x1c0(%rbp,%rbx,4),%ymm3,%ymm2
 40c:	fe ff ff 
 40f:	c4 e2 65 b8 8c 9f 40 	vfmadd231ps -0x1c0(%rdi,%rbx,4),%ymm3,%ymm1
 416:	fe ff ff 
 419:	c4 e2 65 b8 84 9e 40 	vfmadd231ps -0x1c0(%rsi,%rbx,4),%ymm3,%ymm0
 420:	fe ff ff 
 423:	c5 fc 10 5c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm3
 429:	c4 e2 65 b8 94 9d 60 	vfmadd231ps -0x1a0(%rbp,%rbx,4),%ymm3,%ymm2
 430:	fe ff ff 
 433:	c4 e2 65 b8 8c 9f 60 	vfmadd231ps -0x1a0(%rdi,%rbx,4),%ymm3,%ymm1
 43a:	fe ff ff 
 43d:	c4 e2 65 b8 84 9e 60 	vfmadd231ps -0x1a0(%rsi,%rbx,4),%ymm3,%ymm0
 444:	fe ff ff 
 447:	c5 fc 10 5c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm3
 44d:	c4 e2 65 b8 94 9d 80 	vfmadd231ps -0x180(%rbp,%rbx,4),%ymm3,%ymm2
 454:	fe ff ff 
 457:	c4 e2 65 b8 8c 9f 80 	vfmadd231ps -0x180(%rdi,%rbx,4),%ymm3,%ymm1
 45e:	fe ff ff 
 461:	c4 e2 65 b8 84 9e 80 	vfmadd231ps -0x180(%rsi,%rbx,4),%ymm3,%ymm0
 468:	fe ff ff 
 46b:	c5 fc 10 5c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm3
 471:	c4 e2 65 b8 94 9d a0 	vfmadd231ps -0x160(%rbp,%rbx,4),%ymm3,%ymm2
 478:	fe ff ff 
 47b:	c4 e2 65 b8 8c 9f a0 	vfmadd231ps -0x160(%rdi,%rbx,4),%ymm3,%ymm1
 482:	fe ff ff 
 485:	c4 e2 65 b8 84 9e a0 	vfmadd231ps -0x160(%rsi,%rbx,4),%ymm3,%ymm0
 48c:	fe ff ff 
 48f:	c5 fc 10 9c 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm3
 496:	00 00 
 498:	c4 e2 65 b8 94 9d c0 	vfmadd231ps -0x140(%rbp,%rbx,4),%ymm3,%ymm2
 49f:	fe ff ff 
 4a2:	c4 e2 65 b8 8c 9f c0 	vfmadd231ps -0x140(%rdi,%rbx,4),%ymm3,%ymm1
 4a9:	fe ff ff 
 4ac:	c4 e2 65 b8 84 9e c0 	vfmadd231ps -0x140(%rsi,%rbx,4),%ymm3,%ymm0
 4b3:	fe ff ff 
 4b6:	c5 fc 10 9c 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm3
 4bd:	00 00 
 4bf:	c4 e2 65 b8 94 9d e0 	vfmadd231ps -0x120(%rbp,%rbx,4),%ymm3,%ymm2
 4c6:	fe ff ff 
 4c9:	c4 e2 65 b8 8c 9f e0 	vfmadd231ps -0x120(%rdi,%rbx,4),%ymm3,%ymm1
 4d0:	fe ff ff 
 4d3:	c4 e2 65 b8 84 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm3,%ymm0
 4da:	fe ff ff 
 4dd:	c5 fc 10 9c 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm3
 4e4:	00 00 
 4e6:	c4 e2 65 b8 94 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm3,%ymm2
 4ed:	ff ff ff 
 4f0:	c4 e2 65 b8 8c 9f 00 	vfmadd231ps -0x100(%rdi,%rbx,4),%ymm3,%ymm1
 4f7:	ff ff ff 
 4fa:	c4 e2 65 b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm3,%ymm0
 501:	ff ff ff 
 504:	c5 fc 10 9c 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm3
 50b:	00 00 
 50d:	c4 e2 65 b8 94 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm3,%ymm2
 514:	ff ff ff 
 517:	c4 e2 65 b8 8c 9f 20 	vfmadd231ps -0xe0(%rdi,%rbx,4),%ymm3,%ymm1
 51e:	ff ff ff 
 521:	c4 e2 65 b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm3,%ymm0
 528:	ff ff ff 
 52b:	c5 fc 10 9c 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm3
 532:	00 00 
 534:	c4 e2 65 b8 94 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm3,%ymm2
 53b:	ff ff ff 
 53e:	c4 e2 65 b8 8c 9f 40 	vfmadd231ps -0xc0(%rdi,%rbx,4),%ymm3,%ymm1
 545:	ff ff ff 
 548:	c4 e2 65 b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm3,%ymm0
 54f:	ff ff ff 
 552:	c5 fc 10 9c 9a 20 01 	vmovups 0x120(%rdx,%rbx,4),%ymm3
 559:	00 00 
 55b:	c4 e2 65 b8 94 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm3,%ymm2
 562:	ff ff ff 
 565:	c4 e2 65 b8 8c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm3,%ymm1
 56c:	ff ff ff 
 56f:	c4 e2 65 b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm3,%ymm0
 576:	ff ff ff 
 579:	c5 fc 10 9c 9a 40 01 	vmovups 0x140(%rdx,%rbx,4),%ymm3
 580:	00 00 
 582:	c4 e2 65 b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm3,%ymm2
 589:	c4 e2 65 b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm3,%ymm1
 590:	c4 e2 65 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm3,%ymm0
 597:	c5 fc 10 9c 9a 60 01 	vmovups 0x160(%rdx,%rbx,4),%ymm3
 59e:	00 00 
 5a0:	c4 e2 65 b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm3,%ymm2
 5a7:	c4 e2 65 b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm3,%ymm1
 5ae:	c4 e2 65 b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm3,%ymm0
 5b5:	c5 fc 10 9c 9a 80 01 	vmovups 0x180(%rdx,%rbx,4),%ymm3
 5bc:	00 00 
 5be:	c4 e2 65 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm3,%ymm2
 5c5:	c4 e2 65 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm3,%ymm1
 5cc:	c4 e2 65 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm3,%ymm0
 5d3:	c5 fc 10 9c 9a a0 01 	vmovups 0x1a0(%rdx,%rbx,4),%ymm3
 5da:	00 00 
 5dc:	c4 e2 65 b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm3,%ymm2
 5e3:	c4 e2 65 b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm3,%ymm1
 5ea:	c4 e2 65 b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm3,%ymm0
 5f1:	c5 fc 10 9c 9a c0 01 	vmovups 0x1c0(%rdx,%rbx,4),%ymm3
 5f8:	00 00 
 5fa:	c4 e2 65 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm3,%ymm2
 601:	c4 e2 65 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm1
 607:	c4 e2 65 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm0
 60d:	48 83 c3 78          	add    $0x78,%rbx
 611:	48 39 cb             	cmp    %rcx,%rbx
 614:	0f 8c e6 fd ff ff    	jl     400 <.omp_outlined.+0x1e0>
 61a:	e9 3d fd ff ff       	jmpq   35c <.omp_outlined.+0x13c>
 61f:	90                   	nop

...
0000000000000210 <.omp_outlined.>:
 ...
 2db:	41 b9 e0 00 00 00    	mov    $0xe0,%r9d
 ...
 395:	c4 e2 6d b8 8c 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm2,%ymm1
 39c:	ff ff ff 
 39f:	c4 e2 6d b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm2,%ymm0
 3a6:	ff ff ff 
 3a9:	c5 fc 10 5c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm3
 3af:	c5 fc 10 64 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm4
 3b5:	c5 fc 10 6c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm5
 3bb:	c5 fc 10 b4 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm6
 3c2:	00 00 
 3c4:	c5 fc 10 bc 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm7
 3cb:	00 00 
 3cd:	c5 7c 10 84 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm8
 3d4:	00 00 
 3d6:	c5 7c 10 8c 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm9
 3dd:	00 00 
 3df:	c4 e2 65 b8 8c 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm3,%ymm1
 3e6:	ff ff ff 
 3e9:	c4 e2 65 b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm3,%ymm0
 3f0:	ff ff ff 
 3f3:	c4 e2 5d b8 8c 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm4,%ymm1
 3fa:	ff ff ff 
 3fd:	c4 e2 5d b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm4,%ymm0
 404:	ff ff ff 
 407:	c4 e2 55 b8 4c 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm5,%ymm1
 40e:	c4 e2 55 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm5,%ymm0
 415:	c4 e2 4d b8 4c 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm6,%ymm1
 41c:	c4 e2 4d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm6,%ymm0
 423:	c4 e2 45 b8 4c 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm7,%ymm1
 42a:	c4 e2 45 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm7,%ymm0
 431:	c4 e2 3d b8 4c 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm8,%ymm1
 438:	c4 e2 3d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm8,%ymm0
 43f:	c4 e2 35 b8 4c 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm9,%ymm1
 446:	c4 e2 35 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm9,%ymm0
 44c:	48 83 c3 40          	add    $0x40,%rbx
 450:	48 39 cb             	cmp    %rcx,%rbx
 453:	0f 8c 37 ff ff ff    	jl     390 <.omp_outlined.+0x180>
 459:	e9 aa fe ff ff       	jmpq   308 <.omp_outlined.+0xf8>
...
0000000000000460 <_Z6enablev>:
 ...
 473:	b8 40 00 00 00       	mov    $0x40,%eax
 478:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx

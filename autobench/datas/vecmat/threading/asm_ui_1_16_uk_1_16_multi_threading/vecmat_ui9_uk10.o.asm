...
0000000000000220 <.omp_outlined.>:
 ...
 31c:	48 8d ac b0 20 01 00 	lea    0x120(%rax,%rsi,4),%rbp
 323:	00 
 ...
 4fa:	c4 62 35 b8 84 b5 e0 	vfmadd231ps -0x120(%rbp,%rsi,4),%ymm9,%ymm8
 501:	fe ff ff 
 504:	c4 e2 35 b8 bc 88 e0 	vfmadd231ps -0x120(%rax,%rcx,4),%ymm9,%ymm7
 50b:	fe ff ff 
 50e:	c4 e2 35 b8 a4 c8 e0 	vfmadd231ps -0x120(%rax,%rcx,8),%ymm9,%ymm4
 515:	fe ff ff 
 518:	48 8d 84 03 e0 fe ff 	lea    -0x120(%rbx,%rax,1),%rax
 51f:	ff 
 ...
 562:	c4 62 35 b8 84 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm9,%ymm8
 569:	ff ff ff 
 ...
 5bd:	c4 62 35 b8 84 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm9,%ymm8
 5c4:	ff ff ff 
 ...
 618:	c4 62 35 b8 84 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm9,%ymm8
 61f:	ff ff ff 
 ...
 674:	00 00 
 676:	c4 62 35 b8 84 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm9,%ymm8
 67d:	ff ff ff 
 ...
 6d2:	00 00 
 6d4:	c4 62 35 b8 44 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm9,%ymm8
 6db:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 6e1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6e5:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 6eb:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 6f1:	48 01 d8             	add    %rbx,%rax
 6f4:	48 01 d8             	add    %rbx,%rax
 6f7:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 6fd:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 703:	48 01 d8             	add    %rbx,%rax
 706:	48 01 d8             	add    %rbx,%rax
 709:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 70f:	48 01 d8             	add    %rbx,%rax
 712:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 718:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 71c:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 722:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 726:	c5 7c 10 8c b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm9
 72d:	00 00 
 72f:	c4 62 35 b8 44 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm9,%ymm8
 736:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 73c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 740:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 746:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 74c:	48 01 d8             	add    %rbx,%rax
 74f:	48 01 d8             	add    %rbx,%rax
 752:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 758:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 75e:	48 01 d8             	add    %rbx,%rax
 761:	48 01 d8             	add    %rbx,%rax
 764:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 76a:	48 01 d8             	add    %rbx,%rax
 76d:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 773:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 777:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 77d:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 781:	c5 7c 10 8c b2 e0 00 	vmovups 0xe0(%rdx,%rsi,4),%ymm9
 788:	00 00 
 78a:	c4 62 35 b8 44 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm9,%ymm8
 791:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 797:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 79b:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 7a1:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 7a7:	48 01 d8             	add    %rbx,%rax
 7aa:	48 01 d8             	add    %rbx,%rax
 7ad:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 7b3:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 7b9:	48 01 d8             	add    %rbx,%rax
 7bc:	48 01 d8             	add    %rbx,%rax
 7bf:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 7c5:	48 01 d8             	add    %rbx,%rax
 7c8:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 7ce:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 7d2:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 7d8:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 7dc:	c5 7c 10 8c b2 00 01 	vmovups 0x100(%rdx,%rsi,4),%ymm9
 7e3:	00 00 
 7e5:	c4 62 35 b8 44 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm9,%ymm8
 7ec:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 7f2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7f6:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 7fc:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 802:	48 01 d8             	add    %rbx,%rax
 805:	48 01 d8             	add    %rbx,%rax
 808:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 80e:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 814:	48 01 d8             	add    %rbx,%rax
 817:	48 01 d8             	add    %rbx,%rax
 81a:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 820:	48 01 d8             	add    %rbx,%rax
 823:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 829:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 82d:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 833:	48 01 d8             	add    %rbx,%rax
 836:	c5 7c 10 8c b2 20 01 	vmovups 0x120(%rdx,%rsi,4),%ymm9
 83d:	00 00 
 83f:	c4 62 35 b8 44 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm9,%ymm8
 846:	48 83 c6 50          	add    $0x50,%rsi
 84a:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 850:	48 01 f8             	add    %rdi,%rax
 853:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 859:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 85f:	48 01 d8             	add    %rbx,%rax
 862:	48 01 d8             	add    %rbx,%rax
 865:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 86b:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 871:	48 01 d8             	add    %rbx,%rax
 874:	48 01 d8             	add    %rbx,%rax
 877:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 87d:	48 01 d8             	add    %rbx,%rax
 880:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 886:	48 01 d8             	add    %rbx,%rax
 889:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 88f:	48 39 ce             	cmp    %rcx,%rsi
 892:	0f 8c 58 fc ff ff    	jl     4f0 <.omp_outlined.+0x2d0>
 898:	e9 c9 fa ff ff       	jmpq   366 <.omp_outlined.+0x146>

...
0000000000000220 <.omp_outlined.>:
 ...
 54a:	c4 62 25 b8 94 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm11,%ymm10
 551:	ff ff ff 
 554:	c4 62 25 b8 8c 88 60 	vfmadd231ps -0xa0(%rax,%rcx,4),%ymm11,%ymm9
 55b:	ff ff ff 
 55e:	c4 e2 25 b8 b4 c8 60 	vfmadd231ps -0xa0(%rax,%rcx,8),%ymm11,%ymm6
 565:	ff ff ff 
 568:	48 8d 84 07 60 ff ff 	lea    -0xa0(%rdi,%rax,1),%rax
 56f:	ff 
 ...
 5c6:	c4 62 25 b8 54 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm11,%ymm10
 5cd:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 5d3:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5d7:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 5dd:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 5e3:	48 01 f8             	add    %rdi,%rax
 5e6:	48 01 f8             	add    %rdi,%rax
 5e9:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 5ef:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 5f5:	48 01 f8             	add    %rdi,%rax
 5f8:	48 01 f8             	add    %rdi,%rax
 5fb:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 601:	48 01 f8             	add    %rdi,%rax
 604:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 60a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 60e:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 614:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 618:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 61e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 622:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 628:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 62c:	c5 7c 10 5c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm11
 632:	c4 62 25 b8 54 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm11,%ymm10
 639:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 63f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 643:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 649:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 64f:	48 01 f8             	add    %rdi,%rax
 652:	48 01 f8             	add    %rdi,%rax
 655:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 65b:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 661:	48 01 f8             	add    %rdi,%rax
 664:	48 01 f8             	add    %rdi,%rax
 667:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 66d:	48 01 f8             	add    %rdi,%rax
 670:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 676:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 67a:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 680:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 684:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 68a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 68e:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 694:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 698:	c5 7c 10 5c b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm11
 69e:	c4 62 25 b8 54 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm11,%ymm10
 6a5:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 6ab:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6af:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 6b5:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 6bb:	48 01 f8             	add    %rdi,%rax
 6be:	48 01 f8             	add    %rdi,%rax
 6c1:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 6c7:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 6cd:	48 01 f8             	add    %rdi,%rax
 6d0:	48 01 f8             	add    %rdi,%rax
 6d3:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 6d9:	48 01 f8             	add    %rdi,%rax
 6dc:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 6e2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6e6:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 6ec:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6f0:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 6f6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6fa:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 700:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 704:	c5 7c 10 9c b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm11
 70b:	00 00 
 70d:	c4 62 25 b8 54 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm11,%ymm10
 714:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 71a:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 71e:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 724:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 72a:	48 01 f8             	add    %rdi,%rax
 72d:	48 01 f8             	add    %rdi,%rax
 730:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 736:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 73c:	48 01 f8             	add    %rdi,%rax
 73f:	48 01 f8             	add    %rdi,%rax
 742:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 748:	48 01 f8             	add    %rdi,%rax
 74b:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 751:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 755:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 75b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 75f:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 765:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 769:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 76f:	48 01 f8             	add    %rdi,%rax
 772:	c5 7c 10 9c b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm11
 779:	00 00 
 77b:	c4 62 25 b8 54 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm11,%ymm10
 782:	48 83 c6 30          	add    $0x30,%rsi
 786:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 78c:	48 01 d8             	add    %rbx,%rax
 78f:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 795:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 79b:	48 01 f8             	add    %rdi,%rax
 79e:	48 01 f8             	add    %rdi,%rax
 7a1:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 7a7:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 7ad:	48 01 f8             	add    %rdi,%rax
 7b0:	48 01 f8             	add    %rdi,%rax
 7b3:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 7b9:	48 01 f8             	add    %rdi,%rax
 7bc:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 7c2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7c6:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 7cc:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7d0:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 7d6:	48 01 f8             	add    %rdi,%rax
 7d9:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 7df:	48 39 ce             	cmp    %rcx,%rsi
 7e2:	0f 8c 58 fd ff ff    	jl     540 <.omp_outlined.+0x320>
 7e8:	e9 73 fb ff ff       	jmpq   360 <.omp_outlined.+0x140>
...
0000000000000800 <_Z9n_reg_maxv>:
 800:	b8 42 00 00 00       	mov    $0x42,%eax
 805:	c3                   	retq   

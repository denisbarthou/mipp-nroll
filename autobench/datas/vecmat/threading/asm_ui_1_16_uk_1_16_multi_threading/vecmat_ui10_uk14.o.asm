...
0000000000000220 <.omp_outlined.>:
 ...
 34e:	00 
 34f:	48 8d ac f0 a0 01 00 	lea    0x1a0(%rax,%rsi,8),%rbp
 356:	00 
 357:	48 05 a0 01 00 00    	add    $0x1a0,%rax
 ...
 58b:	c4 22 2d b8 8c 8d 60 	vfmadd231ps -0x1a0(%rbp,%r9,4),%ymm10,%ymm9
 592:	fe ff ff 
 595:	c4 02 2d b8 84 88 60 	vfmadd231ps -0x1a0(%r8,%r9,4),%ymm10,%ymm8
 59c:	fe ff ff 
 59f:	4b 8d 84 17 60 fe ff 	lea    -0x1a0(%r15,%r10,1),%rax
 5a6:	ff 
 5a7:	c4 c2 2d b8 bc ca 60 	vfmadd231ps -0x1a0(%r10,%rcx,8),%ymm10,%ymm7
 5ae:	fe ff ff 
 ...
 5f9:	c4 22 2d b8 8c 8d 80 	vfmadd231ps -0x180(%rbp,%r9,4),%ymm10,%ymm9
 600:	fe ff ff 
 603:	c4 02 2d b8 84 88 80 	vfmadd231ps -0x180(%r8,%r9,4),%ymm10,%ymm8
 60a:	fe ff ff 
 ...
 65f:	c4 22 2d b8 8c 8d a0 	vfmadd231ps -0x160(%rbp,%r9,4),%ymm10,%ymm9
 666:	fe ff ff 
 669:	c4 02 2d b8 84 88 a0 	vfmadd231ps -0x160(%r8,%r9,4),%ymm10,%ymm8
 670:	fe ff ff 
 ...
 6c5:	c4 22 2d b8 8c 8d c0 	vfmadd231ps -0x140(%rbp,%r9,4),%ymm10,%ymm9
 6cc:	fe ff ff 
 6cf:	c4 02 2d b8 84 88 c0 	vfmadd231ps -0x140(%r8,%r9,4),%ymm10,%ymm8
 6d6:	fe ff ff 
 ...
 72b:	00 00 00 
 72e:	c4 22 2d b8 8c 8d e0 	vfmadd231ps -0x120(%rbp,%r9,4),%ymm10,%ymm9
 735:	fe ff ff 
 738:	c4 02 2d b8 84 88 e0 	vfmadd231ps -0x120(%r8,%r9,4),%ymm10,%ymm8
 73f:	fe ff ff 
 ...
 794:	00 00 00 
 797:	c4 22 2d b8 8c 8d 00 	vfmadd231ps -0x100(%rbp,%r9,4),%ymm10,%ymm9
 79e:	ff ff ff 
 7a1:	c4 02 2d b8 84 88 00 	vfmadd231ps -0x100(%r8,%r9,4),%ymm10,%ymm8
 7a8:	ff ff ff 
 ...
 7fd:	00 00 00 
 800:	c4 22 2d b8 8c 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm10,%ymm9
 807:	ff ff ff 
 80a:	c4 02 2d b8 84 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm10,%ymm8
 811:	ff ff ff 
 ...
 866:	00 00 00 
 869:	c4 22 2d b8 8c 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm10,%ymm9
 870:	ff ff ff 
 873:	c4 02 2d b8 84 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm10,%ymm8
 87a:	ff ff ff 
 ...
 8cf:	01 00 00 
 8d2:	c4 22 2d b8 8c 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm10,%ymm9
 8d9:	ff ff ff 
 8dc:	c4 02 2d b8 84 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm10,%ymm8
 8e3:	ff ff ff 
 ...
 938:	01 00 00 
 93b:	c4 22 2d b8 4c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm10,%ymm9
 942:	c4 02 2d b8 44 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm10,%ymm8
 949:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 94f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 953:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 959:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 95f:	48 01 f8             	add    %rdi,%rax
 962:	48 01 f8             	add    %rdi,%rax
 965:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 96b:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 971:	48 01 f8             	add    %rdi,%rax
 974:	48 01 f8             	add    %rdi,%rax
 977:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 97d:	48 01 f8             	add    %rdi,%rax
 980:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 986:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 98a:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 990:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 994:	c4 21 7c 10 94 8a 40 	vmovups 0x140(%rdx,%r9,4),%ymm10
 99b:	01 00 00 
 99e:	c4 22 2d b8 4c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm10,%ymm9
 9a5:	c4 02 2d b8 44 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm10,%ymm8
 9ac:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 9b2:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9b6:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 9bc:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 9c2:	48 01 f8             	add    %rdi,%rax
 9c5:	48 01 f8             	add    %rdi,%rax
 9c8:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 9ce:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 9d4:	48 01 f8             	add    %rdi,%rax
 9d7:	48 01 f8             	add    %rdi,%rax
 9da:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 9e0:	48 01 f8             	add    %rdi,%rax
 9e3:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 9e9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9ed:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 9f3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9f7:	c4 21 7c 10 94 8a 60 	vmovups 0x160(%rdx,%r9,4),%ymm10
 9fe:	01 00 00 
 a01:	c4 22 2d b8 4c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm10,%ymm9
 a08:	c4 02 2d b8 44 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm10,%ymm8
 a0f:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 a15:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a19:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 a1f:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 a25:	48 01 f8             	add    %rdi,%rax
 a28:	48 01 f8             	add    %rdi,%rax
 a2b:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 a31:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 a37:	48 01 f8             	add    %rdi,%rax
 a3a:	48 01 f8             	add    %rdi,%rax
 a3d:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 a43:	48 01 f8             	add    %rdi,%rax
 a46:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 a4c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a50:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 a56:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a5a:	c4 21 7c 10 94 8a 80 	vmovups 0x180(%rdx,%r9,4),%ymm10
 a61:	01 00 00 
 a64:	c4 22 2d b8 4c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm10,%ymm9
 a6b:	c4 02 2d b8 44 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm10,%ymm8
 a72:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 a78:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a7c:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 a82:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 a88:	48 01 f8             	add    %rdi,%rax
 a8b:	48 01 f8             	add    %rdi,%rax
 a8e:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 a94:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 a9a:	48 01 f8             	add    %rdi,%rax
 a9d:	48 01 f8             	add    %rdi,%rax
 aa0:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 aa6:	48 01 f8             	add    %rdi,%rax
 aa9:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 aaf:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ab3:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 ab9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 abd:	c4 21 7c 10 94 8a a0 	vmovups 0x1a0(%rdx,%r9,4),%ymm10
 ac4:	01 00 00 
 ac7:	c4 22 2d b8 4c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm10,%ymm9
 ace:	c4 02 2d b8 04 88    	vfmadd231ps (%r8,%r9,4),%ymm10,%ymm8
 ad4:	49 83 c1 70          	add    $0x70,%r9
 ad8:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 ade:	48 01 d8             	add    %rbx,%rax
 ae1:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 ae7:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 aed:	48 01 f8             	add    %rdi,%rax
 af0:	48 01 f8             	add    %rdi,%rax
 af3:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 af9:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 aff:	48 01 f8             	add    %rdi,%rax
 b02:	48 01 f8             	add    %rdi,%rax
 b05:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 b0b:	48 01 f8             	add    %rdi,%rax
 b0e:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 b14:	48 01 f8             	add    %rdi,%rax
 b17:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 b1d:	49 39 c9             	cmp    %rcx,%r9
 b20:	0f 8c 5a fa ff ff    	jl     580 <.omp_outlined.+0x360>
 b26:	e9 70 f8 ff ff       	jmpq   39b <.omp_outlined.+0x17b>
...
0000000000000b40 <_Z9n_reg_maxv>:
 b40:	b8 8c 00 00 00       	mov    $0x8c,%eax
 b45:	c3                   	retq   

...
0000000000000210 <.omp_outlined.>:
 ...
 321:	be 00 01 00 00       	mov    $0x100,%esi
 ...
 49b:	00 00 00 00 00 
 4a0:	c4 21 7c 10 14 aa    	vmovups (%rdx,%r13,4),%ymm10
 4a6:	c4 82 2d b8 9c ac 00 	vfmadd231ps -0x100(%r12,%r13,4),%ymm10,%ymm3
 4ad:	ff ff ff 
 4b0:	c4 82 2d b8 94 af 00 	vfmadd231ps -0x100(%r15,%r13,4),%ymm10,%ymm2
 4b7:	ff ff ff 
 4ba:	c4 82 2d b8 8c a9 00 	vfmadd231ps -0x100(%r9,%r13,4),%ymm10,%ymm1
 4c1:	ff ff ff 
 4c4:	c4 82 2d b8 84 a8 00 	vfmadd231ps -0x100(%r8,%r13,4),%ymm10,%ymm0
 4cb:	ff ff ff 
 4ce:	c4 21 7c 10 5c aa 20 	vmovups 0x20(%rdx,%r13,4),%ymm11
 4d5:	c4 21 7c 10 64 aa 40 	vmovups 0x40(%rdx,%r13,4),%ymm12
 4dc:	c4 21 7c 10 4c aa 60 	vmovups 0x60(%rdx,%r13,4),%ymm9
 4e3:	c4 21 7c 10 84 aa 80 	vmovups 0x80(%rdx,%r13,4),%ymm8
 4ea:	00 00 00 
 4ed:	c4 a1 7c 10 bc aa a0 	vmovups 0xa0(%rdx,%r13,4),%ymm7
 4f4:	00 00 00 
 4f7:	c4 a1 7c 10 b4 aa c0 	vmovups 0xc0(%rdx,%r13,4),%ymm6
 4fe:	00 00 00 
 501:	c4 a1 7c 10 ac aa e0 	vmovups 0xe0(%rdx,%r13,4),%ymm5
 508:	00 00 00 
 50b:	c4 a1 7c 10 a4 aa 00 	vmovups 0x100(%rdx,%r13,4),%ymm4
 512:	01 00 00 
 515:	c4 82 25 b8 9c ac 20 	vfmadd231ps -0xe0(%r12,%r13,4),%ymm11,%ymm3
 51c:	ff ff ff 
 51f:	c4 82 25 b8 94 af 20 	vfmadd231ps -0xe0(%r15,%r13,4),%ymm11,%ymm2
 526:	ff ff ff 
 529:	c4 82 25 b8 8c a9 20 	vfmadd231ps -0xe0(%r9,%r13,4),%ymm11,%ymm1
 530:	ff ff ff 
 533:	c4 82 25 b8 84 a8 20 	vfmadd231ps -0xe0(%r8,%r13,4),%ymm11,%ymm0
 53a:	ff ff ff 
 53d:	c4 82 1d b8 9c ac 40 	vfmadd231ps -0xc0(%r12,%r13,4),%ymm12,%ymm3
 544:	ff ff ff 
 547:	c4 82 1d b8 94 af 40 	vfmadd231ps -0xc0(%r15,%r13,4),%ymm12,%ymm2
 54e:	ff ff ff 
 551:	c4 82 1d b8 8c a9 40 	vfmadd231ps -0xc0(%r9,%r13,4),%ymm12,%ymm1
 558:	ff ff ff 
 55b:	c4 82 1d b8 84 a8 40 	vfmadd231ps -0xc0(%r8,%r13,4),%ymm12,%ymm0
 562:	ff ff ff 
 565:	c4 82 35 b8 9c ac 60 	vfmadd231ps -0xa0(%r12,%r13,4),%ymm9,%ymm3
 56c:	ff ff ff 
 56f:	c4 82 35 b8 94 af 60 	vfmadd231ps -0xa0(%r15,%r13,4),%ymm9,%ymm2
 576:	ff ff ff 
 579:	c4 82 35 b8 8c a9 60 	vfmadd231ps -0xa0(%r9,%r13,4),%ymm9,%ymm1
 580:	ff ff ff 
 583:	c4 82 35 b8 84 a8 60 	vfmadd231ps -0xa0(%r8,%r13,4),%ymm9,%ymm0
 58a:	ff ff ff 
 58d:	c4 82 3d b8 5c ac 80 	vfmadd231ps -0x80(%r12,%r13,4),%ymm8,%ymm3
 594:	c4 82 3d b8 54 af 80 	vfmadd231ps -0x80(%r15,%r13,4),%ymm8,%ymm2
 59b:	c4 82 3d b8 4c a9 80 	vfmadd231ps -0x80(%r9,%r13,4),%ymm8,%ymm1
 5a2:	c4 82 3d b8 44 a8 80 	vfmadd231ps -0x80(%r8,%r13,4),%ymm8,%ymm0
 5a9:	c4 82 45 b8 5c ac a0 	vfmadd231ps -0x60(%r12,%r13,4),%ymm7,%ymm3
 5b0:	c4 82 45 b8 54 af a0 	vfmadd231ps -0x60(%r15,%r13,4),%ymm7,%ymm2
 5b7:	c4 82 45 b8 4c a9 a0 	vfmadd231ps -0x60(%r9,%r13,4),%ymm7,%ymm1
 5be:	c4 82 45 b8 44 a8 a0 	vfmadd231ps -0x60(%r8,%r13,4),%ymm7,%ymm0
 5c5:	c4 82 4d b8 5c ac c0 	vfmadd231ps -0x40(%r12,%r13,4),%ymm6,%ymm3
 5cc:	c4 82 4d b8 54 af c0 	vfmadd231ps -0x40(%r15,%r13,4),%ymm6,%ymm2
 5d3:	c4 82 4d b8 4c a9 c0 	vfmadd231ps -0x40(%r9,%r13,4),%ymm6,%ymm1
 5da:	c4 82 4d b8 44 a8 c0 	vfmadd231ps -0x40(%r8,%r13,4),%ymm6,%ymm0
 5e1:	c4 82 55 b8 5c ac e0 	vfmadd231ps -0x20(%r12,%r13,4),%ymm5,%ymm3
 5e8:	c4 82 55 b8 54 af e0 	vfmadd231ps -0x20(%r15,%r13,4),%ymm5,%ymm2
 5ef:	c4 82 55 b8 4c a9 e0 	vfmadd231ps -0x20(%r9,%r13,4),%ymm5,%ymm1
 5f6:	c4 82 55 b8 44 a8 e0 	vfmadd231ps -0x20(%r8,%r13,4),%ymm5,%ymm0
 5fd:	c4 82 5d b8 1c ac    	vfmadd231ps (%r12,%r13,4),%ymm4,%ymm3
 603:	c4 82 5d b8 14 af    	vfmadd231ps (%r15,%r13,4),%ymm4,%ymm2
 609:	c4 82 5d b8 0c a9    	vfmadd231ps (%r9,%r13,4),%ymm4,%ymm1
 60f:	c4 82 5d b8 04 a8    	vfmadd231ps (%r8,%r13,4),%ymm4,%ymm0
 615:	49 83 c5 48          	add    $0x48,%r13
 619:	4d 39 d5             	cmp    %r10,%r13
 61c:	0f 8c 7e fe ff ff    	jl     4a0 <.omp_outlined.+0x290>
 622:	e9 29 fd ff ff       	jmpq   350 <.omp_outlined.+0x140>
...
0000000000000640 <_Z9n_reg_maxv>:
 640:	b8 24 00 00 00       	mov    $0x24,%eax
 645:	c3                   	retq   

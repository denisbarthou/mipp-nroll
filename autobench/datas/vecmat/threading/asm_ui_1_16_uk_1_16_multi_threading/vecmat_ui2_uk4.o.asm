...
0000000000000210 <.omp_outlined.>:
 ...
 395:	c4 e2 6d b8 4c 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm2,%ymm1
 39c:	c4 e2 6d b8 44 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm2,%ymm0
 3a3:	c5 fc 10 5c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm3
 3a9:	c5 fc 10 64 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm4
 3af:	c5 fc 10 6c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm5
 3b5:	c4 e2 65 b8 4c 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm3,%ymm1
 3bc:	c4 e2 65 b8 44 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm3,%ymm0
 3c3:	c4 e2 5d b8 4c 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm4,%ymm1
 3ca:	c4 e2 5d b8 44 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm4,%ymm0
 3d1:	c4 e2 55 b8 0c 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm5,%ymm1
 3d7:	c4 e2 55 b8 04 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm5,%ymm0
 3dd:	48 83 c3 20          	add    $0x20,%rbx
 3e1:	48 39 cb             	cmp    %rcx,%rbx
 3e4:	7c aa                	jl     390 <.omp_outlined.+0x180>
 3e6:	e9 1d ff ff ff       	jmpq   308 <.omp_outlined.+0xf8>

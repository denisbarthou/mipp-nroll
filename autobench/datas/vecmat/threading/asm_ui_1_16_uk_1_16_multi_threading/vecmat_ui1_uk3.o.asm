...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d 6c 86 40       	lea    0x40(%rsi,%rax,4),%rbp
 2f8:	eb 3c                	jmp    336 <.omp_outlined.+0x116>
 ...
 340:	c5 fc 10 44 b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm0
 346:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34c:	c5 fc 10 54 b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm2
 352:	c5 fc 10 5c b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm3
 358:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 35f:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 366:	48 83 c6 18          	add    $0x18,%rsi
 36a:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 36e:	48 39 ce             	cmp    %rcx,%rsi
 371:	7c cd                	jl     340 <.omp_outlined.+0x120>
 373:	eb 8f                	jmp    304 <.omp_outlined.+0xe4>
...
0000000000000380 <_Z6enablev>:
 ...
 395:	b9 fd ff ff ff       	mov    $0xfffffffd,%ecx

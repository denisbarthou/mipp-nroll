...
0000000000000220 <.omp_outlined.>:
 ...
 2eb:	41 b9 00 01 00 00    	mov    $0x100,%r9d
 ...
 3a0:	c5 fc 10 24 9a       	vmovups (%rdx,%rbx,4),%ymm4
 3a5:	c4 e2 5d b8 8c 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm4,%ymm1
 3ac:	ff ff ff 
 3af:	c4 e2 5d b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm4,%ymm0
 3b6:	ff ff ff 
 3b9:	c5 fc 10 6c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm5
 3bf:	c5 fc 10 74 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm6
 3c5:	c5 fc 10 7c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm7
 3cb:	c5 7c 10 84 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm8
 3d2:	00 00 
 3d4:	c5 7c 10 8c 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm9
 3db:	00 00 
 3dd:	c5 7c 10 94 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm10
 3e4:	00 00 
 3e6:	c5 fc 10 9c 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm3
 3ed:	00 00 
 3ef:	c5 fc 10 94 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm2
 3f6:	00 00 
 3f8:	c4 e2 55 b8 8c 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm5,%ymm1
 3ff:	ff ff ff 
 402:	c4 e2 55 b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm5,%ymm0
 409:	ff ff ff 
 40c:	c4 e2 4d b8 8c 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm6,%ymm1
 413:	ff ff ff 
 416:	c4 e2 4d b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm6,%ymm0
 41d:	ff ff ff 
 420:	c4 e2 45 b8 8c 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm7,%ymm1
 427:	ff ff ff 
 42a:	c4 e2 45 b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm7,%ymm0
 431:	ff ff ff 
 434:	c4 e2 3d b8 4c 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm8,%ymm1
 43b:	c4 e2 3d b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm8,%ymm0
 442:	c4 e2 35 b8 4c 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm9,%ymm1
 449:	c4 e2 35 b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm9,%ymm0
 450:	c4 e2 2d b8 4c 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm10,%ymm1
 457:	c4 e2 2d b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm10,%ymm0
 45e:	c4 e2 65 b8 4c 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm3,%ymm1
 465:	c4 e2 65 b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm3,%ymm0
 46c:	c4 e2 6d b8 4c 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm2,%ymm1
 473:	c4 e2 6d b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm2,%ymm0
 479:	48 83 c3 48          	add    $0x48,%rbx
 47d:	48 39 cb             	cmp    %rcx,%rbx
 480:	0f 8c 1a ff ff ff    	jl     3a0 <.omp_outlined.+0x180>
 486:	e9 8d fe ff ff       	jmpq   318 <.omp_outlined.+0xf8>
 48b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000000490 <_Z6enablev>:
 490:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 497 <_Z6enablev+0x7>
 497:	7d 03                	jge    49c <_Z6enablev+0xc>
 499:	31 c0                	xor    %eax,%eax
 49b:	c3                   	retq   
 49c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 4a3 <_Z6enablev+0x13>
 4a3:	b8 48 00 00 00       	mov    $0x48,%eax
 4a8:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 4ad:	0f 45 c8             	cmovne %eax,%ecx
 4b0:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4b6 <_Z6enablev+0x26>
 4b6:	0f 9e c0             	setle  %al
 4b9:	c3                   	retq   

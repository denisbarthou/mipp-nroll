...
0000000000000210 <.omp_outlined.>:
 ...
 2e2:	00 
 2e3:	48 8d ac 86 80 01 00 	lea    0x180(%rsi,%rax,4),%rbp
 2ea:	00 
 ...
 330:	c5 fc 10 84 b5 80 fe 	vmovups -0x180(%rbp,%rsi,4),%ymm0
 337:	ff ff 
 339:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 33f:	c5 fc 10 94 b5 a0 fe 	vmovups -0x160(%rbp,%rsi,4),%ymm2
 346:	ff ff 
 348:	c5 fc 10 9c b5 c0 fe 	vmovups -0x140(%rbp,%rsi,4),%ymm3
 34f:	ff ff 
 351:	c5 fc 10 a4 b5 e0 fe 	vmovups -0x120(%rbp,%rsi,4),%ymm4
 358:	ff ff 
 35a:	c5 fc 10 ac b5 00 ff 	vmovups -0x100(%rbp,%rsi,4),%ymm5
 361:	ff ff 
 363:	c5 fc 10 b4 b5 20 ff 	vmovups -0xe0(%rbp,%rsi,4),%ymm6
 36a:	ff ff 
 36c:	c5 fc 10 bc b5 40 ff 	vmovups -0xc0(%rbp,%rsi,4),%ymm7
 373:	ff ff 
 375:	c5 7c 10 84 b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm8
 37c:	ff ff 
 37e:	c5 7c 10 4c b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm9
 384:	c5 7c 10 54 b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm10
 38a:	c5 7c 10 5c b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm11
 390:	c5 7c 10 64 b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm12
 396:	c5 7c 10 6c b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm13
 39c:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 3a3:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 3aa:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 3b1:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 3b8:	00 00 00 
 3bb:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 3c2:	00 00 00 
 3c5:	c4 e2 45 b8 84 b2 c0 	vfmadd231ps 0xc0(%rdx,%rsi,4),%ymm7,%ymm0
 3cc:	00 00 00 
 3cf:	c4 e2 3d b8 84 b2 e0 	vfmadd231ps 0xe0(%rdx,%rsi,4),%ymm8,%ymm0
 3d6:	00 00 00 
 3d9:	c4 e2 35 b8 84 b2 00 	vfmadd231ps 0x100(%rdx,%rsi,4),%ymm9,%ymm0
 3e0:	01 00 00 
 3e3:	c4 e2 2d b8 84 b2 20 	vfmadd231ps 0x120(%rdx,%rsi,4),%ymm10,%ymm0
 3ea:	01 00 00 
 3ed:	c4 e2 25 b8 84 b2 40 	vfmadd231ps 0x140(%rdx,%rsi,4),%ymm11,%ymm0
 3f4:	01 00 00 
 3f7:	c4 e2 1d b8 84 b2 60 	vfmadd231ps 0x160(%rdx,%rsi,4),%ymm12,%ymm0
 3fe:	01 00 00 
 401:	c4 e2 15 b8 84 b2 80 	vfmadd231ps 0x180(%rdx,%rsi,4),%ymm13,%ymm0
 408:	01 00 00 
 40b:	48 83 c6 68          	add    $0x68,%rsi
 40f:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 413:	48 39 ce             	cmp    %rcx,%rsi
 416:	0f 8c 14 ff ff ff    	jl     330 <.omp_outlined.+0x120>
 41c:	e9 d3 fe ff ff       	jmpq   2f4 <.omp_outlined.+0xe4>
 421:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 428:	0f 1f 84 00 00 00 00 
 42f:	00 

0000000000000430 <_Z6enablev>:
 430:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 437 <_Z6enablev+0x7>
 437:	7e 1e                	jle    457 <_Z6enablev+0x27>
 439:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 440 <_Z6enablev+0x10>
 440:	b8 68 00 00 00       	mov    $0x68,%eax
 445:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 44a:	0f 45 c8             	cmovne %eax,%ecx
 44d:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 453 <_Z6enablev+0x23>
 453:	0f 9e c0             	setle  %al
 456:	c3                   	retq   

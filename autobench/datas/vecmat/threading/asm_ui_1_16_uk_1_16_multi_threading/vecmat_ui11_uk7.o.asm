...
0000000000000220 <.omp_outlined.>:
 ...
 54a:	c4 62 25 b8 94 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm11,%ymm10
 551:	ff ff ff 
 554:	c4 62 25 b8 8c 88 40 	vfmadd231ps -0xc0(%rax,%rcx,4),%ymm11,%ymm9
 55b:	ff ff ff 
 55e:	c4 e2 25 b8 b4 c8 40 	vfmadd231ps -0xc0(%rax,%rcx,8),%ymm11,%ymm6
 565:	ff ff ff 
 568:	48 8d 84 07 40 ff ff 	lea    -0xc0(%rdi,%rax,1),%rax
 56f:	ff 
 ...
 5c6:	c4 62 25 b8 94 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm11,%ymm10
 5cd:	ff ff ff 
 ...
 635:	c4 62 25 b8 54 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm11,%ymm10
 63c:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 642:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 646:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 64c:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 652:	48 01 f8             	add    %rdi,%rax
 655:	48 01 f8             	add    %rdi,%rax
 658:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 65e:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 664:	48 01 f8             	add    %rdi,%rax
 667:	48 01 f8             	add    %rdi,%rax
 66a:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 670:	48 01 f8             	add    %rdi,%rax
 673:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 679:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 67d:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 683:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 687:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 68d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 691:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 697:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 69b:	c5 7c 10 5c b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm11
 6a1:	c4 62 25 b8 54 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm11,%ymm10
 6a8:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 6ae:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6b2:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 6b8:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 6be:	48 01 f8             	add    %rdi,%rax
 6c1:	48 01 f8             	add    %rdi,%rax
 6c4:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 6ca:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 6d0:	48 01 f8             	add    %rdi,%rax
 6d3:	48 01 f8             	add    %rdi,%rax
 6d6:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 6dc:	48 01 f8             	add    %rdi,%rax
 6df:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 6e5:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6e9:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 6ef:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6f3:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 6f9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6fd:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 703:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 707:	c5 7c 10 9c b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm11
 70e:	00 00 
 710:	c4 62 25 b8 54 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm11,%ymm10
 717:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 71d:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 721:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 727:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 72d:	48 01 f8             	add    %rdi,%rax
 730:	48 01 f8             	add    %rdi,%rax
 733:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 739:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 73f:	48 01 f8             	add    %rdi,%rax
 742:	48 01 f8             	add    %rdi,%rax
 745:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 74b:	48 01 f8             	add    %rdi,%rax
 74e:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 754:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 758:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 75e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 762:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 768:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 76c:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 772:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 776:	c5 7c 10 9c b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm11
 77d:	00 00 
 77f:	c4 62 25 b8 54 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm11,%ymm10
 786:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 78c:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 790:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 796:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 79c:	48 01 f8             	add    %rdi,%rax
 79f:	48 01 f8             	add    %rdi,%rax
 7a2:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 7a8:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 7ae:	48 01 f8             	add    %rdi,%rax
 7b1:	48 01 f8             	add    %rdi,%rax
 7b4:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 7ba:	48 01 f8             	add    %rdi,%rax
 7bd:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 7c3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7c7:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 7cd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7d1:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 7d7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7db:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 7e1:	48 01 f8             	add    %rdi,%rax
 7e4:	c5 7c 10 9c b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm11
 7eb:	00 00 
 7ed:	c4 62 25 b8 54 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm11,%ymm10
 7f4:	48 83 c6 38          	add    $0x38,%rsi
 7f8:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 7fe:	48 01 d8             	add    %rbx,%rax
 801:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 807:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 80d:	48 01 f8             	add    %rdi,%rax
 810:	48 01 f8             	add    %rdi,%rax
 813:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 819:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 81f:	48 01 f8             	add    %rdi,%rax
 822:	48 01 f8             	add    %rdi,%rax
 825:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 82b:	48 01 f8             	add    %rdi,%rax
 82e:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 834:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 838:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 83e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 842:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 848:	48 01 f8             	add    %rdi,%rax
 84b:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 851:	48 39 ce             	cmp    %rcx,%rsi
 854:	0f 8c e6 fc ff ff    	jl     540 <.omp_outlined.+0x320>
 85a:	e9 01 fb ff ff       	jmpq   360 <.omp_outlined.+0x140>
 85f:	90                   	nop
...
0000000000000870 <_Z9n_reg_maxv>:
 870:	b8 4d 00 00 00       	mov    $0x4d,%eax
 875:	c3                   	retq   

...
0000000000000210 <.omp_outlined.>:
 ...
 2ca:	5d                   	pop    %rbp
 2cb:	c3                   	retq   
 2cc:	4d 8b 0c 24          	mov    (%r12),%r9
 2d0:	48 63 0d 00 00 00 00 	movslq 0x0(%rip),%rcx        # 2d7 <.omp_outlined.+0xc7>
 2d7:	49 8b 55 00          	mov    0x0(%r13),%rdx
 ...
 2f3:	49 83 c1 20          	add    $0x20,%r9
 2f7:	01 ed                	add    %ebp,%ebp
 2f9:	eb 6a                	jmp    365 <.omp_outlined.+0x155>
 ...
 395:	c4 e2 6d b8 4c 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm2,%ymm1
 39c:	c4 e2 6d b8 44 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm2,%ymm0
 3a3:	c5 fc 10 5c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm3
 3a9:	c4 e2 65 b8 0c 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm1
 3af:	c4 e2 65 b8 04 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm0
 3b5:	48 83 c3 10          	add    $0x10,%rbx
 3b9:	48 39 cb             	cmp    %rcx,%rbx
 3bc:	7c d2                	jl     390 <.omp_outlined.+0x180>
 3be:	e9 45 ff ff ff       	jmpq   308 <.omp_outlined.+0xf8>
 3c3:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 3ca:	84 00 00 00 00 00 
...
00000000000003d0 <_Z6enablev>:
 ...
 3e8:	b9 fe ff ff ff       	mov    $0xfffffffe,%ecx

...
0000000000000210 <.omp_outlined.>:
 ...
 33e:	00 
 33f:	48 8d ac f0 e0 00 00 	lea    0xe0(%rax,%rsi,8),%rbp
 346:	00 
 347:	48 05 e0 00 00 00    	add    $0xe0,%rax
 34d:	4b 8d 34 bf          	lea    (%r15,%r15,4),%rsi
 351:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
 356:	48 89 74 24 20       	mov    %rsi,0x20(%rsp)
 35b:	e9 b0 01 00 00       	jmpq   510 <.omp_outlined.+0x300>
 ...
 4c2:	c4 c3 fd 01 d3 4e    	vpermpd $0x4e,%ymm11,%ymm2
 4c8:	c5 a4 58 d2          	vaddps %ymm2,%ymm11,%ymm2
 ...
 558:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
 ...
 57b:	c4 22 2d b8 8c 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm10,%ymm9
 582:	ff ff ff 
 585:	c4 02 2d b8 84 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm10,%ymm8
 58c:	ff ff ff 
 58f:	4b 8d 84 17 20 ff ff 	lea    -0xe0(%r15,%r10,1),%rax
 596:	ff 
 597:	c4 c2 2d b8 bc ca 20 	vfmadd231ps -0xe0(%r10,%rcx,8),%ymm10,%ymm7
 59e:	ff ff ff 
 5a1:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 5a7:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 5ad:	48 01 f8             	add    %rdi,%rax
 5b0:	48 01 f8             	add    %rdi,%rax
 5b3:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 5b9:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 5bf:	48 01 f8             	add    %rdi,%rax
 5c2:	48 01 f8             	add    %rdi,%rax
 5c5:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 5cb:	48 01 f8             	add    %rdi,%rax
 5ce:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 5d4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5d8:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 5de:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5e2:	c4 21 7c 10 54 8a 20 	vmovups 0x20(%rdx,%r9,4),%ymm10
 5e9:	c4 22 2d b8 8c 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm10,%ymm9
 5f0:	ff ff ff 
 5f3:	c4 02 2d b8 84 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm10,%ymm8
 5fa:	ff ff ff 
 5fd:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 603:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 607:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 60d:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 613:	48 01 f8             	add    %rdi,%rax
 616:	48 01 f8             	add    %rdi,%rax
 619:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 61f:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 625:	48 01 f8             	add    %rdi,%rax
 628:	48 01 f8             	add    %rdi,%rax
 62b:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 631:	48 01 f8             	add    %rdi,%rax
 634:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 63a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 63e:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 644:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 648:	c4 21 7c 10 54 8a 40 	vmovups 0x40(%rdx,%r9,4),%ymm10
 64f:	c4 22 2d b8 8c 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm10,%ymm9
 656:	ff ff ff 
 659:	c4 02 2d b8 84 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm10,%ymm8
 660:	ff ff ff 
 663:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 669:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 66d:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 673:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 679:	48 01 f8             	add    %rdi,%rax
 67c:	48 01 f8             	add    %rdi,%rax
 67f:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 685:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 68b:	48 01 f8             	add    %rdi,%rax
 68e:	48 01 f8             	add    %rdi,%rax
 691:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 697:	48 01 f8             	add    %rdi,%rax
 69a:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 6a0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6a4:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 6aa:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6ae:	c4 21 7c 10 54 8a 60 	vmovups 0x60(%rdx,%r9,4),%ymm10
 6b5:	c4 22 2d b8 4c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm10,%ymm9
 6bc:	c4 02 2d b8 44 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm10,%ymm8
 6c3:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 6c9:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6cd:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 6d3:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 6d9:	48 01 f8             	add    %rdi,%rax
 6dc:	48 01 f8             	add    %rdi,%rax
 6df:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 6e5:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 6eb:	48 01 f8             	add    %rdi,%rax
 6ee:	48 01 f8             	add    %rdi,%rax
 6f1:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 6f7:	48 01 f8             	add    %rdi,%rax
 6fa:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 700:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 704:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 70a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 70e:	c4 21 7c 10 94 8a 80 	vmovups 0x80(%rdx,%r9,4),%ymm10
 715:	00 00 00 
 718:	c4 22 2d b8 4c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm10,%ymm9
 71f:	c4 02 2d b8 44 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm10,%ymm8
 726:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 72c:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 730:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 736:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 73c:	48 01 f8             	add    %rdi,%rax
 73f:	48 01 f8             	add    %rdi,%rax
 742:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 748:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 74e:	48 01 f8             	add    %rdi,%rax
 751:	48 01 f8             	add    %rdi,%rax
 754:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 75a:	48 01 f8             	add    %rdi,%rax
 75d:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 763:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 767:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 76d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 771:	c4 21 7c 10 94 8a a0 	vmovups 0xa0(%rdx,%r9,4),%ymm10
 778:	00 00 00 
 77b:	c4 22 2d b8 4c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm10,%ymm9
 782:	c4 02 2d b8 44 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm10,%ymm8
 789:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 78f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 793:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 799:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 79f:	48 01 f8             	add    %rdi,%rax
 7a2:	48 01 f8             	add    %rdi,%rax
 7a5:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 7ab:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 7b1:	48 01 f8             	add    %rdi,%rax
 7b4:	48 01 f8             	add    %rdi,%rax
 7b7:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 7bd:	48 01 f8             	add    %rdi,%rax
 7c0:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 7c6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7ca:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 7d0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7d4:	c4 21 7c 10 94 8a c0 	vmovups 0xc0(%rdx,%r9,4),%ymm10
 7db:	00 00 00 
 7de:	c4 22 2d b8 4c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm10,%ymm9
 7e5:	c4 02 2d b8 44 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm10,%ymm8
 7ec:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 7f2:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 7f6:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 7fc:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 802:	48 01 f8             	add    %rdi,%rax
 805:	48 01 f8             	add    %rdi,%rax
 808:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 80e:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 814:	48 01 f8             	add    %rdi,%rax
 817:	48 01 f8             	add    %rdi,%rax
 81a:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 820:	48 01 f8             	add    %rdi,%rax
 823:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 829:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 82d:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 833:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 837:	c4 21 7c 10 94 8a e0 	vmovups 0xe0(%rdx,%r9,4),%ymm10
 83e:	00 00 00 
 841:	c4 22 2d b8 4c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm10,%ymm9
 848:	c4 02 2d b8 04 88    	vfmadd231ps (%r8,%r9,4),%ymm10,%ymm8
 84e:	49 83 c1 40          	add    $0x40,%r9
 852:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 858:	48 01 d8             	add    %rbx,%rax
 85b:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 861:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 867:	48 01 f8             	add    %rdi,%rax
 86a:	48 01 f8             	add    %rdi,%rax
 86d:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 873:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 879:	48 01 f8             	add    %rdi,%rax
 87c:	48 01 f8             	add    %rdi,%rax
 87f:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 885:	48 01 f8             	add    %rdi,%rax
 888:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 88e:	48 01 f8             	add    %rdi,%rax
 891:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 897:	49 39 c9             	cmp    %rcx,%r9
 89a:	0f 8c d0 fc ff ff    	jl     570 <.omp_outlined.+0x360>
 8a0:	e9 e6 fa ff ff       	jmpq   38b <.omp_outlined.+0x17b>
 8a5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 8ac:	00 00 00 00 
...
00000000000008c0 <_Z9n_reg_maxv>:
 8c0:	b8 50 00 00 00       	mov    $0x50,%eax
 8c5:	c3                   	retq   

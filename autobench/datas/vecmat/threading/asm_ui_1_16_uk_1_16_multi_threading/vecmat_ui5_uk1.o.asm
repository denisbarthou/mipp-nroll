...
0000000000000220 <.omp_outlined.>:
 ...
 2f3:	49 8b 55 00          	mov    0x0(%r13),%rdx
 2f7:	4d 8b 14 24          	mov    (%r12),%r10
 2fb:	4c 63 c5             	movslq %ebp,%r8
 2fe:	48 89 ce             	mov    %rcx,%rsi
 301:	48 8d 1c 8d 00 00 00 	lea    0x0(,%rcx,4),%rbx
 308:	00 
 309:	49 0f af f6          	imul   %r14,%rsi
 30d:	4c 8d 0c 9b          	lea    (%rbx,%rbx,4),%r9
 311:	48 8d 2c b6          	lea    (%rsi,%rsi,4),%rbp
 315:	48 c1 e5 02          	shl    $0x2,%rbp
 319:	49 03 2f             	add    (%r15),%rbp
 31c:	e9 dc 00 00 00       	jmpq   3fd <.omp_outlined.+0x1dd>
 ...
 41f:	90                   	nop
 420:	48 8d 7c b5 00       	lea    0x0(%rbp,%rsi,4),%rdi
 425:	c5 fc 10 2c b2       	vmovups (%rdx,%rsi,4),%ymm5
 42a:	c4 e2 55 b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm5,%ymm4
 431:	48 83 c6 08          	add    $0x8,%rsi
 435:	48 8d 04 1f          	lea    (%rdi,%rbx,1),%rax
 439:	c4 e2 55 b8 1c 8f    	vfmadd231ps (%rdi,%rcx,4),%ymm5,%ymm3
 43f:	c4 e2 55 b8 04 cf    	vfmadd231ps (%rdi,%rcx,8),%ymm5,%ymm0
 445:	48 01 d8             	add    %rbx,%rax
 448:	c4 e2 55 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm5,%ymm2
 44e:	c4 e2 55 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm5,%ymm1
 454:	48 39 ce             	cmp    %rcx,%rsi
 457:	7c c7                	jl     420 <.omp_outlined.+0x200>
 459:	e9 e6 fe ff ff       	jmpq   344 <.omp_outlined.+0x124>
 45e:	66 90                	xchg   %ax,%ax

0000000000000460 <_Z6enablev>:
 460:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 467 <_Z6enablev+0x7>
 467:	7d 03                	jge    46c <_Z6enablev+0xc>
 469:	31 c0                	xor    %eax,%eax
 46b:	c3                   	retq   
 46c:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 473 <_Z6enablev+0x13>
 473:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 477:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 47d <_Z6enablev+0x1d>
 47d:	0f 9e c0             	setle  %al
 480:	c3                   	retq   

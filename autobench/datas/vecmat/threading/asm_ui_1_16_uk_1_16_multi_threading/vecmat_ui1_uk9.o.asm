...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d ac 86 00 01 00 	lea    0x100(%rsi,%rax,4),%rbp
 2fa:	00 
 ...
 340:	c5 fc 10 84 b5 00 ff 	vmovups -0x100(%rbp,%rsi,4),%ymm0
 347:	ff ff 
 349:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34f:	c5 fc 10 94 b5 20 ff 	vmovups -0xe0(%rbp,%rsi,4),%ymm2
 356:	ff ff 
 358:	c5 fc 10 9c b5 40 ff 	vmovups -0xc0(%rbp,%rsi,4),%ymm3
 35f:	ff ff 
 361:	c5 fc 10 a4 b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm4
 368:	ff ff 
 36a:	c5 fc 10 6c b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm5
 370:	c5 fc 10 74 b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm6
 376:	c5 fc 10 7c b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm7
 37c:	c5 7c 10 44 b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm8
 382:	c5 7c 10 4c b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm9
 388:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 38f:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 396:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 39d:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 3a4:	00 00 00 
 3a7:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 3ae:	00 00 00 
 3b1:	c4 e2 45 b8 84 b2 c0 	vfmadd231ps 0xc0(%rdx,%rsi,4),%ymm7,%ymm0
 3b8:	00 00 00 
 3bb:	c4 e2 3d b8 84 b2 e0 	vfmadd231ps 0xe0(%rdx,%rsi,4),%ymm8,%ymm0
 3c2:	00 00 00 
 3c5:	c4 e2 35 b8 84 b2 00 	vfmadd231ps 0x100(%rdx,%rsi,4),%ymm9,%ymm0
 3cc:	01 00 00 
 3cf:	48 83 c6 48          	add    $0x48,%rsi
 3d3:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 3d7:	48 39 ce             	cmp    %rcx,%rsi
 3da:	0f 8c 60 ff ff ff    	jl     340 <.omp_outlined.+0x120>
 3e0:	e9 1f ff ff ff       	jmpq   304 <.omp_outlined.+0xe4>
 3e5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 3ec:	00 00 00 00 

00000000000003f0 <_Z6enablev>:
 3f0:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 3f7 <_Z6enablev+0x7>
 3f7:	7e 1e                	jle    417 <_Z6enablev+0x27>
 3f9:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 400 <_Z6enablev+0x10>
 400:	b8 48 00 00 00       	mov    $0x48,%eax
 405:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 40a:	0f 45 c8             	cmovne %eax,%ecx
 40d:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 413 <_Z6enablev+0x23>
 413:	0f 9e c0             	setle  %al
 416:	c3                   	retq   

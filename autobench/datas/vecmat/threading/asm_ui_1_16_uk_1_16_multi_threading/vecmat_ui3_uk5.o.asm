...
0000000000000230 <.omp_outlined.>:
 ...
 323:	48 8d ac be 80 00 00 	lea    0x80(%rsi,%rdi,4),%rbp
 32a:	00 
 ...
 340:	48 8d bc be 80 00 00 	lea    0x80(%rsi,%rdi,4),%rdi
 347:	00 
 348:	48 8d b4 9e 80 00 00 	lea    0x80(%rsi,%rbx,4),%rsi
 34f:	00 
 ...
 40b:	00 00 00 00 00 
 410:	c5 fc 10 1c 9a       	vmovups (%rdx,%rbx,4),%ymm3
 415:	c4 e2 65 b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm3,%ymm2
 41c:	c4 e2 65 b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm3,%ymm1
 423:	c4 e2 65 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm3,%ymm0
 42a:	c5 fc 10 64 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm4
 430:	c5 fc 10 6c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm5
 436:	c5 fc 10 74 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm6
 43c:	c5 fc 10 bc 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm7
 443:	00 00 
 445:	c4 e2 5d b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm4,%ymm2
 44c:	c4 e2 5d b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm4,%ymm1
 453:	c4 e2 5d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm4,%ymm0
 45a:	c4 e2 55 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm5,%ymm2
 461:	c4 e2 55 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm5,%ymm1
 468:	c4 e2 55 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm5,%ymm0
 46f:	c4 e2 4d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm6,%ymm2
 476:	c4 e2 4d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm6,%ymm1
 47d:	c4 e2 4d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm6,%ymm0
 484:	c4 e2 45 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm7,%ymm2
 48b:	c4 e2 45 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm7,%ymm1
 491:	c4 e2 45 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm7,%ymm0
 497:	48 83 c3 28          	add    $0x28,%rbx
 49b:	48 39 cb             	cmp    %rcx,%rbx
 49e:	0f 8c 6c ff ff ff    	jl     410 <.omp_outlined.+0x1e0>
 4a4:	e9 c3 fe ff ff       	jmpq   36c <.omp_outlined.+0x13c>
 4a9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

00000000000004b0 <_Z6enablev>:
 4b0:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 4b7 <_Z6enablev+0x7>
 4b7:	7d 03                	jge    4bc <_Z6enablev+0xc>
 4b9:	31 c0                	xor    %eax,%eax
 4bb:	c3                   	retq   
 4bc:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 4c3 <_Z6enablev+0x13>
 4c3:	b8 28 00 00 00       	mov    $0x28,%eax
 4c8:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx

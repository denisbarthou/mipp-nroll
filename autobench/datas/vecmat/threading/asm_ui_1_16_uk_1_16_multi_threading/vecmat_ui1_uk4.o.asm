...
0000000000000210 <.omp_outlined.>:
 ...
 2e2:	00 
 2e3:	48 8d 6c 86 60       	lea    0x60(%rsi,%rax,4),%rbp
 2e8:	eb 3c                	jmp    326 <.omp_outlined.+0x116>
 ...
 330:	c5 fc 10 44 b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm0
 336:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 33c:	c5 fc 10 54 b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm2
 342:	c5 fc 10 5c b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm3
 348:	c5 fc 10 64 b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm4
 34e:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 355:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 35c:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 363:	48 83 c6 20          	add    $0x20,%rsi
 367:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 36b:	48 39 ce             	cmp    %rcx,%rsi
 36e:	7c c0                	jl     330 <.omp_outlined.+0x120>
 370:	eb 82                	jmp    2f4 <.omp_outlined.+0xe4>
...
0000000000000380 <_Z6enablev>:
 380:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 387 <_Z6enablev+0x7>
 387:	7e 1e                	jle    3a7 <_Z6enablev+0x27>
 389:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 390 <_Z6enablev+0x10>
 390:	b8 20 00 00 00       	mov    $0x20,%eax
 395:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 39a:	0f 45 c8             	cmovne %eax,%ecx
 39d:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3a3 <_Z6enablev+0x23>
 3a3:	0f 9e c0             	setle  %al
 3a6:	c3                   	retq   

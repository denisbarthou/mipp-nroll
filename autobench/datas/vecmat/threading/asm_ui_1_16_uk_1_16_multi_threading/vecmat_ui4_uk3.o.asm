...
0000000000000220 <.omp_outlined.>:
 ...
 496:	c4 82 5d b8 5c ac c0 	vfmadd231ps -0x40(%r12,%r13,4),%ymm4,%ymm3
 49d:	c4 82 5d b8 54 af c0 	vfmadd231ps -0x40(%r15,%r13,4),%ymm4,%ymm2
 4a4:	c4 82 5d b8 4c a9 c0 	vfmadd231ps -0x40(%r9,%r13,4),%ymm4,%ymm1
 4ab:	c4 82 5d b8 44 a8 c0 	vfmadd231ps -0x40(%r8,%r13,4),%ymm4,%ymm0
 4b2:	c4 a1 7c 10 6c aa 20 	vmovups 0x20(%rdx,%r13,4),%ymm5
 4b9:	c4 a1 7c 10 74 aa 40 	vmovups 0x40(%rdx,%r13,4),%ymm6
 4c0:	c4 82 55 b8 5c ac e0 	vfmadd231ps -0x20(%r12,%r13,4),%ymm5,%ymm3
 4c7:	c4 82 55 b8 54 af e0 	vfmadd231ps -0x20(%r15,%r13,4),%ymm5,%ymm2
 4ce:	c4 82 55 b8 4c a9 e0 	vfmadd231ps -0x20(%r9,%r13,4),%ymm5,%ymm1
 4d5:	c4 82 55 b8 44 a8 e0 	vfmadd231ps -0x20(%r8,%r13,4),%ymm5,%ymm0
 4dc:	c4 82 4d b8 1c ac    	vfmadd231ps (%r12,%r13,4),%ymm6,%ymm3
 4e2:	c4 82 4d b8 14 af    	vfmadd231ps (%r15,%r13,4),%ymm6,%ymm2
 4e8:	c4 82 4d b8 0c a9    	vfmadd231ps (%r9,%r13,4),%ymm6,%ymm1
 4ee:	c4 82 4d b8 04 a8    	vfmadd231ps (%r8,%r13,4),%ymm6,%ymm0
 4f4:	49 83 c5 18          	add    $0x18,%r13
 4f8:	49 39 cd             	cmp    %rcx,%r13
 4fb:	7c 93                	jl     490 <.omp_outlined.+0x270>
 4fd:	e9 51 fe ff ff       	jmpq   353 <.omp_outlined.+0x133>
 502:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 509:	1f 84 00 00 00 00 00 

0000000000000510 <_Z6enablev>:
 510:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 517 <_Z6enablev+0x7>

...
0000000000000210 <.omp_outlined.>:
 ...
 321:	be 40 01 00 00       	mov    $0x140,%esi
 ...
 49b:	00 00 00 00 00 
 4a0:	c4 21 7c 10 24 aa    	vmovups (%rdx,%r13,4),%ymm12
 4a6:	c4 82 1d b8 9c ac c0 	vfmadd231ps -0x140(%r12,%r13,4),%ymm12,%ymm3
 4ad:	fe ff ff 
 4b0:	c4 82 1d b8 94 a9 c0 	vfmadd231ps -0x140(%r9,%r13,4),%ymm12,%ymm2
 4b7:	fe ff ff 
 4ba:	c4 82 1d b8 8c af c0 	vfmadd231ps -0x140(%r15,%r13,4),%ymm12,%ymm1
 4c1:	fe ff ff 
 4c4:	c4 82 1d b8 84 a8 c0 	vfmadd231ps -0x140(%r8,%r13,4),%ymm12,%ymm0
 4cb:	fe ff ff 
 4ce:	c4 21 7c 10 6c aa 20 	vmovups 0x20(%rdx,%r13,4),%ymm13
 4d5:	c4 21 7c 10 74 aa 40 	vmovups 0x40(%rdx,%r13,4),%ymm14
 4dc:	c4 21 7c 10 5c aa 60 	vmovups 0x60(%rdx,%r13,4),%ymm11
 4e3:	c4 21 7c 10 94 aa 80 	vmovups 0x80(%rdx,%r13,4),%ymm10
 4ea:	00 00 00 
 4ed:	c4 21 7c 10 8c aa a0 	vmovups 0xa0(%rdx,%r13,4),%ymm9
 4f4:	00 00 00 
 4f7:	c4 21 7c 10 84 aa c0 	vmovups 0xc0(%rdx,%r13,4),%ymm8
 4fe:	00 00 00 
 501:	c4 a1 7c 10 bc aa e0 	vmovups 0xe0(%rdx,%r13,4),%ymm7
 508:	00 00 00 
 50b:	c4 a1 7c 10 b4 aa 00 	vmovups 0x100(%rdx,%r13,4),%ymm6
 512:	01 00 00 
 515:	c4 a1 7c 10 ac aa 20 	vmovups 0x120(%rdx,%r13,4),%ymm5
 51c:	01 00 00 
 51f:	c4 a1 7c 10 a4 aa 40 	vmovups 0x140(%rdx,%r13,4),%ymm4
 526:	01 00 00 
 529:	c4 82 15 b8 9c ac e0 	vfmadd231ps -0x120(%r12,%r13,4),%ymm13,%ymm3
 530:	fe ff ff 
 533:	c4 82 15 b8 94 a9 e0 	vfmadd231ps -0x120(%r9,%r13,4),%ymm13,%ymm2
 53a:	fe ff ff 
 53d:	c4 82 15 b8 8c af e0 	vfmadd231ps -0x120(%r15,%r13,4),%ymm13,%ymm1
 544:	fe ff ff 
 547:	c4 82 15 b8 84 a8 e0 	vfmadd231ps -0x120(%r8,%r13,4),%ymm13,%ymm0
 54e:	fe ff ff 
 551:	c4 82 0d b8 9c ac 00 	vfmadd231ps -0x100(%r12,%r13,4),%ymm14,%ymm3
 558:	ff ff ff 
 55b:	c4 82 0d b8 94 a9 00 	vfmadd231ps -0x100(%r9,%r13,4),%ymm14,%ymm2
 562:	ff ff ff 
 565:	c4 82 0d b8 8c af 00 	vfmadd231ps -0x100(%r15,%r13,4),%ymm14,%ymm1
 56c:	ff ff ff 
 56f:	c4 82 0d b8 84 a8 00 	vfmadd231ps -0x100(%r8,%r13,4),%ymm14,%ymm0
 576:	ff ff ff 
 579:	c4 82 25 b8 9c ac 20 	vfmadd231ps -0xe0(%r12,%r13,4),%ymm11,%ymm3
 580:	ff ff ff 
 583:	c4 82 25 b8 94 a9 20 	vfmadd231ps -0xe0(%r9,%r13,4),%ymm11,%ymm2
 58a:	ff ff ff 
 58d:	c4 82 25 b8 8c af 20 	vfmadd231ps -0xe0(%r15,%r13,4),%ymm11,%ymm1
 594:	ff ff ff 
 597:	c4 82 25 b8 84 a8 20 	vfmadd231ps -0xe0(%r8,%r13,4),%ymm11,%ymm0
 59e:	ff ff ff 
 5a1:	c4 82 2d b8 9c ac 40 	vfmadd231ps -0xc0(%r12,%r13,4),%ymm10,%ymm3
 5a8:	ff ff ff 
 5ab:	c4 82 2d b8 94 a9 40 	vfmadd231ps -0xc0(%r9,%r13,4),%ymm10,%ymm2
 5b2:	ff ff ff 
 5b5:	c4 82 2d b8 8c af 40 	vfmadd231ps -0xc0(%r15,%r13,4),%ymm10,%ymm1
 5bc:	ff ff ff 
 5bf:	c4 82 2d b8 84 a8 40 	vfmadd231ps -0xc0(%r8,%r13,4),%ymm10,%ymm0
 5c6:	ff ff ff 
 5c9:	c4 82 35 b8 9c ac 60 	vfmadd231ps -0xa0(%r12,%r13,4),%ymm9,%ymm3
 5d0:	ff ff ff 
 5d3:	c4 82 35 b8 94 a9 60 	vfmadd231ps -0xa0(%r9,%r13,4),%ymm9,%ymm2
 5da:	ff ff ff 
 5dd:	c4 82 35 b8 8c af 60 	vfmadd231ps -0xa0(%r15,%r13,4),%ymm9,%ymm1
 5e4:	ff ff ff 
 5e7:	c4 82 35 b8 84 a8 60 	vfmadd231ps -0xa0(%r8,%r13,4),%ymm9,%ymm0
 5ee:	ff ff ff 
 5f1:	c4 82 3d b8 5c ac 80 	vfmadd231ps -0x80(%r12,%r13,4),%ymm8,%ymm3
 5f8:	c4 82 3d b8 54 a9 80 	vfmadd231ps -0x80(%r9,%r13,4),%ymm8,%ymm2
 5ff:	c4 82 3d b8 4c af 80 	vfmadd231ps -0x80(%r15,%r13,4),%ymm8,%ymm1
 606:	c4 82 3d b8 44 a8 80 	vfmadd231ps -0x80(%r8,%r13,4),%ymm8,%ymm0
 60d:	c4 82 45 b8 5c ac a0 	vfmadd231ps -0x60(%r12,%r13,4),%ymm7,%ymm3
 614:	c4 82 45 b8 54 a9 a0 	vfmadd231ps -0x60(%r9,%r13,4),%ymm7,%ymm2
 61b:	c4 82 45 b8 4c af a0 	vfmadd231ps -0x60(%r15,%r13,4),%ymm7,%ymm1
 622:	c4 82 45 b8 44 a8 a0 	vfmadd231ps -0x60(%r8,%r13,4),%ymm7,%ymm0
 629:	c4 82 4d b8 5c ac c0 	vfmadd231ps -0x40(%r12,%r13,4),%ymm6,%ymm3
 630:	c4 82 4d b8 54 a9 c0 	vfmadd231ps -0x40(%r9,%r13,4),%ymm6,%ymm2
 637:	c4 82 4d b8 4c af c0 	vfmadd231ps -0x40(%r15,%r13,4),%ymm6,%ymm1
 63e:	c4 82 4d b8 44 a8 c0 	vfmadd231ps -0x40(%r8,%r13,4),%ymm6,%ymm0
 645:	c4 82 55 b8 5c ac e0 	vfmadd231ps -0x20(%r12,%r13,4),%ymm5,%ymm3
 64c:	c4 82 55 b8 54 a9 e0 	vfmadd231ps -0x20(%r9,%r13,4),%ymm5,%ymm2
 653:	c4 82 55 b8 4c af e0 	vfmadd231ps -0x20(%r15,%r13,4),%ymm5,%ymm1
 65a:	c4 82 55 b8 44 a8 e0 	vfmadd231ps -0x20(%r8,%r13,4),%ymm5,%ymm0
 661:	c4 82 5d b8 1c ac    	vfmadd231ps (%r12,%r13,4),%ymm4,%ymm3
 667:	c4 82 5d b8 14 a9    	vfmadd231ps (%r9,%r13,4),%ymm4,%ymm2
 66d:	c4 82 5d b8 0c af    	vfmadd231ps (%r15,%r13,4),%ymm4,%ymm1
 673:	c4 82 5d b8 04 a8    	vfmadd231ps (%r8,%r13,4),%ymm4,%ymm0
 679:	49 83 c5 58          	add    $0x58,%r13
 67d:	4d 39 d5             	cmp    %r10,%r13
 680:	0f 8c 1a fe ff ff    	jl     4a0 <.omp_outlined.+0x290>
 686:	e9 c5 fc ff ff       	jmpq   350 <.omp_outlined.+0x140>
...
00000000000006a0 <_Z9n_reg_maxv>:
 6a0:	b8 2c 00 00 00       	mov    $0x2c,%eax
 6a5:	c3                   	retq   

...
0000000000000220 <.omp_outlined.>:
 ...
 34e:	00 
 34f:	48 8d ac f0 60 01 00 	lea    0x160(%rax,%rsi,8),%rbp
 356:	00 
 357:	48 05 60 01 00 00    	add    $0x160,%rax
 ...
 58b:	c4 22 2d b8 8c 8d a0 	vfmadd231ps -0x160(%rbp,%r9,4),%ymm10,%ymm9
 592:	fe ff ff 
 595:	c4 02 2d b8 84 88 a0 	vfmadd231ps -0x160(%r8,%r9,4),%ymm10,%ymm8
 59c:	fe ff ff 
 59f:	4b 8d 84 17 a0 fe ff 	lea    -0x160(%r15,%r10,1),%rax
 5a6:	ff 
 5a7:	c4 c2 2d b8 bc ca a0 	vfmadd231ps -0x160(%r10,%rcx,8),%ymm10,%ymm7
 5ae:	fe ff ff 
 ...
 5f9:	c4 22 2d b8 8c 8d c0 	vfmadd231ps -0x140(%rbp,%r9,4),%ymm10,%ymm9
 600:	fe ff ff 
 603:	c4 02 2d b8 84 88 c0 	vfmadd231ps -0x140(%r8,%r9,4),%ymm10,%ymm8
 60a:	fe ff ff 
 ...
 65f:	c4 22 2d b8 8c 8d e0 	vfmadd231ps -0x120(%rbp,%r9,4),%ymm10,%ymm9
 666:	fe ff ff 
 669:	c4 02 2d b8 84 88 e0 	vfmadd231ps -0x120(%r8,%r9,4),%ymm10,%ymm8
 670:	fe ff ff 
 ...
 6c5:	c4 22 2d b8 8c 8d 00 	vfmadd231ps -0x100(%rbp,%r9,4),%ymm10,%ymm9
 6cc:	ff ff ff 
 6cf:	c4 02 2d b8 84 88 00 	vfmadd231ps -0x100(%r8,%r9,4),%ymm10,%ymm8
 6d6:	ff ff ff 
 ...
 72b:	00 00 00 
 72e:	c4 22 2d b8 8c 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm10,%ymm9
 735:	ff ff ff 
 738:	c4 02 2d b8 84 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm10,%ymm8
 73f:	ff ff ff 
 ...
 794:	00 00 00 
 797:	c4 22 2d b8 8c 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm10,%ymm9
 79e:	ff ff ff 
 7a1:	c4 02 2d b8 84 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm10,%ymm8
 7a8:	ff ff ff 
 ...
 7fd:	00 00 00 
 800:	c4 22 2d b8 8c 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm10,%ymm9
 807:	ff ff ff 
 80a:	c4 02 2d b8 84 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm10,%ymm8
 811:	ff ff ff 
 ...
 866:	00 00 00 
 869:	c4 22 2d b8 4c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm10,%ymm9
 870:	c4 02 2d b8 44 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm10,%ymm8
 877:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 87d:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 881:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 887:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 88d:	48 01 f8             	add    %rdi,%rax
 890:	48 01 f8             	add    %rdi,%rax
 893:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 899:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 89f:	48 01 f8             	add    %rdi,%rax
 8a2:	48 01 f8             	add    %rdi,%rax
 8a5:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 8ab:	48 01 f8             	add    %rdi,%rax
 8ae:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 8b4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8b8:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 8be:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8c2:	c4 21 7c 10 94 8a 00 	vmovups 0x100(%rdx,%r9,4),%ymm10
 8c9:	01 00 00 
 8cc:	c4 22 2d b8 4c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm10,%ymm9
 8d3:	c4 02 2d b8 44 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm10,%ymm8
 8da:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 8e0:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 8e4:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 8ea:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 8f0:	48 01 f8             	add    %rdi,%rax
 8f3:	48 01 f8             	add    %rdi,%rax
 8f6:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 8fc:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 902:	48 01 f8             	add    %rdi,%rax
 905:	48 01 f8             	add    %rdi,%rax
 908:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 90e:	48 01 f8             	add    %rdi,%rax
 911:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 917:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 91b:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 921:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 925:	c4 21 7c 10 94 8a 20 	vmovups 0x120(%rdx,%r9,4),%ymm10
 92c:	01 00 00 
 92f:	c4 22 2d b8 4c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm10,%ymm9
 936:	c4 02 2d b8 44 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm10,%ymm8
 93d:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 943:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 947:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 94d:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 953:	48 01 f8             	add    %rdi,%rax
 956:	48 01 f8             	add    %rdi,%rax
 959:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 95f:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 965:	48 01 f8             	add    %rdi,%rax
 968:	48 01 f8             	add    %rdi,%rax
 96b:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 971:	48 01 f8             	add    %rdi,%rax
 974:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 97a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 97e:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 984:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 988:	c4 21 7c 10 94 8a 40 	vmovups 0x140(%rdx,%r9,4),%ymm10
 98f:	01 00 00 
 992:	c4 22 2d b8 4c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm10,%ymm9
 999:	c4 02 2d b8 44 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm10,%ymm8
 9a0:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 9a6:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9aa:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 9b0:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 9b6:	48 01 f8             	add    %rdi,%rax
 9b9:	48 01 f8             	add    %rdi,%rax
 9bc:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 9c2:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 9c8:	48 01 f8             	add    %rdi,%rax
 9cb:	48 01 f8             	add    %rdi,%rax
 9ce:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 9d4:	48 01 f8             	add    %rdi,%rax
 9d7:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 9dd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9e1:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 9e7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9eb:	c4 21 7c 10 94 8a 60 	vmovups 0x160(%rdx,%r9,4),%ymm10
 9f2:	01 00 00 
 9f5:	c4 22 2d b8 4c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm10,%ymm9
 9fc:	c4 02 2d b8 04 88    	vfmadd231ps (%r8,%r9,4),%ymm10,%ymm8
 a02:	49 83 c1 60          	add    $0x60,%r9
 a06:	c4 e2 2d b8 3c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm7
 a0c:	48 01 d8             	add    %rbx,%rax
 a0f:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 a15:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 a1b:	48 01 f8             	add    %rdi,%rax
 a1e:	48 01 f8             	add    %rdi,%rax
 a21:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 a27:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 a2d:	48 01 f8             	add    %rdi,%rax
 a30:	48 01 f8             	add    %rdi,%rax
 a33:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 a39:	48 01 f8             	add    %rdi,%rax
 a3c:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 a42:	48 01 f8             	add    %rdi,%rax
 a45:	c4 62 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm11
 a4b:	49 39 c9             	cmp    %rcx,%r9
 a4e:	0f 8c 2c fb ff ff    	jl     580 <.omp_outlined.+0x360>
 a54:	e9 42 f9 ff ff       	jmpq   39b <.omp_outlined.+0x17b>
...
0000000000000a70 <_Z9n_reg_maxv>:
 a70:	b8 78 00 00 00       	mov    $0x78,%eax
 a75:	c3                   	retq   

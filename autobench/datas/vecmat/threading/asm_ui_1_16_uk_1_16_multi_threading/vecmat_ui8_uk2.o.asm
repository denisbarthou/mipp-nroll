...
0000000000000210 <.omp_outlined.>:
 ...
 380:	c4 41 28 57 d2       	vxorps %xmm10,%xmm10,%xmm10
 ...
 4d6:	c4 63 7d 19 d0 01    	vextractf128 $0x1,%ymm10,%xmm0
 4dc:	48 63 f0             	movslq %eax,%rsi
 4df:	8b 44 24 40          	mov    0x40(%rsp),%eax
 4e3:	c5 a8 58 c0          	vaddps %xmm0,%xmm10,%xmm0
 ...
 61f:	90                   	nop
 620:	c5 7c 10 04 9a       	vmovups (%rdx,%rbx,4),%ymm8
 625:	c4 e2 3d b8 7c 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm8,%ymm7
 62c:	c4 c2 3d b8 74 9d e0 	vfmadd231ps -0x20(%r13,%rbx,4),%ymm8,%ymm6
 633:	c4 c2 3d b8 6c 9c e0 	vfmadd231ps -0x20(%r12,%rbx,4),%ymm8,%ymm5
 63a:	c4 c2 3d b8 64 9f e0 	vfmadd231ps -0x20(%r15,%rbx,4),%ymm8,%ymm4
 641:	c4 c2 3d b8 5c 9b e0 	vfmadd231ps -0x20(%r11,%rbx,4),%ymm8,%ymm3
 648:	c4 c2 3d b8 54 9a e0 	vfmadd231ps -0x20(%r10,%rbx,4),%ymm8,%ymm2
 64f:	c4 c2 3d b8 4c 99 e0 	vfmadd231ps -0x20(%r9,%rbx,4),%ymm8,%ymm1
 656:	c4 42 3d b8 54 98 e0 	vfmadd231ps -0x20(%r8,%rbx,4),%ymm8,%ymm10
 65d:	c5 7c 10 4c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm9
 663:	c4 e2 35 b8 3c 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm9,%ymm7
 669:	c4 c2 35 b8 74 9d 00 	vfmadd231ps 0x0(%r13,%rbx,4),%ymm9,%ymm6
 670:	c4 c2 35 b8 2c 9c    	vfmadd231ps (%r12,%rbx,4),%ymm9,%ymm5
 676:	c4 c2 35 b8 24 9f    	vfmadd231ps (%r15,%rbx,4),%ymm9,%ymm4
 67c:	c4 c2 35 b8 1c 9b    	vfmadd231ps (%r11,%rbx,4),%ymm9,%ymm3
 682:	c4 c2 35 b8 14 9a    	vfmadd231ps (%r10,%rbx,4),%ymm9,%ymm2
 688:	c4 c2 35 b8 0c 99    	vfmadd231ps (%r9,%rbx,4),%ymm9,%ymm1
 68e:	c4 42 35 b8 14 98    	vfmadd231ps (%r8,%rbx,4),%ymm9,%ymm10
 694:	48 83 c3 10          	add    $0x10,%rbx
 698:	4c 39 f3             	cmp    %r14,%rbx
 69b:	7c 83                	jl     620 <.omp_outlined.+0x410>
 69d:	e9 ff fc ff ff       	jmpq   3a1 <.omp_outlined.+0x191>
 6a2:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 6a9:	1f 84 00 00 00 00 00 

00000000000006b0 <_Z6enablev>:
 6b0:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # 6b7 <_Z6enablev+0x7>

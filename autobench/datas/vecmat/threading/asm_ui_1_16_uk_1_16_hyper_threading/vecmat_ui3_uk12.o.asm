...
0000000000000220 <.omp_outlined.>:
 ...
 313:	48 8d ac be 60 01 00 	lea    0x160(%rsi,%rdi,4),%rbp
 31a:	00 
 ...
 330:	48 8d bc be 60 01 00 	lea    0x160(%rsi,%rdi,4),%rdi
 337:	00 
 338:	48 8d b4 9e 60 01 00 	lea    0x160(%rsi,%rbx,4),%rsi
 33f:	00 
 ...
 3fb:	00 00 00 00 00 
 400:	c5 7c 10 1c 9a       	vmovups (%rdx,%rbx,4),%ymm11
 405:	c4 e2 25 b8 94 9d a0 	vfmadd231ps -0x160(%rbp,%rbx,4),%ymm11,%ymm2
 40c:	fe ff ff 
 40f:	c4 e2 25 b8 8c 9f a0 	vfmadd231ps -0x160(%rdi,%rbx,4),%ymm11,%ymm1
 416:	fe ff ff 
 419:	c4 e2 25 b8 84 9e a0 	vfmadd231ps -0x160(%rsi,%rbx,4),%ymm11,%ymm0
 420:	fe ff ff 
 423:	c5 7c 10 64 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm12
 429:	c5 7c 10 6c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm13
 42f:	c5 7c 10 74 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm14
 435:	c5 7c 10 94 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm10
 43c:	00 00 
 43e:	c5 7c 10 8c 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm9
 445:	00 00 
 447:	c5 7c 10 84 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm8
 44e:	00 00 
 450:	c5 fc 10 bc 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm7
 457:	00 00 
 459:	c5 fc 10 b4 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm6
 460:	00 00 
 462:	c5 fc 10 ac 9a 20 01 	vmovups 0x120(%rdx,%rbx,4),%ymm5
 469:	00 00 
 46b:	c5 fc 10 a4 9a 40 01 	vmovups 0x140(%rdx,%rbx,4),%ymm4
 472:	00 00 
 474:	c5 fc 10 9c 9a 60 01 	vmovups 0x160(%rdx,%rbx,4),%ymm3
 47b:	00 00 
 47d:	c4 e2 1d b8 94 9d c0 	vfmadd231ps -0x140(%rbp,%rbx,4),%ymm12,%ymm2
 484:	fe ff ff 
 487:	c4 e2 1d b8 8c 9f c0 	vfmadd231ps -0x140(%rdi,%rbx,4),%ymm12,%ymm1
 48e:	fe ff ff 
 491:	c4 e2 1d b8 84 9e c0 	vfmadd231ps -0x140(%rsi,%rbx,4),%ymm12,%ymm0
 498:	fe ff ff 
 49b:	c4 e2 15 b8 94 9d e0 	vfmadd231ps -0x120(%rbp,%rbx,4),%ymm13,%ymm2
 4a2:	fe ff ff 
 4a5:	c4 e2 15 b8 8c 9f e0 	vfmadd231ps -0x120(%rdi,%rbx,4),%ymm13,%ymm1
 4ac:	fe ff ff 
 4af:	c4 e2 15 b8 84 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm13,%ymm0
 4b6:	fe ff ff 
 4b9:	c4 e2 0d b8 94 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm14,%ymm2
 4c0:	ff ff ff 
 4c3:	c4 e2 0d b8 8c 9f 00 	vfmadd231ps -0x100(%rdi,%rbx,4),%ymm14,%ymm1
 4ca:	ff ff ff 
 4cd:	c4 e2 0d b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm14,%ymm0
 4d4:	ff ff ff 
 4d7:	c4 e2 2d b8 94 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm10,%ymm2
 4de:	ff ff ff 
 4e1:	c4 e2 2d b8 8c 9f 20 	vfmadd231ps -0xe0(%rdi,%rbx,4),%ymm10,%ymm1
 4e8:	ff ff ff 
 4eb:	c4 e2 2d b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm10,%ymm0
 4f2:	ff ff ff 
 4f5:	c4 e2 35 b8 94 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm9,%ymm2
 4fc:	ff ff ff 
 4ff:	c4 e2 35 b8 8c 9f 40 	vfmadd231ps -0xc0(%rdi,%rbx,4),%ymm9,%ymm1
 506:	ff ff ff 
 509:	c4 e2 35 b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm9,%ymm0
 510:	ff ff ff 
 513:	c4 e2 3d b8 94 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm8,%ymm2
 51a:	ff ff ff 
 51d:	c4 e2 3d b8 8c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm8,%ymm1
 524:	ff ff ff 
 527:	c4 e2 3d b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm8,%ymm0
 52e:	ff ff ff 
 531:	c4 e2 45 b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm7,%ymm2
 538:	c4 e2 45 b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm7,%ymm1
 53f:	c4 e2 45 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm7,%ymm0
 546:	c4 e2 4d b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm6,%ymm2
 54d:	c4 e2 4d b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm6,%ymm1
 554:	c4 e2 4d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm6,%ymm0
 55b:	c4 e2 55 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm5,%ymm2
 562:	c4 e2 55 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm5,%ymm1
 569:	c4 e2 55 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm5,%ymm0
 570:	c4 e2 5d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm4,%ymm2
 577:	c4 e2 5d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm4,%ymm1
 57e:	c4 e2 5d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm4,%ymm0
 585:	c4 e2 65 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm3,%ymm2
 58c:	c4 e2 65 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm1
 592:	c4 e2 65 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm0
 598:	48 83 c3 60          	add    $0x60,%rbx
 59c:	48 39 cb             	cmp    %rcx,%rbx
 59f:	0f 8c 5b fe ff ff    	jl     400 <.omp_outlined.+0x1e0>
 5a5:	e9 b2 fd ff ff       	jmpq   35c <.omp_outlined.+0x13c>

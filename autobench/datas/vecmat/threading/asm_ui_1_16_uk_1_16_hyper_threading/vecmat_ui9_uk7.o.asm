...
0000000000000220 <.omp_outlined.>:
 ...
 31c:	48 8d ac b0 c0 00 00 	lea    0xc0(%rax,%rsi,4),%rbp
 323:	00 
 ...
 33e:	00 00 
 340:	c4 41 30 57 c9       	vxorps %xmm9,%xmm9,%xmm9
 ...
 46c:	c4 c3 fd 01 d1 4e    	vpermpd $0x4e,%ymm9,%ymm2
 472:	c5 b4 58 d2          	vaddps %ymm2,%ymm9,%ymm2
 ...
 4e8:	c4 41 30 57 c9       	vxorps %xmm9,%xmm9,%xmm9
 4ed:	0f 1f 00             	nopl   (%rax)
 4f0:	48 8d 44 b5 00       	lea    0x0(%rbp,%rsi,4),%rax
 4f5:	c5 fc 10 04 b2       	vmovups (%rdx,%rsi,4),%ymm0
 4fa:	c5 7c 10 54 b2 20    	vmovups 0x20(%rdx,%rsi,4),%ymm10
 500:	c5 7c 10 5c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm11
 506:	c5 7c 10 7c b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm15
 50c:	c4 62 7d b8 84 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm0,%ymm8
 513:	ff ff ff 
 516:	c5 7c 10 a4 b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm12
 51d:	00 00 
 51f:	c5 7c 10 ac b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm13
 526:	00 00 
 528:	c5 7c 10 b4 b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm14
 52f:	00 00 
 531:	c4 e2 7d b8 bc 88 40 	vfmadd231ps -0xc0(%rax,%rcx,4),%ymm0,%ymm7
 538:	ff ff ff 
 53b:	c4 e2 7d b8 a4 c8 40 	vfmadd231ps -0xc0(%rax,%rcx,8),%ymm0,%ymm4
 542:	ff ff ff 
 545:	48 8d 84 03 40 ff ff 	lea    -0xc0(%rbx,%rax,1),%rax
 54c:	ff 
 54d:	48 01 d8             	add    %rbx,%rax
 550:	c4 e2 7d b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm0,%ymm6
 556:	c4 e2 7d b8 2c c8    	vfmadd231ps (%rax,%rcx,8),%ymm0,%ymm5
 55c:	48 01 d8             	add    %rbx,%rax
 55f:	48 01 d8             	add    %rbx,%rax
 562:	c4 62 2d b8 84 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm10,%ymm8
 569:	ff ff ff 
 56c:	c4 e2 7d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm0,%ymm2
 572:	48 01 d8             	add    %rbx,%rax
 575:	c4 e2 7d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm0,%ymm3
 57b:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 57f:	c4 e2 7d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm0,%ymm1
 585:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 589:	c4 62 7d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm0,%ymm9
 58f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 593:	c4 62 25 b8 44 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm11,%ymm8
 59a:	c4 e2 2d b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm7
 5a0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5a4:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 5aa:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 5b0:	48 01 d8             	add    %rbx,%rax
 5b3:	48 01 d8             	add    %rbx,%rax
 5b6:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 5bc:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 5c2:	48 01 d8             	add    %rbx,%rax
 5c5:	c4 62 05 b8 44 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm15,%ymm8
 5cc:	48 01 d8             	add    %rbx,%rax
 5cf:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 5d5:	48 01 d8             	add    %rbx,%rax
 5d8:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 5de:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5e2:	c4 62 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm9
 5e8:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5ec:	c4 62 1d b8 44 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm12,%ymm8
 5f3:	c4 e2 25 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm11,%ymm7
 5f9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5fd:	c4 e2 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm4
 603:	c4 e2 25 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm6
 609:	48 01 d8             	add    %rbx,%rax
 60c:	48 01 d8             	add    %rbx,%rax
 60f:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 615:	c4 e2 25 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm2
 61b:	48 01 d8             	add    %rbx,%rax
 61e:	c4 62 15 b8 44 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm13,%ymm8
 625:	48 01 d8             	add    %rbx,%rax
 628:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 62e:	48 01 d8             	add    %rbx,%rax
 631:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 637:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 63b:	c4 62 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm9
 641:	48 01 d8             	add    %rbx,%rax
 644:	c4 62 0d b8 44 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm14,%ymm8
 64b:	48 83 c6 38          	add    $0x38,%rsi
 64f:	c4 e2 05 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm15,%ymm7
 655:	48 01 f8             	add    %rdi,%rax
 658:	c4 e2 05 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm15,%ymm4
 65e:	c4 e2 05 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm15,%ymm6
 664:	48 01 d8             	add    %rbx,%rax
 667:	48 01 d8             	add    %rbx,%rax
 66a:	c4 e2 05 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm15,%ymm5
 670:	c4 e2 05 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm15,%ymm2
 676:	48 01 d8             	add    %rbx,%rax
 679:	48 01 d8             	add    %rbx,%rax
 67c:	c4 e2 05 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm15,%ymm3
 682:	48 01 d8             	add    %rbx,%rax
 685:	c4 e2 05 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm15,%ymm1
 68b:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 68f:	c4 62 05 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm15,%ymm9
 695:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 699:	c4 e2 1d b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm12,%ymm7
 69f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6a3:	c4 e2 1d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm4
 6a9:	c4 e2 1d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm6
 6af:	48 01 d8             	add    %rbx,%rax
 6b2:	48 01 d8             	add    %rbx,%rax
 6b5:	c4 e2 1d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm5
 6bb:	c4 e2 1d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm2
 6c1:	48 01 d8             	add    %rbx,%rax
 6c4:	48 01 d8             	add    %rbx,%rax
 6c7:	c4 e2 1d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm3
 6cd:	48 01 d8             	add    %rbx,%rax
 6d0:	c4 e2 1d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm1
 6d6:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6da:	c4 62 1d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm9
 6e0:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6e4:	c4 e2 15 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm13,%ymm7
 6ea:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6ee:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 6f4:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 6fa:	48 01 d8             	add    %rbx,%rax
 6fd:	48 01 d8             	add    %rbx,%rax
 700:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 706:	c4 e2 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm2
 70c:	48 01 d8             	add    %rbx,%rax
 70f:	48 01 d8             	add    %rbx,%rax
 712:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 718:	48 01 d8             	add    %rbx,%rax
 71b:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 721:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 725:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 72b:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 72f:	c4 e2 0d b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm14,%ymm7
 735:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 739:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 73f:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 745:	48 01 d8             	add    %rbx,%rax
 748:	48 01 d8             	add    %rbx,%rax
 74b:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 751:	c4 e2 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm2
 757:	48 01 d8             	add    %rbx,%rax
 75a:	48 01 d8             	add    %rbx,%rax
 75d:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 763:	48 01 d8             	add    %rbx,%rax
 766:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 76c:	48 01 d8             	add    %rbx,%rax
 76f:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 775:	48 39 ce             	cmp    %rcx,%rsi
 778:	0f 8c 72 fd ff ff    	jl     4f0 <.omp_outlined.+0x2d0>
 77e:	e9 e3 fb ff ff       	jmpq   366 <.omp_outlined.+0x146>
...
00000000000007a0 <_Z9n_reg_maxv>:
 7a0:	b8 3f 00 00 00       	mov    $0x3f,%eax
 7a5:	c3                   	retq   

...
0000000000000220 <.omp_outlined.>:
 ...
 42a:	c4 e2 55 b8 a4 b5 c0 	vfmadd231ps -0x140(%rbp,%rsi,4),%ymm5,%ymm4
 431:	fe ff ff 
 434:	c5 fc 10 74 b2 20    	vmovups 0x20(%rdx,%rsi,4),%ymm6
 43a:	c5 fc 10 7c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm7
 440:	c5 7c 10 44 b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm8
 446:	c5 7c 10 8c b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm9
 44d:	00 00 
 44f:	c5 7c 10 94 b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm10
 456:	00 00 
 458:	c5 7c 10 9c b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm11
 45f:	00 00 
 461:	c5 7c 10 a4 b2 e0 00 	vmovups 0xe0(%rdx,%rsi,4),%ymm12
 468:	00 00 
 46a:	c5 7c 10 ac b2 00 01 	vmovups 0x100(%rdx,%rsi,4),%ymm13
 471:	00 00 
 473:	c5 7c 10 b4 b2 20 01 	vmovups 0x120(%rdx,%rsi,4),%ymm14
 47a:	00 00 
 47c:	c5 7c 10 bc b2 40 01 	vmovups 0x140(%rdx,%rsi,4),%ymm15
 483:	00 00 
 485:	c4 e2 55 b8 9c 88 c0 	vfmadd231ps -0x140(%rax,%rcx,4),%ymm5,%ymm3
 48c:	fe ff ff 
 48f:	c4 e2 55 b8 84 c8 c0 	vfmadd231ps -0x140(%rax,%rcx,8),%ymm5,%ymm0
 496:	fe ff ff 
 499:	48 8d 84 03 c0 fe ff 	lea    -0x140(%rbx,%rax,1),%rax
 4a0:	ff 
 4a1:	48 01 d8             	add    %rbx,%rax
 4a4:	c4 e2 55 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm5,%ymm2
 4aa:	c4 e2 55 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm5,%ymm1
 4b0:	48 01 d8             	add    %rbx,%rax
 4b3:	48 01 d8             	add    %rbx,%rax
 4b6:	c4 e2 4d b8 a4 b5 e0 	vfmadd231ps -0x120(%rbp,%rsi,4),%ymm6,%ymm4
 4bd:	fe ff ff 
 4c0:	c4 e2 4d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm3
 4c6:	48 01 f8             	add    %rdi,%rax
 4c9:	c4 e2 4d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm0
 4cf:	c4 e2 4d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm6,%ymm2
 4d5:	48 01 d8             	add    %rbx,%rax
 4d8:	48 01 d8             	add    %rbx,%rax
 4db:	c4 e2 45 b8 a4 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm7,%ymm4
 4e2:	ff ff ff 
 4e5:	c4 e2 4d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm1
 4eb:	48 01 d8             	add    %rbx,%rax
 4ee:	c4 e2 45 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm3
 4f4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4f8:	c4 e2 45 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm0
 4fe:	c4 e2 45 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm2
 504:	48 01 d8             	add    %rbx,%rax
 507:	48 01 d8             	add    %rbx,%rax
 50a:	c4 e2 3d b8 a4 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm8,%ymm4
 511:	ff ff ff 
 514:	c4 e2 45 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm1
 51a:	48 01 d8             	add    %rbx,%rax
 51d:	c4 e2 3d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm3
 523:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 527:	c4 e2 3d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm0
 52d:	c4 e2 3d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm2
 533:	48 01 d8             	add    %rbx,%rax
 536:	48 01 d8             	add    %rbx,%rax
 539:	c4 e2 35 b8 a4 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm9,%ymm4
 540:	ff ff ff 
 543:	c4 e2 3d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm1
 549:	48 01 d8             	add    %rbx,%rax
 54c:	c4 e2 35 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm3
 552:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 556:	c4 e2 35 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm0
 55c:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 562:	48 01 d8             	add    %rbx,%rax
 565:	48 01 d8             	add    %rbx,%rax
 568:	c4 e2 2d b8 a4 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm10,%ymm4
 56f:	ff ff ff 
 572:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 578:	48 01 d8             	add    %rbx,%rax
 57b:	c4 e2 2d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm3
 581:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 585:	c4 e2 2d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm0
 58b:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 591:	48 01 d8             	add    %rbx,%rax
 594:	48 01 d8             	add    %rbx,%rax
 597:	c4 e2 25 b8 64 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm11,%ymm4
 59e:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 5a4:	48 01 d8             	add    %rbx,%rax
 5a7:	c4 e2 25 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm11,%ymm3
 5ad:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5b1:	c4 e2 25 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm0
 5b7:	c4 e2 25 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm2
 5bd:	48 01 d8             	add    %rbx,%rax
 5c0:	48 01 d8             	add    %rbx,%rax
 5c3:	c4 e2 1d b8 64 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm12,%ymm4
 5ca:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 5d0:	48 01 d8             	add    %rbx,%rax
 5d3:	c4 e2 1d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm12,%ymm3
 5d9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5dd:	c4 e2 1d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm0
 5e3:	c4 e2 1d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm2
 5e9:	48 01 d8             	add    %rbx,%rax
 5ec:	48 01 d8             	add    %rbx,%rax
 5ef:	c4 e2 15 b8 64 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm13,%ymm4
 5f6:	c4 e2 1d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm1
 5fc:	48 01 d8             	add    %rbx,%rax
 5ff:	c4 e2 15 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm13,%ymm3
 605:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 609:	c4 e2 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm0
 60f:	c4 e2 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm2
 615:	48 01 d8             	add    %rbx,%rax
 618:	48 01 d8             	add    %rbx,%rax
 61b:	c4 e2 0d b8 64 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm14,%ymm4
 622:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 628:	48 01 d8             	add    %rbx,%rax
 62b:	c4 e2 0d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm14,%ymm3
 631:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 635:	c4 e2 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm0
 63b:	c4 e2 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm2
 641:	48 01 d8             	add    %rbx,%rax
 644:	48 01 d8             	add    %rbx,%rax
 647:	c4 e2 05 b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm15,%ymm4
 64e:	48 83 c6 58          	add    $0x58,%rsi
 652:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 658:	48 01 d8             	add    %rbx,%rax
 65b:	c4 e2 05 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm15,%ymm3
 661:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 665:	c4 e2 05 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm15,%ymm0
 66b:	c4 e2 05 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm15,%ymm2
 671:	48 01 d8             	add    %rbx,%rax
 674:	48 01 d8             	add    %rbx,%rax
 677:	c4 e2 05 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm15,%ymm1
 67d:	48 39 ce             	cmp    %rcx,%rsi
 680:	0f 8c 9a fd ff ff    	jl     420 <.omp_outlined.+0x200>
 686:	e9 b9 fc ff ff       	jmpq   344 <.omp_outlined.+0x124>
...
00000000000006a0 <_Z9n_reg_maxv>:
 6a0:	b8 37 00 00 00       	mov    $0x37,%eax
 6a5:	c3                   	retq   

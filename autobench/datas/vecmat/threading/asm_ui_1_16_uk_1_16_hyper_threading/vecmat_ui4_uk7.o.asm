...
0000000000000220 <.omp_outlined.>:
 ...
 331:	be c0 00 00 00       	mov    $0xc0,%esi
 ...
 4ab:	00 00 00 00 00 
 4b0:	c4 21 7c 10 04 aa    	vmovups (%rdx,%r13,4),%ymm8
 4b6:	c4 82 3d b8 9c ac 40 	vfmadd231ps -0xc0(%r12,%r13,4),%ymm8,%ymm3
 4bd:	ff ff ff 
 4c0:	c4 82 3d b8 94 af 40 	vfmadd231ps -0xc0(%r15,%r13,4),%ymm8,%ymm2
 4c7:	ff ff ff 
 4ca:	c4 82 3d b8 8c a9 40 	vfmadd231ps -0xc0(%r9,%r13,4),%ymm8,%ymm1
 4d1:	ff ff ff 
 4d4:	c4 82 3d b8 84 a8 40 	vfmadd231ps -0xc0(%r8,%r13,4),%ymm8,%ymm0
 4db:	ff ff ff 
 4de:	c4 21 7c 10 4c aa 20 	vmovups 0x20(%rdx,%r13,4),%ymm9
 4e5:	c4 21 7c 10 54 aa 40 	vmovups 0x40(%rdx,%r13,4),%ymm10
 4ec:	c4 a1 7c 10 7c aa 60 	vmovups 0x60(%rdx,%r13,4),%ymm7
 4f3:	c4 a1 7c 10 b4 aa 80 	vmovups 0x80(%rdx,%r13,4),%ymm6
 4fa:	00 00 00 
 4fd:	c4 a1 7c 10 ac aa a0 	vmovups 0xa0(%rdx,%r13,4),%ymm5
 504:	00 00 00 
 507:	c4 a1 7c 10 a4 aa c0 	vmovups 0xc0(%rdx,%r13,4),%ymm4
 50e:	00 00 00 
 511:	c4 82 35 b8 9c ac 60 	vfmadd231ps -0xa0(%r12,%r13,4),%ymm9,%ymm3
 518:	ff ff ff 
 51b:	c4 82 35 b8 94 af 60 	vfmadd231ps -0xa0(%r15,%r13,4),%ymm9,%ymm2
 522:	ff ff ff 
 525:	c4 82 35 b8 8c a9 60 	vfmadd231ps -0xa0(%r9,%r13,4),%ymm9,%ymm1
 52c:	ff ff ff 
 52f:	c4 82 35 b8 84 a8 60 	vfmadd231ps -0xa0(%r8,%r13,4),%ymm9,%ymm0
 536:	ff ff ff 
 539:	c4 82 2d b8 5c ac 80 	vfmadd231ps -0x80(%r12,%r13,4),%ymm10,%ymm3
 540:	c4 82 2d b8 54 af 80 	vfmadd231ps -0x80(%r15,%r13,4),%ymm10,%ymm2
 547:	c4 82 2d b8 4c a9 80 	vfmadd231ps -0x80(%r9,%r13,4),%ymm10,%ymm1
 54e:	c4 82 2d b8 44 a8 80 	vfmadd231ps -0x80(%r8,%r13,4),%ymm10,%ymm0
 555:	c4 82 45 b8 5c ac a0 	vfmadd231ps -0x60(%r12,%r13,4),%ymm7,%ymm3
 55c:	c4 82 45 b8 54 af a0 	vfmadd231ps -0x60(%r15,%r13,4),%ymm7,%ymm2
 563:	c4 82 45 b8 4c a9 a0 	vfmadd231ps -0x60(%r9,%r13,4),%ymm7,%ymm1
 56a:	c4 82 45 b8 44 a8 a0 	vfmadd231ps -0x60(%r8,%r13,4),%ymm7,%ymm0
 571:	c4 82 4d b8 5c ac c0 	vfmadd231ps -0x40(%r12,%r13,4),%ymm6,%ymm3
 578:	c4 82 4d b8 54 af c0 	vfmadd231ps -0x40(%r15,%r13,4),%ymm6,%ymm2
 57f:	c4 82 4d b8 4c a9 c0 	vfmadd231ps -0x40(%r9,%r13,4),%ymm6,%ymm1
 586:	c4 82 4d b8 44 a8 c0 	vfmadd231ps -0x40(%r8,%r13,4),%ymm6,%ymm0
 58d:	c4 82 55 b8 5c ac e0 	vfmadd231ps -0x20(%r12,%r13,4),%ymm5,%ymm3
 594:	c4 82 55 b8 54 af e0 	vfmadd231ps -0x20(%r15,%r13,4),%ymm5,%ymm2
 59b:	c4 82 55 b8 4c a9 e0 	vfmadd231ps -0x20(%r9,%r13,4),%ymm5,%ymm1
 5a2:	c4 82 55 b8 44 a8 e0 	vfmadd231ps -0x20(%r8,%r13,4),%ymm5,%ymm0
 5a9:	c4 82 5d b8 1c ac    	vfmadd231ps (%r12,%r13,4),%ymm4,%ymm3
 5af:	c4 82 5d b8 14 af    	vfmadd231ps (%r15,%r13,4),%ymm4,%ymm2
 5b5:	c4 82 5d b8 0c a9    	vfmadd231ps (%r9,%r13,4),%ymm4,%ymm1
 5bb:	c4 82 5d b8 04 a8    	vfmadd231ps (%r8,%r13,4),%ymm4,%ymm0
 5c1:	49 83 c5 38          	add    $0x38,%r13
 5c5:	4d 39 d5             	cmp    %r10,%r13
 5c8:	0f 8c e2 fe ff ff    	jl     4b0 <.omp_outlined.+0x290>
 5ce:	e9 8d fd ff ff       	jmpq   360 <.omp_outlined.+0x140>
 5d3:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 5da:	84 00 00 00 00 00 

00000000000005e0 <_Z6enablev>:
 5e0:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 5e7 <_Z6enablev+0x7>
 5e7:	7d 03                	jge    5ec <_Z6enablev+0xc>
 5e9:	31 c0                	xor    %eax,%eax
 5eb:	c3                   	retq   
 5ec:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 5f3 <_Z6enablev+0x13>
 5f3:	b8 38 00 00 00       	mov    $0x38,%eax
 5f8:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 5fd:	0f 45 c8             	cmovne %eax,%ecx
 600:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 606 <_Z6enablev+0x26>
 606:	0f 9e c0             	setle  %al
 609:	c3                   	retq   
 60a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)

0000000000000610 <_Z9n_reg_maxv>:
 610:	b8 1c 00 00 00       	mov    $0x1c,%eax
 615:	c3                   	retq   

...
0000000000000220 <.omp_outlined.>:
 ...
 31f:	48 8d 6c 38 60       	lea    0x60(%rax,%rdi,1),%rbp
 324:	48 8d 04 c9          	lea    (%rcx,%rcx,8),%rax
 328:	48 8d 3c 8d 00 00 00 	lea    0x0(,%rcx,4),%rdi
 32f:	00 
 330:	4c 8d 0c 40          	lea    (%rax,%rax,2),%r9
 334:	48 8d 04 bf          	lea    (%rdi,%rdi,4),%rax
 338:	49 01 c9             	add    %rcx,%r9
 33b:	48 29 c3             	sub    %rax,%rbx
 33e:	e9 28 01 00 00       	jmpq   46b <.omp_outlined.+0x24b>
 ...
 45e:	4d 39 c5             	cmp    %r8,%r13
 461:	4d 8d 6d 01          	lea    0x1(%r13),%r13
 465:	0f 8d 69 fe ff ff    	jge    2d4 <.omp_outlined.+0xb4>
 46b:	4e 8d 1c ed 00 00 00 	lea    0x0(,%r13,8),%r11
 472:	00 
 473:	4d 29 eb             	sub    %r13,%r11
 476:	85 c9                	test   %ecx,%ecx
 478:	0f 8e d2 fe ff ff    	jle    350 <.omp_outlined.+0x130>
 47e:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
 482:	31 f6                	xor    %esi,%esi
 484:	c5 d0 57 ed          	vxorps %xmm5,%xmm5,%xmm5
 488:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 48c:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
 490:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 494:	c5 f0 57 c9          	vxorps %xmm1,%xmm1,%xmm1
 ...
 4b0:	c4 e2 45 b8 74 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm7,%ymm6
 4b7:	c5 7c 10 4c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm9
 4bd:	c5 7c 10 54 b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm10
 4c3:	c4 e2 45 b8 6c 88 a0 	vfmadd231ps -0x60(%rax,%rcx,4),%ymm7,%ymm5
 4ca:	c4 e2 45 b8 54 c8 a0 	vfmadd231ps -0x60(%rax,%rcx,8),%ymm7,%ymm2
 4d1:	48 8d 44 07 a0       	lea    -0x60(%rdi,%rax,1),%rax
 4d6:	48 01 f8             	add    %rdi,%rax
 4d9:	c4 e2 45 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm4
 4df:	c4 e2 45 b8 1c c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm3
 4e5:	48 01 f8             	add    %rdi,%rax
 4e8:	48 01 f8             	add    %rdi,%rax
 4eb:	c4 e2 3d b8 74 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm8,%ymm6
 4f2:	c4 e2 45 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm1
 4f8:	48 01 f8             	add    %rdi,%rax
 4fb:	c4 e2 45 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm0
 501:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 505:	c4 e2 3d b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm8,%ymm5
 50b:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 50f:	c4 e2 3d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm2
 515:	c4 e2 3d b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm4
 51b:	48 01 f8             	add    %rdi,%rax
 51e:	c4 e2 35 b8 74 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm9,%ymm6
 525:	48 01 f8             	add    %rdi,%rax
 528:	c4 e2 3d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm3
 52e:	c4 e2 3d b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm1
 534:	48 01 f8             	add    %rdi,%rax
 537:	48 01 f8             	add    %rdi,%rax
 53a:	c4 e2 3d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm0
 540:	48 01 f8             	add    %rdi,%rax
 543:	c4 e2 2d b8 74 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm10,%ymm6
 54a:	48 83 c6 20          	add    $0x20,%rsi
 54e:	c4 e2 35 b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm9,%ymm5
 554:	48 01 d8             	add    %rbx,%rax
 557:	c4 e2 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm2
 55d:	c4 e2 35 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm4
 563:	48 01 f8             	add    %rdi,%rax
 566:	48 01 f8             	add    %rdi,%rax
 569:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 56f:	c4 e2 35 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm1
 575:	48 01 f8             	add    %rdi,%rax
 578:	48 01 f8             	add    %rdi,%rax
 57b:	c4 e2 35 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm0
 581:	48 01 f8             	add    %rdi,%rax
 584:	c4 e2 2d b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm5
 58a:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 58e:	c4 e2 2d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm2
 594:	c4 e2 2d b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm4
 59a:	48 01 f8             	add    %rdi,%rax
 59d:	48 01 f8             	add    %rdi,%rax
 5a0:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 5a6:	c4 e2 2d b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm1
 5ac:	48 01 f8             	add    %rdi,%rax
 5af:	48 01 f8             	add    %rdi,%rax
 5b2:	c4 e2 2d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm0
 5b8:	48 39 ce             	cmp    %rcx,%rsi
 5bb:	0f 8c df fe ff ff    	jl     4a0 <.omp_outlined.+0x280>
 5c1:	e9 a6 fd ff ff       	jmpq   36c <.omp_outlined.+0x14c>
 5c6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
 5cd:	00 00 00 

00000000000005d0 <_Z6enablev>:
 5d0:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 5d7 <_Z6enablev+0x7>
 5d7:	7d 03                	jge    5dc <_Z6enablev+0xc>
 5d9:	31 c0                	xor    %eax,%eax
 5db:	c3                   	retq   
 5dc:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 5e3 <_Z6enablev+0x13>
 5e3:	b8 20 00 00 00       	mov    $0x20,%eax
 5e8:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 5ed:	0f 45 c8             	cmovne %eax,%ecx
 5f0:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 5f6 <_Z6enablev+0x26>
 5f6:	0f 9e c0             	setle  %al
 5f9:	c3                   	retq   

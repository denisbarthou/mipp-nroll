...
0000000000000220 <.omp_outlined.>:
 ...
 2fb:	4d 8b 6d 00          	mov    0x0(%r13),%r13
 2ff:	4d 8b 14 24          	mov    (%r12),%r10
 303:	4c 63 c5             	movslq %ebp,%r8
 306:	48 89 ce             	mov    %rcx,%rsi
 309:	49 0f af f6          	imul   %r14,%rsi
 30d:	48 8d 3c f6          	lea    (%rsi,%rsi,8),%rdi
 311:	48 8d 2c 7f          	lea    (%rdi,%rdi,2),%rbp
 315:	48 8d 3c 8d 00 00 00 	lea    0x0(,%rcx,4),%rdi
 31c:	00 
 31d:	48 01 f5             	add    %rsi,%rbp
 320:	49 03 2f             	add    (%r15),%rbp
 323:	48 8d 34 c9          	lea    (%rcx,%rcx,8),%rsi
 327:	4c 8d 0c 76          	lea    (%rsi,%rsi,2),%r9
 32b:	49 01 c9             	add    %rcx,%r9
 32e:	e9 28 01 00 00       	jmpq   45b <.omp_outlined.+0x23b>
 ...
 44e:	4d 39 c6             	cmp    %r8,%r14
 451:	4d 8d 76 01          	lea    0x1(%r14),%r14
 455:	0f 8d 79 fe ff ff    	jge    2d4 <.omp_outlined.+0xb4>
 45b:	4e 8d 1c f5 00 00 00 	lea    0x0(,%r14,8),%r11
 462:	00 
 463:	4d 29 f3             	sub    %r14,%r11
 466:	85 c9                	test   %ecx,%ecx
 468:	0f 8e d2 fe ff ff    	jle    340 <.omp_outlined.+0x120>
 46e:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
 472:	31 f6                	xor    %esi,%esi
 474:	c5 d0 57 ed          	vxorps %xmm5,%xmm5,%xmm5
 478:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 47c:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
 480:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 484:	c5 f0 57 c9          	vxorps %xmm1,%xmm1,%xmm1
 488:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 48c:	0f 1f 40 00          	nopl   0x0(%rax)
 490:	48 8d 5c b5 00       	lea    0x0(%rbp,%rsi,4),%rbx
 495:	c4 c1 7c 10 7c b5 00 	vmovups 0x0(%r13,%rsi,4),%ymm7
 49c:	c4 e2 45 b8 74 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm7,%ymm6
 4a3:	48 83 c6 08          	add    $0x8,%rsi
 4a7:	48 8d 04 3b          	lea    (%rbx,%rdi,1),%rax
 4ab:	c4 e2 45 b8 2c 8b    	vfmadd231ps (%rbx,%rcx,4),%ymm7,%ymm5
 4b1:	c4 e2 45 b8 14 cb    	vfmadd231ps (%rbx,%rcx,8),%ymm7,%ymm2
 4b7:	48 01 f8             	add    %rdi,%rax
 4ba:	48 8d 14 38          	lea    (%rax,%rdi,1),%rdx
 4be:	c4 e2 45 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm4
 4c4:	c4 e2 45 b8 1c c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm3
 4ca:	48 01 fa             	add    %rdi,%rdx
 4cd:	c4 e2 45 b8 0c 8a    	vfmadd231ps (%rdx,%rcx,4),%ymm7,%ymm1
 4d3:	48 01 fa             	add    %rdi,%rdx
 4d6:	c4 e2 45 b8 04 8a    	vfmadd231ps (%rdx,%rcx,4),%ymm7,%ymm0
 4dc:	48 39 ce             	cmp    %rcx,%rsi
 4df:	7c af                	jl     490 <.omp_outlined.+0x270>
 4e1:	e9 76 fe ff ff       	jmpq   35c <.omp_outlined.+0x13c>
 4e6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
 4ed:	00 00 00 

00000000000004f0 <_Z6enablev>:
 4f0:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 4f7 <_Z6enablev+0x7>
 4f7:	7d 03                	jge    4fc <_Z6enablev+0xc>
 4f9:	31 c0                	xor    %eax,%eax
 4fb:	c3                   	retq   
 4fc:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 503 <_Z6enablev+0x13>
 503:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 507:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 50d <_Z6enablev+0x1d>
 50d:	0f 9e c0             	setle  %al
 510:	c3                   	retq   

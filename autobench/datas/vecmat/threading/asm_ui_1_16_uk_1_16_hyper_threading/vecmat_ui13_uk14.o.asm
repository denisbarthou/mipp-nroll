...
vecmat_ui13_uk14.o:     file format elf64-x86-64
...
0000000000000220 <.omp_outlined.>:
 ...
 5aa:	c4 62 15 b8 a4 b5 60 	vfmadd231ps -0x1a0(%rbp,%rsi,4),%ymm13,%ymm12
 5b1:	fe ff ff 
 5b4:	c4 62 15 b8 9c 88 60 	vfmadd231ps -0x1a0(%rax,%rcx,4),%ymm13,%ymm11
 5bb:	fe ff ff 
 5be:	c4 62 15 b8 84 c8 60 	vfmadd231ps -0x1a0(%rax,%rcx,8),%ymm13,%ymm8
 5c5:	fe ff ff 
 5c8:	48 8d 84 07 60 fe ff 	lea    -0x1a0(%rdi,%rax,1),%rax
 5cf:	ff 
 ...
 63a:	c4 62 15 b8 a4 b5 80 	vfmadd231ps -0x180(%rbp,%rsi,4),%ymm13,%ymm12
 641:	fe ff ff 
 ...
 6bd:	c4 62 15 b8 a4 b5 a0 	vfmadd231ps -0x160(%rbp,%rsi,4),%ymm13,%ymm12
 6c4:	fe ff ff 
 ...
 740:	c4 62 15 b8 a4 b5 c0 	vfmadd231ps -0x140(%rbp,%rsi,4),%ymm13,%ymm12
 747:	fe ff ff 
 ...
 7c4:	00 00 
 7c6:	c4 62 15 b8 a4 b5 e0 	vfmadd231ps -0x120(%rbp,%rsi,4),%ymm13,%ymm12
 7cd:	fe ff ff 
 7d0:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 7d6:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 7da:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 7e0:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 7e6:	48 01 f8             	add    %rdi,%rax
 7e9:	48 01 f8             	add    %rdi,%rax
 7ec:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 7f2:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 7f8:	48 01 f8             	add    %rdi,%rax
 7fb:	48 01 f8             	add    %rdi,%rax
 7fe:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 804:	48 01 f8             	add    %rdi,%rax
 807:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 80d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 811:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 817:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 81b:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 821:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 825:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 82b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 82f:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 835:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 839:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 83f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 843:	c5 7c 10 ac b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm13
 84a:	00 00 
 84c:	c4 62 15 b8 a4 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm13,%ymm12
 853:	ff ff ff 
 856:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 85c:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 860:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 866:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 86c:	48 01 f8             	add    %rdi,%rax
 86f:	48 01 f8             	add    %rdi,%rax
 872:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 878:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 87e:	48 01 f8             	add    %rdi,%rax
 881:	48 01 f8             	add    %rdi,%rax
 884:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 88a:	48 01 f8             	add    %rdi,%rax
 88d:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 893:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 897:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 89d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8a1:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 8a7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8ab:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 8b1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8b5:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 8bb:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8bf:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 8c5:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8c9:	c5 7c 10 ac b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm13
 8d0:	00 00 
 8d2:	c4 62 15 b8 a4 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm13,%ymm12
 8d9:	ff ff ff 
 8dc:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 8e2:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 8e6:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 8ec:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 8f2:	48 01 f8             	add    %rdi,%rax
 8f5:	48 01 f8             	add    %rdi,%rax
 8f8:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 8fe:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 904:	48 01 f8             	add    %rdi,%rax
 907:	48 01 f8             	add    %rdi,%rax
 90a:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 910:	48 01 f8             	add    %rdi,%rax
 913:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 919:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 91d:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 923:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 927:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 92d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 931:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 937:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 93b:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 941:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 945:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 94b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 94f:	c5 7c 10 ac b2 e0 00 	vmovups 0xe0(%rdx,%rsi,4),%ymm13
 956:	00 00 
 958:	c4 62 15 b8 a4 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm13,%ymm12
 95f:	ff ff ff 
 962:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 968:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 96c:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 972:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 978:	48 01 f8             	add    %rdi,%rax
 97b:	48 01 f8             	add    %rdi,%rax
 97e:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 984:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 98a:	48 01 f8             	add    %rdi,%rax
 98d:	48 01 f8             	add    %rdi,%rax
 990:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 996:	48 01 f8             	add    %rdi,%rax
 999:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 99f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9a3:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 9a9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9ad:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 9b3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9b7:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 9bd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9c1:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 9c7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9cb:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 9d1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9d5:	c5 7c 10 ac b2 00 01 	vmovups 0x100(%rdx,%rsi,4),%ymm13
 9dc:	00 00 
 9de:	c4 62 15 b8 a4 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm13,%ymm12
 9e5:	ff ff ff 
 9e8:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 9ee:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9f2:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 9f8:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 9fe:	48 01 f8             	add    %rdi,%rax
 a01:	48 01 f8             	add    %rdi,%rax
 a04:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 a0a:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 a10:	48 01 f8             	add    %rdi,%rax
 a13:	48 01 f8             	add    %rdi,%rax
 a16:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 a1c:	48 01 f8             	add    %rdi,%rax
 a1f:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 a25:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a29:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 a2f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a33:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 a39:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a3d:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 a43:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a47:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 a4d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a51:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 a57:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a5b:	c5 7c 10 ac b2 20 01 	vmovups 0x120(%rdx,%rsi,4),%ymm13
 a62:	00 00 
 a64:	c4 62 15 b8 64 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm13,%ymm12
 a6b:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 a71:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a75:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 a7b:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 a81:	48 01 f8             	add    %rdi,%rax
 a84:	48 01 f8             	add    %rdi,%rax
 a87:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 a8d:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 a93:	48 01 f8             	add    %rdi,%rax
 a96:	48 01 f8             	add    %rdi,%rax
 a99:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 a9f:	48 01 f8             	add    %rdi,%rax
 aa2:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 aa8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 aac:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 ab2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ab6:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 abc:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ac0:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 ac6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 aca:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 ad0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ad4:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 ada:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ade:	c5 7c 10 ac b2 40 01 	vmovups 0x140(%rdx,%rsi,4),%ymm13
 ae5:	00 00 
 ae7:	c4 62 15 b8 64 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm13,%ymm12
 aee:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 af4:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 af8:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 afe:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 b04:	48 01 f8             	add    %rdi,%rax
 b07:	48 01 f8             	add    %rdi,%rax
 b0a:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 b10:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 b16:	48 01 f8             	add    %rdi,%rax
 b19:	48 01 f8             	add    %rdi,%rax
 b1c:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 b22:	48 01 f8             	add    %rdi,%rax
 b25:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 b2b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b2f:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 b35:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b39:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 b3f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b43:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 b49:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b4d:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 b53:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b57:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 b5d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b61:	c5 7c 10 ac b2 60 01 	vmovups 0x160(%rdx,%rsi,4),%ymm13
 b68:	00 00 
 b6a:	c4 62 15 b8 64 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm13,%ymm12
 b71:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 b77:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 b7b:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 b81:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 b87:	48 01 f8             	add    %rdi,%rax
 b8a:	48 01 f8             	add    %rdi,%rax
 b8d:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 b93:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 b99:	48 01 f8             	add    %rdi,%rax
 b9c:	48 01 f8             	add    %rdi,%rax
 b9f:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 ba5:	48 01 f8             	add    %rdi,%rax
 ba8:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 bae:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bb2:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 bb8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bbc:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 bc2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bc6:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 bcc:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bd0:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 bd6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bda:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 be0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 be4:	c5 7c 10 ac b2 80 01 	vmovups 0x180(%rdx,%rsi,4),%ymm13
 beb:	00 00 
 bed:	c4 62 15 b8 64 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm13,%ymm12
 bf4:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 bfa:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 bfe:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 c04:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 c0a:	48 01 f8             	add    %rdi,%rax
 c0d:	48 01 f8             	add    %rdi,%rax
 c10:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 c16:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 c1c:	48 01 f8             	add    %rdi,%rax
 c1f:	48 01 f8             	add    %rdi,%rax
 c22:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 c28:	48 01 f8             	add    %rdi,%rax
 c2b:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 c31:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c35:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 c3b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c3f:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 c45:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c49:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 c4f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c53:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 c59:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c5d:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 c63:	48 01 f8             	add    %rdi,%rax
 c66:	c5 7c 10 ac b2 a0 01 	vmovups 0x1a0(%rdx,%rsi,4),%ymm13
 c6d:	00 00 
 c6f:	c4 62 15 b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm13,%ymm12
 c76:	48 83 c6 70          	add    $0x70,%rsi
 c7a:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 c80:	48 01 d8             	add    %rbx,%rax
 c83:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 c89:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 c8f:	48 01 f8             	add    %rdi,%rax
 c92:	48 01 f8             	add    %rdi,%rax
 c95:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 c9b:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 ca1:	48 01 f8             	add    %rdi,%rax
 ca4:	48 01 f8             	add    %rdi,%rax
 ca7:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 cad:	48 01 f8             	add    %rdi,%rax
 cb0:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 cb6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cba:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 cc0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cc4:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 cca:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cce:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 cd4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cd8:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 cde:	48 01 f8             	add    %rdi,%rax
 ce1:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 ce7:	48 39 ce             	cmp    %rcx,%rsi
 cea:	0f 8c b0 f8 ff ff    	jl     5a0 <.omp_outlined.+0x380>
 cf0:	e9 75 f6 ff ff       	jmpq   36a <.omp_outlined.+0x14a>
 cf5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 cfc:	00 00 00 00 
...
0000000000000d10 <_Z9n_reg_maxv>:
 d10:	b8 b6 00 00 00       	mov    $0xb6,%eax
 d15:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui13_uk14.cpp+0x9a>
  96:	01 00 00 00 

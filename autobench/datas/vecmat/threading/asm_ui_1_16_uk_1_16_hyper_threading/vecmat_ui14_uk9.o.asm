...
0000000000000220 <.omp_outlined.>:
 ...
 34d:	48 8d ac 30 00 01 00 	lea    0x100(%rax,%rsi,1),%rbp
 354:	00 
 355:	48 81 c6 00 01 00 00 	add    $0x100,%rsi
 ...
 64b:	c4 22 0d b8 ac 8d 00 	vfmadd231ps -0x100(%rbp,%r9,4),%ymm14,%ymm13
 652:	ff ff ff 
 655:	c4 02 0d b8 a4 88 00 	vfmadd231ps -0x100(%r8,%r9,4),%ymm14,%ymm12
 65c:	ff ff ff 
 65f:	4b 8d 84 17 00 ff ff 	lea    -0x100(%r15,%r10,1),%rax
 666:	ff 
 667:	c4 42 0d b8 9c ca 00 	vfmadd231ps -0x100(%r10,%rcx,8),%ymm14,%ymm11
 66e:	ff ff ff 
 ...
 6e1:	c4 22 0d b8 ac 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm14,%ymm13
 6e8:	ff ff ff 
 6eb:	c4 02 0d b8 a4 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm14,%ymm12
 6f2:	ff ff ff 
 ...
 76f:	c4 22 0d b8 ac 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm14,%ymm13
 776:	ff ff ff 
 779:	c4 02 0d b8 a4 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm14,%ymm12
 780:	ff ff ff 
 ...
 7fd:	c4 22 0d b8 ac 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm14,%ymm13
 804:	ff ff ff 
 807:	c4 02 0d b8 a4 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm14,%ymm12
 80e:	ff ff ff 
 ...
 88b:	00 00 00 
 88e:	c4 22 0d b8 6c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm14,%ymm13
 895:	c4 02 0d b8 64 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm14,%ymm12
 89c:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 8a2:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 8a6:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 8ac:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 8b2:	48 01 f8             	add    %rdi,%rax
 8b5:	48 01 f8             	add    %rdi,%rax
 8b8:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 8be:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 8c4:	48 01 f8             	add    %rdi,%rax
 8c7:	48 01 f8             	add    %rdi,%rax
 8ca:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 8d0:	48 01 f8             	add    %rdi,%rax
 8d3:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 8d9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8dd:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 8e3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8e7:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 8ed:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8f1:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 8f7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8fb:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 901:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 905:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 90b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 90f:	c4 21 7c 10 b4 8a a0 	vmovups 0xa0(%rdx,%r9,4),%ymm14
 916:	00 00 00 
 919:	c4 22 0d b8 6c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm14,%ymm13
 920:	c4 02 0d b8 64 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm14,%ymm12
 927:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 92d:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 931:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 937:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 93d:	48 01 f8             	add    %rdi,%rax
 940:	48 01 f8             	add    %rdi,%rax
 943:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 949:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 94f:	48 01 f8             	add    %rdi,%rax
 952:	48 01 f8             	add    %rdi,%rax
 955:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 95b:	48 01 f8             	add    %rdi,%rax
 95e:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 964:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 968:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 96e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 972:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 978:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 97c:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 982:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 986:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 98c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 990:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 996:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 99a:	c4 21 7c 10 b4 8a c0 	vmovups 0xc0(%rdx,%r9,4),%ymm14
 9a1:	00 00 00 
 9a4:	c4 22 0d b8 6c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm14,%ymm13
 9ab:	c4 02 0d b8 64 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm14,%ymm12
 9b2:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 9b8:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9bc:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 9c2:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 9c8:	48 01 f8             	add    %rdi,%rax
 9cb:	48 01 f8             	add    %rdi,%rax
 9ce:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 9d4:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 9da:	48 01 f8             	add    %rdi,%rax
 9dd:	48 01 f8             	add    %rdi,%rax
 9e0:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 9e6:	48 01 f8             	add    %rdi,%rax
 9e9:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 9ef:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9f3:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 9f9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9fd:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 a03:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a07:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 a0d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a11:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 a17:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a1b:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 a21:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a25:	c4 21 7c 10 b4 8a e0 	vmovups 0xe0(%rdx,%r9,4),%ymm14
 a2c:	00 00 00 
 a2f:	c4 22 0d b8 6c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm14,%ymm13
 a36:	c4 02 0d b8 64 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm14,%ymm12
 a3d:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 a43:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a47:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 a4d:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 a53:	48 01 f8             	add    %rdi,%rax
 a56:	48 01 f8             	add    %rdi,%rax
 a59:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 a5f:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 a65:	48 01 f8             	add    %rdi,%rax
 a68:	48 01 f8             	add    %rdi,%rax
 a6b:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 a71:	48 01 f8             	add    %rdi,%rax
 a74:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 a7a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a7e:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 a84:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a88:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 a8e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a92:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 a98:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a9c:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 aa2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 aa6:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 aac:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ab0:	c4 21 7c 10 b4 8a 00 	vmovups 0x100(%rdx,%r9,4),%ymm14
 ab7:	01 00 00 
 aba:	c4 22 0d b8 6c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm14,%ymm13
 ac1:	c4 02 0d b8 24 88    	vfmadd231ps (%r8,%r9,4),%ymm14,%ymm12
 ac7:	49 83 c1 48          	add    $0x48,%r9
 acb:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 ad1:	48 01 d8             	add    %rbx,%rax
 ad4:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 ada:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 ae0:	48 01 f8             	add    %rdi,%rax
 ae3:	48 01 f8             	add    %rdi,%rax
 ae6:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 aec:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 af2:	48 01 f8             	add    %rdi,%rax
 af5:	48 01 f8             	add    %rdi,%rax
 af8:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 afe:	48 01 f8             	add    %rdi,%rax
 b01:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 b07:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b0b:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 b11:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b15:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 b1b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b1f:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 b25:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b29:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 b2f:	48 01 f8             	add    %rdi,%rax
 b32:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 b38:	49 39 c9             	cmp    %rcx,%r9
 b3b:	0f 8c ff fa ff ff    	jl     640 <.omp_outlined.+0x420>
 b41:	e9 79 f8 ff ff       	jmpq   3bf <.omp_outlined.+0x19f>
...
0000000000000b60 <_Z9n_reg_maxv>:
 b60:	b8 7e 00 00 00       	mov    $0x7e,%eax
 b65:	c3                   	retq   

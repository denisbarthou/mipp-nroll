...
0000000000000220 <.omp_outlined.>:
 ...
 4fa:	c4 62 35 b8 84 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm9,%ymm8
 501:	ff ff ff 
 504:	c4 e2 35 b8 bc 88 00 	vfmadd231ps -0x100(%rax,%rcx,4),%ymm9,%ymm7
 50b:	ff ff ff 
 50e:	c4 e2 35 b8 a4 c8 00 	vfmadd231ps -0x100(%rax,%rcx,8),%ymm9,%ymm4
 515:	ff ff ff 
 518:	48 8d 84 03 00 ff ff 	lea    -0x100(%rbx,%rax,1),%rax
 51f:	ff 
 ...
 562:	c4 62 35 b8 84 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm9,%ymm8
 569:	ff ff ff 
 ...
 5bd:	c4 62 35 b8 84 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm9,%ymm8
 5c4:	ff ff ff 
 ...
 618:	c4 62 35 b8 84 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm9,%ymm8
 61f:	ff ff ff 
 ...
 674:	00 00 
 676:	c4 62 35 b8 44 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm9,%ymm8
 67d:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 683:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 687:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 68d:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 693:	48 01 d8             	add    %rbx,%rax
 696:	48 01 d8             	add    %rbx,%rax
 699:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 69f:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 6a5:	48 01 d8             	add    %rbx,%rax
 6a8:	48 01 d8             	add    %rbx,%rax
 6ab:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 6b1:	48 01 d8             	add    %rbx,%rax
 6b4:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 6ba:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6be:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 6c4:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6c8:	c5 7c 10 8c b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm9
 6cf:	00 00 
 6d1:	c4 62 35 b8 44 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm9,%ymm8
 6d8:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 6de:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6e2:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 6e8:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 6ee:	48 01 d8             	add    %rbx,%rax
 6f1:	48 01 d8             	add    %rbx,%rax
 6f4:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 6fa:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 700:	48 01 d8             	add    %rbx,%rax
 703:	48 01 d8             	add    %rbx,%rax
 706:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 70c:	48 01 d8             	add    %rbx,%rax
 70f:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 715:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 719:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 71f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 723:	c5 7c 10 8c b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm9
 72a:	00 00 
 72c:	c4 62 35 b8 44 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm9,%ymm8
 733:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 739:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 73d:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 743:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 749:	48 01 d8             	add    %rbx,%rax
 74c:	48 01 d8             	add    %rbx,%rax
 74f:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 755:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 75b:	48 01 d8             	add    %rbx,%rax
 75e:	48 01 d8             	add    %rbx,%rax
 761:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 767:	48 01 d8             	add    %rbx,%rax
 76a:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 770:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 774:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 77a:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 77e:	c5 7c 10 8c b2 e0 00 	vmovups 0xe0(%rdx,%rsi,4),%ymm9
 785:	00 00 
 787:	c4 62 35 b8 44 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm9,%ymm8
 78e:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 794:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 798:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 79e:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 7a4:	48 01 d8             	add    %rbx,%rax
 7a7:	48 01 d8             	add    %rbx,%rax
 7aa:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 7b0:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 7b6:	48 01 d8             	add    %rbx,%rax
 7b9:	48 01 d8             	add    %rbx,%rax
 7bc:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 7c2:	48 01 d8             	add    %rbx,%rax
 7c5:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 7cb:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 7cf:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 7d5:	48 01 d8             	add    %rbx,%rax
 7d8:	c5 7c 10 8c b2 00 01 	vmovups 0x100(%rdx,%rsi,4),%ymm9
 7df:	00 00 
 7e1:	c4 62 35 b8 44 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm9,%ymm8
 7e8:	48 83 c6 48          	add    $0x48,%rsi
 7ec:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 7f2:	48 01 f8             	add    %rdi,%rax
 7f5:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 7fb:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 801:	48 01 d8             	add    %rbx,%rax
 804:	48 01 d8             	add    %rbx,%rax
 807:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 80d:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 813:	48 01 d8             	add    %rbx,%rax
 816:	48 01 d8             	add    %rbx,%rax
 819:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 81f:	48 01 d8             	add    %rbx,%rax
 822:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 828:	48 01 d8             	add    %rbx,%rax
 82b:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 831:	48 39 ce             	cmp    %rcx,%rsi
 834:	0f 8c b6 fc ff ff    	jl     4f0 <.omp_outlined.+0x2d0>
 83a:	e9 27 fb ff ff       	jmpq   366 <.omp_outlined.+0x146>
 83f:	90                   	nop
...
0000000000000850 <_Z9n_reg_maxv>:
 850:	b8 51 00 00 00       	mov    $0x51,%eax
 855:	c3                   	retq   

...
0000000000000230 <.omp_outlined.>:
 ...
 323:	48 8d ac be c0 00 00 	lea    0xc0(%rsi,%rdi,4),%rbp
 32a:	00 
 ...
 340:	48 8d bc be c0 00 00 	lea    0xc0(%rsi,%rdi,4),%rdi
 347:	00 
 348:	48 8d b4 9e c0 00 00 	lea    0xc0(%rsi,%rbx,4),%rsi
 34f:	00 
 ...
 40b:	00 00 00 00 00 
 410:	c5 fc 10 2c 9a       	vmovups (%rdx,%rbx,4),%ymm5
 415:	c4 e2 55 b8 94 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm5,%ymm2
 41c:	ff ff ff 
 41f:	c4 e2 55 b8 8c 9f 40 	vfmadd231ps -0xc0(%rdi,%rbx,4),%ymm5,%ymm1
 426:	ff ff ff 
 429:	c4 e2 55 b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm5,%ymm0
 430:	ff ff ff 
 433:	c5 fc 10 74 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm6
 439:	c5 fc 10 7c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm7
 43f:	c5 7c 10 44 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm8
 445:	c5 7c 10 8c 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm9
 44c:	00 00 
 44e:	c5 fc 10 a4 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm4
 455:	00 00 
 457:	c5 fc 10 9c 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm3
 45e:	00 00 
 460:	c4 e2 4d b8 94 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm6,%ymm2
 467:	ff ff ff 
 46a:	c4 e2 4d b8 8c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm6,%ymm1
 471:	ff ff ff 
 474:	c4 e2 4d b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm6,%ymm0
 47b:	ff ff ff 
 47e:	c4 e2 45 b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm7,%ymm2
 485:	c4 e2 45 b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm7,%ymm1
 48c:	c4 e2 45 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm7,%ymm0
 493:	c4 e2 3d b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm8,%ymm2
 49a:	c4 e2 3d b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm8,%ymm1
 4a1:	c4 e2 3d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm8,%ymm0
 4a8:	c4 e2 35 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm9,%ymm2
 4af:	c4 e2 35 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm9,%ymm1
 4b6:	c4 e2 35 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm9,%ymm0
 4bd:	c4 e2 5d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm4,%ymm2
 4c4:	c4 e2 5d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm4,%ymm1
 4cb:	c4 e2 5d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm4,%ymm0
 4d2:	c4 e2 65 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm3,%ymm2
 4d9:	c4 e2 65 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm1
 4df:	c4 e2 65 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm0
 4e5:	48 83 c3 38          	add    $0x38,%rbx
 4e9:	48 39 cb             	cmp    %rcx,%rbx
 4ec:	0f 8c 1e ff ff ff    	jl     410 <.omp_outlined.+0x1e0>
 4f2:	e9 75 fe ff ff       	jmpq   36c <.omp_outlined.+0x13c>
 4f7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
 4fe:	00 00 

0000000000000500 <_Z6enablev>:
 500:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 507 <_Z6enablev+0x7>
 507:	7d 03                	jge    50c <_Z6enablev+0xc>
 509:	31 c0                	xor    %eax,%eax
 50b:	c3                   	retq   
 50c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 513 <_Z6enablev+0x13>
 513:	b8 38 00 00 00       	mov    $0x38,%eax
 518:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx

...
0000000000000220 <.omp_outlined.>:
 ...
 2eb:	41 b9 c0 00 00 00    	mov    $0xc0,%r9d
 ...
 3a5:	c4 e2 6d b8 8c 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm2,%ymm1
 3ac:	ff ff ff 
 3af:	c4 e2 6d b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm2,%ymm0
 3b6:	ff ff ff 
 3b9:	c5 fc 10 5c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm3
 3bf:	c5 fc 10 64 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm4
 3c5:	c5 fc 10 6c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm5
 3cb:	c5 fc 10 b4 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm6
 3d2:	00 00 
 3d4:	c5 fc 10 bc 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm7
 3db:	00 00 
 3dd:	c5 7c 10 84 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm8
 3e4:	00 00 
 3e6:	c4 e2 65 b8 8c 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm3,%ymm1
 3ed:	ff ff ff 
 3f0:	c4 e2 65 b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm3,%ymm0
 3f7:	ff ff ff 
 3fa:	c4 e2 5d b8 4c 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm4,%ymm1
 401:	c4 e2 5d b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm4,%ymm0
 408:	c4 e2 55 b8 4c 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm5,%ymm1
 40f:	c4 e2 55 b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm5,%ymm0
 416:	c4 e2 4d b8 4c 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm6,%ymm1
 41d:	c4 e2 4d b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm6,%ymm0
 424:	c4 e2 45 b8 4c 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm7,%ymm1
 42b:	c4 e2 45 b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm7,%ymm0
 432:	c4 e2 3d b8 4c 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm8,%ymm1
 439:	c4 e2 3d b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm8,%ymm0
 43f:	48 83 c3 38          	add    $0x38,%rbx
 443:	48 39 cb             	cmp    %rcx,%rbx
 446:	0f 8c 54 ff ff ff    	jl     3a0 <.omp_outlined.+0x180>
 44c:	e9 c7 fe ff ff       	jmpq   318 <.omp_outlined.+0xf8>
...
0000000000000460 <_Z6enablev>:
 460:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 467 <_Z6enablev+0x7>
 467:	7d 03                	jge    46c <_Z6enablev+0xc>
 469:	31 c0                	xor    %eax,%eax
 46b:	c3                   	retq   
 46c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 473 <_Z6enablev+0x13>
 473:	b8 38 00 00 00       	mov    $0x38,%eax
 478:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 47d:	0f 45 c8             	cmovne %eax,%ecx
 480:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 486 <_Z6enablev+0x26>
 486:	0f 9e c0             	setle  %al
 489:	c3                   	retq   

...
0000000000000220 <.omp_outlined.>:
 ...
 2eb:	41 b9 20 01 00 00    	mov    $0x120,%r9d
 ...
 3a0:	c5 fc 10 2c 9a       	vmovups (%rdx,%rbx,4),%ymm5
 3a5:	c4 e2 55 b8 8c 9d e0 	vfmadd231ps -0x120(%rbp,%rbx,4),%ymm5,%ymm1
 3ac:	fe ff ff 
 3af:	c4 e2 55 b8 84 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm5,%ymm0
 3b6:	fe ff ff 
 3b9:	c5 fc 10 74 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm6
 3bf:	c5 fc 10 7c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm7
 3c5:	c5 7c 10 44 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm8
 3cb:	c5 7c 10 8c 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm9
 3d2:	00 00 
 3d4:	c5 7c 10 94 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm10
 3db:	00 00 
 3dd:	c5 7c 10 9c 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm11
 3e4:	00 00 
 3e6:	c5 fc 10 a4 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm4
 3ed:	00 00 
 3ef:	c5 fc 10 9c 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm3
 3f6:	00 00 
 3f8:	c5 fc 10 94 9a 20 01 	vmovups 0x120(%rdx,%rbx,4),%ymm2
 3ff:	00 00 
 401:	c4 e2 4d b8 8c 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm6,%ymm1
 408:	ff ff ff 
 40b:	c4 e2 4d b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm6,%ymm0
 412:	ff ff ff 
 415:	c4 e2 45 b8 8c 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm7,%ymm1
 41c:	ff ff ff 
 41f:	c4 e2 45 b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm7,%ymm0
 426:	ff ff ff 
 429:	c4 e2 3d b8 8c 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm8,%ymm1
 430:	ff ff ff 
 433:	c4 e2 3d b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm8,%ymm0
 43a:	ff ff ff 
 43d:	c4 e2 35 b8 8c 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm9,%ymm1
 444:	ff ff ff 
 447:	c4 e2 35 b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm9,%ymm0
 44e:	ff ff ff 
 451:	c4 e2 2d b8 4c 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm10,%ymm1
 458:	c4 e2 2d b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm10,%ymm0
 45f:	c4 e2 25 b8 4c 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm11,%ymm1
 466:	c4 e2 25 b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm11,%ymm0
 46d:	c4 e2 5d b8 4c 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm4,%ymm1
 474:	c4 e2 5d b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm4,%ymm0
 47b:	c4 e2 65 b8 4c 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm3,%ymm1
 482:	c4 e2 65 b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm3,%ymm0
 489:	c4 e2 6d b8 4c 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm2,%ymm1
 490:	c4 e2 6d b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm2,%ymm0
 496:	48 83 c3 50          	add    $0x50,%rbx
 49a:	48 39 cb             	cmp    %rcx,%rbx
 49d:	0f 8c fd fe ff ff    	jl     3a0 <.omp_outlined.+0x180>
 4a3:	e9 70 fe ff ff       	jmpq   318 <.omp_outlined.+0xf8>
 4a8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
 4af:	00 

00000000000004b0 <_Z6enablev>:
 4b0:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 4b7 <_Z6enablev+0x7>
 4b7:	7d 03                	jge    4bc <_Z6enablev+0xc>
 4b9:	31 c0                	xor    %eax,%eax
 4bb:	c3                   	retq   
 4bc:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 4c3 <_Z6enablev+0x13>
 4c3:	b8 50 00 00 00       	mov    $0x50,%eax
 4c8:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx

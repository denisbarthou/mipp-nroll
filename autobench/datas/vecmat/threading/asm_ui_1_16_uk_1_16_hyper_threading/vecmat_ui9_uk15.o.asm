...
0000000000000220 <.omp_outlined.>:
 ...
 31c:	48 8d ac b0 c0 01 00 	lea    0x1c0(%rax,%rsi,4),%rbp
 323:	00 
 ...
 4fa:	c4 62 35 b8 84 b5 40 	vfmadd231ps -0x1c0(%rbp,%rsi,4),%ymm9,%ymm8
 501:	fe ff ff 
 504:	c4 e2 35 b8 bc 88 40 	vfmadd231ps -0x1c0(%rax,%rcx,4),%ymm9,%ymm7
 50b:	fe ff ff 
 50e:	c4 e2 35 b8 a4 c8 40 	vfmadd231ps -0x1c0(%rax,%rcx,8),%ymm9,%ymm4
 515:	fe ff ff 
 518:	48 8d 84 03 40 fe ff 	lea    -0x1c0(%rbx,%rax,1),%rax
 51f:	ff 
 ...
 562:	c4 62 35 b8 84 b5 60 	vfmadd231ps -0x1a0(%rbp,%rsi,4),%ymm9,%ymm8
 569:	fe ff ff 
 ...
 5bd:	c4 62 35 b8 84 b5 80 	vfmadd231ps -0x180(%rbp,%rsi,4),%ymm9,%ymm8
 5c4:	fe ff ff 
 ...
 618:	c4 62 35 b8 84 b5 a0 	vfmadd231ps -0x160(%rbp,%rsi,4),%ymm9,%ymm8
 61f:	fe ff ff 
 ...
 674:	00 00 
 676:	c4 62 35 b8 84 b5 c0 	vfmadd231ps -0x140(%rbp,%rsi,4),%ymm9,%ymm8
 67d:	fe ff ff 
 ...
 6d2:	00 00 
 6d4:	c4 62 35 b8 84 b5 e0 	vfmadd231ps -0x120(%rbp,%rsi,4),%ymm9,%ymm8
 6db:	fe ff ff 
 ...
 730:	00 00 
 732:	c4 62 35 b8 84 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm9,%ymm8
 739:	ff ff ff 
 ...
 78e:	00 00 
 790:	c4 62 35 b8 84 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm9,%ymm8
 797:	ff ff ff 
 ...
 7ec:	00 00 
 7ee:	c4 62 35 b8 84 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm9,%ymm8
 7f5:	ff ff ff 
 7f8:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 7fe:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 802:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 808:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 80e:	48 01 d8             	add    %rbx,%rax
 811:	48 01 d8             	add    %rbx,%rax
 814:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 81a:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 820:	48 01 d8             	add    %rbx,%rax
 823:	48 01 d8             	add    %rbx,%rax
 826:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 82c:	48 01 d8             	add    %rbx,%rax
 82f:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 835:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 839:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 83f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 843:	c5 7c 10 8c b2 20 01 	vmovups 0x120(%rdx,%rsi,4),%ymm9
 84a:	00 00 
 84c:	c4 62 35 b8 84 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm9,%ymm8
 853:	ff ff ff 
 856:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 85c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 860:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 866:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 86c:	48 01 d8             	add    %rbx,%rax
 86f:	48 01 d8             	add    %rbx,%rax
 872:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 878:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 87e:	48 01 d8             	add    %rbx,%rax
 881:	48 01 d8             	add    %rbx,%rax
 884:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 88a:	48 01 d8             	add    %rbx,%rax
 88d:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 893:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 897:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 89d:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 8a1:	c5 7c 10 8c b2 40 01 	vmovups 0x140(%rdx,%rsi,4),%ymm9
 8a8:	00 00 
 8aa:	c4 62 35 b8 44 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm9,%ymm8
 8b1:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 8b7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8bb:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 8c1:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 8c7:	48 01 d8             	add    %rbx,%rax
 8ca:	48 01 d8             	add    %rbx,%rax
 8cd:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 8d3:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 8d9:	48 01 d8             	add    %rbx,%rax
 8dc:	48 01 d8             	add    %rbx,%rax
 8df:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 8e5:	48 01 d8             	add    %rbx,%rax
 8e8:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 8ee:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 8f2:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 8f8:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 8fc:	c5 7c 10 8c b2 60 01 	vmovups 0x160(%rdx,%rsi,4),%ymm9
 903:	00 00 
 905:	c4 62 35 b8 44 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm9,%ymm8
 90c:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 912:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 916:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 91c:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 922:	48 01 d8             	add    %rbx,%rax
 925:	48 01 d8             	add    %rbx,%rax
 928:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 92e:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 934:	48 01 d8             	add    %rbx,%rax
 937:	48 01 d8             	add    %rbx,%rax
 93a:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 940:	48 01 d8             	add    %rbx,%rax
 943:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 949:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 94d:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 953:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 957:	c5 7c 10 8c b2 80 01 	vmovups 0x180(%rdx,%rsi,4),%ymm9
 95e:	00 00 
 960:	c4 62 35 b8 44 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm9,%ymm8
 967:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 96d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 971:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 977:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 97d:	48 01 d8             	add    %rbx,%rax
 980:	48 01 d8             	add    %rbx,%rax
 983:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 989:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 98f:	48 01 d8             	add    %rbx,%rax
 992:	48 01 d8             	add    %rbx,%rax
 995:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 99b:	48 01 d8             	add    %rbx,%rax
 99e:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 9a4:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9a8:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 9ae:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9b2:	c5 7c 10 8c b2 a0 01 	vmovups 0x1a0(%rdx,%rsi,4),%ymm9
 9b9:	00 00 
 9bb:	c4 62 35 b8 44 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm9,%ymm8
 9c2:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 9c8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9cc:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 9d2:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 9d8:	48 01 d8             	add    %rbx,%rax
 9db:	48 01 d8             	add    %rbx,%rax
 9de:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 9e4:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 9ea:	48 01 d8             	add    %rbx,%rax
 9ed:	48 01 d8             	add    %rbx,%rax
 9f0:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 9f6:	48 01 d8             	add    %rbx,%rax
 9f9:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 9ff:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a03:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 a09:	48 01 d8             	add    %rbx,%rax
 a0c:	c5 7c 10 8c b2 c0 01 	vmovups 0x1c0(%rdx,%rsi,4),%ymm9
 a13:	00 00 
 a15:	c4 62 35 b8 44 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm9,%ymm8
 a1c:	48 83 c6 78          	add    $0x78,%rsi
 a20:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 a26:	48 01 f8             	add    %rdi,%rax
 a29:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 a2f:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 a35:	48 01 d8             	add    %rbx,%rax
 a38:	48 01 d8             	add    %rbx,%rax
 a3b:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 a41:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 a47:	48 01 d8             	add    %rbx,%rax
 a4a:	48 01 d8             	add    %rbx,%rax
 a4d:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 a53:	48 01 d8             	add    %rbx,%rax
 a56:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 a5c:	48 01 d8             	add    %rbx,%rax
 a5f:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 a65:	48 39 ce             	cmp    %rcx,%rsi
 a68:	0f 8c 82 fa ff ff    	jl     4f0 <.omp_outlined.+0x2d0>
 a6e:	e9 f3 f8 ff ff       	jmpq   366 <.omp_outlined.+0x146>
...
0000000000000a80 <_Z6enablev>:
 ...
 a82:	c3                   	retq   
 a83:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 a8a:	84 00 00 00 00 00 

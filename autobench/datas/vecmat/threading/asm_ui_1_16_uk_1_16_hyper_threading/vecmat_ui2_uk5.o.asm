...
0000000000000220 <.omp_outlined.>:
 ...
 2da:	5d                   	pop    %rbp
 2db:	c3                   	retq   
 2dc:	4d 8b 0c 24          	mov    (%r12),%r9
 2e0:	48 63 0d 00 00 00 00 	movslq 0x0(%rip),%rcx        # 2e7 <.omp_outlined.+0xc7>
 2e7:	49 8b 55 00          	mov    0x0(%r13),%rdx
 2eb:	4d 8b 17             	mov    (%r15),%r10
 2ee:	4c 63 c5             	movslq %ebp,%r8
 2f1:	89 c5                	mov    %eax,%ebp
 2f3:	44 8d 6c 00 01       	lea    0x1(%rax,%rax,1),%r13d
 2f8:	0f af e9             	imul   %ecx,%ebp
 2fb:	44 0f af e9          	imul   %ecx,%r13d
 2ff:	44 8d 1c 09          	lea    (%rcx,%rcx,1),%r11d
 303:	49 83 e9 80          	sub    $0xffffffffffffff80,%r9
 307:	01 ed                	add    %ebp,%ebp
 309:	eb 6a                	jmp    375 <.omp_outlined.+0x155>
 ...
 38f:	49 8d 3c b1          	lea    (%r9,%rsi,4),%rdi
 393:	48 63 f5             	movslq %ebp,%rsi
 396:	49 8d 34 b1          	lea    (%r9,%rsi,4),%rsi
 39a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
 3a0:	c5 fc 10 14 9a       	vmovups (%rdx,%rbx,4),%ymm2
 3a5:	c4 e2 6d b8 4c 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm2,%ymm1
 3ac:	c4 e2 6d b8 44 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm2,%ymm0
 3b3:	c5 fc 10 5c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm3
 3b9:	c5 fc 10 64 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm4
 3bf:	c5 fc 10 6c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm5
 3c5:	c5 fc 10 b4 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm6
 3cc:	00 00 
 3ce:	c4 e2 65 b8 4c 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm3,%ymm1
 3d5:	c4 e2 65 b8 44 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm3,%ymm0
 3dc:	c4 e2 5d b8 4c 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm4,%ymm1
 3e3:	c4 e2 5d b8 44 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm4,%ymm0
 3ea:	c4 e2 55 b8 4c 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm5,%ymm1
 3f1:	c4 e2 55 b8 44 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm5,%ymm0
 3f8:	c4 e2 4d b8 0c 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm6,%ymm1
 3fe:	c4 e2 4d b8 04 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm6,%ymm0
 404:	48 83 c3 28          	add    $0x28,%rbx
 408:	48 39 cb             	cmp    %rcx,%rbx
 40b:	7c 93                	jl     3a0 <.omp_outlined.+0x180>
 40d:	e9 06 ff ff ff       	jmpq   318 <.omp_outlined.+0xf8>
...
0000000000000420 <_Z6enablev>:
 ...
 433:	b8 28 00 00 00       	mov    $0x28,%eax
 438:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx

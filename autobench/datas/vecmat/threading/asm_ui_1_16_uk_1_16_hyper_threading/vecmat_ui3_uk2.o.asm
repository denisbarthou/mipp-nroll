...
vecmat_ui3_uk2.o:     file format elf64-x86-64
...
0000000000000220 <.omp_outlined.>:
 ...
 313:	48 8d 6c be 20       	lea    0x20(%rsi,%rdi,4),%rbp
 ...
 32d:	48 8d 7c be 20       	lea    0x20(%rsi,%rdi,4),%rdi
 332:	48 8d 74 9e 20       	lea    0x20(%rsi,%rbx,4),%rsi
 ...
 3f5:	c4 e2 65 b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm3,%ymm2
 3fc:	c4 e2 65 b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm3,%ymm1
 403:	c4 e2 65 b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm3,%ymm0
 40a:	c5 fc 10 64 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm4
 410:	c4 e2 5d b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm4,%ymm2
 417:	c4 e2 5d b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm4,%ymm1
 41d:	c4 e2 5d b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm4,%ymm0
 423:	48 83 c3 10          	add    $0x10,%rbx
 427:	48 39 cb             	cmp    %rcx,%rbx
 42a:	7c c4                	jl     3f0 <.omp_outlined.+0x1d0>
 42c:	e9 1b ff ff ff       	jmpq   34c <.omp_outlined.+0x12c>
...
0000000000000440 <_Z6enablev>:
 440:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 447 <_Z6enablev+0x7>
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui3_uk2.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000230 <.omp_outlined.>:
 ...
 32c:	48 8d ac b0 a0 00 00 	lea    0xa0(%rax,%rsi,4),%rbp
 333:	00 
 ...
 43a:	c4 e2 55 b8 a4 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm5,%ymm4
 441:	ff ff ff 
 444:	c5 fc 10 74 b2 20    	vmovups 0x20(%rdx,%rsi,4),%ymm6
 44a:	c5 fc 10 7c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm7
 450:	c5 7c 10 44 b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm8
 456:	c5 7c 10 8c b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm9
 45d:	00 00 
 45f:	c5 7c 10 94 b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm10
 466:	00 00 
 468:	c4 e2 55 b8 9c 88 60 	vfmadd231ps -0xa0(%rax,%rcx,4),%ymm5,%ymm3
 46f:	ff ff ff 
 472:	c4 e2 55 b8 84 c8 60 	vfmadd231ps -0xa0(%rax,%rcx,8),%ymm5,%ymm0
 479:	ff ff ff 
 47c:	48 8d 84 03 60 ff ff 	lea    -0xa0(%rbx,%rax,1),%rax
 483:	ff 
 484:	48 01 d8             	add    %rbx,%rax
 487:	c4 e2 55 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm5,%ymm2
 48d:	c4 e2 55 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm5,%ymm1
 493:	48 01 d8             	add    %rbx,%rax
 496:	48 01 d8             	add    %rbx,%rax
 499:	c4 e2 4d b8 64 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm6,%ymm4
 4a0:	c4 e2 4d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm3
 4a6:	48 01 f8             	add    %rdi,%rax
 4a9:	c4 e2 4d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm0
 4af:	c4 e2 4d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm6,%ymm2
 4b5:	48 01 d8             	add    %rbx,%rax
 4b8:	48 01 d8             	add    %rbx,%rax
 4bb:	c4 e2 45 b8 64 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm7,%ymm4
 4c2:	c4 e2 4d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm1
 4c8:	48 01 d8             	add    %rbx,%rax
 4cb:	c4 e2 45 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm3
 4d1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4d5:	c4 e2 45 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm0
 4db:	c4 e2 45 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm2
 4e1:	48 01 d8             	add    %rbx,%rax
 4e4:	48 01 d8             	add    %rbx,%rax
 4e7:	c4 e2 3d b8 64 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm8,%ymm4
 4ee:	c4 e2 45 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm1
 4f4:	48 01 d8             	add    %rbx,%rax
 4f7:	c4 e2 3d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm3
 4fd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 501:	c4 e2 3d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm0
 507:	c4 e2 3d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm2
 50d:	48 01 d8             	add    %rbx,%rax
 510:	48 01 d8             	add    %rbx,%rax
 513:	c4 e2 35 b8 64 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm9,%ymm4
 51a:	c4 e2 3d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm1
 520:	48 01 d8             	add    %rbx,%rax
 523:	c4 e2 35 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm3
 529:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 52d:	c4 e2 35 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm0
 533:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 539:	48 01 d8             	add    %rbx,%rax
 53c:	48 01 d8             	add    %rbx,%rax
 53f:	c4 e2 2d b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm10,%ymm4
 546:	48 83 c6 30          	add    $0x30,%rsi
 54a:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 550:	48 01 d8             	add    %rbx,%rax
 553:	c4 e2 2d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm3
 559:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 55d:	c4 e2 2d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm0
 563:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 569:	48 01 d8             	add    %rbx,%rax
 56c:	48 01 d8             	add    %rbx,%rax
 56f:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 575:	48 39 ce             	cmp    %rcx,%rsi
 578:	0f 8c b2 fe ff ff    	jl     430 <.omp_outlined.+0x200>
 57e:	e9 d1 fd ff ff       	jmpq   354 <.omp_outlined.+0x124>
 583:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 58a:	84 00 00 00 00 00 

0000000000000590 <_Z6enablev>:
 590:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 597 <_Z6enablev+0x7>
 597:	7d 03                	jge    59c <_Z6enablev+0xc>
 599:	31 c0                	xor    %eax,%eax
 59b:	c3                   	retq   
 59c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 5a3 <_Z6enablev+0x13>
 5a3:	b8 30 00 00 00       	mov    $0x30,%eax
 5a8:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
...
00000000000005c0 <_Z9n_reg_maxv>:
 5c0:	b8 1e 00 00 00       	mov    $0x1e,%eax
 5c5:	c3                   	retq   

...
0000000000000220 <.omp_outlined.>:
 ...
 2eb:	41 b9 a0 00 00 00    	mov    $0xa0,%r9d
 ...
 3a5:	c4 e2 6d b8 8c 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm2,%ymm1
 3ac:	ff ff ff 
 3af:	c4 e2 6d b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm2,%ymm0
 3b6:	ff ff ff 
 ...
 3db:	00 00 
 3dd:	c4 e2 65 b8 4c 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm3,%ymm1
 3e4:	c4 e2 65 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm3,%ymm0
 3eb:	c4 e2 5d b8 4c 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm4,%ymm1
 3f2:	c4 e2 5d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm4,%ymm0
 3f9:	c4 e2 55 b8 4c 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm5,%ymm1
 400:	c4 e2 55 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm5,%ymm0
 407:	c4 e2 4d b8 4c 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm6,%ymm1
 40e:	c4 e2 4d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm6,%ymm0
 415:	c4 e2 45 b8 4c 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm7,%ymm1
 41c:	c4 e2 45 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm7,%ymm0
 422:	48 83 c3 30          	add    $0x30,%rbx
 426:	48 39 cb             	cmp    %rcx,%rbx
 429:	0f 8c 71 ff ff ff    	jl     3a0 <.omp_outlined.+0x180>
 42f:	e9 e4 fe ff ff       	jmpq   318 <.omp_outlined.+0xf8>
 434:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
 43b:	00 00 00 00 00 

0000000000000440 <_Z6enablev>:
 440:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 447 <_Z6enablev+0x7>
 447:	7d 03                	jge    44c <_Z6enablev+0xc>
 449:	31 c0                	xor    %eax,%eax
 44b:	c3                   	retq   
 44c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 453 <_Z6enablev+0x13>
 453:	b8 30 00 00 00       	mov    $0x30,%eax
 458:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx

...
0000000000000210 <.omp_outlined.>:
 ...
 321:	be c0 01 00 00       	mov    $0x1c0,%esi
 ...
 4a6:	c4 82 5d b8 9c a9 40 	vfmadd231ps -0x1c0(%r9,%r13,4),%ymm4,%ymm3
 4ad:	fe ff ff 
 4b0:	c4 82 5d b8 94 ac 40 	vfmadd231ps -0x1c0(%r12,%r13,4),%ymm4,%ymm2
 4b7:	fe ff ff 
 4ba:	c4 82 5d b8 8c af 40 	vfmadd231ps -0x1c0(%r15,%r13,4),%ymm4,%ymm1
 4c1:	fe ff ff 
 4c4:	c4 82 5d b8 84 a8 40 	vfmadd231ps -0x1c0(%r8,%r13,4),%ymm4,%ymm0
 4cb:	fe ff ff 
 4ce:	c4 a1 7c 10 64 aa 20 	vmovups 0x20(%rdx,%r13,4),%ymm4
 4d5:	c4 82 5d b8 9c a9 60 	vfmadd231ps -0x1a0(%r9,%r13,4),%ymm4,%ymm3
 4dc:	fe ff ff 
 4df:	c4 82 5d b8 94 ac 60 	vfmadd231ps -0x1a0(%r12,%r13,4),%ymm4,%ymm2
 4e6:	fe ff ff 
 4e9:	c4 82 5d b8 8c af 60 	vfmadd231ps -0x1a0(%r15,%r13,4),%ymm4,%ymm1
 4f0:	fe ff ff 
 4f3:	c4 82 5d b8 84 a8 60 	vfmadd231ps -0x1a0(%r8,%r13,4),%ymm4,%ymm0
 4fa:	fe ff ff 
 4fd:	c4 a1 7c 10 64 aa 40 	vmovups 0x40(%rdx,%r13,4),%ymm4
 504:	c4 82 5d b8 9c a9 80 	vfmadd231ps -0x180(%r9,%r13,4),%ymm4,%ymm3
 50b:	fe ff ff 
 50e:	c4 82 5d b8 94 ac 80 	vfmadd231ps -0x180(%r12,%r13,4),%ymm4,%ymm2
 515:	fe ff ff 
 518:	c4 82 5d b8 8c af 80 	vfmadd231ps -0x180(%r15,%r13,4),%ymm4,%ymm1
 51f:	fe ff ff 
 522:	c4 82 5d b8 84 a8 80 	vfmadd231ps -0x180(%r8,%r13,4),%ymm4,%ymm0
 529:	fe ff ff 
 52c:	c4 a1 7c 10 64 aa 60 	vmovups 0x60(%rdx,%r13,4),%ymm4
 533:	c4 82 5d b8 9c a9 a0 	vfmadd231ps -0x160(%r9,%r13,4),%ymm4,%ymm3
 53a:	fe ff ff 
 53d:	c4 82 5d b8 94 ac a0 	vfmadd231ps -0x160(%r12,%r13,4),%ymm4,%ymm2
 544:	fe ff ff 
 547:	c4 82 5d b8 8c af a0 	vfmadd231ps -0x160(%r15,%r13,4),%ymm4,%ymm1
 54e:	fe ff ff 
 551:	c4 82 5d b8 84 a8 a0 	vfmadd231ps -0x160(%r8,%r13,4),%ymm4,%ymm0
 558:	fe ff ff 
 55b:	c4 a1 7c 10 a4 aa 80 	vmovups 0x80(%rdx,%r13,4),%ymm4
 562:	00 00 00 
 565:	c4 82 5d b8 9c a9 c0 	vfmadd231ps -0x140(%r9,%r13,4),%ymm4,%ymm3
 56c:	fe ff ff 
 56f:	c4 82 5d b8 94 ac c0 	vfmadd231ps -0x140(%r12,%r13,4),%ymm4,%ymm2
 576:	fe ff ff 
 579:	c4 82 5d b8 8c af c0 	vfmadd231ps -0x140(%r15,%r13,4),%ymm4,%ymm1
 580:	fe ff ff 
 583:	c4 82 5d b8 84 a8 c0 	vfmadd231ps -0x140(%r8,%r13,4),%ymm4,%ymm0
 58a:	fe ff ff 
 58d:	c4 a1 7c 10 a4 aa a0 	vmovups 0xa0(%rdx,%r13,4),%ymm4
 594:	00 00 00 
 597:	c4 82 5d b8 9c a9 e0 	vfmadd231ps -0x120(%r9,%r13,4),%ymm4,%ymm3
 59e:	fe ff ff 
 5a1:	c4 82 5d b8 94 ac e0 	vfmadd231ps -0x120(%r12,%r13,4),%ymm4,%ymm2
 5a8:	fe ff ff 
 5ab:	c4 82 5d b8 8c af e0 	vfmadd231ps -0x120(%r15,%r13,4),%ymm4,%ymm1
 5b2:	fe ff ff 
 5b5:	c4 82 5d b8 84 a8 e0 	vfmadd231ps -0x120(%r8,%r13,4),%ymm4,%ymm0
 5bc:	fe ff ff 
 5bf:	c4 a1 7c 10 a4 aa c0 	vmovups 0xc0(%rdx,%r13,4),%ymm4
 5c6:	00 00 00 
 5c9:	c4 82 5d b8 9c a9 00 	vfmadd231ps -0x100(%r9,%r13,4),%ymm4,%ymm3
 5d0:	ff ff ff 
 5d3:	c4 82 5d b8 94 ac 00 	vfmadd231ps -0x100(%r12,%r13,4),%ymm4,%ymm2
 5da:	ff ff ff 
 5dd:	c4 82 5d b8 8c af 00 	vfmadd231ps -0x100(%r15,%r13,4),%ymm4,%ymm1
 5e4:	ff ff ff 
 5e7:	c4 82 5d b8 84 a8 00 	vfmadd231ps -0x100(%r8,%r13,4),%ymm4,%ymm0
 5ee:	ff ff ff 
 5f1:	c4 a1 7c 10 a4 aa e0 	vmovups 0xe0(%rdx,%r13,4),%ymm4
 5f8:	00 00 00 
 5fb:	c4 82 5d b8 9c a9 20 	vfmadd231ps -0xe0(%r9,%r13,4),%ymm4,%ymm3
 602:	ff ff ff 
 605:	c4 82 5d b8 94 ac 20 	vfmadd231ps -0xe0(%r12,%r13,4),%ymm4,%ymm2
 60c:	ff ff ff 
 60f:	c4 82 5d b8 8c af 20 	vfmadd231ps -0xe0(%r15,%r13,4),%ymm4,%ymm1
 616:	ff ff ff 
 619:	c4 82 5d b8 84 a8 20 	vfmadd231ps -0xe0(%r8,%r13,4),%ymm4,%ymm0
 620:	ff ff ff 
 623:	c4 a1 7c 10 a4 aa 00 	vmovups 0x100(%rdx,%r13,4),%ymm4
 62a:	01 00 00 
 62d:	c4 82 5d b8 9c a9 40 	vfmadd231ps -0xc0(%r9,%r13,4),%ymm4,%ymm3
 634:	ff ff ff 
 637:	c4 82 5d b8 94 ac 40 	vfmadd231ps -0xc0(%r12,%r13,4),%ymm4,%ymm2
 63e:	ff ff ff 
 641:	c4 82 5d b8 8c af 40 	vfmadd231ps -0xc0(%r15,%r13,4),%ymm4,%ymm1
 648:	ff ff ff 
 64b:	c4 82 5d b8 84 a8 40 	vfmadd231ps -0xc0(%r8,%r13,4),%ymm4,%ymm0
 652:	ff ff ff 
 655:	c4 a1 7c 10 a4 aa 20 	vmovups 0x120(%rdx,%r13,4),%ymm4
 65c:	01 00 00 
 65f:	c4 82 5d b8 9c a9 60 	vfmadd231ps -0xa0(%r9,%r13,4),%ymm4,%ymm3
 666:	ff ff ff 
 669:	c4 82 5d b8 94 ac 60 	vfmadd231ps -0xa0(%r12,%r13,4),%ymm4,%ymm2
 670:	ff ff ff 
 673:	c4 82 5d b8 8c af 60 	vfmadd231ps -0xa0(%r15,%r13,4),%ymm4,%ymm1
 67a:	ff ff ff 
 67d:	c4 82 5d b8 84 a8 60 	vfmadd231ps -0xa0(%r8,%r13,4),%ymm4,%ymm0
 684:	ff ff ff 
 687:	c4 a1 7c 10 a4 aa 40 	vmovups 0x140(%rdx,%r13,4),%ymm4
 68e:	01 00 00 
 691:	c4 82 5d b8 5c a9 80 	vfmadd231ps -0x80(%r9,%r13,4),%ymm4,%ymm3
 698:	c4 82 5d b8 54 ac 80 	vfmadd231ps -0x80(%r12,%r13,4),%ymm4,%ymm2
 69f:	c4 82 5d b8 4c af 80 	vfmadd231ps -0x80(%r15,%r13,4),%ymm4,%ymm1
 6a6:	c4 82 5d b8 44 a8 80 	vfmadd231ps -0x80(%r8,%r13,4),%ymm4,%ymm0
 6ad:	c4 a1 7c 10 a4 aa 60 	vmovups 0x160(%rdx,%r13,4),%ymm4
 6b4:	01 00 00 
 6b7:	c4 82 5d b8 5c a9 a0 	vfmadd231ps -0x60(%r9,%r13,4),%ymm4,%ymm3
 6be:	c4 82 5d b8 54 ac a0 	vfmadd231ps -0x60(%r12,%r13,4),%ymm4,%ymm2
 6c5:	c4 82 5d b8 4c af a0 	vfmadd231ps -0x60(%r15,%r13,4),%ymm4,%ymm1
 6cc:	c4 82 5d b8 44 a8 a0 	vfmadd231ps -0x60(%r8,%r13,4),%ymm4,%ymm0
 6d3:	c4 a1 7c 10 a4 aa 80 	vmovups 0x180(%rdx,%r13,4),%ymm4
 6da:	01 00 00 
 6dd:	c4 82 5d b8 5c a9 c0 	vfmadd231ps -0x40(%r9,%r13,4),%ymm4,%ymm3
 6e4:	c4 82 5d b8 54 ac c0 	vfmadd231ps -0x40(%r12,%r13,4),%ymm4,%ymm2
 6eb:	c4 82 5d b8 4c af c0 	vfmadd231ps -0x40(%r15,%r13,4),%ymm4,%ymm1
 6f2:	c4 82 5d b8 44 a8 c0 	vfmadd231ps -0x40(%r8,%r13,4),%ymm4,%ymm0
 6f9:	c4 a1 7c 10 a4 aa a0 	vmovups 0x1a0(%rdx,%r13,4),%ymm4
 700:	01 00 00 
 703:	c4 82 5d b8 5c a9 e0 	vfmadd231ps -0x20(%r9,%r13,4),%ymm4,%ymm3
 70a:	c4 82 5d b8 54 ac e0 	vfmadd231ps -0x20(%r12,%r13,4),%ymm4,%ymm2
 711:	c4 82 5d b8 4c af e0 	vfmadd231ps -0x20(%r15,%r13,4),%ymm4,%ymm1
 718:	c4 82 5d b8 44 a8 e0 	vfmadd231ps -0x20(%r8,%r13,4),%ymm4,%ymm0
 71f:	c4 a1 7c 10 a4 aa c0 	vmovups 0x1c0(%rdx,%r13,4),%ymm4
 726:	01 00 00 
 729:	c4 82 5d b8 1c a9    	vfmadd231ps (%r9,%r13,4),%ymm4,%ymm3
 72f:	c4 82 5d b8 14 ac    	vfmadd231ps (%r12,%r13,4),%ymm4,%ymm2
 735:	c4 82 5d b8 0c af    	vfmadd231ps (%r15,%r13,4),%ymm4,%ymm1
 73b:	c4 82 5d b8 04 a8    	vfmadd231ps (%r8,%r13,4),%ymm4,%ymm0
 741:	49 83 c5 78          	add    $0x78,%r13
 745:	4d 39 d5             	cmp    %r10,%r13
 748:	0f 8c 52 fd ff ff    	jl     4a0 <.omp_outlined.+0x290>
 74e:	e9 fd fb ff ff       	jmpq   350 <.omp_outlined.+0x140>
 753:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 75a:	84 00 00 00 00 00 

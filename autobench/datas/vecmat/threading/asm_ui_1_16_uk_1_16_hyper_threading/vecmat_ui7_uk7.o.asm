...
0000000000000220 <.omp_outlined.>:
 ...
 31f:	48 8d ac 38 c0 00 00 	lea    0xc0(%rax,%rdi,1),%rbp
 326:	00 
 ...
 4b6:	c4 e2 45 b8 b4 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm7,%ymm6
 4bd:	ff ff ff 
 4c0:	c5 7c 10 54 b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm10
 ...
 4df:	00 00 
 4e1:	c4 e2 45 b8 ac 88 40 	vfmadd231ps -0xc0(%rax,%rcx,4),%ymm7,%ymm5
 4e8:	ff ff ff 
 4eb:	c4 e2 45 b8 94 c8 40 	vfmadd231ps -0xc0(%rax,%rcx,8),%ymm7,%ymm2
 4f2:	ff ff ff 
 4f5:	48 8d 84 07 40 ff ff 	lea    -0xc0(%rdi,%rax,1),%rax
 4fc:	ff 
 4fd:	48 01 f8             	add    %rdi,%rax
 500:	c4 e2 45 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm4
 506:	c4 e2 45 b8 1c c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm3
 50c:	48 01 f8             	add    %rdi,%rax
 50f:	48 01 f8             	add    %rdi,%rax
 512:	c4 e2 3d b8 b4 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm8,%ymm6
 519:	ff ff ff 
 51c:	c4 e2 45 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm1
 522:	48 01 f8             	add    %rdi,%rax
 525:	c4 e2 45 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm0
 52b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 52f:	c4 e2 3d b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm8,%ymm5
 535:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 539:	c4 e2 3d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm2
 53f:	c4 e2 3d b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm4
 545:	48 01 f8             	add    %rdi,%rax
 548:	c4 e2 35 b8 74 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm9,%ymm6
 54f:	48 01 f8             	add    %rdi,%rax
 552:	c4 e2 3d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm3
 558:	c4 e2 3d b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm1
 55e:	48 01 f8             	add    %rdi,%rax
 561:	48 01 f8             	add    %rdi,%rax
 564:	c4 e2 3d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm0
 56a:	48 01 f8             	add    %rdi,%rax
 56d:	c4 e2 2d b8 74 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm10,%ymm6
 574:	c4 e2 35 b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm9,%ymm5
 57a:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 57e:	c4 e2 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm2
 584:	c4 e2 35 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm4
 58a:	48 01 f8             	add    %rdi,%rax
 58d:	48 01 f8             	add    %rdi,%rax
 590:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 596:	c4 e2 35 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm1
 59c:	48 01 f8             	add    %rdi,%rax
 59f:	c4 e2 25 b8 74 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm11,%ymm6
 5a6:	48 01 f8             	add    %rdi,%rax
 5a9:	c4 e2 35 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm0
 5af:	48 01 f8             	add    %rdi,%rax
 5b2:	c4 e2 2d b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm10,%ymm5
 5b8:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5bc:	c4 e2 2d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm2
 5c2:	c4 e2 2d b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm4
 5c8:	48 01 f8             	add    %rdi,%rax
 5cb:	c4 e2 1d b8 74 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm12,%ymm6
 5d2:	48 01 f8             	add    %rdi,%rax
 5d5:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 5db:	c4 e2 2d b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm1
 5e1:	48 01 f8             	add    %rdi,%rax
 5e4:	48 01 f8             	add    %rdi,%rax
 5e7:	c4 e2 2d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm0
 5ed:	48 01 f8             	add    %rdi,%rax
 5f0:	c4 e2 15 b8 74 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm13,%ymm6
 5f7:	48 83 c6 38          	add    $0x38,%rsi
 5fb:	c4 e2 25 b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm5
 601:	48 01 d8             	add    %rbx,%rax
 604:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 60a:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 610:	48 01 f8             	add    %rdi,%rax
 613:	48 01 f8             	add    %rdi,%rax
 616:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 61c:	c4 e2 25 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm1
 622:	48 01 f8             	add    %rdi,%rax
 625:	48 01 f8             	add    %rdi,%rax
 628:	c4 e2 25 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm0
 62e:	48 01 f8             	add    %rdi,%rax
 631:	c4 e2 1d b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm12,%ymm5
 637:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 63b:	c4 e2 1d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm2
 641:	c4 e2 1d b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm4
 647:	48 01 f8             	add    %rdi,%rax
 64a:	48 01 f8             	add    %rdi,%rax
 64d:	c4 e2 1d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm3
 653:	c4 e2 1d b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm1
 659:	48 01 f8             	add    %rdi,%rax
 65c:	48 01 f8             	add    %rdi,%rax
 65f:	c4 e2 1d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm0
 665:	48 01 f8             	add    %rdi,%rax
 668:	c4 e2 15 b8 2c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm5
 66e:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 672:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 678:	c4 e2 15 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm4
 67e:	48 01 f8             	add    %rdi,%rax
 681:	48 01 f8             	add    %rdi,%rax
 684:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 68a:	c4 e2 15 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm1
 690:	48 01 f8             	add    %rdi,%rax
 693:	48 01 f8             	add    %rdi,%rax
 696:	c4 e2 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm0
 69c:	48 39 ce             	cmp    %rcx,%rsi
 69f:	0f 8c fb fd ff ff    	jl     4a0 <.omp_outlined.+0x280>
 6a5:	e9 c2 fc ff ff       	jmpq   36c <.omp_outlined.+0x14c>
...
00000000000006c0 <_Z9n_reg_maxv>:
 6c0:	b8 31 00 00 00       	mov    $0x31,%eax
 6c5:	c3                   	retq   

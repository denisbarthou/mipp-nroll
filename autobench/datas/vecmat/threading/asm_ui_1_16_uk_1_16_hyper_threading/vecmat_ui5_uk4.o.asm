...
vecmat_ui5_uk4.o:     file format elf64-x86-64
...
0000000000000220 <.omp_outlined.>:
 ...
 310:	4c 8d 0c 9b          	lea    (%rbx,%rbx,4),%r9
 314:	48 8d 3c bf          	lea    (%rdi,%rdi,4),%rdi
 318:	48 8d 6c be 60       	lea    0x60(%rsi,%rdi,4),%rbp
 31d:	48 8d 34 5b          	lea    (%rbx,%rbx,2),%rsi
 321:	bf 20 00 00 00       	mov    $0x20,%edi
 326:	48 29 f7             	sub    %rsi,%rdi
 329:	e9 cf 00 00 00       	jmpq   3fd <.omp_outlined.+0x1dd>
 ...
 3f0:	4d 39 c6             	cmp    %r8,%r14
 3f3:	4d 8d 76 01          	lea    0x1(%r14),%r14
 3f7:	0f 8d cf fe ff ff    	jge    2cc <.omp_outlined.+0xac>
 3fd:	4f 8d 1c b6          	lea    (%r14,%r14,4),%r11
 401:	85 c9                	test   %ecx,%ecx
 403:	0f 8e 27 ff ff ff    	jle    330 <.omp_outlined.+0x110>
 409:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
 40d:	31 f6                	xor    %esi,%esi
 40f:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 413:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 417:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 41b:	c5 f0 57 c9          	vxorps %xmm1,%xmm1,%xmm1
 41f:	90                   	nop
 420:	48 8d 44 b5 00       	lea    0x0(%rbp,%rsi,4),%rax
 425:	c5 fc 10 2c b2       	vmovups (%rdx,%rsi,4),%ymm5
 42a:	c4 e2 55 b8 64 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm5,%ymm4
 431:	c5 fc 10 74 b2 20    	vmovups 0x20(%rdx,%rsi,4),%ymm6
 437:	c5 fc 10 7c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm7
 43d:	c5 7c 10 44 b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm8
 443:	c4 e2 55 b8 5c 88 a0 	vfmadd231ps -0x60(%rax,%rcx,4),%ymm5,%ymm3
 44a:	c4 e2 55 b8 44 c8 a0 	vfmadd231ps -0x60(%rax,%rcx,8),%ymm5,%ymm0
 451:	48 8d 44 03 a0       	lea    -0x60(%rbx,%rax,1),%rax
 456:	48 01 d8             	add    %rbx,%rax
 459:	c4 e2 55 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm5,%ymm2
 45f:	c4 e2 55 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm5,%ymm1
 465:	48 01 d8             	add    %rbx,%rax
 468:	48 01 d8             	add    %rbx,%rax
 46b:	c4 e2 4d b8 64 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm6,%ymm4
 472:	c4 e2 4d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm3
 478:	48 01 f8             	add    %rdi,%rax
 47b:	c4 e2 4d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm0
 481:	c4 e2 4d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm6,%ymm2
 487:	48 01 d8             	add    %rbx,%rax
 48a:	48 01 d8             	add    %rbx,%rax
 48d:	c4 e2 45 b8 64 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm7,%ymm4
 494:	c4 e2 4d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm1
 49a:	48 01 d8             	add    %rbx,%rax
 49d:	c4 e2 45 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm3
 4a3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4a7:	c4 e2 45 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm0
 4ad:	c4 e2 45 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm2
 4b3:	48 01 d8             	add    %rbx,%rax
 4b6:	48 01 d8             	add    %rbx,%rax
 4b9:	c4 e2 3d b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm8,%ymm4
 4c0:	48 83 c6 20          	add    $0x20,%rsi
 4c4:	c4 e2 45 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm1
 4ca:	48 01 d8             	add    %rbx,%rax
 4cd:	c4 e2 3d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm3
 4d3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4d7:	c4 e2 3d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm0
 4dd:	c4 e2 3d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm2
 4e3:	48 01 d8             	add    %rbx,%rax
 4e6:	48 01 d8             	add    %rbx,%rax
 4e9:	c4 e2 3d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm1
 4ef:	48 39 ce             	cmp    %rcx,%rsi
 4f2:	0f 8c 28 ff ff ff    	jl     420 <.omp_outlined.+0x200>
 4f8:	e9 47 fe ff ff       	jmpq   344 <.omp_outlined.+0x124>
 4fd:	0f 1f 00             	nopl   (%rax)

0000000000000500 <_Z6enablev>:
 500:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 507 <_Z6enablev+0x7>
 507:	7d 03                	jge    50c <_Z6enablev+0xc>
 509:	31 c0                	xor    %eax,%eax
 50b:	c3                   	retq   
 50c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 513 <_Z6enablev+0x13>
 513:	b8 20 00 00 00       	mov    $0x20,%eax
 518:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui5_uk4.cpp+0x9a>
  96:	01 00 00 00 

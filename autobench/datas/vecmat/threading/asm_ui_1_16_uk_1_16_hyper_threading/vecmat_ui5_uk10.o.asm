...
0000000000000220 <.omp_outlined.>:
 ...
 42a:	c4 e2 55 b8 a4 b5 e0 	vfmadd231ps -0x120(%rbp,%rsi,4),%ymm5,%ymm4
 431:	fe ff ff 
 ...
 47a:	00 00 
 47c:	c4 e2 55 b8 9c 88 e0 	vfmadd231ps -0x120(%rax,%rcx,4),%ymm5,%ymm3
 483:	fe ff ff 
 486:	c4 e2 55 b8 84 c8 e0 	vfmadd231ps -0x120(%rax,%rcx,8),%ymm5,%ymm0
 48d:	fe ff ff 
 490:	48 8d 84 03 e0 fe ff 	lea    -0x120(%rbx,%rax,1),%rax
 497:	ff 
 498:	48 01 d8             	add    %rbx,%rax
 49b:	c4 e2 55 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm5,%ymm2
 4a1:	c4 e2 55 b8 0c c8    	vfmadd231ps (%rax,%rcx,8),%ymm5,%ymm1
 4a7:	48 01 d8             	add    %rbx,%rax
 4aa:	48 01 d8             	add    %rbx,%rax
 4ad:	c4 e2 4d b8 a4 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm6,%ymm4
 4b4:	ff ff ff 
 4b7:	c4 e2 4d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm3
 4bd:	48 01 f8             	add    %rdi,%rax
 4c0:	c4 e2 4d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm0
 4c6:	c4 e2 4d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm6,%ymm2
 4cc:	48 01 d8             	add    %rbx,%rax
 4cf:	48 01 d8             	add    %rbx,%rax
 4d2:	c4 e2 45 b8 a4 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm7,%ymm4
 4d9:	ff ff ff 
 4dc:	c4 e2 4d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm6,%ymm1
 4e2:	48 01 d8             	add    %rbx,%rax
 4e5:	c4 e2 45 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm3
 4eb:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4ef:	c4 e2 45 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm0
 4f5:	c4 e2 45 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm7,%ymm2
 4fb:	48 01 d8             	add    %rbx,%rax
 4fe:	48 01 d8             	add    %rbx,%rax
 501:	c4 e2 3d b8 a4 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm8,%ymm4
 508:	ff ff ff 
 50b:	c4 e2 45 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm7,%ymm1
 511:	48 01 d8             	add    %rbx,%rax
 514:	c4 e2 3d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm3
 51a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 51e:	c4 e2 3d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm0
 524:	c4 e2 3d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm8,%ymm2
 52a:	48 01 d8             	add    %rbx,%rax
 52d:	48 01 d8             	add    %rbx,%rax
 530:	c4 e2 35 b8 a4 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm9,%ymm4
 537:	ff ff ff 
 53a:	c4 e2 3d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm8,%ymm1
 540:	48 01 d8             	add    %rbx,%rax
 543:	c4 e2 35 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm3
 549:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 54d:	c4 e2 35 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm0
 553:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 559:	48 01 d8             	add    %rbx,%rax
 55c:	48 01 d8             	add    %rbx,%rax
 55f:	c4 e2 2d b8 64 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm10,%ymm4
 566:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 56c:	48 01 d8             	add    %rbx,%rax
 56f:	c4 e2 2d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm3
 575:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 579:	c4 e2 2d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm0
 57f:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 585:	48 01 d8             	add    %rbx,%rax
 588:	48 01 d8             	add    %rbx,%rax
 58b:	c4 e2 25 b8 64 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm11,%ymm4
 592:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 598:	48 01 d8             	add    %rbx,%rax
 59b:	c4 e2 25 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm11,%ymm3
 5a1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5a5:	c4 e2 25 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm0
 5ab:	c4 e2 25 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm2
 5b1:	48 01 d8             	add    %rbx,%rax
 5b4:	48 01 d8             	add    %rbx,%rax
 5b7:	c4 e2 1d b8 64 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm12,%ymm4
 5be:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 5c4:	48 01 d8             	add    %rbx,%rax
 5c7:	c4 e2 1d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm12,%ymm3
 5cd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5d1:	c4 e2 1d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm0
 5d7:	c4 e2 1d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm2
 5dd:	48 01 d8             	add    %rbx,%rax
 5e0:	48 01 d8             	add    %rbx,%rax
 5e3:	c4 e2 15 b8 64 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm13,%ymm4
 5ea:	c4 e2 1d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm1
 5f0:	48 01 d8             	add    %rbx,%rax
 5f3:	c4 e2 15 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm13,%ymm3
 5f9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5fd:	c4 e2 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm0
 603:	c4 e2 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm2
 609:	48 01 d8             	add    %rbx,%rax
 60c:	48 01 d8             	add    %rbx,%rax
 60f:	c4 e2 0d b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm14,%ymm4
 616:	48 83 c6 50          	add    $0x50,%rsi
 61a:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 620:	48 01 d8             	add    %rbx,%rax
 623:	c4 e2 0d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm14,%ymm3
 629:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 62d:	c4 e2 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm0
 633:	c4 e2 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm2
 639:	48 01 d8             	add    %rbx,%rax
 63c:	48 01 d8             	add    %rbx,%rax
 63f:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 645:	48 39 ce             	cmp    %rcx,%rsi
 648:	0f 8c d2 fd ff ff    	jl     420 <.omp_outlined.+0x200>
 64e:	e9 f1 fc ff ff       	jmpq   344 <.omp_outlined.+0x124>
...
0000000000000670 <_Z9n_reg_maxv>:
 670:	b8 32 00 00 00       	mov    $0x32,%eax
 675:	c3                   	retq   

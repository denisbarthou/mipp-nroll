...
0000000000000220 <.omp_outlined.>:
 ...
 28f:	4c 8d 44 24 18       	lea    0x18(%rsp),%r8
 ...
 2b9:	4c 63 74 24 10       	movslq 0x10(%rsp),%r14
 ...
 2f7:	4d 8b 17             	mov    (%r15),%r10
 2fa:	4d 8b 6d 00          	mov    0x0(%r13),%r13
 2fe:	48 63 c5             	movslq %ebp,%rax
 301:	41 bf 20 00 00 00    	mov    $0x20,%r15d
 307:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
 30c:	48 89 cf             	mov    %rcx,%rdi
 30f:	48 8d 1c 8d 00 00 00 	lea    0x0(,%rcx,4),%rbx
 316:	00 
 317:	49 0f af fe          	imul   %r14,%rdi
 31b:	48 8d 04 5b          	lea    (%rbx,%rbx,2),%rax
 31f:	4c 8d 0c 9b          	lea    (%rbx,%rbx,4),%r9
 323:	49 29 c7             	sub    %rax,%r15
 326:	48 8d 3c bf          	lea    (%rdi,%rdi,4),%rdi
 32a:	4c 8d 64 be 20       	lea    0x20(%rsi,%rdi,4),%r12
 32f:	e9 db 00 00 00       	jmpq   40f <.omp_outlined.+0x1ef>
 ...
 400:	4c 3b 74 24 20       	cmp    0x20(%rsp),%r14
 405:	4d 8d 76 01          	lea    0x1(%r14),%r14
 409:	0f 8d bd fe ff ff    	jge    2cc <.omp_outlined.+0xac>
 40f:	4f 8d 1c b6          	lea    (%r14,%r14,4),%r11
 413:	85 c9                	test   %ecx,%ecx
 415:	0f 8e 25 ff ff ff    	jle    340 <.omp_outlined.+0x120>
 41b:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
 41f:	31 f6                	xor    %esi,%esi
 421:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 425:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 429:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 42d:	c5 f0 57 c9          	vxorps %xmm1,%xmm1,%xmm1
 431:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 438:	0f 1f 84 00 00 00 00 
 43f:	00 
 440:	49 8d 04 b4          	lea    (%r12,%rsi,4),%rax
 444:	c4 c1 7c 10 6c b5 00 	vmovups 0x0(%r13,%rsi,4),%ymm5
 44b:	c4 c2 55 b8 64 b4 e0 	vfmadd231ps -0x20(%r12,%rsi,4),%ymm5,%ymm4
 452:	c4 c1 7c 10 74 b5 20 	vmovups 0x20(%r13,%rsi,4),%ymm6
 459:	48 8d 54 03 e0       	lea    -0x20(%rbx,%rax,1),%rdx
 45e:	c4 e2 55 b8 5c 88 e0 	vfmadd231ps -0x20(%rax,%rcx,4),%ymm5,%ymm3
 465:	c4 e2 55 b8 44 c8 e0 	vfmadd231ps -0x20(%rax,%rcx,8),%ymm5,%ymm0
 46c:	48 01 da             	add    %rbx,%rdx
 46f:	48 8d 3c 1a          	lea    (%rdx,%rbx,1),%rdi
 473:	c4 e2 55 b8 14 8a    	vfmadd231ps (%rdx,%rcx,4),%ymm5,%ymm2
 479:	c4 e2 55 b8 0c ca    	vfmadd231ps (%rdx,%rcx,8),%ymm5,%ymm1
 47f:	48 01 df             	add    %rbx,%rdi
 482:	c4 c2 4d b8 24 b4    	vfmadd231ps (%r12,%rsi,4),%ymm6,%ymm4
 488:	48 83 c6 10          	add    $0x10,%rsi
 48c:	4a 8d 2c 3f          	lea    (%rdi,%r15,1),%rbp
 490:	c4 c2 4d b8 1c 3f    	vfmadd231ps (%r15,%rdi,1),%ymm6,%ymm3
 496:	4c 8d 44 1d 00       	lea    0x0(%rbp,%rbx,1),%r8
 49b:	c4 e2 4d b8 44 8d 00 	vfmadd231ps 0x0(%rbp,%rcx,4),%ymm6,%ymm0
 4a2:	49 01 d8             	add    %rbx,%r8
 4a5:	c4 e2 4d b8 54 cd 00 	vfmadd231ps 0x0(%rbp,%rcx,8),%ymm6,%ymm2
 4ac:	c4 c2 4d b8 0c 88    	vfmadd231ps (%r8,%rcx,4),%ymm6,%ymm1
 4b2:	48 39 ce             	cmp    %rcx,%rsi
 4b5:	7c 89                	jl     440 <.omp_outlined.+0x220>
 4b7:	e9 98 fe ff ff       	jmpq   354 <.omp_outlined.+0x134>
 4bc:	0f 1f 40 00          	nopl   0x0(%rax)

00000000000004c0 <_Z6enablev>:
 4c0:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 4c7 <_Z6enablev+0x7>
 ...
 4d8:	b9 fe ff ff ff       	mov    $0xfffffffe,%ecx

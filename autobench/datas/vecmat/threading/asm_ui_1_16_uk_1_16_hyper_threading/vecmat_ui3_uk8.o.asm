...
0000000000000220 <.omp_outlined.>:
 ...
 313:	48 8d ac be e0 00 00 	lea    0xe0(%rsi,%rdi,4),%rbp
 31a:	00 
 ...
 330:	48 8d bc be e0 00 00 	lea    0xe0(%rsi,%rdi,4),%rdi
 337:	00 
 338:	48 8d b4 9e e0 00 00 	lea    0xe0(%rsi,%rbx,4),%rsi
 33f:	00 
 ...
 3fb:	00 00 00 00 00 
 400:	c5 fc 10 3c 9a       	vmovups (%rdx,%rbx,4),%ymm7
 405:	c4 e2 45 b8 94 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm7,%ymm2
 40c:	ff ff ff 
 40f:	c4 e2 45 b8 8c 9f 20 	vfmadd231ps -0xe0(%rdi,%rbx,4),%ymm7,%ymm1
 416:	ff ff ff 
 419:	c4 e2 45 b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm7,%ymm0
 420:	ff ff ff 
 423:	c5 7c 10 44 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm8
 429:	c5 7c 10 4c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm9
 42f:	c5 7c 10 54 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm10
 435:	c5 fc 10 b4 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm6
 43c:	00 00 
 43e:	c5 fc 10 ac 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm5
 445:	00 00 
 447:	c5 fc 10 a4 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm4
 44e:	00 00 
 450:	c5 fc 10 9c 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm3
 457:	00 00 
 459:	c4 e2 3d b8 94 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm8,%ymm2
 460:	ff ff ff 
 463:	c4 e2 3d b8 8c 9f 40 	vfmadd231ps -0xc0(%rdi,%rbx,4),%ymm8,%ymm1
 46a:	ff ff ff 
 46d:	c4 e2 3d b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm8,%ymm0
 474:	ff ff ff 
 477:	c4 e2 35 b8 94 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm9,%ymm2
 47e:	ff ff ff 
 481:	c4 e2 35 b8 8c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm9,%ymm1
 488:	ff ff ff 
 48b:	c4 e2 35 b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm9,%ymm0
 492:	ff ff ff 
 495:	c4 e2 2d b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm10,%ymm2
 49c:	c4 e2 2d b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm10,%ymm1
 4a3:	c4 e2 2d b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm10,%ymm0
 4aa:	c4 e2 4d b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm6,%ymm2
 4b1:	c4 e2 4d b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm6,%ymm1
 4b8:	c4 e2 4d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm6,%ymm0
 4bf:	c4 e2 55 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm5,%ymm2
 4c6:	c4 e2 55 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm5,%ymm1
 4cd:	c4 e2 55 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm5,%ymm0
 4d4:	c4 e2 5d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm4,%ymm2
 4db:	c4 e2 5d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm4,%ymm1
 4e2:	c4 e2 5d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm4,%ymm0
 4e9:	c4 e2 65 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm3,%ymm2
 4f0:	c4 e2 65 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm1
 4f6:	c4 e2 65 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm0
 4fc:	48 83 c3 40          	add    $0x40,%rbx
 500:	48 39 cb             	cmp    %rcx,%rbx
 503:	0f 8c f7 fe ff ff    	jl     400 <.omp_outlined.+0x1e0>
 509:	e9 4e fe ff ff       	jmpq   35c <.omp_outlined.+0x13c>
 50e:	66 90                	xchg   %ax,%ax

0000000000000510 <_Z6enablev>:
 510:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 517 <_Z6enablev+0x7>
 517:	7d 03                	jge    51c <_Z6enablev+0xc>
 519:	31 c0                	xor    %eax,%eax
 51b:	c3                   	retq   
 51c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 523 <_Z6enablev+0x13>
 523:	b8 40 00 00 00       	mov    $0x40,%eax
 528:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx

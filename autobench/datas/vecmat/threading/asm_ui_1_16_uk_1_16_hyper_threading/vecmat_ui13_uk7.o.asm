...
0000000000000220 <.omp_outlined.>:
 ...
 31c:	48 8d ac 06 c0 00 00 	lea    0xc0(%rsi,%rax,1),%rbp
 323:	00 
 ...
 5aa:	c4 62 15 b8 a4 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm13,%ymm12
 5b1:	ff ff ff 
 5b4:	c4 62 15 b8 9c 88 40 	vfmadd231ps -0xc0(%rax,%rcx,4),%ymm13,%ymm11
 5bb:	ff ff ff 
 5be:	c4 62 15 b8 84 c8 40 	vfmadd231ps -0xc0(%rax,%rcx,8),%ymm13,%ymm8
 5c5:	ff ff ff 
 5c8:	48 8d 84 07 40 ff ff 	lea    -0xc0(%rdi,%rax,1),%rax
 5cf:	ff 
 ...
 63a:	c4 62 15 b8 a4 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm13,%ymm12
 641:	ff ff ff 
 ...
 6bd:	c4 62 15 b8 64 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm13,%ymm12
 6c4:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 6ca:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6ce:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 6d4:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 6da:	48 01 f8             	add    %rdi,%rax
 6dd:	48 01 f8             	add    %rdi,%rax
 6e0:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 6e6:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 6ec:	48 01 f8             	add    %rdi,%rax
 6ef:	48 01 f8             	add    %rdi,%rax
 6f2:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 6f8:	48 01 f8             	add    %rdi,%rax
 6fb:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 701:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 705:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 70b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 70f:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 715:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 719:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 71f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 723:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 729:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 72d:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 733:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 737:	c5 7c 10 6c b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm13
 73d:	c4 62 15 b8 64 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm13,%ymm12
 744:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 74a:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 74e:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 754:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 75a:	48 01 f8             	add    %rdi,%rax
 75d:	48 01 f8             	add    %rdi,%rax
 760:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 766:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 76c:	48 01 f8             	add    %rdi,%rax
 76f:	48 01 f8             	add    %rdi,%rax
 772:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 778:	48 01 f8             	add    %rdi,%rax
 77b:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 781:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 785:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 78b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 78f:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 795:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 799:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 79f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7a3:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 7a9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7ad:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 7b3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7b7:	c5 7c 10 ac b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm13
 7be:	00 00 
 7c0:	c4 62 15 b8 64 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm13,%ymm12
 7c7:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 7cd:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 7d1:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 7d7:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 7dd:	48 01 f8             	add    %rdi,%rax
 7e0:	48 01 f8             	add    %rdi,%rax
 7e3:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 7e9:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 7ef:	48 01 f8             	add    %rdi,%rax
 7f2:	48 01 f8             	add    %rdi,%rax
 7f5:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 7fb:	48 01 f8             	add    %rdi,%rax
 7fe:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 804:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 808:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 80e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 812:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 818:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 81c:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 822:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 826:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 82c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 830:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 836:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 83a:	c5 7c 10 ac b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm13
 841:	00 00 
 843:	c4 62 15 b8 64 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm13,%ymm12
 84a:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 850:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 854:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 85a:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 860:	48 01 f8             	add    %rdi,%rax
 863:	48 01 f8             	add    %rdi,%rax
 866:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 86c:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 872:	48 01 f8             	add    %rdi,%rax
 875:	48 01 f8             	add    %rdi,%rax
 878:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 87e:	48 01 f8             	add    %rdi,%rax
 881:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 887:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 88b:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 891:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 895:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 89b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 89f:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 8a5:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8a9:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 8af:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8b3:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 8b9:	48 01 f8             	add    %rdi,%rax
 8bc:	c5 7c 10 ac b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm13
 8c3:	00 00 
 8c5:	c4 62 15 b8 64 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm13,%ymm12
 8cc:	48 83 c6 38          	add    $0x38,%rsi
 8d0:	c4 62 15 b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm13,%ymm11
 8d6:	48 01 d8             	add    %rbx,%rax
 8d9:	c4 62 15 b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm8
 8df:	c4 62 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm10
 8e5:	48 01 f8             	add    %rdi,%rax
 8e8:	48 01 f8             	add    %rdi,%rax
 8eb:	c4 62 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm9
 8f1:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 8f7:	48 01 f8             	add    %rdi,%rax
 8fa:	48 01 f8             	add    %rdi,%rax
 8fd:	c4 e2 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm7
 903:	48 01 f8             	add    %rdi,%rax
 906:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 90c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 910:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 916:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 91a:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 920:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 924:	c4 62 15 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm14
 92a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 92e:	c4 e2 15 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm2
 934:	48 01 f8             	add    %rdi,%rax
 937:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 93d:	48 39 ce             	cmp    %rcx,%rsi
 940:	0f 8c 5a fc ff ff    	jl     5a0 <.omp_outlined.+0x380>
 946:	e9 1f fa ff ff       	jmpq   36a <.omp_outlined.+0x14a>
...
0000000000000960 <_Z9n_reg_maxv>:
 960:	b8 5b 00 00 00       	mov    $0x5b,%eax
 965:	c3                   	retq   

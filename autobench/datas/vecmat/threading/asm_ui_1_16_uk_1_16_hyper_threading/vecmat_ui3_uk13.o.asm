...
0000000000000220 <.omp_outlined.>:
 ...
 313:	48 8d ac be 80 01 00 	lea    0x180(%rsi,%rdi,4),%rbp
 31a:	00 
 ...
 330:	48 8d bc be 80 01 00 	lea    0x180(%rsi,%rdi,4),%rdi
 337:	00 
 338:	48 8d b4 9e 80 01 00 	lea    0x180(%rsi,%rbx,4),%rsi
 33f:	00 
 ...
 3fb:	00 00 00 00 00 
 400:	c5 7c 10 2c 9a       	vmovups (%rdx,%rbx,4),%ymm13
 405:	c4 e2 15 b8 94 9d 80 	vfmadd231ps -0x180(%rbp,%rbx,4),%ymm13,%ymm2
 40c:	fe ff ff 
 40f:	c4 e2 15 b8 8c 9f 80 	vfmadd231ps -0x180(%rdi,%rbx,4),%ymm13,%ymm1
 416:	fe ff ff 
 419:	c4 e2 15 b8 84 9e 80 	vfmadd231ps -0x180(%rsi,%rbx,4),%ymm13,%ymm0
 420:	fe ff ff 
 423:	c5 7c 10 74 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm14
 429:	c5 7c 10 7c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm15
 42f:	c5 7c 10 64 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm12
 435:	c5 7c 10 9c 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm11
 43c:	00 00 
 43e:	c5 7c 10 94 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm10
 445:	00 00 
 447:	c5 7c 10 8c 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm9
 44e:	00 00 
 450:	c5 7c 10 84 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm8
 457:	00 00 
 459:	c5 fc 10 bc 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm7
 460:	00 00 
 462:	c5 fc 10 b4 9a 20 01 	vmovups 0x120(%rdx,%rbx,4),%ymm6
 469:	00 00 
 46b:	c5 fc 10 ac 9a 40 01 	vmovups 0x140(%rdx,%rbx,4),%ymm5
 472:	00 00 
 474:	c5 fc 10 a4 9a 60 01 	vmovups 0x160(%rdx,%rbx,4),%ymm4
 47b:	00 00 
 47d:	c5 fc 10 9c 9a 80 01 	vmovups 0x180(%rdx,%rbx,4),%ymm3
 484:	00 00 
 486:	c4 e2 0d b8 94 9d a0 	vfmadd231ps -0x160(%rbp,%rbx,4),%ymm14,%ymm2
 48d:	fe ff ff 
 490:	c4 e2 0d b8 8c 9f a0 	vfmadd231ps -0x160(%rdi,%rbx,4),%ymm14,%ymm1
 497:	fe ff ff 
 49a:	c4 e2 0d b8 84 9e a0 	vfmadd231ps -0x160(%rsi,%rbx,4),%ymm14,%ymm0
 4a1:	fe ff ff 
 4a4:	c4 e2 05 b8 94 9d c0 	vfmadd231ps -0x140(%rbp,%rbx,4),%ymm15,%ymm2
 4ab:	fe ff ff 
 4ae:	c4 e2 05 b8 8c 9f c0 	vfmadd231ps -0x140(%rdi,%rbx,4),%ymm15,%ymm1
 4b5:	fe ff ff 
 4b8:	c4 e2 05 b8 84 9e c0 	vfmadd231ps -0x140(%rsi,%rbx,4),%ymm15,%ymm0
 4bf:	fe ff ff 
 4c2:	c4 e2 1d b8 94 9d e0 	vfmadd231ps -0x120(%rbp,%rbx,4),%ymm12,%ymm2
 4c9:	fe ff ff 
 4cc:	c4 e2 1d b8 8c 9f e0 	vfmadd231ps -0x120(%rdi,%rbx,4),%ymm12,%ymm1
 4d3:	fe ff ff 
 4d6:	c4 e2 1d b8 84 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm12,%ymm0
 4dd:	fe ff ff 
 4e0:	c4 e2 25 b8 94 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm11,%ymm2
 4e7:	ff ff ff 
 4ea:	c4 e2 25 b8 8c 9f 00 	vfmadd231ps -0x100(%rdi,%rbx,4),%ymm11,%ymm1
 4f1:	ff ff ff 
 4f4:	c4 e2 25 b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm11,%ymm0
 4fb:	ff ff ff 
 4fe:	c4 e2 2d b8 94 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm10,%ymm2
 505:	ff ff ff 
 508:	c4 e2 2d b8 8c 9f 20 	vfmadd231ps -0xe0(%rdi,%rbx,4),%ymm10,%ymm1
 50f:	ff ff ff 
 512:	c4 e2 2d b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm10,%ymm0
 519:	ff ff ff 
 51c:	c4 e2 35 b8 94 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm9,%ymm2
 523:	ff ff ff 
 526:	c4 e2 35 b8 8c 9f 40 	vfmadd231ps -0xc0(%rdi,%rbx,4),%ymm9,%ymm1
 52d:	ff ff ff 
 530:	c4 e2 35 b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm9,%ymm0
 537:	ff ff ff 
 53a:	c4 e2 3d b8 94 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm8,%ymm2
 541:	ff ff ff 
 544:	c4 e2 3d b8 8c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm8,%ymm1
 54b:	ff ff ff 
 54e:	c4 e2 3d b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm8,%ymm0
 555:	ff ff ff 
 558:	c4 e2 45 b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm7,%ymm2
 55f:	c4 e2 45 b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm7,%ymm1
 566:	c4 e2 45 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm7,%ymm0
 56d:	c4 e2 4d b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm6,%ymm2
 574:	c4 e2 4d b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm6,%ymm1
 57b:	c4 e2 4d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm6,%ymm0
 582:	c4 e2 55 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm5,%ymm2
 589:	c4 e2 55 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm5,%ymm1
 590:	c4 e2 55 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm5,%ymm0
 597:	c4 e2 5d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm4,%ymm2
 59e:	c4 e2 5d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm4,%ymm1
 5a5:	c4 e2 5d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm4,%ymm0
 5ac:	c4 e2 65 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm3,%ymm2
 5b3:	c4 e2 65 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm1
 5b9:	c4 e2 65 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm0
 5bf:	48 83 c3 68          	add    $0x68,%rbx
 5c3:	48 39 cb             	cmp    %rcx,%rbx
 5c6:	0f 8c 34 fe ff ff    	jl     400 <.omp_outlined.+0x1e0>
 5cc:	e9 8b fd ff ff       	jmpq   35c <.omp_outlined.+0x13c>
 5d1:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 5d8:	0f 1f 84 00 00 00 00 
 5df:	00 
...
00000000000005f0 <_Z9n_reg_maxv>:
 5f0:	b8 27 00 00 00       	mov    $0x27,%eax
 5f5:	c3                   	retq   

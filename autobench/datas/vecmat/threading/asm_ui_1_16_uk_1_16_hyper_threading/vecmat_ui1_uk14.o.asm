...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d ac 86 a0 01 00 	lea    0x1a0(%rsi,%rax,4),%rbp
 2fa:	00 
 ...
 340:	c5 fc 10 84 b5 60 fe 	vmovups -0x1a0(%rbp,%rsi,4),%ymm0
 347:	ff ff 
 349:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34f:	c5 fc 10 94 b5 80 fe 	vmovups -0x180(%rbp,%rsi,4),%ymm2
 356:	ff ff 
 358:	c5 fc 10 9c b5 a0 fe 	vmovups -0x160(%rbp,%rsi,4),%ymm3
 35f:	ff ff 
 361:	c5 fc 10 a4 b5 c0 fe 	vmovups -0x140(%rbp,%rsi,4),%ymm4
 368:	ff ff 
 36a:	c5 fc 10 ac b5 e0 fe 	vmovups -0x120(%rbp,%rsi,4),%ymm5
 371:	ff ff 
 373:	c5 fc 10 b4 b5 00 ff 	vmovups -0x100(%rbp,%rsi,4),%ymm6
 37a:	ff ff 
 37c:	c5 fc 10 bc b5 20 ff 	vmovups -0xe0(%rbp,%rsi,4),%ymm7
 383:	ff ff 
 385:	c5 7c 10 84 b5 40 ff 	vmovups -0xc0(%rbp,%rsi,4),%ymm8
 38c:	ff ff 
 38e:	c5 7c 10 8c b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm9
 395:	ff ff 
 397:	c5 7c 10 54 b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm10
 39d:	c5 7c 10 5c b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm11
 3a3:	c5 7c 10 64 b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm12
 3a9:	c5 7c 10 6c b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm13
 3af:	c5 7c 10 74 b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm14
 3b5:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 3bc:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 3c3:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 3ca:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 3d1:	00 00 00 
 3d4:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 3db:	00 00 00 
 3de:	c4 e2 45 b8 84 b2 c0 	vfmadd231ps 0xc0(%rdx,%rsi,4),%ymm7,%ymm0
 3e5:	00 00 00 
 3e8:	c4 e2 3d b8 84 b2 e0 	vfmadd231ps 0xe0(%rdx,%rsi,4),%ymm8,%ymm0
 3ef:	00 00 00 
 3f2:	c4 e2 35 b8 84 b2 00 	vfmadd231ps 0x100(%rdx,%rsi,4),%ymm9,%ymm0
 3f9:	01 00 00 
 3fc:	c4 e2 2d b8 84 b2 20 	vfmadd231ps 0x120(%rdx,%rsi,4),%ymm10,%ymm0
 403:	01 00 00 
 406:	c4 e2 25 b8 84 b2 40 	vfmadd231ps 0x140(%rdx,%rsi,4),%ymm11,%ymm0
 40d:	01 00 00 
 410:	c4 e2 1d b8 84 b2 60 	vfmadd231ps 0x160(%rdx,%rsi,4),%ymm12,%ymm0
 417:	01 00 00 
 41a:	c4 e2 15 b8 84 b2 80 	vfmadd231ps 0x180(%rdx,%rsi,4),%ymm13,%ymm0
 421:	01 00 00 
 424:	c4 e2 0d b8 84 b2 a0 	vfmadd231ps 0x1a0(%rdx,%rsi,4),%ymm14,%ymm0
 42b:	01 00 00 
 42e:	48 83 c6 70          	add    $0x70,%rsi
 432:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 436:	48 39 ce             	cmp    %rcx,%rsi
 439:	0f 8c 01 ff ff ff    	jl     340 <.omp_outlined.+0x120>
 43f:	e9 c0 fe ff ff       	jmpq   304 <.omp_outlined.+0xe4>
 444:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
 44b:	00 00 00 00 00 

0000000000000450 <_Z6enablev>:
 450:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 457 <_Z6enablev+0x7>
 457:	7e 1e                	jle    477 <_Z6enablev+0x27>
 459:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 460 <_Z6enablev+0x10>
 460:	b8 70 00 00 00       	mov    $0x70,%eax
 465:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 46a:	0f 45 c8             	cmovne %eax,%ecx
 46d:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 473 <_Z6enablev+0x23>
 473:	0f 9e c0             	setle  %al
 476:	c3                   	retq   

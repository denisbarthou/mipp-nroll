...
0000000000000220 <.omp_outlined.>:
 ...
 34d:	48 8d ac 30 60 01 00 	lea    0x160(%rax,%rsi,1),%rbp
 354:	00 
 355:	48 81 c6 60 01 00 00 	add    $0x160,%rsi
 ...
 64b:	c4 22 0d b8 ac 8d a0 	vfmadd231ps -0x160(%rbp,%r9,4),%ymm14,%ymm13
 652:	fe ff ff 
 655:	c4 02 0d b8 a4 88 a0 	vfmadd231ps -0x160(%r8,%r9,4),%ymm14,%ymm12
 65c:	fe ff ff 
 65f:	4b 8d 84 17 a0 fe ff 	lea    -0x160(%r15,%r10,1),%rax
 666:	ff 
 667:	c4 42 0d b8 9c ca a0 	vfmadd231ps -0x160(%r10,%rcx,8),%ymm14,%ymm11
 66e:	fe ff ff 
 ...
 6e1:	c4 22 0d b8 ac 8d c0 	vfmadd231ps -0x140(%rbp,%r9,4),%ymm14,%ymm13
 6e8:	fe ff ff 
 6eb:	c4 02 0d b8 a4 88 c0 	vfmadd231ps -0x140(%r8,%r9,4),%ymm14,%ymm12
 6f2:	fe ff ff 
 ...
 76f:	c4 22 0d b8 ac 8d e0 	vfmadd231ps -0x120(%rbp,%r9,4),%ymm14,%ymm13
 776:	fe ff ff 
 779:	c4 02 0d b8 a4 88 e0 	vfmadd231ps -0x120(%r8,%r9,4),%ymm14,%ymm12
 780:	fe ff ff 
 ...
 7fd:	c4 22 0d b8 ac 8d 00 	vfmadd231ps -0x100(%rbp,%r9,4),%ymm14,%ymm13
 804:	ff ff ff 
 807:	c4 02 0d b8 a4 88 00 	vfmadd231ps -0x100(%r8,%r9,4),%ymm14,%ymm12
 80e:	ff ff ff 
 ...
 88b:	00 00 00 
 88e:	c4 22 0d b8 ac 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm14,%ymm13
 895:	ff ff ff 
 898:	c4 02 0d b8 a4 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm14,%ymm12
 89f:	ff ff ff 
 ...
 91c:	00 00 00 
 91f:	c4 22 0d b8 ac 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm14,%ymm13
 926:	ff ff ff 
 929:	c4 02 0d b8 a4 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm14,%ymm12
 930:	ff ff ff 
 ...
 9ad:	00 00 00 
 9b0:	c4 22 0d b8 ac 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm14,%ymm13
 9b7:	ff ff ff 
 9ba:	c4 02 0d b8 a4 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm14,%ymm12
 9c1:	ff ff ff 
 ...
 a3e:	00 00 00 
 a41:	c4 22 0d b8 6c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm14,%ymm13
 a48:	c4 02 0d b8 64 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm14,%ymm12
 a4f:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 a55:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a59:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 a5f:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 a65:	48 01 f8             	add    %rdi,%rax
 a68:	48 01 f8             	add    %rdi,%rax
 a6b:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 a71:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 a77:	48 01 f8             	add    %rdi,%rax
 a7a:	48 01 f8             	add    %rdi,%rax
 a7d:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 a83:	48 01 f8             	add    %rdi,%rax
 a86:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 a8c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a90:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 a96:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a9a:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 aa0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 aa4:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 aaa:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 aae:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 ab4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ab8:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 abe:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ac2:	c4 21 7c 10 b4 8a 00 	vmovups 0x100(%rdx,%r9,4),%ymm14
 ac9:	01 00 00 
 acc:	c4 22 0d b8 6c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm14,%ymm13
 ad3:	c4 02 0d b8 64 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm14,%ymm12
 ada:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 ae0:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 ae4:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 aea:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 af0:	48 01 f8             	add    %rdi,%rax
 af3:	48 01 f8             	add    %rdi,%rax
 af6:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 afc:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 b02:	48 01 f8             	add    %rdi,%rax
 b05:	48 01 f8             	add    %rdi,%rax
 b08:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 b0e:	48 01 f8             	add    %rdi,%rax
 b11:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 b17:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b1b:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 b21:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b25:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 b2b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b2f:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 b35:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b39:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 b3f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b43:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 b49:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b4d:	c4 21 7c 10 b4 8a 20 	vmovups 0x120(%rdx,%r9,4),%ymm14
 b54:	01 00 00 
 b57:	c4 22 0d b8 6c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm14,%ymm13
 b5e:	c4 02 0d b8 64 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm14,%ymm12
 b65:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 b6b:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 b6f:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 b75:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 b7b:	48 01 f8             	add    %rdi,%rax
 b7e:	48 01 f8             	add    %rdi,%rax
 b81:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 b87:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 b8d:	48 01 f8             	add    %rdi,%rax
 b90:	48 01 f8             	add    %rdi,%rax
 b93:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 b99:	48 01 f8             	add    %rdi,%rax
 b9c:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 ba2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ba6:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 bac:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bb0:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 bb6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bba:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 bc0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bc4:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 bca:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bce:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 bd4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bd8:	c4 21 7c 10 b4 8a 40 	vmovups 0x140(%rdx,%r9,4),%ymm14
 bdf:	01 00 00 
 be2:	c4 22 0d b8 6c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm14,%ymm13
 be9:	c4 02 0d b8 64 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm14,%ymm12
 bf0:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 bf6:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 bfa:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 c00:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 c06:	48 01 f8             	add    %rdi,%rax
 c09:	48 01 f8             	add    %rdi,%rax
 c0c:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 c12:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 c18:	48 01 f8             	add    %rdi,%rax
 c1b:	48 01 f8             	add    %rdi,%rax
 c1e:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 c24:	48 01 f8             	add    %rdi,%rax
 c27:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 c2d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c31:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 c37:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c3b:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 c41:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c45:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 c4b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c4f:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 c55:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c59:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 c5f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 c63:	c4 21 7c 10 b4 8a 60 	vmovups 0x160(%rdx,%r9,4),%ymm14
 c6a:	01 00 00 
 c6d:	c4 22 0d b8 6c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm14,%ymm13
 c74:	c4 02 0d b8 24 88    	vfmadd231ps (%r8,%r9,4),%ymm14,%ymm12
 c7a:	49 83 c1 60          	add    $0x60,%r9
 c7e:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 c84:	48 01 d8             	add    %rbx,%rax
 c87:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 c8d:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 c93:	48 01 f8             	add    %rdi,%rax
 c96:	48 01 f8             	add    %rdi,%rax
 c99:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 c9f:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 ca5:	48 01 f8             	add    %rdi,%rax
 ca8:	48 01 f8             	add    %rdi,%rax
 cab:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 cb1:	48 01 f8             	add    %rdi,%rax
 cb4:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 cba:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cbe:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 cc4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cc8:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 cce:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cd2:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 cd8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 cdc:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 ce2:	48 01 f8             	add    %rdi,%rax
 ce5:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 ceb:	49 39 c9             	cmp    %rcx,%r9
 cee:	0f 8c 4c f9 ff ff    	jl     640 <.omp_outlined.+0x420>
 cf4:	e9 c6 f6 ff ff       	jmpq   3bf <.omp_outlined.+0x19f>
 cf9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
...
0000000000000d10 <_Z9n_reg_maxv>:
 d10:	b8 a8 00 00 00       	mov    $0xa8,%eax
 d15:	c3                   	retq   

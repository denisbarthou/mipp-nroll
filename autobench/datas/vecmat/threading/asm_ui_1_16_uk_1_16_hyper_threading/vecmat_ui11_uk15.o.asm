...
0000000000000220 <.omp_outlined.>:
 ...
 31c:	48 8d ac 06 c0 01 00 	lea    0x1c0(%rsi,%rax,1),%rbp
 323:	00 
 ...
 54a:	c4 62 25 b8 94 b5 40 	vfmadd231ps -0x1c0(%rbp,%rsi,4),%ymm11,%ymm10
 551:	fe ff ff 
 554:	c4 62 25 b8 8c 88 40 	vfmadd231ps -0x1c0(%rax,%rcx,4),%ymm11,%ymm9
 55b:	fe ff ff 
 55e:	c4 e2 25 b8 b4 c8 40 	vfmadd231ps -0x1c0(%rax,%rcx,8),%ymm11,%ymm6
 565:	fe ff ff 
 568:	48 8d 84 07 40 fe ff 	lea    -0x1c0(%rdi,%rax,1),%rax
 56f:	ff 
 ...
 5c6:	c4 62 25 b8 94 b5 60 	vfmadd231ps -0x1a0(%rbp,%rsi,4),%ymm11,%ymm10
 5cd:	fe ff ff 
 ...
 635:	c4 62 25 b8 94 b5 80 	vfmadd231ps -0x180(%rbp,%rsi,4),%ymm11,%ymm10
 63c:	fe ff ff 
 ...
 6a4:	c4 62 25 b8 94 b5 a0 	vfmadd231ps -0x160(%rbp,%rsi,4),%ymm11,%ymm10
 6ab:	fe ff ff 
 ...
 714:	00 00 
 716:	c4 62 25 b8 94 b5 c0 	vfmadd231ps -0x140(%rbp,%rsi,4),%ymm11,%ymm10
 71d:	fe ff ff 
 ...
 786:	00 00 
 788:	c4 62 25 b8 94 b5 e0 	vfmadd231ps -0x120(%rbp,%rsi,4),%ymm11,%ymm10
 78f:	fe ff ff 
 ...
 7f8:	00 00 
 7fa:	c4 62 25 b8 94 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm11,%ymm10
 801:	ff ff ff 
 ...
 86a:	00 00 
 86c:	c4 62 25 b8 94 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm11,%ymm10
 873:	ff ff ff 
 ...
 8dc:	00 00 
 8de:	c4 62 25 b8 94 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm11,%ymm10
 8e5:	ff ff ff 
 ...
 94e:	00 00 
 950:	c4 62 25 b8 94 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm11,%ymm10
 957:	ff ff ff 
 95a:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 960:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 964:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 96a:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 970:	48 01 f8             	add    %rdi,%rax
 973:	48 01 f8             	add    %rdi,%rax
 976:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 97c:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 982:	48 01 f8             	add    %rdi,%rax
 985:	48 01 f8             	add    %rdi,%rax
 988:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 98e:	48 01 f8             	add    %rdi,%rax
 991:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 997:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 99b:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 9a1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9a5:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 9ab:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9af:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 9b5:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9b9:	c5 7c 10 9c b2 40 01 	vmovups 0x140(%rdx,%rsi,4),%ymm11
 9c0:	00 00 
 9c2:	c4 62 25 b8 54 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm11,%ymm10
 9c9:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 9cf:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9d3:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 9d9:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 9df:	48 01 f8             	add    %rdi,%rax
 9e2:	48 01 f8             	add    %rdi,%rax
 9e5:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 9eb:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 9f1:	48 01 f8             	add    %rdi,%rax
 9f4:	48 01 f8             	add    %rdi,%rax
 9f7:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 9fd:	48 01 f8             	add    %rdi,%rax
 a00:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 a06:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a0a:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 a10:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a14:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 a1a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a1e:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 a24:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a28:	c5 7c 10 9c b2 60 01 	vmovups 0x160(%rdx,%rsi,4),%ymm11
 a2f:	00 00 
 a31:	c4 62 25 b8 54 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm11,%ymm10
 a38:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 a3e:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a42:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 a48:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 a4e:	48 01 f8             	add    %rdi,%rax
 a51:	48 01 f8             	add    %rdi,%rax
 a54:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 a5a:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 a60:	48 01 f8             	add    %rdi,%rax
 a63:	48 01 f8             	add    %rdi,%rax
 a66:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 a6c:	48 01 f8             	add    %rdi,%rax
 a6f:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 a75:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a79:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 a7f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a83:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 a89:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a8d:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 a93:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a97:	c5 7c 10 9c b2 80 01 	vmovups 0x180(%rdx,%rsi,4),%ymm11
 a9e:	00 00 
 aa0:	c4 62 25 b8 54 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm11,%ymm10
 aa7:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 aad:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 ab1:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 ab7:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 abd:	48 01 f8             	add    %rdi,%rax
 ac0:	48 01 f8             	add    %rdi,%rax
 ac3:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 ac9:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 acf:	48 01 f8             	add    %rdi,%rax
 ad2:	48 01 f8             	add    %rdi,%rax
 ad5:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 adb:	48 01 f8             	add    %rdi,%rax
 ade:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 ae4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ae8:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 aee:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 af2:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 af8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 afc:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 b02:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b06:	c5 7c 10 9c b2 a0 01 	vmovups 0x1a0(%rdx,%rsi,4),%ymm11
 b0d:	00 00 
 b0f:	c4 62 25 b8 54 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm11,%ymm10
 b16:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 b1c:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 b20:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 b26:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 b2c:	48 01 f8             	add    %rdi,%rax
 b2f:	48 01 f8             	add    %rdi,%rax
 b32:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 b38:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 b3e:	48 01 f8             	add    %rdi,%rax
 b41:	48 01 f8             	add    %rdi,%rax
 b44:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 b4a:	48 01 f8             	add    %rdi,%rax
 b4d:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 b53:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b57:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 b5d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b61:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 b67:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b6b:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 b71:	48 01 f8             	add    %rdi,%rax
 b74:	c5 7c 10 9c b2 c0 01 	vmovups 0x1c0(%rdx,%rsi,4),%ymm11
 b7b:	00 00 
 b7d:	c4 62 25 b8 54 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm11,%ymm10
 b84:	48 83 c6 78          	add    $0x78,%rsi
 b88:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 b8e:	48 01 d8             	add    %rbx,%rax
 b91:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 b97:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 b9d:	48 01 f8             	add    %rdi,%rax
 ba0:	48 01 f8             	add    %rdi,%rax
 ba3:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 ba9:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 baf:	48 01 f8             	add    %rdi,%rax
 bb2:	48 01 f8             	add    %rdi,%rax
 bb5:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 bbb:	48 01 f8             	add    %rdi,%rax
 bbe:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 bc4:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bc8:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 bce:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bd2:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 bd8:	48 01 f8             	add    %rdi,%rax
 bdb:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 be1:	48 39 ce             	cmp    %rcx,%rsi
 be4:	0f 8c 56 f9 ff ff    	jl     540 <.omp_outlined.+0x320>
 bea:	e9 71 f7 ff ff       	jmpq   360 <.omp_outlined.+0x140>
 bef:	90                   	nop
...
0000000000000c00 <_Z9n_reg_maxv>:
 c00:	b8 a5 00 00 00       	mov    $0xa5,%eax
 c05:	c3                   	retq   

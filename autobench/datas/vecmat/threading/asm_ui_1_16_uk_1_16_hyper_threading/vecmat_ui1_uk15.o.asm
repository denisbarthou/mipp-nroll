...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d ac 86 c0 01 00 	lea    0x1c0(%rsi,%rax,4),%rbp
 2fa:	00 
 ...
 340:	c5 fc 10 84 b5 40 fe 	vmovups -0x1c0(%rbp,%rsi,4),%ymm0
 347:	ff ff 
 349:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34f:	c5 fc 10 94 b5 60 fe 	vmovups -0x1a0(%rbp,%rsi,4),%ymm2
 356:	ff ff 
 358:	c5 fc 10 9c b5 80 fe 	vmovups -0x180(%rbp,%rsi,4),%ymm3
 35f:	ff ff 
 361:	c5 fc 10 a4 b5 a0 fe 	vmovups -0x160(%rbp,%rsi,4),%ymm4
 368:	ff ff 
 36a:	c5 fc 10 ac b5 c0 fe 	vmovups -0x140(%rbp,%rsi,4),%ymm5
 371:	ff ff 
 373:	c5 fc 10 b4 b5 e0 fe 	vmovups -0x120(%rbp,%rsi,4),%ymm6
 37a:	ff ff 
 37c:	c5 fc 10 bc b5 00 ff 	vmovups -0x100(%rbp,%rsi,4),%ymm7
 383:	ff ff 
 385:	c5 7c 10 84 b5 20 ff 	vmovups -0xe0(%rbp,%rsi,4),%ymm8
 38c:	ff ff 
 38e:	c5 7c 10 8c b5 40 ff 	vmovups -0xc0(%rbp,%rsi,4),%ymm9
 395:	ff ff 
 397:	c5 7c 10 94 b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm10
 39e:	ff ff 
 3a0:	c5 7c 10 5c b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm11
 3a6:	c5 7c 10 64 b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm12
 3ac:	c5 7c 10 6c b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm13
 3b2:	c5 7c 10 74 b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm14
 3b8:	c5 7c 10 7c b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm15
 3be:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 3c5:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 3cc:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 3d3:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 3da:	00 00 00 
 3dd:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 3e4:	00 00 00 
 3e7:	c4 e2 45 b8 84 b2 c0 	vfmadd231ps 0xc0(%rdx,%rsi,4),%ymm7,%ymm0
 3ee:	00 00 00 
 3f1:	c4 e2 3d b8 84 b2 e0 	vfmadd231ps 0xe0(%rdx,%rsi,4),%ymm8,%ymm0
 3f8:	00 00 00 
 3fb:	c4 e2 35 b8 84 b2 00 	vfmadd231ps 0x100(%rdx,%rsi,4),%ymm9,%ymm0
 402:	01 00 00 
 405:	c4 e2 2d b8 84 b2 20 	vfmadd231ps 0x120(%rdx,%rsi,4),%ymm10,%ymm0
 40c:	01 00 00 
 40f:	c4 e2 25 b8 84 b2 40 	vfmadd231ps 0x140(%rdx,%rsi,4),%ymm11,%ymm0
 416:	01 00 00 
 419:	c4 e2 1d b8 84 b2 60 	vfmadd231ps 0x160(%rdx,%rsi,4),%ymm12,%ymm0
 420:	01 00 00 
 423:	c4 e2 15 b8 84 b2 80 	vfmadd231ps 0x180(%rdx,%rsi,4),%ymm13,%ymm0
 42a:	01 00 00 
 42d:	c4 e2 0d b8 84 b2 a0 	vfmadd231ps 0x1a0(%rdx,%rsi,4),%ymm14,%ymm0
 434:	01 00 00 
 437:	c4 e2 05 b8 84 b2 c0 	vfmadd231ps 0x1c0(%rdx,%rsi,4),%ymm15,%ymm0
 43e:	01 00 00 
 441:	48 83 c6 78          	add    $0x78,%rsi
 445:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 449:	48 39 ce             	cmp    %rcx,%rsi
 44c:	0f 8c ee fe ff ff    	jl     340 <.omp_outlined.+0x120>
 452:	e9 ad fe ff ff       	jmpq   304 <.omp_outlined.+0xe4>
 457:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
 45e:	00 00 

0000000000000460 <_Z6enablev>:
 460:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 467 <_Z6enablev+0x7>
 467:	7e 1e                	jle    487 <_Z6enablev+0x27>
 469:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 470 <_Z6enablev+0x10>
 470:	b8 78 00 00 00       	mov    $0x78,%eax
 475:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 47a:	0f 45 c8             	cmovne %eax,%ecx
 47d:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 483 <_Z6enablev+0x23>
 483:	0f 9e c0             	setle  %al
 486:	c3                   	retq   

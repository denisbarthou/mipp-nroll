...
0000000000000210 <.omp_outlined.>:
 ...
 2e2:	00 
 2e3:	48 8d ac 86 e0 00 00 	lea    0xe0(%rsi,%rax,4),%rbp
 2ea:	00 
 ...
 330:	c5 fc 10 84 b5 20 ff 	vmovups -0xe0(%rbp,%rsi,4),%ymm0
 337:	ff ff 
 339:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 33f:	c5 fc 10 94 b5 40 ff 	vmovups -0xc0(%rbp,%rsi,4),%ymm2
 346:	ff ff 
 348:	c5 fc 10 9c b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm3
 34f:	ff ff 
 351:	c5 fc 10 64 b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm4
 357:	c5 fc 10 6c b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm5
 35d:	c5 fc 10 74 b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm6
 363:	c5 fc 10 7c b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm7
 369:	c5 7c 10 44 b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm8
 36f:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 376:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 37d:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 384:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 38b:	00 00 00 
 38e:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 395:	00 00 00 
 398:	c4 e2 45 b8 84 b2 c0 	vfmadd231ps 0xc0(%rdx,%rsi,4),%ymm7,%ymm0
 39f:	00 00 00 
 3a2:	c4 e2 3d b8 84 b2 e0 	vfmadd231ps 0xe0(%rdx,%rsi,4),%ymm8,%ymm0
 3a9:	00 00 00 
 3ac:	48 83 c6 40          	add    $0x40,%rsi
 3b0:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 3b4:	48 39 ce             	cmp    %rcx,%rsi
 3b7:	0f 8c 73 ff ff ff    	jl     330 <.omp_outlined.+0x120>
 3bd:	e9 32 ff ff ff       	jmpq   2f4 <.omp_outlined.+0xe4>
 3c2:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 3c9:	1f 84 00 00 00 00 00 

00000000000003d0 <_Z6enablev>:
 3d0:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 3d7 <_Z6enablev+0x7>
 3d7:	7e 1e                	jle    3f7 <_Z6enablev+0x27>
 3d9:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3e0 <_Z6enablev+0x10>
 3e0:	b8 40 00 00 00       	mov    $0x40,%eax
 3e5:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 3ea:	0f 45 c8             	cmovne %eax,%ecx
 3ed:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3f3 <_Z6enablev+0x23>
 3f3:	0f 9e c0             	setle  %al
 3f6:	c3                   	retq   

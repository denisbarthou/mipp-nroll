...
0000000000000220 <.omp_outlined.>:
 ...
 2ea:	5d                   	pop    %rbp
 2eb:	c3                   	retq   
 2ec:	49 8b 37             	mov    (%r15),%rsi
 2ef:	48 63 0d 00 00 00 00 	movslq 0x0(%rip),%rcx        # 2f6 <.omp_outlined.+0xd6>
 2f6:	49 8b 3e             	mov    (%r14),%rdi
 2f9:	49 8b 14 24          	mov    (%r12),%rdx
 2fd:	48 89 74 24 38       	mov    %rsi,0x38(%rsp)
 302:	48 63 f5             	movslq %ebp,%rsi
 305:	48 89 7c 24 20       	mov    %rdi,0x20(%rsp)
 30a:	48 89 74 24 30       	mov    %rsi,0x30(%rsp)
 30f:	43 8d 74 2d 00       	lea    0x0(%r13,%r13,1),%esi
 314:	8d 04 b6             	lea    (%rsi,%rsi,4),%eax
 317:	8d 34 09             	lea    (%rcx,%rcx,1),%esi
 31a:	8d 34 b6             	lea    (%rsi,%rsi,4),%esi
 31d:	83 c8 01             	or     $0x1,%eax
 320:	89 74 24 10          	mov    %esi,0x10(%rsp)
 324:	4c 89 ee             	mov    %r13,%rsi
 327:	0f af c1             	imul   %ecx,%eax
 32a:	48 0f af f1          	imul   %rcx,%rsi
 32e:	48 8d 34 b6          	lea    (%rsi,%rsi,4),%rsi
 332:	48 8d 2c f7          	lea    (%rdi,%rsi,8),%rbp
 336:	48 8d 34 cd 00 00 00 	lea    0x0(,%rcx,8),%rsi
 33d:	00 
 33e:	48 8d 3c b6          	lea    (%rsi,%rsi,4),%rdi
 342:	48 89 7c 24 28       	mov    %rdi,0x28(%rsp)
 347:	48 8d 3c 8d 00 00 00 	lea    0x0(,%rcx,4),%rdi
 34e:	00 
 34f:	e9 c4 01 00 00       	jmpq   518 <.omp_outlined.+0x2f8>
 ...
 391:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
 396:	4c 8b 44 24 40       	mov    0x40(%rsp),%r8
 39b:	49 63 d9             	movslq %r9d,%rbx
 39e:	48 03 6c 24 28       	add    0x28(%rsp),%rbp
 ...
 3ba:	c4 a1 7a 11 04 80    	vmovss %xmm0,(%rax,%r8,4)
 ...
 3dd:	c5 fa 11 04 98       	vmovss %xmm0,(%rax,%rbx,4)
 ...
 4fa:	c4 a1 7c 11 44 80 08 	vmovups %ymm0,0x8(%rax,%r8,4)
 501:	8b 44 24 14          	mov    0x14(%rsp),%eax
 505:	03 44 24 10          	add    0x10(%rsp),%eax
 509:	4c 3b 6c 24 30       	cmp    0x30(%rsp),%r13
 50e:	4d 8d 6d 01          	lea    0x1(%r13),%r13
 512:	0f 8d b4 fd ff ff    	jge    2cc <.omp_outlined.+0xac>
 518:	4b 8d 5c 2d 00       	lea    0x0(%r13,%r13,1),%rbx
 51d:	89 44 24 14          	mov    %eax,0x14(%rsp)
 521:	48 8d 1c 9b          	lea    (%rbx,%rbx,4),%rbx
 525:	41 89 d9             	mov    %ebx,%r9d
 528:	48 89 5c 24 40       	mov    %rbx,0x40(%rsp)
 52d:	41 83 c9 01          	or     $0x1,%r9d
 531:	85 c9                	test   %ecx,%ecx
 533:	0f 8e 27 fe ff ff    	jle    360 <.omp_outlined.+0x140>
 539:	4c 8b 54 24 20       	mov    0x20(%rsp),%r10
 53e:	48 63 d8             	movslq %eax,%rbx
 541:	c4 41 30 57 c9       	vxorps %xmm9,%xmm9,%xmm9
 546:	45 31 c0             	xor    %r8d,%r8d
 549:	c4 41 38 57 c0       	vxorps %xmm8,%xmm8,%xmm8
 54e:	c5 c0 57 ff          	vxorps %xmm7,%xmm7,%xmm7
 552:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
 556:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
 55a:	c5 d0 57 ed          	vxorps %xmm5,%xmm5,%xmm5
 55e:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 562:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 566:	c5 f0 57 c9          	vxorps %xmm1,%xmm1,%xmm1
 56a:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
 56f:	4d 8d 34 9a          	lea    (%r10,%rbx,4),%r14
 573:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 57a:	84 00 00 00 00 00 
 580:	4a 8d 5c 85 00       	lea    0x0(%rbp,%r8,4),%rbx
 585:	c4 21 7c 10 14 82    	vmovups (%rdx,%r8,4),%ymm10
 58b:	c4 22 2d b8 4c 85 00 	vfmadd231ps 0x0(%rbp,%r8,4),%ymm10,%ymm9
 592:	c4 02 2d b8 04 86    	vfmadd231ps (%r14,%r8,4),%ymm10,%ymm8
 598:	49 83 c0 08          	add    $0x8,%r8
 59c:	4c 8d 14 33          	lea    (%rbx,%rsi,1),%r10
 5a0:	c4 e2 2d b8 3c cb    	vfmadd231ps (%rbx,%rcx,8),%ymm10,%ymm7
 5a6:	4d 8d 1c 3a          	lea    (%r10,%rdi,1),%r11
 5aa:	c4 c2 2d b8 24 8a    	vfmadd231ps (%r10,%rcx,4),%ymm10,%ymm4
 5b0:	c4 c2 2d b8 34 ca    	vfmadd231ps (%r10,%rcx,8),%ymm10,%ymm6
 5b6:	49 01 fb             	add    %rdi,%r11
 5b9:	4d 8d 3c 3b          	lea    (%r11,%rdi,1),%r15
 5bd:	c4 c2 2d b8 2c 8b    	vfmadd231ps (%r11,%rcx,4),%ymm10,%ymm5
 5c3:	c4 c2 2d b8 14 cb    	vfmadd231ps (%r11,%rcx,8),%ymm10,%ymm2
 5c9:	49 01 ff             	add    %rdi,%r15
 5cc:	4d 8d 24 3f          	lea    (%r15,%rdi,1),%r12
 5d0:	c4 c2 2d b8 1c 8f    	vfmadd231ps (%r15,%rcx,4),%ymm10,%ymm3
 5d6:	c4 c2 2d b8 0c 8c    	vfmadd231ps (%r12,%rcx,4),%ymm10,%ymm1
 5dc:	49 01 fc             	add    %rdi,%r12
 5df:	c4 42 2d b8 1c 8c    	vfmadd231ps (%r12,%rcx,4),%ymm10,%ymm11
 5e5:	49 39 c8             	cmp    %rcx,%r8
 5e8:	7c 96                	jl     580 <.omp_outlined.+0x360>
 5ea:	e9 9c fd ff ff       	jmpq   38b <.omp_outlined.+0x16b>
 5ef:	90                   	nop

00000000000005f0 <_Z6enablev>:
 5f0:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 5f7 <_Z6enablev+0x7>
 5f7:	7d 03                	jge    5fc <_Z6enablev+0xc>
 5f9:	31 c0                	xor    %eax,%eax
 5fb:	c3                   	retq   
 5fc:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 603 <_Z6enablev+0x13>
 603:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 607:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 60d <_Z6enablev+0x1d>
 60d:	0f 9e c0             	setle  %al
 610:	c3                   	retq   

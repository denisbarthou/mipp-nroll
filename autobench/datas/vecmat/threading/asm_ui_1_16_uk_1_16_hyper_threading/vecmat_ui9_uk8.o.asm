...
0000000000000210 <.omp_outlined.>:
 ...
 313:	00 
 314:	48 8d 04 c9          	lea    (%rcx,%rcx,8),%rax
 318:	48 8d 04 40          	lea    (%rax,%rax,2),%rax
 31c:	48 01 c8             	add    %rcx,%rax
 31f:	48 29 c7             	sub    %rax,%rdi
 322:	e9 82 01 00 00       	jmpq   4a9 <.omp_outlined.+0x299>
 ...
 4d8:	c4 41 28 57 d2       	vxorps %xmm10,%xmm10,%xmm10
 4dd:	0f 1f 00             	nopl   (%rax)
 4e0:	48 8d 44 b5 00       	lea    0x0(%rbp,%rsi,4),%rax
 4e5:	c5 7c 10 0c b2       	vmovups (%rdx,%rsi,4),%ymm9
 4ea:	c4 62 35 b8 84 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm9,%ymm8
 4f1:	ff ff ff 
 4f4:	c4 e2 35 b8 bc 88 20 	vfmadd231ps -0xe0(%rax,%rcx,4),%ymm9,%ymm7
 4fb:	ff ff ff 
 4fe:	c4 e2 35 b8 a4 c8 20 	vfmadd231ps -0xe0(%rax,%rcx,8),%ymm9,%ymm4
 505:	ff ff ff 
 508:	48 8d 84 03 20 ff ff 	lea    -0xe0(%rbx,%rax,1),%rax
 50f:	ff 
 510:	48 01 d8             	add    %rbx,%rax
 513:	c4 e2 35 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm6
 519:	c4 e2 35 b8 2c c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm5
 51f:	48 01 d8             	add    %rbx,%rax
 522:	48 01 d8             	add    %rbx,%rax
 525:	c4 e2 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm2
 52b:	48 01 d8             	add    %rbx,%rax
 52e:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 534:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 538:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 53e:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 542:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 548:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 54c:	c5 7c 10 4c b2 20    	vmovups 0x20(%rdx,%rsi,4),%ymm9
 552:	c4 62 35 b8 84 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm9,%ymm8
 559:	ff ff ff 
 55c:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 562:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 566:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 56c:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 572:	48 01 d8             	add    %rbx,%rax
 575:	48 01 d8             	add    %rbx,%rax
 578:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 57e:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 584:	48 01 d8             	add    %rbx,%rax
 587:	48 01 d8             	add    %rbx,%rax
 58a:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 590:	48 01 d8             	add    %rbx,%rax
 593:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 599:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 59d:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 5a3:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5a7:	c5 7c 10 4c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm9
 5ad:	c4 62 35 b8 84 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm9,%ymm8
 5b4:	ff ff ff 
 5b7:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 5bd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5c1:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 5c7:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 5cd:	48 01 d8             	add    %rbx,%rax
 5d0:	48 01 d8             	add    %rbx,%rax
 5d3:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 5d9:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 5df:	48 01 d8             	add    %rbx,%rax
 5e2:	48 01 d8             	add    %rbx,%rax
 5e5:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 5eb:	48 01 d8             	add    %rbx,%rax
 5ee:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 5f4:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5f8:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 5fe:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 602:	c5 7c 10 4c b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm9
 608:	c4 62 35 b8 44 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm9,%ymm8
 60f:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 615:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 619:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 61f:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 625:	48 01 d8             	add    %rbx,%rax
 628:	48 01 d8             	add    %rbx,%rax
 62b:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 631:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 637:	48 01 d8             	add    %rbx,%rax
 63a:	48 01 d8             	add    %rbx,%rax
 63d:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 643:	48 01 d8             	add    %rbx,%rax
 646:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 64c:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 650:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 656:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 65a:	c5 7c 10 8c b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm9
 661:	00 00 
 663:	c4 62 35 b8 44 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm9,%ymm8
 66a:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 670:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 674:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 67a:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 680:	48 01 d8             	add    %rbx,%rax
 683:	48 01 d8             	add    %rbx,%rax
 686:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 68c:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 692:	48 01 d8             	add    %rbx,%rax
 695:	48 01 d8             	add    %rbx,%rax
 698:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 69e:	48 01 d8             	add    %rbx,%rax
 6a1:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 6a7:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6ab:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 6b1:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6b5:	c5 7c 10 8c b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm9
 6bc:	00 00 
 6be:	c4 62 35 b8 44 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm9,%ymm8
 6c5:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 6cb:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6cf:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 6d5:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 6db:	48 01 d8             	add    %rbx,%rax
 6de:	48 01 d8             	add    %rbx,%rax
 6e1:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 6e7:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 6ed:	48 01 d8             	add    %rbx,%rax
 6f0:	48 01 d8             	add    %rbx,%rax
 6f3:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 6f9:	48 01 d8             	add    %rbx,%rax
 6fc:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 702:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 706:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 70c:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 710:	c5 7c 10 8c b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm9
 717:	00 00 
 719:	c4 62 35 b8 44 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm9,%ymm8
 720:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 726:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 72a:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 730:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 736:	48 01 d8             	add    %rbx,%rax
 739:	48 01 d8             	add    %rbx,%rax
 73c:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 742:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 748:	48 01 d8             	add    %rbx,%rax
 74b:	48 01 d8             	add    %rbx,%rax
 74e:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 754:	48 01 d8             	add    %rbx,%rax
 757:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 75d:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 761:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 767:	48 01 d8             	add    %rbx,%rax
 76a:	c5 7c 10 8c b2 e0 00 	vmovups 0xe0(%rdx,%rsi,4),%ymm9
 771:	00 00 
 773:	c4 62 35 b8 44 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm9,%ymm8
 77a:	48 83 c6 40          	add    $0x40,%rsi
 77e:	c4 e2 35 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm7
 784:	48 01 f8             	add    %rdi,%rax
 787:	c4 e2 35 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm4
 78d:	c4 e2 35 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm6
 793:	48 01 d8             	add    %rbx,%rax
 796:	48 01 d8             	add    %rbx,%rax
 799:	c4 e2 35 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm5
 79f:	c4 e2 35 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm2
 7a5:	48 01 d8             	add    %rbx,%rax
 7a8:	48 01 d8             	add    %rbx,%rax
 7ab:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 7b1:	48 01 d8             	add    %rbx,%rax
 7b4:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 7ba:	48 01 d8             	add    %rbx,%rax
 7bd:	c4 62 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm10
 7c3:	48 39 ce             	cmp    %rcx,%rsi
 7c6:	0f 8c 14 fd ff ff    	jl     4e0 <.omp_outlined.+0x2d0>
 7cc:	e9 85 fb ff ff       	jmpq   356 <.omp_outlined.+0x146>
 7d1:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 7d8:	0f 1f 84 00 00 00 00 
 7df:	00 
...
00000000000007f0 <_Z9n_reg_maxv>:
 7f0:	b8 48 00 00 00       	mov    $0x48,%eax
 7f5:	c3                   	retq   

...
0000000000000210 <.omp_outlined.>:
 ...
 321:	be 80 01 00 00       	mov    $0x180,%esi
 ...
 489:	4c 8d 0c 9e          	lea    (%rsi,%rbx,4),%r9
 ...
 4a6:	c4 82 5d b8 9c ac 80 	vfmadd231ps -0x180(%r12,%r13,4),%ymm4,%ymm3
 4ad:	fe ff ff 
 4b0:	c4 82 5d b8 94 a9 80 	vfmadd231ps -0x180(%r9,%r13,4),%ymm4,%ymm2
 4b7:	fe ff ff 
 4ba:	c4 82 5d b8 8c af 80 	vfmadd231ps -0x180(%r15,%r13,4),%ymm4,%ymm1
 4c1:	fe ff ff 
 4c4:	c4 82 5d b8 84 a8 80 	vfmadd231ps -0x180(%r8,%r13,4),%ymm4,%ymm0
 4cb:	fe ff ff 
 4ce:	c4 a1 7c 10 64 aa 20 	vmovups 0x20(%rdx,%r13,4),%ymm4
 4d5:	c4 82 5d b8 9c ac a0 	vfmadd231ps -0x160(%r12,%r13,4),%ymm4,%ymm3
 4dc:	fe ff ff 
 4df:	c4 82 5d b8 94 a9 a0 	vfmadd231ps -0x160(%r9,%r13,4),%ymm4,%ymm2
 4e6:	fe ff ff 
 4e9:	c4 82 5d b8 8c af a0 	vfmadd231ps -0x160(%r15,%r13,4),%ymm4,%ymm1
 4f0:	fe ff ff 
 4f3:	c4 82 5d b8 84 a8 a0 	vfmadd231ps -0x160(%r8,%r13,4),%ymm4,%ymm0
 4fa:	fe ff ff 
 4fd:	c4 a1 7c 10 64 aa 40 	vmovups 0x40(%rdx,%r13,4),%ymm4
 504:	c4 82 5d b8 9c ac c0 	vfmadd231ps -0x140(%r12,%r13,4),%ymm4,%ymm3
 50b:	fe ff ff 
 50e:	c4 82 5d b8 94 a9 c0 	vfmadd231ps -0x140(%r9,%r13,4),%ymm4,%ymm2
 515:	fe ff ff 
 518:	c4 82 5d b8 8c af c0 	vfmadd231ps -0x140(%r15,%r13,4),%ymm4,%ymm1
 51f:	fe ff ff 
 522:	c4 82 5d b8 84 a8 c0 	vfmadd231ps -0x140(%r8,%r13,4),%ymm4,%ymm0
 529:	fe ff ff 
 52c:	c4 a1 7c 10 64 aa 60 	vmovups 0x60(%rdx,%r13,4),%ymm4
 533:	c4 82 5d b8 9c ac e0 	vfmadd231ps -0x120(%r12,%r13,4),%ymm4,%ymm3
 53a:	fe ff ff 
 53d:	c4 82 5d b8 94 a9 e0 	vfmadd231ps -0x120(%r9,%r13,4),%ymm4,%ymm2
 544:	fe ff ff 
 547:	c4 82 5d b8 8c af e0 	vfmadd231ps -0x120(%r15,%r13,4),%ymm4,%ymm1
 54e:	fe ff ff 
 551:	c4 82 5d b8 84 a8 e0 	vfmadd231ps -0x120(%r8,%r13,4),%ymm4,%ymm0
 558:	fe ff ff 
 55b:	c4 a1 7c 10 a4 aa 80 	vmovups 0x80(%rdx,%r13,4),%ymm4
 562:	00 00 00 
 565:	c4 82 5d b8 9c ac 00 	vfmadd231ps -0x100(%r12,%r13,4),%ymm4,%ymm3
 56c:	ff ff ff 
 56f:	c4 82 5d b8 94 a9 00 	vfmadd231ps -0x100(%r9,%r13,4),%ymm4,%ymm2
 576:	ff ff ff 
 579:	c4 82 5d b8 8c af 00 	vfmadd231ps -0x100(%r15,%r13,4),%ymm4,%ymm1
 580:	ff ff ff 
 583:	c4 82 5d b8 84 a8 00 	vfmadd231ps -0x100(%r8,%r13,4),%ymm4,%ymm0
 58a:	ff ff ff 
 58d:	c4 a1 7c 10 a4 aa a0 	vmovups 0xa0(%rdx,%r13,4),%ymm4
 594:	00 00 00 
 597:	c4 82 5d b8 9c ac 20 	vfmadd231ps -0xe0(%r12,%r13,4),%ymm4,%ymm3
 59e:	ff ff ff 
 5a1:	c4 82 5d b8 94 a9 20 	vfmadd231ps -0xe0(%r9,%r13,4),%ymm4,%ymm2
 5a8:	ff ff ff 
 5ab:	c4 82 5d b8 8c af 20 	vfmadd231ps -0xe0(%r15,%r13,4),%ymm4,%ymm1
 5b2:	ff ff ff 
 5b5:	c4 82 5d b8 84 a8 20 	vfmadd231ps -0xe0(%r8,%r13,4),%ymm4,%ymm0
 5bc:	ff ff ff 
 5bf:	c4 a1 7c 10 a4 aa c0 	vmovups 0xc0(%rdx,%r13,4),%ymm4
 5c6:	00 00 00 
 5c9:	c4 82 5d b8 9c ac 40 	vfmadd231ps -0xc0(%r12,%r13,4),%ymm4,%ymm3
 5d0:	ff ff ff 
 5d3:	c4 82 5d b8 94 a9 40 	vfmadd231ps -0xc0(%r9,%r13,4),%ymm4,%ymm2
 5da:	ff ff ff 
 5dd:	c4 82 5d b8 8c af 40 	vfmadd231ps -0xc0(%r15,%r13,4),%ymm4,%ymm1
 5e4:	ff ff ff 
 5e7:	c4 82 5d b8 84 a8 40 	vfmadd231ps -0xc0(%r8,%r13,4),%ymm4,%ymm0
 5ee:	ff ff ff 
 5f1:	c4 a1 7c 10 a4 aa e0 	vmovups 0xe0(%rdx,%r13,4),%ymm4
 5f8:	00 00 00 
 5fb:	c4 82 5d b8 9c ac 60 	vfmadd231ps -0xa0(%r12,%r13,4),%ymm4,%ymm3
 602:	ff ff ff 
 605:	c4 82 5d b8 94 a9 60 	vfmadd231ps -0xa0(%r9,%r13,4),%ymm4,%ymm2
 60c:	ff ff ff 
 60f:	c4 82 5d b8 8c af 60 	vfmadd231ps -0xa0(%r15,%r13,4),%ymm4,%ymm1
 616:	ff ff ff 
 619:	c4 82 5d b8 84 a8 60 	vfmadd231ps -0xa0(%r8,%r13,4),%ymm4,%ymm0
 620:	ff ff ff 
 623:	c4 a1 7c 10 a4 aa 00 	vmovups 0x100(%rdx,%r13,4),%ymm4
 62a:	01 00 00 
 62d:	c4 82 5d b8 5c ac 80 	vfmadd231ps -0x80(%r12,%r13,4),%ymm4,%ymm3
 634:	c4 82 5d b8 54 a9 80 	vfmadd231ps -0x80(%r9,%r13,4),%ymm4,%ymm2
 63b:	c4 82 5d b8 4c af 80 	vfmadd231ps -0x80(%r15,%r13,4),%ymm4,%ymm1
 642:	c4 82 5d b8 44 a8 80 	vfmadd231ps -0x80(%r8,%r13,4),%ymm4,%ymm0
 649:	c4 a1 7c 10 a4 aa 20 	vmovups 0x120(%rdx,%r13,4),%ymm4
 650:	01 00 00 
 653:	c4 82 5d b8 5c ac a0 	vfmadd231ps -0x60(%r12,%r13,4),%ymm4,%ymm3
 65a:	c4 82 5d b8 54 a9 a0 	vfmadd231ps -0x60(%r9,%r13,4),%ymm4,%ymm2
 661:	c4 82 5d b8 4c af a0 	vfmadd231ps -0x60(%r15,%r13,4),%ymm4,%ymm1
 668:	c4 82 5d b8 44 a8 a0 	vfmadd231ps -0x60(%r8,%r13,4),%ymm4,%ymm0
 66f:	c4 a1 7c 10 a4 aa 40 	vmovups 0x140(%rdx,%r13,4),%ymm4
 676:	01 00 00 
 679:	c4 82 5d b8 5c ac c0 	vfmadd231ps -0x40(%r12,%r13,4),%ymm4,%ymm3
 680:	c4 82 5d b8 54 a9 c0 	vfmadd231ps -0x40(%r9,%r13,4),%ymm4,%ymm2
 687:	c4 82 5d b8 4c af c0 	vfmadd231ps -0x40(%r15,%r13,4),%ymm4,%ymm1
 68e:	c4 82 5d b8 44 a8 c0 	vfmadd231ps -0x40(%r8,%r13,4),%ymm4,%ymm0
 695:	c4 a1 7c 10 a4 aa 60 	vmovups 0x160(%rdx,%r13,4),%ymm4
 69c:	01 00 00 
 69f:	c4 82 5d b8 5c ac e0 	vfmadd231ps -0x20(%r12,%r13,4),%ymm4,%ymm3
 6a6:	c4 82 5d b8 54 a9 e0 	vfmadd231ps -0x20(%r9,%r13,4),%ymm4,%ymm2
 6ad:	c4 82 5d b8 4c af e0 	vfmadd231ps -0x20(%r15,%r13,4),%ymm4,%ymm1
 6b4:	c4 82 5d b8 44 a8 e0 	vfmadd231ps -0x20(%r8,%r13,4),%ymm4,%ymm0
 6bb:	c4 a1 7c 10 a4 aa 80 	vmovups 0x180(%rdx,%r13,4),%ymm4
 6c2:	01 00 00 
 6c5:	c4 82 5d b8 1c ac    	vfmadd231ps (%r12,%r13,4),%ymm4,%ymm3
 6cb:	c4 82 5d b8 14 a9    	vfmadd231ps (%r9,%r13,4),%ymm4,%ymm2
 6d1:	c4 82 5d b8 0c af    	vfmadd231ps (%r15,%r13,4),%ymm4,%ymm1
 6d7:	c4 82 5d b8 04 a8    	vfmadd231ps (%r8,%r13,4),%ymm4,%ymm0
 6dd:	49 83 c5 68          	add    $0x68,%r13
 6e1:	4d 39 d5             	cmp    %r10,%r13
 6e4:	0f 8c b6 fd ff ff    	jl     4a0 <.omp_outlined.+0x290>
 6ea:	e9 61 fc ff ff       	jmpq   350 <.omp_outlined.+0x140>
 6ef:	90                   	nop
...
0000000000000700 <_Z9n_reg_maxv>:
 700:	b8 34 00 00 00       	mov    $0x34,%eax
 705:	c3                   	retq   

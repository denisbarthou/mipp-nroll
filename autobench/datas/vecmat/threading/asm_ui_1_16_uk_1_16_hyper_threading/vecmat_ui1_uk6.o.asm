...
0000000000000220 <.omp_outlined.>:
 ...
 2f2:	00 
 2f3:	48 8d ac 86 a0 00 00 	lea    0xa0(%rsi,%rax,4),%rbp
 2fa:	00 
 ...
 340:	c5 fc 10 84 b5 60 ff 	vmovups -0xa0(%rbp,%rsi,4),%ymm0
 347:	ff ff 
 349:	c4 e2 75 98 04 b2    	vfmadd132ps (%rdx,%rsi,4),%ymm1,%ymm0
 34f:	c5 fc 10 54 b5 80    	vmovups -0x80(%rbp,%rsi,4),%ymm2
 355:	c5 fc 10 5c b5 a0    	vmovups -0x60(%rbp,%rsi,4),%ymm3
 35b:	c5 fc 10 64 b5 c0    	vmovups -0x40(%rbp,%rsi,4),%ymm4
 361:	c5 fc 10 6c b5 e0    	vmovups -0x20(%rbp,%rsi,4),%ymm5
 367:	c5 fc 10 74 b5 00    	vmovups 0x0(%rbp,%rsi,4),%ymm6
 36d:	c4 e2 6d b8 44 b2 20 	vfmadd231ps 0x20(%rdx,%rsi,4),%ymm2,%ymm0
 374:	c4 e2 65 b8 44 b2 40 	vfmadd231ps 0x40(%rdx,%rsi,4),%ymm3,%ymm0
 37b:	c4 e2 5d b8 44 b2 60 	vfmadd231ps 0x60(%rdx,%rsi,4),%ymm4,%ymm0
 382:	c4 e2 55 b8 84 b2 80 	vfmadd231ps 0x80(%rdx,%rsi,4),%ymm5,%ymm0
 389:	00 00 00 
 38c:	c4 e2 4d b8 84 b2 a0 	vfmadd231ps 0xa0(%rdx,%rsi,4),%ymm6,%ymm0
 393:	00 00 00 
 396:	48 83 c6 30          	add    $0x30,%rsi
 39a:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 39e:	48 39 ce             	cmp    %rcx,%rsi
 3a1:	7c 9d                	jl     340 <.omp_outlined.+0x120>
 3a3:	e9 5c ff ff ff       	jmpq   304 <.omp_outlined.+0xe4>
 3a8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
 3af:	00 

00000000000003b0 <_Z6enablev>:
 3b0:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 3b7 <_Z6enablev+0x7>
 3b7:	7e 1e                	jle    3d7 <_Z6enablev+0x27>
 3b9:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3c0 <_Z6enablev+0x10>
 3c0:	b8 30 00 00 00       	mov    $0x30,%eax
 3c5:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 3ca:	0f 45 c8             	cmovne %eax,%ecx
 3cd:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3d3 <_Z6enablev+0x23>
 3d3:	0f 9e c0             	setle  %al
 3d6:	c3                   	retq   

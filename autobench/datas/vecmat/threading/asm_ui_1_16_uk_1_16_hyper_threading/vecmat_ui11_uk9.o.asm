...
0000000000000220 <.omp_outlined.>:
 ...
 54a:	c4 62 25 b8 94 b5 00 	vfmadd231ps -0x100(%rbp,%rsi,4),%ymm11,%ymm10
 551:	ff ff ff 
 554:	c4 62 25 b8 8c 88 00 	vfmadd231ps -0x100(%rax,%rcx,4),%ymm11,%ymm9
 55b:	ff ff ff 
 55e:	c4 e2 25 b8 b4 c8 00 	vfmadd231ps -0x100(%rax,%rcx,8),%ymm11,%ymm6
 565:	ff ff ff 
 568:	48 8d 84 07 00 ff ff 	lea    -0x100(%rdi,%rax,1),%rax
 56f:	ff 
 ...
 5c6:	c4 62 25 b8 94 b5 20 	vfmadd231ps -0xe0(%rbp,%rsi,4),%ymm11,%ymm10
 5cd:	ff ff ff 
 ...
 635:	c4 62 25 b8 94 b5 40 	vfmadd231ps -0xc0(%rbp,%rsi,4),%ymm11,%ymm10
 63c:	ff ff ff 
 ...
 6a4:	c4 62 25 b8 94 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm11,%ymm10
 6ab:	ff ff ff 
 ...
 714:	00 00 
 716:	c4 62 25 b8 54 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm11,%ymm10
 71d:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 723:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 727:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 72d:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 733:	48 01 f8             	add    %rdi,%rax
 736:	48 01 f8             	add    %rdi,%rax
 739:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 73f:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 745:	48 01 f8             	add    %rdi,%rax
 748:	48 01 f8             	add    %rdi,%rax
 74b:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 751:	48 01 f8             	add    %rdi,%rax
 754:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 75a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 75e:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 764:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 768:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 76e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 772:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 778:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 77c:	c5 7c 10 9c b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm11
 783:	00 00 
 785:	c4 62 25 b8 54 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm11,%ymm10
 78c:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 792:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 796:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 79c:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 7a2:	48 01 f8             	add    %rdi,%rax
 7a5:	48 01 f8             	add    %rdi,%rax
 7a8:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 7ae:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 7b4:	48 01 f8             	add    %rdi,%rax
 7b7:	48 01 f8             	add    %rdi,%rax
 7ba:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 7c0:	48 01 f8             	add    %rdi,%rax
 7c3:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 7c9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7cd:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 7d3:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7d7:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 7dd:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7e1:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 7e7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 7eb:	c5 7c 10 9c b2 c0 00 	vmovups 0xc0(%rdx,%rsi,4),%ymm11
 7f2:	00 00 
 7f4:	c4 62 25 b8 54 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm11,%ymm10
 7fb:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 801:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 805:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 80b:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 811:	48 01 f8             	add    %rdi,%rax
 814:	48 01 f8             	add    %rdi,%rax
 817:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 81d:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 823:	48 01 f8             	add    %rdi,%rax
 826:	48 01 f8             	add    %rdi,%rax
 829:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 82f:	48 01 f8             	add    %rdi,%rax
 832:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 838:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 83c:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 842:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 846:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 84c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 850:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 856:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 85a:	c5 7c 10 9c b2 e0 00 	vmovups 0xe0(%rdx,%rsi,4),%ymm11
 861:	00 00 
 863:	c4 62 25 b8 54 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm11,%ymm10
 86a:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 870:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 874:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 87a:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 880:	48 01 f8             	add    %rdi,%rax
 883:	48 01 f8             	add    %rdi,%rax
 886:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 88c:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 892:	48 01 f8             	add    %rdi,%rax
 895:	48 01 f8             	add    %rdi,%rax
 898:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 89e:	48 01 f8             	add    %rdi,%rax
 8a1:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 8a7:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8ab:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 8b1:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8b5:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 8bb:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 8bf:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 8c5:	48 01 f8             	add    %rdi,%rax
 8c8:	c5 7c 10 9c b2 00 01 	vmovups 0x100(%rdx,%rsi,4),%ymm11
 8cf:	00 00 
 8d1:	c4 62 25 b8 54 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm11,%ymm10
 8d8:	48 83 c6 48          	add    $0x48,%rsi
 8dc:	c4 62 25 b8 0c 03    	vfmadd231ps (%rbx,%rax,1),%ymm11,%ymm9
 8e2:	48 01 d8             	add    %rbx,%rax
 8e5:	c4 e2 25 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm6
 8eb:	c4 62 25 b8 04 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm8
 8f1:	48 01 f8             	add    %rdi,%rax
 8f4:	48 01 f8             	add    %rdi,%rax
 8f7:	c4 e2 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm7
 8fd:	c4 e2 25 b8 24 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm4
 903:	48 01 f8             	add    %rdi,%rax
 906:	48 01 f8             	add    %rdi,%rax
 909:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 90f:	48 01 f8             	add    %rdi,%rax
 912:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 918:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 91c:	c4 e2 25 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm2
 922:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 926:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 92c:	48 01 f8             	add    %rdi,%rax
 92f:	c4 62 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm12
 935:	48 39 ce             	cmp    %rcx,%rsi
 938:	0f 8c 02 fc ff ff    	jl     540 <.omp_outlined.+0x320>
 93e:	e9 1d fa ff ff       	jmpq   360 <.omp_outlined.+0x140>
...
0000000000000960 <_Z9n_reg_maxv>:
 960:	b8 63 00 00 00       	mov    $0x63,%eax
 965:	c3                   	retq   

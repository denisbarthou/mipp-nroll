...
0000000000000230 <.omp_outlined.>:
 ...
 323:	48 8d 6c be 40       	lea    0x40(%rsi,%rdi,4),%rbp
 328:	48 8d 3c 8d 00 00 00 	lea    0x0(,%rcx,4),%rdi
 32f:	00 
 330:	4c 8d 14 7f          	lea    (%rdi,%rdi,2),%r10
 334:	48 8d 7c 40 01       	lea    0x1(%rax,%rax,2),%rdi
 339:	48 0f af f9          	imul   %rcx,%rdi
 33d:	48 8d 7c be 40       	lea    0x40(%rsi,%rdi,4),%rdi
 342:	48 8d 74 9e 40       	lea    0x40(%rsi,%rbx,4),%rsi
 347:	e9 8e 00 00 00       	jmpq   3da <.omp_outlined.+0x1aa>
 ...
 3d4:	0f 8d 01 ff ff ff    	jge    2db <.omp_outlined.+0xab>
 3da:	4c 8d 1c 40          	lea    (%rax,%rax,2),%r11
 3de:	85 c9                	test   %ecx,%ecx
 3e0:	0f 8e 6a ff ff ff    	jle    350 <.omp_outlined.+0x120>
 ...
 405:	c4 e2 65 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm3,%ymm2
 40c:	c4 e2 65 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm3,%ymm1
 413:	c4 e2 65 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm3,%ymm0
 41a:	c5 fc 10 64 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm4
 420:	c5 fc 10 6c 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm5
 426:	c4 e2 5d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm4,%ymm2
 42d:	c4 e2 5d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm4,%ymm1
 434:	c4 e2 5d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm4,%ymm0
 43b:	c4 e2 55 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm5,%ymm2
 442:	c4 e2 55 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm5,%ymm1
 448:	c4 e2 55 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm5,%ymm0
 44e:	48 83 c3 18          	add    $0x18,%rbx
 452:	48 39 cb             	cmp    %rcx,%rbx
 455:	7c a9                	jl     400 <.omp_outlined.+0x1d0>
 457:	e9 00 ff ff ff       	jmpq   35c <.omp_outlined.+0x12c>
 45c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000000460 <_Z6enablev>:
 460:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 467 <_Z6enablev+0x7>
 ...
 478:	b9 fd ff ff ff       	mov    $0xfffffffd,%ecx

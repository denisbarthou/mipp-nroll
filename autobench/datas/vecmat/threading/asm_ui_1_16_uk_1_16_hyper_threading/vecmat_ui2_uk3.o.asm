...
0000000000000220 <.omp_outlined.>:
 ...
 3a5:	c4 e2 6d b8 4c 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm2,%ymm1
 3ac:	c4 e2 6d b8 44 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm2,%ymm0
 3b3:	c5 fc 10 5c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm3
 3b9:	c5 fc 10 64 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm4
 3bf:	c4 e2 65 b8 4c 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm3,%ymm1
 3c6:	c4 e2 65 b8 44 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm3,%ymm0
 3cd:	c4 e2 5d b8 0c 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm4,%ymm1
 3d3:	c4 e2 5d b8 04 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm4,%ymm0
 3d9:	48 83 c3 18          	add    $0x18,%rbx
 3dd:	48 39 cb             	cmp    %rcx,%rbx
 3e0:	7c be                	jl     3a0 <.omp_outlined.+0x180>
 3e2:	e9 31 ff ff ff       	jmpq   318 <.omp_outlined.+0xf8>
 3e7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
 3ee:	00 00 

00000000000003f0 <_Z6enablev>:
 3f0:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 3f7 <_Z6enablev+0x7>
 ...
 408:	b9 fd ff ff ff       	mov    $0xfffffffd,%ecx

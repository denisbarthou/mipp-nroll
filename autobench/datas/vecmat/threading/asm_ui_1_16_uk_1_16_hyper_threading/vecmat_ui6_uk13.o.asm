...
0000000000000220 <.omp_outlined.>:
 ...
 300:	49 8d 88 80 01 00 00 	lea    0x180(%r8),%rcx
 ...
 33f:	49 8d bc c0 80 01 00 	lea    0x180(%r8,%rax,8),%rdi
 346:	00 
 ...
 369:	49 8d 9c a8 80 01 00 	lea    0x180(%r8,%rbp,4),%rbx
 370:	00 
 371:	48 8d 6c 40 04       	lea    0x4(%rax,%rax,2),%rbp
 376:	48 8d 44 40 05       	lea    0x5(%rax,%rax,2),%rax
 37b:	49 8d b4 b0 80 01 00 	lea    0x180(%r8,%rsi,4),%rsi
 382:	00 
 383:	49 0f af ea          	imul   %r10,%rbp
 387:	49 0f af c2          	imul   %r10,%rax
 38b:	49 8d ac a8 80 01 00 	lea    0x180(%r8,%rbp,4),%rbp
 392:	00 
 393:	49 8d 84 80 80 01 00 	lea    0x180(%r8,%rax,4),%rax
 39a:	00 
 ...
 506:	c4 a2 4d b8 ac 8f 80 	vfmadd231ps -0x180(%rdi,%r9,4),%ymm6,%ymm5
 50d:	fe ff ff 
 510:	c4 82 4d b8 a4 88 80 	vfmadd231ps -0x180(%r8,%r9,4),%ymm6,%ymm4
 517:	fe ff ff 
 51a:	c4 a2 4d b8 9c 8e 80 	vfmadd231ps -0x180(%rsi,%r9,4),%ymm6,%ymm3
 521:	fe ff ff 
 524:	c4 a2 4d b8 84 8b 80 	vfmadd231ps -0x180(%rbx,%r9,4),%ymm6,%ymm0
 52b:	fe ff ff 
 52e:	c4 a2 4d b8 94 8d 80 	vfmadd231ps -0x180(%rbp,%r9,4),%ymm6,%ymm2
 535:	fe ff ff 
 538:	c4 a2 4d b8 8c 88 80 	vfmadd231ps -0x180(%rax,%r9,4),%ymm6,%ymm1
 53f:	fe ff ff 
 542:	c4 81 7c 10 74 8e 20 	vmovups 0x20(%r14,%r9,4),%ymm6
 549:	c4 a2 4d b8 ac 8f a0 	vfmadd231ps -0x160(%rdi,%r9,4),%ymm6,%ymm5
 550:	fe ff ff 
 553:	c4 82 4d b8 a4 88 a0 	vfmadd231ps -0x160(%r8,%r9,4),%ymm6,%ymm4
 55a:	fe ff ff 
 55d:	c4 a2 4d b8 9c 8e a0 	vfmadd231ps -0x160(%rsi,%r9,4),%ymm6,%ymm3
 564:	fe ff ff 
 567:	c4 a2 4d b8 84 8b a0 	vfmadd231ps -0x160(%rbx,%r9,4),%ymm6,%ymm0
 56e:	fe ff ff 
 571:	c4 a2 4d b8 94 8d a0 	vfmadd231ps -0x160(%rbp,%r9,4),%ymm6,%ymm2
 578:	fe ff ff 
 57b:	c4 a2 4d b8 8c 88 a0 	vfmadd231ps -0x160(%rax,%r9,4),%ymm6,%ymm1
 582:	fe ff ff 
 585:	c4 81 7c 10 74 8e 40 	vmovups 0x40(%r14,%r9,4),%ymm6
 58c:	c4 a2 4d b8 ac 8f c0 	vfmadd231ps -0x140(%rdi,%r9,4),%ymm6,%ymm5
 593:	fe ff ff 
 596:	c4 82 4d b8 a4 88 c0 	vfmadd231ps -0x140(%r8,%r9,4),%ymm6,%ymm4
 59d:	fe ff ff 
 5a0:	c4 a2 4d b8 9c 8e c0 	vfmadd231ps -0x140(%rsi,%r9,4),%ymm6,%ymm3
 5a7:	fe ff ff 
 5aa:	c4 a2 4d b8 84 8b c0 	vfmadd231ps -0x140(%rbx,%r9,4),%ymm6,%ymm0
 5b1:	fe ff ff 
 5b4:	c4 a2 4d b8 94 8d c0 	vfmadd231ps -0x140(%rbp,%r9,4),%ymm6,%ymm2
 5bb:	fe ff ff 
 5be:	c4 a2 4d b8 8c 88 c0 	vfmadd231ps -0x140(%rax,%r9,4),%ymm6,%ymm1
 5c5:	fe ff ff 
 5c8:	c4 81 7c 10 74 8e 60 	vmovups 0x60(%r14,%r9,4),%ymm6
 5cf:	c4 a2 4d b8 ac 8f e0 	vfmadd231ps -0x120(%rdi,%r9,4),%ymm6,%ymm5
 5d6:	fe ff ff 
 5d9:	c4 82 4d b8 a4 88 e0 	vfmadd231ps -0x120(%r8,%r9,4),%ymm6,%ymm4
 5e0:	fe ff ff 
 5e3:	c4 a2 4d b8 9c 8e e0 	vfmadd231ps -0x120(%rsi,%r9,4),%ymm6,%ymm3
 5ea:	fe ff ff 
 5ed:	c4 a2 4d b8 84 8b e0 	vfmadd231ps -0x120(%rbx,%r9,4),%ymm6,%ymm0
 5f4:	fe ff ff 
 5f7:	c4 a2 4d b8 94 8d e0 	vfmadd231ps -0x120(%rbp,%r9,4),%ymm6,%ymm2
 5fe:	fe ff ff 
 601:	c4 a2 4d b8 8c 88 e0 	vfmadd231ps -0x120(%rax,%r9,4),%ymm6,%ymm1
 608:	fe ff ff 
 60b:	c4 81 7c 10 b4 8e 80 	vmovups 0x80(%r14,%r9,4),%ymm6
 612:	00 00 00 
 615:	c4 a2 4d b8 ac 8f 00 	vfmadd231ps -0x100(%rdi,%r9,4),%ymm6,%ymm5
 61c:	ff ff ff 
 61f:	c4 82 4d b8 a4 88 00 	vfmadd231ps -0x100(%r8,%r9,4),%ymm6,%ymm4
 626:	ff ff ff 
 629:	c4 a2 4d b8 9c 8e 00 	vfmadd231ps -0x100(%rsi,%r9,4),%ymm6,%ymm3
 630:	ff ff ff 
 633:	c4 a2 4d b8 84 8b 00 	vfmadd231ps -0x100(%rbx,%r9,4),%ymm6,%ymm0
 63a:	ff ff ff 
 63d:	c4 a2 4d b8 94 8d 00 	vfmadd231ps -0x100(%rbp,%r9,4),%ymm6,%ymm2
 644:	ff ff ff 
 647:	c4 a2 4d b8 8c 88 00 	vfmadd231ps -0x100(%rax,%r9,4),%ymm6,%ymm1
 64e:	ff ff ff 
 651:	c4 81 7c 10 b4 8e a0 	vmovups 0xa0(%r14,%r9,4),%ymm6
 658:	00 00 00 
 65b:	c4 a2 4d b8 ac 8f 20 	vfmadd231ps -0xe0(%rdi,%r9,4),%ymm6,%ymm5
 662:	ff ff ff 
 665:	c4 82 4d b8 a4 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm6,%ymm4
 66c:	ff ff ff 
 66f:	c4 a2 4d b8 9c 8e 20 	vfmadd231ps -0xe0(%rsi,%r9,4),%ymm6,%ymm3
 676:	ff ff ff 
 679:	c4 a2 4d b8 84 8b 20 	vfmadd231ps -0xe0(%rbx,%r9,4),%ymm6,%ymm0
 680:	ff ff ff 
 683:	c4 a2 4d b8 94 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm6,%ymm2
 68a:	ff ff ff 
 68d:	c4 a2 4d b8 8c 88 20 	vfmadd231ps -0xe0(%rax,%r9,4),%ymm6,%ymm1
 694:	ff ff ff 
 697:	c4 81 7c 10 b4 8e c0 	vmovups 0xc0(%r14,%r9,4),%ymm6
 69e:	00 00 00 
 6a1:	c4 a2 4d b8 ac 8f 40 	vfmadd231ps -0xc0(%rdi,%r9,4),%ymm6,%ymm5
 6a8:	ff ff ff 
 6ab:	c4 82 4d b8 a4 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm6,%ymm4
 6b2:	ff ff ff 
 6b5:	c4 a2 4d b8 9c 8e 40 	vfmadd231ps -0xc0(%rsi,%r9,4),%ymm6,%ymm3
 6bc:	ff ff ff 
 6bf:	c4 a2 4d b8 84 8b 40 	vfmadd231ps -0xc0(%rbx,%r9,4),%ymm6,%ymm0
 6c6:	ff ff ff 
 6c9:	c4 a2 4d b8 94 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm6,%ymm2
 6d0:	ff ff ff 
 6d3:	c4 a2 4d b8 8c 88 40 	vfmadd231ps -0xc0(%rax,%r9,4),%ymm6,%ymm1
 6da:	ff ff ff 
 6dd:	c4 81 7c 10 b4 8e e0 	vmovups 0xe0(%r14,%r9,4),%ymm6
 6e4:	00 00 00 
 6e7:	c4 a2 4d b8 ac 8f 60 	vfmadd231ps -0xa0(%rdi,%r9,4),%ymm6,%ymm5
 6ee:	ff ff ff 
 6f1:	c4 82 4d b8 a4 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm6,%ymm4
 6f8:	ff ff ff 
 6fb:	c4 a2 4d b8 9c 8e 60 	vfmadd231ps -0xa0(%rsi,%r9,4),%ymm6,%ymm3
 702:	ff ff ff 
 705:	c4 a2 4d b8 84 8b 60 	vfmadd231ps -0xa0(%rbx,%r9,4),%ymm6,%ymm0
 70c:	ff ff ff 
 70f:	c4 a2 4d b8 94 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm6,%ymm2
 716:	ff ff ff 
 719:	c4 a2 4d b8 8c 88 60 	vfmadd231ps -0xa0(%rax,%r9,4),%ymm6,%ymm1
 720:	ff ff ff 
 723:	c4 81 7c 10 b4 8e 00 	vmovups 0x100(%r14,%r9,4),%ymm6
 72a:	01 00 00 
 72d:	c4 a2 4d b8 6c 8f 80 	vfmadd231ps -0x80(%rdi,%r9,4),%ymm6,%ymm5
 734:	c4 82 4d b8 64 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm6,%ymm4
 73b:	c4 a2 4d b8 5c 8e 80 	vfmadd231ps -0x80(%rsi,%r9,4),%ymm6,%ymm3
 742:	c4 a2 4d b8 44 8b 80 	vfmadd231ps -0x80(%rbx,%r9,4),%ymm6,%ymm0
 749:	c4 a2 4d b8 54 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm6,%ymm2
 750:	c4 a2 4d b8 4c 88 80 	vfmadd231ps -0x80(%rax,%r9,4),%ymm6,%ymm1
 757:	c4 81 7c 10 b4 8e 20 	vmovups 0x120(%r14,%r9,4),%ymm6
 75e:	01 00 00 
 761:	c4 a2 4d b8 6c 8f a0 	vfmadd231ps -0x60(%rdi,%r9,4),%ymm6,%ymm5
 768:	c4 82 4d b8 64 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm6,%ymm4
 76f:	c4 a2 4d b8 5c 8e a0 	vfmadd231ps -0x60(%rsi,%r9,4),%ymm6,%ymm3
 776:	c4 a2 4d b8 44 8b a0 	vfmadd231ps -0x60(%rbx,%r9,4),%ymm6,%ymm0
 77d:	c4 a2 4d b8 54 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm6,%ymm2
 784:	c4 a2 4d b8 4c 88 a0 	vfmadd231ps -0x60(%rax,%r9,4),%ymm6,%ymm1
 78b:	c4 81 7c 10 b4 8e 40 	vmovups 0x140(%r14,%r9,4),%ymm6
 792:	01 00 00 
 795:	c4 a2 4d b8 6c 8f c0 	vfmadd231ps -0x40(%rdi,%r9,4),%ymm6,%ymm5
 79c:	c4 82 4d b8 64 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm6,%ymm4
 7a3:	c4 a2 4d b8 5c 8e c0 	vfmadd231ps -0x40(%rsi,%r9,4),%ymm6,%ymm3
 7aa:	c4 a2 4d b8 44 8b c0 	vfmadd231ps -0x40(%rbx,%r9,4),%ymm6,%ymm0
 7b1:	c4 a2 4d b8 54 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm6,%ymm2
 7b8:	c4 a2 4d b8 4c 88 c0 	vfmadd231ps -0x40(%rax,%r9,4),%ymm6,%ymm1
 7bf:	c4 81 7c 10 b4 8e 60 	vmovups 0x160(%r14,%r9,4),%ymm6
 7c6:	01 00 00 
 7c9:	c4 a2 4d b8 6c 8f e0 	vfmadd231ps -0x20(%rdi,%r9,4),%ymm6,%ymm5
 7d0:	c4 82 4d b8 64 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm6,%ymm4
 7d7:	c4 a2 4d b8 5c 8e e0 	vfmadd231ps -0x20(%rsi,%r9,4),%ymm6,%ymm3
 7de:	c4 a2 4d b8 44 8b e0 	vfmadd231ps -0x20(%rbx,%r9,4),%ymm6,%ymm0
 7e5:	c4 a2 4d b8 54 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm6,%ymm2
 7ec:	c4 a2 4d b8 4c 88 e0 	vfmadd231ps -0x20(%rax,%r9,4),%ymm6,%ymm1
 7f3:	c4 81 7c 10 b4 8e 80 	vmovups 0x180(%r14,%r9,4),%ymm6
 7fa:	01 00 00 
 7fd:	c4 a2 4d b8 2c 8f    	vfmadd231ps (%rdi,%r9,4),%ymm6,%ymm5
 803:	c4 82 4d b8 24 88    	vfmadd231ps (%r8,%r9,4),%ymm6,%ymm4
 809:	c4 a2 4d b8 1c 8e    	vfmadd231ps (%rsi,%r9,4),%ymm6,%ymm3
 80f:	c4 a2 4d b8 04 8b    	vfmadd231ps (%rbx,%r9,4),%ymm6,%ymm0
 815:	c4 a2 4d b8 54 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm6,%ymm2
 81c:	c4 a2 4d b8 0c 88    	vfmadd231ps (%rax,%r9,4),%ymm6,%ymm1
 822:	49 83 c1 68          	add    $0x68,%r9
 826:	4d 39 d1             	cmp    %r10,%r9
 829:	0f 8c d1 fc ff ff    	jl     500 <.omp_outlined.+0x2e0>
 82f:	e9 84 fb ff ff       	jmpq   3b8 <.omp_outlined.+0x198>
 834:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
 83b:	00 00 00 00 00 
...
0000000000000850 <_Z9n_reg_maxv>:
 850:	b8 4e 00 00 00       	mov    $0x4e,%eax
 855:	c3                   	retq   

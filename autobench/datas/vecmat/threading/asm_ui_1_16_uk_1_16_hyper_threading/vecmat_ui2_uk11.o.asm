...
0000000000000210 <.omp_outlined.>:
 ...
 2db:	41 b9 40 01 00 00    	mov    $0x140,%r9d
 ...
 390:	c5 fc 10 34 9a       	vmovups (%rdx,%rbx,4),%ymm6
 395:	c4 e2 4d b8 8c 9d c0 	vfmadd231ps -0x140(%rbp,%rbx,4),%ymm6,%ymm1
 39c:	fe ff ff 
 39f:	c4 e2 4d b8 84 9e c0 	vfmadd231ps -0x140(%rsi,%rbx,4),%ymm6,%ymm0
 3a6:	fe ff ff 
 3a9:	c5 fc 10 7c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm7
 3af:	c5 7c 10 44 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm8
 3b5:	c5 7c 10 4c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm9
 3bb:	c5 7c 10 94 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm10
 3c2:	00 00 
 3c4:	c5 7c 10 9c 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm11
 3cb:	00 00 
 3cd:	c5 7c 10 a4 9a c0 00 	vmovups 0xc0(%rdx,%rbx,4),%ymm12
 3d4:	00 00 
 3d6:	c5 fc 10 ac 9a e0 00 	vmovups 0xe0(%rdx,%rbx,4),%ymm5
 3dd:	00 00 
 3df:	c5 fc 10 a4 9a 00 01 	vmovups 0x100(%rdx,%rbx,4),%ymm4
 3e6:	00 00 
 3e8:	c5 fc 10 9c 9a 20 01 	vmovups 0x120(%rdx,%rbx,4),%ymm3
 3ef:	00 00 
 3f1:	c5 fc 10 94 9a 40 01 	vmovups 0x140(%rdx,%rbx,4),%ymm2
 3f8:	00 00 
 3fa:	c4 e2 45 b8 8c 9d e0 	vfmadd231ps -0x120(%rbp,%rbx,4),%ymm7,%ymm1
 401:	fe ff ff 
 404:	c4 e2 45 b8 84 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm7,%ymm0
 40b:	fe ff ff 
 40e:	c4 e2 3d b8 8c 9d 00 	vfmadd231ps -0x100(%rbp,%rbx,4),%ymm8,%ymm1
 415:	ff ff ff 
 418:	c4 e2 3d b8 84 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm8,%ymm0
 41f:	ff ff ff 
 422:	c4 e2 35 b8 8c 9d 20 	vfmadd231ps -0xe0(%rbp,%rbx,4),%ymm9,%ymm1
 429:	ff ff ff 
 42c:	c4 e2 35 b8 84 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm9,%ymm0
 433:	ff ff ff 
 436:	c4 e2 2d b8 8c 9d 40 	vfmadd231ps -0xc0(%rbp,%rbx,4),%ymm10,%ymm1
 43d:	ff ff ff 
 440:	c4 e2 2d b8 84 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm10,%ymm0
 447:	ff ff ff 
 44a:	c4 e2 25 b8 8c 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm11,%ymm1
 451:	ff ff ff 
 454:	c4 e2 25 b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm11,%ymm0
 45b:	ff ff ff 
 45e:	c4 e2 1d b8 4c 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm12,%ymm1
 465:	c4 e2 1d b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm12,%ymm0
 46c:	c4 e2 55 b8 4c 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm5,%ymm1
 473:	c4 e2 55 b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm5,%ymm0
 47a:	c4 e2 5d b8 4c 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm4,%ymm1
 481:	c4 e2 5d b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm4,%ymm0
 488:	c4 e2 65 b8 4c 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm3,%ymm1
 48f:	c4 e2 65 b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm3,%ymm0
 496:	c4 e2 6d b8 4c 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm2,%ymm1
 49d:	c4 e2 6d b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm2,%ymm0
 4a3:	48 83 c3 58          	add    $0x58,%rbx
 4a7:	48 39 cb             	cmp    %rcx,%rbx
 4aa:	0f 8c e0 fe ff ff    	jl     390 <.omp_outlined.+0x180>
 4b0:	e9 53 fe ff ff       	jmpq   308 <.omp_outlined.+0xf8>
 4b5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 4bc:	00 00 00 00 

00000000000004c0 <_Z6enablev>:
 4c0:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 4c7 <_Z6enablev+0x7>
 4c7:	7d 03                	jge    4cc <_Z6enablev+0xc>
 4c9:	31 c0                	xor    %eax,%eax
 4cb:	c3                   	retq   
 4cc:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 4d3 <_Z6enablev+0x13>
 4d3:	b8 58 00 00 00       	mov    $0x58,%eax
 4d8:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 4dd:	0f 45 c8             	cmovne %eax,%ecx
 4e0:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4e6 <_Z6enablev+0x26>
 4e6:	0f 9e c0             	setle  %al
 4e9:	c3                   	retq   

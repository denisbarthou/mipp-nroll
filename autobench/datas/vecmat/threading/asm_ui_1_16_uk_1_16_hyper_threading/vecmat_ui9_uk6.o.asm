...
vecmat_ui9_uk6.o:     file format elf64-x86-64
...
0000000000000220 <.omp_outlined.>:
 ...
 31c:	48 8d ac b0 a0 00 00 	lea    0xa0(%rax,%rsi,4),%rbp
 323:	00 
 ...
 33e:	00 00 
 340:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
 ...
 46c:	c4 c3 fd 01 d7 4e    	vpermpd $0x4e,%ymm15,%ymm2
 472:	c5 84 58 d2          	vaddps %ymm2,%ymm15,%ymm2
 ...
 4e8:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
 ...
 500:	c5 7c 10 5c b2 40    	vmovups 0x40(%rdx,%rsi,4),%ymm11
 506:	c5 7c 10 64 b2 60    	vmovups 0x60(%rdx,%rsi,4),%ymm12
 50c:	c4 62 35 b8 84 b5 60 	vfmadd231ps -0xa0(%rbp,%rsi,4),%ymm9,%ymm8
 513:	ff ff ff 
 516:	c5 7c 10 ac b2 80 00 	vmovups 0x80(%rdx,%rsi,4),%ymm13
 51d:	00 00 
 51f:	c5 7c 10 b4 b2 a0 00 	vmovups 0xa0(%rdx,%rsi,4),%ymm14
 526:	00 00 
 528:	c4 e2 35 b8 bc 88 60 	vfmadd231ps -0xa0(%rax,%rcx,4),%ymm9,%ymm7
 52f:	ff ff ff 
 532:	c4 e2 35 b8 a4 c8 60 	vfmadd231ps -0xa0(%rax,%rcx,8),%ymm9,%ymm4
 539:	ff ff ff 
 53c:	48 8d 84 03 60 ff ff 	lea    -0xa0(%rbx,%rax,1),%rax
 543:	ff 
 544:	48 01 d8             	add    %rbx,%rax
 547:	c4 e2 35 b8 34 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm6
 54d:	c4 e2 35 b8 2c c8    	vfmadd231ps (%rax,%rcx,8),%ymm9,%ymm5
 553:	48 01 d8             	add    %rbx,%rax
 556:	48 01 d8             	add    %rbx,%rax
 559:	c4 62 2d b8 44 b5 80 	vfmadd231ps -0x80(%rbp,%rsi,4),%ymm10,%ymm8
 560:	c4 e2 35 b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm2
 566:	48 01 d8             	add    %rbx,%rax
 569:	c4 e2 35 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm3
 56f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 573:	c4 e2 35 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm1
 579:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 57d:	c4 62 35 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm9,%ymm15
 583:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 587:	c4 62 25 b8 44 b5 a0 	vfmadd231ps -0x60(%rbp,%rsi,4),%ymm11,%ymm8
 58e:	c4 e2 2d b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm7
 594:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 598:	c4 e2 2d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm4
 59e:	c4 e2 2d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm6
 5a4:	48 01 d8             	add    %rbx,%rax
 5a7:	48 01 d8             	add    %rbx,%rax
 5aa:	c4 e2 2d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm5
 5b0:	c4 e2 2d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm10,%ymm2
 5b6:	48 01 d8             	add    %rbx,%rax
 5b9:	c4 62 1d b8 44 b5 c0 	vfmadd231ps -0x40(%rbp,%rsi,4),%ymm12,%ymm8
 5c0:	48 01 d8             	add    %rbx,%rax
 5c3:	c4 e2 2d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm3
 5c9:	48 01 d8             	add    %rbx,%rax
 5cc:	c4 e2 2d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm1
 5d2:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5d6:	c4 62 2d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm10,%ymm15
 5dc:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 5e0:	c4 62 15 b8 44 b5 e0 	vfmadd231ps -0x20(%rbp,%rsi,4),%ymm13,%ymm8
 5e7:	c4 e2 25 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm11,%ymm7
 5ed:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 5f1:	c4 e2 25 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm4
 5f7:	c4 e2 25 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm6
 5fd:	48 01 d8             	add    %rbx,%rax
 600:	48 01 d8             	add    %rbx,%rax
 603:	c4 e2 25 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm5
 609:	c4 e2 25 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm11,%ymm2
 60f:	48 01 d8             	add    %rbx,%rax
 612:	c4 62 0d b8 44 b5 00 	vfmadd231ps 0x0(%rbp,%rsi,4),%ymm14,%ymm8
 619:	48 83 c6 30          	add    $0x30,%rsi
 61d:	48 01 d8             	add    %rbx,%rax
 620:	c4 e2 25 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm3
 626:	48 01 d8             	add    %rbx,%rax
 629:	c4 e2 25 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm1
 62f:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 633:	c4 62 25 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm11,%ymm15
 639:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 63d:	c4 e2 1d b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm12,%ymm7
 643:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 647:	c4 e2 1d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm4
 64d:	c4 e2 1d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm6
 653:	48 01 d8             	add    %rbx,%rax
 656:	48 01 d8             	add    %rbx,%rax
 659:	c4 e2 1d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm5
 65f:	c4 e2 1d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm12,%ymm2
 665:	48 01 d8             	add    %rbx,%rax
 668:	48 01 d8             	add    %rbx,%rax
 66b:	c4 e2 1d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm3
 671:	48 01 d8             	add    %rbx,%rax
 674:	c4 e2 1d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm1
 67a:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 67e:	c4 62 1d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm12,%ymm15
 684:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 688:	c4 e2 15 b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm13,%ymm7
 68e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 692:	c4 e2 15 b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm4
 698:	c4 e2 15 b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm6
 69e:	48 01 d8             	add    %rbx,%rax
 6a1:	48 01 d8             	add    %rbx,%rax
 6a4:	c4 e2 15 b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm5
 6aa:	c4 e2 15 b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm13,%ymm2
 6b0:	48 01 d8             	add    %rbx,%rax
 6b3:	48 01 d8             	add    %rbx,%rax
 6b6:	c4 e2 15 b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm3
 6bc:	48 01 d8             	add    %rbx,%rax
 6bf:	c4 e2 15 b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm1
 6c5:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6c9:	c4 62 15 b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm13,%ymm15
 6cf:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 6d3:	c4 e2 0d b8 3c 07    	vfmadd231ps (%rdi,%rax,1),%ymm14,%ymm7
 6d9:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 6dd:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 6e3:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 6e9:	48 01 d8             	add    %rbx,%rax
 6ec:	48 01 d8             	add    %rbx,%rax
 6ef:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 6f5:	c4 e2 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm2
 6fb:	48 01 d8             	add    %rbx,%rax
 6fe:	48 01 d8             	add    %rbx,%rax
 701:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 707:	48 01 d8             	add    %rbx,%rax
 70a:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 710:	48 01 d8             	add    %rbx,%rax
 713:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 719:	48 39 ce             	cmp    %rcx,%rsi
 71c:	0f 8c ce fd ff ff    	jl     4f0 <.omp_outlined.+0x2d0>
 722:	e9 3f fc ff ff       	jmpq   366 <.omp_outlined.+0x146>
...
0000000000000740 <_Z9n_reg_maxv>:
 740:	b8 36 00 00 00       	mov    $0x36,%eax
 745:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui9_uk6.cpp+0x9a>
  96:	01 00 00 00 

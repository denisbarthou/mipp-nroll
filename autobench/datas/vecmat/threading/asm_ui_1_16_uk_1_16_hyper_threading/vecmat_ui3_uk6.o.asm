...
0000000000000230 <.omp_outlined.>:
 ...
 323:	48 8d ac be a0 00 00 	lea    0xa0(%rsi,%rdi,4),%rbp
 32a:	00 
 ...
 340:	48 8d bc be a0 00 00 	lea    0xa0(%rsi,%rdi,4),%rdi
 347:	00 
 348:	48 8d b4 9e a0 00 00 	lea    0xa0(%rsi,%rbx,4),%rsi
 34f:	00 
 ...
 40b:	00 00 00 00 00 
 410:	c5 fc 10 24 9a       	vmovups (%rdx,%rbx,4),%ymm4
 415:	c4 e2 5d b8 94 9d 60 	vfmadd231ps -0xa0(%rbp,%rbx,4),%ymm4,%ymm2
 41c:	ff ff ff 
 41f:	c4 e2 5d b8 8c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm4,%ymm1
 426:	ff ff ff 
 429:	c4 e2 5d b8 84 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm4,%ymm0
 430:	ff ff ff 
 433:	c5 fc 10 6c 9a 20    	vmovups 0x20(%rdx,%rbx,4),%ymm5
 439:	c5 fc 10 74 9a 40    	vmovups 0x40(%rdx,%rbx,4),%ymm6
 43f:	c5 fc 10 7c 9a 60    	vmovups 0x60(%rdx,%rbx,4),%ymm7
 445:	c5 7c 10 84 9a 80 00 	vmovups 0x80(%rdx,%rbx,4),%ymm8
 44c:	00 00 
 44e:	c5 fc 10 9c 9a a0 00 	vmovups 0xa0(%rdx,%rbx,4),%ymm3
 455:	00 00 
 457:	c4 e2 55 b8 54 9d 80 	vfmadd231ps -0x80(%rbp,%rbx,4),%ymm5,%ymm2
 45e:	c4 e2 55 b8 4c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm5,%ymm1
 465:	c4 e2 55 b8 44 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm5,%ymm0
 46c:	c4 e2 4d b8 54 9d a0 	vfmadd231ps -0x60(%rbp,%rbx,4),%ymm6,%ymm2
 473:	c4 e2 4d b8 4c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm6,%ymm1
 47a:	c4 e2 4d b8 44 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm6,%ymm0
 481:	c4 e2 45 b8 54 9d c0 	vfmadd231ps -0x40(%rbp,%rbx,4),%ymm7,%ymm2
 488:	c4 e2 45 b8 4c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm7,%ymm1
 48f:	c4 e2 45 b8 44 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm7,%ymm0
 496:	c4 e2 3d b8 54 9d e0 	vfmadd231ps -0x20(%rbp,%rbx,4),%ymm8,%ymm2
 49d:	c4 e2 3d b8 4c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm8,%ymm1
 4a4:	c4 e2 3d b8 44 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm8,%ymm0
 4ab:	c4 e2 65 b8 54 9d 00 	vfmadd231ps 0x0(%rbp,%rbx,4),%ymm3,%ymm2
 4b2:	c4 e2 65 b8 0c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm3,%ymm1
 4b8:	c4 e2 65 b8 04 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm3,%ymm0
 4be:	48 83 c3 30          	add    $0x30,%rbx
 4c2:	48 39 cb             	cmp    %rcx,%rbx
 4c5:	0f 8c 45 ff ff ff    	jl     410 <.omp_outlined.+0x1e0>
 4cb:	e9 9c fe ff ff       	jmpq   36c <.omp_outlined.+0x13c>

00000000000004d0 <_Z6enablev>:
 4d0:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 4d7 <_Z6enablev+0x7>
 4d7:	7d 03                	jge    4dc <_Z6enablev+0xc>
 4d9:	31 c0                	xor    %eax,%eax
 4db:	c3                   	retq   
 4dc:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 4e3 <_Z6enablev+0x13>
 4e3:	b8 30 00 00 00       	mov    $0x30,%eax
 4e8:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 4ed:	0f 45 c8             	cmovne %eax,%ecx
 4f0:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4f6 <_Z6enablev+0x26>
 4f6:	0f 9e c0             	setle  %al
 4f9:	c3                   	retq   

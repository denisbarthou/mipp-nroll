...
0000000000000220 <.omp_outlined.>:
 ...
 34d:	48 8d ac 30 20 01 00 	lea    0x120(%rax,%rsi,1),%rbp
 354:	00 
 355:	48 81 c6 20 01 00 00 	add    $0x120,%rsi
 ...
 64b:	c4 22 0d b8 ac 8d e0 	vfmadd231ps -0x120(%rbp,%r9,4),%ymm14,%ymm13
 652:	fe ff ff 
 655:	c4 02 0d b8 a4 88 e0 	vfmadd231ps -0x120(%r8,%r9,4),%ymm14,%ymm12
 65c:	fe ff ff 
 65f:	4b 8d 84 17 e0 fe ff 	lea    -0x120(%r15,%r10,1),%rax
 666:	ff 
 667:	c4 42 0d b8 9c ca e0 	vfmadd231ps -0x120(%r10,%rcx,8),%ymm14,%ymm11
 66e:	fe ff ff 
 ...
 6e1:	c4 22 0d b8 ac 8d 00 	vfmadd231ps -0x100(%rbp,%r9,4),%ymm14,%ymm13
 6e8:	ff ff ff 
 6eb:	c4 02 0d b8 a4 88 00 	vfmadd231ps -0x100(%r8,%r9,4),%ymm14,%ymm12
 6f2:	ff ff ff 
 ...
 76f:	c4 22 0d b8 ac 8d 20 	vfmadd231ps -0xe0(%rbp,%r9,4),%ymm14,%ymm13
 776:	ff ff ff 
 779:	c4 02 0d b8 a4 88 20 	vfmadd231ps -0xe0(%r8,%r9,4),%ymm14,%ymm12
 780:	ff ff ff 
 ...
 7fd:	c4 22 0d b8 ac 8d 40 	vfmadd231ps -0xc0(%rbp,%r9,4),%ymm14,%ymm13
 804:	ff ff ff 
 807:	c4 02 0d b8 a4 88 40 	vfmadd231ps -0xc0(%r8,%r9,4),%ymm14,%ymm12
 80e:	ff ff ff 
 ...
 88b:	00 00 00 
 88e:	c4 22 0d b8 ac 8d 60 	vfmadd231ps -0xa0(%rbp,%r9,4),%ymm14,%ymm13
 895:	ff ff ff 
 898:	c4 02 0d b8 a4 88 60 	vfmadd231ps -0xa0(%r8,%r9,4),%ymm14,%ymm12
 89f:	ff ff ff 
 ...
 91c:	00 00 00 
 91f:	c4 22 0d b8 6c 8d 80 	vfmadd231ps -0x80(%rbp,%r9,4),%ymm14,%ymm13
 926:	c4 02 0d b8 64 88 80 	vfmadd231ps -0x80(%r8,%r9,4),%ymm14,%ymm12
 92d:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 933:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 937:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 93d:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 943:	48 01 f8             	add    %rdi,%rax
 946:	48 01 f8             	add    %rdi,%rax
 949:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 94f:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 955:	48 01 f8             	add    %rdi,%rax
 958:	48 01 f8             	add    %rdi,%rax
 95b:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 961:	48 01 f8             	add    %rdi,%rax
 964:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 96a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 96e:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 974:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 978:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 97e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 982:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 988:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 98c:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 992:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 996:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 99c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9a0:	c4 21 7c 10 b4 8a c0 	vmovups 0xc0(%rdx,%r9,4),%ymm14
 9a7:	00 00 00 
 9aa:	c4 22 0d b8 6c 8d a0 	vfmadd231ps -0x60(%rbp,%r9,4),%ymm14,%ymm13
 9b1:	c4 02 0d b8 64 88 a0 	vfmadd231ps -0x60(%r8,%r9,4),%ymm14,%ymm12
 9b8:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 9be:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 9c2:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 9c8:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 9ce:	48 01 f8             	add    %rdi,%rax
 9d1:	48 01 f8             	add    %rdi,%rax
 9d4:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 9da:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 9e0:	48 01 f8             	add    %rdi,%rax
 9e3:	48 01 f8             	add    %rdi,%rax
 9e6:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 9ec:	48 01 f8             	add    %rdi,%rax
 9ef:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 9f5:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 9f9:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 9ff:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a03:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 a09:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a0d:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 a13:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a17:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 a1d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a21:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 a27:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a2b:	c4 21 7c 10 b4 8a e0 	vmovups 0xe0(%rdx,%r9,4),%ymm14
 a32:	00 00 00 
 a35:	c4 22 0d b8 6c 8d c0 	vfmadd231ps -0x40(%rbp,%r9,4),%ymm14,%ymm13
 a3c:	c4 02 0d b8 64 88 c0 	vfmadd231ps -0x40(%r8,%r9,4),%ymm14,%ymm12
 a43:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 a49:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 a4d:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 a53:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 a59:	48 01 f8             	add    %rdi,%rax
 a5c:	48 01 f8             	add    %rdi,%rax
 a5f:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 a65:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 a6b:	48 01 f8             	add    %rdi,%rax
 a6e:	48 01 f8             	add    %rdi,%rax
 a71:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 a77:	48 01 f8             	add    %rdi,%rax
 a7a:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 a80:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a84:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 a8a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a8e:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 a94:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 a98:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 a9e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 aa2:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 aa8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 aac:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 ab2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ab6:	c4 21 7c 10 b4 8a 00 	vmovups 0x100(%rdx,%r9,4),%ymm14
 abd:	01 00 00 
 ac0:	c4 22 0d b8 6c 8d e0 	vfmadd231ps -0x20(%rbp,%r9,4),%ymm14,%ymm13
 ac7:	c4 02 0d b8 64 88 e0 	vfmadd231ps -0x20(%r8,%r9,4),%ymm14,%ymm12
 ace:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 ad4:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 ad8:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 ade:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 ae4:	48 01 f8             	add    %rdi,%rax
 ae7:	48 01 f8             	add    %rdi,%rax
 aea:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 af0:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 af6:	48 01 f8             	add    %rdi,%rax
 af9:	48 01 f8             	add    %rdi,%rax
 afc:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 b02:	48 01 f8             	add    %rdi,%rax
 b05:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 b0b:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b0f:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 b15:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b19:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 b1f:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b23:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 b29:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b2d:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 b33:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b37:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 b3d:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b41:	c4 21 7c 10 b4 8a 20 	vmovups 0x120(%rdx,%r9,4),%ymm14
 b48:	01 00 00 
 b4b:	c4 22 0d b8 6c 8d 00 	vfmadd231ps 0x0(%rbp,%r9,4),%ymm14,%ymm13
 b52:	c4 02 0d b8 24 88    	vfmadd231ps (%r8,%r9,4),%ymm14,%ymm12
 b58:	49 83 c1 50          	add    $0x50,%r9
 b5c:	c4 62 0d b8 1c 03    	vfmadd231ps (%rbx,%rax,1),%ymm14,%ymm11
 b62:	48 01 d8             	add    %rbx,%rax
 b65:	c4 62 0d b8 04 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm8
 b6b:	c4 62 0d b8 14 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm10
 b71:	48 01 f8             	add    %rdi,%rax
 b74:	48 01 f8             	add    %rdi,%rax
 b77:	c4 62 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm9
 b7d:	c4 e2 0d b8 34 c8    	vfmadd231ps (%rax,%rcx,8),%ymm14,%ymm6
 b83:	48 01 f8             	add    %rdi,%rax
 b86:	48 01 f8             	add    %rdi,%rax
 b89:	c4 e2 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm7
 b8f:	48 01 f8             	add    %rdi,%rax
 b92:	c4 e2 0d b8 2c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm5
 b98:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 b9c:	c4 e2 0d b8 24 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm4
 ba2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 ba6:	c4 e2 0d b8 1c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm3
 bac:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bb0:	c4 62 0d b8 3c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm15
 bb6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 bba:	c4 e2 0d b8 14 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm2
 bc0:	48 01 f8             	add    %rdi,%rax
 bc3:	c4 e2 0d b8 0c 88    	vfmadd231ps (%rax,%rcx,4),%ymm14,%ymm1
 bc9:	49 39 c9             	cmp    %rcx,%r9
 bcc:	0f 8c 6e fa ff ff    	jl     640 <.omp_outlined.+0x420>
 bd2:	e9 e8 f7 ff ff       	jmpq   3bf <.omp_outlined.+0x19f>
...
0000000000000bf0 <_Z9n_reg_maxv>:
 bf0:	b8 8c 00 00 00       	mov    $0x8c,%eax
 bf5:	c3                   	retq   

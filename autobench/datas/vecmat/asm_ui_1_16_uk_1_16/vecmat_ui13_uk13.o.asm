...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e 7f 09 00 00    	jle    b0a <_Z5benchv+0x9ba>
 ...
 1be:	00 
 1bf:	48 81 c2 80 01 00 00 	add    $0x180,%rdx
 ...
 3e5:	0f 83 1f 07 00 00    	jae    b0a <_Z5benchv+0x9ba>
 ...
 43a:	c4 62 0d b8 ac 9a 80 	vfmadd231ps -0x180(%rdx,%rbx,4),%ymm14,%ymm13
 441:	fe ff ff 
 444:	c4 62 0d b8 a4 b9 80 	vfmadd231ps -0x180(%rcx,%rdi,4),%ymm14,%ymm12
 44b:	fe ff ff 
 44e:	c4 62 0d b8 8c f9 80 	vfmadd231ps -0x180(%rcx,%rdi,8),%ymm14,%ymm9
 455:	fe ff ff 
 458:	48 8d 8c 08 80 fe ff 	lea    -0x180(%rax,%rcx,1),%rcx
 45f:	ff 
 ...
 4cb:	c4 62 0d b8 ac 9a a0 	vfmadd231ps -0x160(%rdx,%rbx,4),%ymm14,%ymm13
 4d2:	fe ff ff 
 ...
 54f:	c4 62 0d b8 ac 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm14,%ymm13
 556:	fe ff ff 
 ...
 5d3:	c4 62 0d b8 ac 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm14,%ymm13
 5da:	fe ff ff 
 ...
 657:	00 00 00 
 65a:	c4 62 0d b8 ac 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm14,%ymm13
 661:	ff ff ff 
 ...
 6de:	00 00 00 
 6e1:	c4 62 0d b8 ac 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm14,%ymm13
 6e8:	ff ff ff 
 ...
 765:	00 00 00 
 768:	c4 62 0d b8 ac 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm14,%ymm13
 76f:	ff ff ff 
 ...
 7ec:	00 00 00 
 7ef:	c4 62 0d b8 ac 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm14,%ymm13
 7f6:	ff ff ff 
 ...
 873:	01 00 00 
 876:	c4 62 0d b8 6c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm14,%ymm13
 87d:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 883:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 887:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 88d:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 893:	48 01 c1             	add    %rax,%rcx
 896:	48 01 c1             	add    %rax,%rcx
 899:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 89f:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 8a5:	48 01 c1             	add    %rax,%rcx
 8a8:	48 01 c1             	add    %rax,%rcx
 8ab:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 8b1:	48 01 c1             	add    %rax,%rcx
 8b4:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 8ba:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8be:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 8c4:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8c8:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 8ce:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8d2:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 8d8:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8dc:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 8e2:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8e6:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 8ec:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8f0:	c4 41 7c 10 b4 9e 20 	vmovups 0x120(%r14,%rbx,4),%ymm14
 8f7:	01 00 00 
 8fa:	c4 62 0d b8 6c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm14,%ymm13
 901:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 907:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 90b:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 911:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 917:	48 01 c1             	add    %rax,%rcx
 91a:	48 01 c1             	add    %rax,%rcx
 91d:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 923:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 929:	48 01 c1             	add    %rax,%rcx
 92c:	48 01 c1             	add    %rax,%rcx
 92f:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 935:	48 01 c1             	add    %rax,%rcx
 938:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 93e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 942:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 948:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 94c:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 952:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 956:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 95c:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 960:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 966:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 96a:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 970:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 974:	c4 41 7c 10 b4 9e 40 	vmovups 0x140(%r14,%rbx,4),%ymm14
 97b:	01 00 00 
 97e:	c4 62 0d b8 6c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm14,%ymm13
 985:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 98b:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 98f:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 995:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 99b:	48 01 c1             	add    %rax,%rcx
 99e:	48 01 c1             	add    %rax,%rcx
 9a1:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 9a7:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 9ad:	48 01 c1             	add    %rax,%rcx
 9b0:	48 01 c1             	add    %rax,%rcx
 9b3:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 9b9:	48 01 c1             	add    %rax,%rcx
 9bc:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 9c2:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9c6:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 9cc:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9d0:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 9d6:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9da:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 9e0:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9e4:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 9ea:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9ee:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 9f4:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9f8:	c4 41 7c 10 b4 9e 60 	vmovups 0x160(%r14,%rbx,4),%ymm14
 9ff:	01 00 00 
 a02:	c4 62 0d b8 6c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm14,%ymm13
 a09:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 a0f:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 a13:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 a19:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 a1f:	48 01 c1             	add    %rax,%rcx
 a22:	48 01 c1             	add    %rax,%rcx
 a25:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 a2b:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 a31:	48 01 c1             	add    %rax,%rcx
 a34:	48 01 c1             	add    %rax,%rcx
 a37:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 a3d:	48 01 c1             	add    %rax,%rcx
 a40:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 a46:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a4a:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 a50:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a54:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 a5a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a5e:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 a64:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a68:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 a6e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a72:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 a78:	48 01 c1             	add    %rax,%rcx
 a7b:	c4 41 7c 10 b4 9e 80 	vmovups 0x180(%r14,%rbx,4),%ymm14
 a82:	01 00 00 
 a85:	c4 62 0d b8 2c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm14,%ymm13
 a8b:	48 83 c3 68          	add    $0x68,%rbx
 a8f:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 a95:	48 01 f1             	add    %rsi,%rcx
 a98:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 a9e:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 aa4:	48 01 c1             	add    %rax,%rcx
 aa7:	48 01 c1             	add    %rax,%rcx
 aaa:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 ab0:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 ab6:	48 01 c1             	add    %rax,%rcx
 ab9:	48 01 c1             	add    %rax,%rcx
 abc:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 ac2:	48 01 c1             	add    %rax,%rcx
 ac5:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 acb:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 acf:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 ad5:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 ad9:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 adf:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 ae3:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 ae9:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 aed:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 af3:	48 01 c1             	add    %rax,%rcx
 af6:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 afc:	48 39 fb             	cmp    %rdi,%rbx
 aff:	0f 8c 2b f9 ff ff    	jl     430 <_Z5benchv+0x2e0>
 b05:	e9 00 f7 ff ff       	jmpq   20a <_Z5benchv+0xba>
 b0a:	0f 31                	rdtsc  
 b0c:	48 c1 e2 20          	shl    $0x20,%rdx
 b10:	48 09 c2             	or     %rax,%rdx
 b13:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b19 <_Z5benchv+0x9c9>
 b19:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 b1e:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # b26 <_Z5benchv+0x9d6>
 b25:	00 
 b26:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # b2e <_Z5benchv+0x9de>
 b2d:	00 
 b2e:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b35 <_Z5benchv+0x9e5>
 b35:	01 c0                	add    %eax,%eax
 b37:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b3d:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b41:	c4 c1 73 5c c7       	vsubsd %xmm15,%xmm1,%xmm0
 b46:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 b4a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 b4e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 b52:	5b                   	pop    %rbx
 b53:	41 5e                	pop    %r14
...
0000000000000b70 <_Z9n_reg_maxv>:
 b70:	b8 a9 00 00 00       	mov    $0xa9,%eax
 b75:	c3                   	retq   

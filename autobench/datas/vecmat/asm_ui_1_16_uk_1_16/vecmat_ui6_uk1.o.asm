...
0000000000000150 <_Z5benchv>:
 ...
 189:	0f 8e ab 01 00 00    	jle    33a <_Z5benchv+0x1ea>
 18f:	4c 8b 3d 00 00 00 00 	mov    0x0(%rip),%r15        # 196 <_Z5benchv+0x46>
 196:	4c 8b 25 00 00 00 00 	mov    0x0(%rip),%r12        # 19d <_Z5benchv+0x4d>
 ...
 1ab:	45 31 f6             	xor    %r14d,%r14d
 1ae:	48 8d 04 fd 00 00 00 	lea    0x0(,%rdi,8),%rax
 1b5:	00 
 1b6:	4c 8d 0c 40          	lea    (%rax,%rax,2),%r9
 1ba:	48 8d 04 bd 00 00 00 	lea    0x0(,%rdi,4),%rax
 1c1:	00 
 1c2:	e9 f8 00 00 00       	jmpq   2bf <_Z5benchv+0x16f>
 1c7:	90                   	nop
 1c8:	90                   	nop
 1c9:	90                   	nop
 1ca:	90                   	nop
 ...
 207:	c4 81 7a 11 34 b2    	vmovss %xmm6,(%r10,%r14,4)
 ...
 233:	c4 81 7a 11 2c 9a    	vmovss %xmm5,(%r10,%r11,4)
 ...
 2af:	c4 81 78 11 4c b2 08 	vmovups %xmm1,0x8(%r10,%r14,4)
 2b6:	49 83 c6 06          	add    $0x6,%r14
 2ba:	4d 39 c6             	cmp    %r8,%r14
 2bd:	73 7b                	jae    33a <_Z5benchv+0x1ea>
 2bf:	4d 89 f3             	mov    %r14,%r11
 2c2:	49 83 cb 01          	or     $0x1,%r11
 2c6:	85 ff                	test   %edi,%edi
 2c8:	0f 8e 02 ff ff ff    	jle    1d0 <_Z5benchv+0x80>
 2ce:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
 ...
 2e0:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 2e4:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 2e8:	90                   	nop
 2e9:	90                   	nop
 2ea:	90                   	nop
 2eb:	90                   	nop
 ...
 2ee:	90                   	nop
 2ef:	90                   	nop
 2f0:	49 8d 34 9c          	lea    (%r12,%rbx,4),%rsi
 2f4:	c4 c1 7c 10 3c 9f    	vmovups (%r15,%rbx,4),%ymm7
 2fa:	c4 c2 45 b8 34 9c    	vfmadd231ps (%r12,%rbx,4),%ymm7,%ymm6
 300:	48 83 c3 08          	add    $0x8,%rbx
 304:	48 8d 0c 06          	lea    (%rsi,%rax,1),%rcx
 308:	c4 e2 45 b8 2c be    	vfmadd231ps (%rsi,%rdi,4),%ymm7,%ymm5
 30e:	c4 e2 45 b8 24 fe    	vfmadd231ps (%rsi,%rdi,8),%ymm7,%ymm4
 314:	48 01 c1             	add    %rax,%rcx
 317:	48 8d 14 01          	lea    (%rcx,%rax,1),%rdx
 31b:	c4 e2 45 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm7,%ymm1
 321:	c4 e2 45 b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm7,%ymm3
 327:	48 01 c2             	add    %rax,%rdx
 32a:	c4 e2 45 b8 14 ba    	vfmadd231ps (%rdx,%rdi,4),%ymm7,%ymm2
 330:	48 39 fb             	cmp    %rdi,%rbx
 333:	7c bb                	jl     2f0 <_Z5benchv+0x1a0>
 335:	e9 ae fe ff ff       	jmpq   1e8 <_Z5benchv+0x98>
 33a:	0f 31                	rdtsc  
 33c:	48 c1 e2 20          	shl    $0x20,%rdx
 340:	48 09 c2             	or     %rax,%rdx
 343:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 349 <_Z5benchv+0x1f9>
 349:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 34e:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 356 <_Z5benchv+0x206>
 355:	00 
 356:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 35e <_Z5benchv+0x20e>
 35d:	00 
 35e:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 365 <_Z5benchv+0x215>
 365:	01 c0                	add    %eax,%eax
 367:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 36d:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 371:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 375:	c5 ba 2a c8          	vcvtsi2ss %eax,%xmm8,%xmm1
 379:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 37d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 381:	5b                   	pop    %rbx
 382:	41 5c                	pop    %r12
 384:	41 5e                	pop    %r14
 386:	41 5f                	pop    %r15
 388:	c5 f8 77             	vzeroupper 
 38b:	c3                   	retq   
 38c:	90                   	nop
 38d:	90                   	nop
 38e:	90                   	nop
...
0000000000000390 <_Z6enablev>:
 390:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 397 <_Z6enablev+0x7>
 397:	7d 03                	jge    39c <_Z6enablev+0xc>
 399:	31 c0                	xor    %eax,%eax
 39b:	c3                   	retq   
 39c:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 3a3 <_Z6enablev+0x13>
 3a3:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 3a7:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 3ad <_Z6enablev+0x1d>
 3ad:	0f 9e c0             	setle  %al
 3b0:	c3                   	retq   
 3b1:	90                   	nop
 3b2:	90                   	nop
 3b3:	90                   	nop

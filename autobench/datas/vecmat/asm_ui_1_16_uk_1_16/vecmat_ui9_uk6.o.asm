...
0000000000000150 <_Z5benchv>:
 ...
 18b:	0f 8e 3a 04 00 00    	jle    5cb <_Z5benchv+0x47b>
 ...
 1cc:	48 81 c2 a0 00 00 00 	add    $0xa0,%rdx
 ...
 354:	0f 83 71 02 00 00    	jae    5cb <_Z5benchv+0x47b>
 ...
 3a8:	c4 41 7c 10 6c 9e 60 	vmovups 0x60(%r14,%rbx,4),%ymm13
 3af:	c4 62 2d b8 8c 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm10,%ymm9
 3b6:	ff ff ff 
 3b9:	c4 41 7c 10 b4 9e 80 	vmovups 0x80(%r14,%rbx,4),%ymm14
 3c0:	00 00 00 
 3c3:	c4 41 7c 10 bc 9e a0 	vmovups 0xa0(%r14,%rbx,4),%ymm15
 3ca:	00 00 00 
 3cd:	c4 62 2d b8 84 b9 60 	vfmadd231ps -0xa0(%rcx,%rdi,4),%ymm10,%ymm8
 3d4:	ff ff ff 
 3d7:	c4 e2 2d b8 ac f9 60 	vfmadd231ps -0xa0(%rcx,%rdi,8),%ymm10,%ymm5
 3de:	ff ff ff 
 3e1:	48 8d 8c 08 60 ff ff 	lea    -0xa0(%rax,%rcx,1),%rcx
 3e8:	ff 
 3e9:	48 01 c1             	add    %rax,%rcx
 3ec:	c4 e2 2d b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm7
 3f2:	c4 e2 2d b8 34 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm10,%ymm6
 3f8:	48 01 c1             	add    %rax,%rcx
 3fb:	48 01 c1             	add    %rax,%rcx
 3fe:	c4 62 25 b8 4c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm11,%ymm9
 405:	c4 e2 2d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm3
 40b:	48 01 c1             	add    %rax,%rcx
 40e:	c4 e2 2d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm4
 414:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 418:	c4 e2 2d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm2
 41e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 422:	c4 e2 2d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm1
 428:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 42c:	c4 62 1d b8 4c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm12,%ymm9
 433:	c4 62 25 b8 04 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm11,%ymm8
 439:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 43d:	c4 e2 25 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm5
 443:	c4 e2 25 b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm11,%ymm7
 449:	48 01 c1             	add    %rax,%rcx
 44c:	48 01 c1             	add    %rax,%rcx
 44f:	c4 e2 25 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm6
 455:	c4 e2 25 b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm11,%ymm3
 45b:	48 01 c1             	add    %rax,%rcx
 45e:	c4 62 15 b8 4c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm13,%ymm9
 465:	48 01 c1             	add    %rax,%rcx
 468:	c4 e2 25 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm4
 46e:	48 01 c1             	add    %rax,%rcx
 471:	c4 e2 25 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm2
 477:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 47b:	c4 e2 25 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm1
 481:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 485:	c4 62 0d b8 4c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm14,%ymm9
 48c:	c4 62 1d b8 04 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm12,%ymm8
 492:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 496:	c4 e2 1d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm5
 49c:	c4 e2 1d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm12,%ymm7
 4a2:	48 01 c1             	add    %rax,%rcx
 4a5:	48 01 c1             	add    %rax,%rcx
 4a8:	c4 e2 1d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm6
 4ae:	c4 e2 1d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm12,%ymm3
 4b4:	48 01 c1             	add    %rax,%rcx
 4b7:	c4 62 05 b8 0c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm15,%ymm9
 4bd:	48 83 c3 30          	add    $0x30,%rbx
 4c1:	48 01 c1             	add    %rax,%rcx
 4c4:	c4 e2 1d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm4
 4ca:	48 01 c1             	add    %rax,%rcx
 4cd:	c4 e2 1d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm2
 4d3:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 4d7:	c4 e2 1d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm1
 4dd:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 4e1:	c4 62 15 b8 04 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm8
 4e7:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 4eb:	c4 e2 15 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm5
 4f1:	c4 e2 15 b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm7
 4f7:	48 01 c1             	add    %rax,%rcx
 4fa:	48 01 c1             	add    %rax,%rcx
 4fd:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 503:	c4 e2 15 b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm3
 509:	48 01 c1             	add    %rax,%rcx
 50c:	48 01 c1             	add    %rax,%rcx
 50f:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 515:	48 01 c1             	add    %rax,%rcx
 518:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 51e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 522:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 528:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 52c:	c4 62 0d b8 04 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm8
 532:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 536:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 53c:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 542:	48 01 c1             	add    %rax,%rcx
 545:	48 01 c1             	add    %rax,%rcx
 548:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 54e:	c4 e2 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm3
 554:	48 01 c1             	add    %rax,%rcx
 557:	48 01 c1             	add    %rax,%rcx
 55a:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 560:	48 01 c1             	add    %rax,%rcx
 563:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 569:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 56d:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 573:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 577:	c4 62 05 b8 04 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm8
 57d:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 581:	c4 e2 05 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm5
 587:	c4 e2 05 b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm7
 58d:	48 01 c1             	add    %rax,%rcx
 590:	48 01 c1             	add    %rax,%rcx
 593:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 599:	c4 e2 05 b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm3
 59f:	48 01 c1             	add    %rax,%rcx
 5a2:	48 01 c1             	add    %rax,%rcx
 5a5:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 5ab:	48 01 c1             	add    %rax,%rcx
 5ae:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 5b4:	48 01 c1             	add    %rax,%rcx
 5b7:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 5bd:	48 39 fb             	cmp    %rdi,%rbx
 5c0:	0f 8c ca fd ff ff    	jl     390 <_Z5benchv+0x240>
 5c6:	e9 3b fc ff ff       	jmpq   206 <_Z5benchv+0xb6>
 5cb:	0f 31                	rdtsc  
 5cd:	48 c1 e2 20          	shl    $0x20,%rdx
 5d1:	48 09 c2             	or     %rax,%rdx
 5d4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 5da <_Z5benchv+0x48a>
 5da:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 5df:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 5e7 <_Z5benchv+0x497>
 5e6:	00 
 5e7:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 5ef <_Z5benchv+0x49f>
 5ee:	00 
 5ef:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 5f6 <_Z5benchv+0x4a6>
 5f6:	01 c0                	add    %eax,%eax
 5f8:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 5fe:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 602:	c5 f3 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm1,%xmm0
 608:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
...
0000000000000630 <_Z9n_reg_maxv>:
 630:	b8 36 00 00 00       	mov    $0x36,%eax
 635:	c3                   	retq   

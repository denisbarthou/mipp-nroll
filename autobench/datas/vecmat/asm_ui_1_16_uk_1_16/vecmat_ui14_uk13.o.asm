...
0000000000000150 <_Z5benchv>:
 ...
 18d:	0f 8e 49 0a 00 00    	jle    bdc <_Z5benchv+0xa8c>
 ...
 1ce:	48 81 c2 80 01 00 00 	add    $0x180,%rdx
 ...
 41d:	0f 83 b9 07 00 00    	jae    bdc <_Z5benchv+0xa8c>
 ...
 48a:	c4 62 05 b8 b4 9a 80 	vfmadd231ps -0x180(%rdx,%rbx,4),%ymm15,%ymm14
 491:	fe ff ff 
 494:	c4 62 05 b8 ac b9 80 	vfmadd231ps -0x180(%rcx,%rdi,4),%ymm15,%ymm13
 49b:	fe ff ff 
 49e:	c4 62 05 b8 a4 f9 80 	vfmadd231ps -0x180(%rcx,%rdi,8),%ymm15,%ymm12
 4a5:	fe ff ff 
 4a8:	48 8d 8c 08 80 fe ff 	lea    -0x180(%rax,%rcx,1),%rcx
 4af:	ff 
 ...
 525:	c4 62 05 b8 b4 9a a0 	vfmadd231ps -0x160(%rdx,%rbx,4),%ymm15,%ymm14
 52c:	fe ff ff 
 ...
 5b3:	c4 62 05 b8 b4 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm15,%ymm14
 5ba:	fe ff ff 
 ...
 641:	c4 62 05 b8 b4 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm15,%ymm14
 648:	fe ff ff 
 ...
 6cf:	00 00 00 
 6d2:	c4 62 05 b8 b4 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm15,%ymm14
 6d9:	ff ff ff 
 ...
 760:	00 00 00 
 763:	c4 62 05 b8 b4 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm15,%ymm14
 76a:	ff ff ff 
 ...
 7f1:	00 00 00 
 7f4:	c4 62 05 b8 b4 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm15,%ymm14
 7fb:	ff ff ff 
 ...
 882:	00 00 00 
 885:	c4 62 05 b8 b4 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm15,%ymm14
 88c:	ff ff ff 
 88f:	c4 62 05 b8 2c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm13
 895:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 899:	c4 62 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm12
 89f:	c4 62 05 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm9
 8a5:	48 01 c1             	add    %rax,%rcx
 8a8:	48 01 c1             	add    %rax,%rcx
 8ab:	c4 62 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm11
 8b1:	c4 62 05 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm10
 8b7:	48 01 c1             	add    %rax,%rcx
 8ba:	48 01 c1             	add    %rax,%rcx
 8bd:	c4 e2 05 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm7
 8c3:	48 01 c1             	add    %rax,%rcx
 8c6:	c4 62 05 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm8
 8cc:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8d0:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 8d6:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8da:	c4 e2 05 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm5
 8e0:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8e4:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 8ea:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8ee:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 8f4:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8f8:	c4 e2 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm3
 8fe:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 902:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 908:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 90c:	c4 41 7c 10 bc 9f 00 	vmovups 0x100(%r15,%rbx,4),%ymm15
 913:	01 00 00 
 916:	c4 62 05 b8 74 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm15,%ymm14
 91d:	c4 62 05 b8 2c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm13
 923:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 927:	c4 62 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm12
 92d:	c4 62 05 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm9
 933:	48 01 c1             	add    %rax,%rcx
 936:	48 01 c1             	add    %rax,%rcx
 939:	c4 62 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm11
 93f:	c4 62 05 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm10
 945:	48 01 c1             	add    %rax,%rcx
 948:	48 01 c1             	add    %rax,%rcx
 94b:	c4 e2 05 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm7
 951:	48 01 c1             	add    %rax,%rcx
 954:	c4 62 05 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm8
 95a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 95e:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 964:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 968:	c4 e2 05 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm5
 96e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 972:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 978:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 97c:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 982:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 986:	c4 e2 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm3
 98c:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 990:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 996:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 99a:	c4 41 7c 10 bc 9f 20 	vmovups 0x120(%r15,%rbx,4),%ymm15
 9a1:	01 00 00 
 9a4:	c4 62 05 b8 74 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm15,%ymm14
 9ab:	c4 62 05 b8 2c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm13
 9b1:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 9b5:	c4 62 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm12
 9bb:	c4 62 05 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm9
 9c1:	48 01 c1             	add    %rax,%rcx
 9c4:	48 01 c1             	add    %rax,%rcx
 9c7:	c4 62 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm11
 9cd:	c4 62 05 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm10
 9d3:	48 01 c1             	add    %rax,%rcx
 9d6:	48 01 c1             	add    %rax,%rcx
 9d9:	c4 e2 05 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm7
 9df:	48 01 c1             	add    %rax,%rcx
 9e2:	c4 62 05 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm8
 9e8:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9ec:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 9f2:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9f6:	c4 e2 05 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm5
 9fc:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a00:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 a06:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a0a:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 a10:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a14:	c4 e2 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm3
 a1a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a1e:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 a24:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a28:	c4 41 7c 10 bc 9f 40 	vmovups 0x140(%r15,%rbx,4),%ymm15
 a2f:	01 00 00 
 a32:	c4 62 05 b8 74 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm15,%ymm14
 a39:	c4 62 05 b8 2c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm13
 a3f:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 a43:	c4 62 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm12
 a49:	c4 62 05 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm9
 a4f:	48 01 c1             	add    %rax,%rcx
 a52:	48 01 c1             	add    %rax,%rcx
 a55:	c4 62 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm11
 a5b:	c4 62 05 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm10
 a61:	48 01 c1             	add    %rax,%rcx
 a64:	48 01 c1             	add    %rax,%rcx
 a67:	c4 e2 05 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm7
 a6d:	48 01 c1             	add    %rax,%rcx
 a70:	c4 62 05 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm8
 a76:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a7a:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 a80:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a84:	c4 e2 05 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm5
 a8a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a8e:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 a94:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a98:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 a9e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 aa2:	c4 e2 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm3
 aa8:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 aac:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 ab2:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 ab6:	c4 41 7c 10 bc 9f 60 	vmovups 0x160(%r15,%rbx,4),%ymm15
 abd:	01 00 00 
 ac0:	c4 62 05 b8 74 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm15,%ymm14
 ac7:	c4 62 05 b8 2c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm13
 acd:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 ad1:	c4 62 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm12
 ad7:	c4 62 05 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm9
 add:	48 01 c1             	add    %rax,%rcx
 ae0:	48 01 c1             	add    %rax,%rcx
 ae3:	c4 62 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm11
 ae9:	c4 62 05 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm10
 aef:	48 01 c1             	add    %rax,%rcx
 af2:	48 01 c1             	add    %rax,%rcx
 af5:	c4 e2 05 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm7
 afb:	48 01 c1             	add    %rax,%rcx
 afe:	c4 62 05 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm8
 b04:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 b08:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 b0e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 b12:	c4 e2 05 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm5
 b18:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 b1c:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 b22:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 b26:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 b2c:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 b30:	c4 e2 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm3
 b36:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 b3a:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 b40:	48 01 c1             	add    %rax,%rcx
 b43:	c4 41 7c 10 bc 9f 80 	vmovups 0x180(%r15,%rbx,4),%ymm15
 b4a:	01 00 00 
 b4d:	c4 62 05 b8 34 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm15,%ymm14
 b53:	48 83 c3 68          	add    $0x68,%rbx
 b57:	c4 62 05 b8 2c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm13
 b5d:	48 01 f1             	add    %rsi,%rcx
 b60:	c4 62 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm12
 b66:	c4 62 05 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm9
 b6c:	48 01 c1             	add    %rax,%rcx
 b6f:	48 01 c1             	add    %rax,%rcx
 b72:	c4 62 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm11
 b78:	c4 62 05 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm10
 b7e:	48 01 c1             	add    %rax,%rcx
 b81:	48 01 c1             	add    %rax,%rcx
 b84:	c4 e2 05 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm7
 b8a:	48 01 c1             	add    %rax,%rcx
 b8d:	c4 62 05 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm8
 b93:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 b97:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 b9d:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 ba1:	c4 e2 05 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm5
 ba7:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 bab:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 bb1:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 bb5:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 bbb:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 bbf:	c4 e2 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm3
 bc5:	48 01 c1             	add    %rax,%rcx
 bc8:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 bce:	48 39 fb             	cmp    %rdi,%rbx
 bd1:	0f 8c a9 f8 ff ff    	jl     480 <_Z5benchv+0x330>
 bd7:	e9 43 f6 ff ff       	jmpq   21f <_Z5benchv+0xcf>
 bdc:	0f 31                	rdtsc  
 bde:	48 c1 e2 20          	shl    $0x20,%rdx
 be2:	48 09 c2             	or     %rax,%rdx
 be5:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # beb <_Z5benchv+0xa9b>
 beb:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 bf0:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # bf8 <_Z5benchv+0xaa8>
 bf7:	00 
 bf8:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # c00 <_Z5benchv+0xab0>
 bff:	00 
 c00:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # c07 <_Z5benchv+0xab7>
 c07:	01 c0                	add    %eax,%eax
 c09:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 c0f:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 c13:	c5 f3 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm1,%xmm0
 c19:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 c1d:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 c21:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 c25:	5b                   	pop    %rbx
 c26:	41 5e                	pop    %r14
 c28:	41 5f                	pop    %r15
...
0000000000000c40 <_Z9n_reg_maxv>:
 c40:	b8 b6 00 00 00       	mov    $0xb6,%eax
 c45:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
 ...
 18b:	0f 8e 85 09 00 00    	jle    b16 <_Z5benchv+0x9c6>
 ...
 1d7:	48 81 c2 a0 01 00 00 	add    $0x1a0,%rdx
 ...
 3dc:	0f 83 34 07 00 00    	jae    b16 <_Z5benchv+0x9c6>
 ...
 44b:	c4 62 15 b8 a4 9a 60 	vfmadd231ps -0x1a0(%rdx,%rbx,4),%ymm13,%ymm12
 452:	fe ff ff 
 455:	c4 62 15 b8 9c b9 60 	vfmadd231ps -0x1a0(%rcx,%rdi,4),%ymm13,%ymm11
 45c:	fe ff ff 
 45f:	c4 62 15 b8 94 f9 60 	vfmadd231ps -0x1a0(%rcx,%rdi,8),%ymm13,%ymm10
 466:	fe ff ff 
 469:	48 8d 8c 08 60 fe ff 	lea    -0x1a0(%rax,%rcx,1),%rcx
 470:	ff 
 ...
 4d2:	c4 62 15 b8 a4 9a 80 	vfmadd231ps -0x180(%rdx,%rbx,4),%ymm13,%ymm12
 4d9:	fe ff ff 
 ...
 54c:	c4 62 15 b8 a4 9a a0 	vfmadd231ps -0x160(%rdx,%rbx,4),%ymm13,%ymm12
 553:	fe ff ff 
 ...
 5c6:	c4 62 15 b8 a4 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm13,%ymm12
 5cd:	fe ff ff 
 ...
 640:	00 00 00 
 643:	c4 62 15 b8 a4 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm13,%ymm12
 64a:	fe ff ff 
 ...
 6bd:	00 00 00 
 6c0:	c4 62 15 b8 a4 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm13,%ymm12
 6c7:	ff ff ff 
 ...
 73a:	00 00 00 
 73d:	c4 62 15 b8 a4 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm13,%ymm12
 744:	ff ff ff 
 ...
 7b7:	00 00 00 
 7ba:	c4 62 15 b8 a4 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm13,%ymm12
 7c1:	ff ff ff 
 ...
 834:	01 00 00 
 837:	c4 62 15 b8 a4 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm13,%ymm12
 83e:	ff ff ff 
 841:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 847:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 84b:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 851:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 857:	48 01 c1             	add    %rax,%rcx
 85a:	48 01 c1             	add    %rax,%rcx
 85d:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 863:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 869:	48 01 c1             	add    %rax,%rcx
 86c:	48 01 c1             	add    %rax,%rcx
 86f:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 875:	48 01 c1             	add    %rax,%rcx
 878:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 87e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 882:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 888:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 88c:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 892:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 896:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 89c:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8a0:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 8a6:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8aa:	c4 41 7c 10 ac 9d 20 	vmovups 0x120(%r13,%rbx,4),%ymm13
 8b1:	01 00 00 
 8b4:	c4 62 15 b8 64 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm13,%ymm12
 8bb:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 8c1:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 8c5:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 8cb:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 8d1:	48 01 c1             	add    %rax,%rcx
 8d4:	48 01 c1             	add    %rax,%rcx
 8d7:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 8dd:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 8e3:	48 01 c1             	add    %rax,%rcx
 8e6:	48 01 c1             	add    %rax,%rcx
 8e9:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 8ef:	48 01 c1             	add    %rax,%rcx
 8f2:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 8f8:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8fc:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 902:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 906:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 90c:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 910:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 916:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 91a:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 920:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 924:	c4 41 7c 10 ac 9d 40 	vmovups 0x140(%r13,%rbx,4),%ymm13
 92b:	01 00 00 
 92e:	c4 62 15 b8 64 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm13,%ymm12
 935:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 93b:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 93f:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 945:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 94b:	48 01 c1             	add    %rax,%rcx
 94e:	48 01 c1             	add    %rax,%rcx
 951:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 957:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 95d:	48 01 c1             	add    %rax,%rcx
 960:	48 01 c1             	add    %rax,%rcx
 963:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 969:	48 01 c1             	add    %rax,%rcx
 96c:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 972:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 976:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 97c:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 980:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 986:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 98a:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 990:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 994:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 99a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 99e:	c4 41 7c 10 ac 9d 60 	vmovups 0x160(%r13,%rbx,4),%ymm13
 9a5:	01 00 00 
 9a8:	c4 62 15 b8 64 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm13,%ymm12
 9af:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 9b5:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 9b9:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 9bf:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 9c5:	48 01 c1             	add    %rax,%rcx
 9c8:	48 01 c1             	add    %rax,%rcx
 9cb:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 9d1:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 9d7:	48 01 c1             	add    %rax,%rcx
 9da:	48 01 c1             	add    %rax,%rcx
 9dd:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 9e3:	48 01 c1             	add    %rax,%rcx
 9e6:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 9ec:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9f0:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 9f6:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9fa:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 a00:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a04:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 a0a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a0e:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 a14:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a18:	c4 41 7c 10 ac 9d 80 	vmovups 0x180(%r13,%rbx,4),%ymm13
 a1f:	01 00 00 
 a22:	c4 62 15 b8 64 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm13,%ymm12
 a29:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 a2f:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 a33:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 a39:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 a3f:	48 01 c1             	add    %rax,%rcx
 a42:	48 01 c1             	add    %rax,%rcx
 a45:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 a4b:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 a51:	48 01 c1             	add    %rax,%rcx
 a54:	48 01 c1             	add    %rax,%rcx
 a57:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 a5d:	48 01 c1             	add    %rax,%rcx
 a60:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 a66:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a6a:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 a70:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a74:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 a7a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a7e:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 a84:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a88:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 a8e:	48 01 c1             	add    %rax,%rcx
 a91:	c4 41 7c 10 ac 9d a0 	vmovups 0x1a0(%r13,%rbx,4),%ymm13
 a98:	01 00 00 
 a9b:	c4 62 15 b8 24 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm13,%ymm12
 aa1:	48 83 c3 70          	add    $0x70,%rbx
 aa5:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 aab:	48 01 f1             	add    %rsi,%rcx
 aae:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 ab4:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 aba:	48 01 c1             	add    %rax,%rcx
 abd:	48 01 c1             	add    %rax,%rcx
 ac0:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 ac6:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 acc:	48 01 c1             	add    %rax,%rcx
 acf:	48 01 c1             	add    %rax,%rcx
 ad2:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 ad8:	48 01 c1             	add    %rax,%rcx
 adb:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 ae1:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 ae5:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 aeb:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 aef:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 af5:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 af9:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 aff:	48 01 c1             	add    %rax,%rcx
 b02:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 b08:	48 39 fb             	cmp    %rdi,%rbx
 b0b:	0f 8c 2f f9 ff ff    	jl     440 <_Z5benchv+0x2f0>
 b11:	e9 0f f7 ff ff       	jmpq   225 <_Z5benchv+0xd5>
 b16:	0f 31                	rdtsc  
 b18:	48 c1 e2 20          	shl    $0x20,%rdx
 b1c:	48 09 c2             	or     %rax,%rdx
 b1f:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b25 <_Z5benchv+0x9d5>
 b25:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 b2a:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # b32 <_Z5benchv+0x9e2>
 b31:	00 
 b32:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # b3a <_Z5benchv+0x9ea>
 b39:	00 
 b3a:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b41 <_Z5benchv+0x9f1>
 b41:	01 c0                	add    %eax,%eax
 b43:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b49:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b4d:	c4 c1 73 5c c6       	vsubsd %xmm14,%xmm1,%xmm0
 b52:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
 b56:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
...
0000000000000b80 <_Z9n_reg_maxv>:
 b80:	b8 a8 00 00 00       	mov    $0xa8,%eax
 b85:	c3                   	retq   

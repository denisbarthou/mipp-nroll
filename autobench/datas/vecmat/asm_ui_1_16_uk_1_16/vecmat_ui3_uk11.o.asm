...
0000000000000150 <_Z5benchv>:
 ...
 183:	0f 8e 69 02 00 00    	jle    3f2 <_Z5benchv+0x2a2>
 ...
 1b4:	48 8d 84 fa 40 01 00 	lea    0x140(%rdx,%rdi,8),%rax
 1bb:	00 
 1bc:	48 8d b4 ba 40 01 00 	lea    0x140(%rdx,%rdi,4),%rsi
 1c3:	00 
 1c4:	48 81 c2 40 01 00 00 	add    $0x140,%rdx
 ...
 254:	0f 83 98 01 00 00    	jae    3f2 <_Z5benchv+0x2a2>
 ...
 270:	c5 7c 10 1c 99       	vmovups (%rcx,%rbx,4),%ymm11
 275:	c4 e2 25 b8 9c 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm11,%ymm3
 27c:	fe ff ff 
 27f:	c4 e2 25 b8 94 9e c0 	vfmadd231ps -0x140(%rsi,%rbx,4),%ymm11,%ymm2
 286:	fe ff ff 
 289:	c4 e2 25 b8 8c 98 c0 	vfmadd231ps -0x140(%rax,%rbx,4),%ymm11,%ymm1
 290:	fe ff ff 
 293:	c5 7c 10 64 99 20    	vmovups 0x20(%rcx,%rbx,4),%ymm12
 299:	c5 7c 10 6c 99 40    	vmovups 0x40(%rcx,%rbx,4),%ymm13
 29f:	c5 7c 10 74 99 60    	vmovups 0x60(%rcx,%rbx,4),%ymm14
 2a5:	c5 7c 10 94 99 80 00 	vmovups 0x80(%rcx,%rbx,4),%ymm10
 2ac:	00 00 
 2ae:	c5 7c 10 8c 99 a0 00 	vmovups 0xa0(%rcx,%rbx,4),%ymm9
 2b5:	00 00 
 2b7:	c5 7c 10 84 99 c0 00 	vmovups 0xc0(%rcx,%rbx,4),%ymm8
 2be:	00 00 
 2c0:	c5 fc 10 bc 99 e0 00 	vmovups 0xe0(%rcx,%rbx,4),%ymm7
 2c7:	00 00 
 2c9:	c5 fc 10 b4 99 00 01 	vmovups 0x100(%rcx,%rbx,4),%ymm6
 2d0:	00 00 
 2d2:	c5 fc 10 ac 99 20 01 	vmovups 0x120(%rcx,%rbx,4),%ymm5
 2d9:	00 00 
 2db:	c5 fc 10 a4 99 40 01 	vmovups 0x140(%rcx,%rbx,4),%ymm4
 2e2:	00 00 
 2e4:	c4 e2 1d b8 9c 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm12,%ymm3
 2eb:	fe ff ff 
 2ee:	c4 e2 1d b8 94 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm12,%ymm2
 2f5:	fe ff ff 
 2f8:	c4 e2 1d b8 8c 98 e0 	vfmadd231ps -0x120(%rax,%rbx,4),%ymm12,%ymm1
 2ff:	fe ff ff 
 302:	c4 e2 15 b8 9c 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm13,%ymm3
 309:	ff ff ff 
 30c:	c4 e2 15 b8 94 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm13,%ymm2
 313:	ff ff ff 
 316:	c4 e2 15 b8 8c 98 00 	vfmadd231ps -0x100(%rax,%rbx,4),%ymm13,%ymm1
 31d:	ff ff ff 
 320:	c4 e2 0d b8 9c 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm14,%ymm3
 327:	ff ff ff 
 32a:	c4 e2 0d b8 94 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm14,%ymm2
 331:	ff ff ff 
 334:	c4 e2 0d b8 8c 98 20 	vfmadd231ps -0xe0(%rax,%rbx,4),%ymm14,%ymm1
 33b:	ff ff ff 
 33e:	c4 e2 2d b8 9c 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm10,%ymm3
 345:	ff ff ff 
 348:	c4 e2 2d b8 94 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm10,%ymm2
 34f:	ff ff ff 
 352:	c4 e2 2d b8 8c 98 40 	vfmadd231ps -0xc0(%rax,%rbx,4),%ymm10,%ymm1
 359:	ff ff ff 
 35c:	c4 e2 35 b8 9c 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm9,%ymm3
 363:	ff ff ff 
 366:	c4 e2 35 b8 94 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm9,%ymm2
 36d:	ff ff ff 
 370:	c4 e2 35 b8 8c 98 60 	vfmadd231ps -0xa0(%rax,%rbx,4),%ymm9,%ymm1
 377:	ff ff ff 
 37a:	c4 e2 3d b8 5c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm8,%ymm3
 381:	c4 e2 3d b8 54 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm8,%ymm2
 388:	c4 e2 3d b8 4c 98 80 	vfmadd231ps -0x80(%rax,%rbx,4),%ymm8,%ymm1
 38f:	c4 e2 45 b8 5c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm7,%ymm3
 396:	c4 e2 45 b8 54 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm7,%ymm2
 39d:	c4 e2 45 b8 4c 98 a0 	vfmadd231ps -0x60(%rax,%rbx,4),%ymm7,%ymm1
 3a4:	c4 e2 4d b8 5c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm6,%ymm3
 3ab:	c4 e2 4d b8 54 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm6,%ymm2
 3b2:	c4 e2 4d b8 4c 98 c0 	vfmadd231ps -0x40(%rax,%rbx,4),%ymm6,%ymm1
 3b9:	c4 e2 55 b8 5c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm5,%ymm3
 3c0:	c4 e2 55 b8 54 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm5,%ymm2
 3c7:	c4 e2 55 b8 4c 98 e0 	vfmadd231ps -0x20(%rax,%rbx,4),%ymm5,%ymm1
 3ce:	c4 e2 5d b8 1c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm4,%ymm3
 3d4:	c4 e2 5d b8 14 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm4,%ymm2
 3da:	c4 e2 5d b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm4,%ymm1
 3e0:	48 83 c3 58          	add    $0x58,%rbx
 3e4:	48 39 fb             	cmp    %rdi,%rbx
 3e7:	0f 8c 83 fe ff ff    	jl     270 <_Z5benchv+0x120>
 3ed:	e9 ea fd ff ff       	jmpq   1dc <_Z5benchv+0x8c>
 3f2:	0f 31                	rdtsc  

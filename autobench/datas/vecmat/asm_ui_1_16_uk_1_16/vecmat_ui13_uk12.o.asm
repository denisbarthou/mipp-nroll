...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e f8 08 00 00    	jle    a83 <_Z5benchv+0x933>
 ...
 1be:	00 
 1bf:	48 81 c2 60 01 00 00 	add    $0x160,%rdx
 ...
 3e5:	0f 83 98 06 00 00    	jae    a83 <_Z5benchv+0x933>
 ...
 43a:	c4 62 0d b8 ac 9a a0 	vfmadd231ps -0x160(%rdx,%rbx,4),%ymm14,%ymm13
 441:	fe ff ff 
 444:	c4 62 0d b8 a4 b9 a0 	vfmadd231ps -0x160(%rcx,%rdi,4),%ymm14,%ymm12
 44b:	fe ff ff 
 44e:	c4 62 0d b8 8c f9 a0 	vfmadd231ps -0x160(%rcx,%rdi,8),%ymm14,%ymm9
 455:	fe ff ff 
 458:	48 8d 8c 08 a0 fe ff 	lea    -0x160(%rax,%rcx,1),%rcx
 45f:	ff 
 ...
 4cb:	c4 62 0d b8 ac 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm14,%ymm13
 4d2:	fe ff ff 
 ...
 54f:	c4 62 0d b8 ac 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm14,%ymm13
 556:	fe ff ff 
 ...
 5d3:	c4 62 0d b8 ac 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm14,%ymm13
 5da:	ff ff ff 
 ...
 657:	00 00 00 
 65a:	c4 62 0d b8 ac 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm14,%ymm13
 661:	ff ff ff 
 ...
 6de:	00 00 00 
 6e1:	c4 62 0d b8 ac 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm14,%ymm13
 6e8:	ff ff ff 
 ...
 765:	00 00 00 
 768:	c4 62 0d b8 ac 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm14,%ymm13
 76f:	ff ff ff 
 ...
 7ec:	00 00 00 
 7ef:	c4 62 0d b8 6c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm14,%ymm13
 7f6:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 7fc:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 800:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 806:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 80c:	48 01 c1             	add    %rax,%rcx
 80f:	48 01 c1             	add    %rax,%rcx
 812:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 818:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 81e:	48 01 c1             	add    %rax,%rcx
 821:	48 01 c1             	add    %rax,%rcx
 824:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 82a:	48 01 c1             	add    %rax,%rcx
 82d:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 833:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 837:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 83d:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 841:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 847:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 84b:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 851:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 855:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 85b:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 85f:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 865:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 869:	c4 41 7c 10 b4 9e 00 	vmovups 0x100(%r14,%rbx,4),%ymm14
 870:	01 00 00 
 873:	c4 62 0d b8 6c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm14,%ymm13
 87a:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 880:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 884:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 88a:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 890:	48 01 c1             	add    %rax,%rcx
 893:	48 01 c1             	add    %rax,%rcx
 896:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 89c:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 8a2:	48 01 c1             	add    %rax,%rcx
 8a5:	48 01 c1             	add    %rax,%rcx
 8a8:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 8ae:	48 01 c1             	add    %rax,%rcx
 8b1:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 8b7:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8bb:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 8c1:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8c5:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 8cb:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8cf:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 8d5:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8d9:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 8df:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8e3:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 8e9:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8ed:	c4 41 7c 10 b4 9e 20 	vmovups 0x120(%r14,%rbx,4),%ymm14
 8f4:	01 00 00 
 8f7:	c4 62 0d b8 6c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm14,%ymm13
 8fe:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 904:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 908:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 90e:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 914:	48 01 c1             	add    %rax,%rcx
 917:	48 01 c1             	add    %rax,%rcx
 91a:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 920:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 926:	48 01 c1             	add    %rax,%rcx
 929:	48 01 c1             	add    %rax,%rcx
 92c:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 932:	48 01 c1             	add    %rax,%rcx
 935:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 93b:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 93f:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 945:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 949:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 94f:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 953:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 959:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 95d:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 963:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 967:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 96d:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 971:	c4 41 7c 10 b4 9e 40 	vmovups 0x140(%r14,%rbx,4),%ymm14
 978:	01 00 00 
 97b:	c4 62 0d b8 6c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm14,%ymm13
 982:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 988:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 98c:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 992:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 998:	48 01 c1             	add    %rax,%rcx
 99b:	48 01 c1             	add    %rax,%rcx
 99e:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 9a4:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 9aa:	48 01 c1             	add    %rax,%rcx
 9ad:	48 01 c1             	add    %rax,%rcx
 9b0:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 9b6:	48 01 c1             	add    %rax,%rcx
 9b9:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 9bf:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9c3:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 9c9:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9cd:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 9d3:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9d7:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 9dd:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9e1:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 9e7:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 9eb:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 9f1:	48 01 c1             	add    %rax,%rcx
 9f4:	c4 41 7c 10 b4 9e 60 	vmovups 0x160(%r14,%rbx,4),%ymm14
 9fb:	01 00 00 
 9fe:	c4 62 0d b8 2c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm14,%ymm13
 a04:	48 83 c3 60          	add    $0x60,%rbx
 a08:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 a0e:	48 01 f1             	add    %rsi,%rcx
 a11:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 a17:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 a1d:	48 01 c1             	add    %rax,%rcx
 a20:	48 01 c1             	add    %rax,%rcx
 a23:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 a29:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 a2f:	48 01 c1             	add    %rax,%rcx
 a32:	48 01 c1             	add    %rax,%rcx
 a35:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 a3b:	48 01 c1             	add    %rax,%rcx
 a3e:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 a44:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a48:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 a4e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a52:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 a58:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a5c:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 a62:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 a66:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 a6c:	48 01 c1             	add    %rax,%rcx
 a6f:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 a75:	48 39 fb             	cmp    %rdi,%rbx
 a78:	0f 8c b2 f9 ff ff    	jl     430 <_Z5benchv+0x2e0>
 a7e:	e9 87 f7 ff ff       	jmpq   20a <_Z5benchv+0xba>
 a83:	0f 31                	rdtsc  
 a85:	48 c1 e2 20          	shl    $0x20,%rdx
 a89:	48 09 c2             	or     %rax,%rdx
 a8c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # a92 <_Z5benchv+0x942>
 a92:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 a97:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # a9f <_Z5benchv+0x94f>
 a9e:	00 
 a9f:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # aa7 <_Z5benchv+0x957>
 aa6:	00 
 aa7:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # aae <_Z5benchv+0x95e>
 aae:	01 c0                	add    %eax,%eax
 ab0:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 ab6:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 aba:	c4 c1 73 5c c7       	vsubsd %xmm15,%xmm1,%xmm0
 abf:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 ac3:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 ac7:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 acb:	5b                   	pop    %rbx
 acc:	41 5e                	pop    %r14
 ace:	c5 f8 77             	vzeroupper 
 ad1:	c3                   	retq   
 ad2:	90                   	nop
 ad3:	90                   	nop
 ad4:	90                   	nop
...
0000000000000af0 <_Z9n_reg_maxv>:
 af0:	b8 9c 00 00 00       	mov    $0x9c,%eax
 af5:	c3                   	retq   

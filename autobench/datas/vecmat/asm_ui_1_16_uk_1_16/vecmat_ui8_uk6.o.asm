...
vecmat_ui8_uk6.o:     file format elf64-x86-64
...
0000000000000140 <_Z5benchv>:
 ...
 32a:	0f 83 6f 02 00 00    	jae    59f <_Z5benchv+0x45f>
 ...
 3b8:	c4 22 35 b8 84 8a 60 	vfmadd231ps -0xa0(%rdx,%r9,4),%ymm9,%ymm8
 3bf:	ff ff ff 
 3c2:	c4 21 7c 10 64 89 60 	vmovups 0x60(%rcx,%r9,4),%ymm12
 3c9:	c4 21 7c 10 ac 89 80 	vmovups 0x80(%rcx,%r9,4),%ymm13
 3d0:	00 00 00 
 3d3:	c4 21 7c 10 b4 89 a0 	vmovups 0xa0(%rcx,%r9,4),%ymm14
 3da:	00 00 00 
 3dd:	4a 8d 9c 30 60 ff ff 	lea    -0xa0(%rax,%r14,1),%rbx
 3e4:	ff 
 3e5:	c4 c2 35 b8 bc be 60 	vfmadd231ps -0xa0(%r14,%rdi,4),%ymm9,%ymm7
 3ec:	ff ff ff 
 3ef:	c4 c2 35 b8 b4 fe 60 	vfmadd231ps -0xa0(%r14,%rdi,8),%ymm9,%ymm6
 3f6:	ff ff ff 
 3f9:	48 01 c3             	add    %rax,%rbx
 3fc:	c4 e2 35 b8 2c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm5
 402:	c4 e2 35 b8 24 fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm4
 408:	48 01 c3             	add    %rax,%rbx
 40b:	48 01 c3             	add    %rax,%rbx
 40e:	c4 22 2d b8 44 8a 80 	vfmadd231ps -0x80(%rdx,%r9,4),%ymm10,%ymm8
 415:	c4 e2 35 b8 1c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm3
 41b:	48 01 c3             	add    %rax,%rbx
 41e:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 424:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 428:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 42e:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 432:	c4 e2 2d b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm10,%ymm7
 438:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 43c:	c4 22 25 b8 44 8a a0 	vfmadd231ps -0x60(%rdx,%r9,4),%ymm11,%ymm8
 443:	c4 e2 2d b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm6
 449:	c4 e2 2d b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm10,%ymm5
 44f:	48 01 c3             	add    %rax,%rbx
 452:	48 01 c3             	add    %rax,%rbx
 455:	c4 e2 2d b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm4
 45b:	c4 e2 2d b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm10,%ymm3
 461:	48 01 c3             	add    %rax,%rbx
 464:	48 01 c3             	add    %rax,%rbx
 467:	c4 22 1d b8 44 8a c0 	vfmadd231ps -0x40(%rdx,%r9,4),%ymm12,%ymm8
 46e:	c4 e2 2d b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm2
 474:	48 01 c3             	add    %rax,%rbx
 477:	c4 e2 2d b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm1
 47d:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 481:	c4 e2 25 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm11,%ymm7
 487:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 48b:	c4 e2 25 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm6
 491:	c4 e2 25 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm11,%ymm5
 497:	48 01 c3             	add    %rax,%rbx
 49a:	c4 22 15 b8 44 8a e0 	vfmadd231ps -0x20(%rdx,%r9,4),%ymm13,%ymm8
 4a1:	48 01 c3             	add    %rax,%rbx
 4a4:	c4 e2 25 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm4
 4aa:	c4 e2 25 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm11,%ymm3
 4b0:	48 01 c3             	add    %rax,%rbx
 4b3:	48 01 c3             	add    %rax,%rbx
 4b6:	c4 e2 25 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm2
 4bc:	48 01 c3             	add    %rax,%rbx
 4bf:	c4 22 0d b8 04 8a    	vfmadd231ps (%rdx,%r9,4),%ymm14,%ymm8
 4c5:	49 83 c1 30          	add    $0x30,%r9
 4c9:	c4 e2 25 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm1
 4cf:	48 01 c3             	add    %rax,%rbx
 4d2:	c4 e2 1d b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm7
 4d8:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 4dc:	c4 e2 1d b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm6
 4e2:	c4 e2 1d b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm12,%ymm5
 4e8:	48 01 c3             	add    %rax,%rbx
 4eb:	48 01 c3             	add    %rax,%rbx
 4ee:	c4 e2 1d b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm4
 4f4:	c4 e2 1d b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm12,%ymm3
 4fa:	48 01 c3             	add    %rax,%rbx
 4fd:	48 01 c3             	add    %rax,%rbx
 500:	c4 e2 1d b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm2
 506:	48 01 c3             	add    %rax,%rbx
 509:	c4 e2 1d b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm1
 50f:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 513:	c4 e2 15 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm13,%ymm7
 519:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 51d:	c4 e2 15 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm13,%ymm6
 523:	c4 e2 15 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm13,%ymm5
 529:	48 01 c3             	add    %rax,%rbx
 52c:	48 01 c3             	add    %rax,%rbx
 52f:	c4 e2 15 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm13,%ymm4
 535:	c4 e2 15 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm13,%ymm3
 53b:	48 01 c3             	add    %rax,%rbx
 53e:	48 01 c3             	add    %rax,%rbx
 541:	c4 e2 15 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm13,%ymm2
 547:	48 01 c3             	add    %rax,%rbx
 54a:	c4 e2 15 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm13,%ymm1
 550:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 554:	c4 e2 0d b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm14,%ymm7
 55a:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 55e:	c4 e2 0d b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm14,%ymm6
 564:	c4 e2 0d b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm14,%ymm5
 56a:	48 01 c3             	add    %rax,%rbx
 56d:	48 01 c3             	add    %rax,%rbx
 570:	c4 e2 0d b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm14,%ymm4
 576:	c4 e2 0d b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm14,%ymm3
 57c:	48 01 c3             	add    %rax,%rbx
 57f:	48 01 c3             	add    %rax,%rbx
 582:	c4 e2 0d b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm14,%ymm2
 588:	48 01 c3             	add    %rax,%rbx
 58b:	c4 e2 0d b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm14,%ymm1
 591:	49 39 f9             	cmp    %rdi,%r9
 594:	0f 8c 06 fe ff ff    	jl     3a0 <_Z5benchv+0x260>
 59a:	e9 62 fc ff ff       	jmpq   201 <_Z5benchv+0xc1>
 59f:	0f 31                	rdtsc  
 ...
 5d6:	c4 c1 73 5c c7       	vsubsd %xmm15,%xmm1,%xmm0
 5db:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
...
0000000000000610 <_Z9n_reg_maxv>:
 610:	b8 30 00 00 00       	mov    $0x30,%eax
 615:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui8_uk6.cpp+0x9a>
  96:	01 00 00 00 

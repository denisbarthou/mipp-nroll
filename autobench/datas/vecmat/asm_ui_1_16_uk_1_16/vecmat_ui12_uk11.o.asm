...
0000000000000150 <_Z5benchv>:
 ...
 18b:	0f 8e 0e 08 00 00    	jle    99f <_Z5benchv+0x84f>
 ...
 1d7:	48 81 c2 40 01 00 00 	add    $0x140,%rdx
 ...
 3dc:	0f 83 bd 05 00 00    	jae    99f <_Z5benchv+0x84f>
 ...
 44b:	c4 62 15 b8 a4 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm13,%ymm12
 452:	fe ff ff 
 455:	c4 62 15 b8 9c b9 c0 	vfmadd231ps -0x140(%rcx,%rdi,4),%ymm13,%ymm11
 45c:	fe ff ff 
 45f:	c4 62 15 b8 94 f9 c0 	vfmadd231ps -0x140(%rcx,%rdi,8),%ymm13,%ymm10
 466:	fe ff ff 
 469:	48 8d 8c 08 c0 fe ff 	lea    -0x140(%rax,%rcx,1),%rcx
 470:	ff 
 ...
 4d2:	c4 62 15 b8 a4 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm13,%ymm12
 4d9:	fe ff ff 
 ...
 54c:	c4 62 15 b8 a4 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm13,%ymm12
 553:	ff ff ff 
 ...
 5c6:	c4 62 15 b8 a4 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm13,%ymm12
 5cd:	ff ff ff 
 ...
 640:	00 00 00 
 643:	c4 62 15 b8 a4 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm13,%ymm12
 64a:	ff ff ff 
 ...
 6bd:	00 00 00 
 6c0:	c4 62 15 b8 a4 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm13,%ymm12
 6c7:	ff ff ff 
 ...
 73a:	00 00 00 
 73d:	c4 62 15 b8 64 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm13,%ymm12
 744:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 74a:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 74e:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 754:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 75a:	48 01 c1             	add    %rax,%rcx
 75d:	48 01 c1             	add    %rax,%rcx
 760:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 766:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 76c:	48 01 c1             	add    %rax,%rcx
 76f:	48 01 c1             	add    %rax,%rcx
 772:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 778:	48 01 c1             	add    %rax,%rcx
 77b:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 781:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 785:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 78b:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 78f:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 795:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 799:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 79f:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 7a3:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 7a9:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 7ad:	c4 41 7c 10 ac 9d e0 	vmovups 0xe0(%r13,%rbx,4),%ymm13
 7b4:	00 00 00 
 7b7:	c4 62 15 b8 64 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm13,%ymm12
 7be:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 7c4:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 7c8:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 7ce:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 7d4:	48 01 c1             	add    %rax,%rcx
 7d7:	48 01 c1             	add    %rax,%rcx
 7da:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 7e0:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 7e6:	48 01 c1             	add    %rax,%rcx
 7e9:	48 01 c1             	add    %rax,%rcx
 7ec:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 7f2:	48 01 c1             	add    %rax,%rcx
 7f5:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 7fb:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 7ff:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 805:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 809:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 80f:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 813:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 819:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 81d:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 823:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 827:	c4 41 7c 10 ac 9d 00 	vmovups 0x100(%r13,%rbx,4),%ymm13
 82e:	01 00 00 
 831:	c4 62 15 b8 64 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm13,%ymm12
 ...
 8a1:	c4 41 7c 10 ac 9d 20 	vmovups 0x120(%r13,%rbx,4),%ymm13
 8a8:	01 00 00 
 8ab:	c4 62 15 b8 64 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm13,%ymm12
 8b2:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 8b8:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 8bc:	c4 62 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm10
 8c2:	c4 62 15 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm9
 8c8:	48 01 c1             	add    %rax,%rcx
 8cb:	48 01 c1             	add    %rax,%rcx
 8ce:	c4 62 15 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm8
 8d4:	c4 e2 15 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm5
 8da:	48 01 c1             	add    %rax,%rcx
 8dd:	48 01 c1             	add    %rax,%rcx
 8e0:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 8e6:	48 01 c1             	add    %rax,%rcx
 8e9:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 8ef:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8f3:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 8f9:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 8fd:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 903:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 907:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 90d:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 911:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 917:	48 01 c1             	add    %rax,%rcx
 91a:	c4 41 7c 10 ac 9d 40 	vmovups 0x140(%r13,%rbx,4),%ymm13
 921:	01 00 00 
 924:	c4 62 15 b8 24 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm13,%ymm12
 92a:	48 83 c3 58          	add    $0x58,%rbx
 92e:	c4 62 15 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm13,%ymm11
 934:	48 01 f1             	add    %rsi,%rcx
 ...
 988:	48 01 c1             	add    %rax,%rcx
 98b:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 991:	48 39 fb             	cmp    %rdi,%rbx
 994:	0f 8c a6 fa ff ff    	jl     440 <_Z5benchv+0x2f0>
 99a:	e9 86 f8 ff ff       	jmpq   225 <_Z5benchv+0xd5>
 99f:	0f 31                	rdtsc  
 9a1:	48 c1 e2 20          	shl    $0x20,%rdx
 9a5:	48 09 c2             	or     %rax,%rdx
 9a8:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 9ae <_Z5benchv+0x85e>
 9ae:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 9b3:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 9bb <_Z5benchv+0x86b>
 9ba:	00 
 9bb:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 9c3 <_Z5benchv+0x873>
 9c2:	00 
 9c3:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 9ca <_Z5benchv+0x87a>
 9ca:	01 c0                	add    %eax,%eax
 9cc:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 9d2:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 9d6:	c4 c1 73 5c c6       	vsubsd %xmm14,%xmm1,%xmm0
 9db:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
 9df:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 9e3:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 9e7:	5b                   	pop    %rbx
 9e8:	41 5c                	pop    %r12
 9ea:	41 5d                	pop    %r13
 9ec:	41 5e                	pop    %r14
...
0000000000000a10 <_Z9n_reg_maxv>:
 a10:	b8 84 00 00 00       	mov    $0x84,%eax
 a15:	c3                   	retq   

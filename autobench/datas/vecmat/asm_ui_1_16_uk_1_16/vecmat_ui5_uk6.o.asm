...
vecmat_ui5_uk6.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
 ...
 195:	0f 8e 8c 02 00 00    	jle    427 <_Z5benchv+0x2c7>
 ...
 1d2:	48 81 c2 a0 00 00 00 	add    $0xa0,%rdx
 1d9:	e9 cf 00 00 00       	jmpq   2ad <_Z5benchv+0x14d>
 1de:	90                   	nop
 1df:	90                   	nop
 ...
 2a7:	0f 83 7a 01 00 00    	jae    427 <_Z5benchv+0x2c7>
 ...
 2da:	c4 e2 4d b8 ac 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm6,%ymm5
 2e1:	ff ff ff 
 ...
 30a:	00 00 00 
 30d:	c4 e2 4d b8 a4 b1 60 	vfmadd231ps -0xa0(%rcx,%rsi,4),%ymm6,%ymm4
 314:	ff ff ff 
 317:	c4 e2 4d b8 8c f1 60 	vfmadd231ps -0xa0(%rcx,%rsi,8),%ymm6,%ymm1
 31e:	ff ff ff 
 321:	48 8d 8c 08 60 ff ff 	lea    -0xa0(%rax,%rcx,1),%rcx
 328:	ff 
 329:	48 01 c1             	add    %rax,%rcx
 32c:	c4 e2 4d b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm6,%ymm3
 332:	c4 e2 4d b8 14 f1    	vfmadd231ps (%rcx,%rsi,8),%ymm6,%ymm2
 338:	48 01 c1             	add    %rax,%rcx
 33b:	48 01 c1             	add    %rax,%rcx
 33e:	c4 e2 45 b8 6c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm7,%ymm5
 345:	c4 e2 45 b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm7,%ymm4
 34b:	48 01 f9             	add    %rdi,%rcx
 34e:	c4 e2 45 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm7,%ymm1
 354:	c4 e2 45 b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm7,%ymm3
 35a:	48 01 c1             	add    %rax,%rcx
 35d:	48 01 c1             	add    %rax,%rcx
 360:	c4 e2 3d b8 6c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm8,%ymm5
 367:	c4 e2 45 b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm7,%ymm2
 36d:	48 01 c1             	add    %rax,%rcx
 370:	c4 e2 3d b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm8,%ymm4
 376:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 37a:	c4 e2 3d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm8,%ymm1
 380:	c4 e2 3d b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm8,%ymm3
 386:	48 01 c1             	add    %rax,%rcx
 389:	48 01 c1             	add    %rax,%rcx
 38c:	c4 e2 35 b8 6c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm9,%ymm5
 393:	c4 e2 3d b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm8,%ymm2
 399:	48 01 c1             	add    %rax,%rcx
 39c:	c4 e2 35 b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm9,%ymm4
 3a2:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 3a6:	c4 e2 35 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm9,%ymm1
 3ac:	c4 e2 35 b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm9,%ymm3
 3b2:	48 01 c1             	add    %rax,%rcx
 3b5:	48 01 c1             	add    %rax,%rcx
 3b8:	c4 e2 2d b8 6c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm10,%ymm5
 3bf:	c4 e2 35 b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm9,%ymm2
 3c5:	48 01 c1             	add    %rax,%rcx
 3c8:	c4 e2 2d b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm10,%ymm4
 3ce:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 3d2:	c4 e2 2d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm10,%ymm1
 3d8:	c4 e2 2d b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm10,%ymm3
 3de:	48 01 c1             	add    %rax,%rcx
 3e1:	48 01 c1             	add    %rax,%rcx
 3e4:	c4 e2 25 b8 2c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm11,%ymm5
 3ea:	48 83 c3 30          	add    $0x30,%rbx
 3ee:	c4 e2 2d b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm10,%ymm2
 3f4:	48 01 c1             	add    %rax,%rcx
 3f7:	c4 e2 25 b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm11,%ymm4
 3fd:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 401:	c4 e2 25 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm11,%ymm1
 407:	c4 e2 25 b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm11,%ymm3
 40d:	48 01 c1             	add    %rax,%rcx
 410:	48 01 c1             	add    %rax,%rcx
 413:	c4 e2 25 b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm11,%ymm2
 419:	48 39 f3             	cmp    %rsi,%rbx
 41c:	0f 8c ae fe ff ff    	jl     2d0 <_Z5benchv+0x170>
 422:	e9 cd fd ff ff       	jmpq   1f4 <_Z5benchv+0x94>
 427:	0f 31                	rdtsc  
 429:	48 c1 e2 20          	shl    $0x20,%rdx
 42d:	48 09 c2             	or     %rax,%rdx
 430:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 436 <_Z5benchv+0x2d6>
 436:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 43b:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 443 <_Z5benchv+0x2e3>
 442:	00 
 443:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 44b <_Z5benchv+0x2eb>
 44a:	00 
 44b:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 452 <_Z5benchv+0x2f2>
 452:	01 c0                	add    %eax,%eax
 454:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 45a:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 45e:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 462:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
...
0000000000000480 <_Z6enablev>:
 480:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 487 <_Z6enablev+0x7>
 487:	7d 03                	jge    48c <_Z6enablev+0xc>
 489:	31 c0                	xor    %eax,%eax
 48b:	c3                   	retq   
 48c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 493 <_Z6enablev+0x13>
 493:	b8 30 00 00 00       	mov    $0x30,%eax
 498:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
...
00000000000004b0 <_Z9n_reg_maxv>:
 4b0:	b8 1e 00 00 00       	mov    $0x1e,%eax
 4b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui5_uk6.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000140 <_Z5benchv>:
 ...
 173:	0f 8e c6 00 00 00    	jle    23f <_Z5benchv+0xff>
 ...
 18e:	48 63 35 00 00 00 00 	movslq 0x0(%rip),%rsi        # 195 <_Z5benchv+0x55>
 195:	31 ff                	xor    %edi,%edi
 197:	4c 8d 14 f5 00 00 00 	lea    0x0(,%rsi,8),%r10
 19e:	00 
 19f:	48 8d 04 b2          	lea    (%rdx,%rsi,4),%rax
 1a3:	eb 66                	jmp    20b <_Z5benchv+0xcb>
 1a5:	90                   	nop
 1a6:	90                   	nop
 1a7:	90                   	nop
 1a8:	90                   	nop
 ...
 1da:	c4 c1 7a 11 14 b9    	vmovss %xmm2,(%r9,%rdi,4)
 1e0:	c4 e3 7d 19 ca 01    	vextractf128 $0x1,%ymm1,%xmm2
 1e6:	48 83 c7 02          	add    $0x2,%rdi
 ...
 206:	4c 39 c7             	cmp    %r8,%rdi
 209:	73 34                	jae    23f <_Z5benchv+0xff>
 20b:	49 89 fb             	mov    %rdi,%r11
 ...
 225:	c4 e2 65 b8 14 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm3,%ymm2
 22b:	c4 e2 65 b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm3,%ymm1
 231:	48 83 c3 08          	add    $0x8,%rbx
 235:	48 39 f3             	cmp    %rsi,%rbx
 238:	7c e6                	jl     220 <_Z5benchv+0xe0>
 23a:	e9 79 ff ff ff       	jmpq   1b8 <_Z5benchv+0x78>
 23f:	0f 31                	rdtsc  
 241:	48 c1 e2 20          	shl    $0x20,%rdx
 245:	48 09 c2             	or     %rax,%rdx
 248:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 24e <_Z5benchv+0x10e>
 24e:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 253:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 25b <_Z5benchv+0x11b>
 25a:	00 
 25b:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 263 <_Z5benchv+0x123>
 262:	00 
 263:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 26a <_Z5benchv+0x12a>
 26a:	01 c0                	add    %eax,%eax
 26c:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 272:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 276:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 27a:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
 27e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 282:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 286:	5b                   	pop    %rbx
 287:	c5 f8 77             	vzeroupper 
 28a:	c3                   	retq   
 28b:	90                   	nop
 28c:	90                   	nop
 28d:	90                   	nop
...
0000000000000290 <_Z6enablev>:
 290:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 297 <_Z6enablev+0x7>
 297:	7d 03                	jge    29c <_Z6enablev+0xc>
 299:	31 c0                	xor    %eax,%eax
 29b:	c3                   	retq   
 29c:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 2a3 <_Z6enablev+0x13>
 2a3:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 2a7:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 2ad <_Z6enablev+0x1d>
 2ad:	0f 9e c0             	setle  %al
 2b0:	c3                   	retq   
 2b1:	90                   	nop
 2b2:	90                   	nop
 2b3:	90                   	nop

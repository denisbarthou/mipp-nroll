...
vecmat_ui7_uk5.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e 16 03 00 00    	jle    4a1 <_Z5benchv+0x351>
 ...
 2f5:	0f 83 a6 01 00 00    	jae    4a1 <_Z5benchv+0x351>
 ...
 348:	c4 e2 3d b8 7c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm8,%ymm7
 34f:	c4 41 7c 10 5c 9e 60 	vmovups 0x60(%r14,%rbx,4),%ymm11
 356:	c4 41 7c 10 a4 9e 80 	vmovups 0x80(%r14,%rbx,4),%ymm12
 35d:	00 00 00 
 360:	c4 e2 3d b8 74 b9 80 	vfmadd231ps -0x80(%rcx,%rdi,4),%ymm8,%ymm6
 367:	c4 e2 3d b8 5c f9 80 	vfmadd231ps -0x80(%rcx,%rdi,8),%ymm8,%ymm3
 36e:	48 8d 4c 08 80       	lea    -0x80(%rax,%rcx,1),%rcx
 373:	48 01 c1             	add    %rax,%rcx
 376:	c4 e2 3d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm5
 37c:	c4 e2 3d b8 24 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm4
 382:	48 01 c1             	add    %rax,%rcx
 385:	48 01 c1             	add    %rax,%rcx
 388:	c4 e2 35 b8 7c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm9,%ymm7
 38f:	c4 e2 3d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm2
 395:	48 01 c1             	add    %rax,%rcx
 398:	c4 e2 3d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm1
 39e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 3a2:	c4 e2 35 b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm9,%ymm6
 3a8:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 3ac:	c4 e2 35 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm9,%ymm3
 3b2:	c4 e2 35 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm9,%ymm5
 3b8:	48 01 c1             	add    %rax,%rcx
 3bb:	c4 e2 2d b8 7c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm10,%ymm7
 3c2:	48 01 c1             	add    %rax,%rcx
 3c5:	c4 e2 35 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm9,%ymm4
 3cb:	c4 e2 35 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm9,%ymm2
 3d1:	48 01 c1             	add    %rax,%rcx
 3d4:	48 01 c1             	add    %rax,%rcx
 3d7:	c4 e2 35 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm9,%ymm1
 3dd:	48 01 c1             	add    %rax,%rcx
 3e0:	c4 e2 25 b8 7c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm11,%ymm7
 3e7:	c4 e2 2d b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm10,%ymm6
 3ed:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 3f1:	c4 e2 2d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm3
 3f7:	c4 e2 2d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm10,%ymm5
 3fd:	48 01 c1             	add    %rax,%rcx
 400:	48 01 c1             	add    %rax,%rcx
 403:	c4 e2 2d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm4
 409:	c4 e2 2d b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm10,%ymm2
 40f:	48 01 c1             	add    %rax,%rcx
 412:	c4 e2 1d b8 3c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm12,%ymm7
 418:	48 83 c3 28          	add    $0x28,%rbx
 41c:	48 01 c1             	add    %rax,%rcx
 41f:	c4 e2 2d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm10,%ymm1
 425:	48 01 c1             	add    %rax,%rcx
 428:	c4 e2 25 b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm11,%ymm6
 42e:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 432:	c4 e2 25 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm3
 438:	c4 e2 25 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm11,%ymm5
 43e:	48 01 c1             	add    %rax,%rcx
 441:	48 01 c1             	add    %rax,%rcx
 444:	c4 e2 25 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm4
 44a:	c4 e2 25 b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm11,%ymm2
 450:	48 01 c1             	add    %rax,%rcx
 453:	48 01 c1             	add    %rax,%rcx
 456:	c4 e2 25 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm1
 45c:	48 01 c1             	add    %rax,%rcx
 45f:	c4 e2 1d b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm12,%ymm6
 465:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 469:	c4 e2 1d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm3
 46f:	c4 e2 1d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm12,%ymm5
 475:	48 01 c1             	add    %rax,%rcx
 478:	48 01 c1             	add    %rax,%rcx
 47b:	c4 e2 1d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm4
 481:	c4 e2 1d b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm12,%ymm2
 487:	48 01 c1             	add    %rax,%rcx
 48a:	48 01 c1             	add    %rax,%rcx
 48d:	c4 e2 1d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm12,%ymm1
 493:	48 39 fb             	cmp    %rdi,%rbx
 496:	0f 8c 94 fe ff ff    	jl     330 <_Z5benchv+0x1e0>
 49c:	e9 5b fd ff ff       	jmpq   1fc <_Z5benchv+0xac>
 4a1:	0f 31                	rdtsc  
 4a3:	48 c1 e2 20          	shl    $0x20,%rdx
 4a7:	48 09 c2             	or     %rax,%rdx
 4aa:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 4b0 <_Z5benchv+0x360>
 4b0:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 4b5:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 4bd <_Z5benchv+0x36d>
 4bc:	00 
 4bd:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 4c5 <_Z5benchv+0x375>
 4c4:	00 
 4c5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 4cc <_Z5benchv+0x37c>
 4cc:	01 c0                	add    %eax,%eax
 4ce:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 4d4:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 4d8:	c4 c1 73 5c c5       	vsubsd %xmm13,%xmm1,%xmm0
 4dd:	c5 ba 2a c8          	vcvtsi2ss %eax,%xmm8,%xmm1
...
0000000000000500 <_Z9n_reg_maxv>:
 500:	b8 23 00 00 00       	mov    $0x23,%eax
 505:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui7_uk5.cpp+0x9a>
  96:	01 00 00 00 

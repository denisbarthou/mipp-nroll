...
0000000000000140 <_Z5benchv>:
 ...
 17b:	0f 8e b2 03 00 00    	jle    533 <_Z5benchv+0x3f3>
 ...
 1ab:	48 8d 84 82 a0 01 00 	lea    0x1a0(%rdx,%rax,4),%rax
 1b2:	00 
 1b3:	4a 8d b4 da a0 01 00 	lea    0x1a0(%rdx,%r11,8),%rsi
 1ba:	00 
 1bb:	4a 8d bc 9a a0 01 00 	lea    0x1a0(%rdx,%r11,4),%rdi
 1c2:	00 
 1c3:	48 81 c2 a0 01 00 00 	add    $0x1a0,%rdx
 ...
 27b:	0f 83 b2 02 00 00    	jae    533 <_Z5benchv+0x3f3>
 ...
 2c5:	c4 e2 55 b8 a4 9a 60 	vfmadd231ps -0x1a0(%rdx,%rbx,4),%ymm5,%ymm4
 2cc:	fe ff ff 
 2cf:	c4 e2 55 b8 9c 9f 60 	vfmadd231ps -0x1a0(%rdi,%rbx,4),%ymm5,%ymm3
 2d6:	fe ff ff 
 2d9:	c4 e2 55 b8 94 9e 60 	vfmadd231ps -0x1a0(%rsi,%rbx,4),%ymm5,%ymm2
 2e0:	fe ff ff 
 2e3:	c4 e2 55 b8 8c 98 60 	vfmadd231ps -0x1a0(%rax,%rbx,4),%ymm5,%ymm1
 2ea:	fe ff ff 
 2ed:	c5 fc 10 6c 99 20    	vmovups 0x20(%rcx,%rbx,4),%ymm5
 2f3:	c4 e2 55 b8 a4 9a 80 	vfmadd231ps -0x180(%rdx,%rbx,4),%ymm5,%ymm4
 2fa:	fe ff ff 
 2fd:	c4 e2 55 b8 9c 9f 80 	vfmadd231ps -0x180(%rdi,%rbx,4),%ymm5,%ymm3
 304:	fe ff ff 
 307:	c4 e2 55 b8 94 9e 80 	vfmadd231ps -0x180(%rsi,%rbx,4),%ymm5,%ymm2
 30e:	fe ff ff 
 311:	c4 e2 55 b8 8c 98 80 	vfmadd231ps -0x180(%rax,%rbx,4),%ymm5,%ymm1
 318:	fe ff ff 
 31b:	c5 fc 10 6c 99 40    	vmovups 0x40(%rcx,%rbx,4),%ymm5
 321:	c4 e2 55 b8 a4 9a a0 	vfmadd231ps -0x160(%rdx,%rbx,4),%ymm5,%ymm4
 328:	fe ff ff 
 32b:	c4 e2 55 b8 9c 9f a0 	vfmadd231ps -0x160(%rdi,%rbx,4),%ymm5,%ymm3
 332:	fe ff ff 
 335:	c4 e2 55 b8 94 9e a0 	vfmadd231ps -0x160(%rsi,%rbx,4),%ymm5,%ymm2
 33c:	fe ff ff 
 33f:	c4 e2 55 b8 8c 98 a0 	vfmadd231ps -0x160(%rax,%rbx,4),%ymm5,%ymm1
 346:	fe ff ff 
 349:	c5 fc 10 6c 99 60    	vmovups 0x60(%rcx,%rbx,4),%ymm5
 34f:	c4 e2 55 b8 a4 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm5,%ymm4
 356:	fe ff ff 
 359:	c4 e2 55 b8 9c 9f c0 	vfmadd231ps -0x140(%rdi,%rbx,4),%ymm5,%ymm3
 360:	fe ff ff 
 363:	c4 e2 55 b8 94 9e c0 	vfmadd231ps -0x140(%rsi,%rbx,4),%ymm5,%ymm2
 36a:	fe ff ff 
 36d:	c4 e2 55 b8 8c 98 c0 	vfmadd231ps -0x140(%rax,%rbx,4),%ymm5,%ymm1
 374:	fe ff ff 
 377:	c5 fc 10 ac 99 80 00 	vmovups 0x80(%rcx,%rbx,4),%ymm5
 37e:	00 00 
 380:	c4 e2 55 b8 a4 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm5,%ymm4
 387:	fe ff ff 
 38a:	c4 e2 55 b8 9c 9f e0 	vfmadd231ps -0x120(%rdi,%rbx,4),%ymm5,%ymm3
 391:	fe ff ff 
 394:	c4 e2 55 b8 94 9e e0 	vfmadd231ps -0x120(%rsi,%rbx,4),%ymm5,%ymm2
 39b:	fe ff ff 
 39e:	c4 e2 55 b8 8c 98 e0 	vfmadd231ps -0x120(%rax,%rbx,4),%ymm5,%ymm1
 3a5:	fe ff ff 
 3a8:	c5 fc 10 ac 99 a0 00 	vmovups 0xa0(%rcx,%rbx,4),%ymm5
 3af:	00 00 
 3b1:	c4 e2 55 b8 a4 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm5,%ymm4
 3b8:	ff ff ff 
 3bb:	c4 e2 55 b8 9c 9f 00 	vfmadd231ps -0x100(%rdi,%rbx,4),%ymm5,%ymm3
 3c2:	ff ff ff 
 3c5:	c4 e2 55 b8 94 9e 00 	vfmadd231ps -0x100(%rsi,%rbx,4),%ymm5,%ymm2
 3cc:	ff ff ff 
 3cf:	c4 e2 55 b8 8c 98 00 	vfmadd231ps -0x100(%rax,%rbx,4),%ymm5,%ymm1
 3d6:	ff ff ff 
 3d9:	c5 fc 10 ac 99 c0 00 	vmovups 0xc0(%rcx,%rbx,4),%ymm5
 3e0:	00 00 
 3e2:	c4 e2 55 b8 a4 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm5,%ymm4
 3e9:	ff ff ff 
 3ec:	c4 e2 55 b8 9c 9f 20 	vfmadd231ps -0xe0(%rdi,%rbx,4),%ymm5,%ymm3
 3f3:	ff ff ff 
 3f6:	c4 e2 55 b8 94 9e 20 	vfmadd231ps -0xe0(%rsi,%rbx,4),%ymm5,%ymm2
 3fd:	ff ff ff 
 400:	c4 e2 55 b8 8c 98 20 	vfmadd231ps -0xe0(%rax,%rbx,4),%ymm5,%ymm1
 407:	ff ff ff 
 40a:	c5 fc 10 ac 99 e0 00 	vmovups 0xe0(%rcx,%rbx,4),%ymm5
 411:	00 00 
 413:	c4 e2 55 b8 a4 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm5,%ymm4
 41a:	ff ff ff 
 41d:	c4 e2 55 b8 9c 9f 40 	vfmadd231ps -0xc0(%rdi,%rbx,4),%ymm5,%ymm3
 424:	ff ff ff 
 427:	c4 e2 55 b8 94 9e 40 	vfmadd231ps -0xc0(%rsi,%rbx,4),%ymm5,%ymm2
 42e:	ff ff ff 
 431:	c4 e2 55 b8 8c 98 40 	vfmadd231ps -0xc0(%rax,%rbx,4),%ymm5,%ymm1
 438:	ff ff ff 
 43b:	c5 fc 10 ac 99 00 01 	vmovups 0x100(%rcx,%rbx,4),%ymm5
 442:	00 00 
 444:	c4 e2 55 b8 a4 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm5,%ymm4
 44b:	ff ff ff 
 44e:	c4 e2 55 b8 9c 9f 60 	vfmadd231ps -0xa0(%rdi,%rbx,4),%ymm5,%ymm3
 455:	ff ff ff 
 458:	c4 e2 55 b8 94 9e 60 	vfmadd231ps -0xa0(%rsi,%rbx,4),%ymm5,%ymm2
 45f:	ff ff ff 
 462:	c4 e2 55 b8 8c 98 60 	vfmadd231ps -0xa0(%rax,%rbx,4),%ymm5,%ymm1
 469:	ff ff ff 
 46c:	c5 fc 10 ac 99 20 01 	vmovups 0x120(%rcx,%rbx,4),%ymm5
 473:	00 00 
 475:	c4 e2 55 b8 64 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm5,%ymm4
 47c:	c4 e2 55 b8 5c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm5,%ymm3
 483:	c4 e2 55 b8 54 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm5,%ymm2
 48a:	c4 e2 55 b8 4c 98 80 	vfmadd231ps -0x80(%rax,%rbx,4),%ymm5,%ymm1
 491:	c5 fc 10 ac 99 40 01 	vmovups 0x140(%rcx,%rbx,4),%ymm5
 498:	00 00 
 49a:	c4 e2 55 b8 64 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm5,%ymm4
 4a1:	c4 e2 55 b8 5c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm5,%ymm3
 4a8:	c4 e2 55 b8 54 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm5,%ymm2
 4af:	c4 e2 55 b8 4c 98 a0 	vfmadd231ps -0x60(%rax,%rbx,4),%ymm5,%ymm1
 4b6:	c5 fc 10 ac 99 60 01 	vmovups 0x160(%rcx,%rbx,4),%ymm5
 4bd:	00 00 
 4bf:	c4 e2 55 b8 64 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm5,%ymm4
 4c6:	c4 e2 55 b8 5c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm5,%ymm3
 4cd:	c4 e2 55 b8 54 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm5,%ymm2
 4d4:	c4 e2 55 b8 4c 98 c0 	vfmadd231ps -0x40(%rax,%rbx,4),%ymm5,%ymm1
 4db:	c5 fc 10 ac 99 80 01 	vmovups 0x180(%rcx,%rbx,4),%ymm5
 4e2:	00 00 
 4e4:	c4 e2 55 b8 64 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm5,%ymm4
 4eb:	c4 e2 55 b8 5c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm5,%ymm3
 4f2:	c4 e2 55 b8 54 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm5,%ymm2
 4f9:	c4 e2 55 b8 4c 98 e0 	vfmadd231ps -0x20(%rax,%rbx,4),%ymm5,%ymm1
 500:	c5 fc 10 ac 99 a0 01 	vmovups 0x1a0(%rcx,%rbx,4),%ymm5
 507:	00 00 
 509:	c4 e2 55 b8 24 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm5,%ymm4
 50f:	c4 e2 55 b8 1c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm5,%ymm3
 515:	c4 e2 55 b8 14 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm5,%ymm2
 51b:	c4 e2 55 b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm5,%ymm1
 521:	48 83 c3 70          	add    $0x70,%rbx
 525:	4c 39 db             	cmp    %r11,%rbx
 528:	0f 8c 92 fd ff ff    	jl     2c0 <_Z5benchv+0x180>
 52e:	e9 ad fc ff ff       	jmpq   1e0 <_Z5benchv+0xa0>
 533:	0f 31                	rdtsc  
 535:	48 c1 e2 20          	shl    $0x20,%rdx
 539:	48 09 c2             	or     %rax,%rdx
 53c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 542 <_Z5benchv+0x402>
 542:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 547:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 54f <_Z5benchv+0x40f>
 54e:	00 
 54f:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 557 <_Z5benchv+0x417>
 556:	00 
 557:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 55e <_Z5benchv+0x41e>
 55e:	01 c0                	add    %eax,%eax
 560:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 566:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 56a:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 56e:	c5 ca 2a c8          	vcvtsi2ss %eax,%xmm6,%xmm1
...
00000000000005a0 <_Z9n_reg_maxv>:
 5a0:	b8 38 00 00 00       	mov    $0x38,%eax
 5a5:	c3                   	retq   

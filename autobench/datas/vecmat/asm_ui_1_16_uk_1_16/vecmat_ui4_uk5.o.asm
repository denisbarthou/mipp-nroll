...
0000000000000150 <_Z5benchv>:
 ...
 18b:	0f 8e f9 01 00 00    	jle    38a <_Z5benchv+0x23a>
 ...
 1bb:	48 8d 84 82 80 00 00 	lea    0x80(%rdx,%rax,4),%rax
 1c2:	00 
 1c3:	4a 8d b4 da 80 00 00 	lea    0x80(%rdx,%r11,8),%rsi
 1ca:	00 
 1cb:	4a 8d bc 9a 80 00 00 	lea    0x80(%rdx,%r11,4),%rdi
 1d2:	00 
 1d3:	48 83 ea 80          	sub    $0xffffffffffffff80,%rdx
 1d7:	e9 b5 00 00 00       	jmpq   291 <_Z5benchv+0x141>
 1dc:	90                   	nop
 1dd:	90                   	nop
 1de:	90                   	nop
 1df:	90                   	nop
 ...
 28b:	0f 83 f9 00 00 00    	jae    38a <_Z5benchv+0x23a>
 ...
 2ce:	90                   	nop
 2cf:	90                   	nop
 2d0:	c5 fc 10 3c 99       	vmovups (%rcx,%rbx,4),%ymm7
 2d5:	c4 e2 45 b8 64 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm7,%ymm4
 2dc:	c4 e2 45 b8 5c 9f 80 	vfmadd231ps -0x80(%rdi,%rbx,4),%ymm7,%ymm3
 2e3:	c4 e2 45 b8 54 9e 80 	vfmadd231ps -0x80(%rsi,%rbx,4),%ymm7,%ymm2
 2ea:	c4 e2 45 b8 4c 98 80 	vfmadd231ps -0x80(%rax,%rbx,4),%ymm7,%ymm1
 2f1:	c5 7c 10 44 99 20    	vmovups 0x20(%rcx,%rbx,4),%ymm8
 2f7:	c5 7c 10 4c 99 40    	vmovups 0x40(%rcx,%rbx,4),%ymm9
 2fd:	c5 fc 10 74 99 60    	vmovups 0x60(%rcx,%rbx,4),%ymm6
 303:	c5 fc 10 ac 99 80 00 	vmovups 0x80(%rcx,%rbx,4),%ymm5
 30a:	00 00 
 30c:	c4 e2 3d b8 64 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm8,%ymm4
 313:	c4 e2 3d b8 5c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm8,%ymm3
 31a:	c4 e2 3d b8 54 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm8,%ymm2
 321:	c4 e2 3d b8 4c 98 a0 	vfmadd231ps -0x60(%rax,%rbx,4),%ymm8,%ymm1
 328:	c4 e2 35 b8 64 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm9,%ymm4
 32f:	c4 e2 35 b8 5c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm9,%ymm3
 336:	c4 e2 35 b8 54 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm9,%ymm2
 33d:	c4 e2 35 b8 4c 98 c0 	vfmadd231ps -0x40(%rax,%rbx,4),%ymm9,%ymm1
 344:	c4 e2 4d b8 64 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm6,%ymm4
 34b:	c4 e2 4d b8 5c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm6,%ymm3
 352:	c4 e2 4d b8 54 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm6,%ymm2
 359:	c4 e2 4d b8 4c 98 e0 	vfmadd231ps -0x20(%rax,%rbx,4),%ymm6,%ymm1
 360:	c4 e2 55 b8 24 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm5,%ymm4
 366:	c4 e2 55 b8 1c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm5,%ymm3
 36c:	c4 e2 55 b8 14 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm5,%ymm2
 372:	c4 e2 55 b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm5,%ymm1
 378:	48 83 c3 28          	add    $0x28,%rbx
 37c:	4c 39 db             	cmp    %r11,%rbx
 37f:	0f 8c 4b ff ff ff    	jl     2d0 <_Z5benchv+0x180>
 385:	e9 66 fe ff ff       	jmpq   1f0 <_Z5benchv+0xa0>
 38a:	0f 31                	rdtsc  
 38c:	48 c1 e2 20          	shl    $0x20,%rdx
 390:	48 09 c2             	or     %rax,%rdx
 393:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 399 <_Z5benchv+0x249>
 399:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 39e:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 3a6 <_Z5benchv+0x256>
 3a5:	00 
 3a6:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 3ae <_Z5benchv+0x25e>
 3ad:	00 
 3ae:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3b5 <_Z5benchv+0x265>
 3b5:	01 c0                	add    %eax,%eax
 3b7:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 3bd:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 3c1:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 3c5:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 3c9:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 3cd:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 3d1:	5b                   	pop    %rbx
 3d2:	41 5c                	pop    %r12
 3d4:	41 5d                	pop    %r13
 3d6:	41 5e                	pop    %r14
 3d8:	41 5f                	pop    %r15
 3da:	c5 f8 77             	vzeroupper 
 3dd:	c3                   	retq   
 3de:	90                   	nop
 3df:	90                   	nop

00000000000003e0 <_Z6enablev>:
 3e0:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 3e7 <_Z6enablev+0x7>
 ...
 3f8:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx

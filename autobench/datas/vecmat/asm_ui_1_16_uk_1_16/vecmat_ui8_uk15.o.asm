...
0000000000000140 <_Z5benchv>:
 ...
 17f:	0f 8e 16 07 00 00    	jle    89b <_Z5benchv+0x75b>
 ...
 1cc:	48 81 c2 c0 01 00 00 	add    $0x1c0,%rdx
 ...
 32a:	0f 83 6b 05 00 00    	jae    89b <_Z5benchv+0x75b>
 ...
 3aa:	c4 22 35 b8 84 8a 40 	vfmadd231ps -0x1c0(%rdx,%r9,4),%ymm9,%ymm8
 3b1:	fe ff ff 
 3b4:	4a 8d 9c 30 40 fe ff 	lea    -0x1c0(%rax,%r14,1),%rbx
 3bb:	ff 
 3bc:	c4 c2 35 b8 bc be 40 	vfmadd231ps -0x1c0(%r14,%rdi,4),%ymm9,%ymm7
 3c3:	fe ff ff 
 3c6:	c4 c2 35 b8 b4 fe 40 	vfmadd231ps -0x1c0(%r14,%rdi,8),%ymm9,%ymm6
 3cd:	fe ff ff 
 ...
 409:	c4 22 35 b8 84 8a 60 	vfmadd231ps -0x1a0(%rdx,%r9,4),%ymm9,%ymm8
 410:	fe ff ff 
 ...
 45b:	c4 22 35 b8 84 8a 80 	vfmadd231ps -0x180(%rdx,%r9,4),%ymm9,%ymm8
 462:	fe ff ff 
 ...
 4ad:	c4 22 35 b8 84 8a a0 	vfmadd231ps -0x160(%rdx,%r9,4),%ymm9,%ymm8
 4b4:	fe ff ff 
 ...
 4ff:	00 00 00 
 502:	c4 22 35 b8 84 8a c0 	vfmadd231ps -0x140(%rdx,%r9,4),%ymm9,%ymm8
 509:	fe ff ff 
 ...
 554:	00 00 00 
 557:	c4 22 35 b8 84 8a e0 	vfmadd231ps -0x120(%rdx,%r9,4),%ymm9,%ymm8
 55e:	fe ff ff 
 ...
 5a9:	00 00 00 
 5ac:	c4 22 35 b8 84 8a 00 	vfmadd231ps -0x100(%rdx,%r9,4),%ymm9,%ymm8
 5b3:	ff ff ff 
 ...
 5fe:	00 00 00 
 601:	c4 22 35 b8 84 8a 20 	vfmadd231ps -0xe0(%rdx,%r9,4),%ymm9,%ymm8
 608:	ff ff ff 
 ...
 653:	01 00 00 
 656:	c4 22 35 b8 84 8a 40 	vfmadd231ps -0xc0(%rdx,%r9,4),%ymm9,%ymm8
 65d:	ff ff ff 
 ...
 6a8:	01 00 00 
 6ab:	c4 22 35 b8 84 8a 60 	vfmadd231ps -0xa0(%rdx,%r9,4),%ymm9,%ymm8
 6b2:	ff ff ff 
 6b5:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 6bb:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 6bf:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 6c5:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 6cb:	48 01 c3             	add    %rax,%rbx
 6ce:	48 01 c3             	add    %rax,%rbx
 6d1:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 6d7:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 6dd:	48 01 c3             	add    %rax,%rbx
 6e0:	48 01 c3             	add    %rax,%rbx
 6e3:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 6e9:	48 01 c3             	add    %rax,%rbx
 6ec:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 6f2:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 6f6:	c4 21 7c 10 8c 89 40 	vmovups 0x140(%rcx,%r9,4),%ymm9
 6fd:	01 00 00 
 700:	c4 22 35 b8 44 8a 80 	vfmadd231ps -0x80(%rdx,%r9,4),%ymm9,%ymm8
 707:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 70d:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 711:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 717:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 71d:	48 01 c3             	add    %rax,%rbx
 720:	48 01 c3             	add    %rax,%rbx
 723:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 729:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 72f:	48 01 c3             	add    %rax,%rbx
 732:	48 01 c3             	add    %rax,%rbx
 735:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 73b:	48 01 c3             	add    %rax,%rbx
 73e:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 744:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 748:	c4 21 7c 10 8c 89 60 	vmovups 0x160(%rcx,%r9,4),%ymm9
 74f:	01 00 00 
 752:	c4 22 35 b8 44 8a a0 	vfmadd231ps -0x60(%rdx,%r9,4),%ymm9,%ymm8
 759:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 75f:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 763:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 769:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 76f:	48 01 c3             	add    %rax,%rbx
 772:	48 01 c3             	add    %rax,%rbx
 775:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 77b:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 781:	48 01 c3             	add    %rax,%rbx
 784:	48 01 c3             	add    %rax,%rbx
 787:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 78d:	48 01 c3             	add    %rax,%rbx
 790:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 796:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 79a:	c4 21 7c 10 8c 89 80 	vmovups 0x180(%rcx,%r9,4),%ymm9
 7a1:	01 00 00 
 7a4:	c4 22 35 b8 44 8a c0 	vfmadd231ps -0x40(%rdx,%r9,4),%ymm9,%ymm8
 7ab:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 7b1:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 7b5:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 7bb:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 7c1:	48 01 c3             	add    %rax,%rbx
 7c4:	48 01 c3             	add    %rax,%rbx
 7c7:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 7cd:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 7d3:	48 01 c3             	add    %rax,%rbx
 7d6:	48 01 c3             	add    %rax,%rbx
 7d9:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 7df:	48 01 c3             	add    %rax,%rbx
 7e2:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 7e8:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 7ec:	c4 21 7c 10 8c 89 a0 	vmovups 0x1a0(%rcx,%r9,4),%ymm9
 7f3:	01 00 00 
 7f6:	c4 22 35 b8 44 8a e0 	vfmadd231ps -0x20(%rdx,%r9,4),%ymm9,%ymm8
 7fd:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 803:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 807:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 80d:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 813:	48 01 c3             	add    %rax,%rbx
 816:	48 01 c3             	add    %rax,%rbx
 819:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 81f:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 825:	48 01 c3             	add    %rax,%rbx
 828:	48 01 c3             	add    %rax,%rbx
 82b:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 831:	48 01 c3             	add    %rax,%rbx
 834:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 83a:	48 01 c3             	add    %rax,%rbx
 83d:	c4 21 7c 10 8c 89 c0 	vmovups 0x1c0(%rcx,%r9,4),%ymm9
 844:	01 00 00 
 847:	c4 22 35 b8 04 8a    	vfmadd231ps (%rdx,%r9,4),%ymm9,%ymm8
 84d:	49 83 c1 78          	add    $0x78,%r9
 851:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 857:	48 01 f3             	add    %rsi,%rbx
 85a:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 860:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 866:	48 01 c3             	add    %rax,%rbx
 869:	48 01 c3             	add    %rax,%rbx
 86c:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 872:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 878:	48 01 c3             	add    %rax,%rbx
 87b:	48 01 c3             	add    %rax,%rbx
 87e:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 884:	48 01 c3             	add    %rax,%rbx
 887:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 88d:	49 39 f9             	cmp    %rdi,%r9
 890:	0f 8c 0a fb ff ff    	jl     3a0 <_Z5benchv+0x260>
 896:	e9 66 f9 ff ff       	jmpq   201 <_Z5benchv+0xc1>
 89b:	0f 31                	rdtsc  
 89d:	48 c1 e2 20          	shl    $0x20,%rdx
 8a1:	48 09 c2             	or     %rax,%rdx
 8a4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 8aa <_Z5benchv+0x76a>
 8aa:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 8af:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 8b7 <_Z5benchv+0x777>
 8b6:	00 
 8b7:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 8bf <_Z5benchv+0x77f>
 8be:	00 
 8bf:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 8c6 <_Z5benchv+0x786>
 8c6:	01 c0                	add    %eax,%eax
 8c8:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 8ce:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 8d2:	c4 c1 73 5c c2       	vsubsd %xmm10,%xmm1,%xmm0
 8d7:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
 8db:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 8df:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 8e3:	5b                   	pop    %rbx
 8e4:	41 5c                	pop    %r12
 8e6:	41 5d                	pop    %r13
 8e8:	41 5e                	pop    %r14
...
0000000000000910 <_Z9n_reg_maxv>:
 910:	b8 78 00 00 00       	mov    $0x78,%eax
 915:	c3                   	retq   

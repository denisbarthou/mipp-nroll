...
0000000000000140 <_Z5benchv>:
 ...
 179:	c5 73 58 e8          	vaddsd %xmm0,%xmm1,%xmm13
 17d:	85 c0                	test   %eax,%eax
 17f:	0f 8e 6b 03 00 00    	jle    4f0 <_Z5benchv+0x3b0>
 ...
 32a:	0f 83 c0 01 00 00    	jae    4f0 <_Z5benchv+0x3b0>
 ...
 3b8:	c4 22 35 b8 44 8a a0 	vfmadd231ps -0x60(%rdx,%r9,4),%ymm9,%ymm8
 3bf:	c4 21 7c 10 64 89 60 	vmovups 0x60(%rcx,%r9,4),%ymm12
 3c6:	4a 8d 5c 30 a0       	lea    -0x60(%rax,%r14,1),%rbx
 3cb:	c4 c2 35 b8 7c be a0 	vfmadd231ps -0x60(%r14,%rdi,4),%ymm9,%ymm7
 3d2:	c4 c2 35 b8 74 fe a0 	vfmadd231ps -0x60(%r14,%rdi,8),%ymm9,%ymm6
 3d9:	48 01 c3             	add    %rax,%rbx
 3dc:	c4 e2 35 b8 2c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm5
 3e2:	c4 e2 35 b8 24 fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm4
 3e8:	48 01 c3             	add    %rax,%rbx
 3eb:	48 01 c3             	add    %rax,%rbx
 3ee:	c4 22 2d b8 44 8a c0 	vfmadd231ps -0x40(%rdx,%r9,4),%ymm10,%ymm8
 3f5:	c4 e2 35 b8 1c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm3
 3fb:	48 01 c3             	add    %rax,%rbx
 3fe:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 404:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 408:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 40e:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 412:	c4 e2 2d b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm10,%ymm7
 418:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 41c:	c4 22 25 b8 44 8a e0 	vfmadd231ps -0x20(%rdx,%r9,4),%ymm11,%ymm8
 423:	c4 e2 2d b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm6
 429:	c4 e2 2d b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm10,%ymm5
 42f:	48 01 c3             	add    %rax,%rbx
 432:	48 01 c3             	add    %rax,%rbx
 435:	c4 e2 2d b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm4
 43b:	c4 e2 2d b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm10,%ymm3
 441:	48 01 c3             	add    %rax,%rbx
 444:	48 01 c3             	add    %rax,%rbx
 447:	c4 22 1d b8 04 8a    	vfmadd231ps (%rdx,%r9,4),%ymm12,%ymm8
 44d:	49 83 c1 20          	add    $0x20,%r9
 451:	c4 e2 2d b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm2
 457:	48 01 c3             	add    %rax,%rbx
 45a:	c4 e2 2d b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm10,%ymm1
 460:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 464:	c4 e2 25 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm11,%ymm7
 46a:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 46e:	c4 e2 25 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm6
 474:	c4 e2 25 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm11,%ymm5
 47a:	48 01 c3             	add    %rax,%rbx
 47d:	48 01 c3             	add    %rax,%rbx
 480:	c4 e2 25 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm4
 486:	c4 e2 25 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm11,%ymm3
 48c:	48 01 c3             	add    %rax,%rbx
 48f:	48 01 c3             	add    %rax,%rbx
 492:	c4 e2 25 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm2
 498:	48 01 c3             	add    %rax,%rbx
 49b:	c4 e2 25 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm11,%ymm1
 4a1:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 4a5:	c4 e2 1d b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm7
 4ab:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 4af:	c4 e2 1d b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm6
 4b5:	c4 e2 1d b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm12,%ymm5
 4bb:	48 01 c3             	add    %rax,%rbx
 4be:	48 01 c3             	add    %rax,%rbx
 4c1:	c4 e2 1d b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm4
 4c7:	c4 e2 1d b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm12,%ymm3
 4cd:	48 01 c3             	add    %rax,%rbx
 4d0:	48 01 c3             	add    %rax,%rbx
 4d3:	c4 e2 1d b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm2
 4d9:	48 01 c3             	add    %rax,%rbx
 4dc:	c4 e2 1d b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm12,%ymm1
 4e2:	49 39 f9             	cmp    %rdi,%r9
 4e5:	0f 8c b5 fe ff ff    	jl     3a0 <_Z5benchv+0x260>
 4eb:	e9 11 fd ff ff       	jmpq   201 <_Z5benchv+0xc1>
 4f0:	0f 31                	rdtsc  
 4f2:	48 c1 e2 20          	shl    $0x20,%rdx
 4f6:	48 09 c2             	or     %rax,%rdx
 4f9:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 4ff <_Z5benchv+0x3bf>
 4ff:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 504:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 50c <_Z5benchv+0x3cc>
 50b:	00 
 50c:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 514 <_Z5benchv+0x3d4>
 513:	00 
 514:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 51b <_Z5benchv+0x3db>
 51b:	01 c0                	add    %eax,%eax
 51d:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 523:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 527:	c4 c1 73 5c c5       	vsubsd %xmm13,%xmm1,%xmm0
 52c:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
 530:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 534:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 538:	5b                   	pop    %rbx
 539:	41 5c                	pop    %r12
 53b:	41 5d                	pop    %r13
 53d:	41 5e                	pop    %r14
...
0000000000000550 <_Z6enablev>:
 550:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # 557 <_Z6enablev+0x7>
 557:	7d 03                	jge    55c <_Z6enablev+0xc>
 559:	31 c0                	xor    %eax,%eax
 55b:	c3                   	retq   
 55c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 563 <_Z6enablev+0x13>
 563:	b8 20 00 00 00       	mov    $0x20,%eax
 568:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
...
0000000000000580 <_Z9n_reg_maxv>:
 580:	b8 20 00 00 00       	mov    $0x20,%eax
 585:	c3                   	retq   

...
0000000000000140 <_Z5benchv>:
 ...
 17f:	0f 8e 17 06 00 00    	jle    79c <_Z5benchv+0x65c>
 ...
 1cc:	48 81 c2 60 01 00 00 	add    $0x160,%rdx
 ...
 32a:	0f 83 6c 04 00 00    	jae    79c <_Z5benchv+0x65c>
 ...
 3aa:	c4 22 35 b8 84 8a a0 	vfmadd231ps -0x160(%rdx,%r9,4),%ymm9,%ymm8
 3b1:	fe ff ff 
 3b4:	4a 8d 9c 30 a0 fe ff 	lea    -0x160(%rax,%r14,1),%rbx
 3bb:	ff 
 3bc:	c4 c2 35 b8 bc be a0 	vfmadd231ps -0x160(%r14,%rdi,4),%ymm9,%ymm7
 3c3:	fe ff ff 
 3c6:	c4 c2 35 b8 b4 fe a0 	vfmadd231ps -0x160(%r14,%rdi,8),%ymm9,%ymm6
 3cd:	fe ff ff 
 ...
 409:	c4 22 35 b8 84 8a c0 	vfmadd231ps -0x140(%rdx,%r9,4),%ymm9,%ymm8
 410:	fe ff ff 
 ...
 45b:	c4 22 35 b8 84 8a e0 	vfmadd231ps -0x120(%rdx,%r9,4),%ymm9,%ymm8
 462:	fe ff ff 
 ...
 4ad:	c4 22 35 b8 84 8a 00 	vfmadd231ps -0x100(%rdx,%r9,4),%ymm9,%ymm8
 4b4:	ff ff ff 
 ...
 4ff:	00 00 00 
 502:	c4 22 35 b8 84 8a 20 	vfmadd231ps -0xe0(%rdx,%r9,4),%ymm9,%ymm8
 509:	ff ff ff 
 ...
 554:	00 00 00 
 557:	c4 22 35 b8 84 8a 40 	vfmadd231ps -0xc0(%rdx,%r9,4),%ymm9,%ymm8
 55e:	ff ff ff 
 ...
 5a9:	00 00 00 
 5ac:	c4 22 35 b8 84 8a 60 	vfmadd231ps -0xa0(%rdx,%r9,4),%ymm9,%ymm8
 5b3:	ff ff ff 
 ...
 5fe:	00 00 00 
 601:	c4 22 35 b8 44 8a 80 	vfmadd231ps -0x80(%rdx,%r9,4),%ymm9,%ymm8
 608:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 60e:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 612:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 618:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 61e:	48 01 c3             	add    %rax,%rbx
 621:	48 01 c3             	add    %rax,%rbx
 624:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 62a:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 630:	48 01 c3             	add    %rax,%rbx
 633:	48 01 c3             	add    %rax,%rbx
 636:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 63c:	48 01 c3             	add    %rax,%rbx
 63f:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 645:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 649:	c4 21 7c 10 8c 89 00 	vmovups 0x100(%rcx,%r9,4),%ymm9
 650:	01 00 00 
 653:	c4 22 35 b8 44 8a a0 	vfmadd231ps -0x60(%rdx,%r9,4),%ymm9,%ymm8
 65a:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 660:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 664:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 66a:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 670:	48 01 c3             	add    %rax,%rbx
 673:	48 01 c3             	add    %rax,%rbx
 676:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 67c:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 682:	48 01 c3             	add    %rax,%rbx
 685:	48 01 c3             	add    %rax,%rbx
 688:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 68e:	48 01 c3             	add    %rax,%rbx
 691:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 697:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 69b:	c4 21 7c 10 8c 89 20 	vmovups 0x120(%rcx,%r9,4),%ymm9
 6a2:	01 00 00 
 6a5:	c4 22 35 b8 44 8a c0 	vfmadd231ps -0x40(%rdx,%r9,4),%ymm9,%ymm8
 6ac:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 6b2:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 6b6:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 6bc:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 6c2:	48 01 c3             	add    %rax,%rbx
 6c5:	48 01 c3             	add    %rax,%rbx
 6c8:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 6ce:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 6d4:	48 01 c3             	add    %rax,%rbx
 6d7:	48 01 c3             	add    %rax,%rbx
 6da:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 6e0:	48 01 c3             	add    %rax,%rbx
 6e3:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 6e9:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 6ed:	c4 21 7c 10 8c 89 40 	vmovups 0x140(%rcx,%r9,4),%ymm9
 6f4:	01 00 00 
 6f7:	c4 22 35 b8 44 8a e0 	vfmadd231ps -0x20(%rdx,%r9,4),%ymm9,%ymm8
 6fe:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 704:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 708:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 70e:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 714:	48 01 c3             	add    %rax,%rbx
 717:	48 01 c3             	add    %rax,%rbx
 71a:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 720:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 726:	48 01 c3             	add    %rax,%rbx
 729:	48 01 c3             	add    %rax,%rbx
 72c:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 732:	48 01 c3             	add    %rax,%rbx
 735:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 73b:	48 01 c3             	add    %rax,%rbx
 73e:	c4 21 7c 10 8c 89 60 	vmovups 0x160(%rcx,%r9,4),%ymm9
 745:	01 00 00 
 748:	c4 22 35 b8 04 8a    	vfmadd231ps (%rdx,%r9,4),%ymm9,%ymm8
 74e:	49 83 c1 60          	add    $0x60,%r9
 752:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 758:	48 01 f3             	add    %rsi,%rbx
 75b:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 761:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 767:	48 01 c3             	add    %rax,%rbx
 76a:	48 01 c3             	add    %rax,%rbx
 76d:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 773:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 779:	48 01 c3             	add    %rax,%rbx
 77c:	48 01 c3             	add    %rax,%rbx
 77f:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 785:	48 01 c3             	add    %rax,%rbx
 788:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 78e:	49 39 f9             	cmp    %rdi,%r9
 791:	0f 8c 09 fc ff ff    	jl     3a0 <_Z5benchv+0x260>
 797:	e9 65 fa ff ff       	jmpq   201 <_Z5benchv+0xc1>
 79c:	0f 31                	rdtsc  
 79e:	48 c1 e2 20          	shl    $0x20,%rdx
 7a2:	48 09 c2             	or     %rax,%rdx
 7a5:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 7ab <_Z5benchv+0x66b>
 7ab:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 7b0:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 7b8 <_Z5benchv+0x678>
 7b7:	00 
 7b8:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 7c0 <_Z5benchv+0x680>
 7bf:	00 
 7c0:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 7c7 <_Z5benchv+0x687>
 7c7:	01 c0                	add    %eax,%eax
 7c9:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 7cf:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 7d3:	c4 c1 73 5c c2       	vsubsd %xmm10,%xmm1,%xmm0
 7d8:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
 7dc:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 7e0:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 7e4:	5b                   	pop    %rbx
 7e5:	41 5c                	pop    %r12
 7e7:	41 5d                	pop    %r13
 7e9:	41 5e                	pop    %r14
...
0000000000000810 <_Z9n_reg_maxv>:
 810:	b8 60 00 00 00       	mov    $0x60,%eax
 815:	c3                   	retq   

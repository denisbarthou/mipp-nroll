...
0000000000000140 <_Z5benchv>:
 ...
 17f:	0f 8e c2 05 00 00    	jle    747 <_Z5benchv+0x607>
 ...
 1cc:	48 81 c2 40 01 00 00 	add    $0x140,%rdx
 ...
 32a:	0f 83 17 04 00 00    	jae    747 <_Z5benchv+0x607>
 ...
 3aa:	c4 22 35 b8 84 8a c0 	vfmadd231ps -0x140(%rdx,%r9,4),%ymm9,%ymm8
 3b1:	fe ff ff 
 3b4:	4a 8d 9c 30 c0 fe ff 	lea    -0x140(%rax,%r14,1),%rbx
 3bb:	ff 
 3bc:	c4 c2 35 b8 bc be c0 	vfmadd231ps -0x140(%r14,%rdi,4),%ymm9,%ymm7
 3c3:	fe ff ff 
 3c6:	c4 c2 35 b8 b4 fe c0 	vfmadd231ps -0x140(%r14,%rdi,8),%ymm9,%ymm6
 3cd:	fe ff ff 
 ...
 409:	c4 22 35 b8 84 8a e0 	vfmadd231ps -0x120(%rdx,%r9,4),%ymm9,%ymm8
 410:	fe ff ff 
 ...
 45b:	c4 22 35 b8 84 8a 00 	vfmadd231ps -0x100(%rdx,%r9,4),%ymm9,%ymm8
 462:	ff ff ff 
 ...
 4ad:	c4 22 35 b8 84 8a 20 	vfmadd231ps -0xe0(%rdx,%r9,4),%ymm9,%ymm8
 4b4:	ff ff ff 
 ...
 4ff:	00 00 00 
 502:	c4 22 35 b8 84 8a 40 	vfmadd231ps -0xc0(%rdx,%r9,4),%ymm9,%ymm8
 509:	ff ff ff 
 ...
 554:	00 00 00 
 557:	c4 22 35 b8 84 8a 60 	vfmadd231ps -0xa0(%rdx,%r9,4),%ymm9,%ymm8
 55e:	ff ff ff 
 ...
 5a9:	00 00 00 
 5ac:	c4 22 35 b8 44 8a 80 	vfmadd231ps -0x80(%rdx,%r9,4),%ymm9,%ymm8
 5b3:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 5b9:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 5bd:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 5c3:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 5c9:	48 01 c3             	add    %rax,%rbx
 5cc:	48 01 c3             	add    %rax,%rbx
 5cf:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 5d5:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 5db:	48 01 c3             	add    %rax,%rbx
 5de:	48 01 c3             	add    %rax,%rbx
 5e1:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 5e7:	48 01 c3             	add    %rax,%rbx
 5ea:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 5f0:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 5f4:	c4 21 7c 10 8c 89 e0 	vmovups 0xe0(%rcx,%r9,4),%ymm9
 5fb:	00 00 00 
 5fe:	c4 22 35 b8 44 8a a0 	vfmadd231ps -0x60(%rdx,%r9,4),%ymm9,%ymm8
 605:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 60b:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 60f:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 615:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 61b:	48 01 c3             	add    %rax,%rbx
 61e:	48 01 c3             	add    %rax,%rbx
 621:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 627:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 62d:	48 01 c3             	add    %rax,%rbx
 630:	48 01 c3             	add    %rax,%rbx
 633:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 639:	48 01 c3             	add    %rax,%rbx
 63c:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 642:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 646:	c4 21 7c 10 8c 89 00 	vmovups 0x100(%rcx,%r9,4),%ymm9
 64d:	01 00 00 
 650:	c4 22 35 b8 44 8a c0 	vfmadd231ps -0x40(%rdx,%r9,4),%ymm9,%ymm8
 657:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 65d:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 661:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 667:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 66d:	48 01 c3             	add    %rax,%rbx
 670:	48 01 c3             	add    %rax,%rbx
 673:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 679:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 67f:	48 01 c3             	add    %rax,%rbx
 682:	48 01 c3             	add    %rax,%rbx
 685:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 68b:	48 01 c3             	add    %rax,%rbx
 68e:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 694:	48 8d 1c 03          	lea    (%rbx,%rax,1),%rbx
 698:	c4 21 7c 10 8c 89 20 	vmovups 0x120(%rcx,%r9,4),%ymm9
 69f:	01 00 00 
 6a2:	c4 22 35 b8 44 8a e0 	vfmadd231ps -0x20(%rdx,%r9,4),%ymm9,%ymm8
 6a9:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 6af:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 6b3:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 6b9:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 6bf:	48 01 c3             	add    %rax,%rbx
 6c2:	48 01 c3             	add    %rax,%rbx
 6c5:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 6cb:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 6d1:	48 01 c3             	add    %rax,%rbx
 6d4:	48 01 c3             	add    %rax,%rbx
 6d7:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 6dd:	48 01 c3             	add    %rax,%rbx
 6e0:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 6e6:	48 01 c3             	add    %rax,%rbx
 6e9:	c4 21 7c 10 8c 89 40 	vmovups 0x140(%rcx,%r9,4),%ymm9
 6f0:	01 00 00 
 6f3:	c4 22 35 b8 04 8a    	vfmadd231ps (%rdx,%r9,4),%ymm9,%ymm8
 6f9:	49 83 c1 58          	add    $0x58,%r9
 6fd:	c4 e2 35 b8 3c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm7
 703:	48 01 f3             	add    %rsi,%rbx
 706:	c4 e2 35 b8 34 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm6
 70c:	c4 e2 35 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm5
 712:	48 01 c3             	add    %rax,%rbx
 715:	48 01 c3             	add    %rax,%rbx
 718:	c4 e2 35 b8 24 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm4
 71e:	c4 e2 35 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm9,%ymm3
 724:	48 01 c3             	add    %rax,%rbx
 727:	48 01 c3             	add    %rax,%rbx
 72a:	c4 e2 35 b8 14 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm2
 730:	48 01 c3             	add    %rax,%rbx
 733:	c4 e2 35 b8 0c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm9,%ymm1
 739:	49 39 f9             	cmp    %rdi,%r9
 73c:	0f 8c 5e fc ff ff    	jl     3a0 <_Z5benchv+0x260>
 742:	e9 ba fa ff ff       	jmpq   201 <_Z5benchv+0xc1>
 747:	0f 31                	rdtsc  
 749:	48 c1 e2 20          	shl    $0x20,%rdx
 74d:	48 09 c2             	or     %rax,%rdx
 750:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 756 <_Z5benchv+0x616>
 756:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 75b:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 763 <_Z5benchv+0x623>
 762:	00 
 763:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 76b <_Z5benchv+0x62b>
 76a:	00 
 76b:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 772 <_Z5benchv+0x632>
 772:	01 c0                	add    %eax,%eax
 774:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 77a:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 77e:	c4 c1 73 5c c2       	vsubsd %xmm10,%xmm1,%xmm0
 783:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
...
00000000000007b0 <_Z9n_reg_maxv>:
 7b0:	b8 58 00 00 00       	mov    $0x58,%eax
 7b5:	c3                   	retq   

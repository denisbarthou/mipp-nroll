...
0000000000000150 <_Z5benchv>:
 ...
 18e:	45 85 c9             	test   %r9d,%r9d
 191:	0f 8e 20 04 00 00    	jle    5b7 <_Z5benchv+0x467>
 ...
 1a5:	4c 8b 2d 00 00 00 00 	mov    0x0(%rip),%r13        # 1ac <_Z5benchv+0x5c>
 1ac:	4c 8b 15 00 00 00 00 	mov    0x0(%rip),%r10        # 1b3 <_Z5benchv+0x63>
 1b3:	be 20 00 00 00       	mov    $0x20,%esi
 1b8:	45 31 db             	xor    %r11d,%r11d
 1bb:	48 89 f8             	mov    %rdi,%rax
 1be:	48 8d 0c fd 00 00 00 	lea    0x0(,%rdi,8),%rcx
 1c5:	00 
 1c6:	48 c1 e0 04          	shl    $0x4,%rax
 1ca:	48 8d 0c 89          	lea    (%rcx,%rcx,4),%rcx
 ...
 1e1:	e9 fc 01 00 00       	jmpq   3e2 <_Z5benchv+0x292>
 1e6:	90                   	nop
 1e7:	90                   	nop
 1e8:	90                   	nop
 1e9:	90                   	nop
 ...
 3dc:	0f 83 d5 01 00 00    	jae    5b7 <_Z5benchv+0x467>
 ...
 44b:	c4 41 7c 10 74 9d 20 	vmovups 0x20(%r13,%rbx,4),%ymm14
 452:	c4 41 7c 10 7c 9d 40 	vmovups 0x40(%r13,%rbx,4),%ymm15
 459:	c4 62 15 b8 64 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm13,%ymm12
 460:	c4 62 15 b8 5c b9 c0 	vfmadd231ps -0x40(%rcx,%rdi,4),%ymm13,%ymm11
 467:	c4 62 15 b8 54 f9 c0 	vfmadd231ps -0x40(%rcx,%rdi,8),%ymm13,%ymm10
 46e:	48 8d 4c 08 c0       	lea    -0x40(%rax,%rcx,1),%rcx
 473:	48 01 c1             	add    %rax,%rcx
 476:	c4 62 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm9
 47c:	c4 62 15 b8 04 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm13,%ymm8
 482:	48 01 c1             	add    %rax,%rcx
 485:	48 01 c1             	add    %rax,%rcx
 488:	c4 62 0d b8 64 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm14,%ymm12
 48f:	c4 e2 15 b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm5
 495:	48 01 c1             	add    %rax,%rcx
 498:	c4 e2 15 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm7
 49e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 4a2:	c4 e2 15 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm6
 4a8:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 4ac:	c4 e2 15 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm3
 4b2:	48 01 c1             	add    %rax,%rcx
 4b5:	c4 62 05 b8 24 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm15,%ymm12
 4bb:	48 83 c3 18          	add    $0x18,%rbx
 4bf:	c4 e2 15 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm4
 4c5:	48 01 c1             	add    %rax,%rcx
 4c8:	c4 e2 15 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm2
 4ce:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 4d2:	c4 e2 15 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm13,%ymm1
 4d8:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 4dc:	c4 62 0d b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm11
 4e2:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 4e6:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 4ec:	c4 62 0d b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm9
 4f2:	48 01 c1             	add    %rax,%rcx
 4f5:	48 01 c1             	add    %rax,%rcx
 4f8:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 4fe:	c4 e2 0d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm5
 ...
 513:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 519:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 51d:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 523:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 527:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 52d:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 531:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 537:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 53b:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 541:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 545:	c4 62 05 b8 1c 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm15,%ymm11
 54b:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 54f:	c4 62 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm10
 555:	c4 62 05 b8 0c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm9
 55b:	48 01 c1             	add    %rax,%rcx
 55e:	48 01 c1             	add    %rax,%rcx
 561:	c4 62 05 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm8
 567:	c4 e2 05 b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm15,%ymm5
 56d:	48 01 c1             	add    %rax,%rcx
 570:	48 01 c1             	add    %rax,%rcx
 573:	c4 e2 05 b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm7
 579:	48 01 c1             	add    %rax,%rcx
 57c:	c4 e2 05 b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm6
 582:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 586:	c4 e2 05 b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm3
 58c:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 590:	c4 e2 05 b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm4
 596:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 59a:	c4 e2 05 b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm2
 5a0:	48 01 c1             	add    %rax,%rcx
 5a3:	c4 e2 05 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm15,%ymm1
 5a9:	48 39 fb             	cmp    %rdi,%rbx
 5ac:	0f 8c 8e fe ff ff    	jl     440 <_Z5benchv+0x2f0>
 5b2:	e9 6e fc ff ff       	jmpq   225 <_Z5benchv+0xd5>
 5b7:	0f 31                	rdtsc  
 5b9:	48 c1 e2 20          	shl    $0x20,%rdx
 5bd:	48 09 c2             	or     %rax,%rdx
 5c0:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 5c6 <_Z5benchv+0x476>
 5c6:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 5cb:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 5d3 <_Z5benchv+0x483>
 5d2:	00 
 5d3:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 5db <_Z5benchv+0x48b>
 5da:	00 
 5db:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 5e2 <_Z5benchv+0x492>
 5e2:	01 c0                	add    %eax,%eax
 5e4:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 5ea:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 5ee:	c5 f3 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm1,%xmm0
 5f4:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
...
0000000000000620 <_Z9n_reg_maxv>:
 620:	b8 24 00 00 00       	mov    $0x24,%eax
 625:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e 37 03 00 00    	jle    4c2 <_Z5benchv+0x372>
 ...
 297:	0f 83 25 02 00 00    	jae    4c2 <_Z5benchv+0x372>
 ...
 2ca:	c4 e2 4d b8 ac 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm6,%ymm5
 2d1:	ff ff ff 
 ...
 318:	01 00 00 
 31b:	c4 e2 4d b8 a4 b1 00 	vfmadd231ps -0x100(%rcx,%rsi,4),%ymm6,%ymm4
 322:	ff ff ff 
 325:	c4 e2 4d b8 8c f1 00 	vfmadd231ps -0x100(%rcx,%rsi,8),%ymm6,%ymm1
 32c:	ff ff ff 
 32f:	48 8d 8c 08 00 ff ff 	lea    -0x100(%rax,%rcx,1),%rcx
 336:	ff 
 337:	48 01 c1             	add    %rax,%rcx
 33a:	c4 e2 4d b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm6,%ymm3
 340:	c4 e2 4d b8 14 f1    	vfmadd231ps (%rcx,%rsi,8),%ymm6,%ymm2
 346:	48 01 c1             	add    %rax,%rcx
 349:	48 01 c1             	add    %rax,%rcx
 34c:	c4 e2 45 b8 ac 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm7,%ymm5
 353:	ff ff ff 
 356:	c4 e2 45 b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm7,%ymm4
 35c:	48 01 f9             	add    %rdi,%rcx
 35f:	c4 e2 45 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm7,%ymm1
 365:	c4 e2 45 b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm7,%ymm3
 36b:	48 01 c1             	add    %rax,%rcx
 36e:	48 01 c1             	add    %rax,%rcx
 371:	c4 e2 3d b8 ac 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm8,%ymm5
 378:	ff ff ff 
 37b:	c4 e2 45 b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm7,%ymm2
 381:	48 01 c1             	add    %rax,%rcx
 384:	c4 e2 3d b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm8,%ymm4
 38a:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 38e:	c4 e2 3d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm8,%ymm1
 394:	c4 e2 3d b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm8,%ymm3
 39a:	48 01 c1             	add    %rax,%rcx
 39d:	48 01 c1             	add    %rax,%rcx
 3a0:	c4 e2 35 b8 ac 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm9,%ymm5
 3a7:	ff ff ff 
 3aa:	c4 e2 3d b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm8,%ymm2
 3b0:	48 01 c1             	add    %rax,%rcx
 3b3:	c4 e2 35 b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm9,%ymm4
 3b9:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 3bd:	c4 e2 35 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm9,%ymm1
 3c3:	c4 e2 35 b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm9,%ymm3
 3c9:	48 01 c1             	add    %rax,%rcx
 3cc:	48 01 c1             	add    %rax,%rcx
 3cf:	c4 e2 2d b8 6c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm10,%ymm5
 3d6:	c4 e2 35 b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm9,%ymm2
 3dc:	48 01 c1             	add    %rax,%rcx
 3df:	c4 e2 2d b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm10,%ymm4
 3e5:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 3e9:	c4 e2 2d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm10,%ymm1
 3ef:	c4 e2 2d b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm10,%ymm3
 3f5:	48 01 c1             	add    %rax,%rcx
 3f8:	48 01 c1             	add    %rax,%rcx
 3fb:	c4 e2 25 b8 6c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm11,%ymm5
 402:	c4 e2 2d b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm10,%ymm2
 408:	48 01 c1             	add    %rax,%rcx
 40b:	c4 e2 25 b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm11,%ymm4
 411:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 415:	c4 e2 25 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm11,%ymm1
 41b:	c4 e2 25 b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm11,%ymm3
 421:	48 01 c1             	add    %rax,%rcx
 424:	48 01 c1             	add    %rax,%rcx
 427:	c4 e2 1d b8 6c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm12,%ymm5
 42e:	c4 e2 25 b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm11,%ymm2
 434:	48 01 c1             	add    %rax,%rcx
 437:	c4 e2 1d b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm12,%ymm4
 43d:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 441:	c4 e2 1d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm1
 447:	c4 e2 1d b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm12,%ymm3
 44d:	48 01 c1             	add    %rax,%rcx
 450:	48 01 c1             	add    %rax,%rcx
 453:	c4 e2 15 b8 6c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm13,%ymm5
 45a:	c4 e2 1d b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm2
 460:	48 01 c1             	add    %rax,%rcx
 463:	c4 e2 15 b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm13,%ymm4
 469:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 46d:	c4 e2 15 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm1
 473:	c4 e2 15 b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm13,%ymm3
 479:	48 01 c1             	add    %rax,%rcx
 47c:	48 01 c1             	add    %rax,%rcx
 47f:	c4 e2 0d b8 2c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm14,%ymm5
 485:	48 83 c3 48          	add    $0x48,%rbx
 489:	c4 e2 15 b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm2
 48f:	48 01 c1             	add    %rax,%rcx
 492:	c4 e2 0d b8 24 0f    	vfmadd231ps (%rdi,%rcx,1),%ymm14,%ymm4
 498:	48 8d 0c 39          	lea    (%rcx,%rdi,1),%rcx
 49c:	c4 e2 0d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm14,%ymm1
 4a2:	c4 e2 0d b8 1c f1    	vfmadd231ps (%rcx,%rsi,8),%ymm14,%ymm3
 4a8:	48 01 c1             	add    %rax,%rcx
 4ab:	48 01 c1             	add    %rax,%rcx
 4ae:	c4 e2 0d b8 14 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm14,%ymm2
 4b4:	48 39 f3             	cmp    %rsi,%rbx
 4b7:	0f 8c 03 fe ff ff    	jl     2c0 <_Z5benchv+0x170>
 4bd:	e9 22 fd ff ff       	jmpq   1e4 <_Z5benchv+0x94>
 4c2:	0f 31                	rdtsc  
 4c4:	48 c1 e2 20          	shl    $0x20,%rdx
 4c8:	48 09 c2             	or     %rax,%rdx
 4cb:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 4d1 <_Z5benchv+0x381>
 4d1:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 4d6:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 4de <_Z5benchv+0x38e>
 4dd:	00 
 4de:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 4e6 <_Z5benchv+0x396>
 4e5:	00 

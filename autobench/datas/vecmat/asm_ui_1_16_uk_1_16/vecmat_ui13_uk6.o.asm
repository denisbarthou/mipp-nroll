...
vecmat_ui13_uk6.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e ce 05 00 00    	jle    759 <_Z5benchv+0x609>
 ...
 1be:	00 
 1bf:	48 81 c2 a0 00 00 00 	add    $0xa0,%rdx
 ...
 3e5:	0f 83 6e 03 00 00    	jae    759 <_Z5benchv+0x609>
 ...
 43a:	c4 62 0d b8 ac 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm14,%ymm13
 441:	ff ff ff 
 444:	c4 62 0d b8 a4 b9 60 	vfmadd231ps -0xa0(%rcx,%rdi,4),%ymm14,%ymm12
 44b:	ff ff ff 
 44e:	c4 62 0d b8 8c f9 60 	vfmadd231ps -0xa0(%rcx,%rdi,8),%ymm14,%ymm9
 455:	ff ff ff 
 458:	48 8d 8c 08 60 ff ff 	lea    -0xa0(%rax,%rcx,1),%rcx
 45f:	ff 
 ...
 4cb:	c4 62 0d b8 6c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm14,%ymm13
 4d2:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 4d8:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 4dc:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 4e2:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 4e8:	48 01 c1             	add    %rax,%rcx
 4eb:	48 01 c1             	add    %rax,%rcx
 4ee:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 4f4:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 4fa:	48 01 c1             	add    %rax,%rcx
 4fd:	48 01 c1             	add    %rax,%rcx
 500:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 506:	48 01 c1             	add    %rax,%rcx
 509:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 50f:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 513:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 519:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 51d:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 523:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 527:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 52d:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 531:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 537:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 53b:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 541:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 545:	c4 41 7c 10 74 9e 40 	vmovups 0x40(%r14,%rbx,4),%ymm14
 54c:	c4 62 0d b8 6c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm14,%ymm13
 553:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 559:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 55d:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 563:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 569:	48 01 c1             	add    %rax,%rcx
 56c:	48 01 c1             	add    %rax,%rcx
 56f:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 575:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 57b:	48 01 c1             	add    %rax,%rcx
 57e:	48 01 c1             	add    %rax,%rcx
 581:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 587:	48 01 c1             	add    %rax,%rcx
 58a:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 590:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 594:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 59a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 59e:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 5a4:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 5a8:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 5ae:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 5b2:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 5b8:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 5bc:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 5c2:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 5c6:	c4 41 7c 10 74 9e 60 	vmovups 0x60(%r14,%rbx,4),%ymm14
 5cd:	c4 62 0d b8 6c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm14,%ymm13
 5d4:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 5da:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 5de:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 5e4:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 5ea:	48 01 c1             	add    %rax,%rcx
 5ed:	48 01 c1             	add    %rax,%rcx
 5f0:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 5f6:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 5fc:	48 01 c1             	add    %rax,%rcx
 5ff:	48 01 c1             	add    %rax,%rcx
 602:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 608:	48 01 c1             	add    %rax,%rcx
 60b:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 611:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 615:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 61b:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 61f:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 625:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 629:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 62f:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 633:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 639:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 63d:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 643:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 647:	c4 41 7c 10 b4 9e 80 	vmovups 0x80(%r14,%rbx,4),%ymm14
 64e:	00 00 00 
 651:	c4 62 0d b8 6c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm14,%ymm13
 658:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 65e:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 662:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 668:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 66e:	48 01 c1             	add    %rax,%rcx
 671:	48 01 c1             	add    %rax,%rcx
 674:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 67a:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 680:	48 01 c1             	add    %rax,%rcx
 683:	48 01 c1             	add    %rax,%rcx
 686:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 68c:	48 01 c1             	add    %rax,%rcx
 68f:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 695:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 699:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 69f:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 6a3:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 6a9:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 6ad:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 6b3:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 6b7:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 6bd:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 6c1:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 6c7:	48 01 c1             	add    %rax,%rcx
 6ca:	c4 41 7c 10 b4 9e a0 	vmovups 0xa0(%r14,%rbx,4),%ymm14
 6d1:	00 00 00 
 6d4:	c4 62 0d b8 2c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm14,%ymm13
 6da:	48 83 c3 30          	add    $0x30,%rbx
 6de:	c4 62 0d b8 24 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm14,%ymm12
 6e4:	48 01 f1             	add    %rsi,%rcx
 6e7:	c4 62 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm9
 6ed:	c4 62 0d b8 1c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm11
 6f3:	48 01 c1             	add    %rax,%rcx
 6f6:	48 01 c1             	add    %rax,%rcx
 6f9:	c4 62 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm10
 6ff:	c4 e2 0d b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm14,%ymm7
 705:	48 01 c1             	add    %rax,%rcx
 708:	48 01 c1             	add    %rax,%rcx
 70b:	c4 62 0d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm8
 711:	48 01 c1             	add    %rax,%rcx
 714:	c4 e2 0d b8 34 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm6
 71a:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 71e:	c4 e2 0d b8 2c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm5
 724:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 728:	c4 e2 0d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm4
 72e:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 732:	c4 e2 0d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm1
 738:	48 8d 0c 01          	lea    (%rcx,%rax,1),%rcx
 73c:	c4 e2 0d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm3
 742:	48 01 c1             	add    %rax,%rcx
 745:	c4 e2 0d b8 14 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm14,%ymm2
 74b:	48 39 fb             	cmp    %rdi,%rbx
 74e:	0f 8c dc fc ff ff    	jl     430 <_Z5benchv+0x2e0>
 754:	e9 b1 fa ff ff       	jmpq   20a <_Z5benchv+0xba>
 759:	0f 31                	rdtsc  
 75b:	48 c1 e2 20          	shl    $0x20,%rdx
 75f:	48 09 c2             	or     %rax,%rdx
 762:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 768 <_Z5benchv+0x618>
 768:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 76d:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 775 <_Z5benchv+0x625>
 774:	00 
 775:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 77d <_Z5benchv+0x62d>
 77c:	00 
 77d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 784 <_Z5benchv+0x634>
 784:	01 c0                	add    %eax,%eax
 786:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 78c:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 790:	c4 c1 73 5c c7       	vsubsd %xmm15,%xmm1,%xmm0
 795:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 799:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 79d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 7a1:	5b                   	pop    %rbx
 7a2:	41 5e                	pop    %r14
...
00000000000007c0 <_Z9n_reg_maxv>:
 7c0:	b8 4e 00 00 00       	mov    $0x4e,%eax
 7c5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui13_uk6.cpp+0x9a>
  96:	01 00 00 00 

...
vecmat_ui3_uk3.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
 ...
 193:	0f 8e 42 01 00 00    	jle    2db <_Z5benchv+0x17b>
 ...
 1c4:	48 8d 44 fa 40       	lea    0x40(%rdx,%rdi,8),%rax
 1c9:	48 8d 74 ba 40       	lea    0x40(%rdx,%rdi,4),%rsi
 1ce:	48 83 c2 40          	add    $0x40,%rdx
 1d2:	e9 8f 00 00 00       	jmpq   266 <_Z5benchv+0x106>
 1d7:	90                   	nop
 1d8:	90                   	nop
 1d9:	90                   	nop
 1da:	90                   	nop
 ...
 264:	73 75                	jae    2db <_Z5benchv+0x17b>
 266:	85 ff                	test   %edi,%edi
 268:	0f 8e 72 ff ff ff    	jle    1e0 <_Z5benchv+0x80>
 26e:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 272:	31 db                	xor    %ebx,%ebx
 274:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 278:	c5 f1 57 c9          	vxorpd %xmm1,%xmm1,%xmm1
 27c:	90                   	nop
 27d:	90                   	nop
 27e:	90                   	nop
 27f:	90                   	nop
 280:	c5 fc 10 24 99       	vmovups (%rcx,%rbx,4),%ymm4
 285:	c4 e2 5d b8 5c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm4,%ymm3
 28c:	c4 e2 5d b8 54 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm4,%ymm2
 293:	c4 e2 5d b8 4c 98 c0 	vfmadd231ps -0x40(%rax,%rbx,4),%ymm4,%ymm1
 29a:	c5 fc 10 6c 99 20    	vmovups 0x20(%rcx,%rbx,4),%ymm5
 2a0:	c5 fc 10 74 99 40    	vmovups 0x40(%rcx,%rbx,4),%ymm6
 2a6:	c4 e2 55 b8 5c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm5,%ymm3
 2ad:	c4 e2 55 b8 54 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm5,%ymm2
 2b4:	c4 e2 55 b8 4c 98 e0 	vfmadd231ps -0x20(%rax,%rbx,4),%ymm5,%ymm1
 2bb:	c4 e2 4d b8 1c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm6,%ymm3
 2c1:	c4 e2 4d b8 14 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm6,%ymm2
 2c7:	c4 e2 4d b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm6,%ymm1
 2cd:	48 83 c3 18          	add    $0x18,%rbx
 2d1:	48 39 fb             	cmp    %rdi,%rbx
 2d4:	7c aa                	jl     280 <_Z5benchv+0x120>
 2d6:	e9 11 ff ff ff       	jmpq   1ec <_Z5benchv+0x8c>
 2db:	0f 31                	rdtsc  
 2dd:	48 c1 e2 20          	shl    $0x20,%rdx
 2e1:	48 09 c2             	or     %rax,%rdx
 2e4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2ea <_Z5benchv+0x18a>
 2ea:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2ef:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2f7 <_Z5benchv+0x197>
 2f6:	00 
 2f7:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2ff <_Z5benchv+0x19f>
 2fe:	00 
 2ff:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 306 <_Z5benchv+0x1a6>
 306:	01 c0                	add    %eax,%eax
 308:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 30e:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 312:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 316:	c5 c2 2a c8          	vcvtsi2ss %eax,%xmm7,%xmm1
 31a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 31e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 322:	5b                   	pop    %rbx
 323:	c5 f8 77             	vzeroupper 
 326:	c3                   	retq   
 327:	90                   	nop
 328:	90                   	nop
 329:	90                   	nop
...
0000000000000330 <_Z6enablev>:
 330:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 337 <_Z6enablev+0x7>
 337:	7d 03                	jge    33c <_Z6enablev+0xc>
 339:	31 c0                	xor    %eax,%eax
 33b:	c3                   	retq   
 33c:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 343 <_Z6enablev+0x13>
 343:	b8 18 00 00 00       	mov    $0x18,%eax
 348:	b9 fd ff ff ff       	mov    $0xfffffffd,%ecx
 34d:	0f 45 c8             	cmovne %eax,%ecx
 350:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 356 <_Z6enablev+0x26>
 356:	0f 9e c0             	setle  %al
 359:	c3                   	retq   
 35a:	90                   	nop
 35b:	90                   	nop
 35c:	90                   	nop
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui3_uk3.cpp+0x9a>
  96:	01 00 00 00 

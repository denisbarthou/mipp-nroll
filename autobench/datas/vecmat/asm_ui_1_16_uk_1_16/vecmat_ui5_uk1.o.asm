...
vecmat_ui5_uk1.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e 62 01 00 00    	jle    2ed <_Z5benchv+0x19d>
 18b:	4c 8b 35 00 00 00 00 	mov    0x0(%rip),%r14        # 192 <_Z5benchv+0x42>
 ...
 1aa:	48 8d 04 b5 00 00 00 	lea    0x0(,%rsi,4),%rax
 1b1:	00 
 1b2:	4c 8d 0c 80          	lea    (%rax,%rax,4),%r9
 1b6:	e9 ce 00 00 00       	jmpq   289 <_Z5benchv+0x139>
 1bb:	90                   	nop
 1bc:	90                   	nop
 1bd:	90                   	nop
 1be:	90                   	nop
 ...
 287:	73 64                	jae    2ed <_Z5benchv+0x19d>
 289:	85 f6                	test   %esi,%esi
 28b:	0f 8e 2f ff ff ff    	jle    1c0 <_Z5benchv+0x70>
 291:	c5 d0 57 ed          	vxorps %xmm5,%xmm5,%xmm5
 295:	31 ff                	xor    %edi,%edi
 297:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
 29b:	c5 f1 57 c9          	vxorpd %xmm1,%xmm1,%xmm1
 29f:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
 2a3:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 2a7:	90                   	nop
 2a8:	90                   	nop
 2a9:	90                   	nop
 2aa:	90                   	nop
 ...
 2ae:	90                   	nop
 2af:	90                   	nop
 2b0:	48 8d 1c ba          	lea    (%rdx,%rdi,4),%rbx
 2b4:	c4 c1 7c 10 34 be    	vmovups (%r14,%rdi,4),%ymm6
 2ba:	c4 e2 4d b8 2c ba    	vfmadd231ps (%rdx,%rdi,4),%ymm6,%ymm5
 2c0:	48 83 c7 08          	add    $0x8,%rdi
 2c4:	48 8d 0c 03          	lea    (%rbx,%rax,1),%rcx
 2c8:	c4 e2 4d b8 24 b3    	vfmadd231ps (%rbx,%rsi,4),%ymm6,%ymm4
 2ce:	c4 e2 4d b8 0c f3    	vfmadd231ps (%rbx,%rsi,8),%ymm6,%ymm1
 2d4:	48 01 c1             	add    %rax,%rcx
 2d7:	c4 e2 4d b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm6,%ymm3
 2dd:	c4 e2 4d b8 14 f1    	vfmadd231ps (%rcx,%rsi,8),%ymm6,%ymm2
 2e3:	48 39 f7             	cmp    %rsi,%rdi
 2e6:	7c c8                	jl     2b0 <_Z5benchv+0x160>
 2e8:	e9 e7 fe ff ff       	jmpq   1d4 <_Z5benchv+0x84>
 2ed:	0f 31                	rdtsc  
 2ef:	48 c1 e2 20          	shl    $0x20,%rdx
 2f3:	48 09 c2             	or     %rax,%rdx
 2f6:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2fc <_Z5benchv+0x1ac>
 2fc:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 301:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 309 <_Z5benchv+0x1b9>
 308:	00 
 309:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 311 <_Z5benchv+0x1c1>
 310:	00 
 311:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 318 <_Z5benchv+0x1c8>
 318:	01 c0                	add    %eax,%eax
 31a:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 320:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 324:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 328:	c5 c2 2a c8          	vcvtsi2ss %eax,%xmm7,%xmm1
 32c:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 330:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 334:	5b                   	pop    %rbx
 335:	41 5e                	pop    %r14
 337:	c5 f8 77             	vzeroupper 
 33a:	c3                   	retq   
 33b:	90                   	nop
 33c:	90                   	nop
 33d:	90                   	nop
...
0000000000000340 <_Z6enablev>:
 340:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 347 <_Z6enablev+0x7>
 347:	7d 03                	jge    34c <_Z6enablev+0xc>
 349:	31 c0                	xor    %eax,%eax
 34b:	c3                   	retq   
 34c:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 353 <_Z6enablev+0x13>
 353:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 357:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 35d <_Z6enablev+0x1d>
 35d:	0f 9e c0             	setle  %al
 360:	c3                   	retq   
 361:	90                   	nop
 362:	90                   	nop
 363:	90                   	nop
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui5_uk1.cpp+0x9a>
  96:	01 00 00 00 

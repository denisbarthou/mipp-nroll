...
0000000000000140 <_Z5benchv>:
 ...
 17b:	0f 8e d4 01 00 00    	jle    355 <_Z5benchv+0x215>
 ...
 1ab:	48 8d 44 82 60       	lea    0x60(%rdx,%rax,4),%rax
 1b0:	4a 8d 74 da 60       	lea    0x60(%rdx,%r11,8),%rsi
 1b5:	4a 8d 7c 9a 60       	lea    0x60(%rdx,%r11,4),%rdi
 1ba:	48 83 c2 60          	add    $0x60,%rdx
 ...
 27b:	0f 83 d4 00 00 00    	jae    355 <_Z5benchv+0x215>
 ...
 2c5:	c4 e2 55 b8 64 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm5,%ymm4
 2cc:	c4 e2 55 b8 5c 9f a0 	vfmadd231ps -0x60(%rdi,%rbx,4),%ymm5,%ymm3
 2d3:	c4 e2 55 b8 54 9e a0 	vfmadd231ps -0x60(%rsi,%rbx,4),%ymm5,%ymm2
 2da:	c4 e2 55 b8 4c 98 a0 	vfmadd231ps -0x60(%rax,%rbx,4),%ymm5,%ymm1
 2e1:	c5 fc 10 74 99 20    	vmovups 0x20(%rcx,%rbx,4),%ymm6
 2e7:	c5 fc 10 7c 99 40    	vmovups 0x40(%rcx,%rbx,4),%ymm7
 2ed:	c5 7c 10 44 99 60    	vmovups 0x60(%rcx,%rbx,4),%ymm8
 2f3:	c4 e2 4d b8 64 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm6,%ymm4
 2fa:	c4 e2 4d b8 5c 9f c0 	vfmadd231ps -0x40(%rdi,%rbx,4),%ymm6,%ymm3
 301:	c4 e2 4d b8 54 9e c0 	vfmadd231ps -0x40(%rsi,%rbx,4),%ymm6,%ymm2
 308:	c4 e2 4d b8 4c 98 c0 	vfmadd231ps -0x40(%rax,%rbx,4),%ymm6,%ymm1
 30f:	c4 e2 45 b8 64 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm7,%ymm4
 316:	c4 e2 45 b8 5c 9f e0 	vfmadd231ps -0x20(%rdi,%rbx,4),%ymm7,%ymm3
 31d:	c4 e2 45 b8 54 9e e0 	vfmadd231ps -0x20(%rsi,%rbx,4),%ymm7,%ymm2
 324:	c4 e2 45 b8 4c 98 e0 	vfmadd231ps -0x20(%rax,%rbx,4),%ymm7,%ymm1
 32b:	c4 e2 3d b8 24 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm8,%ymm4
 331:	c4 e2 3d b8 1c 9f    	vfmadd231ps (%rdi,%rbx,4),%ymm8,%ymm3
 337:	c4 e2 3d b8 14 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm8,%ymm2
 33d:	c4 e2 3d b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm8,%ymm1
 343:	48 83 c3 20          	add    $0x20,%rbx
 347:	4c 39 db             	cmp    %r11,%rbx
 34a:	0f 8c 70 ff ff ff    	jl     2c0 <_Z5benchv+0x180>
 350:	e9 8b fe ff ff       	jmpq   1e0 <_Z5benchv+0xa0>
 355:	0f 31                	rdtsc  
 357:	48 c1 e2 20          	shl    $0x20,%rdx
 35b:	48 09 c2             	or     %rax,%rdx
 35e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 364 <_Z5benchv+0x224>
 364:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 369:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 371 <_Z5benchv+0x231>
 370:	00 
 371:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 379 <_Z5benchv+0x239>
 378:	00 
 379:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 380 <_Z5benchv+0x240>
 380:	01 c0                	add    %eax,%eax
 382:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 388:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 38c:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 390:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
...
00000000000003b0 <_Z6enablev>:
 3b0:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 3b7 <_Z6enablev+0x7>
 3b7:	7d 03                	jge    3bc <_Z6enablev+0xc>
 3b9:	31 c0                	xor    %eax,%eax
 3bb:	c3                   	retq   
 3bc:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3c3 <_Z6enablev+0x13>
 3c3:	b8 20 00 00 00       	mov    $0x20,%eax
 3c8:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 3cd:	0f 45 c8             	cmovne %eax,%ecx
 3d0:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3d6 <_Z6enablev+0x26>
 3d6:	0f 9e c0             	setle  %al
 3d9:	c3                   	retq   
 3da:	90                   	nop
 3db:	90                   	nop
 3dc:	90                   	nop

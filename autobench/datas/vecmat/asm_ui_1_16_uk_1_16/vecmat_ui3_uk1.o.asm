...
0000000000000150 <_Z5benchv>:
 ...
 183:	0f 8e 0c 01 00 00    	jle    295 <_Z5benchv+0x145>
 ...
 1b4:	48 8d 04 fa          	lea    (%rdx,%rdi,8),%rax
 1b8:	48 8d 34 ba          	lea    (%rdx,%rdi,4),%rsi
 1bc:	e9 95 00 00 00       	jmpq   256 <_Z5benchv+0x106>
 1c1:	90                   	nop
 1c2:	90                   	nop
 1c3:	90                   	nop
 1c4:	90                   	nop
 ...
 254:	73 3f                	jae    295 <_Z5benchv+0x145>
 ...
 275:	c4 e2 5d b8 1c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm4,%ymm3
 27b:	c4 e2 5d b8 14 9e    	vfmadd231ps (%rsi,%rbx,4),%ymm4,%ymm2
 281:	c4 e2 5d b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm4,%ymm1
 287:	48 83 c3 08          	add    $0x8,%rbx
 28b:	48 39 fb             	cmp    %rdi,%rbx
 28e:	7c e0                	jl     270 <_Z5benchv+0x120>
 290:	e9 47 ff ff ff       	jmpq   1dc <_Z5benchv+0x8c>
 295:	0f 31                	rdtsc  
 297:	48 c1 e2 20          	shl    $0x20,%rdx
 29b:	48 09 c2             	or     %rax,%rdx
 29e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2a4 <_Z5benchv+0x154>
 2a4:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2a9:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2b1 <_Z5benchv+0x161>
 2b0:	00 
 2b1:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2b9 <_Z5benchv+0x169>
 2b8:	00 
 2b9:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2c0 <_Z5benchv+0x170>
 ...
 2d0:	c5 d2 2a c8          	vcvtsi2ss %eax,%xmm5,%xmm1
...
00000000000002f0 <_Z6enablev>:
 2f0:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 2f7 <_Z6enablev+0x7>
 2f7:	7d 03                	jge    2fc <_Z6enablev+0xc>
 2f9:	31 c0                	xor    %eax,%eax
 2fb:	c3                   	retq   
 2fc:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 303 <_Z6enablev+0x13>
 303:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 307:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 30d <_Z6enablev+0x1d>
 30d:	0f 9e c0             	setle  %al
 310:	c3                   	retq   
 311:	90                   	nop
 312:	90                   	nop
 313:	90                   	nop

...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 2f 01 00 00    	jle    2b7 <_Z5benchv+0x167>
 ...
 1ad:	00 
 1ae:	48 81 c2 20 01 00 00 	add    $0x120,%rdx
 ...
 1ef:	0f 83 c2 00 00 00    	jae    2b7 <_Z5benchv+0x167>
 1f5:	85 f6                	test   %esi,%esi
 1f7:	7e c7                	jle    1c0 <_Z5benchv+0x70>
 1f9:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 1fd:	31 c0                	xor    %eax,%eax
 1ff:	90                   	nop
 200:	c5 fc 10 8c 82 e0 fe 	vmovups -0x120(%rdx,%rax,4),%ymm1
 207:	ff ff 
 209:	c4 e2 6d 98 0c 81    	vfmadd132ps (%rcx,%rax,4),%ymm2,%ymm1
 20f:	c5 fc 10 9c 82 00 ff 	vmovups -0x100(%rdx,%rax,4),%ymm3
 216:	ff ff 
 218:	c5 fc 10 a4 82 20 ff 	vmovups -0xe0(%rdx,%rax,4),%ymm4
 21f:	ff ff 
 221:	c5 fc 10 ac 82 40 ff 	vmovups -0xc0(%rdx,%rax,4),%ymm5
 228:	ff ff 
 22a:	c5 fc 10 b4 82 60 ff 	vmovups -0xa0(%rdx,%rax,4),%ymm6
 231:	ff ff 
 233:	c5 fc 10 7c 82 80    	vmovups -0x80(%rdx,%rax,4),%ymm7
 239:	c5 7c 10 44 82 a0    	vmovups -0x60(%rdx,%rax,4),%ymm8
 23f:	c5 7c 10 4c 82 c0    	vmovups -0x40(%rdx,%rax,4),%ymm9
 245:	c5 7c 10 54 82 e0    	vmovups -0x20(%rdx,%rax,4),%ymm10
 24b:	c5 7c 10 1c 82       	vmovups (%rdx,%rax,4),%ymm11
 250:	c4 e2 65 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm3,%ymm1
 257:	c4 e2 5d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm1
 25e:	c4 e2 55 b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm5,%ymm1
 265:	c4 e2 4d b8 8c 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm1
 26c:	00 00 00 
 26f:	c4 e2 45 b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm1
 276:	00 00 00 
 279:	c4 e2 3d b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm1
 280:	00 00 00 
 283:	c4 e2 35 b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm9,%ymm1
 28a:	00 00 00 
 28d:	c4 e2 2d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm10,%ymm1
 294:	01 00 00 
 297:	c4 e2 25 b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm1
 29e:	01 00 00 
 2a1:	48 83 c0 50          	add    $0x50,%rax
 2a5:	c5 fc 28 d1          	vmovaps %ymm1,%ymm2
 2a9:	48 39 f0             	cmp    %rsi,%rax
 2ac:	0f 8c 4e ff ff ff    	jl     200 <_Z5benchv+0xb0>
 2b2:	e9 0d ff ff ff       	jmpq   1c4 <_Z5benchv+0x74>
 2b7:	0f 31                	rdtsc  
 2b9:	48 c1 e2 20          	shl    $0x20,%rdx
 2bd:	48 09 c2             	or     %rax,%rdx
 2c0:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2c6 <_Z5benchv+0x176>
 2c6:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2cb:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2d3 <_Z5benchv+0x183>
 2d2:	00 
 2d3:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2db <_Z5benchv+0x18b>
 2da:	00 
 2db:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2e2 <_Z5benchv+0x192>
 2e2:	01 c0                	add    %eax,%eax
 2e4:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 2ea:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 2ee:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 2f2:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 2f6:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 2fa:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 2fe:	c5 f8 77             	vzeroupper 
 301:	c3                   	retq   
 302:	90                   	nop
 303:	90                   	nop
 304:	90                   	nop
...
0000000000000310 <_Z6enablev>:
 ...
 320:	b8 50 00 00 00       	mov    $0x50,%eax
 325:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx

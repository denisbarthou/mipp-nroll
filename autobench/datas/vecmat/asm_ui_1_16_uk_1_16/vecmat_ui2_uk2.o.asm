...
vecmat_ui2_uk2.o:     file format elf64-x86-64
...
0000000000000140 <_Z5benchv>:
 ...
 173:	0f 8e da 00 00 00    	jle    253 <_Z5benchv+0x113>
 ...
 19e:	00 
 19f:	48 8d 44 ba 20       	lea    0x20(%rdx,%rdi,4),%rax
 1a4:	48 83 c2 20          	add    $0x20,%rdx
 ...
 209:	73 48                	jae    253 <_Z5benchv+0x113>
 ...
 225:	c4 e2 65 b8 54 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm3,%ymm2
 22c:	c4 e2 65 b8 4c 98 e0 	vfmadd231ps -0x20(%rax,%rbx,4),%ymm3,%ymm1
 233:	c5 fc 10 64 99 20    	vmovups 0x20(%rcx,%rbx,4),%ymm4
 239:	c4 e2 5d b8 14 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm4,%ymm2
 23f:	c4 e2 5d b8 0c 98    	vfmadd231ps (%rax,%rbx,4),%ymm4,%ymm1
 245:	48 83 c3 10          	add    $0x10,%rbx
 249:	48 39 fb             	cmp    %rdi,%rbx
 24c:	7c d2                	jl     220 <_Z5benchv+0xe0>
 24e:	e9 65 ff ff ff       	jmpq   1b8 <_Z5benchv+0x78>
 253:	0f 31                	rdtsc  
 ...
 28e:	c5 d2 2a c8          	vcvtsi2ss %eax,%xmm5,%xmm1
...
00000000000002a0 <_Z6enablev>:
 2a0:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 2a7 <_Z6enablev+0x7>
 2a7:	7d 03                	jge    2ac <_Z6enablev+0xc>
 2a9:	31 c0                	xor    %eax,%eax
 2ab:	c3                   	retq   
 2ac:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2b3 <_Z6enablev+0x13>
 2b3:	b8 10 00 00 00       	mov    $0x10,%eax
 2b8:	b9 fe ff ff ff       	mov    $0xfffffffe,%ecx
 2bd:	0f 45 c8             	cmovne %eax,%ecx
 2c0:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 2c6 <_Z6enablev+0x26>
 2c6:	0f 9e c0             	setle  %al
 2c9:	c3                   	retq   
 2ca:	90                   	nop
 2cb:	90                   	nop
 2cc:	90                   	nop
...
0000000000000000 <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_vecmat_ui2_uk2.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e 76 05 00 00    	jle    701 <_Z5benchv+0x5b1>
 ...
 2f5:	0f 83 06 04 00 00    	jae    701 <_Z5benchv+0x5b1>
 ...
 33a:	c4 e2 3d b8 bc 9a 80 	vfmadd231ps -0x180(%rdx,%rbx,4),%ymm8,%ymm7
 341:	fe ff ff 
 344:	c4 e2 3d b8 b4 b9 80 	vfmadd231ps -0x180(%rcx,%rdi,4),%ymm8,%ymm6
 34b:	fe ff ff 
 34e:	c4 e2 3d b8 9c f9 80 	vfmadd231ps -0x180(%rcx,%rdi,8),%ymm8,%ymm3
 355:	fe ff ff 
 358:	48 8d 8c 08 80 fe ff 	lea    -0x180(%rax,%rcx,1),%rcx
 35f:	ff 
 ...
 38f:	c4 e2 3d b8 bc 9a a0 	vfmadd231ps -0x160(%rdx,%rbx,4),%ymm8,%ymm7
 396:	fe ff ff 
 ...
 3d7:	c4 e2 3d b8 bc 9a c0 	vfmadd231ps -0x140(%rdx,%rbx,4),%ymm8,%ymm7
 3de:	fe ff ff 
 ...
 41f:	c4 e2 3d b8 bc 9a e0 	vfmadd231ps -0x120(%rdx,%rbx,4),%ymm8,%ymm7
 426:	fe ff ff 
 ...
 467:	00 00 00 
 46a:	c4 e2 3d b8 bc 9a 00 	vfmadd231ps -0x100(%rdx,%rbx,4),%ymm8,%ymm7
 471:	ff ff ff 
 ...
 4b2:	00 00 00 
 4b5:	c4 e2 3d b8 bc 9a 20 	vfmadd231ps -0xe0(%rdx,%rbx,4),%ymm8,%ymm7
 4bc:	ff ff ff 
 ...
 4f6:	c4 41 7c 10 84 9e c0 	vmovups 0xc0(%r14,%rbx,4),%ymm8
 4fd:	00 00 00 
 500:	c4 e2 3d b8 bc 9a 40 	vfmadd231ps -0xc0(%rdx,%rbx,4),%ymm8,%ymm7
 507:	ff ff ff 
 ...
 541:	c4 41 7c 10 84 9e e0 	vmovups 0xe0(%r14,%rbx,4),%ymm8
 548:	00 00 00 
 54b:	c4 e2 3d b8 bc 9a 60 	vfmadd231ps -0xa0(%rdx,%rbx,4),%ymm8,%ymm7
 552:	ff ff ff 
 ...
 58c:	c4 41 7c 10 84 9e 00 	vmovups 0x100(%r14,%rbx,4),%ymm8
 593:	01 00 00 
 596:	c4 e2 3d b8 7c 9a 80 	vfmadd231ps -0x80(%rdx,%rbx,4),%ymm8,%ymm7
 59d:	c4 e2 3d b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm8,%ymm6
 5a3:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 5a7:	c4 e2 3d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm3
 5ad:	c4 e2 3d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm5
 5b3:	48 01 c1             	add    %rax,%rcx
 5b6:	48 01 c1             	add    %rax,%rcx
 5b9:	c4 e2 3d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm4
 5bf:	c4 e2 3d b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm2
 5c5:	48 01 c1             	add    %rax,%rcx
 5c8:	48 01 c1             	add    %rax,%rcx
 5cb:	c4 e2 3d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm1
 5d1:	48 01 c1             	add    %rax,%rcx
 5d4:	c4 41 7c 10 84 9e 20 	vmovups 0x120(%r14,%rbx,4),%ymm8
 5db:	01 00 00 
 5de:	c4 e2 3d b8 7c 9a a0 	vfmadd231ps -0x60(%rdx,%rbx,4),%ymm8,%ymm7
 5e5:	c4 e2 3d b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm8,%ymm6
 5eb:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 5ef:	c4 e2 3d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm3
 5f5:	c4 e2 3d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm5
 5fb:	48 01 c1             	add    %rax,%rcx
 5fe:	48 01 c1             	add    %rax,%rcx
 601:	c4 e2 3d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm4
 607:	c4 e2 3d b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm2
 60d:	48 01 c1             	add    %rax,%rcx
 610:	48 01 c1             	add    %rax,%rcx
 613:	c4 e2 3d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm1
 619:	48 01 c1             	add    %rax,%rcx
 61c:	c4 41 7c 10 84 9e 40 	vmovups 0x140(%r14,%rbx,4),%ymm8
 623:	01 00 00 
 626:	c4 e2 3d b8 7c 9a c0 	vfmadd231ps -0x40(%rdx,%rbx,4),%ymm8,%ymm7
 62d:	c4 e2 3d b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm8,%ymm6
 633:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 637:	c4 e2 3d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm3
 63d:	c4 e2 3d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm5
 643:	48 01 c1             	add    %rax,%rcx
 646:	48 01 c1             	add    %rax,%rcx
 649:	c4 e2 3d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm4
 64f:	c4 e2 3d b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm2
 655:	48 01 c1             	add    %rax,%rcx
 658:	48 01 c1             	add    %rax,%rcx
 65b:	c4 e2 3d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm1
 661:	48 01 c1             	add    %rax,%rcx
 664:	c4 41 7c 10 84 9e 60 	vmovups 0x160(%r14,%rbx,4),%ymm8
 66b:	01 00 00 
 66e:	c4 e2 3d b8 7c 9a e0 	vfmadd231ps -0x20(%rdx,%rbx,4),%ymm8,%ymm7
 675:	c4 e2 3d b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm8,%ymm6
 67b:	48 8d 0c 31          	lea    (%rcx,%rsi,1),%rcx
 67f:	c4 e2 3d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm3
 685:	c4 e2 3d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm5
 68b:	48 01 c1             	add    %rax,%rcx
 68e:	48 01 c1             	add    %rax,%rcx
 691:	c4 e2 3d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm4
 697:	c4 e2 3d b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm2
 69d:	48 01 c1             	add    %rax,%rcx
 6a0:	48 01 c1             	add    %rax,%rcx
 6a3:	c4 e2 3d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm1
 6a9:	48 01 c1             	add    %rax,%rcx
 6ac:	c4 41 7c 10 84 9e 80 	vmovups 0x180(%r14,%rbx,4),%ymm8
 6b3:	01 00 00 
 6b6:	c4 e2 3d b8 3c 9a    	vfmadd231ps (%rdx,%rbx,4),%ymm8,%ymm7
 6bc:	48 83 c3 68          	add    $0x68,%rbx
 6c0:	c4 e2 3d b8 34 0e    	vfmadd231ps (%rsi,%rcx,1),%ymm8,%ymm6
 6c6:	48 01 f1             	add    %rsi,%rcx
 6c9:	c4 e2 3d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm3
 6cf:	c4 e2 3d b8 2c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm5
 6d5:	48 01 c1             	add    %rax,%rcx
 6d8:	48 01 c1             	add    %rax,%rcx
 6db:	c4 e2 3d b8 24 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm4
 6e1:	c4 e2 3d b8 14 f9    	vfmadd231ps (%rcx,%rdi,8),%ymm8,%ymm2
 6e7:	48 01 c1             	add    %rax,%rcx
 6ea:	48 01 c1             	add    %rax,%rcx
 6ed:	c4 e2 3d b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm8,%ymm1
 6f3:	48 39 fb             	cmp    %rdi,%rbx
 6f6:	0f 8c 34 fc ff ff    	jl     330 <_Z5benchv+0x1e0>
 6fc:	e9 fb fa ff ff       	jmpq   1fc <_Z5benchv+0xac>
 701:	0f 31                	rdtsc  
 703:	48 c1 e2 20          	shl    $0x20,%rdx
 707:	48 09 c2             	or     %rax,%rdx
 70a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 710 <_Z5benchv+0x5c0>
 710:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 715:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 71d <_Z5benchv+0x5cd>
 71c:	00 
 71d:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 725 <_Z5benchv+0x5d5>
 724:	00 
 725:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 72c <_Z5benchv+0x5dc>
 72c:	01 c0                	add    %eax,%eax
 72e:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 734:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 738:	c4 c1 73 5c c1       	vsubsd %xmm9,%xmm1,%xmm0
 73d:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 741:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 745:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 749:	5b                   	pop    %rbx
 74a:	41 5e                	pop    %r14
 74c:	c5 f8 77             	vzeroupper 
 74f:	c3                   	retq   
...
0000000000000760 <_Z9n_reg_maxv>:
 760:	b8 5b 00 00 00       	mov    $0x5b,%eax
 765:	c3                   	retq   

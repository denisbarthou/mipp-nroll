...
0000000000000140 <_Z5benchv>:
 ...
 175:	0f 8e 47 01 00 00    	jle    2c2 <_Z5benchv+0x182>
 ...
 1ba:	0f 83 02 01 00 00    	jae    2c2 <_Z5benchv+0x182>
 ...
 207:	c4 e2 75 a8 34 97    	vfmadd213ps (%rdi,%rdx,4),%ymm1,%ymm6
 20d:	c4 e2 75 a8 7c 97 20 	vfmadd213ps 0x20(%rdi,%rdx,4),%ymm1,%ymm7
 214:	c4 62 75 a8 44 97 40 	vfmadd213ps 0x40(%rdi,%rdx,4),%ymm1,%ymm8
 21b:	c4 62 75 a8 4c 97 60 	vfmadd213ps 0x60(%rdi,%rdx,4),%ymm1,%ymm9
 222:	48 8d 04 91          	lea    (%rcx,%rdx,4),%rax
 226:	4a 8d 1c 30          	lea    (%rax,%r14,1),%rbx
 22a:	4c 01 f3             	add    %r14,%rbx
 22d:	c4 e2 6d b8 34 b0    	vfmadd231ps (%rax,%rsi,4),%ymm2,%ymm6
 233:	c4 e2 6d b8 7c b0 20 	vfmadd231ps 0x20(%rax,%rsi,4),%ymm2,%ymm7
 23a:	c4 62 6d b8 44 b0 40 	vfmadd231ps 0x40(%rax,%rsi,4),%ymm2,%ymm8
 241:	c4 62 6d b8 4c b0 60 	vfmadd231ps 0x60(%rax,%rsi,4),%ymm2,%ymm9
 248:	c4 e2 65 b8 34 f0    	vfmadd231ps (%rax,%rsi,8),%ymm3,%ymm6
 24e:	c4 e2 65 b8 7c f0 20 	vfmadd231ps 0x20(%rax,%rsi,8),%ymm3,%ymm7
 255:	c4 62 65 b8 44 f0 40 	vfmadd231ps 0x40(%rax,%rsi,8),%ymm3,%ymm8
 25c:	c4 62 65 b8 4c f0 60 	vfmadd231ps 0x60(%rax,%rsi,8),%ymm3,%ymm9
 263:	c4 e2 5d b8 34 b3    	vfmadd231ps (%rbx,%rsi,4),%ymm4,%ymm6
 269:	c4 e2 5d b8 7c b3 20 	vfmadd231ps 0x20(%rbx,%rsi,4),%ymm4,%ymm7
 270:	c4 62 5d b8 44 b3 40 	vfmadd231ps 0x40(%rbx,%rsi,4),%ymm4,%ymm8
 277:	c4 62 5d b8 4c b3 60 	vfmadd231ps 0x60(%rbx,%rsi,4),%ymm4,%ymm9
 27e:	c4 e2 55 b8 34 f3    	vfmadd231ps (%rbx,%rsi,8),%ymm5,%ymm6
 284:	c4 e2 55 b8 7c f3 20 	vfmadd231ps 0x20(%rbx,%rsi,8),%ymm5,%ymm7
 28b:	c4 62 55 b8 44 f3 40 	vfmadd231ps 0x40(%rbx,%rsi,8),%ymm5,%ymm8
 292:	c4 62 55 b8 4c f3 60 	vfmadd231ps 0x60(%rbx,%rsi,8),%ymm5,%ymm9
 299:	c5 fc 11 34 97       	vmovups %ymm6,(%rdi,%rdx,4)
 29e:	c5 fc 11 7c 97 20    	vmovups %ymm7,0x20(%rdi,%rdx,4)
 2a4:	c5 7c 11 44 97 40    	vmovups %ymm8,0x40(%rdi,%rdx,4)
 2aa:	c5 7c 11 4c 97 60    	vmovups %ymm9,0x60(%rdi,%rdx,4)
 2b0:	48 83 c2 20          	add    $0x20,%rdx
 2b4:	48 39 f2             	cmp    %rsi,%rdx
 2b7:	0f 8c 33 ff ff ff    	jl     1f0 <_Z5benchv+0xb0>
 2bd:	e9 ee fe ff ff       	jmpq   1b0 <_Z5benchv+0x70>
 2c2:	0f 31                	rdtsc  
 2c4:	48 c1 e2 20          	shl    $0x20,%rdx
 2c8:	48 09 c2             	or     %rax,%rdx
 2cb:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2d1 <_Z5benchv+0x191>
 2d1:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2d6:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2de <_Z5benchv+0x19e>
 2dd:	00 
 2de:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2e6 <_Z5benchv+0x1a6>
 2e5:	00 
 2e6:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2ed <_Z5benchv+0x1ad>
 2ed:	01 c0                	add    %eax,%eax
 2ef:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 2f5:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 2f9:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 2fd:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 301:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
...
0000000000000310 <_Z6enablev>:
 ...
 317:	b8 20 00 00 00       	mov    $0x20,%eax
 31c:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
...
0000000000000340 <_Z9n_reg_maxv>:
 340:	b8 1d 00 00 00       	mov    $0x1d,%eax
 345:	c3                   	retq   

...
0000000000000140 <_Z5benchv>:
 ...
 175:	0f 8e b0 01 00 00    	jle    32b <_Z5benchv+0x1eb>
 ...
 1ba:	0f 83 6b 01 00 00    	jae    32b <_Z5benchv+0x1eb>
 ...
 227:	00 00 
 229:	c4 e2 75 a8 2c 96    	vfmadd213ps (%rsi,%rdx,4),%ymm1,%ymm5
 22f:	c4 e2 75 a8 74 96 20 	vfmadd213ps 0x20(%rsi,%rdx,4),%ymm1,%ymm6
 236:	c4 e2 75 a8 7c 96 40 	vfmadd213ps 0x40(%rsi,%rdx,4),%ymm1,%ymm7
 23d:	c4 62 75 a8 44 96 60 	vfmadd213ps 0x60(%rsi,%rdx,4),%ymm1,%ymm8
 244:	c4 62 75 a8 8c 96 80 	vfmadd213ps 0x80(%rsi,%rdx,4),%ymm1,%ymm9
 24b:	00 00 00 
 24e:	c4 62 75 a8 94 96 a0 	vfmadd213ps 0xa0(%rsi,%rdx,4),%ymm1,%ymm10
 255:	00 00 00 
 258:	48 8d 04 91          	lea    (%rcx,%rdx,4),%rax
 25c:	4a 8d 1c 30          	lea    (%rax,%r14,1),%rbx
 260:	4c 01 f3             	add    %r14,%rbx
 263:	c4 e2 6d b8 2c b8    	vfmadd231ps (%rax,%rdi,4),%ymm2,%ymm5
 269:	c4 e2 6d b8 74 b8 20 	vfmadd231ps 0x20(%rax,%rdi,4),%ymm2,%ymm6
 270:	c4 e2 6d b8 7c b8 40 	vfmadd231ps 0x40(%rax,%rdi,4),%ymm2,%ymm7
 277:	c4 62 6d b8 44 b8 60 	vfmadd231ps 0x60(%rax,%rdi,4),%ymm2,%ymm8
 27e:	c4 62 6d b8 8c b8 80 	vfmadd231ps 0x80(%rax,%rdi,4),%ymm2,%ymm9
 285:	00 00 00 
 288:	c4 62 6d b8 94 b8 a0 	vfmadd231ps 0xa0(%rax,%rdi,4),%ymm2,%ymm10
 28f:	00 00 00 
 292:	c4 e2 65 b8 2c f8    	vfmadd231ps (%rax,%rdi,8),%ymm3,%ymm5
 298:	c4 e2 65 b8 74 f8 20 	vfmadd231ps 0x20(%rax,%rdi,8),%ymm3,%ymm6
 29f:	c4 e2 65 b8 7c f8 40 	vfmadd231ps 0x40(%rax,%rdi,8),%ymm3,%ymm7
 2a6:	c4 62 65 b8 44 f8 60 	vfmadd231ps 0x60(%rax,%rdi,8),%ymm3,%ymm8
 2ad:	c4 62 65 b8 8c f8 80 	vfmadd231ps 0x80(%rax,%rdi,8),%ymm3,%ymm9
 2b4:	00 00 00 
 2b7:	c4 62 65 b8 94 f8 a0 	vfmadd231ps 0xa0(%rax,%rdi,8),%ymm3,%ymm10
 2be:	00 00 00 
 2c1:	c4 e2 5d b8 2c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm4,%ymm5
 2c7:	c4 e2 5d b8 74 bb 20 	vfmadd231ps 0x20(%rbx,%rdi,4),%ymm4,%ymm6
 2ce:	c4 e2 5d b8 7c bb 40 	vfmadd231ps 0x40(%rbx,%rdi,4),%ymm4,%ymm7
 2d5:	c4 62 5d b8 44 bb 60 	vfmadd231ps 0x60(%rbx,%rdi,4),%ymm4,%ymm8
 2dc:	c4 62 5d b8 8c bb 80 	vfmadd231ps 0x80(%rbx,%rdi,4),%ymm4,%ymm9
 2e3:	00 00 00 
 2e6:	c4 62 5d b8 94 bb a0 	vfmadd231ps 0xa0(%rbx,%rdi,4),%ymm4,%ymm10
 2ed:	00 00 00 
 2f0:	c5 fc 11 2c 96       	vmovups %ymm5,(%rsi,%rdx,4)
 2f5:	c5 fc 11 74 96 20    	vmovups %ymm6,0x20(%rsi,%rdx,4)
 2fb:	c5 fc 11 7c 96 40    	vmovups %ymm7,0x40(%rsi,%rdx,4)
 301:	c5 7c 11 44 96 60    	vmovups %ymm8,0x60(%rsi,%rdx,4)
 307:	c5 7c 11 8c 96 80 00 	vmovups %ymm9,0x80(%rsi,%rdx,4)
 30e:	00 00 
 310:	c5 7c 11 94 96 a0 00 	vmovups %ymm10,0xa0(%rsi,%rdx,4)
 317:	00 00 
 319:	48 83 c2 30          	add    $0x30,%rdx
 31d:	48 39 fa             	cmp    %rdi,%rdx
 320:	0f 8c da fe ff ff    	jl     200 <_Z5benchv+0xc0>
...
0000000000000380 <_Z6enablev>:
 ...
 387:	b8 30 00 00 00       	mov    $0x30,%eax
 38c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 391:	0f 45 c8             	cmovne %eax,%ecx
 394:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 39a <_Z6enablev+0x1a>
 39a:	0f 9e c1             	setle  %cl
 39d:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 3a4 <_Z6enablev+0x24>

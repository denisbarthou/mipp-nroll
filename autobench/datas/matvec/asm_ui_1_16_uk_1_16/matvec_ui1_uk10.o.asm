...
0000000000000140 <_Z5benchv>:
 ...
 1be:	90                   	nop
 1bf:	90                   	nop
 1c0:	49 83 c3 0a          	add    $0xa,%r11
 1c4:	4d 01 cf             	add    %r9,%r15
 1c7:	4d 39 c3             	cmp    %r8,%r11
 1ca:	0f 83 db 00 00 00    	jae    2ab <_Z5benchv+0x16b>
 ...
 21a:	48 83 ca 04          	or     $0x4,%rdx
 21e:	c4 c2 7d 18 14 12    	vbroadcastss (%r10,%rdx,1),%ymm2
 ...
 22e:	90                   	nop
 22f:	90                   	nop
 230:	c4 41 7c 10 1c 97    	vmovups (%r15,%rdx,4),%ymm11
 236:	c4 42 75 a8 1c 96    	vfmadd213ps (%r14,%rdx,4),%ymm1,%ymm11
 ...
 24b:	c4 62 6d b8 1c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm2,%ymm11
 ...
 261:	c4 62 65 b8 1c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm3,%ymm11
 267:	c4 62 5d b8 1c be    	vfmadd231ps (%rsi,%rdi,4),%ymm4,%ymm11
 26d:	c4 62 55 b8 1c fe    	vfmadd231ps (%rsi,%rdi,8),%ymm5,%ymm11
 273:	c4 62 4d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm6,%ymm11
 279:	c4 42 45 b8 1c bc    	vfmadd231ps (%r12,%rdi,4),%ymm7,%ymm11
 27f:	c4 42 3d b8 5c bd 00 	vfmadd231ps 0x0(%r13,%rdi,4),%ymm8,%ymm11
 286:	c4 62 35 b8 5c bd 00 	vfmadd231ps 0x0(%rbp,%rdi,4),%ymm9,%ymm11
 28d:	48 01 c5             	add    %rax,%rbp
 290:	c4 62 2d b8 5c bd 00 	vfmadd231ps 0x0(%rbp,%rdi,4),%ymm10,%ymm11
 297:	c4 41 7c 11 1c 96    	vmovups %ymm11,(%r14,%rdx,4)
 29d:	48 83 c2 08          	add    $0x8,%rdx
 2a1:	48 39 fa             	cmp    %rdi,%rdx
 2a4:	7c 8a                	jl     230 <_Z5benchv+0xf0>
 2a6:	e9 15 ff ff ff       	jmpq   1c0 <_Z5benchv+0x80>
 2ab:	0f 31                	rdtsc  
 2ad:	48 c1 e2 20          	shl    $0x20,%rdx
 2b1:	48 09 c2             	or     %rax,%rdx
 2b4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2ba <_Z5benchv+0x17a>
 2ba:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2bf:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2c7 <_Z5benchv+0x187>
 2c6:	00 
 2c7:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2cf <_Z5benchv+0x18f>
 2ce:	00 
 2cf:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2d6 <_Z5benchv+0x196>
 2d6:	01 c0                	add    %eax,%eax
 2d8:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 2de:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 2e2:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 2e6:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 2ea:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 2ee:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 2f2:	5b                   	pop    %rbx
 2f3:	41 5c                	pop    %r12
 2f5:	41 5d                	pop    %r13
 2f7:	41 5e                	pop    %r14

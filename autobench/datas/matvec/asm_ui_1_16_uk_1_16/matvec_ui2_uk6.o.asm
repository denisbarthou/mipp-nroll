...
0000000000000140 <_Z5benchv>:
 ...
 179:	0f 8e 1e 01 00 00    	jle    29d <_Z5benchv+0x15d>
 17f:	4c 8b 35 00 00 00 00 	mov    0x0(%rip),%r14        # 186 <_Z5benchv+0x46>
 ...
 1a5:	00 
 1a6:	4c 8d 24 bd 00 00 00 	lea    0x0(,%rdi,4),%r12
 1ad:	00 
 ...
 1ca:	0f 83 cd 00 00 00    	jae    29d <_Z5benchv+0x15d>
 ...
 1fe:	48 83 ca 04          	or     $0x4,%rdx
 202:	c4 c2 7d 18 14 12    	vbroadcastss (%r10,%rdx,1),%ymm2
 ...
 20e:	90                   	nop
 20f:	90                   	nop
 210:	c4 c1 7c 10 3c 96    	vmovups (%r14,%rdx,4),%ymm7
 216:	c4 41 7c 10 44 96 20 	vmovups 0x20(%r14,%rdx,4),%ymm8
 21d:	c4 c2 75 a8 3c 97    	vfmadd213ps (%r15,%rdx,4),%ymm1,%ymm7
 223:	c4 42 75 a8 44 97 20 	vfmadd213ps 0x20(%r15,%rdx,4),%ymm1,%ymm8
 ...
 239:	c4 e2 6d b8 3c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm2,%ymm7
 23f:	c4 62 6d b8 44 bb 20 	vfmadd231ps 0x20(%rbx,%rdi,4),%ymm2,%ymm8
 246:	4a 8d 04 26          	lea    (%rsi,%r12,1),%rax
 24a:	c4 e2 65 b8 3c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm3,%ymm7
 250:	c4 62 65 b8 44 fb 20 	vfmadd231ps 0x20(%rbx,%rdi,8),%ymm3,%ymm8
 257:	c4 e2 5d b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm4,%ymm7
 25d:	c4 62 5d b8 44 b9 20 	vfmadd231ps 0x20(%rcx,%rdi,4),%ymm4,%ymm8
 264:	c4 e2 55 b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm5,%ymm7
 26a:	c4 62 55 b8 44 f9 20 	vfmadd231ps 0x20(%rcx,%rdi,8),%ymm5,%ymm8
 271:	c4 e2 4d b8 3c b8    	vfmadd231ps (%rax,%rdi,4),%ymm6,%ymm7
 277:	c4 62 4d b8 44 fe 20 	vfmadd231ps 0x20(%rsi,%rdi,8),%ymm6,%ymm8
 27e:	c4 c1 7c 11 3c 97    	vmovups %ymm7,(%r15,%rdx,4)
 284:	c4 41 7c 11 44 97 20 	vmovups %ymm8,0x20(%r15,%rdx,4)
 28b:	48 83 c2 10          	add    $0x10,%rdx
 28f:	48 39 fa             	cmp    %rdi,%rdx
 292:	0f 8c 78 ff ff ff    	jl     210 <_Z5benchv+0xd0>
 298:	e9 23 ff ff ff       	jmpq   1c0 <_Z5benchv+0x80>
 29d:	0f 31                	rdtsc  
 29f:	48 c1 e2 20          	shl    $0x20,%rdx
 2a3:	48 09 c2             	or     %rax,%rdx
 2a6:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2ac <_Z5benchv+0x16c>
 2ac:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2b1:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2b9 <_Z5benchv+0x179>
 2b8:	00 
 2b9:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2c1 <_Z5benchv+0x181>
 2c0:	00 
 2c1:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2c8 <_Z5benchv+0x188>
 2c8:	01 c0                	add    %eax,%eax
 2ca:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 2d0:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 2d4:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 2d8:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
 2dc:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 2e0:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 2e4:	5b                   	pop    %rbx
 2e5:	41 5c                	pop    %r12
 2e7:	41 5e                	pop    %r14
 2e9:	41 5f                	pop    %r15

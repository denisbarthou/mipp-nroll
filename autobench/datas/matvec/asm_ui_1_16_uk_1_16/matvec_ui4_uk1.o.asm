...
matvec_ui4_uk1.o:     file format elf64-x86-64
...
0000000000000130 <_Z5benchv>:
 ...
 162:	0f 8e ac 00 00 00    	jle    214 <_Z5benchv+0xe4>
 ...
 18d:	00 
 18e:	48 83 c1 60          	add    $0x60,%rcx
 192:	eb 17                	jmp    1ab <_Z5benchv+0x7b>
 194:	90                   	nop
 195:	90                   	nop
 196:	90                   	nop
 197:	90                   	nop
 ...
 1a9:	73 69                	jae    214 <_Z5benchv+0xe4>
 1ab:	85 f6                	test   %esi,%esi
 1ad:	7e f1                	jle    1a0 <_Z5benchv+0x70>
 1af:	c4 c2 7d 18 0c 80    	vbroadcastss (%r8,%rax,4),%ymm1
 ...
 1be:	90                   	nop
 1bf:	90                   	nop
 1c0:	c5 fc 10 54 91 a0    	vmovups -0x60(%rcx,%rdx,4),%ymm2
 1c6:	c5 fc 10 5c 91 c0    	vmovups -0x40(%rcx,%rdx,4),%ymm3
 1cc:	c5 fc 10 64 91 e0    	vmovups -0x20(%rcx,%rdx,4),%ymm4
 1d2:	c5 fc 10 2c 91       	vmovups (%rcx,%rdx,4),%ymm5
 1d7:	c4 e2 75 a8 14 97    	vfmadd213ps (%rdi,%rdx,4),%ymm1,%ymm2
 1dd:	c4 e2 75 a8 5c 97 20 	vfmadd213ps 0x20(%rdi,%rdx,4),%ymm1,%ymm3
 1e4:	c4 e2 75 a8 64 97 40 	vfmadd213ps 0x40(%rdi,%rdx,4),%ymm1,%ymm4
 1eb:	c4 e2 75 a8 6c 97 60 	vfmadd213ps 0x60(%rdi,%rdx,4),%ymm1,%ymm5
 1f2:	c5 fc 11 14 97       	vmovups %ymm2,(%rdi,%rdx,4)
 1f7:	c5 fc 11 5c 97 20    	vmovups %ymm3,0x20(%rdi,%rdx,4)
 1fd:	c5 fc 11 64 97 40    	vmovups %ymm4,0x40(%rdi,%rdx,4)
 203:	c5 fc 11 6c 97 60    	vmovups %ymm5,0x60(%rdi,%rdx,4)
 209:	48 83 c2 20          	add    $0x20,%rdx
 20d:	48 39 f2             	cmp    %rsi,%rdx
 210:	7c ae                	jl     1c0 <_Z5benchv+0x90>
 212:	eb 8c                	jmp    1a0 <_Z5benchv+0x70>
 214:	0f 31                	rdtsc  
...
0000000000000260 <_Z6enablev>:
 ...
 267:	b8 20 00 00 00       	mov    $0x20,%eax
 26c:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
...
0000000000000000 <_GLOBAL__sub_I_matvec_ui4_uk1.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_ui4_uk1.cpp+0x9a>
  96:	01 00 00 00 

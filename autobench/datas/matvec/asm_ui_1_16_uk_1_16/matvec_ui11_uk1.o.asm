...
0000000000000140 <_Z5benchv>:
 ...
 172:	0f 8e 74 01 00 00    	jle    2ec <_Z5benchv+0x1ac>
 ...
 19d:	00 
 19e:	48 81 c1 40 01 00 00 	add    $0x140,%rcx
 ...
 1b9:	0f 83 2d 01 00 00    	jae    2ec <_Z5benchv+0x1ac>
 ...
 1ce:	90                   	nop
 1cf:	90                   	nop
 1d0:	c5 fc 10 94 91 c0 fe 	vmovups -0x140(%rcx,%rdx,4),%ymm2
 1d7:	ff ff 
 1d9:	c5 fc 10 9c 91 e0 fe 	vmovups -0x120(%rcx,%rdx,4),%ymm3
 1e0:	ff ff 
 1e2:	c5 fc 10 a4 91 00 ff 	vmovups -0x100(%rcx,%rdx,4),%ymm4
 1e9:	ff ff 
 1eb:	c5 fc 10 ac 91 20 ff 	vmovups -0xe0(%rcx,%rdx,4),%ymm5
 1f2:	ff ff 
 1f4:	c5 fc 10 b4 91 40 ff 	vmovups -0xc0(%rcx,%rdx,4),%ymm6
 1fb:	ff ff 
 1fd:	c5 fc 10 bc 91 60 ff 	vmovups -0xa0(%rcx,%rdx,4),%ymm7
 204:	ff ff 
 206:	c5 7c 10 44 91 80    	vmovups -0x80(%rcx,%rdx,4),%ymm8
 20c:	c5 7c 10 4c 91 a0    	vmovups -0x60(%rcx,%rdx,4),%ymm9
 212:	c5 7c 10 54 91 c0    	vmovups -0x40(%rcx,%rdx,4),%ymm10
 218:	c5 7c 10 5c 91 e0    	vmovups -0x20(%rcx,%rdx,4),%ymm11
 21e:	c5 7c 10 24 91       	vmovups (%rcx,%rdx,4),%ymm12
 223:	c4 e2 75 a8 14 97    	vfmadd213ps (%rdi,%rdx,4),%ymm1,%ymm2
 229:	c4 e2 75 a8 5c 97 20 	vfmadd213ps 0x20(%rdi,%rdx,4),%ymm1,%ymm3
 230:	c4 e2 75 a8 64 97 40 	vfmadd213ps 0x40(%rdi,%rdx,4),%ymm1,%ymm4
 237:	c4 e2 75 a8 6c 97 60 	vfmadd213ps 0x60(%rdi,%rdx,4),%ymm1,%ymm5
 23e:	c4 e2 75 a8 b4 97 80 	vfmadd213ps 0x80(%rdi,%rdx,4),%ymm1,%ymm6
 245:	00 00 00 
 248:	c4 e2 75 a8 bc 97 a0 	vfmadd213ps 0xa0(%rdi,%rdx,4),%ymm1,%ymm7
 24f:	00 00 00 
 252:	c4 62 75 a8 84 97 c0 	vfmadd213ps 0xc0(%rdi,%rdx,4),%ymm1,%ymm8
 259:	00 00 00 
 25c:	c4 62 75 a8 8c 97 e0 	vfmadd213ps 0xe0(%rdi,%rdx,4),%ymm1,%ymm9
 263:	00 00 00 
 266:	c4 62 75 a8 94 97 00 	vfmadd213ps 0x100(%rdi,%rdx,4),%ymm1,%ymm10
 26d:	01 00 00 
 270:	c4 62 75 a8 9c 97 20 	vfmadd213ps 0x120(%rdi,%rdx,4),%ymm1,%ymm11
 277:	01 00 00 
 27a:	c4 62 75 a8 a4 97 40 	vfmadd213ps 0x140(%rdi,%rdx,4),%ymm1,%ymm12
 281:	01 00 00 
 284:	c5 fc 11 14 97       	vmovups %ymm2,(%rdi,%rdx,4)
 289:	c5 fc 11 5c 97 20    	vmovups %ymm3,0x20(%rdi,%rdx,4)
 28f:	c5 fc 11 64 97 40    	vmovups %ymm4,0x40(%rdi,%rdx,4)
 295:	c5 fc 11 6c 97 60    	vmovups %ymm5,0x60(%rdi,%rdx,4)
 29b:	c5 fc 11 b4 97 80 00 	vmovups %ymm6,0x80(%rdi,%rdx,4)
 2a2:	00 00 
 2a4:	c5 fc 11 bc 97 a0 00 	vmovups %ymm7,0xa0(%rdi,%rdx,4)
 2ab:	00 00 
 2ad:	c5 7c 11 84 97 c0 00 	vmovups %ymm8,0xc0(%rdi,%rdx,4)
 2b4:	00 00 
 2b6:	c5 7c 11 8c 97 e0 00 	vmovups %ymm9,0xe0(%rdi,%rdx,4)
 2bd:	00 00 
 2bf:	c5 7c 11 94 97 00 01 	vmovups %ymm10,0x100(%rdi,%rdx,4)
 2c6:	00 00 
 2c8:	c5 7c 11 9c 97 20 01 	vmovups %ymm11,0x120(%rdi,%rdx,4)
 2cf:	00 00 
 2d1:	c5 7c 11 a4 97 40 01 	vmovups %ymm12,0x140(%rdi,%rdx,4)
 2d8:	00 00 
 2da:	48 83 c2 58          	add    $0x58,%rdx
 2de:	48 39 f2             	cmp    %rsi,%rdx
 2e1:	0f 8c e9 fe ff ff    	jl     1d0 <_Z5benchv+0x90>
 2e7:	e9 c4 fe ff ff       	jmpq   1b0 <_Z5benchv+0x70>
 2ec:	0f 31                	rdtsc  
 ...
 327:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1

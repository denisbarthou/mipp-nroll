...
0000000000000130 <_Z5benchv>:
 ...
 167:	0f 8e e6 00 00 00    	jle    253 <_Z5benchv+0x123>
 ...
 1aa:	0f 83 a3 00 00 00    	jae    253 <_Z5benchv+0x123>
 ...
 1fb:	c4 e2 75 a8 2c 96    	vfmadd213ps (%rsi,%rdx,4),%ymm1,%ymm5
 201:	c4 e2 75 a8 74 96 20 	vfmadd213ps 0x20(%rsi,%rdx,4),%ymm1,%ymm6
 208:	48 8d 1c 91          	lea    (%rcx,%rdx,4),%rbx
 20c:	4a 8d 04 3b          	lea    (%rbx,%r15,1),%rax
 210:	4c 01 f8             	add    %r15,%rax
 213:	c4 e2 6d b8 2c bb    	vfmadd231ps (%rbx,%rdi,4),%ymm2,%ymm5
 219:	c4 e2 6d b8 74 bb 20 	vfmadd231ps 0x20(%rbx,%rdi,4),%ymm2,%ymm6
 220:	c4 e2 65 b8 2c fb    	vfmadd231ps (%rbx,%rdi,8),%ymm3,%ymm5
 226:	c4 e2 65 b8 74 fb 20 	vfmadd231ps 0x20(%rbx,%rdi,8),%ymm3,%ymm6
 22d:	c4 e2 5d b8 2c b8    	vfmadd231ps (%rax,%rdi,4),%ymm4,%ymm5
 233:	c4 e2 5d b8 74 b8 20 	vfmadd231ps 0x20(%rax,%rdi,4),%ymm4,%ymm6
 23a:	c5 fc 11 2c 96       	vmovups %ymm5,(%rsi,%rdx,4)
 23f:	c5 fc 11 74 96 20    	vmovups %ymm6,0x20(%rsi,%rdx,4)
 245:	48 83 c2 10          	add    $0x10,%rdx
 249:	48 39 fa             	cmp    %rdi,%rdx
 24c:	7c a2                	jl     1f0 <_Z5benchv+0xc0>
 24e:	e9 4d ff ff ff       	jmpq   1a0 <_Z5benchv+0x70>
 253:	0f 31                	rdtsc  
 255:	48 c1 e2 20          	shl    $0x20,%rdx
 259:	48 09 c2             	or     %rax,%rdx
 25c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 262 <_Z5benchv+0x132>
 262:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 267:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 26f <_Z5benchv+0x13f>
 26e:	00 
 26f:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 277 <_Z5benchv+0x147>
 276:	00 
 277:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 27e <_Z5benchv+0x14e>

...
0000000000000150 <_Z5benchv>:
 ...
 189:	0f 8e 53 01 00 00    	jle    2e2 <_Z5benchv+0x192>
 18f:	4c 8b 3d 00 00 00 00 	mov    0x0(%rip),%r15        # 196 <_Z5benchv+0x46>
 ...
 1d4:	4d 01 cf             	add    %r9,%r15
 1d7:	4d 39 c3             	cmp    %r8,%r11
 1da:	0f 83 02 01 00 00    	jae    2e2 <_Z5benchv+0x192>
 ...
 20e:	48 83 ca 04          	or     $0x4,%rdx
 212:	c4 c2 7d 18 14 12    	vbroadcastss (%r10,%rdx,1),%ymm2
 ...
 21e:	90                   	nop
 21f:	90                   	nop
 220:	c4 c1 7c 10 3c 97    	vmovups (%r15,%rdx,4),%ymm7
 226:	c4 41 7c 10 44 97 20 	vmovups 0x20(%r15,%rdx,4),%ymm8
 22d:	c4 41 7c 10 4c 97 40 	vmovups 0x40(%r15,%rdx,4),%ymm9
 234:	c4 e2 75 a8 3c 96    	vfmadd213ps (%rsi,%rdx,4),%ymm1,%ymm7
 23a:	c4 62 75 a8 44 96 20 	vfmadd213ps 0x20(%rsi,%rdx,4),%ymm1,%ymm8
 241:	c4 62 75 a8 4c 96 40 	vfmadd213ps 0x40(%rsi,%rdx,4),%ymm1,%ymm9
 248:	49 8d 04 97          	lea    (%r15,%rdx,4),%rax
 24c:	4a 8d 0c 30          	lea    (%rax,%r14,1),%rcx
 250:	4c 01 f1             	add    %r14,%rcx
 253:	4a 8d 1c 31          	lea    (%rcx,%r14,1),%rbx
 257:	c4 e2 6d b8 3c b8    	vfmadd231ps (%rax,%rdi,4),%ymm2,%ymm7
 25d:	c4 62 6d b8 44 b8 20 	vfmadd231ps 0x20(%rax,%rdi,4),%ymm2,%ymm8
 264:	c4 62 6d b8 4c b8 40 	vfmadd231ps 0x40(%rax,%rdi,4),%ymm2,%ymm9
 26b:	4e 8d 24 33          	lea    (%rbx,%r14,1),%r12
 26f:	c4 e2 65 b8 3c f8    	vfmadd231ps (%rax,%rdi,8),%ymm3,%ymm7
 275:	c4 62 65 b8 44 f8 20 	vfmadd231ps 0x20(%rax,%rdi,8),%ymm3,%ymm8
 27c:	c4 62 65 b8 4c f8 40 	vfmadd231ps 0x40(%rax,%rdi,8),%ymm3,%ymm9
 283:	c4 e2 5d b8 3c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm4,%ymm7
 289:	c4 62 5d b8 44 b9 20 	vfmadd231ps 0x20(%rcx,%rdi,4),%ymm4,%ymm8
 290:	c4 62 5d b8 4c b9 40 	vfmadd231ps 0x40(%rcx,%rdi,4),%ymm4,%ymm9
 297:	c4 e2 55 b8 3c f9    	vfmadd231ps (%rcx,%rdi,8),%ymm5,%ymm7
 29d:	c4 62 55 b8 44 f9 20 	vfmadd231ps 0x20(%rcx,%rdi,8),%ymm5,%ymm8
 2a4:	c4 62 55 b8 4c f9 40 	vfmadd231ps 0x40(%rcx,%rdi,8),%ymm5,%ymm9
 2ab:	c4 c2 4d b8 3c bc    	vfmadd231ps (%r12,%rdi,4),%ymm6,%ymm7
 2b1:	c4 62 4d b8 44 fb 20 	vfmadd231ps 0x20(%rbx,%rdi,8),%ymm6,%ymm8
 2b8:	c4 62 4d b8 4c fb 40 	vfmadd231ps 0x40(%rbx,%rdi,8),%ymm6,%ymm9
 2bf:	c5 fc 11 3c 96       	vmovups %ymm7,(%rsi,%rdx,4)
 2c4:	c5 7c 11 44 96 20    	vmovups %ymm8,0x20(%rsi,%rdx,4)
 2ca:	c5 7c 11 4c 96 40    	vmovups %ymm9,0x40(%rsi,%rdx,4)
 2d0:	48 83 c2 18          	add    $0x18,%rdx
 2d4:	48 39 fa             	cmp    %rdi,%rdx
 2d7:	0f 8c 43 ff ff ff    	jl     220 <_Z5benchv+0xd0>
 2dd:	e9 ee fe ff ff       	jmpq   1d0 <_Z5benchv+0x80>
 2e2:	0f 31                	rdtsc  
 2e4:	48 c1 e2 20          	shl    $0x20,%rdx
 2e8:	48 09 c2             	or     %rax,%rdx
 2eb:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2f1 <_Z5benchv+0x1a1>
 2f1:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2f6:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2fe <_Z5benchv+0x1ae>
 2fd:	00 
 2fe:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 306 <_Z5benchv+0x1b6>
 305:	00 
 306:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 30d <_Z5benchv+0x1bd>
 ...
 31d:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1

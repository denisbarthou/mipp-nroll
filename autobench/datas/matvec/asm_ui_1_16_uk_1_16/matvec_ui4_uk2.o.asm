...
0000000000000130 <_Z5benchv>:
 ...
 162:	0f 8e ea 00 00 00    	jle    252 <_Z5benchv+0x122>
 ...
 18e:	00 
 18f:	48 8d 44 b9 60       	lea    0x60(%rcx,%rdi,4),%rax
 194:	48 83 c1 60          	add    $0x60,%rcx
 198:	eb 19                	jmp    1b3 <_Z5benchv+0x83>
 19a:	90                   	nop
 19b:	90                   	nop
 19c:	90                   	nop
 19d:	90                   	nop
 ...
 1ad:	0f 83 9f 00 00 00    	jae    252 <_Z5benchv+0x122>
 ...
 1de:	90                   	nop
 1df:	90                   	nop
 1e0:	c5 fc 10 5c 91 a0    	vmovups -0x60(%rcx,%rdx,4),%ymm3
 1e6:	c5 fc 10 64 91 c0    	vmovups -0x40(%rcx,%rdx,4),%ymm4
 1ec:	c5 fc 10 6c 91 e0    	vmovups -0x20(%rcx,%rdx,4),%ymm5
 1f2:	c5 fc 10 34 91       	vmovups (%rcx,%rdx,4),%ymm6
 1f7:	c4 e2 75 a8 1c 96    	vfmadd213ps (%rsi,%rdx,4),%ymm1,%ymm3
 1fd:	c4 e2 75 a8 64 96 20 	vfmadd213ps 0x20(%rsi,%rdx,4),%ymm1,%ymm4
 204:	c4 e2 75 a8 6c 96 40 	vfmadd213ps 0x40(%rsi,%rdx,4),%ymm1,%ymm5
 20b:	c4 e2 75 a8 74 96 60 	vfmadd213ps 0x60(%rsi,%rdx,4),%ymm1,%ymm6
 212:	c4 e2 6d b8 5c 90 a0 	vfmadd231ps -0x60(%rax,%rdx,4),%ymm2,%ymm3
 219:	c4 e2 6d b8 64 90 c0 	vfmadd231ps -0x40(%rax,%rdx,4),%ymm2,%ymm4
 220:	c4 e2 6d b8 6c 90 e0 	vfmadd231ps -0x20(%rax,%rdx,4),%ymm2,%ymm5
 227:	c4 e2 6d b8 34 90    	vfmadd231ps (%rax,%rdx,4),%ymm2,%ymm6
 22d:	c5 fc 11 1c 96       	vmovups %ymm3,(%rsi,%rdx,4)
 232:	c5 fc 11 64 96 20    	vmovups %ymm4,0x20(%rsi,%rdx,4)
 238:	c5 fc 11 6c 96 40    	vmovups %ymm5,0x40(%rsi,%rdx,4)
 23e:	c5 fc 11 74 96 60    	vmovups %ymm6,0x60(%rsi,%rdx,4)
 244:	48 83 c2 20          	add    $0x20,%rdx
 248:	48 39 fa             	cmp    %rdi,%rdx
 24b:	7c 93                	jl     1e0 <_Z5benchv+0xb0>
 24d:	e9 4e ff ff ff       	jmpq   1a0 <_Z5benchv+0x70>
 252:	0f 31                	rdtsc  
 254:	48 c1 e2 20          	shl    $0x20,%rdx
 258:	48 09 c2             	or     %rax,%rdx
 25b:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 261 <_Z5benchv+0x131>
 261:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 266:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 26e <_Z5benchv+0x13e>
 26d:	00 
 26e:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 276 <_Z5benchv+0x146>
 275:	00 
 276:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 27d <_Z5benchv+0x14d>
 27d:	01 c0                	add    %eax,%eax
 27f:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 285:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 289:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 28d:	c5 c2 2a c8          	vcvtsi2ss %eax,%xmm7,%xmm1
 291:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 295:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 299:	c5 f8 77             	vzeroupper 
 29c:	c3                   	retq   
 29d:	90                   	nop
 29e:	90                   	nop
 29f:	90                   	nop

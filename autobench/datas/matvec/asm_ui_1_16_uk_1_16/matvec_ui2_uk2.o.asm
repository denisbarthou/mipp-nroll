...
0000000000000130 <_Z5benchv>:
 ...
 162:	0f 8e a3 00 00 00    	jle    20b <_Z5benchv+0xdb>
 ...
 18e:	00 
 18f:	48 8d 44 b9 20       	lea    0x20(%rcx,%rdi,4),%rax
 194:	48 83 c1 20          	add    $0x20,%rcx
 198:	eb 15                	jmp    1af <_Z5benchv+0x7f>
 19a:	90                   	nop
 19b:	90                   	nop
 19c:	90                   	nop
 19d:	90                   	nop
 ...
 1ad:	73 5c                	jae    20b <_Z5benchv+0xdb>
 1af:	85 ff                	test   %edi,%edi
 1b1:	7e ed                	jle    1a0 <_Z5benchv+0x70>
 1b3:	4a 8d 14 9d 00 00 00 	lea    0x0(,%r11,4),%rdx
 1ba:	00 
 1bb:	c4 82 7d 18 0c 99    	vbroadcastss (%r9,%r11,4),%ymm1
 1c1:	48 83 ca 04          	or     $0x4,%rdx
 1c5:	c4 c2 7d 18 14 11    	vbroadcastss (%r9,%rdx,1),%ymm2
 1cb:	31 d2                	xor    %edx,%edx
 1cd:	90                   	nop
 1ce:	90                   	nop
 1cf:	90                   	nop
 1d0:	c5 fc 10 5c 91 e0    	vmovups -0x20(%rcx,%rdx,4),%ymm3
 1d6:	c5 fc 10 24 91       	vmovups (%rcx,%rdx,4),%ymm4
 1db:	c4 e2 75 a8 1c 96    	vfmadd213ps (%rsi,%rdx,4),%ymm1,%ymm3
 1e1:	c4 e2 75 a8 64 96 20 	vfmadd213ps 0x20(%rsi,%rdx,4),%ymm1,%ymm4
 1e8:	c4 e2 6d b8 5c 90 e0 	vfmadd231ps -0x20(%rax,%rdx,4),%ymm2,%ymm3
 1ef:	c4 e2 6d b8 24 90    	vfmadd231ps (%rax,%rdx,4),%ymm2,%ymm4
 1f5:	c5 fc 11 1c 96       	vmovups %ymm3,(%rsi,%rdx,4)
 1fa:	c5 fc 11 64 96 20    	vmovups %ymm4,0x20(%rsi,%rdx,4)
 200:	48 83 c2 10          	add    $0x10,%rdx
 204:	48 39 fa             	cmp    %rdi,%rdx
 207:	7c c7                	jl     1d0 <_Z5benchv+0xa0>
 209:	eb 95                	jmp    1a0 <_Z5benchv+0x70>
 20b:	0f 31                	rdtsc  
 20d:	48 c1 e2 20          	shl    $0x20,%rdx
 211:	48 09 c2             	or     %rax,%rdx
 214:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 21a <_Z5benchv+0xea>
 21a:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 21f:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 227 <_Z5benchv+0xf7>
 226:	00 
 227:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 22f <_Z5benchv+0xff>
 22e:	00 
 22f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 236 <_Z5benchv+0x106>
 236:	01 c0                	add    %eax,%eax
 238:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 23e:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 242:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 246:	c5 d2 2a c8          	vcvtsi2ss %eax,%xmm5,%xmm1
 24a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 24e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 252:	c5 f8 77             	vzeroupper 
 255:	c3                   	retq   
 256:	90                   	nop
 257:	90                   	nop
 258:	90                   	nop

...
0000000000000150 <_Z5benchv>:
 ...
 185:	0f 8e 18 01 00 00    	jle    2a3 <_Z5benchv+0x153>
 ...
 1ca:	0f 83 d3 00 00 00    	jae    2a3 <_Z5benchv+0x153>
 ...
 211:	c4 e2 75 a8 34 97    	vfmadd213ps (%rdi,%rdx,4),%ymm1,%ymm6
 217:	c4 e2 75 a8 7c 97 20 	vfmadd213ps 0x20(%rdi,%rdx,4),%ymm1,%ymm7
 21e:	c4 62 75 a8 44 97 40 	vfmadd213ps 0x40(%rdi,%rdx,4),%ymm1,%ymm8
 225:	48 8d 1c 91          	lea    (%rcx,%rdx,4),%rbx
 229:	4a 8d 04 33          	lea    (%rbx,%r14,1),%rax
 22d:	4c 01 f0             	add    %r14,%rax
 230:	c4 e2 6d b8 34 b3    	vfmadd231ps (%rbx,%rsi,4),%ymm2,%ymm6
 236:	c4 e2 6d b8 7c b3 20 	vfmadd231ps 0x20(%rbx,%rsi,4),%ymm2,%ymm7
 23d:	c4 62 6d b8 44 b3 40 	vfmadd231ps 0x40(%rbx,%rsi,4),%ymm2,%ymm8
 244:	c4 e2 65 b8 34 f3    	vfmadd231ps (%rbx,%rsi,8),%ymm3,%ymm6
 24a:	c4 e2 65 b8 7c f3 20 	vfmadd231ps 0x20(%rbx,%rsi,8),%ymm3,%ymm7
 251:	c4 62 65 b8 44 f3 40 	vfmadd231ps 0x40(%rbx,%rsi,8),%ymm3,%ymm8
 258:	c4 e2 5d b8 34 b0    	vfmadd231ps (%rax,%rsi,4),%ymm4,%ymm6
 25e:	c4 e2 5d b8 7c b0 20 	vfmadd231ps 0x20(%rax,%rsi,4),%ymm4,%ymm7
 265:	c4 62 5d b8 44 b0 40 	vfmadd231ps 0x40(%rax,%rsi,4),%ymm4,%ymm8
 26c:	c4 e2 55 b8 34 f0    	vfmadd231ps (%rax,%rsi,8),%ymm5,%ymm6
 272:	c4 e2 55 b8 7c f0 20 	vfmadd231ps 0x20(%rax,%rsi,8),%ymm5,%ymm7
 279:	c4 62 55 b8 44 f0 40 	vfmadd231ps 0x40(%rax,%rsi,8),%ymm5,%ymm8
 280:	c5 fc 11 34 97       	vmovups %ymm6,(%rdi,%rdx,4)
 285:	c5 fc 11 7c 97 20    	vmovups %ymm7,0x20(%rdi,%rdx,4)
 28b:	c5 7c 11 44 97 40    	vmovups %ymm8,0x40(%rdi,%rdx,4)
 291:	48 83 c2 18          	add    $0x18,%rdx
 295:	48 39 f2             	cmp    %rsi,%rdx
 298:	0f 8c 62 ff ff ff    	jl     200 <_Z5benchv+0xb0>
 29e:	e9 1d ff ff ff       	jmpq   1c0 <_Z5benchv+0x70>
 2a3:	0f 31                	rdtsc  
 2a5:	48 c1 e2 20          	shl    $0x20,%rdx
 2a9:	48 09 c2             	or     %rax,%rdx
 2ac:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2b2 <_Z5benchv+0x162>
 2b2:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2b7:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2bf <_Z5benchv+0x16f>
 2be:	00 
 2bf:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2c7 <_Z5benchv+0x177>
 2c6:	00 
 2c7:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2ce <_Z5benchv+0x17e>
 2ce:	01 c0                	add    %eax,%eax
 2d0:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 2d6:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 2da:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 2de:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
 2e2:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 2e6:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 2ea:	5b                   	pop    %rbx
 2eb:	41 5e                	pop    %r14

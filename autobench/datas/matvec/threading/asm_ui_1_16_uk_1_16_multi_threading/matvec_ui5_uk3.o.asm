...
0000000000000220 <.omp_outlined.>:
 ...
 302:	4c 8d 2c 85 80 00 00 	lea    0x80(,%rax,4),%r13
 309:	00 
 ...
 31f:	48 8d 2c 85 80 00 00 	lea    0x80(,%rax,4),%rbp
 326:	00 
 327:	4b 8d 44 52 02       	lea    0x2(%r10,%r10,2),%rax
 32c:	49 0f af c3          	imul   %r11,%rax
 330:	48 8d 14 85 80 00 00 	lea    0x80(,%rax,4),%rdx
 337:	00 
 ...
 38a:	c5 fc 10 7c be 80    	vmovups -0x80(%rsi,%rdi,4),%ymm7
 390:	c4 e2 7d a8 3c b8    	vfmadd213ps (%rax,%rdi,4),%ymm0,%ymm7
 396:	c5 fc 10 74 be a0    	vmovups -0x60(%rsi,%rdi,4),%ymm6
 39c:	c5 fc 10 6c be c0    	vmovups -0x40(%rsi,%rdi,4),%ymm5
 3a2:	c5 fc 10 64 be e0    	vmovups -0x20(%rsi,%rdi,4),%ymm4
 3a8:	c5 fc 10 1c be       	vmovups (%rsi,%rdi,4),%ymm3
 3ad:	48 8d 34 29          	lea    (%rcx,%rbp,1),%rsi
 3b1:	48 01 d1             	add    %rdx,%rcx
 3b4:	c4 e2 7d a8 74 b8 20 	vfmadd213ps 0x20(%rax,%rdi,4),%ymm0,%ymm6
 3bb:	c4 e2 7d a8 6c b8 40 	vfmadd213ps 0x40(%rax,%rdi,4),%ymm0,%ymm5
 3c2:	c4 e2 7d a8 64 b8 60 	vfmadd213ps 0x60(%rax,%rdi,4),%ymm0,%ymm4
 3c9:	c4 e2 7d a8 9c b8 80 	vfmadd213ps 0x80(%rax,%rdi,4),%ymm0,%ymm3
 3d0:	00 00 00 
 3d3:	c4 e2 75 b8 7c be 80 	vfmadd231ps -0x80(%rsi,%rdi,4),%ymm1,%ymm7
 3da:	c4 e2 75 b8 74 be a0 	vfmadd231ps -0x60(%rsi,%rdi,4),%ymm1,%ymm6
 3e1:	c4 e2 75 b8 6c be c0 	vfmadd231ps -0x40(%rsi,%rdi,4),%ymm1,%ymm5
 3e8:	c4 e2 75 b8 64 be e0 	vfmadd231ps -0x20(%rsi,%rdi,4),%ymm1,%ymm4
 3ef:	c4 e2 75 b8 1c be    	vfmadd231ps (%rsi,%rdi,4),%ymm1,%ymm3
 3f5:	c4 e2 6d b8 7c b9 80 	vfmadd231ps -0x80(%rcx,%rdi,4),%ymm2,%ymm7
 3fc:	c4 e2 6d b8 74 b9 a0 	vfmadd231ps -0x60(%rcx,%rdi,4),%ymm2,%ymm6
 403:	c4 e2 6d b8 6c b9 c0 	vfmadd231ps -0x40(%rcx,%rdi,4),%ymm2,%ymm5
 40a:	c4 e2 6d b8 64 b9 e0 	vfmadd231ps -0x20(%rcx,%rdi,4),%ymm2,%ymm4
 411:	c4 e2 6d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm2,%ymm3
 417:	c5 fc 11 3c b8       	vmovups %ymm7,(%rax,%rdi,4)
 41c:	48 8b 03             	mov    (%rbx),%rax
 41f:	c5 fc 11 74 b8 20    	vmovups %ymm6,0x20(%rax,%rdi,4)
 425:	48 8b 03             	mov    (%rbx),%rax
 428:	c5 fc 11 6c b8 40    	vmovups %ymm5,0x40(%rax,%rdi,4)
 42e:	48 8b 03             	mov    (%rbx),%rax
 431:	c5 fc 11 64 b8 60    	vmovups %ymm4,0x60(%rax,%rdi,4)
 437:	48 8b 03             	mov    (%rbx),%rax
 43a:	c5 fc 11 9c b8 80 00 	vmovups %ymm3,0x80(%rax,%rdi,4)
 441:	00 00 
 443:	48 83 c7 28          	add    $0x28,%rdi
 447:	4c 39 df             	cmp    %r11,%rdi
 44a:	0f 8c 30 ff ff ff    	jl     380 <.omp_outlined.+0x160>
 450:	e9 eb fe ff ff       	jmpq   340 <.omp_outlined.+0x120>
...
0000000000000460 <_Z6enablev>:
 ...
 47d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 484 <_Z6enablev+0x24>

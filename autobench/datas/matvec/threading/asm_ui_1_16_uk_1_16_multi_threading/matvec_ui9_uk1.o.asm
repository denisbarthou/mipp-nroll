...
0000000000000210 <.omp_outlined.>:
 ...
 2db:	00 
 2dc:	48 8d 34 b5 00 01 00 	lea    0x100(,%rsi,4),%rsi
 2e3:	00 
 ...
 319:	c5 fc 10 a4 af 00 ff 	vmovups -0x100(%rdi,%rbp,4),%ymm4
 320:	ff ff 
 322:	c4 e2 7d a8 24 aa    	vfmadd213ps (%rdx,%rbp,4),%ymm0,%ymm4
 328:	c5 fc 10 ac af 20 ff 	vmovups -0xe0(%rdi,%rbp,4),%ymm5
 32f:	ff ff 
 331:	c4 e2 7d a8 6c aa 20 	vfmadd213ps 0x20(%rdx,%rbp,4),%ymm0,%ymm5
 338:	c5 fc 10 b4 af 40 ff 	vmovups -0xc0(%rdi,%rbp,4),%ymm6
 33f:	ff ff 
 341:	c5 fc 10 bc af 60 ff 	vmovups -0xa0(%rdi,%rbp,4),%ymm7
 348:	ff ff 
 34a:	c5 7c 10 44 af 80    	vmovups -0x80(%rdi,%rbp,4),%ymm8
 350:	c5 7c 10 4c af a0    	vmovups -0x60(%rdi,%rbp,4),%ymm9
 356:	c5 fc 10 5c af c0    	vmovups -0x40(%rdi,%rbp,4),%ymm3
 35c:	c5 fc 10 54 af e0    	vmovups -0x20(%rdi,%rbp,4),%ymm2
 362:	c5 fc 10 0c af       	vmovups (%rdi,%rbp,4),%ymm1
 367:	c4 e2 7d a8 74 aa 40 	vfmadd213ps 0x40(%rdx,%rbp,4),%ymm0,%ymm6
 36e:	c4 e2 7d a8 7c aa 60 	vfmadd213ps 0x60(%rdx,%rbp,4),%ymm0,%ymm7
 375:	c4 62 7d a8 84 aa 80 	vfmadd213ps 0x80(%rdx,%rbp,4),%ymm0,%ymm8
 37c:	00 00 00 
 37f:	c4 62 7d a8 8c aa a0 	vfmadd213ps 0xa0(%rdx,%rbp,4),%ymm0,%ymm9
 386:	00 00 00 
 389:	c4 e2 7d a8 9c aa c0 	vfmadd213ps 0xc0(%rdx,%rbp,4),%ymm0,%ymm3
 390:	00 00 00 
 393:	c4 e2 7d a8 94 aa e0 	vfmadd213ps 0xe0(%rdx,%rbp,4),%ymm0,%ymm2
 39a:	00 00 00 
 39d:	c4 e2 7d a8 8c aa 00 	vfmadd213ps 0x100(%rdx,%rbp,4),%ymm0,%ymm1
 3a4:	01 00 00 
 3a7:	c5 fc 11 24 aa       	vmovups %ymm4,(%rdx,%rbp,4)
 3ac:	48 8b 13             	mov    (%rbx),%rdx
 3af:	c5 fc 11 6c aa 20    	vmovups %ymm5,0x20(%rdx,%rbp,4)
 3b5:	48 8b 13             	mov    (%rbx),%rdx
 3b8:	c5 fc 11 74 aa 40    	vmovups %ymm6,0x40(%rdx,%rbp,4)
 3be:	48 8b 13             	mov    (%rbx),%rdx
 3c1:	c5 fc 11 7c aa 60    	vmovups %ymm7,0x60(%rdx,%rbp,4)
 3c7:	48 8b 13             	mov    (%rbx),%rdx
 3ca:	c5 7c 11 84 aa 80 00 	vmovups %ymm8,0x80(%rdx,%rbp,4)
 3d1:	00 00 
 3d3:	48 8b 13             	mov    (%rbx),%rdx
 3d6:	c5 7c 11 8c aa a0 00 	vmovups %ymm9,0xa0(%rdx,%rbp,4)
 3dd:	00 00 
 3df:	48 8b 13             	mov    (%rbx),%rdx
 3e2:	c5 fc 11 9c aa c0 00 	vmovups %ymm3,0xc0(%rdx,%rbp,4)
 3e9:	00 00 
 3eb:	48 8b 13             	mov    (%rbx),%rdx
 3ee:	c5 fc 11 94 aa e0 00 	vmovups %ymm2,0xe0(%rdx,%rbp,4)
 3f5:	00 00 
 3f7:	48 8b 13             	mov    (%rbx),%rdx
 3fa:	c5 fc 11 8c aa 00 01 	vmovups %ymm1,0x100(%rdx,%rbp,4)
 401:	00 00 
 403:	48 83 c5 48          	add    $0x48,%rbp
 407:	48 39 cd             	cmp    %rcx,%rbp
 40a:	0f 8c 00 ff ff ff    	jl     310 <.omp_outlined.+0x100>
 410:	e9 db fe ff ff       	jmpq   2f0 <.omp_outlined.+0xe0>
...
0000000000000420 <_Z6enablev>:
 ...
 427:	b8 48 00 00 00       	mov    $0x48,%eax
 42c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 431:	0f 45 c8             	cmovne %eax,%ecx
 434:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 43a <_Z6enablev+0x1a>
 43a:	0f 9e c1             	setle  %cl
 43d:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 444 <_Z6enablev+0x24>

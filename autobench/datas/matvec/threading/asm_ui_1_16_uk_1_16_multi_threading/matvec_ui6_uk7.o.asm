...
0000000000000220 <.omp_outlined.>:
 ...
 327:	4c 8d ac 08 a0 00 00 	lea    0xa0(%rax,%rcx,1),%r13
 32e:	00 
 ...
 34f:	48 8d 0c 8d a0 00 00 	lea    0xa0(,%rcx,4),%rcx
 356:	00 
 357:	4c 8d 0c 85 a0 00 00 	lea    0xa0(,%rax,4),%r9
 35e:	00 
 35f:	48 8d 46 02          	lea    0x2(%rsi),%rax
 363:	49 0f af c3          	imul   %r11,%rax
 367:	4c 8d 14 85 a0 00 00 	lea    0xa0(,%rax,4),%r10
 36e:	00 
 36f:	48 8d 46 03          	lea    0x3(%rsi),%rax
 373:	49 0f af c3          	imul   %r11,%rax
 377:	48 8d 3c 85 a0 00 00 	lea    0xa0(,%rax,4),%rdi
 37e:	00 
 37f:	48 8d 46 04          	lea    0x4(%rsi),%rax
 383:	48 83 c6 06          	add    $0x6,%rsi
 387:	49 0f af c3          	imul   %r11,%rax
 38b:	49 0f af f3          	imul   %r11,%rsi
 38f:	48 8d 04 85 a0 00 00 	lea    0xa0(,%rax,4),%rax
 396:	00 
 397:	48 8d 34 b5 a0 00 00 	lea    0xa0(,%rsi,4),%rsi
 39e:	00 
 ...
 44a:	c4 21 7c 10 a4 a2 60 	vmovups -0xa0(%rdx,%r12,4),%ymm12
 451:	ff ff ff 
 454:	c4 02 7d a8 24 a7    	vfmadd213ps (%r15,%r12,4),%ymm0,%ymm12
 45a:	c4 21 7c 10 5c a2 80 	vmovups -0x80(%rdx,%r12,4),%ymm11
 461:	c4 21 7c 10 54 a2 a0 	vmovups -0x60(%rdx,%r12,4),%ymm10
 468:	c4 21 7c 10 4c a2 c0 	vmovups -0x40(%rdx,%r12,4),%ymm9
 46f:	c4 21 7c 10 44 a2 e0 	vmovups -0x20(%rdx,%r12,4),%ymm8
 476:	c4 a1 7c 10 3c a2    	vmovups (%rdx,%r12,4),%ymm7
 47c:	4b 8d 14 08          	lea    (%r8,%r9,1),%rdx
 480:	c4 02 7d a8 5c a7 20 	vfmadd213ps 0x20(%r15,%r12,4),%ymm0,%ymm11
 487:	c4 02 7d a8 54 a7 40 	vfmadd213ps 0x40(%r15,%r12,4),%ymm0,%ymm10
 48e:	c4 02 7d a8 4c a7 60 	vfmadd213ps 0x60(%r15,%r12,4),%ymm0,%ymm9
 495:	c4 02 7d a8 84 a7 80 	vfmadd213ps 0x80(%r15,%r12,4),%ymm0,%ymm8
 49c:	00 00 00 
 49f:	c4 82 7d a8 bc a7 a0 	vfmadd213ps 0xa0(%r15,%r12,4),%ymm0,%ymm7
 4a6:	00 00 00 
 4a9:	c4 22 75 b8 a4 a2 60 	vfmadd231ps -0xa0(%rdx,%r12,4),%ymm1,%ymm12
 4b0:	ff ff ff 
 4b3:	c4 22 75 b8 5c a2 80 	vfmadd231ps -0x80(%rdx,%r12,4),%ymm1,%ymm11
 4ba:	c4 22 75 b8 54 a2 a0 	vfmadd231ps -0x60(%rdx,%r12,4),%ymm1,%ymm10
 4c1:	c4 22 75 b8 4c a2 c0 	vfmadd231ps -0x40(%rdx,%r12,4),%ymm1,%ymm9
 4c8:	c4 22 75 b8 44 a2 e0 	vfmadd231ps -0x20(%rdx,%r12,4),%ymm1,%ymm8
 4cf:	c4 a2 75 b8 3c a2    	vfmadd231ps (%rdx,%r12,4),%ymm1,%ymm7
 4d5:	4b 8d 14 10          	lea    (%r8,%r10,1),%rdx
 4d9:	c4 22 6d b8 a4 a2 60 	vfmadd231ps -0xa0(%rdx,%r12,4),%ymm2,%ymm12
 4e0:	ff ff ff 
 4e3:	c4 22 6d b8 5c a2 80 	vfmadd231ps -0x80(%rdx,%r12,4),%ymm2,%ymm11
 4ea:	c4 22 6d b8 54 a2 a0 	vfmadd231ps -0x60(%rdx,%r12,4),%ymm2,%ymm10
 4f1:	c4 22 6d b8 4c a2 c0 	vfmadd231ps -0x40(%rdx,%r12,4),%ymm2,%ymm9
 4f8:	c4 22 6d b8 44 a2 e0 	vfmadd231ps -0x20(%rdx,%r12,4),%ymm2,%ymm8
 4ff:	c4 a2 6d b8 3c a2    	vfmadd231ps (%rdx,%r12,4),%ymm2,%ymm7
 505:	49 8d 14 38          	lea    (%r8,%rdi,1),%rdx
 509:	c4 22 65 b8 a4 a2 60 	vfmadd231ps -0xa0(%rdx,%r12,4),%ymm3,%ymm12
 510:	ff ff ff 
 513:	c4 22 65 b8 5c a2 80 	vfmadd231ps -0x80(%rdx,%r12,4),%ymm3,%ymm11
 51a:	c4 22 65 b8 54 a2 a0 	vfmadd231ps -0x60(%rdx,%r12,4),%ymm3,%ymm10
 521:	c4 22 65 b8 4c a2 c0 	vfmadd231ps -0x40(%rdx,%r12,4),%ymm3,%ymm9
 528:	c4 22 65 b8 44 a2 e0 	vfmadd231ps -0x20(%rdx,%r12,4),%ymm3,%ymm8
 52f:	c4 a2 65 b8 3c a2    	vfmadd231ps (%rdx,%r12,4),%ymm3,%ymm7
 535:	49 8d 14 00          	lea    (%r8,%rax,1),%rdx
 539:	c4 22 5d b8 a4 a2 60 	vfmadd231ps -0xa0(%rdx,%r12,4),%ymm4,%ymm12
 540:	ff ff ff 
 543:	c4 22 5d b8 5c a2 80 	vfmadd231ps -0x80(%rdx,%r12,4),%ymm4,%ymm11
 54a:	c4 22 5d b8 54 a2 a0 	vfmadd231ps -0x60(%rdx,%r12,4),%ymm4,%ymm10
 551:	c4 22 5d b8 4c a2 c0 	vfmadd231ps -0x40(%rdx,%r12,4),%ymm4,%ymm9
 558:	c4 22 5d b8 44 a2 e0 	vfmadd231ps -0x20(%rdx,%r12,4),%ymm4,%ymm8
 55f:	c4 a2 5d b8 3c a2    	vfmadd231ps (%rdx,%r12,4),%ymm4,%ymm7
 565:	49 8d 14 08          	lea    (%r8,%rcx,1),%rdx
 569:	c4 22 55 b8 a4 a2 60 	vfmadd231ps -0xa0(%rdx,%r12,4),%ymm5,%ymm12
 570:	ff ff ff 
 573:	c4 22 55 b8 5c a2 80 	vfmadd231ps -0x80(%rdx,%r12,4),%ymm5,%ymm11
 57a:	c4 22 55 b8 54 a2 a0 	vfmadd231ps -0x60(%rdx,%r12,4),%ymm5,%ymm10
 581:	c4 22 55 b8 4c a2 c0 	vfmadd231ps -0x40(%rdx,%r12,4),%ymm5,%ymm9
 588:	c4 22 55 b8 44 a2 e0 	vfmadd231ps -0x20(%rdx,%r12,4),%ymm5,%ymm8
 58f:	c4 a2 55 b8 3c a2    	vfmadd231ps (%rdx,%r12,4),%ymm5,%ymm7
 595:	49 8d 14 30          	lea    (%r8,%rsi,1),%rdx
 599:	c4 22 4d b8 a4 a2 60 	vfmadd231ps -0xa0(%rdx,%r12,4),%ymm6,%ymm12
 5a0:	ff ff ff 
 5a3:	c4 22 4d b8 5c a2 80 	vfmadd231ps -0x80(%rdx,%r12,4),%ymm6,%ymm11
 5aa:	c4 22 4d b8 54 a2 a0 	vfmadd231ps -0x60(%rdx,%r12,4),%ymm6,%ymm10
 5b1:	c4 22 4d b8 4c a2 c0 	vfmadd231ps -0x40(%rdx,%r12,4),%ymm6,%ymm9
 5b8:	c4 22 4d b8 44 a2 e0 	vfmadd231ps -0x20(%rdx,%r12,4),%ymm6,%ymm8
 5bf:	c4 a2 4d b8 3c a2    	vfmadd231ps (%rdx,%r12,4),%ymm6,%ymm7
 5c5:	c4 01 7c 11 24 a7    	vmovups %ymm12,(%r15,%r12,4)
 5cb:	48 8b 13             	mov    (%rbx),%rdx
 5ce:	c4 21 7c 11 5c a2 20 	vmovups %ymm11,0x20(%rdx,%r12,4)
 5d5:	48 8b 13             	mov    (%rbx),%rdx
 5d8:	c4 21 7c 11 54 a2 40 	vmovups %ymm10,0x40(%rdx,%r12,4)
 5df:	48 8b 13             	mov    (%rbx),%rdx
 5e2:	c4 21 7c 11 4c a2 60 	vmovups %ymm9,0x60(%rdx,%r12,4)
 5e9:	48 8b 13             	mov    (%rbx),%rdx
 5ec:	c4 21 7c 11 84 a2 80 	vmovups %ymm8,0x80(%rdx,%r12,4)
 5f3:	00 00 00 
 5f6:	48 8b 13             	mov    (%rbx),%rdx
 5f9:	c4 a1 7c 11 bc a2 a0 	vmovups %ymm7,0xa0(%rdx,%r12,4)
 600:	00 00 00 
 603:	49 83 c4 30          	add    $0x30,%r12
 607:	4d 39 dc             	cmp    %r11,%r12
 60a:	0f 8c 30 fe ff ff    	jl     440 <.omp_outlined.+0x220>
 610:	e9 9b fd ff ff       	jmpq   3b0 <.omp_outlined.+0x190>
 615:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 61c:	00 00 00 00 

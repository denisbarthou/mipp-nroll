...
0000000000000210 <.omp_outlined.>:
 ...
 2db:	00 
 2dc:	48 8d 34 b5 40 00 00 	lea    0x40(,%rsi,4),%rsi
 2e3:	00 
 ...
 319:	c5 fc 10 4c af c0    	vmovups -0x40(%rdi,%rbp,4),%ymm1
 31f:	c4 e2 7d a8 0c aa    	vfmadd213ps (%rdx,%rbp,4),%ymm0,%ymm1
 325:	c5 fc 10 54 af e0    	vmovups -0x20(%rdi,%rbp,4),%ymm2
 32b:	c4 e2 7d a8 54 aa 20 	vfmadd213ps 0x20(%rdx,%rbp,4),%ymm0,%ymm2
 332:	c5 fc 10 1c af       	vmovups (%rdi,%rbp,4),%ymm3
 337:	c4 e2 7d a8 5c aa 40 	vfmadd213ps 0x40(%rdx,%rbp,4),%ymm0,%ymm3
 33e:	c5 fc 11 0c aa       	vmovups %ymm1,(%rdx,%rbp,4)
 343:	48 8b 13             	mov    (%rbx),%rdx
 346:	c5 fc 11 54 aa 20    	vmovups %ymm2,0x20(%rdx,%rbp,4)
 34c:	48 8b 13             	mov    (%rbx),%rdx
 34f:	c5 fc 11 5c aa 40    	vmovups %ymm3,0x40(%rdx,%rbp,4)
 355:	48 83 c5 18          	add    $0x18,%rbp
 359:	48 39 cd             	cmp    %rcx,%rbp
 35c:	7c b2                	jl     310 <.omp_outlined.+0x100>
 35e:	eb 90                	jmp    2f0 <.omp_outlined.+0xe0>

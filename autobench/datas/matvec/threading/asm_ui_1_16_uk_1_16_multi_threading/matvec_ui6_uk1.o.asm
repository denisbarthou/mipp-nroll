...
0000000000000210 <.omp_outlined.>:
 ...
 2db:	00 
 2dc:	48 8d 34 b5 a0 00 00 	lea    0xa0(,%rsi,4),%rsi
 2e3:	00 
 ...
 319:	c5 fc 10 8c af 60 ff 	vmovups -0xa0(%rdi,%rbp,4),%ymm1
 320:	ff ff 
 322:	c4 e2 7d a8 0c aa    	vfmadd213ps (%rdx,%rbp,4),%ymm0,%ymm1
 328:	c5 fc 10 54 af 80    	vmovups -0x80(%rdi,%rbp,4),%ymm2
 32e:	c4 e2 7d a8 54 aa 20 	vfmadd213ps 0x20(%rdx,%rbp,4),%ymm0,%ymm2
 335:	c5 fc 10 5c af a0    	vmovups -0x60(%rdi,%rbp,4),%ymm3
 33b:	c5 fc 10 64 af c0    	vmovups -0x40(%rdi,%rbp,4),%ymm4
 341:	c5 fc 10 6c af e0    	vmovups -0x20(%rdi,%rbp,4),%ymm5
 347:	c5 fc 10 34 af       	vmovups (%rdi,%rbp,4),%ymm6
 34c:	c4 e2 7d a8 5c aa 40 	vfmadd213ps 0x40(%rdx,%rbp,4),%ymm0,%ymm3
 353:	c4 e2 7d a8 64 aa 60 	vfmadd213ps 0x60(%rdx,%rbp,4),%ymm0,%ymm4
 35a:	c4 e2 7d a8 ac aa 80 	vfmadd213ps 0x80(%rdx,%rbp,4),%ymm0,%ymm5
 361:	00 00 00 
 364:	c4 e2 7d a8 b4 aa a0 	vfmadd213ps 0xa0(%rdx,%rbp,4),%ymm0,%ymm6
 36b:	00 00 00 
 36e:	c5 fc 11 0c aa       	vmovups %ymm1,(%rdx,%rbp,4)
 373:	48 8b 13             	mov    (%rbx),%rdx
 376:	c5 fc 11 54 aa 20    	vmovups %ymm2,0x20(%rdx,%rbp,4)
 37c:	48 8b 13             	mov    (%rbx),%rdx
 37f:	c5 fc 11 5c aa 40    	vmovups %ymm3,0x40(%rdx,%rbp,4)
 385:	48 8b 13             	mov    (%rbx),%rdx
 388:	c5 fc 11 64 aa 60    	vmovups %ymm4,0x60(%rdx,%rbp,4)
 38e:	48 8b 13             	mov    (%rbx),%rdx
 391:	c5 fc 11 ac aa 80 00 	vmovups %ymm5,0x80(%rdx,%rbp,4)
 398:	00 00 
 39a:	48 8b 13             	mov    (%rbx),%rdx
 39d:	c5 fc 11 b4 aa a0 00 	vmovups %ymm6,0xa0(%rdx,%rbp,4)
 3a4:	00 00 
 3a6:	48 83 c5 30          	add    $0x30,%rbp
 3aa:	48 39 cd             	cmp    %rcx,%rbp
 3ad:	0f 8c 5d ff ff ff    	jl     310 <.omp_outlined.+0x100>
 3b3:	e9 38 ff ff ff       	jmpq   2f0 <.omp_outlined.+0xe0>
...
00000000000003c0 <_Z6enablev>:
 ...
 3c7:	b8 30 00 00 00       	mov    $0x30,%eax
 3cc:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx

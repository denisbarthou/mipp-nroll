...
0000000000000210 <.omp_outlined.>:
 ...
 356:	4c 8d a4 28 00 01 00 	lea    0x100(%rax,%rbp,1),%r12
 35d:	00 
 35e:	48 8d 84 10 00 01 00 	lea    0x100(%rax,%rdx,1),%rax
 365:	00 
 366:	c4 41 7c 10 94 b4 00 	vmovups -0x100(%r12,%rsi,4),%ymm10
 36d:	ff ff ff 
 370:	c4 62 7d a8 14 b7    	vfmadd213ps (%rdi,%rsi,4),%ymm0,%ymm10
 376:	c4 41 7c 10 8c b4 20 	vmovups -0xe0(%r12,%rsi,4),%ymm9
 37d:	ff ff ff 
 380:	c4 62 7d a8 4c b7 20 	vfmadd213ps 0x20(%rdi,%rsi,4),%ymm0,%ymm9
 387:	c4 41 7c 10 84 b4 40 	vmovups -0xc0(%r12,%rsi,4),%ymm8
 38e:	ff ff ff 
 391:	c4 c1 7c 10 bc b4 60 	vmovups -0xa0(%r12,%rsi,4),%ymm7
 398:	ff ff ff 
 39b:	c4 c1 7c 10 74 b4 80 	vmovups -0x80(%r12,%rsi,4),%ymm6
 3a2:	c4 c1 7c 10 6c b4 a0 	vmovups -0x60(%r12,%rsi,4),%ymm5
 3a9:	c4 c1 7c 10 64 b4 c0 	vmovups -0x40(%r12,%rsi,4),%ymm4
 3b0:	c4 c1 7c 10 5c b4 e0 	vmovups -0x20(%r12,%rsi,4),%ymm3
 3b7:	c4 c1 7c 10 14 b4    	vmovups (%r12,%rsi,4),%ymm2
 3bd:	c4 62 7d a8 44 b7 40 	vfmadd213ps 0x40(%rdi,%rsi,4),%ymm0,%ymm8
 3c4:	c4 e2 7d a8 7c b7 60 	vfmadd213ps 0x60(%rdi,%rsi,4),%ymm0,%ymm7
 3cb:	c4 e2 7d a8 b4 b7 80 	vfmadd213ps 0x80(%rdi,%rsi,4),%ymm0,%ymm6
 3d2:	00 00 00 
 3d5:	c4 e2 7d a8 ac b7 a0 	vfmadd213ps 0xa0(%rdi,%rsi,4),%ymm0,%ymm5
 3dc:	00 00 00 
 3df:	c4 e2 7d a8 a4 b7 c0 	vfmadd213ps 0xc0(%rdi,%rsi,4),%ymm0,%ymm4
 3e6:	00 00 00 
 3e9:	c4 e2 7d a8 9c b7 e0 	vfmadd213ps 0xe0(%rdi,%rsi,4),%ymm0,%ymm3
 3f0:	00 00 00 
 3f3:	c4 e2 7d a8 94 b7 00 	vfmadd213ps 0x100(%rdi,%rsi,4),%ymm0,%ymm2
 3fa:	01 00 00 
 3fd:	c4 62 75 b8 94 b0 00 	vfmadd231ps -0x100(%rax,%rsi,4),%ymm1,%ymm10
 404:	ff ff ff 
 407:	c4 62 75 b8 8c b0 20 	vfmadd231ps -0xe0(%rax,%rsi,4),%ymm1,%ymm9
 40e:	ff ff ff 
 411:	c4 62 75 b8 84 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm1,%ymm8
 418:	ff ff ff 
 41b:	c4 e2 75 b8 bc b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm1,%ymm7
 422:	ff ff ff 
 425:	c4 e2 75 b8 74 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm1,%ymm6
 42c:	c4 e2 75 b8 6c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm1,%ymm5
 433:	c4 e2 75 b8 64 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm1,%ymm4
 43a:	c4 e2 75 b8 5c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm1,%ymm3
 441:	c4 e2 75 b8 14 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm2
 447:	c5 7c 11 14 b7       	vmovups %ymm10,(%rdi,%rsi,4)
 44c:	48 8b 03             	mov    (%rbx),%rax
 44f:	c5 7c 11 4c b0 20    	vmovups %ymm9,0x20(%rax,%rsi,4)
 455:	48 8b 03             	mov    (%rbx),%rax
 458:	c5 7c 11 44 b0 40    	vmovups %ymm8,0x40(%rax,%rsi,4)
 45e:	48 8b 03             	mov    (%rbx),%rax
 461:	c5 fc 11 7c b0 60    	vmovups %ymm7,0x60(%rax,%rsi,4)
 467:	48 8b 03             	mov    (%rbx),%rax
 46a:	c5 fc 11 b4 b0 80 00 	vmovups %ymm6,0x80(%rax,%rsi,4)
 471:	00 00 
 473:	48 8b 03             	mov    (%rbx),%rax
 476:	c5 fc 11 ac b0 a0 00 	vmovups %ymm5,0xa0(%rax,%rsi,4)
 47d:	00 00 
 47f:	48 8b 03             	mov    (%rbx),%rax
 482:	c5 fc 11 a4 b0 c0 00 	vmovups %ymm4,0xc0(%rax,%rsi,4)
 489:	00 00 
 48b:	48 8b 03             	mov    (%rbx),%rax
 48e:	c5 fc 11 9c b0 e0 00 	vmovups %ymm3,0xe0(%rax,%rsi,4)
 495:	00 00 
 497:	48 8b 03             	mov    (%rbx),%rax
 49a:	c5 fc 11 94 b0 00 01 	vmovups %ymm2,0x100(%rax,%rsi,4)
 4a1:	00 00 
 4a3:	48 83 c6 48          	add    $0x48,%rsi
 4a7:	48 39 ce             	cmp    %rcx,%rsi
 4aa:	0f 8c a0 fe ff ff    	jl     350 <.omp_outlined.+0x140>
 4b0:	e9 4b fe ff ff       	jmpq   300 <.omp_outlined.+0xf0>
 4b5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 4bc:	00 00 00 00 

00000000000004c0 <_Z6enablev>:
 4c0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 4c7 <_Z6enablev+0x7>
 4c7:	b8 48 00 00 00       	mov    $0x48,%eax
 4cc:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 4d1:	0f 45 c8             	cmovne %eax,%ecx
 4d4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4da <_Z6enablev+0x1a>
 4da:	0f 9e c1             	setle  %cl
 4dd:	83 3d 00 00 00 00 01 	cmpl   $0x1,0x0(%rip)        # 4e4 <_Z6enablev+0x24>

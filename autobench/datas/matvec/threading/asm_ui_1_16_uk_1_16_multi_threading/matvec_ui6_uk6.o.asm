...
0000000000000220 <.omp_outlined.>:
 ...
 324:	4c 8d 1c c5 a0 00 00 	lea    0xa0(,%rax,8),%r11
 32b:	00 
 ...
 354:	48 8d 3c 95 a0 00 00 	lea    0xa0(,%rdx,4),%rdi
 35b:	00 
 35c:	48 8d 54 40 03       	lea    0x3(%rax,%rax,2),%rdx
 361:	48 8d 44 40 05       	lea    0x5(%rax,%rax,2),%rax
 366:	48 8d 34 b5 a0 00 00 	lea    0xa0(,%rsi,4),%rsi
 36d:	00 
 36e:	49 0f af d2          	imul   %r10,%rdx
 372:	49 0f af c2          	imul   %r10,%rax
 376:	48 8d 14 95 a0 00 00 	lea    0xa0(,%rdx,4),%rdx
 37d:	00 
 37e:	48 8d 04 85 a0 00 00 	lea    0xa0(,%rax,4),%rax
 385:	00 
 ...
 42a:	c4 21 7c 10 9c b9 60 	vmovups -0xa0(%rcx,%r15,4),%ymm11
 431:	ff ff ff 
 434:	c4 02 7d a8 1c b8    	vfmadd213ps (%r8,%r15,4),%ymm0,%ymm11
 43a:	c4 21 7c 10 54 b9 80 	vmovups -0x80(%rcx,%r15,4),%ymm10
 441:	c4 21 7c 10 4c b9 a0 	vmovups -0x60(%rcx,%r15,4),%ymm9
 448:	c4 21 7c 10 44 b9 c0 	vmovups -0x40(%rcx,%r15,4),%ymm8
 44f:	c4 a1 7c 10 7c b9 e0 	vmovups -0x20(%rcx,%r15,4),%ymm7
 456:	c4 a1 7c 10 34 b9    	vmovups (%rcx,%r15,4),%ymm6
 45c:	4b 8d 0c 21          	lea    (%r9,%r12,1),%rcx
 460:	c4 02 7d a8 54 b8 20 	vfmadd213ps 0x20(%r8,%r15,4),%ymm0,%ymm10
 467:	c4 02 7d a8 4c b8 40 	vfmadd213ps 0x40(%r8,%r15,4),%ymm0,%ymm9
 46e:	c4 02 7d a8 44 b8 60 	vfmadd213ps 0x60(%r8,%r15,4),%ymm0,%ymm8
 475:	c4 82 7d a8 bc b8 80 	vfmadd213ps 0x80(%r8,%r15,4),%ymm0,%ymm7
 47c:	00 00 00 
 47f:	c4 82 7d a8 b4 b8 a0 	vfmadd213ps 0xa0(%r8,%r15,4),%ymm0,%ymm6
 486:	00 00 00 
 489:	c4 22 75 b8 1c b9    	vfmadd231ps (%rcx,%r15,4),%ymm1,%ymm11
 48f:	c4 22 75 b8 54 b9 20 	vfmadd231ps 0x20(%rcx,%r15,4),%ymm1,%ymm10
 496:	c4 22 75 b8 4c b9 40 	vfmadd231ps 0x40(%rcx,%r15,4),%ymm1,%ymm9
 49d:	c4 22 75 b8 44 b9 60 	vfmadd231ps 0x60(%rcx,%r15,4),%ymm1,%ymm8
 4a4:	c4 a2 75 b8 bc b9 80 	vfmadd231ps 0x80(%rcx,%r15,4),%ymm1,%ymm7
 4ab:	00 00 00 
 4ae:	c4 a2 75 b8 b4 b9 a0 	vfmadd231ps 0xa0(%rcx,%r15,4),%ymm1,%ymm6
 4b5:	00 00 00 
 4b8:	49 8d 0c 39          	lea    (%r9,%rdi,1),%rcx
 4bc:	c4 22 6d b8 9c b9 60 	vfmadd231ps -0xa0(%rcx,%r15,4),%ymm2,%ymm11
 4c3:	ff ff ff 
 4c6:	c4 22 6d b8 54 b9 80 	vfmadd231ps -0x80(%rcx,%r15,4),%ymm2,%ymm10
 4cd:	c4 22 6d b8 4c b9 a0 	vfmadd231ps -0x60(%rcx,%r15,4),%ymm2,%ymm9
 4d4:	c4 22 6d b8 44 b9 c0 	vfmadd231ps -0x40(%rcx,%r15,4),%ymm2,%ymm8
 4db:	c4 a2 6d b8 7c b9 e0 	vfmadd231ps -0x20(%rcx,%r15,4),%ymm2,%ymm7
 4e2:	c4 a2 6d b8 34 b9    	vfmadd231ps (%rcx,%r15,4),%ymm2,%ymm6
 4e8:	49 8d 0c 11          	lea    (%r9,%rdx,1),%rcx
 4ec:	c4 22 65 b8 9c b9 60 	vfmadd231ps -0xa0(%rcx,%r15,4),%ymm3,%ymm11
 4f3:	ff ff ff 
 4f6:	c4 22 65 b8 54 b9 80 	vfmadd231ps -0x80(%rcx,%r15,4),%ymm3,%ymm10
 4fd:	c4 22 65 b8 4c b9 a0 	vfmadd231ps -0x60(%rcx,%r15,4),%ymm3,%ymm9
 504:	c4 22 65 b8 44 b9 c0 	vfmadd231ps -0x40(%rcx,%r15,4),%ymm3,%ymm8
 50b:	c4 a2 65 b8 7c b9 e0 	vfmadd231ps -0x20(%rcx,%r15,4),%ymm3,%ymm7
 512:	c4 a2 65 b8 34 b9    	vfmadd231ps (%rcx,%r15,4),%ymm3,%ymm6
 518:	49 8d 0c 31          	lea    (%r9,%rsi,1),%rcx
 51c:	c4 22 5d b8 9c b9 60 	vfmadd231ps -0xa0(%rcx,%r15,4),%ymm4,%ymm11
 523:	ff ff ff 
 526:	c4 22 5d b8 54 b9 80 	vfmadd231ps -0x80(%rcx,%r15,4),%ymm4,%ymm10
 52d:	c4 22 5d b8 4c b9 a0 	vfmadd231ps -0x60(%rcx,%r15,4),%ymm4,%ymm9
 534:	c4 22 5d b8 44 b9 c0 	vfmadd231ps -0x40(%rcx,%r15,4),%ymm4,%ymm8
 53b:	c4 a2 5d b8 7c b9 e0 	vfmadd231ps -0x20(%rcx,%r15,4),%ymm4,%ymm7
 542:	c4 a2 5d b8 34 b9    	vfmadd231ps (%rcx,%r15,4),%ymm4,%ymm6
 548:	49 8d 0c 01          	lea    (%r9,%rax,1),%rcx
 54c:	c4 22 55 b8 9c b9 60 	vfmadd231ps -0xa0(%rcx,%r15,4),%ymm5,%ymm11
 553:	ff ff ff 
 556:	c4 22 55 b8 54 b9 80 	vfmadd231ps -0x80(%rcx,%r15,4),%ymm5,%ymm10
 55d:	c4 22 55 b8 4c b9 a0 	vfmadd231ps -0x60(%rcx,%r15,4),%ymm5,%ymm9
 564:	c4 22 55 b8 44 b9 c0 	vfmadd231ps -0x40(%rcx,%r15,4),%ymm5,%ymm8
 56b:	c4 a2 55 b8 7c b9 e0 	vfmadd231ps -0x20(%rcx,%r15,4),%ymm5,%ymm7
 572:	c4 a2 55 b8 34 b9    	vfmadd231ps (%rcx,%r15,4),%ymm5,%ymm6
 578:	c4 01 7c 11 1c b8    	vmovups %ymm11,(%r8,%r15,4)
 57e:	48 8b 0b             	mov    (%rbx),%rcx
 581:	c4 21 7c 11 54 b9 20 	vmovups %ymm10,0x20(%rcx,%r15,4)
 588:	48 8b 0b             	mov    (%rbx),%rcx
 58b:	c4 21 7c 11 4c b9 40 	vmovups %ymm9,0x40(%rcx,%r15,4)
 592:	48 8b 0b             	mov    (%rbx),%rcx
 595:	c4 21 7c 11 44 b9 60 	vmovups %ymm8,0x60(%rcx,%r15,4)
 59c:	48 8b 0b             	mov    (%rbx),%rcx
 59f:	c4 a1 7c 11 bc b9 80 	vmovups %ymm7,0x80(%rcx,%r15,4)
 5a6:	00 00 00 
 5a9:	48 8b 0b             	mov    (%rbx),%rcx
 5ac:	c4 a1 7c 11 b4 b9 a0 	vmovups %ymm6,0xa0(%rcx,%r15,4)
 5b3:	00 00 00 
 5b6:	49 83 c7 30          	add    $0x30,%r15
 5ba:	4d 39 d7             	cmp    %r10,%r15
 5bd:	0f 8c 5d fe ff ff    	jl     420 <.omp_outlined.+0x200>
 5c3:	e9 c8 fd ff ff       	jmpq   390 <.omp_outlined.+0x170>
...
00000000000005e0 <_Z9n_reg_maxv>:
 5e0:	b8 30 00 00 00       	mov    $0x30,%eax
 5e5:	c3                   	retq   

...
0000000000000200 <.omp_outlined.>:
 ...
 3a1:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
 3a6:	48 8b 7c 24 30       	mov    0x30(%rsp),%rdi
 ...
 3ea:	48 8b 30             	mov    (%rax),%rsi
 3ed:	8d 14 fd 00 00 00 00 	lea    0x0(,%rdi,8),%edx
 3f4:	48 63 d2             	movslq %edx,%rdx
 3f7:	c4 e2 7d 18 04 96    	vbroadcastss (%rsi,%rdx,4),%ymm0
 3fd:	8d 14 fd 01 00 00 00 	lea    0x1(,%rdi,8),%edx
 404:	48 63 d2             	movslq %edx,%rdx
 407:	c4 e2 7d 18 0c 96    	vbroadcastss (%rsi,%rdx,4),%ymm1
 40d:	8d 14 fd 02 00 00 00 	lea    0x2(,%rdi,8),%edx
 414:	48 63 d2             	movslq %edx,%rdx
 417:	c4 e2 7d 18 14 96    	vbroadcastss (%rsi,%rdx,4),%ymm2
 41d:	8d 14 fd 03 00 00 00 	lea    0x3(,%rdi,8),%edx
 424:	48 63 d2             	movslq %edx,%rdx
 427:	c4 e2 7d 18 1c 96    	vbroadcastss (%rsi,%rdx,4),%ymm3
 42d:	8d 14 fd 04 00 00 00 	lea    0x4(,%rdi,8),%edx
 434:	48 63 d2             	movslq %edx,%rdx
 437:	c4 e2 7d 18 24 96    	vbroadcastss (%rsi,%rdx,4),%ymm4
 43d:	8d 14 fd 05 00 00 00 	lea    0x5(,%rdi,8),%edx
 444:	48 63 d2             	movslq %edx,%rdx
 447:	c4 e2 7d 18 2c 96    	vbroadcastss (%rsi,%rdx,4),%ymm5
 44d:	8d 14 fd 06 00 00 00 	lea    0x6(,%rdi,8),%edx
 454:	48 63 d2             	movslq %edx,%rdx
 457:	c4 e2 7d 18 34 96    	vbroadcastss (%rsi,%rdx,4),%ymm6
 45d:	8d 14 fd 07 00 00 00 	lea    0x7(,%rdi,8),%edx
 464:	48 63 d2             	movslq %edx,%rdx
 467:	c4 e2 7d 18 3c 96    	vbroadcastss (%rsi,%rdx,4),%ymm7
 46d:	48 63 54 24 0c       	movslq 0xc(%rsp),%rdx
 472:	31 f6                	xor    %esi,%esi
 474:	48 c1 e2 02          	shl    $0x2,%rdx
 478:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
 47f:	00 
 480:	49 8b 3e             	mov    (%r14),%rdi
 483:	4c 8b 23             	mov    (%rbx),%r12
 486:	48 8d 44 17 60       	lea    0x60(%rdi,%rdx,1),%rax
 48b:	c5 7c 10 5c b0 a0    	vmovups -0x60(%rax,%rsi,4),%ymm11
 491:	c4 42 7d a8 1c b4    	vfmadd213ps (%r12,%rsi,4),%ymm0,%ymm11
 497:	c5 7c 10 54 b0 c0    	vmovups -0x40(%rax,%rsi,4),%ymm10
 49d:	c5 7c 10 4c b0 e0    	vmovups -0x20(%rax,%rsi,4),%ymm9
 4a3:	c5 7c 10 04 b0       	vmovups (%rax,%rsi,4),%ymm8
 4a8:	48 8d 44 2f 60       	lea    0x60(%rdi,%rbp,1),%rax
 4ad:	c4 42 7d a8 54 b4 20 	vfmadd213ps 0x20(%r12,%rsi,4),%ymm0,%ymm10
 4b4:	c4 42 7d a8 4c b4 40 	vfmadd213ps 0x40(%r12,%rsi,4),%ymm0,%ymm9
 4bb:	c4 42 7d a8 44 b4 60 	vfmadd213ps 0x60(%r12,%rsi,4),%ymm0,%ymm8
 4c2:	c4 62 75 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm1,%ymm11
 4c9:	c4 62 75 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm1,%ymm10
 4d0:	c4 62 75 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm1,%ymm9
 4d7:	c4 62 75 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm8
 4dd:	4a 8d 44 2f 60       	lea    0x60(%rdi,%r13,1),%rax
 4e2:	c4 62 6d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm2,%ymm11
 4e9:	c4 62 6d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm2,%ymm10
 4f0:	c4 62 6d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm2,%ymm9
 4f7:	c4 62 6d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm2,%ymm8
 4fd:	4a 8d 44 1f 60       	lea    0x60(%rdi,%r11,1),%rax
 502:	c4 62 65 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm3,%ymm11
 509:	c4 62 65 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm3,%ymm10
 510:	c4 62 65 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm3,%ymm9
 517:	c4 62 65 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm3,%ymm8
 51d:	4a 8d 44 17 60       	lea    0x60(%rdi,%r10,1),%rax
 522:	c4 62 5d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm4,%ymm11
 529:	c4 62 5d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm4,%ymm10
 530:	c4 62 5d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm4,%ymm9
 537:	c4 62 5d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm4,%ymm8
 53d:	4a 8d 44 0f 60       	lea    0x60(%rdi,%r9,1),%rax
 542:	c4 62 55 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm5,%ymm11
 549:	c4 62 55 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm5,%ymm10
 550:	c4 62 55 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm5,%ymm9
 557:	c4 62 55 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm5,%ymm8
 55d:	4a 8d 44 07 60       	lea    0x60(%rdi,%r8,1),%rax
 562:	c4 62 4d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm6,%ymm11
 569:	c4 62 4d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm6,%ymm10
 570:	c4 62 4d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm6,%ymm9
 577:	c4 62 4d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm6,%ymm8
 57d:	4a 8d 44 3f 60       	lea    0x60(%rdi,%r15,1),%rax
 582:	c4 62 45 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm7,%ymm11
 589:	c4 62 45 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm7,%ymm10
 590:	c4 62 45 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm7,%ymm9
 597:	c4 62 45 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm7,%ymm8
 59d:	c4 41 7c 11 1c b4    	vmovups %ymm11,(%r12,%rsi,4)
 5a3:	48 8b 03             	mov    (%rbx),%rax
 5a6:	c5 7c 11 54 b0 20    	vmovups %ymm10,0x20(%rax,%rsi,4)
 5ac:	48 8b 03             	mov    (%rbx),%rax
 5af:	c5 7c 11 4c b0 40    	vmovups %ymm9,0x40(%rax,%rsi,4)
 5b5:	48 8b 03             	mov    (%rbx),%rax
 5b8:	c5 7c 11 44 b0 60    	vmovups %ymm8,0x60(%rax,%rsi,4)
 5be:	48 83 c6 20          	add    $0x20,%rsi
 5c2:	48 39 ce             	cmp    %rcx,%rsi
 5c5:	0f 8c b5 fe ff ff    	jl     480 <.omp_outlined.+0x280>
 5cb:	e9 90 fd ff ff       	jmpq   360 <.omp_outlined.+0x160>

00000000000005d0 <_Z6enablev>:
 5d0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 5d7 <_Z6enablev+0x7>
 5d7:	b8 20 00 00 00       	mov    $0x20,%eax
 5dc:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 5e1:	0f 45 c8             	cmovne %eax,%ecx
 5e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 5ea <_Z6enablev+0x1a>
 5ea:	0f 9e c1             	setle  %cl
 5ed:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 5f4 <_Z6enablev+0x24>
...
0000000000000600 <_Z9n_reg_maxv>:
 600:	b8 2c 00 00 00       	mov    $0x2c,%eax
 605:	c3                   	retq   

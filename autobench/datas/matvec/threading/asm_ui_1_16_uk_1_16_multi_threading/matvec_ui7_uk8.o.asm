...
0000000000000210 <.omp_outlined.>:
 ...
 496:	48 8d 84 17 c0 00 00 	lea    0xc0(%rdi,%rdx,1),%rax
 49d:	00 
 49e:	c5 7c 10 b4 b0 40 ff 	vmovups -0xc0(%rax,%rsi,4),%ymm14
 4a5:	ff ff 
 4a7:	c4 42 7d a8 34 b4    	vfmadd213ps (%r12,%rsi,4),%ymm0,%ymm14
 4ad:	c5 7c 10 ac b0 60 ff 	vmovups -0xa0(%rax,%rsi,4),%ymm13
 4b4:	ff ff 
 4b6:	c5 7c 10 64 b0 80    	vmovups -0x80(%rax,%rsi,4),%ymm12
 4bc:	c5 7c 10 5c b0 a0    	vmovups -0x60(%rax,%rsi,4),%ymm11
 4c2:	c5 7c 10 54 b0 c0    	vmovups -0x40(%rax,%rsi,4),%ymm10
 4c8:	c5 7c 10 4c b0 e0    	vmovups -0x20(%rax,%rsi,4),%ymm9
 4ce:	c5 7c 10 04 b0       	vmovups (%rax,%rsi,4),%ymm8
 4d3:	48 8d 84 2f c0 00 00 	lea    0xc0(%rdi,%rbp,1),%rax
 4da:	00 
 4db:	c4 42 7d a8 6c b4 20 	vfmadd213ps 0x20(%r12,%rsi,4),%ymm0,%ymm13
 4e2:	c4 42 7d a8 64 b4 40 	vfmadd213ps 0x40(%r12,%rsi,4),%ymm0,%ymm12
 4e9:	c4 42 7d a8 5c b4 60 	vfmadd213ps 0x60(%r12,%rsi,4),%ymm0,%ymm11
 4f0:	c4 42 7d a8 94 b4 80 	vfmadd213ps 0x80(%r12,%rsi,4),%ymm0,%ymm10
 4f7:	00 00 00 
 4fa:	c4 42 7d a8 8c b4 a0 	vfmadd213ps 0xa0(%r12,%rsi,4),%ymm0,%ymm9
 501:	00 00 00 
 504:	c4 42 7d a8 84 b4 c0 	vfmadd213ps 0xc0(%r12,%rsi,4),%ymm0,%ymm8
 50b:	00 00 00 
 50e:	c4 62 75 b8 b4 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm1,%ymm14
 515:	ff ff ff 
 518:	c4 62 75 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm1,%ymm13
 51f:	ff ff ff 
 522:	c4 62 75 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm1,%ymm12
 529:	c4 62 75 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm1,%ymm11
 530:	c4 62 75 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm1,%ymm10
 537:	c4 62 75 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm1,%ymm9
 53e:	c4 62 75 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm8
 544:	4a 8d 84 2f c0 00 00 	lea    0xc0(%rdi,%r13,1),%rax
 54b:	00 
 54c:	c4 62 6d b8 b4 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm2,%ymm14
 553:	ff ff ff 
 556:	c4 62 6d b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm2,%ymm13
 55d:	ff ff ff 
 560:	c4 62 6d b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm2,%ymm12
 567:	c4 62 6d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm2,%ymm11
 56e:	c4 62 6d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm2,%ymm10
 575:	c4 62 6d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm2,%ymm9
 57c:	c4 62 6d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm2,%ymm8
 582:	4a 8d 84 1f c0 00 00 	lea    0xc0(%rdi,%r11,1),%rax
 589:	00 
 58a:	c4 62 65 b8 b4 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm3,%ymm14
 591:	ff ff ff 
 594:	c4 62 65 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm3,%ymm13
 59b:	ff ff ff 
 59e:	c4 62 65 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm3,%ymm12
 5a5:	c4 62 65 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm3,%ymm11
 5ac:	c4 62 65 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm3,%ymm10
 5b3:	c4 62 65 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm3,%ymm9
 5ba:	c4 62 65 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm3,%ymm8
 5c0:	4a 8d 84 17 c0 00 00 	lea    0xc0(%rdi,%r10,1),%rax
 5c7:	00 
 5c8:	c4 62 5d b8 b4 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm4,%ymm14
 5cf:	ff ff ff 
 5d2:	c4 62 5d b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm4,%ymm13
 5d9:	ff ff ff 
 5dc:	c4 62 5d b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm4,%ymm12
 5e3:	c4 62 5d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm4,%ymm11
 5ea:	c4 62 5d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm4,%ymm10
 5f1:	c4 62 5d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm4,%ymm9
 5f8:	c4 62 5d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm4,%ymm8
 5fe:	4a 8d 84 0f c0 00 00 	lea    0xc0(%rdi,%r9,1),%rax
 605:	00 
 606:	c4 62 55 b8 b4 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm5,%ymm14
 60d:	ff ff ff 
 610:	c4 62 55 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm5,%ymm13
 617:	ff ff ff 
 61a:	c4 62 55 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm5,%ymm12
 621:	c4 62 55 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm5,%ymm11
 628:	c4 62 55 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm5,%ymm10
 62f:	c4 62 55 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm5,%ymm9
 636:	c4 62 55 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm5,%ymm8
 63c:	4a 8d 84 07 c0 00 00 	lea    0xc0(%rdi,%r8,1),%rax
 643:	00 
 644:	c4 62 4d b8 b4 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm6,%ymm14
 64b:	ff ff ff 
 64e:	c4 62 4d b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm6,%ymm13
 655:	ff ff ff 
 658:	c4 62 4d b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm6,%ymm12
 65f:	c4 62 4d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm6,%ymm11
 666:	c4 62 4d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm6,%ymm10
 66d:	c4 62 4d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm6,%ymm9
 674:	c4 62 4d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm6,%ymm8
 67a:	4a 8d 84 3f c0 00 00 	lea    0xc0(%rdi,%r15,1),%rax
 681:	00 
 682:	c4 62 45 b8 b4 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm7,%ymm14
 689:	ff ff ff 
 68c:	c4 62 45 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm7,%ymm13
 693:	ff ff ff 
 696:	c4 62 45 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm7,%ymm12
 69d:	c4 62 45 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm7,%ymm11
 6a4:	c4 62 45 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm7,%ymm10
 6ab:	c4 62 45 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm7,%ymm9
 6b2:	c4 62 45 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm7,%ymm8
 6b8:	c4 41 7c 11 34 b4    	vmovups %ymm14,(%r12,%rsi,4)
 6be:	48 8b 03             	mov    (%rbx),%rax
 6c1:	c5 7c 11 6c b0 20    	vmovups %ymm13,0x20(%rax,%rsi,4)
 6c7:	48 8b 03             	mov    (%rbx),%rax
 6ca:	c5 7c 11 64 b0 40    	vmovups %ymm12,0x40(%rax,%rsi,4)
 6d0:	48 8b 03             	mov    (%rbx),%rax
 6d3:	c5 7c 11 5c b0 60    	vmovups %ymm11,0x60(%rax,%rsi,4)
 6d9:	48 8b 03             	mov    (%rbx),%rax
 6dc:	c5 7c 11 94 b0 80 00 	vmovups %ymm10,0x80(%rax,%rsi,4)
 6e3:	00 00 
 6e5:	48 8b 03             	mov    (%rbx),%rax
 6e8:	c5 7c 11 8c b0 a0 00 	vmovups %ymm9,0xa0(%rax,%rsi,4)
 6ef:	00 00 
 6f1:	48 8b 03             	mov    (%rbx),%rax
 6f4:	c5 7c 11 84 b0 c0 00 	vmovups %ymm8,0xc0(%rax,%rsi,4)
 6fb:	00 00 
 6fd:	48 83 c6 38          	add    $0x38,%rsi
 701:	48 39 ce             	cmp    %rcx,%rsi
 704:	0f 8c 86 fd ff ff    	jl     490 <.omp_outlined.+0x280>
 70a:	e9 61 fc ff ff       	jmpq   370 <.omp_outlined.+0x160>
 70f:	90                   	nop

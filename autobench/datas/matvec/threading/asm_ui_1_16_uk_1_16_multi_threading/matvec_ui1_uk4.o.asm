...
0000000000000200 <.omp_outlined.>:
 ...
 253:	44 89 64 24 08       	mov    %r12d,0x8(%rsp)
 ...
 29b:	44 89 64 24 08       	mov    %r12d,0x8(%rsp)
 2a0:	45 39 e2             	cmp    %r12d,%r10d
 ...
 2cf:	46 8d 04 95 03 00 00 	lea    0x3(,%r10,4),%r8d
 2d6:	00 
 2d7:	42 8d 14 95 02 00 00 	lea    0x2(,%r10,4),%edx
 2de:	00 
 2df:	42 8d 0c 95 01 00 00 	lea    0x1(,%r10,4),%ecx
 2e6:	00 
 2e7:	49 63 c4             	movslq %r12d,%rax
 2ea:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
 2ef:	45 0f af cb          	imul   %r11d,%r9d
 2f3:	41 0f af d3          	imul   %r11d,%edx
 2f7:	41 0f af cb          	imul   %r11d,%ecx
 2fb:	45 0f af c3          	imul   %r11d,%r8d
 2ff:	42 8d 04 9d 00 00 00 	lea    0x0(,%r11,4),%eax
 306:	00 
 307:	89 44 24 1c          	mov    %eax,0x1c(%rsp)
 30b:	41 c1 e1 02          	shl    $0x2,%r9d
 30f:	89 54 24 10          	mov    %edx,0x10(%rsp)
 313:	89 4c 24 0c          	mov    %ecx,0xc(%rsp)
 317:	eb 28                	jmp    341 <.omp_outlined.+0x141>
 ...
 341:	45 85 db             	test   %r11d,%r11d
 344:	7e da                	jle    320 <.omp_outlined.+0x120>
 346:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
 34b:	49 63 f0             	movslq %r8d,%rsi
 34e:	44 89 c1             	mov    %r8d,%ecx
 351:	46 8d 3c 95 00 00 00 	lea    0x0(,%r10,4),%r15d
 358:	00 
 359:	42 8d 1c 95 02 00 00 	lea    0x2(,%r10,4),%ebx
 360:	00 
 361:	48 63 6c 24 10       	movslq 0x10(%rsp),%rbp
 366:	48 63 54 24 0c       	movslq 0xc(%rsp),%rdx
 36b:	4d 63 e1             	movslq %r9d,%r12
 36e:	49 63 ff             	movslq %r15d,%rdi
 371:	48 c1 e6 02          	shl    $0x2,%rsi
 375:	49 c1 e4 02          	shl    $0x2,%r12
 379:	45 31 ff             	xor    %r15d,%r15d
 37c:	48 c1 e5 02          	shl    $0x2,%rbp
 380:	48 c1 e2 02          	shl    $0x2,%rdx
 384:	4c 8b 00             	mov    (%rax),%r8
 387:	42 8d 04 95 01 00 00 	lea    0x1(,%r10,4),%eax
 38e:	00 
 38f:	c4 c2 7d 18 04 b8    	vbroadcastss (%r8,%rdi,4),%ymm0
 395:	48 63 f8             	movslq %eax,%rdi
 398:	42 8d 04 95 03 00 00 	lea    0x3(,%r10,4),%eax
 39f:	00 
 3a0:	c4 c2 7d 18 0c b8    	vbroadcastss (%r8,%rdi,4),%ymm1
 3a6:	48 63 fb             	movslq %ebx,%rdi
 3a9:	c4 c2 7d 18 14 b8    	vbroadcastss (%r8,%rdi,4),%ymm2
 3af:	48 63 f8             	movslq %eax,%rdi
 3b2:	c4 c2 7d 18 1c b8    	vbroadcastss (%r8,%rdi,4),%ymm3
 3b8:	41 89 c8             	mov    %ecx,%r8d
 3bb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
 3c0:	49 8b 06             	mov    (%r14),%rax
 3c3:	49 8b 7d 00          	mov    0x0(%r13),%rdi
 3c7:	4a 8d 1c 20          	lea    (%rax,%r12,1),%rbx
 3cb:	48 8d 0c 28          	lea    (%rax,%rbp,1),%rcx
 3cf:	c4 a1 7c 10 24 bb    	vmovups (%rbx,%r15,4),%ymm4
 3d5:	c4 a2 7d a8 24 bf    	vfmadd213ps (%rdi,%r15,4),%ymm0,%ymm4
 3db:	48 8d 1c 10          	lea    (%rax,%rdx,1),%rbx
 3df:	48 8d 04 30          	lea    (%rax,%rsi,1),%rax
 3e3:	c4 a2 75 b8 24 bb    	vfmadd231ps (%rbx,%r15,4),%ymm1,%ymm4
 3e9:	c4 a2 6d b8 24 b9    	vfmadd231ps (%rcx,%r15,4),%ymm2,%ymm4
 3ef:	c4 a2 65 b8 24 b8    	vfmadd231ps (%rax,%r15,4),%ymm3,%ymm4
 3f5:	c4 a1 7c 11 24 bf    	vmovups %ymm4,(%rdi,%r15,4)
 3fb:	49 83 c7 08          	add    $0x8,%r15
 3ff:	4d 39 df             	cmp    %r11,%r15
 402:	7c bc                	jl     3c0 <.omp_outlined.+0x1c0>
 404:	e9 17 ff ff ff       	jmpq   320 <.omp_outlined.+0x120>
...
0000000000000410 <_Z6enablev>:
 ...
 424:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 42b <_Z6enablev+0x1b>

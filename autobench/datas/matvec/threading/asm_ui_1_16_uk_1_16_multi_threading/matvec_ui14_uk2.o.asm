...
0000000000000210 <.omp_outlined.>:
 ...
 356:	4c 8d a4 28 a0 01 00 	lea    0x1a0(%rax,%rbp,1),%r12
 35d:	00 
 35e:	48 8d 84 10 a0 01 00 	lea    0x1a0(%rax,%rdx,1),%rax
 365:	00 
 366:	c4 41 7c 10 bc b4 60 	vmovups -0x1a0(%r12,%rsi,4),%ymm15
 36d:	fe ff ff 
 370:	c4 62 7d a8 3c b7    	vfmadd213ps (%rdi,%rsi,4),%ymm0,%ymm15
 376:	c4 41 7c 10 b4 b4 80 	vmovups -0x180(%r12,%rsi,4),%ymm14
 37d:	fe ff ff 
 380:	c4 62 7d a8 74 b7 20 	vfmadd213ps 0x20(%rdi,%rsi,4),%ymm0,%ymm14
 387:	c4 41 7c 10 ac b4 a0 	vmovups -0x160(%r12,%rsi,4),%ymm13
 38e:	fe ff ff 
 391:	c4 41 7c 10 a4 b4 c0 	vmovups -0x140(%r12,%rsi,4),%ymm12
 398:	fe ff ff 
 39b:	c4 41 7c 10 9c b4 e0 	vmovups -0x120(%r12,%rsi,4),%ymm11
 3a2:	fe ff ff 
 3a5:	c4 41 7c 10 94 b4 00 	vmovups -0x100(%r12,%rsi,4),%ymm10
 3ac:	ff ff ff 
 3af:	c4 41 7c 10 8c b4 20 	vmovups -0xe0(%r12,%rsi,4),%ymm9
 3b6:	ff ff ff 
 3b9:	c4 41 7c 10 84 b4 40 	vmovups -0xc0(%r12,%rsi,4),%ymm8
 3c0:	ff ff ff 
 3c3:	c4 c1 7c 10 bc b4 60 	vmovups -0xa0(%r12,%rsi,4),%ymm7
 3ca:	ff ff ff 
 3cd:	c4 c1 7c 10 74 b4 80 	vmovups -0x80(%r12,%rsi,4),%ymm6
 3d4:	c4 c1 7c 10 6c b4 a0 	vmovups -0x60(%r12,%rsi,4),%ymm5
 3db:	c4 c1 7c 10 64 b4 c0 	vmovups -0x40(%r12,%rsi,4),%ymm4
 3e2:	c4 c1 7c 10 5c b4 e0 	vmovups -0x20(%r12,%rsi,4),%ymm3
 3e9:	c4 c1 7c 10 14 b4    	vmovups (%r12,%rsi,4),%ymm2
 3ef:	c4 62 7d a8 6c b7 40 	vfmadd213ps 0x40(%rdi,%rsi,4),%ymm0,%ymm13
 3f6:	c4 62 7d a8 64 b7 60 	vfmadd213ps 0x60(%rdi,%rsi,4),%ymm0,%ymm12
 3fd:	c4 62 7d a8 9c b7 80 	vfmadd213ps 0x80(%rdi,%rsi,4),%ymm0,%ymm11
 404:	00 00 00 
 407:	c4 62 7d a8 94 b7 a0 	vfmadd213ps 0xa0(%rdi,%rsi,4),%ymm0,%ymm10
 40e:	00 00 00 
 411:	c4 62 7d a8 8c b7 c0 	vfmadd213ps 0xc0(%rdi,%rsi,4),%ymm0,%ymm9
 418:	00 00 00 
 41b:	c4 62 7d a8 84 b7 e0 	vfmadd213ps 0xe0(%rdi,%rsi,4),%ymm0,%ymm8
 422:	00 00 00 
 425:	c4 e2 7d a8 bc b7 00 	vfmadd213ps 0x100(%rdi,%rsi,4),%ymm0,%ymm7
 42c:	01 00 00 
 42f:	c4 e2 7d a8 b4 b7 20 	vfmadd213ps 0x120(%rdi,%rsi,4),%ymm0,%ymm6
 436:	01 00 00 
 439:	c4 e2 7d a8 ac b7 40 	vfmadd213ps 0x140(%rdi,%rsi,4),%ymm0,%ymm5
 440:	01 00 00 
 443:	c4 e2 7d a8 a4 b7 60 	vfmadd213ps 0x160(%rdi,%rsi,4),%ymm0,%ymm4
 44a:	01 00 00 
 44d:	c4 e2 7d a8 9c b7 80 	vfmadd213ps 0x180(%rdi,%rsi,4),%ymm0,%ymm3
 454:	01 00 00 
 457:	c4 e2 7d a8 94 b7 a0 	vfmadd213ps 0x1a0(%rdi,%rsi,4),%ymm0,%ymm2
 45e:	01 00 00 
 461:	c4 62 75 b8 bc b0 60 	vfmadd231ps -0x1a0(%rax,%rsi,4),%ymm1,%ymm15
 468:	fe ff ff 
 46b:	c4 62 75 b8 b4 b0 80 	vfmadd231ps -0x180(%rax,%rsi,4),%ymm1,%ymm14
 472:	fe ff ff 
 475:	c4 62 75 b8 ac b0 a0 	vfmadd231ps -0x160(%rax,%rsi,4),%ymm1,%ymm13
 47c:	fe ff ff 
 47f:	c4 62 75 b8 a4 b0 c0 	vfmadd231ps -0x140(%rax,%rsi,4),%ymm1,%ymm12
 486:	fe ff ff 
 489:	c4 62 75 b8 9c b0 e0 	vfmadd231ps -0x120(%rax,%rsi,4),%ymm1,%ymm11
 490:	fe ff ff 
 493:	c4 62 75 b8 94 b0 00 	vfmadd231ps -0x100(%rax,%rsi,4),%ymm1,%ymm10
 49a:	ff ff ff 
 49d:	c4 62 75 b8 8c b0 20 	vfmadd231ps -0xe0(%rax,%rsi,4),%ymm1,%ymm9
 4a4:	ff ff ff 
 4a7:	c4 62 75 b8 84 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm1,%ymm8
 4ae:	ff ff ff 
 4b1:	c4 e2 75 b8 bc b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm1,%ymm7
 4b8:	ff ff ff 
 4bb:	c4 e2 75 b8 74 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm1,%ymm6
 4c2:	c4 e2 75 b8 6c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm1,%ymm5
 4c9:	c4 e2 75 b8 64 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm1,%ymm4
 4d0:	c4 e2 75 b8 5c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm1,%ymm3
 4d7:	c4 e2 75 b8 14 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm2
 4dd:	c5 7c 11 3c b7       	vmovups %ymm15,(%rdi,%rsi,4)
 4e2:	48 8b 03             	mov    (%rbx),%rax
 4e5:	c5 7c 11 74 b0 20    	vmovups %ymm14,0x20(%rax,%rsi,4)
 4eb:	48 8b 03             	mov    (%rbx),%rax
 4ee:	c5 7c 11 6c b0 40    	vmovups %ymm13,0x40(%rax,%rsi,4)
 4f4:	48 8b 03             	mov    (%rbx),%rax
 4f7:	c5 7c 11 64 b0 60    	vmovups %ymm12,0x60(%rax,%rsi,4)
 4fd:	48 8b 03             	mov    (%rbx),%rax
 500:	c5 7c 11 9c b0 80 00 	vmovups %ymm11,0x80(%rax,%rsi,4)
 507:	00 00 
 509:	48 8b 03             	mov    (%rbx),%rax
 50c:	c5 7c 11 94 b0 a0 00 	vmovups %ymm10,0xa0(%rax,%rsi,4)
 513:	00 00 
 515:	48 8b 03             	mov    (%rbx),%rax
 518:	c5 7c 11 8c b0 c0 00 	vmovups %ymm9,0xc0(%rax,%rsi,4)
 51f:	00 00 
 521:	48 8b 03             	mov    (%rbx),%rax
 524:	c5 7c 11 84 b0 e0 00 	vmovups %ymm8,0xe0(%rax,%rsi,4)
 52b:	00 00 
 52d:	48 8b 03             	mov    (%rbx),%rax
 530:	c5 fc 11 bc b0 00 01 	vmovups %ymm7,0x100(%rax,%rsi,4)
 537:	00 00 
 539:	48 8b 03             	mov    (%rbx),%rax
 53c:	c5 fc 11 b4 b0 20 01 	vmovups %ymm6,0x120(%rax,%rsi,4)
 543:	00 00 
 545:	48 8b 03             	mov    (%rbx),%rax
 548:	c5 fc 11 ac b0 40 01 	vmovups %ymm5,0x140(%rax,%rsi,4)
 54f:	00 00 
 551:	48 8b 03             	mov    (%rbx),%rax
 554:	c5 fc 11 a4 b0 60 01 	vmovups %ymm4,0x160(%rax,%rsi,4)
 55b:	00 00 
 55d:	48 8b 03             	mov    (%rbx),%rax
 560:	c5 fc 11 9c b0 80 01 	vmovups %ymm3,0x180(%rax,%rsi,4)
 567:	00 00 
 569:	48 8b 03             	mov    (%rbx),%rax
 56c:	c5 fc 11 94 b0 a0 01 	vmovups %ymm2,0x1a0(%rax,%rsi,4)
 573:	00 00 
 575:	48 83 c6 70          	add    $0x70,%rsi
 579:	48 39 ce             	cmp    %rcx,%rsi
 57c:	0f 8c ce fd ff ff    	jl     350 <.omp_outlined.+0x140>
 582:	e9 79 fd ff ff       	jmpq   300 <.omp_outlined.+0xf0>
...
0000000000000590 <_Z6enablev>:
 ...
 597:	b8 70 00 00 00       	mov    $0x70,%eax
 59c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
...
00000000000005c0 <_Z9n_reg_maxv>:
 5c0:	b8 2c 00 00 00       	mov    $0x2c,%eax
 5c5:	c3                   	retq   

...
0000000000000200 <.omp_outlined.>:
 ...
 2cb:	00 
 2cc:	48 8d 34 b5 20 00 00 	lea    0x20(,%rsi,4),%rsi
 2d3:	00 
 ...
 309:	c5 fc 10 4c af e0    	vmovups -0x20(%rdi,%rbp,4),%ymm1
 30f:	c4 e2 7d a8 0c aa    	vfmadd213ps (%rdx,%rbp,4),%ymm0,%ymm1
 315:	c5 fc 10 14 af       	vmovups (%rdi,%rbp,4),%ymm2
 31a:	c4 e2 7d a8 54 aa 20 	vfmadd213ps 0x20(%rdx,%rbp,4),%ymm0,%ymm2
 321:	c5 fc 11 0c aa       	vmovups %ymm1,(%rdx,%rbp,4)
 326:	48 8b 13             	mov    (%rbx),%rdx
 329:	c5 fc 11 54 aa 20    	vmovups %ymm2,0x20(%rdx,%rbp,4)
 32f:	48 83 c5 10          	add    $0x10,%rbp
 333:	48 39 cd             	cmp    %rcx,%rbp
 336:	7c c8                	jl     300 <.omp_outlined.+0x100>
 338:	eb a6                	jmp    2e0 <.omp_outlined.+0xe0>

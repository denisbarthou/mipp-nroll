...
0000000000000200 <.omp_outlined.>:
 ...
 2cb:	00 
 2cc:	48 8d 34 b5 60 00 00 	lea    0x60(,%rsi,4),%rsi
 2d3:	00 
 2d4:	eb 16                	jmp    2ec <.omp_outlined.+0xec>
 ...
 309:	c5 fc 10 4c af a0    	vmovups -0x60(%rdi,%rbp,4),%ymm1
 30f:	c4 e2 7d a8 0c aa    	vfmadd213ps (%rdx,%rbp,4),%ymm0,%ymm1
 315:	c5 fc 10 54 af c0    	vmovups -0x40(%rdi,%rbp,4),%ymm2
 31b:	c4 e2 7d a8 54 aa 20 	vfmadd213ps 0x20(%rdx,%rbp,4),%ymm0,%ymm2
 322:	c5 fc 10 5c af e0    	vmovups -0x20(%rdi,%rbp,4),%ymm3
 328:	c5 fc 10 24 af       	vmovups (%rdi,%rbp,4),%ymm4
 32d:	c4 e2 7d a8 5c aa 40 	vfmadd213ps 0x40(%rdx,%rbp,4),%ymm0,%ymm3
 334:	c4 e2 7d a8 64 aa 60 	vfmadd213ps 0x60(%rdx,%rbp,4),%ymm0,%ymm4
 33b:	c5 fc 11 0c aa       	vmovups %ymm1,(%rdx,%rbp,4)
 340:	48 8b 13             	mov    (%rbx),%rdx
 343:	c5 fc 11 54 aa 20    	vmovups %ymm2,0x20(%rdx,%rbp,4)
 349:	48 8b 13             	mov    (%rbx),%rdx
 34c:	c5 fc 11 5c aa 40    	vmovups %ymm3,0x40(%rdx,%rbp,4)
 352:	48 8b 13             	mov    (%rbx),%rdx
 355:	c5 fc 11 64 aa 60    	vmovups %ymm4,0x60(%rdx,%rbp,4)
 35b:	48 83 c5 20          	add    $0x20,%rbp
 35f:	48 39 cd             	cmp    %rcx,%rbp
 362:	7c 9c                	jl     300 <.omp_outlined.+0x100>
 364:	e9 77 ff ff ff       	jmpq   2e0 <.omp_outlined.+0xe0>

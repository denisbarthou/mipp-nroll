...
0000000000000200 <.omp_outlined.>:
 ...
 2cb:	00 
 2cc:	48 8d 34 b5 e0 00 00 	lea    0xe0(,%rsi,4),%rsi
 2d3:	00 
 ...
 309:	c5 fc 10 8c af 20 ff 	vmovups -0xe0(%rdi,%rbp,4),%ymm1
 310:	ff ff 
 312:	c4 e2 7d a8 0c aa    	vfmadd213ps (%rdx,%rbp,4),%ymm0,%ymm1
 318:	c5 fc 10 94 af 40 ff 	vmovups -0xc0(%rdi,%rbp,4),%ymm2
 31f:	ff ff 
 321:	c4 e2 7d a8 54 aa 20 	vfmadd213ps 0x20(%rdx,%rbp,4),%ymm0,%ymm2
 328:	c5 fc 10 9c af 60 ff 	vmovups -0xa0(%rdi,%rbp,4),%ymm3
 32f:	ff ff 
 331:	c5 fc 10 64 af 80    	vmovups -0x80(%rdi,%rbp,4),%ymm4
 337:	c5 fc 10 6c af a0    	vmovups -0x60(%rdi,%rbp,4),%ymm5
 33d:	c5 fc 10 74 af c0    	vmovups -0x40(%rdi,%rbp,4),%ymm6
 343:	c5 fc 10 7c af e0    	vmovups -0x20(%rdi,%rbp,4),%ymm7
 349:	c5 7c 10 04 af       	vmovups (%rdi,%rbp,4),%ymm8
 34e:	c4 e2 7d a8 5c aa 40 	vfmadd213ps 0x40(%rdx,%rbp,4),%ymm0,%ymm3
 355:	c4 e2 7d a8 64 aa 60 	vfmadd213ps 0x60(%rdx,%rbp,4),%ymm0,%ymm4
 35c:	c4 e2 7d a8 ac aa 80 	vfmadd213ps 0x80(%rdx,%rbp,4),%ymm0,%ymm5
 363:	00 00 00 
 366:	c4 e2 7d a8 b4 aa a0 	vfmadd213ps 0xa0(%rdx,%rbp,4),%ymm0,%ymm6
 36d:	00 00 00 
 370:	c4 e2 7d a8 bc aa c0 	vfmadd213ps 0xc0(%rdx,%rbp,4),%ymm0,%ymm7
 377:	00 00 00 
 37a:	c4 62 7d a8 84 aa e0 	vfmadd213ps 0xe0(%rdx,%rbp,4),%ymm0,%ymm8
 381:	00 00 00 
 384:	c5 fc 11 0c aa       	vmovups %ymm1,(%rdx,%rbp,4)
 389:	48 8b 13             	mov    (%rbx),%rdx
 38c:	c5 fc 11 54 aa 20    	vmovups %ymm2,0x20(%rdx,%rbp,4)
 392:	48 8b 13             	mov    (%rbx),%rdx
 395:	c5 fc 11 5c aa 40    	vmovups %ymm3,0x40(%rdx,%rbp,4)
 39b:	48 8b 13             	mov    (%rbx),%rdx
 39e:	c5 fc 11 64 aa 60    	vmovups %ymm4,0x60(%rdx,%rbp,4)
 3a4:	48 8b 13             	mov    (%rbx),%rdx
 3a7:	c5 fc 11 ac aa 80 00 	vmovups %ymm5,0x80(%rdx,%rbp,4)
 3ae:	00 00 
 3b0:	48 8b 13             	mov    (%rbx),%rdx
 3b3:	c5 fc 11 b4 aa a0 00 	vmovups %ymm6,0xa0(%rdx,%rbp,4)
 3ba:	00 00 
 3bc:	48 8b 13             	mov    (%rbx),%rdx
 3bf:	c5 fc 11 bc aa c0 00 	vmovups %ymm7,0xc0(%rdx,%rbp,4)
 3c6:	00 00 
 3c8:	48 8b 13             	mov    (%rbx),%rdx
 3cb:	c5 7c 11 84 aa e0 00 	vmovups %ymm8,0xe0(%rdx,%rbp,4)
 3d2:	00 00 
 3d4:	48 83 c5 40          	add    $0x40,%rbp
 3d8:	48 39 cd             	cmp    %rcx,%rbp
 3db:	0f 8c 1f ff ff ff    	jl     300 <.omp_outlined.+0x100>
 3e1:	e9 fa fe ff ff       	jmpq   2e0 <.omp_outlined.+0xe0>
...
00000000000003f0 <_Z6enablev>:
 ...
 3f7:	b8 40 00 00 00       	mov    $0x40,%eax
 3fc:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 401:	0f 45 c8             	cmovne %eax,%ecx
 404:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 40a <_Z6enablev+0x1a>
 40a:	0f 9e c1             	setle  %cl
 40d:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 414 <_Z6enablev+0x24>

...
0000000000000210 <.omp_outlined.>:
 ...
 356:	4c 8d a4 28 60 01 00 	lea    0x160(%rax,%rbp,1),%r12
 35d:	00 
 35e:	48 8d 84 10 60 01 00 	lea    0x160(%rax,%rdx,1),%rax
 365:	00 
 366:	c4 41 7c 10 ac b4 a0 	vmovups -0x160(%r12,%rsi,4),%ymm13
 36d:	fe ff ff 
 370:	c4 62 7d a8 2c b7    	vfmadd213ps (%rdi,%rsi,4),%ymm0,%ymm13
 376:	c4 41 7c 10 a4 b4 c0 	vmovups -0x140(%r12,%rsi,4),%ymm12
 37d:	fe ff ff 
 380:	c4 62 7d a8 64 b7 20 	vfmadd213ps 0x20(%rdi,%rsi,4),%ymm0,%ymm12
 387:	c4 41 7c 10 9c b4 e0 	vmovups -0x120(%r12,%rsi,4),%ymm11
 38e:	fe ff ff 
 391:	c4 41 7c 10 94 b4 00 	vmovups -0x100(%r12,%rsi,4),%ymm10
 398:	ff ff ff 
 39b:	c4 41 7c 10 8c b4 20 	vmovups -0xe0(%r12,%rsi,4),%ymm9
 3a2:	ff ff ff 
 3a5:	c4 41 7c 10 84 b4 40 	vmovups -0xc0(%r12,%rsi,4),%ymm8
 3ac:	ff ff ff 
 3af:	c4 c1 7c 10 bc b4 60 	vmovups -0xa0(%r12,%rsi,4),%ymm7
 3b6:	ff ff ff 
 3b9:	c4 c1 7c 10 74 b4 80 	vmovups -0x80(%r12,%rsi,4),%ymm6
 3c0:	c4 c1 7c 10 6c b4 a0 	vmovups -0x60(%r12,%rsi,4),%ymm5
 3c7:	c4 c1 7c 10 64 b4 c0 	vmovups -0x40(%r12,%rsi,4),%ymm4
 3ce:	c4 c1 7c 10 5c b4 e0 	vmovups -0x20(%r12,%rsi,4),%ymm3
 3d5:	c4 c1 7c 10 14 b4    	vmovups (%r12,%rsi,4),%ymm2
 3db:	c4 62 7d a8 5c b7 40 	vfmadd213ps 0x40(%rdi,%rsi,4),%ymm0,%ymm11
 3e2:	c4 62 7d a8 54 b7 60 	vfmadd213ps 0x60(%rdi,%rsi,4),%ymm0,%ymm10
 3e9:	c4 62 7d a8 8c b7 80 	vfmadd213ps 0x80(%rdi,%rsi,4),%ymm0,%ymm9
 3f0:	00 00 00 
 3f3:	c4 62 7d a8 84 b7 a0 	vfmadd213ps 0xa0(%rdi,%rsi,4),%ymm0,%ymm8
 3fa:	00 00 00 
 3fd:	c4 e2 7d a8 bc b7 c0 	vfmadd213ps 0xc0(%rdi,%rsi,4),%ymm0,%ymm7
 404:	00 00 00 
 407:	c4 e2 7d a8 b4 b7 e0 	vfmadd213ps 0xe0(%rdi,%rsi,4),%ymm0,%ymm6
 40e:	00 00 00 
 411:	c4 e2 7d a8 ac b7 00 	vfmadd213ps 0x100(%rdi,%rsi,4),%ymm0,%ymm5
 418:	01 00 00 
 41b:	c4 e2 7d a8 a4 b7 20 	vfmadd213ps 0x120(%rdi,%rsi,4),%ymm0,%ymm4
 422:	01 00 00 
 425:	c4 e2 7d a8 9c b7 40 	vfmadd213ps 0x140(%rdi,%rsi,4),%ymm0,%ymm3
 42c:	01 00 00 
 42f:	c4 e2 7d a8 94 b7 60 	vfmadd213ps 0x160(%rdi,%rsi,4),%ymm0,%ymm2
 436:	01 00 00 
 439:	c4 62 75 b8 ac b0 a0 	vfmadd231ps -0x160(%rax,%rsi,4),%ymm1,%ymm13
 440:	fe ff ff 
 443:	c4 62 75 b8 a4 b0 c0 	vfmadd231ps -0x140(%rax,%rsi,4),%ymm1,%ymm12
 44a:	fe ff ff 
 44d:	c4 62 75 b8 9c b0 e0 	vfmadd231ps -0x120(%rax,%rsi,4),%ymm1,%ymm11
 454:	fe ff ff 
 457:	c4 62 75 b8 94 b0 00 	vfmadd231ps -0x100(%rax,%rsi,4),%ymm1,%ymm10
 45e:	ff ff ff 
 461:	c4 62 75 b8 8c b0 20 	vfmadd231ps -0xe0(%rax,%rsi,4),%ymm1,%ymm9
 468:	ff ff ff 
 46b:	c4 62 75 b8 84 b0 40 	vfmadd231ps -0xc0(%rax,%rsi,4),%ymm1,%ymm8
 472:	ff ff ff 
 475:	c4 e2 75 b8 bc b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm1,%ymm7
 47c:	ff ff ff 
 47f:	c4 e2 75 b8 74 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm1,%ymm6
 486:	c4 e2 75 b8 6c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm1,%ymm5
 48d:	c4 e2 75 b8 64 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm1,%ymm4
 494:	c4 e2 75 b8 5c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm1,%ymm3
 49b:	c4 e2 75 b8 14 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm2
 4a1:	c5 7c 11 2c b7       	vmovups %ymm13,(%rdi,%rsi,4)
 4a6:	48 8b 03             	mov    (%rbx),%rax
 4a9:	c5 7c 11 64 b0 20    	vmovups %ymm12,0x20(%rax,%rsi,4)
 4af:	48 8b 03             	mov    (%rbx),%rax
 4b2:	c5 7c 11 5c b0 40    	vmovups %ymm11,0x40(%rax,%rsi,4)
 4b8:	48 8b 03             	mov    (%rbx),%rax
 4bb:	c5 7c 11 54 b0 60    	vmovups %ymm10,0x60(%rax,%rsi,4)
 4c1:	48 8b 03             	mov    (%rbx),%rax
 4c4:	c5 7c 11 8c b0 80 00 	vmovups %ymm9,0x80(%rax,%rsi,4)
 4cb:	00 00 
 4cd:	48 8b 03             	mov    (%rbx),%rax
 4d0:	c5 7c 11 84 b0 a0 00 	vmovups %ymm8,0xa0(%rax,%rsi,4)
 4d7:	00 00 
 4d9:	48 8b 03             	mov    (%rbx),%rax
 4dc:	c5 fc 11 bc b0 c0 00 	vmovups %ymm7,0xc0(%rax,%rsi,4)
 4e3:	00 00 
 4e5:	48 8b 03             	mov    (%rbx),%rax
 4e8:	c5 fc 11 b4 b0 e0 00 	vmovups %ymm6,0xe0(%rax,%rsi,4)
 4ef:	00 00 
 4f1:	48 8b 03             	mov    (%rbx),%rax
 4f4:	c5 fc 11 ac b0 00 01 	vmovups %ymm5,0x100(%rax,%rsi,4)
 4fb:	00 00 
 4fd:	48 8b 03             	mov    (%rbx),%rax
 500:	c5 fc 11 a4 b0 20 01 	vmovups %ymm4,0x120(%rax,%rsi,4)
 507:	00 00 
 509:	48 8b 03             	mov    (%rbx),%rax
 50c:	c5 fc 11 9c b0 40 01 	vmovups %ymm3,0x140(%rax,%rsi,4)
 513:	00 00 
 515:	48 8b 03             	mov    (%rbx),%rax
 518:	c5 fc 11 94 b0 60 01 	vmovups %ymm2,0x160(%rax,%rsi,4)
 51f:	00 00 
 521:	48 83 c6 60          	add    $0x60,%rsi
 525:	48 39 ce             	cmp    %rcx,%rsi
 528:	0f 8c 22 fe ff ff    	jl     350 <.omp_outlined.+0x140>
 52e:	e9 cd fd ff ff       	jmpq   300 <.omp_outlined.+0xf0>
 533:	66 66 66 66 2e 0f 1f 	data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 53a:	84 00 00 00 00 00 

0000000000000540 <_Z6enablev>:
 540:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 547 <_Z6enablev+0x7>
 547:	b8 60 00 00 00       	mov    $0x60,%eax
 54c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 551:	0f 45 c8             	cmovne %eax,%ecx
 554:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 55a <_Z6enablev+0x1a>
 55a:	0f 9e c1             	setle  %cl
 55d:	83 3d 00 00 00 00 01 	cmpl   $0x1,0x0(%rip)        # 564 <_Z6enablev+0x24>
...
0000000000000570 <_Z9n_reg_maxv>:
 570:	b8 26 00 00 00       	mov    $0x26,%eax
 575:	c3                   	retq   

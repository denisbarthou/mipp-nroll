...
0000000000000210 <.omp_outlined.>:
 ...
 3d6:	4a 8d bc 20 40 01 00 	lea    0x140(%rax,%r12,1),%rdi
 3dd:	00 
 3de:	4c 8d 9c 10 40 01 00 	lea    0x140(%rax,%rdx,1),%r11
 3e5:	00 
 3e6:	4c 8d 94 28 40 01 00 	lea    0x140(%rax,%rbp,1),%r10
 3ed:	00 
 3ee:	4c 8d 8c 30 40 01 00 	lea    0x140(%rax,%rsi,1),%r9
 3f5:	00 
 3f6:	c4 21 7c 10 b4 bf c0 	vmovups -0x140(%rdi,%r15,4),%ymm14
 3fd:	fe ff ff 
 400:	c4 02 7d a8 34 b8    	vfmadd213ps (%r8,%r15,4),%ymm0,%ymm14
 406:	c4 21 7c 10 ac bf e0 	vmovups -0x120(%rdi,%r15,4),%ymm13
 40d:	fe ff ff 
 410:	c4 02 7d a8 6c b8 20 	vfmadd213ps 0x20(%r8,%r15,4),%ymm0,%ymm13
 417:	c4 21 7c 10 a4 bf 00 	vmovups -0x100(%rdi,%r15,4),%ymm12
 41e:	ff ff ff 
 421:	c4 21 7c 10 9c bf 20 	vmovups -0xe0(%rdi,%r15,4),%ymm11
 428:	ff ff ff 
 42b:	c4 21 7c 10 94 bf 40 	vmovups -0xc0(%rdi,%r15,4),%ymm10
 432:	ff ff ff 
 435:	c4 21 7c 10 8c bf 60 	vmovups -0xa0(%rdi,%r15,4),%ymm9
 43c:	ff ff ff 
 43f:	c4 21 7c 10 44 bf 80 	vmovups -0x80(%rdi,%r15,4),%ymm8
 446:	c4 a1 7c 10 7c bf a0 	vmovups -0x60(%rdi,%r15,4),%ymm7
 44d:	c4 a1 7c 10 74 bf c0 	vmovups -0x40(%rdi,%r15,4),%ymm6
 454:	c4 a1 7c 10 6c bf e0 	vmovups -0x20(%rdi,%r15,4),%ymm5
 45b:	c4 a1 7c 10 24 bf    	vmovups (%rdi,%r15,4),%ymm4
 461:	c4 02 7d a8 64 b8 40 	vfmadd213ps 0x40(%r8,%r15,4),%ymm0,%ymm12
 468:	c4 02 7d a8 5c b8 60 	vfmadd213ps 0x60(%r8,%r15,4),%ymm0,%ymm11
 46f:	c4 02 7d a8 94 b8 80 	vfmadd213ps 0x80(%r8,%r15,4),%ymm0,%ymm10
 476:	00 00 00 
 479:	c4 02 7d a8 8c b8 a0 	vfmadd213ps 0xa0(%r8,%r15,4),%ymm0,%ymm9
 480:	00 00 00 
 483:	c4 02 7d a8 84 b8 c0 	vfmadd213ps 0xc0(%r8,%r15,4),%ymm0,%ymm8
 48a:	00 00 00 
 48d:	c4 82 7d a8 bc b8 e0 	vfmadd213ps 0xe0(%r8,%r15,4),%ymm0,%ymm7
 494:	00 00 00 
 497:	c4 82 7d a8 b4 b8 00 	vfmadd213ps 0x100(%r8,%r15,4),%ymm0,%ymm6
 49e:	01 00 00 
 4a1:	c4 82 7d a8 ac b8 20 	vfmadd213ps 0x120(%r8,%r15,4),%ymm0,%ymm5
 4a8:	01 00 00 
 4ab:	c4 82 7d a8 a4 b8 40 	vfmadd213ps 0x140(%r8,%r15,4),%ymm0,%ymm4
 4b2:	01 00 00 
 4b5:	c4 02 75 b8 b4 bb c0 	vfmadd231ps -0x140(%r11,%r15,4),%ymm1,%ymm14
 4bc:	fe ff ff 
 4bf:	c4 02 75 b8 ac bb e0 	vfmadd231ps -0x120(%r11,%r15,4),%ymm1,%ymm13
 4c6:	fe ff ff 
 4c9:	c4 02 75 b8 a4 bb 00 	vfmadd231ps -0x100(%r11,%r15,4),%ymm1,%ymm12
 4d0:	ff ff ff 
 4d3:	c4 02 75 b8 9c bb 20 	vfmadd231ps -0xe0(%r11,%r15,4),%ymm1,%ymm11
 4da:	ff ff ff 
 4dd:	c4 02 75 b8 94 bb 40 	vfmadd231ps -0xc0(%r11,%r15,4),%ymm1,%ymm10
 4e4:	ff ff ff 
 4e7:	c4 02 75 b8 8c bb 60 	vfmadd231ps -0xa0(%r11,%r15,4),%ymm1,%ymm9
 4ee:	ff ff ff 
 4f1:	c4 02 75 b8 44 bb 80 	vfmadd231ps -0x80(%r11,%r15,4),%ymm1,%ymm8
 4f8:	c4 82 75 b8 7c bb a0 	vfmadd231ps -0x60(%r11,%r15,4),%ymm1,%ymm7
 4ff:	c4 82 75 b8 74 bb c0 	vfmadd231ps -0x40(%r11,%r15,4),%ymm1,%ymm6
 506:	c4 82 75 b8 6c bb e0 	vfmadd231ps -0x20(%r11,%r15,4),%ymm1,%ymm5
 50d:	c4 82 75 b8 24 bb    	vfmadd231ps (%r11,%r15,4),%ymm1,%ymm4
 513:	c4 02 6d b8 b4 ba c0 	vfmadd231ps -0x140(%r10,%r15,4),%ymm2,%ymm14
 51a:	fe ff ff 
 51d:	c4 02 6d b8 ac ba e0 	vfmadd231ps -0x120(%r10,%r15,4),%ymm2,%ymm13
 524:	fe ff ff 
 527:	c4 02 6d b8 a4 ba 00 	vfmadd231ps -0x100(%r10,%r15,4),%ymm2,%ymm12
 52e:	ff ff ff 
 531:	c4 02 6d b8 9c ba 20 	vfmadd231ps -0xe0(%r10,%r15,4),%ymm2,%ymm11
 538:	ff ff ff 
 53b:	c4 02 6d b8 94 ba 40 	vfmadd231ps -0xc0(%r10,%r15,4),%ymm2,%ymm10
 542:	ff ff ff 
 545:	c4 02 6d b8 8c ba 60 	vfmadd231ps -0xa0(%r10,%r15,4),%ymm2,%ymm9
 54c:	ff ff ff 
 54f:	c4 02 6d b8 44 ba 80 	vfmadd231ps -0x80(%r10,%r15,4),%ymm2,%ymm8
 556:	c4 82 6d b8 7c ba a0 	vfmadd231ps -0x60(%r10,%r15,4),%ymm2,%ymm7
 55d:	c4 82 6d b8 74 ba c0 	vfmadd231ps -0x40(%r10,%r15,4),%ymm2,%ymm6
 564:	c4 82 6d b8 6c ba e0 	vfmadd231ps -0x20(%r10,%r15,4),%ymm2,%ymm5
 56b:	c4 82 6d b8 24 ba    	vfmadd231ps (%r10,%r15,4),%ymm2,%ymm4
 571:	c4 02 65 b8 b4 b9 c0 	vfmadd231ps -0x140(%r9,%r15,4),%ymm3,%ymm14
 578:	fe ff ff 
 57b:	c4 02 65 b8 ac b9 e0 	vfmadd231ps -0x120(%r9,%r15,4),%ymm3,%ymm13
 582:	fe ff ff 
 585:	c4 02 65 b8 a4 b9 00 	vfmadd231ps -0x100(%r9,%r15,4),%ymm3,%ymm12
 58c:	ff ff ff 
 58f:	c4 02 65 b8 9c b9 20 	vfmadd231ps -0xe0(%r9,%r15,4),%ymm3,%ymm11
 596:	ff ff ff 
 599:	c4 02 65 b8 94 b9 40 	vfmadd231ps -0xc0(%r9,%r15,4),%ymm3,%ymm10
 5a0:	ff ff ff 
 5a3:	c4 02 65 b8 8c b9 60 	vfmadd231ps -0xa0(%r9,%r15,4),%ymm3,%ymm9
 5aa:	ff ff ff 
 5ad:	c4 02 65 b8 44 b9 80 	vfmadd231ps -0x80(%r9,%r15,4),%ymm3,%ymm8
 5b4:	c4 82 65 b8 7c b9 a0 	vfmadd231ps -0x60(%r9,%r15,4),%ymm3,%ymm7
 5bb:	c4 82 65 b8 74 b9 c0 	vfmadd231ps -0x40(%r9,%r15,4),%ymm3,%ymm6
 5c2:	c4 82 65 b8 6c b9 e0 	vfmadd231ps -0x20(%r9,%r15,4),%ymm3,%ymm5
 5c9:	c4 82 65 b8 24 b9    	vfmadd231ps (%r9,%r15,4),%ymm3,%ymm4
 5cf:	c4 01 7c 11 34 b8    	vmovups %ymm14,(%r8,%r15,4)
 5d5:	48 8b 03             	mov    (%rbx),%rax
 5d8:	c4 21 7c 11 6c b8 20 	vmovups %ymm13,0x20(%rax,%r15,4)
 5df:	48 8b 03             	mov    (%rbx),%rax
 5e2:	c4 21 7c 11 64 b8 40 	vmovups %ymm12,0x40(%rax,%r15,4)
 5e9:	48 8b 03             	mov    (%rbx),%rax
 5ec:	c4 21 7c 11 5c b8 60 	vmovups %ymm11,0x60(%rax,%r15,4)
 5f3:	48 8b 03             	mov    (%rbx),%rax
 5f6:	c4 21 7c 11 94 b8 80 	vmovups %ymm10,0x80(%rax,%r15,4)
 5fd:	00 00 00 
 600:	48 8b 03             	mov    (%rbx),%rax
 603:	c4 21 7c 11 8c b8 a0 	vmovups %ymm9,0xa0(%rax,%r15,4)
 60a:	00 00 00 
 60d:	48 8b 03             	mov    (%rbx),%rax
 610:	c4 21 7c 11 84 b8 c0 	vmovups %ymm8,0xc0(%rax,%r15,4)
 617:	00 00 00 
 61a:	48 8b 03             	mov    (%rbx),%rax
 61d:	c4 a1 7c 11 bc b8 e0 	vmovups %ymm7,0xe0(%rax,%r15,4)
 624:	00 00 00 
 627:	48 8b 03             	mov    (%rbx),%rax
 62a:	c4 a1 7c 11 b4 b8 00 	vmovups %ymm6,0x100(%rax,%r15,4)
 631:	01 00 00 
 634:	48 8b 03             	mov    (%rbx),%rax
 637:	c4 a1 7c 11 ac b8 20 	vmovups %ymm5,0x120(%rax,%r15,4)
 63e:	01 00 00 
 641:	48 8b 03             	mov    (%rbx),%rax
 644:	c4 a1 7c 11 a4 b8 40 	vmovups %ymm4,0x140(%rax,%r15,4)
 64b:	01 00 00 
 64e:	49 83 c7 58          	add    $0x58,%r15
 652:	49 39 cf             	cmp    %rcx,%r15
 655:	0f 8c 75 fd ff ff    	jl     3d0 <.omp_outlined.+0x1c0>
 65b:	e9 d0 fc ff ff       	jmpq   330 <.omp_outlined.+0x120>
...
0000000000000670 <_Z9n_reg_maxv>:
 670:	b8 3b 00 00 00       	mov    $0x3b,%eax
 675:	c3                   	retq   

...
0000000000000210 <.omp_outlined.>:
 ...
 496:	48 8d 84 17 a0 00 00 	lea    0xa0(%rdi,%rdx,1),%rax
 49d:	00 
 49e:	c5 7c 10 ac b0 60 ff 	vmovups -0xa0(%rax,%rsi,4),%ymm13
 4a5:	ff ff 
 4a7:	c4 42 7d a8 2c b4    	vfmadd213ps (%r12,%rsi,4),%ymm0,%ymm13
 4ad:	c5 7c 10 64 b0 80    	vmovups -0x80(%rax,%rsi,4),%ymm12
 4b3:	c5 7c 10 5c b0 a0    	vmovups -0x60(%rax,%rsi,4),%ymm11
 4b9:	c5 7c 10 54 b0 c0    	vmovups -0x40(%rax,%rsi,4),%ymm10
 4bf:	c5 7c 10 4c b0 e0    	vmovups -0x20(%rax,%rsi,4),%ymm9
 4c5:	c5 7c 10 04 b0       	vmovups (%rax,%rsi,4),%ymm8
 4ca:	48 8d 84 2f a0 00 00 	lea    0xa0(%rdi,%rbp,1),%rax
 4d1:	00 
 4d2:	c4 42 7d a8 64 b4 20 	vfmadd213ps 0x20(%r12,%rsi,4),%ymm0,%ymm12
 4d9:	c4 42 7d a8 5c b4 40 	vfmadd213ps 0x40(%r12,%rsi,4),%ymm0,%ymm11
 4e0:	c4 42 7d a8 54 b4 60 	vfmadd213ps 0x60(%r12,%rsi,4),%ymm0,%ymm10
 4e7:	c4 42 7d a8 8c b4 80 	vfmadd213ps 0x80(%r12,%rsi,4),%ymm0,%ymm9
 4ee:	00 00 00 
 4f1:	c4 42 7d a8 84 b4 a0 	vfmadd213ps 0xa0(%r12,%rsi,4),%ymm0,%ymm8
 4f8:	00 00 00 
 4fb:	c4 62 75 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm1,%ymm13
 502:	ff ff ff 
 505:	c4 62 75 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm1,%ymm12
 50c:	c4 62 75 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm1,%ymm11
 513:	c4 62 75 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm1,%ymm10
 51a:	c4 62 75 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm1,%ymm9
 521:	c4 62 75 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm8
 527:	4a 8d 84 2f a0 00 00 	lea    0xa0(%rdi,%r13,1),%rax
 52e:	00 
 52f:	c4 62 6d b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm2,%ymm13
 536:	ff ff ff 
 539:	c4 62 6d b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm2,%ymm12
 540:	c4 62 6d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm2,%ymm11
 547:	c4 62 6d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm2,%ymm10
 54e:	c4 62 6d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm2,%ymm9
 555:	c4 62 6d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm2,%ymm8
 55b:	4a 8d 84 1f a0 00 00 	lea    0xa0(%rdi,%r11,1),%rax
 562:	00 
 563:	c4 62 65 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm3,%ymm13
 56a:	ff ff ff 
 56d:	c4 62 65 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm3,%ymm12
 574:	c4 62 65 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm3,%ymm11
 57b:	c4 62 65 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm3,%ymm10
 582:	c4 62 65 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm3,%ymm9
 589:	c4 62 65 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm3,%ymm8
 58f:	4a 8d 84 17 a0 00 00 	lea    0xa0(%rdi,%r10,1),%rax
 596:	00 
 597:	c4 62 5d b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm4,%ymm13
 59e:	ff ff ff 
 5a1:	c4 62 5d b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm4,%ymm12
 5a8:	c4 62 5d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm4,%ymm11
 5af:	c4 62 5d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm4,%ymm10
 5b6:	c4 62 5d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm4,%ymm9
 5bd:	c4 62 5d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm4,%ymm8
 5c3:	4a 8d 84 0f a0 00 00 	lea    0xa0(%rdi,%r9,1),%rax
 5ca:	00 
 5cb:	c4 62 55 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm5,%ymm13
 5d2:	ff ff ff 
 5d5:	c4 62 55 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm5,%ymm12
 5dc:	c4 62 55 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm5,%ymm11
 5e3:	c4 62 55 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm5,%ymm10
 5ea:	c4 62 55 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm5,%ymm9
 5f1:	c4 62 55 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm5,%ymm8
 5f7:	4a 8d 84 07 a0 00 00 	lea    0xa0(%rdi,%r8,1),%rax
 5fe:	00 
 5ff:	c4 62 4d b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm6,%ymm13
 606:	ff ff ff 
 609:	c4 62 4d b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm6,%ymm12
 610:	c4 62 4d b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm6,%ymm11
 617:	c4 62 4d b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm6,%ymm10
 61e:	c4 62 4d b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm6,%ymm9
 625:	c4 62 4d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm6,%ymm8
 62b:	4a 8d 84 3f a0 00 00 	lea    0xa0(%rdi,%r15,1),%rax
 632:	00 
 633:	c4 62 45 b8 ac b0 60 	vfmadd231ps -0xa0(%rax,%rsi,4),%ymm7,%ymm13
 63a:	ff ff ff 
 63d:	c4 62 45 b8 64 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm7,%ymm12
 644:	c4 62 45 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm7,%ymm11
 64b:	c4 62 45 b8 54 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm7,%ymm10
 652:	c4 62 45 b8 4c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm7,%ymm9
 659:	c4 62 45 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm7,%ymm8
 65f:	c4 41 7c 11 2c b4    	vmovups %ymm13,(%r12,%rsi,4)
 665:	48 8b 03             	mov    (%rbx),%rax
 668:	c5 7c 11 64 b0 20    	vmovups %ymm12,0x20(%rax,%rsi,4)
 66e:	48 8b 03             	mov    (%rbx),%rax
 671:	c5 7c 11 5c b0 40    	vmovups %ymm11,0x40(%rax,%rsi,4)
 677:	48 8b 03             	mov    (%rbx),%rax
 67a:	c5 7c 11 54 b0 60    	vmovups %ymm10,0x60(%rax,%rsi,4)
 680:	48 8b 03             	mov    (%rbx),%rax
 683:	c5 7c 11 8c b0 80 00 	vmovups %ymm9,0x80(%rax,%rsi,4)
 68a:	00 00 
 68c:	48 8b 03             	mov    (%rbx),%rax
 68f:	c5 7c 11 84 b0 a0 00 	vmovups %ymm8,0xa0(%rax,%rsi,4)
 696:	00 00 
 698:	48 83 c6 30          	add    $0x30,%rsi
 69c:	48 39 ce             	cmp    %rcx,%rsi
 69f:	0f 8c eb fd ff ff    	jl     490 <.omp_outlined.+0x280>
 6a5:	e9 c6 fc ff ff       	jmpq   370 <.omp_outlined.+0x160>
...
00000000000006c0 <_Z9n_reg_maxv>:
 6c0:	b8 3e 00 00 00       	mov    $0x3e,%eax
 6c5:	c3                   	retq   

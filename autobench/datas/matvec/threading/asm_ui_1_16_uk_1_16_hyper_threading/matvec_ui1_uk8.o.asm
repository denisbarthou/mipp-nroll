...
0000000000000200 <.omp_outlined.>:
 ...
 486:	48 8d 04 17          	lea    (%rdi,%rdx,1),%rax
 48a:	c5 7c 10 04 b0       	vmovups (%rax,%rsi,4),%ymm8
 48f:	c4 42 7d a8 04 b4    	vfmadd213ps (%r12,%rsi,4),%ymm0,%ymm8
 495:	48 8d 04 2f          	lea    (%rdi,%rbp,1),%rax
 499:	c4 62 75 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm8
 49f:	4a 8d 04 2f          	lea    (%rdi,%r13,1),%rax
 4a3:	c4 62 6d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm2,%ymm8
 4a9:	4a 8d 04 1f          	lea    (%rdi,%r11,1),%rax
 4ad:	c4 62 65 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm3,%ymm8
 4b3:	4a 8d 04 17          	lea    (%rdi,%r10,1),%rax
 4b7:	c4 62 5d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm4,%ymm8
 4bd:	4a 8d 04 0f          	lea    (%rdi,%r9,1),%rax
 4c1:	c4 62 55 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm5,%ymm8
 4c7:	4a 8d 04 07          	lea    (%rdi,%r8,1),%rax
 4cb:	c4 62 4d b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm6,%ymm8
 4d1:	4a 8d 04 3f          	lea    (%rdi,%r15,1),%rax
 4d5:	c4 62 45 b8 04 b0    	vfmadd231ps (%rax,%rsi,4),%ymm7,%ymm8
 4db:	c4 41 7c 11 04 b4    	vmovups %ymm8,(%r12,%rsi,4)
 4e1:	48 83 c6 08          	add    $0x8,%rsi
 4e5:	48 39 ce             	cmp    %rcx,%rsi
 4e8:	7c 96                	jl     480 <.omp_outlined.+0x280>
 4ea:	e9 71 fe ff ff       	jmpq   360 <.omp_outlined.+0x160>
 4ef:	90                   	nop

00000000000004f0 <_Z6enablev>:
 4f0:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 4f7 <_Z6enablev+0x7>
 4f7:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 4fb:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 501 <_Z6enablev+0x11>
 501:	0f 9e c1             	setle  %cl
 504:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 50b <_Z6enablev+0x1b>
 50b:	0f 9f c0             	setg   %al
 50e:	20 c8                	and    %cl,%al
 510:	c3                   	retq   

...
0000000000000220 <.omp_outlined.>:
 ...
 302:	4c 8d 2c 85 a0 00 00 	lea    0xa0(,%rax,4),%r13
 309:	00 
 ...
 31f:	48 8d 2c 85 a0 00 00 	lea    0xa0(,%rax,4),%rbp
 326:	00 
 327:	4b 8d 44 52 02       	lea    0x2(%r10,%r10,2),%rax
 32c:	49 0f af c3          	imul   %r11,%rax
 330:	48 8d 14 85 a0 00 00 	lea    0xa0(,%rax,4),%rdx
 337:	00 
 ...
 38a:	c5 7c 10 84 be 60 ff 	vmovups -0xa0(%rsi,%rdi,4),%ymm8
 391:	ff ff 
 393:	c4 62 7d a8 04 b8    	vfmadd213ps (%rax,%rdi,4),%ymm0,%ymm8
 399:	c5 fc 10 7c be 80    	vmovups -0x80(%rsi,%rdi,4),%ymm7
 39f:	c5 fc 10 74 be a0    	vmovups -0x60(%rsi,%rdi,4),%ymm6
 3a5:	c5 fc 10 6c be c0    	vmovups -0x40(%rsi,%rdi,4),%ymm5
 3ab:	c5 fc 10 64 be e0    	vmovups -0x20(%rsi,%rdi,4),%ymm4
 3b1:	c5 fc 10 1c be       	vmovups (%rsi,%rdi,4),%ymm3
 3b6:	48 8d 34 29          	lea    (%rcx,%rbp,1),%rsi
 3ba:	48 01 d1             	add    %rdx,%rcx
 3bd:	c4 e2 7d a8 7c b8 20 	vfmadd213ps 0x20(%rax,%rdi,4),%ymm0,%ymm7
 3c4:	c4 e2 7d a8 74 b8 40 	vfmadd213ps 0x40(%rax,%rdi,4),%ymm0,%ymm6
 3cb:	c4 e2 7d a8 6c b8 60 	vfmadd213ps 0x60(%rax,%rdi,4),%ymm0,%ymm5
 3d2:	c4 e2 7d a8 a4 b8 80 	vfmadd213ps 0x80(%rax,%rdi,4),%ymm0,%ymm4
 3d9:	00 00 00 
 3dc:	c4 e2 7d a8 9c b8 a0 	vfmadd213ps 0xa0(%rax,%rdi,4),%ymm0,%ymm3
 3e3:	00 00 00 
 3e6:	c4 62 75 b8 84 be 60 	vfmadd231ps -0xa0(%rsi,%rdi,4),%ymm1,%ymm8
 3ed:	ff ff ff 
 3f0:	c4 e2 75 b8 7c be 80 	vfmadd231ps -0x80(%rsi,%rdi,4),%ymm1,%ymm7
 3f7:	c4 e2 75 b8 74 be a0 	vfmadd231ps -0x60(%rsi,%rdi,4),%ymm1,%ymm6
 3fe:	c4 e2 75 b8 6c be c0 	vfmadd231ps -0x40(%rsi,%rdi,4),%ymm1,%ymm5
 405:	c4 e2 75 b8 64 be e0 	vfmadd231ps -0x20(%rsi,%rdi,4),%ymm1,%ymm4
 40c:	c4 e2 75 b8 1c be    	vfmadd231ps (%rsi,%rdi,4),%ymm1,%ymm3
 412:	c4 62 6d b8 84 b9 60 	vfmadd231ps -0xa0(%rcx,%rdi,4),%ymm2,%ymm8
 419:	ff ff ff 
 41c:	c4 e2 6d b8 7c b9 80 	vfmadd231ps -0x80(%rcx,%rdi,4),%ymm2,%ymm7
 423:	c4 e2 6d b8 74 b9 a0 	vfmadd231ps -0x60(%rcx,%rdi,4),%ymm2,%ymm6
 42a:	c4 e2 6d b8 6c b9 c0 	vfmadd231ps -0x40(%rcx,%rdi,4),%ymm2,%ymm5
 431:	c4 e2 6d b8 64 b9 e0 	vfmadd231ps -0x20(%rcx,%rdi,4),%ymm2,%ymm4
 438:	c4 e2 6d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm2,%ymm3
 43e:	c5 7c 11 04 b8       	vmovups %ymm8,(%rax,%rdi,4)
 443:	48 8b 03             	mov    (%rbx),%rax
 446:	c5 fc 11 7c b8 20    	vmovups %ymm7,0x20(%rax,%rdi,4)
 44c:	48 8b 03             	mov    (%rbx),%rax
 44f:	c5 fc 11 74 b8 40    	vmovups %ymm6,0x40(%rax,%rdi,4)
 455:	48 8b 03             	mov    (%rbx),%rax
 458:	c5 fc 11 6c b8 60    	vmovups %ymm5,0x60(%rax,%rdi,4)
 45e:	48 8b 03             	mov    (%rbx),%rax
 461:	c5 fc 11 a4 b8 80 00 	vmovups %ymm4,0x80(%rax,%rdi,4)
 468:	00 00 
 46a:	48 8b 03             	mov    (%rbx),%rax
 46d:	c5 fc 11 9c b8 a0 00 	vmovups %ymm3,0xa0(%rax,%rdi,4)
 474:	00 00 
 476:	48 83 c7 30          	add    $0x30,%rdi
 47a:	4c 39 df             	cmp    %r11,%rdi
 47d:	0f 8c fd fe ff ff    	jl     380 <.omp_outlined.+0x160>
 483:	e9 b8 fe ff ff       	jmpq   340 <.omp_outlined.+0x120>
...
0000000000000490 <_Z6enablev>:
 ...
 497:	b8 30 00 00 00       	mov    $0x30,%eax
 49c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 4a1:	0f 45 c8             	cmovne %eax,%ecx
 4a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4aa <_Z6enablev+0x1a>
 4aa:	0f 9e c1             	setle  %cl
 4ad:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 4b4 <_Z6enablev+0x24>

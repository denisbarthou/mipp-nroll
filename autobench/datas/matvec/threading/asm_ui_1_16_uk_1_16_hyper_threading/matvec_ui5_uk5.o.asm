...
matvec_ui5_uk5.o:     file format elf64-x86-64
...
0000000000000220 <.omp_outlined.>:
 ...
 313:	4c 8d 2c 85 80 00 00 	lea    0x80(,%rax,4),%r13
 31a:	00 
 ...
 38d:	49 01 c8             	add    %rcx,%r8
 390:	49 01 c9             	add    %rcx,%r9
 ...
 3fb:	4e 8d 54 0d 00       	lea    0x0(%rbp,%r9,1),%r10
 400:	4c 8d 7c 3d 00       	lea    0x0(%rbp,%rdi,1),%r15
 405:	4c 8d 64 05 00       	lea    0x0(%rbp,%rax,1),%r12
 40a:	c5 7c 10 4c 8a 80    	vmovups -0x80(%rdx,%rcx,4),%ymm9
 410:	c4 62 7d a8 0c 8e    	vfmadd213ps (%rsi,%rcx,4),%ymm0,%ymm9
 416:	c5 7c 10 44 8a a0    	vmovups -0x60(%rdx,%rcx,4),%ymm8
 41c:	c5 fc 10 7c 8a c0    	vmovups -0x40(%rdx,%rcx,4),%ymm7
 422:	c5 fc 10 74 8a e0    	vmovups -0x20(%rdx,%rcx,4),%ymm6
 428:	c5 fc 10 2c 8a       	vmovups (%rdx,%rcx,4),%ymm5
 42d:	4a 8d 54 05 00       	lea    0x0(%rbp,%r8,1),%rdx
 432:	c4 62 7d a8 44 8e 20 	vfmadd213ps 0x20(%rsi,%rcx,4),%ymm0,%ymm8
 439:	c4 e2 7d a8 7c 8e 40 	vfmadd213ps 0x40(%rsi,%rcx,4),%ymm0,%ymm7
 440:	c4 e2 7d a8 74 8e 60 	vfmadd213ps 0x60(%rsi,%rcx,4),%ymm0,%ymm6
 447:	c4 e2 7d a8 ac 8e 80 	vfmadd213ps 0x80(%rsi,%rcx,4),%ymm0,%ymm5
 44e:	00 00 00 
 451:	c4 62 75 b8 4c 8a 80 	vfmadd231ps -0x80(%rdx,%rcx,4),%ymm1,%ymm9
 458:	c4 62 75 b8 44 8a a0 	vfmadd231ps -0x60(%rdx,%rcx,4),%ymm1,%ymm8
 45f:	c4 e2 75 b8 7c 8a c0 	vfmadd231ps -0x40(%rdx,%rcx,4),%ymm1,%ymm7
 466:	c4 e2 75 b8 74 8a e0 	vfmadd231ps -0x20(%rdx,%rcx,4),%ymm1,%ymm6
 46d:	c4 e2 75 b8 2c 8a    	vfmadd231ps (%rdx,%rcx,4),%ymm1,%ymm5
 473:	c4 42 6d b8 4c 8a 80 	vfmadd231ps -0x80(%r10,%rcx,4),%ymm2,%ymm9
 47a:	c4 42 6d b8 44 8a a0 	vfmadd231ps -0x60(%r10,%rcx,4),%ymm2,%ymm8
 481:	c4 c2 6d b8 7c 8a c0 	vfmadd231ps -0x40(%r10,%rcx,4),%ymm2,%ymm7
 488:	c4 c2 6d b8 74 8a e0 	vfmadd231ps -0x20(%r10,%rcx,4),%ymm2,%ymm6
 48f:	c4 c2 6d b8 2c 8a    	vfmadd231ps (%r10,%rcx,4),%ymm2,%ymm5
 495:	c4 42 65 b8 4c 8f 80 	vfmadd231ps -0x80(%r15,%rcx,4),%ymm3,%ymm9
 49c:	c4 42 65 b8 44 8f a0 	vfmadd231ps -0x60(%r15,%rcx,4),%ymm3,%ymm8
 4a3:	c4 c2 65 b8 7c 8f c0 	vfmadd231ps -0x40(%r15,%rcx,4),%ymm3,%ymm7
 4aa:	c4 c2 65 b8 74 8f e0 	vfmadd231ps -0x20(%r15,%rcx,4),%ymm3,%ymm6
 4b1:	c4 c2 65 b8 2c 8f    	vfmadd231ps (%r15,%rcx,4),%ymm3,%ymm5
 4b7:	c4 42 5d b8 4c 8c 80 	vfmadd231ps -0x80(%r12,%rcx,4),%ymm4,%ymm9
 4be:	c4 42 5d b8 44 8c a0 	vfmadd231ps -0x60(%r12,%rcx,4),%ymm4,%ymm8
 4c5:	c4 c2 5d b8 7c 8c c0 	vfmadd231ps -0x40(%r12,%rcx,4),%ymm4,%ymm7
 4cc:	c4 c2 5d b8 74 8c e0 	vfmadd231ps -0x20(%r12,%rcx,4),%ymm4,%ymm6
 4d3:	c4 c2 5d b8 2c 8c    	vfmadd231ps (%r12,%rcx,4),%ymm4,%ymm5
 4d9:	c5 7c 11 0c 8e       	vmovups %ymm9,(%rsi,%rcx,4)
 4de:	48 8b 13             	mov    (%rbx),%rdx
 4e1:	c5 7c 11 44 8a 20    	vmovups %ymm8,0x20(%rdx,%rcx,4)
 4e7:	48 8b 13             	mov    (%rbx),%rdx
 4ea:	c5 fc 11 7c 8a 40    	vmovups %ymm7,0x40(%rdx,%rcx,4)
 4f0:	48 8b 13             	mov    (%rbx),%rdx
 4f3:	c5 fc 11 74 8a 60    	vmovups %ymm6,0x60(%rdx,%rcx,4)
 4f9:	48 8b 13             	mov    (%rbx),%rdx
 4fc:	c5 fc 11 ac 8a 80 00 	vmovups %ymm5,0x80(%rdx,%rcx,4)
 503:	00 00 
 505:	48 83 c1 28          	add    $0x28,%rcx
 509:	4c 39 d9             	cmp    %r11,%rcx
 50c:	0f 8c de fe ff ff    	jl     3f0 <.omp_outlined.+0x1d0>
 512:	e9 69 fe ff ff       	jmpq   380 <.omp_outlined.+0x160>
...
0000000000000520 <_Z6enablev>:
 ...
 527:	b8 28 00 00 00       	mov    $0x28,%eax
 52c:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx
...
0000000000000000 <_GLOBAL__sub_I_matvec_ui5_uk5.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_ui5_uk5.cpp+0x9a>
  96:	01 00 00 00 

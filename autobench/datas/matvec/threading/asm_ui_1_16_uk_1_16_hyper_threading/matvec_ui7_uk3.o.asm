...
0000000000000220 <.omp_outlined.>:
 ...
 302:	4c 8d 2c 85 c0 00 00 	lea    0xc0(,%rax,4),%r13
 309:	00 
 ...
 31f:	48 8d 2c 85 c0 00 00 	lea    0xc0(,%rax,4),%rbp
 326:	00 
 327:	4b 8d 44 52 02       	lea    0x2(%r10,%r10,2),%rax
 32c:	49 0f af c3          	imul   %r11,%rax
 330:	48 8d 14 85 c0 00 00 	lea    0xc0(,%rax,4),%rdx
 337:	00 
 ...
 38a:	c5 7c 10 8c be 40 ff 	vmovups -0xc0(%rsi,%rdi,4),%ymm9
 391:	ff ff 
 393:	c4 62 7d a8 0c b8    	vfmadd213ps (%rax,%rdi,4),%ymm0,%ymm9
 399:	c5 7c 10 84 be 60 ff 	vmovups -0xa0(%rsi,%rdi,4),%ymm8
 3a0:	ff ff 
 3a2:	c5 fc 10 7c be 80    	vmovups -0x80(%rsi,%rdi,4),%ymm7
 3a8:	c5 fc 10 74 be a0    	vmovups -0x60(%rsi,%rdi,4),%ymm6
 3ae:	c5 fc 10 6c be c0    	vmovups -0x40(%rsi,%rdi,4),%ymm5
 3b4:	c5 fc 10 64 be e0    	vmovups -0x20(%rsi,%rdi,4),%ymm4
 3ba:	c5 fc 10 1c be       	vmovups (%rsi,%rdi,4),%ymm3
 3bf:	48 8d 34 29          	lea    (%rcx,%rbp,1),%rsi
 3c3:	48 01 d1             	add    %rdx,%rcx
 3c6:	c4 62 7d a8 44 b8 20 	vfmadd213ps 0x20(%rax,%rdi,4),%ymm0,%ymm8
 3cd:	c4 e2 7d a8 7c b8 40 	vfmadd213ps 0x40(%rax,%rdi,4),%ymm0,%ymm7
 3d4:	c4 e2 7d a8 74 b8 60 	vfmadd213ps 0x60(%rax,%rdi,4),%ymm0,%ymm6
 3db:	c4 e2 7d a8 ac b8 80 	vfmadd213ps 0x80(%rax,%rdi,4),%ymm0,%ymm5
 3e2:	00 00 00 
 3e5:	c4 e2 7d a8 a4 b8 a0 	vfmadd213ps 0xa0(%rax,%rdi,4),%ymm0,%ymm4
 3ec:	00 00 00 
 3ef:	c4 e2 7d a8 9c b8 c0 	vfmadd213ps 0xc0(%rax,%rdi,4),%ymm0,%ymm3
 3f6:	00 00 00 
 3f9:	c4 62 75 b8 8c be 40 	vfmadd231ps -0xc0(%rsi,%rdi,4),%ymm1,%ymm9
 400:	ff ff ff 
 403:	c4 62 75 b8 84 be 60 	vfmadd231ps -0xa0(%rsi,%rdi,4),%ymm1,%ymm8
 40a:	ff ff ff 
 40d:	c4 e2 75 b8 7c be 80 	vfmadd231ps -0x80(%rsi,%rdi,4),%ymm1,%ymm7
 414:	c4 e2 75 b8 74 be a0 	vfmadd231ps -0x60(%rsi,%rdi,4),%ymm1,%ymm6
 41b:	c4 e2 75 b8 6c be c0 	vfmadd231ps -0x40(%rsi,%rdi,4),%ymm1,%ymm5
 422:	c4 e2 75 b8 64 be e0 	vfmadd231ps -0x20(%rsi,%rdi,4),%ymm1,%ymm4
 429:	c4 e2 75 b8 1c be    	vfmadd231ps (%rsi,%rdi,4),%ymm1,%ymm3
 42f:	c4 62 6d b8 8c b9 40 	vfmadd231ps -0xc0(%rcx,%rdi,4),%ymm2,%ymm9
 436:	ff ff ff 
 439:	c4 62 6d b8 84 b9 60 	vfmadd231ps -0xa0(%rcx,%rdi,4),%ymm2,%ymm8
 440:	ff ff ff 
 443:	c4 e2 6d b8 7c b9 80 	vfmadd231ps -0x80(%rcx,%rdi,4),%ymm2,%ymm7
 44a:	c4 e2 6d b8 74 b9 a0 	vfmadd231ps -0x60(%rcx,%rdi,4),%ymm2,%ymm6
 451:	c4 e2 6d b8 6c b9 c0 	vfmadd231ps -0x40(%rcx,%rdi,4),%ymm2,%ymm5
 458:	c4 e2 6d b8 64 b9 e0 	vfmadd231ps -0x20(%rcx,%rdi,4),%ymm2,%ymm4
 45f:	c4 e2 6d b8 1c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm2,%ymm3
 465:	c5 7c 11 0c b8       	vmovups %ymm9,(%rax,%rdi,4)
 46a:	48 8b 03             	mov    (%rbx),%rax
 46d:	c5 7c 11 44 b8 20    	vmovups %ymm8,0x20(%rax,%rdi,4)
 473:	48 8b 03             	mov    (%rbx),%rax
 476:	c5 fc 11 7c b8 40    	vmovups %ymm7,0x40(%rax,%rdi,4)
 47c:	48 8b 03             	mov    (%rbx),%rax
 47f:	c5 fc 11 74 b8 60    	vmovups %ymm6,0x60(%rax,%rdi,4)
 485:	48 8b 03             	mov    (%rbx),%rax
 488:	c5 fc 11 ac b8 80 00 	vmovups %ymm5,0x80(%rax,%rdi,4)
 48f:	00 00 
 491:	48 8b 03             	mov    (%rbx),%rax
 494:	c5 fc 11 a4 b8 a0 00 	vmovups %ymm4,0xa0(%rax,%rdi,4)
 49b:	00 00 
 49d:	48 8b 03             	mov    (%rbx),%rax
 4a0:	c5 fc 11 9c b8 c0 00 	vmovups %ymm3,0xc0(%rax,%rdi,4)
 4a7:	00 00 
 4a9:	48 83 c7 38          	add    $0x38,%rdi
 4ad:	4c 39 df             	cmp    %r11,%rdi
 4b0:	0f 8c ca fe ff ff    	jl     380 <.omp_outlined.+0x160>
 4b6:	e9 85 fe ff ff       	jmpq   340 <.omp_outlined.+0x120>
...
00000000000004c0 <_Z6enablev>:
 ...
 4c7:	b8 38 00 00 00       	mov    $0x38,%eax
 4cc:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 4d1:	0f 45 c8             	cmovne %eax,%ecx
 4d4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4da <_Z6enablev+0x1a>
 4da:	0f 9e c1             	setle  %cl
 4dd:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 4e4 <_Z6enablev+0x24>

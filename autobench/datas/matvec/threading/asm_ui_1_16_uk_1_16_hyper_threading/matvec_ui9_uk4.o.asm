...
0000000000000210 <.omp_outlined.>:
 ...
 3d6:	4a 8d bc 20 00 01 00 	lea    0x100(%rax,%r12,1),%rdi
 3dd:	00 
 3de:	4c 8d 9c 10 00 01 00 	lea    0x100(%rax,%rdx,1),%r11
 3e5:	00 
 3e6:	4c 8d 94 28 00 01 00 	lea    0x100(%rax,%rbp,1),%r10
 3ed:	00 
 3ee:	4c 8d 8c 30 00 01 00 	lea    0x100(%rax,%rsi,1),%r9
 3f5:	00 
 3f6:	c4 21 7c 10 a4 bf 00 	vmovups -0x100(%rdi,%r15,4),%ymm12
 3fd:	ff ff ff 
 400:	c4 02 7d a8 24 b8    	vfmadd213ps (%r8,%r15,4),%ymm0,%ymm12
 406:	c4 21 7c 10 9c bf 20 	vmovups -0xe0(%rdi,%r15,4),%ymm11
 40d:	ff ff ff 
 410:	c4 02 7d a8 5c b8 20 	vfmadd213ps 0x20(%r8,%r15,4),%ymm0,%ymm11
 417:	c4 21 7c 10 94 bf 40 	vmovups -0xc0(%rdi,%r15,4),%ymm10
 41e:	ff ff ff 
 421:	c4 21 7c 10 8c bf 60 	vmovups -0xa0(%rdi,%r15,4),%ymm9
 428:	ff ff ff 
 42b:	c4 21 7c 10 44 bf 80 	vmovups -0x80(%rdi,%r15,4),%ymm8
 432:	c4 a1 7c 10 7c bf a0 	vmovups -0x60(%rdi,%r15,4),%ymm7
 439:	c4 a1 7c 10 74 bf c0 	vmovups -0x40(%rdi,%r15,4),%ymm6
 440:	c4 a1 7c 10 6c bf e0 	vmovups -0x20(%rdi,%r15,4),%ymm5
 447:	c4 a1 7c 10 24 bf    	vmovups (%rdi,%r15,4),%ymm4
 44d:	c4 02 7d a8 54 b8 40 	vfmadd213ps 0x40(%r8,%r15,4),%ymm0,%ymm10
 454:	c4 02 7d a8 4c b8 60 	vfmadd213ps 0x60(%r8,%r15,4),%ymm0,%ymm9
 45b:	c4 02 7d a8 84 b8 80 	vfmadd213ps 0x80(%r8,%r15,4),%ymm0,%ymm8
 462:	00 00 00 
 465:	c4 82 7d a8 bc b8 a0 	vfmadd213ps 0xa0(%r8,%r15,4),%ymm0,%ymm7
 46c:	00 00 00 
 46f:	c4 82 7d a8 b4 b8 c0 	vfmadd213ps 0xc0(%r8,%r15,4),%ymm0,%ymm6
 476:	00 00 00 
 479:	c4 82 7d a8 ac b8 e0 	vfmadd213ps 0xe0(%r8,%r15,4),%ymm0,%ymm5
 480:	00 00 00 
 483:	c4 82 7d a8 a4 b8 00 	vfmadd213ps 0x100(%r8,%r15,4),%ymm0,%ymm4
 48a:	01 00 00 
 48d:	c4 02 75 b8 a4 bb 00 	vfmadd231ps -0x100(%r11,%r15,4),%ymm1,%ymm12
 494:	ff ff ff 
 497:	c4 02 75 b8 9c bb 20 	vfmadd231ps -0xe0(%r11,%r15,4),%ymm1,%ymm11
 49e:	ff ff ff 
 4a1:	c4 02 75 b8 94 bb 40 	vfmadd231ps -0xc0(%r11,%r15,4),%ymm1,%ymm10
 4a8:	ff ff ff 
 4ab:	c4 02 75 b8 8c bb 60 	vfmadd231ps -0xa0(%r11,%r15,4),%ymm1,%ymm9
 4b2:	ff ff ff 
 4b5:	c4 02 75 b8 44 bb 80 	vfmadd231ps -0x80(%r11,%r15,4),%ymm1,%ymm8
 4bc:	c4 82 75 b8 7c bb a0 	vfmadd231ps -0x60(%r11,%r15,4),%ymm1,%ymm7
 4c3:	c4 82 75 b8 74 bb c0 	vfmadd231ps -0x40(%r11,%r15,4),%ymm1,%ymm6
 4ca:	c4 82 75 b8 6c bb e0 	vfmadd231ps -0x20(%r11,%r15,4),%ymm1,%ymm5
 4d1:	c4 82 75 b8 24 bb    	vfmadd231ps (%r11,%r15,4),%ymm1,%ymm4
 4d7:	c4 02 6d b8 a4 ba 00 	vfmadd231ps -0x100(%r10,%r15,4),%ymm2,%ymm12
 4de:	ff ff ff 
 4e1:	c4 02 6d b8 9c ba 20 	vfmadd231ps -0xe0(%r10,%r15,4),%ymm2,%ymm11
 4e8:	ff ff ff 
 4eb:	c4 02 6d b8 94 ba 40 	vfmadd231ps -0xc0(%r10,%r15,4),%ymm2,%ymm10
 4f2:	ff ff ff 
 4f5:	c4 02 6d b8 8c ba 60 	vfmadd231ps -0xa0(%r10,%r15,4),%ymm2,%ymm9
 4fc:	ff ff ff 
 4ff:	c4 02 6d b8 44 ba 80 	vfmadd231ps -0x80(%r10,%r15,4),%ymm2,%ymm8
 506:	c4 82 6d b8 7c ba a0 	vfmadd231ps -0x60(%r10,%r15,4),%ymm2,%ymm7
 50d:	c4 82 6d b8 74 ba c0 	vfmadd231ps -0x40(%r10,%r15,4),%ymm2,%ymm6
 514:	c4 82 6d b8 6c ba e0 	vfmadd231ps -0x20(%r10,%r15,4),%ymm2,%ymm5
 51b:	c4 82 6d b8 24 ba    	vfmadd231ps (%r10,%r15,4),%ymm2,%ymm4
 521:	c4 02 65 b8 a4 b9 00 	vfmadd231ps -0x100(%r9,%r15,4),%ymm3,%ymm12
 528:	ff ff ff 
 52b:	c4 02 65 b8 9c b9 20 	vfmadd231ps -0xe0(%r9,%r15,4),%ymm3,%ymm11
 532:	ff ff ff 
 535:	c4 02 65 b8 94 b9 40 	vfmadd231ps -0xc0(%r9,%r15,4),%ymm3,%ymm10
 53c:	ff ff ff 
 53f:	c4 02 65 b8 8c b9 60 	vfmadd231ps -0xa0(%r9,%r15,4),%ymm3,%ymm9
 546:	ff ff ff 
 549:	c4 02 65 b8 44 b9 80 	vfmadd231ps -0x80(%r9,%r15,4),%ymm3,%ymm8
 550:	c4 82 65 b8 7c b9 a0 	vfmadd231ps -0x60(%r9,%r15,4),%ymm3,%ymm7
 557:	c4 82 65 b8 74 b9 c0 	vfmadd231ps -0x40(%r9,%r15,4),%ymm3,%ymm6
 55e:	c4 82 65 b8 6c b9 e0 	vfmadd231ps -0x20(%r9,%r15,4),%ymm3,%ymm5
 565:	c4 82 65 b8 24 b9    	vfmadd231ps (%r9,%r15,4),%ymm3,%ymm4
 56b:	c4 01 7c 11 24 b8    	vmovups %ymm12,(%r8,%r15,4)
 571:	48 8b 03             	mov    (%rbx),%rax
 574:	c4 21 7c 11 5c b8 20 	vmovups %ymm11,0x20(%rax,%r15,4)
 57b:	48 8b 03             	mov    (%rbx),%rax
 57e:	c4 21 7c 11 54 b8 40 	vmovups %ymm10,0x40(%rax,%r15,4)
 585:	48 8b 03             	mov    (%rbx),%rax
 588:	c4 21 7c 11 4c b8 60 	vmovups %ymm9,0x60(%rax,%r15,4)
 58f:	48 8b 03             	mov    (%rbx),%rax
 592:	c4 21 7c 11 84 b8 80 	vmovups %ymm8,0x80(%rax,%r15,4)
 599:	00 00 00 
 59c:	48 8b 03             	mov    (%rbx),%rax
 59f:	c4 a1 7c 11 bc b8 a0 	vmovups %ymm7,0xa0(%rax,%r15,4)
 5a6:	00 00 00 
 5a9:	48 8b 03             	mov    (%rbx),%rax
 5ac:	c4 a1 7c 11 b4 b8 c0 	vmovups %ymm6,0xc0(%rax,%r15,4)
 5b3:	00 00 00 
 5b6:	48 8b 03             	mov    (%rbx),%rax
 5b9:	c4 a1 7c 11 ac b8 e0 	vmovups %ymm5,0xe0(%rax,%r15,4)
 5c0:	00 00 00 
 5c3:	48 8b 03             	mov    (%rbx),%rax
 5c6:	c4 a1 7c 11 a4 b8 00 	vmovups %ymm4,0x100(%rax,%r15,4)
 5cd:	01 00 00 
 5d0:	49 83 c7 48          	add    $0x48,%r15
 5d4:	49 39 cf             	cmp    %rcx,%r15
 5d7:	0f 8c f3 fd ff ff    	jl     3d0 <.omp_outlined.+0x1c0>
 5dd:	e9 4e fd ff ff       	jmpq   330 <.omp_outlined.+0x120>
 5e2:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)

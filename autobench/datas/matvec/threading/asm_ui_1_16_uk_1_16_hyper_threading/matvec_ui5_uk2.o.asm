...
0000000000000210 <.omp_outlined.>:
 ...
 356:	48 8d 8c 28 80 00 00 	lea    0x80(%rax,%rbp,1),%rcx
 35d:	00 
 35e:	48 8d 84 10 80 00 00 	lea    0x80(%rax,%rdx,1),%rax
 365:	00 
 366:	c5 fc 10 54 b1 80    	vmovups -0x80(%rcx,%rsi,4),%ymm2
 36c:	c4 e2 7d a8 14 b7    	vfmadd213ps (%rdi,%rsi,4),%ymm0,%ymm2
 372:	c5 fc 10 5c b1 a0    	vmovups -0x60(%rcx,%rsi,4),%ymm3
 378:	c4 e2 7d a8 5c b7 20 	vfmadd213ps 0x20(%rdi,%rsi,4),%ymm0,%ymm3
 37f:	c5 fc 10 64 b1 c0    	vmovups -0x40(%rcx,%rsi,4),%ymm4
 385:	c5 fc 10 6c b1 e0    	vmovups -0x20(%rcx,%rsi,4),%ymm5
 38b:	c5 fc 10 34 b1       	vmovups (%rcx,%rsi,4),%ymm6
 390:	c4 e2 7d a8 64 b7 40 	vfmadd213ps 0x40(%rdi,%rsi,4),%ymm0,%ymm4
 397:	c4 e2 7d a8 6c b7 60 	vfmadd213ps 0x60(%rdi,%rsi,4),%ymm0,%ymm5
 39e:	c4 e2 7d a8 b4 b7 80 	vfmadd213ps 0x80(%rdi,%rsi,4),%ymm0,%ymm6
 3a5:	00 00 00 
 3a8:	c4 e2 75 b8 54 b0 80 	vfmadd231ps -0x80(%rax,%rsi,4),%ymm1,%ymm2
 3af:	c4 e2 75 b8 5c b0 a0 	vfmadd231ps -0x60(%rax,%rsi,4),%ymm1,%ymm3
 3b6:	c4 e2 75 b8 64 b0 c0 	vfmadd231ps -0x40(%rax,%rsi,4),%ymm1,%ymm4
 3bd:	c4 e2 75 b8 6c b0 e0 	vfmadd231ps -0x20(%rax,%rsi,4),%ymm1,%ymm5
 3c4:	c4 e2 75 b8 34 b0    	vfmadd231ps (%rax,%rsi,4),%ymm1,%ymm6
 3ca:	c5 fc 11 14 b7       	vmovups %ymm2,(%rdi,%rsi,4)
 3cf:	48 8b 03             	mov    (%rbx),%rax
 3d2:	c5 fc 11 5c b0 20    	vmovups %ymm3,0x20(%rax,%rsi,4)
 3d8:	48 8b 03             	mov    (%rbx),%rax
 3db:	c5 fc 11 64 b0 40    	vmovups %ymm4,0x40(%rax,%rsi,4)
 3e1:	48 8b 03             	mov    (%rbx),%rax
 3e4:	c5 fc 11 6c b0 60    	vmovups %ymm5,0x60(%rax,%rsi,4)
 3ea:	48 8b 03             	mov    (%rbx),%rax
 3ed:	c5 fc 11 b4 b0 80 00 	vmovups %ymm6,0x80(%rax,%rsi,4)
 3f4:	00 00 
 3f6:	48 83 c6 28          	add    $0x28,%rsi
 3fa:	4c 39 fe             	cmp    %r15,%rsi
 3fd:	0f 8c 4d ff ff ff    	jl     350 <.omp_outlined.+0x140>
 403:	e9 f8 fe ff ff       	jmpq   300 <.omp_outlined.+0xf0>
...
0000000000000410 <_Z6enablev>:
 ...
 417:	b8 28 00 00 00       	mov    $0x28,%eax
 41c:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx

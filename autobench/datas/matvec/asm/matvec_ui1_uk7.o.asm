...
0000000000000140 <_Z5benchv>:
 ...
 177:	0f 8e ec 00 00 00    	jle    269 <_Z5benchv+0x129>
 17d:	48 63 3d 00 00 00 00 	movslq 0x0(%rip),%rdi        # 184 <_Z5benchv+0x44>
 184:	4c 8b 3d 00 00 00 00 	mov    0x0(%rip),%r15        # 18b <_Z5benchv+0x4b>
 18b:	4c 8b 15 00 00 00 00 	mov    0x0(%rip),%r10        # 192 <_Z5benchv+0x52>
 192:	4c 8b 35 00 00 00 00 	mov    0x0(%rip),%r14        # 199 <_Z5benchv+0x59>
 199:	45 31 db             	xor    %r11d,%r11d
 19c:	48 8d 04 ff          	lea    (%rdi,%rdi,8),%rax
 1a0:	4c 8d 0c 40          	lea    (%rax,%rax,2),%r9
 1a4:	48 8d 04 bd 00 00 00 	lea    0x0(,%rdi,4),%rax
 1ab:	00 
 1ac:	49 01 f9             	add    %rdi,%r9
 ...
 1ca:	0f 83 99 00 00 00    	jae    269 <_Z5benchv+0x129>
 ...
 20e:	90                   	nop
 20f:	90                   	nop
 210:	c4 41 7c 10 04 97    	vmovups (%r15,%rdx,4),%ymm8
 216:	c4 42 75 a8 04 96    	vfmadd213ps (%r14,%rdx,4),%ymm1,%ymm8
 21c:	49 8d 1c 97          	lea    (%r15,%rdx,4),%rbx
 220:	48 8d 34 03          	lea    (%rbx,%rax,1),%rsi
 224:	48 01 c6             	add    %rax,%rsi
 227:	48 8d 0c 06          	lea    (%rsi,%rax,1),%rcx
 22b:	c4 62 6d b8 04 bb    	vfmadd231ps (%rbx,%rdi,4),%ymm2,%ymm8
 231:	48 01 c1             	add    %rax,%rcx
 234:	c4 62 65 b8 04 fb    	vfmadd231ps (%rbx,%rdi,8),%ymm3,%ymm8
 23a:	c4 62 5d b8 04 be    	vfmadd231ps (%rsi,%rdi,4),%ymm4,%ymm8
 240:	c4 62 55 b8 04 fe    	vfmadd231ps (%rsi,%rdi,8),%ymm5,%ymm8
 246:	c4 62 4d b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm6,%ymm8
 24c:	48 01 c1             	add    %rax,%rcx
 24f:	c4 62 45 b8 04 b9    	vfmadd231ps (%rcx,%rdi,4),%ymm7,%ymm8
 255:	c4 41 7c 11 04 96    	vmovups %ymm8,(%r14,%rdx,4)
 25b:	48 83 c2 08          	add    $0x8,%rdx
 25f:	48 39 fa             	cmp    %rdi,%rdx
 262:	7c ac                	jl     210 <_Z5benchv+0xd0>
 264:	e9 57 ff ff ff       	jmpq   1c0 <_Z5benchv+0x80>
 269:	0f 31                	rdtsc  
 26b:	48 c1 e2 20          	shl    $0x20,%rdx
 26f:	48 09 c2             	or     %rax,%rdx
 272:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 278 <_Z5benchv+0x138>
 278:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 27d:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 285 <_Z5benchv+0x145>
 284:	00 
 285:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 28d <_Z5benchv+0x14d>
 28c:	00 
 28d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 294 <_Z5benchv+0x154>
 294:	01 c0                	add    %eax,%eax
 296:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 29c:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 2a0:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 2a4:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
 2a8:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 2ac:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 2b0:	5b                   	pop    %rbx
 2b1:	41 5e                	pop    %r14
 2b3:	41 5f                	pop    %r15
...
00000000000002c0 <_Z6enablev>:
 ...
 2d4:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 2db <_Z6enablev+0x1b>

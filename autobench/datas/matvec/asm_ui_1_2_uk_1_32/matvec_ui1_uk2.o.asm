...
0000000000000130 <_Z5benchv>:
 ...
 162:	0f 8e 89 00 00 00    	jle    1f1 <_Z5benchv+0xc1>
 ...
 187:	4c 8d 14 f5 00 00 00 	lea    0x0(,%rsi,8),%r10
 18e:	00 
 18f:	48 8d 04 b1          	lea    (%rcx,%rsi,4),%rax
 193:	eb 1a                	jmp    1af <_Z5benchv+0x7f>
 195:	90                   	nop
 196:	90                   	nop
 197:	90                   	nop
 198:	90                   	nop
 ...
 1ad:	73 42                	jae    1f1 <_Z5benchv+0xc1>
 ...
 1ce:	90                   	nop
 1cf:	90                   	nop
 1d0:	c5 fc 10 1c 91       	vmovups (%rcx,%rdx,4),%ymm3
 1d5:	c4 e2 75 a8 1c 97    	vfmadd213ps (%rdi,%rdx,4),%ymm1,%ymm3
 1db:	c4 e2 6d b8 1c 90    	vfmadd231ps (%rax,%rdx,4),%ymm2,%ymm3
 1e1:	c5 fc 11 1c 97       	vmovups %ymm3,(%rdi,%rdx,4)
 1e6:	48 83 c2 08          	add    $0x8,%rdx
 1ea:	48 39 f2             	cmp    %rsi,%rdx
 1ed:	7c e1                	jl     1d0 <_Z5benchv+0xa0>
 1ef:	eb af                	jmp    1a0 <_Z5benchv+0x70>
 1f1:	0f 31                	rdtsc  
 1f3:	48 c1 e2 20          	shl    $0x20,%rdx
 1f7:	48 09 c2             	or     %rax,%rdx
 1fa:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 200 <_Z5benchv+0xd0>
 200:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 205:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 20d <_Z5benchv+0xdd>
 20c:	00 
 20d:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 215 <_Z5benchv+0xe5>
 214:	00 
 215:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 21c <_Z5benchv+0xec>
 21c:	01 c0                	add    %eax,%eax
 21e:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 224:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 228:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 22c:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
 230:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 234:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000000240 <_Z6enablev>:
 240:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 247 <_Z6enablev+0x7>
 247:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 24b:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 251 <_Z6enablev+0x11>
 251:	0f 9e c1             	setle  %cl
 254:	83 3d 00 00 00 00 01 	cmpl   $0x1,0x0(%rip)        # 25b <_Z6enablev+0x1b>
 25b:	0f 9f c0             	setg   %al
 25e:	20 c8                	and    %cl,%al
 260:	c3                   	retq   
 261:	90                   	nop
 262:	90                   	nop

...
0000000000000490 <_Z6enablev>:
 ...
 497:	b8 20 00 00 00       	mov    $0x20,%eax
 49c:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 4a1:	0f 45 c8             	cmovne %eax,%ecx
 4a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4aa <_Z6enablev+0x1a>
 4aa:	0f 9e c1             	setle  %cl
 4ad:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # 4b4 <_Z6enablev+0x24>
...
00000000000004c0 <_Z9n_reg_maxv>:
 4c0:	b8 40 00 00 00       	mov    $0x40,%eax
 4c5:	c3                   	retq   

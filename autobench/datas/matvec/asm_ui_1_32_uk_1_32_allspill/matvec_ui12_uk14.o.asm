...
0000000000000a30 <_Z6enablev>:
 ...
 a37:	b8 60 00 00 00       	mov    $0x60,%eax
 a3c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 a41:	0f 45 c8             	cmovne %eax,%ecx
 a44:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a4a <_Z6enablev+0x1a>
 a4a:	0f 9e c1             	setle  %cl
 a4d:	83 3d 00 00 00 00 0d 	cmpl   $0xd,0x0(%rip)        # a54 <_Z6enablev+0x24>
...
0000000000000a60 <_Z9n_reg_maxv>:
 a60:	b8 c2 00 00 00       	mov    $0xc2,%eax
 a65:	c3                   	retq   

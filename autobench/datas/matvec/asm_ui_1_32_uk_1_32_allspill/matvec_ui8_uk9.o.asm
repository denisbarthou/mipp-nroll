...
00000000000005b0 <_Z6enablev>:
 ...
 5b7:	b8 40 00 00 00       	mov    $0x40,%eax
 5bc:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 5c1:	0f 45 c8             	cmovne %eax,%ecx
 5c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 5ca <_Z6enablev+0x1a>
 5ca:	0f 9e c1             	setle  %cl
 5cd:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # 5d4 <_Z6enablev+0x24>
...
00000000000005e0 <_Z9n_reg_maxv>:
 5e0:	b8 59 00 00 00       	mov    $0x59,%eax
 5e5:	c3                   	retq   

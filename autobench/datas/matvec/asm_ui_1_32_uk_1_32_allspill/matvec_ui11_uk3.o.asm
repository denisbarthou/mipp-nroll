...
0000000000000430 <_Z6enablev>:
 ...
 437:	b8 58 00 00 00       	mov    $0x58,%eax
 43c:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 441:	0f 45 c8             	cmovne %eax,%ecx
 444:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 44a <_Z6enablev+0x1a>
 44a:	0f 9e c1             	setle  %cl
 44d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 454 <_Z6enablev+0x24>
...
0000000000000460 <_Z9n_reg_maxv>:
 460:	b8 2f 00 00 00       	mov    $0x2f,%eax
 465:	c3                   	retq   

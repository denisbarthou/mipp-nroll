...
0000000000000820 <_Z6enablev>:
 ...
 827:	b8 70 00 00 00       	mov    $0x70,%eax
 82c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 831:	0f 45 c8             	cmovne %eax,%ecx
 834:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 83a <_Z6enablev+0x1a>
 83a:	0f 9e c1             	setle  %cl
 83d:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 844 <_Z6enablev+0x24>
...
0000000000000850 <_Z9n_reg_maxv>:
 850:	b8 86 00 00 00       	mov    $0x86,%eax
 855:	c3                   	retq   

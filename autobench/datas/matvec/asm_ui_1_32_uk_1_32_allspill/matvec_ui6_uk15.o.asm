...
0000000000000660 <_Z6enablev>:
 ...
 667:	b8 30 00 00 00       	mov    $0x30,%eax
 66c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 671:	0f 45 c8             	cmovne %eax,%ecx
 674:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 67a <_Z6enablev+0x1a>
 67a:	0f 9e c1             	setle  %cl
 67d:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # 684 <_Z6enablev+0x24>
...
0000000000000690 <_Z9n_reg_maxv>:
 690:	b8 6f 00 00 00       	mov    $0x6f,%eax
 695:	c3                   	retq   

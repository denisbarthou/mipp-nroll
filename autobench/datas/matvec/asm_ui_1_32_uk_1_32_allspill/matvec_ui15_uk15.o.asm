...
0000000000000e00 <_Z6enablev>:
 ...
 e07:	b8 78 00 00 00       	mov    $0x78,%eax
 e0c:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 e11:	0f 45 c8             	cmovne %eax,%ecx
 e14:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # e1a <_Z6enablev+0x1a>
 e1a:	0f 9e c1             	setle  %cl
 e1d:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # e24 <_Z6enablev+0x24>
...
0000000000000e30 <_Z9n_reg_maxv>:
 e30:	b8 ff 00 00 00       	mov    $0xff,%eax
 e35:	c3                   	retq   

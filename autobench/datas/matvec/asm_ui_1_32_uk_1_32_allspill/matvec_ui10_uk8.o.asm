...
0000000000000650 <_Z6enablev>:
 ...
 657:	b8 50 00 00 00       	mov    $0x50,%eax
 65c:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 661:	0f 45 c8             	cmovne %eax,%ecx
 664:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 66a <_Z6enablev+0x1a>
 66a:	0f 9e c1             	setle  %cl
 66d:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 674 <_Z6enablev+0x24>
...
0000000000000680 <_Z9n_reg_maxv>:
 680:	b8 62 00 00 00       	mov    $0x62,%eax
 685:	c3                   	retq   

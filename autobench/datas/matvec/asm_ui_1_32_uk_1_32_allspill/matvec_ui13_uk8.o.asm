...
00000000000007a0 <_Z6enablev>:
 ...
 7a7:	b8 68 00 00 00       	mov    $0x68,%eax
 7ac:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 7b1:	0f 45 c8             	cmovne %eax,%ecx
 7b4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 7ba <_Z6enablev+0x1a>
 7ba:	0f 9e c1             	setle  %cl
 7bd:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 7c4 <_Z6enablev+0x24>
...
00000000000007d0 <_Z9n_reg_maxv>:
 7d0:	b8 7d 00 00 00       	mov    $0x7d,%eax
 7d5:	c3                   	retq   

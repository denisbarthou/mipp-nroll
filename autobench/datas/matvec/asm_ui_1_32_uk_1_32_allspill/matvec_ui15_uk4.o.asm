...
00000000000006f0 <_Z6enablev>:
 ...
 6f7:	b8 78 00 00 00       	mov    $0x78,%eax
 6fc:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 701:	0f 45 c8             	cmovne %eax,%ecx
 704:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 70a <_Z6enablev+0x1a>
 70a:	0f 9e c1             	setle  %cl
 70d:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 714 <_Z6enablev+0x24>
...
0000000000000720 <_Z9n_reg_maxv>:
 720:	b8 4f 00 00 00       	mov    $0x4f,%eax
 725:	c3                   	retq   

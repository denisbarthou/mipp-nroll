...
0000000000000610 <_Z6enablev>:
 ...
 617:	b8 30 00 00 00       	mov    $0x30,%eax
 61c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 621:	0f 45 c8             	cmovne %eax,%ecx
 624:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 62a <_Z6enablev+0x1a>
 62a:	0f 9e c1             	setle  %cl
 62d:	83 3d 00 00 00 00 0d 	cmpl   $0xd,0x0(%rip)        # 634 <_Z6enablev+0x24>
...
0000000000000640 <_Z9n_reg_maxv>:
 640:	b8 68 00 00 00       	mov    $0x68,%eax
 645:	c3                   	retq   

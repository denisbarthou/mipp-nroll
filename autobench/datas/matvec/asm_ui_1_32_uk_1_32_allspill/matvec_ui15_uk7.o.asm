...
00000000000007d0 <_Z6enablev>:
 ...
 7d7:	b8 78 00 00 00       	mov    $0x78,%eax
 7dc:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 7e1:	0f 45 c8             	cmovne %eax,%ecx
 7e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 7ea <_Z6enablev+0x1a>
 7ea:	0f 9e c1             	setle  %cl
 7ed:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 7f4 <_Z6enablev+0x24>
...
0000000000000800 <_Z9n_reg_maxv>:
 800:	b8 7f 00 00 00       	mov    $0x7f,%eax
 805:	c3                   	retq   

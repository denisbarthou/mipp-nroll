...
00000000000004e0 <_Z6enablev>:
 ...
 4e7:	b8 20 00 00 00       	mov    $0x20,%eax
 4ec:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 4f1:	0f 45 c8             	cmovne %eax,%ecx
 4f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4fa <_Z6enablev+0x1a>
 4fa:	0f 9e c1             	setle  %cl
 4fd:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # 504 <_Z6enablev+0x24>
...
0000000000000510 <_Z9n_reg_maxv>:
 510:	b8 4f 00 00 00       	mov    $0x4f,%eax
 515:	c3                   	retq   

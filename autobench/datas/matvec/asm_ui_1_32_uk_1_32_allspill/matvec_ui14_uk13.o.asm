...
0000000000000bf0 <_Z6enablev>:
 ...
 bf7:	b8 70 00 00 00       	mov    $0x70,%eax
 bfc:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 c01:	0f 45 c8             	cmovne %eax,%ecx
 c04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # c0a <_Z6enablev+0x1a>
 c0a:	0f 9e c1             	setle  %cl
 c0d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # c14 <_Z6enablev+0x24>
...
0000000000000c20 <_Z9n_reg_maxv>:
 c20:	b8 d1 00 00 00       	mov    $0xd1,%eax
 c25:	c3                   	retq   

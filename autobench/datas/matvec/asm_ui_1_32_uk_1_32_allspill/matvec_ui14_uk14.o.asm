...
0000000000000cb0 <_Z6enablev>:
 ...
 cb7:	b8 70 00 00 00       	mov    $0x70,%eax
 cbc:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 cc1:	0f 45 c8             	cmovne %eax,%ecx
 cc4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # cca <_Z6enablev+0x1a>
 cca:	0f 9e c1             	setle  %cl
 ccd:	83 3d 00 00 00 00 0d 	cmpl   $0xd,0x0(%rip)        # cd4 <_Z6enablev+0x24>
...
0000000000000ce0 <_Z9n_reg_maxv>:
 ce0:	b8 e0 00 00 00       	mov    $0xe0,%eax
 ce5:	c3                   	retq   

...
0000000000000980 <_Z6enablev>:
 ...
 987:	b8 60 00 00 00       	mov    $0x60,%eax
 98c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 991:	0f 45 c8             	cmovne %eax,%ecx
 994:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 99a <_Z6enablev+0x1a>
 99a:	0f 9e c1             	setle  %cl
 99d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # 9a4 <_Z6enablev+0x24>
...
00000000000009b0 <_Z9n_reg_maxv>:
 9b0:	b8 a8 00 00 00       	mov    $0xa8,%eax
 9b5:	c3                   	retq   

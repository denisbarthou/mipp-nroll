...
00000000000007b0 <_Z6enablev>:
 ...
 7b7:	b8 78 00 00 00       	mov    $0x78,%eax
 7bc:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 7c1:	0f 45 c8             	cmovne %eax,%ecx
 7c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 7ca <_Z6enablev+0x1a>
 7ca:	0f 9e c1             	setle  %cl
 7cd:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 7d4 <_Z6enablev+0x24>
...
00000000000007e0 <_Z9n_reg_maxv>:
 7e0:	b8 5f 00 00 00       	mov    $0x5f,%eax
 7e5:	c3                   	retq   

...
0000000000000530 <_Z6enablev>:
 ...
 537:	b8 38 00 00 00       	mov    $0x38,%eax
 53c:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 541:	0f 45 c8             	cmovne %eax,%ecx
 544:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 54a <_Z6enablev+0x1a>
 54a:	0f 9e c1             	setle  %cl
 54d:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # 554 <_Z6enablev+0x24>
...
0000000000000560 <_Z9n_reg_maxv>:
 560:	b8 4f 00 00 00       	mov    $0x4f,%eax
 565:	c3                   	retq   

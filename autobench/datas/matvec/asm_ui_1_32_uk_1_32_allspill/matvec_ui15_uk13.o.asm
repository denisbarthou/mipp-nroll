...
0000000000000c80 <_Z6enablev>:
 ...
 c87:	b8 78 00 00 00       	mov    $0x78,%eax
 c8c:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 c91:	0f 45 c8             	cmovne %eax,%ecx
 c94:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # c9a <_Z6enablev+0x1a>
 c9a:	0f 9e c1             	setle  %cl
 c9d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # ca4 <_Z6enablev+0x24>
...
0000000000000cb0 <_Z9n_reg_maxv>:
 cb0:	b8 df 00 00 00       	mov    $0xdf,%eax
 cb5:	c3                   	retq   

...
0000000000000ac0 <_Z6enablev>:
 ...
 ac7:	b8 70 00 00 00       	mov    $0x70,%eax
 acc:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 ad1:	0f 45 c8             	cmovne %eax,%ecx
 ad4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # ada <_Z6enablev+0x1a>
 ada:	0f 9e c1             	setle  %cl
 add:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # ae4 <_Z6enablev+0x24>
...
0000000000000af0 <_Z9n_reg_maxv>:
 af0:	b8 c2 00 00 00       	mov    $0xc2,%eax
 af5:	c3                   	retq   

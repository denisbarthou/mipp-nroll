...
0000000000000680 <_Z6enablev>:
 ...
 687:	b8 38 00 00 00       	mov    $0x38,%eax
 68c:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 691:	0f 45 c8             	cmovne %eax,%ecx
 694:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 69a <_Z6enablev+0x1a>
 69a:	0f 9e c1             	setle  %cl
 69d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # 6a4 <_Z6enablev+0x24>
...
00000000000006b0 <_Z9n_reg_maxv>:
 6b0:	b8 67 00 00 00       	mov    $0x67,%eax
 6b5:	c3                   	retq   

...
0000000000000c90 <_Z6enablev>:
 c90:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # c97 <_Z6enablev+0x7>
 c97:	b8 68 00 00 00       	mov    $0x68,%eax
 c9c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 ca1:	0f 45 c8             	cmovne %eax,%ecx
 ca4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # caa <_Z6enablev+0x1a>
 caa:	0f 9e c1             	setle  %cl
 cad:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # cb4 <_Z6enablev+0x24>
 cb4:	0f 9f c0             	setg   %al
 cb7:	20 c8                	and    %cl,%al
 cb9:	c3                   	retq   
 cba:	90                   	nop
 cbb:	90                   	nop
...
0000000000000cc0 <_Z9n_reg_maxv>:
 cc0:	b8 df 00 00 00       	mov    $0xdf,%eax
 cc5:	c3                   	retq   

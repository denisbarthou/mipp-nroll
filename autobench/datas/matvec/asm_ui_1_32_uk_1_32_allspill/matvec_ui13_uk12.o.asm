...
0000000000000a20 <_Z6enablev>:
 ...
 a27:	b8 68 00 00 00       	mov    $0x68,%eax
 a2c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 a31:	0f 45 c8             	cmovne %eax,%ecx
 a34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a3a <_Z6enablev+0x1a>
 a3a:	0f 9e c1             	setle  %cl
 a3d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # a44 <_Z6enablev+0x24>
...
0000000000000a50 <_Z9n_reg_maxv>:
 a50:	b8 b5 00 00 00       	mov    $0xb5,%eax
 a55:	c3                   	retq   

...
00000000000005d0 <_Z6enablev>:
 ...
 5d7:	b8 30 00 00 00       	mov    $0x30,%eax
 5dc:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 5e1:	0f 45 c8             	cmovne %eax,%ecx
 5e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 5ea <_Z6enablev+0x1a>
 5ea:	0f 9e c1             	setle  %cl
 5ed:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 5f4 <_Z6enablev+0x24>
...
0000000000000600 <_Z9n_reg_maxv>:
 600:	b8 61 00 00 00       	mov    $0x61,%eax
 605:	c3                   	retq   

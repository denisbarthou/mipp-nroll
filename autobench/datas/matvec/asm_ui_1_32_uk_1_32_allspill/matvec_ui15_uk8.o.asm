...
0000000000000890 <_Z6enablev>:
 ...
 897:	b8 78 00 00 00       	mov    $0x78,%eax
 89c:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 8a1:	0f 45 c8             	cmovne %eax,%ecx
 8a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 8aa <_Z6enablev+0x1a>
 8aa:	0f 9e c1             	setle  %cl
 8ad:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 8b4 <_Z6enablev+0x24>
...
00000000000008c0 <_Z9n_reg_maxv>:
 8c0:	b8 8f 00 00 00       	mov    $0x8f,%eax
 8c5:	c3                   	retq   

...
0000000000000460 <_Z6enablev>:
 ...
 467:	b8 38 00 00 00       	mov    $0x38,%eax
 46c:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 471:	0f 45 c8             	cmovne %eax,%ecx
 474:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 47a <_Z6enablev+0x1a>
 47a:	0f 9e c1             	setle  %cl
 47d:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 484 <_Z6enablev+0x24>
...
0000000000000490 <_Z9n_reg_maxv>:
 490:	b8 37 00 00 00       	mov    $0x37,%eax
 495:	c3                   	retq   

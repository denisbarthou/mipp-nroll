...
0000000000000670 <_Z6enablev>:
 ...
 677:	b8 38 00 00 00       	mov    $0x38,%eax
 67c:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 681:	0f 45 c8             	cmovne %eax,%ecx
 684:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 68a <_Z6enablev+0x1a>
 68a:	0f 9e c1             	setle  %cl
 68d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 694 <_Z6enablev+0x24>
...
00000000000006a0 <_Z9n_reg_maxv>:
 6a0:	b8 6f 00 00 00       	mov    $0x6f,%eax
 6a5:	c3                   	retq   

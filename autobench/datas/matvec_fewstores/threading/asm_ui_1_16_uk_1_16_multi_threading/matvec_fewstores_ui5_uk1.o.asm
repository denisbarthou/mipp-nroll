...
0000000000000220 <.omp_outlined.>:
 ...
 2f8:	4b 8d 04 92          	lea    (%r10,%r10,4),%rax
 2fc:	4c 63 c3             	movslq %ebx,%r8
 2ff:	4c 8d 0c c5 20 00 00 	lea    0x20(,%rax,8),%r9
 306:	00 
 307:	48 c1 e2 02          	shl    $0x2,%rdx
 30b:	eb 44                	jmp    351 <.omp_outlined.+0x131>
 30d:	0f 1f 00             	nopl   (%rax)
 310:	c5 fc 11 24 ae       	vmovups %ymm4,(%rsi,%rbp,4)
 315:	49 83 c1 28          	add    $0x28,%r9
 319:	49 8b 45 00          	mov    0x0(%r13),%rax
 31d:	c5 fc 11 5c a8 20    	vmovups %ymm3,0x20(%rax,%rbp,4)
 323:	49 8b 45 00          	mov    0x0(%r13),%rax
 327:	c5 fc 11 54 a8 40    	vmovups %ymm2,0x40(%rax,%rbp,4)
 32d:	49 8b 45 00          	mov    0x0(%r13),%rax
 331:	c5 fc 11 4c a8 60    	vmovups %ymm1,0x60(%rax,%rbp,4)
 337:	49 8b 45 00          	mov    0x0(%r13),%rax
 33b:	c5 fc 11 84 a8 80 00 	vmovups %ymm0,0x80(%rax,%rbp,4)
 342:	00 00 
 344:	4d 39 c2             	cmp    %r8,%r10
 347:	4d 8d 52 01          	lea    0x1(%r10),%r10
 34b:	0f 8d 7b ff ff ff    	jge    2cc <.omp_outlined.+0xac>
 351:	49 8b 75 00          	mov    0x0(%r13),%rsi
 355:	4a 8d 04 d5 00 00 00 	lea    0x0(,%r10,8),%rax
 35c:	00 
 35d:	48 8d 2c 80          	lea    (%rax,%rax,4),%rbp
 361:	c5 fc 10 24 ae       	vmovups (%rsi,%rbp,4),%ymm4
 366:	c5 fc 10 5c ae 20    	vmovups 0x20(%rsi,%rbp,4),%ymm3
 36c:	c5 fc 10 54 ae 40    	vmovups 0x40(%rsi,%rbp,4),%ymm2
 372:	c5 fc 10 4c ae 60    	vmovups 0x60(%rsi,%rbp,4),%ymm1
 378:	c5 fc 10 84 ae 80 00 	vmovups 0x80(%rsi,%rbp,4),%ymm0
 37f:	00 00 
 381:	85 c9                	test   %ecx,%ecx
 383:	7e 8b                	jle    310 <.omp_outlined.+0xf0>
 385:	49 8b 1f             	mov    (%r15),%rbx
 388:	4a 8d 3c 8d 00 00 00 	lea    0x0(,%r9,4),%rdi
 38f:	00 
 390:	49 03 3e             	add    (%r14),%rdi
 393:	31 c0                	xor    %eax,%eax
 395:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 39c:	00 00 00 00 
 3a0:	c4 e2 7d 18 2c 83    	vbroadcastss (%rbx,%rax,4),%ymm5
 3a6:	c4 e2 55 b8 67 80    	vfmadd231ps -0x80(%rdi),%ymm5,%ymm4
 3ac:	c4 e2 55 b8 5f a0    	vfmadd231ps -0x60(%rdi),%ymm5,%ymm3
 3b2:	c4 e2 55 b8 57 c0    	vfmadd231ps -0x40(%rdi),%ymm5,%ymm2
 3b8:	c4 e2 55 b8 4f e0    	vfmadd231ps -0x20(%rdi),%ymm5,%ymm1
 3be:	c4 e2 55 b8 07       	vfmadd231ps (%rdi),%ymm5,%ymm0
 3c3:	48 ff c0             	inc    %rax
 3c6:	48 01 d7             	add    %rdx,%rdi
 3c9:	48 39 c1             	cmp    %rax,%rcx
 3cc:	75 d2                	jne    3a0 <.omp_outlined.+0x180>
 3ce:	e9 3d ff ff ff       	jmpq   310 <.omp_outlined.+0xf0>
...
00000000000003e0 <_Z6enablev>:
 ...
 3e7:	b8 28 00 00 00       	mov    $0x28,%eax
 3ec:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx

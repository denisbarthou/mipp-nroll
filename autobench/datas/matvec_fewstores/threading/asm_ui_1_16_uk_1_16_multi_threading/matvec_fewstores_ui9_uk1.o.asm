...
0000000000000220 <.omp_outlined.>:
 ...
 262:	00 
 263:	48 98                	cltq   
 265:	48 69 c0 39 8e e3 38 	imul   $0x38e38e39,%rax,%rax
 ...
 2f8:	4b 8d 04 d2          	lea    (%r10,%r10,8),%rax
 2fc:	4c 63 c3             	movslq %ebx,%r8
 2ff:	4c 8d 0c c5 40 00 00 	lea    0x40(,%rax,8),%r9
 306:	00 
 307:	48 c1 e2 02          	shl    $0x2,%rdx
 30b:	eb 78                	jmp    385 <.omp_outlined.+0x165>
 30d:	0f 1f 00             	nopl   (%rax)
 310:	c5 7c 11 04 ae       	vmovups %ymm8,(%rsi,%rbp,4)
 315:	49 83 c1 48          	add    $0x48,%r9
 319:	49 8b 45 00          	mov    0x0(%r13),%rax
 31d:	c5 fc 11 7c a8 20    	vmovups %ymm7,0x20(%rax,%rbp,4)
 323:	49 8b 45 00          	mov    0x0(%r13),%rax
 327:	c5 fc 11 74 a8 40    	vmovups %ymm6,0x40(%rax,%rbp,4)
 32d:	49 8b 45 00          	mov    0x0(%r13),%rax
 331:	c5 fc 11 6c a8 60    	vmovups %ymm5,0x60(%rax,%rbp,4)
 337:	49 8b 45 00          	mov    0x0(%r13),%rax
 33b:	c5 fc 11 a4 a8 80 00 	vmovups %ymm4,0x80(%rax,%rbp,4)
 342:	00 00 
 344:	49 8b 45 00          	mov    0x0(%r13),%rax
 348:	c5 fc 11 9c a8 a0 00 	vmovups %ymm3,0xa0(%rax,%rbp,4)
 34f:	00 00 
 351:	49 8b 45 00          	mov    0x0(%r13),%rax
 355:	c5 fc 11 94 a8 c0 00 	vmovups %ymm2,0xc0(%rax,%rbp,4)
 35c:	00 00 
 35e:	49 8b 45 00          	mov    0x0(%r13),%rax
 362:	c5 fc 11 8c a8 e0 00 	vmovups %ymm1,0xe0(%rax,%rbp,4)
 369:	00 00 
 36b:	49 8b 45 00          	mov    0x0(%r13),%rax
 36f:	c5 fc 11 84 a8 00 01 	vmovups %ymm0,0x100(%rax,%rbp,4)
 376:	00 00 
 378:	4d 39 c2             	cmp    %r8,%r10
 37b:	4d 8d 52 01          	lea    0x1(%r10),%r10
 37f:	0f 8d 47 ff ff ff    	jge    2cc <.omp_outlined.+0xac>
 385:	49 8b 75 00          	mov    0x0(%r13),%rsi
 389:	4a 8d 04 d5 00 00 00 	lea    0x0(,%r10,8),%rax
 390:	00 
 391:	48 8d 2c c0          	lea    (%rax,%rax,8),%rbp
 395:	c5 7c 10 04 ae       	vmovups (%rsi,%rbp,4),%ymm8
 39a:	c5 fc 10 7c ae 20    	vmovups 0x20(%rsi,%rbp,4),%ymm7
 3a0:	c5 fc 10 74 ae 40    	vmovups 0x40(%rsi,%rbp,4),%ymm6
 3a6:	c5 fc 10 6c ae 60    	vmovups 0x60(%rsi,%rbp,4),%ymm5
 3ac:	c5 fc 10 a4 ae 80 00 	vmovups 0x80(%rsi,%rbp,4),%ymm4
 3b3:	00 00 
 3b5:	c5 fc 10 9c ae a0 00 	vmovups 0xa0(%rsi,%rbp,4),%ymm3
 3bc:	00 00 
 3be:	c5 fc 10 94 ae c0 00 	vmovups 0xc0(%rsi,%rbp,4),%ymm2
 3c5:	00 00 
 3c7:	c5 fc 10 8c ae e0 00 	vmovups 0xe0(%rsi,%rbp,4),%ymm1
 3ce:	00 00 
 3d0:	c5 fc 10 84 ae 00 01 	vmovups 0x100(%rsi,%rbp,4),%ymm0
 3d7:	00 00 
 3d9:	85 c9                	test   %ecx,%ecx
 3db:	0f 8e 2f ff ff ff    	jle    310 <.omp_outlined.+0xf0>
 3e1:	49 8b 1f             	mov    (%r15),%rbx
 3e4:	4a 8d 3c 8d 00 00 00 	lea    0x0(,%r9,4),%rdi
 3eb:	00 
 3ec:	49 03 3e             	add    (%r14),%rdi
 ...
 3ff:	00 
 400:	c4 62 7d 18 0c 83    	vbroadcastss (%rbx,%rax,4),%ymm9
 406:	c4 62 35 b8 87 00 ff 	vfmadd231ps -0x100(%rdi),%ymm9,%ymm8
 40d:	ff ff 
 40f:	c4 e2 35 b8 bf 20 ff 	vfmadd231ps -0xe0(%rdi),%ymm9,%ymm7
 416:	ff ff 
 418:	c4 e2 35 b8 b7 40 ff 	vfmadd231ps -0xc0(%rdi),%ymm9,%ymm6
 41f:	ff ff 
 421:	c4 e2 35 b8 af 60 ff 	vfmadd231ps -0xa0(%rdi),%ymm9,%ymm5
 428:	ff ff 
 42a:	c4 e2 35 b8 67 80    	vfmadd231ps -0x80(%rdi),%ymm9,%ymm4
 430:	c4 e2 35 b8 5f a0    	vfmadd231ps -0x60(%rdi),%ymm9,%ymm3
 436:	c4 e2 35 b8 57 c0    	vfmadd231ps -0x40(%rdi),%ymm9,%ymm2
 43c:	c4 e2 35 b8 4f e0    	vfmadd231ps -0x20(%rdi),%ymm9,%ymm1
 442:	c4 e2 35 b8 07       	vfmadd231ps (%rdi),%ymm9,%ymm0
 447:	48 ff c0             	inc    %rax
 44a:	48 01 d7             	add    %rdx,%rdi
 44d:	48 39 c1             	cmp    %rax,%rcx
 450:	75 ae                	jne    400 <.omp_outlined.+0x1e0>
 452:	e9 b9 fe ff ff       	jmpq   310 <.omp_outlined.+0xf0>
...
0000000000000460 <_Z6enablev>:
 ...
 467:	b8 48 00 00 00       	mov    $0x48,%eax
 46c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx

...
0000000000000220 <.omp_outlined.>:
 ...
 3ce:	00 00 
 3d0:	c4 02 7d 18 2c 86    	vbroadcastss (%r14,%r8,4),%ymm13
 3d6:	c4 c2 15 b8 47 a0    	vfmadd231ps -0x60(%r15),%ymm13,%ymm0
 3dc:	c4 02 7d 18 64 86 04 	vbroadcastss 0x4(%r14,%r8,4),%ymm12
 3e3:	4d 8d 6c 2f a0       	lea    -0x60(%r15,%rbp,1),%r13
 3e8:	c4 02 7d 18 5c 86 08 	vbroadcastss 0x8(%r14,%r8,4),%ymm11
 3ef:	c4 02 7d 18 54 86 0c 	vbroadcastss 0xc(%r14,%r8,4),%ymm10
 3f6:	c4 02 7d 18 4c 86 10 	vbroadcastss 0x10(%r14,%r8,4),%ymm9
 3fd:	c4 02 7d 18 44 86 14 	vbroadcastss 0x14(%r14,%r8,4),%ymm8
 404:	c4 82 7d 18 7c 86 18 	vbroadcastss 0x18(%r14,%r8,4),%ymm7
 40b:	c4 82 7d 18 74 86 1c 	vbroadcastss 0x1c(%r14,%r8,4),%ymm6
 412:	c4 82 7d 18 6c 86 20 	vbroadcastss 0x20(%r14,%r8,4),%ymm5
 419:	c4 c2 15 b8 4f c0    	vfmadd231ps -0x40(%r15),%ymm13,%ymm1
 41f:	c4 82 7d 18 64 86 24 	vbroadcastss 0x24(%r14,%r8,4),%ymm4
 426:	c4 c2 15 b8 57 e0    	vfmadd231ps -0x20(%r15),%ymm13,%ymm2
 42c:	c4 c2 15 b8 1f       	vfmadd231ps (%r15),%ymm13,%ymm3
 431:	49 83 c0 0a          	add    $0xa,%r8
 435:	49 8d 44 2d 00       	lea    0x0(%r13,%rbp,1),%rax
 43a:	c4 c2 1d b8 44 2f a0 	vfmadd231ps -0x60(%r15,%rbp,1),%ymm12,%ymm0
 441:	49 01 ff             	add    %rdi,%r15
 444:	c4 a2 25 b8 44 2d 00 	vfmadd231ps 0x0(%rbp,%r13,1),%ymm11,%ymm0
 44b:	c4 e2 2d b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm10,%ymm0
 452:	48 01 e8             	add    %rbp,%rax
 455:	c4 e2 35 b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm9,%ymm0
 45c:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 460:	c4 e2 3d b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm8,%ymm0
 467:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 46b:	c4 e2 45 b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm7,%ymm0
 472:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 476:	c4 e2 4d b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm6,%ymm0
 47d:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 481:	c4 e2 55 b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm5,%ymm0
 488:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 48c:	c4 e2 5d b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm4,%ymm0
 493:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 497:	c4 e2 1d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm12,%ymm1
 49d:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 4a1:	c4 e2 25 b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm11,%ymm1
 4a8:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4ac:	c4 e2 2d b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm10,%ymm1
 4b3:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4b7:	c4 e2 35 b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm9,%ymm1
 4be:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4c2:	c4 e2 3d b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm8,%ymm1
 4c9:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4cd:	c4 e2 45 b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm7,%ymm1
 4d4:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4d8:	c4 e2 4d b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm6,%ymm1
 4df:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4e3:	c4 e2 55 b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm5,%ymm1
 4ea:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4ee:	c4 e2 5d b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm4,%ymm1
 4f5:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 4f9:	c4 e2 1d b8 14 02    	vfmadd231ps (%rdx,%rax,1),%ymm12,%ymm2
 4ff:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 503:	c4 e2 25 b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm11,%ymm2
 50a:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 50e:	c4 e2 2d b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm10,%ymm2
 515:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 519:	c4 e2 35 b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm9,%ymm2
 520:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 524:	c4 e2 3d b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm8,%ymm2
 52b:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 52f:	c4 e2 45 b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm7,%ymm2
 536:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 53a:	c4 e2 4d b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm6,%ymm2
 541:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 545:	c4 e2 55 b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm5,%ymm2
 54c:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 550:	c4 e2 5d b8 54 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm4,%ymm2
 557:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 55b:	c4 e2 1d b8 1c 02    	vfmadd231ps (%rdx,%rax,1),%ymm12,%ymm3
 561:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 565:	c4 e2 25 b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm11,%ymm3
 56c:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 570:	c4 e2 2d b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm10,%ymm3
 577:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 57b:	c4 e2 35 b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm9,%ymm3
 582:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 586:	c4 e2 3d b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm8,%ymm3
 58d:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 591:	c4 e2 45 b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm7,%ymm3
 598:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 59c:	c4 e2 4d b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm6,%ymm3
 5a3:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 5a7:	c4 e2 55 b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm5,%ymm3
 5ae:	48 01 e8             	add    %rbp,%rax
 5b1:	c4 e2 5d b8 5c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm4,%ymm3
 5b8:	49 39 c8             	cmp    %rcx,%r8
 5bb:	0f 8c 0f fe ff ff    	jl     3d0 <.omp_outlined.+0x1b0>
 5c1:	e9 6a fd ff ff       	jmpq   330 <.omp_outlined.+0x110>
...
00000000000005e0 <_Z9n_reg_maxv>:
 5e0:	b8 36 00 00 00       	mov    $0x36,%eax
 5e5:	c3                   	retq   

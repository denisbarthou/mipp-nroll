...
0000000000000230 <.omp_outlined.>:
 ...
 3b0:	c4 a2 7d 18 3c a7    	vbroadcastss (%rdi,%r12,4),%ymm7
 3b6:	c4 e2 45 b8 50 c0    	vfmadd231ps -0x40(%rax),%ymm7,%ymm2
 3bc:	c4 a2 7d 18 74 a7 04 	vbroadcastss 0x4(%rdi,%r12,4),%ymm6
 3c3:	4c 8d 74 10 c0       	lea    -0x40(%rax,%rdx,1),%r14
 3c8:	c4 a2 7d 18 6c a7 08 	vbroadcastss 0x8(%rdi,%r12,4),%ymm5
 3cf:	c4 a2 7d 18 64 a7 0c 	vbroadcastss 0xc(%rdi,%r12,4),%ymm4
 3d6:	c4 e2 45 b8 48 e0    	vfmadd231ps -0x20(%rax),%ymm7,%ymm1
 3dc:	c4 a2 7d 18 5c a7 10 	vbroadcastss 0x10(%rdi,%r12,4),%ymm3
 3e3:	c4 e2 45 b8 00       	vfmadd231ps (%rax),%ymm7,%ymm0
 3e8:	49 83 c4 05          	add    $0x5,%r12
 3ec:	49 8d 1c 16          	lea    (%r14,%rdx,1),%rbx
 3f0:	c4 e2 4d b8 54 10 c0 	vfmadd231ps -0x40(%rax,%rdx,1),%ymm6,%ymm2
 3f7:	48 01 e8             	add    %rbp,%rax
 3fa:	c4 a2 55 b8 14 32    	vfmadd231ps (%rdx,%r14,1),%ymm5,%ymm2
 400:	c4 e2 5d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm2
 406:	48 01 d3             	add    %rdx,%rbx
 409:	c4 e2 65 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm3,%ymm2
 40f:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 413:	c4 e2 4d b8 0c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm6,%ymm1
 419:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 41d:	c4 e2 55 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm1
 423:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 427:	c4 e2 5d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm1
 42d:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 431:	c4 e2 65 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm3,%ymm1
 437:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 43b:	c4 e2 4d b8 04 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm6,%ymm0
 441:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 445:	c4 e2 55 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm0
 44b:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 44f:	c4 e2 5d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm0
 455:	48 01 d3             	add    %rdx,%rbx
 458:	c4 e2 65 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm3,%ymm0
 45e:	49 39 cc             	cmp    %rcx,%r12
 461:	0f 8c 49 ff ff ff    	jl     3b0 <.omp_outlined.+0x180>
 467:	e9 d4 fe ff ff       	jmpq   340 <.omp_outlined.+0x110>

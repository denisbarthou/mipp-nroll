...
0000000000000230 <.omp_outlined.>:
 ...
 331:	48 8d 3c 52          	lea    (%rdx,%rdx,2),%rdi
 ...
 3e0:	c4 22 7d 18 14 a0    	vbroadcastss (%rax,%r12,4),%ymm10
 3e6:	c4 e2 2d b8 66 80    	vfmadd231ps -0x80(%rsi),%ymm10,%ymm4
 3ec:	c4 22 7d 18 4c a0 04 	vbroadcastss 0x4(%rax,%r12,4),%ymm9
 3f3:	4c 8d 74 2e 80       	lea    -0x80(%rsi,%rbp,1),%r14
 3f8:	c4 22 7d 18 44 a0 08 	vbroadcastss 0x8(%rax,%r12,4),%ymm8
 3ff:	c4 a2 7d 18 7c a0 0c 	vbroadcastss 0xc(%rax,%r12,4),%ymm7
 406:	c4 a2 7d 18 74 a0 10 	vbroadcastss 0x10(%rax,%r12,4),%ymm6
 40d:	c4 e2 2d b8 5e a0    	vfmadd231ps -0x60(%rsi),%ymm10,%ymm3
 413:	c4 a2 7d 18 6c a0 14 	vbroadcastss 0x14(%rax,%r12,4),%ymm5
 41a:	c4 e2 2d b8 56 c0    	vfmadd231ps -0x40(%rsi),%ymm10,%ymm2
 420:	c4 e2 2d b8 4e e0    	vfmadd231ps -0x20(%rsi),%ymm10,%ymm1
 426:	c4 e2 2d b8 06       	vfmadd231ps (%rsi),%ymm10,%ymm0
 42b:	49 83 c4 06          	add    $0x6,%r12
 42f:	49 8d 1c 2e          	lea    (%r14,%rbp,1),%rbx
 433:	c4 e2 35 b8 64 2e 80 	vfmadd231ps -0x80(%rsi,%rbp,1),%ymm9,%ymm4
 43a:	48 01 fe             	add    %rdi,%rsi
 43d:	c4 a2 3d b8 64 35 00 	vfmadd231ps 0x0(%rbp,%r14,1),%ymm8,%ymm4
 444:	c4 e2 45 b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm4
 44b:	48 01 eb             	add    %rbp,%rbx
 44e:	c4 e2 4d b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm4
 455:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 459:	c4 e2 55 b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm4
 460:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 464:	c4 e2 35 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm3
 46a:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 46e:	c4 e2 3d b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm3
 475:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 479:	c4 e2 45 b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm3
 480:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 484:	c4 e2 4d b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm3
 48b:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 48f:	c4 e2 55 b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm3
 496:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 49a:	c4 e2 35 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm2
 4a0:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4a4:	c4 e2 3d b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm2
 4ab:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4af:	c4 e2 45 b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm2
 4b6:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4ba:	c4 e2 4d b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm2
 4c1:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4c5:	c4 e2 55 b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm2
 4cc:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4d0:	c4 e2 35 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm1
 ...
 506:	c4 e2 35 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm0
 50c:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 510:	c4 e2 3d b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm0
 517:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 51b:	c4 e2 45 b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm0
 522:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 526:	c4 e2 4d b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm0
 52d:	48 01 eb             	add    %rbp,%rbx
 530:	c4 e2 55 b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm0
 537:	49 39 cc             	cmp    %rcx,%r12
 53a:	0f 8c a0 fe ff ff    	jl     3e0 <.omp_outlined.+0x1b0>
 540:	e9 fb fd ff ff       	jmpq   340 <.omp_outlined.+0x110>
...
0000000000000550 <_Z6enablev>:
 ...
 557:	b8 28 00 00 00       	mov    $0x28,%eax
 55c:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx
...
0000000000000580 <_Z9n_reg_maxv>:
 580:	b8 29 00 00 00       	mov    $0x29,%eax
 585:	c3                   	retq   

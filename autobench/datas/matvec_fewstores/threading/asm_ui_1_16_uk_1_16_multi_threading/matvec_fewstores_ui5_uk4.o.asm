...
0000000000000220 <.omp_outlined.>:
 ...
 310:	48 8d 34 80          	lea    (%rax,%rax,4),%rsi
 314:	48 8d 04 52          	lea    (%rdx,%rdx,2),%rax
 318:	48 8d 3c d6          	lea    (%rsi,%rdx,8),%rdi
 31c:	48 8d 2c 96          	lea    (%rsi,%rdx,4),%rbp
 320:	48 c1 e2 04          	shl    $0x4,%rdx
 324:	48 8d 1c 86          	lea    (%rsi,%rax,4),%rbx
 328:	eb 4e                	jmp    378 <.omp_outlined.+0x158>
 32a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
 330:	c4 81 7c 11 24 83    	vmovups %ymm4,(%r11,%r8,4)
 336:	49 83 c1 28          	add    $0x28,%r9
 33a:	49 8b 45 00          	mov    0x0(%r13),%rax
 33e:	c4 a1 7c 11 5c 80 20 	vmovups %ymm3,0x20(%rax,%r8,4)
 345:	49 8b 45 00          	mov    0x0(%r13),%rax
 349:	c4 a1 7c 11 54 80 40 	vmovups %ymm2,0x40(%rax,%r8,4)
 350:	49 8b 45 00          	mov    0x0(%r13),%rax
 354:	c4 a1 7c 11 4c 80 60 	vmovups %ymm1,0x60(%rax,%r8,4)
 35b:	49 8b 45 00          	mov    0x0(%r13),%rax
 35f:	c4 a1 7c 11 84 80 80 	vmovups %ymm0,0x80(%rax,%r8,4)
 366:	00 00 00 
 369:	4c 3b 54 24 30       	cmp    0x30(%rsp),%r10
 36e:	4d 8d 52 01          	lea    0x1(%r10),%r10
 372:	0f 8d 58 ff ff ff    	jge    2d0 <.omp_outlined.+0xb0>
 378:	4d 8b 5d 00          	mov    0x0(%r13),%r11
 37c:	4a 8d 04 d5 00 00 00 	lea    0x0(,%r10,8),%rax
 383:	00 
 384:	4c 8d 04 80          	lea    (%rax,%rax,4),%r8
 388:	c4 81 7c 10 24 83    	vmovups (%r11,%r8,4),%ymm4
 38e:	c4 81 7c 10 5c 83 20 	vmovups 0x20(%r11,%r8,4),%ymm3
 395:	c4 81 7c 10 54 83 40 	vmovups 0x40(%r11,%r8,4),%ymm2
 39c:	c4 81 7c 10 4c 83 60 	vmovups 0x60(%r11,%r8,4),%ymm1
 3a3:	c4 81 7c 10 84 83 80 	vmovups 0x80(%r11,%r8,4),%ymm0
 3aa:	00 00 00 
 3ad:	85 c9                	test   %ecx,%ecx
 3af:	0f 8e 7b ff ff ff    	jle    330 <.omp_outlined.+0x110>
 3b5:	48 8b 44 24 20       	mov    0x20(%rsp),%rax
 3ba:	4e 8d 34 8d 00 00 00 	lea    0x0(,%r9,4),%r14
 3c1:	00 
 3c2:	45 31 ff             	xor    %r15d,%r15d
 3c5:	4c 8b 20             	mov    (%rax),%r12
 3c8:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
 3cd:	4c 03 30             	add    (%rax),%r14
 3d0:	c4 02 7d 18 04 bc    	vbroadcastss (%r12,%r15,4),%ymm8
 3d6:	c4 c2 3d b8 24 36    	vfmadd231ps (%r14,%rsi,1),%ymm8,%ymm4
 3dc:	c4 c2 3d b8 5c 36 20 	vfmadd231ps 0x20(%r14,%rsi,1),%ymm8,%ymm3
 3e3:	c4 c2 3d b8 54 36 40 	vfmadd231ps 0x40(%r14,%rsi,1),%ymm8,%ymm2
 3ea:	c4 c2 3d b8 4c 36 60 	vfmadd231ps 0x60(%r14,%rsi,1),%ymm8,%ymm1
 3f1:	c4 c2 3d b8 84 36 80 	vfmadd231ps 0x80(%r14,%rsi,1),%ymm8,%ymm0
 3f8:	00 00 00 
 3fb:	c4 82 7d 18 7c bc 04 	vbroadcastss 0x4(%r12,%r15,4),%ymm7
 402:	c4 82 7d 18 74 bc 08 	vbroadcastss 0x8(%r12,%r15,4),%ymm6
 409:	c4 82 7d 18 6c bc 0c 	vbroadcastss 0xc(%r12,%r15,4),%ymm5
 410:	49 83 c7 04          	add    $0x4,%r15
 414:	c4 c2 45 b8 24 2e    	vfmadd231ps (%r14,%rbp,1),%ymm7,%ymm4
 41a:	c4 c2 45 b8 5c 2e 20 	vfmadd231ps 0x20(%r14,%rbp,1),%ymm7,%ymm3
 421:	c4 c2 45 b8 54 2e 40 	vfmadd231ps 0x40(%r14,%rbp,1),%ymm7,%ymm2
 428:	c4 c2 45 b8 4c 2e 60 	vfmadd231ps 0x60(%r14,%rbp,1),%ymm7,%ymm1
 42f:	c4 c2 45 b8 84 2e 80 	vfmadd231ps 0x80(%r14,%rbp,1),%ymm7,%ymm0
 436:	00 00 00 
 439:	c4 c2 4d b8 24 3e    	vfmadd231ps (%r14,%rdi,1),%ymm6,%ymm4
 43f:	c4 c2 4d b8 5c 3e 20 	vfmadd231ps 0x20(%r14,%rdi,1),%ymm6,%ymm3
 446:	c4 c2 4d b8 54 3e 40 	vfmadd231ps 0x40(%r14,%rdi,1),%ymm6,%ymm2
 44d:	c4 c2 4d b8 4c 3e 60 	vfmadd231ps 0x60(%r14,%rdi,1),%ymm6,%ymm1
 454:	c4 c2 4d b8 84 3e 80 	vfmadd231ps 0x80(%r14,%rdi,1),%ymm6,%ymm0
 45b:	00 00 00 
 45e:	c4 c2 55 b8 24 1e    	vfmadd231ps (%r14,%rbx,1),%ymm5,%ymm4
 464:	c4 c2 55 b8 5c 1e 20 	vfmadd231ps 0x20(%r14,%rbx,1),%ymm5,%ymm3
 46b:	c4 c2 55 b8 54 1e 40 	vfmadd231ps 0x40(%r14,%rbx,1),%ymm5,%ymm2
 472:	c4 c2 55 b8 4c 1e 60 	vfmadd231ps 0x60(%r14,%rbx,1),%ymm5,%ymm1
 479:	c4 c2 55 b8 84 1e 80 	vfmadd231ps 0x80(%r14,%rbx,1),%ymm5,%ymm0
 480:	00 00 00 
 483:	49 01 d6             	add    %rdx,%r14
 486:	49 39 cf             	cmp    %rcx,%r15
 489:	0f 8c 41 ff ff ff    	jl     3d0 <.omp_outlined.+0x1b0>
 48f:	e9 9c fe ff ff       	jmpq   330 <.omp_outlined.+0x110>

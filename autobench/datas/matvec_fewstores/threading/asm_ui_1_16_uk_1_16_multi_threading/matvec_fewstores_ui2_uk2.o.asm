...
0000000000000210 <.omp_outlined.>:
 ...
 227:	8d 48 0f             	lea    0xf(%rax),%ecx
 22a:	8d 68 1e             	lea    0x1e(%rax),%ebp
 ...
 2d7:	48 63 0d 00 00 00 00 	movslq 0x0(%rip),%rcx        # 2de <.omp_outlined.+0xce>
 2de:	4c 63 c3             	movslq %ebx,%r8
 2e1:	c1 e6 04             	shl    $0x4,%esi
 2e4:	48 63 f6             	movslq %esi,%rsi
 2e7:	48 8d 3c b5 20 00 00 	lea    0x20(,%rsi,4),%rdi
 2ee:	00 
 2ef:	48 c1 e6 02          	shl    $0x2,%rsi
 2f3:	48 8d 2c 96          	lea    (%rsi,%rdx,4),%rbp
 2f7:	48 c1 e2 03          	shl    $0x3,%rdx
 2fb:	eb 24                	jmp    321 <.omp_outlined.+0x111>
 2fd:	0f 1f 00             	nopl   (%rax)
 300:	c4 81 7c 11 04 93    	vmovups %ymm0,(%r11,%r10,4)
 306:	48 83 c7 40          	add    $0x40,%rdi
 30a:	48 83 c5 40          	add    $0x40,%rbp
 30e:	49 8b 75 00          	mov    0x0(%r13),%rsi
 312:	c4 a1 7c 11 0c 8e    	vmovups %ymm1,(%rsi,%r9,4)
 318:	4c 39 c0             	cmp    %r8,%rax
 31b:	48 8d 40 01          	lea    0x1(%rax),%rax
 31f:	7d 8d                	jge    2ae <.omp_outlined.+0x9e>
 321:	4d 8b 5d 00          	mov    0x0(%r13),%r11
 325:	89 c6                	mov    %eax,%esi
 327:	c1 e6 04             	shl    $0x4,%esi
 32a:	8d 5e 08             	lea    0x8(%rsi),%ebx
 32d:	4c 63 d6             	movslq %esi,%r10
 330:	4c 63 cb             	movslq %ebx,%r9
 333:	c4 81 7c 10 04 93    	vmovups (%r11,%r10,4),%ymm0
 339:	c4 81 7c 10 0c 8b    	vmovups (%r11,%r9,4),%ymm1
 33f:	85 c9                	test   %ecx,%ecx
 341:	7e bd                	jle    300 <.omp_outlined.+0xf0>
 343:	49 8b 1f             	mov    (%r15),%rbx
 346:	49 8b 36             	mov    (%r14),%rsi
 349:	45 31 e4             	xor    %r12d,%r12d
 34c:	0f 1f 40 00          	nopl   0x0(%rax)
 350:	c4 a2 7d 18 14 a3    	vbroadcastss (%rbx,%r12,4),%ymm2
 356:	c4 e2 6d b8 44 3e e0 	vfmadd231ps -0x20(%rsi,%rdi,1),%ymm2,%ymm0
 35d:	c4 e2 6d b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm2,%ymm1
 363:	c4 a2 7d 18 5c a3 04 	vbroadcastss 0x4(%rbx,%r12,4),%ymm3
 36a:	49 83 c4 02          	add    $0x2,%r12
 36e:	c4 e2 65 b8 04 2e    	vfmadd231ps (%rsi,%rbp,1),%ymm3,%ymm0
 374:	c4 e2 65 b8 4c 2e 20 	vfmadd231ps 0x20(%rsi,%rbp,1),%ymm3,%ymm1
 37b:	48 01 d6             	add    %rdx,%rsi
 37e:	49 39 cc             	cmp    %rcx,%r12
 381:	7c cd                	jl     350 <.omp_outlined.+0x140>
 383:	e9 78 ff ff ff       	jmpq   300 <.omp_outlined.+0xf0>

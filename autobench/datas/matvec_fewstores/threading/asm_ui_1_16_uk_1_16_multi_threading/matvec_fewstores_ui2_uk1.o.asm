...
0000000000000210 <.omp_outlined.>:
 ...
 234:	0f 8e 84 00 00 00    	jle    2be <.omp_outlined.+0xae>
 23a:	44 8b 27             	mov    (%rdi),%r12d
 23d:	c1 fd 04             	sar    $0x4,%ebp
 240:	4d 89 ce             	mov    %r9,%r14
 243:	4d 89 c7             	mov    %r8,%r15
 246:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
 24d:	00 
 24e:	c7 44 24 14 01 00 00 	movl   $0x1,0x14(%rsp)
 255:	00 
 256:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%rsp)
 25d:	00 
 25e:	8d 5d ff             	lea    -0x1(%rbp),%ebx
 261:	89 5c 24 08          	mov    %ebx,0x8(%rsp)
 265:	48 83 ec 08          	sub    $0x8,%rsp
 269:	48 8d 44 24 1c       	lea    0x1c(%rsp),%rax
 26e:	48 8d 4c 24 18       	lea    0x18(%rsp),%rcx
 273:	4c 8d 44 24 14       	lea    0x14(%rsp),%r8
 278:	4c 8d 4c 24 10       	lea    0x10(%rsp),%r9
 27d:	bf 00 00 00 00       	mov    $0x0,%edi
 282:	44 89 e6             	mov    %r12d,%esi
 ...
 2a6:	89 5c 24 08          	mov    %ebx,0x8(%rsp)
 2aa:	39 d8                	cmp    %ebx,%eax
 2ac:	7e 1f                	jle    2cd <.omp_outlined.+0xbd>
 2ae:	bf 00 00 00 00       	mov    $0x0,%edi
 2b3:	44 89 e6             	mov    %r12d,%esi
 2b6:	c5 f8 77             	vzeroupper 
 2b9:	e8 00 00 00 00       	callq  2be <.omp_outlined.+0xae>
 2be:	48 83 c4 18          	add    $0x18,%rsp
 2c2:	5b                   	pop    %rbx
 2c3:	41 5c                	pop    %r12
 2c5:	41 5d                	pop    %r13
 2c7:	41 5e                	pop    %r14
 ...
 2cb:	5d                   	pop    %rbp
 2cc:	c3                   	retq   
 2cd:	8b 0d 00 00 00 00    	mov    0x0(%rip),%ecx        # 2d3 <.omp_outlined.+0xc3>
 2d3:	48 63 15 00 00 00 00 	movslq 0x0(%rip),%rdx        # 2da <.omp_outlined.+0xca>
 2da:	89 c6                	mov    %eax,%esi
 2dc:	4c 63 c3             	movslq %ebx,%r8
 2df:	c1 e6 04             	shl    $0x4,%esi
 2e2:	48 63 fe             	movslq %esi,%rdi
 2e5:	48 83 cf 08          	or     $0x8,%rdi
 2e9:	48 c1 e2 02          	shl    $0x2,%rdx
 2ed:	eb 1e                	jmp    30d <.omp_outlined.+0xfd>
 2ef:	90                   	nop
 2f0:	c4 81 7c 11 0c 8b    	vmovups %ymm1,(%r11,%r9,4)
 2f6:	48 83 c7 10          	add    $0x10,%rdi
 2fa:	49 8b 75 00          	mov    0x0(%r13),%rsi
 2fe:	c4 a1 7c 11 04 96    	vmovups %ymm0,(%rsi,%r10,4)
 304:	4c 39 c0             	cmp    %r8,%rax
 307:	48 8d 40 01          	lea    0x1(%rax),%rax
 30b:	7d a1                	jge    2ae <.omp_outlined.+0x9e>
 30d:	4d 8b 5d 00          	mov    0x0(%r13),%r11
 311:	89 c6                	mov    %eax,%esi
 313:	c1 e6 04             	shl    $0x4,%esi
 316:	8d 6e 08             	lea    0x8(%rsi),%ebp
 319:	4c 63 ce             	movslq %esi,%r9
 31c:	4c 63 d5             	movslq %ebp,%r10
 31f:	c4 81 7c 10 0c 8b    	vmovups (%r11,%r9,4),%ymm1
 325:	c4 81 7c 10 04 93    	vmovups (%r11,%r10,4),%ymm0
 32b:	85 c9                	test   %ecx,%ecx
 32d:	7e c1                	jle    2f0 <.omp_outlined.+0xe0>
 32f:	49 8b 37             	mov    (%r15),%rsi
 332:	48 8d 1c bd 00 00 00 	lea    0x0(,%rdi,4),%rbx
 339:	00 
 33a:	49 03 1e             	add    (%r14),%rbx
 33d:	31 ed                	xor    %ebp,%ebp
 33f:	90                   	nop
 340:	c4 e2 7d 18 14 ae    	vbroadcastss (%rsi,%rbp,4),%ymm2
 346:	c4 e2 6d b8 4b e0    	vfmadd231ps -0x20(%rbx),%ymm2,%ymm1
 34c:	c4 e2 6d b8 03       	vfmadd231ps (%rbx),%ymm2,%ymm0
 351:	48 ff c5             	inc    %rbp
 354:	48 01 d3             	add    %rdx,%rbx
 357:	48 39 e9             	cmp    %rbp,%rcx
 35a:	75 e4                	jne    340 <.omp_outlined.+0x130>
 35c:	eb 92                	jmp    2f0 <.omp_outlined.+0xe0>

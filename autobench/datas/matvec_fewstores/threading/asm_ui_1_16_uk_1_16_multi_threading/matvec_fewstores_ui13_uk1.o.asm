...
0000000000000220 <.omp_outlined.>:
 ...
 262:	00 
 263:	48 98                	cltq   
 265:	48 69 c0 4f ec c4 4e 	imul   $0x4ec4ec4f,%rax,%rax
 ...
 2f8:	4d 6b ca 68          	imul   $0x68,%r10,%r9
 2fc:	4c 63 c3             	movslq %ebx,%r8
 2ff:	49 83 c1 60          	add    $0x60,%r9
 303:	48 c1 e2 02          	shl    $0x2,%rdx
 307:	e9 ad 00 00 00       	jmpq   3b9 <.omp_outlined.+0x199>
 30c:	0f 1f 40 00          	nopl   0x0(%rax)
 310:	c5 7c 11 24 ae       	vmovups %ymm12,(%rsi,%rbp,4)
 315:	49 83 c1 68          	add    $0x68,%r9
 319:	49 8b 45 00          	mov    0x0(%r13),%rax
 31d:	c5 7c 11 5c a8 20    	vmovups %ymm11,0x20(%rax,%rbp,4)
 323:	49 8b 45 00          	mov    0x0(%r13),%rax
 327:	c5 7c 11 54 a8 40    	vmovups %ymm10,0x40(%rax,%rbp,4)
 32d:	49 8b 45 00          	mov    0x0(%r13),%rax
 331:	c5 7c 11 4c a8 60    	vmovups %ymm9,0x60(%rax,%rbp,4)
 337:	49 8b 45 00          	mov    0x0(%r13),%rax
 33b:	c5 7c 11 84 a8 80 00 	vmovups %ymm8,0x80(%rax,%rbp,4)
 342:	00 00 
 344:	49 8b 45 00          	mov    0x0(%r13),%rax
 348:	c5 fc 11 bc a8 a0 00 	vmovups %ymm7,0xa0(%rax,%rbp,4)
 34f:	00 00 
 351:	49 8b 45 00          	mov    0x0(%r13),%rax
 355:	c5 fc 11 b4 a8 c0 00 	vmovups %ymm6,0xc0(%rax,%rbp,4)
 35c:	00 00 
 35e:	49 8b 45 00          	mov    0x0(%r13),%rax
 362:	c5 fc 11 ac a8 e0 00 	vmovups %ymm5,0xe0(%rax,%rbp,4)
 369:	00 00 
 36b:	49 8b 45 00          	mov    0x0(%r13),%rax
 36f:	c5 fc 11 a4 a8 00 01 	vmovups %ymm4,0x100(%rax,%rbp,4)
 376:	00 00 
 378:	49 8b 45 00          	mov    0x0(%r13),%rax
 37c:	c5 fc 11 9c a8 20 01 	vmovups %ymm3,0x120(%rax,%rbp,4)
 383:	00 00 
 385:	49 8b 45 00          	mov    0x0(%r13),%rax
 389:	c5 fc 11 94 a8 40 01 	vmovups %ymm2,0x140(%rax,%rbp,4)
 390:	00 00 
 392:	49 8b 45 00          	mov    0x0(%r13),%rax
 396:	c5 fc 11 8c a8 60 01 	vmovups %ymm1,0x160(%rax,%rbp,4)
 39d:	00 00 
 39f:	49 8b 45 00          	mov    0x0(%r13),%rax
 3a3:	c5 fc 11 84 a8 80 01 	vmovups %ymm0,0x180(%rax,%rbp,4)
 3aa:	00 00 
 3ac:	4d 39 c2             	cmp    %r8,%r10
 3af:	4d 8d 52 01          	lea    0x1(%r10),%r10
 3b3:	0f 8d 13 ff ff ff    	jge    2cc <.omp_outlined.+0xac>
 3b9:	49 8b 75 00          	mov    0x0(%r13),%rsi
 3bd:	49 6b ea 68          	imul   $0x68,%r10,%rbp
 3c1:	c5 7c 10 24 ae       	vmovups (%rsi,%rbp,4),%ymm12
 3c6:	c5 7c 10 5c ae 20    	vmovups 0x20(%rsi,%rbp,4),%ymm11
 3cc:	c5 7c 10 54 ae 40    	vmovups 0x40(%rsi,%rbp,4),%ymm10
 3d2:	c5 7c 10 4c ae 60    	vmovups 0x60(%rsi,%rbp,4),%ymm9
 3d8:	c5 7c 10 84 ae 80 00 	vmovups 0x80(%rsi,%rbp,4),%ymm8
 3df:	00 00 
 3e1:	c5 fc 10 bc ae a0 00 	vmovups 0xa0(%rsi,%rbp,4),%ymm7
 3e8:	00 00 
 3ea:	c5 fc 10 b4 ae c0 00 	vmovups 0xc0(%rsi,%rbp,4),%ymm6
 3f1:	00 00 
 3f3:	c5 fc 10 ac ae e0 00 	vmovups 0xe0(%rsi,%rbp,4),%ymm5
 3fa:	00 00 
 3fc:	c5 fc 10 a4 ae 00 01 	vmovups 0x100(%rsi,%rbp,4),%ymm4
 403:	00 00 
 405:	c5 fc 10 9c ae 20 01 	vmovups 0x120(%rsi,%rbp,4),%ymm3
 40c:	00 00 
 40e:	c5 fc 10 94 ae 40 01 	vmovups 0x140(%rsi,%rbp,4),%ymm2
 415:	00 00 
 417:	c5 fc 10 8c ae 60 01 	vmovups 0x160(%rsi,%rbp,4),%ymm1
 41e:	00 00 
 420:	c5 fc 10 84 ae 80 01 	vmovups 0x180(%rsi,%rbp,4),%ymm0
 427:	00 00 
 429:	85 c9                	test   %ecx,%ecx
 42b:	0f 8e df fe ff ff    	jle    310 <.omp_outlined.+0xf0>
 431:	49 8b 3f             	mov    (%r15),%rdi
 434:	4a 8d 04 8d 00 00 00 	lea    0x0(,%r9,4),%rax
 43b:	00 
 43c:	49 03 06             	add    (%r14),%rax
 ...
 44f:	00 
 450:	c4 62 7d 18 2c 9f    	vbroadcastss (%rdi,%rbx,4),%ymm13
 456:	c4 62 15 b8 a0 80 fe 	vfmadd231ps -0x180(%rax),%ymm13,%ymm12
 45d:	ff ff 
 45f:	c4 62 15 b8 98 a0 fe 	vfmadd231ps -0x160(%rax),%ymm13,%ymm11
 466:	ff ff 
 468:	c4 62 15 b8 90 c0 fe 	vfmadd231ps -0x140(%rax),%ymm13,%ymm10
 46f:	ff ff 
 471:	c4 62 15 b8 88 e0 fe 	vfmadd231ps -0x120(%rax),%ymm13,%ymm9
 478:	ff ff 
 47a:	c4 62 15 b8 80 00 ff 	vfmadd231ps -0x100(%rax),%ymm13,%ymm8
 481:	ff ff 
 483:	c4 e2 15 b8 b8 20 ff 	vfmadd231ps -0xe0(%rax),%ymm13,%ymm7
 48a:	ff ff 
 48c:	c4 e2 15 b8 b0 40 ff 	vfmadd231ps -0xc0(%rax),%ymm13,%ymm6
 493:	ff ff 
 495:	c4 e2 15 b8 a8 60 ff 	vfmadd231ps -0xa0(%rax),%ymm13,%ymm5
 49c:	ff ff 
 49e:	c4 e2 15 b8 60 80    	vfmadd231ps -0x80(%rax),%ymm13,%ymm4
 4a4:	c4 e2 15 b8 58 a0    	vfmadd231ps -0x60(%rax),%ymm13,%ymm3
 4aa:	c4 e2 15 b8 50 c0    	vfmadd231ps -0x40(%rax),%ymm13,%ymm2
 4b0:	c4 e2 15 b8 48 e0    	vfmadd231ps -0x20(%rax),%ymm13,%ymm1
 4b6:	c4 e2 15 b8 00       	vfmadd231ps (%rax),%ymm13,%ymm0
 4bb:	48 ff c3             	inc    %rbx
 4be:	48 01 d0             	add    %rdx,%rax
 4c1:	48 39 d9             	cmp    %rbx,%rcx
 4c4:	75 8a                	jne    450 <.omp_outlined.+0x230>
 4c6:	e9 45 fe ff ff       	jmpq   310 <.omp_outlined.+0xf0>
...
00000000000004d0 <_Z6enablev>:
 ...
 4d7:	b8 68 00 00 00       	mov    $0x68,%eax
 4dc:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx

...
0000000000000220 <.omp_outlined.>:
 ...
 300:	4d 6b ca 38          	imul   $0x38,%r10,%r9
 304:	4c 63 c3             	movslq %ebx,%r8
 307:	49 83 c1 30          	add    $0x30,%r9
 30b:	48 c1 e2 02          	shl    $0x2,%rdx
 30f:	eb 6a                	jmp    37b <.omp_outlined.+0x15b>
 311:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 318:	0f 1f 84 00 00 00 00 
 31f:	00 
 320:	c5 fc 11 34 ae       	vmovups %ymm6,(%rsi,%rbp,4)
 325:	49 83 c1 38          	add    $0x38,%r9
 329:	49 8b 45 00          	mov    0x0(%r13),%rax
 32d:	c5 fc 11 6c a8 20    	vmovups %ymm5,0x20(%rax,%rbp,4)
 333:	49 8b 45 00          	mov    0x0(%r13),%rax
 337:	c5 fc 11 64 a8 40    	vmovups %ymm4,0x40(%rax,%rbp,4)
 33d:	49 8b 45 00          	mov    0x0(%r13),%rax
 341:	c5 fc 11 5c a8 60    	vmovups %ymm3,0x60(%rax,%rbp,4)
 347:	49 8b 45 00          	mov    0x0(%r13),%rax
 34b:	c5 fc 11 94 a8 80 00 	vmovups %ymm2,0x80(%rax,%rbp,4)
 352:	00 00 
 354:	49 8b 45 00          	mov    0x0(%r13),%rax
 358:	c5 fc 11 8c a8 a0 00 	vmovups %ymm1,0xa0(%rax,%rbp,4)
 35f:	00 00 
 361:	49 8b 45 00          	mov    0x0(%r13),%rax
 365:	c5 fc 11 84 a8 c0 00 	vmovups %ymm0,0xc0(%rax,%rbp,4)
 36c:	00 00 
 36e:	4d 39 c2             	cmp    %r8,%r10
 371:	4d 8d 52 01          	lea    0x1(%r10),%r10
 375:	0f 8d 59 ff ff ff    	jge    2d4 <.omp_outlined.+0xb4>
 37b:	49 8b 75 00          	mov    0x0(%r13),%rsi
 37f:	49 6b ea 38          	imul   $0x38,%r10,%rbp
 383:	c5 fc 10 34 ae       	vmovups (%rsi,%rbp,4),%ymm6
 388:	c5 fc 10 6c ae 20    	vmovups 0x20(%rsi,%rbp,4),%ymm5
 38e:	c5 fc 10 64 ae 40    	vmovups 0x40(%rsi,%rbp,4),%ymm4
 394:	c5 fc 10 5c ae 60    	vmovups 0x60(%rsi,%rbp,4),%ymm3
 39a:	c5 fc 10 94 ae 80 00 	vmovups 0x80(%rsi,%rbp,4),%ymm2
 3a1:	00 00 
 3a3:	c5 fc 10 8c ae a0 00 	vmovups 0xa0(%rsi,%rbp,4),%ymm1
 3aa:	00 00 
 3ac:	c5 fc 10 84 ae c0 00 	vmovups 0xc0(%rsi,%rbp,4),%ymm0
 3b3:	00 00 
 3b5:	85 c9                	test   %ecx,%ecx
 3b7:	0f 8e 63 ff ff ff    	jle    320 <.omp_outlined.+0x100>
 3bd:	49 8b 1f             	mov    (%r15),%rbx
 3c0:	4a 8d 3c 8d 00 00 00 	lea    0x0(,%r9,4),%rdi
 3c7:	00 
 3c8:	49 03 3e             	add    (%r14),%rdi
 3cb:	31 c0                	xor    %eax,%eax
 3cd:	0f 1f 00             	nopl   (%rax)
 3d0:	c4 e2 7d 18 3c 83    	vbroadcastss (%rbx,%rax,4),%ymm7
 3d6:	c4 e2 45 b8 b7 40 ff 	vfmadd231ps -0xc0(%rdi),%ymm7,%ymm6
 3dd:	ff ff 
 3df:	c4 e2 45 b8 af 60 ff 	vfmadd231ps -0xa0(%rdi),%ymm7,%ymm5
 3e6:	ff ff 
 3e8:	c4 e2 45 b8 67 80    	vfmadd231ps -0x80(%rdi),%ymm7,%ymm4
 3ee:	c4 e2 45 b8 5f a0    	vfmadd231ps -0x60(%rdi),%ymm7,%ymm3
 3f4:	c4 e2 45 b8 57 c0    	vfmadd231ps -0x40(%rdi),%ymm7,%ymm2
 3fa:	c4 e2 45 b8 4f e0    	vfmadd231ps -0x20(%rdi),%ymm7,%ymm1
 400:	c4 e2 45 b8 07       	vfmadd231ps (%rdi),%ymm7,%ymm0
 405:	48 ff c0             	inc    %rax
 408:	48 01 d7             	add    %rdx,%rdi
 40b:	48 39 c1             	cmp    %rax,%rcx
 40e:	75 c0                	jne    3d0 <.omp_outlined.+0x1b0>
 410:	e9 0b ff ff ff       	jmpq   320 <.omp_outlined.+0x100>
...
0000000000000420 <_Z6enablev>:
 ...
 427:	b8 38 00 00 00       	mov    $0x38,%eax
 42c:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx

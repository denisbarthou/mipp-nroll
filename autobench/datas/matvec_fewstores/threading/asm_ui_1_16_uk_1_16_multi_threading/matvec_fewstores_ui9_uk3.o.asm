...
0000000000000230 <.omp_outlined.>:
 ...
 307:	48 8b 7c 24 20       	mov    0x20(%rsp),%rdi
 30c:	4c 89 d2             	mov    %r10,%rdx
 30f:	48 63 0d 00 00 00 00 	movslq 0x0(%rip),%rcx        # 316 <.omp_outlined.+0xe6>
 316:	4c 63 c3             	movslq %ebx,%r8
 319:	45 31 c9             	xor    %r9d,%r9d
 31c:	48 c1 e2 05          	shl    $0x5,%rdx
 320:	48 8d 34 d2          	lea    (%rdx,%rdx,8),%rsi
 324:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
 32b:	00 
 32c:	4c 8d 3c 52          	lea    (%rdx,%rdx,2),%r15
 330:	4b 8d 14 d2          	lea    (%r10,%r10,8),%rdx
 334:	48 8d 2c d0          	lea    (%rax,%rdx,8),%rbp
 338:	48 8d 14 c6          	lea    (%rsi,%rax,8),%rdx
 33c:	eb 78                	jmp    3b6 <.omp_outlined.+0x186>
 33e:	66 90                	xchg   %ax,%ax
 340:	c4 41 7c 11 04 9b    	vmovups %ymm8,(%r11,%rbx,4)
 346:	49 83 c1 48          	add    $0x48,%r9
 34a:	49 8b 45 00          	mov    0x0(%r13),%rax
 34e:	c5 fc 11 7c 98 20    	vmovups %ymm7,0x20(%rax,%rbx,4)
 354:	49 8b 45 00          	mov    0x0(%r13),%rax
 358:	c5 fc 11 74 98 40    	vmovups %ymm6,0x40(%rax,%rbx,4)
 35e:	49 8b 45 00          	mov    0x0(%r13),%rax
 362:	c5 fc 11 6c 98 60    	vmovups %ymm5,0x60(%rax,%rbx,4)
 368:	49 8b 45 00          	mov    0x0(%r13),%rax
 36c:	c5 fc 11 a4 98 80 00 	vmovups %ymm4,0x80(%rax,%rbx,4)
 373:	00 00 
 375:	49 8b 45 00          	mov    0x0(%r13),%rax
 379:	c5 fc 11 9c 98 a0 00 	vmovups %ymm3,0xa0(%rax,%rbx,4)
 380:	00 00 
 382:	49 8b 45 00          	mov    0x0(%r13),%rax
 386:	c5 fc 11 94 98 c0 00 	vmovups %ymm2,0xc0(%rax,%rbx,4)
 38d:	00 00 
 38f:	49 8b 45 00          	mov    0x0(%r13),%rax
 393:	c5 fc 11 8c 98 e0 00 	vmovups %ymm1,0xe0(%rax,%rbx,4)
 39a:	00 00 
 39c:	49 8b 45 00          	mov    0x0(%r13),%rax
 3a0:	c5 fc 11 84 98 00 01 	vmovups %ymm0,0x100(%rax,%rbx,4)
 3a7:	00 00 
 ...
 3c1:	00 
 3c2:	48 8d 1c c0          	lea    (%rax,%rax,8),%rbx
 3c6:	c4 41 7c 10 04 9b    	vmovups (%r11,%rbx,4),%ymm8
 3cc:	c4 c1 7c 10 7c 9b 20 	vmovups 0x20(%r11,%rbx,4),%ymm7
 3d3:	c4 c1 7c 10 74 9b 40 	vmovups 0x40(%r11,%rbx,4),%ymm6
 3da:	c4 c1 7c 10 6c 9b 60 	vmovups 0x60(%r11,%rbx,4),%ymm5
 3e1:	c4 c1 7c 10 a4 9b 80 	vmovups 0x80(%r11,%rbx,4),%ymm4
 3e8:	00 00 00 
 3eb:	c4 c1 7c 10 9c 9b a0 	vmovups 0xa0(%r11,%rbx,4),%ymm3
 3f2:	00 00 00 
 3f5:	c4 c1 7c 10 94 9b c0 	vmovups 0xc0(%r11,%rbx,4),%ymm2
 3fc:	00 00 00 
 3ff:	c4 c1 7c 10 8c 9b e0 	vmovups 0xe0(%r11,%rbx,4),%ymm1
 406:	00 00 00 
 409:	c4 c1 7c 10 84 9b 00 	vmovups 0x100(%r11,%rbx,4),%ymm0
 410:	01 00 00 
 413:	85 c9                	test   %ecx,%ecx
 415:	0f 8e 25 ff ff ff    	jle    340 <.omp_outlined.+0x110>
 41b:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
 420:	4e 8d 24 8d 00 00 00 	lea    0x0(,%r9,4),%r12
 427:	00 
 428:	4c 03 27             	add    (%rdi),%r12
 42b:	45 31 f6             	xor    %r14d,%r14d
 42e:	48 8b 00             	mov    (%rax),%rax
 ...
 446:	c4 42 25 b8 04 34    	vfmadd231ps (%r12,%rsi,1),%ymm11,%ymm8
 44c:	c4 c2 25 b8 7c 34 20 	vfmadd231ps 0x20(%r12,%rsi,1),%ymm11,%ymm7
 453:	c4 c2 25 b8 74 34 40 	vfmadd231ps 0x40(%r12,%rsi,1),%ymm11,%ymm6
 45a:	c4 c2 25 b8 6c 34 60 	vfmadd231ps 0x60(%r12,%rsi,1),%ymm11,%ymm5
 461:	c4 c2 25 b8 a4 34 80 	vfmadd231ps 0x80(%r12,%rsi,1),%ymm11,%ymm4
 468:	00 00 00 
 46b:	c4 c2 25 b8 9c 34 a0 	vfmadd231ps 0xa0(%r12,%rsi,1),%ymm11,%ymm3
 472:	00 00 00 
 475:	c4 c2 25 b8 94 34 c0 	vfmadd231ps 0xc0(%r12,%rsi,1),%ymm11,%ymm2
 47c:	00 00 00 
 47f:	c4 c2 25 b8 8c 34 e0 	vfmadd231ps 0xe0(%r12,%rsi,1),%ymm11,%ymm1
 486:	00 00 00 
 489:	c4 c2 25 b8 84 34 00 	vfmadd231ps 0x100(%r12,%rsi,1),%ymm11,%ymm0
 490:	01 00 00 
 493:	c4 22 7d 18 54 b0 04 	vbroadcastss 0x4(%rax,%r14,4),%ymm10
 49a:	c4 22 7d 18 4c b0 08 	vbroadcastss 0x8(%rax,%r14,4),%ymm9
 4a1:	49 83 c6 03          	add    $0x3,%r14
 4a5:	c4 42 2d b8 04 ac    	vfmadd231ps (%r12,%rbp,4),%ymm10,%ymm8
 4ab:	c4 c2 2d b8 7c ac 20 	vfmadd231ps 0x20(%r12,%rbp,4),%ymm10,%ymm7
 4b2:	c4 c2 2d b8 74 ac 40 	vfmadd231ps 0x40(%r12,%rbp,4),%ymm10,%ymm6
 4b9:	c4 c2 2d b8 6c ac 60 	vfmadd231ps 0x60(%r12,%rbp,4),%ymm10,%ymm5
 4c0:	c4 c2 2d b8 a4 ac 80 	vfmadd231ps 0x80(%r12,%rbp,4),%ymm10,%ymm4
 4c7:	00 00 00 
 4ca:	c4 c2 2d b8 9c ac a0 	vfmadd231ps 0xa0(%r12,%rbp,4),%ymm10,%ymm3
 4d1:	00 00 00 
 4d4:	c4 c2 2d b8 94 ac c0 	vfmadd231ps 0xc0(%r12,%rbp,4),%ymm10,%ymm2
 4db:	00 00 00 
 4de:	c4 c2 2d b8 8c ac e0 	vfmadd231ps 0xe0(%r12,%rbp,4),%ymm10,%ymm1
 4e5:	00 00 00 
 4e8:	c4 c2 2d b8 84 ac 00 	vfmadd231ps 0x100(%r12,%rbp,4),%ymm10,%ymm0
 4ef:	01 00 00 
 4f2:	c4 42 35 b8 04 14    	vfmadd231ps (%r12,%rdx,1),%ymm9,%ymm8
 4f8:	c4 c2 35 b8 7c 14 20 	vfmadd231ps 0x20(%r12,%rdx,1),%ymm9,%ymm7
 4ff:	c4 c2 35 b8 74 14 40 	vfmadd231ps 0x40(%r12,%rdx,1),%ymm9,%ymm6
 506:	c4 c2 35 b8 6c 14 60 	vfmadd231ps 0x60(%r12,%rdx,1),%ymm9,%ymm5
 50d:	c4 c2 35 b8 a4 14 80 	vfmadd231ps 0x80(%r12,%rdx,1),%ymm9,%ymm4
 514:	00 00 00 
 517:	c4 c2 35 b8 9c 14 a0 	vfmadd231ps 0xa0(%r12,%rdx,1),%ymm9,%ymm3
 51e:	00 00 00 
 521:	c4 c2 35 b8 94 14 c0 	vfmadd231ps 0xc0(%r12,%rdx,1),%ymm9,%ymm2
 528:	00 00 00 
 52b:	c4 c2 35 b8 8c 14 e0 	vfmadd231ps 0xe0(%r12,%rdx,1),%ymm9,%ymm1
 532:	00 00 00 
 535:	c4 c2 35 b8 84 14 00 	vfmadd231ps 0x100(%r12,%rdx,1),%ymm9,%ymm0
 53c:	01 00 00 
 53f:	4d 01 fc             	add    %r15,%r12
 542:	49 39 ce             	cmp    %rcx,%r14
 545:	0f 8c f5 fe ff ff    	jl     440 <.omp_outlined.+0x210>
 54b:	e9 f0 fd ff ff       	jmpq   340 <.omp_outlined.+0x110>

0000000000000550 <_Z6enablev>:
 550:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 557 <_Z6enablev+0x7>
 557:	b8 48 00 00 00       	mov    $0x48,%eax
 55c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 561:	0f 45 c8             	cmovne %eax,%ecx
 564:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 56a <_Z6enablev+0x1a>
 56a:	0f 9e c1             	setle  %cl
 56d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 574 <_Z6enablev+0x24>

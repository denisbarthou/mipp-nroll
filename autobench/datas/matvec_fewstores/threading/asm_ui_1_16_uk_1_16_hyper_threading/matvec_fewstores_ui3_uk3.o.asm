...
0000000000000230 <.omp_outlined.>:
 ...
 36d:	4d 8b 55 00          	mov    0x0(%r13),%r10
 371:	4a 8d 04 dd 00 00 00 	lea    0x0(,%r11,8),%rax
 378:	00 
 379:	4c 8d 3c 40          	lea    (%rax,%rax,2),%r15
 37d:	c4 81 7c 10 14 ba    	vmovups (%r10,%r15,4),%ymm2
 383:	c4 81 7c 10 4c ba 20 	vmovups 0x20(%r10,%r15,4),%ymm1
 38a:	c4 81 7c 10 44 ba 40 	vmovups 0x40(%r10,%r15,4),%ymm0
 391:	85 c9                	test   %ecx,%ecx
 393:	7e ab                	jle    340 <.omp_outlined.+0x110>
 395:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
 39a:	4e 8d 24 8d 00 00 00 	lea    0x0(,%r9,4),%r12
 3a1:	00 
 3a2:	4c 03 23             	add    (%rbx),%r12
 3a5:	45 31 f6             	xor    %r14d,%r14d
 3a8:	48 8b 00             	mov    (%rax),%rax
 3ab:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
 3b0:	c4 a2 7d 18 1c b0    	vbroadcastss (%rax,%r14,4),%ymm3
 3b6:	c4 c2 65 b8 14 34    	vfmadd231ps (%r12,%rsi,1),%ymm3,%ymm2
 3bc:	c4 c2 65 b8 4c 34 20 	vfmadd231ps 0x20(%r12,%rsi,1),%ymm3,%ymm1
 3c3:	c4 c2 65 b8 44 34 40 	vfmadd231ps 0x40(%r12,%rsi,1),%ymm3,%ymm0
 3ca:	c4 a2 7d 18 64 b0 04 	vbroadcastss 0x4(%rax,%r14,4),%ymm4
 3d1:	c4 a2 7d 18 6c b0 08 	vbroadcastss 0x8(%rax,%r14,4),%ymm5
 3d8:	49 83 c6 03          	add    $0x3,%r14
 3dc:	c4 c2 5d b8 14 ac    	vfmadd231ps (%r12,%rbp,4),%ymm4,%ymm2
 3e2:	c4 c2 5d b8 4c ac 20 	vfmadd231ps 0x20(%r12,%rbp,4),%ymm4,%ymm1
 3e9:	c4 c2 5d b8 44 ac 40 	vfmadd231ps 0x40(%r12,%rbp,4),%ymm4,%ymm0
 3f0:	c4 c2 55 b8 14 14    	vfmadd231ps (%r12,%rdx,1),%ymm5,%ymm2
 3f6:	c4 c2 55 b8 4c 14 20 	vfmadd231ps 0x20(%r12,%rdx,1),%ymm5,%ymm1
 3fd:	c4 c2 55 b8 44 14 40 	vfmadd231ps 0x40(%r12,%rdx,1),%ymm5,%ymm0
 404:	49 01 fc             	add    %rdi,%r12
 407:	49 39 ce             	cmp    %rcx,%r14
 40a:	7c a4                	jl     3b0 <.omp_outlined.+0x180>
 40c:	e9 2f ff ff ff       	jmpq   340 <.omp_outlined.+0x110>
...
0000000000000420 <_Z6enablev>:
 ...
 42c:	b9 fd ff ff ff       	mov    $0xfffffffd,%ecx

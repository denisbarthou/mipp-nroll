...
0000000000000230 <.omp_outlined.>:
 ...
 2fe:	5d                   	pop    %rbp
 2ff:	c3                   	retq   
 300:	4c 63 c3             	movslq %ebx,%r8
 303:	48 63 05 00 00 00 00 	movslq 0x0(%rip),%rax        # 30a <.omp_outlined.+0xda>
 30a:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
 30f:	4c 89 d2             	mov    %r10,%rdx
 312:	48 63 0d 00 00 00 00 	movslq 0x0(%rip),%rcx        # 319 <.omp_outlined.+0xe9>
 319:	45 31 c9             	xor    %r9d,%r9d
 31c:	48 c1 e2 05          	shl    $0x5,%rdx
 320:	48 8d 34 92          	lea    (%rdx,%rdx,4),%rsi
 324:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
 32b:	00 
 32c:	48 8d 3c 52          	lea    (%rdx,%rdx,2),%rdi
 330:	4b 8d 14 92          	lea    (%r10,%r10,4),%rdx
 ...
 3c4:	4e 8d 24 8d 00 00 00 	lea    0x0(,%r9,4),%r12
 3cb:	00 
 3cc:	4c 03 23             	add    (%rbx),%r12
 3cf:	45 31 f6             	xor    %r14d,%r14d
 3d2:	48 8b 00             	mov    (%rax),%rax
 3d5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
 3dc:	00 00 00 00 
 3e0:	c4 a2 7d 18 2c b0    	vbroadcastss (%rax,%r14,4),%ymm5
 3e6:	c4 c2 55 b8 24 34    	vfmadd231ps (%r12,%rsi,1),%ymm5,%ymm4
 3ec:	c4 c2 55 b8 5c 34 20 	vfmadd231ps 0x20(%r12,%rsi,1),%ymm5,%ymm3
 3f3:	c4 c2 55 b8 54 34 40 	vfmadd231ps 0x40(%r12,%rsi,1),%ymm5,%ymm2
 3fa:	c4 c2 55 b8 4c 34 60 	vfmadd231ps 0x60(%r12,%rsi,1),%ymm5,%ymm1
 401:	c4 c2 55 b8 84 34 80 	vfmadd231ps 0x80(%r12,%rsi,1),%ymm5,%ymm0
 408:	00 00 00 
 40b:	c4 a2 7d 18 74 b0 04 	vbroadcastss 0x4(%rax,%r14,4),%ymm6
 412:	c4 a2 7d 18 7c b0 08 	vbroadcastss 0x8(%rax,%r14,4),%ymm7
 419:	49 83 c6 03          	add    $0x3,%r14
 41d:	c4 c2 4d b8 24 ac    	vfmadd231ps (%r12,%rbp,4),%ymm6,%ymm4
 423:	c4 c2 4d b8 5c ac 20 	vfmadd231ps 0x20(%r12,%rbp,4),%ymm6,%ymm3
 42a:	c4 c2 4d b8 54 ac 40 	vfmadd231ps 0x40(%r12,%rbp,4),%ymm6,%ymm2
 431:	c4 c2 4d b8 4c ac 60 	vfmadd231ps 0x60(%r12,%rbp,4),%ymm6,%ymm1
 438:	c4 c2 4d b8 84 ac 80 	vfmadd231ps 0x80(%r12,%rbp,4),%ymm6,%ymm0
 43f:	00 00 00 
 442:	c4 c2 45 b8 24 14    	vfmadd231ps (%r12,%rdx,1),%ymm7,%ymm4
 448:	c4 c2 45 b8 5c 14 20 	vfmadd231ps 0x20(%r12,%rdx,1),%ymm7,%ymm3
 44f:	c4 c2 45 b8 54 14 40 	vfmadd231ps 0x40(%r12,%rdx,1),%ymm7,%ymm2
 456:	c4 c2 45 b8 4c 14 60 	vfmadd231ps 0x60(%r12,%rdx,1),%ymm7,%ymm1
 45d:	c4 c2 45 b8 84 14 80 	vfmadd231ps 0x80(%r12,%rdx,1),%ymm7,%ymm0
 464:	00 00 00 
 467:	49 01 fc             	add    %rdi,%r12
 46a:	49 39 ce             	cmp    %rcx,%r14
 46d:	0f 8c 6d ff ff ff    	jl     3e0 <.omp_outlined.+0x1b0>
 473:	e9 c8 fe ff ff       	jmpq   340 <.omp_outlined.+0x110>
...
0000000000000480 <_Z6enablev>:
 ...
 487:	b8 28 00 00 00       	mov    $0x28,%eax
 48c:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx
 491:	0f 45 c8             	cmovne %eax,%ecx
 494:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 49a <_Z6enablev+0x1a>
 49a:	0f 9e c1             	setle  %cl
 49d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 4a4 <_Z6enablev+0x24>

...
0000000000000220 <.omp_outlined.>:
 ...
 300:	41 b9 20 00 00 00    	mov    $0x20,%r9d
 306:	48 c1 e0 05          	shl    $0x5,%rax
 30a:	48 8d 3c 80          	lea    (%rax,%rax,4),%rdi
 30e:	48 8d 2c 97          	lea    (%rdi,%rdx,4),%rbp
 312:	48 c1 e2 03          	shl    $0x3,%rdx
 316:	eb 4a                	jmp    362 <.omp_outlined.+0x142>
 318:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
 31f:	00 
 320:	c4 c1 7c 11 24 9b    	vmovups %ymm4,(%r11,%rbx,4)
 326:	49 83 c1 28          	add    $0x28,%r9
 32a:	49 8b 45 00          	mov    0x0(%r13),%rax
 32e:	c5 fc 11 5c 98 20    	vmovups %ymm3,0x20(%rax,%rbx,4)
 334:	49 8b 45 00          	mov    0x0(%r13),%rax
 338:	c5 fc 11 54 98 40    	vmovups %ymm2,0x40(%rax,%rbx,4)
 ...
 353:	00 00 
 355:	4d 39 c2             	cmp    %r8,%r10
 358:	4d 8d 52 01          	lea    0x1(%r10),%r10
 35c:	0f 8d 6a ff ff ff    	jge    2cc <.omp_outlined.+0xac>
 362:	4d 8b 5d 00          	mov    0x0(%r13),%r11
 366:	4a 8d 04 d5 00 00 00 	lea    0x0(,%r10,8),%rax
 36d:	00 
 36e:	48 8d 1c 80          	lea    (%rax,%rax,4),%rbx
 372:	c4 c1 7c 10 24 9b    	vmovups (%r11,%rbx,4),%ymm4
 378:	c4 c1 7c 10 5c 9b 20 	vmovups 0x20(%r11,%rbx,4),%ymm3
 37f:	c4 c1 7c 10 54 9b 40 	vmovups 0x40(%r11,%rbx,4),%ymm2
 386:	c4 c1 7c 10 4c 9b 60 	vmovups 0x60(%r11,%rbx,4),%ymm1
 38d:	c4 c1 7c 10 84 9b 80 	vmovups 0x80(%r11,%rbx,4),%ymm0
 394:	00 00 00 
 397:	85 c9                	test   %ecx,%ecx
 399:	7e 85                	jle    320 <.omp_outlined.+0x100>
 39b:	49 8b 07             	mov    (%r15),%rax
 39e:	4a 8d 34 8d 00 00 00 	lea    0x0(,%r9,4),%rsi
 3a5:	00 
 3a6:	49 03 36             	add    (%r14),%rsi
 3a9:	45 31 e4             	xor    %r12d,%r12d
 3ac:	0f 1f 40 00          	nopl   0x0(%rax)
 3b0:	c4 a2 7d 18 2c a0    	vbroadcastss (%rax,%r12,4),%ymm5
 3b6:	c4 e2 55 b8 64 3e 80 	vfmadd231ps -0x80(%rsi,%rdi,1),%ymm5,%ymm4
 3bd:	c4 e2 55 b8 5c 3e a0 	vfmadd231ps -0x60(%rsi,%rdi,1),%ymm5,%ymm3
 3c4:	c4 e2 55 b8 54 3e c0 	vfmadd231ps -0x40(%rsi,%rdi,1),%ymm5,%ymm2
 3cb:	c4 e2 55 b8 4c 3e e0 	vfmadd231ps -0x20(%rsi,%rdi,1),%ymm5,%ymm1
 3d2:	c4 e2 55 b8 04 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm5,%ymm0
 3d8:	c4 a2 7d 18 74 a0 04 	vbroadcastss 0x4(%rax,%r12,4),%ymm6
 3df:	49 83 c4 02          	add    $0x2,%r12
 3e3:	c4 e2 4d b8 64 2e 80 	vfmadd231ps -0x80(%rsi,%rbp,1),%ymm6,%ymm4
 3ea:	c4 e2 4d b8 5c 2e a0 	vfmadd231ps -0x60(%rsi,%rbp,1),%ymm6,%ymm3
 3f1:	c4 e2 4d b8 54 2e c0 	vfmadd231ps -0x40(%rsi,%rbp,1),%ymm6,%ymm2
 3f8:	c4 e2 4d b8 4c 2e e0 	vfmadd231ps -0x20(%rsi,%rbp,1),%ymm6,%ymm1
 3ff:	c4 e2 4d b8 04 2e    	vfmadd231ps (%rsi,%rbp,1),%ymm6,%ymm0
 405:	48 01 d6             	add    %rdx,%rsi
 408:	49 39 cc             	cmp    %rcx,%r12
 40b:	7c a3                	jl     3b0 <.omp_outlined.+0x190>
 40d:	e9 0e ff ff ff       	jmpq   320 <.omp_outlined.+0x100>
...
0000000000000420 <_Z6enablev>:
 ...
 427:	b8 28 00 00 00       	mov    $0x28,%eax
 42c:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx

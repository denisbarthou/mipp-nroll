...
0000000000000220 <.omp_outlined.>:
 ...
 306:	48 6b da 2c          	imul   $0x2c,%rdx,%rbx
 30a:	48 6b ea 34          	imul   $0x34,%rdx,%rbp
 30e:	48 c1 e2 02          	shl    $0x2,%rdx
 ...
 380:	c4 22 7d 18 34 b3    	vbroadcastss (%rbx,%r14,4),%ymm14
 386:	c4 c2 0d b8 44 24 e0 	vfmadd231ps -0x20(%r12),%ymm14,%ymm0
 38d:	c4 22 7d 18 6c b3 04 	vbroadcastss 0x4(%rbx,%r14,4),%ymm13
 394:	49 8d 44 14 e0       	lea    -0x20(%r12,%rdx,1),%rax
 399:	c4 22 7d 18 64 b3 08 	vbroadcastss 0x8(%rbx,%r14,4),%ymm12
 3a0:	c4 22 7d 18 5c b3 0c 	vbroadcastss 0xc(%rbx,%r14,4),%ymm11
 3a7:	c4 22 7d 18 54 b3 10 	vbroadcastss 0x10(%rbx,%r14,4),%ymm10
 3ae:	c4 22 7d 18 4c b3 14 	vbroadcastss 0x14(%rbx,%r14,4),%ymm9
 3b5:	c4 22 7d 18 44 b3 18 	vbroadcastss 0x18(%rbx,%r14,4),%ymm8
 3bc:	c4 a2 7d 18 7c b3 1c 	vbroadcastss 0x1c(%rbx,%r14,4),%ymm7
 3c3:	c4 a2 7d 18 74 b3 20 	vbroadcastss 0x20(%rbx,%r14,4),%ymm6
 3ca:	c4 a2 7d 18 6c b3 24 	vbroadcastss 0x24(%rbx,%r14,4),%ymm5
 3d1:	c4 a2 7d 18 64 b3 28 	vbroadcastss 0x28(%rbx,%r14,4),%ymm4
 3d8:	c4 a2 7d 18 5c b3 2c 	vbroadcastss 0x2c(%rbx,%r14,4),%ymm3
 3df:	c4 c2 0d b8 0c 24    	vfmadd231ps (%r12),%ymm14,%ymm1
 3e5:	c4 a2 7d 18 54 b3 30 	vbroadcastss 0x30(%rbx,%r14,4),%ymm2
 3ec:	49 83 c6 0d          	add    $0xd,%r14
 3f0:	c4 c2 15 b8 44 14 e0 	vfmadd231ps -0x20(%r12,%rdx,1),%ymm13,%ymm0
 3f7:	49 01 ec             	add    %rbp,%r12
 3fa:	c4 e2 1d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm12,%ymm0
 400:	48 01 d0             	add    %rdx,%rax
 403:	c4 e2 25 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm11,%ymm0
 409:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 40d:	c4 e2 2d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm10,%ymm0
 413:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 417:	c4 e2 35 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm9,%ymm0
 41d:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 421:	c4 e2 3d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm8,%ymm0
 427:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 42b:	c4 e2 45 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm7,%ymm0
 431:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 435:	c4 e2 4d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm6,%ymm0
 43b:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 43f:	c4 e2 55 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm5,%ymm0
 445:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 449:	c4 e2 5d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm4,%ymm0
 44f:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 453:	c4 e2 65 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm3,%ymm0
 459:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 45d:	c4 e2 6d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm2,%ymm0
 463:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 467:	c4 e2 15 b8 0c 06    	vfmadd231ps (%rsi,%rax,1),%ymm13,%ymm1
 46d:	48 8d 04 30          	lea    (%rax,%rsi,1),%rax
 471:	c4 e2 1d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm12,%ymm1
 477:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 47b:	c4 e2 25 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm11,%ymm1
 481:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 485:	c4 e2 2d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm10,%ymm1
 48b:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 48f:	c4 e2 35 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm9,%ymm1
 495:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 499:	c4 e2 3d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm8,%ymm1
 49f:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 4a3:	c4 e2 45 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm7,%ymm1
 4a9:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 4ad:	c4 e2 4d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm6,%ymm1
 4b3:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 4b7:	c4 e2 55 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm5,%ymm1
 4bd:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 4c1:	c4 e2 5d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm4,%ymm1
 4c7:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 4cb:	c4 e2 65 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm3,%ymm1
 4d1:	48 01 d0             	add    %rdx,%rax
 4d4:	c4 e2 6d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm2,%ymm1
 4da:	49 39 ce             	cmp    %rcx,%r14
 4dd:	0f 8c 9d fe ff ff    	jl     380 <.omp_outlined.+0x160>
 4e3:	e9 38 fe ff ff       	jmpq   320 <.omp_outlined.+0x100>
...
00000000000004f0 <_Z6enablev>:
 ...
 50d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 514 <_Z6enablev+0x24>
...
0000000000000520 <_Z9n_reg_maxv>:
 520:	b8 29 00 00 00       	mov    $0x29,%eax
 525:	c3                   	retq   

...
0000000000000220 <.omp_outlined.>:
 ...
 2e8:	5d                   	pop    %rbp
 2e9:	c3                   	retq   
 2ea:	8b 0d 00 00 00 00    	mov    0x0(%rip),%ecx        # 2f0 <.omp_outlined.+0xd0>
 2f0:	48 63 15 00 00 00 00 	movslq 0x0(%rip),%rdx        # 2f7 <.omp_outlined.+0xd7>
 2f7:	48 8d 34 40          	lea    (%rax,%rax,2),%rsi
 2fb:	4c 63 c5             	movslq %ebp,%r8
 2fe:	4c 8d 0c f5 10 00 00 	lea    0x10(,%rsi,8),%r9
 305:	00 
 306:	48 c1 e2 02          	shl    $0x2,%rdx
 30a:	eb 2b                	jmp    337 <.omp_outlined.+0x117>
 30c:	0f 1f 40 00          	nopl   0x0(%rax)
 310:	c4 c1 7c 11 14 aa    	vmovups %ymm2,(%r10,%rbp,4)
 316:	49 83 c1 18          	add    $0x18,%r9
 31a:	49 8b 75 00          	mov    0x0(%r13),%rsi
 31e:	c5 fc 11 4c ae 20    	vmovups %ymm1,0x20(%rsi,%rbp,4)
 324:	49 8b 75 00          	mov    0x0(%r13),%rsi
 328:	c5 fc 11 44 ae 40    	vmovups %ymm0,0x40(%rsi,%rbp,4)
 32e:	4c 39 c0             	cmp    %r8,%rax
 331:	48 8d 40 01          	lea    0x1(%rax),%rax
 335:	7d 94                	jge    2cb <.omp_outlined.+0xab>
 337:	4d 8b 55 00          	mov    0x0(%r13),%r10
 33b:	48 8d 34 c5 00 00 00 	lea    0x0(,%rax,8),%rsi
 342:	00 
 343:	48 8d 2c 76          	lea    (%rsi,%rsi,2),%rbp
 347:	c4 c1 7c 10 14 aa    	vmovups (%r10,%rbp,4),%ymm2
 34d:	c4 c1 7c 10 4c aa 20 	vmovups 0x20(%r10,%rbp,4),%ymm1
 354:	c4 c1 7c 10 44 aa 40 	vmovups 0x40(%r10,%rbp,4),%ymm0
 35b:	85 c9                	test   %ecx,%ecx
 35d:	7e b1                	jle    310 <.omp_outlined.+0xf0>
 35f:	49 8b 1f             	mov    (%r15),%rbx
 362:	4a 8d 3c 8d 00 00 00 	lea    0x0(,%r9,4),%rdi
 369:	00 
 36a:	49 03 3e             	add    (%r14),%rdi
 36d:	31 f6                	xor    %esi,%esi
 36f:	90                   	nop
 370:	c4 e2 7d 18 1c b3    	vbroadcastss (%rbx,%rsi,4),%ymm3
 376:	c4 e2 65 b8 57 c0    	vfmadd231ps -0x40(%rdi),%ymm3,%ymm2
 37c:	c4 e2 65 b8 4f e0    	vfmadd231ps -0x20(%rdi),%ymm3,%ymm1
 382:	c4 e2 65 b8 07       	vfmadd231ps (%rdi),%ymm3,%ymm0
 387:	48 ff c6             	inc    %rsi
 38a:	48 01 d7             	add    %rdx,%rdi
 38d:	48 39 f1             	cmp    %rsi,%rcx
 390:	75 de                	jne    370 <.omp_outlined.+0x150>
 392:	e9 79 ff ff ff       	jmpq   310 <.omp_outlined.+0xf0>

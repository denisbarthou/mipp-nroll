...
0000000000000220 <.omp_outlined.>:
 ...
 304:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
 309:	4c 89 d0             	mov    %r10,%rax
 30c:	48 c1 e0 05          	shl    $0x5,%rax
 310:	48 8d 34 40          	lea    (%rax,%rax,2),%rsi
 314:	48 8d 04 52          	lea    (%rdx,%rdx,2),%rax
 318:	48 8d 3c 96          	lea    (%rsi,%rdx,4),%rdi
 31c:	48 8d 2c d6          	lea    (%rsi,%rdx,8),%rbp
 320:	48 c1 e2 04          	shl    $0x4,%rdx
 324:	48 8d 1c 86          	lea    (%rsi,%rax,4),%rbx
 328:	eb 35                	jmp    35f <.omp_outlined.+0x13f>
 32a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
 330:	c4 81 7c 11 14 83    	vmovups %ymm2,(%r11,%r8,4)
 336:	49 83 c1 18          	add    $0x18,%r9
 33a:	49 8b 45 00          	mov    0x0(%r13),%rax
 33e:	c4 a1 7c 11 4c 80 20 	vmovups %ymm1,0x20(%rax,%r8,4)
 345:	49 8b 45 00          	mov    0x0(%r13),%rax
 349:	c4 a1 7c 11 44 80 40 	vmovups %ymm0,0x40(%rax,%r8,4)
 350:	4c 3b 54 24 30       	cmp    0x30(%rsp),%r10
 355:	4d 8d 52 01          	lea    0x1(%r10),%r10
 359:	0f 8d 71 ff ff ff    	jge    2d0 <.omp_outlined.+0xb0>
 35f:	4d 8b 5d 00          	mov    0x0(%r13),%r11
 363:	4a 8d 04 d5 00 00 00 	lea    0x0(,%r10,8),%rax
 36a:	00 
 36b:	4c 8d 04 40          	lea    (%rax,%rax,2),%r8
 36f:	c4 81 7c 10 14 83    	vmovups (%r11,%r8,4),%ymm2
 375:	c4 81 7c 10 4c 83 20 	vmovups 0x20(%r11,%r8,4),%ymm1
 37c:	c4 81 7c 10 44 83 40 	vmovups 0x40(%r11,%r8,4),%ymm0
 383:	85 c9                	test   %ecx,%ecx
 385:	7e a9                	jle    330 <.omp_outlined.+0x110>
 387:	48 8b 44 24 20       	mov    0x20(%rsp),%rax
 38c:	4e 8d 34 8d 00 00 00 	lea    0x0(,%r9,4),%r14
 393:	00 
 394:	45 31 ff             	xor    %r15d,%r15d
 397:	4c 8b 20             	mov    (%rax),%r12
 39a:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
 39f:	4c 03 30             	add    (%rax),%r14
 3a2:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 3a9:	1f 84 00 00 00 00 00 
 3b0:	c4 82 7d 18 1c bc    	vbroadcastss (%r12,%r15,4),%ymm3
 3b6:	c4 c2 65 b8 14 36    	vfmadd231ps (%r14,%rsi,1),%ymm3,%ymm2
 3bc:	c4 c2 65 b8 4c 36 20 	vfmadd231ps 0x20(%r14,%rsi,1),%ymm3,%ymm1
 3c3:	c4 c2 65 b8 44 36 40 	vfmadd231ps 0x40(%r14,%rsi,1),%ymm3,%ymm0
 3ca:	c4 82 7d 18 64 bc 04 	vbroadcastss 0x4(%r12,%r15,4),%ymm4
 3d1:	c4 82 7d 18 6c bc 08 	vbroadcastss 0x8(%r12,%r15,4),%ymm5
 3d8:	c4 82 7d 18 74 bc 0c 	vbroadcastss 0xc(%r12,%r15,4),%ymm6
 3df:	49 83 c7 04          	add    $0x4,%r15
 3e3:	c4 c2 5d b8 14 3e    	vfmadd231ps (%r14,%rdi,1),%ymm4,%ymm2
 3e9:	c4 c2 5d b8 4c 3e 20 	vfmadd231ps 0x20(%r14,%rdi,1),%ymm4,%ymm1
 3f0:	c4 c2 5d b8 44 3e 40 	vfmadd231ps 0x40(%r14,%rdi,1),%ymm4,%ymm0
 3f7:	c4 c2 55 b8 14 2e    	vfmadd231ps (%r14,%rbp,1),%ymm5,%ymm2
 3fd:	c4 c2 55 b8 4c 2e 20 	vfmadd231ps 0x20(%r14,%rbp,1),%ymm5,%ymm1
 404:	c4 c2 55 b8 44 2e 40 	vfmadd231ps 0x40(%r14,%rbp,1),%ymm5,%ymm0
 40b:	c4 c2 4d b8 14 1e    	vfmadd231ps (%r14,%rbx,1),%ymm6,%ymm2
 411:	c4 c2 4d b8 4c 1e 20 	vfmadd231ps 0x20(%r14,%rbx,1),%ymm6,%ymm1
 418:	c4 c2 4d b8 44 1e 40 	vfmadd231ps 0x40(%r14,%rbx,1),%ymm6,%ymm0
 41f:	49 01 d6             	add    %rdx,%r14
 422:	49 39 cf             	cmp    %rcx,%r15
 425:	7c 89                	jl     3b0 <.omp_outlined.+0x190>
 427:	e9 04 ff ff ff       	jmpq   330 <.omp_outlined.+0x110>

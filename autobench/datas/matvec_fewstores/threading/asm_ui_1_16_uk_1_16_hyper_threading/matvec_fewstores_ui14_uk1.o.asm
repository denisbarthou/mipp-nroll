...
0000000000000220 <.omp_outlined.>:
 ...
 261:	00 
 262:	83 c1 6f             	add    $0x6f,%ecx
 265:	48 63 c9             	movslq %ecx,%rcx
 268:	48 69 c9 93 24 49 92 	imul   $0xffffffff92492493,%rcx,%rcx
 26f:	48 c1 e9 20          	shr    $0x20,%rcx
 273:	8d 44 01 6f          	lea    0x6f(%rcx,%rax,1),%eax
 ...
 300:	4d 6b d3 70          	imul   $0x70,%r11,%r10
 304:	4c 63 c3             	movslq %ebx,%r8
 307:	49 83 c2 68          	add    $0x68,%r10
 30b:	48 c1 e2 02          	shl    $0x2,%rdx
 30f:	e9 c2 00 00 00       	jmpq   3d6 <.omp_outlined.+0x1b6>
 314:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
 31b:	00 00 00 00 00 
 320:	c5 7c 11 24 ae       	vmovups %ymm12,(%rsi,%rbp,4)
 325:	49 83 c2 70          	add    $0x70,%r10
 329:	49 8b 45 00          	mov    0x0(%r13),%rax
 32d:	c4 21 7c 11 2c 88    	vmovups %ymm13,(%rax,%r9,4)
 333:	49 8b 45 00          	mov    0x0(%r13),%rax
 337:	c5 7c 11 5c a8 40    	vmovups %ymm11,0x40(%rax,%rbp,4)
 33d:	49 8b 45 00          	mov    0x0(%r13),%rax
 341:	c5 7c 11 54 a8 60    	vmovups %ymm10,0x60(%rax,%rbp,4)
 347:	49 8b 45 00          	mov    0x0(%r13),%rax
 34b:	c5 7c 11 84 a8 80 00 	vmovups %ymm8,0x80(%rax,%rbp,4)
 352:	00 00 
 354:	49 8b 45 00          	mov    0x0(%r13),%rax
 358:	c5 7c 11 8c a8 a0 00 	vmovups %ymm9,0xa0(%rax,%rbp,4)
 35f:	00 00 
 361:	49 8b 45 00          	mov    0x0(%r13),%rax
 365:	c5 fc 11 bc a8 c0 00 	vmovups %ymm7,0xc0(%rax,%rbp,4)
 36c:	00 00 
 36e:	49 8b 45 00          	mov    0x0(%r13),%rax
 372:	c5 fc 11 b4 a8 e0 00 	vmovups %ymm6,0xe0(%rax,%rbp,4)
 379:	00 00 
 37b:	49 8b 45 00          	mov    0x0(%r13),%rax
 37f:	c5 fc 11 ac a8 00 01 	vmovups %ymm5,0x100(%rax,%rbp,4)
 386:	00 00 
 388:	49 8b 45 00          	mov    0x0(%r13),%rax
 38c:	c5 fc 11 a4 a8 20 01 	vmovups %ymm4,0x120(%rax,%rbp,4)
 393:	00 00 
 395:	49 8b 45 00          	mov    0x0(%r13),%rax
 399:	c5 fc 11 9c a8 40 01 	vmovups %ymm3,0x140(%rax,%rbp,4)
 3a0:	00 00 
 3a2:	49 8b 45 00          	mov    0x0(%r13),%rax
 3a6:	c5 fc 11 94 a8 60 01 	vmovups %ymm2,0x160(%rax,%rbp,4)
 3ad:	00 00 
 3af:	49 8b 45 00          	mov    0x0(%r13),%rax
 3b3:	c5 fc 11 8c a8 80 01 	vmovups %ymm1,0x180(%rax,%rbp,4)
 3ba:	00 00 
 3bc:	49 8b 45 00          	mov    0x0(%r13),%rax
 3c0:	c5 fc 11 84 a8 a0 01 	vmovups %ymm0,0x1a0(%rax,%rbp,4)
 3c7:	00 00 
 3c9:	4d 39 c3             	cmp    %r8,%r11
 3cc:	4d 8d 5b 01          	lea    0x1(%r11),%r11
 3d0:	0f 8d fe fe ff ff    	jge    2d4 <.omp_outlined.+0xb4>
 3d6:	49 8b 75 00          	mov    0x0(%r13),%rsi
 3da:	41 6b c3 70          	imul   $0x70,%r11d,%eax
 3de:	49 6b eb 70          	imul   $0x70,%r11,%rbp
 3e2:	83 c8 08             	or     $0x8,%eax
 3e5:	4c 63 c8             	movslq %eax,%r9
 3e8:	c5 7c 10 24 ae       	vmovups (%rsi,%rbp,4),%ymm12
 3ed:	c5 7c 10 5c ae 40    	vmovups 0x40(%rsi,%rbp,4),%ymm11
 3f3:	c5 7c 10 54 ae 60    	vmovups 0x60(%rsi,%rbp,4),%ymm10
 3f9:	c5 7c 10 84 ae 80 00 	vmovups 0x80(%rsi,%rbp,4),%ymm8
 400:	00 00 
 402:	c4 21 7c 10 2c 8e    	vmovups (%rsi,%r9,4),%ymm13
 408:	c5 7c 10 8c ae a0 00 	vmovups 0xa0(%rsi,%rbp,4),%ymm9
 40f:	00 00 
 411:	c5 fc 10 bc ae c0 00 	vmovups 0xc0(%rsi,%rbp,4),%ymm7
 418:	00 00 
 41a:	c5 fc 10 b4 ae e0 00 	vmovups 0xe0(%rsi,%rbp,4),%ymm6
 421:	00 00 
 423:	c5 fc 10 ac ae 00 01 	vmovups 0x100(%rsi,%rbp,4),%ymm5
 42a:	00 00 
 42c:	c5 fc 10 a4 ae 20 01 	vmovups 0x120(%rsi,%rbp,4),%ymm4
 433:	00 00 
 435:	c5 fc 10 9c ae 40 01 	vmovups 0x140(%rsi,%rbp,4),%ymm3
 43c:	00 00 
 43e:	c5 fc 10 94 ae 60 01 	vmovups 0x160(%rsi,%rbp,4),%ymm2
 445:	00 00 
 447:	c5 fc 10 8c ae 80 01 	vmovups 0x180(%rsi,%rbp,4),%ymm1
 44e:	00 00 
 450:	c5 fc 10 84 ae a0 01 	vmovups 0x1a0(%rsi,%rbp,4),%ymm0
 457:	00 00 
 459:	85 c9                	test   %ecx,%ecx
 45b:	0f 8e bf fe ff ff    	jle    320 <.omp_outlined.+0x100>
 461:	49 8b 3f             	mov    (%r15),%rdi
 464:	4a 8d 04 95 00 00 00 	lea    0x0(,%r10,4),%rax
 46b:	00 
 46c:	49 03 06             	add    (%r14),%rax
 ...
 47f:	00 
 480:	c4 62 7d 18 34 9f    	vbroadcastss (%rdi,%rbx,4),%ymm14
 486:	c4 62 0d b8 a0 60 fe 	vfmadd231ps -0x1a0(%rax),%ymm14,%ymm12
 48d:	ff ff 
 48f:	c4 62 0d b8 a8 80 fe 	vfmadd231ps -0x180(%rax),%ymm14,%ymm13
 496:	ff ff 
 498:	c4 62 0d b8 98 a0 fe 	vfmadd231ps -0x160(%rax),%ymm14,%ymm11
 49f:	ff ff 
 4a1:	c4 62 0d b8 90 c0 fe 	vfmadd231ps -0x140(%rax),%ymm14,%ymm10
 4a8:	ff ff 
 4aa:	c4 62 0d b8 80 e0 fe 	vfmadd231ps -0x120(%rax),%ymm14,%ymm8
 4b1:	ff ff 
 4b3:	c4 62 0d b8 88 00 ff 	vfmadd231ps -0x100(%rax),%ymm14,%ymm9
 4ba:	ff ff 
 4bc:	c4 e2 0d b8 b8 20 ff 	vfmadd231ps -0xe0(%rax),%ymm14,%ymm7
 4c3:	ff ff 
 4c5:	c4 e2 0d b8 b0 40 ff 	vfmadd231ps -0xc0(%rax),%ymm14,%ymm6
 4cc:	ff ff 
 4ce:	c4 e2 0d b8 a8 60 ff 	vfmadd231ps -0xa0(%rax),%ymm14,%ymm5
 4d5:	ff ff 
 4d7:	c4 e2 0d b8 60 80    	vfmadd231ps -0x80(%rax),%ymm14,%ymm4
 4dd:	c4 e2 0d b8 58 a0    	vfmadd231ps -0x60(%rax),%ymm14,%ymm3
 4e3:	c4 e2 0d b8 50 c0    	vfmadd231ps -0x40(%rax),%ymm14,%ymm2
 4e9:	c4 e2 0d b8 48 e0    	vfmadd231ps -0x20(%rax),%ymm14,%ymm1
 4ef:	c4 e2 0d b8 00       	vfmadd231ps (%rax),%ymm14,%ymm0
 4f4:	48 ff c3             	inc    %rbx
 4f7:	48 01 d0             	add    %rdx,%rax
 4fa:	48 39 d9             	cmp    %rbx,%rcx
 4fd:	75 81                	jne    480 <.omp_outlined.+0x260>
 4ff:	e9 1c fe ff ff       	jmpq   320 <.omp_outlined.+0x100>
 504:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
 50b:	00 00 00 00 00 

0000000000000510 <_Z6enablev>:
 510:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 517 <_Z6enablev+0x7>
 517:	b8 70 00 00 00       	mov    $0x70,%eax
 51c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 521:	0f 45 c8             	cmovne %eax,%ecx
 524:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 52a <_Z6enablev+0x1a>
 52a:	0f 9e c1             	setle  %cl
 52d:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 534 <_Z6enablev+0x24>

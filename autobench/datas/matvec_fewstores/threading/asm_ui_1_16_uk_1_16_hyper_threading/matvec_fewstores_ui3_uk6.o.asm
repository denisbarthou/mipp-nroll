...
0000000000000230 <.omp_outlined.>:
 ...
 3b0:	c4 22 7d 18 04 a6    	vbroadcastss (%rsi,%r12,4),%ymm8
 3b6:	c4 e2 3d b8 50 c0    	vfmadd231ps -0x40(%rax),%ymm8,%ymm2
 3bc:	c4 a2 7d 18 7c a6 04 	vbroadcastss 0x4(%rsi,%r12,4),%ymm7
 3c3:	4c 8d 74 28 c0       	lea    -0x40(%rax,%rbp,1),%r14
 3c8:	c4 a2 7d 18 74 a6 08 	vbroadcastss 0x8(%rsi,%r12,4),%ymm6
 3cf:	c4 a2 7d 18 6c a6 0c 	vbroadcastss 0xc(%rsi,%r12,4),%ymm5
 3d6:	c4 a2 7d 18 64 a6 10 	vbroadcastss 0x10(%rsi,%r12,4),%ymm4
 3dd:	c4 e2 3d b8 48 e0    	vfmadd231ps -0x20(%rax),%ymm8,%ymm1
 3e3:	c4 a2 7d 18 5c a6 14 	vbroadcastss 0x14(%rsi,%r12,4),%ymm3
 3ea:	c4 e2 3d b8 00       	vfmadd231ps (%rax),%ymm8,%ymm0
 3ef:	49 83 c4 06          	add    $0x6,%r12
 3f3:	49 8d 1c 2e          	lea    (%r14,%rbp,1),%rbx
 3f7:	c4 e2 45 b8 54 28 c0 	vfmadd231ps -0x40(%rax,%rbp,1),%ymm7,%ymm2
 3fe:	48 01 f8             	add    %rdi,%rax
 401:	c4 a2 4d b8 54 35 00 	vfmadd231ps 0x0(%rbp,%r14,1),%ymm6,%ymm2
 408:	c4 e2 55 b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm2
 40f:	48 01 eb             	add    %rbp,%rbx
 412:	c4 e2 5d b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm4,%ymm2
 419:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 41d:	c4 e2 65 b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm3,%ymm2
 424:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 428:	c4 e2 45 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm1
 42e:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 432:	c4 e2 4d b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm1
 439:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 43d:	c4 e2 55 b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm1
 444:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 448:	c4 e2 5d b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm4,%ymm1
 44f:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 453:	c4 e2 65 b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm3,%ymm1
 45a:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 45e:	c4 e2 45 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm0
 464:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 468:	c4 e2 4d b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm0
 46f:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 473:	c4 e2 55 b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm0
 47a:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 47e:	c4 e2 5d b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm4,%ymm0
 485:	48 01 eb             	add    %rbp,%rbx
 488:	c4 e2 65 b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm3,%ymm0
 48f:	49 39 cc             	cmp    %rcx,%r12
 492:	0f 8c 18 ff ff ff    	jl     3b0 <.omp_outlined.+0x180>
 498:	e9 a3 fe ff ff       	jmpq   340 <.omp_outlined.+0x110>
...
00000000000004a0 <_Z6enablev>:
 ...
 4ac:	b9 fd ff ff ff       	mov    $0xfffffffd,%ecx

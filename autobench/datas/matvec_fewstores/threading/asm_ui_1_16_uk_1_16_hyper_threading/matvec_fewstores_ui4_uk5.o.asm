...
0000000000000220 <.omp_outlined.>:
 ...
 3c0:	c4 02 7d 18 04 86    	vbroadcastss (%r14,%r8,4),%ymm8
 3c6:	c4 c2 3d b8 47 a0    	vfmadd231ps -0x60(%r15),%ymm8,%ymm0
 3cc:	c4 82 7d 18 7c 86 04 	vbroadcastss 0x4(%r14,%r8,4),%ymm7
 3d3:	49 8d 5c 17 a0       	lea    -0x60(%r15,%rdx,1),%rbx
 3d8:	c4 82 7d 18 74 86 08 	vbroadcastss 0x8(%r14,%r8,4),%ymm6
 3df:	c4 82 7d 18 6c 86 0c 	vbroadcastss 0xc(%r14,%r8,4),%ymm5
 3e6:	c4 c2 3d b8 4f c0    	vfmadd231ps -0x40(%r15),%ymm8,%ymm1
 3ec:	c4 82 7d 18 64 86 10 	vbroadcastss 0x10(%r14,%r8,4),%ymm4
 3f3:	c4 c2 3d b8 57 e0    	vfmadd231ps -0x20(%r15),%ymm8,%ymm2
 3f9:	c4 c2 3d b8 1f       	vfmadd231ps (%r15),%ymm8,%ymm3
 3fe:	49 83 c0 05          	add    $0x5,%r8
 402:	c4 c2 45 b8 44 17 a0 	vfmadd231ps -0x60(%r15,%rdx,1),%ymm7,%ymm0
 409:	49 01 ef             	add    %rbp,%r15
 40c:	c4 e2 4d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm0
 412:	48 01 d3             	add    %rdx,%rbx
 415:	c4 e2 55 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm0
 41b:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 41f:	c4 e2 5d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm0
 425:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 429:	c4 e2 45 b8 0c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm7,%ymm1
 42f:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 433:	c4 e2 4d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm1
 439:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 43d:	c4 e2 55 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm1
 443:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 447:	c4 e2 5d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm1
 44d:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 451:	c4 e2 45 b8 14 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm7,%ymm2
 457:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 45b:	c4 e2 4d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm2
 461:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 465:	c4 e2 55 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm2
 46b:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 46f:	c4 e2 5d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm2
 475:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 479:	c4 e2 45 b8 1c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm7,%ymm3
 47f:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 483:	c4 e2 4d b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm3
 489:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 48d:	c4 e2 55 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm3
 493:	48 01 d3             	add    %rdx,%rbx
 496:	c4 e2 5d b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm3
 49c:	49 39 c8             	cmp    %rcx,%r8
 49f:	0f 8c 1b ff ff ff    	jl     3c0 <.omp_outlined.+0x1a0>
 4a5:	e9 86 fe ff ff       	jmpq   330 <.omp_outlined.+0x110>
...
00000000000004b0 <_Z6enablev>:
 ...
 4cd:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 4d4 <_Z6enablev+0x24>

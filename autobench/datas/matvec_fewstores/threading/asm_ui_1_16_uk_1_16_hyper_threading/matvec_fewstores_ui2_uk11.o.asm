...
0000000000000220 <.omp_outlined.>:
 ...
 2fd:	be 20 00 00 00       	mov    $0x20,%esi
 302:	48 83 cf 08          	or     $0x8,%rdi
 306:	48 6b ea 2c          	imul   $0x2c,%rdx,%rbp
 30a:	48 c1 e2 02          	shl    $0x2,%rdx
 30e:	48 8d 1c d2          	lea    (%rdx,%rdx,8),%rbx
 312:	48 29 de             	sub    %rbx,%rsi
 315:	eb 26                	jmp    33d <.omp_outlined.+0x11d>
 ...
 380:	c4 22 7d 18 24 b3    	vbroadcastss (%rbx,%r14,4),%ymm12
 386:	c4 c2 1d b8 44 24 e0 	vfmadd231ps -0x20(%r12),%ymm12,%ymm0
 38d:	c4 22 7d 18 5c b3 04 	vbroadcastss 0x4(%rbx,%r14,4),%ymm11
 394:	49 8d 44 14 e0       	lea    -0x20(%r12,%rdx,1),%rax
 399:	c4 22 7d 18 54 b3 08 	vbroadcastss 0x8(%rbx,%r14,4),%ymm10
 3a0:	c4 22 7d 18 4c b3 0c 	vbroadcastss 0xc(%rbx,%r14,4),%ymm9
 3a7:	c4 22 7d 18 44 b3 10 	vbroadcastss 0x10(%rbx,%r14,4),%ymm8
 3ae:	c4 a2 7d 18 7c b3 14 	vbroadcastss 0x14(%rbx,%r14,4),%ymm7
 3b5:	c4 a2 7d 18 74 b3 18 	vbroadcastss 0x18(%rbx,%r14,4),%ymm6
 3bc:	c4 a2 7d 18 6c b3 1c 	vbroadcastss 0x1c(%rbx,%r14,4),%ymm5
 3c3:	c4 a2 7d 18 64 b3 20 	vbroadcastss 0x20(%rbx,%r14,4),%ymm4
 3ca:	c4 a2 7d 18 5c b3 24 	vbroadcastss 0x24(%rbx,%r14,4),%ymm3
 3d1:	c4 c2 1d b8 0c 24    	vfmadd231ps (%r12),%ymm12,%ymm1
 3d7:	c4 a2 7d 18 54 b3 28 	vbroadcastss 0x28(%rbx,%r14,4),%ymm2
 3de:	49 83 c6 0b          	add    $0xb,%r14
 3e2:	c4 c2 25 b8 44 14 e0 	vfmadd231ps -0x20(%r12,%rdx,1),%ymm11,%ymm0
 3e9:	49 01 ec             	add    %rbp,%r12
 3ec:	c4 e2 2d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm10,%ymm0
 3f2:	48 01 d0             	add    %rdx,%rax
 3f5:	c4 e2 35 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm9,%ymm0
 3fb:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 3ff:	c4 e2 3d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm8,%ymm0
 405:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 409:	c4 e2 45 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm7,%ymm0
 40f:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 413:	c4 e2 4d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm6,%ymm0
 419:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 41d:	c4 e2 55 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm5,%ymm0
 423:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 427:	c4 e2 5d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm4,%ymm0
 42d:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 431:	c4 e2 65 b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm3,%ymm0
 437:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 43b:	c4 e2 6d b8 04 02    	vfmadd231ps (%rdx,%rax,1),%ymm2,%ymm0
 441:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 445:	c4 e2 25 b8 0c 06    	vfmadd231ps (%rsi,%rax,1),%ymm11,%ymm1
 44b:	48 8d 04 30          	lea    (%rax,%rsi,1),%rax
 44f:	c4 e2 2d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm10,%ymm1
 455:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 459:	c4 e2 35 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm9,%ymm1
 45f:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 463:	c4 e2 3d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm8,%ymm1
 469:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 46d:	c4 e2 45 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm7,%ymm1
 473:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 477:	c4 e2 4d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm6,%ymm1
 47d:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 481:	c4 e2 55 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm5,%ymm1
 487:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 48b:	c4 e2 5d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm4,%ymm1
 491:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 495:	c4 e2 65 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm3,%ymm1
 49b:	48 01 d0             	add    %rdx,%rax
 49e:	c4 e2 6d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm2,%ymm1
 4a4:	49 39 ce             	cmp    %rcx,%r14
 4a7:	0f 8c d3 fe ff ff    	jl     380 <.omp_outlined.+0x160>
 4ad:	e9 6e fe ff ff       	jmpq   320 <.omp_outlined.+0x100>
...
00000000000004c0 <_Z6enablev>:
 ...
 4dd:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 4e4 <_Z6enablev+0x24>
...
00000000000004f0 <_Z9n_reg_maxv>:
 4f0:	b8 23 00 00 00       	mov    $0x23,%eax
 4f5:	c3                   	retq   

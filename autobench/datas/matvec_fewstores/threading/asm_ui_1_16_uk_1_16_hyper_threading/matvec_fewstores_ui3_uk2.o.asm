...
0000000000000220 <.omp_outlined.>:
 ...
 2b9:	4c 63 5c 24 08       	movslq 0x8(%rsp),%r11
 ...
 2fa:	4c 89 d8             	mov    %r11,%rax
 2fd:	4c 63 c3             	movslq %ebx,%r8
 300:	41 ba 10 00 00 00    	mov    $0x10,%r10d
 306:	48 c1 e0 05          	shl    $0x5,%rax
 30a:	48 8d 3c 40          	lea    (%rax,%rax,2),%rdi
 30e:	48 8d 2c 97          	lea    (%rdi,%rdx,4),%rbp
 312:	48 c1 e2 03          	shl    $0x3,%rdx
 316:	eb 2f                	jmp    347 <.omp_outlined.+0x127>
 318:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
 31f:	00 
 320:	c4 c1 7c 11 14 99    	vmovups %ymm2,(%r9,%rbx,4)
 326:	49 83 c2 18          	add    $0x18,%r10
 32a:	49 8b 45 00          	mov    0x0(%r13),%rax
 32e:	c5 fc 11 4c 98 20    	vmovups %ymm1,0x20(%rax,%rbx,4)
 334:	49 8b 45 00          	mov    0x0(%r13),%rax
 338:	c5 fc 11 44 98 40    	vmovups %ymm0,0x40(%rax,%rbx,4)
 33e:	4d 39 c3             	cmp    %r8,%r11
 341:	4d 8d 5b 01          	lea    0x1(%r11),%r11
 345:	7d 85                	jge    2cc <.omp_outlined.+0xac>
 347:	4d 8b 4d 00          	mov    0x0(%r13),%r9
 34b:	4a 8d 04 dd 00 00 00 	lea    0x0(,%r11,8),%rax
 352:	00 
 353:	48 8d 1c 40          	lea    (%rax,%rax,2),%rbx
 357:	c4 c1 7c 10 14 99    	vmovups (%r9,%rbx,4),%ymm2
 35d:	c4 c1 7c 10 4c 99 20 	vmovups 0x20(%r9,%rbx,4),%ymm1
 364:	c4 c1 7c 10 44 99 40 	vmovups 0x40(%r9,%rbx,4),%ymm0
 36b:	85 c9                	test   %ecx,%ecx
 36d:	7e b1                	jle    320 <.omp_outlined.+0x100>
 36f:	49 8b 37             	mov    (%r15),%rsi
 372:	4a 8d 04 95 00 00 00 	lea    0x0(,%r10,4),%rax
 379:	00 
 37a:	49 03 06             	add    (%r14),%rax
 37d:	45 31 e4             	xor    %r12d,%r12d
 380:	c4 a2 7d 18 1c a6    	vbroadcastss (%rsi,%r12,4),%ymm3
 386:	c4 e2 65 b8 54 38 c0 	vfmadd231ps -0x40(%rax,%rdi,1),%ymm3,%ymm2
 38d:	c4 e2 65 b8 4c 38 e0 	vfmadd231ps -0x20(%rax,%rdi,1),%ymm3,%ymm1
 394:	c4 e2 65 b8 04 38    	vfmadd231ps (%rax,%rdi,1),%ymm3,%ymm0
 39a:	c4 a2 7d 18 64 a6 04 	vbroadcastss 0x4(%rsi,%r12,4),%ymm4
 3a1:	49 83 c4 02          	add    $0x2,%r12
 3a5:	c4 e2 5d b8 54 28 c0 	vfmadd231ps -0x40(%rax,%rbp,1),%ymm4,%ymm2
 3ac:	c4 e2 5d b8 4c 28 e0 	vfmadd231ps -0x20(%rax,%rbp,1),%ymm4,%ymm1
 3b3:	c4 e2 5d b8 04 28    	vfmadd231ps (%rax,%rbp,1),%ymm4,%ymm0
 3b9:	48 01 d0             	add    %rdx,%rax
 3bc:	49 39 cc             	cmp    %rcx,%r12
 3bf:	7c bf                	jl     380 <.omp_outlined.+0x160>
 3c1:	e9 5a ff ff ff       	jmpq   320 <.omp_outlined.+0x100>

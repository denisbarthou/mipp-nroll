...
0000000000000220 <.omp_outlined.>:
 ...
 2f3:	42 8d 34 d5 00 00 00 	lea    0x0(,%r10,8),%esi
 2fa:	00 
 2fb:	48 63 c3             	movslq %ebx,%rax
 2fe:	4c 63 de             	movslq %esi,%r11
 301:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
 306:	48 8d 34 d5 00 00 00 	lea    0x0(,%rdx,8),%rsi
 30d:	00 
 30e:	48 8d 1c 95 00 00 00 	lea    0x0(,%rdx,4),%rbx
 315:	00 
 316:	48 8d 2c b6          	lea    (%rsi,%rsi,4),%rbp
 31a:	eb 21                	jmp    33d <.omp_outlined.+0x11d>
 31c:	0f 1f 40 00          	nopl   0x0(%rax)
 320:	c5 fc 28 c1          	vmovaps %ymm1,%ymm0
 324:	48 8b 74 24 40       	mov    0x40(%rsp),%rsi
 329:	49 83 c3 08          	add    $0x8,%r11
 32d:	c5 fc 11 04 b0       	vmovups %ymm0,(%rax,%rsi,4)
 332:	4c 3b 54 24 30       	cmp    0x30(%rsp),%r10
 337:	4d 8d 52 01          	lea    0x1(%r10),%r10
 33b:	7d 88                	jge    2c5 <.omp_outlined.+0xa5>
 33d:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
 342:	42 8d 34 d5 00 00 00 	lea    0x0(,%r10,8),%esi
 349:	00 
 34a:	48 63 f6             	movslq %esi,%rsi
 34d:	48 89 74 24 40       	mov    %rsi,0x40(%rsp)
 352:	48 8b 00             	mov    (%rax),%rax
 355:	c5 fc 10 0c b0       	vmovups (%rax,%rsi,4),%ymm1
 35a:	85 c9                	test   %ecx,%ecx
 35c:	7e c2                	jle    320 <.omp_outlined.+0x100>
 35e:	48 8b 74 24 20       	mov    0x20(%rsp),%rsi
 363:	4c 8b 4c 24 28       	mov    0x28(%rsp),%r9
 368:	4a 8d 3c 9d 00 00 00 	lea    0x0(,%r11,4),%rdi
 36f:	00 
 370:	49 89 c0             	mov    %rax,%r8
 373:	45 31 e4             	xor    %r12d,%r12d
 376:	4c 89 c0             	mov    %r8,%rax
 379:	48 8b 36             	mov    (%rsi),%rsi
 37c:	49 03 39             	add    (%r9),%rdi
 37f:	90                   	nop
 ...
 399:	4c 8d 34 1f          	lea    (%rdi,%rbx,1),%r14
 ...
 3c7:	c4 22 7d 18 54 a6 24 	vbroadcastss 0x24(%rsi,%r12,4),%ymm10
 3ce:	49 83 c4 0a          	add    $0xa,%r12
 3d2:	49 01 de             	add    %rbx,%r14
 3d5:	4d 8d 3c 1e          	lea    (%r14,%rbx,1),%r15
 3d9:	49 01 df             	add    %rbx,%r15
 3dc:	c4 e2 6d b8 04 97    	vfmadd231ps (%rdi,%rdx,4),%ymm2,%ymm0
 3e2:	4d 8d 2c 1f          	lea    (%r15,%rbx,1),%r13
 3e6:	4d 8d 44 1d 00       	lea    0x0(%r13,%rbx,1),%r8
 3eb:	4d 8d 0c 18          	lea    (%r8,%rbx,1),%r9
 3ef:	c4 e2 65 b8 04 d7    	vfmadd231ps (%rdi,%rdx,8),%ymm3,%ymm0
 3f5:	48 01 ef             	add    %rbp,%rdi
 3f8:	c4 c2 5d b8 04 96    	vfmadd231ps (%r14,%rdx,4),%ymm4,%ymm0
 3fe:	c4 c2 55 b8 04 d6    	vfmadd231ps (%r14,%rdx,8),%ymm5,%ymm0
 404:	c4 c2 4d b8 04 97    	vfmadd231ps (%r15,%rdx,4),%ymm6,%ymm0
 40a:	c4 c2 45 b8 44 95 00 	vfmadd231ps 0x0(%r13,%rdx,4),%ymm7,%ymm0
 411:	c4 c2 3d b8 04 90    	vfmadd231ps (%r8,%rdx,4),%ymm8,%ymm0
 417:	c4 c2 35 b8 04 91    	vfmadd231ps (%r9,%rdx,4),%ymm9,%ymm0
 41d:	49 01 d9             	add    %rbx,%r9
 420:	c4 c2 2d b8 04 91    	vfmadd231ps (%r9,%rdx,4),%ymm10,%ymm0
 426:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 42a:	49 39 cc             	cmp    %rcx,%r12
 42d:	0f 8c 4d ff ff ff    	jl     380 <.omp_outlined.+0x160>
 433:	e9 ec fe ff ff       	jmpq   324 <.omp_outlined.+0x104>
...
0000000000000440 <_Z6enablev>:
 ...
 454:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # 45b <_Z6enablev+0x1b>

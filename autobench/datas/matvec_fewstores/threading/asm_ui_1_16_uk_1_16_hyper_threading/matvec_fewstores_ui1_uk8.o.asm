...
0000000000000210 <.omp_outlined.>:
 ...
 229:	4c 89 4c 24 20       	mov    %r9,0x20(%rsp)
 22e:	4c 89 44 24 18       	mov    %r8,0x18(%rsp)
 ...
 24b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%rsp)
 252:	00 
 ...
 266:	89 5c 24 04          	mov    %ebx,0x4(%rsp)
 26a:	48 83 ec 08          	sub    $0x8,%rsp
 26e:	4c 8d 44 24 10       	lea    0x10(%rsp),%r8
 273:	48 8d 44 24 1c       	lea    0x1c(%rsp),%rax
 278:	48 8d 4c 24 18       	lea    0x18(%rsp),%rcx
 ...
 2a2:	4c 63 44 24 08       	movslq 0x8(%rsp),%r8
 2a7:	39 e8                	cmp    %ebp,%eax
 2a9:	0f 4c d8             	cmovl  %eax,%ebx
 2ac:	89 5c 24 04          	mov    %ebx,0x4(%rsp)
 2b0:	41 39 d8             	cmp    %ebx,%r8d
 2b3:	7e 20                	jle    2d5 <.omp_outlined.+0xc5>
 2b5:	8b 74 24 0c          	mov    0xc(%rsp),%esi
 ...
 2d3:	5d                   	pop    %rbp
 2d4:	c3                   	retq   
 2d5:	48 63 15 00 00 00 00 	movslq 0x0(%rip),%rdx        # 2dc <.omp_outlined.+0xcc>
 2dc:	48 63 0d 00 00 00 00 	movslq 0x0(%rip),%rcx        # 2e3 <.omp_outlined.+0xd3>
 2e3:	42 8d 34 c5 00 00 00 	lea    0x0(,%r8,8),%esi
 2ea:	00 
 2eb:	48 63 c3             	movslq %ebx,%rax
 2ee:	4c 63 de             	movslq %esi,%r11
 2f1:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
 2f6:	48 89 d5             	mov    %rdx,%rbp
 2f9:	48 8d 1c 95 00 00 00 	lea    0x0(,%rdx,4),%rbx
 300:	00 
 301:	48 c1 e5 05          	shl    $0x5,%rbp
 305:	eb 22                	jmp    329 <.omp_outlined.+0x119>
 ...
 31e:	4c 3b 44 24 28       	cmp    0x28(%rsp),%r8
 323:	4d 8d 40 01          	lea    0x1(%r8),%r8
 327:	7d 8c                	jge    2b5 <.omp_outlined.+0xa5>
 329:	48 8b 44 24 30       	mov    0x30(%rsp),%rax
 32e:	42 8d 34 c5 00 00 00 	lea    0x0(,%r8,8),%esi
 335:	00 
 336:	4c 63 d6             	movslq %esi,%r10
 339:	4c 8b 08             	mov    (%rax),%r9
 33c:	c4 81 7c 10 0c 91    	vmovups (%r9,%r10,4),%ymm1
 342:	85 c9                	test   %ecx,%ecx
 344:	7e ca                	jle    310 <.omp_outlined.+0x100>
 346:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
 34b:	4c 8b 74 24 20       	mov    0x20(%rsp),%r14
 350:	4a 8d 3c 9d 00 00 00 	lea    0x0(,%r11,4),%rdi
 357:	00 
 358:	45 31 e4             	xor    %r12d,%r12d
 35b:	48 8b 30             	mov    (%rax),%rsi
 35e:	49 03 3e             	add    (%r14),%rdi
 ...
 3a2:	c4 a2 7d 18 7c a6 18 	vbroadcastss 0x18(%rsi,%r12,4),%ymm7
 3a9:	c4 22 7d 18 44 a6 1c 	vbroadcastss 0x1c(%rsi,%r12,4),%ymm8
 3b0:	49 83 c4 08          	add    $0x8,%r12
 3b4:	49 01 de             	add    %rbx,%r14
 3b7:	4d 8d 3c 1e          	lea    (%r14,%rbx,1),%r15
 3bb:	49 01 df             	add    %rbx,%r15
 3be:	c4 e2 6d b8 04 97    	vfmadd231ps (%rdi,%rdx,4),%ymm2,%ymm0
 3c4:	4d 8d 2c 1f          	lea    (%r15,%rbx,1),%r13
 3c8:	c4 e2 65 b8 04 d7    	vfmadd231ps (%rdi,%rdx,8),%ymm3,%ymm0
 3ce:	48 01 ef             	add    %rbp,%rdi
 3d1:	c4 c2 5d b8 04 96    	vfmadd231ps (%r14,%rdx,4),%ymm4,%ymm0
 3d7:	c4 c2 55 b8 04 d6    	vfmadd231ps (%r14,%rdx,8),%ymm5,%ymm0
 3dd:	c4 c2 4d b8 04 97    	vfmadd231ps (%r15,%rdx,4),%ymm6,%ymm0
 3e3:	c4 c2 45 b8 44 95 00 	vfmadd231ps 0x0(%r13,%rdx,4),%ymm7,%ymm0
 3ea:	49 01 dd             	add    %rbx,%r13
 3ed:	c4 c2 3d b8 44 95 00 	vfmadd231ps 0x0(%r13,%rdx,4),%ymm8,%ymm0
 3f4:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 3f8:	49 39 cc             	cmp    %rcx,%r12
 3fb:	0f 8c 6f ff ff ff    	jl     370 <.omp_outlined.+0x160>
 401:	e9 0e ff ff ff       	jmpq   314 <.omp_outlined.+0x104>
...
0000000000000410 <_Z6enablev>:
 ...
 424:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 42b <_Z6enablev+0x1b>

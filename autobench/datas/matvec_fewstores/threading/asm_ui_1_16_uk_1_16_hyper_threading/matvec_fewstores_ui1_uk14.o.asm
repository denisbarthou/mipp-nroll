...
0000000000000220 <.omp_outlined.>:
 ...
 2ff:	48 6b ea 38          	imul   $0x38,%rdx,%rbp
 ...
 36b:	c4 22 7d 18 5c a6 04 	vbroadcastss 0x4(%rsi,%r12,4),%ymm11
 372:	c4 22 7d 18 64 a6 08 	vbroadcastss 0x8(%rsi,%r12,4),%ymm12
 379:	4c 8d 34 1f          	lea    (%rdi,%rbx,1),%r14
 37d:	c4 22 7d 18 6c a6 0c 	vbroadcastss 0xc(%rsi,%r12,4),%ymm13
 384:	c4 22 7d 18 74 a6 10 	vbroadcastss 0x10(%rsi,%r12,4),%ymm14
 38b:	c4 22 7d 18 54 a6 14 	vbroadcastss 0x14(%rsi,%r12,4),%ymm10
 392:	c4 22 7d 18 4c a6 18 	vbroadcastss 0x18(%rsi,%r12,4),%ymm9
 399:	c4 22 7d 18 44 a6 1c 	vbroadcastss 0x1c(%rsi,%r12,4),%ymm8
 3a0:	c4 a2 7d 18 7c a6 20 	vbroadcastss 0x20(%rsi,%r12,4),%ymm7
 3a7:	c4 a2 7d 18 74 a6 24 	vbroadcastss 0x24(%rsi,%r12,4),%ymm6
 3ae:	c4 a2 7d 18 6c a6 28 	vbroadcastss 0x28(%rsi,%r12,4),%ymm5
 3b5:	c4 a2 7d 18 64 a6 2c 	vbroadcastss 0x2c(%rsi,%r12,4),%ymm4
 3bc:	c4 a2 7d 18 5c a6 30 	vbroadcastss 0x30(%rsi,%r12,4),%ymm3
 3c3:	c4 a2 7d 18 54 a6 34 	vbroadcastss 0x34(%rsi,%r12,4),%ymm2
 3ca:	49 83 c4 0e          	add    $0xe,%r12
 3ce:	49 01 de             	add    %rbx,%r14
 3d1:	49 8d 04 1e          	lea    (%r14,%rbx,1),%rax
 3d5:	48 01 d8             	add    %rbx,%rax
 3d8:	c4 e2 25 b8 04 97    	vfmadd231ps (%rdi,%rdx,4),%ymm11,%ymm0
 3de:	c4 e2 1d b8 04 d7    	vfmadd231ps (%rdi,%rdx,8),%ymm12,%ymm0
 3e4:	48 01 ef             	add    %rbp,%rdi
 3e7:	c4 c2 15 b8 04 96    	vfmadd231ps (%r14,%rdx,4),%ymm13,%ymm0
 3ed:	c4 c2 0d b8 04 d6    	vfmadd231ps (%r14,%rdx,8),%ymm14,%ymm0
 3f3:	c4 e2 2d b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm10,%ymm0
 3f9:	48 01 d8             	add    %rbx,%rax
 3fc:	c4 e2 35 b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm9,%ymm0
 402:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 406:	c4 e2 3d b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm8,%ymm0
 40c:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 410:	c4 e2 45 b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm7,%ymm0
 416:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 41a:	c4 e2 4d b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm6,%ymm0
 420:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 424:	c4 e2 55 b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm5,%ymm0
 42a:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 42e:	c4 e2 5d b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm4,%ymm0
 434:	48 8d 04 18          	lea    (%rax,%rbx,1),%rax
 438:	c4 e2 65 b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm3,%ymm0
 43e:	48 01 d8             	add    %rbx,%rax
 441:	c4 e2 6d b8 04 90    	vfmadd231ps (%rax,%rdx,4),%ymm2,%ymm0
 447:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 44b:	49 39 cc             	cmp    %rcx,%r12
 44e:	0f 8c 0c ff ff ff    	jl     360 <.omp_outlined.+0x140>
 454:	e9 bb fe ff ff       	jmpq   314 <.omp_outlined.+0xf4>
...
0000000000000460 <_Z6enablev>:
 ...
 474:	83 3d 00 00 00 00 0d 	cmpl   $0xd,0x0(%rip)        # 47b <_Z6enablev+0x1b>

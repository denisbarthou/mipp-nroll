...
0000000000000220 <.omp_outlined.>:
 ...
 304:	4c 63 ce             	movslq %esi,%r9
 307:	49 83 c9 18          	or     $0x18,%r9
 30b:	48 8d 34 d2          	lea    (%rdx,%rdx,8),%rsi
 30f:	48 8d 2c 76          	lea    (%rsi,%rsi,2),%rbp
 313:	be 20 00 00 00       	mov    $0x20,%esi
 318:	48 01 d5             	add    %rdx,%rbp
 31b:	48 c1 e2 02          	shl    $0x2,%rdx
 31f:	48 8d 1c 92          	lea    (%rdx,%rdx,4),%rbx
 323:	48 29 de             	sub    %rbx,%rsi
 326:	eb 40                	jmp    368 <.omp_outlined.+0x148>
 ...
 342:	c5 fc 11 0c b8       	vmovups %ymm1,(%rax,%rdi,4)
 ...
 3c0:	c4 02 7d 18 14 86    	vbroadcastss (%r14,%r8,4),%ymm10
 3c6:	c4 c2 2d b8 47 a0    	vfmadd231ps -0x60(%r15),%ymm10,%ymm0
 3cc:	c4 02 7d 18 4c 86 04 	vbroadcastss 0x4(%r14,%r8,4),%ymm9
 3d3:	49 8d 5c 17 a0       	lea    -0x60(%r15,%rdx,1),%rbx
 3d8:	c4 02 7d 18 44 86 08 	vbroadcastss 0x8(%r14,%r8,4),%ymm8
 3df:	c4 82 7d 18 7c 86 0c 	vbroadcastss 0xc(%r14,%r8,4),%ymm7
 3e6:	c4 82 7d 18 74 86 10 	vbroadcastss 0x10(%r14,%r8,4),%ymm6
 3ed:	c4 82 7d 18 6c 86 14 	vbroadcastss 0x14(%r14,%r8,4),%ymm5
 3f4:	c4 c2 2d b8 4f c0    	vfmadd231ps -0x40(%r15),%ymm10,%ymm1
 3fa:	c4 82 7d 18 64 86 18 	vbroadcastss 0x18(%r14,%r8,4),%ymm4
 401:	c4 c2 2d b8 57 e0    	vfmadd231ps -0x20(%r15),%ymm10,%ymm2
 407:	c4 c2 2d b8 1f       	vfmadd231ps (%r15),%ymm10,%ymm3
 40c:	49 83 c0 07          	add    $0x7,%r8
 410:	c4 c2 35 b8 44 17 a0 	vfmadd231ps -0x60(%r15,%rdx,1),%ymm9,%ymm0
 417:	49 01 ef             	add    %rbp,%r15
 41a:	c4 e2 3d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm0
 420:	48 01 d3             	add    %rdx,%rbx
 423:	c4 e2 45 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm0
 429:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 42d:	c4 e2 4d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm0
 433:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 437:	c4 e2 55 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm0
 43d:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 441:	c4 e2 5d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm0
 447:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 44b:	c4 e2 35 b8 0c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm1
 451:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 455:	c4 e2 3d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm1
 45b:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 45f:	c4 e2 45 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm1
 465:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 469:	c4 e2 4d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm1
 46f:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 473:	c4 e2 55 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm1
 479:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 47d:	c4 e2 5d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm1
 483:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 487:	c4 e2 35 b8 14 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm2
 48d:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 491:	c4 e2 3d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm2
 497:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 49b:	c4 e2 45 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm2
 4a1:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4a5:	c4 e2 4d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm2
 4ab:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4af:	c4 e2 55 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm2
 4b5:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4b9:	c4 e2 5d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm2
 4bf:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4c3:	c4 e2 35 b8 1c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm9,%ymm3
 4c9:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 4cd:	c4 e2 3d b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm3
 4d3:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4d7:	c4 e2 45 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm3
 4dd:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4e1:	c4 e2 4d b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm3
 4e7:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4eb:	c4 e2 55 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm3
 4f1:	48 01 d3             	add    %rdx,%rbx
 4f4:	c4 e2 5d b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm3
 4fa:	49 39 c8             	cmp    %rcx,%r8
 4fd:	0f 8c bd fe ff ff    	jl     3c0 <.omp_outlined.+0x1a0>
 503:	e9 28 fe ff ff       	jmpq   330 <.omp_outlined.+0x110>
...
0000000000000510 <_Z6enablev>:
 ...
 517:	b8 20 00 00 00       	mov    $0x20,%eax
 51c:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 521:	0f 45 c8             	cmovne %eax,%ecx
 524:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 52a <_Z6enablev+0x1a>
 52a:	0f 9e c1             	setle  %cl
 52d:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 534 <_Z6enablev+0x24>
...
0000000000000540 <_Z9n_reg_maxv>:
 540:	b8 27 00 00 00       	mov    $0x27,%eax
 545:	c3                   	retq   

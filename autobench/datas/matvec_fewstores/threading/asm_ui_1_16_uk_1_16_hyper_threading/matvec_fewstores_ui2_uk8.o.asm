...
0000000000000210 <.omp_outlined.>:
 ...
 2e1:	44 89 fe             	mov    %r15d,%esi
 2e4:	4c 63 c3             	movslq %ebx,%r8
 2e7:	c1 e6 04             	shl    $0x4,%esi
 2ea:	48 63 f6             	movslq %esi,%rsi
 2ed:	48 83 ce 08          	or     $0x8,%rsi
 2f1:	48 89 d7             	mov    %rdx,%rdi
 2f4:	48 8d 2c 95 00 00 00 	lea    0x0(,%rdx,4),%rbp
 2fb:	00 
 2fc:	48 c1 e2 03          	shl    $0x3,%rdx
 300:	48 8d 1c 52          	lea    (%rdx,%rdx,2),%rbx
 304:	ba 20 00 00 00       	mov    $0x20,%edx
 309:	48 c1 e7 05          	shl    $0x5,%rdi
 30d:	48 29 da             	sub    %rbx,%rdx
 310:	eb 2f                	jmp    341 <.omp_outlined.+0x131>
 312:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
 319:	1f 84 00 00 00 00 00 
 ...
 33b:	0f 8d 72 ff ff ff    	jge    2b3 <.omp_outlined.+0xa3>
 341:	4d 8b 5d 00          	mov    0x0(%r13),%r11
 345:	44 89 f8             	mov    %r15d,%eax
 348:	c1 e0 04             	shl    $0x4,%eax
 34b:	8d 58 08             	lea    0x8(%rax),%ebx
 34e:	4c 63 c8             	movslq %eax,%r9
 351:	4c 63 d3             	movslq %ebx,%r10
 354:	c4 81 7c 10 04 8b    	vmovups (%r11,%r9,4),%ymm0
 35a:	c4 81 7c 10 0c 93    	vmovups (%r11,%r10,4),%ymm1
 360:	85 c9                	test   %ecx,%ecx
 362:	7e bc                	jle    320 <.omp_outlined.+0x110>
 364:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
 369:	4c 8d 24 b5 00 00 00 	lea    0x0(,%rsi,4),%r12
 370:	00 
 371:	45 31 f6             	xor    %r14d,%r14d
 374:	48 8b 18             	mov    (%rax),%rbx
 377:	48 8b 44 24 20       	mov    0x20(%rsp),%rax
 37c:	4c 03 20             	add    (%rax),%r12
 37f:	90                   	nop
 380:	c4 22 7d 18 0c b3    	vbroadcastss (%rbx,%r14,4),%ymm9
 386:	c4 c2 35 b8 44 24 e0 	vfmadd231ps -0x20(%r12),%ymm9,%ymm0
 38d:	c4 22 7d 18 44 b3 04 	vbroadcastss 0x4(%rbx,%r14,4),%ymm8
 394:	49 8d 44 2c e0       	lea    -0x20(%r12,%rbp,1),%rax
 399:	c4 a2 7d 18 7c b3 08 	vbroadcastss 0x8(%rbx,%r14,4),%ymm7
 3a0:	c4 a2 7d 18 74 b3 0c 	vbroadcastss 0xc(%rbx,%r14,4),%ymm6
 3a7:	c4 a2 7d 18 6c b3 10 	vbroadcastss 0x10(%rbx,%r14,4),%ymm5
 3ae:	c4 a2 7d 18 64 b3 14 	vbroadcastss 0x14(%rbx,%r14,4),%ymm4
 3b5:	c4 a2 7d 18 5c b3 18 	vbroadcastss 0x18(%rbx,%r14,4),%ymm3
 3bc:	c4 c2 35 b8 0c 24    	vfmadd231ps (%r12),%ymm9,%ymm1
 3c2:	c4 a2 7d 18 54 b3 1c 	vbroadcastss 0x1c(%rbx,%r14,4),%ymm2
 3c9:	49 83 c6 08          	add    $0x8,%r14
 3cd:	c4 c2 3d b8 44 2c e0 	vfmadd231ps -0x20(%r12,%rbp,1),%ymm8,%ymm0
 3d4:	49 01 fc             	add    %rdi,%r12
 3d7:	c4 e2 45 b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm7,%ymm0
 3de:	48 01 e8             	add    %rbp,%rax
 3e1:	c4 e2 4d b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm6,%ymm0
 3e8:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 3ec:	c4 e2 55 b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm5,%ymm0
 3f3:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 3f7:	c4 e2 5d b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm4,%ymm0
 3fe:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 402:	c4 e2 65 b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm3,%ymm0
 409:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 40d:	c4 e2 6d b8 44 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm2,%ymm0
 414:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 418:	c4 e2 3d b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm8,%ymm1
 41e:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 422:	c4 e2 45 b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm7,%ymm1
 429:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 42d:	c4 e2 4d b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm6,%ymm1
 434:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 438:	c4 e2 55 b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm5,%ymm1
 43f:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 443:	c4 e2 5d b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm4,%ymm1
 44a:	48 8d 04 28          	lea    (%rax,%rbp,1),%rax
 44e:	c4 e2 65 b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm3,%ymm1
 455:	48 01 e8             	add    %rbp,%rax
 458:	c4 e2 6d b8 4c 05 00 	vfmadd231ps 0x0(%rbp,%rax,1),%ymm2,%ymm1
 45f:	49 39 ce             	cmp    %rcx,%r14
 462:	0f 8c 18 ff ff ff    	jl     380 <.omp_outlined.+0x170>
 468:	e9 b3 fe ff ff       	jmpq   320 <.omp_outlined.+0x110>
...
0000000000000470 <_Z6enablev>:
 ...
 48d:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 494 <_Z6enablev+0x24>

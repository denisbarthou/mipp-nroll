...
0000000000000220 <.omp_outlined.>:
 ...
 2f1:	48 63 c3             	movslq %ebx,%rax
 2f4:	44 89 ce             	mov    %r9d,%esi
 ...
 30b:	48 8d 1c d2          	lea    (%rdx,%rdx,8),%rbx
 30f:	48 8d 3c 95 00 00 00 	lea    0x0(,%rdx,4),%rdi
 316:	00 
 317:	48 8d 1c 5b          	lea    (%rbx,%rbx,2),%rbx
 31b:	48 8d 2c ff          	lea    (%rdi,%rdi,8),%rbp
 31f:	48 01 d3             	add    %rdx,%rbx
 322:	ba 20 00 00 00       	mov    $0x20,%edx
 327:	48 29 da             	sub    %rbx,%rdx
 32a:	eb 40                	jmp    36c <.omp_outlined.+0x14c>
 ...
 3ce:	00 00 
 3d0:	c4 02 7d 18 24 86    	vbroadcastss (%r14,%r8,4),%ymm12
 3d6:	c4 c2 1d b8 47 a0    	vfmadd231ps -0x60(%r15),%ymm12,%ymm0
 3dc:	c4 02 7d 18 5c 86 04 	vbroadcastss 0x4(%r14,%r8,4),%ymm11
 3e3:	4d 8d 6c 3f a0       	lea    -0x60(%r15,%rdi,1),%r13
 3e8:	c4 02 7d 18 54 86 08 	vbroadcastss 0x8(%r14,%r8,4),%ymm10
 3ef:	c4 02 7d 18 4c 86 0c 	vbroadcastss 0xc(%r14,%r8,4),%ymm9
 3f6:	c4 02 7d 18 44 86 10 	vbroadcastss 0x10(%r14,%r8,4),%ymm8
 3fd:	c4 82 7d 18 7c 86 14 	vbroadcastss 0x14(%r14,%r8,4),%ymm7
 404:	c4 82 7d 18 74 86 18 	vbroadcastss 0x18(%r14,%r8,4),%ymm6
 40b:	c4 82 7d 18 6c 86 1c 	vbroadcastss 0x1c(%r14,%r8,4),%ymm5
 412:	c4 c2 1d b8 4f c0    	vfmadd231ps -0x40(%r15),%ymm12,%ymm1
 418:	c4 82 7d 18 64 86 20 	vbroadcastss 0x20(%r14,%r8,4),%ymm4
 41f:	c4 c2 1d b8 57 e0    	vfmadd231ps -0x20(%r15),%ymm12,%ymm2
 425:	c4 c2 1d b8 1f       	vfmadd231ps (%r15),%ymm12,%ymm3
 42a:	49 83 c0 09          	add    $0x9,%r8
 42e:	49 8d 44 3d 00       	lea    0x0(%r13,%rdi,1),%rax
 433:	c4 c2 25 b8 44 3f a0 	vfmadd231ps -0x60(%r15,%rdi,1),%ymm11,%ymm0
 43a:	49 01 ef             	add    %rbp,%r15
 43d:	c4 a2 2d b8 04 2f    	vfmadd231ps (%rdi,%r13,1),%ymm10,%ymm0
 443:	c4 e2 35 b8 04 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm0
 449:	48 01 f8             	add    %rdi,%rax
 44c:	c4 e2 3d b8 04 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm0
 452:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 456:	c4 e2 45 b8 04 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm0
 45c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 460:	c4 e2 4d b8 04 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm0
 466:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 46a:	c4 e2 55 b8 04 07    	vfmadd231ps (%rdi,%rax,1),%ymm5,%ymm0
 470:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 474:	c4 e2 5d b8 04 07    	vfmadd231ps (%rdi,%rax,1),%ymm4,%ymm0
 47a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 47e:	c4 e2 25 b8 0c 02    	vfmadd231ps (%rdx,%rax,1),%ymm11,%ymm1
 484:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 488:	c4 e2 2d b8 0c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm1
 48e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 492:	c4 e2 35 b8 0c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm1
 498:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 49c:	c4 e2 3d b8 0c 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm1
 4a2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4a6:	c4 e2 45 b8 0c 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm1
 4ac:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4b0:	c4 e2 4d b8 0c 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm1
 4b6:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4ba:	c4 e2 55 b8 0c 07    	vfmadd231ps (%rdi,%rax,1),%ymm5,%ymm1
 4c0:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4c4:	c4 e2 5d b8 0c 07    	vfmadd231ps (%rdi,%rax,1),%ymm4,%ymm1
 4ca:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4ce:	c4 e2 25 b8 14 02    	vfmadd231ps (%rdx,%rax,1),%ymm11,%ymm2
 4d4:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 4d8:	c4 e2 2d b8 14 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm2
 4de:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4e2:	c4 e2 35 b8 14 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm2
 4e8:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4ec:	c4 e2 3d b8 14 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm2
 4f2:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 4f6:	c4 e2 45 b8 14 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm2
 4fc:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 500:	c4 e2 4d b8 14 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm2
 506:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 50a:	c4 e2 55 b8 14 07    	vfmadd231ps (%rdi,%rax,1),%ymm5,%ymm2
 510:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 514:	c4 e2 5d b8 14 07    	vfmadd231ps (%rdi,%rax,1),%ymm4,%ymm2
 51a:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 51e:	c4 e2 25 b8 1c 02    	vfmadd231ps (%rdx,%rax,1),%ymm11,%ymm3
 524:	48 8d 04 10          	lea    (%rax,%rdx,1),%rax
 528:	c4 e2 2d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm10,%ymm3
 52e:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 532:	c4 e2 35 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm9,%ymm3
 538:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 53c:	c4 e2 3d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm8,%ymm3
 542:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 546:	c4 e2 45 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm7,%ymm3
 54c:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 550:	c4 e2 4d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm6,%ymm3
 556:	48 8d 04 38          	lea    (%rax,%rdi,1),%rax
 55a:	c4 e2 55 b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm5,%ymm3
 560:	48 01 f8             	add    %rdi,%rax
 563:	c4 e2 5d b8 1c 07    	vfmadd231ps (%rdi,%rax,1),%ymm4,%ymm3
 569:	49 39 c8             	cmp    %rcx,%r8
 56c:	0f 8c 5e fe ff ff    	jl     3d0 <.omp_outlined.+0x1b0>
 572:	e9 b9 fd ff ff       	jmpq   330 <.omp_outlined.+0x110>

...
0000000000000220 <.omp_outlined.>:
 ...
 2ff:	48 8d 2c 95 00 00 00 	lea    0x0(,%rdx,4),%rbp
 306:	00 
 307:	48 8d 5c ad 00       	lea    0x0(%rbp,%rbp,4),%rbx
 30c:	eb 19                	jmp    327 <.omp_outlined.+0x107>
 ...
 36b:	c4 a2 7d 18 54 a6 04 	vbroadcastss 0x4(%rsi,%r12,4),%ymm2
 372:	c4 a2 7d 18 5c a6 08 	vbroadcastss 0x8(%rsi,%r12,4),%ymm3
 379:	4c 8d 34 2f          	lea    (%rdi,%rbp,1),%r14
 37d:	c4 a2 7d 18 64 a6 0c 	vbroadcastss 0xc(%rsi,%r12,4),%ymm4
 384:	c4 a2 7d 18 6c a6 10 	vbroadcastss 0x10(%rsi,%r12,4),%ymm5
 38b:	49 83 c4 05          	add    $0x5,%r12
 38f:	49 01 ee             	add    %rbp,%r14
 392:	c4 e2 6d b8 04 97    	vfmadd231ps (%rdi,%rdx,4),%ymm2,%ymm0
 398:	c4 e2 65 b8 04 d7    	vfmadd231ps (%rdi,%rdx,8),%ymm3,%ymm0
 39e:	48 01 df             	add    %rbx,%rdi
 3a1:	c4 c2 5d b8 04 96    	vfmadd231ps (%r14,%rdx,4),%ymm4,%ymm0
 3a7:	c4 c2 55 b8 04 d6    	vfmadd231ps (%r14,%rdx,8),%ymm5,%ymm0
 3ad:	c5 fc 28 c8          	vmovaps %ymm0,%ymm1
 3b1:	49 39 cc             	cmp    %rcx,%r12
 3b4:	7c aa                	jl     360 <.omp_outlined.+0x140>
 3b6:	e9 59 ff ff ff       	jmpq   314 <.omp_outlined.+0xf4>
...
00000000000003c0 <_Z6enablev>:
 ...
 3d4:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 3db <_Z6enablev+0x1b>

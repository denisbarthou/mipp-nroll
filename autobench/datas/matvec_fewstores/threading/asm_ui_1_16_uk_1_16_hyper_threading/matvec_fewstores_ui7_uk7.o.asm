...
0000000000000230 <.omp_outlined.>:
 ...
 306:	5d                   	pop    %rbp
 307:	c3                   	retq   
 308:	48 63 15 00 00 00 00 	movslq 0x0(%rip),%rdx        # 30f <.omp_outlined.+0xdf>
 ...
 326:	48 8d 04 d2          	lea    (%rdx,%rdx,8),%rax
 32a:	48 8d 2c 40          	lea    (%rax,%rax,2),%rbp
 32e:	48 01 d5             	add    %rdx,%rbp
 331:	48 c1 e2 02          	shl    $0x2,%rdx
 335:	48 8d 04 92          	lea    (%rdx,%rdx,4),%rax
 339:	48 29 c6             	sub    %rax,%rsi
 33c:	eb 64                	jmp    3a2 <.omp_outlined.+0x172>
 ...
 39c:	0f 8d 46 ff ff ff    	jge    2e8 <.omp_outlined.+0xb8>
 ...
 44a:	c4 e2 15 b8 af 60 ff 	vfmadd231ps -0xa0(%rdi),%ymm13,%ymm5
 451:	ff ff 
 453:	c4 a2 7d 18 7c a0 18 	vbroadcastss 0x18(%rax,%r12,4),%ymm7
 45a:	c4 e2 15 b8 67 80    	vfmadd231ps -0x80(%rdi),%ymm13,%ymm4
 460:	c4 e2 15 b8 5f a0    	vfmadd231ps -0x60(%rdi),%ymm13,%ymm3
 466:	c4 e2 15 b8 57 c0    	vfmadd231ps -0x40(%rdi),%ymm13,%ymm2
 46c:	c4 e2 15 b8 4f e0    	vfmadd231ps -0x20(%rdi),%ymm13,%ymm1
 472:	c4 e2 15 b8 07       	vfmadd231ps (%rdi),%ymm13,%ymm0
 477:	49 83 c4 07          	add    $0x7,%r12
 47b:	49 8d 1c 16          	lea    (%r14,%rdx,1),%rbx
 47f:	c4 e2 1d b8 b4 17 40 	vfmadd231ps -0xc0(%rdi,%rdx,1),%ymm12,%ymm6
 486:	ff ff ff 
 489:	48 01 ef             	add    %rbp,%rdi
 48c:	c4 a2 25 b8 34 32    	vfmadd231ps (%rdx,%r14,1),%ymm11,%ymm6
 492:	c4 e2 2d b8 34 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm10,%ymm6
 498:	48 01 d3             	add    %rdx,%rbx
 49b:	c4 e2 35 b8 34 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm6
 4a1:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4a5:	c4 e2 3d b8 34 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm6
 4ab:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4af:	c4 e2 45 b8 34 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm6
 4b5:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4b9:	c4 e2 1d b8 2c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm5
 4bf:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 4c3:	c4 e2 25 b8 2c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm5
 4c9:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4cd:	c4 e2 2d b8 2c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm10,%ymm5
 4d3:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4d7:	c4 e2 35 b8 2c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm5
 4dd:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4e1:	c4 e2 3d b8 2c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm5
 4e7:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4eb:	c4 e2 45 b8 2c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm5
 4f1:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4f5:	c4 e2 1d b8 24 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm4
 4fb:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 4ff:	c4 e2 25 b8 24 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm4
 505:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 509:	c4 e2 2d b8 24 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm10,%ymm4
 50f:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 513:	c4 e2 35 b8 24 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm4
 519:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 51d:	c4 e2 3d b8 24 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm4
 523:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 527:	c4 e2 45 b8 24 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm4
 52d:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 531:	c4 e2 1d b8 1c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm3
 537:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 53b:	c4 e2 25 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm3
 541:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 545:	c4 e2 2d b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm10,%ymm3
 54b:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 54f:	c4 e2 35 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm3
 555:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 559:	c4 e2 3d b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm3
 55f:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 563:	c4 e2 45 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm3
 569:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 56d:	c4 e2 1d b8 14 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm2
 573:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 577:	c4 e2 25 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm2
 57d:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 581:	c4 e2 2d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm10,%ymm2
 587:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 58b:	c4 e2 35 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm2
 591:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 595:	c4 e2 3d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm2
 59b:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 59f:	c4 e2 45 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm2
 5a5:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 5a9:	c4 e2 1d b8 0c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm1
 5af:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 5b3:	c4 e2 25 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm1
 5b9:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 5bd:	c4 e2 2d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm10,%ymm1
 5c3:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 5c7:	c4 e2 35 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm1
 5cd:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 5d1:	c4 e2 3d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm1
 5d7:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 5db:	c4 e2 45 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm1
 5e1:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 5e5:	c4 e2 1d b8 04 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm12,%ymm0
 5eb:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 5ef:	c4 e2 25 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm0
 5f5:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 5f9:	c4 e2 2d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm10,%ymm0
 5ff:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 603:	c4 e2 35 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm9,%ymm0
 609:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 60d:	c4 e2 3d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm8,%ymm0
 613:	48 01 d3             	add    %rdx,%rbx
 616:	c4 e2 45 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm0
 61c:	49 39 cc             	cmp    %rcx,%r12
 61f:	0f 8c eb fd ff ff    	jl     410 <.omp_outlined.+0x1e0>
 625:	e9 16 fd ff ff       	jmpq   340 <.omp_outlined.+0x110>

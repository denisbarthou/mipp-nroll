...
0000000000000220 <.omp_outlined.>:
 ...
 2bd:	4c 63 54 24 08       	movslq 0x8(%rsp),%r10
 ...
 2fe:	4b 8d 14 92          	lea    (%r10,%r10,4),%rdx
 302:	4c 63 c3             	movslq %ebx,%r8
 305:	4c 8d 0c d5 20 00 00 	lea    0x20(,%rdx,8),%r9
 30c:	00 
 ...
 32c:	eb 48                	jmp    376 <.omp_outlined.+0x156>
 32e:	66 90                	xchg   %ax,%ax
 330:	c4 81 7c 11 24 bb    	vmovups %ymm4,(%r11,%r15,4)
 336:	49 83 c1 28          	add    $0x28,%r9
 33a:	49 8b 45 00          	mov    0x0(%r13),%rax
 33e:	c4 a1 7c 11 5c b8 20 	vmovups %ymm3,0x20(%rax,%r15,4)
 345:	49 8b 45 00          	mov    0x0(%r13),%rax
 349:	c4 a1 7c 11 54 b8 40 	vmovups %ymm2,0x40(%rax,%r15,4)
 350:	49 8b 45 00          	mov    0x0(%r13),%rax
 354:	c4 a1 7c 11 4c b8 60 	vmovups %ymm1,0x60(%rax,%r15,4)
 35b:	49 8b 45 00          	mov    0x0(%r13),%rax
 35f:	c4 a1 7c 11 84 b8 80 	vmovups %ymm0,0x80(%rax,%r15,4)
 366:	00 00 00 
 369:	4d 39 c2             	cmp    %r8,%r10
 36c:	4d 8d 52 01          	lea    0x1(%r10),%r10
 370:	0f 8d 5a ff ff ff    	jge    2d0 <.omp_outlined.+0xb0>
 376:	4d 8b 5d 00          	mov    0x0(%r13),%r11
 37a:	4a 8d 04 d5 00 00 00 	lea    0x0(,%r10,8),%rax
 381:	00 
 382:	4c 8d 3c 80          	lea    (%rax,%rax,4),%r15
 386:	c4 81 7c 10 24 bb    	vmovups (%r11,%r15,4),%ymm4
 38c:	c4 81 7c 10 5c bb 20 	vmovups 0x20(%r11,%r15,4),%ymm3
 393:	c4 81 7c 10 54 bb 40 	vmovups 0x40(%r11,%r15,4),%ymm2
 39a:	c4 81 7c 10 4c bb 60 	vmovups 0x60(%r11,%r15,4),%ymm1
 3a1:	c4 81 7c 10 84 bb 80 	vmovups 0x80(%r11,%r15,4),%ymm0
 3a8:	00 00 00 
 3ab:	85 c9                	test   %ecx,%ecx
 3ad:	7e 81                	jle    330 <.omp_outlined.+0x110>
 3af:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
 3b4:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
 3b9:	4a 8d 34 8d 00 00 00 	lea    0x0(,%r9,4),%rsi
 3c0:	00 
 3c1:	45 31 e4             	xor    %r12d,%r12d
 3c4:	48 8b 00             	mov    (%rax),%rax
 3c7:	48 03 33             	add    (%rbx),%rsi
 3ca:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
 3d0:	c4 22 7d 18 24 a0    	vbroadcastss (%rax,%r12,4),%ymm12
 3d6:	c4 e2 1d b8 66 80    	vfmadd231ps -0x80(%rsi),%ymm12,%ymm4
 3dc:	c4 22 7d 18 5c a0 04 	vbroadcastss 0x4(%rax,%r12,4),%ymm11
 3e3:	4c 8d 74 2e 80       	lea    -0x80(%rsi,%rbp,1),%r14
 3e8:	c4 22 7d 18 54 a0 08 	vbroadcastss 0x8(%rax,%r12,4),%ymm10
 3ef:	c4 22 7d 18 4c a0 0c 	vbroadcastss 0xc(%rax,%r12,4),%ymm9
 3f6:	c4 22 7d 18 44 a0 10 	vbroadcastss 0x10(%rax,%r12,4),%ymm8
 3fd:	c4 a2 7d 18 7c a0 14 	vbroadcastss 0x14(%rax,%r12,4),%ymm7
 404:	c4 a2 7d 18 74 a0 18 	vbroadcastss 0x18(%rax,%r12,4),%ymm6
 40b:	c4 e2 1d b8 5e a0    	vfmadd231ps -0x60(%rsi),%ymm12,%ymm3
 411:	c4 a2 7d 18 6c a0 1c 	vbroadcastss 0x1c(%rax,%r12,4),%ymm5
 418:	c4 e2 1d b8 56 c0    	vfmadd231ps -0x40(%rsi),%ymm12,%ymm2
 41e:	c4 e2 1d b8 4e e0    	vfmadd231ps -0x20(%rsi),%ymm12,%ymm1
 424:	c4 e2 1d b8 06       	vfmadd231ps (%rsi),%ymm12,%ymm0
 429:	49 83 c4 08          	add    $0x8,%r12
 42d:	49 8d 1c 2e          	lea    (%r14,%rbp,1),%rbx
 431:	c4 e2 25 b8 64 2e 80 	vfmadd231ps -0x80(%rsi,%rbp,1),%ymm11,%ymm4
 438:	48 01 fe             	add    %rdi,%rsi
 43b:	c4 a2 2d b8 64 35 00 	vfmadd231ps 0x0(%rbp,%r14,1),%ymm10,%ymm4
 442:	c4 e2 35 b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm9,%ymm4
 449:	48 01 eb             	add    %rbp,%rbx
 44c:	c4 e2 3d b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm4
 453:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 457:	c4 e2 45 b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm4
 45e:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 462:	c4 e2 4d b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm4
 469:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 46d:	c4 e2 55 b8 64 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm4
 474:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 478:	c4 e2 25 b8 1c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm3
 47e:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 482:	c4 e2 2d b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm10,%ymm3
 489:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 48d:	c4 e2 35 b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm9,%ymm3
 494:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 498:	c4 e2 3d b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm3
 49f:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4a3:	c4 e2 45 b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm3
 4aa:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4ae:	c4 e2 4d b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm3
 4b5:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4b9:	c4 e2 55 b8 5c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm3
 4c0:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4c4:	c4 e2 25 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm2
 4ca:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 4ce:	c4 e2 2d b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm10,%ymm2
 4d5:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4d9:	c4 e2 35 b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm9,%ymm2
 4e0:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4e4:	c4 e2 3d b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm2
 4eb:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4ef:	c4 e2 45 b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm2
 4f6:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 4fa:	c4 e2 4d b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm2
 501:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 505:	c4 e2 55 b8 54 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm2
 50c:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 510:	c4 e2 25 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm1
 516:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 51a:	c4 e2 2d b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm10,%ymm1
 521:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 525:	c4 e2 35 b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm9,%ymm1
 52c:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 530:	c4 e2 3d b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm1
 537:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 53b:	c4 e2 45 b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm1
 542:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 546:	c4 e2 4d b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm1
 54d:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 551:	c4 e2 55 b8 4c 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm1
 558:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 55c:	c4 e2 25 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm11,%ymm0
 562:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 566:	c4 e2 2d b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm10,%ymm0
 56d:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 571:	c4 e2 35 b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm9,%ymm0
 578:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 57c:	c4 e2 3d b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm8,%ymm0
 583:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 587:	c4 e2 45 b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm7,%ymm0
 58e:	48 8d 1c 2b          	lea    (%rbx,%rbp,1),%rbx
 592:	c4 e2 4d b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm6,%ymm0
 599:	48 01 eb             	add    %rbp,%rbx
 59c:	c4 e2 55 b8 44 1d 00 	vfmadd231ps 0x0(%rbp,%rbx,1),%ymm5,%ymm0
 5a3:	49 39 cc             	cmp    %rcx,%r12
 5a6:	0f 8c 24 fe ff ff    	jl     3d0 <.omp_outlined.+0x1b0>
 5ac:	e9 7f fd ff ff       	jmpq   330 <.omp_outlined.+0x110>
...
00000000000005d0 <_Z9n_reg_maxv>:
 5d0:	b8 35 00 00 00       	mov    $0x35,%eax
 5d5:	c3                   	retq   

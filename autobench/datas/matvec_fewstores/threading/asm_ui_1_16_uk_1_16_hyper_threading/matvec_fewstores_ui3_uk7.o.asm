...
0000000000000230 <.omp_outlined.>:
 ...
 307:	4b 8d 04 5b          	lea    (%r11,%r11,2),%rax
 ...
 338:	eb 33                	jmp    36d <.omp_outlined.+0x13d>
 ...
 3b0:	c4 22 7d 18 0c a7    	vbroadcastss (%rdi,%r12,4),%ymm9
 3b6:	c4 e2 35 b8 50 c0    	vfmadd231ps -0x40(%rax),%ymm9,%ymm2
 3bc:	c4 22 7d 18 44 a7 04 	vbroadcastss 0x4(%rdi,%r12,4),%ymm8
 3c3:	4c 8d 74 10 c0       	lea    -0x40(%rax,%rdx,1),%r14
 3c8:	c4 a2 7d 18 7c a7 08 	vbroadcastss 0x8(%rdi,%r12,4),%ymm7
 3cf:	c4 a2 7d 18 74 a7 0c 	vbroadcastss 0xc(%rdi,%r12,4),%ymm6
 3d6:	c4 a2 7d 18 6c a7 10 	vbroadcastss 0x10(%rdi,%r12,4),%ymm5
 3dd:	c4 a2 7d 18 64 a7 14 	vbroadcastss 0x14(%rdi,%r12,4),%ymm4
 3e4:	c4 e2 35 b8 48 e0    	vfmadd231ps -0x20(%rax),%ymm9,%ymm1
 3ea:	c4 a2 7d 18 5c a7 18 	vbroadcastss 0x18(%rdi,%r12,4),%ymm3
 3f1:	c4 e2 35 b8 00       	vfmadd231ps (%rax),%ymm9,%ymm0
 3f6:	49 83 c4 07          	add    $0x7,%r12
 3fa:	49 8d 1c 16          	lea    (%r14,%rdx,1),%rbx
 3fe:	c4 e2 3d b8 54 10 c0 	vfmadd231ps -0x40(%rax,%rdx,1),%ymm8,%ymm2
 405:	48 01 e8             	add    %rbp,%rax
 408:	c4 a2 45 b8 14 32    	vfmadd231ps (%rdx,%r14,1),%ymm7,%ymm2
 40e:	c4 e2 4d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm2
 414:	48 01 d3             	add    %rdx,%rbx
 417:	c4 e2 55 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm2
 41d:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 421:	c4 e2 5d b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm2
 427:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 42b:	c4 e2 65 b8 14 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm3,%ymm2
 431:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 435:	c4 e2 3d b8 0c 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm8,%ymm1
 43b:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 43f:	c4 e2 45 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm1
 445:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 449:	c4 e2 4d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm1
 44f:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 453:	c4 e2 55 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm1
 459:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 45d:	c4 e2 5d b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm1
 463:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 467:	c4 e2 65 b8 0c 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm3,%ymm1
 46d:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 471:	c4 e2 3d b8 04 1e    	vfmadd231ps (%rsi,%rbx,1),%ymm8,%ymm0
 477:	48 8d 1c 33          	lea    (%rbx,%rsi,1),%rbx
 47b:	c4 e2 45 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm7,%ymm0
 481:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 485:	c4 e2 4d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm6,%ymm0
 48b:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 48f:	c4 e2 55 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm5,%ymm0
 495:	48 8d 1c 13          	lea    (%rbx,%rdx,1),%rbx
 499:	c4 e2 5d b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm4,%ymm0
 49f:	48 01 d3             	add    %rdx,%rbx
 4a2:	c4 e2 65 b8 04 1a    	vfmadd231ps (%rdx,%rbx,1),%ymm3,%ymm0
 4a8:	49 39 cc             	cmp    %rcx,%r12
 4ab:	0f 8c ff fe ff ff    	jl     3b0 <.omp_outlined.+0x180>
 4b1:	e9 8a fe ff ff       	jmpq   340 <.omp_outlined.+0x110>
...
00000000000004c0 <_Z6enablev>:
 ...
 4dd:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 4e4 <_Z6enablev+0x24>

...
0000000000000140 <_Z5benchv>:
 ...
 173:	0f 8e 67 01 00 00    	jle    2e0 <_Z5benchv+0x1a0>
 ...
 19e:	49 81 c1 20 01 00 00 	add    $0x120,%r9
 1a5:	eb 6a                	jmp    211 <_Z5benchv+0xd1>
 1a7:	90                   	nop
 1a8:	90                   	nop
 1a9:	90                   	nop
 1aa:	90                   	nop
 ...
 1b5:	c4 21 7c 11 14 96    	vmovups %ymm10,(%rsi,%r10,4)
 ...
 1fb:	00 00 
 1fd:	48 83 c1 50          	add    $0x50,%rcx
 201:	49 81 c1 40 01 00 00 	add    $0x140,%r9
 208:	4c 39 c1             	cmp    %r8,%rcx
 20b:	0f 83 cf 00 00 00    	jae    2e0 <_Z5benchv+0x1a0>
 211:	49 89 ca             	mov    %rcx,%r10
 214:	c5 7c 10 0c 8e       	vmovups (%rsi,%rcx,4),%ymm9
 219:	c5 fc 10 5c 8e 40    	vmovups 0x40(%rsi,%rcx,4),%ymm3
 21f:	c5 fc 10 54 8e 60    	vmovups 0x60(%rsi,%rcx,4),%ymm2
 225:	c5 fc 10 8c 8e 80 00 	vmovups 0x80(%rsi,%rcx,4),%ymm1
 22c:	00 00 
 22e:	c5 7c 10 84 8e a0 00 	vmovups 0xa0(%rsi,%rcx,4),%ymm8
 235:	00 00 
 237:	c5 fc 10 bc 8e c0 00 	vmovups 0xc0(%rsi,%rcx,4),%ymm7
 23e:	00 00 
 240:	c5 fc 10 b4 8e e0 00 	vmovups 0xe0(%rsi,%rcx,4),%ymm6
 247:	00 00 
 249:	c5 fc 10 ac 8e 00 01 	vmovups 0x100(%rsi,%rcx,4),%ymm5
 250:	00 00 
 252:	c5 fc 10 a4 8e 20 01 	vmovups 0x120(%rsi,%rcx,4),%ymm4
 259:	00 00 
 25b:	49 83 ca 08          	or     $0x8,%r10
 25f:	c4 21 7c 10 14 96    	vmovups (%rsi,%r10,4),%ymm10
 265:	85 ff                	test   %edi,%edi
 267:	0f 8e 43 ff ff ff    	jle    1b0 <_Z5benchv+0x70>
 26d:	4c 89 ca             	mov    %r9,%rdx
 ...
 27e:	90                   	nop
 27f:	90                   	nop
 280:	c4 42 7d 18 1c 9b    	vbroadcastss (%r11,%rbx,4),%ymm11
 286:	c4 62 25 b8 8a e0 fe 	vfmadd231ps -0x120(%rdx),%ymm11,%ymm9
 28d:	ff ff 
 28f:	c4 62 25 b8 92 00 ff 	vfmadd231ps -0x100(%rdx),%ymm11,%ymm10
 296:	ff ff 
 298:	c4 e2 25 b8 9a 20 ff 	vfmadd231ps -0xe0(%rdx),%ymm11,%ymm3
 29f:	ff ff 
 2a1:	c4 e2 25 b8 92 40 ff 	vfmadd231ps -0xc0(%rdx),%ymm11,%ymm2
 2a8:	ff ff 
 2aa:	c4 e2 25 b8 8a 60 ff 	vfmadd231ps -0xa0(%rdx),%ymm11,%ymm1
 2b1:	ff ff 
 2b3:	c4 62 25 b8 42 80    	vfmadd231ps -0x80(%rdx),%ymm11,%ymm8
 2b9:	c4 e2 25 b8 7a a0    	vfmadd231ps -0x60(%rdx),%ymm11,%ymm7
 2bf:	c4 e2 25 b8 72 c0    	vfmadd231ps -0x40(%rdx),%ymm11,%ymm6
 2c5:	c4 e2 25 b8 6a e0    	vfmadd231ps -0x20(%rdx),%ymm11,%ymm5
 2cb:	c4 e2 25 b8 22       	vfmadd231ps (%rdx),%ymm11,%ymm4
 2d0:	48 ff c3             	inc    %rbx
 2d3:	48 01 c2             	add    %rax,%rdx
 2d6:	48 39 df             	cmp    %rbx,%rdi
 2d9:	75 a5                	jne    280 <_Z5benchv+0x140>
 2db:	e9 d0 fe ff ff       	jmpq   1b0 <_Z5benchv+0x70>
 2e0:	0f 31                	rdtsc  
 ...
 31b:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
...
0000000000000330 <_Z6enablev>:
 ...
 337:	b8 50 00 00 00       	mov    $0x50,%eax
 33c:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 341:	0f 45 c8             	cmovne %eax,%ecx
 344:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 34a <_Z6enablev+0x1a>
 34a:	0f 9e c1             	setle  %cl
 34d:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 354 <_Z6enablev+0x24>

...
0000000000000140 <_Z5benchv>:
 ...
 177:	0f 8e ce 01 00 00    	jle    34b <_Z5benchv+0x20b>
 17d:	4c 8b 15 00 00 00 00 	mov    0x0(%rip),%r10        # 184 <_Z5benchv+0x44>
 184:	48 8b 15 00 00 00 00 	mov    0x0(%rip),%rdx        # 18b <_Z5benchv+0x4b>
 18b:	4c 8b 0d 00 00 00 00 	mov    0x0(%rip),%r9        # 192 <_Z5benchv+0x52>
 ...
 1a4:	b9 20 00 00 00       	mov    $0x20,%ecx
 1a9:	4a 8d 34 85 00 00 00 	lea    0x0(,%r8,4),%rsi
 1b0:	00 
 1b1:	45 31 db             	xor    %r11d,%r11d
 1b4:	48 8d 04 40          	lea    (%rax,%rax,2),%rax
 1b8:	49 c1 e6 05          	shl    $0x5,%r14
 1bc:	48 29 c1             	sub    %rax,%rcx
 1bf:	49 83 c2 40          	add    $0x40,%r10
 1c3:	eb 30                	jmp    1f5 <_Z5benchv+0xb5>
 1c5:	90                   	nop
 1c6:	90                   	nop
 1c7:	90                   	nop
 1c8:	90                   	nop
 ...
 1ef:	0f 83 56 01 00 00    	jae    34b <_Z5benchv+0x20b>
 ...
 20c:	7e c2                	jle    1d0 <_Z5benchv+0x90>
 ...
 21e:	90                   	nop
 21f:	90                   	nop
 220:	c4 62 7d 18 1c 82    	vbroadcastss (%rdx,%rax,4),%ymm11
 226:	c4 e2 25 b8 4b c0    	vfmadd231ps -0x40(%rbx),%ymm11,%ymm1
 22c:	c4 62 7d 18 54 82 04 	vbroadcastss 0x4(%rdx,%rax,4),%ymm10
 233:	48 8d 7c 33 c0       	lea    -0x40(%rbx,%rsi,1),%rdi
 238:	c4 62 7d 18 4c 82 08 	vbroadcastss 0x8(%rdx,%rax,4),%ymm9
 23f:	c4 62 7d 18 44 82 0c 	vbroadcastss 0xc(%rdx,%rax,4),%ymm8
 246:	c4 e2 7d 18 7c 82 10 	vbroadcastss 0x10(%rdx,%rax,4),%ymm7
 24d:	c4 e2 7d 18 74 82 14 	vbroadcastss 0x14(%rdx,%rax,4),%ymm6
 254:	c4 e2 7d 18 6c 82 18 	vbroadcastss 0x18(%rdx,%rax,4),%ymm5
 25b:	c4 e2 25 b8 53 e0    	vfmadd231ps -0x20(%rbx),%ymm11,%ymm2
 261:	c4 e2 7d 18 64 82 1c 	vbroadcastss 0x1c(%rdx,%rax,4),%ymm4
 268:	c4 e2 25 b8 1b       	vfmadd231ps (%rbx),%ymm11,%ymm3
 26d:	48 83 c0 08          	add    $0x8,%rax
 271:	c4 e2 2d b8 4c 33 c0 	vfmadd231ps -0x40(%rbx,%rsi,1),%ymm10,%ymm1
 278:	4c 01 f3             	add    %r14,%rbx
 27b:	c4 e2 35 b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm9,%ymm1
 281:	48 01 f7             	add    %rsi,%rdi
 284:	c4 e2 3d b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm8,%ymm1
 28a:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 28e:	c4 e2 45 b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm7,%ymm1
 294:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 298:	c4 e2 4d b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm6,%ymm1
 29e:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2a2:	c4 e2 55 b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm5,%ymm1
 2a8:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2ac:	c4 e2 5d b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm4,%ymm1
 2b2:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2b6:	c4 e2 2d b8 14 39    	vfmadd231ps (%rcx,%rdi,1),%ymm10,%ymm2
 2bc:	48 8d 3c 0f          	lea    (%rdi,%rcx,1),%rdi
 2c0:	c4 e2 35 b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm9,%ymm2
 2c6:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2ca:	c4 e2 3d b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm8,%ymm2
 2d0:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2d4:	c4 e2 45 b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm7,%ymm2
 2da:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2de:	c4 e2 4d b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm6,%ymm2
 2e4:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2e8:	c4 e2 55 b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm5,%ymm2
 2ee:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2f2:	c4 e2 5d b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm4,%ymm2
 2f8:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2fc:	c4 e2 2d b8 1c 39    	vfmadd231ps (%rcx,%rdi,1),%ymm10,%ymm3
 302:	48 8d 3c 0f          	lea    (%rdi,%rcx,1),%rdi
 306:	c4 e2 35 b8 1c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm9,%ymm3
 30c:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 310:	c4 e2 3d b8 1c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm8,%ymm3
 316:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 31a:	c4 e2 45 b8 1c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm7,%ymm3
 320:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 324:	c4 e2 4d b8 1c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm6,%ymm3
 32a:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 32e:	c4 e2 55 b8 1c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm5,%ymm3
 334:	48 01 f7             	add    %rsi,%rdi
 337:	c4 e2 5d b8 1c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm4,%ymm3
 33d:	4c 39 f8             	cmp    %r15,%rax
 340:	0f 8c da fe ff ff    	jl     220 <_Z5benchv+0xe0>
 346:	e9 85 fe ff ff       	jmpq   1d0 <_Z5benchv+0x90>
 34b:	0f 31                	rdtsc  
 34d:	48 c1 e2 20          	shl    $0x20,%rdx
 351:	48 09 c2             	or     %rax,%rdx
 354:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 35a <_Z5benchv+0x21a>
 35a:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 35f:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 367 <_Z5benchv+0x227>
 366:	00 
 367:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 36f <_Z5benchv+0x22f>
 36e:	00 
 36f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 376 <_Z5benchv+0x236>
 376:	01 c0                	add    %eax,%eax
 378:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 37e:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 382:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 386:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 38a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 38e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 392:	5b                   	pop    %rbx
 393:	41 5e                	pop    %r14
 395:	41 5f                	pop    %r15
 397:	c5 f8 77             	vzeroupper 
 39a:	c3                   	retq   
 39b:	90                   	nop
 39c:	90                   	nop
 39d:	90                   	nop

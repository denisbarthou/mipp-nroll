...
0000000000000040 <__cxx_global_var_init.1>:
  40:	55                   	push   %rbp
  ...
  53:	e8 00 00 00 00       	callq  58 <__cxx_global_var_init.1+0x18>
  58:	bf 00 00 00 00       	mov    $0x0,%edi
  5d:	be 00 00 00 00       	mov    $0x0,%esi
  62:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
  66:	e8 00 00 00 00       	callq  6b <__cxx_global_var_init.1+0x2b>
  6b:	e9 00 00 00 00       	jmpq   70 <__cxx_global_var_init.1+0x30>
  70:	48 8d 7d f8          	lea    -0x8(%rbp),%rdi
  74:	e8 00 00 00 00       	callq  79 <__cxx_global_var_init.1+0x39>
  ...
  9a:	00 00 00 
  9d:	e8 00 00 00 00       	callq  a2 <__cxx_global_var_init.1+0x62>
  ...
  b3:	e8 00 00 00 00       	callq  b8 <__cxx_global_var_init.1+0x78>
  b8:	48 8b 7d f0          	mov    -0x10(%rbp),%rdi
  bc:	e8 00 00 00 00       	callq  c1 <__cxx_global_var_init.1+0x81>
  c1:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
  c8:	0f 1f 84 00 00 00 00 
  cf:	00 

00000000000000d0 <__cxx_global_var_init.2>:
  d0:	55                   	push   %rbp
  ...
  ef:	00 00 00 
  f2:	e8 00 00 00 00       	callq  f7 <__cxx_global_var_init.2+0x27>
...
0000000000000130 <__cxx_global_var_init.4>:
 ...
 143:	e8 00 00 00 00       	callq  148 <__cxx_global_var_init.4+0x18>
 148:	bf 00 00 00 00       	mov    $0x0,%edi
 14d:	be 00 00 00 00       	mov    $0x0,%esi
 152:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
 156:	e8 00 00 00 00       	callq  15b <__cxx_global_var_init.4+0x2b>
 15b:	e9 00 00 00 00       	jmpq   160 <__cxx_global_var_init.4+0x30>
 160:	48 8d 7d f8          	lea    -0x8(%rbp),%rdi
 164:	e8 00 00 00 00       	callq  169 <__cxx_global_var_init.4+0x39>
 ...
 18a:	00 00 00 
 18d:	e8 00 00 00 00       	callq  192 <__cxx_global_var_init.4+0x62>
 ...
 1a3:	e8 00 00 00 00       	callq  1a8 <__cxx_global_var_init.4+0x78>
 1a8:	48 8b 7d f0          	mov    -0x10(%rbp),%rdi
 1ac:	e8 00 00 00 00       	callq  1b1 <__cxx_global_var_init.4+0x81>
...
00000000000001c0 <_GLOBAL__sub_I_runner.cpp>:
 ...
 1c9:	e8 72 fe ff ff       	callq  40 <__cxx_global_var_init.1>
 1ce:	e8 fd fe ff ff       	callq  d0 <__cxx_global_var_init.2>
 1d3:	e8 58 ff ff ff       	callq  130 <__cxx_global_var_init.4>
 1d8:	5d                   	pop    %rbp
 1d9:	c3                   	retq   
...
0000000000000000 <__clang_call_terminate>:
   ...
   a:	e8 00 00 00 00       	callq  f <GCC_except_table3+0x3>

...
0000000000000160 <_Z5benchv>:
 ...
 193:	0f 8e 72 0c 00 00    	jle    e0b <_Z5benchv+0xcab>
 ...
 22f:	0f 83 d6 0b 00 00    	jae    e0b <_Z5benchv+0xcab>
 ...
 d87:	48 83 c3 17          	add    $0x17,%rbx
 d8b:	48 0f af f0          	imul   %rax,%rsi
 d8f:	48 01 fe             	add    %rdi,%rsi
 d92:	c4 e2 15 b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm3
 d98:	c4 e2 15 b8 6c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm5
 d9f:	c4 e2 15 b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm7
 da6:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
 dad:	c4 e2 15 b8 8c b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm1
 db4:	00 00 00 
 db7:	c4 e2 15 b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm2
 dbe:	00 00 00 
 dc1:	c4 e2 15 b8 a4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm4
 dc8:	00 00 00 
 dcb:	c4 e2 15 b8 b4 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm6
 dd2:	00 00 00 
 dd5:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
 ddc:	01 00 00 
 ddf:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
 de6:	01 00 00 
 de9:	c4 62 15 b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm11
 df0:	01 00 00 
 df3:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm12
 dfa:	01 00 00 
 dfd:	4c 39 c3             	cmp    %r8,%rbx
 e00:	0f 8c ba f4 ff ff    	jl     2c0 <_Z5benchv+0x160>
 e06:	e9 b5 f3 ff ff       	jmpq   1c0 <_Z5benchv+0x60>
 e0b:	0f 31                	rdtsc  
 e0d:	48 c1 e2 20          	shl    $0x20,%rdx
 e11:	48 09 c2             	or     %rax,%rdx
 e14:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # e1a <_Z5benchv+0xcba>
 e1a:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 e1f:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # e27 <_Z5benchv+0xcc7>
 e26:	00 
 e27:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # e2f <_Z5benchv+0xccf>
 e2e:	00 
 e2f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # e36 <_Z5benchv+0xcd6>
 e36:	01 c0                	add    %eax,%eax
 e38:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 e3e:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 e42:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 e46:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 e4a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 e4e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 e52:	5b                   	pop    %rbx
 e53:	41 5e                	pop    %r14
 e55:	c5 f8 77             	vzeroupper 
 e58:	c3                   	retq   
 e59:	90                   	nop
 e5a:	90                   	nop
 e5b:	90                   	nop
...
0000000000000e60 <_Z6enablev>:
 ...
 e7d:	83 3d 00 00 00 00 16 	cmpl   $0x16,0x0(%rip)        # e84 <_Z6enablev+0x24>
...
0000000000000e90 <_Z9n_reg_maxv>:
 e90:	b8 37 01 00 00       	mov    $0x137,%eax
 e95:	c3                   	retq   

...
matvec_fewstores_ui23_uk21.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e f1 1f 00 00    	jle    2199 <_Z5benchv+0x2039>
     ...
     31c:	0f 83 77 1e 00 00    	jae    2199 <_Z5benchv+0x2039>
    ...
    200f:	48 83 c6 15          	add    $0x15,%rsi
    2013:	49 0f af c2          	imul   %r10,%rax
    2017:	48 01 f8             	add    %rdi,%rax
    201a:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    2021:	02 00 00 
    2024:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    202b:	00 00 00 
    202e:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    2035:	00 00 00 
    2038:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    203f:	01 00 00 
    2042:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    2049:	01 00 00 
    204c:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    2053:	02 00 00 
    2056:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    205c:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    2063:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    206a:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    2071:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    2078:	00 00 00 
    207b:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    2082:	00 00 00 
    2085:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    208c:	01 00 00 
    208f:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    2096:	01 00 00 
    2099:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    209f:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    20a6:	00 00 
    20a8:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    20af:	01 00 00 
    20b2:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    20b9:	00 00 
    20bb:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    20bf:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    20c3:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    20c7:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    20ce:	00 00 
    20d0:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    20d7:	00 00 
    20d9:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    20df:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    20e6:	01 00 00 
    20e9:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    20ef:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    20f5:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    20fc:	01 00 00 
    20ff:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    2105:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    210b:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    2112:	01 00 00 
    2115:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    211b:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    2120:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    2127:	02 00 00 
    212a:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    212f:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2135:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    213c:	02 00 00 
    213f:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    2145:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    214b:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    2152:	02 00 00 
    2155:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    215b:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    2161:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    2168:	02 00 00 
    216b:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    2171:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    2177:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    217e:	02 00 00 
    2181:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    2185:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    218b:	4c 39 c6             	cmp    %r8,%rsi
    218e:	0f 8c fc e2 ff ff    	jl     490 <_Z5benchv+0x330>
    2194:	e9 56 e0 ff ff       	jmpq   1ef <_Z5benchv+0x8f>
    2199:	0f 31                	rdtsc  
    219b:	48 c1 e2 20          	shl    $0x20,%rdx
    219f:	48 09 c2             	or     %rax,%rdx
    21a2:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 21a8 <_Z5benchv+0x2048>
    21a8:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    21ad:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 21b5 <_Z5benchv+0x2055>
    21b4:	00 
    21b5:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 21bd <_Z5benchv+0x205d>
    21bc:	00 
    21bd:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 21c4 <_Z5benchv+0x2064>
    21c4:	01 c0                	add    %eax,%eax
    21c6:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    21cc:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    21d0:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    21d7:	00 00 
    21d9:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    21dd:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    21e1:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    21e5:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    21e9:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    21f0:	c5 f8 77             	vzeroupper 
    21f3:	c3                   	retq   
    21f4:	90                   	nop
    21f5:	90                   	nop
    21f6:	90                   	nop
...
0000000000002200 <_Z6enablev>:
    ...
    2207:	b8 b8 00 00 00       	mov    $0xb8,%eax
    220c:	b9 e9 ff ff ff       	mov    $0xffffffe9,%ecx
    2211:	0f 45 c8             	cmovne %eax,%ecx
    2214:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 221a <_Z6enablev+0x1a>
    221a:	0f 9e c1             	setle  %cl
    221d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 2224 <_Z6enablev+0x24>
...
0000000000002230 <_Z9n_reg_maxv>:
    2230:	b8 0f 02 00 00       	mov    $0x20f,%eax
    2235:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui23_uk21.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000b60 <_Z6enablev>:
 b60:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # b67 <_Z6enablev+0x7>
 b67:	b8 90 00 00 00       	mov    $0x90,%eax
 b6c:	b9 ee ff ff ff       	mov    $0xffffffee,%ecx
 b71:	0f 45 c8             	cmovne %eax,%ecx
 b74:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b7a <_Z6enablev+0x1a>
 b7a:	0f 9e c1             	setle  %cl
 b7d:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # b84 <_Z6enablev+0x24>
 b84:	0f 9f c0             	setg   %al
 b87:	20 c8                	and    %cl,%al
 b89:	c3                   	retq   
 b8a:	90                   	nop
 b8b:	90                   	nop
...
0000000000000b90 <_Z9n_reg_maxv>:
 b90:	b8 84 00 00 00       	mov    $0x84,%eax
 b95:	c3                   	retq   

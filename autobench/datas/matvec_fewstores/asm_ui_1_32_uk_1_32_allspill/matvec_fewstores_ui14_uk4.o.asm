...
0000000000000560 <_Z6enablev>:
 ...
 567:	b8 70 00 00 00       	mov    $0x70,%eax
 56c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 571:	0f 45 c8             	cmovne %eax,%ecx
 574:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 57a <_Z6enablev+0x1a>
 57a:	0f 9e c1             	setle  %cl
 57d:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 584 <_Z6enablev+0x24>
...
0000000000000590 <_Z9n_reg_maxv>:
 590:	b8 4a 00 00 00       	mov    $0x4a,%eax
 595:	c3                   	retq   

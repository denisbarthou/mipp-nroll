...
0000000000001460 <_Z6enablev>:
    ...
    1467:	b8 b0 00 00 00       	mov    $0xb0,%eax
    146c:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    1471:	0f 45 c8             	cmovne %eax,%ecx
    1474:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 147a <_Z6enablev+0x1a>
    147a:	0f 9e c1             	setle  %cl
    147d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # 1484 <_Z6enablev+0x24>
...
0000000000001490 <_Z9n_reg_maxv>:
    1490:	b8 2a 01 00 00       	mov    $0x12a,%eax
    1495:	c3                   	retq   

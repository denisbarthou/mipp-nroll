...
0000000000000f90 <_Z6enablev>:
 ...
 f97:	b8 98 00 00 00       	mov    $0x98,%eax
 f9c:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
 fa1:	0f 45 c8             	cmovne %eax,%ecx
 fa4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # faa <_Z6enablev+0x1a>
 faa:	0f 9e c1             	setle  %cl
 fad:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # fb4 <_Z6enablev+0x24>
...
0000000000000fc0 <_Z9n_reg_maxv>:
 fc0:	b8 c7 00 00 00       	mov    $0xc7,%eax
 fc5:	c3                   	retq   

...
0000000000001210 <_Z6enablev>:
    ...
    1217:	b8 b0 00 00 00       	mov    $0xb0,%eax
    121c:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    1221:	0f 45 c8             	cmovne %eax,%ecx
    1224:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 122a <_Z6enablev+0x1a>
    122a:	0f 9e c1             	setle  %cl
    122d:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # 1234 <_Z6enablev+0x24>
...
0000000000001240 <_Z9n_reg_maxv>:
    1240:	b8 fc 00 00 00       	mov    $0xfc,%eax
    1245:	c3                   	retq   

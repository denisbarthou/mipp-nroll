...
matvec_fewstores_ui9_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e fd 0a 00 00    	jle    c85 <_Z5benchv+0xb35>
 ...
 204:	0f 83 7b 0a 00 00    	jae    c85 <_Z5benchv+0xb35>
 ...
 c1f:	48 83 c7 1b          	add    $0x1b,%rdi
 c23:	49 0f af c3          	imul   %r11,%rax
 c27:	48 01 f0             	add    %rsi,%rax
 c2a:	c4 e2 2d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm10,%ymm1
 c30:	c4 e2 2d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm10,%ymm2
 c37:	c4 e2 2d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm10,%ymm3
 c3e:	c4 e2 2d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm10,%ymm4
 c45:	c4 e2 2d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm10,%ymm5
 c4c:	00 00 00 
 c4f:	c4 e2 2d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm10,%ymm6
 c56:	00 00 00 
 c59:	c4 e2 2d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm10,%ymm7
 c60:	00 00 00 
 c63:	c4 62 2d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm10,%ymm8
 c6a:	00 00 00 
 c6d:	c4 62 2d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm10,%ymm9
 c74:	01 00 00 
 c77:	4c 39 cf             	cmp    %r9,%rdi
 c7a:	0f 8c f0 f5 ff ff    	jl     270 <_Z5benchv+0x120>
 c80:	e9 2b f5 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 c85:	0f 31                	rdtsc  
 c87:	48 c1 e2 20          	shl    $0x20,%rdx
 c8b:	48 09 c2             	or     %rax,%rdx
 c8e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # c94 <_Z5benchv+0xb44>
 c94:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 c99:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # ca1 <_Z5benchv+0xb51>
 ca0:	00 
 ca1:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # ca9 <_Z5benchv+0xb59>
 ca8:	00 
 ca9:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # cb0 <_Z5benchv+0xb60>
 cb0:	01 c0                	add    %eax,%eax
 cb2:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 cb8:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 cbc:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 cc0:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
...
0000000000000cd0 <_Z6enablev>:
 ...
 cd7:	b8 48 00 00 00       	mov    $0x48,%eax
 cdc:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 ce1:	0f 45 c8             	cmovne %eax,%ecx
 ce4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # cea <_Z6enablev+0x1a>
 cea:	0f 9e c1             	setle  %cl
 ced:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # cf4 <_Z6enablev+0x24>
...
0000000000000d00 <_Z9n_reg_maxv>:
 d00:	b8 17 01 00 00       	mov    $0x117,%eax
 d05:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui9_uk27.cpp+0x9a>
  96:	01 00 00 00 

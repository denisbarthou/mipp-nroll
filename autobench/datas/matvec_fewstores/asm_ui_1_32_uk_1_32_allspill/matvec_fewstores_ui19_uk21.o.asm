...
matvec_fewstores_ui19_uk21.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e e5 17 00 00    	jle    197a <_Z5benchv+0x182a>
     ...
     2bc:	0f 83 b8 16 00 00    	jae    197a <_Z5benchv+0x182a>
    ...
    1825:	48 83 c6 15          	add    $0x15,%rsi
    1829:	49 0f af c2          	imul   %r10,%rax
    182d:	48 01 f8             	add    %rdi,%rax
    1830:	c4 e2 5d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm1
    1837:	01 00 00 
    183a:	c4 e2 5d b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm3
    1841:	01 00 00 
    1844:	c4 62 5d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm14
    184b:	01 00 00 
    184e:	c4 62 5d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm12
    1855:	01 00 00 
    1858:	c4 e2 5d b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm7
    185f:	c4 62 5d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm9
    1866:	c4 62 5d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm15
    186d:	01 00 00 
    1870:	c4 e2 5d b8 34 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm6
    1876:	c4 62 5d b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm8
    187d:	00 00 00 
    1880:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm10
    1887:	00 00 00 
    188a:	c4 62 5d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm13
    1891:	01 00 00 
    1894:	c4 62 5d b8 9c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm11
    189b:	00 00 00 
    189e:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    18a5:	00 00 00 
    18a8:	c4 e2 5d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm2
    18af:	02 00 00 
    18b2:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    18b8:	c5 fc 10 6c 24 e0    	vmovups -0x20(%rsp),%ymm5
    18be:	c4 e2 5d b8 6c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm5
    18c5:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    18cc:	00 00 
    18ce:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    18d2:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    18d8:	c4 e2 5d b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm3
    18df:	01 00 00 
    18e2:	c5 7c 11 74 24 60    	vmovups %ymm14,0x60(%rsp)
    18e8:	c4 41 7c 28 f4       	vmovaps %ymm12,%ymm14
    18ed:	c5 7c 10 24 24       	vmovups (%rsp),%ymm12
    18f2:	c4 62 5d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm12
    18f9:	02 00 00 
    18fc:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
    1902:	c4 41 7c 28 fd       	vmovaps %ymm13,%ymm15
    1907:	c5 7c 11 9c 24 c0 00 	vmovups %ymm11,0xc0(%rsp)
    190e:	00 00 
    1910:	c5 fc 11 84 24 a0 00 	vmovups %ymm0,0xa0(%rsp)
    1917:	00 00 
    1919:	c5 fc 11 6c 24 e0    	vmovups %ymm5,-0x20(%rsp)
    191f:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1925:	c4 e2 5d b8 ac 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm5
    192c:	01 00 00 
    192f:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    1935:	c5 fc 10 5c 24 80    	vmovups -0x80(%rsp),%ymm3
    193b:	c4 e2 5d b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm3
    1942:	02 00 00 
    1945:	c5 fc 28 e6          	vmovaps %ymm6,%ymm4
    1949:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    194d:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    1952:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    1958:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    195c:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    1960:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    1966:	c5 fc 11 5c 24 80    	vmovups %ymm3,-0x80(%rsp)
    196c:	4c 39 c6             	cmp    %r8,%rsi
    196f:	0f 8c 4b ea ff ff    	jl     3c0 <_Z5benchv+0x270>
    1975:	e9 4e e8 ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    197a:	0f 31                	rdtsc  
    197c:	48 c1 e2 20          	shl    $0x20,%rdx
    1980:	48 09 c2             	or     %rax,%rdx
    1983:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1989 <_Z5benchv+0x1839>
    1989:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    198e:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1996 <_Z5benchv+0x1846>
    1995:	00 
    1996:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 199e <_Z5benchv+0x184e>
    199d:	00 
    199e:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 19a5 <_Z5benchv+0x1855>
    19a5:	01 c0                	add    %eax,%eax
    19a7:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    19ad:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    19b1:	c5 fb 5c 44 24 38    	vsubsd 0x38(%rsp),%xmm0,%xmm0
    19b7:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
    19bc:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
    19c0:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    19c4:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    19c8:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
    19cf:	c5 f8 77             	vzeroupper 
    19d2:	c3                   	retq   
    19d3:	90                   	nop
    19d4:	90                   	nop
    19d5:	90                   	nop
...
00000000000019e0 <_Z6enablev>:
    ...
    19e7:	b8 98 00 00 00       	mov    $0x98,%eax
    19ec:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    19f1:	0f 45 c8             	cmovne %eax,%ecx
    19f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 19fa <_Z6enablev+0x1a>
    19fa:	0f 9e c1             	setle  %cl
    19fd:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 1a04 <_Z6enablev+0x24>
...
0000000000001a10 <_Z9n_reg_maxv>:
    1a10:	b8 b7 01 00 00       	mov    $0x1b7,%eax
    1a15:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui19_uk21.cpp+0x9a>
  96:	01 00 00 00 

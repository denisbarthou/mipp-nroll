...
00000000000015e0 <_Z6enablev>:
    ...
    15e7:	b8 c8 00 00 00       	mov    $0xc8,%eax
    15ec:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    15f1:	0f 45 c8             	cmovne %eax,%ecx
    15f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 15fa <_Z6enablev+0x1a>
    15fa:	0f 9e c1             	setle  %cl
    15fd:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # 1604 <_Z6enablev+0x24>
...
0000000000001610 <_Z9n_reg_maxv>:
    1610:	b8 1d 01 00 00       	mov    $0x11d,%eax
    1615:	c3                   	retq   

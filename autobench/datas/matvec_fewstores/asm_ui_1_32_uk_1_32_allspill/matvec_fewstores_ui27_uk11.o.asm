...
0000000000001a10 <_Z6enablev>:
    1a10:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1a17 <_Z6enablev+0x7>
    1a17:	b8 d8 00 00 00       	mov    $0xd8,%eax
    1a1c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    1a21:	0f 45 c8             	cmovne %eax,%ecx
    1a24:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1a2a <_Z6enablev+0x1a>
    1a2a:	0f 9e c1             	setle  %cl
    1a2d:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 1a34 <_Z6enablev+0x24>
    1a34:	0f 9f c0             	setg   %al
    1a37:	20 c8                	and    %cl,%al
    1a39:	c3                   	retq   
    1a3a:	90                   	nop
    1a3b:	90                   	nop
    1a3c:	90                   	nop
...
0000000000001a40 <_Z9n_reg_maxv>:
    1a40:	b8 4f 01 00 00       	mov    $0x14f,%eax
    1a45:	c3                   	retq   

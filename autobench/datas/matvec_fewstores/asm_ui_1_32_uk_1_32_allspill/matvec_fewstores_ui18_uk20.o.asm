...
0000000000001710 <_Z6enablev>:
    ...
    1717:	b8 90 00 00 00       	mov    $0x90,%eax
    171c:	b9 ee ff ff ff       	mov    $0xffffffee,%ecx
    1721:	0f 45 c8             	cmovne %eax,%ecx
    1724:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 172a <_Z6enablev+0x1a>
    172a:	0f 9e c1             	setle  %cl
    172d:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # 1734 <_Z6enablev+0x24>
...
0000000000001740 <_Z9n_reg_maxv>:
    1740:	b8 8e 01 00 00       	mov    $0x18e,%eax
    1745:	c3                   	retq   

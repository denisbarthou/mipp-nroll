...
0000000000000990 <_Z6enablev>:
 ...
 997:	b8 c8 00 00 00       	mov    $0xc8,%eax
 99c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
 9a1:	0f 45 c8             	cmovne %eax,%ecx
 9a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 9aa <_Z6enablev+0x1a>
 9aa:	0f 9e c1             	setle  %cl
 9ad:	83 3d 00 00 00 00 01 	cmpl   $0x1,0x0(%rip)        # 9b4 <_Z6enablev+0x24>
...
00000000000009c0 <_Z9n_reg_maxv>:
 9c0:	b8 4d 00 00 00       	mov    $0x4d,%eax
 9c5:	c3                   	retq   

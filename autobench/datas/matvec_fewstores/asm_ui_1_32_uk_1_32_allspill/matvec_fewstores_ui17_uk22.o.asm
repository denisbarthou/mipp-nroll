...
matvec_fewstores_ui17_uk22.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     19c:	0f 8e 42 14 00 00    	jle    15e4 <_Z5benchv+0x1484>
     ...
     29f:	0f 83 3f 13 00 00    	jae    15e4 <_Z5benchv+0x1484>
    ...
    11a7:	49 0f af c2          	imul   %r10,%rax
    11ab:	48 01 f8             	add    %rdi,%rax
    11ae:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    11b4:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    11bb:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    11c2:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    11c9:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    11d0:	00 00 00 
    11d3:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    11da:	00 00 00 
    11dd:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    11e4:	00 00 00 
    11e7:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    11ee:	01 00 00 
    11f1:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    11f8:	01 00 00 
    11fb:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    1202:	01 00 00 
    1205:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    120c:	01 00 00 
    120f:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    1216:	01 00 00 
    1219:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    1220:	01 00 00 
    1223:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    122a:	02 00 00 
    122d:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1233:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1239:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    1240:	00 00 00 
    1243:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    1249:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    124f:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    1256:	01 00 00 
    1259:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    125f:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1265:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    126c:	01 00 00 
    126f:	48 8d 46 12          	lea    0x12(%rsi),%rax
    1273:	c4 e2 7d 18 54 b2 48 	vbroadcastss 0x48(%rdx,%rsi,4),%ymm2
    127a:	49 0f af c2          	imul   %r10,%rax
    127e:	48 01 f8             	add    %rdi,%rax
    1281:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1287:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    128e:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    1295:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    129c:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    12a3:	00 00 00 
    12a6:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    12ad:	00 00 00 
    12b0:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    12b7:	00 00 00 
    12ba:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    12c1:	01 00 00 
    12c4:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    12cb:	01 00 00 
    12ce:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    12d5:	01 00 00 
    12d8:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    12df:	01 00 00 
    12e2:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    12e9:	01 00 00 
    12ec:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    12f3:	01 00 00 
    12f6:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    12fd:	02 00 00 
    1300:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1306:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    130c:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    1313:	00 00 00 
    1316:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    131c:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1322:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    1329:	01 00 00 
    132c:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    1332:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1338:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    133f:	01 00 00 
    1342:	48 8d 46 13          	lea    0x13(%rsi),%rax
    1346:	c4 e2 7d 18 54 b2 4c 	vbroadcastss 0x4c(%rdx,%rsi,4),%ymm2
    134d:	49 0f af c2          	imul   %r10,%rax
    1351:	48 01 f8             	add    %rdi,%rax
    1354:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    135a:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1361:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    1368:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    136f:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1376:	00 00 00 
    1379:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1380:	00 00 00 
    1383:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    138a:	00 00 00 
    138d:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1394:	01 00 00 
    1397:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    139e:	01 00 00 
    13a1:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    13a8:	01 00 00 
    13ab:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    13b2:	01 00 00 
    13b5:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    13bc:	01 00 00 
    13bf:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    13c6:	01 00 00 
    13c9:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    13d0:	02 00 00 
    13d3:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    13d9:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    13df:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    13e6:	00 00 00 
    13e9:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    13ef:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    13f5:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    13fc:	01 00 00 
    13ff:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    1405:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    140b:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    1412:	01 00 00 
    1415:	48 8d 46 14          	lea    0x14(%rsi),%rax
    1419:	c4 e2 7d 18 54 b2 50 	vbroadcastss 0x50(%rdx,%rsi,4),%ymm2
    1420:	49 0f af c2          	imul   %r10,%rax
    1424:	48 01 f8             	add    %rdi,%rax
    1427:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    142d:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1434:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    143b:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    1442:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1449:	00 00 00 
    144c:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1453:	00 00 00 
    1456:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    145d:	00 00 00 
    1460:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1467:	01 00 00 
    146a:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1471:	01 00 00 
    1474:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    147b:	01 00 00 
    147e:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    1485:	01 00 00 
    1488:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    148f:	01 00 00 
    1492:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    1499:	01 00 00 
    149c:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    14a3:	02 00 00 
    14a6:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    14ac:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    14b2:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    14b9:	00 00 00 
    14bc:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    14c2:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    14c8:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    14cf:	01 00 00 
    14d2:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    14d8:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    14de:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    14e5:	01 00 00 
    14e8:	48 8d 46 15          	lea    0x15(%rsi),%rax
    14ec:	c4 e2 7d 18 54 b2 54 	vbroadcastss 0x54(%rdx,%rsi,4),%ymm2
    14f3:	48 83 c6 16          	add    $0x16,%rsi
    14f7:	49 0f af c2          	imul   %r10,%rax
    14fb:	48 01 f8             	add    %rdi,%rax
    14fe:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    1505:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    150b:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1512:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    1519:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1520:	00 00 00 
    1523:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    152a:	00 00 00 
    152d:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    1534:	00 00 00 
    1537:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    153e:	01 00 00 
    1541:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1548:	01 00 00 
    154b:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    1552:	01 00 00 
    1555:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    155c:	01 00 00 
    155f:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    1566:	01 00 00 
    1569:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    1570:	01 00 00 
    1573:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    157a:	02 00 00 
    157d:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1583:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1589:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    1590:	00 00 00 
    1593:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    1598:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    159e:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm6
    15a5:	01 00 00 
    15a8:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    15ae:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    15b4:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    15bb:	01 00 00 
    15be:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    15c2:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    15c6:	c5 7c 29 f4          	vmovaps %ymm14,%ymm4
    15ca:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    15d0:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    15d6:	4c 39 c6             	cmp    %r8,%rsi
    15d9:	0f 8c a1 ed ff ff    	jl     380 <_Z5benchv+0x220>
    15df:	e9 fd eb ff ff       	jmpq   1e1 <_Z5benchv+0x81>
    15e4:	0f 31                	rdtsc  
    15e6:	48 c1 e2 20          	shl    $0x20,%rdx
    15ea:	48 09 c2             	or     %rax,%rdx
    15ed:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 15f3 <_Z5benchv+0x1493>
    15f3:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    15f8:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1600 <_Z5benchv+0x14a0>
    15ff:	00 
    1600:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1608 <_Z5benchv+0x14a8>
    1607:	00 
    1608:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 160f <_Z5benchv+0x14af>
    160f:	01 c0                	add    %eax,%eax
    1611:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1617:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    161b:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1621:	c4 41 08 57 f6       	vxorps %xmm14,%xmm14,%xmm14
    1626:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    162a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    162e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1632:	48 83 c4 38          	add    $0x38,%rsp
...
0000000000001640 <_Z6enablev>:
    ...
    1647:	b8 88 00 00 00       	mov    $0x88,%eax
    164c:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1651:	0f 45 c8             	cmovne %eax,%ecx
    1654:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 165a <_Z6enablev+0x1a>
    165a:	0f 9e c1             	setle  %cl
    165d:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 1664 <_Z6enablev+0x24>
...
0000000000001670 <_Z9n_reg_maxv>:
    1670:	b8 9d 01 00 00       	mov    $0x19d,%eax
    1675:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui17_uk22.cpp+0x9a>
  96:	01 00 00 00 

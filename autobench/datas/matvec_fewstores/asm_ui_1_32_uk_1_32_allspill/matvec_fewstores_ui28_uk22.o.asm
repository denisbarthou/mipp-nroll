...
0000000000000160 <_Z5benchv>:
     ...
     1a7:	0f 8e fc 2e 00 00    	jle    30a9 <_Z5benchv+0x2f49>
     ...
     3a9:	0f 83 fa 2c 00 00    	jae    30a9 <_Z5benchv+0x2f49>
    ...
    2e63:	48 83 c3 16          	add    $0x16,%rbx
    2e67:	49 0f af c7          	imul   %r15,%rax
    2e6b:	48 01 f8             	add    %rdi,%rax
    2e6e:	c4 e2 15 b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm13,%ymm1
    2e75:	00 00 00 
    2e78:	c4 e2 15 b8 b4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm13,%ymm6
    2e7f:	01 00 00 
    2e82:	c4 62 15 b8 9c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm13,%ymm11
    2e89:	02 00 00 
    2e8c:	c4 e2 15 b8 ac 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm13,%ymm5
    2e93:	02 00 00 
    2e96:	c4 62 15 b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm13,%ymm15
    2e9d:	00 00 00 
    2ea0:	c4 e2 15 b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm13,%ymm0
    2ea6:	c4 e2 15 b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm13,%ymm2
    2ead:	c4 e2 15 b8 64 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm13,%ymm4
    2eb4:	c4 e2 15 b8 9c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm13,%ymm3
    2ebb:	00 00 00 
    2ebe:	c4 62 15 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm13,%ymm10
    2ec5:	01 00 00 
    2ec8:	c4 62 15 b8 a4 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm13,%ymm12
    2ecf:	03 00 00 
    2ed2:	c4 62 15 b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm13,%ymm14
    2ed9:	00 00 00 
    2edc:	c4 62 15 b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm13,%ymm9
    2ee3:	c4 62 15 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm13,%ymm8
    2eea:	01 00 00 
    2eed:	c5 fc 11 bc 24 20 01 	vmovups %ymm7,0x120(%rsp)
    2ef4:	00 00 
    2ef6:	c5 fc 10 bc 24 00 01 	vmovups 0x100(%rsp),%ymm7
    2efd:	00 00 
    2eff:	c4 e2 15 b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm13,%ymm7
    2f06:	01 00 00 
    2f09:	c5 fc 11 8c 24 80 01 	vmovups %ymm1,0x180(%rsp)
    2f10:	00 00 
    2f12:	c5 fc 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm1
    2f19:	00 00 
    2f1b:	c4 e2 15 b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm13,%ymm1
    2f22:	01 00 00 
    2f25:	c5 7c 11 bc 24 a0 01 	vmovups %ymm15,0x1a0(%rsp)
    2f2c:	00 00 
    2f2e:	c5 7c 28 f8          	vmovaps %ymm0,%ymm15
    2f32:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    2f36:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    2f3a:	c5 7c 29 e3          	vmovaps %ymm12,%ymm3
    2f3e:	c5 7c 11 b4 24 60 01 	vmovups %ymm14,0x160(%rsp)
    2f45:	00 00 
    2f47:	c5 fc 11 bc 24 00 01 	vmovups %ymm7,0x100(%rsp)
    2f4e:	00 00 
    2f50:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    2f56:	c4 e2 15 b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm13,%ymm7
    2f5d:	01 00 00 
    2f60:	c5 fc 11 8c 24 a0 00 	vmovups %ymm1,0xa0(%rsp)
    2f67:	00 00 
    2f69:	c5 fc 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm1
    2f70:	00 00 
    2f72:	c4 e2 15 b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm13,%ymm1
    2f79:	01 00 00 
    2f7c:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    2f82:	c5 fc 10 bc 24 00 01 	vmovups 0x100(%rsp),%ymm7
    2f89:	00 00 
    2f8b:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    2f92:	00 00 
    2f94:	c5 fc 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm1
    2f9b:	00 00 
    2f9d:	c4 e2 15 b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm13,%ymm1
    2fa4:	01 00 00 
    2fa7:	c5 fc 11 8c 24 c0 00 	vmovups %ymm1,0xc0(%rsp)
    2fae:	00 00 
    2fb0:	c5 fc 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm1
    2fb7:	00 00 
    2fb9:	c4 e2 15 b8 8c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm13,%ymm1
    2fc0:	02 00 00 
    2fc3:	c5 fc 11 8c 24 e0 00 	vmovups %ymm1,0xe0(%rsp)
    2fca:	00 00 
    2fcc:	c5 fc 10 4c 24 20    	vmovups 0x20(%rsp),%ymm1
    2fd2:	c4 e2 15 b8 8c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm13,%ymm1
    2fd9:	02 00 00 
    2fdc:	c5 fc 11 4c 24 20    	vmovups %ymm1,0x20(%rsp)
    2fe2:	c5 fc 10 4c 24 40    	vmovups 0x40(%rsp),%ymm1
    2fe8:	c4 e2 15 b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm13,%ymm1
    2fef:	02 00 00 
    2ff2:	c5 fc 11 4c 24 40    	vmovups %ymm1,0x40(%rsp)
    2ff8:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    2ffe:	c4 e2 15 b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm13,%ymm1
    3005:	02 00 00 
    3008:	c5 fc 11 4c 24 60    	vmovups %ymm1,0x60(%rsp)
    300e:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    3014:	c4 e2 15 b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm13,%ymm1
    301b:	02 00 00 
    301e:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    3024:	c5 fc 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm1
    302a:	c4 e2 15 b8 8c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm13,%ymm1
    3031:	02 00 00 
    3034:	c5 fc 11 4c 24 e0    	vmovups %ymm1,-0x20(%rsp)
    303a:	c5 fc 10 0c 24       	vmovups (%rsp),%ymm1
    303f:	c4 e2 15 b8 8c 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm13,%ymm1
    3046:	03 00 00 
    3049:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    304e:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    3054:	c4 e2 15 b8 8c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm13,%ymm1
    305b:	03 00 00 
    305e:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    3064:	c5 fc 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm1
    306b:	00 00 
    306d:	c4 e2 15 b8 8c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm13,%ymm1
    3074:	03 00 00 
    3077:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    307c:	c5 7c 28 dd          	vmovaps %ymm5,%ymm11
    3080:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    3084:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    308a:	c5 fc 11 8c 24 20 01 	vmovups %ymm1,0x120(%rsp)
    3091:	00 00 
    3093:	c5 fc 28 cc          	vmovaps %ymm4,%ymm1
    3097:	c5 7c 29 d4          	vmovaps %ymm10,%ymm4
    309b:	4c 39 c3             	cmp    %r8,%rbx
    309e:	0f 8c 4c d5 ff ff    	jl     5f0 <_Z5benchv+0x490>
    30a4:	e9 7d d1 ff ff       	jmpq   226 <_Z5benchv+0xc6>
    30a9:	0f 31                	rdtsc  
    30ab:	48 c1 e2 20          	shl    $0x20,%rdx
    30af:	48 09 c2             	or     %rax,%rdx
    30b2:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 30b8 <_Z5benchv+0x2f58>
    30b8:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    30bd:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 30c5 <_Z5benchv+0x2f65>
    30c4:	00 
    30c5:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 30cd <_Z5benchv+0x2f6d>
    30cc:	00 
    30cd:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 30d4 <_Z5benchv+0x2f74>
    30d4:	01 c0                	add    %eax,%eax
    30d6:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    30dc:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    30e0:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    30e7:	00 00 
    30e9:	c4 41 08 57 f6       	vxorps %xmm14,%xmm14,%xmm14
    30ee:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    30f2:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    30f6:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    30fa:	48 81 c4 a0 02 00 00 	add    $0x2a0,%rsp
    3101:	5b                   	pop    %rbx
    3102:	41 5e                	pop    %r14
    3104:	41 5f                	pop    %r15
    3106:	c5 f8 77             	vzeroupper 
    3109:	c3                   	retq   
    310a:	90                   	nop
    310b:	90                   	nop
    310c:	90                   	nop
...
0000000000003110 <_Z6enablev>:
    ...
    3117:	b8 e0 00 00 00       	mov    $0xe0,%eax
    311c:	b9 e4 ff ff ff       	mov    $0xffffffe4,%ecx
    3121:	0f 45 c8             	cmovne %eax,%ecx
    3124:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 312a <_Z6enablev+0x1a>
    312a:	0f 9e c1             	setle  %cl
    312d:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 3134 <_Z6enablev+0x24>
...
0000000000003140 <_Z9n_reg_maxv>:
    3140:	b8 9a 02 00 00       	mov    $0x29a,%eax
    3145:	c3                   	retq   

...
matvec_fewstores_ui24_uk19.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     19a:	0f 8e c3 1f 00 00    	jle    2163 <_Z5benchv+0x2013>
     ...
     314:	0f 83 49 1e 00 00    	jae    2163 <_Z5benchv+0x2013>
    ...
    1f95:	48 83 c3 13          	add    $0x13,%rbx
    1f99:	48 0f af e8          	imul   %rax,%rbp
    1f9d:	48 01 fd             	add    %rdi,%rbp
    1fa0:	c4 e2 35 b8 9c a9 a0 	vfmadd231ps 0x1a0(%rcx,%rbp,4),%ymm9,%ymm3
    1fa7:	01 00 00 
    1faa:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm6
    1fb1:	00 00 00 
    1fb4:	c4 e2 35 b8 8c a9 e0 	vfmadd231ps 0x2e0(%rcx,%rbp,4),%ymm9,%ymm1
    1fbb:	02 00 00 
    1fbe:	c4 62 35 b8 2c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm13
    1fc4:	c4 62 35 b8 74 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm14
    1fcb:	c4 62 35 b8 7c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm15
    1fd2:	c4 e2 35 b8 94 a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm2
    1fd9:	00 00 00 
    1fdc:	c4 62 35 b8 94 a9 00 	vfmadd231ps 0x100(%rcx,%rbp,4),%ymm9,%ymm10
    1fe3:	01 00 00 
    1fe6:	c4 62 35 b8 9c a9 20 	vfmadd231ps 0x120(%rcx,%rbp,4),%ymm9,%ymm11
    1fed:	01 00 00 
    1ff0:	c4 62 35 b8 a4 a9 40 	vfmadd231ps 0x140(%rcx,%rbp,4),%ymm9,%ymm12
    1ff7:	01 00 00 
    1ffa:	c4 62 35 b8 84 a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm8
    2001:	00 00 00 
    2004:	c4 e2 35 b8 a4 a9 80 	vfmadd231ps 0x180(%rcx,%rbp,4),%ymm9,%ymm4
    200b:	01 00 00 
    200e:	c4 e2 35 b8 7c a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm7
    2015:	c4 e2 35 b8 ac a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm5
    201c:	00 00 00 
    201f:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    2025:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    202c:	00 00 
    202e:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    2035:	00 00 
    2037:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x1c0(%rcx,%rbp,4),%ymm9,%ymm3
    203e:	01 00 00 
    2041:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    2048:	00 00 
    204a:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    2050:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x160(%rcx,%rbp,4),%ymm9,%ymm6
    2057:	01 00 00 
    205a:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    2061:	00 00 
    2063:	c5 7c 29 d1          	vmovaps %ymm10,%ymm1
    2067:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    206c:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    2071:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    2076:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    207b:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    2080:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    2084:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    208b:	00 00 
    208d:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    2092:	c4 e2 35 b8 9c a9 00 	vfmadd231ps 0x200(%rcx,%rbp,4),%ymm9,%ymm3
    2099:	02 00 00 
    209c:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    20a2:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    20a9:	00 00 
    20ab:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0x1e0(%rcx,%rbp,4),%ymm9,%ymm6
    20b2:	01 00 00 
    20b5:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    20bb:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    20c0:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    20c6:	c4 e2 35 b8 9c a9 40 	vfmadd231ps 0x240(%rcx,%rbp,4),%ymm9,%ymm3
    20cd:	02 00 00 
    20d0:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    20d7:	00 00 
    20d9:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    20df:	c4 e2 35 b8 b4 a9 20 	vfmadd231ps 0x220(%rcx,%rbp,4),%ymm9,%ymm6
    20e6:	02 00 00 
    20e9:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    20ef:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    20f5:	c4 e2 35 b8 9c a9 80 	vfmadd231ps 0x280(%rcx,%rbp,4),%ymm9,%ymm3
    20fc:	02 00 00 
    20ff:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    2105:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    210b:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x260(%rcx,%rbp,4),%ymm9,%ymm6
    2112:	02 00 00 
    2115:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    211b:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    2121:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x2c0(%rcx,%rbp,4),%ymm9,%ymm3
    2128:	02 00 00 
    212b:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    2131:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2137:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0x2a0(%rcx,%rbp,4),%ymm9,%ymm6
    213e:	02 00 00 
    2141:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    2145:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    214b:	c5 7c 29 c3          	vmovaps %ymm8,%ymm3
    214f:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    2155:	4c 39 c3             	cmp    %r8,%rbx
    2158:	0f 8c 62 e3 ff ff    	jl     4c0 <_Z5benchv+0x370>
    215e:	e9 92 e0 ff ff       	jmpq   1f5 <_Z5benchv+0xa5>
    2163:	0f 31                	rdtsc  
    2165:	48 c1 e2 20          	shl    $0x20,%rdx
    2169:	48 09 c2             	or     %rax,%rdx
    216c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2172 <_Z5benchv+0x2022>
    2172:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2177:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 217f <_Z5benchv+0x202f>
    217e:	00 
    217f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2187 <_Z5benchv+0x2037>
    2186:	00 
    2187:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 218e <_Z5benchv+0x203e>
    218e:	01 c0                	add    %eax,%eax
    2190:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2196:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    219a:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    21a1:	00 00 
    21a3:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    21a7:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    21ab:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    21af:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    21b3:	48 81 c4 a8 01 00 00 	add    $0x1a8,%rsp
    21ba:	5b                   	pop    %rbx
    21bb:	41 5c                	pop    %r12
    21bd:	41 5d                	pop    %r13
    21bf:	41 5e                	pop    %r14
...
00000000000021d0 <_Z6enablev>:
    ...
    21d7:	b8 c0 00 00 00       	mov    $0xc0,%eax
    21dc:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    21e1:	0f 45 c8             	cmovne %eax,%ecx
    21e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 21ea <_Z6enablev+0x1a>
    21ea:	0f 9e c1             	setle  %cl
    21ed:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # 21f4 <_Z6enablev+0x24>
...
0000000000002200 <_Z9n_reg_maxv>:
    2200:	b8 f3 01 00 00       	mov    $0x1f3,%eax
    2205:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui24_uk19.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000001160 <_Z6enablev>:
    ...
    1167:	b8 80 00 00 00       	mov    $0x80,%eax
    116c:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
    1171:	0f 45 c8             	cmovne %eax,%ecx
    1174:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 117a <_Z6enablev+0x1a>
    117a:	0f 9e c1             	setle  %cl
    117d:	83 3d 00 00 00 00 0f 	cmpl   $0xf,0x0(%rip)        # 1184 <_Z6enablev+0x24>
...
0000000000001190 <_Z9n_reg_maxv>:
    1190:	b8 20 01 00 00       	mov    $0x120,%eax
    1195:	c3                   	retq   

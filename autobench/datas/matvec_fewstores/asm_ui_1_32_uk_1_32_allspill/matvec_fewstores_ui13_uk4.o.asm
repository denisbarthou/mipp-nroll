...
0000000000000510 <_Z6enablev>:
 ...
 517:	b8 68 00 00 00       	mov    $0x68,%eax
 51c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 521:	0f 45 c8             	cmovne %eax,%ecx
 524:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 52a <_Z6enablev+0x1a>
 52a:	0f 9e c1             	setle  %cl
 52d:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 534 <_Z6enablev+0x24>
...
0000000000000540 <_Z9n_reg_maxv>:
 540:	b8 45 00 00 00       	mov    $0x45,%eax
 545:	c3                   	retq   

...
matvec_fewstores_ui28_uk25.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     1a3:	0f 8e 4c 34 00 00    	jle    35f5 <_Z5benchv+0x3495>
     ...
     38f:	0f 83 60 32 00 00    	jae    35f5 <_Z5benchv+0x3495>
    ...
    33c4:	48 83 c3 19          	add    $0x19,%rbx
    33c8:	48 0f af f0          	imul   %rax,%rsi
    33cc:	48 01 fe             	add    %rdi,%rsi
    33cf:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm3
    33d6:	00 00 00 
    33d9:	c4 e2 15 b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm2
    33e0:	c4 e2 15 b8 64 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm4
    33e7:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
    33ee:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
    33f5:	01 00 00 
    33f8:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
    33ff:	01 00 00 
    3402:	c4 e2 15 b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm6
    3409:	01 00 00 
    340c:	c4 62 15 b8 9c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm13,%ymm11
    3413:	02 00 00 
    3416:	c4 e2 15 b8 ac b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm13,%ymm5
    341d:	02 00 00 
    3420:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm13,%ymm12
    3427:	03 00 00 
    342a:	c4 e2 15 b8 04 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm0
    3430:	c4 62 15 b8 b4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm14
    3437:	00 00 00 
    343a:	c4 62 15 b8 bc b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm15
    3441:	00 00 00 
    3444:	c4 e2 15 b8 8c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm1
    344b:	00 00 00 
    344e:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    3454:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    345a:	c4 e2 15 b8 bc b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm7
    3461:	01 00 00 
    3464:	c5 fc 11 9c 24 80 01 	vmovups %ymm3,0x180(%rsp)
    346b:	00 00 
    346d:	c5 fc 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm3
    3474:	00 00 
    3476:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm13,%ymm3
    347d:	01 00 00 
    3480:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    3486:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    348c:	c4 e2 15 b8 bc b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm13,%ymm7
    3493:	01 00 00 
    3496:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    349d:	00 00 
    349f:	c5 fc 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm3
    34a6:	00 00 
    34a8:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm13,%ymm3
    34af:	01 00 00 
    34b2:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    34b8:	c5 fc 28 fa          	vmovaps %ymm2,%ymm7
    34bc:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    34c2:	c5 fc 11 9c 24 c0 00 	vmovups %ymm3,0xc0(%rsp)
    34c9:	00 00 
    34cb:	c5 fc 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm3
    34d2:	00 00 
    34d4:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm13,%ymm3
    34db:	01 00 00 
    34de:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    34e5:	00 00 
    34e7:	c5 fc 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm3
    34ee:	00 00 
    34f0:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm13,%ymm3
    34f7:	02 00 00 
    34fa:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    3501:	00 00 
    3503:	c5 fc 10 5c 24 60    	vmovups 0x60(%rsp),%ymm3
    3509:	c4 e2 15 b8 9c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm13,%ymm3
    3510:	02 00 00 
    3513:	c5 fc 11 5c 24 60    	vmovups %ymm3,0x60(%rsp)
    3519:	c5 fc 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm3
    3520:	00 00 
    3522:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm13,%ymm3
    3529:	02 00 00 
    352c:	c5 fc 11 9c 24 80 00 	vmovups %ymm3,0x80(%rsp)
    3533:	00 00 
    3535:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    353c:	00 00 
    353e:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm13,%ymm3
    3545:	02 00 00 
    3548:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    354f:	00 00 
    3551:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    3556:	c4 e2 15 b8 9c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm13,%ymm3
    355d:	02 00 00 
    3560:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    3565:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    356b:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm13,%ymm3
    3572:	02 00 00 
    3575:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    357b:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    3581:	c4 e2 15 b8 9c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm13,%ymm3
    3588:	03 00 00 
    358b:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    3591:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    3597:	c4 e2 15 b8 9c b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm13,%ymm3
    359e:	03 00 00 
    35a1:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    35a7:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    35ad:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm13,%ymm3
    35b4:	03 00 00 
    35b7:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    35bd:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    35c1:	c5 7c 29 c4          	vmovaps %ymm8,%ymm4
    35c5:	c4 41 7c 28 c3       	vmovaps %ymm11,%ymm8
    35ca:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    35cf:	c4 41 7c 28 e1       	vmovaps %ymm9,%ymm12
    35d4:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    35d9:	c5 7c 28 d5          	vmovaps %ymm5,%ymm10
    35dd:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    35e1:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    35e7:	4c 39 c3             	cmp    %r8,%rbx
    35ea:	0f 8c d0 cf ff ff    	jl     5c0 <_Z5benchv+0x460>
    35f0:	e9 26 cc ff ff       	jmpq   21b <_Z5benchv+0xbb>
    35f5:	0f 31                	rdtsc  
    35f7:	48 c1 e2 20          	shl    $0x20,%rdx
    35fb:	48 09 c2             	or     %rax,%rdx
    35fe:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3604 <_Z5benchv+0x34a4>
    3604:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3609:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3611 <_Z5benchv+0x34b1>
    3610:	00 
    3611:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3619 <_Z5benchv+0x34b9>
    3618:	00 
    3619:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3620 <_Z5benchv+0x34c0>
    3620:	01 c0                	add    %eax,%eax
    3622:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3628:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    362c:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    3633:	00 00 
    3635:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    363a:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    363e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3642:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3646:	48 81 c4 68 02 00 00 	add    $0x268,%rsp
    364d:	5b                   	pop    %rbx
    364e:	41 5e                	pop    %r14
    3650:	c5 f8 77             	vzeroupper 
    3653:	c3                   	retq   
    3654:	90                   	nop
    3655:	90                   	nop
    3656:	90                   	nop
...
0000000000003660 <_Z6enablev>:
    3660:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3667 <_Z6enablev+0x7>
    3667:	b8 e0 00 00 00       	mov    $0xe0,%eax
    366c:	b9 e4 ff ff ff       	mov    $0xffffffe4,%ecx
    3671:	0f 45 c8             	cmovne %eax,%ecx
    3674:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 367a <_Z6enablev+0x1a>
    367a:	0f 9e c1             	setle  %cl
    367d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 3684 <_Z6enablev+0x24>
    3684:	0f 9f c0             	setg   %al
    3687:	20 c8                	and    %cl,%al
    3689:	c3                   	retq   
    368a:	90                   	nop
    368b:	90                   	nop
    368c:	90                   	nop
...
0000000000003690 <_Z9n_reg_maxv>:
    3690:	b8 f1 02 00 00       	mov    $0x2f1,%eax
    3695:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui28_uk25.cpp+0x9a>
  96:	01 00 00 00 

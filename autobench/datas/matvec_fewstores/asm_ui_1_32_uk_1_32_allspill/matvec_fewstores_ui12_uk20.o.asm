...
0000000000000ce0 <_Z6enablev>:
 ...
 ce7:	b8 60 00 00 00       	mov    $0x60,%eax
 cec:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 cf1:	0f 45 c8             	cmovne %eax,%ecx
 cf4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # cfa <_Z6enablev+0x1a>
 cfa:	0f 9e c1             	setle  %cl
 cfd:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # d04 <_Z6enablev+0x24>
...
0000000000000d10 <_Z9n_reg_maxv>:
 d10:	b8 10 01 00 00       	mov    $0x110,%eax
 d15:	c3                   	retq   

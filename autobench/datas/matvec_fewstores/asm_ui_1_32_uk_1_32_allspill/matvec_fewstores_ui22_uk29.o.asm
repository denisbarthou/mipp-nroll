...
matvec_fewstores_ui22_uk29.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e ad 27 00 00    	jle    2955 <_Z5benchv+0x27f5>
     ...
     2fe:	0f 83 51 26 00 00    	jae    2955 <_Z5benchv+0x27f5>
    ...
    27ab:	48 83 c6 1d          	add    $0x1d,%rsi
    27af:	49 0f af c3          	imul   %r11,%rax
    27b3:	48 01 f8             	add    %rdi,%rax
    27b6:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm7,%ymm3
    27bd:	01 00 00 
    27c0:	c4 62 45 b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm8
    27c6:	c4 e2 45 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm1
    27cd:	c4 62 45 b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm9
    27d4:	c4 62 45 b8 54 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm10
    27db:	c4 62 45 b8 9c 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm11
    27e2:	00 00 00 
    27e5:	c4 62 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm13
    27ec:	00 00 00 
    27ef:	c4 62 45 b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm7,%ymm15
    27f6:	00 00 00 
    27f9:	c4 62 45 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm7,%ymm12
    2800:	01 00 00 
    2803:	c4 62 45 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm7,%ymm14
    280a:	01 00 00 
    280d:	c4 e2 45 b8 84 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm7,%ymm0
    2814:	01 00 00 
    2817:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm7,%ymm4
    281e:	01 00 00 
    2821:	c4 e2 45 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm7,%ymm6
    2828:	01 00 00 
    282b:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm7,%ymm5
    2832:	02 00 00 
    2835:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    283b:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    2841:	c4 e2 45 b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm7,%ymm2
    2848:	00 00 00 
    284b:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    2852:	00 00 
    2854:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    285a:	c4 e2 45 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm7,%ymm3
    2861:	01 00 00 
    2864:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    286b:	00 00 
    286d:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    2874:	00 00 
    2876:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    287d:	00 00 
    287f:	c5 fc 11 ac 24 00 01 	vmovups %ymm5,0x100(%rsp)
    2886:	00 00 
    2888:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    288e:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    2894:	c4 e2 45 b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm7,%ymm2
    289b:	01 00 00 
    289e:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    28a4:	c5 fc 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm3
    28aa:	c4 e2 45 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm7,%ymm3
    28b1:	02 00 00 
    28b4:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    28ba:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    28bf:	c4 e2 45 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm7,%ymm2
    28c6:	02 00 00 
    28c9:	c5 fc 11 5c 24 a0    	vmovups %ymm3,-0x60(%rsp)
    28cf:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    28d5:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm7,%ymm3
    28dc:	02 00 00 
    28df:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    28e4:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    28ea:	c4 e2 45 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm7,%ymm2
    28f1:	02 00 00 
    28f4:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    28fa:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    2900:	c5 fc 10 54 24 c0    	vmovups -0x40(%rsp),%ymm2
    2906:	c4 e2 45 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm7,%ymm2
    290d:	02 00 00 
    2910:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    2914:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    2919:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    291e:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    2923:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    2928:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    292d:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    2932:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    2937:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    293b:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    2941:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    2947:	4c 39 c6             	cmp    %r8,%rsi
    294a:	0f 8c f0 da ff ff    	jl     440 <_Z5benchv+0x2e0>
    2950:	e9 7b d8 ff ff       	jmpq   1d0 <_Z5benchv+0x70>
    2955:	0f 31                	rdtsc  
    2957:	48 c1 e2 20          	shl    $0x20,%rdx
    295b:	48 09 c2             	or     %rax,%rdx
    295e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2964 <_Z5benchv+0x2804>
    2964:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2969:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2971 <_Z5benchv+0x2811>
    2970:	00 
    2971:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2979 <_Z5benchv+0x2819>
    2978:	00 
    2979:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2980 <_Z5benchv+0x2820>
    2980:	01 c0                	add    %eax,%eax
    2982:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2988:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    298c:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    2993:	00 00 
    2995:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    2999:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    299d:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    29a1:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    29a5:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
    29ac:	c5 f8 77             	vzeroupper 
    29af:	c3                   	retq   

00000000000029b0 <_Z6enablev>:
    29b0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 29b7 <_Z6enablev+0x7>
    29b7:	b8 b0 00 00 00       	mov    $0xb0,%eax
    29bc:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    29c1:	0f 45 c8             	cmovne %eax,%ecx
    29c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 29ca <_Z6enablev+0x1a>
    29ca:	0f 9e c1             	setle  %cl
    29cd:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 29d4 <_Z6enablev+0x24>
...
00000000000029e0 <_Z9n_reg_maxv>:
    29e0:	b8 b1 02 00 00       	mov    $0x2b1,%eax
    29e5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui22_uk29.cpp+0x9a>
  96:	01 00 00 00 

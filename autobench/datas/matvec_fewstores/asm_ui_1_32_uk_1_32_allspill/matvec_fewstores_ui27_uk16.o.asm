...
0000000000002390 <_Z6enablev>:
    2390:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2397 <_Z6enablev+0x7>
    2397:	b8 d8 00 00 00       	mov    $0xd8,%eax
    239c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    23a1:	0f 45 c8             	cmovne %eax,%ecx
    23a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 23aa <_Z6enablev+0x1a>
    23aa:	0f 9e c1             	setle  %cl
    23ad:	83 3d 00 00 00 00 0f 	cmpl   $0xf,0x0(%rip)        # 23b4 <_Z6enablev+0x24>
    23b4:	0f 9f c0             	setg   %al
    23b7:	20 c8                	and    %cl,%al
    23b9:	c3                   	retq   
    23ba:	90                   	nop
    23bb:	90                   	nop
    23bc:	90                   	nop
...
00000000000023c0 <_Z9n_reg_maxv>:
    23c0:	b8 db 01 00 00       	mov    $0x1db,%eax
    23c5:	c3                   	retq   

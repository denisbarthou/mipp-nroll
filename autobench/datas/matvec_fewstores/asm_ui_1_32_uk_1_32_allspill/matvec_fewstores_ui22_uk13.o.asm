...
0000000000001540 <_Z6enablev>:
    ...
    1547:	b8 b0 00 00 00       	mov    $0xb0,%eax
    154c:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    1551:	0f 45 c8             	cmovne %eax,%ecx
    1554:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 155a <_Z6enablev+0x1a>
    155a:	0f 9e c1             	setle  %cl
    155d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 1564 <_Z6enablev+0x24>
...
0000000000001570 <_Z9n_reg_maxv>:
    1570:	b8 41 01 00 00       	mov    $0x141,%eax
    1575:	c3                   	retq   

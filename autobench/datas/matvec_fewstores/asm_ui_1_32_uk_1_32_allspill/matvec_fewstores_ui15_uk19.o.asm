...
matvec_fewstores_ui15_uk19.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 188:	0f 8e f3 0c 00 00    	jle    e81 <_Z5benchv+0xd31>
 ...
 250:	0f 83 2b 0c 00 00    	jae    e81 <_Z5benchv+0xd31>
 ...
 ddf:	48 83 c6 13          	add    $0x13,%rsi
 de3:	49 0f af c2          	imul   %r10,%rax
 de7:	48 01 f8             	add    %rdi,%rax
 dea:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
 df0:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
 df7:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
 dfe:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
 e05:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
 e0c:	00 00 00 
 e0f:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
 e16:	00 00 00 
 e19:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
 e20:	00 00 00 
 e23:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
 e2a:	00 00 00 
 e2d:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
 e34:	01 00 00 
 e37:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
 e3e:	01 00 00 
 e41:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
 e48:	01 00 00 
 e4b:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
 e52:	01 00 00 
 e55:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
 e5c:	01 00 00 
 e5f:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
 e66:	01 00 00 
 e69:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
 e70:	01 00 00 
 e73:	4c 39 c6             	cmp    %r8,%rsi
 e76:	0f 8c 74 f4 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
 e7c:	e9 3f f3 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
 e81:	0f 31                	rdtsc  
 e83:	48 c1 e2 20          	shl    $0x20,%rdx
 e87:	48 09 c2             	or     %rax,%rdx
 e8a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # e90 <_Z5benchv+0xd40>
 e90:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
 e95:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # e9d <_Z5benchv+0xd4d>
 e9c:	00 
 e9d:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # ea5 <_Z5benchv+0xd55>
 ea4:	00 
 ea5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # eac <_Z5benchv+0xd5c>
 eac:	01 c0                	add    %eax,%eax
 eae:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
 eb4:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
 eb8:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
 ebe:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 ec2:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
 ec6:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 eca:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 ece:	c5 f8 77             	vzeroupper 
 ed1:	c3                   	retq   
 ed2:	90                   	nop
 ed3:	90                   	nop
 ed4:	90                   	nop
...
0000000000000ee0 <_Z6enablev>:
 ...
 ee7:	b8 78 00 00 00       	mov    $0x78,%eax
 eec:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 ef1:	0f 45 c8             	cmovne %eax,%ecx
 ef4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # efa <_Z6enablev+0x1a>
 efa:	0f 9e c1             	setle  %cl
 efd:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # f04 <_Z6enablev+0x24>
...
0000000000000f10 <_Z9n_reg_maxv>:
 f10:	b8 3f 01 00 00       	mov    $0x13f,%eax
 f15:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui15_uk19.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000160 <_Z5benchv>:
     ...
     19f:	0f 8e 16 10 00 00    	jle    11bb <_Z5benchv+0x105b>
     ...
     29c:	0f 83 19 0f 00 00    	jae    11bb <_Z5benchv+0x105b>
     ...
     f22:	49 0f af c2          	imul   %r10,%rax
     f26:	48 01 f8             	add    %rdi,%rax
     f29:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
     f2f:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
     f36:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
     f3d:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
     f44:	00 00 00 
     f47:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
     f4e:	00 00 00 
     f51:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
     f58:	00 00 00 
     f5b:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
     f62:	00 00 00 
     f65:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
     f6c:	01 00 00 
     f6f:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
     f76:	01 00 00 
     f79:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
     f80:	01 00 00 
     f83:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
     f8a:	01 00 00 
     f8d:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
     f94:	01 00 00 
     f97:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
     f9e:	01 00 00 
     fa1:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
     fa8:	02 00 00 
     fab:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
     fb1:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
     fb7:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
     fbe:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
     fc4:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
     fca:	c4 e2 6d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm1
     fd1:	01 00 00 
     fd4:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
     fda:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
     fe0:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
     fe7:	01 00 00 
     fea:	48 8d 46 0f          	lea    0xf(%rsi),%rax
     fee:	c4 e2 7d 18 54 b2 3c 	vbroadcastss 0x3c(%rdx,%rsi,4),%ymm2
     ff5:	49 0f af c2          	imul   %r10,%rax
     ff9:	48 01 f8             	add    %rdi,%rax
     ffc:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1002:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1009:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    1010:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    1017:	00 00 00 
    101a:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1021:	00 00 00 
    1024:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    102b:	00 00 00 
    102e:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    1035:	00 00 00 
    1038:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    103f:	01 00 00 
    1042:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1049:	01 00 00 
    104c:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    1053:	01 00 00 
    1056:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
    105d:	01 00 00 
    1060:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    1067:	01 00 00 
    106a:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
    1071:	01 00 00 
    1074:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    107b:	02 00 00 
    107e:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    1084:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    108a:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
    1091:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    1097:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    109d:	c4 e2 6d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm1
    10a4:	01 00 00 
    10a7:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    10ad:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    10b3:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
    10ba:	01 00 00 
    10bd:	48 8d 46 10          	lea    0x10(%rsi),%rax
    10c1:	c4 e2 7d 18 54 b2 40 	vbroadcastss 0x40(%rdx,%rsi,4),%ymm2
    10c8:	48 83 c6 11          	add    $0x11,%rsi
    10cc:	49 0f af c2          	imul   %r10,%rax
    10d0:	48 01 f8             	add    %rdi,%rax
    10d3:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    10da:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    10e0:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    10e7:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
    10ee:	01 00 00 
    10f1:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
    10f8:	01 00 00 
    10fb:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    1102:	00 00 00 
    1105:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    110c:	00 00 00 
    110f:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1116:	00 00 00 
    1119:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    1120:	00 00 00 
    1123:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    112a:	01 00 00 
    112d:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1134:	01 00 00 
    1137:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    113e:	01 00 00 
    1141:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    1148:	01 00 00 
    114b:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    1152:	02 00 00 
    1155:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    115b:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    1161:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
    1168:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    116d:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1173:	c4 e2 6d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm5
    117a:	01 00 00 
    117d:	c5 7c 11 64 24 20    	vmovups %ymm12,0x20(%rsp)
    1183:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
    1189:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    118f:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    1195:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
    119c:	01 00 00 
    119f:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    11a3:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    11a7:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    11ad:	4c 39 c6             	cmp    %r8,%rsi
    11b0:	0f 8c ba f1 ff ff    	jl     370 <_Z5benchv+0x210>
    11b6:	e9 1d f0 ff ff       	jmpq   1d8 <_Z5benchv+0x78>
    11bb:	0f 31                	rdtsc  
    11bd:	48 c1 e2 20          	shl    $0x20,%rdx
    11c1:	48 09 c2             	or     %rax,%rdx
    11c4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 11ca <_Z5benchv+0x106a>
    11ca:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    11cf:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 11d7 <_Z5benchv+0x1077>
    11d6:	00 
    11d7:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 11df <_Z5benchv+0x107f>
    11de:	00 
    11df:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 11e6 <_Z5benchv+0x1086>
    11e6:	01 c0                	add    %eax,%eax
    11e8:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    11ee:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    11f2:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    11f8:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    11fd:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    1201:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1205:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1209:	48 81 c4 98 00 00 00 	add    $0x98,%rsp
    1210:	c5 f8 77             	vzeroupper 
    1213:	c3                   	retq   
    1214:	90                   	nop
    1215:	90                   	nop
    1216:	90                   	nop
...
0000000000001220 <_Z6enablev>:
    ...
    1227:	b8 88 00 00 00       	mov    $0x88,%eax
    122c:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1231:	0f 45 c8             	cmovne %eax,%ecx
    1234:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 123a <_Z6enablev+0x1a>
    123a:	0f 9e c1             	setle  %cl
    123d:	83 3d 00 00 00 00 10 	cmpl   $0x10,0x0(%rip)        # 1244 <_Z6enablev+0x24>
...
0000000000001250 <_Z9n_reg_maxv>:
    1250:	b8 43 01 00 00       	mov    $0x143,%eax
    1255:	c3                   	retq   

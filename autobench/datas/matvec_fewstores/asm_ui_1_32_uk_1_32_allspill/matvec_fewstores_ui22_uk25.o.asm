...
matvec_fewstores_ui22_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e b1 22 00 00    	jle    2449 <_Z5benchv+0x22f9>
     ...
     2ee:	0f 83 55 21 00 00    	jae    2449 <_Z5benchv+0x22f9>
    ...
    229f:	48 83 c6 19          	add    $0x19,%rsi
    22a3:	49 0f af c3          	imul   %r11,%rax
    22a7:	48 01 f8             	add    %rdi,%rax
    22aa:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm7,%ymm3
    22b1:	01 00 00 
    22b4:	c4 62 45 b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm8
    22ba:	c4 e2 45 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm1
    22c1:	c4 62 45 b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm9
    22c8:	c4 62 45 b8 54 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm10
    22cf:	c4 62 45 b8 9c 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm11
    22d6:	00 00 00 
    22d9:	c4 62 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm13
    22e0:	00 00 00 
    22e3:	c4 62 45 b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm7,%ymm15
    22ea:	00 00 00 
    22ed:	c4 62 45 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm7,%ymm12
    22f4:	01 00 00 
    22f7:	c4 62 45 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm7,%ymm14
    22fe:	01 00 00 
    2301:	c4 e2 45 b8 84 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm7,%ymm0
    2308:	01 00 00 
    230b:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm7,%ymm4
    2312:	01 00 00 
    2315:	c4 e2 45 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm7,%ymm6
    231c:	01 00 00 
    231f:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm7,%ymm5
    2326:	02 00 00 
    2329:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    232f:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    2335:	c4 e2 45 b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm7,%ymm2
    233c:	00 00 00 
    233f:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    2346:	00 00 
    2348:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    234e:	c4 e2 45 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm7,%ymm3
    2355:	01 00 00 
    2358:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    235f:	00 00 
    2361:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    2368:	00 00 
    236a:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    2371:	00 00 
    2373:	c5 fc 11 ac 24 00 01 	vmovups %ymm5,0x100(%rsp)
    237a:	00 00 
    237c:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    2382:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    2388:	c4 e2 45 b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm7,%ymm2
    238f:	01 00 00 
    2392:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    2398:	c5 fc 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm3
    239e:	c4 e2 45 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm7,%ymm3
    23a5:	02 00 00 
    23a8:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    23ae:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    23b3:	c4 e2 45 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm7,%ymm2
    23ba:	02 00 00 
    23bd:	c5 fc 11 5c 24 a0    	vmovups %ymm3,-0x60(%rsp)
    23c3:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    23c9:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm7,%ymm3
    23d0:	02 00 00 
    23d3:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    23d8:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    23de:	c4 e2 45 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm7,%ymm2
    23e5:	02 00 00 
    23e8:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    23ee:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    23f4:	c5 fc 10 54 24 c0    	vmovups -0x40(%rsp),%ymm2
    23fa:	c4 e2 45 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm7,%ymm2
    2401:	02 00 00 
    ...
    241c:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    2421:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    2426:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    242b:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    242f:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    2435:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    243b:	4c 39 c6             	cmp    %r8,%rsi
    243e:	0f 8c ec df ff ff    	jl     430 <_Z5benchv+0x2e0>
    2444:	e9 77 dd ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    2449:	0f 31                	rdtsc  
    244b:	48 c1 e2 20          	shl    $0x20,%rdx
    244f:	48 09 c2             	or     %rax,%rdx
    2452:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2458 <_Z5benchv+0x2308>
    2458:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    245d:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2465 <_Z5benchv+0x2315>
    2464:	00 
    2465:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 246d <_Z5benchv+0x231d>
    246c:	00 
    246d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2474 <_Z5benchv+0x2324>
    2474:	01 c0                	add    %eax,%eax
    2476:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    247c:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2480:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    2487:	00 00 
    2489:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    248d:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    2491:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2495:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2499:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
...
00000000000024b0 <_Z6enablev>:
    ...
    24b7:	b8 b0 00 00 00       	mov    $0xb0,%eax
    24bc:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    24c1:	0f 45 c8             	cmovne %eax,%ecx
    24c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 24ca <_Z6enablev+0x1a>
    24ca:	0f 9e c1             	setle  %cl
    24cd:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 24d4 <_Z6enablev+0x24>
...
00000000000024e0 <_Z9n_reg_maxv>:
    24e0:	b8 55 02 00 00       	mov    $0x255,%eax
    24e5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui22_uk25.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000003150 <_Z6enablev>:
    3150:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3157 <_Z6enablev+0x7>
    3157:	b8 d8 00 00 00       	mov    $0xd8,%eax
    315c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    3161:	0f 45 c8             	cmovne %eax,%ecx
    3164:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 316a <_Z6enablev+0x1a>
    316a:	0f 9e c1             	setle  %cl
    316d:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 3174 <_Z6enablev+0x24>
    3174:	0f 9f c0             	setg   %al
    3177:	20 c8                	and    %cl,%al
    3179:	c3                   	retq   
    317a:	90                   	nop
    317b:	90                   	nop
    317c:	90                   	nop
...
0000000000003180 <_Z9n_reg_maxv>:
    3180:	b8 bb 02 00 00       	mov    $0x2bb,%eax
    3185:	c3                   	retq   

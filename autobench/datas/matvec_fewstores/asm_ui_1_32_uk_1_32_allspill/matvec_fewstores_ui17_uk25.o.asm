...
matvec_fewstores_ui17_uk25.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     19c:	0f 8e 7b 16 00 00    	jle    181d <_Z5benchv+0x16bd>
     ...
     290:	0f 83 87 15 00 00    	jae    181d <_Z5benchv+0x16bd>
    ...
    1736:	48 83 c6 19          	add    $0x19,%rsi
    173a:	49 0f af c2          	imul   %r10,%rax
    173e:	48 01 f8             	add    %rdi,%rax
    1741:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1747:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    174e:	c4 e2 6d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm1
    1755:	01 00 00 
    1758:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    175f:	00 00 00 
    1762:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1769:	00 00 00 
    176c:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1773:	00 00 00 
    1776:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    177d:	00 00 00 
    1780:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1787:	01 00 00 
    178a:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1791:	01 00 00 
    1794:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    179b:	01 00 00 
    179e:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    17a5:	01 00 00 
    17a8:	c4 62 6d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm15
    17af:	01 00 00 
    17b2:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    17b9:	01 00 00 
    17bc:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    17c3:	02 00 00 
    17c6:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    17cc:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    17d2:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    17d9:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    17de:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    17e4:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    17ea:	c4 e2 6d b8 6c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm5
    17f1:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    17f7:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    17fd:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    1804:	01 00 00 
    1807:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    180b:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    180f:	4c 39 c6             	cmp    %r8,%rsi
    1812:	0f 8c 48 eb ff ff    	jl     360 <_Z5benchv+0x200>
    1818:	e9 bb e9 ff ff       	jmpq   1d8 <_Z5benchv+0x78>
    181d:	0f 31                	rdtsc  
    181f:	48 c1 e2 20          	shl    $0x20,%rdx
    1823:	48 09 c2             	or     %rax,%rdx
    1826:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 182c <_Z5benchv+0x16cc>
    182c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1831:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1839 <_Z5benchv+0x16d9>
    1838:	00 
    1839:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1841 <_Z5benchv+0x16e1>
    1840:	00 
    1841:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1848 <_Z5benchv+0x16e8>
    1848:	01 c0                	add    %eax,%eax
    184a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1850:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1854:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    185a:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
    185e:	c5 ca 2a c8          	vcvtsi2ss %eax,%xmm6,%xmm1
    1862:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1866:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    186a:	48 83 c4 38          	add    $0x38,%rsp
    186e:	c5 f8 77             	vzeroupper 
    1871:	c3                   	retq   
    1872:	90                   	nop
    1873:	90                   	nop
    1874:	90                   	nop
...
0000000000001880 <_Z6enablev>:
    1880:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1887 <_Z6enablev+0x7>
    1887:	b8 88 00 00 00       	mov    $0x88,%eax
    188c:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1891:	0f 45 c8             	cmovne %eax,%ecx
    1894:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 189a <_Z6enablev+0x1a>
    189a:	0f 9e c1             	setle  %cl
    189d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 18a4 <_Z6enablev+0x24>
    18a4:	0f 9f c0             	setg   %al
    18a7:	20 c8                	and    %cl,%al
    18a9:	c3                   	retq   
    18aa:	90                   	nop
    18ab:	90                   	nop
    18ac:	90                   	nop
...
00000000000018b0 <_Z9n_reg_maxv>:
    18b0:	b8 d3 01 00 00       	mov    $0x1d3,%eax
    18b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui17_uk25.cpp+0x9a>
  96:	01 00 00 00 

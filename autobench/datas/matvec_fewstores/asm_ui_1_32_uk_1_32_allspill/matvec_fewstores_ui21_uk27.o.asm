...
matvec_fewstores_ui21_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e da 22 00 00    	jle    246f <_Z5benchv+0x231f>
     ...
     2e1:	0f 83 88 21 00 00    	jae    246f <_Z5benchv+0x231f>
    ...
    22e9:	48 83 c6 1b          	add    $0x1b,%rsi
    22ed:	49 0f af c2          	imul   %r10,%rax
    22f1:	48 01 f8             	add    %rdi,%rax
    22f4:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    22fb:	01 00 00 
    22fe:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    2305:	01 00 00 
    2308:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    230f:	01 00 00 
    2312:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    2319:	02 00 00 
    231c:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    2323:	01 00 00 
    2326:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    232c:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    2333:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    233a:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    2341:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    2348:	00 00 00 
    234b:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    2352:	00 00 00 
    2355:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    235c:	00 00 00 
    235f:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    2366:	01 00 00 
    2369:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    2370:	01 00 00 
    2373:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    2379:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    237e:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    2385:	00 00 00 
    2388:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    238f:	00 00 
    2391:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    2397:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    239e:	00 00 
    23a0:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    23a6:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    23ad:	00 00 
    23af:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    23b5:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm2
    23bc:	02 00 00 
    23bf:	c4 e2 4d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm1
    23c6:	01 00 00 
    23c9:	c4 e2 4d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm4
    23d0:	02 00 00 
    23d3:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    23d9:	c5 fc 11 ac 24 80 00 	vmovups %ymm5,0x80(%rsp)
    23e0:	00 00 
    23e2:	c5 7c 29 cd          	vmovaps %ymm9,%ymm5
    23e6:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    23eb:	c4 41 7c 28 dd       	vmovaps %ymm13,%ymm11
    23f0:	c5 7c 11 bc 24 20 01 	vmovups %ymm15,0x120(%rsp)
    23f7:	00 00 
    23f9:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    2400:	00 00 
    2402:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    2407:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    240d:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    2414:	01 00 00 
    2417:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    241c:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    2422:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    2428:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    242e:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    2435:	02 00 00 
    2438:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    243e:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    2444:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    244b:	02 00 00 
    244e:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    2452:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    2457:	c4 41 7c 28 d4       	vmovaps %ymm12,%ymm10
    245c:	c4 41 7c 28 e6       	vmovaps %ymm14,%ymm12
    2461:	4c 39 c6             	cmp    %r8,%rsi
    2464:	0f 8c a6 df ff ff    	jl     410 <_Z5benchv+0x2c0>
    246a:	e9 55 dd ff ff       	jmpq   1c4 <_Z5benchv+0x74>
    246f:	0f 31                	rdtsc  
    2471:	48 c1 e2 20          	shl    $0x20,%rdx
    2475:	48 09 c2             	or     %rax,%rdx
    2478:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 247e <_Z5benchv+0x232e>
    247e:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2483:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 248b <_Z5benchv+0x233b>
    248a:	00 
    248b:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2493 <_Z5benchv+0x2343>
    2492:	00 
    2493:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 249a <_Z5benchv+0x234a>
    249a:	01 c0                	add    %eax,%eax
    249c:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    24a2:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    24a6:	c5 fb 5c 44 24 78    	vsubsd 0x78(%rsp),%xmm0,%xmm0
    24ac:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    24b1:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    24b5:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    24b9:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    24bd:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
00000000000024d0 <_Z6enablev>:
    24d0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 24d7 <_Z6enablev+0x7>
    24d7:	b8 a8 00 00 00       	mov    $0xa8,%eax
    24dc:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    24e1:	0f 45 c8             	cmovne %eax,%ecx
    24e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 24ea <_Z6enablev+0x1a>
    24ea:	0f 9e c1             	setle  %cl
    24ed:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 24f4 <_Z6enablev+0x24>
    24f4:	0f 9f c0             	setg   %al
    24f7:	20 c8                	and    %cl,%al
    24f9:	c3                   	retq   
    24fa:	90                   	nop
    24fb:	90                   	nop
    24fc:	90                   	nop
...
0000000000002500 <_Z9n_reg_maxv>:
    2500:	b8 67 02 00 00       	mov    $0x267,%eax
    2505:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui21_uk27.cpp+0x9a>
  96:	01 00 00 00 

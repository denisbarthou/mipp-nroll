...
matvec_fewstores_ui12_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 183:	0f 8e 6c 0d 00 00    	jle    ef5 <_Z5benchv+0xda5>
 ...
 21f:	0f 83 d0 0c 00 00    	jae    ef5 <_Z5benchv+0xda5>
 ...
 e71:	48 83 c3 19          	add    $0x19,%rbx
 e75:	48 0f af f0          	imul   %rax,%rsi
 e79:	48 01 fe             	add    %rdi,%rsi
 e7c:	c4 e2 15 b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm3
 e82:	c4 e2 15 b8 6c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm5
 e89:	c4 e2 15 b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm7
 e90:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
 e97:	c4 e2 15 b8 8c b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm1
 e9e:	00 00 00 
 ea1:	c4 e2 15 b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm2
 ea8:	00 00 00 
 eab:	c4 e2 15 b8 a4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm4
 eb2:	00 00 00 
 eb5:	c4 e2 15 b8 b4 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm6
 ebc:	00 00 00 
 ebf:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
 ec6:	01 00 00 
 ec9:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
 ed0:	01 00 00 
 ed3:	c4 62 15 b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm11
 eda:	01 00 00 
 edd:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm12
 ee4:	01 00 00 
 ee7:	4c 39 c3             	cmp    %r8,%rbx
 eea:	0f 8c c0 f3 ff ff    	jl     2b0 <_Z5benchv+0x160>
 ef0:	e9 bb f2 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 ef5:	0f 31                	rdtsc  
 ef7:	48 c1 e2 20          	shl    $0x20,%rdx
 efb:	48 09 c2             	or     %rax,%rdx
 efe:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # f04 <_Z5benchv+0xdb4>
 f04:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 f09:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # f11 <_Z5benchv+0xdc1>
 f10:	00 
 f11:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # f19 <_Z5benchv+0xdc9>
 f18:	00 
 f19:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # f20 <_Z5benchv+0xdd0>
 f20:	01 c0                	add    %eax,%eax
 f22:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 f28:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 f2c:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 f30:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 f34:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 f38:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 f3c:	5b                   	pop    %rbx
 f3d:	41 5e                	pop    %r14
...
0000000000000f50 <_Z6enablev>:
 ...
 f57:	b8 60 00 00 00       	mov    $0x60,%eax
 f5c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 f61:	0f 45 c8             	cmovne %eax,%ecx
 f64:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # f6a <_Z6enablev+0x1a>
 f6a:	0f 9e c1             	setle  %cl
 f6d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # f74 <_Z6enablev+0x24>
...
0000000000000f80 <_Z9n_reg_maxv>:
 f80:	b8 51 01 00 00       	mov    $0x151,%eax
 f85:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui12_uk25.cpp+0x9a>
  96:	01 00 00 00 

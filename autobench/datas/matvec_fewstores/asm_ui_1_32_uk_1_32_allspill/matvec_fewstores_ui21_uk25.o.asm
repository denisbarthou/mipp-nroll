...
matvec_fewstores_ui21_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e 88 20 00 00    	jle    221d <_Z5benchv+0x20cd>
     ...
     2e1:	0f 83 36 1f 00 00    	jae    221d <_Z5benchv+0x20cd>
    ...
    2097:	48 83 c6 19          	add    $0x19,%rsi
    209b:	49 0f af c2          	imul   %r10,%rax
    209f:	48 01 f8             	add    %rdi,%rax
    20a2:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    20a9:	01 00 00 
    20ac:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    20b3:	01 00 00 
    20b6:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    20bd:	01 00 00 
    20c0:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    20c7:	02 00 00 
    20ca:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    20d1:	01 00 00 
    20d4:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    20da:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    20e1:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    20e8:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    20ef:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    20f6:	00 00 00 
    20f9:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    2100:	00 00 00 
    2103:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    210a:	00 00 00 
    210d:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    2114:	01 00 00 
    2117:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    211e:	01 00 00 
    2121:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    2127:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    212c:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    2133:	00 00 00 
    2136:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    213d:	00 00 
    213f:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    2145:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    214c:	00 00 
    214e:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    2154:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    215b:	00 00 
    215d:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    2163:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm2
    216a:	02 00 00 
    216d:	c4 e2 4d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm1
    2174:	01 00 00 
    2177:	c4 e2 4d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm4
    217e:	02 00 00 
    2181:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    2187:	c5 fc 11 ac 24 80 00 	vmovups %ymm5,0x80(%rsp)
    218e:	00 00 
    2190:	c5 7c 29 cd          	vmovaps %ymm9,%ymm5
    2194:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    2199:	c4 41 7c 28 dd       	vmovaps %ymm13,%ymm11
    219e:	c5 7c 11 bc 24 20 01 	vmovups %ymm15,0x120(%rsp)
    21a5:	00 00 
    21a7:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    21ae:	00 00 
    21b0:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    21b5:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    21bb:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    21c2:	01 00 00 
    21c5:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    21ca:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    21d0:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    21d6:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    21dc:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    21e3:	02 00 00 
    21e6:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    21ec:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    21f2:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    21f9:	02 00 00 
    21fc:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    2200:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    2205:	c4 41 7c 28 d4       	vmovaps %ymm12,%ymm10
    220a:	c4 41 7c 28 e6       	vmovaps %ymm14,%ymm12
    220f:	4c 39 c6             	cmp    %r8,%rsi
    2212:	0f 8c f8 e1 ff ff    	jl     410 <_Z5benchv+0x2c0>
    2218:	e9 a7 df ff ff       	jmpq   1c4 <_Z5benchv+0x74>
    221d:	0f 31                	rdtsc  
    221f:	48 c1 e2 20          	shl    $0x20,%rdx
    2223:	48 09 c2             	or     %rax,%rdx
    2226:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 222c <_Z5benchv+0x20dc>
    222c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2231:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2239 <_Z5benchv+0x20e9>
    2238:	00 
    2239:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2241 <_Z5benchv+0x20f1>
    2240:	00 
    2241:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2248 <_Z5benchv+0x20f8>
    2248:	01 c0                	add    %eax,%eax
    224a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2250:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2254:	c5 fb 5c 44 24 78    	vsubsd 0x78(%rsp),%xmm0,%xmm0
    225a:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    225f:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    2263:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2267:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    226b:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
0000000000002280 <_Z6enablev>:
    ...
    2287:	b8 a8 00 00 00       	mov    $0xa8,%eax
    228c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    2291:	0f 45 c8             	cmovne %eax,%ecx
    2294:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 229a <_Z6enablev+0x1a>
    229a:	0f 9e c1             	setle  %cl
    229d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 22a4 <_Z6enablev+0x24>
...
00000000000022b0 <_Z9n_reg_maxv>:
    22b0:	b8 3b 02 00 00       	mov    $0x23b,%eax
    22b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui21_uk25.cpp+0x9a>
  96:	01 00 00 00 

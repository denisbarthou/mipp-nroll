...
0000000000000930 <_Z6enablev>:
 ...
 937:	b8 30 00 00 00       	mov    $0x30,%eax
 93c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 941:	0f 45 c8             	cmovne %eax,%ecx
 944:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 94a <_Z6enablev+0x1a>
 94a:	0f 9e c1             	setle  %cl
 94d:	83 3d 00 00 00 00 0f 	cmpl   $0xf,0x0(%rip)        # 954 <_Z6enablev+0x24>
...
0000000000000960 <_Z9n_reg_maxv>:
 960:	b8 76 00 00 00       	mov    $0x76,%eax
 965:	c3                   	retq   

...
0000000000001360 <_Z6enablev>:
    ...
    1367:	b8 78 00 00 00       	mov    $0x78,%eax
    136c:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
    1371:	0f 45 c8             	cmovne %eax,%ecx
    1374:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 137a <_Z6enablev+0x1a>
    137a:	0f 9e c1             	setle  %cl
    137d:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 1384 <_Z6enablev+0x24>
...
0000000000001390 <_Z9n_reg_maxv>:
    1390:	b8 8f 01 00 00       	mov    $0x18f,%eax
    1395:	c3                   	retq   

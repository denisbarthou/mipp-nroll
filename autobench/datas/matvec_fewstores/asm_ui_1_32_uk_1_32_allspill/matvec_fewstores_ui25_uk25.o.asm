...
matvec_fewstores_ui25_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 63 2b 00 00    	jle    2cfb <_Z5benchv+0x2bab>
     ...
     344:	0f 83 b1 29 00 00    	jae    2cfb <_Z5benchv+0x2bab>
    ...
    2b38:	48 83 c6 19          	add    $0x19,%rsi
    2b3c:	49 0f af c2          	imul   %r10,%rax
    2b40:	48 01 f8             	add    %rdi,%rax
    2b43:	c4 e2 2d b8 84 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm10,%ymm0
    2b4a:	03 00 00 
    2b4d:	c4 62 2d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm10,%ymm8
    2b54:	00 00 00 
    2b57:	c4 e2 2d b8 ac 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm10,%ymm5
    2b5e:	01 00 00 
    2b61:	c4 e2 2d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm10,%ymm3
    2b68:	01 00 00 
    2b6b:	c4 e2 2d b8 94 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm10,%ymm2
    2b72:	01 00 00 
    2b75:	c4 e2 2d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm10,%ymm7
    2b7c:	01 00 00 
    2b7f:	c4 62 2d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm10,%ymm11
    2b85:	c4 62 2d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm10,%ymm12
    2b8c:	c4 62 2d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm10,%ymm13
    2b93:	c4 62 2d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm10,%ymm14
    2b9a:	c4 62 2d b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm10,%ymm15
    2ba1:	00 00 00 
    2ba4:	c4 e2 2d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm10,%ymm1
    2bab:	00 00 00 
    2bae:	c4 62 2d b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm10,%ymm9
    2bb5:	00 00 00 
    2bb8:	c4 e2 2d b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm10,%ymm6
    2bbf:	01 00 00 
    2bc2:	c5 fc 11 64 24 a0    	vmovups %ymm4,-0x60(%rsp)
    2bc8:	c5 fc 10 64 24 80    	vmovups -0x80(%rsp),%ymm4
    2bce:	c4 e2 2d b8 a4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm10,%ymm4
    2bd5:	01 00 00 
    2bd8:	c5 fc 11 84 24 20 01 	vmovups %ymm0,0x120(%rsp)
    2bdf:	00 00 
    2be1:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    2be5:	c5 fc 28 d5          	vmovaps %ymm5,%ymm2
    2be9:	c5 fc 11 64 24 80    	vmovups %ymm4,-0x80(%rsp)
    2bef:	c5 fc 10 a4 24 c0 00 	vmovups 0xc0(%rsp),%ymm4
    2bf6:	00 00 
    2bf8:	c4 e2 2d b8 a4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm10,%ymm4
    2bff:	01 00 00 
    2c02:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    2c09:	00 00 
    2c0b:	c5 fc 10 a4 24 a0 00 	vmovups 0xa0(%rsp),%ymm4
    2c12:	00 00 
    2c14:	c4 e2 2d b8 a4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm10,%ymm4
    2c1b:	01 00 00 
    2c1e:	c5 fc 11 a4 24 a0 00 	vmovups %ymm4,0xa0(%rsp)
    2c25:	00 00 
    2c27:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    2c2d:	c4 e2 2d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm10,%ymm4
    2c34:	02 00 00 
    2c37:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    2c3d:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    2c44:	00 00 
    2c46:	c4 e2 2d b8 a4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm10,%ymm4
    2c4d:	02 00 00 
    2c50:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    2c57:	00 00 
    2c59:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    2c5f:	c4 e2 2d b8 a4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm10,%ymm4
    2c66:	02 00 00 
    2c69:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    2c6f:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    2c74:	c4 e2 2d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm10,%ymm4
    2c7b:	02 00 00 
    2c7e:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    2c83:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    2c89:	c4 e2 2d b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm10,%ymm4
    2c90:	02 00 00 
    2c93:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    2c99:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    2c9f:	c4 e2 2d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm10,%ymm4
    2ca6:	02 00 00 
    2ca9:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    2caf:	c5 fc 10 64 24 c0    	vmovups -0x40(%rsp),%ymm4
    2cb5:	c4 e2 2d b8 a4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm10,%ymm4
    2cbc:	02 00 00 
    2cbf:	c5 fc 11 64 24 c0    	vmovups %ymm4,-0x40(%rsp)
    2cc5:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    2ccb:	c4 e2 2d b8 a4 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm10,%ymm4
    2cd2:	02 00 00 
    2cd5:	c5 7c 28 d7          	vmovaps %ymm7,%ymm10
    2cd9:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    2cdd:	c5 7c 28 c3          	vmovaps %ymm3,%ymm8
    2ce1:	c5 fc 11 64 24 a0    	vmovups %ymm4,-0x60(%rsp)
    2ce7:	c5 fc 10 64 24 80    	vmovups -0x80(%rsp),%ymm4
    2ced:	4c 39 c6             	cmp    %r8,%rsi
    2cf0:	0f 8c 1a d8 ff ff    	jl     510 <_Z5benchv+0x3c0>
    2cf6:	e9 05 d5 ff ff       	jmpq   200 <_Z5benchv+0xb0>
    2cfb:	0f 31                	rdtsc  
    2cfd:	48 c1 e2 20          	shl    $0x20,%rdx
    2d01:	48 09 c2             	or     %rax,%rdx
    2d04:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2d0a <_Z5benchv+0x2bba>
    2d0a:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2d0f:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2d17 <_Z5benchv+0x2bc7>
    2d16:	00 
    2d17:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2d1f <_Z5benchv+0x2bcf>
    2d1e:	00 
    2d1f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2d26 <_Z5benchv+0x2bd6>
    2d26:	01 c0                	add    %eax,%eax
    2d28:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2d2e:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2d32:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    2d39:	00 00 
    2d3b:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    2d3f:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    2d43:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2d47:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2d4b:	48 81 c4 f8 01 00 00 	add    $0x1f8,%rsp
...
0000000000002d60 <_Z6enablev>:
    2d60:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2d67 <_Z6enablev+0x7>
    2d67:	b8 c8 00 00 00       	mov    $0xc8,%eax
    2d6c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    2d71:	0f 45 c8             	cmovne %eax,%ecx
    2d74:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 2d7a <_Z6enablev+0x1a>
    2d7a:	0f 9e c1             	setle  %cl
    2d7d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 2d84 <_Z6enablev+0x24>
    2d84:	0f 9f c0             	setg   %al
    2d87:	20 c8                	and    %cl,%al
    2d89:	c3                   	retq   
    2d8a:	90                   	nop
    2d8b:	90                   	nop
    2d8c:	90                   	nop
...
0000000000002d90 <_Z9n_reg_maxv>:
    2d90:	b8 a3 02 00 00       	mov    $0x2a3,%eax
    2d95:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui25_uk25.cpp+0x9a>
  96:	01 00 00 00 

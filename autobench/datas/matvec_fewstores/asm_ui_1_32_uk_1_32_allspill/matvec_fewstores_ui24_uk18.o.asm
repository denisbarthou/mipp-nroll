...
matvec_fewstores_ui24_uk18.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     19a:	0f 8e 6d 1e 00 00    	jle    200d <_Z5benchv+0x1ebd>
     ...
     31c:	0f 83 eb 1c 00 00    	jae    200d <_Z5benchv+0x1ebd>
    ...
    1e41:	48 83 c3 12          	add    $0x12,%rbx
    1e45:	48 0f af e8          	imul   %rax,%rbp
    1e49:	48 01 fd             	add    %rdi,%rbp
    1e4c:	c4 62 35 b8 74 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm14
    1e53:	c4 62 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm15
    1e5a:	00 00 00 
    1e5d:	c4 62 35 b8 94 a9 00 	vfmadd231ps 0x100(%rcx,%rbp,4),%ymm9,%ymm10
    1e64:	01 00 00 
    1e67:	c4 e2 35 b8 94 a9 80 	vfmadd231ps 0x180(%rcx,%rbp,4),%ymm9,%ymm2
    1e6e:	01 00 00 
    1e71:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm6
    1e78:	00 00 00 
    1e7b:	c4 e2 35 b8 9c a9 a0 	vfmadd231ps 0x1a0(%rcx,%rbp,4),%ymm9,%ymm3
    1e82:	01 00 00 
    1e85:	c4 e2 35 b8 64 a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm4
    1e8c:	c4 62 35 b8 84 a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm8
    1e93:	00 00 00 
    1e96:	c4 e2 35 b8 ac a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm5
    1e9d:	00 00 00 
    1ea0:	c4 62 35 b8 9c a9 20 	vfmadd231ps 0x120(%rcx,%rbp,4),%ymm9,%ymm11
    1ea7:	01 00 00 
    1eaa:	c4 62 35 b8 a4 a9 40 	vfmadd231ps 0x140(%rcx,%rbp,4),%ymm9,%ymm12
    1eb1:	01 00 00 
    1eb4:	c4 e2 35 b8 84 a9 e0 	vfmadd231ps 0x2e0(%rcx,%rbp,4),%ymm9,%ymm0
    1ebb:	02 00 00 
    1ebe:	c4 62 35 b8 2c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm13
    1ec4:	c4 e2 35 b8 7c a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm7
    1ecb:	c5 fc 11 4c 24 e0    	vmovups %ymm1,-0x20(%rsp)
    1ed1:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    1ed7:	c4 e2 35 b8 8c a9 60 	vfmadd231ps 0x160(%rcx,%rbp,4),%ymm9,%ymm1
    1ede:	01 00 00 
    1ee1:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    1ee8:	00 00 
    1eea:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    1ef1:	00 00 
    1ef3:	c5 7c 29 db          	vmovaps %ymm11,%ymm3
    1ef7:	c5 7c 29 e6          	vmovaps %ymm12,%ymm6
    1efb:	c5 7c 28 dc          	vmovaps %ymm4,%ymm11
    1eff:	c5 fc 11 84 24 60 01 	vmovups %ymm0,0x160(%rsp)
    1f06:	00 00 
    1f08:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    1f0e:	c5 fc 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm1
    1f15:	00 00 
    1f17:	c4 e2 35 b8 8c a9 c0 	vfmadd231ps 0x1c0(%rcx,%rbp,4),%ymm9,%ymm1
    1f1e:	01 00 00 
    1f21:	c5 fc 11 8c 24 a0 00 	vmovups %ymm1,0xa0(%rsp)
    1f28:	00 00 
    1f2a:	c5 fc 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm1
    1f31:	00 00 
    1f33:	c4 e2 35 b8 8c a9 e0 	vfmadd231ps 0x1e0(%rcx,%rbp,4),%ymm9,%ymm1
    1f3a:	01 00 00 
    1f3d:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    1f44:	00 00 
    1f46:	c5 fc 10 0c 24       	vmovups (%rsp),%ymm1
    1f4b:	c4 e2 35 b8 8c a9 00 	vfmadd231ps 0x200(%rcx,%rbp,4),%ymm9,%ymm1
    1f52:	02 00 00 
    1f55:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    1f5a:	c5 fc 10 4c 24 20    	vmovups 0x20(%rsp),%ymm1
    1f60:	c4 e2 35 b8 8c a9 20 	vfmadd231ps 0x220(%rcx,%rbp,4),%ymm9,%ymm1
    1f67:	02 00 00 
    1f6a:	c5 fc 11 4c 24 20    	vmovups %ymm1,0x20(%rsp)
    1f70:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    1f76:	c4 e2 35 b8 8c a9 40 	vfmadd231ps 0x240(%rcx,%rbp,4),%ymm9,%ymm1
    1f7d:	02 00 00 
    1f80:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    1f86:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    1f8c:	c4 e2 35 b8 8c a9 60 	vfmadd231ps 0x260(%rcx,%rbp,4),%ymm9,%ymm1
    1f93:	02 00 00 
    1f96:	c5 fc 11 4c 24 60    	vmovups %ymm1,0x60(%rsp)
    1f9c:	c5 fc 10 4c 24 40    	vmovups 0x40(%rsp),%ymm1
    1fa2:	c4 e2 35 b8 8c a9 80 	vfmadd231ps 0x280(%rcx,%rbp,4),%ymm9,%ymm1
    1fa9:	02 00 00 
    1fac:	c5 fc 11 4c 24 40    	vmovups %ymm1,0x40(%rsp)
    1fb2:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    1fb8:	c4 e2 35 b8 8c a9 a0 	vfmadd231ps 0x2a0(%rcx,%rbp,4),%ymm9,%ymm1
    1fbf:	02 00 00 
    1fc2:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    1fc8:	c5 fc 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm1
    1fce:	c4 e2 35 b8 8c a9 c0 	vfmadd231ps 0x2c0(%rcx,%rbp,4),%ymm9,%ymm1
    1fd5:	02 00 00 
    1fd8:	c4 41 7c 28 c8       	vmovaps %ymm8,%ymm9
    1fdd:	c5 7c 28 c5          	vmovaps %ymm5,%ymm8
    1fe1:	c5 fc 11 4c 24 e0    	vmovups %ymm1,-0x20(%rsp)
    1fe7:	c5 7c 29 d1          	vmovaps %ymm10,%ymm1
    1feb:	c4 41 7c 28 d6       	vmovaps %ymm14,%ymm10
    1ff0:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    1ff5:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    1ff9:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    1fff:	4c 39 c3             	cmp    %r8,%rbx
    2002:	0f 8c c8 e4 ff ff    	jl     4d0 <_Z5benchv+0x380>
    2008:	e9 e9 e1 ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    200d:	0f 31                	rdtsc  
    200f:	48 c1 e2 20          	shl    $0x20,%rdx
    2013:	48 09 c2             	or     %rax,%rdx
    2016:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 201c <_Z5benchv+0x1ecc>
    201c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2021:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2029 <_Z5benchv+0x1ed9>
    2028:	00 
    2029:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2031 <_Z5benchv+0x1ee1>
    2030:	00 
    2031:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2038 <_Z5benchv+0x1ee8>
    2038:	01 c0                	add    %eax,%eax
    203a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2040:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2044:	c5 fb 5c 84 24 f0 00 	vsubsd 0xf0(%rsp),%xmm0,%xmm0
    204b:	00 00 
    204d:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    2051:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    2055:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2059:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    205d:	48 81 c4 a8 01 00 00 	add    $0x1a8,%rsp
    2064:	5b                   	pop    %rbx
    2065:	41 5c                	pop    %r12
    2067:	41 5d                	pop    %r13
    2069:	41 5e                	pop    %r14
...
0000000000002080 <_Z6enablev>:
    2080:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2087 <_Z6enablev+0x7>
    2087:	b8 c0 00 00 00       	mov    $0xc0,%eax
    208c:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    2091:	0f 45 c8             	cmovne %eax,%ecx
    2094:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 209a <_Z6enablev+0x1a>
    209a:	0f 9e c1             	setle  %cl
    209d:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # 20a4 <_Z6enablev+0x24>
    20a4:	0f 9f c0             	setg   %al
    20a7:	20 c8                	and    %cl,%al
    20a9:	c3                   	retq   
    20aa:	90                   	nop
    20ab:	90                   	nop
    20ac:	90                   	nop
...
00000000000020b0 <_Z9n_reg_maxv>:
    20b0:	b8 da 01 00 00       	mov    $0x1da,%eax
    20b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui24_uk18.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000001a80 <_Z6enablev>:
    1a80:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1a87 <_Z6enablev+0x7>
    1a87:	b8 c8 00 00 00       	mov    $0xc8,%eax
    1a8c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    1a91:	0f 45 c8             	cmovne %eax,%ecx
    1a94:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1a9a <_Z6enablev+0x1a>
    1a9a:	0f 9e c1             	setle  %cl
    1a9d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 1aa4 <_Z6enablev+0x24>
    1aa4:	0f 9f c0             	setg   %al
    1aa7:	20 c8                	and    %cl,%al
    1aa9:	c3                   	retq   
    1aaa:	90                   	nop
    1aab:	90                   	nop
    1aac:	90                   	nop
...
0000000000001ab0 <_Z9n_reg_maxv>:
    1ab0:	b8 6b 01 00 00       	mov    $0x16b,%eax
    1ab5:	c3                   	retq   

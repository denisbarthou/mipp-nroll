...
0000000000002220 <_Z6enablev>:
    ...
    2227:	b8 f0 00 00 00       	mov    $0xf0,%eax
    222c:	b9 e2 ff ff ff       	mov    $0xffffffe2,%ecx
    2231:	0f 45 c8             	cmovne %eax,%ecx
    2234:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 223a <_Z6enablev+0x1a>
    223a:	0f 9e c1             	setle  %cl
    223d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 2244 <_Z6enablev+0x24>
...
0000000000002250 <_Z9n_reg_maxv>:
    2250:	b8 b1 01 00 00       	mov    $0x1b1,%eax
    2255:	c3                   	retq   

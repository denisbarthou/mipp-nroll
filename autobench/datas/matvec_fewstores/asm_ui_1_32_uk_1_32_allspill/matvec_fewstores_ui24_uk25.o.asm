...
matvec_fewstores_ui24_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     19a:	0f 8e 8d 28 00 00    	jle    2a2d <_Z5benchv+0x28dd>
     ...
     314:	0f 83 13 27 00 00    	jae    2a2d <_Z5benchv+0x28dd>
    ...
    285f:	48 83 c3 19          	add    $0x19,%rbx
    2863:	48 0f af e8          	imul   %rax,%rbp
    2867:	48 01 fd             	add    %rdi,%rbp
    286a:	c4 e2 35 b8 9c a9 a0 	vfmadd231ps 0x1a0(%rcx,%rbp,4),%ymm9,%ymm3
    2871:	01 00 00 
    2874:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm6
    287b:	00 00 00 
    287e:	c4 e2 35 b8 8c a9 e0 	vfmadd231ps 0x2e0(%rcx,%rbp,4),%ymm9,%ymm1
    2885:	02 00 00 
    2888:	c4 62 35 b8 2c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm13
    288e:	c4 62 35 b8 74 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm14
    2895:	c4 62 35 b8 7c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm15
    289c:	c4 e2 35 b8 94 a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm2
    28a3:	00 00 00 
    28a6:	c4 62 35 b8 94 a9 00 	vfmadd231ps 0x100(%rcx,%rbp,4),%ymm9,%ymm10
    28ad:	01 00 00 
    28b0:	c4 62 35 b8 9c a9 20 	vfmadd231ps 0x120(%rcx,%rbp,4),%ymm9,%ymm11
    28b7:	01 00 00 
    28ba:	c4 62 35 b8 a4 a9 40 	vfmadd231ps 0x140(%rcx,%rbp,4),%ymm9,%ymm12
    28c1:	01 00 00 
    28c4:	c4 62 35 b8 84 a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm8
    28cb:	00 00 00 
    28ce:	c4 e2 35 b8 a4 a9 80 	vfmadd231ps 0x180(%rcx,%rbp,4),%ymm9,%ymm4
    28d5:	01 00 00 
    28d8:	c4 e2 35 b8 7c a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm7
    28df:	c4 e2 35 b8 ac a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm5
    28e6:	00 00 00 
    28e9:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    28ef:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    28f6:	00 00 
    28f8:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    28ff:	00 00 
    2901:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x1c0(%rcx,%rbp,4),%ymm9,%ymm3
    2908:	01 00 00 
    290b:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    2912:	00 00 
    2914:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    291a:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x160(%rcx,%rbp,4),%ymm9,%ymm6
    2921:	01 00 00 
    2924:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    292b:	00 00 
    292d:	c5 7c 29 d1          	vmovaps %ymm10,%ymm1
    2931:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    2936:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    293b:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    2940:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    2945:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    294a:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    294e:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    2955:	00 00 
    2957:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    295c:	c4 e2 35 b8 9c a9 00 	vfmadd231ps 0x200(%rcx,%rbp,4),%ymm9,%ymm3
    2963:	02 00 00 
    2966:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    296c:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2973:	00 00 
    2975:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0x1e0(%rcx,%rbp,4),%ymm9,%ymm6
    297c:	01 00 00 
    297f:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    2985:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    298a:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    2990:	c4 e2 35 b8 9c a9 40 	vfmadd231ps 0x240(%rcx,%rbp,4),%ymm9,%ymm3
    2997:	02 00 00 
    299a:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    29a1:	00 00 
    29a3:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    29a9:	c4 e2 35 b8 b4 a9 20 	vfmadd231ps 0x220(%rcx,%rbp,4),%ymm9,%ymm6
    29b0:	02 00 00 
    29b3:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    29b9:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    29bf:	c4 e2 35 b8 9c a9 80 	vfmadd231ps 0x280(%rcx,%rbp,4),%ymm9,%ymm3
    29c6:	02 00 00 
    29c9:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    29cf:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    29d5:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x260(%rcx,%rbp,4),%ymm9,%ymm6
    29dc:	02 00 00 
    29df:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    29e5:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    29eb:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x2c0(%rcx,%rbp,4),%ymm9,%ymm3
    29f2:	02 00 00 
    29f5:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    29fb:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2a01:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0x2a0(%rcx,%rbp,4),%ymm9,%ymm6
    2a08:	02 00 00 
    2a0b:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    2a0f:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    2a15:	c5 7c 29 c3          	vmovaps %ymm8,%ymm3
    2a19:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    2a1f:	4c 39 c3             	cmp    %r8,%rbx
    2a22:	0f 8c 98 da ff ff    	jl     4c0 <_Z5benchv+0x370>
    2a28:	e9 c8 d7 ff ff       	jmpq   1f5 <_Z5benchv+0xa5>
    2a2d:	0f 31                	rdtsc  
    2a2f:	48 c1 e2 20          	shl    $0x20,%rdx
    2a33:	48 09 c2             	or     %rax,%rdx
    2a36:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2a3c <_Z5benchv+0x28ec>
    2a3c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2a41:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2a49 <_Z5benchv+0x28f9>
    2a48:	00 
    2a49:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2a51 <_Z5benchv+0x2901>
    2a50:	00 
    2a51:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2a58 <_Z5benchv+0x2908>
    2a58:	01 c0                	add    %eax,%eax
    2a5a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2a60:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2a64:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    2a6b:	00 00 
    2a6d:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    2a71:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    2a75:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2a79:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2a7d:	48 81 c4 a8 01 00 00 	add    $0x1a8,%rsp
    2a84:	5b                   	pop    %rbx
    2a85:	41 5c                	pop    %r12
    2a87:	41 5d                	pop    %r13
    2a89:	41 5e                	pop    %r14
...
0000000000002aa0 <_Z6enablev>:
    ...
    2aa7:	b8 c0 00 00 00       	mov    $0xc0,%eax
    2aac:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    2ab1:	0f 45 c8             	cmovne %eax,%ecx
    2ab4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 2aba <_Z6enablev+0x1a>
    2aba:	0f 9e c1             	setle  %cl
    2abd:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 2ac4 <_Z6enablev+0x24>
...
0000000000002ad0 <_Z9n_reg_maxv>:
    2ad0:	b8 89 02 00 00       	mov    $0x289,%eax
    2ad5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui24_uk25.cpp+0x9a>
  96:	01 00 00 00 

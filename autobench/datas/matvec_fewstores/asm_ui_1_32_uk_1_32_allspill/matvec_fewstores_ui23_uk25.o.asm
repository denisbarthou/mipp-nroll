...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e 5d 25 00 00    	jle    2705 <_Z5benchv+0x25a5>
     ...
     31c:	0f 83 e3 23 00 00    	jae    2705 <_Z5benchv+0x25a5>
    ...
    257b:	48 83 c6 19          	add    $0x19,%rsi
    257f:	49 0f af c2          	imul   %r10,%rax
    2583:	48 01 f8             	add    %rdi,%rax
    2586:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    258d:	02 00 00 
    2590:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    2597:	00 00 00 
    259a:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    25a1:	00 00 00 
    25a4:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    25ab:	01 00 00 
    25ae:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    25b5:	01 00 00 
    25b8:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    25bf:	02 00 00 
    25c2:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    25c8:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    25cf:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    25d6:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    25dd:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    25e4:	00 00 00 
    25e7:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    25ee:	00 00 00 
    25f1:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    25f8:	01 00 00 
    25fb:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    2602:	01 00 00 
    2605:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    260b:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2612:	00 00 
    2614:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    261b:	01 00 00 
    261e:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    2625:	00 00 
    2627:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    262b:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    262f:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    2633:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    263a:	00 00 
    263c:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    2643:	00 00 
    2645:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    264b:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    2652:	01 00 00 
    2655:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    265b:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    2661:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    2668:	01 00 00 
    266b:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    2671:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    2677:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    267e:	01 00 00 
    2681:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    2687:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    268c:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    2693:	02 00 00 
    2696:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    269b:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    26a1:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    26a8:	02 00 00 
    26ab:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    26b1:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    26b7:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    26be:	02 00 00 
    26c1:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    26c7:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    26cd:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    26d4:	02 00 00 
    26d7:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    26dd:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    26e3:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    26ea:	02 00 00 
    26ed:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    26f1:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    26f7:	4c 39 c6             	cmp    %r8,%rsi
    26fa:	0f 8c 90 dd ff ff    	jl     490 <_Z5benchv+0x330>
    2700:	e9 ea da ff ff       	jmpq   1ef <_Z5benchv+0x8f>
    2705:	0f 31                	rdtsc  
    2707:	48 c1 e2 20          	shl    $0x20,%rdx
    270b:	48 09 c2             	or     %rax,%rdx
    270e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2714 <_Z5benchv+0x25b4>
    2714:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2719:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2721 <_Z5benchv+0x25c1>
    2720:	00 
    2721:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2729 <_Z5benchv+0x25c9>
    2728:	00 
    2729:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2730 <_Z5benchv+0x25d0>
    2730:	01 c0                	add    %eax,%eax
    2732:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2738:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    273c:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    2743:	00 00 
    2745:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    2749:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    274d:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2751:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2755:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    275c:	c5 f8 77             	vzeroupper 
    275f:	c3                   	retq   

0000000000002760 <_Z6enablev>:
    2760:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2767 <_Z6enablev+0x7>
    2767:	b8 b8 00 00 00       	mov    $0xb8,%eax
    276c:	b9 e9 ff ff ff       	mov    $0xffffffe9,%ecx
    2771:	0f 45 c8             	cmovne %eax,%ecx
    2774:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 277a <_Z6enablev+0x1a>
    277a:	0f 9e c1             	setle  %cl
    277d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 2784 <_Z6enablev+0x24>
...
0000000000002790 <_Z9n_reg_maxv>:
    2790:	b8 6f 02 00 00       	mov    $0x26f,%eax
    2795:	c3                   	retq   

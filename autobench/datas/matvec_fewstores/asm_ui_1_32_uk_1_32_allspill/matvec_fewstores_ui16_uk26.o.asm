...
0000000000001930 <_Z6enablev>:
    1930:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1937 <_Z6enablev+0x7>
    1937:	b8 80 00 00 00       	mov    $0x80,%eax
    193c:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
    1941:	0f 45 c8             	cmovne %eax,%ecx
    1944:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 194a <_Z6enablev+0x1a>
    194a:	0f 9e c1             	setle  %cl
    194d:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # 1954 <_Z6enablev+0x24>
    1954:	0f 9f c0             	setg   %al
    1957:	20 c8                	and    %cl,%al
    1959:	c3                   	retq   
    195a:	90                   	nop
    195b:	90                   	nop
    195c:	90                   	nop
...
0000000000001960 <_Z9n_reg_maxv>:
    1960:	b8 ca 01 00 00       	mov    $0x1ca,%eax
    1965:	c3                   	retq   

...
0000000000000fa0 <_Z6enablev>:
 ...
 fa7:	b8 a8 00 00 00       	mov    $0xa8,%eax
 fac:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
 fb1:	0f 45 c8             	cmovne %eax,%ecx
 fb4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # fba <_Z6enablev+0x1a>
 fba:	0f 9e c1             	setle  %cl
 fbd:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # fc4 <_Z6enablev+0x24>
...
0000000000000fd0 <_Z9n_reg_maxv>:
 fd0:	b8 c5 00 00 00       	mov    $0xc5,%eax
 fd5:	c3                   	retq   

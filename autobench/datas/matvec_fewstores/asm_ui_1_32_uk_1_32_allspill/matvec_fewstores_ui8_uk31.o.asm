...
0000000000000150 <_Z5benchv>:
 ...
 18a:	0f 8e 2b 0b 00 00    	jle    cbb <_Z5benchv+0xb6b>
 ...
 1e7:	0f 83 ce 0a 00 00    	jae    cbb <_Z5benchv+0xb6b>
 ...
 bb5:	48 0f af e8          	imul   %rax,%rbp
 bb9:	48 01 f5             	add    %rsi,%rbp
 bbc:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 bc2:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 bc9:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 bd0:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 bd7:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 bde:	00 00 00 
 be1:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 be8:	00 00 00 
 beb:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 bf2:	00 00 00 
 bf5:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 bfc:	00 00 00 
 bff:	48 8d 6b 1d          	lea    0x1d(%rbx),%rbp
 c03:	c4 62 7d 18 4c 9a 74 	vbroadcastss 0x74(%rdx,%rbx,4),%ymm9
 c0a:	48 0f af e8          	imul   %rax,%rbp
 c0e:	48 01 f5             	add    %rsi,%rbp
 c11:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 c17:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 c1e:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 c25:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 c2c:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 c33:	00 00 00 
 c36:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 c3d:	00 00 00 
 c40:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 c47:	00 00 00 
 c4a:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 c51:	00 00 00 
 c54:	48 8d 6b 1e          	lea    0x1e(%rbx),%rbp
 c58:	c4 62 7d 18 4c 9a 78 	vbroadcastss 0x78(%rdx,%rbx,4),%ymm9
 c5f:	48 83 c3 1f          	add    $0x1f,%rbx
 c63:	48 0f af e8          	imul   %rax,%rbp
 c67:	48 01 f5             	add    %rsi,%rbp
 c6a:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 c70:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 c77:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 c7e:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 c85:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 c8c:	00 00 00 
 c8f:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 c96:	00 00 00 
 c99:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 ca0:	00 00 00 
 ca3:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 caa:	00 00 00 
 cad:	48 39 fb             	cmp    %rdi,%rbx
 cb0:	0f 8c aa f5 ff ff    	jl     260 <_Z5benchv+0x110>
 cb6:	e9 f5 f4 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 cbb:	0f 31                	rdtsc  
 cbd:	48 c1 e2 20          	shl    $0x20,%rdx
 cc1:	48 09 c2             	or     %rax,%rdx
 cc4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # cca <_Z5benchv+0xb7a>
 cca:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 ccf:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # cd7 <_Z5benchv+0xb87>
 cd6:	00 
 cd7:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # cdf <_Z5benchv+0xb8f>
 cde:	00 
 cdf:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # ce6 <_Z5benchv+0xb96>
 ce6:	01 c0                	add    %eax,%eax
 ce8:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 cee:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 cf2:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 cf6:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 cfa:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 cfe:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 d02:	5b                   	pop    %rbx
 d03:	41 5c                	pop    %r12
 d05:	41 5d                	pop    %r13
 d07:	41 5e                	pop    %r14
...
0000000000000d40 <_Z9n_reg_maxv>:
 d40:	b8 1f 01 00 00       	mov    $0x11f,%eax
 d45:	c3                   	retq   

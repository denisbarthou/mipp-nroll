...
matvec_fewstores_ui27_uk29.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e 61 38 00 00    	jle    3a09 <_Z5benchv+0x38a9>
     ...
     36d:	0f 83 96 36 00 00    	jae    3a09 <_Z5benchv+0x38a9>
    ...
    37e7:	48 83 c6 1d          	add    $0x1d,%rsi
    37eb:	49 0f af c2          	imul   %r10,%rax
    37ef:	48 01 f8             	add    %rdi,%rax
    37f2:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm12,%ymm4
    37f9:	02 00 00 
    37fc:	c4 e2 1d b8 94 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm2
    3803:	00 00 00 
    3806:	c4 e2 1d b8 9c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm3
    380d:	00 00 00 
    3810:	c4 e2 1d b8 ac 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm5
    3817:	00 00 00 
    381a:	c4 62 1d b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm10
    3821:	00 00 00 
    3824:	c4 62 1d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm8
    382b:	01 00 00 
    382e:	c4 e2 1d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm12,%ymm6
    3835:	01 00 00 
    3838:	c4 62 1d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm12,%ymm9
    383f:	02 00 00 
    3842:	c4 62 1d b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm12,%ymm11
    3849:	02 00 00 
    384c:	c4 e2 1d b8 84 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm12,%ymm0
    3853:	03 00 00 
    3856:	c4 62 1d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm13
    385c:	c4 62 1d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm14
    3863:	c4 62 1d b8 7c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm15
    386a:	c4 e2 1d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm1
    3871:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    3877:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    387d:	c4 e2 1d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm7
    3884:	01 00 00 
    3887:	c5 fc 11 a4 24 80 01 	vmovups %ymm4,0x180(%rsp)
    388e:	00 00 
    3890:	c5 fc 10 a4 24 00 01 	vmovups 0x100(%rsp),%ymm4
    3897:	00 00 
    3899:	c4 e2 1d b8 a4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm12,%ymm4
    38a0:	02 00 00 
    38a3:	c5 fc 11 84 24 a0 01 	vmovups %ymm0,0x1a0(%rsp)
    38aa:	00 00 
    38ac:	c5 7c 29 e8          	vmovaps %ymm13,%ymm0
    38b0:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    38b6:	c5 fc 10 bc 24 e0 00 	vmovups 0xe0(%rsp),%ymm7
    38bd:	00 00 
    38bf:	c4 e2 1d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm7
    38c6:	01 00 00 
    38c9:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    38d0:	00 00 
    38d2:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    38d8:	c4 e2 1d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm12,%ymm4
    38df:	02 00 00 
    38e2:	c5 fc 11 bc 24 e0 00 	vmovups %ymm7,0xe0(%rsp)
    38e9:	00 00 
    38eb:	c5 fc 10 bc 24 a0 00 	vmovups 0xa0(%rsp),%ymm7
    38f2:	00 00 
    38f4:	c4 e2 1d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm12,%ymm7
    38fb:	01 00 00 
    38fe:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    3904:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    390a:	c4 e2 1d b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm12,%ymm4
    3911:	02 00 00 
    3914:	c5 fc 11 bc 24 a0 00 	vmovups %ymm7,0xa0(%rsp)
    391b:	00 00 
    391d:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    3923:	c4 e2 1d b8 bc 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm12,%ymm7
    392a:	01 00 00 
    392d:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    3933:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    393a:	00 00 
    393c:	c4 e2 1d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm12,%ymm4
    3943:	02 00 00 
    3946:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    394c:	c5 fc 10 bc 24 c0 00 	vmovups 0xc0(%rsp),%ymm7
    3953:	00 00 
    3955:	c4 e2 1d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm12,%ymm7
    395c:	01 00 00 
    395f:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    3966:	00 00 
    3968:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    396e:	c4 e2 1d b8 a4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm12,%ymm4
    3975:	02 00 00 
    3978:	c5 fc 11 bc 24 c0 00 	vmovups %ymm7,0xc0(%rsp)
    397f:	00 00 
    3981:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    3987:	c4 e2 1d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm12,%ymm7
    398e:	01 00 00 
    3991:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    3997:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    399c:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm12,%ymm4
    39a3:	03 00 00 
    39a6:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    39ac:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    39b0:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    39b4:	c5 7c 29 c5          	vmovaps %ymm8,%ymm5
    39b8:	c5 7c 10 44 24 c0    	vmovups -0x40(%rsp),%ymm8
    39be:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    39c3:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    39c9:	c4 e2 1d b8 a4 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm12,%ymm4
    39d0:	03 00 00 
    39d3:	c5 7c 28 e2          	vmovaps %ymm2,%ymm12
    39d7:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    39dd:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    39e3:	c5 7c 29 cc          	vmovaps %ymm9,%ymm4
    39e7:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    39ec:	c4 41 7c 28 da       	vmovaps %ymm10,%ymm11
    39f1:	c5 7c 28 d6          	vmovaps %ymm6,%ymm10
    39f5:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    39fb:	4c 39 c6             	cmp    %r8,%rsi
    39fe:	0f 8c 4c cb ff ff    	jl     550 <_Z5benchv+0x3f0>
    3a04:	e9 fd c7 ff ff       	jmpq   206 <_Z5benchv+0xa6>
    3a09:	0f 31                	rdtsc  
    3a0b:	48 c1 e2 20          	shl    $0x20,%rdx
    3a0f:	48 09 c2             	or     %rax,%rdx
    3a12:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3a18 <_Z5benchv+0x38b8>
    3a18:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3a1d:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3a25 <_Z5benchv+0x38c5>
    3a24:	00 
    3a25:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3a2d <_Z5benchv+0x38cd>
    3a2c:	00 
    3a2d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3a34 <_Z5benchv+0x38d4>
    3a34:	01 c0                	add    %eax,%eax
    3a36:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3a3c:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3a40:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    3a47:	00 00 
    3a49:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    3a4e:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    3a52:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3a56:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3a5a:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
    3a61:	c5 f8 77             	vzeroupper 
    3a64:	c3                   	retq   
    3a65:	90                   	nop
    3a66:	90                   	nop
    3a67:	90                   	nop
...
0000000000003a70 <_Z6enablev>:
    3a70:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3a77 <_Z6enablev+0x7>
    3a77:	b8 d8 00 00 00       	mov    $0xd8,%eax
    3a7c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    3a81:	0f 45 c8             	cmovne %eax,%ecx
    3a84:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3a8a <_Z6enablev+0x1a>
    3a8a:	0f 9e c1             	setle  %cl
    3a8d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 3a94 <_Z6enablev+0x24>
    3a94:	0f 9f c0             	setg   %al
    3a97:	20 c8                	and    %cl,%al
    3a99:	c3                   	retq   
    3a9a:	90                   	nop
    3a9b:	90                   	nop
    3a9c:	90                   	nop
...
0000000000003aa0 <_Z9n_reg_maxv>:
    3aa0:	b8 47 03 00 00       	mov    $0x347,%eax
    3aa5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui27_uk29.cpp+0x9a>
  96:	01 00 00 00 

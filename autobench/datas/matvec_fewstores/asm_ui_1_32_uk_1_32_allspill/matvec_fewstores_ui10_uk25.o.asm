...
matvec_fewstores_ui10_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 181:	0f 8e 4a 0b 00 00    	jle    cd1 <_Z5benchv+0xb81>
 ...
 20d:	0f 83 be 0a 00 00    	jae    cd1 <_Z5benchv+0xb81>
 ...
 c61:	48 83 c7 19          	add    $0x19,%rdi
 c65:	48 0f af c3          	imul   %rbx,%rax
 c69:	48 01 f0             	add    %rsi,%rax
 c6c:	c4 e2 25 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm1
 c72:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
 c79:	c4 e2 25 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm2
 c80:	c4 e2 25 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm3
 c87:	c4 e2 25 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm4
 c8e:	00 00 00 
 c91:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm5
 c98:	00 00 00 
 c9b:	c4 e2 25 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm6
 ca2:	00 00 00 
 ca5:	c4 62 25 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm8
 cac:	00 00 00 
 caf:	c4 62 25 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm9
 cb6:	01 00 00 
 cb9:	c4 62 25 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm10
 cc0:	01 00 00 
 cc3:	4c 39 d7             	cmp    %r10,%rdi
 cc6:	0f 8c b4 f5 ff ff    	jl     280 <_Z5benchv+0x130>
 ccc:	e9 df f4 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 cd1:	0f 31                	rdtsc  
 cd3:	48 c1 e2 20          	shl    $0x20,%rdx
 cd7:	48 09 c2             	or     %rax,%rdx
 cda:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # ce0 <_Z5benchv+0xb90>
 ce0:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 ce5:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # ced <_Z5benchv+0xb9d>
 cec:	00 
 ced:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # cf5 <_Z5benchv+0xba5>
 cf4:	00 
 cf5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # cfc <_Z5benchv+0xbac>
 cfc:	01 c0                	add    %eax,%eax
 cfe:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 d04:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 d08:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 d0c:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 d10:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 d14:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 d18:	5b                   	pop    %rbx
 d19:	c5 f8 77             	vzeroupper 
 d1c:	c3                   	retq   
 d1d:	90                   	nop
 d1e:	90                   	nop
 d1f:	90                   	nop
...
0000000000000d20 <_Z6enablev>:
 ...
 d27:	b8 50 00 00 00       	mov    $0x50,%eax
 d2c:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 d31:	0f 45 c8             	cmovne %eax,%ecx
 d34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # d3a <_Z6enablev+0x1a>
 d3a:	0f 9e c1             	setle  %cl
 d3d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # d44 <_Z6enablev+0x24>
...
0000000000000d50 <_Z9n_reg_maxv>:
 d50:	b8 1d 01 00 00       	mov    $0x11d,%eax
 d55:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui10_uk25.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e 24 42 00 00    	jle    43cc <_Z5benchv+0x426c>
     ...
     393:	0f 83 33 40 00 00    	jae    43cc <_Z5benchv+0x426c>
    ...
    416b:	48 83 c6 1d          	add    $0x1d,%rsi
    416f:	49 0f af c3          	imul   %r11,%rax
    4173:	48 01 f8             	add    %rdi,%rax
    4176:	c4 e2 05 b8 84 81 a0 	vfmadd231ps 0x3a0(%rcx,%rax,4),%ymm15,%ymm0
    417d:	03 00 00 
    4180:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
    4187:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
    418e:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
    4195:	01 00 00 
    4198:	c4 62 05 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm14
    419f:	01 00 00 
    41a2:	c4 62 05 b8 94 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm15,%ymm10
    41a9:	02 00 00 
    41ac:	c4 62 05 b8 ac 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm15,%ymm13
    41b3:	03 00 00 
    41b6:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
    41bc:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
    41c3:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
    41ca:	00 00 00 
    41cd:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
    41d4:	00 00 00 
    41d7:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
    41de:	00 00 00 
    41e1:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
    41e8:	00 00 00 
    41eb:	c4 62 05 b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm15,%ymm12
    41f2:	02 00 00 
    41f5:	c5 7c 11 1c 24       	vmovups %ymm11,(%rsp)
    41fa:	c5 7c 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm11
    4200:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
    4207:	01 00 00 
    420a:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    4211:	00 00 
    4213:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    4217:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    421b:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    421f:	c5 7c 11 5c 24 c0    	vmovups %ymm11,-0x40(%rsp)
    4225:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    422b:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm11
    4232:	01 00 00 
    4235:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    423b:	c5 7c 11 5c 24 80    	vmovups %ymm11,-0x80(%rsp)
    4241:	c5 7c 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm11
    4248:	00 00 
    424a:	c4 62 05 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm11
    4251:	01 00 00 
    4254:	c5 7c 11 9c 24 20 01 	vmovups %ymm11,0x120(%rsp)
    425b:	00 00 
    425d:	c5 7c 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm11
    4264:	00 00 
    4266:	c4 62 05 b8 9c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm11
    426d:	01 00 00 
    4270:	c5 7c 11 9c 24 e0 00 	vmovups %ymm11,0xe0(%rsp)
    4277:	00 00 
    4279:	c5 7c 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm11
    4280:	00 00 
    4282:	c4 62 05 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm15,%ymm11
    4289:	01 00 00 
    428c:	c5 7c 11 9c 24 a0 00 	vmovups %ymm11,0xa0(%rsp)
    4293:	00 00 
    4295:	c5 7c 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm11
    429c:	00 00 
    429e:	c4 62 05 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm15,%ymm11
    42a5:	01 00 00 
    42a8:	c5 7c 11 9c 24 80 00 	vmovups %ymm11,0x80(%rsp)
    42af:	00 00 
    42b1:	c5 7c 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm11
    42b8:	00 00 
    42ba:	c4 62 05 b8 9c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm15,%ymm11
    42c1:	02 00 00 
    42c4:	c5 7c 11 9c 24 00 01 	vmovups %ymm11,0x100(%rsp)
    42cb:	00 00 
    42cd:	c5 7c 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm11
    42d4:	00 00 
    42d6:	c4 62 05 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm15,%ymm11
    42dd:	02 00 00 
    42e0:	c5 7c 11 9c 24 c0 00 	vmovups %ymm11,0xc0(%rsp)
    42e7:	00 00 
    42e9:	c5 7c 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm11
    42ef:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm15,%ymm11
    42f6:	02 00 00 
    42f9:	c5 7c 11 5c 24 a0    	vmovups %ymm11,-0x60(%rsp)
    42ff:	c5 7c 10 9c 24 40 01 	vmovups 0x140(%rsp),%ymm11
    4306:	00 00 
    4308:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm15,%ymm11
    430f:	02 00 00 
    4312:	c5 7c 11 9c 24 40 01 	vmovups %ymm11,0x140(%rsp)
    4319:	00 00 
    431b:	c5 7c 10 9c 24 60 01 	vmovups 0x160(%rsp),%ymm11
    4322:	00 00 
    4324:	c4 62 05 b8 9c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm15,%ymm11
    432b:	02 00 00 
    432e:	c5 7c 11 9c 24 60 01 	vmovups %ymm11,0x160(%rsp)
    4335:	00 00 
    4337:	c5 7c 10 5c 24 20    	vmovups 0x20(%rsp),%ymm11
    433d:	c4 62 05 b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm15,%ymm11
    4344:	02 00 00 
    4347:	c5 7c 11 5c 24 20    	vmovups %ymm11,0x20(%rsp)
    434d:	c5 7c 10 5c 24 60    	vmovups 0x60(%rsp),%ymm11
    4353:	c4 62 05 b8 9c 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm15,%ymm11
    435a:	03 00 00 
    435d:	c5 7c 11 5c 24 60    	vmovups %ymm11,0x60(%rsp)
    4363:	c5 7c 10 5c 24 40    	vmovups 0x40(%rsp),%ymm11
    4369:	c4 62 05 b8 9c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm15,%ymm11
    4370:	03 00 00 
    4373:	c5 7c 11 5c 24 40    	vmovups %ymm11,0x40(%rsp)
    4379:	c5 7c 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm11
    437f:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm15,%ymm11
    4386:	03 00 00 
    4389:	c5 7c 11 5c 24 e0    	vmovups %ymm11,-0x20(%rsp)
    438f:	c5 7c 10 1c 24       	vmovups (%rsp),%ymm11
    4394:	c4 62 05 b8 9c 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm15,%ymm11
    439b:	03 00 00 
    439e:	c4 41 7c 28 fd       	vmovaps %ymm13,%ymm15
    43a3:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    43a8:	c4 41 7c 28 f2       	vmovaps %ymm10,%ymm14
    43ad:	c5 7c 10 54 24 a0    	vmovups -0x60(%rsp),%ymm10
    43b3:	c5 7c 11 1c 24       	vmovups %ymm11,(%rsp)
    43b8:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    43be:	4c 39 c6             	cmp    %r8,%rsi
    43c1:	0f 8c d9 c1 ff ff    	jl     5a0 <_Z5benchv+0x440>
    43c7:	e9 31 be ff ff       	jmpq   1fd <_Z5benchv+0x9d>
    43cc:	0f 31                	rdtsc  
    43ce:	48 c1 e2 20          	shl    $0x20,%rdx
    43d2:	48 09 c2             	or     %rax,%rdx
    43d5:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 43db <_Z5benchv+0x427b>
    43db:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    43e0:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 43e8 <_Z5benchv+0x4288>
    43e7:	00 
    43e8:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 43f0 <_Z5benchv+0x4290>
    43ef:	00 
    43f0:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 43f7 <_Z5benchv+0x4297>
    43f7:	01 c0                	add    %eax,%eax
    43f9:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    43ff:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    4403:	c5 fb 5c 84 24 98 01 	vsubsd 0x198(%rsp),%xmm0,%xmm0
    440a:	00 00 
    440c:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    4410:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    4414:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    4418:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    441c:	48 81 c4 78 02 00 00 	add    $0x278,%rsp
    4423:	c5 f8 77             	vzeroupper 
    4426:	c3                   	retq   
    4427:	90                   	nop
    4428:	90                   	nop
    4429:	90                   	nop
...
0000000000004430 <_Z6enablev>:
    ...
    4437:	b8 f0 00 00 00       	mov    $0xf0,%eax
    443c:	b9 e2 ff ff ff       	mov    $0xffffffe2,%ecx
    4441:	0f 45 c8             	cmovne %eax,%ecx
    4444:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 444a <_Z6enablev+0x1a>
    444a:	0f 9e c1             	setle  %cl
    444d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 4454 <_Z6enablev+0x24>
...
0000000000004460 <_Z9n_reg_maxv>:
    4460:	b8 a1 03 00 00       	mov    $0x3a1,%eax
    4465:	c3                   	retq   

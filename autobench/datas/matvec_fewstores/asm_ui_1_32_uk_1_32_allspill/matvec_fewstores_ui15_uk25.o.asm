...
matvec_fewstores_ui15_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     188:	0f 8e 95 10 00 00    	jle    1223 <_Z5benchv+0x10d3>
     ...
     250:	0f 83 cd 0f 00 00    	jae    1223 <_Z5benchv+0x10d3>
    ...
    1181:	48 83 c6 19          	add    $0x19,%rsi
    1185:	49 0f af c2          	imul   %r10,%rax
    1189:	48 01 f8             	add    %rdi,%rax
    118c:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
    1192:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
    1199:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
    11a0:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
    11a7:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
    11ae:	00 00 00 
    11b1:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
    11b8:	00 00 00 
    11bb:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
    11c2:	00 00 00 
    11c5:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
    11cc:	00 00 00 
    11cf:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
    11d6:	01 00 00 
    11d9:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
    11e0:	01 00 00 
    11e3:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
    11ea:	01 00 00 
    11ed:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
    11f4:	01 00 00 
    11f7:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
    11fe:	01 00 00 
    1201:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
    1208:	01 00 00 
    120b:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
    1212:	01 00 00 
    1215:	4c 39 c6             	cmp    %r8,%rsi
    1218:	0f 8c d2 f0 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
    121e:	e9 9d ef ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    1223:	0f 31                	rdtsc  
    1225:	48 c1 e2 20          	shl    $0x20,%rdx
    1229:	48 09 c2             	or     %rax,%rdx
    122c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1232 <_Z5benchv+0x10e2>
    1232:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1237:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 123f <_Z5benchv+0x10ef>
    123e:	00 
    123f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1247 <_Z5benchv+0x10f7>
    1246:	00 
    1247:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 124e <_Z5benchv+0x10fe>
    124e:	01 c0                	add    %eax,%eax
    1250:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1256:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    125a:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1260:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
    1264:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
...
0000000000001280 <_Z6enablev>:
    ...
    1287:	b8 78 00 00 00       	mov    $0x78,%eax
    128c:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
    1291:	0f 45 c8             	cmovne %eax,%ecx
    1294:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 129a <_Z6enablev+0x1a>
    129a:	0f 9e c1             	setle  %cl
    129d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 12a4 <_Z6enablev+0x24>
...
00000000000012b0 <_Z9n_reg_maxv>:
    12b0:	b8 9f 01 00 00       	mov    $0x19f,%eax
    12b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui15_uk25.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000f20 <_Z6enablev>:
 ...
 f27:	b8 70 00 00 00       	mov    $0x70,%eax
 f2c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 f31:	0f 45 c8             	cmovne %eax,%ecx
 f34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # f3a <_Z6enablev+0x1a>
 f3a:	0f 9e c1             	setle  %cl
 f3d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # f44 <_Z6enablev+0x24>
...
0000000000000f50 <_Z9n_reg_maxv>:
 f50:	b8 49 01 00 00       	mov    $0x149,%eax
 f55:	c3                   	retq   

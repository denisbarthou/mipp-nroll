...
matvec_fewstores_ui13_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     182:	0f 8e 85 0f 00 00    	jle    110d <_Z5benchv+0xfbd>
     ...
     22c:	0f 83 db 0e 00 00    	jae    110d <_Z5benchv+0xfbd>
    ...
    107f:	48 83 c6 1b          	add    $0x1b,%rsi
    1083:	49 0f af c2          	imul   %r10,%rax
    1087:	48 01 f8             	add    %rdi,%rax
    108a:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
    1090:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
    1097:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
    109e:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
    10a5:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
    10ac:	00 00 00 
    10af:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
    10b6:	00 00 00 
    10b9:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
    10c0:	00 00 00 
    10c3:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
    10ca:	00 00 00 
    10cd:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
    10d4:	01 00 00 
    10d7:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
    10de:	01 00 00 
    10e1:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
    10e8:	01 00 00 
    10eb:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
    10f2:	01 00 00 
    10f5:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
    10fc:	01 00 00 
    10ff:	4c 39 c6             	cmp    %r8,%rsi
    1102:	0f 8c b8 f1 ff ff    	jl     2c0 <_Z5benchv+0x170>
    1108:	e9 a3 f0 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
    110d:	0f 31                	rdtsc  
    110f:	48 c1 e2 20          	shl    $0x20,%rdx
    1113:	48 09 c2             	or     %rax,%rdx
    1116:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 111c <_Z5benchv+0xfcc>
    111c:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    1121:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1129 <_Z5benchv+0xfd9>
    1128:	00 
    1129:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 1131 <_Z5benchv+0xfe1>
    1130:	00 
    1131:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1138 <_Z5benchv+0xfe8>
    1138:	01 c0                	add    %eax,%eax
    113a:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    1140:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    1144:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    1148:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    114c:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1150:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1154:	c5 f8 77             	vzeroupper 
    1157:	c3                   	retq   
    1158:	90                   	nop
    1159:	90                   	nop
    115a:	90                   	nop
...
0000000000001160 <_Z6enablev>:
    ...
    1167:	b8 68 00 00 00       	mov    $0x68,%eax
    116c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
    1171:	0f 45 c8             	cmovne %eax,%ecx
    1174:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 117a <_Z6enablev+0x1a>
    117a:	0f 9e c1             	setle  %cl
    117d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 1184 <_Z6enablev+0x24>
...
0000000000001190 <_Z9n_reg_maxv>:
    1190:	b8 87 01 00 00       	mov    $0x187,%eax
    1195:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui13_uk27.cpp+0x9a>
  96:	01 00 00 00 

...
matvec_fewstores_ui12_uk18.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 187:	0f 8e ff 09 00 00    	jle    b8c <_Z5benchv+0xa3c>
 ...
 21f:	0f 83 67 09 00 00    	jae    b8c <_Z5benchv+0xa3c>
 ...
 b7b:	01 00 00 
 b7e:	4c 39 c3             	cmp    %r8,%rbx
 b81:	0f 8c 29 f7 ff ff    	jl     2b0 <_Z5benchv+0x160>
 b87:	e9 24 f6 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 b8c:	0f 31                	rdtsc  
 b8e:	48 c1 e2 20          	shl    $0x20,%rdx
 b92:	48 09 c2             	or     %rax,%rdx
 b95:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b9b <_Z5benchv+0xa4b>
 b9b:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 ba0:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # ba8 <_Z5benchv+0xa58>
 ba7:	00 
 ba8:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # bb0 <_Z5benchv+0xa60>
 baf:	00 
 bb0:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # bb7 <_Z5benchv+0xa67>
 bb7:	01 c0                	add    %eax,%eax
 bb9:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 bbf:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 bc3:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 bc7:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 bcb:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 bcf:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 bd3:	5b                   	pop    %rbx
 bd4:	41 5e                	pop    %r14
 bd6:	41 5f                	pop    %r15
 bd8:	c5 f8 77             	vzeroupper 
 bdb:	c3                   	retq   
 bdc:	90                   	nop
 bdd:	90                   	nop
 bde:	90                   	nop
...
0000000000000be0 <_Z6enablev>:
 ...
 be7:	b8 60 00 00 00       	mov    $0x60,%eax
 bec:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 bf1:	0f 45 c8             	cmovne %eax,%ecx
 bf4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # bfa <_Z6enablev+0x1a>
 bfa:	0f 9e c1             	setle  %cl
 bfd:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # c04 <_Z6enablev+0x24>
...
0000000000000c10 <_Z9n_reg_maxv>:
 c10:	b8 f6 00 00 00       	mov    $0xf6,%eax
 c15:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui12_uk18.cpp+0x9a>
  96:	01 00 00 00 

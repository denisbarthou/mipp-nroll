...
matvec_fewstores_ui24_uk21.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     19a:	0f 8e b1 22 00 00    	jle    2451 <_Z5benchv+0x2301>
     ...
     314:	0f 83 37 21 00 00    	jae    2451 <_Z5benchv+0x2301>
    ...
    2283:	48 83 c3 15          	add    $0x15,%rbx
    2287:	48 0f af e8          	imul   %rax,%rbp
    228b:	48 01 fd             	add    %rdi,%rbp
    228e:	c4 e2 35 b8 9c a9 a0 	vfmadd231ps 0x1a0(%rcx,%rbp,4),%ymm9,%ymm3
    2295:	01 00 00 
    2298:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm6
    229f:	00 00 00 
    22a2:	c4 e2 35 b8 8c a9 e0 	vfmadd231ps 0x2e0(%rcx,%rbp,4),%ymm9,%ymm1
    22a9:	02 00 00 
    22ac:	c4 62 35 b8 2c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm13
    22b2:	c4 62 35 b8 74 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm14
    22b9:	c4 62 35 b8 7c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm15
    22c0:	c4 e2 35 b8 94 a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm2
    22c7:	00 00 00 
    22ca:	c4 62 35 b8 94 a9 00 	vfmadd231ps 0x100(%rcx,%rbp,4),%ymm9,%ymm10
    22d1:	01 00 00 
    22d4:	c4 62 35 b8 9c a9 20 	vfmadd231ps 0x120(%rcx,%rbp,4),%ymm9,%ymm11
    22db:	01 00 00 
    22de:	c4 62 35 b8 a4 a9 40 	vfmadd231ps 0x140(%rcx,%rbp,4),%ymm9,%ymm12
    22e5:	01 00 00 
    22e8:	c4 62 35 b8 84 a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm8
    22ef:	00 00 00 
    22f2:	c4 e2 35 b8 a4 a9 80 	vfmadd231ps 0x180(%rcx,%rbp,4),%ymm9,%ymm4
    22f9:	01 00 00 
    22fc:	c4 e2 35 b8 7c a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm7
    2303:	c4 e2 35 b8 ac a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm5
    230a:	00 00 00 
    230d:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    2313:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    231a:	00 00 
    231c:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    2323:	00 00 
    2325:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x1c0(%rcx,%rbp,4),%ymm9,%ymm3
    232c:	01 00 00 
    232f:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    2336:	00 00 
    2338:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    233e:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x160(%rcx,%rbp,4),%ymm9,%ymm6
    2345:	01 00 00 
    2348:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    234f:	00 00 
    2351:	c5 7c 29 d1          	vmovaps %ymm10,%ymm1
    2355:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    235a:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    235f:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    2364:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    2369:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    236e:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    2372:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    2379:	00 00 
    237b:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    2380:	c4 e2 35 b8 9c a9 00 	vfmadd231ps 0x200(%rcx,%rbp,4),%ymm9,%ymm3
    2387:	02 00 00 
    238a:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    2390:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2397:	00 00 
    2399:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0x1e0(%rcx,%rbp,4),%ymm9,%ymm6
    23a0:	01 00 00 
    23a3:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    23a9:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    23ae:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    23b4:	c4 e2 35 b8 9c a9 40 	vfmadd231ps 0x240(%rcx,%rbp,4),%ymm9,%ymm3
    23bb:	02 00 00 
    23be:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    23c5:	00 00 
    23c7:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    23cd:	c4 e2 35 b8 b4 a9 20 	vfmadd231ps 0x220(%rcx,%rbp,4),%ymm9,%ymm6
    23d4:	02 00 00 
    23d7:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    23dd:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    23e3:	c4 e2 35 b8 9c a9 80 	vfmadd231ps 0x280(%rcx,%rbp,4),%ymm9,%ymm3
    23ea:	02 00 00 
    23ed:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    23f3:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    23f9:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x260(%rcx,%rbp,4),%ymm9,%ymm6
    2400:	02 00 00 
    2403:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    2409:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    240f:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x2c0(%rcx,%rbp,4),%ymm9,%ymm3
    2416:	02 00 00 
    2419:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    241f:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2425:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0x2a0(%rcx,%rbp,4),%ymm9,%ymm6
    242c:	02 00 00 
    242f:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    2433:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    2439:	c5 7c 29 c3          	vmovaps %ymm8,%ymm3
    243d:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    2443:	4c 39 c3             	cmp    %r8,%rbx
    2446:	0f 8c 74 e0 ff ff    	jl     4c0 <_Z5benchv+0x370>
    244c:	e9 a4 dd ff ff       	jmpq   1f5 <_Z5benchv+0xa5>
    2451:	0f 31                	rdtsc  
    2453:	48 c1 e2 20          	shl    $0x20,%rdx
    2457:	48 09 c2             	or     %rax,%rdx
    245a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2460 <_Z5benchv+0x2310>
    2460:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2465:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 246d <_Z5benchv+0x231d>
    246c:	00 
    246d:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2475 <_Z5benchv+0x2325>
    2474:	00 
    2475:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 247c <_Z5benchv+0x232c>
    247c:	01 c0                	add    %eax,%eax
    247e:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2484:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2488:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    248f:	00 00 
    2491:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    2495:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    2499:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    249d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    24a1:	48 81 c4 a8 01 00 00 	add    $0x1a8,%rsp
    24a8:	5b                   	pop    %rbx
    24a9:	41 5c                	pop    %r12
    24ab:	41 5d                	pop    %r13
    24ad:	41 5e                	pop    %r14
...
00000000000024c0 <_Z6enablev>:
    ...
    24dd:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 24e4 <_Z6enablev+0x24>
...
00000000000024f0 <_Z9n_reg_maxv>:
    24f0:	b8 25 02 00 00       	mov    $0x225,%eax
    24f5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui24_uk21.cpp+0x9a>
  96:	01 00 00 00 

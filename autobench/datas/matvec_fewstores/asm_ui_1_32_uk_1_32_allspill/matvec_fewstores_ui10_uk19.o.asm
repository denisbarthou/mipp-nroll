...
matvec_fewstores_ui10_uk19.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e d3 08 00 00    	jle    a5b <_Z5benchv+0x90b>
 ...
 20d:	0f 83 48 08 00 00    	jae    a5b <_Z5benchv+0x90b>
 ...
 9eb:	48 83 c7 13          	add    $0x13,%rdi
 9ef:	49 0f af c3          	imul   %r11,%rax
 9f3:	48 01 f0             	add    %rsi,%rax
 9f6:	c4 e2 25 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm1
 9fc:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
 a03:	c4 e2 25 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm2
 a0a:	c4 e2 25 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm3
 a11:	c4 e2 25 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm4
 a18:	00 00 00 
 a1b:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm5
 a22:	00 00 00 
 a25:	c4 e2 25 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm6
 a2c:	00 00 00 
 a2f:	c4 62 25 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm8
 a36:	00 00 00 
 a39:	c4 62 25 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm9
 a40:	01 00 00 
 a43:	c4 62 25 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm10
 a4a:	01 00 00 
 a4d:	4c 39 d7             	cmp    %r10,%rdi
 a50:	0f 8c 2a f8 ff ff    	jl     280 <_Z5benchv+0x130>
 a56:	e9 55 f7 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 a5b:	0f 31                	rdtsc  
 a5d:	48 c1 e2 20          	shl    $0x20,%rdx
 a61:	48 09 c2             	or     %rax,%rdx
 a64:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # a6a <_Z5benchv+0x91a>
 a6a:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 a6f:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # a77 <_Z5benchv+0x927>
 a76:	00 
 a77:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # a7f <_Z5benchv+0x92f>
 a7e:	00 
 a7f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # a86 <_Z5benchv+0x936>
 a86:	01 c0                	add    %eax,%eax
 a88:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 a8e:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 a92:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 a96:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 a9a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 a9e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 aa2:	c5 f8 77             	vzeroupper 
 aa5:	c3                   	retq   
 aa6:	90                   	nop
 aa7:	90                   	nop
 aa8:	90                   	nop
...
0000000000000ab0 <_Z6enablev>:
 ...
 ab7:	b8 50 00 00 00       	mov    $0x50,%eax
 abc:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 ac1:	0f 45 c8             	cmovne %eax,%ecx
 ac4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # aca <_Z6enablev+0x1a>
 aca:	0f 9e c1             	setle  %cl
 acd:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # ad4 <_Z6enablev+0x24>
...
0000000000000ae0 <_Z9n_reg_maxv>:
 ae0:	b8 db 00 00 00       	mov    $0xdb,%eax
 ae5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui10_uk19.cpp+0x9a>
  96:	01 00 00 00 

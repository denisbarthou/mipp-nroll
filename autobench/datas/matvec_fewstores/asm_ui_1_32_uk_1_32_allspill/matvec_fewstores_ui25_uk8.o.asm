...
00000000000012b0 <_Z6enablev>:
    ...
    12b7:	b8 c8 00 00 00       	mov    $0xc8,%eax
    12bc:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    12c1:	0f 45 c8             	cmovne %eax,%ecx
    12c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 12ca <_Z6enablev+0x1a>
    12ca:	0f 9e c1             	setle  %cl
    12cd:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 12d4 <_Z6enablev+0x24>
...
00000000000012e0 <_Z9n_reg_maxv>:
    12e0:	b8 e9 00 00 00       	mov    $0xe9,%eax
    12e5:	c3                   	retq   

...
matvec_fewstores_ui14_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     182:	0f 8e a3 10 00 00    	jle    122b <_Z5benchv+0x10db>
     ...
     235:	0f 83 f0 0f 00 00    	jae    122b <_Z5benchv+0x10db>
    ...
    1193:	48 83 c6 1b          	add    $0x1b,%rsi
    1197:	49 0f af c3          	imul   %r11,%rax
    119b:	48 01 f8             	add    %rdi,%rax
    119e:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
    11a4:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
    11ab:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
    11b2:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
    11b9:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
    11c0:	00 00 00 
    11c3:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
    11ca:	00 00 00 
    11cd:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
    11d4:	00 00 00 
    11d7:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
    11de:	00 00 00 
    11e1:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
    11e8:	01 00 00 
    11eb:	c4 62 05 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm10
    11f2:	01 00 00 
    11f5:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
    11fc:	01 00 00 
    11ff:	c4 62 05 b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm12
    1206:	01 00 00 
    1209:	c4 62 05 b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm13
    1210:	01 00 00 
    1213:	c4 62 05 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm14
    121a:	01 00 00 
    121d:	4c 39 c6             	cmp    %r8,%rsi
    1220:	0f 8c aa f0 ff ff    	jl     2d0 <_Z5benchv+0x180>
    1226:	e9 85 ef ff ff       	jmpq   1b0 <_Z5benchv+0x60>
    122b:	0f 31                	rdtsc  
    122d:	48 c1 e2 20          	shl    $0x20,%rdx
    1231:	48 09 c2             	or     %rax,%rdx
    1234:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 123a <_Z5benchv+0x10ea>
    123a:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    123f:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1247 <_Z5benchv+0x10f7>
    1246:	00 
    1247:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 124f <_Z5benchv+0x10ff>
    124e:	00 
    124f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1256 <_Z5benchv+0x1106>
    1256:	01 c0                	add    %eax,%eax
    1258:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    125e:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    1262:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    1266:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    126b:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    126f:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1273:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1277:	c5 f8 77             	vzeroupper 
    127a:	c3                   	retq   
    127b:	90                   	nop
    127c:	90                   	nop
    127d:	90                   	nop
...
0000000000001280 <_Z6enablev>:
    ...
    1287:	b8 70 00 00 00       	mov    $0x70,%eax
    128c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
    1291:	0f 45 c8             	cmovne %eax,%ecx
    1294:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 129a <_Z6enablev+0x1a>
    129a:	0f 9e c1             	setle  %cl
    129d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 12a4 <_Z6enablev+0x24>
...
00000000000012b0 <_Z9n_reg_maxv>:
    12b0:	b8 a3 01 00 00       	mov    $0x1a3,%eax
    12b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui14_uk27.cpp+0x9a>
  96:	01 00 00 00 

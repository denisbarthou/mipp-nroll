...
0000000000000160 <_Z5benchv>:
 ...
 192:	0f 8e bb 0b 00 00    	jle    d53 <_Z5benchv+0xbf3>
 ...
 214:	0f 83 39 0b 00 00    	jae    d53 <_Z5benchv+0xbf3>
 ...
 ced:	48 83 c7 1d          	add    $0x1d,%rdi
 cf1:	49 0f af c3          	imul   %r11,%rax
 cf5:	48 01 f0             	add    %rsi,%rax
 cf8:	c4 e2 2d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm10,%ymm1
 cfe:	c4 e2 2d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm10,%ymm2
 d05:	c4 e2 2d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm10,%ymm3
 d0c:	c4 e2 2d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm10,%ymm4
 d13:	c4 e2 2d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm10,%ymm5
 d1a:	00 00 00 
 d1d:	c4 e2 2d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm10,%ymm6
 d24:	00 00 00 
 d27:	c4 e2 2d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm10,%ymm7
 d2e:	00 00 00 
 d31:	c4 62 2d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm10,%ymm8
 d38:	00 00 00 
 d3b:	c4 62 2d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm10,%ymm9
 d42:	01 00 00 
 d45:	4c 39 cf             	cmp    %r9,%rdi
 d48:	0f 8c 32 f5 ff ff    	jl     280 <_Z5benchv+0x120>
 d4e:	e9 6d f4 ff ff       	jmpq   1c0 <_Z5benchv+0x60>
 d53:	0f 31                	rdtsc  
 d55:	48 c1 e2 20          	shl    $0x20,%rdx
 d59:	48 09 c2             	or     %rax,%rdx
 d5c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # d62 <_Z5benchv+0xc02>
 d62:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 d67:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # d6f <_Z5benchv+0xc0f>
 d6e:	00 
 d6f:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # d77 <_Z5benchv+0xc17>
 d76:	00 
 d77:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # d7e <_Z5benchv+0xc1e>
 d7e:	01 c0                	add    %eax,%eax
 d80:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 d86:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 d8a:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 d8e:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
 d92:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 d96:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 d9a:	c5 f8 77             	vzeroupper 
 d9d:	c3                   	retq   
 d9e:	90                   	nop
 d9f:	90                   	nop
...
0000000000000da0 <_Z6enablev>:
 ...
 da7:	b8 48 00 00 00       	mov    $0x48,%eax
 dac:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 db1:	0f 45 c8             	cmovne %eax,%ecx
 db4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # dba <_Z6enablev+0x1a>
 dba:	0f 9e c1             	setle  %cl
 dbd:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # dc4 <_Z6enablev+0x24>
...
0000000000000dd0 <_Z9n_reg_maxv>:
 dd0:	b8 2b 01 00 00       	mov    $0x12b,%eax
 dd5:	c3                   	retq   

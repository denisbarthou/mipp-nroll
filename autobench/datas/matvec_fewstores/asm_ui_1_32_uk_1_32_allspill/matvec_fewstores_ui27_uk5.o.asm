...
0000000000000ff0 <_Z6enablev>:
     ...
     ff7:	b8 d8 00 00 00       	mov    $0xd8,%eax
     ffc:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    1001:	0f 45 c8             	cmovne %eax,%ecx
    1004:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 100a <_Z6enablev+0x1a>
    100a:	0f 9e c1             	setle  %cl
    100d:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 1014 <_Z6enablev+0x24>
...
0000000000001020 <_Z9n_reg_maxv>:
    1020:	b8 a7 00 00 00       	mov    $0xa7,%eax
    1025:	c3                   	retq   

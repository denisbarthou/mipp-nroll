...
0000000000000c60 <_Z6enablev>:
 ...
 c67:	b8 28 00 00 00       	mov    $0x28,%eax
 c6c:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx
 c71:	0f 45 c8             	cmovne %eax,%ecx
 c74:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # c7a <_Z6enablev+0x1a>
 c7a:	0f 9e c1             	setle  %cl
 c7d:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # c84 <_Z6enablev+0x24>
...
0000000000000c90 <_Z9n_reg_maxv>:
 c90:	b8 89 00 00 00       	mov    $0x89,%eax
 c95:	c3                   	retq   

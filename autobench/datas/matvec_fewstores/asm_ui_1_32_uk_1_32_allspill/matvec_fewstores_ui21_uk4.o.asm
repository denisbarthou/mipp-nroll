...
0000000000000a70 <_Z6enablev>:
 ...
 a77:	b8 a8 00 00 00       	mov    $0xa8,%eax
 a7c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
 a81:	0f 45 c8             	cmovne %eax,%ecx
 a84:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a8a <_Z6enablev+0x1a>
 a8a:	0f 9e c1             	setle  %cl
 a8d:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # a94 <_Z6enablev+0x24>
...
0000000000000aa0 <_Z9n_reg_maxv>:
 aa0:	b8 6d 00 00 00       	mov    $0x6d,%eax
 aa5:	c3                   	retq   

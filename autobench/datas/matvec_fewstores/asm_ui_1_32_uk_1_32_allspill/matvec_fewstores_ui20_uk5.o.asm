...
0000000000000cc0 <_Z6enablev>:
 ...
 cc7:	b8 a0 00 00 00       	mov    $0xa0,%eax
 ccc:	b9 ec ff ff ff       	mov    $0xffffffec,%ecx
 cd1:	0f 45 c8             	cmovne %eax,%ecx
 cd4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # cda <_Z6enablev+0x1a>
 cda:	0f 9e c1             	setle  %cl
 cdd:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # ce4 <_Z6enablev+0x24>
...
0000000000000cf0 <_Z9n_reg_maxv>:
 cf0:	b8 7d 00 00 00       	mov    $0x7d,%eax
 cf5:	c3                   	retq   

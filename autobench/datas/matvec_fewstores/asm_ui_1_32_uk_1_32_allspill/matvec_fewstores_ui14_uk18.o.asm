...
matvec_fewstores_ui14_uk18.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 8c 0b 00 00    	jle    d14 <_Z5benchv+0xbc4>
 ...
 235:	0f 83 d9 0a 00 00    	jae    d14 <_Z5benchv+0xbc4>
 ...
 d03:	01 00 00 
 d06:	4c 39 c6             	cmp    %r8,%rsi
 d09:	0f 8c c1 f5 ff ff    	jl     2d0 <_Z5benchv+0x180>
 d0f:	e9 9c f4 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 d14:	0f 31                	rdtsc  
 d16:	48 c1 e2 20          	shl    $0x20,%rdx
 d1a:	48 09 c2             	or     %rax,%rdx
 d1d:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # d23 <_Z5benchv+0xbd3>
 d23:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 d28:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # d30 <_Z5benchv+0xbe0>
 d2f:	00 
 d30:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # d38 <_Z5benchv+0xbe8>
 d37:	00 
 d38:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # d3f <_Z5benchv+0xbef>
 d3f:	01 c0                	add    %eax,%eax
 d41:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 d47:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 d4b:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 d4f:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
 d54:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 d58:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 d5c:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 d60:	c5 f8 77             	vzeroupper 
 d63:	c3                   	retq   
 d64:	90                   	nop
 d65:	90                   	nop
 d66:	90                   	nop
...
0000000000000d70 <_Z6enablev>:
 d70:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # d77 <_Z6enablev+0x7>
 d77:	b8 70 00 00 00       	mov    $0x70,%eax
 d7c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 d81:	0f 45 c8             	cmovne %eax,%ecx
 d84:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # d8a <_Z6enablev+0x1a>
 d8a:	0f 9e c1             	setle  %cl
 d8d:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # d94 <_Z6enablev+0x24>
 d94:	0f 9f c0             	setg   %al
 d97:	20 c8                	and    %cl,%al
 d99:	c3                   	retq   
 d9a:	90                   	nop
 d9b:	90                   	nop
...
0000000000000da0 <_Z9n_reg_maxv>:
 da0:	b8 1c 01 00 00       	mov    $0x11c,%eax
 da5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui14_uk18.cpp+0x9a>
  96:	01 00 00 00 

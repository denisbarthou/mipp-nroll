...
00000000000018a0 <_Z6enablev>:
    ...
    18a7:	b8 98 00 00 00       	mov    $0x98,%eax
    18ac:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    18b1:	0f 45 c8             	cmovne %eax,%ecx
    18b4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 18ba <_Z6enablev+0x1a>
    18ba:	0f 9e c1             	setle  %cl
    18bd:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # 18c4 <_Z6enablev+0x24>
...
00000000000018d0 <_Z9n_reg_maxv>:
    18d0:	b8 8f 01 00 00       	mov    $0x18f,%eax
    18d5:	c3                   	retq   

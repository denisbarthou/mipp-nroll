...
0000000000000fc0 <_Z6enablev>:
 ...
 fc7:	b8 60 00 00 00       	mov    $0x60,%eax
 fcc:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 fd1:	0f 45 c8             	cmovne %eax,%ecx
 fd4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # fda <_Z6enablev+0x1a>
 fda:	0f 9e c1             	setle  %cl
 fdd:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # fe4 <_Z6enablev+0x24>
...
0000000000000ff0 <_Z9n_reg_maxv>:
 ff0:	b8 cf 00 00 00       	mov    $0xcf,%eax
 ff5:	c3                   	retq   

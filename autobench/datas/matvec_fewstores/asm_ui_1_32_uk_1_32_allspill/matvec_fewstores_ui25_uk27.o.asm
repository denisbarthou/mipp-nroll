...
matvec_fewstores_ui25_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 89 2e 00 00    	jle    3021 <_Z5benchv+0x2ed1>
     ...
     344:	0f 83 d7 2c 00 00    	jae    3021 <_Z5benchv+0x2ed1>
    ...
    2e5e:	48 83 c6 1b          	add    $0x1b,%rsi
    2e62:	49 0f af c2          	imul   %r10,%rax
    2e66:	48 01 f8             	add    %rdi,%rax
    2e69:	c4 e2 2d b8 84 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm10,%ymm0
    2e70:	03 00 00 
    2e73:	c4 62 2d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm10,%ymm8
    2e7a:	00 00 00 
    2e7d:	c4 e2 2d b8 ac 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm10,%ymm5
    2e84:	01 00 00 
    2e87:	c4 e2 2d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm10,%ymm3
    2e8e:	01 00 00 
    2e91:	c4 e2 2d b8 94 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm10,%ymm2
    2e98:	01 00 00 
    2e9b:	c4 e2 2d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm10,%ymm7
    2ea2:	01 00 00 
    2ea5:	c4 62 2d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm10,%ymm11
    2eab:	c4 62 2d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm10,%ymm12
    2eb2:	c4 62 2d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm10,%ymm13
    2eb9:	c4 62 2d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm10,%ymm14
    2ec0:	c4 62 2d b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm10,%ymm15
    2ec7:	00 00 00 
    2eca:	c4 e2 2d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm10,%ymm1
    2ed1:	00 00 00 
    2ed4:	c4 62 2d b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm10,%ymm9
    2edb:	00 00 00 
    2ede:	c4 e2 2d b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm10,%ymm6
    2ee5:	01 00 00 
    2ee8:	c5 fc 11 64 24 a0    	vmovups %ymm4,-0x60(%rsp)
    2eee:	c5 fc 10 64 24 80    	vmovups -0x80(%rsp),%ymm4
    2ef4:	c4 e2 2d b8 a4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm10,%ymm4
    2efb:	01 00 00 
    2efe:	c5 fc 11 84 24 20 01 	vmovups %ymm0,0x120(%rsp)
    2f05:	00 00 
    2f07:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    2f0b:	c5 fc 28 d5          	vmovaps %ymm5,%ymm2
    2f0f:	c5 fc 11 64 24 80    	vmovups %ymm4,-0x80(%rsp)
    2f15:	c5 fc 10 a4 24 c0 00 	vmovups 0xc0(%rsp),%ymm4
    2f1c:	00 00 
    2f1e:	c4 e2 2d b8 a4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm10,%ymm4
    2f25:	01 00 00 
    2f28:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    2f2f:	00 00 
    2f31:	c5 fc 10 a4 24 a0 00 	vmovups 0xa0(%rsp),%ymm4
    2f38:	00 00 
    2f3a:	c4 e2 2d b8 a4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm10,%ymm4
    2f41:	01 00 00 
    2f44:	c5 fc 11 a4 24 a0 00 	vmovups %ymm4,0xa0(%rsp)
    2f4b:	00 00 
    2f4d:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    2f53:	c4 e2 2d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm10,%ymm4
    2f5a:	02 00 00 
    2f5d:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    2f63:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    2f6a:	00 00 
    2f6c:	c4 e2 2d b8 a4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm10,%ymm4
    2f73:	02 00 00 
    2f76:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    2f7d:	00 00 
    2f7f:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    2f85:	c4 e2 2d b8 a4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm10,%ymm4
    2f8c:	02 00 00 
    2f8f:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    2f95:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    2f9a:	c4 e2 2d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm10,%ymm4
    2fa1:	02 00 00 
    2fa4:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    2fa9:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    2faf:	c4 e2 2d b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm10,%ymm4
    2fb6:	02 00 00 
    2fb9:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    2fbf:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    2fc5:	c4 e2 2d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm10,%ymm4
    2fcc:	02 00 00 
    2fcf:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    2fd5:	c5 fc 10 64 24 c0    	vmovups -0x40(%rsp),%ymm4
    2fdb:	c4 e2 2d b8 a4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm10,%ymm4
    2fe2:	02 00 00 
    2fe5:	c5 fc 11 64 24 c0    	vmovups %ymm4,-0x40(%rsp)
    2feb:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    2ff1:	c4 e2 2d b8 a4 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm10,%ymm4
    2ff8:	02 00 00 
    2ffb:	c5 7c 28 d7          	vmovaps %ymm7,%ymm10
    2fff:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    3003:	c5 7c 28 c3          	vmovaps %ymm3,%ymm8
    3007:	c5 fc 11 64 24 a0    	vmovups %ymm4,-0x60(%rsp)
    300d:	c5 fc 10 64 24 80    	vmovups -0x80(%rsp),%ymm4
    3013:	4c 39 c6             	cmp    %r8,%rsi
    3016:	0f 8c f4 d4 ff ff    	jl     510 <_Z5benchv+0x3c0>
    301c:	e9 df d1 ff ff       	jmpq   200 <_Z5benchv+0xb0>
    3021:	0f 31                	rdtsc  
    3023:	48 c1 e2 20          	shl    $0x20,%rdx
    3027:	48 09 c2             	or     %rax,%rdx
    302a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3030 <_Z5benchv+0x2ee0>
    3030:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3035:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 303d <_Z5benchv+0x2eed>
    303c:	00 
    303d:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3045 <_Z5benchv+0x2ef5>
    3044:	00 
    3045:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 304c <_Z5benchv+0x2efc>
    304c:	01 c0                	add    %eax,%eax
    304e:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3054:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3058:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    305f:	00 00 
    3061:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    3065:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    3069:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    306d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3071:	48 81 c4 f8 01 00 00 	add    $0x1f8,%rsp
    3078:	c5 f8 77             	vzeroupper 
    307b:	c3                   	retq   
    307c:	90                   	nop
    307d:	90                   	nop
    307e:	90                   	nop
...
0000000000003080 <_Z6enablev>:
    ...
    3087:	b8 c8 00 00 00       	mov    $0xc8,%eax
    308c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    3091:	0f 45 c8             	cmovne %eax,%ecx
    3094:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 309a <_Z6enablev+0x1a>
    309a:	0f 9e c1             	setle  %cl
    309d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 30a4 <_Z6enablev+0x24>
...
00000000000030b0 <_Z9n_reg_maxv>:
    30b0:	b8 d7 02 00 00       	mov    $0x2d7,%eax
    30b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui25_uk27.cpp+0x9a>
  96:	01 00 00 00 

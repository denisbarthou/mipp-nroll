...
0000000000000750 <_Z6enablev>:
 ...
 757:	b8 40 00 00 00       	mov    $0x40,%eax
 75c:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 761:	0f 45 c8             	cmovne %eax,%ecx
 764:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 76a <_Z6enablev+0x1a>
 76a:	0f 9e c1             	setle  %cl
 76d:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # 774 <_Z6enablev+0x24>
...
0000000000000780 <_Z9n_reg_maxv>:
 780:	b8 62 00 00 00       	mov    $0x62,%eax
 785:	c3                   	retq   

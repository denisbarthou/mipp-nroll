...
0000000000000a10 <_Z6enablev>:
 ...
 a17:	b8 d0 00 00 00       	mov    $0xd0,%eax
 a1c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
 a21:	0f 45 c8             	cmovne %eax,%ecx
 a24:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a2a <_Z6enablev+0x1a>
 a2a:	0f 9e c1             	setle  %cl
 a2d:	83 3d 00 00 00 00 01 	cmpl   $0x1,0x0(%rip)        # a34 <_Z6enablev+0x24>
...
0000000000000a40 <_Z9n_reg_maxv>:
 a40:	b8 50 00 00 00       	mov    $0x50,%eax
 a45:	c3                   	retq   

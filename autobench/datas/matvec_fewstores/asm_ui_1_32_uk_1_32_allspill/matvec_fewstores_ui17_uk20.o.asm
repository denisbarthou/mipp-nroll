...
0000000000000160 <_Z5benchv>:
     ...
     19c:	0f 8e b8 12 00 00    	jle    145a <_Z5benchv+0x12fa>
     ...
     2a0:	0f 83 b4 11 00 00    	jae    145a <_Z5benchv+0x12fa>
    ...
    1368:	48 83 c6 14          	add    $0x14,%rsi
    136c:	49 0f af c2          	imul   %r10,%rax
    1370:	48 01 f8             	add    %rdi,%rax
    1373:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    137a:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1380:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1387:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    138e:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1395:	00 00 00 
    1398:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    139f:	00 00 00 
    13a2:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    13a9:	00 00 00 
    13ac:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    13b3:	01 00 00 
    13b6:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    13bd:	01 00 00 
    13c0:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    13c7:	01 00 00 
    13ca:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    13d1:	01 00 00 
    13d4:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    13db:	01 00 00 
    13de:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    13e5:	01 00 00 
    13e8:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    13ef:	02 00 00 
    13f2:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    13f8:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    13fe:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    1405:	00 00 00 
    1408:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    140e:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    1414:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm6
    141b:	01 00 00 
    141e:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    1424:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    142a:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    1431:	01 00 00 
    1434:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    1438:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    143c:	c5 7c 29 f4          	vmovaps %ymm14,%ymm4
    1440:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    1446:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    144c:	4c 39 c6             	cmp    %r8,%rsi
    144f:	0f 8c 2b ef ff ff    	jl     380 <_Z5benchv+0x220>
    1455:	e9 87 ed ff ff       	jmpq   1e1 <_Z5benchv+0x81>
    145a:	0f 31                	rdtsc  
    145c:	48 c1 e2 20          	shl    $0x20,%rdx
    1460:	48 09 c2             	or     %rax,%rdx
    1463:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1469 <_Z5benchv+0x1309>
    1469:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    146e:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1476 <_Z5benchv+0x1316>
    1475:	00 
    1476:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 147e <_Z5benchv+0x131e>
    147d:	00 
    147e:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1485 <_Z5benchv+0x1325>
    1485:	01 c0                	add    %eax,%eax
    1487:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    148d:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1491:	c5 fb 5c 44 24 18    	vsubsd 0x18(%rsp),%xmm0,%xmm0
    1497:	c4 41 08 57 f6       	vxorps %xmm14,%xmm14,%xmm14
    149c:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    14a0:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    14a4:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    14a8:	48 83 c4 58          	add    $0x58,%rsp
    14ac:	c5 f8 77             	vzeroupper 
    14af:	c3                   	retq   

00000000000014b0 <_Z6enablev>:
    14b0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 14b7 <_Z6enablev+0x7>
    14b7:	b8 88 00 00 00       	mov    $0x88,%eax
    14bc:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    14c1:	0f 45 c8             	cmovne %eax,%ecx
    14c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 14ca <_Z6enablev+0x1a>
    14ca:	0f 9e c1             	setle  %cl
    14cd:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # 14d4 <_Z6enablev+0x24>
...
00000000000014e0 <_Z9n_reg_maxv>:
    14e0:	b8 79 01 00 00       	mov    $0x179,%eax
    14e5:	c3                   	retq   

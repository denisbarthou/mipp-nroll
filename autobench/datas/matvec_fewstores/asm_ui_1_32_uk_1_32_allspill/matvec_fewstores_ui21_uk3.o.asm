...
0000000000000950 <_Z6enablev>:
 ...
 957:	b8 a8 00 00 00       	mov    $0xa8,%eax
 95c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
 961:	0f 45 c8             	cmovne %eax,%ecx
 964:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 96a <_Z6enablev+0x1a>
 96a:	0f 9e c1             	setle  %cl
 96d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 974 <_Z6enablev+0x24>
...
0000000000000980 <_Z9n_reg_maxv>:
 980:	b8 57 00 00 00       	mov    $0x57,%eax
 985:	c3                   	retq   

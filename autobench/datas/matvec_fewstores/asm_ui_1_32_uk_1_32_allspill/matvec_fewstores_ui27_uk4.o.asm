...
0000000000000e00 <_Z6enablev>:
 ...
 e07:	b8 d8 00 00 00       	mov    $0xd8,%eax
 e0c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
 e11:	0f 45 c8             	cmovne %eax,%ecx
 e14:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # e1a <_Z6enablev+0x1a>
 e1a:	0f 9e c1             	setle  %cl
 e1d:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # e24 <_Z6enablev+0x24>
...
0000000000000e30 <_Z9n_reg_maxv>:
 e30:	b8 8b 00 00 00       	mov    $0x8b,%eax
 e35:	c3                   	retq   

...
0000000000000ed0 <_Z6enablev>:
 ...
 ed7:	b8 90 00 00 00       	mov    $0x90,%eax
 edc:	b9 ee ff ff ff       	mov    $0xffffffee,%ecx
 ee1:	0f 45 c8             	cmovne %eax,%ecx
 ee4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # eea <_Z6enablev+0x1a>
 eea:	0f 9e c1             	setle  %cl
 eed:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # ef4 <_Z6enablev+0x24>
...
0000000000000f00 <_Z9n_reg_maxv>:
 f00:	b8 e3 00 00 00       	mov    $0xe3,%eax
 f05:	c3                   	retq   

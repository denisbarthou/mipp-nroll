...
00000000000018e0 <_Z6enablev>:
    ...
    18e7:	b8 d0 00 00 00       	mov    $0xd0,%eax
    18ec:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    18f1:	0f 45 c8             	cmovne %eax,%ecx
    18f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 18fa <_Z6enablev+0x1a>
    18fa:	0f 9e c1             	setle  %cl
    18fd:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 1904 <_Z6enablev+0x24>
...
0000000000001910 <_Z9n_reg_maxv>:
    1910:	b8 43 01 00 00       	mov    $0x143,%eax
    1915:	c3                   	retq   

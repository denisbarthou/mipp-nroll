...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e 47 1f 00 00    	jle    20ef <_Z5benchv+0x1f8f>
     ...
     36d:	0f 83 7c 1d 00 00    	jae    20ef <_Z5benchv+0x1f8f>
    ...
    1ecd:	48 83 c0 0f          	add    $0xf,%rax
    1ed1:	49 0f af f2          	imul   %r10,%rsi
    1ed5:	48 01 fe             	add    %rdi,%rsi
    1ed8:	c4 e2 1d b8 9c b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm12,%ymm3
    1edf:	00 00 00 
    1ee2:	c4 e2 1d b8 94 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm12,%ymm2
    1ee9:	00 00 00 
    1eec:	c4 e2 1d b8 ac b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm12,%ymm5
    1ef3:	00 00 00 
    1ef6:	c4 62 1d b8 94 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm12,%ymm10
    1efd:	00 00 00 
    1f00:	c4 62 1d b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm12,%ymm8
    1f07:	01 00 00 
    1f0a:	c4 e2 1d b8 b4 b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm12,%ymm6
    1f11:	01 00 00 
    1f14:	c4 e2 1d b8 a4 b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm12,%ymm4
    1f1b:	02 00 00 
    1f1e:	c4 62 1d b8 8c b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm12,%ymm9
    1f25:	02 00 00 
    1f28:	c4 62 1d b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm12,%ymm11
    1f2f:	02 00 00 
    1f32:	c4 e2 1d b8 84 b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm12,%ymm0
    1f39:	03 00 00 
    1f3c:	c4 62 1d b8 2c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm13
    1f42:	c4 62 1d b8 74 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm12,%ymm14
    1f49:	c4 62 1d b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm12,%ymm15
    1f50:	c4 e2 1d b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm12,%ymm1
    1f57:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    1f5d:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    1f63:	c4 e2 1d b8 bc b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm12,%ymm7
    1f6a:	01 00 00 
    1f6d:	c5 fc 11 9c 24 80 01 	vmovups %ymm3,0x180(%rsp)
    1f74:	00 00 
    1f76:	c5 fc 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm3
    1f7d:	00 00 
    1f7f:	c4 e2 1d b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm12,%ymm3
    1f86:	01 00 00 
    1f89:	c5 fc 11 84 24 a0 01 	vmovups %ymm0,0x1a0(%rsp)
    1f90:	00 00 
    1f92:	c5 7c 29 e8          	vmovaps %ymm13,%ymm0
    1f96:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    1f9c:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    1fa2:	c4 e2 1d b8 bc b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm12,%ymm7
    1fa9:	01 00 00 
    1fac:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    1fb3:	00 00 
    1fb5:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    1fbc:	00 00 
    1fbe:	c4 e2 1d b8 9c b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm12,%ymm3
    1fc5:	01 00 00 
    1fc8:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    1fce:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    1fd4:	c4 e2 1d b8 bc b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm12,%ymm7
    1fdb:	01 00 00 
    1fde:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    1fe5:	00 00 
    1fe7:	c5 fc 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm3
    1fee:	00 00 
    1ff0:	c4 e2 1d b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm12,%ymm3
    1ff7:	01 00 00 
    1ffa:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    2000:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    2006:	c5 fc 11 9c 24 c0 00 	vmovups %ymm3,0xc0(%rsp)
    200d:	00 00 
    200f:	c5 fc 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm3
    2016:	00 00 
    2018:	c4 e2 1d b8 9c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm12,%ymm3
    201f:	02 00 00 
    2022:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    2029:	00 00 
    202b:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    2031:	c4 e2 1d b8 9c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm12,%ymm3
    2038:	02 00 00 
    203b:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    2041:	c5 fc 10 5c 24 60    	vmovups 0x60(%rsp),%ymm3
    2047:	c4 e2 1d b8 9c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm12,%ymm3
    204e:	02 00 00 
    2051:	c5 fc 11 5c 24 60    	vmovups %ymm3,0x60(%rsp)
    2057:	c5 fc 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm3
    205e:	00 00 
    2060:	c4 e2 1d b8 9c b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm12,%ymm3
    2067:	02 00 00 
    206a:	c5 fc 11 9c 24 80 00 	vmovups %ymm3,0x80(%rsp)
    2071:	00 00 
    2073:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    2079:	c4 e2 1d b8 9c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm12,%ymm3
    2080:	02 00 00 
    2083:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    2089:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    208e:	c4 e2 1d b8 9c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm12,%ymm3
    2095:	03 00 00 
    2098:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    209d:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    20a3:	c4 e2 1d b8 9c b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm12,%ymm3
    20aa:	03 00 00 
    20ad:	c5 7c 28 e2          	vmovaps %ymm2,%ymm12
    20b1:	c5 fc 28 d4          	vmovaps %ymm4,%ymm2
    20b5:	c5 7c 29 cc          	vmovaps %ymm9,%ymm4
    20b9:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    20be:	c4 41 7c 28 da       	vmovaps %ymm10,%ymm11
    20c3:	c5 7c 28 d6          	vmovaps %ymm6,%ymm10
    20c7:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    20cd:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    20d3:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    20d7:	c5 7c 29 c5          	vmovaps %ymm8,%ymm5
    20db:	c5 7c 10 44 24 c0    	vmovups -0x40(%rsp),%ymm8
    20e1:	4c 39 c0             	cmp    %r8,%rax
    20e4:	0f 8c 66 e4 ff ff    	jl     550 <_Z5benchv+0x3f0>
    20ea:	e9 17 e1 ff ff       	jmpq   206 <_Z5benchv+0xa6>
    20ef:	0f 31                	rdtsc  
    20f1:	48 c1 e2 20          	shl    $0x20,%rdx
    20f5:	48 09 c2             	or     %rax,%rdx
    20f8:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 20fe <_Z5benchv+0x1f9e>
    20fe:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2103:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 210b <_Z5benchv+0x1fab>
    210a:	00 
    210b:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2113 <_Z5benchv+0x1fb3>
    2112:	00 
    2113:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 211a <_Z5benchv+0x1fba>
    211a:	01 c0                	add    %eax,%eax
    211c:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2122:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2126:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    212d:	00 00 
    212f:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    2134:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    2138:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    213c:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2140:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
    2147:	c5 f8 77             	vzeroupper 
    214a:	c3                   	retq   
    214b:	90                   	nop
    214c:	90                   	nop
    214d:	90                   	nop
...
0000000000002150 <_Z6enablev>:
    2150:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2157 <_Z6enablev+0x7>
    2157:	b8 d8 00 00 00       	mov    $0xd8,%eax
    215c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    2161:	0f 45 c8             	cmovne %eax,%ecx
    2164:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 216a <_Z6enablev+0x1a>
    216a:	0f 9e c1             	setle  %cl
    216d:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # 2174 <_Z6enablev+0x24>
    2174:	0f 9f c0             	setg   %al
    2177:	20 c8                	and    %cl,%al
    2179:	c3                   	retq   
    217a:	90                   	nop
    217b:	90                   	nop
    217c:	90                   	nop
...
0000000000002180 <_Z9n_reg_maxv>:
    2180:	b8 bf 01 00 00       	mov    $0x1bf,%eax
    2185:	c3                   	retq   

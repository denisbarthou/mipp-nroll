...
0000000000000dd0 <_Z6enablev>:
 ...
 dd7:	b8 30 00 00 00       	mov    $0x30,%eax
 ddc:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 de1:	0f 45 c8             	cmovne %eax,%ecx
 de4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # dea <_Z6enablev+0x1a>
 dea:	0f 9e c1             	setle  %cl
 ded:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # df4 <_Z6enablev+0x24>
...
0000000000000e00 <_Z9n_reg_maxv>:
 e00:	b8 92 00 00 00       	mov    $0x92,%eax
 e05:	c3                   	retq   

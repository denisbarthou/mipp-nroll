...
matvec_fewstores_ui23_uk13.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 40 15 00 00    	jle    16d8 <_Z5benchv+0x1588>
     ...
     30c:	0f 83 c6 13 00 00    	jae    16d8 <_Z5benchv+0x1588>
     ...
     633:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
     ...
     6d5:	02 00 00 
     6d8:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     ...
     755:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
     75b:	c4 e2 3d b8 b4 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm6
     762:	02 00 00 
     765:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
     ...
     795:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
     ...
     8b0:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     8b6:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
     8bd:	02 00 00 
     8c0:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     ...
     8f0:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
     ...
     98e:	02 00 00 
     991:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     ...
     a0b:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     a11:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
     a18:	02 00 00 
     a1b:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     ...
     ae9:	02 00 00 
     aec:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     ...
     b66:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     b6c:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
     b73:	02 00 00 
     b76:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     ...
     c44:	02 00 00 
     c47:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     ...
     cce:	02 00 00 
     cd1:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     ...
     d9f:	02 00 00 
     da2:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     ...
     e1c:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     e22:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
     e29:	02 00 00 
     e2c:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     ...
     e5c:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
     ...
     efa:	02 00 00 
     efd:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     ...
     f77:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     f7d:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
     f84:	02 00 00 
     f87:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    ...
    10d2:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    10d8:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
    10df:	02 00 00 
    10e2:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    ...
    1112:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    ...
    11b0:	02 00 00 
    11b3:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    ...
    122d:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    1233:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
    123a:	02 00 00 
    123d:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    ...
    126d:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    ...
    130b:	02 00 00 
    130e:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    ...
    13c8:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    ...
    1466:	02 00 00 
    1469:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    ...
    14e3:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    14e9:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
    14f0:	02 00 00 
    14f3:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    ...
    153e:	48 83 c0 0d          	add    $0xd,%rax
    1542:	49 0f af f2          	imul   %r10,%rsi
    1546:	48 01 fe             	add    %rdi,%rsi
    1549:	c4 e2 3d b8 8c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm8,%ymm1
    1550:	02 00 00 
    1553:	c4 62 3d b8 b4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm8,%ymm14
    155a:	00 00 00 
    155d:	c4 e2 3d b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm8,%ymm2
    1564:	00 00 00 
    1567:	c4 e2 3d b8 a4 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm8,%ymm4
    156e:	01 00 00 
    1571:	c4 62 3d b8 bc b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm8,%ymm15
    1578:	01 00 00 
    157b:	c4 e2 3d b8 b4 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm8,%ymm6
    1582:	01 00 00 
    1585:	c4 e2 3d b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm8,%ymm3
    158c:	01 00 00 
    158f:	c4 62 3d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm8,%ymm9
    1595:	c4 62 3d b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm8,%ymm10
    159c:	c4 62 3d b8 5c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm8,%ymm11
    15a3:	c4 62 3d b8 64 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm8,%ymm12
    15aa:	c4 e2 3d b8 bc b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm8,%ymm7
    15b1:	00 00 00 
    15b4:	c4 e2 3d b8 ac b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm8,%ymm5
    15bb:	01 00 00 
    15be:	c4 62 3d b8 ac b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm8,%ymm13
    15c5:	01 00 00 
    15c8:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    15ce:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    15d4:	c4 e2 3d b8 84 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm8,%ymm0
    15db:	00 00 00 
    15de:	c5 fc 11 8c 24 20 01 	vmovups %ymm1,0x120(%rsp)
    15e5:	00 00 
    15e7:	c5 7c 29 f1          	vmovaps %ymm14,%ymm1
    15eb:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    15f0:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    15f4:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    15fb:	00 00 
    15fd:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    1604:	00 00 
    1606:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    160c:	c5 fc 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm0
    1613:	00 00 
    1615:	c4 e2 3d b8 84 b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm8,%ymm0
    161c:	01 00 00 
    161f:	c5 fc 11 84 24 80 00 	vmovups %ymm0,0x80(%rsp)
    1626:	00 00 
    1628:	c5 fc 10 44 24 60    	vmovups 0x60(%rsp),%ymm0
    162e:	c4 e2 3d b8 84 b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm8,%ymm0
    1635:	01 00 00 
    1638:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    163e:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    1644:	c4 e2 3d b8 84 b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm8,%ymm0
    164b:	02 00 00 
    164e:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    1654:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    165a:	c4 e2 3d b8 84 b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm8,%ymm0
    1661:	02 00 00 
    1664:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    166a:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    1670:	c4 e2 3d b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm8,%ymm0
    1677:	02 00 00 
    167a:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    1680:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    1686:	c4 e2 3d b8 84 b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm8,%ymm0
    168d:	02 00 00 
    1690:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    1696:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    169b:	c4 e2 3d b8 84 b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm8,%ymm0
    16a2:	02 00 00 
    16a5:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    16aa:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    16b0:	c4 e2 3d b8 84 b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm8,%ymm0
    16b7:	02 00 00 
    16ba:	c5 7c 28 c4          	vmovaps %ymm4,%ymm8
    16be:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    16c4:	c5 fd 10 44 24 80    	vmovupd -0x80(%rsp),%ymm0
    16ca:	4c 39 c0             	cmp    %r8,%rax
    16cd:	0f 8c ad ed ff ff    	jl     480 <_Z5benchv+0x330>
    16d3:	e9 04 eb ff ff       	jmpq   1dc <_Z5benchv+0x8c>
    16d8:	0f 31                	rdtsc  
    16da:	48 c1 e2 20          	shl    $0x20,%rdx
    16de:	48 09 c2             	or     %rax,%rdx
    16e1:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 16e7 <_Z5benchv+0x1597>
    16e7:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    16ec:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 16f4 <_Z5benchv+0x15a4>
    16f3:	00 
    16f4:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 16fc <_Z5benchv+0x15ac>
    16fb:	00 
    16fc:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1703 <_Z5benchv+0x15b3>
    1703:	01 c0                	add    %eax,%eax
    1705:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    170b:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    170f:	c5 fb 5c 84 24 d8 00 	vsubsd 0xd8(%rsp),%xmm0,%xmm0
    1716:	00 00 
    1718:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    171c:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    1720:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1724:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1728:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
0000000000001740 <_Z6enablev>:
    ...
    1747:	b8 b8 00 00 00       	mov    $0xb8,%eax
    174c:	b9 e9 ff ff ff       	mov    $0xffffffe9,%ecx
    1751:	0f 45 c8             	cmovne %eax,%ecx
    1754:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 175a <_Z6enablev+0x1a>
    175a:	0f 9e c1             	setle  %cl
    175d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 1764 <_Z6enablev+0x24>
...
0000000000001770 <_Z9n_reg_maxv>:
    1770:	b8 4f 01 00 00       	mov    $0x14f,%eax
    1775:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui23_uk13.cpp+0x9a>
  96:	01 00 00 00 

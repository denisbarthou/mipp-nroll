...
matvec_fewstores_ui25_uk11.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 5b 15 00 00    	jle    16f3 <_Z5benchv+0x15a3>
     ...
     344:	0f 83 a9 13 00 00    	jae    16f3 <_Z5benchv+0x15a3>
    ...
    1524:	48 83 c0 0b          	add    $0xb,%rax
    1528:	49 0f af f2          	imul   %r10,%rsi
    152c:	48 01 fe             	add    %rdi,%rsi
    152f:	c4 e2 2d b8 84 b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm10,%ymm0
    1536:	03 00 00 
    1539:	c4 62 2d b8 bc b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm10,%ymm15
    1540:	00 00 00 
    1543:	c4 e2 2d b8 8c b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm10,%ymm1
    154a:	00 00 00 
    154d:	c4 62 2d b8 8c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm10,%ymm9
    1554:	00 00 00 
    1557:	c4 62 2d b8 84 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm10,%ymm8
    155e:	00 00 00 
    1561:	c4 e2 2d b8 ac b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm10,%ymm5
    1568:	01 00 00 
    156b:	c4 e2 2d b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm10,%ymm3
    1572:	01 00 00 
    1575:	c4 e2 2d b8 94 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm10,%ymm2
    157c:	01 00 00 
    157f:	c4 e2 2d b8 bc b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm10,%ymm7
    1586:	01 00 00 
    1589:	c4 62 2d b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm10,%ymm11
    158f:	c4 62 2d b8 64 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm10,%ymm12
    1596:	c4 62 2d b8 6c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm10,%ymm13
    159d:	c4 62 2d b8 74 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm10,%ymm14
    15a4:	c4 e2 2d b8 b4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm10,%ymm6
    15ab:	01 00 00 
    15ae:	c5 fc 11 64 24 a0    	vmovups %ymm4,-0x60(%rsp)
    15b4:	c5 fc 10 64 24 80    	vmovups -0x80(%rsp),%ymm4
    15ba:	c4 e2 2d b8 a4 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm10,%ymm4
    15c1:	01 00 00 
    15c4:	c5 fc 11 84 24 20 01 	vmovups %ymm0,0x120(%rsp)
    15cb:	00 00 
    15cd:	c5 fc 11 64 24 80    	vmovups %ymm4,-0x80(%rsp)
    15d3:	c5 fc 10 a4 24 c0 00 	vmovups 0xc0(%rsp),%ymm4
    15da:	00 00 
    15dc:	c4 e2 2d b8 a4 b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm10,%ymm4
    15e3:	01 00 00 
    15e6:	c5 fd 10 44 24 80    	vmovupd -0x80(%rsp),%ymm0
    15ec:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    15f3:	00 00 
    15f5:	c5 fc 10 a4 24 a0 00 	vmovups 0xa0(%rsp),%ymm4
    15fc:	00 00 
    15fe:	c4 e2 2d b8 a4 b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm10,%ymm4
    1605:	01 00 00 
    1608:	c5 fc 11 a4 24 a0 00 	vmovups %ymm4,0xa0(%rsp)
    160f:	00 00 
    1611:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    1617:	c4 e2 2d b8 a4 b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm10,%ymm4
    161e:	02 00 00 
    1621:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    1627:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    162e:	00 00 
    1630:	c4 e2 2d b8 a4 b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm10,%ymm4
    1637:	02 00 00 
    163a:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    1641:	00 00 
    1643:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    1649:	c4 e2 2d b8 a4 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm10,%ymm4
    1650:	02 00 00 
    1653:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    1659:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    165e:	c4 e2 2d b8 a4 b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm10,%ymm4
    1665:	02 00 00 
    1668:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    166d:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    1673:	c4 e2 2d b8 a4 b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm10,%ymm4
    167a:	02 00 00 
    167d:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    1683:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    1689:	c4 e2 2d b8 a4 b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm10,%ymm4
    1690:	02 00 00 
    1693:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    1699:	c5 fc 10 64 24 c0    	vmovups -0x40(%rsp),%ymm4
    169f:	c4 e2 2d b8 a4 b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm10,%ymm4
    16a6:	02 00 00 
    16a9:	c5 fc 11 64 24 c0    	vmovups %ymm4,-0x40(%rsp)
    16af:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    16b5:	c4 e2 2d b8 a4 b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm10,%ymm4
    16bc:	02 00 00 
    16bf:	c5 7c 28 d2          	vmovaps %ymm2,%ymm10
    16c3:	c5 fc 28 d5          	vmovaps %ymm5,%ymm2
    16c7:	c5 fc 11 64 24 a0    	vmovups %ymm4,-0x60(%rsp)
    16cd:	c5 7c 29 fc          	vmovaps %ymm15,%ymm4
    16d1:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    16d5:	c5 7c 29 c9          	vmovaps %ymm9,%ymm1
    16d9:	c5 7c 28 cf          	vmovaps %ymm7,%ymm9
    16dd:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    16e1:	c5 7c 28 c3          	vmovaps %ymm3,%ymm8
    16e5:	4c 39 c0             	cmp    %r8,%rax
    16e8:	0f 8c 22 ee ff ff    	jl     510 <_Z5benchv+0x3c0>
    16ee:	e9 0d eb ff ff       	jmpq   200 <_Z5benchv+0xb0>
    16f3:	0f 31                	rdtsc  
    16f5:	48 c1 e2 20          	shl    $0x20,%rdx
    16f9:	48 09 c2             	or     %rax,%rdx
    16fc:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1702 <_Z5benchv+0x15b2>
    1702:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1707:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 170f <_Z5benchv+0x15bf>
    170e:	00 
    170f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1717 <_Z5benchv+0x15c7>
    1716:	00 
    1717:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 171e <_Z5benchv+0x15ce>
    171e:	01 c0                	add    %eax,%eax
    1720:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1726:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    172a:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    1731:	00 00 
    1733:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    1737:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    173b:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    173f:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1743:	48 81 c4 f8 01 00 00 	add    $0x1f8,%rsp
    174a:	c5 f8 77             	vzeroupper 
    174d:	c3                   	retq   
    174e:	90                   	nop
    174f:	90                   	nop
...
0000000000001750 <_Z6enablev>:
    ...
    1757:	b8 c8 00 00 00       	mov    $0xc8,%eax
    175c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    1761:	0f 45 c8             	cmovne %eax,%ecx
    1764:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 176a <_Z6enablev+0x1a>
    176a:	0f 9e c1             	setle  %cl
    176d:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 1774 <_Z6enablev+0x24>
...
0000000000001780 <_Z9n_reg_maxv>:
    1780:	b8 37 01 00 00       	mov    $0x137,%eax
    1785:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui25_uk11.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000001bf0 <_Z6enablev>:
    ...
    1bf7:	b8 d8 00 00 00       	mov    $0xd8,%eax
    1bfc:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    1c01:	0f 45 c8             	cmovne %eax,%ecx
    1c04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1c0a <_Z6enablev+0x1a>
    1c0a:	0f 9e c1             	setle  %cl
    1c0d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # 1c14 <_Z6enablev+0x24>
...
0000000000001c20 <_Z9n_reg_maxv>:
    1c20:	b8 6b 01 00 00       	mov    $0x16b,%eax
    1c25:	c3                   	retq   

...
matvec_fewstores_ui13_uk23.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
 ...
 192:	0f 8e 69 0d 00 00    	jle    f01 <_Z5benchv+0xda1>
 ...
 23c:	0f 83 bf 0c 00 00    	jae    f01 <_Z5benchv+0xda1>
 ...
 2d3:	c4 62 7d 18 34 b2    	vbroadcastss (%rdx,%rsi,4),%ymm14
 2d9:	49 0f af c2          	imul   %r10,%rax
 2dd:	48 01 f8             	add    %rdi,%rax
 2e0:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
 2e6:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
 2ed:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
 2f4:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
 2fb:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
 302:	00 00 00 
 305:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
 30c:	00 00 00 
 30f:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
 316:	00 00 00 
 319:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
 320:	00 00 00 
 323:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
 32a:	01 00 00 
 32d:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
 334:	01 00 00 
 337:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
 33e:	01 00 00 
 341:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
 348:	01 00 00 
 34b:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
 352:	01 00 00 
 355:	48 8d 46 01          	lea    0x1(%rsi),%rax
 359:	c4 62 7d 18 74 b2 04 	vbroadcastss 0x4(%rdx,%rsi,4),%ymm14
 360:	49 0f af c2          	imul   %r10,%rax
 364:	48 01 f8             	add    %rdi,%rax
 ...
 e73:	48 83 c6 17          	add    $0x17,%rsi
 e77:	49 0f af c2          	imul   %r10,%rax
 e7b:	48 01 f8             	add    %rdi,%rax
 e7e:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
 e84:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
 e8b:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
 e92:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
 e99:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
 ea0:	00 00 00 
 ea3:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
 eaa:	00 00 00 
 ead:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
 eb4:	00 00 00 
 eb7:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
 ebe:	00 00 00 
 ec1:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
 ec8:	01 00 00 
 ecb:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
 ed2:	01 00 00 
 ed5:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
 edc:	01 00 00 
 edf:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
 ee6:	01 00 00 
 ee9:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
 ef0:	01 00 00 
 ef3:	4c 39 c6             	cmp    %r8,%rsi
 ef6:	0f 8c d4 f3 ff ff    	jl     2d0 <_Z5benchv+0x170>
 efc:	e9 bf f2 ff ff       	jmpq   1c0 <_Z5benchv+0x60>
 f01:	0f 31                	rdtsc  
 f03:	48 c1 e2 20          	shl    $0x20,%rdx
 f07:	48 09 c2             	or     %rax,%rdx
 f0a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # f10 <_Z5benchv+0xdb0>
 f10:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 f15:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # f1d <_Z5benchv+0xdbd>
 f1c:	00 
 f1d:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # f25 <_Z5benchv+0xdc5>
 f24:	00 
 f25:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # f2c <_Z5benchv+0xdcc>
 f2c:	01 c0                	add    %eax,%eax
 f2e:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 f34:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 f38:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 f3c:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 f40:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 f44:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 f48:	c5 f8 77             	vzeroupper 
 f4b:	c3                   	retq   
 f4c:	90                   	nop
 f4d:	90                   	nop
 f4e:	90                   	nop
...
0000000000000f50 <_Z6enablev>:
 ...
 f57:	b8 68 00 00 00       	mov    $0x68,%eax
 f5c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 f61:	0f 45 c8             	cmovne %eax,%ecx
 f64:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # f6a <_Z6enablev+0x1a>
 f6a:	0f 9e c1             	setle  %cl
 f6d:	83 3d 00 00 00 00 16 	cmpl   $0x16,0x0(%rip)        # f74 <_Z6enablev+0x24>
...
0000000000000f80 <_Z9n_reg_maxv>:
 f80:	b8 4f 01 00 00       	mov    $0x14f,%eax
 f85:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui13_uk23.cpp+0x9a>
  96:	01 00 00 00 

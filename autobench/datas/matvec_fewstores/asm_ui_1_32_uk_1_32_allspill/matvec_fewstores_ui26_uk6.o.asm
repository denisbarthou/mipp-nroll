...
0000000000001180 <_Z6enablev>:
    ...
    1187:	b8 d0 00 00 00       	mov    $0xd0,%eax
    118c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    1191:	0f 45 c8             	cmovne %eax,%ecx
    1194:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 119a <_Z6enablev+0x1a>
    119a:	0f 9e c1             	setle  %cl
    119d:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 11a4 <_Z6enablev+0x24>
...
00000000000011b0 <_Z9n_reg_maxv>:
    11b0:	b8 bc 00 00 00       	mov    $0xbc,%eax
    11b5:	c3                   	retq   

...
0000000000000160 <_Z5benchv>:
     ...
     192:	0f 8e 93 10 00 00    	jle    122b <_Z5benchv+0x10cb>
     ...
     23c:	0f 83 e9 0f 00 00    	jae    122b <_Z5benchv+0x10cb>
    ...
    119d:	48 83 c6 1d          	add    $0x1d,%rsi
    11a1:	49 0f af c3          	imul   %r11,%rax
    11a5:	48 01 f8             	add    %rdi,%rax
    11a8:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
    11ae:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
    11b5:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
    11bc:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
    11c3:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
    11ca:	00 00 00 
    11cd:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
    11d4:	00 00 00 
    11d7:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
    11de:	00 00 00 
    11e1:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
    11e8:	00 00 00 
    11eb:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
    11f2:	01 00 00 
    11f5:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
    11fc:	01 00 00 
    11ff:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
    1206:	01 00 00 
    1209:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
    1210:	01 00 00 
    1213:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
    121a:	01 00 00 
    121d:	4c 39 c6             	cmp    %r8,%rsi
    1220:	0f 8c aa f0 ff ff    	jl     2d0 <_Z5benchv+0x170>
    1226:	e9 95 ef ff ff       	jmpq   1c0 <_Z5benchv+0x60>
    122b:	0f 31                	rdtsc  
    122d:	48 c1 e2 20          	shl    $0x20,%rdx
    1231:	48 09 c2             	or     %rax,%rdx
    1234:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 123a <_Z5benchv+0x10da>
    123a:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    123f:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1247 <_Z5benchv+0x10e7>
    1246:	00 
    1247:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 124f <_Z5benchv+0x10ef>
    124e:	00 
    124f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1256 <_Z5benchv+0x10f6>
    ...
    1266:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    126a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    126e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000001280 <_Z6enablev>:
    ...
    1287:	b8 68 00 00 00       	mov    $0x68,%eax
    128c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
    1291:	0f 45 c8             	cmovne %eax,%ecx
    1294:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 129a <_Z6enablev+0x1a>
    129a:	0f 9e c1             	setle  %cl
    129d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 12a4 <_Z6enablev+0x24>

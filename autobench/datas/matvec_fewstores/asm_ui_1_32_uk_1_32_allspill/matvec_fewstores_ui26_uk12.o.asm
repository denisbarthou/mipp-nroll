...
0000000000001a90 <_Z6enablev>:
    ...
    1a97:	b8 d0 00 00 00       	mov    $0xd0,%eax
    1a9c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    1aa1:	0f 45 c8             	cmovne %eax,%ecx
    1aa4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1aaa <_Z6enablev+0x1a>
    1aaa:	0f 9e c1             	setle  %cl
    1aad:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # 1ab4 <_Z6enablev+0x24>
...
0000000000001ac0 <_Z9n_reg_maxv>:
    1ac0:	b8 5e 01 00 00       	mov    $0x15e,%eax
    1ac5:	c3                   	retq   

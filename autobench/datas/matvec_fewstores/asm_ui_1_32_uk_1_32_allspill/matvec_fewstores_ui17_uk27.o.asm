...
0000000000000160 <_Z5benchv>:
     ...
     19c:	0f 8e 21 18 00 00    	jle    19c3 <_Z5benchv+0x1863>
     ...
     290:	0f 83 2d 17 00 00    	jae    19c3 <_Z5benchv+0x1863>
    ...
    18dc:	48 83 c6 1b          	add    $0x1b,%rsi
    18e0:	49 0f af c2          	imul   %r10,%rax
    18e4:	48 01 f8             	add    %rdi,%rax
    18e7:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    18ed:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    18f4:	c4 e2 6d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm1
    18fb:	01 00 00 
    18fe:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    1905:	00 00 00 
    1908:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    190f:	00 00 00 
    1912:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1919:	00 00 00 
    191c:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    1923:	00 00 00 
    1926:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    192d:	01 00 00 
    1930:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1937:	01 00 00 
    193a:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    1941:	01 00 00 
    1944:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    194b:	01 00 00 
    194e:	c4 62 6d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm15
    1955:	01 00 00 
    1958:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    195f:	01 00 00 
    1962:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    1969:	02 00 00 
    196c:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    1972:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1978:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    197f:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    1984:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    198a:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1990:	c4 e2 6d b8 6c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm5
    1997:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    199d:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    19a3:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    19aa:	01 00 00 
    19ad:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    19b1:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    19b5:	4c 39 c6             	cmp    %r8,%rsi
    19b8:	0f 8c a2 e9 ff ff    	jl     360 <_Z5benchv+0x200>
    19be:	e9 15 e8 ff ff       	jmpq   1d8 <_Z5benchv+0x78>
    19c3:	0f 31                	rdtsc  
    19c5:	48 c1 e2 20          	shl    $0x20,%rdx
    19c9:	48 09 c2             	or     %rax,%rdx
    19cc:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 19d2 <_Z5benchv+0x1872>
    19d2:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    19d7:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 19df <_Z5benchv+0x187f>
    19de:	00 
    19df:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 19e7 <_Z5benchv+0x1887>
    19e6:	00 
    19e7:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 19ee <_Z5benchv+0x188e>
    19ee:	01 c0                	add    %eax,%eax
    19f0:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    19f6:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    19fa:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1a00:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
    1a04:	c5 ca 2a c8          	vcvtsi2ss %eax,%xmm6,%xmm1
    1a08:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1a0c:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1a10:	48 83 c4 38          	add    $0x38,%rsp
    1a14:	c5 f8 77             	vzeroupper 
    1a17:	c3                   	retq   
    1a18:	90                   	nop
    1a19:	90                   	nop
    1a1a:	90                   	nop
...
0000000000001a20 <_Z6enablev>:
    ...
    1a27:	b8 88 00 00 00       	mov    $0x88,%eax
    1a2c:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1a31:	0f 45 c8             	cmovne %eax,%ecx
    1a34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1a3a <_Z6enablev+0x1a>
    1a3a:	0f 9e c1             	setle  %cl
    1a3d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 1a44 <_Z6enablev+0x24>
...
0000000000001a50 <_Z9n_reg_maxv>:
    1a50:	b8 f7 01 00 00       	mov    $0x1f7,%eax
    1a55:	c3                   	retq   

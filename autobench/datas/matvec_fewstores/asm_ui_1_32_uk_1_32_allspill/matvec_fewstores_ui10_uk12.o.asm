...
0000000000000af0 <_Z6enablev>:
 ...
 af7:	b8 50 00 00 00       	mov    $0x50,%eax
 afc:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 b01:	0f 45 c8             	cmovne %eax,%ecx
 b04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b0a <_Z6enablev+0x1a>
 b0a:	0f 9e c1             	setle  %cl
 b0d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # b14 <_Z6enablev+0x24>
...
0000000000000b20 <_Z9n_reg_maxv>:
 b20:	b8 8e 00 00 00       	mov    $0x8e,%eax
 b25:	c3                   	retq   

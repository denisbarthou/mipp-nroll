...
matvec_fewstores_ui26_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e d5 31 00 00    	jle    336d <_Z5benchv+0x321d>
     ...
     356:	0f 83 11 30 00 00    	jae    336d <_Z5benchv+0x321d>
    ...
    316c:	48 83 c6 1b          	add    $0x1b,%rsi
    3170:	49 0f af c3          	imul   %r11,%rax
    3174:	48 01 f8             	add    %rdi,%rax
    3177:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm2
    317e:	00 00 00 
    3181:	c4 e2 25 b8 84 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm11,%ymm0
    3188:	03 00 00 
    318b:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
    3192:	c4 e2 25 b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm1
    3199:	00 00 00 
    319c:	c4 62 25 b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm9
    31a3:	00 00 00 
    31a6:	c4 e2 25 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm4
    31ad:	01 00 00 
    31b0:	c4 e2 25 b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm11,%ymm6
    31b7:	01 00 00 
    31ba:	c4 e2 25 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm11,%ymm3
    31c1:	01 00 00 
    31c4:	c4 62 25 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm11,%ymm10
    31cb:	01 00 00 
    31ce:	c4 62 25 b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm11,%ymm8
    31d5:	02 00 00 
    31d8:	c4 62 25 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm12
    31de:	c4 62 25 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm13
    31e5:	c4 62 25 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm14
    31ec:	c4 62 25 b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm15
    31f3:	00 00 00 
    31f6:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    31fb:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    3201:	c4 e2 25 b8 ac 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm5
    3208:	01 00 00 
    320b:	c5 fc 11 94 24 60 01 	vmovups %ymm2,0x160(%rsp)
    3212:	00 00 
    3214:	c5 fc 10 94 24 c0 00 	vmovups 0xc0(%rsp),%ymm2
    321b:	00 00 
    321d:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm11,%ymm2
    3224:	01 00 00 
    3227:	c5 fc 11 84 24 80 01 	vmovups %ymm0,0x180(%rsp)
    322e:	00 00 
    3230:	c5 fc 28 c1          	vmovaps %ymm1,%ymm0
    3234:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    3238:	c5 fc 28 de          	vmovaps %ymm6,%ymm3
    323c:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    3242:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    3248:	c4 e2 25 b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm11,%ymm5
    324f:	01 00 00 
    3252:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    3258:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    325f:	00 00 
    3261:	c5 fc 10 94 24 e0 00 	vmovups 0xe0(%rsp),%ymm2
    3268:	00 00 
    326a:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm11,%ymm2
    3271:	02 00 00 
    3274:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    327a:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    3280:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm11,%ymm5
    3287:	01 00 00 
    328a:	c5 fc 11 94 24 e0 00 	vmovups %ymm2,0xe0(%rsp)
    3291:	00 00 
    3293:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    3299:	c4 e2 25 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm11,%ymm2
    32a0:	02 00 00 
    32a3:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    32a9:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    32af:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    32b5:	c5 fc 10 94 24 a0 00 	vmovups 0xa0(%rsp),%ymm2
    32bc:	00 00 
    32be:	c4 e2 25 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm11,%ymm2
    32c5:	02 00 00 
    32c8:	c5 fc 11 94 24 a0 00 	vmovups %ymm2,0xa0(%rsp)
    32cf:	00 00 
    32d1:	c5 fc 10 94 24 80 00 	vmovups 0x80(%rsp),%ymm2
    32d8:	00 00 
    32da:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm11,%ymm2
    32e1:	02 00 00 
    32e4:	c5 fc 11 94 24 80 00 	vmovups %ymm2,0x80(%rsp)
    32eb:	00 00 
    32ed:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    32f3:	c4 e2 25 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm11,%ymm2
    32fa:	02 00 00 
    32fd:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    3303:	c5 fc 10 54 24 20    	vmovups 0x20(%rsp),%ymm2
    3309:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm11,%ymm2
    3310:	02 00 00 
    3313:	c5 fc 11 54 24 20    	vmovups %ymm2,0x20(%rsp)
    3319:	c5 fc 10 54 24 e0    	vmovups -0x20(%rsp),%ymm2
    331f:	c4 e2 25 b8 94 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm11,%ymm2
    3326:	02 00 00 
    3329:	c5 fc 11 54 24 e0    	vmovups %ymm2,-0x20(%rsp)
    332f:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    3334:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm11,%ymm2
    333b:	03 00 00 
    333e:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    3343:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    3347:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    334b:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    3350:	c4 41 7c 28 d0       	vmovaps %ymm8,%ymm10
    3355:	c5 7c 28 c4          	vmovaps %ymm4,%ymm8
    3359:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    335f:	4c 39 c6             	cmp    %r8,%rsi
    3362:	0f 8c d8 d1 ff ff    	jl     540 <_Z5benchv+0x3f0>
    3368:	e9 96 ce ff ff       	jmpq   203 <_Z5benchv+0xb3>
    336d:	0f 31                	rdtsc  
    336f:	48 c1 e2 20          	shl    $0x20,%rdx
    3373:	48 09 c2             	or     %rax,%rdx
    3376:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 337c <_Z5benchv+0x322c>
    337c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3381:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3389 <_Z5benchv+0x3239>
    3388:	00 
    3389:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3391 <_Z5benchv+0x3241>
    3390:	00 
    3391:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3398 <_Z5benchv+0x3248>
    3398:	01 c0                	add    %eax,%eax
    339a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    33a0:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    33a4:	c5 fb 5c 84 24 18 01 	vsubsd 0x118(%rsp),%xmm0,%xmm0
    33ab:	00 00 
    33ad:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    33b2:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    33b6:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    33ba:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    33be:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
    33c5:	c5 f8 77             	vzeroupper 
    33c8:	c3                   	retq   
    33c9:	90                   	nop
    33ca:	90                   	nop
    33cb:	90                   	nop
...
00000000000033d0 <_Z6enablev>:
    33d0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 33d7 <_Z6enablev+0x7>
    33d7:	b8 d0 00 00 00       	mov    $0xd0,%eax
    33dc:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    33e1:	0f 45 c8             	cmovne %eax,%ecx
    33e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 33ea <_Z6enablev+0x1a>
    33ea:	0f 9e c1             	setle  %cl
    33ed:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 33f4 <_Z6enablev+0x24>
    33f4:	0f 9f c0             	setg   %al
    33f7:	20 c8                	and    %cl,%al
    33f9:	c3                   	retq   
    33fa:	90                   	nop
    33fb:	90                   	nop
    33fc:	90                   	nop
...
0000000000003400 <_Z9n_reg_maxv>:
    3400:	b8 f3 02 00 00       	mov    $0x2f3,%eax
    3405:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui26_uk27.cpp+0x9a>
  96:	01 00 00 00 

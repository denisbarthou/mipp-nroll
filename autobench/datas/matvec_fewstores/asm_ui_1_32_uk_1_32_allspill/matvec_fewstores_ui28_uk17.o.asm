...
0000000000000160 <_Z5benchv>:
     ...
     1a3:	0f 8e 08 25 00 00    	jle    26b1 <_Z5benchv+0x2551>
     ...
     38f:	0f 83 1c 23 00 00    	jae    26b1 <_Z5benchv+0x2551>
    ...
    247c:	48 83 c6 11          	add    $0x11,%rsi
    2480:	48 0f af d8          	imul   %rax,%rbx
    2484:	48 01 fb             	add    %rdi,%rbx
    2487:	c4 e2 15 b8 8c 99 c0 	vfmadd231ps 0xc0(%rcx,%rbx,4),%ymm13,%ymm1
    248e:	00 00 00 
    2491:	c4 e2 15 b8 54 99 20 	vfmadd231ps 0x20(%rcx,%rbx,4),%ymm13,%ymm2
    2498:	c4 e2 15 b8 64 99 40 	vfmadd231ps 0x40(%rcx,%rbx,4),%ymm13,%ymm4
    249f:	c4 62 15 b8 4c 99 60 	vfmadd231ps 0x60(%rcx,%rbx,4),%ymm13,%ymm9
    24a6:	c4 e2 15 b8 9c 99 e0 	vfmadd231ps 0xe0(%rcx,%rbx,4),%ymm13,%ymm3
    24ad:	00 00 00 
    24b0:	c4 62 15 b8 84 99 00 	vfmadd231ps 0x100(%rcx,%rbx,4),%ymm13,%ymm8
    24b7:	01 00 00 
    24ba:	c4 62 15 b8 94 99 20 	vfmadd231ps 0x120(%rcx,%rbx,4),%ymm13,%ymm10
    24c1:	01 00 00 
    24c4:	c4 e2 15 b8 b4 99 40 	vfmadd231ps 0x140(%rcx,%rbx,4),%ymm13,%ymm6
    24cb:	01 00 00 
    24ce:	c4 62 15 b8 9c 99 00 	vfmadd231ps 0x200(%rcx,%rbx,4),%ymm13,%ymm11
    24d5:	02 00 00 
    24d8:	c4 e2 15 b8 ac 99 20 	vfmadd231ps 0x220(%rcx,%rbx,4),%ymm13,%ymm5
    24df:	02 00 00 
    24e2:	c4 62 15 b8 a4 99 60 	vfmadd231ps 0x360(%rcx,%rbx,4),%ymm13,%ymm12
    24e9:	03 00 00 
    24ec:	c4 e2 15 b8 04 99    	vfmadd231ps (%rcx,%rbx,4),%ymm13,%ymm0
    24f2:	c4 62 15 b8 b4 99 80 	vfmadd231ps 0x80(%rcx,%rbx,4),%ymm13,%ymm14
    24f9:	00 00 00 
    24fc:	c4 62 15 b8 bc 99 a0 	vfmadd231ps 0xa0(%rcx,%rbx,4),%ymm13,%ymm15
    2503:	00 00 00 
    2506:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    250c:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    2512:	c4 e2 15 b8 bc 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm13,%ymm7
    2519:	01 00 00 
    251c:	c5 fc 11 8c 24 80 01 	vmovups %ymm1,0x180(%rsp)
    2523:	00 00 
    2525:	c5 fc 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm1
    252c:	00 00 
    252e:	c4 e2 15 b8 8c 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm13,%ymm1
    2535:	01 00 00 
    2538:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    253e:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    2544:	c4 e2 15 b8 bc 99 c0 	vfmadd231ps 0x1c0(%rcx,%rbx,4),%ymm13,%ymm7
    254b:	01 00 00 
    254e:	c5 fc 11 8c 24 e0 00 	vmovups %ymm1,0xe0(%rsp)
    2555:	00 00 
    2557:	c5 fc 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm1
    255e:	00 00 
    2560:	c4 e2 15 b8 8c 99 a0 	vfmadd231ps 0x1a0(%rcx,%rbx,4),%ymm13,%ymm1
    2567:	01 00 00 
    256a:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    2570:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    2576:	c5 fc 11 8c 24 c0 00 	vmovups %ymm1,0xc0(%rsp)
    257d:	00 00 
    257f:	c5 fc 10 8c 24 00 01 	vmovups 0x100(%rsp),%ymm1
    2586:	00 00 
    2588:	c4 e2 15 b8 8c 99 e0 	vfmadd231ps 0x1e0(%rcx,%rbx,4),%ymm13,%ymm1
    258f:	01 00 00 
    2592:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    2599:	00 00 
    259b:	c5 fc 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm1
    25a2:	00 00 
    25a4:	c4 e2 15 b8 8c 99 40 	vfmadd231ps 0x240(%rcx,%rbx,4),%ymm13,%ymm1
    25ab:	02 00 00 
    25ae:	c5 fc 11 8c 24 20 01 	vmovups %ymm1,0x120(%rsp)
    25b5:	00 00 
    25b7:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    25bd:	c4 e2 15 b8 8c 99 60 	vfmadd231ps 0x260(%rcx,%rbx,4),%ymm13,%ymm1
    25c4:	02 00 00 
    25c7:	c5 fc 11 4c 24 60    	vmovups %ymm1,0x60(%rsp)
    25cd:	c5 fc 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm1
    25d4:	00 00 
    25d6:	c4 e2 15 b8 8c 99 80 	vfmadd231ps 0x280(%rcx,%rbx,4),%ymm13,%ymm1
    25dd:	02 00 00 
    25e0:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    25e7:	00 00 
    25e9:	c5 fc 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm1
    25f0:	00 00 
    25f2:	c4 e2 15 b8 8c 99 a0 	vfmadd231ps 0x2a0(%rcx,%rbx,4),%ymm13,%ymm1
    25f9:	02 00 00 
    25fc:	c5 fc 11 8c 24 a0 00 	vmovups %ymm1,0xa0(%rsp)
    2603:	00 00 
    2605:	c5 fc 10 0c 24       	vmovups (%rsp),%ymm1
    260a:	c4 e2 15 b8 8c 99 c0 	vfmadd231ps 0x2c0(%rcx,%rbx,4),%ymm13,%ymm1
    2611:	02 00 00 
    2614:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    2619:	c5 fc 10 4c 24 20    	vmovups 0x20(%rsp),%ymm1
    261f:	c4 e2 15 b8 8c 99 e0 	vfmadd231ps 0x2e0(%rcx,%rbx,4),%ymm13,%ymm1
    2626:	02 00 00 
    2629:	c5 fc 11 4c 24 20    	vmovups %ymm1,0x20(%rsp)
    262f:	c5 fc 10 4c 24 40    	vmovups 0x40(%rsp),%ymm1
    2635:	c4 e2 15 b8 8c 99 00 	vfmadd231ps 0x300(%rcx,%rbx,4),%ymm13,%ymm1
    263c:	03 00 00 
    263f:	c5 fc 11 4c 24 40    	vmovups %ymm1,0x40(%rsp)
    2645:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    264b:	c4 e2 15 b8 8c 99 20 	vfmadd231ps 0x320(%rcx,%rbx,4),%ymm13,%ymm1
    2652:	03 00 00 
    2655:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    265b:	c5 fc 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm1
    2661:	c4 e2 15 b8 8c 99 40 	vfmadd231ps 0x340(%rcx,%rbx,4),%ymm13,%ymm1
    2668:	03 00 00 
    266b:	c5 fc 11 4c 24 e0    	vmovups %ymm1,-0x20(%rsp)
    2671:	c5 fc 28 ca          	vmovaps %ymm2,%ymm1
    2675:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    2679:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    267d:	c5 7c 29 c4          	vmovaps %ymm8,%ymm4
    2681:	c4 41 7c 28 c3       	vmovaps %ymm11,%ymm8
    2686:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    268b:	c4 41 7c 28 e1       	vmovaps %ymm9,%ymm12
    2690:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    2695:	c5 7c 28 d5          	vmovaps %ymm5,%ymm10
    2699:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    269d:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    26a3:	4c 39 c6             	cmp    %r8,%rsi
    26a6:	0f 8c 14 df ff ff    	jl     5c0 <_Z5benchv+0x460>
    26ac:	e9 6a db ff ff       	jmpq   21b <_Z5benchv+0xbb>
    26b1:	0f 31                	rdtsc  
    26b3:	48 c1 e2 20          	shl    $0x20,%rdx
    26b7:	48 09 c2             	or     %rax,%rdx
    26ba:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 26c0 <_Z5benchv+0x2560>
    26c0:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    26c5:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 26cd <_Z5benchv+0x256d>
    26cc:	00 
    26cd:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 26d5 <_Z5benchv+0x2575>
    26d4:	00 
    26d5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 26dc <_Z5benchv+0x257c>
    26dc:	01 c0                	add    %eax,%eax
    26de:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    26e4:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    26e8:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    26ef:	00 00 
    26f1:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    26f6:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    26fa:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    26fe:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2702:	48 81 c4 68 02 00 00 	add    $0x268,%rsp
    2709:	5b                   	pop    %rbx
    270a:	41 5e                	pop    %r14
    270c:	c5 f8 77             	vzeroupper 
    270f:	c3                   	retq   

0000000000002710 <_Z6enablev>:
    2710:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2717 <_Z6enablev+0x7>
    2717:	b8 e0 00 00 00       	mov    $0xe0,%eax
    271c:	b9 e4 ff ff ff       	mov    $0xffffffe4,%ecx
    2721:	0f 45 c8             	cmovne %eax,%ecx
    2724:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 272a <_Z6enablev+0x1a>
    272a:	0f 9e c1             	setle  %cl
    272d:	83 3d 00 00 00 00 10 	cmpl   $0x10,0x0(%rip)        # 2734 <_Z6enablev+0x24>
    2734:	0f 9f c0             	setg   %al
    2737:	20 c8                	and    %cl,%al
    2739:	c3                   	retq   
    273a:	90                   	nop
    273b:	90                   	nop
    273c:	90                   	nop
...
0000000000002740 <_Z9n_reg_maxv>:
    2740:	b8 09 02 00 00       	mov    $0x209,%eax
    2745:	c3                   	retq   

...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e 45 31 00 00    	jle    32ed <_Z5benchv+0x318d>
     ...
     39c:	0f 83 4b 2f 00 00    	jae    32ed <_Z5benchv+0x318d>
    ...
    307e:	48 83 c6 15          	add    $0x15,%rsi
    3082:	49 0f af c3          	imul   %r11,%rax
    3086:	48 01 f8             	add    %rdi,%rax
    3089:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
    3090:	00 00 00 
    3093:	c4 e2 05 b8 84 81 a0 	vfmadd231ps 0x3a0(%rcx,%rax,4),%ymm15,%ymm0
    309a:	03 00 00 
    309d:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
    30a4:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
    30ab:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
    30b2:	01 00 00 
    30b5:	c4 62 05 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm14
    30bc:	01 00 00 
    30bf:	c4 62 05 b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm15,%ymm12
    30c6:	02 00 00 
    30c9:	c4 62 05 b8 94 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm15,%ymm10
    30d0:	02 00 00 
    30d3:	c4 62 05 b8 ac 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm15,%ymm13
    30da:	03 00 00 
    30dd:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
    30e3:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
    30ea:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
    30f1:	00 00 00 
    30f4:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
    30fb:	00 00 00 
    30fe:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
    3105:	00 00 00 
    3108:	c5 7c 11 1c 24       	vmovups %ymm11,(%rsp)
    310d:	c5 7c 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm11
    3113:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
    311a:	01 00 00 
    311d:	c5 7c 11 84 24 00 02 	vmovups %ymm8,0x200(%rsp)
    3124:	00 00 
    3126:	c5 7c 10 84 24 20 01 	vmovups 0x120(%rsp),%ymm8
    312d:	00 00 
    312f:	c4 62 05 b8 84 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm8
    3136:	01 00 00 
    3139:	c5 fc 11 84 24 20 02 	vmovups %ymm0,0x220(%rsp)
    3140:	00 00 
    3142:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    3146:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    314a:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    314e:	c5 7c 11 5c 24 c0    	vmovups %ymm11,-0x40(%rsp)
    3154:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    315a:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm11
    3161:	01 00 00 
    3164:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    316a:	c5 7c 11 84 24 20 01 	vmovups %ymm8,0x120(%rsp)
    3171:	00 00 
    3173:	c5 7c 10 84 24 e0 00 	vmovups 0xe0(%rsp),%ymm8
    317a:	00 00 
    317c:	c4 62 05 b8 84 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm8
    3183:	01 00 00 
    3186:	c5 7c 11 5c 24 80    	vmovups %ymm11,-0x80(%rsp)
    318c:	c5 7c 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm11
    3192:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm15,%ymm11
    3199:	02 00 00 
    319c:	c5 7c 11 84 24 e0 00 	vmovups %ymm8,0xe0(%rsp)
    31a3:	00 00 
    31a5:	c5 7c 10 84 24 a0 00 	vmovups 0xa0(%rsp),%ymm8
    31ac:	00 00 
    31ae:	c4 62 05 b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm15,%ymm8
    31b5:	01 00 00 
    31b8:	c5 7c 11 5c 24 a0    	vmovups %ymm11,-0x60(%rsp)
    31be:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    31c4:	c5 7c 11 84 24 a0 00 	vmovups %ymm8,0xa0(%rsp)
    31cb:	00 00 
    31cd:	c5 7c 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm8
    31d4:	00 00 
    31d6:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm15,%ymm8
    31dd:	01 00 00 
    31e0:	c5 7c 11 84 24 80 00 	vmovups %ymm8,0x80(%rsp)
    31e7:	00 00 
    31e9:	c5 7c 10 84 24 00 01 	vmovups 0x100(%rsp),%ymm8
    31f0:	00 00 
    31f2:	c4 62 05 b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm15,%ymm8
    31f9:	02 00 00 
    31fc:	c5 7c 11 84 24 00 01 	vmovups %ymm8,0x100(%rsp)
    3203:	00 00 
    3205:	c5 7c 10 84 24 c0 00 	vmovups 0xc0(%rsp),%ymm8
    320c:	00 00 
    320e:	c4 62 05 b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm15,%ymm8
    3215:	02 00 00 
    3218:	c5 7c 11 84 24 c0 00 	vmovups %ymm8,0xc0(%rsp)
    321f:	00 00 
    3221:	c5 7c 10 84 24 40 01 	vmovups 0x140(%rsp),%ymm8
    3228:	00 00 
    322a:	c4 62 05 b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm15,%ymm8
    3231:	02 00 00 
    3234:	c5 7c 11 84 24 40 01 	vmovups %ymm8,0x140(%rsp)
    323b:	00 00 
    323d:	c5 7c 10 84 24 60 01 	vmovups 0x160(%rsp),%ymm8
    3244:	00 00 
    3246:	c4 62 05 b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm15,%ymm8
    324d:	02 00 00 
    3250:	c5 7c 11 84 24 60 01 	vmovups %ymm8,0x160(%rsp)
    3257:	00 00 
    3259:	c5 7c 10 44 24 20    	vmovups 0x20(%rsp),%ymm8
    325f:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm15,%ymm8
    3266:	02 00 00 
    3269:	c5 7c 11 44 24 20    	vmovups %ymm8,0x20(%rsp)
    326f:	c5 7c 10 44 24 60    	vmovups 0x60(%rsp),%ymm8
    3275:	c4 62 05 b8 84 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm15,%ymm8
    327c:	03 00 00 
    327f:	c5 7c 11 44 24 60    	vmovups %ymm8,0x60(%rsp)
    3285:	c5 7c 10 44 24 40    	vmovups 0x40(%rsp),%ymm8
    328b:	c4 62 05 b8 84 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm15,%ymm8
    3292:	03 00 00 
    3295:	c5 7c 11 44 24 40    	vmovups %ymm8,0x40(%rsp)
    329b:	c5 7c 10 44 24 e0    	vmovups -0x20(%rsp),%ymm8
    32a1:	c4 62 05 b8 84 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm15,%ymm8
    32a8:	03 00 00 
    32ab:	c5 7c 11 44 24 e0    	vmovups %ymm8,-0x20(%rsp)
    32b1:	c5 7c 10 04 24       	vmovups (%rsp),%ymm8
    32b6:	c4 62 05 b8 84 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm15,%ymm8
    32bd:	03 00 00 
    32c0:	c5 7c 11 04 24       	vmovups %ymm8,(%rsp)
    32c5:	c4 41 7c 28 c4       	vmovaps %ymm12,%ymm8
    32ca:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    32cf:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    32d4:	c4 41 7c 28 f2       	vmovaps %ymm10,%ymm14
    32d9:	c5 7c 10 54 24 a0    	vmovups -0x60(%rsp),%ymm10
    32df:	4c 39 c6             	cmp    %r8,%rsi
    32e2:	0f 8c c8 d2 ff ff    	jl     5b0 <_Z5benchv+0x450>
    32e8:	e9 10 cf ff ff       	jmpq   1fd <_Z5benchv+0x9d>
    32ed:	0f 31                	rdtsc  
    32ef:	48 c1 e2 20          	shl    $0x20,%rdx
    32f3:	48 09 c2             	or     %rax,%rdx
    32f6:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 32fc <_Z5benchv+0x319c>
    32fc:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3301:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3309 <_Z5benchv+0x31a9>
    3308:	00 
    3309:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3311 <_Z5benchv+0x31b1>
    3310:	00 
    3311:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3318 <_Z5benchv+0x31b8>
    3318:	01 c0                	add    %eax,%eax
    331a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3320:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3324:	c5 fb 5c 84 24 98 01 	vsubsd 0x198(%rsp),%xmm0,%xmm0
    332b:	00 00 
    332d:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    3332:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    3336:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    333a:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    333e:	48 81 c4 58 02 00 00 	add    $0x258,%rsp
...
0000000000003350 <_Z6enablev>:
    3350:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3357 <_Z6enablev+0x7>
    3357:	b8 f0 00 00 00       	mov    $0xf0,%eax
    335c:	b9 e2 ff ff ff       	mov    $0xffffffe2,%ecx
    3361:	0f 45 c8             	cmovne %eax,%ecx
    3364:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 336a <_Z6enablev+0x1a>
    336a:	0f 9e c1             	setle  %cl
    336d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 3374 <_Z6enablev+0x24>
    3374:	0f 9f c0             	setg   %al
    3377:	20 c8                	and    %cl,%al
    3379:	c3                   	retq   
    337a:	90                   	nop
    337b:	90                   	nop
    337c:	90                   	nop
...
0000000000003380 <_Z9n_reg_maxv>:
    3380:	b8 a9 02 00 00       	mov    $0x2a9,%eax
    3385:	c3                   	retq   

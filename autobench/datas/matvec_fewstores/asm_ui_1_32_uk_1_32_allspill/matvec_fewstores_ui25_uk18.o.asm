...
matvec_fewstores_ui25_uk18.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     344:	0f 83 d0 1e 00 00    	jae    221a <_Z5benchv+0x20ca>
    ...
    2044:	48 83 c6 12          	add    $0x12,%rsi
    2048:	49 0f af c2          	imul   %r10,%rax
    204c:	48 01 f8             	add    %rdi,%rax
    204f:	c4 e2 2d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm10,%ymm0
    2056:	00 00 00 
    2059:	c4 e2 2d b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm10,%ymm6
    2060:	00 00 00 
    2063:	c4 e2 2d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm10,%ymm7
    206a:	00 00 00 
    206d:	c4 e2 2d b8 ac 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm10,%ymm5
    2074:	01 00 00 
    2077:	c4 e2 2d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm10,%ymm2
    207e:	01 00 00 
    2081:	c4 e2 2d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm10,%ymm3
    2088:	01 00 00 
    208b:	c4 e2 2d b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm10,%ymm1
    2092:	01 00 00 
    2095:	c4 62 2d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm10,%ymm8
    209c:	01 00 00 
    209f:	c4 62 2d b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm10,%ymm9
    20a6:	02 00 00 
    20a9:	c4 62 2d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm10,%ymm11
    20af:	c4 62 2d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm10,%ymm12
    20b6:	c4 62 2d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm10,%ymm13
    20bd:	c4 62 2d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm10,%ymm14
    20c4:	c4 62 2d b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm10,%ymm15
    20cb:	00 00 00 
    20ce:	c5 fc 11 64 24 c0    	vmovups %ymm4,-0x40(%rsp)
    20d4:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    20da:	c4 e2 2d b8 a4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm10,%ymm4
    20e1:	01 00 00 
    20e4:	c5 fc 11 84 24 20 01 	vmovups %ymm0,0x120(%rsp)
    20eb:	00 00 
    20ed:	c5 fc 10 84 24 c0 00 	vmovups 0xc0(%rsp),%ymm0
    20f4:	00 00 
    20f6:	c4 e2 2d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm10,%ymm0
    20fd:	01 00 00 
    2100:	c5 fc 11 64 24 a0    	vmovups %ymm4,-0x60(%rsp)
    2106:	c5 fc 10 64 24 80    	vmovups -0x80(%rsp),%ymm4
    210c:	c4 e2 2d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm10,%ymm4
    2113:	01 00 00 
    2116:	c5 fc 11 84 24 c0 00 	vmovups %ymm0,0xc0(%rsp)
    211d:	00 00 
    211f:	c5 fc 10 44 24 60    	vmovups 0x60(%rsp),%ymm0
    2125:	c4 e2 2d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm10,%ymm0
    212c:	02 00 00 
    212f:	c5 fc 11 64 24 80    	vmovups %ymm4,-0x80(%rsp)
    2135:	c5 fc 10 64 24 80    	vmovups -0x80(%rsp),%ymm4
    213b:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    2141:	c5 fc 10 84 24 a0 00 	vmovups 0xa0(%rsp),%ymm0
    2148:	00 00 
    214a:	c4 e2 2d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm10,%ymm0
    2151:	02 00 00 
    2154:	c5 fc 11 84 24 a0 00 	vmovups %ymm0,0xa0(%rsp)
    215b:	00 00 
    215d:	c5 fc 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm0
    2164:	00 00 
    2166:	c4 e2 2d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm10,%ymm0
    216d:	02 00 00 
    2170:	c5 fc 11 84 24 80 00 	vmovups %ymm0,0x80(%rsp)
    2177:	00 00 
    2179:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    217f:	c4 e2 2d b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm10,%ymm0
    2186:	02 00 00 
    2189:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    218f:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    2195:	c4 e2 2d b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm10,%ymm0
    219c:	02 00 00 
    219f:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    21a5:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    21ab:	c4 e2 2d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm10,%ymm0
    21b2:	02 00 00 
    21b5:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    21bb:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    21c0:	c4 e2 2d b8 84 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm10,%ymm0
    21c7:	02 00 00 
    21ca:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    21cf:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    21d5:	c4 e2 2d b8 84 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm10,%ymm0
    21dc:	03 00 00 
    21df:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    21e5:	c5 fc 28 c1          	vmovaps %ymm1,%ymm0
    21e9:	c5 fc 28 ce          	vmovaps %ymm6,%ymm1
    21ed:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    21f1:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    21f6:	c5 7c 28 cf          	vmovaps %ymm7,%ymm9
    21fa:	c5 fc 28 fa          	vmovaps %ymm2,%ymm7
    21fe:	c5 fc 28 d5          	vmovaps %ymm5,%ymm2
    2202:	c5 fc 28 eb          	vmovaps %ymm3,%ymm5
    2206:	c5 fc 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm3
    220c:	4c 39 c6             	cmp    %r8,%rsi
    220f:	0f 8c 0b e3 ff ff    	jl     520 <_Z5benchv+0x3d0>
    2215:	e9 ec df ff ff       	jmpq   206 <_Z5benchv+0xb6>
    221a:	0f 31                	rdtsc  
    ...
    2251:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    2258:	00 00 
    225a:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
    225f:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
    2263:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2267:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    226b:	48 81 c4 f8 01 00 00 	add    $0x1f8,%rsp
...
0000000000002280 <_Z6enablev>:
    2280:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2287 <_Z6enablev+0x7>
    2287:	b8 c8 00 00 00       	mov    $0xc8,%eax
    228c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    2291:	0f 45 c8             	cmovne %eax,%ecx
    2294:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 229a <_Z6enablev+0x1a>
    229a:	0f 9e c1             	setle  %cl
    229d:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # 22a4 <_Z6enablev+0x24>
    22a4:	0f 9f c0             	setg   %al
    22a7:	20 c8                	and    %cl,%al
    22a9:	c3                   	retq   
    22aa:	90                   	nop
    22ab:	90                   	nop
    22ac:	90                   	nop
...
00000000000022b0 <_Z9n_reg_maxv>:
    22b0:	b8 ed 01 00 00       	mov    $0x1ed,%eax
    22b5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui25_uk18.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000eb0 <_Z6enablev>:
 ...
 eb7:	b8 d0 00 00 00       	mov    $0xd0,%eax
 ebc:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
 ec1:	0f 45 c8             	cmovne %eax,%ecx
 ec4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # eca <_Z6enablev+0x1a>
 eca:	0f 9e c1             	setle  %cl
 ecd:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # ed4 <_Z6enablev+0x24>
...
0000000000000ee0 <_Z9n_reg_maxv>:
 ee0:	b8 a1 00 00 00       	mov    $0xa1,%eax
 ee5:	c3                   	retq   

...
matvec_fewstores_ui15_uk22.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     188:	0f 8e c6 0e 00 00    	jle    1054 <_Z5benchv+0xf04>
     ...
     250:	0f 83 fe 0d 00 00    	jae    1054 <_Z5benchv+0xf04>
     ...
     fb2:	48 83 c6 16          	add    $0x16,%rsi
     fb6:	49 0f af c2          	imul   %r10,%rax
     fba:	48 01 f8             	add    %rdi,%rax
     fbd:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
     fc3:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
     fca:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
     fd1:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
     fd8:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
     fdf:	00 00 00 
     fe2:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
     fe9:	00 00 00 
     fec:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
     ff3:	00 00 00 
     ff6:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
     ffd:	00 00 00 
    1000:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
    1007:	01 00 00 
    100a:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
    1011:	01 00 00 
    1014:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
    101b:	01 00 00 
    101e:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
    1025:	01 00 00 
    1028:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
    102f:	01 00 00 
    1032:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
    1039:	01 00 00 
    103c:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
    1043:	01 00 00 
    1046:	4c 39 c6             	cmp    %r8,%rsi
    1049:	0f 8c a1 f2 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
    104f:	e9 6c f1 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    1054:	0f 31                	rdtsc  
    1056:	48 c1 e2 20          	shl    $0x20,%rdx
    105a:	48 09 c2             	or     %rax,%rdx
    105d:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1063 <_Z5benchv+0xf13>
    1063:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1068:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1070 <_Z5benchv+0xf20>
    106f:	00 
    1070:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1078 <_Z5benchv+0xf28>
    1077:	00 
    1078:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 107f <_Z5benchv+0xf2f>
    107f:	01 c0                	add    %eax,%eax
    1081:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1087:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    108b:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1091:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
    1095:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
    1099:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    109d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    10a1:	c5 f8 77             	vzeroupper 
    10a4:	c3                   	retq   
    10a5:	90                   	nop
    10a6:	90                   	nop
    10a7:	90                   	nop
...
00000000000010b0 <_Z6enablev>:
    ...
    10b7:	b8 78 00 00 00       	mov    $0x78,%eax
    10bc:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
    10c1:	0f 45 c8             	cmovne %eax,%ecx
    10c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 10ca <_Z6enablev+0x1a>
    10ca:	0f 9e c1             	setle  %cl
    10cd:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 10d4 <_Z6enablev+0x24>
...
00000000000010e0 <_Z9n_reg_maxv>:
    10e0:	b8 6f 01 00 00       	mov    $0x16f,%eax
    10e5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui15_uk22.cpp+0x9a>
  96:	01 00 00 00 

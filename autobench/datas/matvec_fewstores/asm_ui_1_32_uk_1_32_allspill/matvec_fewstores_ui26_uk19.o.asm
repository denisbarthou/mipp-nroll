...
matvec_fewstores_ui26_uk19.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 5d 24 00 00    	jle    25f5 <_Z5benchv+0x24a5>
     ...
     356:	0f 83 99 22 00 00    	jae    25f5 <_Z5benchv+0x24a5>
    ...
    23f4:	48 83 c6 13          	add    $0x13,%rsi
    23f8:	49 0f af c3          	imul   %r11,%rax
    23fc:	48 01 f8             	add    %rdi,%rax
    23ff:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm2
    2406:	00 00 00 
    2409:	c4 e2 25 b8 84 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm11,%ymm0
    2410:	03 00 00 
    2413:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
    241a:	c4 e2 25 b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm1
    2421:	00 00 00 
    2424:	c4 62 25 b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm9
    242b:	00 00 00 
    242e:	c4 e2 25 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm4
    2435:	01 00 00 
    2438:	c4 e2 25 b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm11,%ymm6
    243f:	01 00 00 
    2442:	c4 e2 25 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm11,%ymm3
    2449:	01 00 00 
    244c:	c4 62 25 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm11,%ymm10
    2453:	01 00 00 
    2456:	c4 62 25 b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm11,%ymm8
    245d:	02 00 00 
    2460:	c4 62 25 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm12
    2466:	c4 62 25 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm13
    246d:	c4 62 25 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm14
    2474:	c4 62 25 b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm15
    247b:	00 00 00 
    247e:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    2483:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    2489:	c4 e2 25 b8 ac 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm5
    2490:	01 00 00 
    2493:	c5 fc 11 94 24 60 01 	vmovups %ymm2,0x160(%rsp)
    249a:	00 00 
    249c:	c5 fc 10 94 24 c0 00 	vmovups 0xc0(%rsp),%ymm2
    24a3:	00 00 
    24a5:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm11,%ymm2
    24ac:	01 00 00 
    24af:	c5 fc 11 84 24 80 01 	vmovups %ymm0,0x180(%rsp)
    24b6:	00 00 
    24b8:	c5 fc 28 c1          	vmovaps %ymm1,%ymm0
    24bc:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    24c0:	c5 fc 28 de          	vmovaps %ymm6,%ymm3
    24c4:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    24ca:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    24d0:	c4 e2 25 b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm11,%ymm5
    24d7:	01 00 00 
    24da:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    24e0:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    24e7:	00 00 
    24e9:	c5 fc 10 94 24 e0 00 	vmovups 0xe0(%rsp),%ymm2
    24f0:	00 00 
    24f2:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm11,%ymm2
    24f9:	02 00 00 
    24fc:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    2502:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    2508:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm11,%ymm5
    250f:	01 00 00 
    2512:	c5 fc 11 94 24 e0 00 	vmovups %ymm2,0xe0(%rsp)
    2519:	00 00 
    251b:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    2521:	c4 e2 25 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm11,%ymm2
    2528:	02 00 00 
    252b:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    2531:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    2537:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    253d:	c5 fc 10 94 24 a0 00 	vmovups 0xa0(%rsp),%ymm2
    2544:	00 00 
    2546:	c4 e2 25 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm11,%ymm2
    254d:	02 00 00 
    2550:	c5 fc 11 94 24 a0 00 	vmovups %ymm2,0xa0(%rsp)
    2557:	00 00 
    2559:	c5 fc 10 94 24 80 00 	vmovups 0x80(%rsp),%ymm2
    2560:	00 00 
    2562:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm11,%ymm2
    2569:	02 00 00 
    256c:	c5 fc 11 94 24 80 00 	vmovups %ymm2,0x80(%rsp)
    2573:	00 00 
    2575:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    257b:	c4 e2 25 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm11,%ymm2
    2582:	02 00 00 
    2585:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    258b:	c5 fc 10 54 24 20    	vmovups 0x20(%rsp),%ymm2
    2591:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm11,%ymm2
    2598:	02 00 00 
    259b:	c5 fc 11 54 24 20    	vmovups %ymm2,0x20(%rsp)
    25a1:	c5 fc 10 54 24 e0    	vmovups -0x20(%rsp),%ymm2
    25a7:	c4 e2 25 b8 94 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm11,%ymm2
    25ae:	02 00 00 
    25b1:	c5 fc 11 54 24 e0    	vmovups %ymm2,-0x20(%rsp)
    25b7:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    25bc:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm11,%ymm2
    25c3:	03 00 00 
    25c6:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    25cb:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    25cf:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    25d3:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    25d8:	c4 41 7c 28 d0       	vmovaps %ymm8,%ymm10
    25dd:	c5 7c 28 c4          	vmovaps %ymm4,%ymm8
    25e1:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    25e7:	4c 39 c6             	cmp    %r8,%rsi
    25ea:	0f 8c 50 df ff ff    	jl     540 <_Z5benchv+0x3f0>
    25f0:	e9 0e dc ff ff       	jmpq   203 <_Z5benchv+0xb3>
    25f5:	0f 31                	rdtsc  
    25f7:	48 c1 e2 20          	shl    $0x20,%rdx
    25fb:	48 09 c2             	or     %rax,%rdx
    25fe:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2604 <_Z5benchv+0x24b4>
    2604:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2609:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2611 <_Z5benchv+0x24c1>
    2610:	00 
    2611:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2619 <_Z5benchv+0x24c9>
    2618:	00 
    2619:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2620 <_Z5benchv+0x24d0>
    2620:	01 c0                	add    %eax,%eax
    2622:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2628:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    262c:	c5 fb 5c 84 24 18 01 	vsubsd 0x118(%rsp),%xmm0,%xmm0
    2633:	00 00 
    2635:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    263a:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    263e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2642:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2646:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
    264d:	c5 f8 77             	vzeroupper 
    2650:	c3                   	retq   
    2651:	90                   	nop
    2652:	90                   	nop
    2653:	90                   	nop
...
0000000000002660 <_Z6enablev>:
    ...
    2667:	b8 d0 00 00 00       	mov    $0xd0,%eax
    266c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    2671:	0f 45 c8             	cmovne %eax,%ecx
    2674:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 267a <_Z6enablev+0x1a>
    267a:	0f 9e c1             	setle  %cl
    267d:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # 2684 <_Z6enablev+0x24>
...
0000000000002690 <_Z9n_reg_maxv>:
    2690:	b8 1b 02 00 00       	mov    $0x21b,%eax
    2695:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui26_uk19.cpp+0x9a>
  96:	01 00 00 00 

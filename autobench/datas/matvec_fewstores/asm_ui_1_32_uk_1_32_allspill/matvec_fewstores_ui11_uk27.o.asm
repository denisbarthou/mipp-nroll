...
matvec_fewstores_ui11_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 39 0d 00 00    	jle    ec1 <_Z5benchv+0xd71>
 ...
 218:	0f 83 a3 0c 00 00    	jae    ec1 <_Z5benchv+0xd71>
 ...
 e47:	48 83 c6 1b          	add    $0x1b,%rsi
 e4b:	49 0f af c3          	imul   %r11,%rax
 e4f:	48 01 f8             	add    %rdi,%rax
 e52:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
 e58:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
 e5f:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
 e66:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
 e6d:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
 e74:	00 00 00 
 e77:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
 e7e:	00 00 00 
 e81:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
 e88:	00 00 00 
 e8b:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
 e92:	00 00 00 
 e95:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
 e9c:	01 00 00 
 e9f:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
 ea6:	01 00 00 
 ea9:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
 eb0:	01 00 00 
 eb3:	4c 39 c6             	cmp    %r8,%rsi
 eb6:	0f 8c d4 f3 ff ff    	jl     290 <_Z5benchv+0x140>
 ebc:	e9 ef f2 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 ec1:	0f 31                	rdtsc  
 ec3:	48 c1 e2 20          	shl    $0x20,%rdx
 ec7:	48 09 c2             	or     %rax,%rdx
 eca:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # ed0 <_Z5benchv+0xd80>
 ed0:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 ed5:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # edd <_Z5benchv+0xd8d>
 edc:	00 
 edd:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # ee5 <_Z5benchv+0xd95>
 ee4:	00 
 ee5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # eec <_Z5benchv+0xd9c>
 eec:	01 c0                	add    %eax,%eax
 eee:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 ef4:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 ef8:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 efc:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
 f00:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 f04:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 f08:	c5 f8 77             	vzeroupper 
 f0b:	c3                   	retq   
 f0c:	90                   	nop
 f0d:	90                   	nop
 f0e:	90                   	nop
...
0000000000000f10 <_Z6enablev>:
 ...
 f17:	b8 58 00 00 00       	mov    $0x58,%eax
 f1c:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 f21:	0f 45 c8             	cmovne %eax,%ecx
 f24:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # f2a <_Z6enablev+0x1a>
 f2a:	0f 9e c1             	setle  %cl
 f2d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # f34 <_Z6enablev+0x24>
...
0000000000000f40 <_Z9n_reg_maxv>:
 f40:	b8 4f 01 00 00       	mov    $0x14f,%eax
 f45:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui11_uk27.cpp+0x9a>
  96:	01 00 00 00 

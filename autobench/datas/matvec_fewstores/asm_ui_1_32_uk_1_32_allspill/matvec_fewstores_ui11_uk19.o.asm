...
matvec_fewstores_ui11_uk19.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e a1 09 00 00    	jle    b29 <_Z5benchv+0x9d9>
 ...
 218:	0f 83 0b 09 00 00    	jae    b29 <_Z5benchv+0x9d9>
 ...
 aaf:	48 83 c6 13          	add    $0x13,%rsi
 ab3:	49 0f af c2          	imul   %r10,%rax
 ab7:	48 01 f8             	add    %rdi,%rax
 aba:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
 ac0:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
 ac7:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
 ace:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
 ad5:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
 adc:	00 00 00 
 adf:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
 ae6:	00 00 00 
 ae9:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
 af0:	00 00 00 
 af3:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
 afa:	00 00 00 
 afd:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
 b04:	01 00 00 
 b07:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
 b0e:	01 00 00 
 b11:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
 b18:	01 00 00 
 b1b:	4c 39 c6             	cmp    %r8,%rsi
 b1e:	0f 8c 6c f7 ff ff    	jl     290 <_Z5benchv+0x140>
 b24:	e9 87 f6 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 b29:	0f 31                	rdtsc  
 b2b:	48 c1 e2 20          	shl    $0x20,%rdx
 b2f:	48 09 c2             	or     %rax,%rdx
 b32:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b38 <_Z5benchv+0x9e8>
 b38:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 b3d:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # b45 <_Z5benchv+0x9f5>
 b44:	00 
 b45:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # b4d <_Z5benchv+0x9fd>
 b4c:	00 
 b4d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b54 <_Z5benchv+0xa04>
 b54:	01 c0                	add    %eax,%eax
 b56:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b5c:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b60:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 b64:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
 b68:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 b6c:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 b70:	c5 f8 77             	vzeroupper 
 b73:	c3                   	retq   
 b74:	90                   	nop
 b75:	90                   	nop
 b76:	90                   	nop
...
0000000000000b80 <_Z6enablev>:
 ...
 b87:	b8 58 00 00 00       	mov    $0x58,%eax
 b8c:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 b91:	0f 45 c8             	cmovne %eax,%ecx
 b94:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b9a <_Z6enablev+0x1a>
 b9a:	0f 9e c1             	setle  %cl
 b9d:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # ba4 <_Z6enablev+0x24>
...
0000000000000bb0 <_Z9n_reg_maxv>:
 bb0:	b8 ef 00 00 00       	mov    $0xef,%eax
 bb5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui11_uk19.cpp+0x9a>
  96:	01 00 00 00 

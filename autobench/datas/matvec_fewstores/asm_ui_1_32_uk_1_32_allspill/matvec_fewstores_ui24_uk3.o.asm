...
0000000000000b40 <_Z6enablev>:
 b40:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # b47 <_Z6enablev+0x7>
 b47:	b8 c0 00 00 00       	mov    $0xc0,%eax
 b4c:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
 b51:	0f 45 c8             	cmovne %eax,%ecx
 b54:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b5a <_Z6enablev+0x1a>
 b5a:	0f 9e c1             	setle  %cl
 b5d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # b64 <_Z6enablev+0x24>
 b64:	0f 9f c0             	setg   %al
 b67:	20 c8                	and    %cl,%al
 b69:	c3                   	retq   
 b6a:	90                   	nop
 b6b:	90                   	nop
...
0000000000000b70 <_Z9n_reg_maxv>:
 b70:	b8 63 00 00 00       	mov    $0x63,%eax
 b75:	c3                   	retq   

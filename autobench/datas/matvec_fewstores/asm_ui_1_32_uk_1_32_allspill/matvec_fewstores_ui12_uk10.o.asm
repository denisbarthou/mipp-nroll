...
0000000000000b60 <_Z6enablev>:
 ...
 b67:	b8 60 00 00 00       	mov    $0x60,%eax
 b6c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 b71:	0f 45 c8             	cmovne %eax,%ecx
 b74:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b7a <_Z6enablev+0x1a>
 b7a:	0f 9e c1             	setle  %cl
 b7d:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # b84 <_Z6enablev+0x24>
...
0000000000000b90 <_Z9n_reg_maxv>:
 b90:	b8 8e 00 00 00       	mov    $0x8e,%eax
 b95:	c3                   	retq   

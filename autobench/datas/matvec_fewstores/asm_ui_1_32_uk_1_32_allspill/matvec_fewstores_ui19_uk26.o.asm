...
matvec_fewstores_ui19_uk26.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e 21 1c 00 00    	jle    1db6 <_Z5benchv+0x1c66>
     ...
     2ab:	0f 83 05 1b 00 00    	jae    1db6 <_Z5benchv+0x1c66>
    ...
    1c90:	48 83 c6 1a          	add    $0x1a,%rsi
    1c94:	49 0f af c2          	imul   %r10,%rax
    1c98:	48 01 f8             	add    %rdi,%rax
    1c9b:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm10
    1ca2:	00 00 00 
    1ca5:	c4 e2 5d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm5
    1cab:	c4 e2 5d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm6
    1cb2:	c4 e2 5d b8 7c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm7
    1cb9:	c4 62 5d b8 44 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm8
    1cc0:	c4 62 5d b8 8c 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm9
    1cc7:	00 00 00 
    1cca:	c4 62 5d b8 9c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm11
    1cd1:	02 00 00 
    1cd4:	c4 62 5d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm12
    1cdb:	01 00 00 
    1cde:	c4 62 5d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm13
    1ce5:	01 00 00 
    1ce8:	c4 62 5d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm14
    1cef:	01 00 00 
    1cf2:	c4 62 5d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm15
    1cf9:	01 00 00 
    1cfc:	c4 e2 5d b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm2
    1d03:	01 00 00 
    1d06:	c4 e2 5d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm1
    1d0d:	02 00 00 
    1d10:	c4 e2 5d b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm3
    1d17:	02 00 00 
    1d1a:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    1d20:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    1d26:	c4 e2 5d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm0
    1d2d:	00 00 00 
    1d30:	c5 7c 11 54 24 40    	vmovups %ymm10,0x40(%rsp)
    1d36:	c5 7c 10 14 24       	vmovups (%rsp),%ymm10
    1d3b:	c4 62 5d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm10
    1d42:	01 00 00 
    1d45:	c5 7c 11 5c 24 60    	vmovups %ymm11,0x60(%rsp)
    1d4b:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    1d51:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    1d57:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    1d5e:	00 00 00 
    1d61:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    1d67:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    1d6d:	c4 e2 5d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm0
    1d74:	01 00 00 
    1d77:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    1d7d:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    1d83:	c4 e2 5d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm0
    1d8a:	01 00 00 
    1d8d:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    1d91:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    1d95:	c5 fc 28 f7          	vmovaps %ymm7,%ymm6
    1d99:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    1d9d:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    1da2:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    1da8:	4c 39 c6             	cmp    %r8,%rsi
    1dab:	0f 8c ef e5 ff ff    	jl     3a0 <_Z5benchv+0x250>
    1db1:	e9 16 e4 ff ff       	jmpq   1cc <_Z5benchv+0x7c>
    1db6:	0f 31                	rdtsc  
    1db8:	48 c1 e2 20          	shl    $0x20,%rdx
    1dbc:	48 09 c2             	or     %rax,%rdx
    1dbf:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1dc5 <_Z5benchv+0x1c75>
    1dc5:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1dca:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1dd2 <_Z5benchv+0x1c82>
    1dd1:	00 
    1dd2:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1dda <_Z5benchv+0x1c8a>
    1dd9:	00 
    1dda:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1de1 <_Z5benchv+0x1c91>
    1de1:	01 c0                	add    %eax,%eax
    1de3:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1de9:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1ded:	c5 fb 5c 44 24 38    	vsubsd 0x38(%rsp),%xmm0,%xmm0
    1df3:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
    1df8:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
    1dfc:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1e00:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1e04:	48 81 c4 b8 00 00 00 	add    $0xb8,%rsp
    1e0b:	c5 f8 77             	vzeroupper 
    1e0e:	c3                   	retq   
    1e0f:	90                   	nop

0000000000001e10 <_Z6enablev>:
    1e10:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1e17 <_Z6enablev+0x7>
    1e17:	b8 98 00 00 00       	mov    $0x98,%eax
    1e1c:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    1e21:	0f 45 c8             	cmovne %eax,%ecx
    1e24:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1e2a <_Z6enablev+0x1a>
    1e2a:	0f 9e c1             	setle  %cl
    1e2d:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # 1e34 <_Z6enablev+0x24>
...
0000000000001e40 <_Z9n_reg_maxv>:
    1e40:	b8 1b 02 00 00       	mov    $0x21b,%eax
    1e45:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui19_uk26.cpp+0x9a>
  96:	01 00 00 00 

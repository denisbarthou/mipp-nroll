...
0000000000002f00 <_Z6enablev>:
    2f00:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2f07 <_Z6enablev+0x7>
    2f07:	b8 c8 00 00 00       	mov    $0xc8,%eax
    2f0c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
    2f11:	0f 45 c8             	cmovne %eax,%ecx
    2f14:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 2f1a <_Z6enablev+0x1a>
    2f1a:	0f 9e c1             	setle  %cl
    2f1d:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # 2f24 <_Z6enablev+0x24>
    2f24:	0f 9f c0             	setg   %al
    2f27:	20 c8                	and    %cl,%al
    2f29:	c3                   	retq   
    2f2a:	90                   	nop
    2f2b:	90                   	nop
    2f2c:	90                   	nop
...
0000000000002f30 <_Z9n_reg_maxv>:
    2f30:	b8 bd 02 00 00       	mov    $0x2bd,%eax
    2f35:	c3                   	retq   

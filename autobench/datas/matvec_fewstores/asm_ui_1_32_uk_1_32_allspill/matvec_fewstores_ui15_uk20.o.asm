...
matvec_fewstores_ui15_uk20.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 188:	0f 8e dd 0d 00 00    	jle    f6b <_Z5benchv+0xe1b>
 ...
 250:	0f 83 15 0d 00 00    	jae    f6b <_Z5benchv+0xe1b>
 ...
 ec9:	48 83 c6 14          	add    $0x14,%rsi
 ecd:	49 0f af c2          	imul   %r10,%rax
 ed1:	48 01 f8             	add    %rdi,%rax
 ed4:	c4 e2 7d b8 14 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm2
 eda:	c4 e2 7d b8 5c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm3
 ee1:	c4 e2 7d b8 64 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm4
 ee8:	c4 e2 7d b8 6c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm5
 eef:	c4 e2 7d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm6
 ef6:	00 00 00 
 ef9:	c4 e2 7d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm7
 f00:	00 00 00 
 f03:	c4 62 7d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm8
 f0a:	00 00 00 
 f0d:	c4 62 7d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm9
 f14:	00 00 00 
 f17:	c4 62 7d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm10
 f1e:	01 00 00 
 f21:	c4 62 7d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm11
 f28:	01 00 00 
 f2b:	c4 62 7d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm12
 f32:	01 00 00 
 f35:	c4 62 7d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm13
 f3c:	01 00 00 
 f3f:	c4 62 7d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm14
 f46:	01 00 00 
 f49:	c4 62 7d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm15
 f50:	01 00 00 
 f53:	c4 e2 7d b8 8c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm1
 f5a:	01 00 00 
 f5d:	4c 39 c6             	cmp    %r8,%rsi
 f60:	0f 8c 8a f3 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
 f66:	e9 55 f2 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
 f6b:	0f 31                	rdtsc  
 f6d:	48 c1 e2 20          	shl    $0x20,%rdx
 f71:	48 09 c2             	or     %rax,%rdx
 f74:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # f7a <_Z5benchv+0xe2a>
 f7a:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
 f7f:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # f87 <_Z5benchv+0xe37>
 f86:	00 
 f87:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # f8f <_Z5benchv+0xe3f>
 f8e:	00 
 f8f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # f96 <_Z5benchv+0xe46>
 f96:	01 c0                	add    %eax,%eax
 f98:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
 f9e:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
 fa2:	c5 fb 5c 44 24 a0    	vsubsd -0x60(%rsp),%xmm0,%xmm0
 fa8:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 fac:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
 fb0:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 fb4:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 fb8:	c5 f8 77             	vzeroupper 
 fbb:	c3                   	retq   
 fbc:	90                   	nop
 fbd:	90                   	nop
 fbe:	90                   	nop
...
0000000000000fc0 <_Z6enablev>:
 ...
 fc7:	b8 78 00 00 00       	mov    $0x78,%eax
 fcc:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
...
0000000000000ff0 <_Z9n_reg_maxv>:
 ff0:	b8 4f 01 00 00       	mov    $0x14f,%eax
 ff5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui15_uk20.cpp+0x9a>
  96:	01 00 00 00 

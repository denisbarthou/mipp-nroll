...
matvec_fewstores_ui12_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     183:	0f 8e 66 0e 00 00    	jle    fef <_Z5benchv+0xe9f>
     ...
     21f:	0f 83 ca 0d 00 00    	jae    fef <_Z5benchv+0xe9f>
     ...
     f6b:	48 83 c3 1b          	add    $0x1b,%rbx
     f6f:	48 0f af f0          	imul   %rax,%rsi
     f73:	48 01 fe             	add    %rdi,%rsi
     f76:	c4 e2 15 b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm3
     f7c:	c4 e2 15 b8 6c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm5
     f83:	c4 e2 15 b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm7
     f8a:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
     f91:	c4 e2 15 b8 8c b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm1
     f98:	00 00 00 
     f9b:	c4 e2 15 b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm2
     fa2:	00 00 00 
     fa5:	c4 e2 15 b8 a4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm4
     fac:	00 00 00 
     faf:	c4 e2 15 b8 b4 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm6
     fb6:	00 00 00 
     fb9:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
     fc0:	01 00 00 
     fc3:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
     fca:	01 00 00 
     fcd:	c4 62 15 b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm11
     fd4:	01 00 00 
     fd7:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm12
     fde:	01 00 00 
     fe1:	4c 39 c3             	cmp    %r8,%rbx
     fe4:	0f 8c c6 f2 ff ff    	jl     2b0 <_Z5benchv+0x160>
     fea:	e9 c1 f1 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
     fef:	0f 31                	rdtsc  
     ff1:	48 c1 e2 20          	shl    $0x20,%rdx
     ff5:	48 09 c2             	or     %rax,%rdx
     ff8:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # ffe <_Z5benchv+0xeae>
     ffe:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    1003:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 100b <_Z5benchv+0xebb>
    100a:	00 
    100b:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 1013 <_Z5benchv+0xec3>
    1012:	00 
    1013:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 101a <_Z5benchv+0xeca>
    101a:	01 c0                	add    %eax,%eax
    101c:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    1022:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    1026:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    102a:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    102e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1032:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1036:	5b                   	pop    %rbx
    1037:	41 5e                	pop    %r14
    1039:	c5 f8 77             	vzeroupper 
    103c:	c3                   	retq   
    103d:	90                   	nop
    103e:	90                   	nop
    103f:	90                   	nop
...
0000000000001040 <_Z6enablev>:
    ...
    1047:	b8 60 00 00 00       	mov    $0x60,%eax
    104c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
    1051:	0f 45 c8             	cmovne %eax,%ecx
    1054:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 105a <_Z6enablev+0x1a>
    105a:	0f 9e c1             	setle  %cl
    105d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 1064 <_Z6enablev+0x24>
...
0000000000001070 <_Z9n_reg_maxv>:
    1070:	b8 6b 01 00 00       	mov    $0x16b,%eax
    1075:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui12_uk27.cpp+0x9a>
  96:	01 00 00 00 

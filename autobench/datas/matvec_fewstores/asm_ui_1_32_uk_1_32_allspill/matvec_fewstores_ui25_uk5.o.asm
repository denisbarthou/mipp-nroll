...
0000000000000f00 <_Z6enablev>:
 ...
 f07:	b8 c8 00 00 00       	mov    $0xc8,%eax
 f0c:	b9 e7 ff ff ff       	mov    $0xffffffe7,%ecx
 f11:	0f 45 c8             	cmovne %eax,%ecx
 f14:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # f1a <_Z6enablev+0x1a>
 f1a:	0f 9e c1             	setle  %cl
 f1d:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # f24 <_Z6enablev+0x24>
...
0000000000000f30 <_Z9n_reg_maxv>:
 f30:	b8 9b 00 00 00       	mov    $0x9b,%eax
 f35:	c3                   	retq   

...
0000000000001620 <_Z6enablev>:
    ...
    1627:	b8 80 00 00 00       	mov    $0x80,%eax
    162c:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
    1631:	0f 45 c8             	cmovne %eax,%ecx
    1634:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 163a <_Z6enablev+0x1a>
    163a:	0f 9e c1             	setle  %cl
    163d:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 1644 <_Z6enablev+0x24>
...
0000000000001650 <_Z9n_reg_maxv>:
    1650:	b8 86 01 00 00       	mov    $0x186,%eax
    1655:	c3                   	retq   

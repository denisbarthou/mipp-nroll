...
00000000000010a0 <_Z6enablev>:
    ...
    10a7:	b8 90 00 00 00       	mov    $0x90,%eax
    10ac:	b9 ee ff ff ff       	mov    $0xffffffee,%ecx
    10b1:	0f 45 c8             	cmovne %eax,%ecx
    10b4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 10ba <_Z6enablev+0x1a>
    10ba:	0f 9e c1             	setle  %cl
    10bd:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 10c4 <_Z6enablev+0x24>
...
00000000000010d0 <_Z9n_reg_maxv>:
    10d0:	b8 09 01 00 00       	mov    $0x109,%eax
    10d5:	c3                   	retq   

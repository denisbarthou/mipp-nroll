...
0000000000000bd0 <_Z6enablev>:
 ...
 bd7:	b8 48 00 00 00       	mov    $0x48,%eax
 bdc:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 be1:	0f 45 c8             	cmovne %eax,%ecx
 be4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # bea <_Z6enablev+0x1a>
 bea:	0f 9e c1             	setle  %cl
 bed:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # bf4 <_Z6enablev+0x24>
...
0000000000000c00 <_Z9n_reg_maxv>:
 c00:	b8 f9 00 00 00       	mov    $0xf9,%eax
 c05:	c3                   	retq   

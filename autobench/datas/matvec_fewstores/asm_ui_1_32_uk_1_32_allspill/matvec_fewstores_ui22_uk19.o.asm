...
0000000000001d30 <_Z6enablev>:
    1d30:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1d37 <_Z6enablev+0x7>
    1d37:	b8 b0 00 00 00       	mov    $0xb0,%eax
    1d3c:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    1d41:	0f 45 c8             	cmovne %eax,%ecx
    1d44:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1d4a <_Z6enablev+0x1a>
    1d4a:	0f 9e c1             	setle  %cl
    1d4d:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # 1d54 <_Z6enablev+0x24>
    1d54:	0f 9f c0             	setg   %al
    1d57:	20 c8                	and    %cl,%al
    1d59:	c3                   	retq   
    1d5a:	90                   	nop
    1d5b:	90                   	nop
    1d5c:	90                   	nop
...
0000000000001d60 <_Z9n_reg_maxv>:
    1d60:	b8 cb 01 00 00       	mov    $0x1cb,%eax
    1d65:	c3                   	retq   

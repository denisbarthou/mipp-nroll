...
0000000000001490 <_Z6enablev>:
    1490:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1497 <_Z6enablev+0x7>
    1497:	b8 48 00 00 00       	mov    $0x48,%eax
    149c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
    14a1:	0f 45 c8             	cmovne %eax,%ecx
    14a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 14aa <_Z6enablev+0x1a>
    14aa:	0f 9e c1             	setle  %cl
    14ad:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # 14b4 <_Z6enablev+0x24>
    14b4:	0f 9f c0             	setg   %al
    14b7:	20 c8                	and    %cl,%al
    14b9:	c3                   	retq   
    14ba:	90                   	nop
    14bb:	90                   	nop
    14bc:	90                   	nop
...
00000000000014c0 <_Z9n_reg_maxv>:
    14c0:	b8 c7 00 00 00       	mov    $0xc7,%eax
    14c5:	c3                   	retq   

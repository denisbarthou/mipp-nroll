...
matvec_fewstores_ui29_uk17.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e ed 26 00 00    	jle    2895 <_Z5benchv+0x2735>
     ...
     393:	0f 83 fc 24 00 00    	jae    2895 <_Z5benchv+0x2735>
    ...
    263d:	48 83 c0 11          	add    $0x11,%rax
    2641:	49 0f af f2          	imul   %r10,%rsi
    2645:	48 01 fe             	add    %rdi,%rsi
    2648:	c4 e2 0d b8 b4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm14,%ymm6
    264f:	00 00 00 
    2652:	c4 e2 0d b8 84 b1 80 	vfmadd231ps 0x380(%rcx,%rsi,4),%ymm14,%ymm0
    2659:	03 00 00 
    265c:	c4 62 0d b8 3c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm14,%ymm15
    2662:	c4 e2 0d b8 ac b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm14,%ymm5
    2669:	00 00 00 
    266c:	c4 e2 0d b8 bc b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm14,%ymm7
    2673:	00 00 00 
    2676:	c4 62 0d b8 9c b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm14,%ymm11
    267d:	01 00 00 
    2680:	c4 62 0d b8 84 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm14,%ymm8
    2687:	01 00 00 
    268a:	c4 62 0d b8 94 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm14,%ymm10
    2691:	02 00 00 
    2694:	c4 62 0d b8 a4 b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm14,%ymm12
    269b:	02 00 00 
    269e:	c4 62 0d b8 ac b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm14,%ymm13
    26a5:	03 00 00 
    26a8:	c4 e2 0d b8 4c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm14,%ymm1
    26af:	c4 e2 0d b8 54 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm14,%ymm2
    26b6:	c4 e2 0d b8 5c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm14,%ymm3
    26bd:	c4 e2 0d b8 a4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm14,%ymm4
    26c4:	00 00 00 
    26c7:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    26cd:	c5 7c 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm9
    26d3:	c4 62 0d b8 8c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm14,%ymm9
    26da:	01 00 00 
    26dd:	c5 fc 11 b4 24 e0 01 	vmovups %ymm6,0x1e0(%rsp)
    26e4:	00 00 
    26e6:	c5 fc 10 b4 24 20 01 	vmovups 0x120(%rsp),%ymm6
    26ed:	00 00 
    26ef:	c4 e2 0d b8 b4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm14,%ymm6
    26f6:	01 00 00 
    26f9:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    2700:	00 00 
    2702:	c5 7c 29 f8          	vmovaps %ymm15,%ymm0
    2706:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    270a:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    270e:	c5 7c 11 4c 24 a0    	vmovups %ymm9,-0x60(%rsp)
    2714:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    271a:	c4 62 0d b8 8c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm14,%ymm9
    2721:	02 00 00 
    2724:	c5 fc 11 b4 24 20 01 	vmovups %ymm6,0x120(%rsp)
    272b:	00 00 
    272d:	c5 fc 10 b4 24 e0 00 	vmovups 0xe0(%rsp),%ymm6
    2734:	00 00 
    2736:	c4 e2 0d b8 b4 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm14,%ymm6
    273d:	01 00 00 
    2740:	c5 7c 11 4c 24 c0    	vmovups %ymm9,-0x40(%rsp)
    2746:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    274c:	c4 62 0d b8 8c b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm14,%ymm9
    2753:	02 00 00 
    2756:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    275c:	c5 fc 11 b4 24 e0 00 	vmovups %ymm6,0xe0(%rsp)
    2763:	00 00 
    2765:	c5 fc 10 b4 24 a0 00 	vmovups 0xa0(%rsp),%ymm6
    276c:	00 00 
    276e:	c4 e2 0d b8 b4 b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm14,%ymm6
    2775:	01 00 00 
    2778:	c5 7c 11 4c 24 80    	vmovups %ymm9,-0x80(%rsp)
    277e:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    2784:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    278b:	00 00 
    278d:	c5 fc 10 b4 24 00 01 	vmovups 0x100(%rsp),%ymm6
    2794:	00 00 
    2796:	c4 e2 0d b8 b4 b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm14,%ymm6
    279d:	01 00 00 
    27a0:	c5 fc 11 b4 24 00 01 	vmovups %ymm6,0x100(%rsp)
    27a7:	00 00 
    27a9:	c5 fc 10 b4 24 c0 00 	vmovups 0xc0(%rsp),%ymm6
    27b0:	00 00 
    27b2:	c4 e2 0d b8 b4 b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm14,%ymm6
    27b9:	01 00 00 
    27bc:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    27c3:	00 00 
    27c5:	c5 fc 10 b4 24 40 01 	vmovups 0x140(%rsp),%ymm6
    27cc:	00 00 
    27ce:	c4 e2 0d b8 b4 b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm14,%ymm6
    27d5:	02 00 00 
    27d8:	c5 fc 11 b4 24 40 01 	vmovups %ymm6,0x140(%rsp)
    27df:	00 00 
    27e1:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    27e7:	c4 e2 0d b8 b4 b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm14,%ymm6
    27ee:	02 00 00 
    27f1:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    27f7:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    27fd:	c4 e2 0d b8 b4 b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm14,%ymm6
    2804:	02 00 00 
    2807:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    280d:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2814:	00 00 
    2816:	c4 e2 0d b8 b4 b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm14,%ymm6
    281d:	02 00 00 
    2820:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    2827:	00 00 
    2829:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    282f:	c4 e2 0d b8 b4 b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm14,%ymm6
    2836:	03 00 00 
    2839:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    283f:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    2844:	c4 e2 0d b8 b4 b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm14,%ymm6
    284b:	03 00 00 
    284e:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    2853:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    2859:	c4 e2 0d b8 b4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm14,%ymm6
    2860:	03 00 00 
    2863:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    2869:	c5 7c 29 d6          	vmovaps %ymm10,%ymm6
    286d:	c4 41 7c 28 d5       	vmovaps %ymm13,%ymm10
    2872:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    2877:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    287c:	c4 41 7c 28 e0       	vmovaps %ymm8,%ymm12
    2881:	c5 7c 10 44 24 a0    	vmovups -0x60(%rsp),%ymm8
    2887:	4c 39 c0             	cmp    %r8,%rax
    288a:	0f 8c 10 dd ff ff    	jl     5a0 <_Z5benchv+0x440>
    2890:	e9 71 d9 ff ff       	jmpq   206 <_Z5benchv+0xa6>
    2895:	0f 31                	rdtsc  
    2897:	48 c1 e2 20          	shl    $0x20,%rdx
    289b:	48 09 c2             	or     %rax,%rdx
    289e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 28a4 <_Z5benchv+0x2744>
    28a4:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    28a9:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 28b1 <_Z5benchv+0x2751>
    28b0:	00 
    28b1:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 28b9 <_Z5benchv+0x2759>
    28b8:	00 
    28b9:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 28c0 <_Z5benchv+0x2760>
    28c0:	01 c0                	add    %eax,%eax
    28c2:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    28c8:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    28cc:	c5 fb 5c 84 24 78 01 	vsubsd 0x178(%rsp),%xmm0,%xmm0
    28d3:	00 00 
    28d5:	c4 41 08 57 f6       	vxorps %xmm14,%xmm14,%xmm14
    28da:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    28de:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    28e2:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    28e6:	48 81 c4 58 02 00 00 	add    $0x258,%rsp
    28ed:	c5 f8 77             	vzeroupper 
    28f0:	c3                   	retq   
    28f1:	90                   	nop
    28f2:	90                   	nop
    28f3:	90                   	nop
...
0000000000002900 <_Z6enablev>:
    ...
    291d:	83 3d 00 00 00 00 10 	cmpl   $0x10,0x0(%rip)        # 2924 <_Z6enablev+0x24>
...
0000000000002930 <_Z9n_reg_maxv>:
    2930:	b8 1b 02 00 00       	mov    $0x21b,%eax
    2935:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui29_uk17.cpp+0x9a>
  96:	01 00 00 00 

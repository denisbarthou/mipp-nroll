...
matvec_fewstores_ui17_uk29.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     19c:	0f 8e c7 19 00 00    	jle    1b69 <_Z5benchv+0x1a09>
     ...
     290:	0f 83 d3 18 00 00    	jae    1b69 <_Z5benchv+0x1a09>
    ...
    1a82:	48 83 c6 1d          	add    $0x1d,%rsi
    1a86:	49 0f af c2          	imul   %r10,%rax
    1a8a:	48 01 f8             	add    %rdi,%rax
    1a8d:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1a93:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1a9a:	c4 e2 6d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm1
    1aa1:	01 00 00 
    1aa4:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    1aab:	00 00 00 
    1aae:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1ab5:	00 00 00 
    1ab8:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1abf:	00 00 00 
    1ac2:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    1ac9:	00 00 00 
    1acc:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1ad3:	01 00 00 
    1ad6:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1add:	01 00 00 
    1ae0:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    1ae7:	01 00 00 
    1aea:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    1af1:	01 00 00 
    1af4:	c4 62 6d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm15
    1afb:	01 00 00 
    1afe:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    1b05:	01 00 00 
    1b08:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    1b0f:	02 00 00 
    1b12:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    1b18:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1b1e:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    1b25:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    1b2a:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    1b30:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1b36:	c4 e2 6d b8 6c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm5
    1b3d:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1b43:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1b49:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    1b50:	01 00 00 
    1b53:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    1b57:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    1b5b:	4c 39 c6             	cmp    %r8,%rsi
    1b5e:	0f 8c fc e7 ff ff    	jl     360 <_Z5benchv+0x200>
    1b64:	e9 6f e6 ff ff       	jmpq   1d8 <_Z5benchv+0x78>
    1b69:	0f 31                	rdtsc  
    1b6b:	48 c1 e2 20          	shl    $0x20,%rdx
    1b6f:	48 09 c2             	or     %rax,%rdx
    1b72:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1b78 <_Z5benchv+0x1a18>
    1b78:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1b7d:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1b85 <_Z5benchv+0x1a25>
    1b84:	00 
    1b85:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1b8d <_Z5benchv+0x1a2d>
    1b8c:	00 
    1b8d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1b94 <_Z5benchv+0x1a34>
    1b94:	01 c0                	add    %eax,%eax
    1b96:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1b9c:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1ba0:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1ba6:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
    1baa:	c5 ca 2a c8          	vcvtsi2ss %eax,%xmm6,%xmm1
    1bae:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1bb2:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1bb6:	48 83 c4 38          	add    $0x38,%rsp
...
0000000000001bc0 <_Z6enablev>:
    ...
    1bc7:	b8 88 00 00 00       	mov    $0x88,%eax
    1bcc:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1bd1:	0f 45 c8             	cmovne %eax,%ecx
    1bd4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1bda <_Z6enablev+0x1a>
    1bda:	0f 9e c1             	setle  %cl
    1bdd:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 1be4 <_Z6enablev+0x24>
...
0000000000001bf0 <_Z9n_reg_maxv>:
    1bf0:	b8 1b 02 00 00       	mov    $0x21b,%eax
    1bf5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui17_uk29.cpp+0x9a>
  96:	01 00 00 00 

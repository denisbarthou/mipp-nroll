...
matvec_fewstores_ui26_uk13.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 39 1a 00 00    	jle    1bd1 <_Z5benchv+0x1a81>
     ...
     356:	0f 83 75 18 00 00    	jae    1bd1 <_Z5benchv+0x1a81>
    ...
    19d0:	48 83 c0 0d          	add    $0xd,%rax
    19d4:	49 0f af f3          	imul   %r11,%rsi
    19d8:	48 01 fe             	add    %rdi,%rsi
    19db:	c4 e2 25 b8 8c b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm11,%ymm1
    19e2:	00 00 00 
    19e5:	c4 e2 25 b8 7c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm11,%ymm7
    19ec:	c4 e2 25 b8 94 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm11,%ymm2
    19f3:	00 00 00 
    19f6:	c4 62 25 b8 8c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm11,%ymm9
    19fd:	00 00 00 
    1a00:	c4 e2 25 b8 a4 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm11,%ymm4
    1a07:	01 00 00 
    1a0a:	c4 e2 25 b8 b4 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm11,%ymm6
    1a11:	01 00 00 
    1a14:	c4 e2 25 b8 9c b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm11,%ymm3
    1a1b:	01 00 00 
    1a1e:	c4 62 25 b8 94 b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm11,%ymm10
    1a25:	01 00 00 
    1a28:	c4 62 25 b8 84 b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm11,%ymm8
    1a2f:	02 00 00 
    1a32:	c4 e2 25 b8 84 b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm11,%ymm0
    1a39:	03 00 00 
    1a3c:	c4 62 25 b8 24 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm11,%ymm12
    1a42:	c4 62 25 b8 6c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm11,%ymm13
    1a49:	c4 62 25 b8 74 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm11,%ymm14
    1a50:	c4 62 25 b8 bc b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm11,%ymm15
    1a57:	00 00 00 
    1a5a:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    1a5f:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1a65:	c4 e2 25 b8 ac b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm11,%ymm5
    1a6c:	01 00 00 
    1a6f:	c5 fc 11 8c 24 60 01 	vmovups %ymm1,0x160(%rsp)
    1a76:	00 00 
    1a78:	c5 fc 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm1
    1a7f:	00 00 
    1a81:	c4 e2 25 b8 8c b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm11,%ymm1
    1a88:	01 00 00 
    1a8b:	c5 fc 11 84 24 80 01 	vmovups %ymm0,0x180(%rsp)
    1a92:	00 00 
    1a94:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    1a9a:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1aa0:	c4 e2 25 b8 ac b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm11,%ymm5
    1aa7:	01 00 00 
    1aaa:	c5 fc 11 8c 24 c0 00 	vmovups %ymm1,0xc0(%rsp)
    1ab1:	00 00 
    1ab3:	c5 fc 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm1
    1aba:	00 00 
    1abc:	c4 e2 25 b8 8c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm11,%ymm1
    1ac3:	02 00 00 
    1ac6:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1acc:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1ad2:	c4 e2 25 b8 ac b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm11,%ymm5
    1ad9:	01 00 00 
    1adc:	c5 fc 11 8c 24 e0 00 	vmovups %ymm1,0xe0(%rsp)
    1ae3:	00 00 
    1ae5:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    1aeb:	c4 e2 25 b8 8c b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm11,%ymm1
    1af2:	02 00 00 
    1af5:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    1afb:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1b01:	c5 fc 11 4c 24 60    	vmovups %ymm1,0x60(%rsp)
    1b07:	c5 fc 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm1
    1b0e:	00 00 
    1b10:	c4 e2 25 b8 8c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm11,%ymm1
    1b17:	02 00 00 
    1b1a:	c5 fc 11 8c 24 a0 00 	vmovups %ymm1,0xa0(%rsp)
    1b21:	00 00 
    1b23:	c5 fc 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm1
    1b2a:	00 00 
    1b2c:	c4 e2 25 b8 8c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm11,%ymm1
    1b33:	02 00 00 
    1b36:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    1b3d:	00 00 
    1b3f:	c5 fc 10 4c 24 40    	vmovups 0x40(%rsp),%ymm1
    1b45:	c4 e2 25 b8 8c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm11,%ymm1
    1b4c:	02 00 00 
    1b4f:	c5 fc 11 4c 24 40    	vmovups %ymm1,0x40(%rsp)
    1b55:	c5 fc 10 4c 24 20    	vmovups 0x20(%rsp),%ymm1
    1b5b:	c4 e2 25 b8 8c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm11,%ymm1
    1b62:	02 00 00 
    1b65:	c5 fc 11 4c 24 20    	vmovups %ymm1,0x20(%rsp)
    1b6b:	c5 fc 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm1
    1b71:	c4 e2 25 b8 8c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm11,%ymm1
    1b78:	02 00 00 
    1b7b:	c5 fc 11 4c 24 e0    	vmovups %ymm1,-0x20(%rsp)
    1b81:	c5 fc 10 0c 24       	vmovups (%rsp),%ymm1
    1b86:	c4 e2 25 b8 8c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm11,%ymm1
    1b8d:	03 00 00 
    1b90:	c5 7c 28 da          	vmovaps %ymm2,%ymm11
    1b94:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    1b98:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    1b9c:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    1ba1:	c4 41 7c 28 d0       	vmovaps %ymm8,%ymm10
    1ba6:	c5 7c 28 c4          	vmovaps %ymm4,%ymm8
    1baa:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    1bb0:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    1bb5:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    1bb9:	c5 fc 28 de          	vmovaps %ymm6,%ymm3
    1bbd:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    1bc3:	4c 39 c0             	cmp    %r8,%rax
    1bc6:	0f 8c 74 e9 ff ff    	jl     540 <_Z5benchv+0x3f0>
    1bcc:	e9 32 e6 ff ff       	jmpq   203 <_Z5benchv+0xb3>
    1bd1:	0f 31                	rdtsc  
    1bd3:	48 c1 e2 20          	shl    $0x20,%rdx
    1bd7:	48 09 c2             	or     %rax,%rdx
    1bda:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1be0 <_Z5benchv+0x1a90>
    1be0:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1be5:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1bed <_Z5benchv+0x1a9d>
    1bec:	00 
    1bed:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1bf5 <_Z5benchv+0x1aa5>
    1bf4:	00 
    1bf5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1bfc <_Z5benchv+0x1aac>
    1bfc:	01 c0                	add    %eax,%eax
    1bfe:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1c04:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1c08:	c5 fb 5c 84 24 18 01 	vsubsd 0x118(%rsp),%xmm0,%xmm0
    1c0f:	00 00 
    1c11:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    1c16:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    1c1a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1c1e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1c22:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
...
0000000000001c30 <_Z6enablev>:
    1c30:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1c37 <_Z6enablev+0x7>
    1c37:	b8 d0 00 00 00       	mov    $0xd0,%eax
    1c3c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    1c41:	0f 45 c8             	cmovne %eax,%ecx
    1c44:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1c4a <_Z6enablev+0x1a>
    1c4a:	0f 9e c1             	setle  %cl
    1c4d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 1c54 <_Z6enablev+0x24>
    1c54:	0f 9f c0             	setg   %al
    1c57:	20 c8                	and    %cl,%al
    1c59:	c3                   	retq   
    1c5a:	90                   	nop
    1c5b:	90                   	nop
    1c5c:	90                   	nop
...
0000000000001c60 <_Z9n_reg_maxv>:
    1c60:	b8 79 01 00 00       	mov    $0x179,%eax
    1c65:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui26_uk13.cpp+0x9a>
  96:	01 00 00 00 

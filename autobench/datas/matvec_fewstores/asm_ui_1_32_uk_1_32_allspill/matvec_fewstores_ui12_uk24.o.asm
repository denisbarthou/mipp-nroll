...
0000000000000ee0 <_Z6enablev>:
 ...
 ee7:	b8 60 00 00 00       	mov    $0x60,%eax
 eec:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 ef1:	0f 45 c8             	cmovne %eax,%ecx
 ef4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # efa <_Z6enablev+0x1a>
 efa:	0f 9e c1             	setle  %cl
 efd:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # f04 <_Z6enablev+0x24>
...
0000000000000f10 <_Z9n_reg_maxv>:
 f10:	b8 44 01 00 00       	mov    $0x144,%eax
 f15:	c3                   	retq   

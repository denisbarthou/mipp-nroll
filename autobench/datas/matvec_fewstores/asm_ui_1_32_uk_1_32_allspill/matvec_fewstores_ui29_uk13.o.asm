...
00000000000020d0 <_Z6enablev>:
    ...
    20d7:	b8 e8 00 00 00       	mov    $0xe8,%eax
    20dc:	b9 e3 ff ff ff       	mov    $0xffffffe3,%ecx
    20e1:	0f 45 c8             	cmovne %eax,%ecx
    20e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 20ea <_Z6enablev+0x1a>
    20ea:	0f 9e c1             	setle  %cl
    20ed:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 20f4 <_Z6enablev+0x24>
...
0000000000002100 <_Z9n_reg_maxv>:
    2100:	b8 a3 01 00 00       	mov    $0x1a3,%eax
    2105:	c3                   	retq   

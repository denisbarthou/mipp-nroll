...
0000000000000b80 <_Z6enablev>:
 ...
 b87:	b8 50 00 00 00       	mov    $0x50,%eax
 b8c:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 b91:	0f 45 c8             	cmovne %eax,%ecx
 b94:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b9a <_Z6enablev+0x1a>
 b9a:	0f 9e c1             	setle  %cl
 b9d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # ba4 <_Z6enablev+0x24>
...
0000000000000bb0 <_Z9n_reg_maxv>:
 bb0:	b8 f1 00 00 00       	mov    $0xf1,%eax
 bb5:	c3                   	retq   

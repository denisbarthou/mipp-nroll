...
0000000000001a20 <_Z6enablev>:
    ...
    1a27:	b8 98 00 00 00       	mov    $0x98,%eax
    1a2c:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    1a31:	0f 45 c8             	cmovne %eax,%ecx
    1a34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1a3a <_Z6enablev+0x1a>
    1a3a:	0f 9e c1             	setle  %cl
    1a3d:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 1a44 <_Z6enablev+0x24>
...
0000000000001a50 <_Z9n_reg_maxv>:
    1a50:	b8 cb 01 00 00       	mov    $0x1cb,%eax
    1a55:	c3                   	retq   

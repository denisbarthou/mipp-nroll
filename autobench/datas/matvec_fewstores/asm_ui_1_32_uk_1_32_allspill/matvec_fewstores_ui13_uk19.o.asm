...
matvec_fewstores_ui13_uk19.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 4d 0b 00 00    	jle    cd5 <_Z5benchv+0xb85>
 ...
 22c:	0f 83 a3 0a 00 00    	jae    cd5 <_Z5benchv+0xb85>
 ...
 c47:	48 83 c6 13          	add    $0x13,%rsi
 c4b:	49 0f af c2          	imul   %r10,%rax
 c4f:	48 01 f8             	add    %rdi,%rax
 c52:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
 c58:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
 c5f:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
 c66:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
 c6d:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
 c74:	00 00 00 
 c77:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
 c7e:	00 00 00 
 c81:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
 c88:	00 00 00 
 c8b:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
 c92:	00 00 00 
 c95:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
 c9c:	01 00 00 
 c9f:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
 ca6:	01 00 00 
 ca9:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
 cb0:	01 00 00 
 cb3:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
 cba:	01 00 00 
 cbd:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
 cc4:	01 00 00 
 cc7:	4c 39 c6             	cmp    %r8,%rsi
 cca:	0f 8c f0 f5 ff ff    	jl     2c0 <_Z5benchv+0x170>
 cd0:	e9 db f4 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 cd5:	0f 31                	rdtsc  
 cd7:	48 c1 e2 20          	shl    $0x20,%rdx
 cdb:	48 09 c2             	or     %rax,%rdx
 cde:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # ce4 <_Z5benchv+0xb94>
 ce4:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 ce9:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # cf1 <_Z5benchv+0xba1>
 cf0:	00 
 cf1:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # cf9 <_Z5benchv+0xba9>
 cf8:	00 
 cf9:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # d00 <_Z5benchv+0xbb0>
 d00:	01 c0                	add    %eax,%eax
 d02:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 d08:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 d0c:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 d10:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 d14:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 d18:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 d1c:	c5 f8 77             	vzeroupper 
 d1f:	c3                   	retq   

0000000000000d20 <_Z6enablev>:
 d20:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # d27 <_Z6enablev+0x7>
 d27:	b8 68 00 00 00       	mov    $0x68,%eax
 d2c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 d31:	0f 45 c8             	cmovne %eax,%ecx
 d34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # d3a <_Z6enablev+0x1a>
 d3a:	0f 9e c1             	setle  %cl
 d3d:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # d44 <_Z6enablev+0x24>
...
0000000000000d50 <_Z9n_reg_maxv>:
 d50:	b8 17 01 00 00       	mov    $0x117,%eax
 d55:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui13_uk19.cpp+0x9a>
  96:	01 00 00 00 

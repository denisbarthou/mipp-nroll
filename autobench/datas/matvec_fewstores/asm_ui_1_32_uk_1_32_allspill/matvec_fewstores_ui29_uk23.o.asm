...
matvec_fewstores_ui29_uk23.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e ea 32 00 00    	jle    3492 <_Z5benchv+0x3332>
     ...
     38a:	0f 83 02 31 00 00    	jae    3492 <_Z5benchv+0x3332>
    ...
    3247:	48 83 c6 17          	add    $0x17,%rsi
    324b:	49 0f af c2          	imul   %r10,%rax
    324f:	48 01 f8             	add    %rdi,%rax
    3252:	c4 e2 0d b8 84 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm14,%ymm0
    3259:	03 00 00 
    325c:	c4 62 0d b8 3c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm15
    3262:	c4 e2 0d b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm5
    3269:	00 00 00 
    326c:	c4 e2 0d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm7
    3273:	00 00 00 
    3276:	c4 62 0d b8 9c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm11
    327d:	01 00 00 
    3280:	c4 62 0d b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm8
    3287:	01 00 00 
    328a:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm14,%ymm12
    3291:	02 00 00 
    3294:	c4 62 0d b8 ac 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm14,%ymm13
    329b:	03 00 00 
    329e:	c4 e2 0d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm1
    32a5:	c4 e2 0d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm2
    32ac:	c4 e2 0d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm3
    32b3:	c4 e2 0d b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm4
    32ba:	00 00 00 
    32bd:	c4 e2 0d b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm6
    32c4:	00 00 00 
    32c7:	c4 62 0d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm14,%ymm10
    32ce:	02 00 00 
    32d1:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    32d7:	c5 7c 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm9
    32dd:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm9
    32e4:	01 00 00 
    32e7:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    32ee:	00 00 
    32f0:	c5 7c 29 f8          	vmovaps %ymm15,%ymm0
    32f4:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    32f8:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    32fc:	c5 7c 11 4c 24 a0    	vmovups %ymm9,-0x60(%rsp)
    3302:	c5 7c 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm9
    3309:	00 00 
    330b:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm9
    3312:	01 00 00 
    3315:	c5 7c 11 8c 24 20 01 	vmovups %ymm9,0x120(%rsp)
    331c:	00 00 
    331e:	c5 7c 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm9
    3325:	00 00 
    3327:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm9
    332e:	01 00 00 
    3331:	c5 7c 11 8c 24 e0 00 	vmovups %ymm9,0xe0(%rsp)
    3338:	00 00 
    333a:	c5 7c 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm9
    3341:	00 00 
    3343:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm14,%ymm9
    334a:	01 00 00 
    334d:	c5 7c 11 8c 24 a0 00 	vmovups %ymm9,0xa0(%rsp)
    3354:	00 00 
    3356:	c5 7c 10 8c 24 00 01 	vmovups 0x100(%rsp),%ymm9
    335d:	00 00 
    335f:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm14,%ymm9
    3366:	01 00 00 
    3369:	c5 7c 11 8c 24 00 01 	vmovups %ymm9,0x100(%rsp)
    3370:	00 00 
    3372:	c5 7c 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm9
    3379:	00 00 
    337b:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm14,%ymm9
    3382:	01 00 00 
    3385:	c5 7c 11 8c 24 c0 00 	vmovups %ymm9,0xc0(%rsp)
    338c:	00 00 
    338e:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    3394:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm14,%ymm9
    339b:	02 00 00 
    339e:	c5 7c 11 4c 24 c0    	vmovups %ymm9,-0x40(%rsp)
    33a4:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    33aa:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm14,%ymm9
    33b1:	02 00 00 
    33b4:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    33ba:	c5 7c 11 4c 24 80    	vmovups %ymm9,-0x80(%rsp)
    33c0:	c5 7c 10 8c 24 40 01 	vmovups 0x140(%rsp),%ymm9
    33c7:	00 00 
    33c9:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm14,%ymm9
    33d0:	02 00 00 
    33d3:	c5 7c 11 8c 24 40 01 	vmovups %ymm9,0x140(%rsp)
    33da:	00 00 
    33dc:	c5 7c 10 4c 24 60    	vmovups 0x60(%rsp),%ymm9
    33e2:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm14,%ymm9
    33e9:	02 00 00 
    33ec:	c5 7c 11 4c 24 60    	vmovups %ymm9,0x60(%rsp)
    33f2:	c5 7c 10 4c 24 40    	vmovups 0x40(%rsp),%ymm9
    33f8:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm14,%ymm9
    33ff:	02 00 00 
    3402:	c5 7c 11 4c 24 40    	vmovups %ymm9,0x40(%rsp)
    3408:	c5 7c 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm9
    340f:	00 00 
    3411:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm14,%ymm9
    3418:	02 00 00 
    341b:	c5 7c 11 8c 24 80 00 	vmovups %ymm9,0x80(%rsp)
    3422:	00 00 
    3424:	c5 7c 10 4c 24 20    	vmovups 0x20(%rsp),%ymm9
    342a:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm14,%ymm9
    3431:	03 00 00 
    3434:	c5 7c 11 4c 24 20    	vmovups %ymm9,0x20(%rsp)
    343a:	c5 7c 10 0c 24       	vmovups (%rsp),%ymm9
    343f:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm14,%ymm9
    3446:	03 00 00 
    3449:	c5 7c 11 0c 24       	vmovups %ymm9,(%rsp)
    344e:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    3454:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm14,%ymm9
    345b:	03 00 00 
    345e:	c4 41 7c 28 f5       	vmovaps %ymm13,%ymm14
    3463:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    3468:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    346d:	c4 41 7c 28 e0       	vmovaps %ymm8,%ymm12
    3472:	c5 7c 10 44 24 a0    	vmovups -0x60(%rsp),%ymm8
    3478:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    347e:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    3484:	4c 39 c6             	cmp    %r8,%rsi
    3487:	0f 8c 03 d1 ff ff    	jl     590 <_Z5benchv+0x430>
    348d:	e9 74 cd ff ff       	jmpq   206 <_Z5benchv+0xa6>
    3492:	0f 31                	rdtsc  
    3494:	48 c1 e2 20          	shl    $0x20,%rdx
    3498:	48 09 c2             	or     %rax,%rdx
    349b:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 34a1 <_Z5benchv+0x3341>
    34a1:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    34a6:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 34ae <_Z5benchv+0x334e>
    34ad:	00 
    34ae:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 34b6 <_Z5benchv+0x3356>
    34b5:	00 
    34b6:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 34bd <_Z5benchv+0x335d>
    34bd:	01 c0                	add    %eax,%eax
    34bf:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    34c5:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    34c9:	c5 fb 5c 84 24 78 01 	vsubsd 0x178(%rsp),%xmm0,%xmm0
    34d0:	00 00 
    34d2:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    34d6:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    34da:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    34de:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    34e2:	48 81 c4 38 02 00 00 	add    $0x238,%rsp
    34e9:	c5 f8 77             	vzeroupper 
    34ec:	c3                   	retq   
    34ed:	90                   	nop
    34ee:	90                   	nop
    34ef:	90                   	nop

00000000000034f0 <_Z6enablev>:
    34f0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 34f7 <_Z6enablev+0x7>
    34f7:	b8 e8 00 00 00       	mov    $0xe8,%eax
    34fc:	b9 e3 ff ff ff       	mov    $0xffffffe3,%ecx
    3501:	0f 45 c8             	cmovne %eax,%ecx
    3504:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 350a <_Z6enablev+0x1a>
    350a:	0f 9e c1             	setle  %cl
    350d:	83 3d 00 00 00 00 16 	cmpl   $0x16,0x0(%rip)        # 3514 <_Z6enablev+0x24>
    3514:	0f 9f c0             	setg   %al
    3517:	20 c8                	and    %cl,%al
    3519:	c3                   	retq   
    351a:	90                   	nop
    351b:	90                   	nop
    351c:	90                   	nop
...
0000000000003520 <_Z9n_reg_maxv>:
    3520:	b8 cf 02 00 00       	mov    $0x2cf,%eax
    3525:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui29_uk23.cpp+0x9a>
  96:	01 00 00 00 

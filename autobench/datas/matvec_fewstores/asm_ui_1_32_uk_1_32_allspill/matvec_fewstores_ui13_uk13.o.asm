...
0000000000000e90 <_Z6enablev>:
 e90:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # e97 <_Z6enablev+0x7>
 e97:	b8 68 00 00 00       	mov    $0x68,%eax
 e9c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 ea1:	0f 45 c8             	cmovne %eax,%ecx
 ea4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # eaa <_Z6enablev+0x1a>
 eaa:	0f 9e c1             	setle  %cl
 ead:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # eb4 <_Z6enablev+0x24>
 eb4:	0f 9f c0             	setg   %al
 eb7:	20 c8                	and    %cl,%al
 eb9:	c3                   	retq   
 eba:	90                   	nop
 ebb:	90                   	nop
...
0000000000000ec0 <_Z9n_reg_maxv>:
 ec0:	b8 c3 00 00 00       	mov    $0xc3,%eax
 ec5:	c3                   	retq   

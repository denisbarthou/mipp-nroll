...
0000000000001660 <_Z6enablev>:
    1660:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1667 <_Z6enablev+0x7>
    1667:	b8 d8 00 00 00       	mov    $0xd8,%eax
    166c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    1671:	0f 45 c8             	cmovne %eax,%ecx
    1674:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 167a <_Z6enablev+0x1a>
    167a:	0f 9e c1             	setle  %cl
    167d:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # 1684 <_Z6enablev+0x24>
    1684:	0f 9f c0             	setg   %al
    1687:	20 c8                	and    %cl,%al
    1689:	c3                   	retq   
    168a:	90                   	nop
    168b:	90                   	nop
    168c:	90                   	nop
...
0000000000001690 <_Z9n_reg_maxv>:
    1690:	b8 17 01 00 00       	mov    $0x117,%eax
    1695:	c3                   	retq   

...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e a7 22 00 00    	jle    244f <_Z5benchv+0x22ef>
     ...
     31c:	0f 83 2d 21 00 00    	jae    244f <_Z5benchv+0x22ef>
    ...
    22c5:	48 83 c6 17          	add    $0x17,%rsi
    22c9:	49 0f af c2          	imul   %r10,%rax
    22cd:	48 01 f8             	add    %rdi,%rax
    22d0:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    22d7:	02 00 00 
    22da:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    22e1:	00 00 00 
    22e4:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    22eb:	00 00 00 
    22ee:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    22f5:	01 00 00 
    22f8:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    22ff:	01 00 00 
    2302:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    2309:	02 00 00 
    230c:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    2312:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    2319:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    2320:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    2327:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    232e:	00 00 00 
    2331:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    2338:	00 00 00 
    233b:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    2342:	01 00 00 
    2345:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    234c:	01 00 00 
    234f:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    2355:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    235c:	00 00 
    235e:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    2365:	01 00 00 
    2368:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    236f:	00 00 
    2371:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    2375:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    2379:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    237d:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    2384:	00 00 
    2386:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    238d:	00 00 
    238f:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    2395:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    239c:	01 00 00 
    239f:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    23a5:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    23ab:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    23b2:	01 00 00 
    23b5:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    23bb:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    23c1:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    23c8:	01 00 00 
    23cb:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    23d1:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    23d6:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    23dd:	02 00 00 
    23e0:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    23e5:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    23eb:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    23f2:	02 00 00 
    23f5:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    23fb:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    2401:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    2408:	02 00 00 
    240b:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    2411:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    2417:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    241e:	02 00 00 
    2421:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    2427:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    242d:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    2434:	02 00 00 
    2437:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    243b:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    2441:	4c 39 c6             	cmp    %r8,%rsi
    2444:	0f 8c 46 e0 ff ff    	jl     490 <_Z5benchv+0x330>
    244a:	e9 a0 dd ff ff       	jmpq   1ef <_Z5benchv+0x8f>
    244f:	0f 31                	rdtsc  
    2451:	48 c1 e2 20          	shl    $0x20,%rdx
    2455:	48 09 c2             	or     %rax,%rdx
    2458:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 245e <_Z5benchv+0x22fe>
    245e:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2463:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 246b <_Z5benchv+0x230b>
    246a:	00 
    246b:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2473 <_Z5benchv+0x2313>
    2472:	00 
    2473:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 247a <_Z5benchv+0x231a>
    247a:	01 c0                	add    %eax,%eax
    247c:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2482:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2486:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    248d:	00 00 
    248f:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    2493:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    2497:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    249b:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    249f:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
00000000000024b0 <_Z6enablev>:
    ...
    24b7:	b8 b8 00 00 00       	mov    $0xb8,%eax
    24bc:	b9 e9 ff ff ff       	mov    $0xffffffe9,%ecx
    24c1:	0f 45 c8             	cmovne %eax,%ecx
    24c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 24ca <_Z6enablev+0x1a>
    24ca:	0f 9e c1             	setle  %cl
    24cd:	83 3d 00 00 00 00 16 	cmpl   $0x16,0x0(%rip)        # 24d4 <_Z6enablev+0x24>
...
00000000000024e0 <_Z9n_reg_maxv>:
    24e0:	b8 3f 02 00 00       	mov    $0x23f,%eax
    24e5:	c3                   	retq   

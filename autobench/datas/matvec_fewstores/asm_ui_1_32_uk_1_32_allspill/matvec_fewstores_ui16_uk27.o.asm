...
matvec_fewstores_ui16_uk27.o:     file format elf64-x86-64
...
0000000000000140 <_Z5benchv>:
     ...
     184:	0f 8e 79 16 00 00    	jle    1803 <_Z5benchv+0x16c3>
     ...
     285:	0f 83 78 15 00 00    	jae    1803 <_Z5benchv+0x16c3>
    ...
    1739:	49 83 c5 1b          	add    $0x1b,%r13
    173d:	48 0f af d8          	imul   %rax,%rbx
    1741:	48 01 fb             	add    %rdi,%rbx
    1744:	c4 e2 75 b8 5c 99 20 	vfmadd231ps 0x20(%rcx,%rbx,4),%ymm1,%ymm3
    174b:	c4 e2 75 b8 64 99 40 	vfmadd231ps 0x40(%rcx,%rbx,4),%ymm1,%ymm4
    1752:	c4 e2 75 b8 6c 99 60 	vfmadd231ps 0x60(%rcx,%rbx,4),%ymm1,%ymm5
    1759:	c4 e2 75 b8 b4 99 80 	vfmadd231ps 0x80(%rcx,%rbx,4),%ymm1,%ymm6
    1760:	00 00 00 
    1763:	c4 e2 75 b8 bc 99 a0 	vfmadd231ps 0xa0(%rcx,%rbx,4),%ymm1,%ymm7
    176a:	00 00 00 
    176d:	c4 62 75 b8 84 99 c0 	vfmadd231ps 0xc0(%rcx,%rbx,4),%ymm1,%ymm8
    1774:	00 00 00 
    1777:	c4 62 75 b8 8c 99 e0 	vfmadd231ps 0xe0(%rcx,%rbx,4),%ymm1,%ymm9
    177e:	00 00 00 
    1781:	c4 62 75 b8 94 99 00 	vfmadd231ps 0x100(%rcx,%rbx,4),%ymm1,%ymm10
    1788:	01 00 00 
    178b:	c4 62 75 b8 9c 99 20 	vfmadd231ps 0x120(%rcx,%rbx,4),%ymm1,%ymm11
    1792:	01 00 00 
    1795:	c4 62 75 b8 a4 99 40 	vfmadd231ps 0x140(%rcx,%rbx,4),%ymm1,%ymm12
    179c:	01 00 00 
    179f:	c4 62 75 b8 ac 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm13
    17a6:	01 00 00 
    17a9:	c4 62 75 b8 b4 99 a0 	vfmadd231ps 0x1a0(%rcx,%rbx,4),%ymm1,%ymm14
    17b0:	01 00 00 
    17b3:	c4 62 75 b8 bc 99 c0 	vfmadd231ps 0x1c0(%rcx,%rbx,4),%ymm1,%ymm15
    17ba:	01 00 00 
    17bd:	c4 e2 75 b8 84 99 e0 	vfmadd231ps 0x1e0(%rcx,%rbx,4),%ymm1,%ymm0
    17c4:	01 00 00 
    17c7:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    17cd:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    17d3:	c4 e2 75 b8 14 99    	vfmadd231ps (%rcx,%rbx,4),%ymm1,%ymm2
    17d9:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    17df:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    17e5:	c4 e2 75 b8 94 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm2
    17ec:	01 00 00 
    17ef:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    17f5:	49 39 ed             	cmp    %rbp,%r13
    17f8:	0f 8c 02 ec ff ff    	jl     400 <_Z5benchv+0x2c0>
    17fe:	e9 d4 e9 ff ff       	jmpq   1d7 <_Z5benchv+0x97>
    1803:	0f 31                	rdtsc  
    1805:	48 c1 e2 20          	shl    $0x20,%rdx
    1809:	48 09 c2             	or     %rax,%rdx
    180c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1812 <_Z5benchv+0x16d2>
    1812:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1817:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 181f <_Z5benchv+0x16df>
    181e:	00 
    181f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1827 <_Z5benchv+0x16e7>
    1826:	00 
    1827:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 182e <_Z5benchv+0x16ee>
    182e:	01 c0                	add    %eax,%eax
    1830:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1836:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    183a:	c5 fb 5c 44 24 e8    	vsubsd -0x18(%rsp),%xmm0,%xmm0
    1840:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    1844:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    1848:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    184c:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1850:	48 83 c4 48          	add    $0x48,%rsp
    1854:	5b                   	pop    %rbx
    1855:	41 5c                	pop    %r12
    1857:	41 5d                	pop    %r13
    1859:	41 5e                	pop    %r14
...
0000000000001870 <_Z6enablev>:
    1870:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1877 <_Z6enablev+0x7>
    1877:	b8 80 00 00 00       	mov    $0x80,%eax
    187c:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
    1881:	0f 45 c8             	cmovne %eax,%ecx
    1884:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 188a <_Z6enablev+0x1a>
    188a:	0f 9e c1             	setle  %cl
    188d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 1894 <_Z6enablev+0x24>
    1894:	0f 9f c0             	setg   %al
    1897:	20 c8                	and    %cl,%al
    1899:	c3                   	retq   
    189a:	90                   	nop
    189b:	90                   	nop
    189c:	90                   	nop
...
00000000000018a0 <_Z9n_reg_maxv>:
    18a0:	b8 db 01 00 00       	mov    $0x1db,%eax
    18a5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui16_uk27.cpp+0x9a>
  96:	01 00 00 00 

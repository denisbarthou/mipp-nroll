...
00000000000014c0 <_Z6enablev>:
    14c0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 14c7 <_Z6enablev+0x7>
    14c7:	b8 d8 00 00 00       	mov    $0xd8,%eax
    14cc:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    14d1:	0f 45 c8             	cmovne %eax,%ecx
    14d4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 14da <_Z6enablev+0x1a>
    14da:	0f 9e c1             	setle  %cl
    14dd:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 14e4 <_Z6enablev+0x24>
    14e4:	0f 9f c0             	setg   %al
    14e7:	20 c8                	and    %cl,%al
    14e9:	c3                   	retq   
    14ea:	90                   	nop
    14eb:	90                   	nop
    14ec:	90                   	nop
...
00000000000014f0 <_Z9n_reg_maxv>:
    14f0:	b8 fb 00 00 00       	mov    $0xfb,%eax
    14f5:	c3                   	retq   

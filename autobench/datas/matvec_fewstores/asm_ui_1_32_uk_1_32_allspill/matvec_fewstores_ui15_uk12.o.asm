...
0000000000000f40 <_Z6enablev>:
 ...
 f47:	b8 78 00 00 00       	mov    $0x78,%eax
 f4c:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 f51:	0f 45 c8             	cmovne %eax,%ecx
 f54:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # f5a <_Z6enablev+0x1a>
 f5a:	0f 9e c1             	setle  %cl
 f5d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # f64 <_Z6enablev+0x24>
...
0000000000000f70 <_Z9n_reg_maxv>:
 f70:	b8 cf 00 00 00       	mov    $0xcf,%eax
 f75:	c3                   	retq   

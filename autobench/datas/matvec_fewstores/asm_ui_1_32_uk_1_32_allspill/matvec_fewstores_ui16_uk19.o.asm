...
matvec_fewstores_ui16_uk19.o:     file format elf64-x86-64
...
0000000000000140 <_Z5benchv>:
     ...
     184:	0f 8e a1 10 00 00    	jle    122b <_Z5benchv+0x10eb>
     ...
     28a:	0f 83 9b 0f 00 00    	jae    122b <_Z5benchv+0x10eb>
    ...
    1161:	49 83 c5 13          	add    $0x13,%r13
    1165:	48 0f af d8          	imul   %rax,%rbx
    1169:	48 01 fb             	add    %rdi,%rbx
    116c:	c4 e2 75 b8 5c 99 20 	vfmadd231ps 0x20(%rcx,%rbx,4),%ymm1,%ymm3
    1173:	c4 e2 75 b8 64 99 40 	vfmadd231ps 0x40(%rcx,%rbx,4),%ymm1,%ymm4
    117a:	c4 e2 75 b8 6c 99 60 	vfmadd231ps 0x60(%rcx,%rbx,4),%ymm1,%ymm5
    1181:	c4 e2 75 b8 b4 99 80 	vfmadd231ps 0x80(%rcx,%rbx,4),%ymm1,%ymm6
    1188:	00 00 00 
    118b:	c4 e2 75 b8 bc 99 a0 	vfmadd231ps 0xa0(%rcx,%rbx,4),%ymm1,%ymm7
    1192:	00 00 00 
    1195:	c4 62 75 b8 84 99 c0 	vfmadd231ps 0xc0(%rcx,%rbx,4),%ymm1,%ymm8
    119c:	00 00 00 
    119f:	c4 62 75 b8 8c 99 e0 	vfmadd231ps 0xe0(%rcx,%rbx,4),%ymm1,%ymm9
    11a6:	00 00 00 
    11a9:	c4 62 75 b8 94 99 00 	vfmadd231ps 0x100(%rcx,%rbx,4),%ymm1,%ymm10
    11b0:	01 00 00 
    11b3:	c4 62 75 b8 9c 99 20 	vfmadd231ps 0x120(%rcx,%rbx,4),%ymm1,%ymm11
    11ba:	01 00 00 
    11bd:	c4 62 75 b8 a4 99 40 	vfmadd231ps 0x140(%rcx,%rbx,4),%ymm1,%ymm12
    11c4:	01 00 00 
    11c7:	c4 62 75 b8 ac 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm13
    11ce:	01 00 00 
    11d1:	c4 62 75 b8 b4 99 a0 	vfmadd231ps 0x1a0(%rcx,%rbx,4),%ymm1,%ymm14
    11d8:	01 00 00 
    11db:	c4 62 75 b8 bc 99 c0 	vfmadd231ps 0x1c0(%rcx,%rbx,4),%ymm1,%ymm15
    11e2:	01 00 00 
    11e5:	c4 e2 75 b8 84 99 e0 	vfmadd231ps 0x1e0(%rcx,%rbx,4),%ymm1,%ymm0
    11ec:	01 00 00 
    11ef:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    11f5:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    11fb:	c4 e2 75 b8 14 99    	vfmadd231ps (%rcx,%rbx,4),%ymm1,%ymm2
    1201:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    1207:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    120d:	c4 e2 75 b8 94 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm2
    1214:	01 00 00 
    1217:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    121d:	49 39 ed             	cmp    %rbp,%r13
    1220:	0f 8c ea f1 ff ff    	jl     410 <_Z5benchv+0x2d0>
    1226:	e9 b1 ef ff ff       	jmpq   1dc <_Z5benchv+0x9c>
    122b:	0f 31                	rdtsc  
    122d:	48 c1 e2 20          	shl    $0x20,%rdx
    1231:	48 09 c2             	or     %rax,%rdx
    1234:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 123a <_Z5benchv+0x10fa>
    123a:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    123f:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1247 <_Z5benchv+0x1107>
    1246:	00 
    1247:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 124f <_Z5benchv+0x110f>
    124e:	00 
    124f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1256 <_Z5benchv+0x1116>
    1256:	01 c0                	add    %eax,%eax
    1258:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    125e:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1262:	c5 fb 5c 44 24 e8    	vsubsd -0x18(%rsp),%xmm0,%xmm0
    1268:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    126c:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    1270:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1274:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1278:	48 83 c4 48          	add    $0x48,%rsp
    127c:	5b                   	pop    %rbx
    127d:	41 5c                	pop    %r12
    127f:	41 5d                	pop    %r13
    1281:	41 5e                	pop    %r14
...
0000000000001290 <_Z6enablev>:
    ...
    1297:	b8 80 00 00 00       	mov    $0x80,%eax
    129c:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
    12a1:	0f 45 c8             	cmovne %eax,%ecx
    12a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 12aa <_Z6enablev+0x1a>
    12aa:	0f 9e c1             	setle  %cl
    12ad:	83 3d 00 00 00 00 12 	cmpl   $0x12,0x0(%rip)        # 12b4 <_Z6enablev+0x24>
...
00000000000012c0 <_Z9n_reg_maxv>:
    12c0:	b8 53 01 00 00       	mov    $0x153,%eax
    12c5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui16_uk19.cpp+0x9a>
  96:	01 00 00 00 

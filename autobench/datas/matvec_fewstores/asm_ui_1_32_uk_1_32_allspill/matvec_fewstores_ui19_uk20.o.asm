...
0000000000001950 <_Z6enablev>:
    ...
    1957:	b8 98 00 00 00       	mov    $0x98,%eax
    195c:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    1961:	0f 45 c8             	cmovne %eax,%ecx
    1964:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 196a <_Z6enablev+0x1a>
    196a:	0f 9e c1             	setle  %cl
    196d:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # 1974 <_Z6enablev+0x24>
...
0000000000001980 <_Z9n_reg_maxv>:
    1980:	b8 a3 01 00 00       	mov    $0x1a3,%eax
    1985:	c3                   	retq   

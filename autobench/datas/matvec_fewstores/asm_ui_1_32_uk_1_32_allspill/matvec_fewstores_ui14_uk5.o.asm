...
0000000000000730 <_Z6enablev>:
 ...
 737:	b8 70 00 00 00       	mov    $0x70,%eax
 73c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 741:	0f 45 c8             	cmovne %eax,%ecx
 744:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 74a <_Z6enablev+0x1a>
 74a:	0f 9e c1             	setle  %cl
 74d:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 754 <_Z6enablev+0x24>
...
0000000000000760 <_Z9n_reg_maxv>:
 760:	b8 59 00 00 00       	mov    $0x59,%eax
 765:	c3                   	retq   

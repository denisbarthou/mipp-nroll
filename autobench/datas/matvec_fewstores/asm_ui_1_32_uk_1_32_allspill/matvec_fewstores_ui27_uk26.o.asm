...
matvec_fewstores_ui27_uk26.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 11 33 00 00    	jle    34a9 <_Z5benchv+0x3359>
     ...
     366:	0f 83 3d 31 00 00    	jae    34a9 <_Z5benchv+0x3359>
    ...
    329e:	48 83 c6 1a          	add    $0x1a,%rsi
    32a2:	49 0f af c2          	imul   %r10,%rax
    32a6:	48 01 f8             	add    %rdi,%rax
    32a9:	c4 e2 1d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm2
    32b0:	00 00 00 
    32b3:	c4 e2 1d b8 9c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm3
    32ba:	00 00 00 
    32bd:	c4 e2 1d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm7
    32c4:	00 00 00 
    32c7:	c4 62 1d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm8
    32ce:	01 00 00 
    32d1:	c4 e2 1d b8 a4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm4
    32d8:	01 00 00 
    32db:	c4 e2 1d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm12,%ymm5
    32e2:	01 00 00 
    32e5:	c4 62 1d b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm12,%ymm10
    32ec:	01 00 00 
    32ef:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm12,%ymm9
    32f6:	02 00 00 
    32f9:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm12,%ymm11
    3300:	03 00 00 
    3303:	c4 62 1d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm13
    3309:	c4 62 1d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm14
    3310:	c4 62 1d b8 7c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm15
    3317:	c4 e2 1d b8 44 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm0
    331e:	c4 e2 1d b8 8c 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm1
    3325:	00 00 00 
    3328:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    332e:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    3334:	c4 e2 1d b8 b4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm6
    333b:	01 00 00 
    333e:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    3344:	c5 fc 10 b4 24 e0 00 	vmovups 0xe0(%rsp),%ymm6
    334b:	00 00 
    334d:	c4 e2 1d b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm12,%ymm6
    3354:	01 00 00 
    3357:	c5 fc 11 b4 24 e0 00 	vmovups %ymm6,0xe0(%rsp)
    335e:	00 00 
    3360:	c5 fc 10 b4 24 c0 00 	vmovups 0xc0(%rsp),%ymm6
    3367:	00 00 
    3369:	c4 e2 1d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm12,%ymm6
    3370:	01 00 00 
    3373:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    337a:	00 00 
    337c:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    3382:	c4 e2 1d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm12,%ymm6
    3389:	01 00 00 
    338c:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    3392:	c5 fc 10 b4 24 00 01 	vmovups 0x100(%rsp),%ymm6
    3399:	00 00 
    339b:	c4 e2 1d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm12,%ymm6
    33a2:	02 00 00 
    33a5:	c5 fc 11 b4 24 00 01 	vmovups %ymm6,0x100(%rsp)
    33ac:	00 00 
    33ae:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    33b4:	c4 e2 1d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm12,%ymm6
    33bb:	02 00 00 
    33be:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    33c4:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    33cb:	00 00 
    33cd:	c4 e2 1d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm12,%ymm6
    33d4:	02 00 00 
    33d7:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    33de:	00 00 
    33e0:	c5 fc 10 b4 24 a0 00 	vmovups 0xa0(%rsp),%ymm6
    33e7:	00 00 
    33e9:	c4 e2 1d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm12,%ymm6
    33f0:	02 00 00 
    33f3:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    33fa:	00 00 
    33fc:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    3401:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm12,%ymm6
    3408:	02 00 00 
    340b:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    3410:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    3416:	c4 e2 1d b8 b4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm12,%ymm6
    341d:	02 00 00 
    3420:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    3426:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    342c:	c4 e2 1d b8 b4 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm12,%ymm6
    3433:	02 00 00 
    3436:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    343c:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    3442:	c4 e2 1d b8 b4 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm12,%ymm6
    3449:	03 00 00 
    344c:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    3452:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    3458:	c4 e2 1d b8 b4 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm12,%ymm6
    345f:	03 00 00 
    3462:	c4 41 7c 28 e3       	vmovaps %ymm11,%ymm12
    3467:	c4 41 7c 28 d8       	vmovaps %ymm8,%ymm11
    346c:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    3471:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    3475:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    3479:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    347f:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    3485:	c5 fc 28 f2          	vmovaps %ymm2,%ymm6
    3489:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    348d:	c5 fc 28 df          	vmovaps %ymm7,%ymm3
    3491:	c5 7c 29 d7          	vmovaps %ymm10,%ymm7
    3495:	c5 7c 10 54 24 80    	vmovups -0x80(%rsp),%ymm10
    349b:	4c 39 c6             	cmp    %r8,%rsi
    349e:	0f 8c bc d0 ff ff    	jl     560 <_Z5benchv+0x410>
    34a4:	e9 62 cd ff ff       	jmpq   20b <_Z5benchv+0xbb>
    34a9:	0f 31                	rdtsc  
    34ab:	48 c1 e2 20          	shl    $0x20,%rdx
    34af:	48 09 c2             	or     %rax,%rdx
    34b2:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 34b8 <_Z5benchv+0x3368>
    34b8:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    34bd:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 34c5 <_Z5benchv+0x3375>
    34c4:	00 
    34c5:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 34cd <_Z5benchv+0x337d>
    34cc:	00 
    34cd:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 34d4 <_Z5benchv+0x3384>
    34d4:	01 c0                	add    %eax,%eax
    34d6:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    34dc:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    34e0:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    34e7:	00 00 
    34e9:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    34ee:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    34f2:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    34f6:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    34fa:	48 81 c4 38 02 00 00 	add    $0x238,%rsp
    3501:	c5 f8 77             	vzeroupper 
    3504:	c3                   	retq   
    3505:	90                   	nop
    3506:	90                   	nop
    3507:	90                   	nop
...
0000000000003510 <_Z6enablev>:
    ...
    3517:	b8 d8 00 00 00       	mov    $0xd8,%eax
    351c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    3521:	0f 45 c8             	cmovne %eax,%ecx
    3524:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 352a <_Z6enablev+0x1a>
    352a:	0f 9e c1             	setle  %cl
    352d:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # 3534 <_Z6enablev+0x24>
...
0000000000003540 <_Z9n_reg_maxv>:
    3540:	b8 f3 02 00 00       	mov    $0x2f3,%eax
    3545:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui27_uk26.cpp+0x9a>
  96:	01 00 00 00 

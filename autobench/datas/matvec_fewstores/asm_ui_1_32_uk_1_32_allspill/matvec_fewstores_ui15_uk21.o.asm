...
matvec_fewstores_ui15_uk21.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     188:	0f 8e 29 0e 00 00    	jle    fb7 <_Z5benchv+0xe67>
     ...
     250:	0f 83 61 0d 00 00    	jae    fb7 <_Z5benchv+0xe67>
     ...
     f15:	48 83 c6 15          	add    $0x15,%rsi
     f19:	49 0f af c2          	imul   %r10,%rax
     f1d:	48 01 f8             	add    %rdi,%rax
     f20:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
     f26:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
     f2d:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
     f34:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
     f3b:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
     f42:	00 00 00 
     f45:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
     f4c:	00 00 00 
     f4f:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
     f56:	00 00 00 
     f59:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
     f60:	00 00 00 
     f63:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
     f6a:	01 00 00 
     f6d:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
     f74:	01 00 00 
     f77:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
     f7e:	01 00 00 
     f81:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
     f88:	01 00 00 
     f8b:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
     f92:	01 00 00 
     f95:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
     f9c:	01 00 00 
     f9f:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
     fa6:	01 00 00 
     fa9:	4c 39 c6             	cmp    %r8,%rsi
     fac:	0f 8c 3e f3 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
     fb2:	e9 09 f2 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
     fb7:	0f 31                	rdtsc  
     fb9:	48 c1 e2 20          	shl    $0x20,%rdx
     fbd:	48 09 c2             	or     %rax,%rdx
     fc0:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # fc6 <_Z5benchv+0xe76>
     fc6:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
     fcb:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # fd3 <_Z5benchv+0xe83>
     fd2:	00 
     fd3:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # fdb <_Z5benchv+0xe8b>
     fda:	00 
     fdb:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # fe2 <_Z5benchv+0xe92>
     fe2:	01 c0                	add    %eax,%eax
     fe4:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
     fea:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
     fee:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
     ff4:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
     ff8:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
     ffc:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1000:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1004:	c5 f8 77             	vzeroupper 
    1007:	c3                   	retq   
    1008:	90                   	nop
    1009:	90                   	nop
    100a:	90                   	nop
...
0000000000001010 <_Z6enablev>:
    ...
    102d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 1034 <_Z6enablev+0x24>
...
0000000000001040 <_Z9n_reg_maxv>:
    1040:	b8 5f 01 00 00       	mov    $0x15f,%eax
    1045:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui15_uk21.cpp+0x9a>
  96:	01 00 00 00 

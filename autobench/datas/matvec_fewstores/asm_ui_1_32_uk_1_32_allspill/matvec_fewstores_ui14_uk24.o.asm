...
00000000000010e0 <_Z6enablev>:
    ...
    10e7:	b8 70 00 00 00       	mov    $0x70,%eax
    10ec:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
    10f1:	0f 45 c8             	cmovne %eax,%ecx
    10f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 10fa <_Z6enablev+0x1a>
    10fa:	0f 9e c1             	setle  %cl
    10fd:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 1104 <_Z6enablev+0x24>
...
0000000000001110 <_Z9n_reg_maxv>:
    1110:	b8 76 01 00 00       	mov    $0x176,%eax
    1115:	c3                   	retq   

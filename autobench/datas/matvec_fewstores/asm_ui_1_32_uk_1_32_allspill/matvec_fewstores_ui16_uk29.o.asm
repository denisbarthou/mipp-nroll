...
0000000000000150 <_Z5benchv>:
     ...
     194:	0f 8e f3 17 00 00    	jle    198d <_Z5benchv+0x183d>
     ...
     295:	0f 83 f2 16 00 00    	jae    198d <_Z5benchv+0x183d>
    ...
    18c3:	49 83 c5 1d          	add    $0x1d,%r13
    18c7:	48 0f af d8          	imul   %rax,%rbx
    18cb:	48 01 fb             	add    %rdi,%rbx
    18ce:	c4 e2 75 b8 5c 99 20 	vfmadd231ps 0x20(%rcx,%rbx,4),%ymm1,%ymm3
    18d5:	c4 e2 75 b8 64 99 40 	vfmadd231ps 0x40(%rcx,%rbx,4),%ymm1,%ymm4
    18dc:	c4 e2 75 b8 6c 99 60 	vfmadd231ps 0x60(%rcx,%rbx,4),%ymm1,%ymm5
    18e3:	c4 e2 75 b8 b4 99 80 	vfmadd231ps 0x80(%rcx,%rbx,4),%ymm1,%ymm6
    18ea:	00 00 00 
    18ed:	c4 e2 75 b8 bc 99 a0 	vfmadd231ps 0xa0(%rcx,%rbx,4),%ymm1,%ymm7
    18f4:	00 00 00 
    18f7:	c4 62 75 b8 84 99 c0 	vfmadd231ps 0xc0(%rcx,%rbx,4),%ymm1,%ymm8
    18fe:	00 00 00 
    1901:	c4 62 75 b8 8c 99 e0 	vfmadd231ps 0xe0(%rcx,%rbx,4),%ymm1,%ymm9
    1908:	00 00 00 
    190b:	c4 62 75 b8 94 99 00 	vfmadd231ps 0x100(%rcx,%rbx,4),%ymm1,%ymm10
    1912:	01 00 00 
    1915:	c4 62 75 b8 9c 99 20 	vfmadd231ps 0x120(%rcx,%rbx,4),%ymm1,%ymm11
    191c:	01 00 00 
    191f:	c4 62 75 b8 a4 99 40 	vfmadd231ps 0x140(%rcx,%rbx,4),%ymm1,%ymm12
    1926:	01 00 00 
    1929:	c4 62 75 b8 ac 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm13
    1930:	01 00 00 
    1933:	c4 62 75 b8 b4 99 a0 	vfmadd231ps 0x1a0(%rcx,%rbx,4),%ymm1,%ymm14
    193a:	01 00 00 
    193d:	c4 62 75 b8 bc 99 c0 	vfmadd231ps 0x1c0(%rcx,%rbx,4),%ymm1,%ymm15
    1944:	01 00 00 
    1947:	c4 e2 75 b8 84 99 e0 	vfmadd231ps 0x1e0(%rcx,%rbx,4),%ymm1,%ymm0
    194e:	01 00 00 
    1951:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    1957:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    195d:	c4 e2 75 b8 14 99    	vfmadd231ps (%rcx,%rbx,4),%ymm1,%ymm2
    1963:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    1969:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    196f:	c4 e2 75 b8 94 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm2
    1976:	01 00 00 
    1979:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    197f:	49 39 ed             	cmp    %rbp,%r13
    1982:	0f 8c 88 ea ff ff    	jl     410 <_Z5benchv+0x2c0>
    1988:	e9 5a e8 ff ff       	jmpq   1e7 <_Z5benchv+0x97>
    198d:	0f 31                	rdtsc  
    ...
    19c4:	c5 fb 5c 44 24 e8    	vsubsd -0x18(%rsp),%xmm0,%xmm0
    19ca:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    19ce:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    19d2:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    19d6:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    19da:	48 83 c4 48          	add    $0x48,%rsp
    19de:	5b                   	pop    %rbx
    19df:	41 5c                	pop    %r12
    19e1:	41 5d                	pop    %r13
    19e3:	41 5e                	pop    %r14
...
00000000000019f0 <_Z6enablev>:
    ...
    19f7:	b8 80 00 00 00       	mov    $0x80,%eax
    19fc:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
    1a01:	0f 45 c8             	cmovne %eax,%ecx
    1a04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1a0a <_Z6enablev+0x1a>
    1a0a:	0f 9e c1             	setle  %cl
    1a0d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 1a14 <_Z6enablev+0x24>
...
0000000000001a20 <_Z9n_reg_maxv>:
    1a20:	b8 fd 01 00 00       	mov    $0x1fd,%eax
    1a25:	c3                   	retq   

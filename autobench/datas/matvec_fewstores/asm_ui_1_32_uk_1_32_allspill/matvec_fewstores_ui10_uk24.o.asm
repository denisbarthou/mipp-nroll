...
0000000000000cd0 <_Z6enablev>:
 ...
 cd7:	b8 50 00 00 00       	mov    $0x50,%eax
 cdc:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 ce1:	0f 45 c8             	cmovne %eax,%ecx
 ce4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # cea <_Z6enablev+0x1a>
 cea:	0f 9e c1             	setle  %cl
 ced:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # cf4 <_Z6enablev+0x24>
...
0000000000000d00 <_Z9n_reg_maxv>:
 d00:	b8 12 01 00 00       	mov    $0x112,%eax
 d05:	c3                   	retq   

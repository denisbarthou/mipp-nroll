...
00000000000017e0 <_Z6enablev>:
    ...
    17e7:	b8 80 00 00 00       	mov    $0x80,%eax
    17ec:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
    17f1:	0f 45 c8             	cmovne %eax,%ecx
    17f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 17fa <_Z6enablev+0x1a>
    17fa:	0f 9e c1             	setle  %cl
    17fd:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 1804 <_Z6enablev+0x24>
...
0000000000001810 <_Z9n_reg_maxv>:
    1810:	b8 a8 01 00 00       	mov    $0x1a8,%eax
    1815:	c3                   	retq   

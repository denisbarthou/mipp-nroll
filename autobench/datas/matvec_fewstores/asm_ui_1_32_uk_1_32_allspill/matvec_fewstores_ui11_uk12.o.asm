...
0000000000000b90 <_Z6enablev>:
 ...
 b97:	b8 58 00 00 00       	mov    $0x58,%eax
 b9c:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 ba1:	0f 45 c8             	cmovne %eax,%ecx
 ba4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # baa <_Z6enablev+0x1a>
 baa:	0f 9e c1             	setle  %cl
 bad:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # bb4 <_Z6enablev+0x24>
...
0000000000000bc0 <_Z9n_reg_maxv>:
 bc0:	b8 9b 00 00 00       	mov    $0x9b,%eax
 bc5:	c3                   	retq   

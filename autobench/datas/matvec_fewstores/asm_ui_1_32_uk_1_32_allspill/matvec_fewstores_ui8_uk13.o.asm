...
00000000000009c0 <_Z6enablev>:
 9c0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 9c7 <_Z6enablev+0x7>
 9c7:	b8 40 00 00 00       	mov    $0x40,%eax
 9cc:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 9d1:	0f 45 c8             	cmovne %eax,%ecx
 9d4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 9da <_Z6enablev+0x1a>
 9da:	0f 9e c1             	setle  %cl
 9dd:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 9e4 <_Z6enablev+0x24>
 9e4:	0f 9f c0             	setg   %al
 9e7:	20 c8                	and    %cl,%al
 9e9:	c3                   	retq   
 9ea:	90                   	nop
 9eb:	90                   	nop
...
00000000000009f0 <_Z9n_reg_maxv>:
 9f0:	b8 7d 00 00 00       	mov    $0x7d,%eax
 9f5:	c3                   	retq   

...
0000000000001d80 <_Z6enablev>:
    ...
    1d87:	b8 e8 00 00 00       	mov    $0xe8,%eax
    1d8c:	b9 e3 ff ff ff       	mov    $0xffffffe3,%ecx
    1d91:	0f 45 c8             	cmovne %eax,%ecx
    1d94:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1d9a <_Z6enablev+0x1a>
    1d9a:	0f 9e c1             	setle  %cl
    1d9d:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 1da4 <_Z6enablev+0x24>
...
0000000000001db0 <_Z9n_reg_maxv>:
    1db0:	b8 67 01 00 00       	mov    $0x167,%eax
    1db5:	c3                   	retq   

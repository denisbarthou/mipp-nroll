...
0000000000000810 <_Z6enablev>:
 ...
 817:	b8 50 00 00 00       	mov    $0x50,%eax
 81c:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 821:	0f 45 c8             	cmovne %eax,%ecx
 824:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 82a <_Z6enablev+0x1a>
 82a:	0f 9e c1             	setle  %cl
 82d:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # 834 <_Z6enablev+0x24>
...
0000000000000840 <_Z9n_reg_maxv>:
 840:	b8 6d 00 00 00       	mov    $0x6d,%eax
 845:	c3                   	retq   

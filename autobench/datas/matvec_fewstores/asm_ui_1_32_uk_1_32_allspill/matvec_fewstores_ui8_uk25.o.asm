...
0000000000000b10 <_Z6enablev>:
 ...
 b17:	b8 40 00 00 00       	mov    $0x40,%eax
 b1c:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 b21:	0f 45 c8             	cmovne %eax,%ecx
 b24:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b2a <_Z6enablev+0x1a>
 b2a:	0f 9e c1             	setle  %cl
 b2d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # b34 <_Z6enablev+0x24>
...
0000000000000b40 <_Z9n_reg_maxv>:
 b40:	b8 e9 00 00 00       	mov    $0xe9,%eax
 b45:	c3                   	retq   

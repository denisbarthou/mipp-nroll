...
0000000000000860 <_Z6enablev>:
 ...
 867:	b8 30 00 00 00       	mov    $0x30,%eax
 86c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 871:	0f 45 c8             	cmovne %eax,%ecx
 874:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 87a <_Z6enablev+0x1a>
 87a:	0f 9e c1             	setle  %cl
 87d:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # 884 <_Z6enablev+0x24>
...
0000000000000890 <_Z9n_reg_maxv>:
 890:	b8 6f 00 00 00       	mov    $0x6f,%eax
 895:	c3                   	retq   

...
0000000000000160 <_Z5benchv>:
     ...
     198:	0f 8e 6e 17 00 00    	jle    190c <_Z5benchv+0x17ac>
     ...
     29a:	0f 83 6c 16 00 00    	jae    190c <_Z5benchv+0x17ac>
    ...
    1820:	48 83 c6 1a          	add    $0x1a,%rsi
    1824:	49 0f af c2          	imul   %r10,%rax
    1828:	48 01 f8             	add    %rdi,%rax
    182b:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1831:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1838:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    183f:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1846:	00 00 00 
    1849:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1850:	00 00 00 
    1853:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    185a:	00 00 00 
    185d:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1864:	01 00 00 
    1867:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    186e:	01 00 00 
    1871:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    1878:	01 00 00 
    187b:	c4 62 6d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm14
    1882:	01 00 00 
    1885:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    188c:	01 00 00 
    188f:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    1896:	01 00 00 
    1899:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    18a0:	01 00 00 
    18a3:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    18aa:	02 00 00 
    18ad:	c5 fc 11 74 24 88    	vmovups %ymm6,-0x78(%rsp)
    18b3:	c5 fc 10 74 24 c8    	vmovups -0x38(%rsp),%ymm6
    18b9:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    18c0:	c5 fc 11 74 24 c8    	vmovups %ymm6,-0x38(%rsp)
    18c6:	c5 fc 10 74 24 a8    	vmovups -0x58(%rsp),%ymm6
    18cc:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    18d3:	00 00 00 
    18d6:	c5 fc 11 74 24 a8    	vmovups %ymm6,-0x58(%rsp)
    18dc:	c5 fc 10 74 24 88    	vmovups -0x78(%rsp),%ymm6
    18e2:	c4 e2 6d b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm6
    18e9:	01 00 00 
    18ec:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    18f0:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    18f4:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    18f8:	c5 fc 11 74 24 88    	vmovups %ymm6,-0x78(%rsp)
    18fe:	4c 39 c6             	cmp    %r8,%rsi
    1901:	0f 8c 69 ea ff ff    	jl     370 <_Z5benchv+0x210>
    1907:	e9 d5 e8 ff ff       	jmpq   1e1 <_Z5benchv+0x81>
    190c:	0f 31                	rdtsc  
    ...
    1943:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1949:	c5 c0 57 ff          	vxorps %xmm7,%xmm7,%xmm7
    194d:	c5 c2 2a c8          	vcvtsi2ss %eax,%xmm7,%xmm1
    1951:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1955:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1959:	c5 f8 77             	vzeroupper 
    195c:	c3                   	retq   
    195d:	90                   	nop
    195e:	90                   	nop
    195f:	90                   	nop
...
0000000000001960 <_Z6enablev>:
    ...
    1967:	b8 88 00 00 00       	mov    $0x88,%eax
    196c:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1971:	0f 45 c8             	cmovne %eax,%ecx
    1974:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 197a <_Z6enablev+0x1a>
    197a:	0f 9e c1             	setle  %cl
    197d:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # 1984 <_Z6enablev+0x24>
...
0000000000001990 <_Z9n_reg_maxv>:
    1990:	b8 e5 01 00 00       	mov    $0x1e5,%eax
    1995:	c3                   	retq   

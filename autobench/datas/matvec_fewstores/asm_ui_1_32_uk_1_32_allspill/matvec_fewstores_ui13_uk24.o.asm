...
0000000000000fe0 <_Z6enablev>:
     fe0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # fe7 <_Z6enablev+0x7>
     fe7:	b8 68 00 00 00       	mov    $0x68,%eax
     fec:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
     ff1:	0f 45 c8             	cmovne %eax,%ecx
     ff4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # ffa <_Z6enablev+0x1a>
     ffa:	0f 9e c1             	setle  %cl
     ffd:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 1004 <_Z6enablev+0x24>
    1004:	0f 9f c0             	setg   %al
    1007:	20 c8                	and    %cl,%al
    1009:	c3                   	retq   
    100a:	90                   	nop
    100b:	90                   	nop
    100c:	90                   	nop
...
0000000000001010 <_Z9n_reg_maxv>:
    1010:	b8 5d 01 00 00       	mov    $0x15d,%eax
    1015:	c3                   	retq   

...
matvec_fewstores_ui6_uk31.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
 ...
 191:	0f 8e 98 08 00 00    	jle    a2f <_Z5benchv+0x8cf>
 ...
 1f5:	0f 83 34 08 00 00    	jae    a2f <_Z5benchv+0x8cf>
 ...
 965:	48 0f af c3          	imul   %rbx,%rax
 969:	48 01 f0             	add    %rsi,%rax
 96c:	c4 e2 45 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm1
 972:	c4 e2 45 b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm6
 979:	c4 e2 45 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm2
 980:	c4 e2 45 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm3
 987:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm4
 98e:	00 00 00 
 991:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm5
 998:	00 00 00 
 99b:	48 8d 47 1d          	lea    0x1d(%rdi),%rax
 99f:	c4 e2 7d 18 7c ba 74 	vbroadcastss 0x74(%rdx,%rdi,4),%ymm7
 9a6:	48 0f af c3          	imul   %rbx,%rax
 9aa:	48 01 f0             	add    %rsi,%rax
 9ad:	c4 e2 45 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm1
 9b3:	c4 e2 45 b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm6
 9ba:	c4 e2 45 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm2
 9c1:	c4 e2 45 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm3
 9c8:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm4
 9cf:	00 00 00 
 9d2:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm5
 9d9:	00 00 00 
 9dc:	48 8d 47 1e          	lea    0x1e(%rdi),%rax
 9e0:	c4 e2 7d 18 7c ba 78 	vbroadcastss 0x78(%rdx,%rdi,4),%ymm7
 9e7:	48 83 c7 1f          	add    $0x1f,%rdi
 9eb:	48 0f af c3          	imul   %rbx,%rax
 9ef:	48 01 f0             	add    %rsi,%rax
 9f2:	c4 e2 45 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm1
 9f8:	c4 e2 45 b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm6
 9ff:	c4 e2 45 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm2
 a06:	c4 e2 45 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm3
 a0d:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm4
 a14:	00 00 00 
 a17:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm5
 a1e:	00 00 00 
 a21:	4c 39 d7             	cmp    %r10,%rdi
 a24:	0f 8c 16 f8 ff ff    	jl     240 <_Z5benchv+0xe0>
 a2a:	e9 91 f7 ff ff       	jmpq   1c0 <_Z5benchv+0x60>
 a2f:	0f 31                	rdtsc  
 a31:	48 c1 e2 20          	shl    $0x20,%rdx
 a35:	48 09 c2             	or     %rax,%rdx
 a38:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # a3e <_Z5benchv+0x8de>
 a3e:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 a43:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # a4b <_Z5benchv+0x8eb>
 a4a:	00 
 a4b:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # a53 <_Z5benchv+0x8f3>
 a52:	00 
 a53:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # a5a <_Z5benchv+0x8fa>
 a5a:	01 c0                	add    %eax,%eax
 a5c:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 a62:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 a66:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 a6a:	c5 ba 2a c8          	vcvtsi2ss %eax,%xmm8,%xmm1
 a6e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 a72:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 a76:	5b                   	pop    %rbx
...
0000000000000a80 <_Z6enablev>:
 ...
 a87:	b8 30 00 00 00       	mov    $0x30,%eax
 a8c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 a91:	0f 45 c8             	cmovne %eax,%ecx
 a94:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a9a <_Z6enablev+0x1a>
 a9a:	0f 9e c1             	setle  %cl
 a9d:	83 3d 00 00 00 00 1e 	cmpl   $0x1e,0x0(%rip)        # aa4 <_Z6enablev+0x24>
...
0000000000000ab0 <_Z9n_reg_maxv>:
 ab0:	b8 df 00 00 00       	mov    $0xdf,%eax
 ab5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui6_uk31.cpp+0x9a>
  96:	01 00 00 00 

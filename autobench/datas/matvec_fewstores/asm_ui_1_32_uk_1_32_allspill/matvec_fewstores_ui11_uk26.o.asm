...
0000000000000ea0 <_Z6enablev>:
 ea0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # ea7 <_Z6enablev+0x7>
 ea7:	b8 58 00 00 00       	mov    $0x58,%eax
 eac:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 eb1:	0f 45 c8             	cmovne %eax,%ecx
 eb4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # eba <_Z6enablev+0x1a>
 eba:	0f 9e c1             	setle  %cl
 ebd:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # ec4 <_Z6enablev+0x24>
 ec4:	0f 9f c0             	setg   %al
 ec7:	20 c8                	and    %cl,%al
 ec9:	c3                   	retq   
 eca:	90                   	nop
 ecb:	90                   	nop
...
0000000000000ed0 <_Z9n_reg_maxv>:
 ed0:	b8 43 01 00 00       	mov    $0x143,%eax
 ed5:	c3                   	retq   

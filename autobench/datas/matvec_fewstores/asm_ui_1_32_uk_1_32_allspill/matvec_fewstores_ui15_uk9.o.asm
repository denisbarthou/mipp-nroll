...
0000000000000ba0 <_Z6enablev>:
 ...
 ba7:	b8 78 00 00 00       	mov    $0x78,%eax
 bac:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 bb1:	0f 45 c8             	cmovne %eax,%ecx
 bb4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # bba <_Z6enablev+0x1a>
 bba:	0f 9e c1             	setle  %cl
 bbd:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # bc4 <_Z6enablev+0x24>
...
0000000000000bd0 <_Z9n_reg_maxv>:
 bd0:	b8 9f 00 00 00       	mov    $0x9f,%eax
 bd5:	c3                   	retq   

...
0000000000001050 <_Z6enablev>:
    ...
    1057:	b8 30 00 00 00       	mov    $0x30,%eax
    105c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
    1061:	0f 45 c8             	cmovne %eax,%ecx
    1064:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 106a <_Z6enablev+0x1a>
    106a:	0f 9e c1             	setle  %cl
    106d:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 1074 <_Z6enablev+0x24>
...
0000000000001080 <_Z9n_reg_maxv>:
    1080:	b8 ae 00 00 00       	mov    $0xae,%eax
    1085:	c3                   	retq   

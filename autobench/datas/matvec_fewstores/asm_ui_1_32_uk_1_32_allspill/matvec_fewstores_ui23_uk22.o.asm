...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e 7d 21 00 00    	jle    2325 <_Z5benchv+0x21c5>
     ...
     31c:	0f 83 03 20 00 00    	jae    2325 <_Z5benchv+0x21c5>
    ...
    2186:	48 83 c6 16          	add    $0x16,%rsi
    218a:	49 0f af c2          	imul   %r10,%rax
    218e:	48 01 f8             	add    %rdi,%rax
    2191:	c4 e2 3d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm5
    2198:	01 00 00 
    219b:	c4 62 3d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm14
    21a2:	00 00 00 
    21a5:	c4 e2 3d b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm2
    21ac:	00 00 00 
    21af:	c4 62 3d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm15
    21b6:	01 00 00 
    21b9:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm6
    21c0:	01 00 00 
    21c3:	c4 e2 3d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm4
    21ca:	01 00 00 
    21cd:	c4 e2 3d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm1
    21d4:	02 00 00 
    21d7:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    21dd:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    21e4:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    21eb:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    21f2:	c4 62 3d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm13
    21f9:	00 00 00 
    21fc:	c4 e2 3d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm7
    2203:	00 00 00 
    2206:	c4 e2 3d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm3
    220d:	01 00 00 
    2210:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2216:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    221c:	c4 e2 3d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm0
    2223:	01 00 00 
    2226:	c5 fc 11 ac 24 c0 00 	vmovups %ymm5,0xc0(%rsp)
    222d:	00 00 
    222f:	c5 7c 29 f5          	vmovaps %ymm14,%ymm5
    2233:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    2238:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    223c:	c5 fc 11 b4 24 00 01 	vmovups %ymm6,0x100(%rsp)
    2243:	00 00 
    2245:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    224c:	00 00 
    224e:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    2255:	00 00 
    2257:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    225d:	c5 fc 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm0
    2264:	00 00 
    2266:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm0
    226d:	01 00 00 
    2270:	c5 fc 11 84 24 80 00 	vmovups %ymm0,0x80(%rsp)
    2277:	00 00 
    2279:	c5 fc 10 44 24 60    	vmovups 0x60(%rsp),%ymm0
    227f:	c4 e2 3d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm0
    2286:	01 00 00 
    2289:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    228f:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    2295:	c4 e2 3d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm0
    229c:	02 00 00 
    229f:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    22a5:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    22ab:	c4 e2 3d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm0
    22b2:	02 00 00 
    22b5:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    22bb:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    22c1:	c4 e2 3d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm0
    22c8:	02 00 00 
    22cb:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    22d1:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    22d6:	c4 e2 3d b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm0
    22dd:	02 00 00 
    22e0:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    22e5:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    22eb:	c4 e2 3d b8 84 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm0
    22f2:	02 00 00 
    22f5:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    22fb:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    2301:	c4 e2 3d b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm0
    2308:	02 00 00 
    230b:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2311:	c5 fd 10 44 24 80    	vmovupd -0x80(%rsp),%ymm0
    2317:	4c 39 c6             	cmp    %r8,%rsi
    231a:	0f 8c 60 e1 ff ff    	jl     480 <_Z5benchv+0x320>
    2320:	e9 be de ff ff       	jmpq   1e3 <_Z5benchv+0x83>
    2325:	0f 31                	rdtsc  
    2327:	48 c1 e2 20          	shl    $0x20,%rdx
    232b:	48 09 c2             	or     %rax,%rdx
    232e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2334 <_Z5benchv+0x21d4>
    2334:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2339:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2341 <_Z5benchv+0x21e1>
    2340:	00 
    2341:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2349 <_Z5benchv+0x21e9>
    2348:	00 
    2349:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2350 <_Z5benchv+0x21f0>
    2350:	01 c0                	add    %eax,%eax
    2352:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2358:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    235c:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    2363:	00 00 
    2365:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    2369:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    236d:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2371:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2375:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    237c:	c5 f8 77             	vzeroupper 
    237f:	c3                   	retq   

0000000000002380 <_Z6enablev>:
    2380:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2387 <_Z6enablev+0x7>
    2387:	b8 b8 00 00 00       	mov    $0xb8,%eax
    238c:	b9 e9 ff ff ff       	mov    $0xffffffe9,%ecx
    2391:	0f 45 c8             	cmovne %eax,%ecx
    2394:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 239a <_Z6enablev+0x1a>
    239a:	0f 9e c1             	setle  %cl
    239d:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 23a4 <_Z6enablev+0x24>
...
00000000000023b0 <_Z9n_reg_maxv>:
    23b0:	b8 27 02 00 00       	mov    $0x227,%eax
    23b5:	c3                   	retq   

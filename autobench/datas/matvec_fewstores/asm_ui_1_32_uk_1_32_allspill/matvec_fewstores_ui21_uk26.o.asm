...
matvec_fewstores_ui21_uk26.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 72 21 00 00    	jle    230a <_Z5benchv+0x21ba>
     ...
     2cf:	0f 83 35 20 00 00    	jae    230a <_Z5benchv+0x21ba>
    ...
    218f:	48 83 c6 1a          	add    $0x1a,%rsi
    2193:	49 0f af c2          	imul   %r10,%rax
    2197:	48 01 f8             	add    %rdi,%rax
    219a:	c4 e2 4d b8 94 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm2
    21a1:	01 00 00 
    21a4:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    21ab:	01 00 00 
    21ae:	c4 e2 4d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm5
    21b5:	01 00 00 
    21b8:	c4 e2 4d b8 3c 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm7
    21be:	c4 62 4d b8 44 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm8
    21c5:	c4 62 4d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm9
    21cc:	c4 62 4d b8 54 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm10
    21d3:	c4 62 4d b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm12
    21da:	00 00 00 
    21dd:	c4 62 4d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm14
    21e4:	00 00 00 
    21e7:	c4 62 4d b8 9c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm11
    21ee:	00 00 00 
    21f1:	c4 62 4d b8 ac 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm13
    21f8:	01 00 00 
    21fb:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm0
    2202:	01 00 00 
    2205:	c4 e2 4d b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm1
    220c:	02 00 00 
    220f:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    2215:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    221b:	c4 e2 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm4
    2222:	00 00 00 
    2225:	c5 fc 11 94 24 e0 00 	vmovups %ymm2,0xe0(%rsp)
    222c:	00 00 
    222e:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    2233:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    223a:	00 00 
    223c:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    2242:	c4 e2 4d b8 94 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm2
    2249:	01 00 00 
    224c:	c4 e2 4d b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm3
    2253:	01 00 00 
    2256:	c5 fc 11 ac 24 c0 00 	vmovups %ymm5,0xc0(%rsp)
    225d:	00 00 
    225f:	c5 fc 10 6c 24 40    	vmovups 0x40(%rsp),%ymm5
    2265:	c4 e2 4d b8 ac 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm5
    226c:	02 00 00 
    226f:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    2275:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    227b:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    2280:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    2286:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    228c:	c5 fc 10 5c 24 80    	vmovups -0x80(%rsp),%ymm3
    2292:	c4 e2 4d b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm2
    2299:	01 00 00 
    229c:	c4 e2 4d b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm3
    22a3:	02 00 00 
    22a6:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    22ac:	c5 7c 29 fa          	vmovaps %ymm15,%ymm2
    22b0:	c5 fc 11 5c 24 80    	vmovups %ymm3,-0x80(%rsp)
    22b6:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    22bc:	c4 e2 4d b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm2
    22c3:	02 00 00 
    22c6:	c4 e2 4d b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm3
    22cd:	02 00 00 
    22d0:	c5 fc 28 f7          	vmovaps %ymm7,%ymm6
    22d4:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    22d8:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    22dd:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    22e2:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    22e7:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    22ec:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    22f1:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    22f6:	c5 7c 10 74 24 e0    	vmovups -0x20(%rsp),%ymm14
    22fc:	4c 39 c6             	cmp    %r8,%rsi
    22ff:	0f 8c eb e0 ff ff    	jl     3f0 <_Z5benchv+0x2a0>
    2305:	e9 be de ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    230a:	0f 31                	rdtsc  
    230c:	48 c1 e2 20          	shl    $0x20,%rdx
    2310:	48 09 c2             	or     %rax,%rdx
    2313:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2319 <_Z5benchv+0x21c9>
    2319:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    231e:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2326 <_Z5benchv+0x21d6>
    2325:	00 
    2326:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 232e <_Z5benchv+0x21de>
    232d:	00 
    232e:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2335 <_Z5benchv+0x21e5>
    2335:	01 c0                	add    %eax,%eax
    2337:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    233d:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2341:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    2348:	00 00 
    234a:	c5 d0 57 ed          	vxorps %xmm5,%xmm5,%xmm5
    234e:	c5 d2 2a c8          	vcvtsi2ss %eax,%xmm5,%xmm1
    2352:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2356:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    235a:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
    2361:	c5 f8 77             	vzeroupper 
    2364:	c3                   	retq   
    2365:	90                   	nop
    2366:	90                   	nop
    2367:	90                   	nop
...
0000000000002370 <_Z6enablev>:
    2370:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2377 <_Z6enablev+0x7>
    2377:	b8 a8 00 00 00       	mov    $0xa8,%eax
    237c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    2381:	0f 45 c8             	cmovne %eax,%ecx
    2384:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 238a <_Z6enablev+0x1a>
    238a:	0f 9e c1             	setle  %cl
    238d:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # 2394 <_Z6enablev+0x24>
    2394:	0f 9f c0             	setg   %al
    2397:	20 c8                	and    %cl,%al
    2399:	c3                   	retq   
    239a:	90                   	nop
    239b:	90                   	nop
    239c:	90                   	nop
...
00000000000023a0 <_Z9n_reg_maxv>:
    23a0:	b8 51 02 00 00       	mov    $0x251,%eax
    23a5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui21_uk26.cpp+0x9a>
  96:	01 00 00 00 

...
matvec_fewstores_ui14_uk22.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e d0 0d 00 00    	jle    f58 <_Z5benchv+0xe08>
 ...
 235:	0f 83 1d 0d 00 00    	jae    f58 <_Z5benchv+0xe08>
 ...
 f47:	01 00 00 
 f4a:	4c 39 c6             	cmp    %r8,%rsi
 f4d:	0f 8c 7d f3 ff ff    	jl     2d0 <_Z5benchv+0x180>
 f53:	e9 58 f2 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 f58:	0f 31                	rdtsc  
 f5a:	48 c1 e2 20          	shl    $0x20,%rdx
 f5e:	48 09 c2             	or     %rax,%rdx
 f61:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # f67 <_Z5benchv+0xe17>
 f67:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 f6c:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # f74 <_Z5benchv+0xe24>
 f73:	00 
 f74:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # f7c <_Z5benchv+0xe2c>
 f7b:	00 
 f7c:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # f83 <_Z5benchv+0xe33>
 f83:	01 c0                	add    %eax,%eax
 f85:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 f8b:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 f8f:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 f93:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
 f98:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 f9c:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 fa0:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 fa4:	c5 f8 77             	vzeroupper 
 fa7:	c3                   	retq   
 fa8:	90                   	nop
 fa9:	90                   	nop
 faa:	90                   	nop
...
0000000000000fb0 <_Z6enablev>:
 ...
 fb7:	b8 70 00 00 00       	mov    $0x70,%eax
 fbc:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 fc1:	0f 45 c8             	cmovne %eax,%ecx
 fc4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # fca <_Z6enablev+0x1a>
 fca:	0f 9e c1             	setle  %cl
 fcd:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # fd4 <_Z6enablev+0x24>
...
0000000000000fe0 <_Z9n_reg_maxv>:
 fe0:	b8 58 01 00 00       	mov    $0x158,%eax
 fe5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui14_uk22.cpp+0x9a>
  96:	01 00 00 00 

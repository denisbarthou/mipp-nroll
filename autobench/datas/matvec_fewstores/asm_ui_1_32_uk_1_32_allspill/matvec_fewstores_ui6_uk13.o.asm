...
0000000000000710 <_Z6enablev>:
 ...
 717:	b8 30 00 00 00       	mov    $0x30,%eax
 71c:	b9 fa ff ff ff       	mov    $0xfffffffa,%ecx
 721:	0f 45 c8             	cmovne %eax,%ecx
 724:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 72a <_Z6enablev+0x1a>
 72a:	0f 9e c1             	setle  %cl
 72d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 734 <_Z6enablev+0x24>
...
0000000000000740 <_Z9n_reg_maxv>:
 740:	b8 61 00 00 00       	mov    $0x61,%eax
 745:	c3                   	retq   

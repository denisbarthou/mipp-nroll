...
0000000000001e50 <_Z6enablev>:
    ...
    1e57:	b8 98 00 00 00       	mov    $0x98,%eax
    1e5c:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    1e61:	0f 45 c8             	cmovne %eax,%ecx
    1e64:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1e6a <_Z6enablev+0x1a>
    1e6a:	0f 9e c1             	setle  %cl
    1e6d:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 1e74 <_Z6enablev+0x24>
...
0000000000001e80 <_Z9n_reg_maxv>:
    1e80:	b8 f3 01 00 00       	mov    $0x1f3,%eax
    1e85:	c3                   	retq   

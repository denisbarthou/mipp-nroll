...
00000000000007c0 <_Z6enablev>:
 ...
 7c7:	b8 80 00 00 00       	mov    $0x80,%eax
 7cc:	b9 f0 ff ff ff       	mov    $0xfffffff0,%ecx
 7d1:	0f 45 c8             	cmovne %eax,%ecx
 7d4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 7da <_Z6enablev+0x1a>
 7da:	0f 9e c1             	setle  %cl
 7dd:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 7e4 <_Z6enablev+0x24>
...
00000000000007f0 <_Z9n_reg_maxv>:
 7f0:	b8 54 00 00 00       	mov    $0x54,%eax
 7f5:	c3                   	retq   

...
0000000000001cc0 <_Z6enablev>:
    1cc0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1cc7 <_Z6enablev+0x7>
    1cc7:	b8 a0 00 00 00       	mov    $0xa0,%eax
    1ccc:	b9 ec ff ff ff       	mov    $0xffffffec,%ecx
    1cd1:	0f 45 c8             	cmovne %eax,%ecx
    1cd4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1cda <_Z6enablev+0x1a>
    1cda:	0f 9e c1             	setle  %cl
    1cdd:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 1ce4 <_Z6enablev+0x24>
    1ce4:	0f 9f c0             	setg   %al
    1ce7:	20 c8                	and    %cl,%al
    1ce9:	c3                   	retq   
    1cea:	90                   	nop
    1ceb:	90                   	nop
    1cec:	90                   	nop
...
0000000000001cf0 <_Z9n_reg_maxv>:
    1cf0:	b8 e2 01 00 00       	mov    $0x1e2,%eax
    1cf5:	c3                   	retq   

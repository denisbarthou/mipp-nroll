...
0000000000000740 <_Z6enablev>:
 ...
 747:	b8 60 00 00 00       	mov    $0x60,%eax
 74c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 751:	0f 45 c8             	cmovne %eax,%ecx
 754:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 75a <_Z6enablev+0x1a>
 75a:	0f 9e c1             	setle  %cl
 75d:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 764 <_Z6enablev+0x24>
...
0000000000000770 <_Z9n_reg_maxv>:
 770:	b8 5a 00 00 00       	mov    $0x5a,%eax
 775:	c3                   	retq   

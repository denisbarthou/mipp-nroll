...
00000000000008f0 <_Z6enablev>:
 ...
 8f7:	b8 98 00 00 00       	mov    $0x98,%eax
 8fc:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
 901:	0f 45 c8             	cmovne %eax,%ecx
 904:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 90a <_Z6enablev+0x1a>
 90a:	0f 9e c1             	setle  %cl
 90d:	83 3d 00 00 00 00 03 	cmpl   $0x3,0x0(%rip)        # 914 <_Z6enablev+0x24>
...
0000000000000920 <_Z9n_reg_maxv>:
 920:	b8 63 00 00 00       	mov    $0x63,%eax
 925:	c3                   	retq   

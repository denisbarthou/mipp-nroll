...
0000000000001100 <_Z6enablev>:
    ...
    1107:	b8 b0 00 00 00       	mov    $0xb0,%eax
    110c:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    1111:	0f 45 c8             	cmovne %eax,%ecx
    1114:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 111a <_Z6enablev+0x1a>
    111a:	0f 9e c1             	setle  %cl
    111d:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 1124 <_Z6enablev+0x24>
...
0000000000001130 <_Z9n_reg_maxv>:
    1130:	b8 ce 00 00 00       	mov    $0xce,%eax
    1135:	c3                   	retq   

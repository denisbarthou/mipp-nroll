...
0000000000000c00 <_Z6enablev>:
 ...
 c07:	b8 20 00 00 00       	mov    $0x20,%eax
 c0c:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 c11:	0f 45 c8             	cmovne %eax,%ecx
 c14:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # c1a <_Z6enablev+0x1a>
 c1a:	0f 9e c1             	setle  %cl
 c1d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # c24 <_Z6enablev+0x24>
...
0000000000000c30 <_Z9n_reg_maxv>:
 c30:	b8 8b 00 00 00       	mov    $0x8b,%eax
 c35:	c3                   	retq   

...
0000000000000a50 <_Z6enablev>:
 a50:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # a57 <_Z6enablev+0x7>
 a57:	b8 d8 00 00 00       	mov    $0xd8,%eax
 a5c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
 a61:	0f 45 c8             	cmovne %eax,%ecx
 a64:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a6a <_Z6enablev+0x1a>
 a6a:	0f 9e c1             	setle  %cl
 a6d:	83 3d 00 00 00 00 01 	cmpl   $0x1,0x0(%rip)        # a74 <_Z6enablev+0x24>
 a74:	0f 9f c0             	setg   %al
 a77:	20 c8                	and    %cl,%al
 a79:	c3                   	retq   
 a7a:	90                   	nop
 a7b:	90                   	nop
...
0000000000000a80 <_Z9n_reg_maxv>:
 a80:	b8 53 00 00 00       	mov    $0x53,%eax
 a85:	c3                   	retq   

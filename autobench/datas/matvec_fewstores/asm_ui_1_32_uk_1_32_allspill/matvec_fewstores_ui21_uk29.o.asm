...
0000000000000160 <_Z5benchv>:
     ...
     19f:	0f 8e 2c 25 00 00    	jle    26d1 <_Z5benchv+0x2571>
     ...
     2f1:	0f 83 da 23 00 00    	jae    26d1 <_Z5benchv+0x2571>
    ...
    254b:	48 83 c6 1d          	add    $0x1d,%rsi
    254f:	49 0f af c2          	imul   %r10,%rax
    2553:	48 01 f8             	add    %rdi,%rax
    2556:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    255d:	01 00 00 
    2560:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    2567:	01 00 00 
    256a:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    2571:	01 00 00 
    2574:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    257b:	02 00 00 
    257e:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    2585:	01 00 00 
    2588:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    258e:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    2595:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    259c:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    25a3:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    25aa:	00 00 00 
    25ad:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    25b4:	00 00 00 
    25b7:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    25be:	00 00 00 
    25c1:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    25c8:	01 00 00 
    25cb:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    25d2:	01 00 00 
    25d5:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    25db:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    25e0:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    25e7:	00 00 00 
    25ea:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    25f1:	00 00 
    25f3:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    25f9:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    2600:	00 00 
    2602:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    2608:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    260f:	00 00 
    2611:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    2617:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm2
    261e:	02 00 00 
    2621:	c4 e2 4d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm1
    2628:	01 00 00 
    262b:	c4 e2 4d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm4
    2632:	02 00 00 
    2635:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    263b:	c5 fc 11 ac 24 80 00 	vmovups %ymm5,0x80(%rsp)
    2642:	00 00 
    2644:	c5 7c 29 cd          	vmovaps %ymm9,%ymm5
    2648:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    264d:	c4 41 7c 28 dd       	vmovaps %ymm13,%ymm11
    2652:	c5 7c 11 bc 24 20 01 	vmovups %ymm15,0x120(%rsp)
    2659:	00 00 
    265b:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    2662:	00 00 
    2664:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    2669:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    266f:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    2676:	01 00 00 
    2679:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    267e:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    2684:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    268a:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    2690:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    2697:	02 00 00 
    269a:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    26a0:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    26a6:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    26ad:	02 00 00 
    26b0:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    26b4:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    26b9:	c4 41 7c 28 d4       	vmovaps %ymm12,%ymm10
    26be:	c4 41 7c 28 e6       	vmovaps %ymm14,%ymm12
    26c3:	4c 39 c6             	cmp    %r8,%rsi
    26c6:	0f 8c 54 dd ff ff    	jl     420 <_Z5benchv+0x2c0>
    26cc:	e9 03 db ff ff       	jmpq   1d4 <_Z5benchv+0x74>
    26d1:	0f 31                	rdtsc  
    26d3:	48 c1 e2 20          	shl    $0x20,%rdx
    26d7:	48 09 c2             	or     %rax,%rdx
    26da:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 26e0 <_Z5benchv+0x2580>
    26e0:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    26e5:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 26ed <_Z5benchv+0x258d>
    26ec:	00 
    26ed:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 26f5 <_Z5benchv+0x2595>
    26f4:	00 
    26f5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 26fc <_Z5benchv+0x259c>
    26fc:	01 c0                	add    %eax,%eax
    26fe:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2704:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2708:	c5 fb 5c 44 24 78    	vsubsd 0x78(%rsp),%xmm0,%xmm0
    270e:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    2713:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    2717:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    271b:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    271f:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    2726:	c5 f8 77             	vzeroupper 
    2729:	c3                   	retq   
    272a:	90                   	nop
    272b:	90                   	nop
    272c:	90                   	nop
...
0000000000002730 <_Z6enablev>:
    ...
    2737:	b8 a8 00 00 00       	mov    $0xa8,%eax
    273c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    2741:	0f 45 c8             	cmovne %eax,%ecx
    2744:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 274a <_Z6enablev+0x1a>
    274a:	0f 9e c1             	setle  %cl
    274d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 2754 <_Z6enablev+0x24>
...
0000000000002760 <_Z9n_reg_maxv>:
    2760:	b8 93 02 00 00       	mov    $0x293,%eax
    2765:	c3                   	retq   

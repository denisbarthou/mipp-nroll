...
0000000000000160 <_Z5benchv>:
     ...
     193:	0f 8e 60 0f 00 00    	jle    10f9 <_Z5benchv+0xf99>
     ...
     22f:	0f 83 c4 0e 00 00    	jae    10f9 <_Z5benchv+0xf99>
    ...
    1075:	48 83 c3 1d          	add    $0x1d,%rbx
    1079:	48 0f af f0          	imul   %rax,%rsi
    107d:	48 01 fe             	add    %rdi,%rsi
    1080:	c4 e2 15 b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm3
    1086:	c4 e2 15 b8 6c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm5
    108d:	c4 e2 15 b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm7
    1094:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
    109b:	c4 e2 15 b8 8c b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm1
    10a2:	00 00 00 
    10a5:	c4 e2 15 b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm2
    10ac:	00 00 00 
    10af:	c4 e2 15 b8 a4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm4
    10b6:	00 00 00 
    10b9:	c4 e2 15 b8 b4 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm6
    10c0:	00 00 00 
    10c3:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
    10ca:	01 00 00 
    10cd:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
    10d4:	01 00 00 
    10d7:	c4 62 15 b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm11
    10de:	01 00 00 
    10e1:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm12
    10e8:	01 00 00 
    10eb:	4c 39 c3             	cmp    %r8,%rbx
    10ee:	0f 8c cc f1 ff ff    	jl     2c0 <_Z5benchv+0x160>
    10f4:	e9 c7 f0 ff ff       	jmpq   1c0 <_Z5benchv+0x60>
    10f9:	0f 31                	rdtsc  
    10fb:	48 c1 e2 20          	shl    $0x20,%rdx
    10ff:	48 09 c2             	or     %rax,%rdx
    1102:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1108 <_Z5benchv+0xfa8>
    1108:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    110d:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1115 <_Z5benchv+0xfb5>
    1114:	00 
    1115:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 111d <_Z5benchv+0xfbd>
    111c:	00 
    111d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1124 <_Z5benchv+0xfc4>
    ...
    1134:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
...
0000000000001150 <_Z6enablev>:
    ...
    1157:	b8 60 00 00 00       	mov    $0x60,%eax
    115c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
    1161:	0f 45 c8             	cmovne %eax,%ecx
    1164:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 116a <_Z6enablev+0x1a>
    116a:	0f 9e c1             	setle  %cl
    116d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 1174 <_Z6enablev+0x24>
...
0000000000001180 <_Z9n_reg_maxv>:
    1180:	b8 85 01 00 00       	mov    $0x185,%eax
    1185:	c3                   	retq   

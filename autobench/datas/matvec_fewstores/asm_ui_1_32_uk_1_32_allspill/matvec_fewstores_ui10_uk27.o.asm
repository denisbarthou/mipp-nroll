...
0000000000000df0 <_Z6enablev>:
 ...
 df7:	b8 50 00 00 00       	mov    $0x50,%eax
 dfc:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 e01:	0f 45 c8             	cmovne %eax,%ecx
 e04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # e0a <_Z6enablev+0x1a>
 e0a:	0f 9e c1             	setle  %cl
 e0d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # e14 <_Z6enablev+0x24>
...
0000000000000e20 <_Z9n_reg_maxv>:
 e20:	b8 33 01 00 00       	mov    $0x133,%eax
 e25:	c3                   	retq   

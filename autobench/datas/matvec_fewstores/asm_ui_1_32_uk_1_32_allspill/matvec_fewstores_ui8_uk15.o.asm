...
0000000000000b50 <_Z6enablev>:
 b50:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # b57 <_Z6enablev+0x7>
 b57:	b8 40 00 00 00       	mov    $0x40,%eax
 b5c:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 b61:	0f 45 c8             	cmovne %eax,%ecx
 b64:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b6a <_Z6enablev+0x1a>
 b6a:	0f 9e c1             	setle  %cl
 b6d:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # b74 <_Z6enablev+0x24>
 b74:	0f 9f c0             	setg   %al
 b77:	20 c8                	and    %cl,%al
 b79:	c3                   	retq   
 b7a:	90                   	nop
 b7b:	90                   	nop

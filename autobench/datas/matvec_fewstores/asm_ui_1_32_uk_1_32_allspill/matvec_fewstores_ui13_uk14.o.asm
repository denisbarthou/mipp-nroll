...
0000000000000fb0 <_Z6enablev>:
 ...
 fb7:	b8 68 00 00 00       	mov    $0x68,%eax
 fbc:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 fc1:	0f 45 c8             	cmovne %eax,%ecx
 fc4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # fca <_Z6enablev+0x1a>
 fca:	0f 9e c1             	setle  %cl
 fcd:	83 3d 00 00 00 00 0d 	cmpl   $0xd,0x0(%rip)        # fd4 <_Z6enablev+0x24>
...
0000000000000fe0 <_Z9n_reg_maxv>:
 fe0:	b8 d1 00 00 00       	mov    $0xd1,%eax
 fe5:	c3                   	retq   

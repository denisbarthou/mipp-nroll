...
matvec_fewstores_ui8_uk23.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 18a:	0f 8e 83 08 00 00    	jle    a13 <_Z5benchv+0x8c3>
 ...
 1e7:	0f 83 26 08 00 00    	jae    a13 <_Z5benchv+0x8c3>
 ...
 9b7:	48 83 c3 17          	add    $0x17,%rbx
 9bb:	48 0f af e8          	imul   %rax,%rbp
 9bf:	48 01 f5             	add    %rsi,%rbp
 9c2:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 9c8:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 9cf:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 9d6:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 9dd:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 9e4:	00 00 00 
 9e7:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 9ee:	00 00 00 
 9f1:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 9f8:	00 00 00 
 9fb:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 a02:	00 00 00 
 a05:	48 39 fb             	cmp    %rdi,%rbx
 a08:	0f 8c 52 f8 ff ff    	jl     260 <_Z5benchv+0x110>
 a0e:	e9 9d f7 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 a13:	0f 31                	rdtsc  
 a15:	48 c1 e2 20          	shl    $0x20,%rdx
 a19:	48 09 c2             	or     %rax,%rdx
 a1c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # a22 <_Z5benchv+0x8d2>
 a22:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 a27:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # a2f <_Z5benchv+0x8df>
 a2e:	00 
 a2f:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # a37 <_Z5benchv+0x8e7>
 a36:	00 
 a37:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # a3e <_Z5benchv+0x8ee>
 a3e:	01 c0                	add    %eax,%eax
 a40:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 a46:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 a4a:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 a4e:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 a52:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 a56:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 a5a:	5b                   	pop    %rbx
 a5b:	41 5c                	pop    %r12
 a5d:	41 5d                	pop    %r13
 a5f:	41 5e                	pop    %r14
...
0000000000000a70 <_Z6enablev>:
 ...
 a77:	b8 40 00 00 00       	mov    $0x40,%eax
 a7c:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui8_uk23.cpp+0x9a>
  96:	01 00 00 00 

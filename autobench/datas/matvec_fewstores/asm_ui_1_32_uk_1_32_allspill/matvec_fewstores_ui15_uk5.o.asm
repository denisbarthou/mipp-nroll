...
00000000000007e0 <_Z6enablev>:
 ...
 7e7:	b8 78 00 00 00       	mov    $0x78,%eax
 7ec:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 7f1:	0f 45 c8             	cmovne %eax,%ecx
 7f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 7fa <_Z6enablev+0x1a>
 7fa:	0f 9e c1             	setle  %cl
 7fd:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 804 <_Z6enablev+0x24>
...
0000000000000810 <_Z9n_reg_maxv>:
 810:	b8 5f 00 00 00       	mov    $0x5f,%eax
 815:	c3                   	retq   

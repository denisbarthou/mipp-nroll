...
0000000000000670 <_Z6enablev>:
 ...
 677:	b8 60 00 00 00       	mov    $0x60,%eax
 67c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 681:	0f 45 c8             	cmovne %eax,%ecx
 684:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 68a <_Z6enablev+0x1a>
 68a:	0f 9e c1             	setle  %cl
 68d:	83 3d 00 00 00 00 04 	cmpl   $0x4,0x0(%rip)        # 694 <_Z6enablev+0x24>
...
00000000000006a0 <_Z9n_reg_maxv>:
 6a0:	b8 4d 00 00 00       	mov    $0x4d,%eax
 6a5:	c3                   	retq   

...
0000000000002160 <_Z6enablev>:
    ...
    2167:	b8 d0 00 00 00       	mov    $0xd0,%eax
    216c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    2171:	0f 45 c8             	cmovne %eax,%ecx
    2174:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 217a <_Z6enablev+0x1a>
    217a:	0f 9e c1             	setle  %cl
    217d:	83 3d 00 00 00 00 0f 	cmpl   $0xf,0x0(%rip)        # 2184 <_Z6enablev+0x24>
...
0000000000002190 <_Z9n_reg_maxv>:
    2190:	b8 ca 01 00 00       	mov    $0x1ca,%eax
    2195:	c3                   	retq   

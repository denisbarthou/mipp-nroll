...
0000000000000b00 <_Z6enablev>:
 ...
 b07:	b8 68 00 00 00       	mov    $0x68,%eax
 b0c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 b11:	0f 45 c8             	cmovne %eax,%ecx
 b14:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b1a <_Z6enablev+0x1a>
 b1a:	0f 9e c1             	setle  %cl
 b1d:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # b24 <_Z6enablev+0x24>
...
0000000000000b30 <_Z9n_reg_maxv>:
 b30:	b8 99 00 00 00       	mov    $0x99,%eax
 b35:	c3                   	retq   

...
matvec_fewstores_ui14_uk23.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     192:	0f 8e 5f 0e 00 00    	jle    ff7 <_Z5benchv+0xe97>
     ...
     245:	0f 83 ac 0d 00 00    	jae    ff7 <_Z5benchv+0xe97>
     ...
     f5f:	48 83 c6 17          	add    $0x17,%rsi
     f63:	49 0f af c3          	imul   %r11,%rax
     f67:	48 01 f8             	add    %rdi,%rax
     f6a:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
     f70:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
     f77:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
     f7e:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
     f85:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
     f8c:	00 00 00 
     f8f:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
     f96:	00 00 00 
     f99:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
     fa0:	00 00 00 
     fa3:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
     faa:	00 00 00 
     fad:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
     fb4:	01 00 00 
     fb7:	c4 62 05 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm10
     fbe:	01 00 00 
     fc1:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
     fc8:	01 00 00 
     fcb:	c4 62 05 b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm12
     fd2:	01 00 00 
     fd5:	c4 62 05 b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm13
     fdc:	01 00 00 
     fdf:	c4 62 05 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm14
     fe6:	01 00 00 
     fe9:	4c 39 c6             	cmp    %r8,%rsi
     fec:	0f 8c ee f2 ff ff    	jl     2e0 <_Z5benchv+0x180>
     ff2:	e9 c9 f1 ff ff       	jmpq   1c0 <_Z5benchv+0x60>
     ff7:	0f 31                	rdtsc  
     ff9:	48 c1 e2 20          	shl    $0x20,%rdx
     ffd:	48 09 c2             	or     %rax,%rdx
    1000:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1006 <_Z5benchv+0xea6>
    1006:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    100b:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1013 <_Z5benchv+0xeb3>
    1012:	00 
    1013:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 101b <_Z5benchv+0xebb>
    101a:	00 
    101b:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1022 <_Z5benchv+0xec2>
    1022:	01 c0                	add    %eax,%eax
    1024:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    102a:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    102e:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    1032:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    1037:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    103b:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    103f:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000001050 <_Z6enablev>:
    ...
    1057:	b8 70 00 00 00       	mov    $0x70,%eax
    105c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
    1061:	0f 45 c8             	cmovne %eax,%ecx
    1064:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 106a <_Z6enablev+0x1a>
    106a:	0f 9e c1             	setle  %cl
    106d:	83 3d 00 00 00 00 16 	cmpl   $0x16,0x0(%rip)        # 1074 <_Z6enablev+0x24>
...
0000000000001080 <_Z9n_reg_maxv>:
    1080:	b8 67 01 00 00       	mov    $0x167,%eax
    1085:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui14_uk23.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000910 <_Z6enablev>:
 ...
 917:	b8 48 00 00 00       	mov    $0x48,%eax
 91c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 921:	0f 45 c8             	cmovne %eax,%ecx
 924:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 92a <_Z6enablev+0x1a>
 92a:	0f 9e c1             	setle  %cl
 92d:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 934 <_Z6enablev+0x24>
...
0000000000000940 <_Z9n_reg_maxv>:
 940:	b8 77 00 00 00       	mov    $0x77,%eax
 945:	c3                   	retq   

...
0000000000001d70 <_Z6enablev>:
    ...
    1d77:	b8 88 00 00 00       	mov    $0x88,%eax
    1d7c:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1d81:	0f 45 c8             	cmovne %eax,%ecx
    1d84:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1d8a <_Z6enablev+0x1a>
    1d8a:	0f 9e c1             	setle  %cl
    1d8d:	83 3d 00 00 00 00 1e 	cmpl   $0x1e,0x0(%rip)        # 1d94 <_Z6enablev+0x24>
...
0000000000001da0 <_Z9n_reg_maxv>:
    1da0:	b8 3f 02 00 00       	mov    $0x23f,%eax
    1da5:	c3                   	retq   

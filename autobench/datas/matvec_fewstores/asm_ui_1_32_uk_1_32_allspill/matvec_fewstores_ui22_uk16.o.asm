...
0000000000001910 <_Z6enablev>:
    1910:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1917 <_Z6enablev+0x7>
    1917:	b8 b0 00 00 00       	mov    $0xb0,%eax
    191c:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    1921:	0f 45 c8             	cmovne %eax,%ecx
    1924:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 192a <_Z6enablev+0x1a>
    192a:	0f 9e c1             	setle  %cl
    192d:	83 3d 00 00 00 00 0f 	cmpl   $0xf,0x0(%rip)        # 1934 <_Z6enablev+0x24>
    1934:	0f 9f c0             	setg   %al
    1937:	20 c8                	and    %cl,%al
    1939:	c3                   	retq   
    193a:	90                   	nop
    193b:	90                   	nop
    193c:	90                   	nop
...
0000000000001940 <_Z9n_reg_maxv>:
    1940:	b8 86 01 00 00       	mov    $0x186,%eax
    1945:	c3                   	retq   

...
0000000000002b60 <_Z6enablev>:
    ...
    2b67:	b8 c0 00 00 00       	mov    $0xc0,%eax
    2b6c:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    2b71:	0f 45 c8             	cmovne %eax,%ecx
    2b74:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 2b7a <_Z6enablev+0x1a>
    2b7a:	0f 9e c1             	setle  %cl
    2b7d:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 2b84 <_Z6enablev+0x24>
...
0000000000002b90 <_Z9n_reg_maxv>:
    2b90:	b8 70 02 00 00       	mov    $0x270,%eax
    2b95:	c3                   	retq   

...
matvec_fewstores_ui27_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 35 31 00 00    	jle    32cd <_Z5benchv+0x317d>
     ...
     35d:	0f 83 6a 2f 00 00    	jae    32cd <_Z5benchv+0x317d>
    ...
    30ab:	48 83 c6 19          	add    $0x19,%rsi
    30af:	49 0f af c2          	imul   %r10,%rax
    30b3:	48 01 f8             	add    %rdi,%rax
    30b6:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm12,%ymm4
    30bd:	02 00 00 
    30c0:	c4 e2 1d b8 94 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm2
    30c7:	00 00 00 
    30ca:	c4 e2 1d b8 9c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm3
    30d1:	00 00 00 
    30d4:	c4 e2 1d b8 ac 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm5
    30db:	00 00 00 
    30de:	c4 62 1d b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm10
    30e5:	00 00 00 
    30e8:	c4 62 1d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm8
    30ef:	01 00 00 
    30f2:	c4 e2 1d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm12,%ymm6
    30f9:	01 00 00 
    30fc:	c4 62 1d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm12,%ymm9
    3103:	02 00 00 
    3106:	c4 62 1d b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm12,%ymm11
    310d:	02 00 00 
    3110:	c4 e2 1d b8 84 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm12,%ymm0
    3117:	03 00 00 
    311a:	c4 62 1d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm13
    3120:	c4 62 1d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm14
    3127:	c4 62 1d b8 7c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm15
    312e:	c4 e2 1d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm1
    3135:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    313b:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    3141:	c4 e2 1d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm7
    3148:	01 00 00 
    314b:	c5 fc 11 a4 24 80 01 	vmovups %ymm4,0x180(%rsp)
    3152:	00 00 
    3154:	c5 fc 10 a4 24 00 01 	vmovups 0x100(%rsp),%ymm4
    315b:	00 00 
    315d:	c4 e2 1d b8 a4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm12,%ymm4
    3164:	02 00 00 
    3167:	c5 fc 11 84 24 a0 01 	vmovups %ymm0,0x1a0(%rsp)
    316e:	00 00 
    3170:	c5 7c 29 e8          	vmovaps %ymm13,%ymm0
    3174:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    317a:	c5 fc 10 bc 24 e0 00 	vmovups 0xe0(%rsp),%ymm7
    3181:	00 00 
    3183:	c4 e2 1d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm7
    318a:	01 00 00 
    318d:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    3194:	00 00 
    3196:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    319c:	c4 e2 1d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm12,%ymm4
    31a3:	02 00 00 
    31a6:	c5 fc 11 bc 24 e0 00 	vmovups %ymm7,0xe0(%rsp)
    31ad:	00 00 
    31af:	c5 fc 10 bc 24 a0 00 	vmovups 0xa0(%rsp),%ymm7
    31b6:	00 00 
    31b8:	c4 e2 1d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm12,%ymm7
    31bf:	01 00 00 
    31c2:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    31c8:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    31ce:	c4 e2 1d b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm12,%ymm4
    31d5:	02 00 00 
    31d8:	c5 fc 11 bc 24 a0 00 	vmovups %ymm7,0xa0(%rsp)
    31df:	00 00 
    31e1:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    31e7:	c4 e2 1d b8 bc 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm12,%ymm7
    31ee:	01 00 00 
    31f1:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    31f7:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    31fe:	00 00 
    3200:	c4 e2 1d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm12,%ymm4
    3207:	02 00 00 
    320a:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    3210:	c5 fc 10 bc 24 c0 00 	vmovups 0xc0(%rsp),%ymm7
    3217:	00 00 
    3219:	c4 e2 1d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm12,%ymm7
    3220:	01 00 00 
    3223:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    322a:	00 00 
    322c:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    3232:	c4 e2 1d b8 a4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm12,%ymm4
    3239:	02 00 00 
    323c:	c5 fc 11 bc 24 c0 00 	vmovups %ymm7,0xc0(%rsp)
    3243:	00 00 
    3245:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    324b:	c4 e2 1d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm12,%ymm7
    3252:	01 00 00 
    3255:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    325b:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    3260:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm12,%ymm4
    3267:	03 00 00 
    326a:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    3270:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    3274:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    3278:	c5 7c 29 c5          	vmovaps %ymm8,%ymm5
    327c:	c5 7c 10 44 24 c0    	vmovups -0x40(%rsp),%ymm8
    3282:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    3287:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    328d:	c4 e2 1d b8 a4 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm12,%ymm4
    3294:	03 00 00 
    3297:	c5 7c 28 e2          	vmovaps %ymm2,%ymm12
    329b:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    32a1:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    32a7:	c5 7c 29 cc          	vmovaps %ymm9,%ymm4
    32ab:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    32b0:	c4 41 7c 28 da       	vmovaps %ymm10,%ymm11
    32b5:	c5 7c 28 d6          	vmovaps %ymm6,%ymm10
    32b9:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    32bf:	4c 39 c6             	cmp    %r8,%rsi
    32c2:	0f 8c 78 d2 ff ff    	jl     540 <_Z5benchv+0x3f0>
    32c8:	e9 29 cf ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    32cd:	0f 31                	rdtsc  
    32cf:	48 c1 e2 20          	shl    $0x20,%rdx
    32d3:	48 09 c2             	or     %rax,%rdx
    32d6:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 32dc <_Z5benchv+0x318c>
    32dc:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    32e1:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 32e9 <_Z5benchv+0x3199>
    32e8:	00 
    32e9:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 32f1 <_Z5benchv+0x31a1>
    32f0:	00 
    32f1:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 32f8 <_Z5benchv+0x31a8>
    32f8:	01 c0                	add    %eax,%eax
    32fa:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3300:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3304:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    330b:	00 00 
    330d:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    3312:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    3316:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    331a:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    331e:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
...
0000000000003330 <_Z6enablev>:
    ...
    334d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 3354 <_Z6enablev+0x24>
...
0000000000003360 <_Z9n_reg_maxv>:
    3360:	b8 d7 02 00 00       	mov    $0x2d7,%eax
    3365:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui27_uk25.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000ca0 <_Z6enablev>:
 ...
 ca7:	b8 68 00 00 00       	mov    $0x68,%eax
 cac:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 cb1:	0f 45 c8             	cmovne %eax,%ecx
 cb4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # cba <_Z6enablev+0x1a>
 cba:	0f 9e c1             	setle  %cl
 cbd:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # cc4 <_Z6enablev+0x24>
...
0000000000000cd0 <_Z9n_reg_maxv>:
 cd0:	b8 09 01 00 00       	mov    $0x109,%eax
 cd5:	c3                   	retq   

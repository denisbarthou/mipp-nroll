...
0000000000000870 <_Z6enablev>:
 ...
 877:	b8 68 00 00 00       	mov    $0x68,%eax
 87c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 881:	0f 45 c8             	cmovne %eax,%ecx
 884:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 88a <_Z6enablev+0x1a>
 88a:	0f 9e c1             	setle  %cl
 88d:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 894 <_Z6enablev+0x24>
...
00000000000008a0 <_Z9n_reg_maxv>:
 8a0:	b8 6f 00 00 00       	mov    $0x6f,%eax
 8a5:	c3                   	retq   

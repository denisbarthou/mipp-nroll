...
0000000000000160 <_Z5benchv>:
     ...
     19f:	0f 8e cd 1f 00 00    	jle    2172 <_Z5benchv+0x2012>
     ...
     2cc:	0f 83 a0 1e 00 00    	jae    2172 <_Z5benchv+0x2012>
    ...
    201d:	48 83 c6 1d          	add    $0x1d,%rsi
    2021:	49 0f af c2          	imul   %r10,%rax
    2025:	48 01 f8             	add    %rdi,%rax
    2028:	c4 e2 5d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm1
    202f:	01 00 00 
    2032:	c4 e2 5d b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm3
    2039:	01 00 00 
    203c:	c4 62 5d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm14
    2043:	01 00 00 
    2046:	c4 62 5d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm12
    204d:	01 00 00 
    2050:	c4 62 5d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm9
    2057:	c4 62 5d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm15
    205e:	01 00 00 
    2061:	c4 e2 5d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm5
    2067:	c4 e2 5d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm6
    206e:	c4 62 5d b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm8
    2075:	00 00 00 
    2078:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm10
    207f:	00 00 00 
    2082:	c4 62 5d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm13
    2089:	01 00 00 
    208c:	c4 62 5d b8 9c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm11
    2093:	00 00 00 
    2096:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    209d:	00 00 00 
    20a0:	c4 e2 5d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm2
    20a7:	02 00 00 
    20aa:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    20b0:	c5 fc 10 7c 24 e0    	vmovups -0x20(%rsp),%ymm7
    20b6:	c4 e2 5d b8 7c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm7
    20bd:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    20c4:	00 00 
    20c6:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    20ca:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    20d0:	c4 e2 5d b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm3
    20d7:	01 00 00 
    20da:	c5 7c 11 74 24 60    	vmovups %ymm14,0x60(%rsp)
    20e0:	c4 41 7c 28 f4       	vmovaps %ymm12,%ymm14
    20e5:	c5 7c 10 24 24       	vmovups (%rsp),%ymm12
    20ea:	c4 62 5d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm12
    20f1:	02 00 00 
    20f4:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
    20fa:	c4 41 7c 28 fd       	vmovaps %ymm13,%ymm15
    20ff:	c5 7c 11 9c 24 c0 00 	vmovups %ymm11,0xc0(%rsp)
    2106:	00 00 
    2108:	c5 fc 11 84 24 a0 00 	vmovups %ymm0,0xa0(%rsp)
    210f:	00 00 
    2111:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    2117:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    211d:	c4 e2 5d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm7
    2124:	01 00 00 
    2127:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    212d:	c5 fc 10 5c 24 80    	vmovups -0x80(%rsp),%ymm3
    2133:	c4 e2 5d b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm3
    213a:	02 00 00 
    213d:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    2141:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    2145:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    2149:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    214e:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    2154:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    2158:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    215e:	c5 fc 11 5c 24 80    	vmovups %ymm3,-0x80(%rsp)
    2164:	4c 39 c6             	cmp    %r8,%rsi
    2167:	0f 8c 63 e2 ff ff    	jl     3d0 <_Z5benchv+0x270>
    216d:	e9 66 e0 ff ff       	jmpq   1d8 <_Z5benchv+0x78>
    2172:	0f 31                	rdtsc  
    2174:	48 c1 e2 20          	shl    $0x20,%rdx
    2178:	48 09 c2             	or     %rax,%rdx
    217b:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2181 <_Z5benchv+0x2021>
    2181:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2186:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 218e <_Z5benchv+0x202e>
    218d:	00 
    218e:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2196 <_Z5benchv+0x2036>
    2195:	00 
    2196:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 219d <_Z5benchv+0x203d>
    219d:	01 c0                	add    %eax,%eax
    219f:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    21a5:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    21a9:	c5 fb 5c 44 24 38    	vsubsd 0x38(%rsp),%xmm0,%xmm0
    21af:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
    21b4:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
    21b8:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    21bc:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    21c0:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
...
00000000000021d0 <_Z6enablev>:
    ...
    21d7:	b8 98 00 00 00       	mov    $0x98,%eax
    21dc:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    21e1:	0f 45 c8             	cmovne %eax,%ecx
    21e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 21ea <_Z6enablev+0x1a>
    21ea:	0f 9e c1             	setle  %cl
    21ed:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 21f4 <_Z6enablev+0x24>
...
0000000000002200 <_Z9n_reg_maxv>:
    2200:	b8 57 02 00 00       	mov    $0x257,%eax
    2205:	c3                   	retq   

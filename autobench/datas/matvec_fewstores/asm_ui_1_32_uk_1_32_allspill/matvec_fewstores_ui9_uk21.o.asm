...
0000000000000aa0 <_Z6enablev>:
 ...
 aa7:	b8 48 00 00 00       	mov    $0x48,%eax
 aac:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 ab1:	0f 45 c8             	cmovne %eax,%ecx
 ab4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # aba <_Z6enablev+0x1a>
 aba:	0f 9e c1             	setle  %cl
 abd:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # ac4 <_Z6enablev+0x24>
...
0000000000000ad0 <_Z9n_reg_maxv>:
 ad0:	b8 db 00 00 00       	mov    $0xdb,%eax
 ad5:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e d7 09 00 00    	jle    b5f <_Z5benchv+0xa0f>
 ...
 235:	0f 83 24 09 00 00    	jae    b5f <_Z5benchv+0xa0f>
 ...
 ac7:	48 83 c6 0f          	add    $0xf,%rsi
 acb:	49 0f af c3          	imul   %r11,%rax
 acf:	48 01 f8             	add    %rdi,%rax
 ad2:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
 ad8:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
 adf:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
 ae6:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
 aed:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
 af4:	00 00 00 
 af7:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
 afe:	00 00 00 
 b01:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
 b08:	00 00 00 
 b0b:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
 b12:	00 00 00 
 b15:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
 b1c:	01 00 00 
 b1f:	c4 62 05 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm10
 b26:	01 00 00 
 b29:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
 b30:	01 00 00 
 b33:	c4 62 05 b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm12
 b3a:	01 00 00 
 b3d:	c4 62 05 b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm13
 b44:	01 00 00 
 b47:	c4 62 05 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm14
 b4e:	01 00 00 
 b51:	4c 39 c6             	cmp    %r8,%rsi
 b54:	0f 8c 76 f7 ff ff    	jl     2d0 <_Z5benchv+0x180>
 b5a:	e9 51 f6 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 b5f:	0f 31                	rdtsc  
 b61:	48 c1 e2 20          	shl    $0x20,%rdx
 b65:	48 09 c2             	or     %rax,%rdx
 b68:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b6e <_Z5benchv+0xa1e>
 b6e:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 b73:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # b7b <_Z5benchv+0xa2b>
 b7a:	00 
 b7b:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # b83 <_Z5benchv+0xa33>
 b82:	00 
 b83:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b8a <_Z5benchv+0xa3a>
 b8a:	01 c0                	add    %eax,%eax
 b8c:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b92:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b96:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 b9a:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
 b9f:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 ba3:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 ba7:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000000bb0 <_Z6enablev>:
 ...
 bb7:	b8 70 00 00 00       	mov    $0x70,%eax
 bbc:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 bc1:	0f 45 c8             	cmovne %eax,%ecx
 bc4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # bca <_Z6enablev+0x1a>
 bca:	0f 9e c1             	setle  %cl
 bcd:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # bd4 <_Z6enablev+0x24>
...
0000000000000be0 <_Z9n_reg_maxv>:
 be0:	b8 ef 00 00 00       	mov    $0xef,%eax
 be5:	c3                   	retq   

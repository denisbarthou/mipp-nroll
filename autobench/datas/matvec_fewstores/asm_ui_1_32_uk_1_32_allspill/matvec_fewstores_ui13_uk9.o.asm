...
0000000000000a30 <_Z6enablev>:
 ...
 a37:	b8 68 00 00 00       	mov    $0x68,%eax
 a3c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 a41:	0f 45 c8             	cmovne %eax,%ecx
 a44:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a4a <_Z6enablev+0x1a>
 a4a:	0f 9e c1             	setle  %cl
 a4d:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # a54 <_Z6enablev+0x24>
...
0000000000000a60 <_Z9n_reg_maxv>:
 a60:	b8 8b 00 00 00       	mov    $0x8b,%eax
 a65:	c3                   	retq   

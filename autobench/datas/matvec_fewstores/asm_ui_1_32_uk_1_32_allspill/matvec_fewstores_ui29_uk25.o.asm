...
matvec_fewstores_ui29_uk25.o:     file format elf64-x86-64
...
0000000000000160 <_Z5benchv>:
     ...
     1a2:	0f 8e f0 36 00 00    	jle    3898 <_Z5benchv+0x3738>
     ...
     38a:	0f 83 08 35 00 00    	jae    3898 <_Z5benchv+0x3738>
    ...
    364d:	48 83 c6 19          	add    $0x19,%rsi
    3651:	49 0f af c2          	imul   %r10,%rax
    3655:	48 01 f8             	add    %rdi,%rax
    3658:	c4 e2 0d b8 84 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm14,%ymm0
    365f:	03 00 00 
    3662:	c4 62 0d b8 3c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm15
    3668:	c4 e2 0d b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm5
    366f:	00 00 00 
    3672:	c4 e2 0d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm7
    3679:	00 00 00 
    367c:	c4 62 0d b8 9c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm11
    3683:	01 00 00 
    3686:	c4 62 0d b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm8
    368d:	01 00 00 
    3690:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm14,%ymm12
    3697:	02 00 00 
    369a:	c4 62 0d b8 ac 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm14,%ymm13
    36a1:	03 00 00 
    36a4:	c4 e2 0d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm1
    36ab:	c4 e2 0d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm2
    36b2:	c4 e2 0d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm3
    36b9:	c4 e2 0d b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm4
    36c0:	00 00 00 
    36c3:	c4 e2 0d b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm6
    36ca:	00 00 00 
    36cd:	c4 62 0d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm14,%ymm10
    36d4:	02 00 00 
    36d7:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    36dd:	c5 7c 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm9
    36e3:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm9
    36ea:	01 00 00 
    36ed:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    36f4:	00 00 
    36f6:	c5 7c 29 f8          	vmovaps %ymm15,%ymm0
    36fa:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    36fe:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    3702:	c5 7c 11 4c 24 a0    	vmovups %ymm9,-0x60(%rsp)
    3708:	c5 7c 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm9
    370f:	00 00 
    3711:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm9
    3718:	01 00 00 
    371b:	c5 7c 11 8c 24 20 01 	vmovups %ymm9,0x120(%rsp)
    3722:	00 00 
    3724:	c5 7c 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm9
    372b:	00 00 
    372d:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm9
    3734:	01 00 00 
    3737:	c5 7c 11 8c 24 e0 00 	vmovups %ymm9,0xe0(%rsp)
    373e:	00 00 
    3740:	c5 7c 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm9
    3747:	00 00 
    3749:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm14,%ymm9
    3750:	01 00 00 
    3753:	c5 7c 11 8c 24 a0 00 	vmovups %ymm9,0xa0(%rsp)
    375a:	00 00 
    375c:	c5 7c 10 8c 24 00 01 	vmovups 0x100(%rsp),%ymm9
    3763:	00 00 
    3765:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm14,%ymm9
    376c:	01 00 00 
    376f:	c5 7c 11 8c 24 00 01 	vmovups %ymm9,0x100(%rsp)
    3776:	00 00 
    3778:	c5 7c 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm9
    377f:	00 00 
    3781:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm14,%ymm9
    3788:	01 00 00 
    378b:	c5 7c 11 8c 24 c0 00 	vmovups %ymm9,0xc0(%rsp)
    3792:	00 00 
    3794:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    379a:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm14,%ymm9
    37a1:	02 00 00 
    37a4:	c5 7c 11 4c 24 c0    	vmovups %ymm9,-0x40(%rsp)
    37aa:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    37b0:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm14,%ymm9
    37b7:	02 00 00 
    37ba:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    37c0:	c5 7c 11 4c 24 80    	vmovups %ymm9,-0x80(%rsp)
    37c6:	c5 7c 10 8c 24 40 01 	vmovups 0x140(%rsp),%ymm9
    37cd:	00 00 
    37cf:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm14,%ymm9
    37d6:	02 00 00 
    37d9:	c5 7c 11 8c 24 40 01 	vmovups %ymm9,0x140(%rsp)
    37e0:	00 00 
    37e2:	c5 7c 10 4c 24 60    	vmovups 0x60(%rsp),%ymm9
    37e8:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm14,%ymm9
    37ef:	02 00 00 
    37f2:	c5 7c 11 4c 24 60    	vmovups %ymm9,0x60(%rsp)
    37f8:	c5 7c 10 4c 24 40    	vmovups 0x40(%rsp),%ymm9
    37fe:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm14,%ymm9
    3805:	02 00 00 
    3808:	c5 7c 11 4c 24 40    	vmovups %ymm9,0x40(%rsp)
    380e:	c5 7c 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm9
    3815:	00 00 
    3817:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm14,%ymm9
    381e:	02 00 00 
    3821:	c5 7c 11 8c 24 80 00 	vmovups %ymm9,0x80(%rsp)
    3828:	00 00 
    382a:	c5 7c 10 4c 24 20    	vmovups 0x20(%rsp),%ymm9
    3830:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm14,%ymm9
    3837:	03 00 00 
    383a:	c5 7c 11 4c 24 20    	vmovups %ymm9,0x20(%rsp)
    3840:	c5 7c 10 0c 24       	vmovups (%rsp),%ymm9
    3845:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm14,%ymm9
    384c:	03 00 00 
    384f:	c5 7c 11 0c 24       	vmovups %ymm9,(%rsp)
    3854:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    385a:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm14,%ymm9
    3861:	03 00 00 
    3864:	c4 41 7c 28 f5       	vmovaps %ymm13,%ymm14
    3869:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    386e:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    3873:	c4 41 7c 28 e0       	vmovaps %ymm8,%ymm12
    3878:	c5 7c 10 44 24 a0    	vmovups -0x60(%rsp),%ymm8
    387e:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    3884:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    388a:	4c 39 c6             	cmp    %r8,%rsi
    388d:	0f 8c fd cc ff ff    	jl     590 <_Z5benchv+0x430>
    3893:	e9 6e c9 ff ff       	jmpq   206 <_Z5benchv+0xa6>
    3898:	0f 31                	rdtsc  
    389a:	48 c1 e2 20          	shl    $0x20,%rdx
    389e:	48 09 c2             	or     %rax,%rdx
    38a1:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 38a7 <_Z5benchv+0x3747>
    38a7:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    38ac:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 38b4 <_Z5benchv+0x3754>
    38b3:	00 
    38b4:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 38bc <_Z5benchv+0x375c>
    38bb:	00 
    38bc:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 38c3 <_Z5benchv+0x3763>
    38c3:	01 c0                	add    %eax,%eax
    38c5:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    38cb:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    38cf:	c5 fb 5c 84 24 78 01 	vsubsd 0x178(%rsp),%xmm0,%xmm0
    38d6:	00 00 
    38d8:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    38dc:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    38e0:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    38e4:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    38e8:	48 81 c4 38 02 00 00 	add    $0x238,%rsp
    38ef:	c5 f8 77             	vzeroupper 
    38f2:	c3                   	retq   
    38f3:	90                   	nop
    38f4:	90                   	nop
    38f5:	90                   	nop
...
0000000000003900 <_Z6enablev>:
    3900:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3907 <_Z6enablev+0x7>
    3907:	b8 e8 00 00 00       	mov    $0xe8,%eax
    390c:	b9 e3 ff ff ff       	mov    $0xffffffe3,%ecx
    3911:	0f 45 c8             	cmovne %eax,%ecx
    3914:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 391a <_Z6enablev+0x1a>
    391a:	0f 9e c1             	setle  %cl
    391d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 3924 <_Z6enablev+0x24>
    3924:	0f 9f c0             	setg   %al
    3927:	20 c8                	and    %cl,%al
    3929:	c3                   	retq   
    392a:	90                   	nop
    392b:	90                   	nop
    392c:	90                   	nop
...
0000000000003930 <_Z9n_reg_maxv>:
    3930:	b8 0b 03 00 00       	mov    $0x30b,%eax
    3935:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui29_uk25.cpp+0x9a>
  96:	01 00 00 00 

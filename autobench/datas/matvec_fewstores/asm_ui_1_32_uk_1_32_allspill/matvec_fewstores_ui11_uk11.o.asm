...
0000000000000ae0 <_Z6enablev>:
 ...
 ae7:	b8 58 00 00 00       	mov    $0x58,%eax
 aec:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 af1:	0f 45 c8             	cmovne %eax,%ecx
 af4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # afa <_Z6enablev+0x1a>
 afa:	0f 9e c1             	setle  %cl
 afd:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # b04 <_Z6enablev+0x24>
...
0000000000000b10 <_Z9n_reg_maxv>:
 b10:	b8 8f 00 00 00       	mov    $0x8f,%eax
 b15:	c3                   	retq   

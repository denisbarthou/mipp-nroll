...
00000000000008a0 <_Z6enablev>:
 ...
 8a7:	b8 28 00 00 00       	mov    $0x28,%eax
 8ac:	b9 fb ff ff ff       	mov    $0xfffffffb,%ecx
 8b1:	0f 45 c8             	cmovne %eax,%ecx
 8b4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 8ba <_Z6enablev+0x1a>
 8ba:	0f 9e c1             	setle  %cl
 8bd:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # 8c4 <_Z6enablev+0x24>
...
00000000000008d0 <_Z9n_reg_maxv>:
 8d0:	b8 71 00 00 00       	mov    $0x71,%eax
 8d5:	c3                   	retq   

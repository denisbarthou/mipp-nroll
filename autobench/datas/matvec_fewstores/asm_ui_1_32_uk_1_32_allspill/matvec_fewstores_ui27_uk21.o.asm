...
matvec_fewstores_ui27_uk21.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 09 2a 00 00    	jle    2ba1 <_Z5benchv+0x2a51>
     ...
     35d:	0f 83 3e 28 00 00    	jae    2ba1 <_Z5benchv+0x2a51>
    ...
    297f:	48 83 c6 15          	add    $0x15,%rsi
    2983:	49 0f af c2          	imul   %r10,%rax
    2987:	48 01 f8             	add    %rdi,%rax
    298a:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm12,%ymm4
    2991:	02 00 00 
    2994:	c4 e2 1d b8 94 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm2
    299b:	00 00 00 
    299e:	c4 e2 1d b8 9c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm3
    29a5:	00 00 00 
    29a8:	c4 e2 1d b8 ac 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm5
    29af:	00 00 00 
    29b2:	c4 62 1d b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm10
    29b9:	00 00 00 
    29bc:	c4 62 1d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm8
    29c3:	01 00 00 
    29c6:	c4 e2 1d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm12,%ymm6
    29cd:	01 00 00 
    29d0:	c4 62 1d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm12,%ymm9
    29d7:	02 00 00 
    29da:	c4 62 1d b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm12,%ymm11
    29e1:	02 00 00 
    29e4:	c4 e2 1d b8 84 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm12,%ymm0
    29eb:	03 00 00 
    29ee:	c4 62 1d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm13
    29f4:	c4 62 1d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm14
    29fb:	c4 62 1d b8 7c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm15
    2a02:	c4 e2 1d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm1
    2a09:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    2a0f:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    2a15:	c4 e2 1d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm7
    2a1c:	01 00 00 
    2a1f:	c5 fc 11 a4 24 80 01 	vmovups %ymm4,0x180(%rsp)
    2a26:	00 00 
    2a28:	c5 fc 10 a4 24 00 01 	vmovups 0x100(%rsp),%ymm4
    2a2f:	00 00 
    2a31:	c4 e2 1d b8 a4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm12,%ymm4
    2a38:	02 00 00 
    2a3b:	c5 fc 11 84 24 a0 01 	vmovups %ymm0,0x1a0(%rsp)
    2a42:	00 00 
    2a44:	c5 7c 29 e8          	vmovaps %ymm13,%ymm0
    2a48:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    2a4e:	c5 fc 10 bc 24 e0 00 	vmovups 0xe0(%rsp),%ymm7
    2a55:	00 00 
    2a57:	c4 e2 1d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm7
    2a5e:	01 00 00 
    2a61:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    2a68:	00 00 
    2a6a:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    2a70:	c4 e2 1d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm12,%ymm4
    2a77:	02 00 00 
    2a7a:	c5 fc 11 bc 24 e0 00 	vmovups %ymm7,0xe0(%rsp)
    2a81:	00 00 
    2a83:	c5 fc 10 bc 24 a0 00 	vmovups 0xa0(%rsp),%ymm7
    2a8a:	00 00 
    2a8c:	c4 e2 1d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm12,%ymm7
    2a93:	01 00 00 
    2a96:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    2a9c:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    2aa2:	c4 e2 1d b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm12,%ymm4
    2aa9:	02 00 00 
    2aac:	c5 fc 11 bc 24 a0 00 	vmovups %ymm7,0xa0(%rsp)
    2ab3:	00 00 
    2ab5:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    2abb:	c4 e2 1d b8 bc 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm12,%ymm7
    2ac2:	01 00 00 
    2ac5:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    2acb:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    2ad2:	00 00 
    2ad4:	c4 e2 1d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm12,%ymm4
    2adb:	02 00 00 
    2ade:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    2ae4:	c5 fc 10 bc 24 c0 00 	vmovups 0xc0(%rsp),%ymm7
    2aeb:	00 00 
    2aed:	c4 e2 1d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm12,%ymm7
    2af4:	01 00 00 
    2af7:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    2afe:	00 00 
    2b00:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    2b06:	c4 e2 1d b8 a4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm12,%ymm4
    2b0d:	02 00 00 
    2b10:	c5 fc 11 bc 24 c0 00 	vmovups %ymm7,0xc0(%rsp)
    2b17:	00 00 
    2b19:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    2b1f:	c4 e2 1d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm12,%ymm7
    2b26:	01 00 00 
    2b29:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    2b2f:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    2b34:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm12,%ymm4
    2b3b:	03 00 00 
    2b3e:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    2b44:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    2b48:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    2b4c:	c5 7c 29 c5          	vmovaps %ymm8,%ymm5
    2b50:	c5 7c 10 44 24 c0    	vmovups -0x40(%rsp),%ymm8
    2b56:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    2b5b:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    2b61:	c4 e2 1d b8 a4 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm12,%ymm4
    2b68:	03 00 00 
    2b6b:	c5 7c 28 e2          	vmovaps %ymm2,%ymm12
    2b6f:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    2b75:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    2b7b:	c5 7c 29 cc          	vmovaps %ymm9,%ymm4
    2b7f:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    2b84:	c4 41 7c 28 da       	vmovaps %ymm10,%ymm11
    2b89:	c5 7c 28 d6          	vmovaps %ymm6,%ymm10
    2b8d:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2b93:	4c 39 c6             	cmp    %r8,%rsi
    2b96:	0f 8c a4 d9 ff ff    	jl     540 <_Z5benchv+0x3f0>
    2b9c:	e9 55 d6 ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    2ba1:	0f 31                	rdtsc  
    2ba3:	48 c1 e2 20          	shl    $0x20,%rdx
    2ba7:	48 09 c2             	or     %rax,%rdx
    2baa:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2bb0 <_Z5benchv+0x2a60>
    2bb0:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2bb5:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2bbd <_Z5benchv+0x2a6d>
    2bbc:	00 
    2bbd:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2bc5 <_Z5benchv+0x2a75>
    2bc4:	00 
    2bc5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2bcc <_Z5benchv+0x2a7c>
    2bcc:	01 c0                	add    %eax,%eax
    2bce:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2bd4:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2bd8:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    2bdf:	00 00 
    2be1:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    2be6:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    2bea:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2bee:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2bf2:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
...
0000000000002c00 <_Z6enablev>:
    2c00:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2c07 <_Z6enablev+0x7>
    2c07:	b8 d8 00 00 00       	mov    $0xd8,%eax
    2c0c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    2c11:	0f 45 c8             	cmovne %eax,%ecx
    2c14:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 2c1a <_Z6enablev+0x1a>
    2c1a:	0f 9e c1             	setle  %cl
    2c1d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 2c24 <_Z6enablev+0x24>
    2c24:	0f 9f c0             	setg   %al
    2c27:	20 c8                	and    %cl,%al
    2c29:	c3                   	retq   
    2c2a:	90                   	nop
    2c2b:	90                   	nop
    2c2c:	90                   	nop
...
0000000000002c30 <_Z9n_reg_maxv>:
    2c30:	b8 67 02 00 00       	mov    $0x267,%eax
    2c35:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui27_uk21.cpp+0x9a>
  96:	01 00 00 00 

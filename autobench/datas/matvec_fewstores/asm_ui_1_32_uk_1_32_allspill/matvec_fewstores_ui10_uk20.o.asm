...
0000000000000b20 <_Z6enablev>:
 ...
 b27:	b8 50 00 00 00       	mov    $0x50,%eax
 b2c:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 b31:	0f 45 c8             	cmovne %eax,%ecx
 b34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b3a <_Z6enablev+0x1a>
 b3a:	0f 9e c1             	setle  %cl
 b3d:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # b44 <_Z6enablev+0x24>
...
0000000000000b50 <_Z9n_reg_maxv>:
 b50:	b8 e6 00 00 00       	mov    $0xe6,%eax
 b55:	c3                   	retq   

...
matvec_fewstores_ui26_uk21.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e bb 27 00 00    	jle    2953 <_Z5benchv+0x2803>
     ...
     356:	0f 83 f7 25 00 00    	jae    2953 <_Z5benchv+0x2803>
    ...
    2752:	48 83 c6 15          	add    $0x15,%rsi
    2756:	49 0f af c3          	imul   %r11,%rax
    275a:	48 01 f8             	add    %rdi,%rax
    275d:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm2
    2764:	00 00 00 
    2767:	c4 e2 25 b8 84 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm11,%ymm0
    276e:	03 00 00 
    2771:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
    2778:	c4 e2 25 b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm1
    277f:	00 00 00 
    2782:	c4 62 25 b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm9
    2789:	00 00 00 
    278c:	c4 e2 25 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm4
    2793:	01 00 00 
    2796:	c4 e2 25 b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm11,%ymm6
    279d:	01 00 00 
    27a0:	c4 e2 25 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm11,%ymm3
    27a7:	01 00 00 
    27aa:	c4 62 25 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm11,%ymm10
    27b1:	01 00 00 
    27b4:	c4 62 25 b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm11,%ymm8
    27bb:	02 00 00 
    27be:	c4 62 25 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm12
    27c4:	c4 62 25 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm13
    27cb:	c4 62 25 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm14
    27d2:	c4 62 25 b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm15
    27d9:	00 00 00 
    27dc:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    27e1:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    27e7:	c4 e2 25 b8 ac 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm5
    27ee:	01 00 00 
    27f1:	c5 fc 11 94 24 60 01 	vmovups %ymm2,0x160(%rsp)
    27f8:	00 00 
    27fa:	c5 fc 10 94 24 c0 00 	vmovups 0xc0(%rsp),%ymm2
    2801:	00 00 
    2803:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm11,%ymm2
    280a:	01 00 00 
    280d:	c5 fc 11 84 24 80 01 	vmovups %ymm0,0x180(%rsp)
    2814:	00 00 
    2816:	c5 fc 28 c1          	vmovaps %ymm1,%ymm0
    281a:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    281e:	c5 fc 28 de          	vmovaps %ymm6,%ymm3
    2822:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    2828:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    282e:	c4 e2 25 b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm11,%ymm5
    2835:	01 00 00 
    2838:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    283e:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    2845:	00 00 
    2847:	c5 fc 10 94 24 e0 00 	vmovups 0xe0(%rsp),%ymm2
    284e:	00 00 
    2850:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm11,%ymm2
    2857:	02 00 00 
    285a:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    2860:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    2866:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm11,%ymm5
    286d:	01 00 00 
    2870:	c5 fc 11 94 24 e0 00 	vmovups %ymm2,0xe0(%rsp)
    2877:	00 00 
    2879:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    287f:	c4 e2 25 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm11,%ymm2
    2886:	02 00 00 
    2889:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    288f:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    2895:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    289b:	c5 fc 10 94 24 a0 00 	vmovups 0xa0(%rsp),%ymm2
    28a2:	00 00 
    28a4:	c4 e2 25 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm11,%ymm2
    28ab:	02 00 00 
    28ae:	c5 fc 11 94 24 a0 00 	vmovups %ymm2,0xa0(%rsp)
    28b5:	00 00 
    28b7:	c5 fc 10 94 24 80 00 	vmovups 0x80(%rsp),%ymm2
    28be:	00 00 
    28c0:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm11,%ymm2
    28c7:	02 00 00 
    28ca:	c5 fc 11 94 24 80 00 	vmovups %ymm2,0x80(%rsp)
    28d1:	00 00 
    28d3:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    28d9:	c4 e2 25 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm11,%ymm2
    28e0:	02 00 00 
    28e3:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    28e9:	c5 fc 10 54 24 20    	vmovups 0x20(%rsp),%ymm2
    28ef:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm11,%ymm2
    28f6:	02 00 00 
    28f9:	c5 fc 11 54 24 20    	vmovups %ymm2,0x20(%rsp)
    28ff:	c5 fc 10 54 24 e0    	vmovups -0x20(%rsp),%ymm2
    2905:	c4 e2 25 b8 94 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm11,%ymm2
    290c:	02 00 00 
    290f:	c5 fc 11 54 24 e0    	vmovups %ymm2,-0x20(%rsp)
    2915:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    291a:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm11,%ymm2
    2921:	03 00 00 
    2924:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    2929:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    292d:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    2931:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    2936:	c4 41 7c 28 d0       	vmovaps %ymm8,%ymm10
    293b:	c5 7c 28 c4          	vmovaps %ymm4,%ymm8
    293f:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    2945:	4c 39 c6             	cmp    %r8,%rsi
    2948:	0f 8c f2 db ff ff    	jl     540 <_Z5benchv+0x3f0>
    294e:	e9 b0 d8 ff ff       	jmpq   203 <_Z5benchv+0xb3>
    2953:	0f 31                	rdtsc  
    2955:	48 c1 e2 20          	shl    $0x20,%rdx
    2959:	48 09 c2             	or     %rax,%rdx
    295c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2962 <_Z5benchv+0x2812>
    2962:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2967:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 296f <_Z5benchv+0x281f>
    296e:	00 
    296f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2977 <_Z5benchv+0x2827>
    2976:	00 
    2977:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 297e <_Z5benchv+0x282e>
    297e:	01 c0                	add    %eax,%eax
    2980:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2986:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    298a:	c5 fb 5c 84 24 18 01 	vsubsd 0x118(%rsp),%xmm0,%xmm0
    2991:	00 00 
    2993:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    2998:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    299c:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    29a0:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    29a4:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
    29ab:	c5 f8 77             	vzeroupper 
    29ae:	c3                   	retq   
    29af:	90                   	nop

00000000000029b0 <_Z6enablev>:
    29b0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 29b7 <_Z6enablev+0x7>
    29b7:	b8 d0 00 00 00       	mov    $0xd0,%eax
    29bc:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    29c1:	0f 45 c8             	cmovne %eax,%ecx
    29c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 29ca <_Z6enablev+0x1a>
    29ca:	0f 9e c1             	setle  %cl
    29cd:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 29d4 <_Z6enablev+0x24>
    29d4:	0f 9f c0             	setg   %al
    29d7:	20 c8                	and    %cl,%al
    29d9:	c3                   	retq   
    29da:	90                   	nop
    29db:	90                   	nop
    29dc:	90                   	nop
...
00000000000029e0 <_Z9n_reg_maxv>:
    29e0:	b8 51 02 00 00       	mov    $0x251,%eax
    29e5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui26_uk21.cpp+0x9a>
  96:	01 00 00 00 

...
matvec_fewstores_ui13_uk21.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 5b 0c 00 00    	jle    de3 <_Z5benchv+0xc93>
 ...
 22c:	0f 83 b1 0b 00 00    	jae    de3 <_Z5benchv+0xc93>
 ...
 d55:	48 83 c6 15          	add    $0x15,%rsi
 d59:	49 0f af c2          	imul   %r10,%rax
 d5d:	48 01 f8             	add    %rdi,%rax
 d60:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
 d66:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
 d6d:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
 d74:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
 d7b:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
 d82:	00 00 00 
 d85:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
 d8c:	00 00 00 
 d8f:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
 d96:	00 00 00 
 d99:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
 da0:	00 00 00 
 da3:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
 daa:	01 00 00 
 dad:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
 db4:	01 00 00 
 db7:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
 dbe:	01 00 00 
 dc1:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
 dc8:	01 00 00 
 dcb:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
 dd2:	01 00 00 
 dd5:	4c 39 c6             	cmp    %r8,%rsi
 dd8:	0f 8c e2 f4 ff ff    	jl     2c0 <_Z5benchv+0x170>
 dde:	e9 cd f3 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 de3:	0f 31                	rdtsc  
 de5:	48 c1 e2 20          	shl    $0x20,%rdx
 de9:	48 09 c2             	or     %rax,%rdx
 dec:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # df2 <_Z5benchv+0xca2>
 df2:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 df7:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # dff <_Z5benchv+0xcaf>
 dfe:	00 
 dff:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # e07 <_Z5benchv+0xcb7>
 e06:	00 
 e07:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # e0e <_Z5benchv+0xcbe>
 e0e:	01 c0                	add    %eax,%eax
 e10:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 e16:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 e1a:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 e1e:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 e22:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 e26:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000000e30 <_Z6enablev>:
 ...
 e37:	b8 68 00 00 00       	mov    $0x68,%eax
 e3c:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 e41:	0f 45 c8             	cmovne %eax,%ecx
 e44:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # e4a <_Z6enablev+0x1a>
 e4a:	0f 9e c1             	setle  %cl
 e4d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # e54 <_Z6enablev+0x24>
...
0000000000000e60 <_Z9n_reg_maxv>:
 e60:	b8 33 01 00 00       	mov    $0x133,%eax
 e65:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui13_uk21.cpp+0x9a>
  96:	01 00 00 00 

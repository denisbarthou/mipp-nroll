...
0000000000000150 <_Z5benchv>:
 ...
 188:	0f 8e ee 09 00 00    	jle    b7c <_Z5benchv+0xa2c>
 ...
 250:	0f 83 26 09 00 00    	jae    b7c <_Z5benchv+0xa2c>
 ...
 ada:	48 83 c6 0e          	add    $0xe,%rsi
 ade:	49 0f af c2          	imul   %r10,%rax
 ae2:	48 01 f8             	add    %rdi,%rax
 ae5:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
 aeb:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
 af2:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
 af9:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
 b00:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
 b07:	00 00 00 
 b0a:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
 b11:	00 00 00 
 b14:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
 b1b:	00 00 00 
 b1e:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
 b25:	00 00 00 
 b28:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
 b2f:	01 00 00 
 b32:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
 b39:	01 00 00 
 b3c:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
 b43:	01 00 00 
 b46:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
 b4d:	01 00 00 
 b50:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
 b57:	01 00 00 
 b5a:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
 b61:	01 00 00 
 b64:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
 b6b:	01 00 00 
 b6e:	4c 39 c6             	cmp    %r8,%rsi
 b71:	0f 8c 79 f7 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
 b77:	e9 44 f6 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
 b7c:	0f 31                	rdtsc  
 ...
 bb3:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
 bb9:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 bbd:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
 bc1:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 bc5:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 bc9:	c5 f8 77             	vzeroupper 
 bcc:	c3                   	retq   
 bcd:	90                   	nop
 bce:	90                   	nop
 bcf:	90                   	nop
...
0000000000000bd0 <_Z6enablev>:
 ...
 bed:	83 3d 00 00 00 00 0d 	cmpl   $0xd,0x0(%rip)        # bf4 <_Z6enablev+0x24>
...
0000000000000c00 <_Z9n_reg_maxv>:
 c00:	b8 ef 00 00 00       	mov    $0xef,%eax
 c05:	c3                   	retq   

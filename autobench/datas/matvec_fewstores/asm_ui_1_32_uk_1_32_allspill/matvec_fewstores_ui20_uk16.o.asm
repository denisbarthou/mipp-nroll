...
0000000000001710 <_Z6enablev>:
    ...
    1717:	b8 a0 00 00 00       	mov    $0xa0,%eax
    171c:	b9 ec ff ff ff       	mov    $0xffffffec,%ecx
    1721:	0f 45 c8             	cmovne %eax,%ecx
    1724:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 172a <_Z6enablev+0x1a>
    172a:	0f 9e c1             	setle  %cl
    172d:	83 3d 00 00 00 00 0f 	cmpl   $0xf,0x0(%rip)        # 1734 <_Z6enablev+0x24>
...
0000000000001740 <_Z9n_reg_maxv>:
    1740:	b8 64 01 00 00       	mov    $0x164,%eax
    1745:	c3                   	retq   

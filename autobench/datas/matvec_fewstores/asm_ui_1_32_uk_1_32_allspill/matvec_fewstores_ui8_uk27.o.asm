...
matvec_fewstores_ui8_uk27.o:     file format elf64-x86-64
...
0000000000000140 <_Z5benchv>:
 ...
 17a:	0f 8e d7 09 00 00    	jle    b57 <_Z5benchv+0xa17>
 ...
 1d7:	0f 83 7a 09 00 00    	jae    b57 <_Z5benchv+0xa17>
 ...
 afb:	48 83 c3 1b          	add    $0x1b,%rbx
 aff:	48 0f af e8          	imul   %rax,%rbp
 b03:	48 01 f5             	add    %rsi,%rbp
 b06:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 b0c:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 b13:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 b1a:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 b21:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 b28:	00 00 00 
 b2b:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 b32:	00 00 00 
 b35:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 b3c:	00 00 00 
 b3f:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 b46:	00 00 00 
 b49:	48 39 fb             	cmp    %rdi,%rbx
 b4c:	0f 8c fe f6 ff ff    	jl     250 <_Z5benchv+0x110>
 b52:	e9 49 f6 ff ff       	jmpq   1a0 <_Z5benchv+0x60>
 b57:	0f 31                	rdtsc  
 b59:	48 c1 e2 20          	shl    $0x20,%rdx
 b5d:	48 09 c2             	or     %rax,%rdx
 b60:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b66 <_Z5benchv+0xa26>
 b66:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 b6b:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # b73 <_Z5benchv+0xa33>
 b72:	00 
 b73:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # b7b <_Z5benchv+0xa3b>
 b7a:	00 
 b7b:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b82 <_Z5benchv+0xa42>
 b82:	01 c0                	add    %eax,%eax
 b84:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b8a:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b8e:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 b92:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 b96:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 b9a:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 b9e:	5b                   	pop    %rbx
 b9f:	41 5c                	pop    %r12
 ba1:	41 5d                	pop    %r13
 ba3:	41 5e                	pop    %r14
...
0000000000000bb0 <_Z6enablev>:
 ...
 bb7:	b8 40 00 00 00       	mov    $0x40,%eax
 bbc:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 bc1:	0f 45 c8             	cmovne %eax,%ecx
 bc4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # bca <_Z6enablev+0x1a>
 bca:	0f 9e c1             	setle  %cl
 bcd:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # bd4 <_Z6enablev+0x24>
...
0000000000000be0 <_Z9n_reg_maxv>:
 be0:	b8 fb 00 00 00       	mov    $0xfb,%eax
 be5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui8_uk27.cpp+0x9a>
  96:	01 00 00 00 

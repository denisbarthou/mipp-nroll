...
0000000000000160 <_Z5benchv>:
     ...
     191:	0f 8e c6 11 00 00    	jle    135d <_Z5benchv+0x11fd>
     ...
     245:	0f 83 12 11 00 00    	jae    135d <_Z5benchv+0x11fd>
    ...
    12c5:	48 83 c6 1d          	add    $0x1d,%rsi
    12c9:	48 0f af c3          	imul   %rbx,%rax
    12cd:	48 01 f8             	add    %rdi,%rax
    12d0:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
    12d6:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
    12dd:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
    12e4:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
    12eb:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
    12f2:	00 00 00 
    12f5:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
    12fc:	00 00 00 
    12ff:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
    1306:	00 00 00 
    1309:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
    1310:	00 00 00 
    1313:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
    131a:	01 00 00 
    131d:	c4 62 05 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm10
    1324:	01 00 00 
    1327:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
    132e:	01 00 00 
    1331:	c4 62 05 b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm12
    1338:	01 00 00 
    133b:	c4 62 05 b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm13
    1342:	01 00 00 
    1345:	c4 62 05 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm14
    134c:	01 00 00 
    134f:	4c 39 c6             	cmp    %r8,%rsi
    1352:	0f 8c 88 ef ff ff    	jl     2e0 <_Z5benchv+0x180>
    1358:	e9 63 ee ff ff       	jmpq   1c0 <_Z5benchv+0x60>
    135d:	0f 31                	rdtsc  
    135f:	48 c1 e2 20          	shl    $0x20,%rdx
    1363:	48 09 c2             	or     %rax,%rdx
    1366:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 136c <_Z5benchv+0x120c>
    136c:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    1371:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1379 <_Z5benchv+0x1219>
    1378:	00 
    1379:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 1381 <_Z5benchv+0x1221>
    1380:	00 
    1381:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1388 <_Z5benchv+0x1228>
    1388:	01 c0                	add    %eax,%eax
    138a:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    1390:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    1394:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    1398:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    139d:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    13a1:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    13a5:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    13a9:	5b                   	pop    %rbx
    13aa:	c5 f8 77             	vzeroupper 
    13ad:	c3                   	retq   
    13ae:	90                   	nop
    13af:	90                   	nop
...
00000000000013b0 <_Z6enablev>:
    ...
    13b7:	b8 70 00 00 00       	mov    $0x70,%eax
    13bc:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
    13c1:	0f 45 c8             	cmovne %eax,%ecx
    13c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 13ca <_Z6enablev+0x1a>
    13ca:	0f 9e c1             	setle  %cl
    13cd:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 13d4 <_Z6enablev+0x24>
...
00000000000013e0 <_Z9n_reg_maxv>:
    13e0:	b8 c1 01 00 00       	mov    $0x1c1,%eax
    13e5:	c3                   	retq   

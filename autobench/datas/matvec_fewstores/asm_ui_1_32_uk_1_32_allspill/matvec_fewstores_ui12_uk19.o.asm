...
matvec_fewstores_ui12_uk19.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 183:	0f 8e 7e 0a 00 00    	jle    c07 <_Z5benchv+0xab7>
 ...
 21f:	0f 83 e2 09 00 00    	jae    c07 <_Z5benchv+0xab7>
 ...
 b83:	48 83 c3 13          	add    $0x13,%rbx
 b87:	48 0f af f0          	imul   %rax,%rsi
 b8b:	48 01 fe             	add    %rdi,%rsi
 b8e:	c4 e2 15 b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm3
 b94:	c4 e2 15 b8 6c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm5
 b9b:	c4 e2 15 b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm7
 ba2:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
 ba9:	c4 e2 15 b8 8c b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm1
 bb0:	00 00 00 
 bb3:	c4 e2 15 b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm2
 bba:	00 00 00 
 bbd:	c4 e2 15 b8 a4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm4
 bc4:	00 00 00 
 bc7:	c4 e2 15 b8 b4 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm6
 bce:	00 00 00 
 bd1:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
 bd8:	01 00 00 
 bdb:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
 be2:	01 00 00 
 be5:	c4 62 15 b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm11
 bec:	01 00 00 
 bef:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm12
 bf6:	01 00 00 
 bf9:	4c 39 c3             	cmp    %r8,%rbx
 bfc:	0f 8c ae f6 ff ff    	jl     2b0 <_Z5benchv+0x160>
 c02:	e9 a9 f5 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 c07:	0f 31                	rdtsc  
 c09:	48 c1 e2 20          	shl    $0x20,%rdx
 c0d:	48 09 c2             	or     %rax,%rdx
 c10:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # c16 <_Z5benchv+0xac6>
 c16:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 c1b:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # c23 <_Z5benchv+0xad3>
 c22:	00 
 c23:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # c2b <_Z5benchv+0xadb>
 c2a:	00 
 c2b:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # c32 <_Z5benchv+0xae2>
 c32:	01 c0                	add    %eax,%eax
 c34:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 c3a:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 c3e:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 c42:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 c46:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 c4a:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 c4e:	5b                   	pop    %rbx
 c4f:	41 5e                	pop    %r14
 c51:	c5 f8 77             	vzeroupper 
 c54:	c3                   	retq   
 c55:	90                   	nop
 c56:	90                   	nop
 c57:	90                   	nop
...
0000000000000c60 <_Z6enablev>:
 ...
 c67:	b8 60 00 00 00       	mov    $0x60,%eax
 c6c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
...
0000000000000c90 <_Z9n_reg_maxv>:
 c90:	b8 03 01 00 00       	mov    $0x103,%eax
 c95:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui12_uk19.cpp+0x9a>
  96:	01 00 00 00 

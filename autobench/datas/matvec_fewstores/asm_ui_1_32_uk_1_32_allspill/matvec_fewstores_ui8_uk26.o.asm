...
matvec_fewstores_ui8_uk26.o:     file format elf64-x86-64
...
0000000000000140 <_Z5benchv>:
 ...
 17a:	0f 8e 94 09 00 00    	jle    b14 <_Z5benchv+0x9d4>
 ...
 1dc:	0f 83 32 09 00 00    	jae    b14 <_Z5benchv+0x9d4>
 ...
 ab8:	48 83 c3 1a          	add    $0x1a,%rbx
 abc:	48 0f af e8          	imul   %rax,%rbp
 ac0:	48 01 f5             	add    %rsi,%rbp
 ac3:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 ac9:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 ad0:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 ad7:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 ade:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 ae5:	00 00 00 
 ae8:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 aef:	00 00 00 
 af2:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 af9:	00 00 00 
 afc:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 b03:	00 00 00 
 b06:	48 39 fb             	cmp    %rdi,%rbx
 b09:	0f 8c 51 f7 ff ff    	jl     260 <_Z5benchv+0x120>
 b0f:	e9 8c f6 ff ff       	jmpq   1a0 <_Z5benchv+0x60>
 b14:	0f 31                	rdtsc  
 b16:	48 c1 e2 20          	shl    $0x20,%rdx
 b1a:	48 09 c2             	or     %rax,%rdx
 b1d:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b23 <_Z5benchv+0x9e3>
 b23:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 b28:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # b30 <_Z5benchv+0x9f0>
 b2f:	00 
 b30:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # b38 <_Z5benchv+0x9f8>
 b37:	00 
 b38:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b3f <_Z5benchv+0x9ff>
 b3f:	01 c0                	add    %eax,%eax
 b41:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b47:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b4b:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 b4f:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
...
0000000000000b70 <_Z6enablev>:
 ...
 b77:	b8 40 00 00 00       	mov    $0x40,%eax
 b7c:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 b81:	0f 45 c8             	cmovne %eax,%ecx
 b84:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b8a <_Z6enablev+0x1a>
 b8a:	0f 9e c1             	setle  %cl
 b8d:	83 3d 00 00 00 00 19 	cmpl   $0x19,0x0(%rip)        # b94 <_Z6enablev+0x24>
...
0000000000000ba0 <_Z9n_reg_maxv>:
 ba0:	b8 f2 00 00 00       	mov    $0xf2,%eax
 ba5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui8_uk26.cpp+0x9a>
  96:	01 00 00 00 

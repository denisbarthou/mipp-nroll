...
0000000000000160 <_Z5benchv>:
     ...
     1a3:	0f 8e 1a 38 00 00    	jle    39c3 <_Z5benchv+0x3863>
     ...
     38f:	0f 83 2e 36 00 00    	jae    39c3 <_Z5benchv+0x3863>
    ...
    3792:	48 83 c3 1b          	add    $0x1b,%rbx
    3796:	48 0f af f0          	imul   %rax,%rsi
    379a:	48 01 fe             	add    %rdi,%rsi
    379d:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm3
    37a4:	00 00 00 
    37a7:	c4 e2 15 b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm2
    37ae:	c4 e2 15 b8 64 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm4
    37b5:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
    37bc:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
    37c3:	01 00 00 
    37c6:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
    37cd:	01 00 00 
    37d0:	c4 e2 15 b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm6
    37d7:	01 00 00 
    37da:	c4 62 15 b8 9c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm13,%ymm11
    37e1:	02 00 00 
    37e4:	c4 e2 15 b8 ac b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm13,%ymm5
    37eb:	02 00 00 
    37ee:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm13,%ymm12
    37f5:	03 00 00 
    37f8:	c4 e2 15 b8 04 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm0
    37fe:	c4 62 15 b8 b4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm14
    3805:	00 00 00 
    3808:	c4 62 15 b8 bc b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm15
    380f:	00 00 00 
    3812:	c4 e2 15 b8 8c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm1
    3819:	00 00 00 
    381c:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    3822:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    3828:	c4 e2 15 b8 bc b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm7
    382f:	01 00 00 
    3832:	c5 fc 11 9c 24 80 01 	vmovups %ymm3,0x180(%rsp)
    3839:	00 00 
    383b:	c5 fc 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm3
    3842:	00 00 
    3844:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm13,%ymm3
    384b:	01 00 00 
    384e:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    3854:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    385a:	c4 e2 15 b8 bc b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm13,%ymm7
    3861:	01 00 00 
    3864:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    386b:	00 00 
    386d:	c5 fc 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm3
    3874:	00 00 
    3876:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm13,%ymm3
    387d:	01 00 00 
    3880:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    3886:	c5 fc 28 fa          	vmovaps %ymm2,%ymm7
    388a:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    3890:	c5 fc 11 9c 24 c0 00 	vmovups %ymm3,0xc0(%rsp)
    3897:	00 00 
    3899:	c5 fc 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm3
    38a0:	00 00 
    38a2:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm13,%ymm3
    38a9:	01 00 00 
    38ac:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    38b3:	00 00 
    38b5:	c5 fc 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm3
    38bc:	00 00 
    38be:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm13,%ymm3
    38c5:	02 00 00 
    38c8:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    38cf:	00 00 
    38d1:	c5 fc 10 5c 24 60    	vmovups 0x60(%rsp),%ymm3
    38d7:	c4 e2 15 b8 9c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm13,%ymm3
    38de:	02 00 00 
    38e1:	c5 fc 11 5c 24 60    	vmovups %ymm3,0x60(%rsp)
    38e7:	c5 fc 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm3
    38ee:	00 00 
    38f0:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm13,%ymm3
    38f7:	02 00 00 
    38fa:	c5 fc 11 9c 24 80 00 	vmovups %ymm3,0x80(%rsp)
    3901:	00 00 
    3903:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    390a:	00 00 
    390c:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm13,%ymm3
    3913:	02 00 00 
    3916:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    391d:	00 00 
    391f:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    3924:	c4 e2 15 b8 9c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm13,%ymm3
    392b:	02 00 00 
    392e:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    3933:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    3939:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm13,%ymm3
    3940:	02 00 00 
    3943:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    3949:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    394f:	c4 e2 15 b8 9c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm13,%ymm3
    3956:	03 00 00 
    3959:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    395f:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    3965:	c4 e2 15 b8 9c b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm13,%ymm3
    396c:	03 00 00 
    396f:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    3975:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    397b:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm13,%ymm3
    3982:	03 00 00 
    3985:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    398b:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    398f:	c5 7c 29 c4          	vmovaps %ymm8,%ymm4
    3993:	c4 41 7c 28 c3       	vmovaps %ymm11,%ymm8
    3998:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    399d:	c4 41 7c 28 e1       	vmovaps %ymm9,%ymm12
    39a2:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    39a7:	c5 7c 28 d5          	vmovaps %ymm5,%ymm10
    39ab:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    39af:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    39b5:	4c 39 c3             	cmp    %r8,%rbx
    39b8:	0f 8c 02 cc ff ff    	jl     5c0 <_Z5benchv+0x460>
    39be:	e9 58 c8 ff ff       	jmpq   21b <_Z5benchv+0xbb>
    39c3:	0f 31                	rdtsc  
    39c5:	48 c1 e2 20          	shl    $0x20,%rdx
    39c9:	48 09 c2             	or     %rax,%rdx
    39cc:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 39d2 <_Z5benchv+0x3872>
    39d2:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    39d7:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 39df <_Z5benchv+0x387f>
    39de:	00 
    39df:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 39e7 <_Z5benchv+0x3887>
    39e6:	00 
    39e7:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 39ee <_Z5benchv+0x388e>
    39ee:	01 c0                	add    %eax,%eax
    39f0:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    39f6:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    39fa:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    3a01:	00 00 
    3a03:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    3a08:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    3a0c:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3a10:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3a14:	48 81 c4 68 02 00 00 	add    $0x268,%rsp
    3a1b:	5b                   	pop    %rbx
    3a1c:	41 5e                	pop    %r14
...
0000000000003a30 <_Z6enablev>:
    ...
    3a4d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 3a54 <_Z6enablev+0x24>
...
0000000000003a60 <_Z9n_reg_maxv>:
    3a60:	b8 2b 03 00 00       	mov    $0x32b,%eax
    3a65:	c3                   	retq   

...
0000000000001450 <_Z6enablev>:
    ...
    1457:	b8 40 00 00 00       	mov    $0x40,%eax
    145c:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
    1461:	0f 45 c8             	cmovne %eax,%ecx
    1464:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 146a <_Z6enablev+0x1a>
    146a:	0f 9e c1             	setle  %cl
    146d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 1474 <_Z6enablev+0x24>
...
0000000000001480 <_Z9n_reg_maxv>:
    1480:	b8 c5 00 00 00       	mov    $0xc5,%eax
    1485:	c3                   	retq   

...
0000000000000160 <_Z5benchv>:
     ...
     1aa:	0f 8e 69 2e 00 00    	jle    3019 <_Z5benchv+0x2eb9>
     ...
     324:	0f 83 ef 2c 00 00    	jae    3019 <_Z5benchv+0x2eb9>
    ...
    2e4b:	48 83 c3 1d          	add    $0x1d,%rbx
    2e4f:	48 0f af e8          	imul   %rax,%rbp
    2e53:	48 01 fd             	add    %rdi,%rbp
    2e56:	c4 e2 35 b8 9c a9 a0 	vfmadd231ps 0x1a0(%rcx,%rbp,4),%ymm9,%ymm3
    2e5d:	01 00 00 
    2e60:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm6
    2e67:	00 00 00 
    2e6a:	c4 e2 35 b8 8c a9 e0 	vfmadd231ps 0x2e0(%rcx,%rbp,4),%ymm9,%ymm1
    2e71:	02 00 00 
    2e74:	c4 62 35 b8 2c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm13
    2e7a:	c4 62 35 b8 74 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm14
    2e81:	c4 62 35 b8 7c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm15
    2e88:	c4 e2 35 b8 94 a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm2
    2e8f:	00 00 00 
    2e92:	c4 62 35 b8 94 a9 00 	vfmadd231ps 0x100(%rcx,%rbp,4),%ymm9,%ymm10
    2e99:	01 00 00 
    2e9c:	c4 62 35 b8 9c a9 20 	vfmadd231ps 0x120(%rcx,%rbp,4),%ymm9,%ymm11
    2ea3:	01 00 00 
    2ea6:	c4 62 35 b8 a4 a9 40 	vfmadd231ps 0x140(%rcx,%rbp,4),%ymm9,%ymm12
    2ead:	01 00 00 
    2eb0:	c4 62 35 b8 84 a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm8
    2eb7:	00 00 00 
    2eba:	c4 e2 35 b8 a4 a9 80 	vfmadd231ps 0x180(%rcx,%rbp,4),%ymm9,%ymm4
    2ec1:	01 00 00 
    2ec4:	c4 e2 35 b8 7c a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm7
    2ecb:	c4 e2 35 b8 ac a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm5
    2ed2:	00 00 00 
    2ed5:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    2edb:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    2ee2:	00 00 
    2ee4:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    2eeb:	00 00 
    2eed:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x1c0(%rcx,%rbp,4),%ymm9,%ymm3
    2ef4:	01 00 00 
    2ef7:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    2efe:	00 00 
    2f00:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    2f06:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x160(%rcx,%rbp,4),%ymm9,%ymm6
    2f0d:	01 00 00 
    2f10:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    2f17:	00 00 
    2f19:	c5 7c 29 d1          	vmovaps %ymm10,%ymm1
    2f1d:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    2f22:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    2f27:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    2f2c:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    2f31:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    2f36:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    2f3a:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    2f41:	00 00 
    2f43:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    2f48:	c4 e2 35 b8 9c a9 00 	vfmadd231ps 0x200(%rcx,%rbp,4),%ymm9,%ymm3
    2f4f:	02 00 00 
    2f52:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    2f58:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2f5f:	00 00 
    2f61:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0x1e0(%rcx,%rbp,4),%ymm9,%ymm6
    2f68:	01 00 00 
    2f6b:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    2f71:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    2f76:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    2f7c:	c4 e2 35 b8 9c a9 40 	vfmadd231ps 0x240(%rcx,%rbp,4),%ymm9,%ymm3
    2f83:	02 00 00 
    2f86:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    2f8d:	00 00 
    2f8f:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    2f95:	c4 e2 35 b8 b4 a9 20 	vfmadd231ps 0x220(%rcx,%rbp,4),%ymm9,%ymm6
    2f9c:	02 00 00 
    2f9f:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    2fa5:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    2fab:	c4 e2 35 b8 9c a9 80 	vfmadd231ps 0x280(%rcx,%rbp,4),%ymm9,%ymm3
    2fb2:	02 00 00 
    2fb5:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    2fbb:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    2fc1:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x260(%rcx,%rbp,4),%ymm9,%ymm6
    2fc8:	02 00 00 
    2fcb:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    2fd1:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    2fd7:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x2c0(%rcx,%rbp,4),%ymm9,%ymm3
    2fde:	02 00 00 
    2fe1:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    2fe7:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2fed:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0x2a0(%rcx,%rbp,4),%ymm9,%ymm6
    2ff4:	02 00 00 
    2ff7:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    2ffb:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    3001:	c5 7c 29 c3          	vmovaps %ymm8,%ymm3
    3005:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    300b:	4c 39 c3             	cmp    %r8,%rbx
    300e:	0f 8c bc d4 ff ff    	jl     4d0 <_Z5benchv+0x370>
    3014:	e9 ec d1 ff ff       	jmpq   205 <_Z5benchv+0xa5>
    3019:	0f 31                	rdtsc  
    301b:	48 c1 e2 20          	shl    $0x20,%rdx
    301f:	48 09 c2             	or     %rax,%rdx
    3022:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3028 <_Z5benchv+0x2ec8>
    3028:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    302d:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3035 <_Z5benchv+0x2ed5>
    3034:	00 
    3035:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 303d <_Z5benchv+0x2edd>
    303c:	00 
    303d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3044 <_Z5benchv+0x2ee4>
    3044:	01 c0                	add    %eax,%eax
    3046:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    304c:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3050:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    3057:	00 00 
    3059:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    305d:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    3061:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3065:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3069:	48 81 c4 a8 01 00 00 	add    $0x1a8,%rsp
    3070:	5b                   	pop    %rbx
    3071:	41 5c                	pop    %r12
    3073:	41 5d                	pop    %r13
    3075:	41 5e                	pop    %r14
...
0000000000003080 <_Z6enablev>:
    ...
    3087:	b8 c0 00 00 00       	mov    $0xc0,%eax
    308c:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    3091:	0f 45 c8             	cmovne %eax,%ecx
    3094:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 309a <_Z6enablev+0x1a>
    309a:	0f 9e c1             	setle  %cl
    309d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 30a4 <_Z6enablev+0x24>
...
00000000000030b0 <_Z9n_reg_maxv>:
    30b0:	b8 ed 02 00 00       	mov    $0x2ed,%eax
    30b5:	c3                   	retq   

...
0000000000000ab0 <_Z6enablev>:
 ...
 ab7:	b8 70 00 00 00       	mov    $0x70,%eax
 abc:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 ac1:	0f 45 c8             	cmovne %eax,%ecx
 ac4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # aca <_Z6enablev+0x1a>
 aca:	0f 9e c1             	setle  %cl
 acd:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # ad4 <_Z6enablev+0x24>
...
0000000000000ae0 <_Z9n_reg_maxv>:
 ae0:	b8 95 00 00 00       	mov    $0x95,%eax
 ae5:	c3                   	retq   

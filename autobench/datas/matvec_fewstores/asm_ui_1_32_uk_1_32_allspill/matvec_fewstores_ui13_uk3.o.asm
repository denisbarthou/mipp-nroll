...
00000000000004b0 <_Z6enablev>:
 ...
 4b7:	b8 68 00 00 00       	mov    $0x68,%eax
 4bc:	b9 f3 ff ff ff       	mov    $0xfffffff3,%ecx
 4c1:	0f 45 c8             	cmovne %eax,%ecx
 4c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 4ca <_Z6enablev+0x1a>
 4ca:	0f 9e c1             	setle  %cl
 4cd:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 4d4 <_Z6enablev+0x24>
...
00000000000004e0 <_Z9n_reg_maxv>:
 4e0:	b8 37 00 00 00       	mov    $0x37,%eax
 4e5:	c3                   	retq   

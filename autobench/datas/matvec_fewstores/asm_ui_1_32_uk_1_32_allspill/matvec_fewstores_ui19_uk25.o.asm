...
0000000000001dd0 <_Z6enablev>:
    ...
    1dd7:	b8 98 00 00 00       	mov    $0x98,%eax
    1ddc:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    1de1:	0f 45 c8             	cmovne %eax,%ecx
    1de4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1dea <_Z6enablev+0x1a>
    1dea:	0f 9e c1             	setle  %cl
    1ded:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 1df4 <_Z6enablev+0x24>
...
0000000000001e00 <_Z9n_reg_maxv>:
    1e00:	b8 07 02 00 00       	mov    $0x207,%eax
    1e05:	c3                   	retq   

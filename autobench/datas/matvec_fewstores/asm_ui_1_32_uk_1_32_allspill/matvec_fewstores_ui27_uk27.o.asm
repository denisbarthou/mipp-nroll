...
matvec_fewstores_ui27_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e cb 34 00 00    	jle    3663 <_Z5benchv+0x3513>
     ...
     35d:	0f 83 00 33 00 00    	jae    3663 <_Z5benchv+0x3513>
    ...
    3441:	48 83 c6 1b          	add    $0x1b,%rsi
    3445:	49 0f af c2          	imul   %r10,%rax
    3449:	48 01 f8             	add    %rdi,%rax
    344c:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm12,%ymm4
    3453:	02 00 00 
    3456:	c4 e2 1d b8 94 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm2
    345d:	00 00 00 
    3460:	c4 e2 1d b8 9c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm3
    3467:	00 00 00 
    346a:	c4 e2 1d b8 ac 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm5
    3471:	00 00 00 
    3474:	c4 62 1d b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm10
    347b:	00 00 00 
    347e:	c4 62 1d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm8
    3485:	01 00 00 
    3488:	c4 e2 1d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm12,%ymm6
    348f:	01 00 00 
    3492:	c4 62 1d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm12,%ymm9
    3499:	02 00 00 
    349c:	c4 62 1d b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm12,%ymm11
    34a3:	02 00 00 
    34a6:	c4 e2 1d b8 84 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm12,%ymm0
    34ad:	03 00 00 
    34b0:	c4 62 1d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm13
    34b6:	c4 62 1d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm14
    34bd:	c4 62 1d b8 7c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm15
    34c4:	c4 e2 1d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm1
    34cb:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    34d1:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    34d7:	c4 e2 1d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm7
    34de:	01 00 00 
    34e1:	c5 fc 11 a4 24 80 01 	vmovups %ymm4,0x180(%rsp)
    34e8:	00 00 
    34ea:	c5 fc 10 a4 24 00 01 	vmovups 0x100(%rsp),%ymm4
    34f1:	00 00 
    34f3:	c4 e2 1d b8 a4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm12,%ymm4
    34fa:	02 00 00 
    34fd:	c5 fc 11 84 24 a0 01 	vmovups %ymm0,0x1a0(%rsp)
    3504:	00 00 
    3506:	c5 7c 29 e8          	vmovaps %ymm13,%ymm0
    350a:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    3510:	c5 fc 10 bc 24 e0 00 	vmovups 0xe0(%rsp),%ymm7
    3517:	00 00 
    3519:	c4 e2 1d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm7
    3520:	01 00 00 
    3523:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    352a:	00 00 
    352c:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    3532:	c4 e2 1d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm12,%ymm4
    3539:	02 00 00 
    353c:	c5 fc 11 bc 24 e0 00 	vmovups %ymm7,0xe0(%rsp)
    3543:	00 00 
    3545:	c5 fc 10 bc 24 a0 00 	vmovups 0xa0(%rsp),%ymm7
    354c:	00 00 
    354e:	c4 e2 1d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm12,%ymm7
    3555:	01 00 00 
    3558:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    355e:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    3564:	c4 e2 1d b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm12,%ymm4
    356b:	02 00 00 
    356e:	c5 fc 11 bc 24 a0 00 	vmovups %ymm7,0xa0(%rsp)
    3575:	00 00 
    3577:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    357d:	c4 e2 1d b8 bc 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm12,%ymm7
    3584:	01 00 00 
    3587:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    358d:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    3594:	00 00 
    3596:	c4 e2 1d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm12,%ymm4
    359d:	02 00 00 
    35a0:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    35a6:	c5 fc 10 bc 24 c0 00 	vmovups 0xc0(%rsp),%ymm7
    35ad:	00 00 
    35af:	c4 e2 1d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm12,%ymm7
    35b6:	01 00 00 
    35b9:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    35c0:	00 00 
    35c2:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    35c8:	c4 e2 1d b8 a4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm12,%ymm4
    35cf:	02 00 00 
    35d2:	c5 fc 11 bc 24 c0 00 	vmovups %ymm7,0xc0(%rsp)
    35d9:	00 00 
    35db:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    35e1:	c4 e2 1d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm12,%ymm7
    35e8:	01 00 00 
    35eb:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    35f1:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    35f6:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm12,%ymm4
    35fd:	03 00 00 
    3600:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    3606:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    360a:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    360e:	c5 7c 29 c5          	vmovaps %ymm8,%ymm5
    3612:	c5 7c 10 44 24 c0    	vmovups -0x40(%rsp),%ymm8
    3618:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    361d:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    3623:	c4 e2 1d b8 a4 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm12,%ymm4
    362a:	03 00 00 
    362d:	c5 7c 28 e2          	vmovaps %ymm2,%ymm12
    3631:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    3637:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    363d:	c5 7c 29 cc          	vmovaps %ymm9,%ymm4
    3641:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    3646:	c4 41 7c 28 da       	vmovaps %ymm10,%ymm11
    364b:	c5 7c 28 d6          	vmovaps %ymm6,%ymm10
    364f:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    3655:	4c 39 c6             	cmp    %r8,%rsi
    3658:	0f 8c e2 ce ff ff    	jl     540 <_Z5benchv+0x3f0>
    365e:	e9 93 cb ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    3663:	0f 31                	rdtsc  
    3665:	48 c1 e2 20          	shl    $0x20,%rdx
    3669:	48 09 c2             	or     %rax,%rdx
    366c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3672 <_Z5benchv+0x3522>
    3672:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3677:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 367f <_Z5benchv+0x352f>
    367e:	00 
    367f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3687 <_Z5benchv+0x3537>
    3686:	00 
    3687:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 368e <_Z5benchv+0x353e>
    368e:	01 c0                	add    %eax,%eax
    3690:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3696:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    369a:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    36a1:	00 00 
    36a3:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    36a8:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    36ac:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    36b0:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    36b4:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
    36bb:	c5 f8 77             	vzeroupper 
    36be:	c3                   	retq   
    36bf:	90                   	nop

00000000000036c0 <_Z6enablev>:
    36c0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 36c7 <_Z6enablev+0x7>
    36c7:	b8 d8 00 00 00       	mov    $0xd8,%eax
    36cc:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    36d1:	0f 45 c8             	cmovne %eax,%ecx
    36d4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 36da <_Z6enablev+0x1a>
    36da:	0f 9e c1             	setle  %cl
    36dd:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 36e4 <_Z6enablev+0x24>
    36e4:	0f 9f c0             	setg   %al
    36e7:	20 c8                	and    %cl,%al
    36e9:	c3                   	retq   
    36ea:	90                   	nop
    36eb:	90                   	nop
    36ec:	90                   	nop
...
00000000000036f0 <_Z9n_reg_maxv>:
    36f0:	b8 0f 03 00 00       	mov    $0x30f,%eax
    36f5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui27_uk27.cpp+0x9a>
  96:	01 00 00 00 

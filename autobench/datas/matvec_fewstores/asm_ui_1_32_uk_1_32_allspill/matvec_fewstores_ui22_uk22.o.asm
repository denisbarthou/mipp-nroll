...
matvec_fewstores_ui22_uk22.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e f6 1e 00 00    	jle    208e <_Z5benchv+0x1f3e>
     ...
     2ee:	0f 83 9a 1d 00 00    	jae    208e <_Z5benchv+0x1f3e>
    ...
    1ee4:	48 83 c6 16          	add    $0x16,%rsi
    1ee8:	49 0f af c3          	imul   %r11,%rax
    1eec:	48 01 f8             	add    %rdi,%rax
    1eef:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm7,%ymm3
    1ef6:	01 00 00 
    ...
    1f81:	00 00 00 
    1f84:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    1f8b:	00 00 
    1f8d:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    1f93:	c4 e2 45 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm7,%ymm3
    1f9a:	01 00 00 
    1f9d:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    1fa4:	00 00 
    1fa6:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    1fad:	00 00 
    1faf:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    1fb6:	00 00 
    1fb8:	c5 fc 11 ac 24 00 01 	vmovups %ymm5,0x100(%rsp)
    1fbf:	00 00 
    1fc1:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    1fc7:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    1fcd:	c4 e2 45 b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm7,%ymm2
    1fd4:	01 00 00 
    1fd7:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    1fdd:	c5 fc 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm3
    1fe3:	c4 e2 45 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm7,%ymm3
    1fea:	02 00 00 
    1fed:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    1ff3:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    1ff8:	c4 e2 45 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm7,%ymm2
    1fff:	02 00 00 
    2002:	c5 fc 11 5c 24 a0    	vmovups %ymm3,-0x60(%rsp)
    2008:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    200e:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm7,%ymm3
    2015:	02 00 00 
    2018:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    201d:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    2023:	c4 e2 45 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm7,%ymm2
    202a:	02 00 00 
    202d:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    2033:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    2039:	c5 fc 10 54 24 c0    	vmovups -0x40(%rsp),%ymm2
    203f:	c4 e2 45 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm7,%ymm2
    2046:	02 00 00 
    2049:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    204d:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    2052:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    2057:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    205c:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    2061:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    2066:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    206b:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    2070:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    2074:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    207a:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    2080:	4c 39 c6             	cmp    %r8,%rsi
    2083:	0f 8c a7 e3 ff ff    	jl     430 <_Z5benchv+0x2e0>
    2089:	e9 32 e1 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    208e:	0f 31                	rdtsc  
    2090:	48 c1 e2 20          	shl    $0x20,%rdx
    2094:	48 09 c2             	or     %rax,%rdx
    2097:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 209d <_Z5benchv+0x1f4d>
    209d:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    20a2:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 20aa <_Z5benchv+0x1f5a>
    20a9:	00 
    20aa:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 20b2 <_Z5benchv+0x1f62>
    20b1:	00 
    20b2:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 20b9 <_Z5benchv+0x1f69>
    20b9:	01 c0                	add    %eax,%eax
    20bb:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    20c1:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    20c5:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    20cc:	00 00 
    20ce:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    20d2:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    20d6:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    20da:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    20de:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
...
00000000000020f0 <_Z6enablev>:
    ...
    20f7:	b8 b0 00 00 00       	mov    $0xb0,%eax
    20fc:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    2101:	0f 45 c8             	cmovne %eax,%ecx
    2104:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 210a <_Z6enablev+0x1a>
    210a:	0f 9e c1             	setle  %cl
    210d:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 2114 <_Z6enablev+0x24>
...
0000000000002120 <_Z9n_reg_maxv>:
    2120:	b8 10 02 00 00       	mov    $0x210,%eax
    2125:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui22_uk22.cpp+0x9a>
  96:	01 00 00 00 

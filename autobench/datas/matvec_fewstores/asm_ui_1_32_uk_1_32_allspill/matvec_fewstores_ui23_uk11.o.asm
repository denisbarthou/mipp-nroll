...
0000000000001490 <_Z6enablev>:
    ...
    1497:	b8 b8 00 00 00       	mov    $0xb8,%eax
    149c:	b9 e9 ff ff ff       	mov    $0xffffffe9,%ecx
    14a1:	0f 45 c8             	cmovne %eax,%ecx
    14a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 14aa <_Z6enablev+0x1a>
    14aa:	0f 9e c1             	setle  %cl
    14ad:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 14b4 <_Z6enablev+0x24>
...
00000000000014c0 <_Z9n_reg_maxv>:
    14c0:	b8 1f 01 00 00       	mov    $0x11f,%eax
    14c5:	c3                   	retq   

...
0000000000000a90 <_Z6enablev>:
 ...
 a97:	b8 20 00 00 00       	mov    $0x20,%eax
 a9c:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 aa1:	0f 45 c8             	cmovne %eax,%ecx
 aa4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # aaa <_Z6enablev+0x1a>
 aaa:	0f 9e c1             	setle  %cl
 aad:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # ab4 <_Z6enablev+0x24>
...
0000000000000ac0 <_Z9n_reg_maxv>:
 ac0:	b8 7c 00 00 00       	mov    $0x7c,%eax
 ac5:	c3                   	retq   

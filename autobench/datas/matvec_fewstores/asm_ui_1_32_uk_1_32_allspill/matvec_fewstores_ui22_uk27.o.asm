...
matvec_fewstores_ui22_uk27.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 2f 25 00 00    	jle    26c7 <_Z5benchv+0x2577>
     ...
     2ee:	0f 83 d3 23 00 00    	jae    26c7 <_Z5benchv+0x2577>
    ...
    251d:	48 83 c6 1b          	add    $0x1b,%rsi
    2521:	49 0f af c3          	imul   %r11,%rax
    2525:	48 01 f8             	add    %rdi,%rax
    2528:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm7,%ymm3
    252f:	01 00 00 
    2532:	c4 62 45 b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm8
    2538:	c4 e2 45 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm1
    253f:	c4 62 45 b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm9
    2546:	c4 62 45 b8 54 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm10
    254d:	c4 62 45 b8 9c 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm11
    2554:	00 00 00 
    2557:	c4 62 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm13
    255e:	00 00 00 
    2561:	c4 62 45 b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm7,%ymm15
    2568:	00 00 00 
    256b:	c4 62 45 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm7,%ymm12
    2572:	01 00 00 
    2575:	c4 62 45 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm7,%ymm14
    257c:	01 00 00 
    257f:	c4 e2 45 b8 84 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm7,%ymm0
    2586:	01 00 00 
    2589:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm7,%ymm4
    2590:	01 00 00 
    2593:	c4 e2 45 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm7,%ymm6
    259a:	01 00 00 
    259d:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm7,%ymm5
    25a4:	02 00 00 
    25a7:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    25ad:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    25b3:	c4 e2 45 b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm7,%ymm2
    25ba:	00 00 00 
    25bd:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    25c4:	00 00 
    25c6:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    25cc:	c4 e2 45 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm7,%ymm3
    25d3:	01 00 00 
    25d6:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    25dd:	00 00 
    25df:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    25e6:	00 00 
    25e8:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    25ef:	00 00 
    25f1:	c5 fc 11 ac 24 00 01 	vmovups %ymm5,0x100(%rsp)
    25f8:	00 00 
    25fa:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    2600:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    2606:	c4 e2 45 b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm7,%ymm2
    260d:	01 00 00 
    2610:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    2616:	c5 fc 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm3
    261c:	c4 e2 45 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm7,%ymm3
    2623:	02 00 00 
    2626:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    262c:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    2631:	c4 e2 45 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm7,%ymm2
    2638:	02 00 00 
    263b:	c5 fc 11 5c 24 a0    	vmovups %ymm3,-0x60(%rsp)
    2641:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    2647:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm7,%ymm3
    264e:	02 00 00 
    2651:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    2656:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    265c:	c4 e2 45 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm7,%ymm2
    2663:	02 00 00 
    2666:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    266c:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    2672:	c5 fc 10 54 24 c0    	vmovups -0x40(%rsp),%ymm2
    2678:	c4 e2 45 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm7,%ymm2
    267f:	02 00 00 
    2682:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    2686:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    268b:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    2690:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    2695:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    269a:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    269f:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    26a4:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    26a9:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    26ad:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    26b3:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    26b9:	4c 39 c6             	cmp    %r8,%rsi
    26bc:	0f 8c 6e dd ff ff    	jl     430 <_Z5benchv+0x2e0>
    26c2:	e9 f9 da ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    26c7:	0f 31                	rdtsc  
    26c9:	48 c1 e2 20          	shl    $0x20,%rdx
    26cd:	48 09 c2             	or     %rax,%rdx
    26d0:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 26d6 <_Z5benchv+0x2586>
    26d6:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    26db:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 26e3 <_Z5benchv+0x2593>
    26e2:	00 
    26e3:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 26eb <_Z5benchv+0x259b>
    26ea:	00 
    26eb:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 26f2 <_Z5benchv+0x25a2>
    26f2:	01 c0                	add    %eax,%eax
    26f4:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    26fa:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    26fe:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    2705:	00 00 
    2707:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    270b:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    270f:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2713:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2717:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
...
0000000000002730 <_Z6enablev>:
    2730:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 2737 <_Z6enablev+0x7>
    2737:	b8 b0 00 00 00       	mov    $0xb0,%eax
    273c:	b9 ea ff ff ff       	mov    $0xffffffea,%ecx
    2741:	0f 45 c8             	cmovne %eax,%ecx
    2744:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 274a <_Z6enablev+0x1a>
    274a:	0f 9e c1             	setle  %cl
    274d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 2754 <_Z6enablev+0x24>
    2754:	0f 9f c0             	setg   %al
    2757:	20 c8                	and    %cl,%al
    2759:	c3                   	retq   
    275a:	90                   	nop
    275b:	90                   	nop
    275c:	90                   	nop
...
0000000000002760 <_Z9n_reg_maxv>:
    2760:	b8 83 02 00 00       	mov    $0x283,%eax
    2765:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui22_uk27.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000540 <_Z6enablev>:
 ...
 547:	b8 48 00 00 00       	mov    $0x48,%eax
 54c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 551:	0f 45 c8             	cmovne %eax,%ecx
 554:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 55a <_Z6enablev+0x1a>
 55a:	0f 9e c1             	setle  %cl
 55d:	83 3d 00 00 00 00 05 	cmpl   $0x5,0x0(%rip)        # 564 <_Z6enablev+0x24>
...
0000000000000570 <_Z9n_reg_maxv>:
 570:	b8 45 00 00 00       	mov    $0x45,%eax
 575:	c3                   	retq   

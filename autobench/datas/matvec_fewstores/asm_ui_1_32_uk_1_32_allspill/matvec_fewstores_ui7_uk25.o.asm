...
matvec_fewstores_ui7_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 1b 08 00 00    	jle    9a3 <_Z5benchv+0x853>
 ...
 1f0:	0f 83 ad 07 00 00    	jae    9a3 <_Z5benchv+0x853>
 ...
 951:	48 83 c7 19          	add    $0x19,%rdi
 955:	49 0f af c3          	imul   %r11,%rax
 959:	48 01 f0             	add    %rsi,%rax
 95c:	c4 e2 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm1
 962:	c4 e2 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm2
 969:	c4 e2 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm3
 970:	c4 e2 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm4
 977:	c4 e2 3d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm5
 97e:	00 00 00 
 981:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm6
 988:	00 00 00 
 98b:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
 992:	00 00 00 
 995:	4c 39 cf             	cmp    %r9,%rdi
 998:	0f 8c a2 f8 ff ff    	jl     240 <_Z5benchv+0xf0>
 99e:	e9 0d f8 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 9a3:	0f 31                	rdtsc  
 9a5:	48 c1 e2 20          	shl    $0x20,%rdx
 9a9:	48 09 c2             	or     %rax,%rdx
 9ac:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 9b2 <_Z5benchv+0x862>
 9b2:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 9b7:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 9bf <_Z5benchv+0x86f>
 9be:	00 
 9bf:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 9c7 <_Z5benchv+0x877>
 9c6:	00 
 9c7:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 9ce <_Z5benchv+0x87e>
 9ce:	01 c0                	add    %eax,%eax
 9d0:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 9d6:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 9da:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 9de:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
 9e2:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 9e6:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 9ea:	c5 f8 77             	vzeroupper 
 9ed:	c3                   	retq   
 9ee:	90                   	nop
 9ef:	90                   	nop
...
00000000000009f0 <_Z6enablev>:
 ...
 9f7:	b8 38 00 00 00       	mov    $0x38,%eax
 9fc:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
 a01:	0f 45 c8             	cmovne %eax,%ecx
 a04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a0a <_Z6enablev+0x1a>
 a0a:	0f 9e c1             	setle  %cl
 a0d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # a14 <_Z6enablev+0x24>
...
0000000000000a20 <_Z9n_reg_maxv>:
 a20:	b8 cf 00 00 00       	mov    $0xcf,%eax
 a25:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui7_uk25.cpp+0x9a>
  96:	01 00 00 00 

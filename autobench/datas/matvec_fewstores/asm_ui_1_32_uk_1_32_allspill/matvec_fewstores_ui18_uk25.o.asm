...
matvec_fewstores_ui18_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e ae 19 00 00    	jle    1b43 <_Z5benchv+0x19f3>
     ...
     2b6:	0f 83 87 18 00 00    	jae    1b43 <_Z5benchv+0x19f3>
    ...
    186d:	00 00 00 
    1870:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
    1877:	01 00 00 
    187a:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
    1881:	01 00 00 
    1884:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
    188b:	01 00 00 
    188e:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
    1895:	01 00 00 
    1898:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
    189f:	02 00 00 
    18a2:	c4 e2 65 b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm1
    18a9:	02 00 00 
    18ac:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    18b2:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    18b8:	c4 e2 65 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm0
    18bf:	00 00 00 
    18c2:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    18c8:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    18ce:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
    18d5:	01 00 00 
    18d8:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    18de:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    18e4:	c4 e2 65 b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm0
    18eb:	01 00 00 
    18ee:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    18f4:	c5 7c 29 e0          	vmovaps %ymm12,%ymm0
    18f8:	c4 e2 65 b8 84 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm0
    18ff:	01 00 00 
    1902:	c5 7c 10 64 24 e0    	vmovups -0x20(%rsp),%ymm12
    1908:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    190d:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    1913:	c4 e2 65 b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm0
    191a:	01 00 00 
    191d:	48 8d 46 17          	lea    0x17(%rsi),%rax
    1921:	c4 e2 7d 18 5c b2 5c 	vbroadcastss 0x5c(%rdx,%rsi,4),%ymm3
    1928:	49 0f af c3          	imul   %r11,%rax
    192c:	48 01 f8             	add    %rdi,%rax
    192f:	c4 62 65 b8 a4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm12
    1936:	01 00 00 
    1939:	c4 e2 65 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm3,%ymm4
    193f:	c4 62 65 b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm3,%ymm10
    1946:	c4 e2 65 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm3,%ymm5
    194d:	c4 e2 65 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm3,%ymm6
    1954:	c4 62 65 b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm3,%ymm8
    195b:	00 00 00 
    195e:	c4 e2 65 b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm3,%ymm7
    1965:	00 00 00 
    1968:	c4 62 65 b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm3,%ymm9
    196f:	00 00 00 
    1972:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
    1979:	01 00 00 
    197c:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
    1983:	01 00 00 
    1986:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
    198d:	01 00 00 
    1990:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
    1997:	01 00 00 
    199a:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
    19a1:	02 00 00 
    19a4:	c4 e2 65 b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm1
    19ab:	02 00 00 
    19ae:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    19b4:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    19ba:	c4 e2 65 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm0
    19c1:	00 00 00 
    19c4:	c5 7c 11 64 24 e0    	vmovups %ymm12,-0x20(%rsp)
    19ca:	c5 7c 10 24 24       	vmovups (%rsp),%ymm12
    19cf:	c4 62 65 b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm12
    19d6:	01 00 00 
    19d9:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    19df:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    19e5:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
    19ec:	01 00 00 
    19ef:	c5 7c 11 24 24       	vmovups %ymm12,(%rsp)
    19f4:	c5 7c 10 64 24 c0    	vmovups -0x40(%rsp),%ymm12
    19fa:	c4 62 65 b8 a4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm12
    1a01:	01 00 00 
    1a04:	48 8d 46 18          	lea    0x18(%rsi),%rax
    1a08:	c4 e2 7d 18 5c b2 60 	vbroadcastss 0x60(%rdx,%rsi,4),%ymm3
    1a0f:	48 83 c6 19          	add    $0x19,%rsi
    1a13:	49 0f af c3          	imul   %r11,%rax
    1a17:	48 01 f8             	add    %rdi,%rax
    1a1a:	c4 62 65 b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm3,%ymm10
    1a21:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
    1a28:	01 00 00 
    1a2b:	c4 e2 65 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm3,%ymm4
    ...
    1a5a:	00 00 00 
    1a5d:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
    1a64:	01 00 00 
    1a67:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
    1a6e:	01 00 00 
    1a71:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
    1a78:	01 00 00 
    1a7b:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
    1a82:	02 00 00 
    1a85:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
    1a8c:	01 00 00 
    1a8f:	c4 e2 65 b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm1
    1a96:	02 00 00 
    1a99:	c5 7c 11 64 24 c0    	vmovups %ymm12,-0x40(%rsp)
    1a9f:	c5 7c 10 24 24       	vmovups (%rsp),%ymm12
    1aa4:	c4 62 65 b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm12
    1aab:	01 00 00 
    1aae:	c5 7c 11 54 24 60    	vmovups %ymm10,0x60(%rsp)
    1ab4:	c5 7c 10 54 24 80    	vmovups -0x80(%rsp),%ymm10
    1aba:	c4 62 65 b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm10
    1ac1:	00 00 00 
    1ac4:	c5 7c 11 9c 24 80 00 	vmovups %ymm11,0x80(%rsp)
    1acb:	00 00 
    1acd:	c5 7c 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm11
    1ad3:	c4 62 65 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm11
    1ada:	01 00 00 
    1add:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    1ae3:	c5 7c 11 b4 24 a0 00 	vmovups %ymm14,0xa0(%rsp)
    1aea:	00 00 
    1aec:	c5 7c 11 6c 24 20    	vmovups %ymm13,0x20(%rsp)
    1af2:	c5 7c 11 bc 24 c0 00 	vmovups %ymm15,0xc0(%rsp)
    1af9:	00 00 
    1afb:	c5 7c 11 24 24       	vmovups %ymm12,(%rsp)
    1b00:	c5 7c 11 54 24 80    	vmovups %ymm10,-0x80(%rsp)
    1b06:	c5 7c 10 54 24 e0    	vmovups -0x20(%rsp),%ymm10
    1b0c:	c4 62 65 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm10
    1b13:	01 00 00 
    1b16:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    1b1a:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    1b1e:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    1b22:	c5 fc 28 f7          	vmovaps %ymm7,%ymm6
    1b26:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    1b2a:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    1b2f:	c5 7c 11 5c 24 c0    	vmovups %ymm11,-0x40(%rsp)
    1b35:	4c 39 c6             	cmp    %r8,%rsi
    1b38:	0f 8c 82 e8 ff ff    	jl     3c0 <_Z5benchv+0x270>
    1b3e:	e9 85 e6 ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    1b43:	0f 31                	rdtsc  
    1b45:	48 c1 e2 20          	shl    $0x20,%rdx
    1b49:	48 09 c2             	or     %rax,%rdx
    1b4c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1b52 <_Z5benchv+0x1a02>
    1b52:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1b57:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1b5f <_Z5benchv+0x1a0f>
    1b5e:	00 
    1b5f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1b67 <_Z5benchv+0x1a17>
    1b66:	00 
    1b67:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1b6e <_Z5benchv+0x1a1e>
    1b6e:	01 c0                	add    %eax,%eax
    1b70:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1b76:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1b7a:	c5 fb 5c 44 24 58    	vsubsd 0x58(%rsp),%xmm0,%xmm0
    1b80:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    1b85:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    1b89:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1b8d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1b91:	48 81 c4 f8 00 00 00 	add    $0xf8,%rsp
    1b98:	c5 f8 77             	vzeroupper 
    1b9b:	c3                   	retq   
    1b9c:	90                   	nop
    1b9d:	90                   	nop
    1b9e:	90                   	nop
...
0000000000001ba0 <_Z6enablev>:
    ...
    1ba7:	b8 90 00 00 00       	mov    $0x90,%eax
    1bac:	b9 ee ff ff ff       	mov    $0xffffffee,%ecx
    1bb1:	0f 45 c8             	cmovne %eax,%ecx
    1bb4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1bba <_Z6enablev+0x1a>
    1bba:	0f 9e c1             	setle  %cl
    1bbd:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 1bc4 <_Z6enablev+0x24>
...
0000000000001bd0 <_Z9n_reg_maxv>:
    1bd0:	b8 ed 01 00 00       	mov    $0x1ed,%eax
    1bd5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui18_uk25.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000001120 <_Z6enablev>:
    ...
    1127:	b8 38 00 00 00       	mov    $0x38,%eax
    112c:	b9 f9 ff ff ff       	mov    $0xfffffff9,%ecx
    1131:	0f 45 c8             	cmovne %eax,%ecx
    1134:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 113a <_Z6enablev+0x1a>
    113a:	0f 9e c1             	setle  %cl
    113d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 1144 <_Z6enablev+0x24>
...
0000000000001150 <_Z9n_reg_maxv>:
    1150:	b8 af 00 00 00       	mov    $0xaf,%eax
    1155:	c3                   	retq   

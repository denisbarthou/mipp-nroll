...
0000000000000920 <_Z6enablev>:
 ...
 927:	b8 50 00 00 00       	mov    $0x50,%eax
 92c:	b9 f6 ff ff ff       	mov    $0xfffffff6,%ecx
 931:	0f 45 c8             	cmovne %eax,%ecx
 934:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 93a <_Z6enablev+0x1a>
 93a:	0f 9e c1             	setle  %cl
 93d:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # 944 <_Z6enablev+0x24>
...
0000000000000950 <_Z9n_reg_maxv>:
 950:	b8 78 00 00 00       	mov    $0x78,%eax
 955:	c3                   	retq   

...
0000000000001140 <_Z6enablev>:
    1140:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1147 <_Z6enablev+0x7>
    1147:	b8 98 00 00 00       	mov    $0x98,%eax
    114c:	b9 ed ff ff ff       	mov    $0xffffffed,%ecx
    1151:	0f 45 c8             	cmovne %eax,%ecx
    1154:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 115a <_Z6enablev+0x1a>
    115a:	0f 9e c1             	setle  %cl
    115d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # 1164 <_Z6enablev+0x24>
    1164:	0f 9f c0             	setg   %al
    1167:	20 c8                	and    %cl,%al
    1169:	c3                   	retq   
    116a:	90                   	nop
    116b:	90                   	nop
    116c:	90                   	nop
...
0000000000001170 <_Z9n_reg_maxv>:
    1170:	b8 03 01 00 00       	mov    $0x103,%eax
    1175:	c3                   	retq   

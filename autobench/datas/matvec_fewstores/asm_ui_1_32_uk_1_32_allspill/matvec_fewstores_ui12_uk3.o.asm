...
0000000000000470 <_Z6enablev>:
 ...
 477:	b8 60 00 00 00       	mov    $0x60,%eax
 47c:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 481:	0f 45 c8             	cmovne %eax,%ecx
 484:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 48a <_Z6enablev+0x1a>
 48a:	0f 9e c1             	setle  %cl
 48d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 494 <_Z6enablev+0x24>
...
00000000000004a0 <_Z9n_reg_maxv>:
 4a0:	b8 33 00 00 00       	mov    $0x33,%eax
 4a5:	c3                   	retq   

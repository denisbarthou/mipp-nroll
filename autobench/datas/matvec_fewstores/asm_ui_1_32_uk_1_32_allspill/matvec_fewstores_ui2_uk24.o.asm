...
0000000000000590 <_Z6enablev>:
 ...
 597:	b8 10 00 00 00       	mov    $0x10,%eax
 59c:	b9 fe ff ff ff       	mov    $0xfffffffe,%ecx
 5a1:	0f 45 c8             	cmovne %eax,%ecx
 5a4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 5aa <_Z6enablev+0x1a>
 5aa:	0f 9e c1             	setle  %cl
 5ad:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 5b4 <_Z6enablev+0x24>
...
00000000000005c0 <_Z9n_reg_maxv>:
 5c0:	b8 4a 00 00 00       	mov    $0x4a,%eax
 5c5:	c3                   	retq   

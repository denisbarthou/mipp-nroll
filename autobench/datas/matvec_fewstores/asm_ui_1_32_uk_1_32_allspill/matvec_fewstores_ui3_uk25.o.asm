...
0000000000000850 <_Z6enablev>:
 ...
 857:	b8 18 00 00 00       	mov    $0x18,%eax
 85c:	b9 fd ff ff ff       	mov    $0xfffffffd,%ecx
 861:	0f 45 c8             	cmovne %eax,%ecx
 864:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 86a <_Z6enablev+0x1a>
 86a:	0f 9e c1             	setle  %cl
 86d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 874 <_Z6enablev+0x24>
...
0000000000000880 <_Z9n_reg_maxv>:
 880:	b8 67 00 00 00       	mov    $0x67,%eax
 885:	c3                   	retq   

...
00000000000013b0 <_Z6enablev>:
    ...
    13b7:	b8 78 00 00 00       	mov    $0x78,%eax
    13bc:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
    13c1:	0f 45 c8             	cmovne %eax,%ecx
    13c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 13ca <_Z6enablev+0x1a>
    13ca:	0f 9e c1             	setle  %cl
    13cd:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 13d4 <_Z6enablev+0x24>
...
00000000000013e0 <_Z9n_reg_maxv>:
    13e0:	b8 bf 01 00 00       	mov    $0x1bf,%eax
    13e5:	c3                   	retq   

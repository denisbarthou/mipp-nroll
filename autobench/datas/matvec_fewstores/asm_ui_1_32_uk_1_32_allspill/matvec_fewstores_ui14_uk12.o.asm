...
0000000000000e80 <_Z6enablev>:
 e80:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # e87 <_Z6enablev+0x7>
 e87:	b8 70 00 00 00       	mov    $0x70,%eax
 e8c:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
 e91:	0f 45 c8             	cmovne %eax,%ecx
 e94:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # e9a <_Z6enablev+0x1a>
 e9a:	0f 9e c1             	setle  %cl
 e9d:	83 3d 00 00 00 00 0b 	cmpl   $0xb,0x0(%rip)        # ea4 <_Z6enablev+0x24>
 ea4:	0f 9f c0             	setg   %al
 ea7:	20 c8                	and    %cl,%al
 ea9:	c3                   	retq   
 eaa:	90                   	nop
 eab:	90                   	nop
...
0000000000000eb0 <_Z9n_reg_maxv>:
 eb0:	b8 c2 00 00 00       	mov    $0xc2,%eax
 eb5:	c3                   	retq   

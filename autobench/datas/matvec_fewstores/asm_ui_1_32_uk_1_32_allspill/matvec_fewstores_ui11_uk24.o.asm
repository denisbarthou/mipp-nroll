...
0000000000000dd0 <_Z6enablev>:
 ...
 dd7:	b8 58 00 00 00       	mov    $0x58,%eax
 ddc:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 de1:	0f 45 c8             	cmovne %eax,%ecx
 de4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # dea <_Z6enablev+0x1a>
 dea:	0f 9e c1             	setle  %cl
 ded:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # df4 <_Z6enablev+0x24>
...
0000000000000e00 <_Z9n_reg_maxv>:
 e00:	b8 2b 01 00 00       	mov    $0x12b,%eax
 e05:	c3                   	retq   

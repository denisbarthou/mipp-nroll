...
0000000000000160 <_Z5benchv>:
     ...
     1a3:	0f 8e e8 3b 00 00    	jle    3d91 <_Z5benchv+0x3c31>
     ...
     38f:	0f 83 fc 39 00 00    	jae    3d91 <_Z5benchv+0x3c31>
    ...
    3b60:	48 83 c3 1d          	add    $0x1d,%rbx
    3b64:	48 0f af f0          	imul   %rax,%rsi
    3b68:	48 01 fe             	add    %rdi,%rsi
    3b6b:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm3
    3b72:	00 00 00 
    3b75:	c4 e2 15 b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm2
    3b7c:	c4 e2 15 b8 64 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm4
    3b83:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
    3b8a:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
    3b91:	01 00 00 
    3b94:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
    3b9b:	01 00 00 
    3b9e:	c4 e2 15 b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm6
    3ba5:	01 00 00 
    3ba8:	c4 62 15 b8 9c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm13,%ymm11
    3baf:	02 00 00 
    3bb2:	c4 e2 15 b8 ac b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm13,%ymm5
    3bb9:	02 00 00 
    3bbc:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm13,%ymm12
    3bc3:	03 00 00 
    3bc6:	c4 e2 15 b8 04 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm0
    3bcc:	c4 62 15 b8 b4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm14
    3bd3:	00 00 00 
    3bd6:	c4 62 15 b8 bc b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm15
    3bdd:	00 00 00 
    3be0:	c4 e2 15 b8 8c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm1
    3be7:	00 00 00 
    3bea:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    3bf0:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    3bf6:	c4 e2 15 b8 bc b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm7
    3bfd:	01 00 00 
    3c00:	c5 fc 11 9c 24 80 01 	vmovups %ymm3,0x180(%rsp)
    3c07:	00 00 
    3c09:	c5 fc 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm3
    3c10:	00 00 
    3c12:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm13,%ymm3
    3c19:	01 00 00 
    3c1c:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    3c22:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    3c28:	c4 e2 15 b8 bc b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm13,%ymm7
    3c2f:	01 00 00 
    3c32:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    3c39:	00 00 
    3c3b:	c5 fc 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm3
    3c42:	00 00 
    3c44:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm13,%ymm3
    3c4b:	01 00 00 
    3c4e:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    3c54:	c5 fc 28 fa          	vmovaps %ymm2,%ymm7
    3c58:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    3c5e:	c5 fc 11 9c 24 c0 00 	vmovups %ymm3,0xc0(%rsp)
    3c65:	00 00 
    3c67:	c5 fc 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm3
    3c6e:	00 00 
    3c70:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm13,%ymm3
    3c77:	01 00 00 
    3c7a:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    3c81:	00 00 
    3c83:	c5 fc 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm3
    3c8a:	00 00 
    3c8c:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm13,%ymm3
    3c93:	02 00 00 
    3c96:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    3c9d:	00 00 
    3c9f:	c5 fc 10 5c 24 60    	vmovups 0x60(%rsp),%ymm3
    3ca5:	c4 e2 15 b8 9c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm13,%ymm3
    3cac:	02 00 00 
    3caf:	c5 fc 11 5c 24 60    	vmovups %ymm3,0x60(%rsp)
    3cb5:	c5 fc 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm3
    3cbc:	00 00 
    3cbe:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm13,%ymm3
    3cc5:	02 00 00 
    3cc8:	c5 fc 11 9c 24 80 00 	vmovups %ymm3,0x80(%rsp)
    3ccf:	00 00 
    3cd1:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    3cd8:	00 00 
    3cda:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm13,%ymm3
    3ce1:	02 00 00 
    3ce4:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    3ceb:	00 00 
    3ced:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    3cf2:	c4 e2 15 b8 9c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm13,%ymm3
    3cf9:	02 00 00 
    3cfc:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    3d01:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    3d07:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm13,%ymm3
    3d0e:	02 00 00 
    3d11:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    3d17:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    3d1d:	c4 e2 15 b8 9c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm13,%ymm3
    3d24:	03 00 00 
    3d27:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    3d2d:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    3d33:	c4 e2 15 b8 9c b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm13,%ymm3
    3d3a:	03 00 00 
    3d3d:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    3d43:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    3d49:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm13,%ymm3
    3d50:	03 00 00 
    3d53:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    3d59:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    3d5d:	c5 7c 29 c4          	vmovaps %ymm8,%ymm4
    3d61:	c4 41 7c 28 c3       	vmovaps %ymm11,%ymm8
    3d66:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    3d6b:	c4 41 7c 28 e1       	vmovaps %ymm9,%ymm12
    3d70:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    3d75:	c5 7c 28 d5          	vmovaps %ymm5,%ymm10
    3d79:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    3d7d:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    3d83:	4c 39 c3             	cmp    %r8,%rbx
    3d86:	0f 8c 34 c8 ff ff    	jl     5c0 <_Z5benchv+0x460>
    3d8c:	e9 8a c4 ff ff       	jmpq   21b <_Z5benchv+0xbb>
    3d91:	0f 31                	rdtsc  
    3d93:	48 c1 e2 20          	shl    $0x20,%rdx
    3d97:	48 09 c2             	or     %rax,%rdx
    3d9a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3da0 <_Z5benchv+0x3c40>
    3da0:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3da5:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3dad <_Z5benchv+0x3c4d>
    3dac:	00 
    3dad:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3db5 <_Z5benchv+0x3c55>
    3db4:	00 
    3db5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3dbc <_Z5benchv+0x3c5c>
    3dbc:	01 c0                	add    %eax,%eax
    3dbe:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3dc4:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3dc8:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    3dcf:	00 00 
    3dd1:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    3dd6:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    3dda:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3dde:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3de2:	48 81 c4 68 02 00 00 	add    $0x268,%rsp
    3de9:	5b                   	pop    %rbx
    3dea:	41 5e                	pop    %r14
    3dec:	c5 f8 77             	vzeroupper 
    3def:	c3                   	retq   

0000000000003df0 <_Z6enablev>:
    3df0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3df7 <_Z6enablev+0x7>
    3df7:	b8 e0 00 00 00       	mov    $0xe0,%eax
    3dfc:	b9 e4 ff ff ff       	mov    $0xffffffe4,%ecx
    3e01:	0f 45 c8             	cmovne %eax,%ecx
    3e04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 3e0a <_Z6enablev+0x1a>
    3e0a:	0f 9e c1             	setle  %cl
    3e0d:	83 3d 00 00 00 00 1c 	cmpl   $0x1c,0x0(%rip)        # 3e14 <_Z6enablev+0x24>
...
0000000000003e20 <_Z9n_reg_maxv>:
    3e20:	b8 65 03 00 00       	mov    $0x365,%eax
    3e25:	c3                   	retq   

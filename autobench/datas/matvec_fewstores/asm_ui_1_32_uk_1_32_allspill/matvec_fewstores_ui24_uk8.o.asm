...
0000000000001270 <_Z6enablev>:
    ...
    1277:	b8 c0 00 00 00       	mov    $0xc0,%eax
    127c:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    1281:	0f 45 c8             	cmovne %eax,%ecx
    1284:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 128a <_Z6enablev+0x1a>
    128a:	0f 9e c1             	setle  %cl
    128d:	83 3d 00 00 00 00 07 	cmpl   $0x7,0x0(%rip)        # 1294 <_Z6enablev+0x24>
...
00000000000012a0 <_Z9n_reg_maxv>:
    12a0:	b8 e0 00 00 00       	mov    $0xe0,%eax
    12a5:	c3                   	retq   

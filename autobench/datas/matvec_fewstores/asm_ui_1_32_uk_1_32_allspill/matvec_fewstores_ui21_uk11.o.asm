...
00000000000011d0 <_Z6enablev>:
    ...
    11d7:	b8 a8 00 00 00       	mov    $0xa8,%eax
    11dc:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    11e1:	0f 45 c8             	cmovne %eax,%ecx
    11e4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 11ea <_Z6enablev+0x1a>
    11ea:	0f 9e c1             	setle  %cl
    11ed:	83 3d 00 00 00 00 0a 	cmpl   $0xa,0x0(%rip)        # 11f4 <_Z6enablev+0x24>
...
0000000000001200 <_Z9n_reg_maxv>:
    1200:	b8 07 01 00 00       	mov    $0x107,%eax
    1205:	c3                   	retq   

...
0000000000000e60 <_Z6enablev>:
 ...
 e67:	b8 58 00 00 00       	mov    $0x58,%eax
 e6c:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 e71:	0f 45 c8             	cmovne %eax,%ecx
 e74:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # e7a <_Z6enablev+0x1a>
 e7a:	0f 9e c1             	setle  %cl
 e7d:	83 3d 00 00 00 00 0e 	cmpl   $0xe,0x0(%rip)        # e84 <_Z6enablev+0x24>
...
0000000000000e90 <_Z9n_reg_maxv>:
 e90:	b8 bf 00 00 00       	mov    $0xbf,%eax
 e95:	c3                   	retq   

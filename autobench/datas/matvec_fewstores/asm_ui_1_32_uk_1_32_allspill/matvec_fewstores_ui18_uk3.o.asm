...
0000000000000780 <_Z6enablev>:
 ...
 787:	b8 90 00 00 00       	mov    $0x90,%eax
 78c:	b9 ee ff ff ff       	mov    $0xffffffee,%ecx
 791:	0f 45 c8             	cmovne %eax,%ecx
 794:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 79a <_Z6enablev+0x1a>
 79a:	0f 9e c1             	setle  %cl
 79d:	83 3d 00 00 00 00 02 	cmpl   $0x2,0x0(%rip)        # 7a4 <_Z6enablev+0x24>
...
00000000000007b0 <_Z9n_reg_maxv>:
 7b0:	b8 4b 00 00 00       	mov    $0x4b,%eax
 7b5:	c3                   	retq   

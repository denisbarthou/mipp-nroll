...
0000000000001d70 <_Z6enablev>:
    1d70:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1d77 <_Z6enablev+0x7>
    1d77:	b8 90 00 00 00       	mov    $0x90,%eax
    1d7c:	b9 ee ff ff ff       	mov    $0xffffffee,%ecx
    1d81:	0f 45 c8             	cmovne %eax,%ecx
    1d84:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1d8a <_Z6enablev+0x1a>
    1d8a:	0f 9e c1             	setle  %cl
    1d8d:	83 3d 00 00 00 00 1a 	cmpl   $0x1a,0x0(%rip)        # 1d94 <_Z6enablev+0x24>
    1d94:	0f 9f c0             	setg   %al
    1d97:	20 c8                	and    %cl,%al
    1d99:	c3                   	retq   
    1d9a:	90                   	nop
    1d9b:	90                   	nop
    1d9c:	90                   	nop
...
0000000000001da0 <_Z9n_reg_maxv>:
    1da0:	b8 13 02 00 00       	mov    $0x213,%eax
    1da5:	c3                   	retq   

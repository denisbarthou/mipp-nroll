...
0000000000003070 <_Z6enablev>:
    3070:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 3077 <_Z6enablev+0x7>
    3077:	b8 d0 00 00 00       	mov    $0xd0,%eax
    307c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    3081:	0f 45 c8             	cmovne %eax,%ecx
    3084:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 308a <_Z6enablev+0x1a>
    308a:	0f 9e c1             	setle  %cl
    308d:	83 3d 00 00 00 00 18 	cmpl   $0x18,0x0(%rip)        # 3094 <_Z6enablev+0x24>
    3094:	0f 9f c0             	setg   %al
    3097:	20 c8                	and    %cl,%al
    3099:	c3                   	retq   
    309a:	90                   	nop
    309b:	90                   	nop
    309c:	90                   	nop
...
00000000000030a0 <_Z9n_reg_maxv>:
    30a0:	b8 bd 02 00 00       	mov    $0x2bd,%eax
    30a5:	c3                   	retq   

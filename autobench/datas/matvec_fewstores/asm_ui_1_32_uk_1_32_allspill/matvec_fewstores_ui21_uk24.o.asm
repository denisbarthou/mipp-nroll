...
0000000000002240 <_Z6enablev>:
    ...
    2247:	b8 a8 00 00 00       	mov    $0xa8,%eax
    224c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    2251:	0f 45 c8             	cmovne %eax,%ecx
    2254:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 225a <_Z6enablev+0x1a>
    225a:	0f 9e c1             	setle  %cl
    225d:	83 3d 00 00 00 00 17 	cmpl   $0x17,0x0(%rip)        # 2264 <_Z6enablev+0x24>
...
0000000000002270 <_Z9n_reg_maxv>:
    2270:	b8 25 02 00 00       	mov    $0x225,%eax
    2275:	c3                   	retq   

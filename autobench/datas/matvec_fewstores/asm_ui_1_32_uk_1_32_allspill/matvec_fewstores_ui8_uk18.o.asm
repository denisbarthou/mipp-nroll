...
0000000000000d40 <_Z6enablev>:
 ...
 d47:	b8 40 00 00 00       	mov    $0x40,%eax
 d4c:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
 d51:	0f 45 c8             	cmovne %eax,%ecx
 d54:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # d5a <_Z6enablev+0x1a>
 d5a:	0f 9e c1             	setle  %cl
 d5d:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # d64 <_Z6enablev+0x24>
...
0000000000000d70 <_Z9n_reg_maxv>:
 d70:	b8 aa 00 00 00       	mov    $0xaa,%eax
 d75:	c3                   	retq   

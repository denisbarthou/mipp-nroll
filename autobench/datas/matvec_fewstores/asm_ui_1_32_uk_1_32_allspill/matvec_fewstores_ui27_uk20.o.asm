...
0000000000002a20 <_Z6enablev>:
    ...
    2a27:	b8 d8 00 00 00       	mov    $0xd8,%eax
    2a2c:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    2a31:	0f 45 c8             	cmovne %eax,%ecx
    2a34:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 2a3a <_Z6enablev+0x1a>
    2a3a:	0f 9e c1             	setle  %cl
    2a3d:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # 2a44 <_Z6enablev+0x24>
...
0000000000002a50 <_Z9n_reg_maxv>:
    2a50:	b8 4b 02 00 00       	mov    $0x24b,%eax
    2a55:	c3                   	retq   

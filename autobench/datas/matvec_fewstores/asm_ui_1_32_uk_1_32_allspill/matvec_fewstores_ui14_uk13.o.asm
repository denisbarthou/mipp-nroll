...
0000000000000fe0 <_Z6enablev>:
     ...
     fe7:	b8 70 00 00 00       	mov    $0x70,%eax
     fec:	b9 f2 ff ff ff       	mov    $0xfffffff2,%ecx
     ff1:	0f 45 c8             	cmovne %eax,%ecx
     ff4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # ffa <_Z6enablev+0x1a>
     ffa:	0f 9e c1             	setle  %cl
     ffd:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 1004 <_Z6enablev+0x24>
...
0000000000001010 <_Z9n_reg_maxv>:
    1010:	b8 d1 00 00 00       	mov    $0xd1,%eax
    1015:	c3                   	retq   

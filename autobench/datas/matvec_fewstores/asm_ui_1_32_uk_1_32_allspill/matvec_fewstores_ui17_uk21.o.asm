...
0000000000000160 <_Z5benchv>:
     ...
     19c:	0f 8e 61 13 00 00    	jle    1503 <_Z5benchv+0x13a3>
     ...
     29c:	0f 83 61 12 00 00    	jae    1503 <_Z5benchv+0x13a3>
    ...
    127e:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    1285:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    128c:	00 00 00 
    128f:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1296:	00 00 00 
    1299:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    12a0:	00 00 00 
    12a3:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    12aa:	00 00 00 
    12ad:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    12b4:	01 00 00 
    12b7:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    12be:	01 00 00 
    12c1:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    12c8:	01 00 00 
    12cb:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
    12d2:	01 00 00 
    12d5:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    12dc:	01 00 00 
    12df:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
    12e6:	01 00 00 
    12e9:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    12f0:	02 00 00 
    12f3:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    12f9:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    12ff:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
    1306:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    130c:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    1312:	c4 e2 6d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm1
    1319:	01 00 00 
    131c:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    1322:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    1328:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
    132f:	01 00 00 
    ...
    1351:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    1358:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    135f:	00 00 00 
    1362:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1369:	00 00 00 
    136c:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1373:	00 00 00 
    1376:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    137d:	00 00 00 
    1380:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1387:	01 00 00 
    138a:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1391:	01 00 00 
    1394:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    139b:	01 00 00 
    139e:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
    13a5:	01 00 00 
    13a8:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    13af:	01 00 00 
    13b2:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
    13b9:	01 00 00 
    13bc:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    13c3:	02 00 00 
    13c6:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    13cc:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    13d2:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
    13d9:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    13df:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    13e5:	c4 e2 6d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm1
    13ec:	01 00 00 
    13ef:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    13f5:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    13fb:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
    1402:	01 00 00 
    1405:	48 8d 46 14          	lea    0x14(%rsi),%rax
    1409:	c4 e2 7d 18 54 b2 50 	vbroadcastss 0x50(%rdx,%rsi,4),%ymm2
    1410:	48 83 c6 15          	add    $0x15,%rsi
    1414:	49 0f af c2          	imul   %r10,%rax
    1418:	48 01 f8             	add    %rdi,%rax
    141b:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    1422:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1428:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    142f:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
    1436:	01 00 00 
    1439:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
    1440:	01 00 00 
    1443:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    144a:	00 00 00 
    144d:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1454:	00 00 00 
    1457:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    145e:	00 00 00 
    1461:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    1468:	00 00 00 
    146b:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1472:	01 00 00 
    1475:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    147c:	01 00 00 
    147f:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    1486:	01 00 00 
    1489:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    1490:	01 00 00 
    1493:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    149a:	02 00 00 
    149d:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    14a3:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    14a9:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
    14b0:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    14b5:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    14bb:	c4 e2 6d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm5
    14c2:	01 00 00 
    14c5:	c5 7c 11 64 24 20    	vmovups %ymm12,0x20(%rsp)
    14cb:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
    14d1:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    14d7:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    14dd:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
    14e4:	01 00 00 
    14e7:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    14eb:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    14ef:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    14f5:	4c 39 c6             	cmp    %r8,%rsi
    14f8:	0f 8c 72 ee ff ff    	jl     370 <_Z5benchv+0x210>
    14fe:	e9 d5 ec ff ff       	jmpq   1d8 <_Z5benchv+0x78>
    1503:	0f 31                	rdtsc  
    1505:	48 c1 e2 20          	shl    $0x20,%rdx
    1509:	48 09 c2             	or     %rax,%rdx
    150c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1512 <_Z5benchv+0x13b2>
    1512:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1517:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 151f <_Z5benchv+0x13bf>
    151e:	00 
    151f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1527 <_Z5benchv+0x13c7>
    1526:	00 
    1527:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 152e <_Z5benchv+0x13ce>
    152e:	01 c0                	add    %eax,%eax
    1530:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1536:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    153a:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1540:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    1545:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    1549:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    154d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1551:	48 83 c4 78          	add    $0x78,%rsp
    1555:	c5 f8 77             	vzeroupper 
    1558:	c3                   	retq   
    1559:	90                   	nop
    155a:	90                   	nop
    155b:	90                   	nop
...
0000000000001560 <_Z6enablev>:
    ...
    1567:	b8 88 00 00 00       	mov    $0x88,%eax
    156c:	b9 ef ff ff ff       	mov    $0xffffffef,%ecx
    1571:	0f 45 c8             	cmovne %eax,%ecx
    1574:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 157a <_Z6enablev+0x1a>
    157a:	0f 9e c1             	setle  %cl
    157d:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 1584 <_Z6enablev+0x24>
...
0000000000001590 <_Z9n_reg_maxv>:
    1590:	b8 8b 01 00 00       	mov    $0x18b,%eax
    1595:	c3                   	retq   

...
00000000000026c0 <_Z6enablev>:
    ...
    26c7:	b8 d8 00 00 00       	mov    $0xd8,%eax
    26cc:	b9 e5 ff ff ff       	mov    $0xffffffe5,%ecx
    26d1:	0f 45 c8             	cmovne %eax,%ecx
    26d4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 26da <_Z6enablev+0x1a>
    26da:	0f 9e c1             	setle  %cl
    26dd:	83 3d 00 00 00 00 11 	cmpl   $0x11,0x0(%rip)        # 26e4 <_Z6enablev+0x24>
...
00000000000026f0 <_Z9n_reg_maxv>:
    26f0:	b8 13 02 00 00       	mov    $0x213,%eax
    26f5:	c3                   	retq   

...
0000000000001220 <_Z6enablev>:
    ...
    1227:	b8 c0 00 00 00       	mov    $0xc0,%eax
    122c:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    1231:	0f 45 c8             	cmovne %eax,%ecx
    1234:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 123a <_Z6enablev+0x1a>
    123a:	0f 9e c1             	setle  %cl
    123d:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 1244 <_Z6enablev+0x24>
...
0000000000001250 <_Z9n_reg_maxv>:
    1250:	b8 c7 00 00 00       	mov    $0xc7,%eax
    1255:	c3                   	retq   

...
00000000000008b0 <_Z6enablev>:
 ...
 8b7:	b8 20 00 00 00       	mov    $0x20,%eax
 8bc:	b9 fc ff ff ff       	mov    $0xfffffffc,%ecx
 8c1:	0f 45 c8             	cmovne %eax,%ecx
 8c4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 8ca <_Z6enablev+0x1a>
 8ca:	0f 9e c1             	setle  %cl
 8cd:	83 3d 00 00 00 00 14 	cmpl   $0x14,0x0(%rip)        # 8d4 <_Z6enablev+0x24>
...
00000000000008e0 <_Z9n_reg_maxv>:
 8e0:	b8 6d 00 00 00       	mov    $0x6d,%eax
 8e5:	c3                   	retq   

...
0000000000001140 <_Z6enablev>:
    ...
    1147:	b8 a8 00 00 00       	mov    $0xa8,%eax
    114c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    1151:	0f 45 c8             	cmovne %eax,%ecx
    1154:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 115a <_Z6enablev+0x1a>
    115a:	0f 9e c1             	setle  %cl
    115d:	83 3d 00 00 00 00 08 	cmpl   $0x8,0x0(%rip)        # 1164 <_Z6enablev+0x24>
...
0000000000001170 <_Z9n_reg_maxv>:
    1170:	b8 db 00 00 00       	mov    $0xdb,%eax
    1175:	c3                   	retq   

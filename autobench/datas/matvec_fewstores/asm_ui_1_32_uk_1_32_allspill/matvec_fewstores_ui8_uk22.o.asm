...
00000000000014e0 <_Z6enablev>:
    14e0:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 14e7 <_Z6enablev+0x7>
    14e7:	b8 40 00 00 00       	mov    $0x40,%eax
    14ec:	b9 f8 ff ff ff       	mov    $0xfffffff8,%ecx
    14f1:	0f 45 c8             	cmovne %eax,%ecx
    14f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 14fa <_Z6enablev+0x1a>
    14fa:	0f 9e c1             	setle  %cl
    14fd:	83 3d 00 00 00 00 15 	cmpl   $0x15,0x0(%rip)        # 1504 <_Z6enablev+0x24>
    1504:	0f 9f c0             	setg   %al
    1507:	20 c8                	and    %cl,%al
    1509:	c3                   	retq   
    150a:	90                   	nop
    150b:	90                   	nop
    150c:	90                   	nop
...
0000000000001510 <_Z9n_reg_maxv>:
    1510:	b8 ce 00 00 00       	mov    $0xce,%eax
    1515:	c3                   	retq   

...
matvec_fewstores_ui24_uk13.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     19a:	0f 8e f9 16 00 00    	jle    1899 <_Z5benchv+0x1749>
     ...
     314:	0f 83 7f 15 00 00    	jae    1899 <_Z5benchv+0x1749>
    ...
    16cb:	48 83 c3 0d          	add    $0xd,%rbx
    16cf:	48 0f af e8          	imul   %rax,%rbp
    16d3:	48 01 fd             	add    %rdi,%rbp
    16d6:	c4 e2 35 b8 9c a9 a0 	vfmadd231ps 0x1a0(%rcx,%rbp,4),%ymm9,%ymm3
    16dd:	01 00 00 
    16e0:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm6
    16e7:	00 00 00 
    16ea:	c4 e2 35 b8 8c a9 e0 	vfmadd231ps 0x2e0(%rcx,%rbp,4),%ymm9,%ymm1
    16f1:	02 00 00 
    16f4:	c4 62 35 b8 2c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm13
    16fa:	c4 62 35 b8 74 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm14
    1701:	c4 62 35 b8 7c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm15
    1708:	c4 e2 35 b8 94 a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm2
    170f:	00 00 00 
    1712:	c4 62 35 b8 94 a9 00 	vfmadd231ps 0x100(%rcx,%rbp,4),%ymm9,%ymm10
    1719:	01 00 00 
    171c:	c4 62 35 b8 9c a9 20 	vfmadd231ps 0x120(%rcx,%rbp,4),%ymm9,%ymm11
    1723:	01 00 00 
    1726:	c4 62 35 b8 a4 a9 40 	vfmadd231ps 0x140(%rcx,%rbp,4),%ymm9,%ymm12
    172d:	01 00 00 
    1730:	c4 62 35 b8 84 a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm8
    1737:	00 00 00 
    173a:	c4 e2 35 b8 a4 a9 80 	vfmadd231ps 0x180(%rcx,%rbp,4),%ymm9,%ymm4
    1741:	01 00 00 
    1744:	c4 e2 35 b8 7c a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm7
    174b:	c4 e2 35 b8 ac a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm5
    1752:	00 00 00 
    1755:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    175b:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    1762:	00 00 
    1764:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    176b:	00 00 
    176d:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x1c0(%rcx,%rbp,4),%ymm9,%ymm3
    1774:	01 00 00 
    1777:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    177e:	00 00 
    1780:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    1786:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x160(%rcx,%rbp,4),%ymm9,%ymm6
    178d:	01 00 00 
    1790:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    1797:	00 00 
    1799:	c5 7c 29 d1          	vmovaps %ymm10,%ymm1
    179d:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    17a2:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    17a7:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    17ac:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    17b1:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    17b6:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    17ba:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    17c1:	00 00 
    17c3:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    17c8:	c4 e2 35 b8 9c a9 00 	vfmadd231ps 0x200(%rcx,%rbp,4),%ymm9,%ymm3
    17cf:	02 00 00 
    17d2:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    17d8:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    17df:	00 00 
    17e1:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0x1e0(%rcx,%rbp,4),%ymm9,%ymm6
    17e8:	01 00 00 
    17eb:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    17f1:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    17f6:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    17fc:	c4 e2 35 b8 9c a9 40 	vfmadd231ps 0x240(%rcx,%rbp,4),%ymm9,%ymm3
    1803:	02 00 00 
    1806:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    180d:	00 00 
    180f:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    1815:	c4 e2 35 b8 b4 a9 20 	vfmadd231ps 0x220(%rcx,%rbp,4),%ymm9,%ymm6
    181c:	02 00 00 
    181f:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    1825:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    182b:	c4 e2 35 b8 9c a9 80 	vfmadd231ps 0x280(%rcx,%rbp,4),%ymm9,%ymm3
    1832:	02 00 00 
    1835:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    183b:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    1841:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x260(%rcx,%rbp,4),%ymm9,%ymm6
    1848:	02 00 00 
    184b:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    1851:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    1857:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x2c0(%rcx,%rbp,4),%ymm9,%ymm3
    185e:	02 00 00 
    1861:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    1867:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    186d:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0x2a0(%rcx,%rbp,4),%ymm9,%ymm6
    1874:	02 00 00 
    1877:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    187b:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    1881:	c5 7c 29 c3          	vmovaps %ymm8,%ymm3
    1885:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    188b:	4c 39 c3             	cmp    %r8,%rbx
    188e:	0f 8c 2c ec ff ff    	jl     4c0 <_Z5benchv+0x370>
    1894:	e9 5c e9 ff ff       	jmpq   1f5 <_Z5benchv+0xa5>
    1899:	0f 31                	rdtsc  
    189b:	48 c1 e2 20          	shl    $0x20,%rdx
    189f:	48 09 c2             	or     %rax,%rdx
    18a2:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 18a8 <_Z5benchv+0x1758>
    18a8:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    18ad:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 18b5 <_Z5benchv+0x1765>
    18b4:	00 
    18b5:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 18bd <_Z5benchv+0x176d>
    18bc:	00 
    18bd:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 18c4 <_Z5benchv+0x1774>
    18c4:	01 c0                	add    %eax,%eax
    18c6:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    18cc:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    18d0:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    18d7:	00 00 
    18d9:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    18dd:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    18e1:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    18e5:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    18e9:	48 81 c4 a8 01 00 00 	add    $0x1a8,%rsp
    18f0:	5b                   	pop    %rbx
    18f1:	41 5c                	pop    %r12
    18f3:	41 5d                	pop    %r13
    18f5:	41 5e                	pop    %r14
    18f7:	41 5f                	pop    %r15
    18f9:	5d                   	pop    %rbp
    18fa:	c5 f8 77             	vzeroupper 
    18fd:	c3                   	retq   
    18fe:	90                   	nop
    18ff:	90                   	nop

0000000000001900 <_Z6enablev>:
    1900:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # 1907 <_Z6enablev+0x7>
    1907:	b8 c0 00 00 00       	mov    $0xc0,%eax
    190c:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    1911:	0f 45 c8             	cmovne %eax,%ecx
    1914:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 191a <_Z6enablev+0x1a>
    191a:	0f 9e c1             	setle  %cl
    191d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # 1924 <_Z6enablev+0x24>
    1924:	0f 9f c0             	setg   %al
    1927:	20 c8                	and    %cl,%al
    1929:	c3                   	retq   
    192a:	90                   	nop
    192b:	90                   	nop
    192c:	90                   	nop
...
0000000000001930 <_Z9n_reg_maxv>:
    1930:	b8 5d 01 00 00       	mov    $0x15d,%eax
    1935:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui24_uk13.cpp+0x9a>
  96:	01 00 00 00 

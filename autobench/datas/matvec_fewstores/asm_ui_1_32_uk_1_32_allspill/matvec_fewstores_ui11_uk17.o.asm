...
0000000000000a90 <_Z6enablev>:
 ...
 a97:	b8 58 00 00 00       	mov    $0x58,%eax
 a9c:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
 aa1:	0f 45 c8             	cmovne %eax,%ecx
 aa4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # aaa <_Z6enablev+0x1a>
 aaa:	0f 9e c1             	setle  %cl
 aad:	83 3d 00 00 00 00 10 	cmpl   $0x10,0x0(%rip)        # ab4 <_Z6enablev+0x24>
...
0000000000000ac0 <_Z9n_reg_maxv>:
 ac0:	b8 d7 00 00 00       	mov    $0xd7,%eax
 ac5:	c3                   	retq   

...
00000000000007e0 <_Z6enablev>:
 ...
 7e7:	b8 60 00 00 00       	mov    $0x60,%eax
 7ec:	b9 f4 ff ff ff       	mov    $0xfffffff4,%ecx
 7f1:	0f 45 c8             	cmovne %eax,%ecx
 7f4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 7fa <_Z6enablev+0x1a>
 7fa:	0f 9e c1             	setle  %cl
 7fd:	83 3d 00 00 00 00 06 	cmpl   $0x6,0x0(%rip)        # 804 <_Z6enablev+0x24>
...
0000000000000810 <_Z9n_reg_maxv>:
 810:	b8 67 00 00 00       	mov    $0x67,%eax
 815:	c3                   	retq   

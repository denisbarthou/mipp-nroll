...
0000000000000160 <_Z5benchv>:
     ...
     1aa:	0f 8e d5 1c 00 00    	jle    1e85 <_Z5benchv+0x1d25>
     ...
     324:	0f 83 5b 1b 00 00    	jae    1e85 <_Z5benchv+0x1d25>
    ...
    1cb7:	48 83 c3 11          	add    $0x11,%rbx
    1cbb:	48 0f af e8          	imul   %rax,%rbp
    1cbf:	48 01 fd             	add    %rdi,%rbp
    1cc2:	c4 e2 35 b8 9c a9 a0 	vfmadd231ps 0x1a0(%rcx,%rbp,4),%ymm9,%ymm3
    1cc9:	01 00 00 
    1ccc:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm6
    1cd3:	00 00 00 
    1cd6:	c4 e2 35 b8 8c a9 e0 	vfmadd231ps 0x2e0(%rcx,%rbp,4),%ymm9,%ymm1
    1cdd:	02 00 00 
    1ce0:	c4 62 35 b8 2c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm13
    1ce6:	c4 62 35 b8 74 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm14
    1ced:	c4 62 35 b8 7c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm15
    1cf4:	c4 e2 35 b8 94 a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm2
    1cfb:	00 00 00 
    1cfe:	c4 62 35 b8 94 a9 00 	vfmadd231ps 0x100(%rcx,%rbp,4),%ymm9,%ymm10
    1d05:	01 00 00 
    1d08:	c4 62 35 b8 9c a9 20 	vfmadd231ps 0x120(%rcx,%rbp,4),%ymm9,%ymm11
    1d0f:	01 00 00 
    1d12:	c4 62 35 b8 a4 a9 40 	vfmadd231ps 0x140(%rcx,%rbp,4),%ymm9,%ymm12
    1d19:	01 00 00 
    1d1c:	c4 62 35 b8 84 a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm8
    1d23:	00 00 00 
    1d26:	c4 e2 35 b8 a4 a9 80 	vfmadd231ps 0x180(%rcx,%rbp,4),%ymm9,%ymm4
    1d2d:	01 00 00 
    1d30:	c4 e2 35 b8 7c a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm7
    1d37:	c4 e2 35 b8 ac a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm5
    1d3e:	00 00 00 
    1d41:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    1d47:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    1d4e:	00 00 
    1d50:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    1d57:	00 00 
    1d59:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x1c0(%rcx,%rbp,4),%ymm9,%ymm3
    1d60:	01 00 00 
    1d63:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    1d6a:	00 00 
    1d6c:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    1d72:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x160(%rcx,%rbp,4),%ymm9,%ymm6
    1d79:	01 00 00 
    1d7c:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    1d83:	00 00 
    1d85:	c5 7c 29 d1          	vmovaps %ymm10,%ymm1
    1d89:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    1d8e:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    1d93:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    1d98:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    1d9d:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    1da2:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    1da6:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    1dad:	00 00 
    1daf:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    1db4:	c4 e2 35 b8 9c a9 00 	vfmadd231ps 0x200(%rcx,%rbp,4),%ymm9,%ymm3
    1dbb:	02 00 00 
    1dbe:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    1dc4:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    1dcb:	00 00 
    1dcd:	c4 e2 35 b8 b4 a9 e0 	vfmadd231ps 0x1e0(%rcx,%rbp,4),%ymm9,%ymm6
    1dd4:	01 00 00 
    1dd7:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    1ddd:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    1de2:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    1de8:	c4 e2 35 b8 9c a9 40 	vfmadd231ps 0x240(%rcx,%rbp,4),%ymm9,%ymm3
    1def:	02 00 00 
    1df2:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    1df9:	00 00 
    1dfb:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    1e01:	c4 e2 35 b8 b4 a9 20 	vfmadd231ps 0x220(%rcx,%rbp,4),%ymm9,%ymm6
    1e08:	02 00 00 
    1e0b:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    1e11:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    1e17:	c4 e2 35 b8 9c a9 80 	vfmadd231ps 0x280(%rcx,%rbp,4),%ymm9,%ymm3
    1e1e:	02 00 00 
    1e21:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    1e27:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    1e2d:	c4 e2 35 b8 b4 a9 60 	vfmadd231ps 0x260(%rcx,%rbp,4),%ymm9,%ymm6
    1e34:	02 00 00 
    1e37:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    1e3d:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    1e43:	c4 e2 35 b8 9c a9 c0 	vfmadd231ps 0x2c0(%rcx,%rbp,4),%ymm9,%ymm3
    1e4a:	02 00 00 
    1e4d:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    1e53:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    1e59:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0x2a0(%rcx,%rbp,4),%ymm9,%ymm6
    1e60:	02 00 00 
    1e63:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    1e67:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    1e6d:	c5 7c 29 c3          	vmovaps %ymm8,%ymm3
    1e71:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    1e77:	4c 39 c3             	cmp    %r8,%rbx
    1e7a:	0f 8c 50 e6 ff ff    	jl     4d0 <_Z5benchv+0x370>
    1e80:	e9 80 e3 ff ff       	jmpq   205 <_Z5benchv+0xa5>
    1e85:	0f 31                	rdtsc  
    1e87:	48 c1 e2 20          	shl    $0x20,%rdx
    1e8b:	48 09 c2             	or     %rax,%rdx
    1e8e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1e94 <_Z5benchv+0x1d34>
    1e94:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1e99:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1ea1 <_Z5benchv+0x1d41>
    1ea0:	00 
    1ea1:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1ea9 <_Z5benchv+0x1d49>
    1ea8:	00 
    1ea9:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1eb0 <_Z5benchv+0x1d50>
    1eb0:	01 c0                	add    %eax,%eax
    1eb2:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1eb8:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1ebc:	c5 fb 5c 84 24 f8 00 	vsubsd 0xf8(%rsp),%xmm0,%xmm0
    1ec3:	00 00 
    1ec5:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    1ec9:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    1ecd:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1ed1:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1ed5:	48 81 c4 a8 01 00 00 	add    $0x1a8,%rsp
    1edc:	5b                   	pop    %rbx
    1edd:	41 5c                	pop    %r12
    1edf:	41 5d                	pop    %r13
    1ee1:	41 5e                	pop    %r14
...
0000000000001ef0 <_Z6enablev>:
    ...
    1ef7:	b8 c0 00 00 00       	mov    $0xc0,%eax
    1efc:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    1f01:	0f 45 c8             	cmovne %eax,%ecx
    1f04:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1f0a <_Z6enablev+0x1a>
    1f0a:	0f 9e c1             	setle  %cl
    1f0d:	83 3d 00 00 00 00 10 	cmpl   $0x10,0x0(%rip)        # 1f14 <_Z6enablev+0x24>
...
0000000000001f20 <_Z9n_reg_maxv>:
    1f20:	b8 c1 01 00 00       	mov    $0x1c1,%eax
    1f25:	c3                   	retq   

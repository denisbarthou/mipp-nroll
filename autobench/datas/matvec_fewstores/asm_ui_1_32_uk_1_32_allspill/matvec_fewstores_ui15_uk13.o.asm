...
0000000000000150 <_Z5benchv>:
 ...
 188:	0f 8e 51 09 00 00    	jle    adf <_Z5benchv+0x98f>
 ...
 250:	0f 83 89 08 00 00    	jae    adf <_Z5benchv+0x98f>
 ...
 a3d:	48 83 c6 0d          	add    $0xd,%rsi
 a41:	49 0f af c2          	imul   %r10,%rax
 a45:	48 01 f8             	add    %rdi,%rax
 a48:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
 a4e:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
 a55:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
 a5c:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
 a63:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
 a6a:	00 00 00 
 a6d:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
 a74:	00 00 00 
 a77:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
 a7e:	00 00 00 
 a81:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
 a88:	00 00 00 
 a8b:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
 a92:	01 00 00 
 a95:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
 a9c:	01 00 00 
 a9f:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
 aa6:	01 00 00 
 aa9:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
 ab0:	01 00 00 
 ab3:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
 aba:	01 00 00 
 abd:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
 ac4:	01 00 00 
 ac7:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
 ace:	01 00 00 
 ad1:	4c 39 c6             	cmp    %r8,%rsi
 ad4:	0f 8c 16 f8 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
 ada:	e9 e1 f6 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
 adf:	0f 31                	rdtsc  
 ae1:	48 c1 e2 20          	shl    $0x20,%rdx
 ae5:	48 09 c2             	or     %rax,%rdx
 ae8:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # aee <_Z5benchv+0x99e>
 aee:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
 af3:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # afb <_Z5benchv+0x9ab>
 afa:	00 
 afb:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # b03 <_Z5benchv+0x9b3>
 b02:	00 
 b03:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b0a <_Z5benchv+0x9ba>
 b0a:	01 c0                	add    %eax,%eax
 b0c:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
 b12:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
 b16:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
 b1c:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 b20:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
 b24:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 b28:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 b2c:	c5 f8 77             	vzeroupper 
 b2f:	c3                   	retq   

0000000000000b30 <_Z6enablev>:
 b30:	80 3d 00 00 00 00 00 	cmpb   $0x0,0x0(%rip)        # b37 <_Z6enablev+0x7>
 b37:	b8 78 00 00 00       	mov    $0x78,%eax
 b3c:	b9 f1 ff ff ff       	mov    $0xfffffff1,%ecx
 b41:	0f 45 c8             	cmovne %eax,%ecx
 b44:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # b4a <_Z6enablev+0x1a>
 b4a:	0f 9e c1             	setle  %cl
 b4d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # b54 <_Z6enablev+0x24>
...
0000000000000b60 <_Z9n_reg_maxv>:
 b60:	b8 df 00 00 00       	mov    $0xdf,%eax
 b65:	c3                   	retq   

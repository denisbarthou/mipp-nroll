...
0000000000000160 <_Z5benchv>:
     ...
     19f:	0f 8e 36 1e 00 00    	jle    1fdb <_Z5benchv+0x1e7b>
     ...
     2f1:	0f 83 e4 1c 00 00    	jae    1fdb <_Z5benchv+0x1e7b>
    ...
    1e55:	48 83 c6 17          	add    $0x17,%rsi
    1e59:	49 0f af c2          	imul   %r10,%rax
    1e5d:	48 01 f8             	add    %rdi,%rax
    1e60:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    1e67:	01 00 00 
    1e6a:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    1e71:	01 00 00 
    1e74:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    1e7b:	01 00 00 
    1e7e:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    1e85:	02 00 00 
    1e88:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    1e8f:	01 00 00 
    1e92:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    1e98:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    1e9f:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    1ea6:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    1ead:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    1eb4:	00 00 00 
    1eb7:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    1ebe:	00 00 00 
    1ec1:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    1ec8:	00 00 00 
    1ecb:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    1ed2:	01 00 00 
    1ed5:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    1edc:	01 00 00 
    1edf:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    1ee5:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    1eea:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    1ef1:	00 00 00 
    1ef4:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    1efb:	00 00 
    1efd:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    1f03:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    1f0a:	00 00 
    1f0c:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    1f12:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    1f19:	00 00 
    1f1b:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    1f21:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm2
    1f28:	02 00 00 
    1f2b:	c4 e2 4d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm1
    1f32:	01 00 00 
    1f35:	c4 e2 4d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm4
    1f3c:	02 00 00 
    1f3f:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    1f45:	c5 fc 11 ac 24 80 00 	vmovups %ymm5,0x80(%rsp)
    1f4c:	00 00 
    1f4e:	c5 7c 29 cd          	vmovaps %ymm9,%ymm5
    1f52:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    1f57:	c4 41 7c 28 dd       	vmovaps %ymm13,%ymm11
    1f5c:	c5 7c 11 bc 24 20 01 	vmovups %ymm15,0x120(%rsp)
    1f63:	00 00 
    1f65:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    1f6c:	00 00 
    1f6e:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    1f73:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    1f79:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    1f80:	01 00 00 
    1f83:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    1f88:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    1f8e:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    1f94:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    1f9a:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    1fa1:	02 00 00 
    1fa4:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    1faa:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    1fb0:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    1fb7:	02 00 00 
    1fba:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    1fbe:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    1fc3:	c4 41 7c 28 d4       	vmovaps %ymm12,%ymm10
    1fc8:	c4 41 7c 28 e6       	vmovaps %ymm14,%ymm12
    1fcd:	4c 39 c6             	cmp    %r8,%rsi
    1fd0:	0f 8c 4a e4 ff ff    	jl     420 <_Z5benchv+0x2c0>
    1fd6:	e9 f9 e1 ff ff       	jmpq   1d4 <_Z5benchv+0x74>
    1fdb:	0f 31                	rdtsc  
    1fdd:	48 c1 e2 20          	shl    $0x20,%rdx
    1fe1:	48 09 c2             	or     %rax,%rdx
    1fe4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1fea <_Z5benchv+0x1e8a>
    1fea:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1fef:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1ff7 <_Z5benchv+0x1e97>
    1ff6:	00 
    1ff7:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1fff <_Z5benchv+0x1e9f>
    1ffe:	00 
    1fff:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2006 <_Z5benchv+0x1ea6>
    2006:	01 c0                	add    %eax,%eax
    2008:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    200e:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2012:	c5 fb 5c 44 24 78    	vsubsd 0x78(%rsp),%xmm0,%xmm0
    2018:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    201d:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    2021:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2025:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2029:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
0000000000002040 <_Z6enablev>:
    ...
    2047:	b8 a8 00 00 00       	mov    $0xa8,%eax
    204c:	b9 eb ff ff ff       	mov    $0xffffffeb,%ecx
    2051:	0f 45 c8             	cmovne %eax,%ecx
    2054:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 205a <_Z6enablev+0x1a>
    205a:	0f 9e c1             	setle  %cl
    205d:	83 3d 00 00 00 00 16 	cmpl   $0x16,0x0(%rip)        # 2064 <_Z6enablev+0x24>
...
0000000000002070 <_Z9n_reg_maxv>:
    2070:	b8 0f 02 00 00       	mov    $0x20f,%eax
    2075:	c3                   	retq   

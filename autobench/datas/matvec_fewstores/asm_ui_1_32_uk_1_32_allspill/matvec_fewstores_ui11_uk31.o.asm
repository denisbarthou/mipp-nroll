...
0000000000000160 <_Z5benchv>:
     ...
     192:	0f 8e 05 0f 00 00    	jle    109d <_Z5benchv+0xf3d>
     ...
     228:	0f 83 6f 0e 00 00    	jae    109d <_Z5benchv+0xf3d>
     ...
     f3d:	49 0f af c3          	imul   %r11,%rax
     f41:	48 01 f8             	add    %rdi,%rax
     f44:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
     f4a:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
     f51:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
     f58:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
     f5f:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
     f66:	00 00 00 
     f69:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
     f70:	00 00 00 
     f73:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
     f7a:	00 00 00 
     f7d:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
     f84:	00 00 00 
     f87:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
     f8e:	01 00 00 
     f91:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
     f98:	01 00 00 
     f9b:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
     fa2:	01 00 00 
     fa5:	48 8d 46 1d          	lea    0x1d(%rsi),%rax
     fa9:	c4 62 7d 18 64 b2 74 	vbroadcastss 0x74(%rdx,%rsi,4),%ymm12
     fb0:	49 0f af c3          	imul   %r11,%rax
     fb4:	48 01 f8             	add    %rdi,%rax
     fb7:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
     fbd:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
     fc4:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
     fcb:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
     fd2:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
     fd9:	00 00 00 
     fdc:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
     fe3:	00 00 00 
     fe6:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
     fed:	00 00 00 
     ff0:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
     ff7:	00 00 00 
     ffa:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
    1001:	01 00 00 
    1004:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
    100b:	01 00 00 
    100e:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
    1015:	01 00 00 
    1018:	48 8d 46 1e          	lea    0x1e(%rsi),%rax
    101c:	c4 62 7d 18 64 b2 78 	vbroadcastss 0x78(%rdx,%rsi,4),%ymm12
    1023:	48 83 c6 1f          	add    $0x1f,%rsi
    1027:	49 0f af c3          	imul   %r11,%rax
    102b:	48 01 f8             	add    %rdi,%rax
    102e:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
    1034:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
    103b:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
    1042:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
    1049:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
    1050:	00 00 00 
    1053:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
    105a:	00 00 00 
    105d:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
    1064:	00 00 00 
    1067:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
    106e:	00 00 00 
    1071:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
    1078:	01 00 00 
    107b:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
    1082:	01 00 00 
    1085:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
    108c:	01 00 00 
    108f:	4c 39 c6             	cmp    %r8,%rsi
    1092:	0f 8c 08 f2 ff ff    	jl     2a0 <_Z5benchv+0x140>
    1098:	e9 23 f1 ff ff       	jmpq   1c0 <_Z5benchv+0x60>
    109d:	0f 31                	rdtsc  
    109f:	48 c1 e2 20          	shl    $0x20,%rdx
    10a3:	48 09 c2             	or     %rax,%rdx
    10a6:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 10ac <_Z5benchv+0xf4c>
    10ac:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    10b1:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 10b9 <_Z5benchv+0xf59>
    10b8:	00 
    10b9:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 10c1 <_Z5benchv+0xf61>
    10c0:	00 
    10c1:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 10c8 <_Z5benchv+0xf68>
    10c8:	01 c0                	add    %eax,%eax
    10ca:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    10d0:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    10d4:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    10d8:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    10dc:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    10e0:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    10e4:	c5 f8 77             	vzeroupper 
    10e7:	c3                   	retq   
    10e8:	90                   	nop
    10e9:	90                   	nop
    10ea:	90                   	nop
...
00000000000010f0 <_Z6enablev>:
    ...
    10f7:	b8 58 00 00 00       	mov    $0x58,%eax
    10fc:	b9 f5 ff ff ff       	mov    $0xfffffff5,%ecx
    1101:	0f 45 c8             	cmovne %eax,%ecx
    1104:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 110a <_Z6enablev+0x1a>
    110a:	0f 9e c1             	setle  %cl
    110d:	83 3d 00 00 00 00 1e 	cmpl   $0x1e,0x0(%rip)        # 1114 <_Z6enablev+0x24>
...
0000000000001120 <_Z9n_reg_maxv>:
    1120:	b8 7f 01 00 00       	mov    $0x17f,%eax
    1125:	c3                   	retq   

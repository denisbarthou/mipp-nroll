...
0000000000001730 <_Z6enablev>:
    ...
    1737:	b8 d0 00 00 00       	mov    $0xd0,%eax
    173c:	b9 e6 ff ff ff       	mov    $0xffffffe6,%ecx
    1741:	0f 45 c8             	cmovne %eax,%ecx
    1744:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 174a <_Z6enablev+0x1a>
    174a:	0f 9e c1             	setle  %cl
    174d:	83 3d 00 00 00 00 09 	cmpl   $0x9,0x0(%rip)        # 1754 <_Z6enablev+0x24>
...
0000000000001760 <_Z9n_reg_maxv>:
    1760:	b8 28 01 00 00       	mov    $0x128,%eax
    1765:	c3                   	retq   

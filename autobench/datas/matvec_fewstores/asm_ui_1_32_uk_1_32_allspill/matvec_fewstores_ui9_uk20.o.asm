...
0000000000000a40 <_Z6enablev>:
 ...
 a47:	b8 48 00 00 00       	mov    $0x48,%eax
 a4c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 a51:	0f 45 c8             	cmovne %eax,%ecx
 a54:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a5a <_Z6enablev+0x1a>
 a5a:	0f 9e c1             	setle  %cl
 a5d:	83 3d 00 00 00 00 13 	cmpl   $0x13,0x0(%rip)        # a64 <_Z6enablev+0x24>
...
0000000000000a70 <_Z9n_reg_maxv>:
 a70:	b8 d1 00 00 00       	mov    $0xd1,%eax
 a75:	c3                   	retq   

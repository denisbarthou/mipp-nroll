...
0000000000001ab0 <_Z6enablev>:
    ...
    1ab7:	b8 c0 00 00 00       	mov    $0xc0,%eax
    1abc:	b9 e8 ff ff ff       	mov    $0xffffffe8,%ecx
    1ac1:	0f 45 c8             	cmovne %eax,%ecx
    1ac4:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # 1aca <_Z6enablev+0x1a>
    1aca:	0f 9e c1             	setle  %cl
    1acd:	83 3d 00 00 00 00 0d 	cmpl   $0xd,0x0(%rip)        # 1ad4 <_Z6enablev+0x24>
...
0000000000001ae0 <_Z9n_reg_maxv>:
    1ae0:	b8 76 01 00 00       	mov    $0x176,%eax
    1ae5:	c3                   	retq   

...
0000000000000a70 <_Z6enablev>:
 ...
 a77:	b8 48 00 00 00       	mov    $0x48,%eax
 a7c:	b9 f7 ff ff ff       	mov    $0xfffffff7,%ecx
 a81:	0f 45 c8             	cmovne %eax,%ecx
 a84:	3b 0d 00 00 00 00    	cmp    0x0(%rip),%ecx        # a8a <_Z6enablev+0x1a>
 a8a:	0f 9e c1             	setle  %cl
 a8d:	83 3d 00 00 00 00 0c 	cmpl   $0xc,0x0(%rip)        # a94 <_Z6enablev+0x24>
...
0000000000000aa0 <_Z9n_reg_maxv>:
 aa0:	b8 8b 00 00 00       	mov    $0x8b,%eax
 aa5:	c3                   	retq   

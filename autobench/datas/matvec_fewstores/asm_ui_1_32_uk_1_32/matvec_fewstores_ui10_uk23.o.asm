...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 77 0a 00 00    	jle    bff <_Z5benchv+0xaaf>
 ...
 20d:	0f 83 ec 09 00 00    	jae    bff <_Z5benchv+0xaaf>
 ...
 b8f:	48 83 c7 17          	add    $0x17,%rdi
 b93:	49 0f af c3          	imul   %r11,%rax
 b97:	48 01 f0             	add    %rsi,%rax
 b9a:	c4 e2 25 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm1
 ba0:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
 ba7:	c4 e2 25 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm2
 bae:	c4 e2 25 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm3
 bb5:	c4 e2 25 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm4
 bbc:	00 00 00 
 bbf:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm5
 bc6:	00 00 00 
 bc9:	c4 e2 25 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm6
 bd0:	00 00 00 
 bd3:	c4 62 25 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm8
 bda:	00 00 00 
 bdd:	c4 62 25 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm9
 be4:	01 00 00 
 be7:	c4 62 25 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm10
 bee:	01 00 00 
 bf1:	4c 39 d7             	cmp    %r10,%rdi
 bf4:	0f 8c 86 f6 ff ff    	jl     280 <_Z5benchv+0x130>
 bfa:	e9 b1 f5 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 bff:	0f 31                	rdtsc  
 c01:	48 c1 e2 20          	shl    $0x20,%rdx
 c05:	48 09 c2             	or     %rax,%rdx
 c08:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # c0e <_Z5benchv+0xabe>
 c0e:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 c13:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # c1b <_Z5benchv+0xacb>
 c1a:	00 
 c1b:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # c23 <_Z5benchv+0xad3>
 c22:	00 
 c23:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # c2a <_Z5benchv+0xada>
 c2a:	01 c0                	add    %eax,%eax
 c2c:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 c32:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 c36:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 c3a:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 c3e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 c42:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000000c60 <_Z9n_reg_maxv>:
 c60:	b8 07 01 00 00       	mov    $0x107,%eax
 c65:	c3                   	retq   

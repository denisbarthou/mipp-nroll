...
0000000000000150 <_Z5benchv>:
     ...
     182:	0f 8e a1 11 00 00    	jle    1329 <_Z5benchv+0x11d9>
     ...
     22c:	0f 83 f7 10 00 00    	jae    1329 <_Z5benchv+0x11d9>
    ...
    118d:	49 0f af c3          	imul   %r11,%rax
    1191:	48 01 f8             	add    %rdi,%rax
    1194:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
    119a:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
    11a1:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
    11a8:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
    11af:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
    11b6:	00 00 00 
    11b9:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
    11c0:	00 00 00 
    11c3:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
    11ca:	00 00 00 
    11cd:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
    11d4:	00 00 00 
    11d7:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
    11de:	01 00 00 
    11e1:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
    11e8:	01 00 00 
    11eb:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
    11f2:	01 00 00 
    11f5:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
    11fc:	01 00 00 
    11ff:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
    1206:	01 00 00 
    1209:	48 8d 46 1d          	lea    0x1d(%rsi),%rax
    120d:	c4 62 7d 18 74 b2 74 	vbroadcastss 0x74(%rdx,%rsi,4),%ymm14
    1214:	49 0f af c3          	imul   %r11,%rax
    1218:	48 01 f8             	add    %rdi,%rax
    121b:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
    1221:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
    1228:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
    122f:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
    1236:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
    123d:	00 00 00 
    1240:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
    1247:	00 00 00 
    124a:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
    1251:	00 00 00 
    1254:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
    125b:	00 00 00 
    125e:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
    1265:	01 00 00 
    1268:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
    126f:	01 00 00 
    1272:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
    1279:	01 00 00 
    127c:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
    1283:	01 00 00 
    1286:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
    128d:	01 00 00 
    1290:	48 8d 46 1e          	lea    0x1e(%rsi),%rax
    1294:	c4 62 7d 18 74 b2 78 	vbroadcastss 0x78(%rdx,%rsi,4),%ymm14
    129b:	48 83 c6 1f          	add    $0x1f,%rsi
    129f:	49 0f af c3          	imul   %r11,%rax
    12a3:	48 01 f8             	add    %rdi,%rax
    12a6:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
    12ac:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
    12b3:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
    12ba:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
    12c1:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
    12c8:	00 00 00 
    12cb:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
    12d2:	00 00 00 
    12d5:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
    12dc:	00 00 00 
    12df:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
    12e6:	00 00 00 
    12e9:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
    12f0:	01 00 00 
    12f3:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
    12fa:	01 00 00 
    12fd:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
    1304:	01 00 00 
    1307:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
    130e:	01 00 00 
    1311:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
    1318:	01 00 00 
    131b:	4c 39 c6             	cmp    %r8,%rsi
    131e:	0f 8c 9c ef ff ff    	jl     2c0 <_Z5benchv+0x170>
    1324:	e9 87 ee ff ff       	jmpq   1b0 <_Z5benchv+0x60>
    1329:	0f 31                	rdtsc  
    132b:	48 c1 e2 20          	shl    $0x20,%rdx
    132f:	48 09 c2             	or     %rax,%rdx
    1332:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1338 <_Z5benchv+0x11e8>
    1338:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    133d:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1345 <_Z5benchv+0x11f5>
    1344:	00 
    1345:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 134d <_Z5benchv+0x11fd>
    134c:	00 
    134d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1354 <_Z5benchv+0x1204>
    1354:	01 c0                	add    %eax,%eax
    1356:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    135c:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    1360:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    1364:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    1368:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    136c:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1370:	c5 f8 77             	vzeroupper 
    1373:	c3                   	retq   
    1374:	90                   	nop
    1375:	90                   	nop
    1376:	90                   	nop
...
0000000000001390 <_Z9n_reg_maxv>:
    1390:	b8 bf 01 00 00       	mov    $0x1bf,%eax
    1395:	c3                   	retq   

...
0000000000000000 <_Z4initv>:
      ...
      41:	48 69 d1 89 88 88 88 	imul   $0xffffffff88888889,%rcx,%rdx
...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e 70 0e 00 00    	jle    1005 <_Z5benchv+0xeb5>
     ...
     28c:	0f 83 73 0d 00 00    	jae    1005 <_Z5benchv+0xeb5>
     ...
     f12:	48 83 c6 0f          	add    $0xf,%rsi
     f16:	49 0f af c2          	imul   %r10,%rax
     f1a:	48 01 f8             	add    %rdi,%rax
     f1d:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
     f24:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
     f2a:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
     f31:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
     f38:	01 00 00 
     f3b:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
     f42:	01 00 00 
     f45:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
     f4c:	00 00 00 
     f4f:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
     f56:	00 00 00 
     f59:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
     f60:	00 00 00 
     f63:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
     f6a:	00 00 00 
     f6d:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
     f74:	01 00 00 
     f77:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
     f7e:	01 00 00 
     f81:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
     f88:	01 00 00 
     f8b:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
     f92:	01 00 00 
     f95:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
     f9c:	02 00 00 
     f9f:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
     fa5:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
     fab:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
     fb2:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
     fb7:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
     fbd:	c4 e2 6d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm5
     fc4:	01 00 00 
     fc7:	c5 7c 11 64 24 20    	vmovups %ymm12,0x20(%rsp)
     fcd:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
     fd3:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
     fd9:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
     fdf:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
     fe6:	01 00 00 
     fe9:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
     fed:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
     ff1:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
     ff7:	4c 39 c6             	cmp    %r8,%rsi
     ffa:	0f 8c 60 f3 ff ff    	jl     360 <_Z5benchv+0x210>
    1000:	e9 c3 f1 ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    1005:	0f 31                	rdtsc  
    1007:	48 c1 e2 20          	shl    $0x20,%rdx
    100b:	48 09 c2             	or     %rax,%rdx
    100e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1014 <_Z5benchv+0xec4>
    1014:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1019:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1021 <_Z5benchv+0xed1>
    1020:	00 
    1021:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1029 <_Z5benchv+0xed9>
    1028:	00 
    1029:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1030 <_Z5benchv+0xee0>
    1030:	01 c0                	add    %eax,%eax
    1032:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1038:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    103c:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1042:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    1047:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    104b:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    104f:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1053:	48 81 c4 98 00 00 00 	add    $0x98,%rsp
    105a:	c5 f8 77             	vzeroupper 
    105d:	c3                   	retq   
    105e:	90                   	nop
    105f:	90                   	nop
...
0000000000001070 <_Z9n_reg_maxv>:
    1070:	b8 1f 01 00 00       	mov    $0x11f,%eax
    1075:	c3                   	retq   

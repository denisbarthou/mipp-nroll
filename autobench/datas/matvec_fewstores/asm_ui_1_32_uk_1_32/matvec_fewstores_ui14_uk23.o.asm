...
0000000000000150 <_Z5benchv>:
     ...
     182:	0f 8e 5f 0e 00 00    	jle    fe7 <_Z5benchv+0xe97>
     ...
     235:	0f 83 ac 0d 00 00    	jae    fe7 <_Z5benchv+0xe97>
     ...
     f4f:	48 83 c6 17          	add    $0x17,%rsi
     f53:	49 0f af c3          	imul   %r11,%rax
     f57:	48 01 f8             	add    %rdi,%rax
     f5a:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
     f60:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
     f67:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
     f6e:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
     f75:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
     f7c:	00 00 00 
     f7f:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
     f86:	00 00 00 
     f89:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
     f90:	00 00 00 
     f93:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
     f9a:	00 00 00 
     f9d:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
     fa4:	01 00 00 
     fa7:	c4 62 05 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm10
     fae:	01 00 00 
     fb1:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
     fb8:	01 00 00 
     fbb:	c4 62 05 b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm12
     fc2:	01 00 00 
     fc5:	c4 62 05 b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm13
     fcc:	01 00 00 
     fcf:	c4 62 05 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm14
     fd6:	01 00 00 
     fd9:	4c 39 c6             	cmp    %r8,%rsi
     fdc:	0f 8c ee f2 ff ff    	jl     2d0 <_Z5benchv+0x180>
     fe2:	e9 c9 f1 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
     fe7:	0f 31                	rdtsc  
     fe9:	48 c1 e2 20          	shl    $0x20,%rdx
     fed:	48 09 c2             	or     %rax,%rdx
     ff0:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # ff6 <_Z5benchv+0xea6>
     ff6:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
     ffb:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1003 <_Z5benchv+0xeb3>
    1002:	00 
    1003:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 100b <_Z5benchv+0xebb>
    100a:	00 
    100b:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1012 <_Z5benchv+0xec2>
    1012:	01 c0                	add    %eax,%eax
    1014:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    101a:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    101e:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    1022:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    1027:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    102b:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    102f:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1033:	c5 f8 77             	vzeroupper 
    1036:	c3                   	retq   
    1037:	90                   	nop
    1038:	90                   	nop
    1039:	90                   	nop
...
0000000000001050 <_Z9n_reg_maxv>:
    1050:	b8 67 01 00 00       	mov    $0x167,%eax
    1055:	c3                   	retq   

...
matvec_fewstores_ui23_uk25.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 5d 25 00 00    	jle    26f5 <_Z5benchv+0x25a5>
     ...
     30c:	0f 83 e3 23 00 00    	jae    26f5 <_Z5benchv+0x25a5>
    ...
    256b:	48 83 c6 19          	add    $0x19,%rsi
    256f:	49 0f af c2          	imul   %r10,%rax
    2573:	48 01 f8             	add    %rdi,%rax
    2576:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    257d:	02 00 00 
    2580:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    2587:	00 00 00 
    258a:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    2591:	00 00 00 
    2594:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    259b:	01 00 00 
    259e:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    25a5:	01 00 00 
    25a8:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    25af:	02 00 00 
    25b2:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    25b8:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    25bf:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    25c6:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    25cd:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    25d4:	00 00 00 
    25d7:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    25de:	00 00 00 
    25e1:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    25e8:	01 00 00 
    25eb:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    25f2:	01 00 00 
    25f5:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    25fb:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2602:	00 00 
    2604:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    260b:	01 00 00 
    260e:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    2615:	00 00 
    2617:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    261b:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    261f:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    2623:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    262a:	00 00 
    262c:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    2633:	00 00 
    2635:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    263b:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    2642:	01 00 00 
    2645:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    264b:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    2651:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    2658:	01 00 00 
    265b:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    2661:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    2667:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    266e:	01 00 00 
    2671:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    2677:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    267c:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    2683:	02 00 00 
    2686:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    268b:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2691:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    2698:	02 00 00 
    269b:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    26a1:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    26a7:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    26ae:	02 00 00 
    26b1:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    26b7:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    26bd:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    26c4:	02 00 00 
    26c7:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    26cd:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    26d3:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    26da:	02 00 00 
    26dd:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    26e1:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    26e7:	4c 39 c6             	cmp    %r8,%rsi
    26ea:	0f 8c 90 dd ff ff    	jl     480 <_Z5benchv+0x330>
    26f0:	e9 ea da ff ff       	jmpq   1df <_Z5benchv+0x8f>
    26f5:	0f 31                	rdtsc  
    26f7:	48 c1 e2 20          	shl    $0x20,%rdx
    26fb:	48 09 c2             	or     %rax,%rdx
    26fe:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2704 <_Z5benchv+0x25b4>
    2704:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2709:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2711 <_Z5benchv+0x25c1>
    2710:	00 
    2711:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2719 <_Z5benchv+0x25c9>
    2718:	00 
    2719:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2720 <_Z5benchv+0x25d0>
    2720:	01 c0                	add    %eax,%eax
    2722:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2728:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    272c:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    2733:	00 00 
    2735:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    2739:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    273d:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2741:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2745:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    274c:	c5 f8 77             	vzeroupper 
    274f:	c3                   	retq   
...
0000000000002760 <_Z9n_reg_maxv>:
    2760:	b8 6f 02 00 00       	mov    $0x26f,%eax
    2765:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui23_uk25.cpp+0x9a>
  96:	01 00 00 00 

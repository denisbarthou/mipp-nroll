...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 13 28 00 00    	jle    29ab <_Z5benchv+0x285b>
     ...
     30c:	0f 83 99 26 00 00    	jae    29ab <_Z5benchv+0x285b>
    ...
    2821:	48 83 c6 1b          	add    $0x1b,%rsi
    2825:	49 0f af c2          	imul   %r10,%rax
    2829:	48 01 f8             	add    %rdi,%rax
    282c:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    2833:	02 00 00 
    2836:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    283d:	00 00 00 
    2840:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    2847:	00 00 00 
    284a:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    2851:	01 00 00 
    2854:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    285b:	01 00 00 
    285e:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    2865:	02 00 00 
    2868:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    286e:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    2875:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    287c:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    2883:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    288a:	00 00 00 
    288d:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    2894:	00 00 00 
    2897:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    289e:	01 00 00 
    28a1:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    28a8:	01 00 00 
    28ab:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    28b1:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    28b8:	00 00 
    28ba:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    28c1:	01 00 00 
    28c4:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    28cb:	00 00 
    28cd:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    28d1:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    28d5:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    28d9:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    28e0:	00 00 
    28e2:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    28e9:	00 00 
    28eb:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    28f1:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    28f8:	01 00 00 
    28fb:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    2901:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    2907:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    290e:	01 00 00 
    2911:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    2917:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    291d:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    2924:	01 00 00 
    2927:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    292d:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    2932:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    2939:	02 00 00 
    293c:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    2941:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2947:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    294e:	02 00 00 
    2951:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    2957:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    295d:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    2964:	02 00 00 
    2967:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    296d:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    2973:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    297a:	02 00 00 
    297d:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    2983:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    2989:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    2990:	02 00 00 
    2993:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    2997:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    299d:	4c 39 c6             	cmp    %r8,%rsi
    29a0:	0f 8c da da ff ff    	jl     480 <_Z5benchv+0x330>
    29a6:	e9 34 d8 ff ff       	jmpq   1df <_Z5benchv+0x8f>
    29ab:	0f 31                	rdtsc  
    29ad:	48 c1 e2 20          	shl    $0x20,%rdx
    29b1:	48 09 c2             	or     %rax,%rdx
    29b4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 29ba <_Z5benchv+0x286a>
    29ba:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    29bf:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 29c7 <_Z5benchv+0x2877>
    29c6:	00 
    29c7:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 29cf <_Z5benchv+0x287f>
    29ce:	00 
    29cf:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 29d6 <_Z5benchv+0x2886>
    29d6:	01 c0                	add    %eax,%eax
    29d8:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    29de:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    29e2:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    29e9:	00 00 
    29eb:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    29ef:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    29f3:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    29f7:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    29fb:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    2a02:	c5 f8 77             	vzeroupper 
    2a05:	c3                   	retq   
    2a06:	90                   	nop
    2a07:	90                   	nop
    2a08:	90                   	nop
...
0000000000002a20 <_Z9n_reg_maxv>:
    2a20:	b8 9f 02 00 00       	mov    $0x29f,%eax
    2a25:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e c9 3b 00 00    	jle    3d61 <_Z5benchv+0x3c11>
     ...
     383:	0f 83 d8 39 00 00    	jae    3d61 <_Z5benchv+0x3c11>
    ...
    3b00:	48 83 c6 1a          	add    $0x1a,%rsi
    3b04:	49 0f af c3          	imul   %r11,%rax
    3b08:	48 01 f8             	add    %rdi,%rax
    3b0b:	c4 e2 05 b8 84 81 a0 	vfmadd231ps 0x3a0(%rcx,%rax,4),%ymm15,%ymm0
    3b12:	03 00 00 
    3b15:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
    3b1c:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
    3b23:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
    3b2a:	01 00 00 
    3b2d:	c4 62 05 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm14
    3b34:	01 00 00 
    3b37:	c4 62 05 b8 94 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm15,%ymm10
    3b3e:	02 00 00 
    3b41:	c4 62 05 b8 ac 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm15,%ymm13
    3b48:	03 00 00 
    3b4b:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
    3b51:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
    3b58:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
    3b5f:	00 00 00 
    3b62:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
    3b69:	00 00 00 
    3b6c:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
    3b73:	00 00 00 
    3b76:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
    3b7d:	00 00 00 
    3b80:	c4 62 05 b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm15,%ymm12
    3b87:	02 00 00 
    ...
    3b9c:	01 00 00 
    3b9f:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    3ba6:	00 00 
    3ba8:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    3bac:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    3bb0:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    3bb4:	c5 7c 11 5c 24 c0    	vmovups %ymm11,-0x40(%rsp)
    3bba:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    3bc0:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm11
    3bc7:	01 00 00 
    3bca:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    3bd0:	c5 7c 11 5c 24 80    	vmovups %ymm11,-0x80(%rsp)
    3bd6:	c5 7c 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm11
    3bdd:	00 00 
    3bdf:	c4 62 05 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm11
    3be6:	01 00 00 
    3be9:	c5 7c 11 9c 24 20 01 	vmovups %ymm11,0x120(%rsp)
    3bf0:	00 00 
    3bf2:	c5 7c 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm11
    3bf9:	00 00 
    3bfb:	c4 62 05 b8 9c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm11
    3c02:	01 00 00 
    3c05:	c5 7c 11 9c 24 e0 00 	vmovups %ymm11,0xe0(%rsp)
    3c0c:	00 00 
    3c0e:	c5 7c 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm11
    3c15:	00 00 
    3c17:	c4 62 05 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm15,%ymm11
    3c1e:	01 00 00 
    3c21:	c5 7c 11 9c 24 a0 00 	vmovups %ymm11,0xa0(%rsp)
    3c28:	00 00 
    3c2a:	c5 7c 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm11
    3c31:	00 00 
    3c33:	c4 62 05 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm15,%ymm11
    3c3a:	01 00 00 
    3c3d:	c5 7c 11 9c 24 80 00 	vmovups %ymm11,0x80(%rsp)
    3c44:	00 00 
    3c46:	c5 7c 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm11
    3c4d:	00 00 
    3c4f:	c4 62 05 b8 9c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm15,%ymm11
    3c56:	02 00 00 
    3c59:	c5 7c 11 9c 24 00 01 	vmovups %ymm11,0x100(%rsp)
    3c60:	00 00 
    3c62:	c5 7c 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm11
    3c69:	00 00 
    3c6b:	c4 62 05 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm15,%ymm11
    3c72:	02 00 00 
    3c75:	c5 7c 11 9c 24 c0 00 	vmovups %ymm11,0xc0(%rsp)
    3c7c:	00 00 
    3c7e:	c5 7c 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm11
    3c84:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm15,%ymm11
    3c8b:	02 00 00 
    3c8e:	c5 7c 11 5c 24 a0    	vmovups %ymm11,-0x60(%rsp)
    3c94:	c5 7c 10 9c 24 40 01 	vmovups 0x140(%rsp),%ymm11
    3c9b:	00 00 
    3c9d:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm15,%ymm11
    3ca4:	02 00 00 
    3ca7:	c5 7c 11 9c 24 40 01 	vmovups %ymm11,0x140(%rsp)
    3cae:	00 00 
    3cb0:	c5 7c 10 9c 24 60 01 	vmovups 0x160(%rsp),%ymm11
    3cb7:	00 00 
    3cb9:	c4 62 05 b8 9c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm15,%ymm11
    3cc0:	02 00 00 
    3cc3:	c5 7c 11 9c 24 60 01 	vmovups %ymm11,0x160(%rsp)
    3cca:	00 00 
    3ccc:	c5 7c 10 5c 24 20    	vmovups 0x20(%rsp),%ymm11
    3cd2:	c4 62 05 b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm15,%ymm11
    3cd9:	02 00 00 
    3cdc:	c5 7c 11 5c 24 20    	vmovups %ymm11,0x20(%rsp)
    3ce2:	c5 7c 10 5c 24 60    	vmovups 0x60(%rsp),%ymm11
    3ce8:	c4 62 05 b8 9c 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm15,%ymm11
    3cef:	03 00 00 
    3cf2:	c5 7c 11 5c 24 60    	vmovups %ymm11,0x60(%rsp)
    3cf8:	c5 7c 10 5c 24 40    	vmovups 0x40(%rsp),%ymm11
    3cfe:	c4 62 05 b8 9c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm15,%ymm11
    3d05:	03 00 00 
    3d08:	c5 7c 11 5c 24 40    	vmovups %ymm11,0x40(%rsp)
    3d0e:	c5 7c 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm11
    3d14:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm15,%ymm11
    3d1b:	03 00 00 
    3d1e:	c5 7c 11 5c 24 e0    	vmovups %ymm11,-0x20(%rsp)
    3d24:	c5 7c 10 1c 24       	vmovups (%rsp),%ymm11
    3d29:	c4 62 05 b8 9c 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm15,%ymm11
    3d30:	03 00 00 
    3d33:	c4 41 7c 28 fd       	vmovaps %ymm13,%ymm15
    3d38:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    3d3d:	c4 41 7c 28 f2       	vmovaps %ymm10,%ymm14
    3d42:	c5 7c 10 54 24 a0    	vmovups -0x60(%rsp),%ymm10
    3d48:	c5 7c 11 1c 24       	vmovups %ymm11,(%rsp)
    3d4d:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    3d53:	4c 39 c6             	cmp    %r8,%rsi
    3d56:	0f 8c 34 c8 ff ff    	jl     590 <_Z5benchv+0x440>
    3d5c:	e9 8c c4 ff ff       	jmpq   1ed <_Z5benchv+0x9d>
    3d61:	0f 31                	rdtsc  
    3d63:	48 c1 e2 20          	shl    $0x20,%rdx
    3d67:	48 09 c2             	or     %rax,%rdx
    3d6a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3d70 <_Z5benchv+0x3c20>
    3d70:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3d75:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3d7d <_Z5benchv+0x3c2d>
    3d7c:	00 
    3d7d:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3d85 <_Z5benchv+0x3c35>
    3d84:	00 
    3d85:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3d8c <_Z5benchv+0x3c3c>
    3d8c:	01 c0                	add    %eax,%eax
    3d8e:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3d94:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3d98:	c5 fb 5c 84 24 98 01 	vsubsd 0x198(%rsp),%xmm0,%xmm0
    3d9f:	00 00 
    3da1:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    3da5:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    3da9:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3dad:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3db1:	48 81 c4 78 02 00 00 	add    $0x278,%rsp
    3db8:	c5 f8 77             	vzeroupper 
    3dbb:	c3                   	retq   
    3dbc:	90                   	nop
    3dbd:	90                   	nop
    3dbe:	90                   	nop
...
0000000000003dc0 <_Z6enablev>:
    3dc0:	31 c0                	xor    %eax,%eax
    3dc2:	c3                   	retq   
    3dc3:	90                   	nop
    3dc4:	90                   	nop
    3dc5:	90                   	nop
...
0000000000003dd0 <_Z9n_reg_maxv>:
    3dd0:	b8 44 03 00 00       	mov    $0x344,%eax
    3dd5:	c3                   	retq   

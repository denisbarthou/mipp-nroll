...
0000000000000150 <_Z5benchv>:
     ...
     193:	0f 8e 7e 30 00 00    	jle    3217 <_Z5benchv+0x30c7>
     ...
     37f:	0f 83 92 2e 00 00    	jae    3217 <_Z5benchv+0x30c7>
    ...
    2fe6:	48 83 c3 17          	add    $0x17,%rbx
    2fea:	48 0f af f0          	imul   %rax,%rsi
    2fee:	48 01 fe             	add    %rdi,%rsi
    2ff1:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm3
    2ff8:	00 00 00 
    2ffb:	c4 e2 15 b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm2
    3002:	c4 e2 15 b8 64 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm4
    3009:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
    3010:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
    3017:	01 00 00 
    301a:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
    3021:	01 00 00 
    3024:	c4 e2 15 b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm6
    302b:	01 00 00 
    302e:	c4 62 15 b8 9c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm13,%ymm11
    3035:	02 00 00 
    3038:	c4 e2 15 b8 ac b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm13,%ymm5
    303f:	02 00 00 
    3042:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm13,%ymm12
    3049:	03 00 00 
    304c:	c4 e2 15 b8 04 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm0
    3052:	c4 62 15 b8 b4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm14
    3059:	00 00 00 
    305c:	c4 62 15 b8 bc b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm15
    3063:	00 00 00 
    3066:	c4 e2 15 b8 8c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm1
    306d:	00 00 00 
    3070:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    3076:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    307c:	c4 e2 15 b8 bc b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm7
    3083:	01 00 00 
    3086:	c5 fc 11 9c 24 80 01 	vmovups %ymm3,0x180(%rsp)
    308d:	00 00 
    308f:	c5 fc 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm3
    3096:	00 00 
    3098:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm13,%ymm3
    309f:	01 00 00 
    30a2:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    30a8:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    30ae:	c4 e2 15 b8 bc b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm13,%ymm7
    30b5:	01 00 00 
    30b8:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    30bf:	00 00 
    30c1:	c5 fc 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm3
    30c8:	00 00 
    30ca:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm13,%ymm3
    30d1:	01 00 00 
    30d4:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    30da:	c5 fc 28 fa          	vmovaps %ymm2,%ymm7
    30de:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    30e4:	c5 fc 11 9c 24 c0 00 	vmovups %ymm3,0xc0(%rsp)
    30eb:	00 00 
    30ed:	c5 fc 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm3
    30f4:	00 00 
    30f6:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm13,%ymm3
    30fd:	01 00 00 
    3100:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    3107:	00 00 
    3109:	c5 fc 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm3
    3110:	00 00 
    3112:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm13,%ymm3
    3119:	02 00 00 
    311c:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    3123:	00 00 
    3125:	c5 fc 10 5c 24 60    	vmovups 0x60(%rsp),%ymm3
    312b:	c4 e2 15 b8 9c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm13,%ymm3
    3132:	02 00 00 
    3135:	c5 fc 11 5c 24 60    	vmovups %ymm3,0x60(%rsp)
    313b:	c5 fc 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm3
    3142:	00 00 
    3144:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm13,%ymm3
    314b:	02 00 00 
    314e:	c5 fc 11 9c 24 80 00 	vmovups %ymm3,0x80(%rsp)
    3155:	00 00 
    3157:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    315e:	00 00 
    3160:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm13,%ymm3
    3167:	02 00 00 
    316a:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    3171:	00 00 
    3173:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    3178:	c4 e2 15 b8 9c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm13,%ymm3
    317f:	02 00 00 
    3182:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    3187:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    318d:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm13,%ymm3
    3194:	02 00 00 
    3197:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    319d:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    31a3:	c4 e2 15 b8 9c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm13,%ymm3
    31aa:	03 00 00 
    31ad:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    31b3:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    31b9:	c4 e2 15 b8 9c b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm13,%ymm3
    31c0:	03 00 00 
    31c3:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    31c9:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    31cf:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm13,%ymm3
    31d6:	03 00 00 
    31d9:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    31df:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    31e3:	c5 7c 29 c4          	vmovaps %ymm8,%ymm4
    31e7:	c4 41 7c 28 c3       	vmovaps %ymm11,%ymm8
    31ec:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    31f1:	c4 41 7c 28 e1       	vmovaps %ymm9,%ymm12
    31f6:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    31fb:	c5 7c 28 d5          	vmovaps %ymm5,%ymm10
    31ff:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    3203:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    3209:	4c 39 c3             	cmp    %r8,%rbx
    320c:	0f 8c 9e d3 ff ff    	jl     5b0 <_Z5benchv+0x460>
    3212:	e9 f4 cf ff ff       	jmpq   20b <_Z5benchv+0xbb>
    3217:	0f 31                	rdtsc  
    3219:	48 c1 e2 20          	shl    $0x20,%rdx
    321d:	48 09 c2             	or     %rax,%rdx
    3220:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3226 <_Z5benchv+0x30d6>
    3226:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    322b:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3233 <_Z5benchv+0x30e3>
    3232:	00 
    3233:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 323b <_Z5benchv+0x30eb>
    323a:	00 
    323b:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3242 <_Z5benchv+0x30f2>
    3242:	01 c0                	add    %eax,%eax
    3244:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    324a:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    324e:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    3255:	00 00 
    3257:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    325c:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    3260:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3264:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3268:	48 81 c4 68 02 00 00 	add    $0x268,%rsp
    326f:	5b                   	pop    %rbx
    3270:	41 5e                	pop    %r14
    3272:	c5 f8 77             	vzeroupper 
    3275:	c3                   	retq   
    3276:	90                   	nop
    3277:	90                   	nop
    3278:	90                   	nop
...
0000000000003290 <_Z9n_reg_maxv>:
    3290:	b8 b7 02 00 00       	mov    $0x2b7,%eax
    3295:	c3                   	retq   

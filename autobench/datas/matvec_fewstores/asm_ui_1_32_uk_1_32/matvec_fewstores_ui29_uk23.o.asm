...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e ea 32 00 00    	jle    3482 <_Z5benchv+0x3332>
     ...
     37a:	0f 83 02 31 00 00    	jae    3482 <_Z5benchv+0x3332>
    ...
    3237:	48 83 c6 17          	add    $0x17,%rsi
    323b:	49 0f af c2          	imul   %r10,%rax
    323f:	48 01 f8             	add    %rdi,%rax
    3242:	c4 e2 0d b8 84 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm14,%ymm0
    3249:	03 00 00 
    324c:	c4 62 0d b8 3c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm15
    3252:	c4 e2 0d b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm5
    3259:	00 00 00 
    325c:	c4 e2 0d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm7
    3263:	00 00 00 
    3266:	c4 62 0d b8 9c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm11
    326d:	01 00 00 
    3270:	c4 62 0d b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm8
    3277:	01 00 00 
    327a:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm14,%ymm12
    3281:	02 00 00 
    3284:	c4 62 0d b8 ac 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm14,%ymm13
    328b:	03 00 00 
    328e:	c4 e2 0d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm1
    3295:	c4 e2 0d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm2
    329c:	c4 e2 0d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm3
    32a3:	c4 e2 0d b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm4
    32aa:	00 00 00 
    32ad:	c4 e2 0d b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm6
    32b4:	00 00 00 
    32b7:	c4 62 0d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm14,%ymm10
    32be:	02 00 00 
    32c1:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    32c7:	c5 7c 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm9
    32cd:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm9
    32d4:	01 00 00 
    32d7:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    32de:	00 00 
    32e0:	c5 7c 29 f8          	vmovaps %ymm15,%ymm0
    32e4:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    32e8:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    32ec:	c5 7c 11 4c 24 a0    	vmovups %ymm9,-0x60(%rsp)
    32f2:	c5 7c 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm9
    32f9:	00 00 
    32fb:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm9
    3302:	01 00 00 
    3305:	c5 7c 11 8c 24 20 01 	vmovups %ymm9,0x120(%rsp)
    330c:	00 00 
    330e:	c5 7c 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm9
    3315:	00 00 
    3317:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm9
    331e:	01 00 00 
    3321:	c5 7c 11 8c 24 e0 00 	vmovups %ymm9,0xe0(%rsp)
    3328:	00 00 
    332a:	c5 7c 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm9
    3331:	00 00 
    3333:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm14,%ymm9
    333a:	01 00 00 
    333d:	c5 7c 11 8c 24 a0 00 	vmovups %ymm9,0xa0(%rsp)
    3344:	00 00 
    3346:	c5 7c 10 8c 24 00 01 	vmovups 0x100(%rsp),%ymm9
    334d:	00 00 
    334f:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm14,%ymm9
    3356:	01 00 00 
    3359:	c5 7c 11 8c 24 00 01 	vmovups %ymm9,0x100(%rsp)
    3360:	00 00 
    3362:	c5 7c 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm9
    3369:	00 00 
    336b:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm14,%ymm9
    3372:	01 00 00 
    3375:	c5 7c 11 8c 24 c0 00 	vmovups %ymm9,0xc0(%rsp)
    337c:	00 00 
    337e:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    3384:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm14,%ymm9
    338b:	02 00 00 
    338e:	c5 7c 11 4c 24 c0    	vmovups %ymm9,-0x40(%rsp)
    3394:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    339a:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm14,%ymm9
    33a1:	02 00 00 
    33a4:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    33aa:	c5 7c 11 4c 24 80    	vmovups %ymm9,-0x80(%rsp)
    33b0:	c5 7c 10 8c 24 40 01 	vmovups 0x140(%rsp),%ymm9
    33b7:	00 00 
    33b9:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm14,%ymm9
    33c0:	02 00 00 
    33c3:	c5 7c 11 8c 24 40 01 	vmovups %ymm9,0x140(%rsp)
    33ca:	00 00 
    33cc:	c5 7c 10 4c 24 60    	vmovups 0x60(%rsp),%ymm9
    33d2:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm14,%ymm9
    33d9:	02 00 00 
    33dc:	c5 7c 11 4c 24 60    	vmovups %ymm9,0x60(%rsp)
    33e2:	c5 7c 10 4c 24 40    	vmovups 0x40(%rsp),%ymm9
    33e8:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm14,%ymm9
    33ef:	02 00 00 
    33f2:	c5 7c 11 4c 24 40    	vmovups %ymm9,0x40(%rsp)
    33f8:	c5 7c 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm9
    33ff:	00 00 
    3401:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm14,%ymm9
    3408:	02 00 00 
    340b:	c5 7c 11 8c 24 80 00 	vmovups %ymm9,0x80(%rsp)
    3412:	00 00 
    3414:	c5 7c 10 4c 24 20    	vmovups 0x20(%rsp),%ymm9
    341a:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm14,%ymm9
    3421:	03 00 00 
    3424:	c5 7c 11 4c 24 20    	vmovups %ymm9,0x20(%rsp)
    342a:	c5 7c 10 0c 24       	vmovups (%rsp),%ymm9
    342f:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm14,%ymm9
    3436:	03 00 00 
    3439:	c5 7c 11 0c 24       	vmovups %ymm9,(%rsp)
    343e:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    3444:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm14,%ymm9
    344b:	03 00 00 
    344e:	c4 41 7c 28 f5       	vmovaps %ymm13,%ymm14
    3453:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    3458:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    345d:	c4 41 7c 28 e0       	vmovaps %ymm8,%ymm12
    3462:	c5 7c 10 44 24 a0    	vmovups -0x60(%rsp),%ymm8
    3468:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    346e:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    3474:	4c 39 c6             	cmp    %r8,%rsi
    3477:	0f 8c 03 d1 ff ff    	jl     580 <_Z5benchv+0x430>
    347d:	e9 74 cd ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    3482:	0f 31                	rdtsc  
    3484:	48 c1 e2 20          	shl    $0x20,%rdx
    3488:	48 09 c2             	or     %rax,%rdx
    348b:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3491 <_Z5benchv+0x3341>
    3491:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3496:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 349e <_Z5benchv+0x334e>
    349d:	00 
    349e:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 34a6 <_Z5benchv+0x3356>
    34a5:	00 
    34a6:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 34ad <_Z5benchv+0x335d>
    34ad:	01 c0                	add    %eax,%eax
    34af:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    34b5:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    34b9:	c5 fb 5c 84 24 78 01 	vsubsd 0x178(%rsp),%xmm0,%xmm0
    34c0:	00 00 
    34c2:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    34c6:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    34ca:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    34ce:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    34d2:	48 81 c4 38 02 00 00 	add    $0x238,%rsp
    34d9:	c5 f8 77             	vzeroupper 
    34dc:	c3                   	retq   
    34dd:	90                   	nop
    34de:	90                   	nop
    34df:	90                   	nop
...
00000000000034f0 <_Z9n_reg_maxv>:
    34f0:	b8 cf 02 00 00       	mov    $0x2cf,%eax
    34f5:	c3                   	retq   

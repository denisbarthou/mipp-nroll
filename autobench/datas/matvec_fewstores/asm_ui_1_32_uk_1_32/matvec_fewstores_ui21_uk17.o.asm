...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 55 17 00 00    	jle    18ed <_Z5benchv+0x179d>
     ...
     2e1:	0f 83 06 16 00 00    	jae    18ed <_Z5benchv+0x179d>
    ...
    1623:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    162a:	01 00 00 
    ...
    166d:	01 00 00 
    1670:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    1677:	02 00 00 
    167a:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    1680:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    1686:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    168d:	00 00 00 
    1690:	c5 fc 11 4c 24 60    	vmovups %ymm1,0x60(%rsp)
    1696:	c5 fc 28 cc          	vmovaps %ymm4,%ymm1
    169a:	c5 fc 28 e2          	vmovaps %ymm2,%ymm4
    169e:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    16a2:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    16a6:	c5 fc 10 6c 24 40    	vmovups 0x40(%rsp),%ymm5
    16ac:	c4 e2 4d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm1
    16b3:	01 00 00 
    16b6:	c4 e2 4d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm4
    16bd:	01 00 00 
    16c0:	c4 e2 4d b8 94 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm2
    16c7:	01 00 00 
    16ca:	c4 e2 4d b8 9c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm3
    16d1:	01 00 00 
    16d4:	c4 e2 4d b8 ac 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm5
    16db:	01 00 00 
    16de:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    16e4:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    16ea:	c4 e2 4d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm0
    16f1:	01 00 00 
    16f4:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    16fa:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    1700:	c4 e2 4d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm0
    1707:	02 00 00 
    170a:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    1710:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    1716:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    171d:	02 00 00 
    1720:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    1726:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    172b:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    1732:	02 00 00 
    1735:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    173a:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    1740:	c4 e2 4d b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm0
    1747:	02 00 00 
    174a:	48 8d 46 10          	lea    0x10(%rsi),%rax
    174e:	c4 e2 7d 18 74 b2 40 	vbroadcastss 0x40(%rdx,%rsi,4),%ymm6
    1755:	48 83 c6 11          	add    $0x11,%rsi
    1759:	49 0f af c2          	imul   %r10,%rax
    175d:	48 01 f8             	add    %rdi,%rax
    1760:	c4 e2 4d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm1
    1767:	01 00 00 
    176a:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    1771:	01 00 00 
    1774:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    177b:	02 00 00 
    177e:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    1784:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    178b:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    1792:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    1799:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    17a0:	00 00 00 
    17a3:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    17aa:	00 00 00 
    17ad:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    17b4:	00 00 00 
    17b7:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    17bd:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    17c3:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    17ca:	00 00 00 
    17cd:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    17d4:	00 00 
    17d6:	c5 fc 28 cc          	vmovaps %ymm4,%ymm1
    17da:	c4 e2 4d b8 8c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm1
    17e1:	01 00 00 
    17e4:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    17ea:	c5 7c 11 bc 24 20 01 	vmovups %ymm15,0x120(%rsp)
    17f1:	00 00 
    17f3:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    17f7:	c4 62 4d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm15
    17fe:	01 00 00 
    1801:	c4 e2 4d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm4
    1808:	02 00 00 
    180b:	c5 fc 11 bc 24 40 01 	vmovups %ymm7,0x140(%rsp)
    1812:	00 00 
    1814:	c5 7c 29 cd          	vmovaps %ymm9,%ymm5
    1818:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    181d:	c4 41 7c 28 dd       	vmovaps %ymm13,%ymm11
    1822:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    1828:	c5 fc 10 44 24 60    	vmovups 0x60(%rsp),%ymm0
    182e:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm0
    1835:	01 00 00 
    1838:	c5 fc 10 7c 24 e0    	vmovups -0x20(%rsp),%ymm7
    183e:	c5 fc 11 8c 24 e0 00 	vmovups %ymm1,0xe0(%rsp)
    1845:	00 00 
    1847:	c5 fc 28 ca          	vmovaps %ymm2,%ymm1
    184b:	c4 e2 4d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm1
    1852:	01 00 00 
    1855:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    185b:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    1861:	c4 e2 4d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm0
    1868:	01 00 00 
    186b:	c5 fc 11 8c 24 c0 00 	vmovups %ymm1,0xc0(%rsp)
    1872:	00 00 
    1874:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    1878:	c4 e2 4d b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm1
    187f:	01 00 00 
    1882:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    1888:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    188e:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    1895:	02 00 00 
    1898:	c5 fc 11 8c 24 a0 00 	vmovups %ymm1,0xa0(%rsp)
    189f:	00 00 
    18a1:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    18a7:	c4 e2 4d b8 8c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm1
    18ae:	02 00 00 
    18b1:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    18b7:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    18bc:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    18c3:	02 00 00 
    18c6:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    18ca:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    18cf:	c4 41 7c 28 d4       	vmovaps %ymm12,%ymm10
    18d4:	c4 41 7c 28 e6       	vmovaps %ymm14,%ymm12
    18d9:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    18df:	4c 39 c6             	cmp    %r8,%rsi
    18e2:	0f 8c 28 eb ff ff    	jl     410 <_Z5benchv+0x2c0>
    18e8:	e9 d7 e8 ff ff       	jmpq   1c4 <_Z5benchv+0x74>
    18ed:	0f 31                	rdtsc  
    18ef:	48 c1 e2 20          	shl    $0x20,%rdx
    18f3:	48 09 c2             	or     %rax,%rdx
    18f6:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 18fc <_Z5benchv+0x17ac>
    18fc:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1901:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1909 <_Z5benchv+0x17b9>
    1908:	00 
    1909:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1911 <_Z5benchv+0x17c1>
    1910:	00 
    1911:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1918 <_Z5benchv+0x17c8>
    1918:	01 c0                	add    %eax,%eax
    191a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1920:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1924:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    192b:	00 00 
    192d:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    1931:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    1935:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1939:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    193d:	48 81 c4 98 01 00 00 	add    $0x198,%rsp
    1944:	c5 f8 77             	vzeroupper 
    1947:	c3                   	retq   
    1948:	90                   	nop
    1949:	90                   	nop
    194a:	90                   	nop
...
0000000000001960 <_Z9n_reg_maxv>:
    1960:	b8 8b 01 00 00       	mov    $0x18b,%eax
    1965:	c3                   	retq   

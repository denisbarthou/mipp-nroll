...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e f1 1f 00 00    	jle    2189 <_Z5benchv+0x2039>
     ...
     30c:	0f 83 77 1e 00 00    	jae    2189 <_Z5benchv+0x2039>
    ...
    1fff:	48 83 c6 15          	add    $0x15,%rsi
    2003:	49 0f af c2          	imul   %r10,%rax
    2007:	48 01 f8             	add    %rdi,%rax
    200a:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    2011:	02 00 00 
    2014:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    201b:	00 00 00 
    201e:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    2025:	00 00 00 
    2028:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    202f:	01 00 00 
    2032:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    2039:	01 00 00 
    203c:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    2043:	02 00 00 
    2046:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    204c:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    2053:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    205a:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    2061:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    2068:	00 00 00 
    206b:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    2072:	00 00 00 
    2075:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    207c:	01 00 00 
    207f:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    2086:	01 00 00 
    2089:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    208f:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2096:	00 00 
    2098:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    209f:	01 00 00 
    20a2:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    20a9:	00 00 
    20ab:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    20af:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    20b3:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    20b7:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    20be:	00 00 
    20c0:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    20c7:	00 00 
    20c9:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    20cf:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    20d6:	01 00 00 
    20d9:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    20df:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    20e5:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    20ec:	01 00 00 
    20ef:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    20f5:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    20fb:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    2102:	01 00 00 
    2105:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    210b:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    2110:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    2117:	02 00 00 
    211a:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    211f:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2125:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    212c:	02 00 00 
    212f:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    2135:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    213b:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    2142:	02 00 00 
    2145:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    214b:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    2151:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    2158:	02 00 00 
    215b:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    2161:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    2167:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    216e:	02 00 00 
    2171:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    2175:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    217b:	4c 39 c6             	cmp    %r8,%rsi
    217e:	0f 8c fc e2 ff ff    	jl     480 <_Z5benchv+0x330>
    2184:	e9 56 e0 ff ff       	jmpq   1df <_Z5benchv+0x8f>
    2189:	0f 31                	rdtsc  
    218b:	48 c1 e2 20          	shl    $0x20,%rdx
    218f:	48 09 c2             	or     %rax,%rdx
    2192:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2198 <_Z5benchv+0x2048>
    2198:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    219d:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 21a5 <_Z5benchv+0x2055>
    21a4:	00 
    21a5:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 21ad <_Z5benchv+0x205d>
    21ac:	00 
    21ad:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 21b4 <_Z5benchv+0x2064>
    21b4:	01 c0                	add    %eax,%eax
    21b6:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    21bc:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    21c0:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    21c7:	00 00 
    21c9:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    21cd:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    21d1:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    21d5:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    21d9:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
0000000000002200 <_Z9n_reg_maxv>:
    2200:	b8 0f 02 00 00       	mov    $0x20f,%eax
    2205:	c3                   	retq   

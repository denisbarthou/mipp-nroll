...
0000000000000150 <_Z5benchv>:
     ...
     18c:	0f 8e 7b 16 00 00    	jle    180d <_Z5benchv+0x16bd>
     ...
     280:	0f 83 87 15 00 00    	jae    180d <_Z5benchv+0x16bd>
    ...
    1726:	48 83 c6 19          	add    $0x19,%rsi
    172a:	49 0f af c2          	imul   %r10,%rax
    172e:	48 01 f8             	add    %rdi,%rax
    1731:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1737:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    173e:	c4 e2 6d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm1
    1745:	01 00 00 
    1748:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    174f:	00 00 00 
    1752:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1759:	00 00 00 
    175c:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1763:	00 00 00 
    1766:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    176d:	00 00 00 
    1770:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1777:	01 00 00 
    177a:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1781:	01 00 00 
    1784:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    178b:	01 00 00 
    178e:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    1795:	01 00 00 
    1798:	c4 62 6d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm15
    179f:	01 00 00 
    17a2:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    17a9:	01 00 00 
    17ac:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    17b3:	02 00 00 
    17b6:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    17bc:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    17c2:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    17c9:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    17ce:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    17d4:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    17da:	c4 e2 6d b8 6c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm5
    17e1:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    17e7:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    17ed:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    17f4:	01 00 00 
    17f7:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    17fb:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    17ff:	4c 39 c6             	cmp    %r8,%rsi
    1802:	0f 8c 48 eb ff ff    	jl     350 <_Z5benchv+0x200>
    1808:	e9 bb e9 ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    180d:	0f 31                	rdtsc  
    180f:	48 c1 e2 20          	shl    $0x20,%rdx
    1813:	48 09 c2             	or     %rax,%rdx
    1816:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 181c <_Z5benchv+0x16cc>
    181c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1821:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1829 <_Z5benchv+0x16d9>
    1828:	00 
    1829:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1831 <_Z5benchv+0x16e1>
    1830:	00 
    1831:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1838 <_Z5benchv+0x16e8>
    1838:	01 c0                	add    %eax,%eax
    183a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1840:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1844:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    184a:	c5 c8 57 f6          	vxorps %xmm6,%xmm6,%xmm6
    184e:	c5 ca 2a c8          	vcvtsi2ss %eax,%xmm6,%xmm1
    1852:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1856:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    185a:	48 83 c4 38          	add    $0x38,%rsp
...
0000000000001880 <_Z9n_reg_maxv>:
    1880:	b8 d3 01 00 00       	mov    $0x1d3,%eax
    1885:	c3                   	retq   

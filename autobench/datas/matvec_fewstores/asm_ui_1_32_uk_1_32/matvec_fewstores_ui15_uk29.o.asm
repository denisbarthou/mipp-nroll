...
0000000000000150 <_Z5benchv>:
     ...
     188:	0f 8e 01 13 00 00    	jle    148f <_Z5benchv+0x133f>
     ...
     250:	0f 83 39 12 00 00    	jae    148f <_Z5benchv+0x133f>
    ...
    13ed:	48 83 c6 1d          	add    $0x1d,%rsi
    13f1:	49 0f af c2          	imul   %r10,%rax
    13f5:	48 01 f8             	add    %rdi,%rax
    13f8:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
    13fe:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
    1405:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
    140c:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
    1413:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
    141a:	00 00 00 
    141d:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
    1424:	00 00 00 
    1427:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
    142e:	00 00 00 
    1431:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
    1438:	00 00 00 
    143b:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
    1442:	01 00 00 
    1445:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
    144c:	01 00 00 
    144f:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
    1456:	01 00 00 
    1459:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
    1460:	01 00 00 
    1463:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
    146a:	01 00 00 
    146d:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
    1474:	01 00 00 
    1477:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
    147e:	01 00 00 
    1481:	4c 39 c6             	cmp    %r8,%rsi
    1484:	0f 8c 66 ee ff ff    	jl     2f0 <_Z5benchv+0x1a0>
    148a:	e9 31 ed ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    148f:	0f 31                	rdtsc  
    1491:	48 c1 e2 20          	shl    $0x20,%rdx
    1495:	48 09 c2             	or     %rax,%rdx
    1498:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 149e <_Z5benchv+0x134e>
    149e:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    14a3:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 14ab <_Z5benchv+0x135b>
    14aa:	00 
    14ab:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 14b3 <_Z5benchv+0x1363>
    14b2:	00 
    14b3:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 14ba <_Z5benchv+0x136a>
    14ba:	01 c0                	add    %eax,%eax
    14bc:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    14c2:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    14c6:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    14cc:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
    14d0:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
    14d4:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    14d8:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
00000000000014f0 <_Z9n_reg_maxv>:
    14f0:	b8 df 01 00 00       	mov    $0x1df,%eax
    14f5:	c3                   	retq   

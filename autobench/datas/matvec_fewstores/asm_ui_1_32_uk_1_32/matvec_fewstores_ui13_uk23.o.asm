...
0000000000000000 <_Z4initv>:
  ...
  35:	48 69 d1 c9 42 16 b2 	imul   $0xffffffffb21642c9,%rcx,%rdx
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 69 0d 00 00    	jle    ef1 <_Z5benchv+0xda1>
 ...
 22c:	0f 83 bf 0c 00 00    	jae    ef1 <_Z5benchv+0xda1>
 ...
 e63:	48 83 c6 17          	add    $0x17,%rsi
 e67:	49 0f af c2          	imul   %r10,%rax
 e6b:	48 01 f8             	add    %rdi,%rax
 e6e:	c4 e2 0d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm1
 e74:	c4 e2 0d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm2
 e7b:	c4 e2 0d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm3
 e82:	c4 e2 0d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm4
 e89:	c4 e2 0d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm5
 e90:	00 00 00 
 e93:	c4 e2 0d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm6
 e9a:	00 00 00 
 e9d:	c4 e2 0d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm7
 ea4:	00 00 00 
 ea7:	c4 62 0d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm8
 eae:	00 00 00 
 eb1:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm9
 eb8:	01 00 00 
 ebb:	c4 62 0d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm10
 ec2:	01 00 00 
 ec5:	c4 62 0d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm11
 ecc:	01 00 00 
 ecf:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm12
 ed6:	01 00 00 
 ed9:	c4 62 0d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm13
 ee0:	01 00 00 
 ee3:	4c 39 c6             	cmp    %r8,%rsi
 ee6:	0f 8c d4 f3 ff ff    	jl     2c0 <_Z5benchv+0x170>
 eec:	e9 bf f2 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 ef1:	0f 31                	rdtsc  
 ef3:	48 c1 e2 20          	shl    $0x20,%rdx
 ef7:	48 09 c2             	or     %rax,%rdx
 efa:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # f00 <_Z5benchv+0xdb0>
 f00:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 f05:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # f0d <_Z5benchv+0xdbd>
 f0c:	00 
 f0d:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # f15 <_Z5benchv+0xdc5>
 f14:	00 
 f15:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # f1c <_Z5benchv+0xdcc>
 f1c:	01 c0                	add    %eax,%eax
 f1e:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 f24:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 f28:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 f2c:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
 f30:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 f34:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000000f50 <_Z9n_reg_maxv>:
 f50:	b8 4f 01 00 00       	mov    $0x14f,%eax
 f55:	c3                   	retq   

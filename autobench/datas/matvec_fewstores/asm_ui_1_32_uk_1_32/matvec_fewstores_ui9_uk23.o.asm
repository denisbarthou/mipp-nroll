...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 81 09 00 00    	jle    b09 <_Z5benchv+0x9b9>
 ...
 204:	0f 83 ff 08 00 00    	jae    b09 <_Z5benchv+0x9b9>
 ...
 aa3:	48 83 c7 17          	add    $0x17,%rdi
 aa7:	49 0f af c3          	imul   %r11,%rax
 aab:	48 01 f0             	add    %rsi,%rax
 aae:	c4 e2 2d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm10,%ymm1
 ab4:	c4 e2 2d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm10,%ymm2
 abb:	c4 e2 2d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm10,%ymm3
 ac2:	c4 e2 2d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm10,%ymm4
 ac9:	c4 e2 2d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm10,%ymm5
 ad0:	00 00 00 
 ad3:	c4 e2 2d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm10,%ymm6
 ada:	00 00 00 
 add:	c4 e2 2d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm10,%ymm7
 ae4:	00 00 00 
 ae7:	c4 62 2d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm10,%ymm8
 aee:	00 00 00 
 af1:	c4 62 2d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm10,%ymm9
 af8:	01 00 00 
 afb:	4c 39 cf             	cmp    %r9,%rdi
 afe:	0f 8c 6c f7 ff ff    	jl     270 <_Z5benchv+0x120>
 b04:	e9 a7 f6 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 b09:	0f 31                	rdtsc  
 b0b:	48 c1 e2 20          	shl    $0x20,%rdx
 b0f:	48 09 c2             	or     %rax,%rdx
 b12:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # b18 <_Z5benchv+0x9c8>
 b18:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 b1d:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # b25 <_Z5benchv+0x9d5>
 b24:	00 
 b25:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # b2d <_Z5benchv+0x9dd>
 b2c:	00 
 b2d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # b34 <_Z5benchv+0x9e4>
 b34:	01 c0                	add    %eax,%eax
 b36:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b3c:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b40:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 b44:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
 b48:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 b4c:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 b50:	c5 f8 77             	vzeroupper 
 b53:	c3                   	retq   
 b54:	90                   	nop
 b55:	90                   	nop
 b56:	90                   	nop
...
0000000000000b70 <_Z9n_reg_maxv>:
 b70:	b8 ef 00 00 00       	mov    $0xef,%eax
 b75:	c3                   	retq   

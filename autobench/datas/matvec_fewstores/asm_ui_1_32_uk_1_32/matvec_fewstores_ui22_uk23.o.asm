...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 33 20 00 00    	jle    21cb <_Z5benchv+0x207b>
     ...
     2ee:	0f 83 d7 1e 00 00    	jae    21cb <_Z5benchv+0x207b>
    ...
    2021:	48 83 c6 17          	add    $0x17,%rsi
    2025:	49 0f af c3          	imul   %r11,%rax
    2029:	48 01 f8             	add    %rdi,%rax
    202c:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm7,%ymm3
    2033:	01 00 00 
    ...
    208a:	01 00 00 
    208d:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm7,%ymm4
    2094:	01 00 00 
    2097:	c4 e2 45 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm7,%ymm6
    209e:	01 00 00 
    20a1:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm7,%ymm5
    20a8:	02 00 00 
    20ab:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    20b1:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    20b7:	c4 e2 45 b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm7,%ymm2
    20be:	00 00 00 
    20c1:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    20c8:	00 00 
    20ca:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    20d0:	c4 e2 45 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm7,%ymm3
    20d7:	01 00 00 
    20da:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    20e1:	00 00 
    20e3:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    20ea:	00 00 
    20ec:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    20f3:	00 00 
    20f5:	c5 fc 11 ac 24 00 01 	vmovups %ymm5,0x100(%rsp)
    20fc:	00 00 
    20fe:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    2104:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    210a:	c4 e2 45 b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm7,%ymm2
    2111:	01 00 00 
    2114:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    211a:	c5 fc 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm3
    2120:	c4 e2 45 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm7,%ymm3
    2127:	02 00 00 
    212a:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    2130:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    2135:	c4 e2 45 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm7,%ymm2
    213c:	02 00 00 
    213f:	c5 fc 11 5c 24 a0    	vmovups %ymm3,-0x60(%rsp)
    2145:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    214b:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm7,%ymm3
    2152:	02 00 00 
    2155:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    215a:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    2160:	c4 e2 45 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm7,%ymm2
    2167:	02 00 00 
    216a:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    2170:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    2176:	c5 fc 10 54 24 c0    	vmovups -0x40(%rsp),%ymm2
    217c:	c4 e2 45 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm7,%ymm2
    2183:	02 00 00 
    2186:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    218a:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    218f:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    2194:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    2199:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    219e:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    21a3:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    21a8:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    21ad:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    21b1:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    21b7:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    21bd:	4c 39 c6             	cmp    %r8,%rsi
    21c0:	0f 8c 6a e2 ff ff    	jl     430 <_Z5benchv+0x2e0>
    21c6:	e9 f5 df ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    21cb:	0f 31                	rdtsc  
    21cd:	48 c1 e2 20          	shl    $0x20,%rdx
    21d1:	48 09 c2             	or     %rax,%rdx
    21d4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 21da <_Z5benchv+0x208a>
    21da:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    21df:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 21e7 <_Z5benchv+0x2097>
    21e6:	00 
    21e7:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 21ef <_Z5benchv+0x209f>
    21ee:	00 
    21ef:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 21f6 <_Z5benchv+0x20a6>
    21f6:	01 c0                	add    %eax,%eax
    21f8:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    21fe:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2202:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    2209:	00 00 
    220b:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    220f:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    2213:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2217:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    221b:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
    2222:	c5 f8 77             	vzeroupper 
    2225:	c3                   	retq   
    2226:	90                   	nop
    2227:	90                   	nop
    2228:	90                   	nop
...
0000000000002240 <_Z9n_reg_maxv>:
    2240:	b8 27 02 00 00       	mov    $0x227,%eax
    2245:	c3                   	retq   

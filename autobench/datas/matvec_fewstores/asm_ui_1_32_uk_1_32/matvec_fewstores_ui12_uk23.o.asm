...
matvec_fewstores_ui12_uk23.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
 ...
 183:	0f 8e 72 0c 00 00    	jle    dfb <_Z5benchv+0xcab>
 ...
 21f:	0f 83 d6 0b 00 00    	jae    dfb <_Z5benchv+0xcab>
 ...
 d77:	48 83 c3 17          	add    $0x17,%rbx
 d7b:	48 0f af f0          	imul   %rax,%rsi
 d7f:	48 01 fe             	add    %rdi,%rsi
 d82:	c4 e2 15 b8 1c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm3
 d88:	c4 e2 15 b8 6c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm5
 d8f:	c4 e2 15 b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm7
 d96:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
 d9d:	c4 e2 15 b8 8c b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm1
 da4:	00 00 00 
 da7:	c4 e2 15 b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm2
 dae:	00 00 00 
 db1:	c4 e2 15 b8 a4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm4
 db8:	00 00 00 
 dbb:	c4 e2 15 b8 b4 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm6
 dc2:	00 00 00 
 dc5:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
 dcc:	01 00 00 
 dcf:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
 dd6:	01 00 00 
 dd9:	c4 62 15 b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm11
 de0:	01 00 00 
 de3:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm12
 dea:	01 00 00 
 ded:	4c 39 c3             	cmp    %r8,%rbx
 df0:	0f 8c ba f4 ff ff    	jl     2b0 <_Z5benchv+0x160>
 df6:	e9 b5 f3 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 dfb:	0f 31                	rdtsc  
 dfd:	48 c1 e2 20          	shl    $0x20,%rdx
 e01:	48 09 c2             	or     %rax,%rdx
 e04:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # e0a <_Z5benchv+0xcba>
 e0a:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 e0f:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # e17 <_Z5benchv+0xcc7>
 e16:	00 
 e17:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # e1f <_Z5benchv+0xccf>
 e1e:	00 
 e1f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # e26 <_Z5benchv+0xcd6>
 e26:	01 c0                	add    %eax,%eax
 e28:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 e2e:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 e32:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 e36:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
 e3a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 e3e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 e42:	5b                   	pop    %rbx
 e43:	41 5e                	pop    %r14
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui12_uk23.cpp+0x9a>
  96:	01 00 00 00 

...
0000000000000140 <_Z5benchv>:
 ...
 17a:	0f 8e 83 08 00 00    	jle    a03 <_Z5benchv+0x8c3>
 ...
 1d7:	0f 83 26 08 00 00    	jae    a03 <_Z5benchv+0x8c3>
 ...
 9a7:	48 83 c3 17          	add    $0x17,%rbx
 9ab:	48 0f af e8          	imul   %rax,%rbp
 9af:	48 01 f5             	add    %rsi,%rbp
 9b2:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 9b8:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 9bf:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 9c6:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 9cd:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 9d4:	00 00 00 
 9d7:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 9de:	00 00 00 
 9e1:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 9e8:	00 00 00 
 9eb:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 9f2:	00 00 00 
 9f5:	48 39 fb             	cmp    %rdi,%rbx
 9f8:	0f 8c 52 f8 ff ff    	jl     250 <_Z5benchv+0x110>
 9fe:	e9 9d f7 ff ff       	jmpq   1a0 <_Z5benchv+0x60>
 a03:	0f 31                	rdtsc  
 a05:	48 c1 e2 20          	shl    $0x20,%rdx
 a09:	48 09 c2             	or     %rax,%rdx
 a0c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # a12 <_Z5benchv+0x8d2>
 a12:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 a17:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # a1f <_Z5benchv+0x8df>
 a1e:	00 
 a1f:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # a27 <_Z5benchv+0x8e7>
 a26:	00 
 a27:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # a2e <_Z5benchv+0x8ee>
 a2e:	01 c0                	add    %eax,%eax
 a30:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 a36:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 a3a:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 a3e:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 a42:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 a46:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 a4a:	5b                   	pop    %rbx
 a4b:	41 5c                	pop    %r12
 a4d:	41 5d                	pop    %r13
 a4f:	41 5e                	pop    %r14
...
0000000000000a70 <_Z9n_reg_maxv>:
 a70:	b8 d7 00 00 00       	mov    $0xd7,%eax
 a75:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
 ...
 181:	0f 8e ee 0c 00 00    	jle    e75 <_Z5benchv+0xd25>
 ...
 20d:	0f 83 62 0c 00 00    	jae    e75 <_Z5benchv+0xd25>
 ...
 e05:	48 83 c7 1d          	add    $0x1d,%rdi
 e09:	48 0f af c3          	imul   %rbx,%rax
 e0d:	48 01 f0             	add    %rsi,%rax
 e10:	c4 e2 25 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm1
 e16:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
 e1d:	c4 e2 25 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm2
 e24:	c4 e2 25 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm3
 e2b:	c4 e2 25 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm4
 e32:	00 00 00 
 e35:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm5
 e3c:	00 00 00 
 e3f:	c4 e2 25 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm6
 e46:	00 00 00 
 e49:	c4 62 25 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm8
 e50:	00 00 00 
 e53:	c4 62 25 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm9
 e5a:	01 00 00 
 e5d:	c4 62 25 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm10
 e64:	01 00 00 
 e67:	4c 39 d7             	cmp    %r10,%rdi
 e6a:	0f 8c 10 f4 ff ff    	jl     280 <_Z5benchv+0x130>
 e70:	e9 3b f3 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 e75:	0f 31                	rdtsc  
 e77:	48 c1 e2 20          	shl    $0x20,%rdx
 e7b:	48 09 c2             	or     %rax,%rdx
 e7e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # e84 <_Z5benchv+0xd34>
 e84:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 e89:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # e91 <_Z5benchv+0xd41>
 e90:	00 
 e91:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # e99 <_Z5benchv+0xd49>
 e98:	00 
 e99:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # ea0 <_Z5benchv+0xd50>
 ea0:	01 c0                	add    %eax,%eax
 ea2:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 ea8:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 eac:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 eb0:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 eb4:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 eb8:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 ebc:	5b                   	pop    %rbx
 ebd:	c5 f8 77             	vzeroupper 
 ec0:	c3                   	retq   
 ec1:	90                   	nop
 ec2:	90                   	nop
 ec3:	90                   	nop
...
0000000000000ee0 <_Z9n_reg_maxv>:
 ee0:	b8 49 01 00 00       	mov    $0x149,%eax
 ee5:	c3                   	retq   

...
0000000000000140 <_Z5benchv>:
 ...
 17a:	0f 8e 81 0a 00 00    	jle    c01 <_Z5benchv+0xac1>
 ...
 1d7:	0f 83 24 0a 00 00    	jae    c01 <_Z5benchv+0xac1>
 ...
 ba5:	48 83 c3 1d          	add    $0x1d,%rbx
 ba9:	48 0f af e8          	imul   %rax,%rbp
 bad:	48 01 f5             	add    %rsi,%rbp
 bb0:	c4 e2 35 b8 0c a9    	vfmadd231ps (%rcx,%rbp,4),%ymm9,%ymm1
 bb6:	c4 e2 35 b8 54 a9 20 	vfmadd231ps 0x20(%rcx,%rbp,4),%ymm9,%ymm2
 bbd:	c4 e2 35 b8 5c a9 40 	vfmadd231ps 0x40(%rcx,%rbp,4),%ymm9,%ymm3
 bc4:	c4 e2 35 b8 64 a9 60 	vfmadd231ps 0x60(%rcx,%rbp,4),%ymm9,%ymm4
 bcb:	c4 e2 35 b8 ac a9 80 	vfmadd231ps 0x80(%rcx,%rbp,4),%ymm9,%ymm5
 bd2:	00 00 00 
 bd5:	c4 e2 35 b8 b4 a9 a0 	vfmadd231ps 0xa0(%rcx,%rbp,4),%ymm9,%ymm6
 bdc:	00 00 00 
 bdf:	c4 e2 35 b8 bc a9 c0 	vfmadd231ps 0xc0(%rcx,%rbp,4),%ymm9,%ymm7
 be6:	00 00 00 
 be9:	c4 62 35 b8 84 a9 e0 	vfmadd231ps 0xe0(%rcx,%rbp,4),%ymm9,%ymm8
 bf0:	00 00 00 
 bf3:	48 39 fb             	cmp    %rdi,%rbx
 bf6:	0f 8c 54 f6 ff ff    	jl     250 <_Z5benchv+0x110>
 bfc:	e9 9f f5 ff ff       	jmpq   1a0 <_Z5benchv+0x60>
 c01:	0f 31                	rdtsc  
 c03:	48 c1 e2 20          	shl    $0x20,%rdx
 c07:	48 09 c2             	or     %rax,%rdx
 c0a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # c10 <_Z5benchv+0xad0>
 c10:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 c15:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # c1d <_Z5benchv+0xadd>
 c1c:	00 
 c1d:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # c25 <_Z5benchv+0xae5>
 c24:	00 
 c25:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # c2c <_Z5benchv+0xaec>
 c2c:	01 c0                	add    %eax,%eax
 c2e:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 c34:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 c38:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 c3c:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 c40:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 c44:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 c48:	5b                   	pop    %rbx
 c49:	41 5c                	pop    %r12
 c4b:	41 5d                	pop    %r13
 c4d:	41 5e                	pop    %r14
...
0000000000000c70 <_Z9n_reg_maxv>:
 c70:	b8 0d 01 00 00       	mov    $0x10d,%eax
 c75:	c3                   	retq   

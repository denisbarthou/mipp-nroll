...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 83 35 00 00    	jle    371b <_Z5benchv+0x35cb>
     ...
     38c:	0f 83 89 33 00 00    	jae    371b <_Z5benchv+0x35cb>
    ...
    34ac:	48 83 c6 17          	add    $0x17,%rsi
    34b0:	49 0f af c3          	imul   %r11,%rax
    34b4:	48 01 f8             	add    %rdi,%rax
    34b7:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
    34be:	00 00 00 
    34c1:	c4 e2 05 b8 84 81 a0 	vfmadd231ps 0x3a0(%rcx,%rax,4),%ymm15,%ymm0
    34c8:	03 00 00 
    34cb:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
    34d2:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
    34d9:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
    34e0:	01 00 00 
    34e3:	c4 62 05 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm14
    34ea:	01 00 00 
    34ed:	c4 62 05 b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm15,%ymm12
    34f4:	02 00 00 
    34f7:	c4 62 05 b8 94 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm15,%ymm10
    34fe:	02 00 00 
    3501:	c4 62 05 b8 ac 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm15,%ymm13
    3508:	03 00 00 
    350b:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
    3511:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
    3518:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
    351f:	00 00 00 
    3522:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
    3529:	00 00 00 
    352c:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
    3533:	00 00 00 
    3536:	c5 7c 11 1c 24       	vmovups %ymm11,(%rsp)
    353b:	c5 7c 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm11
    3541:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
    3548:	01 00 00 
    354b:	c5 7c 11 84 24 00 02 	vmovups %ymm8,0x200(%rsp)
    3552:	00 00 
    3554:	c5 7c 10 84 24 20 01 	vmovups 0x120(%rsp),%ymm8
    355b:	00 00 
    355d:	c4 62 05 b8 84 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm8
    3564:	01 00 00 
    3567:	c5 fc 11 84 24 20 02 	vmovups %ymm0,0x220(%rsp)
    356e:	00 00 
    3570:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    3574:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    3578:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    357c:	c5 7c 11 5c 24 c0    	vmovups %ymm11,-0x40(%rsp)
    3582:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    3588:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm11
    358f:	01 00 00 
    3592:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    3598:	c5 7c 11 84 24 20 01 	vmovups %ymm8,0x120(%rsp)
    359f:	00 00 
    35a1:	c5 7c 10 84 24 e0 00 	vmovups 0xe0(%rsp),%ymm8
    35a8:	00 00 
    35aa:	c4 62 05 b8 84 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm8
    35b1:	01 00 00 
    35b4:	c5 7c 11 5c 24 80    	vmovups %ymm11,-0x80(%rsp)
    35ba:	c5 7c 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm11
    35c0:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm15,%ymm11
    35c7:	02 00 00 
    35ca:	c5 7c 11 84 24 e0 00 	vmovups %ymm8,0xe0(%rsp)
    35d1:	00 00 
    35d3:	c5 7c 10 84 24 a0 00 	vmovups 0xa0(%rsp),%ymm8
    35da:	00 00 
    35dc:	c4 62 05 b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm15,%ymm8
    35e3:	01 00 00 
    35e6:	c5 7c 11 5c 24 a0    	vmovups %ymm11,-0x60(%rsp)
    35ec:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    35f2:	c5 7c 11 84 24 a0 00 	vmovups %ymm8,0xa0(%rsp)
    35f9:	00 00 
    35fb:	c5 7c 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm8
    3602:	00 00 
    3604:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm15,%ymm8
    360b:	01 00 00 
    360e:	c5 7c 11 84 24 80 00 	vmovups %ymm8,0x80(%rsp)
    3615:	00 00 
    3617:	c5 7c 10 84 24 00 01 	vmovups 0x100(%rsp),%ymm8
    361e:	00 00 
    3620:	c4 62 05 b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm15,%ymm8
    3627:	02 00 00 
    362a:	c5 7c 11 84 24 00 01 	vmovups %ymm8,0x100(%rsp)
    3631:	00 00 
    3633:	c5 7c 10 84 24 c0 00 	vmovups 0xc0(%rsp),%ymm8
    363a:	00 00 
    363c:	c4 62 05 b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm15,%ymm8
    3643:	02 00 00 
    3646:	c5 7c 11 84 24 c0 00 	vmovups %ymm8,0xc0(%rsp)
    364d:	00 00 
    364f:	c5 7c 10 84 24 40 01 	vmovups 0x140(%rsp),%ymm8
    3656:	00 00 
    3658:	c4 62 05 b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm15,%ymm8
    365f:	02 00 00 
    3662:	c5 7c 11 84 24 40 01 	vmovups %ymm8,0x140(%rsp)
    3669:	00 00 
    366b:	c5 7c 10 84 24 60 01 	vmovups 0x160(%rsp),%ymm8
    3672:	00 00 
    3674:	c4 62 05 b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm15,%ymm8
    367b:	02 00 00 
    367e:	c5 7c 11 84 24 60 01 	vmovups %ymm8,0x160(%rsp)
    3685:	00 00 
    3687:	c5 7c 10 44 24 20    	vmovups 0x20(%rsp),%ymm8
    368d:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm15,%ymm8
    3694:	02 00 00 
    3697:	c5 7c 11 44 24 20    	vmovups %ymm8,0x20(%rsp)
    369d:	c5 7c 10 44 24 60    	vmovups 0x60(%rsp),%ymm8
    36a3:	c4 62 05 b8 84 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm15,%ymm8
    36aa:	03 00 00 
    36ad:	c5 7c 11 44 24 60    	vmovups %ymm8,0x60(%rsp)
    36b3:	c5 7c 10 44 24 40    	vmovups 0x40(%rsp),%ymm8
    36b9:	c4 62 05 b8 84 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm15,%ymm8
    36c0:	03 00 00 
    36c3:	c5 7c 11 44 24 40    	vmovups %ymm8,0x40(%rsp)
    36c9:	c5 7c 10 44 24 e0    	vmovups -0x20(%rsp),%ymm8
    36cf:	c4 62 05 b8 84 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm15,%ymm8
    36d6:	03 00 00 
    36d9:	c5 7c 11 44 24 e0    	vmovups %ymm8,-0x20(%rsp)
    36df:	c5 7c 10 04 24       	vmovups (%rsp),%ymm8
    36e4:	c4 62 05 b8 84 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm15,%ymm8
    36eb:	03 00 00 
    36ee:	c5 7c 11 04 24       	vmovups %ymm8,(%rsp)
    36f3:	c4 41 7c 28 c4       	vmovaps %ymm12,%ymm8
    36f8:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    36fd:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    3702:	c4 41 7c 28 f2       	vmovaps %ymm10,%ymm14
    3707:	c5 7c 10 54 24 a0    	vmovups -0x60(%rsp),%ymm10
    370d:	4c 39 c6             	cmp    %r8,%rsi
    3710:	0f 8c 8a ce ff ff    	jl     5a0 <_Z5benchv+0x450>
    3716:	e9 d2 ca ff ff       	jmpq   1ed <_Z5benchv+0x9d>
    371b:	0f 31                	rdtsc  
    371d:	48 c1 e2 20          	shl    $0x20,%rdx
    3721:	48 09 c2             	or     %rax,%rdx
    3724:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 372a <_Z5benchv+0x35da>
    372a:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    372f:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3737 <_Z5benchv+0x35e7>
    3736:	00 
    3737:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 373f <_Z5benchv+0x35ef>
    373e:	00 
    373f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3746 <_Z5benchv+0x35f6>
    3746:	01 c0                	add    %eax,%eax
    3748:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    374e:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3752:	c5 fb 5c 84 24 98 01 	vsubsd 0x198(%rsp),%xmm0,%xmm0
    3759:	00 00 
    375b:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    3760:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    3764:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3768:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    376c:	48 81 c4 58 02 00 00 	add    $0x258,%rsp
    3773:	c5 f8 77             	vzeroupper 
    3776:	c3                   	retq   
    3777:	90                   	nop
    3778:	90                   	nop
    3779:	90                   	nop
...
0000000000003790 <_Z9n_reg_maxv>:
    3790:	b8 e7 02 00 00       	mov    $0x2e7,%eax
    3795:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 19 2b 00 00    	jle    2cb1 <_Z5benchv+0x2b61>
     ...
     356:	0f 83 55 29 00 00    	jae    2cb1 <_Z5benchv+0x2b61>
    ...
    2ab0:	48 83 c6 17          	add    $0x17,%rsi
    2ab4:	49 0f af c3          	imul   %r11,%rax
    2ab8:	48 01 f8             	add    %rdi,%rax
    2abb:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm11,%ymm2
    2ac2:	00 00 00 
    2ac5:	c4 e2 25 b8 84 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm11,%ymm0
    2acc:	03 00 00 
    2acf:	c4 e2 25 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm11,%ymm7
    2ad6:	c4 e2 25 b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm11,%ymm1
    2add:	00 00 00 
    2ae0:	c4 62 25 b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm11,%ymm9
    2ae7:	00 00 00 
    2aea:	c4 e2 25 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm11,%ymm4
    2af1:	01 00 00 
    2af4:	c4 e2 25 b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm11,%ymm6
    2afb:	01 00 00 
    2afe:	c4 e2 25 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm11,%ymm3
    2b05:	01 00 00 
    2b08:	c4 62 25 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm11,%ymm10
    2b0f:	01 00 00 
    2b12:	c4 62 25 b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm11,%ymm8
    2b19:	02 00 00 
    2b1c:	c4 62 25 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm11,%ymm12
    2b22:	c4 62 25 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm11,%ymm13
    2b29:	c4 62 25 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm11,%ymm14
    2b30:	c4 62 25 b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm11,%ymm15
    2b37:	00 00 00 
    2b3a:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    2b3f:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    2b45:	c4 e2 25 b8 ac 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm11,%ymm5
    2b4c:	01 00 00 
    2b4f:	c5 fc 11 94 24 60 01 	vmovups %ymm2,0x160(%rsp)
    2b56:	00 00 
    2b58:	c5 fc 10 94 24 c0 00 	vmovups 0xc0(%rsp),%ymm2
    2b5f:	00 00 
    2b61:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm11,%ymm2
    2b68:	01 00 00 
    2b6b:	c5 fc 11 84 24 80 01 	vmovups %ymm0,0x180(%rsp)
    2b72:	00 00 
    2b74:	c5 fc 28 c1          	vmovaps %ymm1,%ymm0
    2b78:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    2b7c:	c5 fc 28 de          	vmovaps %ymm6,%ymm3
    2b80:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    2b86:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    2b8c:	c4 e2 25 b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm11,%ymm5
    2b93:	01 00 00 
    2b96:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    2b9c:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    2ba3:	00 00 
    2ba5:	c5 fc 10 94 24 e0 00 	vmovups 0xe0(%rsp),%ymm2
    2bac:	00 00 
    2bae:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm11,%ymm2
    2bb5:	02 00 00 
    2bb8:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    2bbe:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    2bc4:	c4 e2 25 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm11,%ymm5
    2bcb:	01 00 00 
    2bce:	c5 fc 11 94 24 e0 00 	vmovups %ymm2,0xe0(%rsp)
    2bd5:	00 00 
    2bd7:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    2bdd:	c4 e2 25 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm11,%ymm2
    2be4:	02 00 00 
    2be7:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    2bed:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    2bf3:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    2bf9:	c5 fc 10 94 24 a0 00 	vmovups 0xa0(%rsp),%ymm2
    2c00:	00 00 
    2c02:	c4 e2 25 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm11,%ymm2
    2c09:	02 00 00 
    2c0c:	c5 fc 11 94 24 a0 00 	vmovups %ymm2,0xa0(%rsp)
    2c13:	00 00 
    2c15:	c5 fc 10 94 24 80 00 	vmovups 0x80(%rsp),%ymm2
    2c1c:	00 00 
    2c1e:	c4 e2 25 b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm11,%ymm2
    2c25:	02 00 00 
    2c28:	c5 fc 11 94 24 80 00 	vmovups %ymm2,0x80(%rsp)
    2c2f:	00 00 
    2c31:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    2c37:	c4 e2 25 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm11,%ymm2
    2c3e:	02 00 00 
    2c41:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    2c47:	c5 fc 10 54 24 20    	vmovups 0x20(%rsp),%ymm2
    2c4d:	c4 e2 25 b8 94 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm11,%ymm2
    2c54:	02 00 00 
    2c57:	c5 fc 11 54 24 20    	vmovups %ymm2,0x20(%rsp)
    2c5d:	c5 fc 10 54 24 e0    	vmovups -0x20(%rsp),%ymm2
    2c63:	c4 e2 25 b8 94 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm11,%ymm2
    2c6a:	02 00 00 
    2c6d:	c5 fc 11 54 24 e0    	vmovups %ymm2,-0x20(%rsp)
    2c73:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    2c78:	c4 e2 25 b8 94 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm11,%ymm2
    2c7f:	03 00 00 
    2c82:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    2c87:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    2c8b:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    2c8f:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    2c94:	c4 41 7c 28 d0       	vmovaps %ymm8,%ymm10
    2c99:	c5 7c 28 c4          	vmovaps %ymm4,%ymm8
    2c9d:	c5 fc 10 64 24 a0    	vmovups -0x60(%rsp),%ymm4
    2ca3:	4c 39 c6             	cmp    %r8,%rsi
    2ca6:	0f 8c 94 d8 ff ff    	jl     540 <_Z5benchv+0x3f0>
    2cac:	e9 52 d5 ff ff       	jmpq   203 <_Z5benchv+0xb3>
    2cb1:	0f 31                	rdtsc  
    2cb3:	48 c1 e2 20          	shl    $0x20,%rdx
    2cb7:	48 09 c2             	or     %rax,%rdx
    2cba:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2cc0 <_Z5benchv+0x2b70>
    2cc0:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2cc5:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2ccd <_Z5benchv+0x2b7d>
    2ccc:	00 
    2ccd:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2cd5 <_Z5benchv+0x2b85>
    2cd4:	00 
    2cd5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2cdc <_Z5benchv+0x2b8c>
    2cdc:	01 c0                	add    %eax,%eax
    2cde:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2ce4:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2ce8:	c5 fb 5c 84 24 18 01 	vsubsd 0x118(%rsp),%xmm0,%xmm0
    2cef:	00 00 
    2cf1:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    2cf6:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    2cfa:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2cfe:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2d02:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
...
0000000000002d20 <_Z9n_reg_maxv>:
    2d20:	b8 87 02 00 00       	mov    $0x287,%eax
    2d25:	c3                   	retq   

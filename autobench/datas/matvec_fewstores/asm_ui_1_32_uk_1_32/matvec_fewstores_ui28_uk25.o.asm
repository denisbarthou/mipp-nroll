...
0000000000000150 <_Z5benchv>:
     ...
     193:	0f 8e 4c 34 00 00    	jle    35e5 <_Z5benchv+0x3495>
     ...
     37f:	0f 83 60 32 00 00    	jae    35e5 <_Z5benchv+0x3495>
    ...
    33b4:	48 83 c3 19          	add    $0x19,%rbx
    33b8:	48 0f af f0          	imul   %rax,%rsi
    33bc:	48 01 fe             	add    %rdi,%rsi
    33bf:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm3
    33c6:	00 00 00 
    33c9:	c4 e2 15 b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm2
    33d0:	c4 e2 15 b8 64 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm4
    33d7:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
    33de:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
    33e5:	01 00 00 
    33e8:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
    33ef:	01 00 00 
    33f2:	c4 e2 15 b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm6
    33f9:	01 00 00 
    33fc:	c4 62 15 b8 9c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm13,%ymm11
    3403:	02 00 00 
    3406:	c4 e2 15 b8 ac b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm13,%ymm5
    340d:	02 00 00 
    3410:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm13,%ymm12
    3417:	03 00 00 
    341a:	c4 e2 15 b8 04 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm0
    3420:	c4 62 15 b8 b4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm14
    3427:	00 00 00 
    342a:	c4 62 15 b8 bc b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm15
    3431:	00 00 00 
    3434:	c4 e2 15 b8 8c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm1
    343b:	00 00 00 
    343e:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    3444:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    344a:	c4 e2 15 b8 bc b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm7
    3451:	01 00 00 
    3454:	c5 fc 11 9c 24 80 01 	vmovups %ymm3,0x180(%rsp)
    345b:	00 00 
    345d:	c5 fc 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm3
    3464:	00 00 
    3466:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm13,%ymm3
    346d:	01 00 00 
    3470:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    3476:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    347c:	c4 e2 15 b8 bc b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm13,%ymm7
    3483:	01 00 00 
    3486:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    348d:	00 00 
    348f:	c5 fc 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm3
    3496:	00 00 
    3498:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm13,%ymm3
    349f:	01 00 00 
    34a2:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    34a8:	c5 fc 28 fa          	vmovaps %ymm2,%ymm7
    34ac:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    34b2:	c5 fc 11 9c 24 c0 00 	vmovups %ymm3,0xc0(%rsp)
    34b9:	00 00 
    34bb:	c5 fc 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm3
    34c2:	00 00 
    34c4:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm13,%ymm3
    34cb:	01 00 00 
    34ce:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    34d5:	00 00 
    34d7:	c5 fc 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm3
    34de:	00 00 
    34e0:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm13,%ymm3
    34e7:	02 00 00 
    34ea:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    34f1:	00 00 
    34f3:	c5 fc 10 5c 24 60    	vmovups 0x60(%rsp),%ymm3
    34f9:	c4 e2 15 b8 9c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm13,%ymm3
    3500:	02 00 00 
    3503:	c5 fc 11 5c 24 60    	vmovups %ymm3,0x60(%rsp)
    3509:	c5 fc 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm3
    3510:	00 00 
    3512:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm13,%ymm3
    3519:	02 00 00 
    351c:	c5 fc 11 9c 24 80 00 	vmovups %ymm3,0x80(%rsp)
    3523:	00 00 
    3525:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    352c:	00 00 
    352e:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm13,%ymm3
    3535:	02 00 00 
    3538:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    353f:	00 00 
    3541:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    3546:	c4 e2 15 b8 9c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm13,%ymm3
    354d:	02 00 00 
    3550:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    3555:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    355b:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm13,%ymm3
    3562:	02 00 00 
    3565:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    356b:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    3571:	c4 e2 15 b8 9c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm13,%ymm3
    3578:	03 00 00 
    357b:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    3581:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    3587:	c4 e2 15 b8 9c b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm13,%ymm3
    358e:	03 00 00 
    3591:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    3597:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    359d:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm13,%ymm3
    35a4:	03 00 00 
    35a7:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    35ad:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    35b1:	c5 7c 29 c4          	vmovaps %ymm8,%ymm4
    35b5:	c4 41 7c 28 c3       	vmovaps %ymm11,%ymm8
    35ba:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    35bf:	c4 41 7c 28 e1       	vmovaps %ymm9,%ymm12
    35c4:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    35c9:	c5 7c 28 d5          	vmovaps %ymm5,%ymm10
    35cd:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    35d1:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    35d7:	4c 39 c3             	cmp    %r8,%rbx
    35da:	0f 8c d0 cf ff ff    	jl     5b0 <_Z5benchv+0x460>
    35e0:	e9 26 cc ff ff       	jmpq   20b <_Z5benchv+0xbb>
    35e5:	0f 31                	rdtsc  
    35e7:	48 c1 e2 20          	shl    $0x20,%rdx
    35eb:	48 09 c2             	or     %rax,%rdx
    35ee:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 35f4 <_Z5benchv+0x34a4>
    35f4:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    35f9:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3601 <_Z5benchv+0x34b1>
    3600:	00 
    3601:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3609 <_Z5benchv+0x34b9>
    3608:	00 
    3609:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3610 <_Z5benchv+0x34c0>
    3610:	01 c0                	add    %eax,%eax
    3612:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3618:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    361c:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    3623:	00 00 
    3625:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    362a:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    362e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3632:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3636:	48 81 c4 68 02 00 00 	add    $0x268,%rsp
    363d:	5b                   	pop    %rbx
    363e:	41 5e                	pop    %r14
    3640:	c5 f8 77             	vzeroupper 
    3643:	c3                   	retq   
    3644:	90                   	nop
    3645:	90                   	nop
    3646:	90                   	nop
...
0000000000003660 <_Z9n_reg_maxv>:
    3660:	b8 f1 02 00 00       	mov    $0x2f1,%eax
    3665:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
 ...
 188:	0f 8e bd 0b 00 00    	jle    d4b <_Z5benchv+0xbfb>
 ...
 250:	0f 83 f5 0a 00 00    	jae    d4b <_Z5benchv+0xbfb>
 ...
 ca9:	48 83 c6 11          	add    $0x11,%rsi
 cad:	49 0f af c2          	imul   %r10,%rax
 cb1:	48 01 f8             	add    %rdi,%rax
 cb4:	c4 e2 7d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm0,%ymm1
 cba:	c4 e2 7d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm0,%ymm2
 cc1:	c4 e2 7d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm0,%ymm3
 cc8:	c4 e2 7d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm0,%ymm4
 ccf:	c4 e2 7d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm0,%ymm5
 cd6:	00 00 00 
 cd9:	c4 e2 7d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm0,%ymm6
 ce0:	00 00 00 
 ce3:	c4 e2 7d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm0,%ymm7
 cea:	00 00 00 
 ced:	c4 62 7d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm0,%ymm8
 cf4:	00 00 00 
 cf7:	c4 62 7d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm0,%ymm9
 cfe:	01 00 00 
 d01:	c4 62 7d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm0,%ymm10
 d08:	01 00 00 
 d0b:	c4 62 7d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm0,%ymm11
 d12:	01 00 00 
 d15:	c4 62 7d b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm0,%ymm12
 d1c:	01 00 00 
 d1f:	c4 62 7d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm0,%ymm13
 d26:	01 00 00 
 d29:	c4 62 7d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm0,%ymm14
 d30:	01 00 00 
 d33:	c4 62 7d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm0,%ymm15
 d3a:	01 00 00 
 d3d:	4c 39 c6             	cmp    %r8,%rsi
 d40:	0f 8c aa f5 ff ff    	jl     2f0 <_Z5benchv+0x1a0>
 d46:	e9 75 f4 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
 d4b:	0f 31                	rdtsc  
 d4d:	48 c1 e2 20          	shl    $0x20,%rdx
 d51:	48 09 c2             	or     %rax,%rdx
 d54:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # d5a <_Z5benchv+0xc0a>
 d5a:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
 d5f:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # d67 <_Z5benchv+0xc17>
 d66:	00 
 d67:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # d6f <_Z5benchv+0xc1f>
 d6e:	00 
 d6f:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # d76 <_Z5benchv+0xc26>
 d76:	01 c0                	add    %eax,%eax
 d78:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
 d7e:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
 d82:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
 d88:	c5 e8 57 d2          	vxorps %xmm2,%xmm2,%xmm2
 d8c:	c5 ea 2a c8          	vcvtsi2ss %eax,%xmm2,%xmm1
 d90:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 d94:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 d98:	c5 f8 77             	vzeroupper 
 d9b:	c3                   	retq   
 d9c:	90                   	nop
 d9d:	90                   	nop
 d9e:	90                   	nop
...
0000000000000db0 <_Z9n_reg_maxv>:
 db0:	b8 1f 01 00 00       	mov    $0x11f,%eax
 db5:	c3                   	retq   

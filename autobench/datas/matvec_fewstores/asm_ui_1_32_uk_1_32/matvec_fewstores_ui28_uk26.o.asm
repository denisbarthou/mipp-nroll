...
0000000000000150 <_Z5benchv>:
     ...
     197:	0f 8e 98 36 00 00    	jle    3835 <_Z5benchv+0x36e5>
     ...
     399:	0f 83 96 34 00 00    	jae    3835 <_Z5benchv+0x36e5>
    ...
    35ef:	48 83 c3 1a          	add    $0x1a,%rbx
    35f3:	49 0f af c7          	imul   %r15,%rax
    35f7:	48 01 f8             	add    %rdi,%rax
    35fa:	c4 e2 15 b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm13,%ymm1
    3601:	00 00 00 
    3604:	c4 e2 15 b8 b4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm13,%ymm6
    360b:	01 00 00 
    360e:	c4 62 15 b8 9c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm13,%ymm11
    3615:	02 00 00 
    3618:	c4 e2 15 b8 ac 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm13,%ymm5
    361f:	02 00 00 
    3622:	c4 62 15 b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm13,%ymm15
    3629:	00 00 00 
    362c:	c4 e2 15 b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm13,%ymm0
    3632:	c4 e2 15 b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm13,%ymm2
    3639:	c4 e2 15 b8 64 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm13,%ymm4
    3640:	c4 e2 15 b8 9c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm13,%ymm3
    3647:	00 00 00 
    364a:	c4 62 15 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm13,%ymm10
    3651:	01 00 00 
    3654:	c4 62 15 b8 a4 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm13,%ymm12
    365b:	03 00 00 
    365e:	c4 62 15 b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm13,%ymm14
    3665:	00 00 00 
    3668:	c4 62 15 b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm13,%ymm9
    366f:	c4 62 15 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm13,%ymm8
    3676:	01 00 00 
    3679:	c5 fc 11 bc 24 20 01 	vmovups %ymm7,0x120(%rsp)
    3680:	00 00 
    3682:	c5 fc 10 bc 24 00 01 	vmovups 0x100(%rsp),%ymm7
    3689:	00 00 
    368b:	c4 e2 15 b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm13,%ymm7
    3692:	01 00 00 
    3695:	c5 fc 11 8c 24 80 01 	vmovups %ymm1,0x180(%rsp)
    369c:	00 00 
    369e:	c5 fc 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm1
    36a5:	00 00 
    36a7:	c4 e2 15 b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm13,%ymm1
    36ae:	01 00 00 
    36b1:	c5 7c 11 bc 24 a0 01 	vmovups %ymm15,0x1a0(%rsp)
    36b8:	00 00 
    36ba:	c5 7c 28 f8          	vmovaps %ymm0,%ymm15
    36be:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    36c2:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    36c6:	c5 7c 29 e3          	vmovaps %ymm12,%ymm3
    36ca:	c5 7c 11 b4 24 60 01 	vmovups %ymm14,0x160(%rsp)
    36d1:	00 00 
    36d3:	c5 fc 11 bc 24 00 01 	vmovups %ymm7,0x100(%rsp)
    36da:	00 00 
    36dc:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    36e2:	c4 e2 15 b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm13,%ymm7
    36e9:	01 00 00 
    36ec:	c5 fc 11 8c 24 a0 00 	vmovups %ymm1,0xa0(%rsp)
    36f3:	00 00 
    36f5:	c5 fc 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm1
    36fc:	00 00 
    36fe:	c4 e2 15 b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm13,%ymm1
    3705:	01 00 00 
    3708:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    370e:	c5 fc 10 bc 24 00 01 	vmovups 0x100(%rsp),%ymm7
    3715:	00 00 
    3717:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    371e:	00 00 
    3720:	c5 fc 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm1
    3727:	00 00 
    3729:	c4 e2 15 b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm13,%ymm1
    3730:	01 00 00 
    3733:	c5 fc 11 8c 24 c0 00 	vmovups %ymm1,0xc0(%rsp)
    373a:	00 00 
    373c:	c5 fc 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm1
    3743:	00 00 
    3745:	c4 e2 15 b8 8c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm13,%ymm1
    374c:	02 00 00 
    374f:	c5 fc 11 8c 24 e0 00 	vmovups %ymm1,0xe0(%rsp)
    3756:	00 00 
    3758:	c5 fc 10 4c 24 20    	vmovups 0x20(%rsp),%ymm1
    375e:	c4 e2 15 b8 8c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm13,%ymm1
    3765:	02 00 00 
    3768:	c5 fc 11 4c 24 20    	vmovups %ymm1,0x20(%rsp)
    376e:	c5 fc 10 4c 24 40    	vmovups 0x40(%rsp),%ymm1
    3774:	c4 e2 15 b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm13,%ymm1
    377b:	02 00 00 
    377e:	c5 fc 11 4c 24 40    	vmovups %ymm1,0x40(%rsp)
    3784:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    378a:	c4 e2 15 b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm13,%ymm1
    3791:	02 00 00 
    3794:	c5 fc 11 4c 24 60    	vmovups %ymm1,0x60(%rsp)
    379a:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    37a0:	c4 e2 15 b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm13,%ymm1
    37a7:	02 00 00 
    37aa:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    37b0:	c5 fc 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm1
    37b6:	c4 e2 15 b8 8c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm13,%ymm1
    37bd:	02 00 00 
    37c0:	c5 fc 11 4c 24 e0    	vmovups %ymm1,-0x20(%rsp)
    37c6:	c5 fc 10 0c 24       	vmovups (%rsp),%ymm1
    37cb:	c4 e2 15 b8 8c 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm13,%ymm1
    37d2:	03 00 00 
    37d5:	c5 fc 11 0c 24       	vmovups %ymm1,(%rsp)
    37da:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    37e0:	c4 e2 15 b8 8c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm13,%ymm1
    37e7:	03 00 00 
    37ea:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    37f0:	c5 fc 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm1
    37f7:	00 00 
    37f9:	c4 e2 15 b8 8c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm13,%ymm1
    3800:	03 00 00 
    3803:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    3808:	c5 7c 28 dd          	vmovaps %ymm5,%ymm11
    380c:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    3810:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    3816:	c5 fc 11 8c 24 20 01 	vmovups %ymm1,0x120(%rsp)
    381d:	00 00 
    381f:	c5 fc 28 cc          	vmovaps %ymm4,%ymm1
    3823:	c5 7c 29 d4          	vmovaps %ymm10,%ymm4
    3827:	4c 39 c3             	cmp    %r8,%rbx
    382a:	0f 8c b0 cd ff ff    	jl     5e0 <_Z5benchv+0x490>
    3830:	e9 e1 c9 ff ff       	jmpq   216 <_Z5benchv+0xc6>
    3835:	0f 31                	rdtsc  
    3837:	48 c1 e2 20          	shl    $0x20,%rdx
    383b:	48 09 c2             	or     %rax,%rdx
    383e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3844 <_Z5benchv+0x36f4>
    3844:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3849:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3851 <_Z5benchv+0x3701>
    3850:	00 
    3851:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3859 <_Z5benchv+0x3709>
    3858:	00 
    3859:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3860 <_Z5benchv+0x3710>
    3860:	01 c0                	add    %eax,%eax
    3862:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3868:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    386c:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    3873:	00 00 
    3875:	c4 41 08 57 f6       	vxorps %xmm14,%xmm14,%xmm14
    387a:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    387e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3882:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3886:	48 81 c4 a0 02 00 00 	add    $0x2a0,%rsp
    388d:	5b                   	pop    %rbx
    388e:	41 5e                	pop    %r14
    3890:	41 5f                	pop    %r15
...
00000000000038b0 <_Z9n_reg_maxv>:
    38b0:	b8 0e 03 00 00       	mov    $0x30e,%eax
    38b5:	c3                   	retq   

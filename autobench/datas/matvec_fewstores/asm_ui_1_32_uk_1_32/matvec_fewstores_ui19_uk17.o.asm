...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e 91 14 00 00    	jle    1626 <_Z5benchv+0x14d6>
     ...
     2bc:	0f 83 64 13 00 00    	jae    1626 <_Z5benchv+0x14d6>
    ...
    1474:	c5 7c 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm13
    147a:	c4 62 5d b8 ac 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm13
    1481:	02 00 00 
    1484:	c5 7c 11 54 24 e0    	vmovups %ymm10,-0x20(%rsp)
    148a:	c5 7c 10 54 24 20    	vmovups 0x20(%rsp),%ymm10
    1490:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm10
    1497:	01 00 00 
    149a:	c5 7c 11 54 24 20    	vmovups %ymm10,0x20(%rsp)
    14a0:	c5 7c 10 54 24 a0    	vmovups -0x60(%rsp),%ymm10
    14a6:	c4 62 5d b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm10
    14ad:	01 00 00 
    14b0:	c5 7c 11 54 24 a0    	vmovups %ymm10,-0x60(%rsp)
    14b6:	c5 7c 10 14 24       	vmovups (%rsp),%ymm10
    14bb:	c4 62 5d b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm10
    14c2:	02 00 00 
    14c5:	48 8d 46 10          	lea    0x10(%rsi),%rax
    14c9:	c4 e2 7d 18 64 b2 40 	vbroadcastss 0x40(%rdx,%rsi,4),%ymm4
    14d0:	48 83 c6 11          	add    $0x11,%rsi
    14d4:	49 0f af c2          	imul   %r10,%rax
    14d8:	48 01 f8             	add    %rdi,%rax
    14db:	c4 e2 5d b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm2
    14e2:	00 00 00 
    14e5:	c4 e2 5d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm1
    14ec:	01 00 00 
    14ef:	c4 e2 5d b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm3
    14f6:	01 00 00 
    14f9:	c4 62 5d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm15
    1500:	01 00 00 
    1503:	c4 e2 5d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm5
    1509:	c4 e2 5d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm6
    1510:	c4 62 5d b8 44 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm8
    1517:	c4 e2 5d b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm7
    151e:	00 00 00 
    1521:	c4 62 5d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm9
    1528:	00 00 00 
    152b:	c4 62 5d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm14
    1532:	01 00 00 
    1535:	c4 62 5d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm12
    153c:	01 00 00 
    153f:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    1546:	00 00 00 
    1549:	c4 62 5d b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm11
    1550:	02 00 00 
    1553:	c5 7c 11 14 24       	vmovups %ymm10,(%rsp)
    1558:	c5 7c 10 54 24 e0    	vmovups -0x20(%rsp),%ymm10
    155e:	c4 62 5d b8 54 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm10
    1565:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    156b:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    1571:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    1578:	00 00 
    157a:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    157e:	c5 fc 10 5c 24 80    	vmovups -0x80(%rsp),%ymm3
    1584:	c4 e2 5d b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm2
    158b:	01 00 00 
    158e:	c4 e2 5d b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm3
    1595:	01 00 00 
    1598:	c5 7c 11 bc 24 c0 00 	vmovups %ymm15,0xc0(%rsp)
    159f:	00 00 
    15a1:	c5 7c 10 7c 24 20    	vmovups 0x20(%rsp),%ymm15
    15a7:	c4 62 5d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm15
    15ae:	01 00 00 
    15b1:	c5 7c 11 b4 24 e0 00 	vmovups %ymm14,0xe0(%rsp)
    15b8:	00 00 
    15ba:	c4 41 7c 28 f4       	vmovaps %ymm12,%ymm14
    15bf:	c5 fc 11 84 24 a0 00 	vmovups %ymm0,0xa0(%rsp)
    15c6:	00 00 
    15c8:	c5 7c 11 54 24 e0    	vmovups %ymm10,-0x20(%rsp)
    15ce:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    15d4:	c5 7c 29 ea          	vmovaps %ymm13,%ymm2
    15d8:	c5 fc 11 5c 24 80    	vmovups %ymm3,-0x80(%rsp)
    15de:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    15e3:	c4 e2 5d b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm2
    15ea:	02 00 00 
    15ed:	c4 e2 5d b8 9c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm3
    15f4:	02 00 00 
    15f7:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    15fb:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    15ff:	c5 fc 28 f7          	vmovaps %ymm7,%ymm6
    1603:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    1607:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    160c:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    1612:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    1618:	4c 39 c6             	cmp    %r8,%rsi
    161b:	0f 8c 9f ed ff ff    	jl     3c0 <_Z5benchv+0x270>
    1621:	e9 9f eb ff ff       	jmpq   1c5 <_Z5benchv+0x75>
    1626:	0f 31                	rdtsc  
    1628:	48 c1 e2 20          	shl    $0x20,%rdx
    162c:	48 09 c2             	or     %rax,%rdx
    162f:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1635 <_Z5benchv+0x14e5>
    1635:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    163a:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1642 <_Z5benchv+0x14f2>
    1641:	00 
    1642:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 164a <_Z5benchv+0x14fa>
    1649:	00 
    164a:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1651 <_Z5benchv+0x1501>
    1651:	01 c0                	add    %eax,%eax
    1653:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1659:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    165d:	c5 fb 5c 44 24 78    	vsubsd 0x78(%rsp),%xmm0,%xmm0
    1663:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    1668:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    166c:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1670:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1674:	48 81 c4 38 01 00 00 	add    $0x138,%rsp
    167b:	c5 f8 77             	vzeroupper 
    167e:	c3                   	retq   
    167f:	90                   	nop
...
0000000000001690 <_Z9n_reg_maxv>:
    1690:	b8 67 01 00 00       	mov    $0x167,%eax
    1695:	c3                   	retq   

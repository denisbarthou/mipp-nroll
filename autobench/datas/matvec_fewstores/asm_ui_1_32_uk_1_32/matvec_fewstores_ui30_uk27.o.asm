...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e e6 3d 00 00    	jle    3f7e <_Z5benchv+0x3e2e>
     ...
     383:	0f 83 f5 3b 00 00    	jae    3f7e <_Z5benchv+0x3e2e>
    ...
    3d1d:	48 83 c6 1b          	add    $0x1b,%rsi
    3d21:	49 0f af c3          	imul   %r11,%rax
    3d25:	48 01 f8             	add    %rdi,%rax
    3d28:	c4 e2 05 b8 84 81 a0 	vfmadd231ps 0x3a0(%rcx,%rax,4),%ymm15,%ymm0
    3d2f:	03 00 00 
    3d32:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
    3d39:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
    3d40:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
    3d47:	01 00 00 
    3d4a:	c4 62 05 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm14
    3d51:	01 00 00 
    3d54:	c4 62 05 b8 94 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm15,%ymm10
    3d5b:	02 00 00 
    3d5e:	c4 62 05 b8 ac 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm15,%ymm13
    3d65:	03 00 00 
    3d68:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
    3d6e:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
    3d75:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
    3d7c:	00 00 00 
    3d7f:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
    3d86:	00 00 00 
    3d89:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
    3d90:	00 00 00 
    3d93:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
    3d9a:	00 00 00 
    3d9d:	c4 62 05 b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm15,%ymm12
    3da4:	02 00 00 
    3da7:	c5 7c 11 1c 24       	vmovups %ymm11,(%rsp)
    3dac:	c5 7c 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm11
    3db2:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
    3db9:	01 00 00 
    3dbc:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    3dc3:	00 00 
    3dc5:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    3dc9:	c5 fc 28 d7          	vmovaps %ymm7,%ymm2
    3dcd:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    3dd1:	c5 7c 11 5c 24 c0    	vmovups %ymm11,-0x40(%rsp)
    3dd7:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    3ddd:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm11
    3de4:	01 00 00 
    3de7:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    3ded:	c5 7c 11 5c 24 80    	vmovups %ymm11,-0x80(%rsp)
    3df3:	c5 7c 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm11
    3dfa:	00 00 
    3dfc:	c4 62 05 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm11
    3e03:	01 00 00 
    3e06:	c5 7c 11 9c 24 20 01 	vmovups %ymm11,0x120(%rsp)
    3e0d:	00 00 
    3e0f:	c5 7c 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm11
    3e16:	00 00 
    3e18:	c4 62 05 b8 9c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm11
    3e1f:	01 00 00 
    3e22:	c5 7c 11 9c 24 e0 00 	vmovups %ymm11,0xe0(%rsp)
    3e29:	00 00 
    3e2b:	c5 7c 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm11
    3e32:	00 00 
    3e34:	c4 62 05 b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm15,%ymm11
    3e3b:	01 00 00 
    3e3e:	c5 7c 11 9c 24 a0 00 	vmovups %ymm11,0xa0(%rsp)
    3e45:	00 00 
    3e47:	c5 7c 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm11
    3e4e:	00 00 
    3e50:	c4 62 05 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm15,%ymm11
    3e57:	01 00 00 
    3e5a:	c5 7c 11 9c 24 80 00 	vmovups %ymm11,0x80(%rsp)
    3e61:	00 00 
    3e63:	c5 7c 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm11
    3e6a:	00 00 
    3e6c:	c4 62 05 b8 9c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm15,%ymm11
    3e73:	02 00 00 
    3e76:	c5 7c 11 9c 24 00 01 	vmovups %ymm11,0x100(%rsp)
    3e7d:	00 00 
    3e7f:	c5 7c 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm11
    3e86:	00 00 
    3e88:	c4 62 05 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm15,%ymm11
    3e8f:	02 00 00 
    3e92:	c5 7c 11 9c 24 c0 00 	vmovups %ymm11,0xc0(%rsp)
    3e99:	00 00 
    3e9b:	c5 7c 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm11
    3ea1:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm15,%ymm11
    3ea8:	02 00 00 
    3eab:	c5 7c 11 5c 24 a0    	vmovups %ymm11,-0x60(%rsp)
    3eb1:	c5 7c 10 9c 24 40 01 	vmovups 0x140(%rsp),%ymm11
    3eb8:	00 00 
    3eba:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm15,%ymm11
    3ec1:	02 00 00 
    3ec4:	c5 7c 11 9c 24 40 01 	vmovups %ymm11,0x140(%rsp)
    3ecb:	00 00 
    3ecd:	c5 7c 10 9c 24 60 01 	vmovups 0x160(%rsp),%ymm11
    3ed4:	00 00 
    3ed6:	c4 62 05 b8 9c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm15,%ymm11
    3edd:	02 00 00 
    3ee0:	c5 7c 11 9c 24 60 01 	vmovups %ymm11,0x160(%rsp)
    3ee7:	00 00 
    3ee9:	c5 7c 10 5c 24 20    	vmovups 0x20(%rsp),%ymm11
    3eef:	c4 62 05 b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm15,%ymm11
    3ef6:	02 00 00 
    3ef9:	c5 7c 11 5c 24 20    	vmovups %ymm11,0x20(%rsp)
    3eff:	c5 7c 10 5c 24 60    	vmovups 0x60(%rsp),%ymm11
    3f05:	c4 62 05 b8 9c 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm15,%ymm11
    3f0c:	03 00 00 
    3f0f:	c5 7c 11 5c 24 60    	vmovups %ymm11,0x60(%rsp)
    3f15:	c5 7c 10 5c 24 40    	vmovups 0x40(%rsp),%ymm11
    3f1b:	c4 62 05 b8 9c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm15,%ymm11
    3f22:	03 00 00 
    3f25:	c5 7c 11 5c 24 40    	vmovups %ymm11,0x40(%rsp)
    3f2b:	c5 7c 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm11
    3f31:	c4 62 05 b8 9c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm15,%ymm11
    3f38:	03 00 00 
    3f3b:	c5 7c 11 5c 24 e0    	vmovups %ymm11,-0x20(%rsp)
    3f41:	c5 7c 10 1c 24       	vmovups (%rsp),%ymm11
    3f46:	c4 62 05 b8 9c 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm15,%ymm11
    3f4d:	03 00 00 
    3f50:	c4 41 7c 28 fd       	vmovaps %ymm13,%ymm15
    3f55:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    3f5a:	c4 41 7c 28 f2       	vmovaps %ymm10,%ymm14
    3f5f:	c5 7c 10 54 24 a0    	vmovups -0x60(%rsp),%ymm10
    3f65:	c5 7c 11 1c 24       	vmovups %ymm11,(%rsp)
    3f6a:	c5 7c 10 5c 24 80    	vmovups -0x80(%rsp),%ymm11
    3f70:	4c 39 c6             	cmp    %r8,%rsi
    3f73:	0f 8c 17 c6 ff ff    	jl     590 <_Z5benchv+0x440>
    3f79:	e9 6f c2 ff ff       	jmpq   1ed <_Z5benchv+0x9d>
    3f7e:	0f 31                	rdtsc  
    3f80:	48 c1 e2 20          	shl    $0x20,%rdx
    3f84:	48 09 c2             	or     %rax,%rdx
    3f87:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3f8d <_Z5benchv+0x3e3d>
    3f8d:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3f92:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3f9a <_Z5benchv+0x3e4a>
    3f99:	00 
    3f9a:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3fa2 <_Z5benchv+0x3e52>
    3fa1:	00 
    3fa2:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3fa9 <_Z5benchv+0x3e59>
    3fa9:	01 c0                	add    %eax,%eax
    3fab:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3fb1:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3fb5:	c5 fb 5c 84 24 98 01 	vsubsd 0x198(%rsp),%xmm0,%xmm0
    3fbc:	00 00 
    3fbe:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    3fc2:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    3fc6:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3fca:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3fce:	48 81 c4 78 02 00 00 	add    $0x278,%rsp
    3fd5:	c5 f8 77             	vzeroupper 
    3fd8:	c3                   	retq   
    3fd9:	90                   	nop
    3fda:	90                   	nop
    3fdb:	90                   	nop
...
0000000000003ff0 <_Z9n_reg_maxv>:
    3ff0:	b8 63 03 00 00       	mov    $0x363,%eax
    3ff5:	c3                   	retq   

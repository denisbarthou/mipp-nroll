...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 5b 24 00 00    	jle    25f3 <_Z5benchv+0x24a3>
     ...
     37a:	0f 83 73 22 00 00    	jae    25f3 <_Z5benchv+0x24a3>
    ...
    215e:	c4 e2 05 b8 84 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm15,%ymm0
    2165:	01 00 00 
    2168:	c4 e2 05 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm15,%ymm1
    216e:	c4 e2 05 b8 7c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm15,%ymm7
    2175:	c4 e2 05 b8 54 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm15,%ymm2
    217c:	c4 e2 05 b8 5c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm15,%ymm3
    2183:	c4 e2 05 b8 a4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm15,%ymm4
    218a:	00 00 00 
    218d:	c4 e2 05 b8 ac b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm15,%ymm5
    2194:	00 00 00 
    2197:	c4 e2 05 b8 b4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm15,%ymm6
    219e:	00 00 00 
    21a1:	c4 62 05 b8 8c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm15,%ymm9
    21a8:	00 00 00 
    21ab:	c4 62 05 b8 a4 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm15,%ymm12
    21b2:	01 00 00 
    ...
    21e3:	c5 7c 10 94 24 40 01 	vmovups 0x140(%rsp),%ymm10
    21ea:	00 00 
    21ec:	c4 62 05 b8 94 b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm15,%ymm10
    21f3:	02 00 00 
    21f6:	c5 fc 11 84 24 c0 01 	vmovups %ymm0,0x1c0(%rsp)
    21fd:	00 00 
    21ff:	c5 fc 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm0
    2206:	00 00 
    2208:	c4 e2 05 b8 84 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm15,%ymm0
    220f:	01 00 00 
    2212:	c5 7c 11 94 24 40 01 	vmovups %ymm10,0x140(%rsp)
    2219:	00 00 
    221b:	c5 7c 10 94 24 60 01 	vmovups 0x160(%rsp),%ymm10
    2222:	00 00 
    2224:	c4 62 05 b8 94 b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm15,%ymm10
    222b:	03 00 00 
    222e:	c5 fc 11 84 24 80 00 	vmovups %ymm0,0x80(%rsp)
    2235:	00 00 
    2237:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    223d:	c4 e2 05 b8 84 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm15,%ymm0
    2244:	01 00 00 
    2247:	c5 7c 11 94 24 60 01 	vmovups %ymm10,0x160(%rsp)
    224e:	00 00 
    2250:	c5 7c 10 94 24 20 01 	vmovups 0x120(%rsp),%ymm10
    2257:	00 00 
    2259:	c4 62 05 b8 94 b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm15,%ymm10
    2260:	03 00 00 
    2263:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    2269:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    226e:	c4 e2 05 b8 84 b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm15,%ymm0
    2275:	01 00 00 
    2278:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    227d:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    2283:	c4 e2 05 b8 84 b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm15,%ymm0
    228a:	01 00 00 
    228d:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    2293:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    2299:	c4 e2 05 b8 84 b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm15,%ymm0
    22a0:	01 00 00 
    22a3:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    22a9:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    22af:	c4 e2 05 b8 84 b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm15,%ymm0
    22b6:	02 00 00 
    22b9:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    22bf:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    22c5:	c4 e2 05 b8 84 b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm15,%ymm0
    22cc:	02 00 00 
    22cf:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    22d5:	c5 fc 10 84 24 a0 00 	vmovups 0xa0(%rsp),%ymm0
    22dc:	00 00 
    22de:	c4 e2 05 b8 84 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm15,%ymm0
    22e5:	02 00 00 
    22e8:	c5 fc 11 84 24 a0 00 	vmovups %ymm0,0xa0(%rsp)
    22ef:	00 00 
    22f1:	c5 fc 10 44 24 60    	vmovups 0x60(%rsp),%ymm0
    22f7:	c4 e2 05 b8 84 b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm15,%ymm0
    22fe:	02 00 00 
    2301:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    2307:	c5 fc 10 84 24 c0 00 	vmovups 0xc0(%rsp),%ymm0
    230e:	00 00 
    2310:	c4 e2 05 b8 84 b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm15,%ymm0
    2317:	02 00 00 
    231a:	c5 fc 11 84 24 c0 00 	vmovups %ymm0,0xc0(%rsp)
    2321:	00 00 
    2323:	c5 fc 10 84 24 00 01 	vmovups 0x100(%rsp),%ymm0
    232a:	00 00 
    232c:	c4 e2 05 b8 84 b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm15,%ymm0
    2333:	02 00 00 
    2336:	c5 fc 11 84 24 00 01 	vmovups %ymm0,0x100(%rsp)
    233d:	00 00 
    233f:	c5 fc 10 84 24 e0 00 	vmovups 0xe0(%rsp),%ymm0
    2346:	00 00 
    2348:	c4 e2 05 b8 84 b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm15,%ymm0
    234f:	03 00 00 
    2352:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    2359:	00 00 
    235b:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    2361:	c4 e2 05 b8 84 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm15,%ymm0
    2368:	03 00 00 
    236b:	48 8d 70 0e          	lea    0xe(%rax),%rsi
    236f:	c4 62 7d 18 7c 82 38 	vbroadcastss 0x38(%rdx,%rax,4),%ymm15
    2376:	48 83 c0 0f          	add    $0xf,%rax
    237a:	49 0f af f3          	imul   %r11,%rsi
    237e:	48 01 fe             	add    %rdi,%rsi
    2381:	c4 62 05 b8 a4 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm15,%ymm12
    2388:	01 00 00 
    238b:	c4 e2 05 b8 54 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm15,%ymm2
    2392:	c4 e2 05 b8 a4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm15,%ymm4
    2399:	00 00 00 
    239c:	c4 e2 05 b8 b4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm15,%ymm6
    23a3:	00 00 00 
    23a6:	c4 62 05 b8 8c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm15,%ymm9
    23ad:	00 00 00 
    23b0:	c4 e2 05 b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm15,%ymm1
    23b6:	c4 e2 05 b8 7c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm15,%ymm7
    23bd:	c4 e2 05 b8 5c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm15,%ymm3
    23c4:	c4 e2 05 b8 ac b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm15,%ymm5
    23cb:	00 00 00 
    23ce:	c4 62 05 b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm15,%ymm11
    23d5:	02 00 00 
    23d8:	c4 62 05 b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm15,%ymm14
    23df:	01 00 00 
    23e2:	c4 62 05 b8 94 b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm15,%ymm10
    23e9:	03 00 00 
    23ec:	c4 62 05 b8 ac b1 80 	vfmadd231ps 0x380(%rcx,%rsi,4),%ymm15,%ymm13
    23f3:	03 00 00 
    23f6:	c4 62 05 b8 84 b1 a0 	vfmadd231ps 0x3a0(%rcx,%rsi,4),%ymm15,%ymm8
    23fd:	03 00 00 
    2400:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    2406:	c5 fc 10 84 24 c0 01 	vmovups 0x1c0(%rsp),%ymm0
    240d:	00 00 
    240f:	c4 e2 05 b8 84 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm15,%ymm0
    2416:	01 00 00 
    2419:	c5 7c 11 a4 24 e0 01 	vmovups %ymm12,0x1e0(%rsp)
    2420:	00 00 
    2422:	c5 7c 10 a4 24 40 01 	vmovups 0x140(%rsp),%ymm12
    2429:	00 00 
    242b:	c4 62 05 b8 a4 b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm15,%ymm12
    2432:	02 00 00 
    2435:	c5 7c 11 b4 24 a0 01 	vmovups %ymm14,0x1a0(%rsp)
    243c:	00 00 
    243e:	c5 7c 11 94 24 20 01 	vmovups %ymm10,0x120(%rsp)
    2445:	00 00 
    2447:	c5 7c 11 ac 24 20 02 	vmovups %ymm13,0x220(%rsp)
    244e:	00 00 
    2450:	c5 7c 11 84 24 00 02 	vmovups %ymm8,0x200(%rsp)
    2457:	00 00 
    2459:	c5 fc 11 84 24 c0 01 	vmovups %ymm0,0x1c0(%rsp)
    2460:	00 00 
    2462:	c5 fc 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm0
    2469:	00 00 
    246b:	c4 e2 05 b8 84 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm15,%ymm0
    2472:	01 00 00 
    2475:	c5 7c 11 a4 24 40 01 	vmovups %ymm12,0x140(%rsp)
    247c:	00 00 
    247e:	c5 7c 10 a4 24 60 01 	vmovups 0x160(%rsp),%ymm12
    2485:	00 00 
    2487:	c4 62 05 b8 a4 b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm15,%ymm12
    248e:	03 00 00 
    2491:	c5 fc 11 84 24 80 00 	vmovups %ymm0,0x80(%rsp)
    2498:	00 00 
    249a:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    24a0:	c4 e2 05 b8 84 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm15,%ymm0
    24a7:	01 00 00 
    ...
    25af:	03 00 00 
    25b2:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    25b6:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    25ba:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    25be:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    25c2:	c5 7c 29 df          	vmovaps %ymm11,%ymm7
    25c6:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    25cc:	c5 fc 28 c2          	vmovaps %ymm2,%ymm0
    25d0:	c5 fc 28 d4          	vmovaps %ymm4,%ymm2
    25d4:	c5 fc 28 e6          	vmovaps %ymm6,%ymm4
    25d8:	c5 7c 29 ce          	vmovaps %ymm9,%ymm6
    25dc:	c5 7c 10 8c 24 40 01 	vmovups 0x140(%rsp),%ymm9
    25e3:	00 00 
    25e5:	4c 39 c0             	cmp    %r8,%rax
    25e8:	0f 8c 62 df ff ff    	jl     550 <_Z5benchv+0x400>
    25ee:	e9 cd db ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    25f3:	0f 31                	rdtsc  
    25f5:	48 c1 e2 20          	shl    $0x20,%rdx
    25f9:	48 09 c2             	or     %rax,%rdx
    25fc:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2602 <_Z5benchv+0x24b2>
    2602:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2607:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 260f <_Z5benchv+0x24bf>
    260e:	00 
    260f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2617 <_Z5benchv+0x24c7>
    2616:	00 
    2617:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 261e <_Z5benchv+0x24ce>
    261e:	01 c0                	add    %eax,%eax
    2620:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2626:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    262a:	c5 fb 5c 84 24 98 01 	vsubsd 0x198(%rsp),%xmm0,%xmm0
    2631:	00 00 
    2633:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
    2637:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    263b:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    263f:	48 81 c4 58 02 00 00 	add    $0x258,%rsp
    2646:	c5 f8 77             	vzeroupper 
    2649:	c3                   	retq   
    264a:	90                   	nop
    264b:	90                   	nop
    264c:	90                   	nop
...
0000000000002660 <_Z9n_reg_maxv>:
    2660:	b8 ef 01 00 00       	mov    $0x1ef,%eax
    2665:	c3                   	retq   

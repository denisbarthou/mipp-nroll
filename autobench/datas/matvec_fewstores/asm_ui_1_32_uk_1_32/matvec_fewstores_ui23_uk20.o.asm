...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e b2 20 00 00    	jle    224a <_Z5benchv+0x20fa>
     ...
     31f:	0f 83 25 1f 00 00    	jae    224a <_Z5benchv+0x20fa>
    ...
    20a3:	48 83 c6 14          	add    $0x14,%rsi
    20a7:	49 0f af c2          	imul   %r10,%rax
    20ab:	48 01 f8             	add    %rdi,%rax
    20ae:	c4 62 3d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm14
    20b5:	01 00 00 
    20b8:	c4 e2 3d b8 94 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm2
    20bf:	02 00 00 
    20c2:	c4 e2 3d b8 9c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm3
    20c9:	00 00 00 
    20cc:	c4 62 3d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm9
    20d3:	c4 62 3d b8 bc 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm15
    20da:	00 00 00 
    20dd:	c4 e2 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm5
    20e4:	01 00 00 
    20e7:	c4 e2 3d b8 84 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm0
    20ee:	01 00 00 
    20f1:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm4
    20f8:	01 00 00 
    20fb:	c4 62 3d b8 14 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm10
    2101:	c4 62 3d b8 5c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm11
    2108:	c4 62 3d b8 64 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm12
    210f:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    2116:	00 00 00 
    2119:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm6
    2120:	00 00 00 
    2123:	c4 62 3d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm13
    212a:	01 00 00 
    212d:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    2133:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    2139:	c4 e2 3d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm1
    2140:	01 00 00 
    2143:	c5 7c 11 74 24 80    	vmovups %ymm14,-0x80(%rsp)
    2149:	c5 7c 10 74 24 60    	vmovups 0x60(%rsp),%ymm14
    214f:	c4 62 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm14
    2156:	01 00 00 
    2159:	c5 fc 11 94 24 80 01 	vmovups %ymm2,0x180(%rsp)
    2160:	00 00 
    2162:	c5 7c 11 8c 24 c0 00 	vmovups %ymm9,0xc0(%rsp)
    2169:	00 00 
    216b:	c4 41 7c 28 cf       	vmovaps %ymm15,%ymm9
    2170:	c5 7c 28 f8          	vmovaps %ymm0,%ymm15
    2174:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    217a:	c5 fc 10 4c 24 20    	vmovups 0x20(%rsp),%ymm1
    2180:	c4 e2 3d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm1
    2187:	01 00 00 
    218a:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    2190:	c5 7c 11 74 24 60    	vmovups %ymm14,0x60(%rsp)
    2196:	c5 7c 10 74 24 40    	vmovups 0x40(%rsp),%ymm14
    219c:	c4 62 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm14
    21a3:	02 00 00 
    21a6:	c5 fc 11 4c 24 20    	vmovups %ymm1,0x20(%rsp)
    21ac:	c5 fc 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm1
    21b3:	00 00 
    21b5:	c4 e2 3d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm1
    21bc:	02 00 00 
    21bf:	c5 7c 11 74 24 40    	vmovups %ymm14,0x40(%rsp)
    21c5:	c5 7c 10 b4 24 a0 00 	vmovups 0xa0(%rsp),%ymm14
    21cc:	00 00 
    21ce:	c4 62 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm14
    21d5:	02 00 00 
    21d8:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    21df:	00 00 
    21e1:	c5 fc 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm1
    21e7:	c4 e2 3d b8 8c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm1
    21ee:	02 00 00 
    21f1:	c5 7c 11 b4 24 a0 00 	vmovups %ymm14,0xa0(%rsp)
    21f8:	00 00 
    21fa:	c5 7c 10 34 24       	vmovups (%rsp),%ymm14
    21ff:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm14
    2206:	02 00 00 
    2209:	c5 fc 11 4c 24 e0    	vmovups %ymm1,-0x20(%rsp)
    220f:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    2215:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm1
    221c:	02 00 00 
    221f:	c5 7c 28 c5          	vmovaps %ymm5,%ymm8
    2223:	c5 7c 11 34 24       	vmovups %ymm14,(%rsp)
    2228:	c5 7c 28 f4          	vmovaps %ymm4,%ymm14
    222c:	c5 fc 11 4c 24 c0    	vmovups %ymm1,-0x40(%rsp)
    2232:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    2236:	c5 fc 10 5c 24 80    	vmovups -0x80(%rsp),%ymm3
    223c:	4c 39 c6             	cmp    %r8,%rsi
    223f:	0f 8c 7b e2 ff ff    	jl     4c0 <_Z5benchv+0x370>
    2245:	e9 ab df ff ff       	jmpq   1f5 <_Z5benchv+0xa5>
    224a:	0f 31                	rdtsc  
    224c:	48 c1 e2 20          	shl    $0x20,%rdx
    2250:	48 09 c2             	or     %rax,%rdx
    2253:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2259 <_Z5benchv+0x2109>
    2259:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    225e:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2266 <_Z5benchv+0x2116>
    2265:	00 
    2266:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 226e <_Z5benchv+0x211e>
    226d:	00 
    226e:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2275 <_Z5benchv+0x2125>
    2275:	01 c0                	add    %eax,%eax
    2277:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    227d:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2281:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    2288:	00 00 
    228a:	c5 d0 57 ed          	vxorps %xmm5,%xmm5,%xmm5
    228e:	c5 d2 2a c8          	vcvtsi2ss %eax,%xmm5,%xmm1
    2292:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2296:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    229a:	48 81 c4 b8 01 00 00 	add    $0x1b8,%rsp
    22a1:	c5 f8 77             	vzeroupper 
    22a4:	c3                   	retq   
    22a5:	90                   	nop
    22a6:	90                   	nop
    22a7:	90                   	nop
...
00000000000022c0 <_Z9n_reg_maxv>:
    22c0:	b8 f7 01 00 00       	mov    $0x1f7,%eax
    22c5:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
     ...
     18c:	0f 8e 42 14 00 00    	jle    15d4 <_Z5benchv+0x1484>
     ...
     28f:	0f 83 3f 13 00 00    	jae    15d4 <_Z5benchv+0x1484>
    ...
    11ab:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    11b2:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    11b9:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    11c0:	00 00 00 
    11c3:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    11ca:	00 00 00 
    11cd:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    11d4:	00 00 00 
    11d7:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    11de:	01 00 00 
    11e1:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    11e8:	01 00 00 
    11eb:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    11f2:	01 00 00 
    11f5:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    11fc:	01 00 00 
    11ff:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    1206:	01 00 00 
    1209:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    1210:	01 00 00 
    1213:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    121a:	02 00 00 
    121d:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1223:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1229:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    1230:	00 00 00 
    1233:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    1239:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    123f:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    1246:	01 00 00 
    1249:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    124f:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1255:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    125c:	01 00 00 
    125f:	48 8d 46 12          	lea    0x12(%rsi),%rax
    1263:	c4 e2 7d 18 54 b2 48 	vbroadcastss 0x48(%rdx,%rsi,4),%ymm2
    126a:	49 0f af c2          	imul   %r10,%rax
    126e:	48 01 f8             	add    %rdi,%rax
    1271:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1277:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    127e:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    1285:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    128c:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1293:	00 00 00 
    1296:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    129d:	00 00 00 
    12a0:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    12a7:	00 00 00 
    12aa:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    12b1:	01 00 00 
    12b4:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    12bb:	01 00 00 
    12be:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    12c5:	01 00 00 
    12c8:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    12cf:	01 00 00 
    12d2:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    12d9:	01 00 00 
    12dc:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    12e3:	01 00 00 
    12e6:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    12ed:	02 00 00 
    12f0:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    12f6:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    12fc:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    1303:	00 00 00 
    1306:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    130c:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1312:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    1319:	01 00 00 
    131c:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    1322:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    1328:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    132f:	01 00 00 
    1332:	48 8d 46 13          	lea    0x13(%rsi),%rax
    1336:	c4 e2 7d 18 54 b2 4c 	vbroadcastss 0x4c(%rdx,%rsi,4),%ymm2
    133d:	49 0f af c2          	imul   %r10,%rax
    1341:	48 01 f8             	add    %rdi,%rax
    1344:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    134a:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1351:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    1358:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    135f:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1366:	00 00 00 
    1369:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1370:	00 00 00 
    1373:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    137a:	00 00 00 
    137d:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1384:	01 00 00 
    1387:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    138e:	01 00 00 
    1391:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    1398:	01 00 00 
    139b:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    13a2:	01 00 00 
    13a5:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    13ac:	01 00 00 
    13af:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    13b6:	01 00 00 
    13b9:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    13c0:	02 00 00 
    13c3:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    13c9:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    13cf:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    13d6:	00 00 00 
    13d9:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    13df:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    13e5:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    13ec:	01 00 00 
    13ef:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    13f5:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    13fb:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    1402:	01 00 00 
    1405:	48 8d 46 14          	lea    0x14(%rsi),%rax
    1409:	c4 e2 7d 18 54 b2 50 	vbroadcastss 0x50(%rdx,%rsi,4),%ymm2
    1410:	49 0f af c2          	imul   %r10,%rax
    1414:	48 01 f8             	add    %rdi,%rax
    1417:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    141d:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1424:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    142b:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    1432:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1439:	00 00 00 
    143c:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    1443:	00 00 00 
    1446:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    144d:	00 00 00 
    1450:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    1457:	01 00 00 
    145a:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1461:	01 00 00 
    1464:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    146b:	01 00 00 
    146e:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    1475:	01 00 00 
    1478:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    147f:	01 00 00 
    1482:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    1489:	01 00 00 
    148c:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    1493:	02 00 00 
    1496:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    149c:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    14a2:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    14a9:	00 00 00 
    14ac:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    14b2:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    14b8:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    14bf:	01 00 00 
    14c2:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    14c8:	c5 fc 10 6c 24 80    	vmovups -0x80(%rsp),%ymm5
    14ce:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm5
    14d5:	01 00 00 
    14d8:	48 8d 46 15          	lea    0x15(%rsi),%rax
    14dc:	c4 e2 7d 18 54 b2 54 	vbroadcastss 0x54(%rdx,%rsi,4),%ymm2
    14e3:	48 83 c6 16          	add    $0x16,%rsi
    14e7:	49 0f af c2          	imul   %r10,%rax
    14eb:	48 01 f8             	add    %rdi,%rax
    14ee:	c4 e2 6d b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm6
    14f5:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    14fb:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1502:	c4 62 6d b8 74 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm14
    1509:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    1510:	00 00 00 
    1513:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    151a:	00 00 00 
    151d:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    1524:	00 00 00 
    1527:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    152e:	01 00 00 
    1531:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    1538:	01 00 00 
    153b:	c4 62 6d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm12
    1542:	01 00 00 
    1545:	c4 62 6d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm13
    154c:	01 00 00 
    154f:	c4 62 6d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm15
    1556:	01 00 00 
    1559:	c4 e2 6d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm0
    1560:	01 00 00 
    1563:	c4 e2 6d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm1
    156a:	02 00 00 
    156d:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1573:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1579:	c4 e2 6d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm5
    1580:	00 00 00 
    1583:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    1588:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    158e:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm6
    1595:	01 00 00 
    1598:	c5 fc 11 6c 24 c0    	vmovups %ymm5,-0x40(%rsp)
    159e:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    15a4:	c4 e2 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm5
    15ab:	01 00 00 
    15ae:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    15b2:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    15b6:	c5 7c 29 f4          	vmovaps %ymm14,%ymm4
    15ba:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    15c0:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    15c6:	4c 39 c6             	cmp    %r8,%rsi
    15c9:	0f 8c a1 ed ff ff    	jl     370 <_Z5benchv+0x220>
    15cf:	e9 fd eb ff ff       	jmpq   1d1 <_Z5benchv+0x81>
    15d4:	0f 31                	rdtsc  
    15d6:	48 c1 e2 20          	shl    $0x20,%rdx
    15da:	48 09 c2             	or     %rax,%rdx
    15dd:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 15e3 <_Z5benchv+0x1493>
    15e3:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    15e8:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 15f0 <_Z5benchv+0x14a0>
    15ef:	00 
    15f0:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 15f8 <_Z5benchv+0x14a8>
    15f7:	00 
    15f8:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 15ff <_Z5benchv+0x14af>
    15ff:	01 c0                	add    %eax,%eax
    1601:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1607:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    160b:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    1611:	c4 41 08 57 f6       	vxorps %xmm14,%xmm14,%xmm14
    1616:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    161a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    161e:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1622:	48 83 c4 38          	add    $0x38,%rsp
...
0000000000001640 <_Z9n_reg_maxv>:
    1640:	b8 9d 01 00 00       	mov    $0x19d,%eax
    1645:	c3                   	retq   

...
0000000000000130 <_Z5benchv>:
 130:	0f 31                	rdtsc  
 132:	44 8b 1d 00 00 00 00 	mov    0x0(%rip),%r11d        # 139 <_Z5benchv+0x9>
 ...
 15f:	45 85 db             	test   %r11d,%r11d
 162:	0f 8e 92 00 00 00    	jle    1fa <_Z5benchv+0xca>
 168:	4c 8b 0d 00 00 00 00 	mov    0x0(%rip),%r9        # 16f <_Z5benchv+0x3f>
 16f:	48 8b 15 00 00 00 00 	mov    0x0(%rip),%rdx        # 176 <_Z5benchv+0x46>
 176:	4c 8b 05 00 00 00 00 	mov    0x0(%rip),%r8        # 17d <_Z5benchv+0x4d>
 17d:	48 63 3d 00 00 00 00 	movslq 0x0(%rip),%rdi        # 184 <_Z5benchv+0x54>
 184:	4a 8d 34 dd 00 00 00 	lea    0x0(,%r11,8),%rsi
 18b:	00 
 18c:	45 31 d2             	xor    %r10d,%r10d
 18f:	eb 26                	jmp    1b7 <_Z5benchv+0x87>
 191:	90                   	nop
 192:	90                   	nop
 193:	90                   	nop
 194:	90                   	nop
 ...
 1ce:	90                   	nop
 1cf:	90                   	nop
 1d0:	c4 e2 7d 18 0c 82    	vbroadcastss (%rdx,%rax,4),%ymm1
 1d6:	c4 e2 6d 98 09       	vfmadd132ps (%rcx),%ymm2,%ymm1
 1db:	c4 e2 7d 18 5c 82 04 	vbroadcastss 0x4(%rdx,%rax,4),%ymm3
 1e2:	48 83 c0 02          	add    $0x2,%rax
 1e6:	c4 a2 65 b8 0c 99    	vfmadd231ps (%rcx,%r11,4),%ymm3,%ymm1
 1ec:	48 01 f1             	add    %rsi,%rcx
 1ef:	c5 fc 28 d1          	vmovaps %ymm1,%ymm2
 1f3:	48 39 f8             	cmp    %rdi,%rax
 1f6:	7c d8                	jl     1d0 <_Z5benchv+0xa0>
 1f8:	eb aa                	jmp    1a4 <_Z5benchv+0x74>
 1fa:	0f 31                	rdtsc  
 1fc:	48 c1 e2 20          	shl    $0x20,%rdx
 200:	48 09 c2             	or     %rax,%rdx
 203:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 209 <_Z5benchv+0xd9>
 209:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 20e:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 216 <_Z5benchv+0xe6>
 215:	00 
 216:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 21e <_Z5benchv+0xee>
 21d:	00 
 21e:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 225 <_Z5benchv+0xf5>
 225:	01 c0                	add    %eax,%eax
 227:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 22d:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 231:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 235:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
 239:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 23d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 241:	c5 f8 77             	vzeroupper 
 244:	c3                   	retq   
 245:	90                   	nop
 246:	90                   	nop
 247:	90                   	nop
...
0000000000000250 <_Z6enablev>:
 250:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 257 <_Z6enablev+0x7>
 257:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 25b:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 261 <_Z6enablev+0x11>
 261:	0f 9e c1             	setle  %cl
 264:	83 3d 00 00 00 00 01 	cmpl   $0x1,0x0(%rip)        # 26b <_Z6enablev+0x1b>
 26b:	0f 9f c0             	setg   %al
 26e:	20 c8                	and    %cl,%al
 270:	c3                   	retq   
 271:	90                   	nop
 272:	90                   	nop

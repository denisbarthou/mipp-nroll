...
matvec_fewstores_ui21_uk23.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e 36 1e 00 00    	jle    1fcb <_Z5benchv+0x1e7b>
     ...
     2e1:	0f 83 e4 1c 00 00    	jae    1fcb <_Z5benchv+0x1e7b>
    ...
    1e45:	48 83 c6 17          	add    $0x17,%rsi
    1e49:	49 0f af c2          	imul   %r10,%rax
    1e4d:	48 01 f8             	add    %rdi,%rax
    1e50:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    1e57:	01 00 00 
    1e5a:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    1e61:	01 00 00 
    1e64:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    1e6b:	01 00 00 
    1e6e:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    1e75:	02 00 00 
    1e78:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    1e7f:	01 00 00 
    1e82:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    1e88:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    1e8f:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    1e96:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    1e9d:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    1ea4:	00 00 00 
    1ea7:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    1eae:	00 00 00 
    1eb1:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    1eb8:	00 00 00 
    1ebb:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    1ec2:	01 00 00 
    1ec5:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    1ecc:	01 00 00 
    1ecf:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    1ed5:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    1eda:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    1ee1:	00 00 00 
    1ee4:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    1eeb:	00 00 
    1eed:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    1ef3:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    1efa:	00 00 
    1efc:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    1f02:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    1f09:	00 00 
    1f0b:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    1f11:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm2
    1f18:	02 00 00 
    1f1b:	c4 e2 4d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm1
    1f22:	01 00 00 
    1f25:	c4 e2 4d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm4
    1f2c:	02 00 00 
    1f2f:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    1f35:	c5 fc 11 ac 24 80 00 	vmovups %ymm5,0x80(%rsp)
    1f3c:	00 00 
    1f3e:	c5 7c 29 cd          	vmovaps %ymm9,%ymm5
    1f42:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    1f47:	c4 41 7c 28 dd       	vmovaps %ymm13,%ymm11
    1f4c:	c5 7c 11 bc 24 20 01 	vmovups %ymm15,0x120(%rsp)
    1f53:	00 00 
    1f55:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    1f5c:	00 00 
    1f5e:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    1f63:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    1f69:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    1f70:	01 00 00 
    1f73:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    1f78:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    1f7e:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    1f84:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    1f8a:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    1f91:	02 00 00 
    1f94:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    1f9a:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    1fa0:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    1fa7:	02 00 00 
    1faa:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    1fae:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    1fb3:	c4 41 7c 28 d4       	vmovaps %ymm12,%ymm10
    1fb8:	c4 41 7c 28 e6       	vmovaps %ymm14,%ymm12
    1fbd:	4c 39 c6             	cmp    %r8,%rsi
    1fc0:	0f 8c 4a e4 ff ff    	jl     410 <_Z5benchv+0x2c0>
    1fc6:	e9 f9 e1 ff ff       	jmpq   1c4 <_Z5benchv+0x74>
    1fcb:	0f 31                	rdtsc  
    1fcd:	48 c1 e2 20          	shl    $0x20,%rdx
    1fd1:	48 09 c2             	or     %rax,%rdx
    1fd4:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1fda <_Z5benchv+0x1e8a>
    1fda:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1fdf:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1fe7 <_Z5benchv+0x1e97>
    1fe6:	00 
    1fe7:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1fef <_Z5benchv+0x1e9f>
    1fee:	00 
    1fef:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1ff6 <_Z5benchv+0x1ea6>
    1ff6:	01 c0                	add    %eax,%eax
    1ff8:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1ffe:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2002:	c5 fb 5c 44 24 78    	vsubsd 0x78(%rsp),%xmm0,%xmm0
    2008:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    200d:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    2011:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2015:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2019:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    2020:	c5 f8 77             	vzeroupper 
    2023:	c3                   	retq   
    2024:	90                   	nop
    2025:	90                   	nop
    2026:	90                   	nop
...
0000000000002040 <_Z9n_reg_maxv>:
    2040:	b8 0f 02 00 00       	mov    $0x20f,%eax
    2045:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui21_uk23.cpp+0x9a>
  96:	01 00 00 00 

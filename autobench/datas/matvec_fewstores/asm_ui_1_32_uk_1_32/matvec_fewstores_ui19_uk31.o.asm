...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e c7 21 00 00    	jle    235c <_Z5benchv+0x220c>
     ...
     2bc:	0f 83 9a 20 00 00    	jae    235c <_Z5benchv+0x220c>
    ...
    200d:	49 0f af c2          	imul   %r10,%rax
    2011:	48 01 f8             	add    %rdi,%rax
    2014:	c4 e2 5d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm5
    201a:	c4 e2 5d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm6
    2021:	c4 62 5d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm9
    2028:	c4 62 5d b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm8
    202f:	00 00 00 
    2032:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm10
    2039:	00 00 00 
    203c:	c4 62 5d b8 9c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm11
    2043:	00 00 00 
    2046:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    204d:	00 00 00 
    2050:	c4 e2 5d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm1
    2057:	01 00 00 
    205a:	c4 62 5d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm14
    2061:	01 00 00 
    2064:	c4 62 5d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm15
    206b:	01 00 00 
    206e:	c4 e2 5d b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm3
    2075:	01 00 00 
    2078:	c4 62 5d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm12
    207f:	01 00 00 
    2082:	c4 62 5d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm13
    2089:	01 00 00 
    208c:	c4 e2 5d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm2
    2093:	02 00 00 
    2096:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    209c:	c5 fc 10 7c 24 e0    	vmovups -0x20(%rsp),%ymm7
    20a2:	c4 e2 5d b8 7c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm7
    20a9:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    20af:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    20b5:	c4 e2 5d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm7
    20bc:	01 00 00 
    20bf:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    20c5:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    20cb:	c4 e2 5d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm7
    20d2:	01 00 00 
    20d5:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    20db:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    20e0:	c4 e2 5d b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm7
    20e7:	02 00 00 
    20ea:	c5 fc 11 3c 24       	vmovups %ymm7,(%rsp)
    20ef:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    20f5:	c4 e2 5d b8 bc 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm7
    20fc:	02 00 00 
    20ff:	48 8d 46 1d          	lea    0x1d(%rsi),%rax
    2103:	c4 e2 7d 18 64 b2 74 	vbroadcastss 0x74(%rdx,%rsi,4),%ymm4
    210a:	49 0f af c2          	imul   %r10,%rax
    210e:	48 01 f8             	add    %rdi,%rax
    2111:	c4 e2 5d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm5
    2117:	c4 e2 5d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm6
    211e:	c4 62 5d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm9
    2125:	c4 62 5d b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm8
    212c:	00 00 00 
    212f:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm10
    2136:	00 00 00 
    2139:	c4 62 5d b8 9c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm11
    2140:	00 00 00 
    2143:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    214a:	00 00 00 
    214d:	c4 e2 5d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm1
    2154:	01 00 00 
    2157:	c4 62 5d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm14
    215e:	01 00 00 
    2161:	c4 62 5d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm15
    2168:	01 00 00 
    216b:	c4 e2 5d b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm3
    2172:	01 00 00 
    2175:	c4 62 5d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm12
    217c:	01 00 00 
    217f:	c4 62 5d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm13
    2186:	01 00 00 
    2189:	c4 e2 5d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm2
    2190:	02 00 00 
    2193:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    2199:	c5 fc 10 7c 24 e0    	vmovups -0x20(%rsp),%ymm7
    219f:	c4 e2 5d b8 7c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm7
    21a6:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    21ac:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    21b2:	c4 e2 5d b8 bc 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm7
    21b9:	01 00 00 
    21bc:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    21c2:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    21c8:	c4 e2 5d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm7
    21cf:	01 00 00 
    21d2:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    21d8:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    21dd:	c4 e2 5d b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm7
    21e4:	02 00 00 
    21e7:	c5 fc 11 3c 24       	vmovups %ymm7,(%rsp)
    21ec:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    21f2:	c4 e2 5d b8 bc 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm7
    21f9:	02 00 00 
    21fc:	48 8d 46 1e          	lea    0x1e(%rsi),%rax
    2200:	c4 e2 7d 18 64 b2 78 	vbroadcastss 0x78(%rdx,%rsi,4),%ymm4
    2207:	48 83 c6 1f          	add    $0x1f,%rsi
    220b:	49 0f af c2          	imul   %r10,%rax
    220f:	48 01 f8             	add    %rdi,%rax
    2212:	c4 e2 5d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm1
    2219:	01 00 00 
    221c:	c4 e2 5d b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm3
    2223:	01 00 00 
    2226:	c4 62 5d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm14
    222d:	01 00 00 
    2230:	c4 62 5d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm12
    2237:	01 00 00 
    223a:	c4 62 5d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm9
    2241:	c4 62 5d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm15
    2248:	01 00 00 
    224b:	c4 e2 5d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm5
    2251:	c4 e2 5d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm6
    2258:	c4 62 5d b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm8
    225f:	00 00 00 
    2262:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm10
    2269:	00 00 00 
    226c:	c4 62 5d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm13
    2273:	01 00 00 
    2276:	c4 62 5d b8 9c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm11
    227d:	00 00 00 
    2280:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    2287:	00 00 00 
    228a:	c4 e2 5d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm2
    2291:	02 00 00 
    2294:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    229a:	c5 fc 10 7c 24 e0    	vmovups -0x20(%rsp),%ymm7
    22a0:	c4 e2 5d b8 7c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm7
    22a7:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    22ae:	00 00 
    22b0:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    22b4:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    22ba:	c4 e2 5d b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm3
    22c1:	01 00 00 
    22c4:	c5 7c 11 74 24 60    	vmovups %ymm14,0x60(%rsp)
    22ca:	c4 41 7c 28 f4       	vmovaps %ymm12,%ymm14
    22cf:	c5 7c 10 24 24       	vmovups (%rsp),%ymm12
    22d4:	c4 62 5d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm12
    22db:	02 00 00 
    22de:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
    22e4:	c4 41 7c 28 fd       	vmovaps %ymm13,%ymm15
    22e9:	c5 7c 11 9c 24 c0 00 	vmovups %ymm11,0xc0(%rsp)
    22f0:	00 00 
    22f2:	c5 fc 11 84 24 a0 00 	vmovups %ymm0,0xa0(%rsp)
    22f9:	00 00 
    22fb:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    2301:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    2307:	c4 e2 5d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm7
    230e:	01 00 00 
    2311:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    2317:	c5 fc 10 5c 24 80    	vmovups -0x80(%rsp),%ymm3
    231d:	c4 e2 5d b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm3
    2324:	02 00 00 
    2327:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    232b:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    232f:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    2333:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    2338:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    233e:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    2342:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    2348:	c5 fc 11 5c 24 80    	vmovups %ymm3,-0x80(%rsp)
    234e:	4c 39 c6             	cmp    %r8,%rsi
    2351:	0f 8c 69 e0 ff ff    	jl     3c0 <_Z5benchv+0x270>
    2357:	e9 6c de ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    235c:	0f 31                	rdtsc  
    235e:	48 c1 e2 20          	shl    $0x20,%rdx
    2362:	48 09 c2             	or     %rax,%rdx
    2365:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 236b <_Z5benchv+0x221b>
    236b:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2370:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2378 <_Z5benchv+0x2228>
    2377:	00 
    2378:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2380 <_Z5benchv+0x2230>
    237f:	00 
    2380:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2387 <_Z5benchv+0x2237>
    2387:	01 c0                	add    %eax,%eax
    2389:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    238f:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2393:	c5 fb 5c 44 24 38    	vsubsd 0x38(%rsp),%xmm0,%xmm0
    2399:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
    239e:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
    23a2:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    23a6:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    23aa:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
    23b1:	c5 f8 77             	vzeroupper 
    23b4:	c3                   	retq   
    23b5:	90                   	nop
    23b6:	90                   	nop
    23b7:	90                   	nop
...
00000000000023d0 <_Z9n_reg_maxv>:
    23d0:	b8 7f 02 00 00       	mov    $0x27f,%eax
    23d5:	c3                   	retq   

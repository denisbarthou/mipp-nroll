...
matvec_fewstores_ui11_uk17.o:     file format elf64-x86-64
...
0000000000000000 <_Z4initv>:
  ...
  32:	48 69 c9 79 78 78 78 	imul   $0x78787879,%rcx,%rcx
  ...
  4f:	c1 e2 07             	shl    $0x7,%edx
  52:	8d 0c ca             	lea    (%rdx,%rcx,8),%ecx
  55:	48 63 d9             	movslq %ecx,%rbx
  58:	89 0d 00 00 00 00    	mov    %ecx,0x0(%rip)        # 5e <_Z4initv+0x5e>
  5e:	48 0f af fb          	imul   %rbx,%rdi
  62:	e8 00 00 00 00       	callq  67 <_Z4initv+0x67>
  67:	48 c1 e3 02          	shl    $0x2,%rbx
  6b:	48 89 05 00 00 00 00 	mov    %rax,0x0(%rip)        # 72 <_Z4initv+0x72>
  72:	48 89 df             	mov    %rbx,%rdi
  75:	e8 00 00 00 00       	callq  7a <_Z4initv+0x7a>
  7a:	4c 89 f7             	mov    %r14,%rdi
  7d:	48 89 05 00 00 00 00 	mov    %rax,0x0(%rip)        # 84 <_Z4initv+0x84>
  84:	e8 00 00 00 00       	callq  89 <_Z4initv+0x89>
...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e bb 08 00 00    	jle    a43 <_Z5benchv+0x8f3>
 ...
 218:	0f 83 25 08 00 00    	jae    a43 <_Z5benchv+0x8f3>
 ...
 9c9:	48 83 c6 11          	add    $0x11,%rsi
 9cd:	49 0f af c2          	imul   %r10,%rax
 9d1:	48 01 f8             	add    %rdi,%rax
 9d4:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
 9da:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
 9e1:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
 9e8:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
 9ef:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
 9f6:	00 00 00 
 9f9:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
 a00:	00 00 00 
 a03:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
 a0a:	00 00 00 
 a0d:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
 a14:	00 00 00 
 a17:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
 a1e:	01 00 00 
 a21:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
 a28:	01 00 00 
 a2b:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
 a32:	01 00 00 
 a35:	4c 39 c6             	cmp    %r8,%rsi
 a38:	0f 8c 52 f8 ff ff    	jl     290 <_Z5benchv+0x140>
 a3e:	e9 6d f7 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 a43:	0f 31                	rdtsc  
 a45:	48 c1 e2 20          	shl    $0x20,%rdx
 a49:	48 09 c2             	or     %rax,%rdx
 a4c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # a52 <_Z5benchv+0x902>
 a52:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 a57:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # a5f <_Z5benchv+0x90f>
 a5e:	00 
 a5f:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # a67 <_Z5benchv+0x917>
 a66:	00 
 a67:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # a6e <_Z5benchv+0x91e>
 a6e:	01 c0                	add    %eax,%eax
 a70:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 a76:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 a7a:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 a7e:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
 a82:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 a86:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 a8a:	c5 f8 77             	vzeroupper 
 a8d:	c3                   	retq   
 a8e:	90                   	nop
 a8f:	90                   	nop
...
0000000000000aa0 <_Z9n_reg_maxv>:
 aa0:	b8 d7 00 00 00       	mov    $0xd7,%eax
 aa5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui11_uk17.cpp+0x9a>
  96:	01 00 00 00 

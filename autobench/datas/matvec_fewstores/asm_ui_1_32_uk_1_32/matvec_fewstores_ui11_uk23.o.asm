...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 6d 0b 00 00    	jle    cf5 <_Z5benchv+0xba5>
 ...
 218:	0f 83 d7 0a 00 00    	jae    cf5 <_Z5benchv+0xba5>
 ...
 c7b:	48 83 c6 17          	add    $0x17,%rsi
 c7f:	49 0f af c2          	imul   %r10,%rax
 c83:	48 01 f8             	add    %rdi,%rax
 c86:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
 c8c:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
 c93:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
 c9a:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
 ca1:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
 ca8:	00 00 00 
 cab:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
 cb2:	00 00 00 
 cb5:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
 cbc:	00 00 00 
 cbf:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
 cc6:	00 00 00 
 cc9:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
 cd0:	01 00 00 
 cd3:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
 cda:	01 00 00 
 cdd:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
 ce4:	01 00 00 
 ce7:	4c 39 c6             	cmp    %r8,%rsi
 cea:	0f 8c a0 f5 ff ff    	jl     290 <_Z5benchv+0x140>
 cf0:	e9 bb f4 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 cf5:	0f 31                	rdtsc  
 cf7:	48 c1 e2 20          	shl    $0x20,%rdx
 cfb:	48 09 c2             	or     %rax,%rdx
 cfe:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # d04 <_Z5benchv+0xbb4>
 d04:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 d09:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # d11 <_Z5benchv+0xbc1>
 d10:	00 
 d11:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # d19 <_Z5benchv+0xbc9>
 d18:	00 
 d19:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # d20 <_Z5benchv+0xbd0>
 d20:	01 c0                	add    %eax,%eax
 d22:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 d28:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 d2c:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 d30:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
 d34:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 d38:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000000d50 <_Z9n_reg_maxv>:
 d50:	b8 1f 01 00 00       	mov    $0x11f,%eax
 d55:	c3                   	retq   

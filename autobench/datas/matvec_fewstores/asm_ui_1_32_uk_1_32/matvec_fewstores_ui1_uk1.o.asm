...
0000000000000130 <_Z5benchv>:
 ...
 162:	7e 74                	jle    1d8 <_Z5benchv+0xa8>
 164:	4c 8b 15 00 00 00 00 	mov    0x0(%rip),%r10        # 16b <_Z5benchv+0x3b>
 16b:	48 8b 15 00 00 00 00 	mov    0x0(%rip),%rdx        # 172 <_Z5benchv+0x42>
 172:	4c 8b 0d 00 00 00 00 	mov    0x0(%rip),%r9        # 179 <_Z5benchv+0x49>
 179:	8b 3d 00 00 00 00    	mov    0x0(%rip),%edi        # 17f <_Z5benchv+0x4f>
 17f:	4a 8d 04 85 00 00 00 	lea    0x0(,%r8,4),%rax
 186:	00 
 187:	45 31 db             	xor    %r11d,%r11d
 18a:	eb 17                	jmp    1a3 <_Z5benchv+0x73>
 18c:	90                   	nop
 18d:	90                   	nop
 18e:	90                   	nop
 18f:	90                   	nop
 190:	c4 81 7c 11 0c 99    	vmovups %ymm1,(%r9,%r11,4)
 196:	49 83 c3 08          	add    $0x8,%r11
 19a:	49 83 c2 20          	add    $0x20,%r10
 19e:	4d 39 c3             	cmp    %r8,%r11
 1a1:	73 35                	jae    1d8 <_Z5benchv+0xa8>
 1a3:	c4 81 7c 10 0c 99    	vmovups (%r9,%r11,4),%ymm1
 1a9:	85 ff                	test   %edi,%edi
 1ab:	7e e3                	jle    190 <_Z5benchv+0x60>
 1ad:	4c 89 d1             	mov    %r10,%rcx
 ...
 1be:	90                   	nop
 1bf:	90                   	nop
 1c0:	c4 e2 7d 18 14 b2    	vbroadcastss (%rdx,%rsi,4),%ymm2
 1c6:	c4 e2 6d b8 09       	vfmadd231ps (%rcx),%ymm2,%ymm1
 1cb:	48 ff c6             	inc    %rsi
 1ce:	48 01 c1             	add    %rax,%rcx
 1d1:	48 39 f7             	cmp    %rsi,%rdi
 1d4:	75 ea                	jne    1c0 <_Z5benchv+0x90>
 1d6:	eb b8                	jmp    190 <_Z5benchv+0x60>
 1d8:	0f 31                	rdtsc  
 1da:	48 c1 e2 20          	shl    $0x20,%rdx
 1de:	48 09 c2             	or     %rax,%rdx
 1e1:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1e7 <_Z5benchv+0xb7>
 1e7:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 1ec:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1f4 <_Z5benchv+0xc4>
 1f3:	00 
 1f4:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 1fc <_Z5benchv+0xcc>
 1fb:	00 
 1fc:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 203 <_Z5benchv+0xd3>
 203:	01 c0                	add    %eax,%eax
 205:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 20b:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 20f:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 213:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
 217:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 21b:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 21f:	c5 f8 77             	vzeroupper 
 222:	c3                   	retq   
 223:	90                   	nop
 224:	90                   	nop
 225:	90                   	nop
...
0000000000000230 <_Z6enablev>:
 230:	0f b6 05 00 00 00 00 	movzbl 0x0(%rip),%eax        # 237 <_Z6enablev+0x7>
 237:	8d 44 c0 ff          	lea    -0x1(%rax,%rax,8),%eax
 23b:	3b 05 00 00 00 00    	cmp    0x0(%rip),%eax        # 241 <_Z6enablev+0x11>
 241:	0f 9e c1             	setle  %cl
 244:	83 3d 00 00 00 00 00 	cmpl   $0x0,0x0(%rip)        # 24b <_Z6enablev+0x1b>
 24b:	0f 9f c0             	setg   %al
 24e:	20 c8                	and    %cl,%al
 250:	c3                   	retq   
 251:	90                   	nop
 252:	90                   	nop

...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 3b 1d 00 00    	jle    1ed3 <_Z5benchv+0x1d83>
     ...
     30c:	0f 83 c1 1b 00 00    	jae    1ed3 <_Z5benchv+0x1d83>
    ...
    1d49:	48 83 c6 13          	add    $0x13,%rsi
    1d4d:	49 0f af c2          	imul   %r10,%rax
    1d51:	48 01 f8             	add    %rdi,%rax
    1d54:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    1d5b:	02 00 00 
    1d5e:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    1d65:	00 00 00 
    1d68:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    1d6f:	00 00 00 
    1d72:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    1d79:	01 00 00 
    1d7c:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    1d83:	01 00 00 
    1d86:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    1d8d:	02 00 00 
    1d90:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    1d96:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    1d9d:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    1da4:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    1dab:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    1db2:	00 00 00 
    1db5:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    1dbc:	00 00 00 
    1dbf:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    1dc6:	01 00 00 
    1dc9:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    1dd0:	01 00 00 
    1dd3:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    1dd9:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    1de0:	00 00 
    1de2:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    1de9:	01 00 00 
    1dec:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    1df3:	00 00 
    1df5:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    1df9:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    1dfd:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    1e01:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    1e08:	00 00 
    1e0a:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    1e11:	00 00 
    1e13:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    1e19:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    1e20:	01 00 00 
    1e23:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    1e29:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    1e2f:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    1e36:	01 00 00 
    1e39:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    1e3f:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    1e45:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    1e4c:	01 00 00 
    1e4f:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    1e55:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    1e5a:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    1e61:	02 00 00 
    1e64:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    1e69:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    1e6f:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    1e76:	02 00 00 
    1e79:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    1e7f:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    1e85:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    1e8c:	02 00 00 
    1e8f:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    1e95:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    1e9b:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    1ea2:	02 00 00 
    1ea5:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    1eab:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    1eb1:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    1eb8:	02 00 00 
    1ebb:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    1ebf:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    1ec5:	4c 39 c6             	cmp    %r8,%rsi
    1ec8:	0f 8c b2 e5 ff ff    	jl     480 <_Z5benchv+0x330>
    1ece:	e9 0c e3 ff ff       	jmpq   1df <_Z5benchv+0x8f>
    1ed3:	0f 31                	rdtsc  
    1ed5:	48 c1 e2 20          	shl    $0x20,%rdx
    1ed9:	48 09 c2             	or     %rax,%rdx
    1edc:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1ee2 <_Z5benchv+0x1d92>
    1ee2:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1ee7:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1eef <_Z5benchv+0x1d9f>
    1eee:	00 
    1eef:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1ef7 <_Z5benchv+0x1da7>
    1ef6:	00 
    1ef7:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1efe <_Z5benchv+0x1dae>
    1efe:	01 c0                	add    %eax,%eax
    1f00:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1f06:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1f0a:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    1f11:	00 00 
    1f13:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    1f17:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    1f1b:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1f1f:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1f23:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
0000000000001f40 <_Z9n_reg_maxv>:
    1f40:	b8 df 01 00 00       	mov    $0x1df,%eax
    1f45:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e 47 09 00 00    	jle    acf <_Z5benchv+0x97f>
 ...
 1f0:	0f 83 d9 08 00 00    	jae    acf <_Z5benchv+0x97f>
 ...
 a7d:	48 83 c7 1d          	add    $0x1d,%rdi
 a81:	49 0f af c3          	imul   %r11,%rax
 a85:	48 01 f0             	add    %rsi,%rax
 a88:	c4 e2 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm1
 a8e:	c4 e2 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm2
 a95:	c4 e2 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm3
 a9c:	c4 e2 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm4
 aa3:	c4 e2 3d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm5
 aaa:	00 00 00 
 aad:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm6
 ab4:	00 00 00 
 ab7:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
 abe:	00 00 00 
 ac1:	4c 39 cf             	cmp    %r9,%rdi
 ac4:	0f 8c 76 f7 ff ff    	jl     240 <_Z5benchv+0xf0>
 aca:	e9 e1 f6 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 acf:	0f 31                	rdtsc  
 ad1:	48 c1 e2 20          	shl    $0x20,%rdx
 ad5:	48 09 c2             	or     %rax,%rdx
 ad8:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # ade <_Z5benchv+0x98e>
 ade:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 ae3:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # aeb <_Z5benchv+0x99b>
 aea:	00 
 aeb:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # af3 <_Z5benchv+0x9a3>
 af2:	00 
 af3:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # afa <_Z5benchv+0x9aa>
 afa:	01 c0                	add    %eax,%eax
 afc:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 b02:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 b06:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 b0a:	c5 b2 2a c8          	vcvtsi2ss %eax,%xmm9,%xmm1
 b0e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 b12:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
...
0000000000000b30 <_Z9n_reg_maxv>:
 b30:	b8 ef 00 00 00       	mov    $0xef,%eax
 b35:	c3                   	retq   

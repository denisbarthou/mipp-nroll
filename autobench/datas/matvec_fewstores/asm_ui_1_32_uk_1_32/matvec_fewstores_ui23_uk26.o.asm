...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e e0 26 00 00    	jle    2878 <_Z5benchv+0x2728>
     ...
     30c:	0f 83 66 25 00 00    	jae    2878 <_Z5benchv+0x2728>
    ...
    26e2:	48 83 c6 1a          	add    $0x1a,%rsi
    26e6:	49 0f af c2          	imul   %r10,%rax
    26ea:	48 01 f8             	add    %rdi,%rax
    26ed:	c4 e2 3d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm5
    26f4:	01 00 00 
    26f7:	c4 e2 3d b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm2
    26fe:	00 00 00 
    2701:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm6
    2708:	01 00 00 
    270b:	c4 e2 3d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm4
    2712:	01 00 00 
    2715:	c4 e2 3d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm1
    271c:	02 00 00 
    271f:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    2725:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    272c:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    2733:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    273a:	c4 62 3d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm13
    2741:	00 00 00 
    2744:	c4 62 3d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm14
    274b:	00 00 00 
    274e:	c4 e2 3d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm7
    2755:	00 00 00 
    2758:	c4 62 3d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm15
    275f:	01 00 00 
    2762:	c4 e2 3d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm3
    2769:	01 00 00 
    276c:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2772:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    2778:	c4 e2 3d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm0
    277f:	01 00 00 
    2782:	c5 fc 11 ac 24 c0 00 	vmovups %ymm5,0xc0(%rsp)
    2789:	00 00 
    278b:	c5 fc 28 ea          	vmovaps %ymm2,%ymm5
    278f:	c5 fc 11 b4 24 00 01 	vmovups %ymm6,0x100(%rsp)
    2796:	00 00 
    2798:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    279f:	00 00 
    27a1:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    27a8:	00 00 
    27aa:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    27b0:	c5 fc 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm0
    27b7:	00 00 
    27b9:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm0
    27c0:	01 00 00 
    27c3:	c5 fc 11 84 24 80 00 	vmovups %ymm0,0x80(%rsp)
    27ca:	00 00 
    27cc:	c5 fc 10 44 24 60    	vmovups 0x60(%rsp),%ymm0
    27d2:	c4 e2 3d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm0
    27d9:	01 00 00 
    27dc:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    27e2:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    27e8:	c4 e2 3d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm0
    27ef:	02 00 00 
    27f2:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    27f8:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    27fe:	c4 e2 3d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm0
    2805:	02 00 00 
    2808:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    280e:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    2814:	c4 e2 3d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm0
    281b:	02 00 00 
    281e:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    2824:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    2829:	c4 e2 3d b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm0
    2830:	02 00 00 
    2833:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    2838:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    283e:	c4 e2 3d b8 84 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm0
    2845:	02 00 00 
    2848:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    284e:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    2854:	c4 e2 3d b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm0
    285b:	02 00 00 
    285e:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2864:	c5 fd 10 44 24 80    	vmovupd -0x80(%rsp),%ymm0
    286a:	4c 39 c6             	cmp    %r8,%rsi
    286d:	0f 8c fd db ff ff    	jl     470 <_Z5benchv+0x320>
    2873:	e9 5b d9 ff ff       	jmpq   1d3 <_Z5benchv+0x83>
    2878:	0f 31                	rdtsc  
    287a:	48 c1 e2 20          	shl    $0x20,%rdx
    287e:	48 09 c2             	or     %rax,%rdx
    2881:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2887 <_Z5benchv+0x2737>
    2887:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    288c:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2894 <_Z5benchv+0x2744>
    2893:	00 
    2894:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 289c <_Z5benchv+0x274c>
    289b:	00 
    289c:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 28a3 <_Z5benchv+0x2753>
    28a3:	01 c0                	add    %eax,%eax
    28a5:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    28ab:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    28af:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    28b6:	00 00 
    28b8:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    28bc:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    28c0:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    28c4:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    28c8:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
00000000000028f0 <_Z9n_reg_maxv>:
    28f0:	b8 87 02 00 00       	mov    $0x287,%eax
    28f5:	c3                   	retq   

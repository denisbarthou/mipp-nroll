...
0000000000000140 <_Z5benchv>:
 ...
 179:	0f 8e 55 01 00 00    	jle    2d4 <_Z5benchv+0x194>
 ...
 19b:	4b 8d 04 c0          	lea    (%r8,%r8,8),%rax
 19f:	4a 8d 34 85 00 00 00 	lea    0x0(,%r8,4),%rsi
 1a6:	00 
 1a7:	b9 20 00 00 00       	mov    $0x20,%ecx
 1ac:	45 31 db             	xor    %r11d,%r11d
 1af:	4c 8d 3c 40          	lea    (%rax,%rax,2),%r15
 1b3:	48 8d 04 b6          	lea    (%rsi,%rsi,4),%rax
 1b7:	4d 01 c7             	add    %r8,%r15
 1ba:	48 29 c1             	sub    %rax,%rcx
 ...
 1e7:	0f 83 e7 00 00 00    	jae    2d4 <_Z5benchv+0x194>
 ...
 20e:	90                   	nop
 20f:	90                   	nop
 210:	c4 62 7d 18 0c 82    	vbroadcastss (%rdx,%rax,4),%ymm9
 216:	c4 e2 35 b8 4b e0    	vfmadd231ps -0x20(%rbx),%ymm9,%ymm1
 21c:	c4 62 7d 18 44 82 04 	vbroadcastss 0x4(%rdx,%rax,4),%ymm8
 223:	48 8d 7c 33 e0       	lea    -0x20(%rbx,%rsi,1),%rdi
 228:	c4 e2 7d 18 7c 82 08 	vbroadcastss 0x8(%rdx,%rax,4),%ymm7
 22f:	c4 e2 7d 18 74 82 0c 	vbroadcastss 0xc(%rdx,%rax,4),%ymm6
 236:	c4 e2 7d 18 6c 82 10 	vbroadcastss 0x10(%rdx,%rax,4),%ymm5
 23d:	c4 e2 7d 18 64 82 14 	vbroadcastss 0x14(%rdx,%rax,4),%ymm4
 244:	c4 e2 35 b8 13       	vfmadd231ps (%rbx),%ymm9,%ymm2
 249:	c4 e2 7d 18 5c 82 18 	vbroadcastss 0x18(%rdx,%rax,4),%ymm3
 250:	48 83 c0 07          	add    $0x7,%rax
 254:	c4 e2 3d b8 4c 33 e0 	vfmadd231ps -0x20(%rbx,%rsi,1),%ymm8,%ymm1
 25b:	4c 01 fb             	add    %r15,%rbx
 25e:	c4 e2 45 b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm7,%ymm1
 264:	48 01 f7             	add    %rsi,%rdi
 267:	c4 e2 4d b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm6,%ymm1
 26d:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 271:	c4 e2 55 b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm5,%ymm1
 277:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 27b:	c4 e2 5d b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm4,%ymm1
 281:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 285:	c4 e2 65 b8 0c 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm3,%ymm1
 28b:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 28f:	c4 e2 3d b8 14 39    	vfmadd231ps (%rcx,%rdi,1),%ymm8,%ymm2
 295:	48 8d 3c 0f          	lea    (%rdi,%rcx,1),%rdi
 299:	c4 e2 45 b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm7,%ymm2
 29f:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2a3:	c4 e2 4d b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm6,%ymm2
 2a9:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2ad:	c4 e2 55 b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm5,%ymm2
 2b3:	48 8d 3c 37          	lea    (%rdi,%rsi,1),%rdi
 2b7:	c4 e2 5d b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm4,%ymm2
 2bd:	48 01 f7             	add    %rsi,%rdi
 2c0:	c4 e2 65 b8 14 3e    	vfmadd231ps (%rsi,%rdi,1),%ymm3,%ymm2
 2c6:	4c 39 e0             	cmp    %r12,%rax
 2c9:	0f 8c 41 ff ff ff    	jl     210 <_Z5benchv+0xd0>
 2cf:	e9 fc fe ff ff       	jmpq   1d0 <_Z5benchv+0x90>
 2d4:	0f 31                	rdtsc  
 2d6:	48 c1 e2 20          	shl    $0x20,%rdx
 2da:	48 09 c2             	or     %rax,%rdx
 2dd:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2e3 <_Z5benchv+0x1a3>
 2e3:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 2e8:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 2f0 <_Z5benchv+0x1b0>
 2ef:	00 
 2f0:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 2f8 <_Z5benchv+0x1b8>
 2f7:	00 
 2f8:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2ff <_Z5benchv+0x1bf>
 2ff:	01 c0                	add    %eax,%eax
 301:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 307:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 30b:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 30f:	c5 aa 2a c8          	vcvtsi2ss %eax,%xmm10,%xmm1
 313:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 317:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 31b:	5b                   	pop    %rbx
 31c:	41 5c                	pop    %r12
 31e:	41 5e                	pop    %r14
 320:	41 5f                	pop    %r15

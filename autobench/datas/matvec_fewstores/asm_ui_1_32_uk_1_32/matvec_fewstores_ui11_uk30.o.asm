...
0000000000000150 <_Z5benchv>:
     ...
     182:	0f 8e 94 0e 00 00    	jle    101c <_Z5benchv+0xecc>
     ...
     218:	0f 83 fe 0d 00 00    	jae    101c <_Z5benchv+0xecc>
     ...
     dd6:	49 0f af f3          	imul   %r11,%rsi
     dda:	48 01 fe             	add    %rdi,%rsi
     ddd:	c4 e2 1d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm1
     de3:	c4 e2 1d b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm12,%ymm2
     dea:	c4 e2 1d b8 5c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm12,%ymm3
     df1:	c4 e2 1d b8 64 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm12,%ymm4
     df8:	c4 e2 1d b8 ac b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm12,%ymm5
     dff:	00 00 00 
     e02:	c4 e2 1d b8 b4 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm12,%ymm6
     e09:	00 00 00 
     e0c:	c4 e2 1d b8 bc b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm12,%ymm7
     e13:	00 00 00 
     e16:	c4 62 1d b8 84 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm12,%ymm8
     e1d:	00 00 00 
     e20:	c4 62 1d b8 8c b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm12,%ymm9
     e27:	01 00 00 
     e2a:	c4 62 1d b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm12,%ymm10
     e31:	01 00 00 
     e34:	c4 62 1d b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm12,%ymm11
     e3b:	01 00 00 
     e3e:	48 8d 70 1a          	lea    0x1a(%rax),%rsi
     e42:	c4 62 7d 18 64 82 68 	vbroadcastss 0x68(%rdx,%rax,4),%ymm12
     e49:	49 0f af f3          	imul   %r11,%rsi
     e4d:	48 01 fe             	add    %rdi,%rsi
     e50:	c4 e2 1d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm1
     e56:	c4 e2 1d b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm12,%ymm2
     e5d:	c4 e2 1d b8 5c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm12,%ymm3
     e64:	c4 e2 1d b8 64 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm12,%ymm4
     e6b:	c4 e2 1d b8 ac b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm12,%ymm5
     e72:	00 00 00 
     e75:	c4 e2 1d b8 b4 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm12,%ymm6
     e7c:	00 00 00 
     e7f:	c4 e2 1d b8 bc b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm12,%ymm7
     e86:	00 00 00 
     e89:	c4 62 1d b8 84 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm12,%ymm8
     e90:	00 00 00 
     e93:	c4 62 1d b8 8c b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm12,%ymm9
     e9a:	01 00 00 
     e9d:	c4 62 1d b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm12,%ymm10
     ea4:	01 00 00 
     ea7:	c4 62 1d b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm12,%ymm11
     eae:	01 00 00 
     eb1:	48 8d 70 1b          	lea    0x1b(%rax),%rsi
     eb5:	c4 62 7d 18 64 82 6c 	vbroadcastss 0x6c(%rdx,%rax,4),%ymm12
     ebc:	49 0f af f3          	imul   %r11,%rsi
     ec0:	48 01 fe             	add    %rdi,%rsi
     ec3:	c4 e2 1d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm1
     ec9:	c4 e2 1d b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm12,%ymm2
     ed0:	c4 e2 1d b8 5c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm12,%ymm3
     ed7:	c4 e2 1d b8 64 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm12,%ymm4
     ede:	c4 e2 1d b8 ac b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm12,%ymm5
     ee5:	00 00 00 
     ee8:	c4 e2 1d b8 b4 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm12,%ymm6
     eef:	00 00 00 
     ef2:	c4 e2 1d b8 bc b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm12,%ymm7
     ef9:	00 00 00 
     efc:	c4 62 1d b8 84 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm12,%ymm8
     f03:	00 00 00 
     f06:	c4 62 1d b8 8c b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm12,%ymm9
     f0d:	01 00 00 
     f10:	c4 62 1d b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm12,%ymm10
     f17:	01 00 00 
     f1a:	c4 62 1d b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm12,%ymm11
     f21:	01 00 00 
     f24:	48 8d 70 1c          	lea    0x1c(%rax),%rsi
     f28:	c4 62 7d 18 64 82 70 	vbroadcastss 0x70(%rdx,%rax,4),%ymm12
     f2f:	49 0f af f3          	imul   %r11,%rsi
     f33:	48 01 fe             	add    %rdi,%rsi
     f36:	c4 e2 1d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm1
     f3c:	c4 e2 1d b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm12,%ymm2
     f43:	c4 e2 1d b8 5c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm12,%ymm3
     f4a:	c4 e2 1d b8 64 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm12,%ymm4
     f51:	c4 e2 1d b8 ac b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm12,%ymm5
     f58:	00 00 00 
     f5b:	c4 e2 1d b8 b4 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm12,%ymm6
     f62:	00 00 00 
     f65:	c4 e2 1d b8 bc b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm12,%ymm7
     f6c:	00 00 00 
     f6f:	c4 62 1d b8 84 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm12,%ymm8
     f76:	00 00 00 
     f79:	c4 62 1d b8 8c b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm12,%ymm9
     f80:	01 00 00 
     f83:	c4 62 1d b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm12,%ymm10
     f8a:	01 00 00 
     f8d:	c4 62 1d b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm12,%ymm11
     f94:	01 00 00 
     f97:	48 8d 70 1d          	lea    0x1d(%rax),%rsi
     f9b:	c4 62 7d 18 64 82 74 	vbroadcastss 0x74(%rdx,%rax,4),%ymm12
     fa2:	48 83 c0 1e          	add    $0x1e,%rax
     fa6:	49 0f af f3          	imul   %r11,%rsi
     faa:	48 01 fe             	add    %rdi,%rsi
     fad:	c4 e2 1d b8 0c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm1
     fb3:	c4 e2 1d b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm12,%ymm2
     fba:	c4 e2 1d b8 5c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm12,%ymm3
     fc1:	c4 e2 1d b8 64 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm12,%ymm4
     fc8:	c4 e2 1d b8 ac b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm12,%ymm5
     fcf:	00 00 00 
     fd2:	c4 e2 1d b8 b4 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm12,%ymm6
     fd9:	00 00 00 
     fdc:	c4 e2 1d b8 bc b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm12,%ymm7
     fe3:	00 00 00 
     fe6:	c4 62 1d b8 84 b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm12,%ymm8
     fed:	00 00 00 
     ff0:	c4 62 1d b8 8c b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm12,%ymm9
     ff7:	01 00 00 
     ffa:	c4 62 1d b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm12,%ymm10
    1001:	01 00 00 
    1004:	c4 62 1d b8 9c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm12,%ymm11
    100b:	01 00 00 
    100e:	4c 39 c0             	cmp    %r8,%rax
    1011:	0f 8c 79 f2 ff ff    	jl     290 <_Z5benchv+0x140>
    1017:	e9 94 f1 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
    101c:	0f 31                	rdtsc  
    101e:	48 c1 e2 20          	shl    $0x20,%rdx
    1022:	48 09 c2             	or     %rax,%rdx
    1025:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 102b <_Z5benchv+0xedb>
    102b:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
    1030:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # 1038 <_Z5benchv+0xee8>
    1037:	00 
    1038:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # 1040 <_Z5benchv+0xef0>
    103f:	00 
    1040:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1047 <_Z5benchv+0xef7>
    1047:	01 c0                	add    %eax,%eax
    1049:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
    104f:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    1053:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
    1057:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    105b:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    105f:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1063:	c5 f8 77             	vzeroupper 
    1066:	c3                   	retq   
    1067:	90                   	nop
    1068:	90                   	nop
    1069:	90                   	nop
...
0000000000001080 <_Z9n_reg_maxv>:
    1080:	b8 73 01 00 00       	mov    $0x173,%eax
    1085:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
     ...
     18c:	0f 8e bb 11 00 00    	jle    134d <_Z5benchv+0x11fd>
     ...
     28c:	0f 83 bb 10 00 00    	jae    134d <_Z5benchv+0x11fd>
    ...
    125a:	48 83 c6 13          	add    $0x13,%rsi
    125e:	49 0f af c2          	imul   %r10,%rax
    1262:	48 01 f8             	add    %rdi,%rax
    1265:	c4 e2 6d b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm2,%ymm5
    126c:	c4 e2 6d b8 1c 81    	vfmadd231ps (%rcx,%rax,4),%ymm2,%ymm3
    1272:	c4 e2 6d b8 64 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm2,%ymm4
    1279:	c4 62 6d b8 a4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm2,%ymm12
    1280:	01 00 00 
    1283:	c4 62 6d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm2,%ymm15
    128a:	01 00 00 
    128d:	c4 e2 6d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm2,%ymm6
    1294:	00 00 00 
    1297:	c4 e2 6d b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm2,%ymm7
    129e:	00 00 00 
    12a1:	c4 62 6d b8 84 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm2,%ymm8
    12a8:	00 00 00 
    12ab:	c4 62 6d b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm2,%ymm9
    12b2:	00 00 00 
    12b5:	c4 62 6d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm2,%ymm10
    12bc:	01 00 00 
    12bf:	c4 62 6d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm2,%ymm11
    12c6:	01 00 00 
    12c9:	c4 62 6d b8 ac 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm2,%ymm13
    12d0:	01 00 00 
    12d3:	c4 62 6d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm2,%ymm14
    12da:	01 00 00 
    12dd:	c4 e2 6d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm2,%ymm0
    12e4:	02 00 00 
    12e7:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    12ed:	c5 fc 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm1
    12f3:	c4 e2 6d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm2,%ymm1
    12fa:	c5 fc 11 2c 24       	vmovups %ymm5,(%rsp)
    12ff:	c5 fc 10 6c 24 c0    	vmovups -0x40(%rsp),%ymm5
    1305:	c4 e2 6d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm2,%ymm5
    130c:	01 00 00 
    130f:	c5 7c 11 64 24 20    	vmovups %ymm12,0x20(%rsp)
    1315:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
    131b:	c5 fc 11 4c 24 a0    	vmovups %ymm1,-0x60(%rsp)
    1321:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    1327:	c4 e2 6d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm2,%ymm1
    132e:	01 00 00 
    1331:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    1335:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    1339:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    133f:	4c 39 c6             	cmp    %r8,%rsi
    1342:	0f 8c 18 f0 ff ff    	jl     360 <_Z5benchv+0x210>
    1348:	e9 7b ee ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    134d:	0f 31                	rdtsc  
    134f:	48 c1 e2 20          	shl    $0x20,%rdx
    1353:	48 09 c2             	or     %rax,%rdx
    1356:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 135c <_Z5benchv+0x120c>
    135c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1361:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1369 <_Z5benchv+0x1219>
    1368:	00 
    1369:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1371 <_Z5benchv+0x1221>
    1370:	00 
    1371:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1378 <_Z5benchv+0x1228>
    1378:	01 c0                	add    %eax,%eax
    137a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1380:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1384:	c5 fb 5c 44 24 f8    	vsubsd -0x8(%rsp),%xmm0,%xmm0
    138a:	c4 41 18 57 e4       	vxorps %xmm12,%xmm12,%xmm12
    138f:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
    1393:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1397:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    139b:	48 83 c4 78          	add    $0x78,%rsp
    139f:	c5 f8 77             	vzeroupper 
    13a2:	c3                   	retq   
    13a3:	90                   	nop
    13a4:	90                   	nop
    13a5:	90                   	nop
...
00000000000013c0 <_Z9n_reg_maxv>:
    13c0:	b8 67 01 00 00       	mov    $0x167,%eax
    13c5:	c3                   	retq   

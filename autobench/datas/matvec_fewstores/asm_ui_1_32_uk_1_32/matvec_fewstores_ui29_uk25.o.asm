...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e f0 36 00 00    	jle    3888 <_Z5benchv+0x3738>
     ...
     37a:	0f 83 08 35 00 00    	jae    3888 <_Z5benchv+0x3738>
    ...
    363d:	48 83 c6 19          	add    $0x19,%rsi
    3641:	49 0f af c2          	imul   %r10,%rax
    3645:	48 01 f8             	add    %rdi,%rax
    3648:	c4 e2 0d b8 84 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm14,%ymm0
    364f:	03 00 00 
    3652:	c4 62 0d b8 3c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm15
    3658:	c4 e2 0d b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm5
    365f:	00 00 00 
    3662:	c4 e2 0d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm7
    3669:	00 00 00 
    366c:	c4 62 0d b8 9c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm11
    3673:	01 00 00 
    3676:	c4 62 0d b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm8
    367d:	01 00 00 
    3680:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm14,%ymm12
    3687:	02 00 00 
    368a:	c4 62 0d b8 ac 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm14,%ymm13
    3691:	03 00 00 
    3694:	c4 e2 0d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm1
    369b:	c4 e2 0d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm2
    36a2:	c4 e2 0d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm3
    36a9:	c4 e2 0d b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm4
    36b0:	00 00 00 
    36b3:	c4 e2 0d b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm6
    36ba:	00 00 00 
    36bd:	c4 62 0d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm14,%ymm10
    36c4:	02 00 00 
    36c7:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    36cd:	c5 7c 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm9
    36d3:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm9
    36da:	01 00 00 
    36dd:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    36e4:	00 00 
    36e6:	c5 7c 29 f8          	vmovaps %ymm15,%ymm0
    36ea:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    36ee:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    36f2:	c5 7c 11 4c 24 a0    	vmovups %ymm9,-0x60(%rsp)
    36f8:	c5 7c 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm9
    36ff:	00 00 
    3701:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm9
    3708:	01 00 00 
    370b:	c5 7c 11 8c 24 20 01 	vmovups %ymm9,0x120(%rsp)
    3712:	00 00 
    3714:	c5 7c 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm9
    371b:	00 00 
    371d:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm9
    3724:	01 00 00 
    3727:	c5 7c 11 8c 24 e0 00 	vmovups %ymm9,0xe0(%rsp)
    372e:	00 00 
    3730:	c5 7c 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm9
    3737:	00 00 
    3739:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm14,%ymm9
    3740:	01 00 00 
    3743:	c5 7c 11 8c 24 a0 00 	vmovups %ymm9,0xa0(%rsp)
    374a:	00 00 
    374c:	c5 7c 10 8c 24 00 01 	vmovups 0x100(%rsp),%ymm9
    3753:	00 00 
    3755:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm14,%ymm9
    375c:	01 00 00 
    375f:	c5 7c 11 8c 24 00 01 	vmovups %ymm9,0x100(%rsp)
    3766:	00 00 
    3768:	c5 7c 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm9
    376f:	00 00 
    3771:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm14,%ymm9
    3778:	01 00 00 
    377b:	c5 7c 11 8c 24 c0 00 	vmovups %ymm9,0xc0(%rsp)
    3782:	00 00 
    3784:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    378a:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm14,%ymm9
    3791:	02 00 00 
    3794:	c5 7c 11 4c 24 c0    	vmovups %ymm9,-0x40(%rsp)
    379a:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    37a0:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm14,%ymm9
    37a7:	02 00 00 
    37aa:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    37b0:	c5 7c 11 4c 24 80    	vmovups %ymm9,-0x80(%rsp)
    37b6:	c5 7c 10 8c 24 40 01 	vmovups 0x140(%rsp),%ymm9
    37bd:	00 00 
    37bf:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm14,%ymm9
    37c6:	02 00 00 
    37c9:	c5 7c 11 8c 24 40 01 	vmovups %ymm9,0x140(%rsp)
    37d0:	00 00 
    37d2:	c5 7c 10 4c 24 60    	vmovups 0x60(%rsp),%ymm9
    37d8:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm14,%ymm9
    37df:	02 00 00 
    37e2:	c5 7c 11 4c 24 60    	vmovups %ymm9,0x60(%rsp)
    37e8:	c5 7c 10 4c 24 40    	vmovups 0x40(%rsp),%ymm9
    37ee:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm14,%ymm9
    37f5:	02 00 00 
    37f8:	c5 7c 11 4c 24 40    	vmovups %ymm9,0x40(%rsp)
    37fe:	c5 7c 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm9
    3805:	00 00 
    3807:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm14,%ymm9
    380e:	02 00 00 
    3811:	c5 7c 11 8c 24 80 00 	vmovups %ymm9,0x80(%rsp)
    3818:	00 00 
    381a:	c5 7c 10 4c 24 20    	vmovups 0x20(%rsp),%ymm9
    3820:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm14,%ymm9
    3827:	03 00 00 
    382a:	c5 7c 11 4c 24 20    	vmovups %ymm9,0x20(%rsp)
    3830:	c5 7c 10 0c 24       	vmovups (%rsp),%ymm9
    3835:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm14,%ymm9
    383c:	03 00 00 
    383f:	c5 7c 11 0c 24       	vmovups %ymm9,(%rsp)
    3844:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    384a:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm14,%ymm9
    3851:	03 00 00 
    3854:	c4 41 7c 28 f5       	vmovaps %ymm13,%ymm14
    3859:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    385e:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    3863:	c4 41 7c 28 e0       	vmovaps %ymm8,%ymm12
    3868:	c5 7c 10 44 24 a0    	vmovups -0x60(%rsp),%ymm8
    386e:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    3874:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    387a:	4c 39 c6             	cmp    %r8,%rsi
    387d:	0f 8c fd cc ff ff    	jl     580 <_Z5benchv+0x430>
    3883:	e9 6e c9 ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    3888:	0f 31                	rdtsc  
    388a:	48 c1 e2 20          	shl    $0x20,%rdx
    388e:	48 09 c2             	or     %rax,%rdx
    3891:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3897 <_Z5benchv+0x3747>
    3897:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    389c:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 38a4 <_Z5benchv+0x3754>
    38a3:	00 
    38a4:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 38ac <_Z5benchv+0x375c>
    38ab:	00 
    38ac:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 38b3 <_Z5benchv+0x3763>
    38b3:	01 c0                	add    %eax,%eax
    38b5:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    38bb:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    38bf:	c5 fb 5c 84 24 78 01 	vsubsd 0x178(%rsp),%xmm0,%xmm0
    38c6:	00 00 
    38c8:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    38cc:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    38d0:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    38d4:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    38d8:	48 81 c4 38 02 00 00 	add    $0x238,%rsp
    38df:	c5 f8 77             	vzeroupper 
    38e2:	c3                   	retq   
    38e3:	90                   	nop
    38e4:	90                   	nop
    38e5:	90                   	nop
...
0000000000003900 <_Z9n_reg_maxv>:
    3900:	b8 0b 03 00 00       	mov    $0x30b,%eax
    3905:	c3                   	retq   

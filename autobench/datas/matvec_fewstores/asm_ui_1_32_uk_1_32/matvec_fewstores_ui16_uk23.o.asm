...
0000000000000140 <_Z5benchv>:
     ...
     184:	0f 8e 95 13 00 00    	jle    151f <_Z5benchv+0x13df>
     ...
     28a:	0f 83 8f 12 00 00    	jae    151f <_Z5benchv+0x13df>
    ...
    133a:	01 00 00 
    133d:	c4 62 75 b8 ac 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm13
    1344:	01 00 00 
    ...
    1383:	c4 e2 75 b8 94 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm2
    138a:	01 00 00 
    ...
    13f7:	01 00 00 
    13fa:	c4 62 75 b8 ac 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm13
    1401:	01 00 00 
    ...
    1440:	c4 e2 75 b8 94 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm2
    1447:	01 00 00 
    144a:	49 8d 5d 16          	lea    0x16(%r13),%rbx
    144e:	c4 a2 7d 18 4c aa 58 	vbroadcastss 0x58(%rdx,%r13,4),%ymm1
    1455:	49 83 c5 17          	add    $0x17,%r13
    1459:	48 0f af d8          	imul   %rax,%rbx
    145d:	48 01 fb             	add    %rdi,%rbx
    1460:	c4 e2 75 b8 5c 99 20 	vfmadd231ps 0x20(%rcx,%rbx,4),%ymm1,%ymm3
    1467:	c4 e2 75 b8 64 99 40 	vfmadd231ps 0x40(%rcx,%rbx,4),%ymm1,%ymm4
    146e:	c4 e2 75 b8 6c 99 60 	vfmadd231ps 0x60(%rcx,%rbx,4),%ymm1,%ymm5
    1475:	c4 e2 75 b8 b4 99 80 	vfmadd231ps 0x80(%rcx,%rbx,4),%ymm1,%ymm6
    147c:	00 00 00 
    147f:	c4 e2 75 b8 bc 99 a0 	vfmadd231ps 0xa0(%rcx,%rbx,4),%ymm1,%ymm7
    1486:	00 00 00 
    1489:	c4 62 75 b8 84 99 c0 	vfmadd231ps 0xc0(%rcx,%rbx,4),%ymm1,%ymm8
    1490:	00 00 00 
    1493:	c4 62 75 b8 8c 99 e0 	vfmadd231ps 0xe0(%rcx,%rbx,4),%ymm1,%ymm9
    149a:	00 00 00 
    149d:	c4 62 75 b8 94 99 00 	vfmadd231ps 0x100(%rcx,%rbx,4),%ymm1,%ymm10
    14a4:	01 00 00 
    14a7:	c4 62 75 b8 9c 99 20 	vfmadd231ps 0x120(%rcx,%rbx,4),%ymm1,%ymm11
    14ae:	01 00 00 
    14b1:	c4 62 75 b8 a4 99 40 	vfmadd231ps 0x140(%rcx,%rbx,4),%ymm1,%ymm12
    14b8:	01 00 00 
    14bb:	c4 62 75 b8 ac 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm13
    14c2:	01 00 00 
    14c5:	c4 62 75 b8 b4 99 a0 	vfmadd231ps 0x1a0(%rcx,%rbx,4),%ymm1,%ymm14
    14cc:	01 00 00 
    14cf:	c4 62 75 b8 bc 99 c0 	vfmadd231ps 0x1c0(%rcx,%rbx,4),%ymm1,%ymm15
    14d6:	01 00 00 
    14d9:	c4 e2 75 b8 84 99 e0 	vfmadd231ps 0x1e0(%rcx,%rbx,4),%ymm1,%ymm0
    14e0:	01 00 00 
    14e3:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    14e9:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    14ef:	c4 e2 75 b8 14 99    	vfmadd231ps (%rcx,%rbx,4),%ymm1,%ymm2
    14f5:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    14fb:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    1501:	c4 e2 75 b8 94 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm2
    1508:	01 00 00 
    150b:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    1511:	49 39 ed             	cmp    %rbp,%r13
    1514:	0f 8c f6 ee ff ff    	jl     410 <_Z5benchv+0x2d0>
    151a:	e9 bd ec ff ff       	jmpq   1dc <_Z5benchv+0x9c>
    151f:	0f 31                	rdtsc  
    1521:	48 c1 e2 20          	shl    $0x20,%rdx
    1525:	48 09 c2             	or     %rax,%rdx
    1528:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 152e <_Z5benchv+0x13ee>
    152e:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1533:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 153b <_Z5benchv+0x13fb>
    153a:	00 
    153b:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1543 <_Z5benchv+0x1403>
    1542:	00 
    1543:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 154a <_Z5benchv+0x140a>
    154a:	01 c0                	add    %eax,%eax
    154c:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1552:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1556:	c5 fb 5c 44 24 e8    	vsubsd -0x18(%rsp),%xmm0,%xmm0
    155c:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    1560:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    1564:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1568:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    156c:	48 83 c4 48          	add    $0x48,%rsp
    1570:	5b                   	pop    %rbx
    1571:	41 5c                	pop    %r12
    1573:	41 5d                	pop    %r13
    1575:	41 5e                	pop    %r14
...
0000000000001590 <_Z9n_reg_maxv>:
    1590:	b8 97 01 00 00       	mov    $0x197,%eax
    1595:	c3                   	retq   

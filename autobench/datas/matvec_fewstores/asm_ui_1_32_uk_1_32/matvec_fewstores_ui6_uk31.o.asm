...
0000000000000150 <_Z5benchv>:
 ...
 181:	0f 8e 98 08 00 00    	jle    a1f <_Z5benchv+0x8cf>
 ...
 1e5:	0f 83 34 08 00 00    	jae    a1f <_Z5benchv+0x8cf>
 ...
 955:	48 0f af c3          	imul   %rbx,%rax
 959:	48 01 f0             	add    %rsi,%rax
 95c:	c4 e2 45 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm1
 962:	c4 e2 45 b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm6
 969:	c4 e2 45 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm2
 970:	c4 e2 45 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm3
 977:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm4
 97e:	00 00 00 
 981:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm5
 988:	00 00 00 
 98b:	48 8d 47 1d          	lea    0x1d(%rdi),%rax
 98f:	c4 e2 7d 18 7c ba 74 	vbroadcastss 0x74(%rdx,%rdi,4),%ymm7
 996:	48 0f af c3          	imul   %rbx,%rax
 99a:	48 01 f0             	add    %rsi,%rax
 99d:	c4 e2 45 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm1
 9a3:	c4 e2 45 b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm6
 9aa:	c4 e2 45 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm2
 9b1:	c4 e2 45 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm3
 9b8:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm4
 9bf:	00 00 00 
 9c2:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm5
 9c9:	00 00 00 
 9cc:	48 8d 47 1e          	lea    0x1e(%rdi),%rax
 9d0:	c4 e2 7d 18 7c ba 78 	vbroadcastss 0x78(%rdx,%rdi,4),%ymm7
 9d7:	48 83 c7 1f          	add    $0x1f,%rdi
 9db:	48 0f af c3          	imul   %rbx,%rax
 9df:	48 01 f0             	add    %rsi,%rax
 9e2:	c4 e2 45 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm1
 9e8:	c4 e2 45 b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm6
 9ef:	c4 e2 45 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm2
 9f6:	c4 e2 45 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm3
 9fd:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm4
 a04:	00 00 00 
 a07:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm5
 a0e:	00 00 00 
 a11:	4c 39 d7             	cmp    %r10,%rdi
 a14:	0f 8c 16 f8 ff ff    	jl     230 <_Z5benchv+0xe0>
 a1a:	e9 91 f7 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 a1f:	0f 31                	rdtsc  
 a21:	48 c1 e2 20          	shl    $0x20,%rdx
 a25:	48 09 c2             	or     %rax,%rdx
 a28:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # a2e <_Z5benchv+0x8de>
 a2e:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 a33:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # a3b <_Z5benchv+0x8eb>
 a3a:	00 
 a3b:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # a43 <_Z5benchv+0x8f3>
 a42:	00 
 a43:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # a4a <_Z5benchv+0x8fa>
 a4a:	01 c0                	add    %eax,%eax
 a4c:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 a52:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 a56:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 a5a:	c5 ba 2a c8          	vcvtsi2ss %eax,%xmm8,%xmm1
 a5e:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 a62:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 a66:	5b                   	pop    %rbx
 a67:	c5 f8 77             	vzeroupper 
 a6a:	c3                   	retq   
 a6b:	90                   	nop
 a6c:	90                   	nop
 a6d:	90                   	nop
...
0000000000000a80 <_Z9n_reg_maxv>:
 a80:	b8 df 00 00 00       	mov    $0xdf,%eax
 a85:	c3                   	retq   

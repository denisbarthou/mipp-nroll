...
0000000000000150 <_Z5benchv>:
     ...
     182:	0f 8e 1f 0e 00 00    	jle    fa7 <_Z5benchv+0xe57>
     ...
     218:	0f 83 89 0d 00 00    	jae    fa7 <_Z5benchv+0xe57>
     ...
     f2d:	48 83 c6 1d          	add    $0x1d,%rsi
     f31:	49 0f af c3          	imul   %r11,%rax
     f35:	48 01 f8             	add    %rdi,%rax
     f38:	c4 e2 1d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm1
     f3e:	c4 e2 1d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm2
     f45:	c4 e2 1d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm3
     f4c:	c4 e2 1d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm4
     f53:	c4 e2 1d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm5
     f5a:	00 00 00 
     f5d:	c4 e2 1d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm6
     f64:	00 00 00 
     f67:	c4 e2 1d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm7
     f6e:	00 00 00 
     f71:	c4 62 1d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm8
     f78:	00 00 00 
     f7b:	c4 62 1d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm9
     f82:	01 00 00 
     f85:	c4 62 1d b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm10
     f8c:	01 00 00 
     f8f:	c4 62 1d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm11
     f96:	01 00 00 
     f99:	4c 39 c6             	cmp    %r8,%rsi
     f9c:	0f 8c ee f2 ff ff    	jl     290 <_Z5benchv+0x140>
     fa2:	e9 09 f2 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
     fa7:	0f 31                	rdtsc  
     fa9:	48 c1 e2 20          	shl    $0x20,%rdx
     fad:	48 09 c2             	or     %rax,%rdx
     fb0:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # fb6 <_Z5benchv+0xe66>
     fb6:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
     fbb:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # fc3 <_Z5benchv+0xe73>
     fc2:	00 
     fc3:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # fcb <_Z5benchv+0xe7b>
     fca:	00 
     fcb:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # fd2 <_Z5benchv+0xe82>
     fd2:	01 c0                	add    %eax,%eax
     fd4:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
     fda:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
     fde:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
     fe2:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
     fe6:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
     fea:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
     fee:	c5 f8 77             	vzeroupper 
     ff1:	c3                   	retq   
     ff2:	90                   	nop
     ff3:	90                   	nop
     ff4:	90                   	nop
...
0000000000001010 <_Z9n_reg_maxv>:
    1010:	b8 67 01 00 00       	mov    $0x167,%eax
    1015:	c3                   	retq   

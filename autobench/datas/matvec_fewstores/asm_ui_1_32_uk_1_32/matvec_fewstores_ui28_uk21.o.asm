...
0000000000000150 <_Z5benchv>:
     ...
     193:	0f 8e b0 2c 00 00    	jle    2e49 <_Z5benchv+0x2cf9>
     ...
     37f:	0f 83 c4 2a 00 00    	jae    2e49 <_Z5benchv+0x2cf9>
    ...
    2c18:	48 83 c3 15          	add    $0x15,%rbx
    2c1c:	48 0f af f0          	imul   %rax,%rsi
    2c20:	48 01 fe             	add    %rdi,%rsi
    2c23:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm13,%ymm3
    2c2a:	00 00 00 
    2c2d:	c4 e2 15 b8 54 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm13,%ymm2
    2c34:	c4 e2 15 b8 64 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm13,%ymm4
    2c3b:	c4 62 15 b8 4c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm13,%ymm9
    2c42:	c4 62 15 b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm13,%ymm8
    2c49:	01 00 00 
    2c4c:	c4 62 15 b8 94 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm13,%ymm10
    2c53:	01 00 00 
    2c56:	c4 e2 15 b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm13,%ymm6
    2c5d:	01 00 00 
    2c60:	c4 62 15 b8 9c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm13,%ymm11
    2c67:	02 00 00 
    2c6a:	c4 e2 15 b8 ac b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm13,%ymm5
    2c71:	02 00 00 
    2c74:	c4 62 15 b8 a4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm13,%ymm12
    2c7b:	03 00 00 
    2c7e:	c4 e2 15 b8 04 b1    	vfmadd231ps (%rcx,%rsi,4),%ymm13,%ymm0
    2c84:	c4 62 15 b8 b4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm13,%ymm14
    2c8b:	00 00 00 
    2c8e:	c4 62 15 b8 bc b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm13,%ymm15
    2c95:	00 00 00 
    2c98:	c4 e2 15 b8 8c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm13,%ymm1
    2c9f:	00 00 00 
    2ca2:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    2ca8:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    2cae:	c4 e2 15 b8 bc b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm13,%ymm7
    2cb5:	01 00 00 
    2cb8:	c5 fc 11 9c 24 80 01 	vmovups %ymm3,0x180(%rsp)
    2cbf:	00 00 
    2cc1:	c5 fc 10 9c 24 e0 00 	vmovups 0xe0(%rsp),%ymm3
    2cc8:	00 00 
    2cca:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm13,%ymm3
    2cd1:	01 00 00 
    2cd4:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    2cda:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    2ce0:	c4 e2 15 b8 bc b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm13,%ymm7
    2ce7:	01 00 00 
    2cea:	c5 fc 11 9c 24 e0 00 	vmovups %ymm3,0xe0(%rsp)
    2cf1:	00 00 
    2cf3:	c5 fc 10 9c 24 c0 00 	vmovups 0xc0(%rsp),%ymm3
    2cfa:	00 00 
    2cfc:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm13,%ymm3
    2d03:	01 00 00 
    2d06:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    2d0c:	c5 fc 28 fa          	vmovaps %ymm2,%ymm7
    2d10:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    2d16:	c5 fc 11 9c 24 c0 00 	vmovups %ymm3,0xc0(%rsp)
    2d1d:	00 00 
    2d1f:	c5 fc 10 9c 24 00 01 	vmovups 0x100(%rsp),%ymm3
    2d26:	00 00 
    2d28:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm13,%ymm3
    2d2f:	01 00 00 
    2d32:	c5 fc 11 9c 24 00 01 	vmovups %ymm3,0x100(%rsp)
    2d39:	00 00 
    2d3b:	c5 fc 10 9c 24 20 01 	vmovups 0x120(%rsp),%ymm3
    2d42:	00 00 
    2d44:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm13,%ymm3
    2d4b:	02 00 00 
    2d4e:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    2d55:	00 00 
    2d57:	c5 fc 10 5c 24 60    	vmovups 0x60(%rsp),%ymm3
    2d5d:	c4 e2 15 b8 9c b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm13,%ymm3
    2d64:	02 00 00 
    2d67:	c5 fc 11 5c 24 60    	vmovups %ymm3,0x60(%rsp)
    2d6d:	c5 fc 10 9c 24 80 00 	vmovups 0x80(%rsp),%ymm3
    2d74:	00 00 
    2d76:	c4 e2 15 b8 9c b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm13,%ymm3
    2d7d:	02 00 00 
    2d80:	c5 fc 11 9c 24 80 00 	vmovups %ymm3,0x80(%rsp)
    2d87:	00 00 
    2d89:	c5 fc 10 9c 24 a0 00 	vmovups 0xa0(%rsp),%ymm3
    2d90:	00 00 
    2d92:	c4 e2 15 b8 9c b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm13,%ymm3
    2d99:	02 00 00 
    2d9c:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    2da3:	00 00 
    2da5:	c5 fc 10 1c 24       	vmovups (%rsp),%ymm3
    2daa:	c4 e2 15 b8 9c b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm13,%ymm3
    2db1:	02 00 00 
    2db4:	c5 fc 11 1c 24       	vmovups %ymm3,(%rsp)
    2db9:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    2dbf:	c4 e2 15 b8 9c b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm13,%ymm3
    2dc6:	02 00 00 
    2dc9:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    2dcf:	c5 fc 10 5c 24 40    	vmovups 0x40(%rsp),%ymm3
    2dd5:	c4 e2 15 b8 9c b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm13,%ymm3
    2ddc:	03 00 00 
    2ddf:	c5 fc 11 5c 24 40    	vmovups %ymm3,0x40(%rsp)
    2de5:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    2deb:	c4 e2 15 b8 9c b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm13,%ymm3
    2df2:	03 00 00 
    2df5:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    2dfb:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    2e01:	c4 e2 15 b8 9c b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm13,%ymm3
    2e08:	03 00 00 
    2e0b:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    2e11:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    2e15:	c5 7c 29 c4          	vmovaps %ymm8,%ymm4
    2e19:	c4 41 7c 28 c3       	vmovaps %ymm11,%ymm8
    2e1e:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    2e23:	c4 41 7c 28 e1       	vmovaps %ymm9,%ymm12
    2e28:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    2e2d:	c5 7c 28 d5          	vmovaps %ymm5,%ymm10
    2e31:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    2e35:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    2e3b:	4c 39 c3             	cmp    %r8,%rbx
    2e3e:	0f 8c 6c d7 ff ff    	jl     5b0 <_Z5benchv+0x460>
    2e44:	e9 c2 d3 ff ff       	jmpq   20b <_Z5benchv+0xbb>
    2e49:	0f 31                	rdtsc  
    2e4b:	48 c1 e2 20          	shl    $0x20,%rdx
    2e4f:	48 09 c2             	or     %rax,%rdx
    2e52:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2e58 <_Z5benchv+0x2d08>
    2e58:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2e5d:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2e65 <_Z5benchv+0x2d15>
    2e64:	00 
    2e65:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2e6d <_Z5benchv+0x2d1d>
    2e6c:	00 
    2e6d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2e74 <_Z5benchv+0x2d24>
    2e74:	01 c0                	add    %eax,%eax
    2e76:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2e7c:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    2e80:	c5 fb 5c 84 24 58 01 	vsubsd 0x158(%rsp),%xmm0,%xmm0
    2e87:	00 00 
    2e89:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    2e8e:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    2e92:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2e96:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2e9a:	48 81 c4 68 02 00 00 	add    $0x268,%rsp
    2ea1:	5b                   	pop    %rbx
    2ea2:	41 5e                	pop    %r14
    2ea4:	c5 f8 77             	vzeroupper 
    2ea7:	c3                   	retq   
    2ea8:	90                   	nop
    2ea9:	90                   	nop
    2eaa:	90                   	nop
...
0000000000002ec0 <_Z9n_reg_maxv>:
    2ec0:	b8 7d 02 00 00       	mov    $0x27d,%eax
    2ec5:	c3                   	retq   

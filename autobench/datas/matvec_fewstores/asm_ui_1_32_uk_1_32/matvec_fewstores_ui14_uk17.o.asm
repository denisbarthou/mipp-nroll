...
0000000000000150 <_Z5benchv>:
 ...
 182:	0f 8e f9 0a 00 00    	jle    c81 <_Z5benchv+0xb31>
 ...
 235:	0f 83 46 0a 00 00    	jae    c81 <_Z5benchv+0xb31>
 ...
 be9:	48 83 c6 11          	add    $0x11,%rsi
 bed:	49 0f af c3          	imul   %r11,%rax
 bf1:	48 01 f8             	add    %rdi,%rax
 bf4:	c4 e2 05 b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm15,%ymm1
 bfa:	c4 e2 05 b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm15,%ymm7
 c01:	c4 e2 05 b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm15,%ymm2
 c08:	c4 e2 05 b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm15,%ymm3
 c0f:	c4 e2 05 b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm15,%ymm4
 c16:	00 00 00 
 c19:	c4 e2 05 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm15,%ymm5
 c20:	00 00 00 
 c23:	c4 e2 05 b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm15,%ymm6
 c2a:	00 00 00 
 c2d:	c4 62 05 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm15,%ymm8
 c34:	00 00 00 
 c37:	c4 62 05 b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm15,%ymm9
 c3e:	01 00 00 
 c41:	c4 62 05 b8 94 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm15,%ymm10
 c48:	01 00 00 
 c4b:	c4 62 05 b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm15,%ymm11
 c52:	01 00 00 
 c55:	c4 62 05 b8 a4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm15,%ymm12
 c5c:	01 00 00 
 c5f:	c4 62 05 b8 ac 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm15,%ymm13
 c66:	01 00 00 
 c69:	c4 62 05 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm15,%ymm14
 c70:	01 00 00 
 c73:	4c 39 c6             	cmp    %r8,%rsi
 c76:	0f 8c 54 f6 ff ff    	jl     2d0 <_Z5benchv+0x180>
 c7c:	e9 2f f5 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 c81:	0f 31                	rdtsc  
 c83:	48 c1 e2 20          	shl    $0x20,%rdx
 c87:	48 09 c2             	or     %rax,%rdx
 c8a:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # c90 <_Z5benchv+0xb40>
 c90:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 c95:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # c9d <_Z5benchv+0xb4d>
 c9c:	00 
 c9d:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # ca5 <_Z5benchv+0xb55>
 ca4:	00 
 ca5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # cac <_Z5benchv+0xb5c>
 cac:	01 c0                	add    %eax,%eax
 cae:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 cb4:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 cb8:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 cbc:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
 cc1:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
...
0000000000000cf0 <_Z9n_reg_maxv>:
 cf0:	b8 0d 01 00 00       	mov    $0x10d,%eax
 cf5:	c3                   	retq   

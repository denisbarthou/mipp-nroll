...
matvec_fewstores_ui16_uk29.o:     file format elf64-x86-64
...
0000000000000140 <_Z5benchv>:
     ...
     184:	0f 8e f3 17 00 00    	jle    197d <_Z5benchv+0x183d>
     ...
     285:	0f 83 f2 16 00 00    	jae    197d <_Z5benchv+0x183d>
    ...
    18b3:	49 83 c5 1d          	add    $0x1d,%r13
    18b7:	48 0f af d8          	imul   %rax,%rbx
    18bb:	48 01 fb             	add    %rdi,%rbx
    18be:	c4 e2 75 b8 5c 99 20 	vfmadd231ps 0x20(%rcx,%rbx,4),%ymm1,%ymm3
    18c5:	c4 e2 75 b8 64 99 40 	vfmadd231ps 0x40(%rcx,%rbx,4),%ymm1,%ymm4
    18cc:	c4 e2 75 b8 6c 99 60 	vfmadd231ps 0x60(%rcx,%rbx,4),%ymm1,%ymm5
    18d3:	c4 e2 75 b8 b4 99 80 	vfmadd231ps 0x80(%rcx,%rbx,4),%ymm1,%ymm6
    18da:	00 00 00 
    18dd:	c4 e2 75 b8 bc 99 a0 	vfmadd231ps 0xa0(%rcx,%rbx,4),%ymm1,%ymm7
    18e4:	00 00 00 
    18e7:	c4 62 75 b8 84 99 c0 	vfmadd231ps 0xc0(%rcx,%rbx,4),%ymm1,%ymm8
    18ee:	00 00 00 
    18f1:	c4 62 75 b8 8c 99 e0 	vfmadd231ps 0xe0(%rcx,%rbx,4),%ymm1,%ymm9
    18f8:	00 00 00 
    18fb:	c4 62 75 b8 94 99 00 	vfmadd231ps 0x100(%rcx,%rbx,4),%ymm1,%ymm10
    1902:	01 00 00 
    1905:	c4 62 75 b8 9c 99 20 	vfmadd231ps 0x120(%rcx,%rbx,4),%ymm1,%ymm11
    190c:	01 00 00 
    190f:	c4 62 75 b8 a4 99 40 	vfmadd231ps 0x140(%rcx,%rbx,4),%ymm1,%ymm12
    1916:	01 00 00 
    1919:	c4 62 75 b8 ac 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm13
    1920:	01 00 00 
    1923:	c4 62 75 b8 b4 99 a0 	vfmadd231ps 0x1a0(%rcx,%rbx,4),%ymm1,%ymm14
    192a:	01 00 00 
    192d:	c4 62 75 b8 bc 99 c0 	vfmadd231ps 0x1c0(%rcx,%rbx,4),%ymm1,%ymm15
    1934:	01 00 00 
    1937:	c4 e2 75 b8 84 99 e0 	vfmadd231ps 0x1e0(%rcx,%rbx,4),%ymm1,%ymm0
    193e:	01 00 00 
    1941:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    1947:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    194d:	c4 e2 75 b8 14 99    	vfmadd231ps (%rcx,%rbx,4),%ymm1,%ymm2
    1953:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    1959:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    195f:	c4 e2 75 b8 94 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm2
    1966:	01 00 00 
    1969:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    196f:	49 39 ed             	cmp    %rbp,%r13
    1972:	0f 8c 88 ea ff ff    	jl     400 <_Z5benchv+0x2c0>
    1978:	e9 5a e8 ff ff       	jmpq   1d7 <_Z5benchv+0x97>
    197d:	0f 31                	rdtsc  
    197f:	48 c1 e2 20          	shl    $0x20,%rdx
    1983:	48 09 c2             	or     %rax,%rdx
    1986:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 198c <_Z5benchv+0x184c>
    198c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1991:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1999 <_Z5benchv+0x1859>
    1998:	00 
    1999:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 19a1 <_Z5benchv+0x1861>
    19a0:	00 
    19a1:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 19a8 <_Z5benchv+0x1868>
    19a8:	01 c0                	add    %eax,%eax
    19aa:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    19b0:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    19b4:	c5 fb 5c 44 24 e8    	vsubsd -0x18(%rsp),%xmm0,%xmm0
    19ba:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    19be:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    19c2:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    19c6:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    19ca:	48 83 c4 48          	add    $0x48,%rsp
    19ce:	5b                   	pop    %rbx
    19cf:	41 5c                	pop    %r12
    19d1:	41 5d                	pop    %r13
    19d3:	41 5e                	pop    %r14
...
00000000000019f0 <_Z9n_reg_maxv>:
    19f0:	b8 fd 01 00 00       	mov    $0x1fd,%eax
    19f5:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui16_uk29.cpp+0x9a>
  96:	01 00 00 00 

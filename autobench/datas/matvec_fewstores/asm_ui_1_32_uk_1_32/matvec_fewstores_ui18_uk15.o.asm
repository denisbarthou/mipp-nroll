...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e 84 10 00 00    	jle    1219 <_Z5benchv+0x10c9>
     ...
     2aa:	0f 83 69 0f 00 00    	jae    1219 <_Z5benchv+0x10c9>
     ...
     d7a:	00 00 00 
     d7d:	c4 62 65 b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm12
     d84:	01 00 00 
     d87:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
     d8e:	01 00 00 
     d91:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
     d98:	01 00 00 
     d9b:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
     da2:	01 00 00 
     da5:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
     dac:	01 00 00 
     daf:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
     db6:	02 00 00 
     db9:	c4 62 65 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm10
     dc0:	02 00 00 
     dc3:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     dc9:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
     dcf:	c4 e2 65 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm0
     dd6:	00 00 00 
     dd9:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
     ddf:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
     de5:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
     dec:	01 00 00 
     def:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     df5:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
     dfb:	c4 e2 65 b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm0
     e02:	01 00 00 
     e05:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
     e0b:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     e11:	c4 e2 65 b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm0
     e18:	01 00 00 
     e1b:	48 8d 46 0b          	lea    0xb(%rsi),%rax
     e1f:	c4 e2 7d 18 5c b2 2c 	vbroadcastss 0x2c(%rdx,%rsi,4),%ymm3
     e26:	49 0f af c3          	imul   %r11,%rax
     e2a:	48 01 f8             	add    %rdi,%rax
     e2d:	c4 e2 65 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm3,%ymm4
     e33:	c4 e2 65 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm3,%ymm1
     e3a:	c4 e2 65 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm3,%ymm5
     e41:	c4 e2 65 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm3,%ymm6
     e48:	c4 62 65 b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm3,%ymm8
     e4f:	00 00 00 
     e52:	c4 e2 65 b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm3,%ymm7
     e59:	00 00 00 
     e5c:	c4 62 65 b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm3,%ymm9
     e63:	00 00 00 
     e66:	c4 62 65 b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm12
     e6d:	01 00 00 
     e70:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
     e77:	01 00 00 
     e7a:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
     e81:	01 00 00 
     e84:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
     e8b:	01 00 00 
     e8e:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
     e95:	01 00 00 
     e98:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
     e9f:	02 00 00 
     ea2:	c4 62 65 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm10
     ea9:	02 00 00 
     eac:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     eb2:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
     eb8:	c4 e2 65 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm0
     ebf:	00 00 00 
     ec2:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
     ec8:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
     ece:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
     ed5:	01 00 00 
     ed8:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     ede:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
     ee4:	c4 e2 65 b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm0
     eeb:	01 00 00 
     eee:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
     ef4:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     efa:	c4 e2 65 b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm0
     f01:	01 00 00 
     f04:	48 8d 46 0c          	lea    0xc(%rsi),%rax
     f08:	c4 e2 7d 18 5c b2 30 	vbroadcastss 0x30(%rdx,%rsi,4),%ymm3
     f0f:	49 0f af c3          	imul   %r11,%rax
     f13:	48 01 f8             	add    %rdi,%rax
     f16:	c4 e2 65 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm3,%ymm4
     f1c:	c4 e2 65 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm3,%ymm1
     f23:	c4 e2 65 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm3,%ymm5
     f2a:	c4 e2 65 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm3,%ymm6
     f31:	c4 62 65 b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm3,%ymm8
     f38:	00 00 00 
     f3b:	c4 e2 65 b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm3,%ymm7
     f42:	00 00 00 
     f45:	c4 62 65 b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm3,%ymm9
     f4c:	00 00 00 
     f4f:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
     f56:	01 00 00 
     f59:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
     f60:	01 00 00 
     f63:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
     f6a:	01 00 00 
     f6d:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
     f74:	01 00 00 
     f77:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
     f7e:	02 00 00 
     f81:	c4 62 65 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm10
     f88:	02 00 00 
     f8b:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
     f91:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
     f97:	c4 e2 65 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm0
     f9e:	00 00 00 
     fa1:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
     fa7:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
     fad:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
     fb4:	01 00 00 
     fb7:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
     fbd:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
     fc3:	c4 e2 65 b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm0
     fca:	01 00 00 
     fcd:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
     fd3:	c5 7c 29 e0          	vmovaps %ymm12,%ymm0
     fd7:	c4 e2 65 b8 84 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm0
     fde:	01 00 00 
     fe1:	c5 7c 10 64 24 e0    	vmovups -0x20(%rsp),%ymm12
     fe7:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
     fec:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
     ff2:	c4 e2 65 b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm0
     ff9:	01 00 00 
     ffc:	48 8d 46 0d          	lea    0xd(%rsi),%rax
    1000:	c4 e2 7d 18 5c b2 34 	vbroadcastss 0x34(%rdx,%rsi,4),%ymm3
    1007:	49 0f af c3          	imul   %r11,%rax
    100b:	48 01 f8             	add    %rdi,%rax
    100e:	c4 62 65 b8 a4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm12
    1015:	01 00 00 
    1018:	c4 e2 65 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm3,%ymm4
    101e:	c4 e2 65 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm3,%ymm1
    1025:	c4 e2 65 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm3,%ymm5
    102c:	c4 e2 65 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm3,%ymm6
    1033:	c4 62 65 b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm3,%ymm8
    103a:	00 00 00 
    103d:	c4 e2 65 b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm3,%ymm7
    1044:	00 00 00 
    1047:	c4 62 65 b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm3,%ymm9
    104e:	00 00 00 
    1051:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
    1058:	01 00 00 
    105b:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
    1062:	01 00 00 
    1065:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
    106c:	01 00 00 
    106f:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
    1076:	01 00 00 
    1079:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
    1080:	02 00 00 
    1083:	c4 62 65 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm10
    108a:	02 00 00 
    108d:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    1093:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    1099:	c4 e2 65 b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm0
    10a0:	00 00 00 
    10a3:	c5 7c 11 64 24 e0    	vmovups %ymm12,-0x20(%rsp)
    10a9:	c5 7c 10 24 24       	vmovups (%rsp),%ymm12
    10ae:	c4 62 65 b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm12
    10b5:	01 00 00 
    10b8:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    10be:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    10c4:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
    10cb:	01 00 00 
    10ce:	c5 7c 11 24 24       	vmovups %ymm12,(%rsp)
    10d3:	c5 7c 10 64 24 c0    	vmovups -0x40(%rsp),%ymm12
    10d9:	c4 62 65 b8 a4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm12
    10e0:	01 00 00 
    10e3:	48 8d 46 0e          	lea    0xe(%rsi),%rax
    10e7:	c4 e2 7d 18 5c b2 38 	vbroadcastss 0x38(%rdx,%rsi,4),%ymm3
    10ee:	48 83 c6 0f          	add    $0xf,%rsi
    10f2:	49 0f af c3          	imul   %r11,%rax
    10f6:	48 01 f8             	add    %rdi,%rax
    10f9:	c4 e2 65 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm3,%ymm1
    1100:	c4 e2 65 b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm3,%ymm0
    1107:	01 00 00 
    110a:	c4 e2 65 b8 24 81    	vfmadd231ps (%rcx,%rax,4),%ymm3,%ymm4
    1110:	c4 e2 65 b8 6c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm3,%ymm5
    1117:	c4 e2 65 b8 74 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm3,%ymm6
    111e:	c4 62 65 b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm3,%ymm8
    1125:	00 00 00 
    1128:	c4 e2 65 b8 bc 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm3,%ymm7
    112f:	00 00 00 
    1132:	c4 62 65 b8 8c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm3,%ymm9
    1139:	00 00 00 
    113c:	c4 62 65 b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm3,%ymm14
    1143:	01 00 00 
    1146:	c4 62 65 b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm3,%ymm13
    114d:	01 00 00 
    1150:	c4 62 65 b8 bc 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm3,%ymm15
    1157:	02 00 00 
    115a:	c4 62 65 b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm3,%ymm11
    1161:	01 00 00 
    1164:	c4 e2 65 b8 94 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm3,%ymm2
    116b:	01 00 00 
    116e:	c4 62 65 b8 94 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm3,%ymm10
    1175:	02 00 00 
    1178:	c5 7c 11 64 24 c0    	vmovups %ymm12,-0x40(%rsp)
    117e:	c5 7c 10 64 24 c0    	vmovups -0x40(%rsp),%ymm12
    1184:	c4 62 65 b8 a4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm3,%ymm12
    118b:	01 00 00 
    118e:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    1195:	00 00 
    1197:	c5 fc 10 4c 24 80    	vmovups -0x80(%rsp),%ymm1
    119d:	c4 e2 65 b8 8c 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm3,%ymm1
    11a4:	00 00 00 
    11a7:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    11ad:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    11b2:	c4 e2 65 b8 84 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm3,%ymm0
    11b9:	01 00 00 
    11bc:	c5 7c 11 74 24 60    	vmovups %ymm14,0x60(%rsp)
    11c2:	c5 7c 11 6c 24 20    	vmovups %ymm13,0x20(%rsp)
    11c8:	c5 7c 11 bc 24 a0 00 	vmovups %ymm15,0xa0(%rsp)
    11cf:	00 00 
    11d1:	c5 7c 11 64 24 c0    	vmovups %ymm12,-0x40(%rsp)
    11d7:	c5 fc 11 4c 24 80    	vmovups %ymm1,-0x80(%rsp)
    11dd:	c5 fc 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm1
    11e3:	c4 e2 65 b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm3,%ymm1
    11ea:	01 00 00 
    11ed:	c5 fc 28 dc          	vmovaps %ymm4,%ymm3
    11f1:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    11f5:	c5 fc 28 ee          	vmovaps %ymm6,%ymm5
    11f9:	c5 fc 28 f7          	vmovaps %ymm7,%ymm6
    11fd:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    1201:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    1206:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    120b:	4c 39 c6             	cmp    %r8,%rsi
    120e:	0f 8c 9c f1 ff ff    	jl     3b0 <_Z5benchv+0x260>
    1214:	e9 ac ef ff ff       	jmpq   1c5 <_Z5benchv+0x75>
    1219:	0f 31                	rdtsc  
    ...
    1250:	c5 fb 5c 44 24 58    	vsubsd 0x58(%rsp),%xmm0,%xmm0
    1256:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    125b:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    125f:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1263:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1267:	48 81 c4 d8 00 00 00 	add    $0xd8,%rsp
    126e:	c5 f8 77             	vzeroupper 
    1271:	c3                   	retq   
    1272:	90                   	nop
    1273:	90                   	nop
    1274:	90                   	nop
...
0000000000001290 <_Z9n_reg_maxv>:
    1290:	b8 2f 01 00 00       	mov    $0x12f,%eax
    1295:	c3                   	retq   

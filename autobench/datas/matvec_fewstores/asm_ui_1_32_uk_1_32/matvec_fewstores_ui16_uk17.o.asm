...
0000000000000140 <_Z5benchv>:
     ...
     184:	0f 8e 27 0f 00 00    	jle    10b1 <_Z5benchv+0xf71>
     ...
     28a:	0f 83 21 0e 00 00    	jae    10b1 <_Z5benchv+0xf71>
     ...
     fe7:	49 83 c5 11          	add    $0x11,%r13
     feb:	48 0f af d8          	imul   %rax,%rbx
     fef:	48 01 fb             	add    %rdi,%rbx
     ff2:	c4 e2 75 b8 5c 99 20 	vfmadd231ps 0x20(%rcx,%rbx,4),%ymm1,%ymm3
     ff9:	c4 e2 75 b8 64 99 40 	vfmadd231ps 0x40(%rcx,%rbx,4),%ymm1,%ymm4
    1000:	c4 e2 75 b8 6c 99 60 	vfmadd231ps 0x60(%rcx,%rbx,4),%ymm1,%ymm5
    1007:	c4 e2 75 b8 b4 99 80 	vfmadd231ps 0x80(%rcx,%rbx,4),%ymm1,%ymm6
    100e:	00 00 00 
    1011:	c4 e2 75 b8 bc 99 a0 	vfmadd231ps 0xa0(%rcx,%rbx,4),%ymm1,%ymm7
    1018:	00 00 00 
    101b:	c4 62 75 b8 84 99 c0 	vfmadd231ps 0xc0(%rcx,%rbx,4),%ymm1,%ymm8
    1022:	00 00 00 
    1025:	c4 62 75 b8 8c 99 e0 	vfmadd231ps 0xe0(%rcx,%rbx,4),%ymm1,%ymm9
    102c:	00 00 00 
    102f:	c4 62 75 b8 94 99 00 	vfmadd231ps 0x100(%rcx,%rbx,4),%ymm1,%ymm10
    1036:	01 00 00 
    1039:	c4 62 75 b8 9c 99 20 	vfmadd231ps 0x120(%rcx,%rbx,4),%ymm1,%ymm11
    1040:	01 00 00 
    1043:	c4 62 75 b8 a4 99 40 	vfmadd231ps 0x140(%rcx,%rbx,4),%ymm1,%ymm12
    104a:	01 00 00 
    104d:	c4 62 75 b8 ac 99 80 	vfmadd231ps 0x180(%rcx,%rbx,4),%ymm1,%ymm13
    1054:	01 00 00 
    1057:	c4 62 75 b8 b4 99 a0 	vfmadd231ps 0x1a0(%rcx,%rbx,4),%ymm1,%ymm14
    105e:	01 00 00 
    1061:	c4 62 75 b8 bc 99 c0 	vfmadd231ps 0x1c0(%rcx,%rbx,4),%ymm1,%ymm15
    1068:	01 00 00 
    106b:	c4 e2 75 b8 84 99 e0 	vfmadd231ps 0x1e0(%rcx,%rbx,4),%ymm1,%ymm0
    1072:	01 00 00 
    1075:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    107b:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    1081:	c4 e2 75 b8 14 99    	vfmadd231ps (%rcx,%rbx,4),%ymm1,%ymm2
    1087:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    108d:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    1093:	c4 e2 75 b8 94 99 60 	vfmadd231ps 0x160(%rcx,%rbx,4),%ymm1,%ymm2
    109a:	01 00 00 
    109d:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    10a3:	49 39 ed             	cmp    %rbp,%r13
    10a6:	0f 8c 64 f3 ff ff    	jl     410 <_Z5benchv+0x2d0>
    10ac:	e9 2b f1 ff ff       	jmpq   1dc <_Z5benchv+0x9c>
    10b1:	0f 31                	rdtsc  
    10b3:	48 c1 e2 20          	shl    $0x20,%rdx
    10b7:	48 09 c2             	or     %rax,%rdx
    10ba:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 10c0 <_Z5benchv+0xf80>
    10c0:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    10c5:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 10cd <_Z5benchv+0xf8d>
    10cc:	00 
    10cd:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 10d5 <_Z5benchv+0xf95>
    10d4:	00 
    10d5:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 10dc <_Z5benchv+0xf9c>
    10dc:	01 c0                	add    %eax,%eax
    10de:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    10e4:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    10e8:	c5 fb 5c 44 24 e8    	vsubsd -0x18(%rsp),%xmm0,%xmm0
    10ee:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    10f2:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    10f6:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    10fa:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    10fe:	48 83 c4 48          	add    $0x48,%rsp
    1102:	5b                   	pop    %rbx
    1103:	41 5c                	pop    %r12
    1105:	41 5d                	pop    %r13
    1107:	41 5e                	pop    %r14
...
0000000000001120 <_Z9n_reg_maxv>:
    1120:	b8 31 01 00 00       	mov    $0x131,%eax
    1125:	c3                   	retq   

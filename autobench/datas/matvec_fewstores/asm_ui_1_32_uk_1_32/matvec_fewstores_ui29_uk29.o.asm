...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e fc 3e 00 00    	jle    4094 <_Z5benchv+0x3f44>
     ...
     37a:	0f 83 14 3d 00 00    	jae    4094 <_Z5benchv+0x3f44>
    ...
    3e49:	48 83 c6 1d          	add    $0x1d,%rsi
    3e4d:	49 0f af c2          	imul   %r10,%rax
    3e51:	48 01 f8             	add    %rdi,%rax
    3e54:	c4 e2 0d b8 84 81 80 	vfmadd231ps 0x380(%rcx,%rax,4),%ymm14,%ymm0
    3e5b:	03 00 00 
    3e5e:	c4 62 0d b8 3c 81    	vfmadd231ps (%rcx,%rax,4),%ymm14,%ymm15
    3e64:	c4 e2 0d b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm14,%ymm5
    3e6b:	00 00 00 
    3e6e:	c4 e2 0d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm14,%ymm7
    3e75:	00 00 00 
    3e78:	c4 62 0d b8 9c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm14,%ymm11
    3e7f:	01 00 00 
    3e82:	c4 62 0d b8 84 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm14,%ymm8
    3e89:	01 00 00 
    3e8c:	c4 62 0d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm14,%ymm12
    3e93:	02 00 00 
    3e96:	c4 62 0d b8 ac 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm14,%ymm13
    3e9d:	03 00 00 
    3ea0:	c4 e2 0d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm14,%ymm1
    3ea7:	c4 e2 0d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm14,%ymm2
    3eae:	c4 e2 0d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm14,%ymm3
    3eb5:	c4 e2 0d b8 a4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm14,%ymm4
    3ebc:	00 00 00 
    3ebf:	c4 e2 0d b8 b4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm14,%ymm6
    3ec6:	00 00 00 
    3ec9:	c4 62 0d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm14,%ymm10
    3ed0:	02 00 00 
    3ed3:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    3ed9:	c5 7c 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm9
    3edf:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm14,%ymm9
    3ee6:	01 00 00 
    3ee9:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    3ef0:	00 00 
    3ef2:	c5 7c 29 f8          	vmovaps %ymm15,%ymm0
    3ef6:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    3efa:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    3efe:	c5 7c 11 4c 24 a0    	vmovups %ymm9,-0x60(%rsp)
    3f04:	c5 7c 10 8c 24 20 01 	vmovups 0x120(%rsp),%ymm9
    3f0b:	00 00 
    3f0d:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm14,%ymm9
    3f14:	01 00 00 
    3f17:	c5 7c 11 8c 24 20 01 	vmovups %ymm9,0x120(%rsp)
    3f1e:	00 00 
    3f20:	c5 7c 10 8c 24 e0 00 	vmovups 0xe0(%rsp),%ymm9
    3f27:	00 00 
    3f29:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm14,%ymm9
    3f30:	01 00 00 
    3f33:	c5 7c 11 8c 24 e0 00 	vmovups %ymm9,0xe0(%rsp)
    3f3a:	00 00 
    3f3c:	c5 7c 10 8c 24 a0 00 	vmovups 0xa0(%rsp),%ymm9
    3f43:	00 00 
    3f45:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm14,%ymm9
    3f4c:	01 00 00 
    3f4f:	c5 7c 11 8c 24 a0 00 	vmovups %ymm9,0xa0(%rsp)
    3f56:	00 00 
    3f58:	c5 7c 10 8c 24 00 01 	vmovups 0x100(%rsp),%ymm9
    3f5f:	00 00 
    3f61:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm14,%ymm9
    3f68:	01 00 00 
    3f6b:	c5 7c 11 8c 24 00 01 	vmovups %ymm9,0x100(%rsp)
    3f72:	00 00 
    3f74:	c5 7c 10 8c 24 c0 00 	vmovups 0xc0(%rsp),%ymm9
    3f7b:	00 00 
    3f7d:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm14,%ymm9
    3f84:	01 00 00 
    3f87:	c5 7c 11 8c 24 c0 00 	vmovups %ymm9,0xc0(%rsp)
    3f8e:	00 00 
    3f90:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    3f96:	c4 62 0d b8 8c 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm14,%ymm9
    3f9d:	02 00 00 
    3fa0:	c5 7c 11 4c 24 c0    	vmovups %ymm9,-0x40(%rsp)
    3fa6:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    3fac:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm14,%ymm9
    3fb3:	02 00 00 
    3fb6:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    3fbc:	c5 7c 11 4c 24 80    	vmovups %ymm9,-0x80(%rsp)
    3fc2:	c5 7c 10 8c 24 40 01 	vmovups 0x140(%rsp),%ymm9
    3fc9:	00 00 
    3fcb:	c4 62 0d b8 8c 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm14,%ymm9
    3fd2:	02 00 00 
    3fd5:	c5 7c 11 8c 24 40 01 	vmovups %ymm9,0x140(%rsp)
    3fdc:	00 00 
    3fde:	c5 7c 10 4c 24 60    	vmovups 0x60(%rsp),%ymm9
    3fe4:	c4 62 0d b8 8c 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm14,%ymm9
    3feb:	02 00 00 
    3fee:	c5 7c 11 4c 24 60    	vmovups %ymm9,0x60(%rsp)
    3ff4:	c5 7c 10 4c 24 40    	vmovups 0x40(%rsp),%ymm9
    3ffa:	c4 62 0d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm14,%ymm9
    4001:	02 00 00 
    4004:	c5 7c 11 4c 24 40    	vmovups %ymm9,0x40(%rsp)
    400a:	c5 7c 10 8c 24 80 00 	vmovups 0x80(%rsp),%ymm9
    4011:	00 00 
    4013:	c4 62 0d b8 8c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm14,%ymm9
    401a:	02 00 00 
    401d:	c5 7c 11 8c 24 80 00 	vmovups %ymm9,0x80(%rsp)
    4024:	00 00 
    4026:	c5 7c 10 4c 24 20    	vmovups 0x20(%rsp),%ymm9
    402c:	c4 62 0d b8 8c 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm14,%ymm9
    4033:	03 00 00 
    4036:	c5 7c 11 4c 24 20    	vmovups %ymm9,0x20(%rsp)
    403c:	c5 7c 10 0c 24       	vmovups (%rsp),%ymm9
    4041:	c4 62 0d b8 8c 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm14,%ymm9
    4048:	03 00 00 
    404b:	c5 7c 11 0c 24       	vmovups %ymm9,(%rsp)
    4050:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    4056:	c4 62 0d b8 8c 81 60 	vfmadd231ps 0x360(%rcx,%rax,4),%ymm14,%ymm9
    405d:	03 00 00 
    4060:	c4 41 7c 28 f5       	vmovaps %ymm13,%ymm14
    4065:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    406a:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    406f:	c4 41 7c 28 e0       	vmovaps %ymm8,%ymm12
    4074:	c5 7c 10 44 24 a0    	vmovups -0x60(%rsp),%ymm8
    407a:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    4080:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    4086:	4c 39 c6             	cmp    %r8,%rsi
    4089:	0f 8c f1 c4 ff ff    	jl     580 <_Z5benchv+0x430>
    408f:	e9 62 c1 ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    4094:	0f 31                	rdtsc  
    4096:	48 c1 e2 20          	shl    $0x20,%rdx
    409a:	48 09 c2             	or     %rax,%rdx
    409d:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 40a3 <_Z5benchv+0x3f53>
    40a3:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    40a8:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 40b0 <_Z5benchv+0x3f60>
    40af:	00 
    40b0:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 40b8 <_Z5benchv+0x3f68>
    40b7:	00 
    40b8:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 40bf <_Z5benchv+0x3f6f>
    40bf:	01 c0                	add    %eax,%eax
    40c1:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    40c7:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    40cb:	c5 fb 5c 84 24 78 01 	vsubsd 0x178(%rsp),%xmm0,%xmm0
    40d2:	00 00 
    40d4:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    40d8:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    40dc:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    40e0:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    40e4:	48 81 c4 38 02 00 00 	add    $0x238,%rsp
    40eb:	c5 f8 77             	vzeroupper 
    40ee:	c3                   	retq   
    40ef:	90                   	nop
...
0000000000004100 <_Z9n_reg_maxv>:
    4100:	b8 83 03 00 00       	mov    $0x383,%eax
    4105:	c3                   	retq   

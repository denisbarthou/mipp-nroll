...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 96 1d 00 00    	jle    1f2e <_Z5benchv+0x1dde>
     ...
     36f:	0f 83 b9 1b 00 00    	jae    1f2e <_Z5benchv+0x1dde>
    ...
    1d1e:	48 83 c0 0e          	add    $0xe,%rax
    1d22:	49 0f af f2          	imul   %r10,%rsi
    1d26:	48 01 fe             	add    %rdi,%rsi
    1d29:	c4 e2 1d b8 94 b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm12,%ymm2
    1d30:	00 00 00 
    1d33:	c4 e2 1d b8 9c b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm12,%ymm3
    1d3a:	00 00 00 
    1d3d:	c4 e2 1d b8 bc b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm12,%ymm7
    1d44:	00 00 00 
    1d47:	c4 62 1d b8 84 b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm12,%ymm8
    1d4e:	01 00 00 
    1d51:	c4 e2 1d b8 a4 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm12,%ymm4
    1d58:	01 00 00 
    1d5b:	c4 e2 1d b8 ac b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm12,%ymm5
    1d62:	01 00 00 
    1d65:	c4 62 1d b8 94 b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm12,%ymm10
    1d6c:	01 00 00 
    1d6f:	c4 62 1d b8 8c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm12,%ymm9
    1d76:	02 00 00 
    1d79:	c4 62 1d b8 9c b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm12,%ymm11
    1d80:	03 00 00 
    1d83:	c4 62 1d b8 2c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm12,%ymm13
    1d89:	c4 62 1d b8 74 b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm12,%ymm14
    1d90:	c4 62 1d b8 7c b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm12,%ymm15
    1d97:	c4 e2 1d b8 44 b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm12,%ymm0
    1d9e:	c4 e2 1d b8 8c b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm12,%ymm1
    1da5:	00 00 00 
    1da8:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    1dae:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    1db4:	c4 e2 1d b8 b4 b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm12,%ymm6
    1dbb:	01 00 00 
    1dbe:	c5 fc 11 94 24 60 01 	vmovups %ymm2,0x160(%rsp)
    1dc5:	00 00 
    1dc7:	c5 fc 10 94 24 e0 00 	vmovups 0xe0(%rsp),%ymm2
    1dce:	00 00 
    1dd0:	c4 e2 1d b8 94 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm12,%ymm2
    1dd7:	01 00 00 
    1dda:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    1de0:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    1de6:	c4 e2 1d b8 b4 b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm12,%ymm6
    1ded:	01 00 00 
    1df0:	c5 fc 11 94 24 e0 00 	vmovups %ymm2,0xe0(%rsp)
    1df7:	00 00 
    1df9:	c5 fc 10 94 24 c0 00 	vmovups 0xc0(%rsp),%ymm2
    1e00:	00 00 
    1e02:	c4 e2 1d b8 94 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm12,%ymm2
    1e09:	01 00 00 
    1e0c:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    1e12:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    1e18:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    1e1f:	00 00 
    1e21:	c5 fc 10 94 24 00 01 	vmovups 0x100(%rsp),%ymm2
    1e28:	00 00 
    1e2a:	c4 e2 1d b8 94 b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm12,%ymm2
    1e31:	02 00 00 
    1e34:	c5 fc 11 94 24 00 01 	vmovups %ymm2,0x100(%rsp)
    1e3b:	00 00 
    1e3d:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    1e43:	c4 e2 1d b8 94 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm12,%ymm2
    1e4a:	02 00 00 
    1e4d:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    1e53:	c5 fc 10 94 24 80 00 	vmovups 0x80(%rsp),%ymm2
    1e5a:	00 00 
    1e5c:	c4 e2 1d b8 94 b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm12,%ymm2
    1e63:	02 00 00 
    1e66:	c5 fc 11 94 24 80 00 	vmovups %ymm2,0x80(%rsp)
    1e6d:	00 00 
    1e6f:	c5 fc 10 94 24 a0 00 	vmovups 0xa0(%rsp),%ymm2
    1e76:	00 00 
    1e78:	c4 e2 1d b8 94 b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm12,%ymm2
    1e7f:	02 00 00 
    1e82:	c5 fc 11 94 24 a0 00 	vmovups %ymm2,0xa0(%rsp)
    1e89:	00 00 
    1e8b:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    1e90:	c4 e2 1d b8 94 b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm12,%ymm2
    1e97:	02 00 00 
    1e9a:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    1e9f:	c5 fc 10 54 24 20    	vmovups 0x20(%rsp),%ymm2
    1ea5:	c4 e2 1d b8 94 b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm12,%ymm2
    1eac:	02 00 00 
    1eaf:	c5 fc 11 54 24 20    	vmovups %ymm2,0x20(%rsp)
    1eb5:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    1ebb:	c4 e2 1d b8 94 b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm12,%ymm2
    1ec2:	02 00 00 
    1ec5:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    1ecb:	c5 fc 10 54 24 c0    	vmovups -0x40(%rsp),%ymm2
    1ed1:	c4 e2 1d b8 94 b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm12,%ymm2
    1ed8:	03 00 00 
    1edb:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    1ee1:	c5 fc 10 54 24 e0    	vmovups -0x20(%rsp),%ymm2
    1ee7:	c4 e2 1d b8 94 b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm12,%ymm2
    1eee:	03 00 00 
    1ef1:	c5 fc 11 54 24 e0    	vmovups %ymm2,-0x20(%rsp)
    1ef7:	c5 fc 28 d3          	vmovaps %ymm3,%ymm2
    1efb:	c5 fc 28 df          	vmovaps %ymm7,%ymm3
    1eff:	c5 7c 29 d7          	vmovaps %ymm10,%ymm7
    1f03:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    1f08:	c4 41 7c 28 d8       	vmovaps %ymm8,%ymm11
    1f0d:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    1f12:	c5 7c 28 cc          	vmovaps %ymm4,%ymm9
    1f16:	c5 fc 28 e5          	vmovaps %ymm5,%ymm4
    1f1a:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1f20:	4c 39 c0             	cmp    %r8,%rax
    1f23:	0f 8c 47 e6 ff ff    	jl     570 <_Z5benchv+0x420>
    1f29:	e9 dd e2 ff ff       	jmpq   20b <_Z5benchv+0xbb>
    1f2e:	0f 31                	rdtsc  
    1f30:	48 c1 e2 20          	shl    $0x20,%rdx
    1f34:	48 09 c2             	or     %rax,%rdx
    1f37:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1f3d <_Z5benchv+0x1ded>
    1f3d:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1f42:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1f4a <_Z5benchv+0x1dfa>
    1f49:	00 
    1f4a:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1f52 <_Z5benchv+0x1e02>
    1f51:	00 
    1f52:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1f59 <_Z5benchv+0x1e09>
    1f59:	01 c0                	add    %eax,%eax
    1f5b:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1f61:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1f65:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    1f6c:	00 00 
    1f6e:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    1f73:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    1f77:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1f7b:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1f7f:	48 81 c4 58 02 00 00 	add    $0x258,%rsp
...
0000000000001fa0 <_Z9n_reg_maxv>:
    1fa0:	b8 a3 01 00 00       	mov    $0x1a3,%eax
    1fa5:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e ad 27 00 00    	jle    2945 <_Z5benchv+0x27f5>
     ...
     2ee:	0f 83 51 26 00 00    	jae    2945 <_Z5benchv+0x27f5>
    ...
    279b:	48 83 c6 1d          	add    $0x1d,%rsi
    279f:	49 0f af c3          	imul   %r11,%rax
    27a3:	48 01 f8             	add    %rdi,%rax
    27a6:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm7,%ymm3
    27ad:	01 00 00 
    27b0:	c4 62 45 b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm7,%ymm8
    27b6:	c4 e2 45 b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm7,%ymm1
    27bd:	c4 62 45 b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm7,%ymm9
    27c4:	c4 62 45 b8 54 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm7,%ymm10
    27cb:	c4 62 45 b8 9c 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm7,%ymm11
    27d2:	00 00 00 
    27d5:	c4 62 45 b8 ac 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm7,%ymm13
    27dc:	00 00 00 
    27df:	c4 62 45 b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm7,%ymm15
    27e6:	00 00 00 
    27e9:	c4 62 45 b8 a4 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm7,%ymm12
    27f0:	01 00 00 
    27f3:	c4 62 45 b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm7,%ymm14
    27fa:	01 00 00 
    27fd:	c4 e2 45 b8 84 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm7,%ymm0
    2804:	01 00 00 
    2807:	c4 e2 45 b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm7,%ymm4
    280e:	01 00 00 
    2811:	c4 e2 45 b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm7,%ymm6
    2818:	01 00 00 
    281b:	c4 e2 45 b8 ac 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm7,%ymm5
    2822:	02 00 00 
    2825:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    282b:	c5 fc 10 54 24 60    	vmovups 0x60(%rsp),%ymm2
    2831:	c4 e2 45 b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm7,%ymm2
    2838:	00 00 00 
    283b:	c5 fc 11 9c 24 20 01 	vmovups %ymm3,0x120(%rsp)
    2842:	00 00 
    2844:	c5 fc 10 5c 24 20    	vmovups 0x20(%rsp),%ymm3
    284a:	c4 e2 45 b8 9c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm7,%ymm3
    2851:	01 00 00 
    2854:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    285b:	00 00 
    285d:	c5 fc 11 a4 24 c0 00 	vmovups %ymm4,0xc0(%rsp)
    2864:	00 00 
    2866:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    286d:	00 00 
    286f:	c5 fc 11 ac 24 00 01 	vmovups %ymm5,0x100(%rsp)
    2876:	00 00 
    2878:	c5 fc 11 54 24 60    	vmovups %ymm2,0x60(%rsp)
    287e:	c5 fc 10 54 24 40    	vmovups 0x40(%rsp),%ymm2
    2884:	c4 e2 45 b8 94 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm7,%ymm2
    288b:	01 00 00 
    288e:	c5 fc 11 5c 24 20    	vmovups %ymm3,0x20(%rsp)
    2894:	c5 fc 10 5c 24 a0    	vmovups -0x60(%rsp),%ymm3
    289a:	c4 e2 45 b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm7,%ymm3
    28a1:	02 00 00 
    28a4:	c5 fc 11 54 24 40    	vmovups %ymm2,0x40(%rsp)
    28aa:	c5 fc 10 14 24       	vmovups (%rsp),%ymm2
    28af:	c4 e2 45 b8 94 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm7,%ymm2
    28b6:	02 00 00 
    28b9:	c5 fc 11 5c 24 a0    	vmovups %ymm3,-0x60(%rsp)
    28bf:	c5 fc 10 5c 24 e0    	vmovups -0x20(%rsp),%ymm3
    28c5:	c4 e2 45 b8 9c 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm7,%ymm3
    28cc:	02 00 00 
    28cf:	c5 fc 11 14 24       	vmovups %ymm2,(%rsp)
    28d4:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    28da:	c4 e2 45 b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm7,%ymm2
    28e1:	02 00 00 
    28e4:	c5 fc 11 5c 24 e0    	vmovups %ymm3,-0x20(%rsp)
    28ea:	c5 fc 11 54 24 80    	vmovups %ymm2,-0x80(%rsp)
    28f0:	c5 fc 10 54 24 c0    	vmovups -0x40(%rsp),%ymm2
    28f6:	c4 e2 45 b8 94 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm7,%ymm2
    28fd:	02 00 00 
    2900:	c5 7c 29 c7          	vmovaps %ymm8,%ymm7
    2904:	c4 41 7c 28 c1       	vmovaps %ymm9,%ymm8
    2909:	c4 41 7c 28 ca       	vmovaps %ymm10,%ymm9
    290e:	c4 41 7c 28 d3       	vmovaps %ymm11,%ymm10
    2913:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    2918:	c4 41 7c 28 e5       	vmovaps %ymm13,%ymm12
    291d:	c4 41 7c 28 ee       	vmovaps %ymm14,%ymm13
    2922:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    2927:	c5 7c 28 f9          	vmovaps %ymm1,%ymm15
    292b:	c5 fc 10 4c 24 60    	vmovups 0x60(%rsp),%ymm1
    2931:	c5 fc 11 54 24 c0    	vmovups %ymm2,-0x40(%rsp)
    2937:	4c 39 c6             	cmp    %r8,%rsi
    293a:	0f 8c f0 da ff ff    	jl     430 <_Z5benchv+0x2e0>
    2940:	e9 7b d8 ff ff       	jmpq   1c0 <_Z5benchv+0x70>
    2945:	0f 31                	rdtsc  
    2947:	48 c1 e2 20          	shl    $0x20,%rdx
    294b:	48 09 c2             	or     %rax,%rdx
    294e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2954 <_Z5benchv+0x2804>
    2954:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2959:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2961 <_Z5benchv+0x2811>
    2960:	00 
    2961:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2969 <_Z5benchv+0x2819>
    2968:	00 
    2969:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2970 <_Z5benchv+0x2820>
    2970:	01 c0                	add    %eax,%eax
    2972:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2978:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    297c:	c5 fb 5c 84 24 98 00 	vsubsd 0x98(%rsp),%xmm0,%xmm0
    2983:	00 00 
    2985:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    2989:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    298d:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2991:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2995:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
...
00000000000029b0 <_Z9n_reg_maxv>:
    29b0:	b8 b1 02 00 00       	mov    $0x2b1,%eax
    29b5:	c3                   	retq   

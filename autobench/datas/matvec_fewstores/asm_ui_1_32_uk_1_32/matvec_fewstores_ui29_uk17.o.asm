...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e ed 26 00 00    	jle    2885 <_Z5benchv+0x2735>
     ...
     383:	0f 83 fc 24 00 00    	jae    2885 <_Z5benchv+0x2735>
    ...
    262d:	48 83 c0 11          	add    $0x11,%rax
    2631:	49 0f af f2          	imul   %r10,%rsi
    2635:	48 01 fe             	add    %rdi,%rsi
    2638:	c4 e2 0d b8 b4 b1 c0 	vfmadd231ps 0xc0(%rcx,%rsi,4),%ymm14,%ymm6
    263f:	00 00 00 
    2642:	c4 e2 0d b8 84 b1 80 	vfmadd231ps 0x380(%rcx,%rsi,4),%ymm14,%ymm0
    2649:	03 00 00 
    264c:	c4 62 0d b8 3c b1    	vfmadd231ps (%rcx,%rsi,4),%ymm14,%ymm15
    2652:	c4 e2 0d b8 ac b1 a0 	vfmadd231ps 0xa0(%rcx,%rsi,4),%ymm14,%ymm5
    2659:	00 00 00 
    265c:	c4 e2 0d b8 bc b1 e0 	vfmadd231ps 0xe0(%rcx,%rsi,4),%ymm14,%ymm7
    2663:	00 00 00 
    2666:	c4 62 0d b8 9c b1 00 	vfmadd231ps 0x100(%rcx,%rsi,4),%ymm14,%ymm11
    266d:	01 00 00 
    2670:	c4 62 0d b8 84 b1 20 	vfmadd231ps 0x120(%rcx,%rsi,4),%ymm14,%ymm8
    2677:	01 00 00 
    267a:	c4 62 0d b8 94 b1 40 	vfmadd231ps 0x240(%rcx,%rsi,4),%ymm14,%ymm10
    2681:	02 00 00 
    2684:	c4 62 0d b8 a4 b1 60 	vfmadd231ps 0x260(%rcx,%rsi,4),%ymm14,%ymm12
    268b:	02 00 00 
    268e:	c4 62 0d b8 ac b1 00 	vfmadd231ps 0x300(%rcx,%rsi,4),%ymm14,%ymm13
    2695:	03 00 00 
    2698:	c4 e2 0d b8 4c b1 20 	vfmadd231ps 0x20(%rcx,%rsi,4),%ymm14,%ymm1
    269f:	c4 e2 0d b8 54 b1 40 	vfmadd231ps 0x40(%rcx,%rsi,4),%ymm14,%ymm2
    26a6:	c4 e2 0d b8 5c b1 60 	vfmadd231ps 0x60(%rcx,%rsi,4),%ymm14,%ymm3
    26ad:	c4 e2 0d b8 a4 b1 80 	vfmadd231ps 0x80(%rcx,%rsi,4),%ymm14,%ymm4
    26b4:	00 00 00 
    26b7:	c5 7c 11 4c 24 e0    	vmovups %ymm9,-0x20(%rsp)
    26bd:	c5 7c 10 4c 24 a0    	vmovups -0x60(%rsp),%ymm9
    26c3:	c4 62 0d b8 8c b1 40 	vfmadd231ps 0x140(%rcx,%rsi,4),%ymm14,%ymm9
    26ca:	01 00 00 
    26cd:	c5 fc 11 b4 24 e0 01 	vmovups %ymm6,0x1e0(%rsp)
    26d4:	00 00 
    26d6:	c5 fc 10 b4 24 20 01 	vmovups 0x120(%rsp),%ymm6
    26dd:	00 00 
    26df:	c4 e2 0d b8 b4 b1 60 	vfmadd231ps 0x160(%rcx,%rsi,4),%ymm14,%ymm6
    26e6:	01 00 00 
    26e9:	c5 fc 11 84 24 00 02 	vmovups %ymm0,0x200(%rsp)
    26f0:	00 00 
    26f2:	c5 7c 29 f8          	vmovaps %ymm15,%ymm0
    26f6:	c5 7c 28 fd          	vmovaps %ymm5,%ymm15
    26fa:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    26fe:	c5 7c 11 4c 24 a0    	vmovups %ymm9,-0x60(%rsp)
    2704:	c5 7c 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm9
    270a:	c4 62 0d b8 8c b1 00 	vfmadd231ps 0x200(%rcx,%rsi,4),%ymm14,%ymm9
    2711:	02 00 00 
    2714:	c5 fc 11 b4 24 20 01 	vmovups %ymm6,0x120(%rsp)
    271b:	00 00 
    271d:	c5 fc 10 b4 24 e0 00 	vmovups 0xe0(%rsp),%ymm6
    2724:	00 00 
    2726:	c4 e2 0d b8 b4 b1 80 	vfmadd231ps 0x180(%rcx,%rsi,4),%ymm14,%ymm6
    272d:	01 00 00 
    2730:	c5 7c 11 4c 24 c0    	vmovups %ymm9,-0x40(%rsp)
    2736:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    273c:	c4 62 0d b8 8c b1 20 	vfmadd231ps 0x220(%rcx,%rsi,4),%ymm14,%ymm9
    2743:	02 00 00 
    2746:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    274c:	c5 fc 11 b4 24 e0 00 	vmovups %ymm6,0xe0(%rsp)
    2753:	00 00 
    2755:	c5 fc 10 b4 24 a0 00 	vmovups 0xa0(%rsp),%ymm6
    275c:	00 00 
    275e:	c4 e2 0d b8 b4 b1 a0 	vfmadd231ps 0x1a0(%rcx,%rsi,4),%ymm14,%ymm6
    2765:	01 00 00 
    2768:	c5 7c 11 4c 24 80    	vmovups %ymm9,-0x80(%rsp)
    276e:	c5 7c 10 4c 24 80    	vmovups -0x80(%rsp),%ymm9
    2774:	c5 fc 11 b4 24 a0 00 	vmovups %ymm6,0xa0(%rsp)
    277b:	00 00 
    277d:	c5 fc 10 b4 24 00 01 	vmovups 0x100(%rsp),%ymm6
    2784:	00 00 
    2786:	c4 e2 0d b8 b4 b1 c0 	vfmadd231ps 0x1c0(%rcx,%rsi,4),%ymm14,%ymm6
    278d:	01 00 00 
    2790:	c5 fc 11 b4 24 00 01 	vmovups %ymm6,0x100(%rsp)
    2797:	00 00 
    2799:	c5 fc 10 b4 24 c0 00 	vmovups 0xc0(%rsp),%ymm6
    27a0:	00 00 
    27a2:	c4 e2 0d b8 b4 b1 e0 	vfmadd231ps 0x1e0(%rcx,%rsi,4),%ymm14,%ymm6
    27a9:	01 00 00 
    27ac:	c5 fc 11 b4 24 c0 00 	vmovups %ymm6,0xc0(%rsp)
    27b3:	00 00 
    27b5:	c5 fc 10 b4 24 40 01 	vmovups 0x140(%rsp),%ymm6
    27bc:	00 00 
    27be:	c4 e2 0d b8 b4 b1 80 	vfmadd231ps 0x280(%rcx,%rsi,4),%ymm14,%ymm6
    27c5:	02 00 00 
    27c8:	c5 fc 11 b4 24 40 01 	vmovups %ymm6,0x140(%rsp)
    27cf:	00 00 
    27d1:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    27d7:	c4 e2 0d b8 b4 b1 a0 	vfmadd231ps 0x2a0(%rcx,%rsi,4),%ymm14,%ymm6
    27de:	02 00 00 
    27e1:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    27e7:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    27ed:	c4 e2 0d b8 b4 b1 c0 	vfmadd231ps 0x2c0(%rcx,%rsi,4),%ymm14,%ymm6
    27f4:	02 00 00 
    27f7:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    27fd:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    2804:	00 00 
    2806:	c4 e2 0d b8 b4 b1 e0 	vfmadd231ps 0x2e0(%rcx,%rsi,4),%ymm14,%ymm6
    280d:	02 00 00 
    2810:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    2817:	00 00 
    2819:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    281f:	c4 e2 0d b8 b4 b1 20 	vfmadd231ps 0x320(%rcx,%rsi,4),%ymm14,%ymm6
    2826:	03 00 00 
    2829:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    282f:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    2834:	c4 e2 0d b8 b4 b1 40 	vfmadd231ps 0x340(%rcx,%rsi,4),%ymm14,%ymm6
    283b:	03 00 00 
    283e:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    2843:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    2849:	c4 e2 0d b8 b4 b1 60 	vfmadd231ps 0x360(%rcx,%rsi,4),%ymm14,%ymm6
    2850:	03 00 00 
    2853:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    2859:	c5 7c 29 d6          	vmovaps %ymm10,%ymm6
    285d:	c4 41 7c 28 d5       	vmovaps %ymm13,%ymm10
    2862:	c4 41 7c 28 eb       	vmovaps %ymm11,%ymm13
    2867:	c4 41 7c 28 dc       	vmovaps %ymm12,%ymm11
    286c:	c4 41 7c 28 e0       	vmovaps %ymm8,%ymm12
    2871:	c5 7c 10 44 24 a0    	vmovups -0x60(%rsp),%ymm8
    2877:	4c 39 c0             	cmp    %r8,%rax
    287a:	0f 8c 10 dd ff ff    	jl     590 <_Z5benchv+0x440>
    2880:	e9 71 d9 ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    2885:	0f 31                	rdtsc  
    2887:	48 c1 e2 20          	shl    $0x20,%rdx
    288b:	48 09 c2             	or     %rax,%rdx
    288e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2894 <_Z5benchv+0x2744>
    2894:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2899:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 28a1 <_Z5benchv+0x2751>
    28a0:	00 
    28a1:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 28a9 <_Z5benchv+0x2759>
    28a8:	00 
    28a9:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 28b0 <_Z5benchv+0x2760>
    28b0:	01 c0                	add    %eax,%eax
    28b2:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    28b8:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    28bc:	c5 fb 5c 84 24 78 01 	vsubsd 0x178(%rsp),%xmm0,%xmm0
    28c3:	00 00 
    28c5:	c4 41 08 57 f6       	vxorps %xmm14,%xmm14,%xmm14
    28ca:	c5 8a 2a c8          	vcvtsi2ss %eax,%xmm14,%xmm1
    28ce:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    28d2:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    28d6:	48 81 c4 58 02 00 00 	add    $0x258,%rsp
    28dd:	c5 f8 77             	vzeroupper 
    28e0:	c3                   	retq   
    28e1:	90                   	nop
    28e2:	90                   	nop
    28e3:	90                   	nop
...
0000000000002900 <_Z9n_reg_maxv>:
    2900:	b8 1b 02 00 00       	mov    $0x21b,%eax
    2905:	c3                   	retq   

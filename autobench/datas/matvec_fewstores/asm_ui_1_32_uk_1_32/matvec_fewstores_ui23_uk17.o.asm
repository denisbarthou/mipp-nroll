...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 85 1a 00 00    	jle    1c1d <_Z5benchv+0x1acd>
     ...
     30c:	0f 83 0b 19 00 00    	jae    1c1d <_Z5benchv+0x1acd>
    ...
    1a93:	48 83 c6 11          	add    $0x11,%rsi
    1a97:	49 0f af c2          	imul   %r10,%rax
    1a9b:	48 01 f8             	add    %rdi,%rax
    1a9e:	c4 e2 3d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm4
    1aa5:	02 00 00 
    1aa8:	c4 e2 3d b8 8c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm1
    1aaf:	00 00 00 
    1ab2:	c4 e2 3d b8 bc 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm7
    1ab9:	00 00 00 
    1abc:	c4 e2 3d b8 94 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm2
    1ac3:	01 00 00 
    1ac6:	c4 e2 3d b8 9c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm3
    1acd:	01 00 00 
    1ad0:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm0
    1ad7:	02 00 00 
    1ada:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    1ae0:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    1ae7:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    1aee:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    1af5:	c4 62 3d b8 b4 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm14
    1afc:	00 00 00 
    1aff:	c4 e2 3d b8 ac 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm5
    1b06:	00 00 00 
    1b09:	c4 62 3d b8 ac 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm13
    1b10:	01 00 00 
    1b13:	c4 62 3d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm15
    1b1a:	01 00 00 
    1b1d:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    1b23:	c5 fc 10 b4 24 80 00 	vmovups 0x80(%rsp),%ymm6
    1b2a:	00 00 
    1b2c:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm6
    1b33:	01 00 00 
    1b36:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    1b3d:	00 00 
    1b3f:	c5 fc 28 e1          	vmovaps %ymm1,%ymm4
    1b43:	c5 fc 28 cf          	vmovaps %ymm7,%ymm1
    1b47:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    1b4b:	c5 fc 11 84 24 e0 00 	vmovups %ymm0,0xe0(%rsp)
    1b52:	00 00 
    1b54:	c5 fc 11 b4 24 80 00 	vmovups %ymm6,0x80(%rsp)
    1b5b:	00 00 
    1b5d:	c5 fc 10 74 24 60    	vmovups 0x60(%rsp),%ymm6
    1b63:	c4 e2 3d b8 b4 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm6
    1b6a:	01 00 00 
    1b6d:	c5 fc 11 74 24 60    	vmovups %ymm6,0x60(%rsp)
    1b73:	c5 fc 10 74 24 40    	vmovups 0x40(%rsp),%ymm6
    1b79:	c4 e2 3d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm6
    1b80:	01 00 00 
    1b83:	c5 fc 11 74 24 40    	vmovups %ymm6,0x40(%rsp)
    1b89:	c5 fc 10 74 24 20    	vmovups 0x20(%rsp),%ymm6
    1b8f:	c4 e2 3d b8 b4 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm6
    1b96:	01 00 00 
    1b99:	c5 fc 11 74 24 20    	vmovups %ymm6,0x20(%rsp)
    1b9f:	c5 fc 10 34 24       	vmovups (%rsp),%ymm6
    1ba4:	c4 e2 3d b8 b4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm6
    1bab:	02 00 00 
    1bae:	c5 fc 11 34 24       	vmovups %ymm6,(%rsp)
    1bb3:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    1bb9:	c4 e2 3d b8 b4 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm6
    1bc0:	02 00 00 
    1bc3:	c5 fc 11 74 24 a0    	vmovups %ymm6,-0x60(%rsp)
    1bc9:	c5 fc 10 74 24 80    	vmovups -0x80(%rsp),%ymm6
    1bcf:	c4 e2 3d b8 b4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm6
    1bd6:	02 00 00 
    1bd9:	c5 fc 11 74 24 80    	vmovups %ymm6,-0x80(%rsp)
    1bdf:	c5 fc 10 74 24 e0    	vmovups -0x20(%rsp),%ymm6
    1be5:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm6
    1bec:	02 00 00 
    1bef:	c5 fc 11 74 24 e0    	vmovups %ymm6,-0x20(%rsp)
    1bf5:	c5 fc 10 74 24 c0    	vmovups -0x40(%rsp),%ymm6
    1bfb:	c4 e2 3d b8 b4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm6
    1c02:	02 00 00 
    1c05:	c5 7c 28 c2          	vmovaps %ymm2,%ymm8
    1c09:	c5 fc 11 74 24 c0    	vmovups %ymm6,-0x40(%rsp)
    1c0f:	4c 39 c6             	cmp    %r8,%rsi
    1c12:	0f 8c 68 e8 ff ff    	jl     480 <_Z5benchv+0x330>
    1c18:	e9 c2 e5 ff ff       	jmpq   1df <_Z5benchv+0x8f>
    1c1d:	0f 31                	rdtsc  
    1c1f:	48 c1 e2 20          	shl    $0x20,%rdx
    1c23:	48 09 c2             	or     %rax,%rdx
    1c26:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1c2c <_Z5benchv+0x1adc>
    1c2c:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1c31:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1c39 <_Z5benchv+0x1ae9>
    1c38:	00 
    1c39:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1c41 <_Z5benchv+0x1af1>
    1c40:	00 
    1c41:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1c48 <_Z5benchv+0x1af8>
    1c48:	01 c0                	add    %eax,%eax
    1c4a:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1c50:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1c54:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    1c5b:	00 00 
    1c5d:	c5 e0 57 db          	vxorps %xmm3,%xmm3,%xmm3
    1c61:	c5 e2 2a c8          	vcvtsi2ss %eax,%xmm3,%xmm1
    1c65:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1c69:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1c6d:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    1c74:	c5 f8 77             	vzeroupper 
    1c77:	c3                   	retq   
    1c78:	90                   	nop
    1c79:	90                   	nop
    1c7a:	90                   	nop
...
0000000000001c90 <_Z9n_reg_maxv>:
    1c90:	b8 af 01 00 00       	mov    $0x1af,%eax
    1c95:	c3                   	retq   

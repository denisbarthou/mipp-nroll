...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 61 38 00 00    	jle    39f9 <_Z5benchv+0x38a9>
     ...
     35d:	0f 83 96 36 00 00    	jae    39f9 <_Z5benchv+0x38a9>
    ...
    37d7:	48 83 c6 1d          	add    $0x1d,%rsi
    37db:	49 0f af c2          	imul   %r10,%rax
    37df:	48 01 f8             	add    %rdi,%rax
    37e2:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm12,%ymm4
    37e9:	02 00 00 
    37ec:	c4 e2 1d b8 94 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm12,%ymm2
    37f3:	00 00 00 
    37f6:	c4 e2 1d b8 9c 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm12,%ymm3
    37fd:	00 00 00 
    3800:	c4 e2 1d b8 ac 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm12,%ymm5
    3807:	00 00 00 
    380a:	c4 62 1d b8 94 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm12,%ymm10
    3811:	00 00 00 
    3814:	c4 62 1d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm12,%ymm8
    381b:	01 00 00 
    381e:	c4 e2 1d b8 b4 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm12,%ymm6
    3825:	01 00 00 
    3828:	c4 62 1d b8 8c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm12,%ymm9
    382f:	02 00 00 
    3832:	c4 62 1d b8 9c 81 e0 	vfmadd231ps 0x2e0(%rcx,%rax,4),%ymm12,%ymm11
    3839:	02 00 00 
    383c:	c4 e2 1d b8 84 81 40 	vfmadd231ps 0x340(%rcx,%rax,4),%ymm12,%ymm0
    3843:	03 00 00 
    3846:	c4 62 1d b8 2c 81    	vfmadd231ps (%rcx,%rax,4),%ymm12,%ymm13
    384c:	c4 62 1d b8 74 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm12,%ymm14
    3853:	c4 62 1d b8 7c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm12,%ymm15
    385a:	c4 e2 1d b8 4c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm12,%ymm1
    3861:	c5 fc 11 7c 24 e0    	vmovups %ymm7,-0x20(%rsp)
    3867:	c5 fc 10 7c 24 a0    	vmovups -0x60(%rsp),%ymm7
    386d:	c4 e2 1d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm12,%ymm7
    3874:	01 00 00 
    3877:	c5 fc 11 a4 24 80 01 	vmovups %ymm4,0x180(%rsp)
    387e:	00 00 
    3880:	c5 fc 10 a4 24 00 01 	vmovups 0x100(%rsp),%ymm4
    3887:	00 00 
    3889:	c4 e2 1d b8 a4 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm12,%ymm4
    3890:	02 00 00 
    3893:	c5 fc 11 84 24 a0 01 	vmovups %ymm0,0x1a0(%rsp)
    389a:	00 00 
    389c:	c5 7c 29 e8          	vmovaps %ymm13,%ymm0
    38a0:	c5 fc 11 7c 24 a0    	vmovups %ymm7,-0x60(%rsp)
    38a6:	c5 fc 10 bc 24 e0 00 	vmovups 0xe0(%rsp),%ymm7
    38ad:	00 00 
    38af:	c4 e2 1d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm12,%ymm7
    38b6:	01 00 00 
    38b9:	c5 fc 11 a4 24 00 01 	vmovups %ymm4,0x100(%rsp)
    38c0:	00 00 
    38c2:	c5 fc 10 64 24 20    	vmovups 0x20(%rsp),%ymm4
    38c8:	c4 e2 1d b8 a4 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm12,%ymm4
    38cf:	02 00 00 
    38d2:	c5 fc 11 bc 24 e0 00 	vmovups %ymm7,0xe0(%rsp)
    38d9:	00 00 
    38db:	c5 fc 10 bc 24 a0 00 	vmovups 0xa0(%rsp),%ymm7
    38e2:	00 00 
    38e4:	c4 e2 1d b8 bc 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm12,%ymm7
    38eb:	01 00 00 
    38ee:	c5 fc 11 64 24 20    	vmovups %ymm4,0x20(%rsp)
    38f4:	c5 fc 10 64 24 60    	vmovups 0x60(%rsp),%ymm4
    38fa:	c4 e2 1d b8 a4 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm12,%ymm4
    3901:	02 00 00 
    3904:	c5 fc 11 bc 24 a0 00 	vmovups %ymm7,0xa0(%rsp)
    390b:	00 00 
    390d:	c5 fc 10 7c 24 80    	vmovups -0x80(%rsp),%ymm7
    3913:	c4 e2 1d b8 bc 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm12,%ymm7
    391a:	01 00 00 
    391d:	c5 fc 11 64 24 60    	vmovups %ymm4,0x60(%rsp)
    3923:	c5 fc 10 a4 24 80 00 	vmovups 0x80(%rsp),%ymm4
    392a:	00 00 
    392c:	c4 e2 1d b8 a4 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm12,%ymm4
    3933:	02 00 00 
    3936:	c5 fc 11 7c 24 80    	vmovups %ymm7,-0x80(%rsp)
    393c:	c5 fc 10 bc 24 c0 00 	vmovups 0xc0(%rsp),%ymm7
    3943:	00 00 
    3945:	c4 e2 1d b8 bc 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm12,%ymm7
    394c:	01 00 00 
    394f:	c5 fc 11 a4 24 80 00 	vmovups %ymm4,0x80(%rsp)
    3956:	00 00 
    3958:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    395e:	c4 e2 1d b8 a4 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm12,%ymm4
    3965:	02 00 00 
    3968:	c5 fc 11 bc 24 c0 00 	vmovups %ymm7,0xc0(%rsp)
    396f:	00 00 
    3971:	c5 fc 10 7c 24 c0    	vmovups -0x40(%rsp),%ymm7
    3977:	c4 e2 1d b8 bc 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm12,%ymm7
    397e:	01 00 00 
    3981:	c5 fc 11 64 24 40    	vmovups %ymm4,0x40(%rsp)
    3987:	c5 fc 10 24 24       	vmovups (%rsp),%ymm4
    398c:	c4 e2 1d b8 a4 81 00 	vfmadd231ps 0x300(%rcx,%rax,4),%ymm12,%ymm4
    3993:	03 00 00 
    3996:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    399c:	c5 fc 28 fb          	vmovaps %ymm3,%ymm7
    39a0:	c5 fc 28 dd          	vmovaps %ymm5,%ymm3
    39a4:	c5 7c 29 c5          	vmovaps %ymm8,%ymm5
    39a8:	c5 7c 10 44 24 c0    	vmovups -0x40(%rsp),%ymm8
    39ae:	c5 fc 11 24 24       	vmovups %ymm4,(%rsp)
    39b3:	c5 fc 10 64 24 e0    	vmovups -0x20(%rsp),%ymm4
    39b9:	c4 e2 1d b8 a4 81 20 	vfmadd231ps 0x320(%rcx,%rax,4),%ymm12,%ymm4
    39c0:	03 00 00 
    39c3:	c5 7c 28 e2          	vmovaps %ymm2,%ymm12
    39c7:	c5 fc 10 54 24 80    	vmovups -0x80(%rsp),%ymm2
    39cd:	c5 fc 11 64 24 e0    	vmovups %ymm4,-0x20(%rsp)
    39d3:	c5 7c 29 cc          	vmovaps %ymm9,%ymm4
    39d7:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    39dc:	c4 41 7c 28 da       	vmovaps %ymm10,%ymm11
    39e1:	c5 7c 28 d6          	vmovaps %ymm6,%ymm10
    39e5:	c5 fc 10 74 24 a0    	vmovups -0x60(%rsp),%ymm6
    39eb:	4c 39 c6             	cmp    %r8,%rsi
    39ee:	0f 8c 4c cb ff ff    	jl     540 <_Z5benchv+0x3f0>
    39f4:	e9 fd c7 ff ff       	jmpq   1f6 <_Z5benchv+0xa6>
    39f9:	0f 31                	rdtsc  
    39fb:	48 c1 e2 20          	shl    $0x20,%rdx
    39ff:	48 09 c2             	or     %rax,%rdx
    3a02:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 3a08 <_Z5benchv+0x38b8>
    3a08:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    3a0d:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 3a15 <_Z5benchv+0x38c5>
    3a14:	00 
    3a15:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 3a1d <_Z5benchv+0x38cd>
    3a1c:	00 
    3a1d:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 3a24 <_Z5benchv+0x38d4>
    3a24:	01 c0                	add    %eax,%eax
    3a26:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    3a2c:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    3a30:	c5 fb 5c 84 24 38 01 	vsubsd 0x138(%rsp),%xmm0,%xmm0
    3a37:	00 00 
    3a39:	c4 41 10 57 ed       	vxorps %xmm13,%xmm13,%xmm13
    3a3e:	c5 92 2a c8          	vcvtsi2ss %eax,%xmm13,%xmm1
    3a42:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    3a46:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    3a4a:	48 81 c4 18 02 00 00 	add    $0x218,%rsp
...
0000000000003a70 <_Z9n_reg_maxv>:
    3a70:	b8 47 03 00 00       	mov    $0x347,%eax
    3a75:	c3                   	retq   

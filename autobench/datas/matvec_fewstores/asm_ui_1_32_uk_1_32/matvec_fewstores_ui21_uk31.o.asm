...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e 7e 27 00 00    	jle    2913 <_Z5benchv+0x27c3>
     ...
     2e1:	0f 83 2c 26 00 00    	jae    2913 <_Z5benchv+0x27c3>
    ...
    253b:	49 0f af c2          	imul   %r10,%rax
    253f:	48 01 f8             	add    %rdi,%rax
    2542:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    2548:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    254f:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    2556:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    255d:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    2564:	00 00 00 
    2567:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    256e:	00 00 00 
    2571:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    2578:	00 00 00 
    257b:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    2582:	01 00 00 
    2585:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    258c:	01 00 00 
    258f:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    2596:	01 00 00 
    2599:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    25a0:	01 00 00 
    25a3:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    25aa:	01 00 00 
    25ad:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    25b4:	01 00 00 
    25b7:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    25be:	02 00 00 
    25c1:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    25c7:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    25cc:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    25d3:	00 00 00 
    25d6:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    25db:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    25e1:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    25e8:	01 00 00 
    25eb:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    25f1:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    25f7:	c4 e2 4d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm0
    25fe:	01 00 00 
    2601:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    2607:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    260d:	c4 e2 4d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm0
    2614:	02 00 00 
    2617:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    261d:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    2623:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    262a:	02 00 00 
    262d:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    2633:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    2639:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    2640:	02 00 00 
    2643:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2649:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    264f:	c4 e2 4d b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm0
    2656:	02 00 00 
    2659:	48 8d 46 1d          	lea    0x1d(%rsi),%rax
    265d:	c4 e2 7d 18 74 b2 74 	vbroadcastss 0x74(%rdx,%rsi,4),%ymm6
    2664:	49 0f af c2          	imul   %r10,%rax
    2668:	48 01 f8             	add    %rdi,%rax
    266b:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    2671:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    2678:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    267f:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    2686:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    268d:	00 00 00 
    2690:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    2697:	00 00 00 
    269a:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    26a1:	00 00 00 
    26a4:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    26ab:	01 00 00 
    26ae:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    26b5:	01 00 00 
    26b8:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    26bf:	01 00 00 
    26c2:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    26c9:	01 00 00 
    26cc:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    26d3:	01 00 00 
    26d6:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    26dd:	01 00 00 
    26e0:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    26e7:	02 00 00 
    26ea:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    26f0:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    26f5:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    26fc:	00 00 00 
    26ff:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    2704:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    270a:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    2711:	01 00 00 
    2714:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    271a:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    2720:	c4 e2 4d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm0
    2727:	01 00 00 
    272a:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    2730:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    2736:	c4 e2 4d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm0
    273d:	02 00 00 
    2740:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    2746:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    274c:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    2753:	02 00 00 
    2756:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    275c:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    2762:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    2769:	02 00 00 
    276c:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2772:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    2778:	c4 e2 4d b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm0
    277f:	02 00 00 
    2782:	48 8d 46 1e          	lea    0x1e(%rsi),%rax
    2786:	c4 e2 7d 18 74 b2 78 	vbroadcastss 0x78(%rdx,%rsi,4),%ymm6
    278d:	48 83 c6 1f          	add    $0x1f,%rsi
    2791:	49 0f af c2          	imul   %r10,%rax
    2795:	48 01 f8             	add    %rdi,%rax
    2798:	c4 e2 4d b8 8c 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm6,%ymm1
    279f:	01 00 00 
    27a2:	c4 e2 4d b8 a4 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm6,%ymm4
    27a9:	01 00 00 
    27ac:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm6,%ymm2
    27b3:	01 00 00 
    27b6:	c4 e2 4d b8 bc 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm6,%ymm7
    27bd:	02 00 00 
    27c0:	c4 e2 4d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm6,%ymm5
    27c7:	01 00 00 
    27ca:	c4 62 4d b8 04 81    	vfmadd231ps (%rcx,%rax,4),%ymm6,%ymm8
    27d0:	c4 62 4d b8 4c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm6,%ymm9
    27d7:	c4 62 4d b8 54 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm6,%ymm10
    27de:	c4 62 4d b8 5c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm6,%ymm11
    27e5:	c4 62 4d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm6,%ymm13
    27ec:	00 00 00 
    27ef:	c4 62 4d b8 a4 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm6,%ymm12
    27f6:	00 00 00 
    27f9:	c4 62 4d b8 b4 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm6,%ymm14
    2800:	00 00 00 
    2803:	c4 62 4d b8 bc 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm6,%ymm15
    280a:	01 00 00 
    280d:	c4 e2 4d b8 9c 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm6,%ymm3
    2814:	01 00 00 
    2817:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    281d:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    2822:	c4 e2 4d b8 84 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm6,%ymm0
    2829:	00 00 00 
    282c:	c5 fc 11 8c 24 00 01 	vmovups %ymm1,0x100(%rsp)
    2833:	00 00 
    2835:	c5 fc 10 4c 24 c0    	vmovups -0x40(%rsp),%ymm1
    283b:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    2842:	00 00 
    2844:	c5 fc 10 64 24 40    	vmovups 0x40(%rsp),%ymm4
    284a:	c5 fc 11 94 24 c0 00 	vmovups %ymm2,0xc0(%rsp)
    2851:	00 00 
    2853:	c5 fc 10 54 24 a0    	vmovups -0x60(%rsp),%ymm2
    2859:	c4 e2 4d b8 94 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm6,%ymm2
    2860:	02 00 00 
    2863:	c4 e2 4d b8 8c 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm6,%ymm1
    286a:	01 00 00 
    286d:	c4 e2 4d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm6,%ymm4
    2874:	02 00 00 
    2877:	c5 fc 11 7c 24 c0    	vmovups %ymm7,-0x40(%rsp)
    287d:	c5 fc 11 ac 24 80 00 	vmovups %ymm5,0x80(%rsp)
    2884:	00 00 
    2886:	c5 7c 29 cd          	vmovaps %ymm9,%ymm5
    288a:	c4 41 7c 28 cb       	vmovaps %ymm11,%ymm9
    288f:	c4 41 7c 28 dd       	vmovaps %ymm13,%ymm11
    2894:	c5 7c 11 bc 24 20 01 	vmovups %ymm15,0x120(%rsp)
    289b:	00 00 
    289d:	c5 fc 11 9c 24 a0 00 	vmovups %ymm3,0xa0(%rsp)
    28a4:	00 00 
    28a6:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    28ab:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    28b1:	c4 e2 4d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm6,%ymm0
    28b8:	01 00 00 
    28bb:	c5 fc 10 3c 24       	vmovups (%rsp),%ymm7
    28c0:	c5 fc 11 54 24 a0    	vmovups %ymm2,-0x60(%rsp)
    28c6:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    28cc:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    28d2:	c4 e2 4d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm6,%ymm0
    28d9:	02 00 00 
    28dc:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    28e2:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    28e8:	c4 e2 4d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm6,%ymm0
    28ef:	02 00 00 
    28f2:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    28f6:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    28fb:	c4 41 7c 28 d4       	vmovaps %ymm12,%ymm10
    2900:	c4 41 7c 28 e6       	vmovaps %ymm14,%ymm12
    2905:	4c 39 c6             	cmp    %r8,%rsi
    2908:	0f 8c 02 db ff ff    	jl     410 <_Z5benchv+0x2c0>
    290e:	e9 b1 d8 ff ff       	jmpq   1c4 <_Z5benchv+0x74>
    2913:	0f 31                	rdtsc  
    2915:	48 c1 e2 20          	shl    $0x20,%rdx
    2919:	48 09 c2             	or     %rax,%rdx
    291c:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2922 <_Z5benchv+0x27d2>
    2922:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2927:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 292f <_Z5benchv+0x27df>
    292e:	00 
    292f:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2937 <_Z5benchv+0x27e7>
    2936:	00 
    2937:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 293e <_Z5benchv+0x27ee>
    293e:	01 c0                	add    %eax,%eax
    2940:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2946:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    294a:	c5 fb 5c 44 24 78    	vsubsd 0x78(%rsp),%xmm0,%xmm0
    2950:	c4 41 00 57 ff       	vxorps %xmm15,%xmm15,%xmm15
    2955:	c5 82 2a c8          	vcvtsi2ss %eax,%xmm15,%xmm1
    2959:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    295d:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2961:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
...
0000000000002980 <_Z9n_reg_maxv>:
    2980:	b8 bf 02 00 00       	mov    $0x2bf,%eax
    2985:	c3                   	retq   

...
0000000000000150 <_Z5benchv>:
 ...
 181:	0f 8e 59 0d 00 00    	jle    ee0 <_Z5benchv+0xd90>
 ...
 20d:	0f 83 cd 0c 00 00    	jae    ee0 <_Z5benchv+0xd90>
 ...
 ccc:	48 0f af f8          	imul   %rax,%rdi
 cd0:	48 01 f7             	add    %rsi,%rdi
 cd3:	c4 e2 25 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm1
 cd9:	c4 e2 25 b8 7c b9 20 	vfmadd231ps 0x20(%rcx,%rdi,4),%ymm11,%ymm7
 ce0:	c4 e2 25 b8 54 b9 40 	vfmadd231ps 0x40(%rcx,%rdi,4),%ymm11,%ymm2
 ce7:	c4 e2 25 b8 5c b9 60 	vfmadd231ps 0x60(%rcx,%rdi,4),%ymm11,%ymm3
 cee:	c4 e2 25 b8 a4 b9 80 	vfmadd231ps 0x80(%rcx,%rdi,4),%ymm11,%ymm4
 cf5:	00 00 00 
 cf8:	c4 e2 25 b8 ac b9 a0 	vfmadd231ps 0xa0(%rcx,%rdi,4),%ymm11,%ymm5
 cff:	00 00 00 
 d02:	c4 e2 25 b8 b4 b9 c0 	vfmadd231ps 0xc0(%rcx,%rdi,4),%ymm11,%ymm6
 d09:	00 00 00 
 d0c:	c4 62 25 b8 84 b9 e0 	vfmadd231ps 0xe0(%rcx,%rdi,4),%ymm11,%ymm8
 d13:	00 00 00 
 d16:	c4 62 25 b8 8c b9 00 	vfmadd231ps 0x100(%rcx,%rdi,4),%ymm11,%ymm9
 d1d:	01 00 00 
 d20:	c4 62 25 b8 94 b9 20 	vfmadd231ps 0x120(%rcx,%rdi,4),%ymm11,%ymm10
 d27:	01 00 00 
 d2a:	48 8d 7b 1a          	lea    0x1a(%rbx),%rdi
 d2e:	c4 62 7d 18 5c 9a 68 	vbroadcastss 0x68(%rdx,%rbx,4),%ymm11
 d35:	48 0f af f8          	imul   %rax,%rdi
 d39:	48 01 f7             	add    %rsi,%rdi
 d3c:	c4 e2 25 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm1
 d42:	c4 e2 25 b8 7c b9 20 	vfmadd231ps 0x20(%rcx,%rdi,4),%ymm11,%ymm7
 d49:	c4 e2 25 b8 54 b9 40 	vfmadd231ps 0x40(%rcx,%rdi,4),%ymm11,%ymm2
 d50:	c4 e2 25 b8 5c b9 60 	vfmadd231ps 0x60(%rcx,%rdi,4),%ymm11,%ymm3
 d57:	c4 e2 25 b8 a4 b9 80 	vfmadd231ps 0x80(%rcx,%rdi,4),%ymm11,%ymm4
 d5e:	00 00 00 
 d61:	c4 e2 25 b8 ac b9 a0 	vfmadd231ps 0xa0(%rcx,%rdi,4),%ymm11,%ymm5
 d68:	00 00 00 
 d6b:	c4 e2 25 b8 b4 b9 c0 	vfmadd231ps 0xc0(%rcx,%rdi,4),%ymm11,%ymm6
 d72:	00 00 00 
 d75:	c4 62 25 b8 84 b9 e0 	vfmadd231ps 0xe0(%rcx,%rdi,4),%ymm11,%ymm8
 d7c:	00 00 00 
 d7f:	c4 62 25 b8 8c b9 00 	vfmadd231ps 0x100(%rcx,%rdi,4),%ymm11,%ymm9
 d86:	01 00 00 
 d89:	c4 62 25 b8 94 b9 20 	vfmadd231ps 0x120(%rcx,%rdi,4),%ymm11,%ymm10
 d90:	01 00 00 
 d93:	48 8d 7b 1b          	lea    0x1b(%rbx),%rdi
 d97:	c4 62 7d 18 5c 9a 6c 	vbroadcastss 0x6c(%rdx,%rbx,4),%ymm11
 d9e:	48 0f af f8          	imul   %rax,%rdi
 da2:	48 01 f7             	add    %rsi,%rdi
 da5:	c4 e2 25 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm1
 dab:	c4 e2 25 b8 7c b9 20 	vfmadd231ps 0x20(%rcx,%rdi,4),%ymm11,%ymm7
 db2:	c4 e2 25 b8 54 b9 40 	vfmadd231ps 0x40(%rcx,%rdi,4),%ymm11,%ymm2
 db9:	c4 e2 25 b8 5c b9 60 	vfmadd231ps 0x60(%rcx,%rdi,4),%ymm11,%ymm3
 dc0:	c4 e2 25 b8 a4 b9 80 	vfmadd231ps 0x80(%rcx,%rdi,4),%ymm11,%ymm4
 dc7:	00 00 00 
 dca:	c4 e2 25 b8 ac b9 a0 	vfmadd231ps 0xa0(%rcx,%rdi,4),%ymm11,%ymm5
 dd1:	00 00 00 
 dd4:	c4 e2 25 b8 b4 b9 c0 	vfmadd231ps 0xc0(%rcx,%rdi,4),%ymm11,%ymm6
 ddb:	00 00 00 
 dde:	c4 62 25 b8 84 b9 e0 	vfmadd231ps 0xe0(%rcx,%rdi,4),%ymm11,%ymm8
 de5:	00 00 00 
 de8:	c4 62 25 b8 8c b9 00 	vfmadd231ps 0x100(%rcx,%rdi,4),%ymm11,%ymm9
 def:	01 00 00 
 df2:	c4 62 25 b8 94 b9 20 	vfmadd231ps 0x120(%rcx,%rdi,4),%ymm11,%ymm10
 df9:	01 00 00 
 dfc:	48 8d 7b 1c          	lea    0x1c(%rbx),%rdi
 e00:	c4 62 7d 18 5c 9a 70 	vbroadcastss 0x70(%rdx,%rbx,4),%ymm11
 e07:	48 0f af f8          	imul   %rax,%rdi
 e0b:	48 01 f7             	add    %rsi,%rdi
 e0e:	c4 e2 25 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm1
 e14:	c4 e2 25 b8 7c b9 20 	vfmadd231ps 0x20(%rcx,%rdi,4),%ymm11,%ymm7
 e1b:	c4 e2 25 b8 54 b9 40 	vfmadd231ps 0x40(%rcx,%rdi,4),%ymm11,%ymm2
 e22:	c4 e2 25 b8 5c b9 60 	vfmadd231ps 0x60(%rcx,%rdi,4),%ymm11,%ymm3
 e29:	c4 e2 25 b8 a4 b9 80 	vfmadd231ps 0x80(%rcx,%rdi,4),%ymm11,%ymm4
 e30:	00 00 00 
 e33:	c4 e2 25 b8 ac b9 a0 	vfmadd231ps 0xa0(%rcx,%rdi,4),%ymm11,%ymm5
 e3a:	00 00 00 
 e3d:	c4 e2 25 b8 b4 b9 c0 	vfmadd231ps 0xc0(%rcx,%rdi,4),%ymm11,%ymm6
 e44:	00 00 00 
 e47:	c4 62 25 b8 84 b9 e0 	vfmadd231ps 0xe0(%rcx,%rdi,4),%ymm11,%ymm8
 e4e:	00 00 00 
 e51:	c4 62 25 b8 8c b9 00 	vfmadd231ps 0x100(%rcx,%rdi,4),%ymm11,%ymm9
 e58:	01 00 00 
 e5b:	c4 62 25 b8 94 b9 20 	vfmadd231ps 0x120(%rcx,%rdi,4),%ymm11,%ymm10
 e62:	01 00 00 
 e65:	48 8d 7b 1d          	lea    0x1d(%rbx),%rdi
 e69:	c4 62 7d 18 5c 9a 74 	vbroadcastss 0x74(%rdx,%rbx,4),%ymm11
 e70:	48 83 c3 1e          	add    $0x1e,%rbx
 e74:	48 0f af f8          	imul   %rax,%rdi
 e78:	48 01 f7             	add    %rsi,%rdi
 e7b:	c4 e2 25 b8 0c b9    	vfmadd231ps (%rcx,%rdi,4),%ymm11,%ymm1
 e81:	c4 e2 25 b8 7c b9 20 	vfmadd231ps 0x20(%rcx,%rdi,4),%ymm11,%ymm7
 e88:	c4 e2 25 b8 54 b9 40 	vfmadd231ps 0x40(%rcx,%rdi,4),%ymm11,%ymm2
 e8f:	c4 e2 25 b8 5c b9 60 	vfmadd231ps 0x60(%rcx,%rdi,4),%ymm11,%ymm3
 e96:	c4 e2 25 b8 a4 b9 80 	vfmadd231ps 0x80(%rcx,%rdi,4),%ymm11,%ymm4
 e9d:	00 00 00 
 ea0:	c4 e2 25 b8 ac b9 a0 	vfmadd231ps 0xa0(%rcx,%rdi,4),%ymm11,%ymm5
 ea7:	00 00 00 
 eaa:	c4 e2 25 b8 b4 b9 c0 	vfmadd231ps 0xc0(%rcx,%rdi,4),%ymm11,%ymm6
 eb1:	00 00 00 
 eb4:	c4 62 25 b8 84 b9 e0 	vfmadd231ps 0xe0(%rcx,%rdi,4),%ymm11,%ymm8
 ebb:	00 00 00 
 ebe:	c4 62 25 b8 8c b9 00 	vfmadd231ps 0x100(%rcx,%rdi,4),%ymm11,%ymm9
 ec5:	01 00 00 
 ec8:	c4 62 25 b8 94 b9 20 	vfmadd231ps 0x120(%rcx,%rdi,4),%ymm11,%ymm10
 ecf:	01 00 00 
 ed2:	4c 39 d3             	cmp    %r10,%rbx
 ed5:	0f 8c a5 f3 ff ff    	jl     280 <_Z5benchv+0x130>
 edb:	e9 d0 f2 ff ff       	jmpq   1b0 <_Z5benchv+0x60>
 ee0:	0f 31                	rdtsc  
 ee2:	48 c1 e2 20          	shl    $0x20,%rdx
 ee6:	48 09 c2             	or     %rax,%rdx
 ee9:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # eef <_Z5benchv+0xd9f>
 eef:	c4 e1 f9 6e ca       	vmovq  %rdx,%xmm1
 ef4:	c5 f1 62 0d 00 00 00 	vpunpckldq 0x0(%rip),%xmm1,%xmm1        # efc <_Z5benchv+0xdac>
 efb:	00 
 efc:	c5 f1 5c 0d 00 00 00 	vsubpd 0x0(%rip),%xmm1,%xmm1        # f04 <_Z5benchv+0xdb4>
 f03:	00 
 f04:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # f0b <_Z5benchv+0xdbb>
 f0b:	01 c0                	add    %eax,%eax
 f0d:	c4 e3 79 05 d1 01    	vpermilpd $0x1,%xmm1,%xmm2
 f13:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
 f17:	c5 f3 5c c0          	vsubsd %xmm0,%xmm1,%xmm0
 f1b:	c5 9a 2a c8          	vcvtsi2ss %eax,%xmm12,%xmm1
 f1f:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 f23:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
 f27:	5b                   	pop    %rbx
 f28:	c5 f8 77             	vzeroupper 
 f2b:	c3                   	retq   
 f2c:	90                   	nop
 f2d:	90                   	nop
 f2e:	90                   	nop
...
0000000000000f40 <_Z9n_reg_maxv>:
 f40:	b8 54 01 00 00       	mov    $0x154,%eax
 f45:	c3                   	retq   

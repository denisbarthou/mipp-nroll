...
matvec_fewstores_ui23_uk22.o:     file format elf64-x86-64
...
0000000000000150 <_Z5benchv>:
     ...
     192:	0f 8e 7d 21 00 00    	jle    2315 <_Z5benchv+0x21c5>
     ...
     30c:	0f 83 03 20 00 00    	jae    2315 <_Z5benchv+0x21c5>
    ...
    2176:	48 83 c6 16          	add    $0x16,%rsi
    217a:	49 0f af c2          	imul   %r10,%rax
    217e:	48 01 f8             	add    %rdi,%rax
    2181:	c4 e2 3d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm8,%ymm5
    2188:	01 00 00 
    218b:	c4 62 3d b8 b4 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm8,%ymm14
    2192:	00 00 00 
    2195:	c4 e2 3d b8 94 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm8,%ymm2
    219c:	00 00 00 
    219f:	c4 62 3d b8 bc 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm8,%ymm15
    21a6:	01 00 00 
    21a9:	c4 e2 3d b8 b4 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm8,%ymm6
    21b0:	01 00 00 
    21b3:	c4 e2 3d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm8,%ymm4
    21ba:	01 00 00 
    21bd:	c4 e2 3d b8 8c 81 c0 	vfmadd231ps 0x2c0(%rcx,%rax,4),%ymm8,%ymm1
    21c4:	02 00 00 
    21c7:	c4 62 3d b8 0c 81    	vfmadd231ps (%rcx,%rax,4),%ymm8,%ymm9
    21cd:	c4 62 3d b8 54 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm8,%ymm10
    21d4:	c4 62 3d b8 5c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm8,%ymm11
    21db:	c4 62 3d b8 64 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm8,%ymm12
    21e2:	c4 62 3d b8 ac 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm8,%ymm13
    21e9:	00 00 00 
    21ec:	c4 e2 3d b8 bc 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm8,%ymm7
    21f3:	00 00 00 
    21f6:	c4 e2 3d b8 9c 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm8,%ymm3
    21fd:	01 00 00 
    2200:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2206:	c5 fc 10 44 24 80    	vmovups -0x80(%rsp),%ymm0
    220c:	c4 e2 3d b8 84 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm8,%ymm0
    2213:	01 00 00 
    2216:	c5 fc 11 ac 24 c0 00 	vmovups %ymm5,0xc0(%rsp)
    221d:	00 00 
    221f:	c5 7c 29 f5          	vmovaps %ymm14,%ymm5
    2223:	c4 41 7c 28 f7       	vmovaps %ymm15,%ymm14
    2228:	c5 7c 28 fa          	vmovaps %ymm2,%ymm15
    222c:	c5 fc 11 b4 24 00 01 	vmovups %ymm6,0x100(%rsp)
    2233:	00 00 
    2235:	c5 fc 11 a4 24 e0 00 	vmovups %ymm4,0xe0(%rsp)
    223c:	00 00 
    223e:	c5 fc 11 8c 24 40 01 	vmovups %ymm1,0x140(%rsp)
    2245:	00 00 
    2247:	c5 fc 11 44 24 80    	vmovups %ymm0,-0x80(%rsp)
    224d:	c5 fc 10 84 24 80 00 	vmovups 0x80(%rsp),%ymm0
    2254:	00 00 
    2256:	c4 e2 3d b8 84 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm8,%ymm0
    225d:	01 00 00 
    2260:	c5 fc 11 84 24 80 00 	vmovups %ymm0,0x80(%rsp)
    2267:	00 00 
    2269:	c5 fc 10 44 24 60    	vmovups 0x60(%rsp),%ymm0
    226f:	c4 e2 3d b8 84 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm8,%ymm0
    2276:	01 00 00 
    2279:	c5 fc 11 44 24 60    	vmovups %ymm0,0x60(%rsp)
    227f:	c5 fc 10 44 24 40    	vmovups 0x40(%rsp),%ymm0
    2285:	c4 e2 3d b8 84 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm8,%ymm0
    228c:	02 00 00 
    228f:	c5 fc 11 44 24 40    	vmovups %ymm0,0x40(%rsp)
    2295:	c5 fc 10 44 24 c0    	vmovups -0x40(%rsp),%ymm0
    229b:	c4 e2 3d b8 84 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm8,%ymm0
    22a2:	02 00 00 
    22a5:	c5 fc 11 44 24 c0    	vmovups %ymm0,-0x40(%rsp)
    22ab:	c5 fc 10 44 24 a0    	vmovups -0x60(%rsp),%ymm0
    22b1:	c4 e2 3d b8 84 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm8,%ymm0
    22b8:	02 00 00 
    22bb:	c5 fc 11 44 24 a0    	vmovups %ymm0,-0x60(%rsp)
    22c1:	c5 fc 10 04 24       	vmovups (%rsp),%ymm0
    22c6:	c4 e2 3d b8 84 81 60 	vfmadd231ps 0x260(%rcx,%rax,4),%ymm8,%ymm0
    22cd:	02 00 00 
    22d0:	c5 fc 11 04 24       	vmovups %ymm0,(%rsp)
    22d5:	c5 fc 10 44 24 e0    	vmovups -0x20(%rsp),%ymm0
    22db:	c4 e2 3d b8 84 81 80 	vfmadd231ps 0x280(%rcx,%rax,4),%ymm8,%ymm0
    22e2:	02 00 00 
    22e5:	c5 fc 11 44 24 e0    	vmovups %ymm0,-0x20(%rsp)
    22eb:	c5 fc 10 44 24 20    	vmovups 0x20(%rsp),%ymm0
    22f1:	c4 e2 3d b8 84 81 a0 	vfmadd231ps 0x2a0(%rcx,%rax,4),%ymm8,%ymm0
    22f8:	02 00 00 
    22fb:	c5 fc 11 44 24 20    	vmovups %ymm0,0x20(%rsp)
    2301:	c5 fd 10 44 24 80    	vmovupd -0x80(%rsp),%ymm0
    2307:	4c 39 c6             	cmp    %r8,%rsi
    230a:	0f 8c 60 e1 ff ff    	jl     470 <_Z5benchv+0x320>
    2310:	e9 be de ff ff       	jmpq   1d3 <_Z5benchv+0x83>
    2315:	0f 31                	rdtsc  
    2317:	48 c1 e2 20          	shl    $0x20,%rdx
    231b:	48 09 c2             	or     %rax,%rdx
    231e:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 2324 <_Z5benchv+0x21d4>
    2324:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    2329:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 2331 <_Z5benchv+0x21e1>
    2330:	00 
    2331:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 2339 <_Z5benchv+0x21e9>
    2338:	00 
    2339:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 2340 <_Z5benchv+0x21f0>
    2340:	01 c0                	add    %eax,%eax
    2342:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    2348:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    234c:	c5 fb 5c 84 24 b8 00 	vsubsd 0xb8(%rsp),%xmm0,%xmm0
    2353:	00 00 
    2355:	c5 d8 57 e4          	vxorps %xmm4,%xmm4,%xmm4
    2359:	c5 da 2a c8          	vcvtsi2ss %eax,%xmm4,%xmm1
    235d:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    2361:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    2365:	48 81 c4 78 01 00 00 	add    $0x178,%rsp
    236c:	c5 f8 77             	vzeroupper 
    236f:	c3                   	retq   

0000000000002370 <_Z6enablev>:
...
0000000000002380 <_Z9n_reg_maxv>:
    2380:	b8 27 02 00 00       	mov    $0x227,%eax
    2385:	c3                   	retq   
...
0000000000000000 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp>:
   0:	50                   	push   %rax
   1:	bf 00 00 00 00       	mov    $0x0,%edi
   6:	e8 00 00 00 00       	callq  b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0xb>
   b:	bf 00 00 00 00       	mov    $0x0,%edi
  10:	be 00 00 00 00       	mov    $0x0,%esi
  15:	ba 00 00 00 00       	mov    $0x0,%edx
  1a:	e8 00 00 00 00       	callq  1f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x1f>
  1f:	bf 00 00 00 00       	mov    $0x0,%edi
  24:	be 00 00 00 00       	mov    $0x0,%esi
  29:	ba 00 00 00 00       	mov    $0x0,%edx
  2e:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 39 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x39>
  35:	00 00 00 00 
  39:	c7 05 00 00 00 00 41 	movl   $0x585641,0x0(%rip)        # 43 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x43>
  40:	56 58 00 
  43:	48 c7 05 00 00 00 00 	movq   $0x3,0x0(%rip)        # 4e <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x4e>
  4a:	03 00 00 00 
  4e:	e8 00 00 00 00       	callq  53 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x53>
  53:	bf 00 00 00 00       	mov    $0x0,%edi
  58:	be 00 00 00 00       	mov    $0x0,%esi
  5d:	ba 00 00 00 00       	mov    $0x0,%edx
  62:	e8 00 00 00 00       	callq  67 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x67>
  67:	bf 00 00 00 00       	mov    $0x0,%edi
  6c:	be 00 00 00 00       	mov    $0x0,%esi
  71:	ba 00 00 00 00       	mov    $0x0,%edx
  76:	e8 00 00 00 00       	callq  7b <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x7b>
  7b:	48 c7 05 00 00 00 00 	movq   $0x0,0x0(%rip)        # 86 <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x86>
  82:	00 00 00 00 
  86:	66 c7 05 00 00 00 00 	movw   $0x32,0x0(%rip)        # 8f <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x8f>
  8d:	32 00 
  8f:	48 c7 05 00 00 00 00 	movq   $0x1,0x0(%rip)        # 9a <_GLOBAL__sub_I_matvec_fewstores_ui23_uk22.cpp+0x9a>
  96:	01 00 00 00 

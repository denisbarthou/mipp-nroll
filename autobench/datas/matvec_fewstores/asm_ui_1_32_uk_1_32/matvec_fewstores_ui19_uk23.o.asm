...
0000000000000150 <_Z5benchv>:
     ...
     18f:	0f 8e df 19 00 00    	jle    1b74 <_Z5benchv+0x1a24>
     ...
     2bc:	0f 83 b2 18 00 00    	jae    1b74 <_Z5benchv+0x1a24>
    ...
    1a1f:	48 83 c6 17          	add    $0x17,%rsi
    1a23:	49 0f af c2          	imul   %r10,%rax
    1a27:	48 01 f8             	add    %rdi,%rax
    1a2a:	c4 e2 5d b8 8c 81 00 	vfmadd231ps 0x100(%rcx,%rax,4),%ymm4,%ymm1
    1a31:	01 00 00 
    1a34:	c4 e2 5d b8 9c 81 60 	vfmadd231ps 0x160(%rcx,%rax,4),%ymm4,%ymm3
    1a3b:	01 00 00 
    1a3e:	c4 62 5d b8 b4 81 20 	vfmadd231ps 0x120(%rcx,%rax,4),%ymm4,%ymm14
    1a45:	01 00 00 
    1a48:	c4 62 5d b8 a4 81 80 	vfmadd231ps 0x180(%rcx,%rax,4),%ymm4,%ymm12
    1a4f:	01 00 00 
    1a52:	c4 e2 5d b8 7c 81 20 	vfmadd231ps 0x20(%rcx,%rax,4),%ymm4,%ymm7
    1a59:	c4 62 5d b8 4c 81 40 	vfmadd231ps 0x40(%rcx,%rax,4),%ymm4,%ymm9
    1a60:	c4 62 5d b8 bc 81 40 	vfmadd231ps 0x140(%rcx,%rax,4),%ymm4,%ymm15
    1a67:	01 00 00 
    1a6a:	c4 e2 5d b8 34 81    	vfmadd231ps (%rcx,%rax,4),%ymm4,%ymm6
    1a70:	c4 62 5d b8 84 81 80 	vfmadd231ps 0x80(%rcx,%rax,4),%ymm4,%ymm8
    1a77:	00 00 00 
    1a7a:	c4 62 5d b8 94 81 a0 	vfmadd231ps 0xa0(%rcx,%rax,4),%ymm4,%ymm10
    1a81:	00 00 00 
    1a84:	c4 62 5d b8 ac 81 a0 	vfmadd231ps 0x1a0(%rcx,%rax,4),%ymm4,%ymm13
    1a8b:	01 00 00 
    1a8e:	c4 62 5d b8 9c 81 c0 	vfmadd231ps 0xc0(%rcx,%rax,4),%ymm4,%ymm11
    1a95:	00 00 00 
    1a98:	c4 e2 5d b8 84 81 e0 	vfmadd231ps 0xe0(%rcx,%rax,4),%ymm4,%ymm0
    1a9f:	00 00 00 
    1aa2:	c4 e2 5d b8 94 81 40 	vfmadd231ps 0x240(%rcx,%rax,4),%ymm4,%ymm2
    1aa9:	02 00 00 
    1aac:	c5 fc 11 6c 24 80    	vmovups %ymm5,-0x80(%rsp)
    1ab2:	c5 fc 10 6c 24 e0    	vmovups -0x20(%rsp),%ymm5
    1ab8:	c4 e2 5d b8 6c 81 60 	vfmadd231ps 0x60(%rcx,%rax,4),%ymm4,%ymm5
    1abf:	c5 fc 11 8c 24 80 00 	vmovups %ymm1,0x80(%rsp)
    1ac6:	00 00 
    1ac8:	c5 fc 28 cb          	vmovaps %ymm3,%ymm1
    1acc:	c5 fc 10 5c 24 c0    	vmovups -0x40(%rsp),%ymm3
    1ad2:	c4 e2 5d b8 9c 81 c0 	vfmadd231ps 0x1c0(%rcx,%rax,4),%ymm4,%ymm3
    1ad9:	01 00 00 
    1adc:	c5 7c 11 74 24 60    	vmovups %ymm14,0x60(%rsp)
    1ae2:	c4 41 7c 28 f4       	vmovaps %ymm12,%ymm14
    1ae7:	c5 7c 10 24 24       	vmovups (%rsp),%ymm12
    1aec:	c4 62 5d b8 a4 81 00 	vfmadd231ps 0x200(%rcx,%rax,4),%ymm4,%ymm12
    1af3:	02 00 00 
    1af6:	c5 7c 11 7c 24 40    	vmovups %ymm15,0x40(%rsp)
    1afc:	c4 41 7c 28 fd       	vmovaps %ymm13,%ymm15
    1b01:	c5 7c 11 9c 24 c0 00 	vmovups %ymm11,0xc0(%rsp)
    1b08:	00 00 
    1b0a:	c5 fc 11 84 24 a0 00 	vmovups %ymm0,0xa0(%rsp)
    1b11:	00 00 
    1b13:	c5 fc 11 6c 24 e0    	vmovups %ymm5,-0x20(%rsp)
    1b19:	c5 fc 10 6c 24 a0    	vmovups -0x60(%rsp),%ymm5
    1b1f:	c4 e2 5d b8 ac 81 e0 	vfmadd231ps 0x1e0(%rcx,%rax,4),%ymm4,%ymm5
    1b26:	01 00 00 
    1b29:	c5 fc 11 5c 24 c0    	vmovups %ymm3,-0x40(%rsp)
    1b2f:	c5 fc 10 5c 24 80    	vmovups -0x80(%rsp),%ymm3
    1b35:	c4 e2 5d b8 9c 81 20 	vfmadd231ps 0x220(%rcx,%rax,4),%ymm4,%ymm3
    1b3c:	02 00 00 
    1b3f:	c5 fc 28 e6          	vmovaps %ymm6,%ymm4
    1b43:	c5 7c 29 c6          	vmovaps %ymm8,%ymm6
    1b47:	c4 41 7c 28 c2       	vmovaps %ymm10,%ymm8
    1b4c:	c5 fc 11 6c 24 a0    	vmovups %ymm5,-0x60(%rsp)
    1b52:	c5 fc 28 ef          	vmovaps %ymm7,%ymm5
    1b56:	c5 7c 29 cf          	vmovaps %ymm9,%ymm7
    1b5a:	c5 7c 10 4c 24 e0    	vmovups -0x20(%rsp),%ymm9
    1b60:	c5 fc 11 5c 24 80    	vmovups %ymm3,-0x80(%rsp)
    1b66:	4c 39 c6             	cmp    %r8,%rsi
    1b69:	0f 8c 51 e8 ff ff    	jl     3c0 <_Z5benchv+0x270>
    1b6f:	e9 54 e6 ff ff       	jmpq   1c8 <_Z5benchv+0x78>
    1b74:	0f 31                	rdtsc  
    1b76:	48 c1 e2 20          	shl    $0x20,%rdx
    1b7a:	48 09 c2             	or     %rax,%rdx
    1b7d:	8b 05 00 00 00 00    	mov    0x0(%rip),%eax        # 1b83 <_Z5benchv+0x1a33>
    1b83:	c4 e1 f9 6e c2       	vmovq  %rdx,%xmm0
    1b88:	c5 f9 62 05 00 00 00 	vpunpckldq 0x0(%rip),%xmm0,%xmm0        # 1b90 <_Z5benchv+0x1a40>
    1b8f:	00 
    1b90:	c5 f9 5c 05 00 00 00 	vsubpd 0x0(%rip),%xmm0,%xmm0        # 1b98 <_Z5benchv+0x1a48>
    1b97:	00 
    1b98:	0f af 05 00 00 00 00 	imul   0x0(%rip),%eax        # 1b9f <_Z5benchv+0x1a4f>
    1b9f:	01 c0                	add    %eax,%eax
    1ba1:	c4 e3 79 05 c8 01    	vpermilpd $0x1,%xmm0,%xmm1
    1ba7:	c5 f3 58 c0          	vaddsd %xmm0,%xmm1,%xmm0
    1bab:	c5 fb 5c 44 24 38    	vsubsd 0x38(%rsp),%xmm0,%xmm0
    1bb1:	c4 41 20 57 db       	vxorps %xmm11,%xmm11,%xmm11
    1bb6:	c5 a2 2a c8          	vcvtsi2ss %eax,%xmm11,%xmm1
    1bba:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
    1bbe:	c5 f2 5e c0          	vdivss %xmm0,%xmm1,%xmm0
    1bc2:	48 81 c4 58 01 00 00 	add    $0x158,%rsp
    1bc9:	c5 f8 77             	vzeroupper 
    1bcc:	c3                   	retq   
    1bcd:	90                   	nop
    1bce:	90                   	nop
    1bcf:	90                   	nop
...
0000000000001be0 <_Z9n_reg_maxv>:
    1be0:	b8 df 01 00 00       	mov    $0x1df,%eax
    1be5:	c3                   	retq   

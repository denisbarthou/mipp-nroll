...
#stats "icc-19.1.3.dat" using 10:6 nooutput
set format y "%.0f%%" 
set ytics 0,10,100 
set parametric
set trange [0: 100]
plot 32,t lc rgb "red", "icc-19.1.3.dat" using ($10+$8):($6/32*100):($3*$5+$4*$5+$3*$5<=32?0:($8==0?1:2)) with circles palette 
quit

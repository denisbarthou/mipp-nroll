...
unset colorbox
unset key
#set title "Block DGEMM Performance used on Intel CascadeLake with clang 15, PBQP register allocation\nThe block (BI,BK,BJ) is 64x256x64\nCodes with block size <= 32 are in blue, others in red. "
...
stats "pbqp.dat" using 10:6 nooutput
set parametric
set yrange [0: STATS_max_y+4 ]
set trange [0: STATS_max_y +4 ]
plot 32,t lc rgb "red", "pbqp.dat" using ($10+$8):6:($3*$4+$3*$5+$4*$5>32?1:0) with circles palette 
quit
